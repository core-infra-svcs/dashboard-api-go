...
type InlineResponse200239 struct {
	...
	Counts []InlineResponse200239Counts `json:"counts,omitempty"`
}
...
// SetCounts gets a reference to the given []InlineResponse200239Counts and assigns it to the Counts field.
