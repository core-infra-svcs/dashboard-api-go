...
func (o *InlineResponse200325) GetStatus() bool {
...
func (o *InlineResponse200325) GetStatusOk() (*bool, bool) {
	if o == nil || isNil(o.Status) {
    return nil, false
	}
...
func (o *InlineResponse200325) HasStatus() bool {
	if o != nil && !isNil(o.Status) {
		return true
	}
...
func (o *InlineResponse200325) SetStatus(v bool) {
	o.Status = &v
}

// GetMessage returns the Message field value if set, zero value otherwise.
func (o *InlineResponse200325) GetMessage() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200325) GetMessageOk() (*string, bool) {
	if o == nil || isNil(o.Message) {
    return nil, false
	}
...
func (o *InlineResponse200325) HasMessage() bool {
	if o != nil && !isNil(o.Message) {
		return true
	}
...
func (o *InlineResponse200325) SetMessage(v string) {
	o.Message = &v
}
