...
// InlineResponse20032Wan2 WAN 2 settings (only for MX devices)
type InlineResponse20032Wan2 struct {
...
func (o InlineResponse20032Wan2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20032Wan2 struct {
	value *InlineResponse20032Wan2
	isSet bool
}

func (v NullableInlineResponse20032Wan2) Get() *InlineResponse20032Wan2 {
	return v.value
}

func (v *NullableInlineResponse20032Wan2) Set(val *InlineResponse20032Wan2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20032Wan2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20032Wan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20032Wan2(val *InlineResponse20032Wan2) *NullableInlineResponse20032Wan2 {
	return &NullableInlineResponse20032Wan2{value: val, isSet: true}
}

func (v NullableInlineResponse20032Wan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20032Wan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
