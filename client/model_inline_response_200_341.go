...
func (o *InlineResponse200341) GetMeta() OrganizationsOrganizationIdFloorPlansAutoLocateDevicesMeta {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200341) GetMetaOk() (*OrganizationsOrganizationIdFloorPlansAutoLocateDevicesMeta, bool) {
	if o == nil || isNil(o.Meta) {
    return nil, false
	}
	return o.Meta, true
...
func (o *InlineResponse200341) SetMeta(v OrganizationsOrganizationIdFloorPlansAutoLocateDevicesMeta) {
	o.Meta = &v
}
