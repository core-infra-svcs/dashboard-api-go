...
// InlineResponse200142CountsByStatus byStatus
type InlineResponse200142CountsByStatus struct {
	// online count
...
func NewInlineResponse200142CountsByStatus() *InlineResponse200142CountsByStatus {
	this := InlineResponse200142CountsByStatus{}
	return &this
}
...
func (o InlineResponse200142CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200142CountsByStatus struct {
	value *InlineResponse200142CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200142CountsByStatus) Get() *InlineResponse200142CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200142CountsByStatus) Set(val *InlineResponse200142CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200142CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200142CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200142CountsByStatus(val *InlineResponse200142CountsByStatus) *NullableInlineResponse200142CountsByStatus {
	return &NullableInlineResponse200142CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200142CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200142CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
