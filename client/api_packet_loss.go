...
func (r PacketLossApiGetOrganizationWirelessDevicesPacketLossByClientRequest) Execute() ([]InlineResponse200341, *http.Response, error) {
...
func (a *PacketLossApiService) GetOrganizationWirelessDevicesPacketLossByClientExecute(r PacketLossApiGetOrganizationWirelessDevicesPacketLossByClientRequest) ([]InlineResponse200341, *http.Response, error) {
	var (
...
func (r PacketLossApiGetOrganizationWirelessDevicesPacketLossByDeviceRequest) Execute() ([]InlineResponse200342, *http.Response, error) {
...
func (a *PacketLossApiService) GetOrganizationWirelessDevicesPacketLossByDeviceExecute(r PacketLossApiGetOrganizationWirelessDevicesPacketLossByDeviceRequest) ([]InlineResponse200342, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PacketLossApiGetOrganizationWirelessDevicesPacketLossByNetworkRequest) Execute() ([]InlineResponse200343, *http.Response, error) {
...
func (a *PacketLossApiService) GetOrganizationWirelessDevicesPacketLossByNetworkExecute(r PacketLossApiGetOrganizationWirelessDevicesPacketLossByNetworkRequest) ([]InlineResponse200343, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
