...
func (r PacketLossApiGetOrganizationWirelessDevicesPacketLossByClientRequest) Execute() ([]InlineResponse200374, *http.Response, error) {
...
func (a *PacketLossApiService) GetOrganizationWirelessDevicesPacketLossByClientExecute(r PacketLossApiGetOrganizationWirelessDevicesPacketLossByClientRequest) ([]InlineResponse200374, *http.Response, error) {
	var (
...
func (r PacketLossApiGetOrganizationWirelessDevicesPacketLossByDeviceRequest) Execute() ([]InlineResponse200375, *http.Response, error) {
...
func (a *PacketLossApiService) GetOrganizationWirelessDevicesPacketLossByDeviceExecute(r PacketLossApiGetOrganizationWirelessDevicesPacketLossByDeviceRequest) ([]InlineResponse200375, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PacketLossApiGetOrganizationWirelessDevicesPacketLossByNetworkRequest) Execute() ([]InlineResponse200376, *http.Response, error) {
...
func (a *PacketLossApiService) GetOrganizationWirelessDevicesPacketLossByNetworkExecute(r PacketLossApiGetOrganizationWirelessDevicesPacketLossByNetworkRequest) ([]InlineResponse200376, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
