...
// InlineResponse200307CountsByStatusInactiveByMedia The inactive count data, indexed by media type (RJ45 or SFP)
type InlineResponse200307CountsByStatusInactiveByMedia struct {
	Rj45 *InlineResponse200307CountsByStatusInactiveByMediaRj45 `json:"rj45,omitempty"`
	Sfp *InlineResponse200307CountsByStatusInactiveByMediaSfp `json:"sfp,omitempty"`
}
...
func NewInlineResponse200307CountsByStatusInactiveByMedia() *InlineResponse200307CountsByStatusInactiveByMedia {
	this := InlineResponse200307CountsByStatusInactiveByMedia{}
	return &this
}
...
func (o *InlineResponse200307CountsByStatusInactiveByMedia) GetRj45() InlineResponse200307CountsByStatusInactiveByMediaRj45 {
	if o == nil || isNil(o.Rj45) {
		var ret InlineResponse200307CountsByStatusInactiveByMediaRj45
		return ret
	}
	return *o.Rj45
}
...
// SetRj45 gets a reference to the given InlineResponse200307CountsByStatusInactiveByMediaRj45 and assigns it to the Rj45 field.
...
func (o *InlineResponse200307CountsByStatusInactiveByMedia) GetSfp() InlineResponse200307CountsByStatusInactiveByMediaSfp {
	if o == nil || isNil(o.Sfp) {
		var ret InlineResponse200307CountsByStatusInactiveByMediaSfp
		return ret
	}
	return *o.Sfp
}
...
// SetSfp gets a reference to the given InlineResponse200307CountsByStatusInactiveByMediaSfp and assigns it to the Sfp field.
func (o *InlineResponse200307CountsByStatusInactiveByMedia) SetSfp(v InlineResponse200307CountsByStatusInactiveByMediaSfp) {
	o.Sfp = &v
}

func (o InlineResponse200307CountsByStatusInactiveByMedia) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200307CountsByStatusInactiveByMedia struct {
	value *InlineResponse200307CountsByStatusInactiveByMedia
	isSet bool
}

func (v NullableInlineResponse200307CountsByStatusInactiveByMedia) Get() *InlineResponse200307CountsByStatusInactiveByMedia {
	return v.value
}

func (v *NullableInlineResponse200307CountsByStatusInactiveByMedia) Set(val *InlineResponse200307CountsByStatusInactiveByMedia) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200307CountsByStatusInactiveByMedia) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200307CountsByStatusInactiveByMedia) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200307CountsByStatusInactiveByMedia(val *InlineResponse200307CountsByStatusInactiveByMedia) *NullableInlineResponse200307CountsByStatusInactiveByMedia {
	return &NullableInlineResponse200307CountsByStatusInactiveByMedia{value: val, isSet: true}
}

func (v NullableInlineResponse200307CountsByStatusInactiveByMedia) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200307CountsByStatusInactiveByMedia) UnmarshalJSON(src []byte) error {
	v.isSet = true
