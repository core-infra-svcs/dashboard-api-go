...
func (r ConnectionStatsApiGetDeviceWirelessConnectionStatsRequest) Execute() (*InlineResponse20014, *http.Response, error) {
...
func (a *ConnectionStatsApiService) GetDeviceWirelessConnectionStatsExecute(r ConnectionStatsApiGetDeviceWirelessConnectionStatsRequest) (*InlineResponse20014, *http.Response, error) {
	var (
...
func (r ConnectionStatsApiGetNetworkWirelessConnectionStatsRequest) Execute() (*InlineResponse200102, *http.Response, error) {
...
func (a *ConnectionStatsApiService) GetNetworkWirelessConnectionStatsExecute(r ConnectionStatsApiGetNetworkWirelessConnectionStatsRequest) (*InlineResponse200102, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ConnectionStatsApiGetNetworkWirelessDevicesConnectionStatsRequest) Execute() ([]InlineResponse20014, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20014
func (a *ConnectionStatsApiService) GetNetworkWirelessDevicesConnectionStatsExecute(r ConnectionStatsApiGetNetworkWirelessDevicesConnectionStatsRequest) ([]InlineResponse20014, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
