...
func (r ConnectionStatsApiGetDeviceWirelessConnectionStatsRequest) Execute() (*InlineResponse20041, *http.Response, error) {
...
func (a *ConnectionStatsApiService) GetDeviceWirelessConnectionStatsExecute(r ConnectionStatsApiGetDeviceWirelessConnectionStatsRequest) (*InlineResponse20041, *http.Response, error) {
	var (
...
func (r ConnectionStatsApiGetNetworkWirelessClientConnectionStatsRequest) Execute() (*InlineResponse200178, *http.Response, error) {
...
func (a *ConnectionStatsApiService) GetNetworkWirelessClientConnectionStatsExecute(r ConnectionStatsApiGetNetworkWirelessClientConnectionStatsRequest) (*InlineResponse200178, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ConnectionStatsApiGetNetworkWirelessConnectionStatsRequest) Execute() (*InlineResponse200181, *http.Response, error) {
...
func (a *ConnectionStatsApiService) GetNetworkWirelessConnectionStatsExecute(r ConnectionStatsApiGetNetworkWirelessConnectionStatsRequest) (*InlineResponse200181, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ConnectionStatsApiGetNetworkWirelessDevicesConnectionStatsRequest) Execute() ([]InlineResponse20041, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20041
func (a *ConnectionStatsApiService) GetNetworkWirelessDevicesConnectionStatsExecute(r ConnectionStatsApiGetNetworkWirelessDevicesConnectionStatsRequest) ([]InlineResponse20041, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
