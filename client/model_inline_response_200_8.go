...
type InlineResponse2008 struct {
	Livestream *InlineResponse2008Livestream `json:"livestream,omitempty"`
}
...
func (o *InlineResponse2008) GetLivestream() InlineResponse2008Livestream {
	if o == nil || isNil(o.Livestream) {
		var ret InlineResponse2008Livestream
		return ret
	}
	return *o.Livestream
}
...
// SetLivestream gets a reference to the given InlineResponse2008Livestream and assigns it to the Livestream field.
