...
// InlineResponse200218SentryEnrollment Systems Manager sentry enrollment splash settings.
type InlineResponse200218SentryEnrollment struct {
	SystemsManagerNetwork *InlineResponse200218SentryEnrollmentSystemsManagerNetwork `json:"systemsManagerNetwork,omitempty"`
...
func NewInlineResponse200218SentryEnrollment() *InlineResponse200218SentryEnrollment {
	this := InlineResponse200218SentryEnrollment{}
	return &this
}
...
func (o *InlineResponse200218SentryEnrollment) GetSystemsManagerNetwork() InlineResponse200218SentryEnrollmentSystemsManagerNetwork {
	if o == nil || isNil(o.SystemsManagerNetwork) {
		var ret InlineResponse200218SentryEnrollmentSystemsManagerNetwork
		return ret
	}
...
// SetSystemsManagerNetwork gets a reference to the given InlineResponse200218SentryEnrollmentSystemsManagerNetwork and assigns it to the SystemsManagerNetwork field.
...
func (o InlineResponse200218SentryEnrollment) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200218SentryEnrollment struct {
	value *InlineResponse200218SentryEnrollment
	isSet bool
}

func (v NullableInlineResponse200218SentryEnrollment) Get() *InlineResponse200218SentryEnrollment {
	return v.value
}

func (v *NullableInlineResponse200218SentryEnrollment) Set(val *InlineResponse200218SentryEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200218SentryEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200218SentryEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200218SentryEnrollment(val *InlineResponse200218SentryEnrollment) *NullableInlineResponse200218SentryEnrollment {
	return &NullableInlineResponse200218SentryEnrollment{value: val, isSet: true}
}

func (v NullableInlineResponse200218SentryEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200218SentryEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
