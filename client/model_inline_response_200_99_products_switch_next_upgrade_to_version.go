...
// InlineResponse20099ProductsSwitchNextUpgradeToVersion Details of the version the device will upgrade to
type InlineResponse20099ProductsSwitchNextUpgradeToVersion struct {
...
func NewInlineResponse20099ProductsSwitchNextUpgradeToVersion() *InlineResponse20099ProductsSwitchNextUpgradeToVersion {
	this := InlineResponse20099ProductsSwitchNextUpgradeToVersion{}
	return &this
}
...
func (o InlineResponse20099ProductsSwitchNextUpgradeToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20099ProductsSwitchNextUpgradeToVersion struct {
	value *InlineResponse20099ProductsSwitchNextUpgradeToVersion
	isSet bool
}

func (v NullableInlineResponse20099ProductsSwitchNextUpgradeToVersion) Get() *InlineResponse20099ProductsSwitchNextUpgradeToVersion {
	return v.value
}

func (v *NullableInlineResponse20099ProductsSwitchNextUpgradeToVersion) Set(val *InlineResponse20099ProductsSwitchNextUpgradeToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20099ProductsSwitchNextUpgradeToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20099ProductsSwitchNextUpgradeToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20099ProductsSwitchNextUpgradeToVersion(val *InlineResponse20099ProductsSwitchNextUpgradeToVersion) *NullableInlineResponse20099ProductsSwitchNextUpgradeToVersion {
	return &NullableInlineResponse20099ProductsSwitchNextUpgradeToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20099ProductsSwitchNextUpgradeToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20099ProductsSwitchNextUpgradeToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
