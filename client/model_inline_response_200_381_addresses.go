...
// InlineResponse200381Addresses struct for InlineResponse200381Addresses
type InlineResponse200381Addresses struct {
...
func NewInlineResponse200381Addresses() *InlineResponse200381Addresses {
	this := InlineResponse200381Addresses{}
	return &this
}
...
func (o InlineResponse200381Addresses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200381Addresses struct {
	value *InlineResponse200381Addresses
	isSet bool
}

func (v NullableInlineResponse200381Addresses) Get() *InlineResponse200381Addresses {
	return v.value
}

func (v *NullableInlineResponse200381Addresses) Set(val *InlineResponse200381Addresses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200381Addresses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200381Addresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200381Addresses(val *InlineResponse200381Addresses) *NullableInlineResponse200381Addresses {
	return &NullableInlineResponse200381Addresses{value: val, isSet: true}
}

func (v NullableInlineResponse200381Addresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200381Addresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
