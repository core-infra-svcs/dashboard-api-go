...
func (r ModelsApiGetOrganizationSummaryTopDevicesModelsByUsageRequest) Execute() ([]InlineResponse200300, *http.Response, error) {
...
func (a *ModelsApiService) GetOrganizationSummaryTopDevicesModelsByUsageExecute(r ModelsApiGetOrganizationSummaryTopDevicesModelsByUsageRequest) ([]InlineResponse200300, *http.Response, error) {
	var (
