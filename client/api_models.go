...
func (r ModelsApiGetOrganizationSummaryTopDevicesModelsByUsageRequest) Execute() ([]InlineResponse200285, *http.Response, error) {
...
func (a *ModelsApiService) GetOrganizationSummaryTopDevicesModelsByUsageExecute(r ModelsApiGetOrganizationSummaryTopDevicesModelsByUsageRequest) ([]InlineResponse200285, *http.Response, error) {
	var (
