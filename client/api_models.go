...
func (r ModelsApiGetOrganizationSummaryTopDevicesModelsByUsageRequest) Execute() ([]InlineResponse200313, *http.Response, error) {
...
func (a *ModelsApiService) GetOrganizationSummaryTopDevicesModelsByUsageExecute(r ModelsApiGetOrganizationSummaryTopDevicesModelsByUsageRequest) ([]InlineResponse200313, *http.Response, error) {
	var (
