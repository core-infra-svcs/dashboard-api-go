...
func (r RecentApiApiGetDeviceCameraAnalyticsRecentRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *RecentApiService) GetDeviceCameraAnalyticsRecent(ctx context.Context, serial string) RecentApiApiGetDeviceCameraAnalyticsRecentRequest {
	return RecentApiApiGetDeviceCameraAnalyticsRecentRequest{
		ApiService: a,
		ctx: ctx,
		serial: serial,
...
func (a *RecentApiService) GetDeviceCameraAnalyticsRecentExecute(r RecentApiApiGetDeviceCameraAnalyticsRecentRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
