...
func (r RecentApiGetDeviceCameraAnalyticsRecentRequest) Execute() ([]InlineResponse20010, *http.Response, error) {
...
// Deprecated
func (a *RecentApiService) GetDeviceCameraAnalyticsRecentExecute(r RecentApiGetDeviceCameraAnalyticsRecentRequest) ([]InlineResponse20010, *http.Response, error) {
	var (
