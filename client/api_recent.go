...
func (r RecentApiGetDeviceCameraAnalyticsRecentRequest) Execute() ([]InlineResponse20011, *http.Response, error) {
...
// Deprecated
func (a *RecentApiService) GetDeviceCameraAnalyticsRecentExecute(r RecentApiGetDeviceCameraAnalyticsRecentRequest) ([]InlineResponse20011, *http.Response, error) {
	var (
