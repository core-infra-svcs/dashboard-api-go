...
type RecentApiApiGetDeviceCameraAnalyticsRecentRequest struct {
...
func (r RecentApiApiGetDeviceCameraAnalyticsRecentRequest) ObjectType(objectType string) RecentApiApiGetDeviceCameraAnalyticsRecentRequest {
	r.objectType = &objectType
	return r
}

func (r RecentApiApiGetDeviceCameraAnalyticsRecentRequest) Execute() ([]map[string]interface{}, *_nethttp.Response, error) {
...
Returns most recent record for analytics zones
 ...
 @param serial
 @return RecentApiApiGetDeviceCameraAnalyticsRecentRequest
*/
func (a *RecentApiService) GetDeviceCameraAnalyticsRecent(ctx _context.Context, serial string) RecentApiApiGetDeviceCameraAnalyticsRecentRequest {
	return RecentApiApiGetDeviceCameraAnalyticsRecentRequest{
		ApiService: a,
		ctx: ctx,
		serial: serial,
...
func (a *RecentApiService) GetDeviceCameraAnalyticsRecentExecute(r RecentApiApiGetDeviceCameraAnalyticsRecentRequest) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
