...
func (r RecentApiGetDeviceCameraAnalyticsRecentRequest) Execute() ([]InlineResponse20013, *http.Response, error) {
...
// Deprecated
func (a *RecentApiService) GetDeviceCameraAnalyticsRecentExecute(r RecentApiGetDeviceCameraAnalyticsRecentRequest) ([]InlineResponse20013, *http.Response, error) {
	var (
