...
// InlineResponse200116Billing Details associated with billing splash
type InlineResponse200116Billing struct {
	FreeAccess *InlineResponse200116BillingFreeAccess `json:"freeAccess,omitempty"`
...
func NewInlineResponse200116Billing() *InlineResponse200116Billing {
	this := InlineResponse200116Billing{}
	return &this
}
...
func (o *InlineResponse200116Billing) GetFreeAccess() InlineResponse200116BillingFreeAccess {
	if o == nil || isNil(o.FreeAccess) {
		var ret InlineResponse200116BillingFreeAccess
		return ret
	}
	return *o.FreeAccess
}
...
// SetFreeAccess gets a reference to the given InlineResponse200116BillingFreeAccess and assigns it to the FreeAccess field.
...
func (o InlineResponse200116Billing) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200116Billing struct {
	value *InlineResponse200116Billing
	isSet bool
}

func (v NullableInlineResponse200116Billing) Get() *InlineResponse200116Billing {
	return v.value
}

func (v *NullableInlineResponse200116Billing) Set(val *InlineResponse200116Billing) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200116Billing) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200116Billing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200116Billing(val *InlineResponse200116Billing) *NullableInlineResponse200116Billing {
	return &NullableInlineResponse200116Billing{value: val, isSet: true}
}

func (v NullableInlineResponse200116Billing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200116Billing) UnmarshalJSON(src []byte) error {
	v.isSet = true
