...
// InlineResponse20022ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20022ToVersion struct {
...
func NewInlineResponse20022ToVersion() *InlineResponse20022ToVersion {
	this := InlineResponse20022ToVersion{}
	return &this
}
...
func (o InlineResponse20022ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20022ToVersion struct {
	value *InlineResponse20022ToVersion
	isSet bool
}

func (v NullableInlineResponse20022ToVersion) Get() *InlineResponse20022ToVersion {
	return v.value
}

func (v *NullableInlineResponse20022ToVersion) Set(val *InlineResponse20022ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20022ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20022ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20022ToVersion(val *InlineResponse20022ToVersion) *NullableInlineResponse20022ToVersion {
	return &NullableInlineResponse20022ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20022ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20022ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
