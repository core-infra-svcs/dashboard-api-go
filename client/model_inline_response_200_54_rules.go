...
// InlineResponse20054Rules struct for InlineResponse20054Rules
type InlineResponse20054Rules struct {
...
func (o InlineResponse20054Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20054Rules struct {
	value *InlineResponse20054Rules
	isSet bool
}

func (v NullableInlineResponse20054Rules) Get() *InlineResponse20054Rules {
	return v.value
}

func (v *NullableInlineResponse20054Rules) Set(val *InlineResponse20054Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20054Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20054Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20054Rules(val *InlineResponse20054Rules) *NullableInlineResponse20054Rules {
	return &NullableInlineResponse20054Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20054Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20054Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
