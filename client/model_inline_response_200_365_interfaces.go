...
// InlineResponse200365Interfaces struct for InlineResponse200365Interfaces
type InlineResponse200365Interfaces struct {
	...
	Addresses []InlineResponse200365Addresses `json:"addresses,omitempty"`
	Vrf *InlineResponse200365Vrf `json:"vrf,omitempty"`
...
func NewInlineResponse200365Interfaces() *InlineResponse200365Interfaces {
	this := InlineResponse200365Interfaces{}
	return &this
}
...
func (o *InlineResponse200365Interfaces) GetAddresses() []InlineResponse200365Addresses {
	if o == nil || isNil(o.Addresses) {
		var ret []InlineResponse200365Addresses
		return ret
	}
	return o.Addresses
}
...
// SetAddresses gets a reference to the given []InlineResponse200365Addresses and assigns it to the Addresses field.
...
func (o *InlineResponse200365Interfaces) GetVrf() InlineResponse200365Vrf {
	if o == nil || isNil(o.Vrf) {
		var ret InlineResponse200365Vrf
		return ret
	}
	return *o.Vrf
}
...
// SetVrf gets a reference to the given InlineResponse200365Vrf and assigns it to the Vrf field.
...
func (o InlineResponse200365Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200365Interfaces struct {
	value *InlineResponse200365Interfaces
	isSet bool
}

func (v NullableInlineResponse200365Interfaces) Get() *InlineResponse200365Interfaces {
	return v.value
}

func (v *NullableInlineResponse200365Interfaces) Set(val *InlineResponse200365Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200365Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200365Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200365Interfaces(val *InlineResponse200365Interfaces) *NullableInlineResponse200365Interfaces {
	return &NullableInlineResponse200365Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200365Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200365Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
