...
// InlineResponse200150Overrides struct for InlineResponse200150Overrides
type InlineResponse200150Overrides struct {
...
func NewInlineResponse200150Overrides() *InlineResponse200150Overrides {
	this := InlineResponse200150Overrides{}
	return &this
}
...
func (o InlineResponse200150Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200150Overrides struct {
	value *InlineResponse200150Overrides
	isSet bool
}

func (v NullableInlineResponse200150Overrides) Get() *InlineResponse200150Overrides {
	return v.value
}

func (v *NullableInlineResponse200150Overrides) Set(val *InlineResponse200150Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200150Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200150Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200150Overrides(val *InlineResponse200150Overrides) *NullableInlineResponse200150Overrides {
	return &NullableInlineResponse200150Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse200150Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200150Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
