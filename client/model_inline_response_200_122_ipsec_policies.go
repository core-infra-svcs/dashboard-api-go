...
// InlineResponse200122IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200122IpsecPolicies struct {
...
func NewInlineResponse200122IpsecPolicies() *InlineResponse200122IpsecPolicies {
	this := InlineResponse200122IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200122IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200122IpsecPolicies struct {
	value *InlineResponse200122IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200122IpsecPolicies) Get() *InlineResponse200122IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200122IpsecPolicies) Set(val *InlineResponse200122IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200122IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200122IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200122IpsecPolicies(val *InlineResponse200122IpsecPolicies) *NullableInlineResponse200122IpsecPolicies {
	return &NullableInlineResponse200122IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200122IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200122IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
