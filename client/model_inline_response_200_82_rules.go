...
// InlineResponse20082Rules struct for InlineResponse20082Rules
type InlineResponse20082Rules struct {
...
func (o InlineResponse20082Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20082Rules struct {
	value *InlineResponse20082Rules
	isSet bool
}

func (v NullableInlineResponse20082Rules) Get() *InlineResponse20082Rules {
	return v.value
}

func (v *NullableInlineResponse20082Rules) Set(val *InlineResponse20082Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20082Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20082Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20082Rules(val *InlineResponse20082Rules) *NullableInlineResponse20082Rules {
	return &NullableInlineResponse20082Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20082Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20082Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
