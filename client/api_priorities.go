...
func (r PrioritiesApiGetOrganizationBrandingPoliciesPrioritiesRequest) Execute() (*InlineResponse200251, *http.Response, error) {
...
func (a *PrioritiesApiService) GetOrganizationBrandingPoliciesPrioritiesExecute(r PrioritiesApiGetOrganizationBrandingPoliciesPrioritiesRequest) (*InlineResponse200251, *http.Response, error) {
	var (
...
func (r PrioritiesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) UpdateOrganizationBrandingPoliciesPriorities(updateOrganizationBrandingPoliciesPriorities InlineObject242) PrioritiesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest {
	r.updateOrganizationBrandingPoliciesPriorities = &updateOrganizationBrandingPoliciesPriorities
	return r
}

func (r PrioritiesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) Execute() (*InlineResponse200251, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200251
func (a *PrioritiesApiService) UpdateOrganizationBrandingPoliciesPrioritiesExecute(r PrioritiesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) (*InlineResponse200251, *http.Response, error) {
	var (
