...
func (r PrioritiesApiGetOrganizationBrandingPoliciesPrioritiesRequest) Execute() (*InlineResponse200136, *http.Response, error) {
...
func (a *PrioritiesApiService) GetOrganizationBrandingPoliciesPrioritiesExecute(r PrioritiesApiGetOrganizationBrandingPoliciesPrioritiesRequest) (*InlineResponse200136, *http.Response, error) {
	var (
...
func (r PrioritiesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) UpdateOrganizationBrandingPoliciesPriorities(updateOrganizationBrandingPoliciesPriorities InlineObject208) PrioritiesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest {
	r.updateOrganizationBrandingPoliciesPriorities = &updateOrganizationBrandingPoliciesPriorities
	return r
}

func (r PrioritiesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) Execute() (*InlineResponse200136, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200136
func (a *PrioritiesApiService) UpdateOrganizationBrandingPoliciesPrioritiesExecute(r PrioritiesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) (*InlineResponse200136, *http.Response, error) {
	var (
