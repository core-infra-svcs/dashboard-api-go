...
func (r PrioritiesApiGetOrganizationBrandingPoliciesPrioritiesRequest) Execute() (*InlineResponse200250, *http.Response, error) {
...
func (a *PrioritiesApiService) GetOrganizationBrandingPoliciesPrioritiesExecute(r PrioritiesApiGetOrganizationBrandingPoliciesPrioritiesRequest) (*InlineResponse200250, *http.Response, error) {
	var (
...
func (r PrioritiesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) UpdateOrganizationBrandingPoliciesPriorities(updateOrganizationBrandingPoliciesPriorities InlineObject241) PrioritiesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest {
	r.updateOrganizationBrandingPoliciesPriorities = &updateOrganizationBrandingPoliciesPriorities
	return r
}

func (r PrioritiesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) Execute() (*InlineResponse200250, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200250
func (a *PrioritiesApiService) UpdateOrganizationBrandingPoliciesPrioritiesExecute(r PrioritiesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) (*InlineResponse200250, *http.Response, error) {
	var (
