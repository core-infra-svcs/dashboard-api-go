...
func (r VlanProfilesApiCreateNetworkVlanProfileRequest) Execute() (*InlineResponse200182, *http.Response, error) {
...
func (a *VlanProfilesApiService) CreateNetworkVlanProfileExecute(r VlanProfilesApiCreateNetworkVlanProfileRequest) (*InlineResponse200182, *http.Response, error) {
	var (
...
func (r VlanProfilesApiGetNetworkVlanProfileRequest) Execute() (*InlineResponse200182, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200182
func (a *VlanProfilesApiService) GetNetworkVlanProfileExecute(r VlanProfilesApiGetNetworkVlanProfileRequest) (*InlineResponse200182, *http.Response, error) {
	var (
...
func (r VlanProfilesApiGetNetworkVlanProfilesRequest) Execute() ([]InlineResponse200182, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200182
func (a *VlanProfilesApiService) GetNetworkVlanProfilesExecute(r VlanProfilesApiGetNetworkVlanProfilesRequest) ([]InlineResponse200182, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlanProfilesApiGetNetworkVlanProfilesAssignmentsByDeviceRequest) Execute() ([]InlineResponse200183, *http.Response, error) {
...
func (a *VlanProfilesApiService) GetNetworkVlanProfilesAssignmentsByDeviceExecute(r VlanProfilesApiGetNetworkVlanProfilesAssignmentsByDeviceRequest) ([]InlineResponse200183, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlanProfilesApiReassignNetworkVlanProfilesAssignmentsRequest) Execute() (*InlineResponse200184, *http.Response, error) {
...
func (a *VlanProfilesApiService) ReassignNetworkVlanProfilesAssignmentsExecute(r VlanProfilesApiReassignNetworkVlanProfilesAssignmentsRequest) (*InlineResponse200184, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlanProfilesApiUpdateNetworkVlanProfileRequest) Execute() (*InlineResponse200182, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200182
func (a *VlanProfilesApiService) UpdateNetworkVlanProfileExecute(r VlanProfilesApiUpdateNetworkVlanProfileRequest) (*InlineResponse200182, *http.Response, error) {
	var (
