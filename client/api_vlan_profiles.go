...
func (r VlanProfilesApiCreateNetworkVlanProfileRequest) Execute() (*InlineResponse200160, *http.Response, error) {
...
func (a *VlanProfilesApiService) CreateNetworkVlanProfileExecute(r VlanProfilesApiCreateNetworkVlanProfileRequest) (*InlineResponse200160, *http.Response, error) {
	var (
...
func (r VlanProfilesApiGetNetworkVlanProfileRequest) Execute() (*InlineResponse200160, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200160
func (a *VlanProfilesApiService) GetNetworkVlanProfileExecute(r VlanProfilesApiGetNetworkVlanProfileRequest) (*InlineResponse200160, *http.Response, error) {
	var (
...
func (r VlanProfilesApiGetNetworkVlanProfilesRequest) Execute() ([]InlineResponse200160, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200160
func (a *VlanProfilesApiService) GetNetworkVlanProfilesExecute(r VlanProfilesApiGetNetworkVlanProfilesRequest) ([]InlineResponse200160, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlanProfilesApiGetNetworkVlanProfilesAssignmentsByDeviceRequest) Execute() ([]InlineResponse200161, *http.Response, error) {
...
func (a *VlanProfilesApiService) GetNetworkVlanProfilesAssignmentsByDeviceExecute(r VlanProfilesApiGetNetworkVlanProfilesAssignmentsByDeviceRequest) ([]InlineResponse200161, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlanProfilesApiReassignNetworkVlanProfilesAssignmentsRequest) Execute() (*InlineResponse200162, *http.Response, error) {
...
func (a *VlanProfilesApiService) ReassignNetworkVlanProfilesAssignmentsExecute(r VlanProfilesApiReassignNetworkVlanProfilesAssignmentsRequest) (*InlineResponse200162, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlanProfilesApiUpdateNetworkVlanProfileRequest) Execute() (*InlineResponse200160, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200160
func (a *VlanProfilesApiService) UpdateNetworkVlanProfileExecute(r VlanProfilesApiUpdateNetworkVlanProfileRequest) (*InlineResponse200160, *http.Response, error) {
	var (
