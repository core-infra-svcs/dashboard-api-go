...
func (r VlanProfilesApiCreateNetworkVlanProfileRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
func (a *VlanProfilesApiService) CreateNetworkVlanProfileExecute(r VlanProfilesApiCreateNetworkVlanProfileRequest) (*InlineResponse20093, *http.Response, error) {
	var (
...
func (r VlanProfilesApiGetNetworkVlanProfileRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20093
func (a *VlanProfilesApiService) GetNetworkVlanProfileExecute(r VlanProfilesApiGetNetworkVlanProfileRequest) (*InlineResponse20093, *http.Response, error) {
	var (
...
func (r VlanProfilesApiGetNetworkVlanProfilesRequest) Execute() ([]InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20093
func (a *VlanProfilesApiService) GetNetworkVlanProfilesExecute(r VlanProfilesApiGetNetworkVlanProfilesRequest) ([]InlineResponse20093, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlanProfilesApiGetNetworkVlanProfilesAssignmentsByDeviceRequest) Execute() ([]InlineResponse20094, *http.Response, error) {
...
func (a *VlanProfilesApiService) GetNetworkVlanProfilesAssignmentsByDeviceExecute(r VlanProfilesApiGetNetworkVlanProfilesAssignmentsByDeviceRequest) ([]InlineResponse20094, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlanProfilesApiReassignNetworkVlanProfilesAssignmentsRequest) Execute() (*InlineResponse20095, *http.Response, error) {
...
func (a *VlanProfilesApiService) ReassignNetworkVlanProfilesAssignmentsExecute(r VlanProfilesApiReassignNetworkVlanProfilesAssignmentsRequest) (*InlineResponse20095, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlanProfilesApiUpdateNetworkVlanProfileRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20093
func (a *VlanProfilesApiService) UpdateNetworkVlanProfileExecute(r VlanProfilesApiUpdateNetworkVlanProfileRequest) (*InlineResponse20093, *http.Response, error) {
	var (
