...
// InlineResponse200283CountsByStatus byStatus
type InlineResponse200283CountsByStatus struct {
	// online count
...
func NewInlineResponse200283CountsByStatus() *InlineResponse200283CountsByStatus {
	this := InlineResponse200283CountsByStatus{}
	return &this
}
...
func (o InlineResponse200283CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200283CountsByStatus struct {
	value *InlineResponse200283CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200283CountsByStatus) Get() *InlineResponse200283CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200283CountsByStatus) Set(val *InlineResponse200283CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200283CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200283CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200283CountsByStatus(val *InlineResponse200283CountsByStatus) *NullableInlineResponse200283CountsByStatus {
	return &NullableInlineResponse200283CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200283CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200283CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
