...
func (o *InlineObject89) GetDestinations() []NetworksNetworkIdCellularGatewayConnectivityMonitoringDestinationsDestinations {
...
func (o *InlineObject89) GetDestinationsOk() ([]NetworksNetworkIdCellularGatewayConnectivityMonitoringDestinationsDestinations, bool) {
	if o == nil || isNil(o.Destinations) {
    return nil, false
	}
...
func (o *InlineObject89) HasDestinations() bool {
	if o != nil && !isNil(o.Destinations) {
		return true
	}
...
func (o *InlineObject89) SetDestinations(v []NetworksNetworkIdCellularGatewayConnectivityMonitoringDestinationsDestinations) {
	o.Destinations = v
}
