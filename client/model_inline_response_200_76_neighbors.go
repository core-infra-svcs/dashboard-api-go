...
// InlineResponse20076Neighbors struct for InlineResponse20076Neighbors
type InlineResponse20076Neighbors struct {
	// The IPv4 address of the neighbor
	Ip *string `json:"ip,omitempty"`
	Ipv6 *InlineResponse20076Ipv6 `json:"ipv6,omitempty"`
	...
	TtlSecurity *InlineResponse20076TtlSecurity `json:"ttlSecurity,omitempty"`
	Authentication *InlineResponse20076Authentication `json:"authentication,omitempty"`
...
func NewInlineResponse20076Neighbors() *InlineResponse20076Neighbors {
	this := InlineResponse20076Neighbors{}
	return &this
}
...
func (o *InlineResponse20076Neighbors) GetIpv6() InlineResponse20076Ipv6 {
	if o == nil || isNil(o.Ipv6) {
		var ret InlineResponse20076Ipv6
		return ret
	}
	return *o.Ipv6
}
...
// SetIpv6 gets a reference to the given InlineResponse20076Ipv6 and assigns it to the Ipv6 field.
...
func (o *InlineResponse20076Neighbors) GetTtlSecurity() InlineResponse20076TtlSecurity {
	if o == nil || isNil(o.TtlSecurity) {
		var ret InlineResponse20076TtlSecurity
		return ret
	}
...
// SetTtlSecurity gets a reference to the given InlineResponse20076TtlSecurity and assigns it to the TtlSecurity field.
...
func (o *InlineResponse20076Neighbors) GetAuthentication() InlineResponse20076Authentication {
	if o == nil || isNil(o.Authentication) {
		var ret InlineResponse20076Authentication
		return ret
	}
...
// SetAuthentication gets a reference to the given InlineResponse20076Authentication and assigns it to the Authentication field.
...
func (o InlineResponse20076Neighbors) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20076Neighbors struct {
	value *InlineResponse20076Neighbors
	isSet bool
}

func (v NullableInlineResponse20076Neighbors) Get() *InlineResponse20076Neighbors {
	return v.value
}

func (v *NullableInlineResponse20076Neighbors) Set(val *InlineResponse20076Neighbors) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20076Neighbors) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20076Neighbors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20076Neighbors(val *InlineResponse20076Neighbors) *NullableInlineResponse20076Neighbors {
	return &NullableInlineResponse20076Neighbors{value: val, isSet: true}
}

func (v NullableInlineResponse20076Neighbors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20076Neighbors) UnmarshalJSON(src []byte) error {
	v.isSet = true
