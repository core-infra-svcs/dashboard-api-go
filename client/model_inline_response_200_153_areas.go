...
// InlineResponse200153Areas struct for InlineResponse200153Areas
type InlineResponse200153Areas struct {
	// OSPF area ID
...
func NewInlineResponse200153Areas() *InlineResponse200153Areas {
	this := InlineResponse200153Areas{}
	return &this
}
...
func (o InlineResponse200153Areas) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200153Areas struct {
	value *InlineResponse200153Areas
	isSet bool
}

func (v NullableInlineResponse200153Areas) Get() *InlineResponse200153Areas {
	return v.value
}

func (v *NullableInlineResponse200153Areas) Set(val *InlineResponse200153Areas) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200153Areas) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200153Areas) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200153Areas(val *InlineResponse200153Areas) *NullableInlineResponse200153Areas {
	return &NullableInlineResponse200153Areas{value: val, isSet: true}
}

func (v NullableInlineResponse200153Areas) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200153Areas) UnmarshalJSON(src []byte) error {
	v.isSet = true
