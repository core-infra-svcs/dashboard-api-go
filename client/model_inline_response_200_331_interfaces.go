...
// InlineResponse200331Interfaces struct for InlineResponse200331Interfaces
type InlineResponse200331Interfaces struct {
	...
	Addresses []InlineResponse200331Addresses `json:"addresses,omitempty"`
	Vrf *InlineResponse200331Vrf `json:"vrf,omitempty"`
...
func NewInlineResponse200331Interfaces() *InlineResponse200331Interfaces {
	this := InlineResponse200331Interfaces{}
	return &this
}
...
func (o *InlineResponse200331Interfaces) GetAddresses() []InlineResponse200331Addresses {
	if o == nil || isNil(o.Addresses) {
		var ret []InlineResponse200331Addresses
		return ret
	}
	return o.Addresses
}
...
// SetAddresses gets a reference to the given []InlineResponse200331Addresses and assigns it to the Addresses field.
...
func (o *InlineResponse200331Interfaces) GetVrf() InlineResponse200331Vrf {
	if o == nil || isNil(o.Vrf) {
		var ret InlineResponse200331Vrf
		return ret
	}
	return *o.Vrf
}
...
// SetVrf gets a reference to the given InlineResponse200331Vrf and assigns it to the Vrf field.
...
func (o InlineResponse200331Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200331Interfaces struct {
	value *InlineResponse200331Interfaces
	isSet bool
}

func (v NullableInlineResponse200331Interfaces) Get() *InlineResponse200331Interfaces {
	return v.value
}

func (v *NullableInlineResponse200331Interfaces) Set(val *InlineResponse200331Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200331Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200331Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200331Interfaces(val *InlineResponse200331Interfaces) *NullableInlineResponse200331Interfaces {
	return &NullableInlineResponse200331Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200331Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200331Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
