...
func (r JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest) BatchNetworkFloorPlansAutoLocateJobs(batchNetworkFloorPlansAutoLocateJobs InlineObject106) JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest {
	r.batchNetworkFloorPlansAutoLocateJobs = &batchNetworkFloorPlansAutoLocateJobs
	return r
}

func (r JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest) Execute() (*InlineResponse200102, *http.Response, error) {
...
func (a *JobsApiService) BatchNetworkFloorPlansAutoLocateJobsExecute(r JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest) (*InlineResponse200102, *http.Response, error) {
	var (
...
func (r JobsApiPublishNetworkFloorPlansAutoLocateJobRequest) PublishNetworkFloorPlansAutoLocateJob(publishNetworkFloorPlansAutoLocateJob InlineObject107) JobsApiPublishNetworkFloorPlansAutoLocateJobRequest {
	r.publishNetworkFloorPlansAutoLocateJob = &publishNetworkFloorPlansAutoLocateJob
	return r
}

func (r JobsApiPublishNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse200103, *http.Response, error) {
...
func (a *JobsApiService) PublishNetworkFloorPlansAutoLocateJobExecute(r JobsApiPublishNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse200103, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest) RecalculateNetworkFloorPlansAutoLocateJob(recalculateNetworkFloorPlansAutoLocateJob InlineObject108) JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest {
	r.recalculateNetworkFloorPlansAutoLocateJob = &recalculateNetworkFloorPlansAutoLocateJob
	return r
}

func (r JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse200104, *http.Response, error) {
...
func (a *JobsApiService) RecalculateNetworkFloorPlansAutoLocateJobExecute(r JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse200104, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
