...
func (r JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest) BatchNetworkFloorPlansAutoLocateJobs(batchNetworkFloorPlansAutoLocateJobs InlineObject108) JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest {
	r.batchNetworkFloorPlansAutoLocateJobs = &batchNetworkFloorPlansAutoLocateJobs
	return r
}

func (r JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest) Execute() (*InlineResponse200114, *http.Response, error) {
...
func (a *JobsApiService) BatchNetworkFloorPlansAutoLocateJobsExecute(r JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest) (*InlineResponse200114, *http.Response, error) {
	var (
...
func (r JobsApiPublishNetworkFloorPlansAutoLocateJobRequest) PublishNetworkFloorPlansAutoLocateJob(publishNetworkFloorPlansAutoLocateJob InlineObject109) JobsApiPublishNetworkFloorPlansAutoLocateJobRequest {
	r.publishNetworkFloorPlansAutoLocateJob = &publishNetworkFloorPlansAutoLocateJob
	return r
}

func (r JobsApiPublishNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse200115, *http.Response, error) {
...
func (a *JobsApiService) PublishNetworkFloorPlansAutoLocateJobExecute(r JobsApiPublishNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse200115, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest) RecalculateNetworkFloorPlansAutoLocateJob(recalculateNetworkFloorPlansAutoLocateJob InlineObject110) JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest {
	r.recalculateNetworkFloorPlansAutoLocateJob = &recalculateNetworkFloorPlansAutoLocateJob
	return r
}

func (r JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse200116, *http.Response, error) {
...
func (a *JobsApiService) RecalculateNetworkFloorPlansAutoLocateJobExecute(r JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse200116, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
