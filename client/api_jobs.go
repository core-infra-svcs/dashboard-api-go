...
func (r JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest) BatchNetworkFloorPlansAutoLocateJobs(batchNetworkFloorPlansAutoLocateJobs InlineObject101) JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest {
	r.batchNetworkFloorPlansAutoLocateJobs = &batchNetworkFloorPlansAutoLocateJobs
	return r
}

func (r JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest) Execute() (*InlineResponse20096, *http.Response, error) {
...
func (a *JobsApiService) BatchNetworkFloorPlansAutoLocateJobsExecute(r JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest) (*InlineResponse20096, *http.Response, error) {
	var (
...
func (r JobsApiPublishNetworkFloorPlansAutoLocateJobRequest) PublishNetworkFloorPlansAutoLocateJob(publishNetworkFloorPlansAutoLocateJob InlineObject102) JobsApiPublishNetworkFloorPlansAutoLocateJobRequest {
	r.publishNetworkFloorPlansAutoLocateJob = &publishNetworkFloorPlansAutoLocateJob
	return r
}

func (r JobsApiPublishNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse20097, *http.Response, error) {
...
func (a *JobsApiService) PublishNetworkFloorPlansAutoLocateJobExecute(r JobsApiPublishNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse20097, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest) RecalculateNetworkFloorPlansAutoLocateJob(recalculateNetworkFloorPlansAutoLocateJob InlineObject103) JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest {
	r.recalculateNetworkFloorPlansAutoLocateJob = &recalculateNetworkFloorPlansAutoLocateJob
	return r
}

func (r JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse20098, *http.Response, error) {
...
func (a *JobsApiService) RecalculateNetworkFloorPlansAutoLocateJobExecute(r JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse20098, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
