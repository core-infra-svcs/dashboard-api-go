...
func (r JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest) BatchNetworkFloorPlansAutoLocateJobs(batchNetworkFloorPlansAutoLocateJobs InlineObject107) JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest {
	r.batchNetworkFloorPlansAutoLocateJobs = &batchNetworkFloorPlansAutoLocateJobs
	return r
}

func (r JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest) Execute() (*InlineResponse200105, *http.Response, error) {
...
func (a *JobsApiService) BatchNetworkFloorPlansAutoLocateJobsExecute(r JobsApiBatchNetworkFloorPlansAutoLocateJobsRequest) (*InlineResponse200105, *http.Response, error) {
	var (
...
func (r JobsApiPublishNetworkFloorPlansAutoLocateJobRequest) PublishNetworkFloorPlansAutoLocateJob(publishNetworkFloorPlansAutoLocateJob InlineObject108) JobsApiPublishNetworkFloorPlansAutoLocateJobRequest {
	r.publishNetworkFloorPlansAutoLocateJob = &publishNetworkFloorPlansAutoLocateJob
	return r
}

func (r JobsApiPublishNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse200106, *http.Response, error) {
...
func (a *JobsApiService) PublishNetworkFloorPlansAutoLocateJobExecute(r JobsApiPublishNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse200106, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest) RecalculateNetworkFloorPlansAutoLocateJob(recalculateNetworkFloorPlansAutoLocateJob InlineObject109) JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest {
	r.recalculateNetworkFloorPlansAutoLocateJob = &recalculateNetworkFloorPlansAutoLocateJob
	return r
}

func (r JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse200107, *http.Response, error) {
...
func (a *JobsApiService) RecalculateNetworkFloorPlansAutoLocateJobExecute(r JobsApiRecalculateNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse200107, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
