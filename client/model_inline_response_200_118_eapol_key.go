...
// InlineResponse200118EapolKey EAPOL Key settings.
type InlineResponse200118EapolKey struct {
...
func NewInlineResponse200118EapolKey() *InlineResponse200118EapolKey {
	this := InlineResponse200118EapolKey{}
	return &this
}
...
func (o InlineResponse200118EapolKey) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200118EapolKey struct {
	value *InlineResponse200118EapolKey
	isSet bool
}

func (v NullableInlineResponse200118EapolKey) Get() *InlineResponse200118EapolKey {
	return v.value
}

func (v *NullableInlineResponse200118EapolKey) Set(val *InlineResponse200118EapolKey) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200118EapolKey) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200118EapolKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200118EapolKey(val *InlineResponse200118EapolKey) *NullableInlineResponse200118EapolKey {
	return &NullableInlineResponse200118EapolKey{value: val, isSet: true}
}

func (v NullableInlineResponse200118EapolKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200118EapolKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
