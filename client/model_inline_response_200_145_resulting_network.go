...
// InlineResponse200145ResultingNetwork Network after the combination
type InlineResponse200145ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200145ResultingNetwork() *InlineResponse200145ResultingNetwork {
	this := InlineResponse200145ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200145ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200145ResultingNetwork struct {
	value *InlineResponse200145ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200145ResultingNetwork) Get() *InlineResponse200145ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200145ResultingNetwork) Set(val *InlineResponse200145ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200145ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200145ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200145ResultingNetwork(val *InlineResponse200145ResultingNetwork) *NullableInlineResponse200145ResultingNetwork {
	return &NullableInlineResponse200145ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200145ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200145ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
