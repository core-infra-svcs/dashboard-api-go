...
// InlineResponse200262UsageOverall Overall data usage of all clients across organization
type InlineResponse200262UsageOverall struct {
...
func NewInlineResponse200262UsageOverall() *InlineResponse200262UsageOverall {
	this := InlineResponse200262UsageOverall{}
	return &this
}
...
func (o InlineResponse200262UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200262UsageOverall struct {
	value *InlineResponse200262UsageOverall
	isSet bool
}

func (v NullableInlineResponse200262UsageOverall) Get() *InlineResponse200262UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200262UsageOverall) Set(val *InlineResponse200262UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200262UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200262UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200262UsageOverall(val *InlineResponse200262UsageOverall) *NullableInlineResponse200262UsageOverall {
	return &NullableInlineResponse200262UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200262UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200262UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
