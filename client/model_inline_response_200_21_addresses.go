...
// InlineResponse20021Addresses struct for InlineResponse20021Addresses
type InlineResponse20021Addresses struct {
...
func NewInlineResponse20021Addresses() *InlineResponse20021Addresses {
	this := InlineResponse20021Addresses{}
	return &this
}
...
func (o InlineResponse20021Addresses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20021Addresses struct {
	value *InlineResponse20021Addresses
	isSet bool
}

func (v NullableInlineResponse20021Addresses) Get() *InlineResponse20021Addresses {
	return v.value
}

func (v *NullableInlineResponse20021Addresses) Set(val *InlineResponse20021Addresses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20021Addresses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20021Addresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20021Addresses(val *InlineResponse20021Addresses) *NullableInlineResponse20021Addresses {
	return &NullableInlineResponse20021Addresses{value: val, isSet: true}
}

func (v NullableInlineResponse20021Addresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20021Addresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
