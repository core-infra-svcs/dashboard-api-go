...
type InlineObject197 struct {
	...
	RadiusRadsec *NetworksNetworkIdWirelessSsidsNumberRadiusRadsec `json:"radiusRadsec,omitempty"`
	...
	NamedVlans *NetworksNetworkIdWirelessSsidsNumberNamedVlans `json:"namedVlans,omitempty"`
	LocalAuthFallback *NetworksNetworkIdWirelessSsidsNumberLocalAuthFallback `json:"localAuthFallback,omitempty"`
	// The delay (in seconds) before sending the first RADIUS accounting start message. Must be between 0 and 60 seconds.
	RadiusAccountingStartDelay *int32 `json:"radiusAccountingStartDelay,omitempty"`
}
...
// GetRadiusRadsec returns the RadiusRadsec field value if set, zero value otherwise.
func (o *InlineObject197) GetRadiusRadsec() NetworksNetworkIdWirelessSsidsNumberRadiusRadsec {
	if o == nil || isNil(o.RadiusRadsec) {
		var ret NetworksNetworkIdWirelessSsidsNumberRadiusRadsec
		return ret
	}
	return *o.RadiusRadsec
}

// GetRadiusRadsecOk returns a tuple with the RadiusRadsec field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InlineObject197) GetRadiusRadsecOk() (*NetworksNetworkIdWirelessSsidsNumberRadiusRadsec, bool) {
	if o == nil || isNil(o.RadiusRadsec) {
    return nil, false
	}
	return o.RadiusRadsec, true
}
...
// SetRadiusRadsec gets a reference to the given NetworksNetworkIdWirelessSsidsNumberRadiusRadsec and assigns it to the RadiusRadsec field.
...
func (o *InlineObject197) GetNamedVlans() NetworksNetworkIdWirelessSsidsNumberNamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret NetworksNetworkIdWirelessSsidsNumberNamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given NetworksNetworkIdWirelessSsidsNumberNamedVlans and assigns it to the NamedVlans field.
func (o *InlineObject197) SetNamedVlans(v NetworksNetworkIdWirelessSsidsNumberNamedVlans) {
	o.NamedVlans = &v
}

// GetLocalAuthFallback returns the LocalAuthFallback field value if set, zero value otherwise.
func (o *InlineObject197) GetLocalAuthFallback() NetworksNetworkIdWirelessSsidsNumberLocalAuthFallback {
	if o == nil || isNil(o.LocalAuthFallback) {
		var ret NetworksNetworkIdWirelessSsidsNumberLocalAuthFallback
		return ret
	}
	return *o.LocalAuthFallback
}

// GetLocalAuthFallbackOk returns a tuple with the LocalAuthFallback field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InlineObject197) GetLocalAuthFallbackOk() (*NetworksNetworkIdWirelessSsidsNumberLocalAuthFallback, bool) {
	if o == nil || isNil(o.LocalAuthFallback) {
    return nil, false
	}
	return o.LocalAuthFallback, true
}
...
// SetLocalAuthFallback gets a reference to the given NetworksNetworkIdWirelessSsidsNumberLocalAuthFallback and assigns it to the LocalAuthFallback field.
func (o *InlineObject197) SetLocalAuthFallback(v NetworksNetworkIdWirelessSsidsNumberLocalAuthFallback) {
	o.LocalAuthFallback = &v
}

// GetRadiusAccountingStartDelay returns the RadiusAccountingStartDelay field value if set, zero value otherwise.
func (o *InlineObject197) GetRadiusAccountingStartDelay() int32 {
	if o == nil || isNil(o.RadiusAccountingStartDelay) {
		var ret int32
		return ret
	}
	return *o.RadiusAccountingStartDelay
}

// GetRadiusAccountingStartDelayOk returns a tuple with the RadiusAccountingStartDelay field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InlineObject197) GetRadiusAccountingStartDelayOk() (*int32, bool) {
	if o == nil || isNil(o.RadiusAccountingStartDelay) {
    return nil, false
	}
	return o.RadiusAccountingStartDelay, true
}
...
// SetRadiusAccountingStartDelay gets a reference to the given int32 and assigns it to the RadiusAccountingStartDelay field.
func (o *InlineObject197) SetRadiusAccountingStartDelay(v int32) {
	o.RadiusAccountingStartDelay = &v
}
...
func (o InlineObject197) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.RadiusRadsec) {
		toSerialize["radiusRadsec"] = o.RadiusRadsec
	}
	...
	if !isNil(o.LocalAuthFallback) {
		toSerialize["localAuthFallback"] = o.LocalAuthFallback
	}
	if !isNil(o.RadiusAccountingStartDelay) {
		toSerialize["radiusAccountingStartDelay"] = o.RadiusAccountingStartDelay
	}
