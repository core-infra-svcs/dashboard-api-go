...
// InlineResponse200369Tags struct for InlineResponse200369Tags
type InlineResponse200369Tags struct {
	// Policy tag
...
func (o InlineResponse200369Tags) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200369Tags struct {
	value *InlineResponse200369Tags
	isSet bool
}

func (v NullableInlineResponse200369Tags) Get() *InlineResponse200369Tags {
	return v.value
}

func (v *NullableInlineResponse200369Tags) Set(val *InlineResponse200369Tags) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200369Tags) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200369Tags) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200369Tags(val *InlineResponse200369Tags) *NullableInlineResponse200369Tags {
	return &NullableInlineResponse200369Tags{value: val, isSet: true}
}

func (v NullableInlineResponse200369Tags) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200369Tags) UnmarshalJSON(src []byte) error {
	v.isSet = true
