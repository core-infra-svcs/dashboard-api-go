...
func (o *InlineResponse200140) GetLevel() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200140) GetLevelOk() (*string, bool) {
	if o == nil || isNil(o.Level) {
    return nil, false
	}
	return o.Level, true
...
func (o *InlineResponse200140) HasLevel() bool {
	if o != nil && !isNil(o.Level) {
		return true
	}
...
func (o *InlineResponse200140) SetLevel(v string) {
	o.Level = &v
}
