...
func (r SecurityApiGetNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20056, *http.Response, error) {
...
func (a *SecurityApiService) GetNetworkApplianceSecurityIntrusionExecute(r SecurityApiGetNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20056, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiGetNetworkApplianceSecurityMalwareRequest) Execute() (*InlineResponse20057, *http.Response, error) {
...
func (a *SecurityApiService) GetNetworkApplianceSecurityMalwareExecute(r SecurityApiGetNetworkApplianceSecurityMalwareRequest) (*InlineResponse20057, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20056, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20056
func (a *SecurityApiService) UpdateNetworkApplianceSecurityIntrusionExecute(r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20056, *http.Response, error) {
	var (
...
func (r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) Execute() (*InlineResponse20057, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20057
func (a *SecurityApiService) UpdateNetworkApplianceSecurityMalwareExecute(r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) (*InlineResponse20057, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
