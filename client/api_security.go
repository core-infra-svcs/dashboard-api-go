...
func (r SecurityApiGetNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20058, *http.Response, error) {
...
func (a *SecurityApiService) GetNetworkApplianceSecurityIntrusionExecute(r SecurityApiGetNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20058, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiGetNetworkApplianceSecurityMalwareRequest) Execute() (*InlineResponse20059, *http.Response, error) {
...
func (a *SecurityApiService) GetNetworkApplianceSecurityMalwareExecute(r SecurityApiGetNetworkApplianceSecurityMalwareRequest) (*InlineResponse20059, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) UpdateNetworkApplianceSecurityIntrusion(updateNetworkApplianceSecurityIntrusion InlineObject58) SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest {
	r.updateNetworkApplianceSecurityIntrusion = &updateNetworkApplianceSecurityIntrusion
	return r
}

func (r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20058, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20058
func (a *SecurityApiService) UpdateNetworkApplianceSecurityIntrusionExecute(r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20058, *http.Response, error) {
	var (
...
func (r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) UpdateNetworkApplianceSecurityMalware(updateNetworkApplianceSecurityMalware InlineObject59) SecurityApiUpdateNetworkApplianceSecurityMalwareRequest {
	r.updateNetworkApplianceSecurityMalware = &updateNetworkApplianceSecurityMalware
	return r
}

func (r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) Execute() (*InlineResponse20059, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20059
func (a *SecurityApiService) UpdateNetworkApplianceSecurityMalwareExecute(r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) (*InlineResponse20059, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiUpdateOrganizationApplianceSecurityIntrusionRequest) UpdateOrganizationApplianceSecurityIntrusion(updateOrganizationApplianceSecurityIntrusion InlineObject217) SecurityApiUpdateOrganizationApplianceSecurityIntrusionRequest {
