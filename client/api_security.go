...
func (r SecurityApiGetNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20055, *http.Response, error) {
...
func (a *SecurityApiService) GetNetworkApplianceSecurityIntrusionExecute(r SecurityApiGetNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20055, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiGetNetworkApplianceSecurityMalwareRequest) Execute() (*InlineResponse20056, *http.Response, error) {
...
func (a *SecurityApiService) GetNetworkApplianceSecurityMalwareExecute(r SecurityApiGetNetworkApplianceSecurityMalwareRequest) (*InlineResponse20056, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) UpdateNetworkApplianceSecurityIntrusion(updateNetworkApplianceSecurityIntrusion InlineObject56) SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest {
	r.updateNetworkApplianceSecurityIntrusion = &updateNetworkApplianceSecurityIntrusion
	return r
}

func (r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20055, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20055
func (a *SecurityApiService) UpdateNetworkApplianceSecurityIntrusionExecute(r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20055, *http.Response, error) {
	var (
...
func (r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) UpdateNetworkApplianceSecurityMalware(updateNetworkApplianceSecurityMalware InlineObject57) SecurityApiUpdateNetworkApplianceSecurityMalwareRequest {
	r.updateNetworkApplianceSecurityMalware = &updateNetworkApplianceSecurityMalware
	return r
}

func (r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) Execute() (*InlineResponse20056, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20056
func (a *SecurityApiService) UpdateNetworkApplianceSecurityMalwareExecute(r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) (*InlineResponse20056, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiUpdateOrganizationApplianceSecurityIntrusionRequest) UpdateOrganizationApplianceSecurityIntrusion(updateOrganizationApplianceSecurityIntrusion InlineObject210) SecurityApiUpdateOrganizationApplianceSecurityIntrusionRequest {
