...
func (r SecurityApiGetNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20057, *http.Response, error) {
...
func (a *SecurityApiService) GetNetworkApplianceSecurityIntrusionExecute(r SecurityApiGetNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20057, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiGetNetworkApplianceSecurityMalwareRequest) Execute() (*InlineResponse20058, *http.Response, error) {
...
func (a *SecurityApiService) GetNetworkApplianceSecurityMalwareExecute(r SecurityApiGetNetworkApplianceSecurityMalwareRequest) (*InlineResponse20058, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) UpdateNetworkApplianceSecurityIntrusion(updateNetworkApplianceSecurityIntrusion InlineObject57) SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest {
	r.updateNetworkApplianceSecurityIntrusion = &updateNetworkApplianceSecurityIntrusion
	return r
}

func (r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20057, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20057
func (a *SecurityApiService) UpdateNetworkApplianceSecurityIntrusionExecute(r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20057, *http.Response, error) {
	var (
...
func (r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) UpdateNetworkApplianceSecurityMalware(updateNetworkApplianceSecurityMalware InlineObject58) SecurityApiUpdateNetworkApplianceSecurityMalwareRequest {
	r.updateNetworkApplianceSecurityMalware = &updateNetworkApplianceSecurityMalware
	return r
}

func (r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) Execute() (*InlineResponse20058, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20058
func (a *SecurityApiService) UpdateNetworkApplianceSecurityMalwareExecute(r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) (*InlineResponse20058, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiUpdateOrganizationApplianceSecurityIntrusionRequest) UpdateOrganizationApplianceSecurityIntrusion(updateOrganizationApplianceSecurityIntrusion InlineObject212) SecurityApiUpdateOrganizationApplianceSecurityIntrusionRequest {
