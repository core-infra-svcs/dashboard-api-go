...
func (r SecurityApiGetNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20061, *http.Response, error) {
...
func (a *SecurityApiService) GetNetworkApplianceSecurityIntrusionExecute(r SecurityApiGetNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20061, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiGetNetworkApplianceSecurityMalwareRequest) Execute() (*InlineResponse20062, *http.Response, error) {
...
func (a *SecurityApiService) GetNetworkApplianceSecurityMalwareExecute(r SecurityApiGetNetworkApplianceSecurityMalwareRequest) (*InlineResponse20062, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) UpdateNetworkApplianceSecurityIntrusion(updateNetworkApplianceSecurityIntrusion InlineObject59) SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest {
	r.updateNetworkApplianceSecurityIntrusion = &updateNetworkApplianceSecurityIntrusion
	return r
}

func (r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20061, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20061
func (a *SecurityApiService) UpdateNetworkApplianceSecurityIntrusionExecute(r SecurityApiUpdateNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20061, *http.Response, error) {
	var (
...
func (r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) UpdateNetworkApplianceSecurityMalware(updateNetworkApplianceSecurityMalware InlineObject60) SecurityApiUpdateNetworkApplianceSecurityMalwareRequest {
	r.updateNetworkApplianceSecurityMalware = &updateNetworkApplianceSecurityMalware
	return r
}

func (r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) Execute() (*InlineResponse20062, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20062
func (a *SecurityApiService) UpdateNetworkApplianceSecurityMalwareExecute(r SecurityApiUpdateNetworkApplianceSecurityMalwareRequest) (*InlineResponse20062, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SecurityApiUpdateOrganizationApplianceSecurityIntrusionRequest) UpdateOrganizationApplianceSecurityIntrusion(updateOrganizationApplianceSecurityIntrusion InlineObject228) SecurityApiUpdateOrganizationApplianceSecurityIntrusionRequest {
