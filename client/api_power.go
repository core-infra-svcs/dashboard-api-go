...
func (r PowerApiGetOrganizationSummarySwitchPowerHistoryRequest) Execute() ([]InlineResponse200306, *http.Response, error) {
...
func (a *PowerApiService) GetOrganizationSummarySwitchPowerHistoryExecute(r PowerApiGetOrganizationSummarySwitchPowerHistoryRequest) ([]InlineResponse200306, *http.Response, error) {
	var (
...
func (r PowerApiGetOrganizationWirelessDevicesPowerModeHistoryRequest) Execute() (*InlineResponse200339, *http.Response, error) {
...
func (a *PowerApiService) GetOrganizationWirelessDevicesPowerModeHistoryExecute(r PowerApiGetOrganizationWirelessDevicesPowerModeHistoryRequest) (*InlineResponse200339, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
