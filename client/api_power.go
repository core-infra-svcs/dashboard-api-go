...
func (r PowerApiGetOrganizationSummarySwitchPowerHistoryRequest) Execute() ([]InlineResponse200317, *http.Response, error) {
...
func (a *PowerApiService) GetOrganizationSummarySwitchPowerHistoryExecute(r PowerApiGetOrganizationSummarySwitchPowerHistoryRequest) ([]InlineResponse200317, *http.Response, error) {
	var (
...
func (r PowerApiGetOrganizationWirelessDevicesPowerModeHistoryRequest) Execute() (*InlineResponse200350, *http.Response, error) {
...
func (a *PowerApiService) GetOrganizationWirelessDevicesPowerModeHistoryExecute(r PowerApiGetOrganizationWirelessDevicesPowerModeHistoryRequest) (*InlineResponse200350, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
