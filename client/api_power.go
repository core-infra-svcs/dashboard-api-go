...
func (r PowerApiGetOrganizationSummarySwitchPowerHistoryRequest) Execute() ([]InlineResponse200328, *http.Response, error) {
...
func (a *PowerApiService) GetOrganizationSummarySwitchPowerHistoryExecute(r PowerApiGetOrganizationSummarySwitchPowerHistoryRequest) ([]InlineResponse200328, *http.Response, error) {
	var (
...
func (r PowerApiGetOrganizationWirelessDevicesPowerModeHistoryRequest) Execute() (*InlineResponse200361, *http.Response, error) {
...
func (a *PowerApiService) GetOrganizationWirelessDevicesPowerModeHistoryExecute(r PowerApiGetOrganizationWirelessDevicesPowerModeHistoryRequest) (*InlineResponse200361, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
