...
func (r PowerApiGetOrganizationSummarySwitchPowerHistoryRequest) Execute() ([]InlineResponse200323, *http.Response, error) {
...
func (a *PowerApiService) GetOrganizationSummarySwitchPowerHistoryExecute(r PowerApiGetOrganizationSummarySwitchPowerHistoryRequest) ([]InlineResponse200323, *http.Response, error) {
	var (
...
func (r PowerApiGetOrganizationWirelessDevicesPowerModeHistoryRequest) Execute() (*InlineResponse200356, *http.Response, error) {
...
func (a *PowerApiService) GetOrganizationWirelessDevicesPowerModeHistoryExecute(r PowerApiGetOrganizationWirelessDevicesPowerModeHistoryRequest) (*InlineResponse200356, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
