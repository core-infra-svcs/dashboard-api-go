...
func (r PowerApiGetOrganizationSummarySwitchPowerHistoryRequest) Execute() ([]InlineResponse200170, *http.Response, error) {
...
func (a *PowerApiService) GetOrganizationSummarySwitchPowerHistoryExecute(r PowerApiGetOrganizationSummarySwitchPowerHistoryRequest) ([]InlineResponse200170, *http.Response, error) {
	var (
