...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200376, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200376, *http.Response, error) {
	var (
