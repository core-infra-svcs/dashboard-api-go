...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200173, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200173, *http.Response, error) {
	var (
