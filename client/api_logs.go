...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200295, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200295, *http.Response, error) {
	var (
