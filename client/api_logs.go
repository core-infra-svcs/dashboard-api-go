...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200349, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200349, *http.Response, error) {
	var (
