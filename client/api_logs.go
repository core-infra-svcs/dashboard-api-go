...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200280, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200280, *http.Response, error) {
	var (
