...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200205, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200205, *http.Response, error) {
	var (
