...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200115, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200115, *http.Response, error) {
	var (
