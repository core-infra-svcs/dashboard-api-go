...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200344, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200344, *http.Response, error) {
	var (
