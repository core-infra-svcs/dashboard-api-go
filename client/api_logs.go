...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200329, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200329, *http.Response, error) {
	var (
