...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200182, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200182, *http.Response, error) {
	var (
