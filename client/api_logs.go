...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200362, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200362, *http.Response, error) {
	var (
