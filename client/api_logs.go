...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200313, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200313, *http.Response, error) {
	var (
