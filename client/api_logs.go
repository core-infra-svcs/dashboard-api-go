...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200345, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200345, *http.Response, error) {
	var (
