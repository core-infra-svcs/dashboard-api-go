...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200296, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200296, *http.Response, error) {
	var (
