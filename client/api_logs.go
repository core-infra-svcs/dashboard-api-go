...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200309, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200309, *http.Response, error) {
	var (
