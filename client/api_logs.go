...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200110, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200110, *http.Response, error) {
	var (
