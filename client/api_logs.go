...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200338, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200338, *http.Response, error) {
	var (
