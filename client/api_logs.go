...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200315, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200315, *http.Response, error) {
	var (
