...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200332, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200332, *http.Response, error) {
	var (
