...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200180, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200180, *http.Response, error) {
	var (
