...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200195, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200195, *http.Response, error) {
	var (
