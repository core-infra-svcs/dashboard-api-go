...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200120, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200120, *http.Response, error) {
	var (
