...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200162, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200162, *http.Response, error) {
	var (
