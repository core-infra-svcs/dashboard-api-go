...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200353, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200353, *http.Response, error) {
	var (
