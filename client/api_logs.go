...
func (r LogsApiApiGetOrganizationWebhooksLogsRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *LogsApiService) GetOrganizationWebhooksLogs(ctx context.Context, organizationId string) LogsApiApiGetOrganizationWebhooksLogsRequest {
	return LogsApiApiGetOrganizationWebhooksLogsRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiApiGetOrganizationWebhooksLogsRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
