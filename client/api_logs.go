...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200290, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200290, *http.Response, error) {
	var (
