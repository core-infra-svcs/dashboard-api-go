...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200176, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200176, *http.Response, error) {
	var (
