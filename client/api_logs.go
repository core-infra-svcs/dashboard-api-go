...
func (r LogsApiApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200100, *_nethttp.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200100, *_nethttp.Response, error) {
	var (
