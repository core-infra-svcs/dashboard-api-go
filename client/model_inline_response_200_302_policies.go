...
// InlineResponse200302Policies struct for InlineResponse200302Policies
type InlineResponse200302Policies struct {
...
func NewInlineResponse200302Policies() *InlineResponse200302Policies {
	this := InlineResponse200302Policies{}
	return &this
}
...
func (o InlineResponse200302Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200302Policies struct {
	value *InlineResponse200302Policies
	isSet bool
}

func (v NullableInlineResponse200302Policies) Get() *InlineResponse200302Policies {
	return v.value
}

func (v *NullableInlineResponse200302Policies) Set(val *InlineResponse200302Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200302Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200302Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200302Policies(val *InlineResponse200302Policies) *NullableInlineResponse200302Policies {
	return &NullableInlineResponse200302Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200302Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200302Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
