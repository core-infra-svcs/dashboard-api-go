...
func (r TrafficAnalysisApiGetNetworkTrafficAnalysisRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
func (a *TrafficAnalysisApiService) GetNetworkTrafficAnalysisExecute(r TrafficAnalysisApiGetNetworkTrafficAnalysisRequest) (*InlineResponse200159, *http.Response, error) {
	var (
...
func (r TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200159
func (a *TrafficAnalysisApiService) UpdateNetworkTrafficAnalysisExecute(r TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest) (*InlineResponse200159, *http.Response, error) {
	var (
