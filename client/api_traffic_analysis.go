...
func (r TrafficAnalysisApiGetNetworkTrafficAnalysisRequest) Execute() (*InlineResponse200181, *http.Response, error) {
...
func (a *TrafficAnalysisApiService) GetNetworkTrafficAnalysisExecute(r TrafficAnalysisApiGetNetworkTrafficAnalysisRequest) (*InlineResponse200181, *http.Response, error) {
	var (
...
func (r TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest) Execute() (*InlineResponse200181, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200181
func (a *TrafficAnalysisApiService) UpdateNetworkTrafficAnalysisExecute(r TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest) (*InlineResponse200181, *http.Response, error) {
	var (
