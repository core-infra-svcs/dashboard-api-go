...
func (r TrafficAnalysisApiGetNetworkTrafficAnalysisRequest) Execute() (*InlineResponse200160, *http.Response, error) {
...
func (a *TrafficAnalysisApiService) GetNetworkTrafficAnalysisExecute(r TrafficAnalysisApiGetNetworkTrafficAnalysisRequest) (*InlineResponse200160, *http.Response, error) {
	var (
...
func (r TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest) UpdateNetworkTrafficAnalysis(updateNetworkTrafficAnalysis InlineObject159) TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest {
	r.updateNetworkTrafficAnalysis = &updateNetworkTrafficAnalysis
	return r
}

func (r TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest) Execute() (*InlineResponse200160, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200160
func (a *TrafficAnalysisApiService) UpdateNetworkTrafficAnalysisExecute(r TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest) (*InlineResponse200160, *http.Response, error) {
	var (
