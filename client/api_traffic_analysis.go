...
func (r TrafficAnalysisApiGetNetworkTrafficAnalysisRequest) Execute() (*InlineResponse200168, *http.Response, error) {
...
func (a *TrafficAnalysisApiService) GetNetworkTrafficAnalysisExecute(r TrafficAnalysisApiGetNetworkTrafficAnalysisRequest) (*InlineResponse200168, *http.Response, error) {
	var (
...
func (r TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest) Execute() (*InlineResponse200168, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200168
func (a *TrafficAnalysisApiService) UpdateNetworkTrafficAnalysisExecute(r TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest) (*InlineResponse200168, *http.Response, error) {
	var (
