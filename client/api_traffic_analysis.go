...
func (r TrafficAnalysisApiGetNetworkTrafficAnalysisRequest) Execute() (*InlineResponse200177, *http.Response, error) {
...
func (a *TrafficAnalysisApiService) GetNetworkTrafficAnalysisExecute(r TrafficAnalysisApiGetNetworkTrafficAnalysisRequest) (*InlineResponse200177, *http.Response, error) {
	var (
...
func (r TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest) UpdateNetworkTrafficAnalysis(updateNetworkTrafficAnalysis InlineObject170) TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest {
	r.updateNetworkTrafficAnalysis = &updateNetworkTrafficAnalysis
	return r
}

func (r TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest) Execute() (*InlineResponse200177, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200177
func (a *TrafficAnalysisApiService) UpdateNetworkTrafficAnalysisExecute(r TrafficAnalysisApiUpdateNetworkTrafficAnalysisRequest) (*InlineResponse200177, *http.Response, error) {
	var (
