...
// InlineResponse20053PerSsidSettings2 Settings for SSID 2.
type InlineResponse20053PerSsidSettings2 struct {
...
func NewInlineResponse20053PerSsidSettings2() *InlineResponse20053PerSsidSettings2 {
	this := InlineResponse20053PerSsidSettings2{}
	return &this
}
...
func (o InlineResponse20053PerSsidSettings2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20053PerSsidSettings2 struct {
	value *InlineResponse20053PerSsidSettings2
	isSet bool
}

func (v NullableInlineResponse20053PerSsidSettings2) Get() *InlineResponse20053PerSsidSettings2 {
	return v.value
}

func (v *NullableInlineResponse20053PerSsidSettings2) Set(val *InlineResponse20053PerSsidSettings2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20053PerSsidSettings2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20053PerSsidSettings2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20053PerSsidSettings2(val *InlineResponse20053PerSsidSettings2) *NullableInlineResponse20053PerSsidSettings2 {
	return &NullableInlineResponse20053PerSsidSettings2{value: val, isSet: true}
}

func (v NullableInlineResponse20053PerSsidSettings2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20053PerSsidSettings2) UnmarshalJSON(src []byte) error {
	v.isSet = true
