...
// InlineResponse200105Limits The current limits of various adaptive policy objects.
type InlineResponse200105Limits struct {
...
func NewInlineResponse200105Limits() *InlineResponse200105Limits {
	this := InlineResponse200105Limits{}
	return &this
}
...
func (o InlineResponse200105Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200105Limits struct {
	value *InlineResponse200105Limits
	isSet bool
}

func (v NullableInlineResponse200105Limits) Get() *InlineResponse200105Limits {
	return v.value
}

func (v *NullableInlineResponse200105Limits) Set(val *InlineResponse200105Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200105Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200105Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200105Limits(val *InlineResponse200105Limits) *NullableInlineResponse200105Limits {
	return &NullableInlineResponse200105Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200105Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200105Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
