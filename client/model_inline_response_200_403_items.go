...
type InlineResponse200403Items struct {
	...
	Network *InlineResponse200403Network `json:"network,omitempty"`
	// Status information for wireless access points.
	BasicServiceSets []InlineResponse200403BasicServiceSets `json:"basicServiceSets,omitempty"`
}
...
func (o *InlineResponse200403Items) GetNetwork() InlineResponse200403Network {
	if o == nil || isNil(o.Network) {
		var ret InlineResponse200403Network
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given InlineResponse200403Network and assigns it to the Network field.
...
func (o *InlineResponse200403Items) GetBasicServiceSets() []InlineResponse200403BasicServiceSets {
	if o == nil || isNil(o.BasicServiceSets) {
		var ret []InlineResponse200403BasicServiceSets
		return ret
	}
...
// SetBasicServiceSets gets a reference to the given []InlineResponse200403BasicServiceSets and assigns it to the BasicServiceSets field.
