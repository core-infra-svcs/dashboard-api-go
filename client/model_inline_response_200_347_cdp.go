...
// InlineResponse200347Cdp struct for InlineResponse200347Cdp
type InlineResponse200347Cdp struct {
...
func (o InlineResponse200347Cdp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200347Cdp struct {
	value *InlineResponse200347Cdp
	isSet bool
}

func (v NullableInlineResponse200347Cdp) Get() *InlineResponse200347Cdp {
	return v.value
}

func (v *NullableInlineResponse200347Cdp) Set(val *InlineResponse200347Cdp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200347Cdp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200347Cdp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200347Cdp(val *InlineResponse200347Cdp) *NullableInlineResponse200347Cdp {
	return &NullableInlineResponse200347Cdp{value: val, isSet: true}
}

func (v NullableInlineResponse200347Cdp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200347Cdp) UnmarshalJSON(src []byte) error {
	v.isSet = true
