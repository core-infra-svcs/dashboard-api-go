...
// InlineResponse200284Used Information regarding memory usage on the device over the entire timespan
type InlineResponse200284Used struct {
...
func (o InlineResponse200284Used) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200284Used struct {
	value *InlineResponse200284Used
	isSet bool
}

func (v NullableInlineResponse200284Used) Get() *InlineResponse200284Used {
	return v.value
}

func (v *NullableInlineResponse200284Used) Set(val *InlineResponse200284Used) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200284Used) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200284Used) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200284Used(val *InlineResponse200284Used) *NullableInlineResponse200284Used {
	return &NullableInlineResponse200284Used{value: val, isSet: true}
}

func (v NullableInlineResponse200284Used) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200284Used) UnmarshalJSON(src []byte) error {
	v.isSet = true
