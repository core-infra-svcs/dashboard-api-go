...
// InlineResponse200367Radio Wireless access point radio identifier.
type InlineResponse200367Radio struct {
...
func NewInlineResponse200367Radio() *InlineResponse200367Radio {
	this := InlineResponse200367Radio{}
	return &this
}
...
func (o InlineResponse200367Radio) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200367Radio struct {
	value *InlineResponse200367Radio
	isSet bool
}

func (v NullableInlineResponse200367Radio) Get() *InlineResponse200367Radio {
	return v.value
}

func (v *NullableInlineResponse200367Radio) Set(val *InlineResponse200367Radio) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200367Radio) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200367Radio) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200367Radio(val *InlineResponse200367Radio) *NullableInlineResponse200367Radio {
	return &NullableInlineResponse200367Radio{value: val, isSet: true}
}

func (v NullableInlineResponse200367Radio) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200367Radio) UnmarshalJSON(src []byte) error {
	v.isSet = true
