...
type InlineResponse200301 struct {
	ResultingNetwork *InlineResponse200301ResultingNetwork `json:"resultingNetwork,omitempty"`
}
...
func (o *InlineResponse200301) GetResultingNetwork() InlineResponse200301ResultingNetwork {
	if o == nil || isNil(o.ResultingNetwork) {
		var ret InlineResponse200301ResultingNetwork
		return ret
	}
...
// SetResultingNetwork gets a reference to the given InlineResponse200301ResultingNetwork and assigns it to the ResultingNetwork field.
