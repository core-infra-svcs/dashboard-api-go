...
func (o *InlineResponse20111) GetImportId() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20111) GetImportIdOk() (*string, bool) {
	if o == nil || isNil(o.ImportId) {
    return nil, false
	}
...
func (o *InlineResponse20111) HasImportId() bool {
	if o != nil && !isNil(o.ImportId) {
		return true
	}
...
func (o *InlineResponse20111) SetImportId(v string) {
	o.ImportId = &v
}
