...
// InlineResponse200254Records struct for InlineResponse200254Records
type InlineResponse200254Records struct {
	...
	ClientVpnConnections []InlineResponse200254ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200254Records() *InlineResponse200254Records {
	this := InlineResponse200254Records{}
	return &this
}
...
func (o *InlineResponse200254Records) GetClientVpnConnections() []InlineResponse200254ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200254ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200254ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200254Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200254Records struct {
	value *InlineResponse200254Records
	isSet bool
}

func (v NullableInlineResponse200254Records) Get() *InlineResponse200254Records {
	return v.value
}

func (v *NullableInlineResponse200254Records) Set(val *InlineResponse200254Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200254Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200254Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200254Records(val *InlineResponse200254Records) *NullableInlineResponse200254Records {
	return &NullableInlineResponse200254Records{value: val, isSet: true}
}

func (v NullableInlineResponse200254Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200254Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
