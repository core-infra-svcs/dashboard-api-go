...
// InlineResponse200292ResultingNetwork Network after the combination
type InlineResponse200292ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200292ResultingNetwork() *InlineResponse200292ResultingNetwork {
	this := InlineResponse200292ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200292ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200292ResultingNetwork struct {
	value *InlineResponse200292ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200292ResultingNetwork) Get() *InlineResponse200292ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200292ResultingNetwork) Set(val *InlineResponse200292ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200292ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200292ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200292ResultingNetwork(val *InlineResponse200292ResultingNetwork) *NullableInlineResponse200292ResultingNetwork {
	return &NullableInlineResponse200292ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200292ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200292ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
