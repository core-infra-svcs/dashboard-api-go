...
type InlineResponse20086 struct {
	...
	Hubs []InlineResponse20086Hubs `json:"hubs,omitempty"`
...
func (o *InlineResponse20086) GetHubs() []InlineResponse20086Hubs {
	if o == nil || isNil(o.Hubs) {
		var ret []InlineResponse20086Hubs
		return ret
	}
	return o.Hubs
}
...
// SetHubs gets a reference to the given []InlineResponse20086Hubs and assigns it to the Hubs field.
