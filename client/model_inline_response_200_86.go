...
type InlineResponse20086 struct {
	...
	ClientVpnConnections []InlineResponse20086ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20086) GetClientVpnConnections() []InlineResponse20086ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20086ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20086ClientVpnConnections and assigns it to the ClientVpnConnections field.
