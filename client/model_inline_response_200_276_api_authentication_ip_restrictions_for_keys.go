...
// InlineResponse200276ApiAuthenticationIpRestrictionsForKeys Details for API-only IP restrictions.
type InlineResponse200276ApiAuthenticationIpRestrictionsForKeys struct {
...
func NewInlineResponse200276ApiAuthenticationIpRestrictionsForKeys() *InlineResponse200276ApiAuthenticationIpRestrictionsForKeys {
	this := InlineResponse200276ApiAuthenticationIpRestrictionsForKeys{}
	return &this
}
...
func (o InlineResponse200276ApiAuthenticationIpRestrictionsForKeys) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200276ApiAuthenticationIpRestrictionsForKeys struct {
	value *InlineResponse200276ApiAuthenticationIpRestrictionsForKeys
	isSet bool
}

func (v NullableInlineResponse200276ApiAuthenticationIpRestrictionsForKeys) Get() *InlineResponse200276ApiAuthenticationIpRestrictionsForKeys {
	return v.value
}

func (v *NullableInlineResponse200276ApiAuthenticationIpRestrictionsForKeys) Set(val *InlineResponse200276ApiAuthenticationIpRestrictionsForKeys) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200276ApiAuthenticationIpRestrictionsForKeys) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200276ApiAuthenticationIpRestrictionsForKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200276ApiAuthenticationIpRestrictionsForKeys(val *InlineResponse200276ApiAuthenticationIpRestrictionsForKeys) *NullableInlineResponse200276ApiAuthenticationIpRestrictionsForKeys {
	return &NullableInlineResponse200276ApiAuthenticationIpRestrictionsForKeys{value: val, isSet: true}
}

func (v NullableInlineResponse200276ApiAuthenticationIpRestrictionsForKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200276ApiAuthenticationIpRestrictionsForKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
