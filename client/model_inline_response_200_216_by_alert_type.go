...
// InlineResponse200216ByAlertType struct for InlineResponse200216ByAlertType
type InlineResponse200216ByAlertType struct {
	// Alert Type
...
func NewInlineResponse200216ByAlertType() *InlineResponse200216ByAlertType {
	this := InlineResponse200216ByAlertType{}
	return &this
}
...
func (o InlineResponse200216ByAlertType) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200216ByAlertType struct {
	value *InlineResponse200216ByAlertType
	isSet bool
}

func (v NullableInlineResponse200216ByAlertType) Get() *InlineResponse200216ByAlertType {
	return v.value
}

func (v *NullableInlineResponse200216ByAlertType) Set(val *InlineResponse200216ByAlertType) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200216ByAlertType) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200216ByAlertType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200216ByAlertType(val *InlineResponse200216ByAlertType) *NullableInlineResponse200216ByAlertType {
	return &NullableInlineResponse200216ByAlertType{value: val, isSet: true}
}

func (v NullableInlineResponse200216ByAlertType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200216ByAlertType) UnmarshalJSON(src []byte) error {
	v.isSet = true
