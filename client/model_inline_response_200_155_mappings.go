...
// InlineResponse200155Mappings struct for InlineResponse200155Mappings
type InlineResponse200155Mappings struct {
...
func NewInlineResponse200155Mappings() *InlineResponse200155Mappings {
	this := InlineResponse200155Mappings{}
	return &this
}
...
func (o InlineResponse200155Mappings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200155Mappings struct {
	value *InlineResponse200155Mappings
	isSet bool
}

func (v NullableInlineResponse200155Mappings) Get() *InlineResponse200155Mappings {
	return v.value
}

func (v *NullableInlineResponse200155Mappings) Set(val *InlineResponse200155Mappings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200155Mappings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200155Mappings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200155Mappings(val *InlineResponse200155Mappings) *NullableInlineResponse200155Mappings {
	return &NullableInlineResponse200155Mappings{value: val, isSet: true}
}

func (v NullableInlineResponse200155Mappings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200155Mappings) UnmarshalJSON(src []byte) error {
	v.isSet = true
