...
type InlineResponse20087 struct {
	...
	ClientVpnConnections []InlineResponse20087ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20087) GetClientVpnConnections() []InlineResponse20087ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20087ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20087ClientVpnConnections and assigns it to the ClientVpnConnections field.
