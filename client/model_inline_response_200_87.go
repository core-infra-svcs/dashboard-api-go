...
type InlineResponse20087 struct {
	...
	Events []InlineResponse20087Events `json:"events,omitempty"`
}
...
func (o *InlineResponse20087) GetEvents() []InlineResponse20087Events {
	if o == nil || isNil(o.Events) {
		var ret []InlineResponse20087Events
		return ret
	}
	return o.Events
}
...
// SetEvents gets a reference to the given []InlineResponse20087Events and assigns it to the Events field.
