...
// InlineResponse20046LocalStatusPageAuthentication A hash of Local Status page(s)' authentication options applied to the Network.
type InlineResponse20046LocalStatusPageAuthentication struct {
...
func NewInlineResponse20046LocalStatusPageAuthentication() *InlineResponse20046LocalStatusPageAuthentication {
	this := InlineResponse20046LocalStatusPageAuthentication{}
	return &this
}
...
func (o InlineResponse20046LocalStatusPageAuthentication) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20046LocalStatusPageAuthentication struct {
	value *InlineResponse20046LocalStatusPageAuthentication
	isSet bool
}

func (v NullableInlineResponse20046LocalStatusPageAuthentication) Get() *InlineResponse20046LocalStatusPageAuthentication {
	return v.value
}

func (v *NullableInlineResponse20046LocalStatusPageAuthentication) Set(val *InlineResponse20046LocalStatusPageAuthentication) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20046LocalStatusPageAuthentication) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20046LocalStatusPageAuthentication) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20046LocalStatusPageAuthentication(val *InlineResponse20046LocalStatusPageAuthentication) *NullableInlineResponse20046LocalStatusPageAuthentication {
	return &NullableInlineResponse20046LocalStatusPageAuthentication{value: val, isSet: true}
}

func (v NullableInlineResponse20046LocalStatusPageAuthentication) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20046LocalStatusPageAuthentication) UnmarshalJSON(src []byte) error {
	v.isSet = true
