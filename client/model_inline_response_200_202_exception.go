...
// InlineResponse200202Exception Bonjour forwarding exception
type InlineResponse200202Exception struct {
...
func NewInlineResponse200202Exception() *InlineResponse200202Exception {
	this := InlineResponse200202Exception{}
	return &this
}
...
func (o InlineResponse200202Exception) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200202Exception struct {
	value *InlineResponse200202Exception
	isSet bool
}

func (v NullableInlineResponse200202Exception) Get() *InlineResponse200202Exception {
	return v.value
}

func (v *NullableInlineResponse200202Exception) Set(val *InlineResponse200202Exception) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200202Exception) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200202Exception) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200202Exception(val *InlineResponse200202Exception) *NullableInlineResponse200202Exception {
	return &NullableInlineResponse200202Exception{value: val, isSet: true}
}

func (v NullableInlineResponse200202Exception) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200202Exception) UnmarshalJSON(src []byte) error {
	v.isSet = true
