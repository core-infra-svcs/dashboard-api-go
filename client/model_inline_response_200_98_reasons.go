...
// InlineResponse20098Reasons struct for InlineResponse20098Reasons
type InlineResponse20098Reasons struct {
...
func NewInlineResponse20098Reasons() *InlineResponse20098Reasons {
	this := InlineResponse20098Reasons{}
	return &this
}
...
func (o InlineResponse20098Reasons) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20098Reasons struct {
	value *InlineResponse20098Reasons
	isSet bool
}

func (v NullableInlineResponse20098Reasons) Get() *InlineResponse20098Reasons {
	return v.value
}

func (v *NullableInlineResponse20098Reasons) Set(val *InlineResponse20098Reasons) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20098Reasons) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20098Reasons) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20098Reasons(val *InlineResponse20098Reasons) *NullableInlineResponse20098Reasons {
	return &NullableInlineResponse20098Reasons{value: val, isSet: true}
}

func (v NullableInlineResponse20098Reasons) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20098Reasons) UnmarshalJSON(src []byte) error {
	v.isSet = true
