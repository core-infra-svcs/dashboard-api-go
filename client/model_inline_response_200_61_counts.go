...
// InlineResponse20061Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse20061Counts struct {
	...
	Noise *InlineResponse20061CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse20061Counts() *InlineResponse20061Counts {
	this := InlineResponse20061Counts{}
	return &this
}
...
func (o *InlineResponse20061Counts) GetNoise() InlineResponse20061CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse20061CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse20061CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse20061Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20061Counts struct {
	value *InlineResponse20061Counts
	isSet bool
}

func (v NullableInlineResponse20061Counts) Get() *InlineResponse20061Counts {
	return v.value
}

func (v *NullableInlineResponse20061Counts) Set(val *InlineResponse20061Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20061Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20061Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20061Counts(val *InlineResponse20061Counts) *NullableInlineResponse20061Counts {
	return &NullableInlineResponse20061Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20061Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20061Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
