...
func (r FeaturesApiGetOrganizationEarlyAccessFeaturesRequest) Execute() ([]InlineResponse200131, *http.Response, error) {
...
func (a *FeaturesApiService) GetOrganizationEarlyAccessFeaturesExecute(r FeaturesApiGetOrganizationEarlyAccessFeaturesRequest) ([]InlineResponse200131, *http.Response, error) {
	var (
