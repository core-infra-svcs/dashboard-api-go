...
func (r FeaturesApiGetOrganizationEarlyAccessFeaturesRequest) Execute() ([]InlineResponse200145, *http.Response, error) {
...
func (a *FeaturesApiService) GetOrganizationEarlyAccessFeaturesExecute(r FeaturesApiGetOrganizationEarlyAccessFeaturesRequest) ([]InlineResponse200145, *http.Response, error) {
	var (
