...
// InlineResponse200211BusyHourSchedule Busy hour mode settings
type InlineResponse200211BusyHourSchedule struct {
	...
	Automatic *InlineResponse200211BusyHourScheduleAutomatic `json:"automatic,omitempty"`
...
func NewInlineResponse200211BusyHourSchedule() *InlineResponse200211BusyHourSchedule {
	this := InlineResponse200211BusyHourSchedule{}
	return &this
}
...
func (o *InlineResponse200211BusyHourSchedule) GetAutomatic() InlineResponse200211BusyHourScheduleAutomatic {
	if o == nil || isNil(o.Automatic) {
		var ret InlineResponse200211BusyHourScheduleAutomatic
		return ret
	}
	return *o.Automatic
}
...
// SetAutomatic gets a reference to the given InlineResponse200211BusyHourScheduleAutomatic and assigns it to the Automatic field.
...
func (o InlineResponse200211BusyHourSchedule) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200211BusyHourSchedule struct {
	value *InlineResponse200211BusyHourSchedule
	isSet bool
}

func (v NullableInlineResponse200211BusyHourSchedule) Get() *InlineResponse200211BusyHourSchedule {
	return v.value
}

func (v *NullableInlineResponse200211BusyHourSchedule) Set(val *InlineResponse200211BusyHourSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200211BusyHourSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200211BusyHourSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200211BusyHourSchedule(val *InlineResponse200211BusyHourSchedule) *NullableInlineResponse200211BusyHourSchedule {
	return &NullableInlineResponse200211BusyHourSchedule{value: val, isSet: true}
}

func (v NullableInlineResponse200211BusyHourSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200211BusyHourSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
