...
// InlineResponse200193SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200193SixGhzSettings struct {
...
func NewInlineResponse200193SixGhzSettings() *InlineResponse200193SixGhzSettings {
	this := InlineResponse200193SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200193SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200193SixGhzSettings struct {
	value *InlineResponse200193SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200193SixGhzSettings) Get() *InlineResponse200193SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200193SixGhzSettings) Set(val *InlineResponse200193SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200193SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200193SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200193SixGhzSettings(val *InlineResponse200193SixGhzSettings) *NullableInlineResponse200193SixGhzSettings {
	return &NullableInlineResponse200193SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200193SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200193SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
