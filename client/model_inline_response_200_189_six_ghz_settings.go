...
// InlineResponse200189SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200189SixGhzSettings struct {
...
func NewInlineResponse200189SixGhzSettings() *InlineResponse200189SixGhzSettings {
	this := InlineResponse200189SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200189SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200189SixGhzSettings struct {
	value *InlineResponse200189SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200189SixGhzSettings) Get() *InlineResponse200189SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200189SixGhzSettings) Set(val *InlineResponse200189SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200189SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200189SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200189SixGhzSettings(val *InlineResponse200189SixGhzSettings) *NullableInlineResponse200189SixGhzSettings {
	return &NullableInlineResponse200189SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200189SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200189SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
