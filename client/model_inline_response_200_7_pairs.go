...
// InlineResponse2007Pairs struct for InlineResponse2007Pairs
type InlineResponse2007Pairs struct {
...
func (o InlineResponse2007Pairs) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2007Pairs struct {
	value *InlineResponse2007Pairs
	isSet bool
}

func (v NullableInlineResponse2007Pairs) Get() *InlineResponse2007Pairs {
	return v.value
}

func (v *NullableInlineResponse2007Pairs) Set(val *InlineResponse2007Pairs) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2007Pairs) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2007Pairs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2007Pairs(val *InlineResponse2007Pairs) *NullableInlineResponse2007Pairs {
	return &NullableInlineResponse2007Pairs{value: val, isSet: true}
}

func (v NullableInlineResponse2007Pairs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2007Pairs) UnmarshalJSON(src []byte) error {
	v.isSet = true
