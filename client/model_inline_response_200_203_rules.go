...
// InlineResponse200203Rules struct for InlineResponse200203Rules
type InlineResponse200203Rules struct {
...
func NewInlineResponse200203Rules() *InlineResponse200203Rules {
	this := InlineResponse200203Rules{}
	return &this
}
...
func (o InlineResponse200203Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200203Rules struct {
	value *InlineResponse200203Rules
	isSet bool
}

func (v NullableInlineResponse200203Rules) Get() *InlineResponse200203Rules {
	return v.value
}

func (v *NullableInlineResponse200203Rules) Set(val *InlineResponse200203Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200203Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200203Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200203Rules(val *InlineResponse200203Rules) *NullableInlineResponse200203Rules {
	return &NullableInlineResponse200203Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200203Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200203Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
