...
// InlineResponse200346Match Indicates whether or not clients are allowed to        connect to rogue SSIDs by default. (blocked by default)
type InlineResponse200346Match struct {
...
func NewInlineResponse200346Match() *InlineResponse200346Match {
	this := InlineResponse200346Match{}
	return &this
}
...
func (o InlineResponse200346Match) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200346Match struct {
	value *InlineResponse200346Match
	isSet bool
}

func (v NullableInlineResponse200346Match) Get() *InlineResponse200346Match {
	return v.value
}

func (v *NullableInlineResponse200346Match) Set(val *InlineResponse200346Match) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200346Match) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200346Match) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200346Match(val *InlineResponse200346Match) *NullableInlineResponse200346Match {
	return &NullableInlineResponse200346Match{value: val, isSet: true}
}

func (v NullableInlineResponse200346Match) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200346Match) UnmarshalJSON(src []byte) error {
	v.isSet = true
