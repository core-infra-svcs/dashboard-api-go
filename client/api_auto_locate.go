...
func (r AutoLocateApiBatchNetworkFloorPlansAutoLocateJobsRequest) Execute() (*InlineResponse20097, *http.Response, error) {
...
func (a *AutoLocateApiService) BatchNetworkFloorPlansAutoLocateJobsExecute(r AutoLocateApiBatchNetworkFloorPlansAutoLocateJobsRequest) (*InlineResponse20097, *http.Response, error) {
	var (
...
func (r AutoLocateApiGetOrganizationFloorPlansAutoLocateDevicesRequest) Execute() ([]InlineResponse200263, *http.Response, error) {
...
func (a *AutoLocateApiService) GetOrganizationFloorPlansAutoLocateDevicesExecute(r AutoLocateApiGetOrganizationFloorPlansAutoLocateDevicesRequest) ([]InlineResponse200263, *http.Response, error) {
	var (
...
func (r AutoLocateApiGetOrganizationFloorPlansAutoLocateStatusesRequest) Execute() ([]InlineResponse200264, *http.Response, error) {
...
func (a *AutoLocateApiService) GetOrganizationFloorPlansAutoLocateStatusesExecute(r AutoLocateApiGetOrganizationFloorPlansAutoLocateStatusesRequest) ([]InlineResponse200264, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AutoLocateApiPublishNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse20098, *http.Response, error) {
...
func (a *AutoLocateApiService) PublishNetworkFloorPlansAutoLocateJobExecute(r AutoLocateApiPublishNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse20098, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AutoLocateApiRecalculateNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse20099, *http.Response, error) {
...
func (a *AutoLocateApiService) RecalculateNetworkFloorPlansAutoLocateJobExecute(r AutoLocateApiRecalculateNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse20099, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
