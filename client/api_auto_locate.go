...
func (r AutoLocateApiBatchNetworkFloorPlansAutoLocateJobsRequest) Execute() (*InlineResponse200108, *http.Response, error) {
...
func (a *AutoLocateApiService) BatchNetworkFloorPlansAutoLocateJobsExecute(r AutoLocateApiBatchNetworkFloorPlansAutoLocateJobsRequest) (*InlineResponse200108, *http.Response, error) {
	var (
...
func (r AutoLocateApiGetOrganizationFloorPlansAutoLocateDevicesRequest) Execute() ([]InlineResponse200302, *http.Response, error) {
...
func (a *AutoLocateApiService) GetOrganizationFloorPlansAutoLocateDevicesExecute(r AutoLocateApiGetOrganizationFloorPlansAutoLocateDevicesRequest) ([]InlineResponse200302, *http.Response, error) {
	var (
...
func (r AutoLocateApiGetOrganizationFloorPlansAutoLocateStatusesRequest) Execute() ([]InlineResponse200303, *http.Response, error) {
...
func (a *AutoLocateApiService) GetOrganizationFloorPlansAutoLocateStatusesExecute(r AutoLocateApiGetOrganizationFloorPlansAutoLocateStatusesRequest) ([]InlineResponse200303, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AutoLocateApiPublishNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse200109, *http.Response, error) {
...
func (a *AutoLocateApiService) PublishNetworkFloorPlansAutoLocateJobExecute(r AutoLocateApiPublishNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse200109, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AutoLocateApiRecalculateNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse200110, *http.Response, error) {
...
func (a *AutoLocateApiService) RecalculateNetworkFloorPlansAutoLocateJobExecute(r AutoLocateApiRecalculateNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse200110, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
