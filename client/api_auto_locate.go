...
func (r AutoLocateApiBatchNetworkFloorPlansAutoLocateJobsRequest) Execute() (*InlineResponse200103, *http.Response, error) {
...
func (a *AutoLocateApiService) BatchNetworkFloorPlansAutoLocateJobsExecute(r AutoLocateApiBatchNetworkFloorPlansAutoLocateJobsRequest) (*InlineResponse200103, *http.Response, error) {
	var (
...
func (r AutoLocateApiGetOrganizationFloorPlansAutoLocateDevicesRequest) Execute() ([]InlineResponse200291, *http.Response, error) {
...
func (a *AutoLocateApiService) GetOrganizationFloorPlansAutoLocateDevicesExecute(r AutoLocateApiGetOrganizationFloorPlansAutoLocateDevicesRequest) ([]InlineResponse200291, *http.Response, error) {
	var (
...
func (r AutoLocateApiGetOrganizationFloorPlansAutoLocateStatusesRequest) Execute() ([]InlineResponse200292, *http.Response, error) {
...
func (a *AutoLocateApiService) GetOrganizationFloorPlansAutoLocateStatusesExecute(r AutoLocateApiGetOrganizationFloorPlansAutoLocateStatusesRequest) ([]InlineResponse200292, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AutoLocateApiPublishNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse200104, *http.Response, error) {
...
func (a *AutoLocateApiService) PublishNetworkFloorPlansAutoLocateJobExecute(r AutoLocateApiPublishNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse200104, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AutoLocateApiRecalculateNetworkFloorPlansAutoLocateJobRequest) Execute() (*InlineResponse200105, *http.Response, error) {
...
func (a *AutoLocateApiService) RecalculateNetworkFloorPlansAutoLocateJobExecute(r AutoLocateApiRecalculateNetworkFloorPlansAutoLocateJobRequest) (*InlineResponse200105, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
