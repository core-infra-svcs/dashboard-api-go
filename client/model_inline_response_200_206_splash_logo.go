...
// InlineResponse200206SplashLogo The logo used in the splash page.
type InlineResponse200206SplashLogo struct {
...
func NewInlineResponse200206SplashLogo() *InlineResponse200206SplashLogo {
	this := InlineResponse200206SplashLogo{}
	return &this
}
...
func (o InlineResponse200206SplashLogo) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200206SplashLogo struct {
	value *InlineResponse200206SplashLogo
	isSet bool
}

func (v NullableInlineResponse200206SplashLogo) Get() *InlineResponse200206SplashLogo {
	return v.value
}

func (v *NullableInlineResponse200206SplashLogo) Set(val *InlineResponse200206SplashLogo) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200206SplashLogo) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200206SplashLogo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200206SplashLogo(val *InlineResponse200206SplashLogo) *NullableInlineResponse200206SplashLogo {
	return &NullableInlineResponse200206SplashLogo{value: val, isSet: true}
}

func (v NullableInlineResponse200206SplashLogo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200206SplashLogo) UnmarshalJSON(src []byte) error {
	v.isSet = true
