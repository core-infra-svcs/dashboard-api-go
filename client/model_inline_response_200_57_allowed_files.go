...
// InlineResponse20057AllowedFiles struct for InlineResponse20057AllowedFiles
type InlineResponse20057AllowedFiles struct {
...
func NewInlineResponse20057AllowedFiles() *InlineResponse20057AllowedFiles {
	this := InlineResponse20057AllowedFiles{}
	return &this
}
...
func (o InlineResponse20057AllowedFiles) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20057AllowedFiles struct {
	value *InlineResponse20057AllowedFiles
	isSet bool
}

func (v NullableInlineResponse20057AllowedFiles) Get() *InlineResponse20057AllowedFiles {
	return v.value
}

func (v *NullableInlineResponse20057AllowedFiles) Set(val *InlineResponse20057AllowedFiles) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20057AllowedFiles) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20057AllowedFiles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20057AllowedFiles(val *InlineResponse20057AllowedFiles) *NullableInlineResponse20057AllowedFiles {
	return &NullableInlineResponse20057AllowedFiles{value: val, isSet: true}
}

func (v NullableInlineResponse20057AllowedFiles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20057AllowedFiles) UnmarshalJSON(src []byte) error {
	v.isSet = true
