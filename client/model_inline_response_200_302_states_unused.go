...
// InlineResponse200302StatesUnused Data for unused licenses
type InlineResponse200302StatesUnused struct {
	// The number of unused licenses
	Count *int32 `json:"count,omitempty"`
	SoonestActivation *InlineResponse200302StatesUnusedSoonestActivation `json:"soonestActivation,omitempty"`
}
...
func NewInlineResponse200302StatesUnused() *InlineResponse200302StatesUnused {
	this := InlineResponse200302StatesUnused{}
	return &this
}
...
func (o *InlineResponse200302StatesUnused) GetSoonestActivation() InlineResponse200302StatesUnusedSoonestActivation {
	if o == nil || isNil(o.SoonestActivation) {
		var ret InlineResponse200302StatesUnusedSoonestActivation
		return ret
	}
...
// SetSoonestActivation gets a reference to the given InlineResponse200302StatesUnusedSoonestActivation and assigns it to the SoonestActivation field.
...
func (o InlineResponse200302StatesUnused) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200302StatesUnused struct {
	value *InlineResponse200302StatesUnused
	isSet bool
}

func (v NullableInlineResponse200302StatesUnused) Get() *InlineResponse200302StatesUnused {
	return v.value
}

func (v *NullableInlineResponse200302StatesUnused) Set(val *InlineResponse200302StatesUnused) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200302StatesUnused) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200302StatesUnused) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200302StatesUnused(val *InlineResponse200302StatesUnused) *NullableInlineResponse200302StatesUnused {
	return &NullableInlineResponse200302StatesUnused{value: val, isSet: true}
}

func (v NullableInlineResponse200302StatesUnused) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200302StatesUnused) UnmarshalJSON(src []byte) error {
	v.isSet = true
