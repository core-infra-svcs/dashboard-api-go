...
// InlineResponse20055Rules struct for InlineResponse20055Rules
type InlineResponse20055Rules struct {
...
func (o InlineResponse20055Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20055Rules struct {
	value *InlineResponse20055Rules
	isSet bool
}

func (v NullableInlineResponse20055Rules) Get() *InlineResponse20055Rules {
	return v.value
}

func (v *NullableInlineResponse20055Rules) Set(val *InlineResponse20055Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20055Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20055Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20055Rules(val *InlineResponse20055Rules) *NullableInlineResponse20055Rules {
	return &NullableInlineResponse20055Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20055Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20055Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
