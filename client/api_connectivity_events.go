...
func (r ConnectivityEventsApiGetNetworkWirelessClientConnectivityEventsRequest) Execute() ([]InlineResponse200174, *http.Response, error) {
...
func (a *ConnectivityEventsApiService) GetNetworkWirelessClientConnectivityEventsExecute(r ConnectivityEventsApiGetNetworkWirelessClientConnectivityEventsRequest) ([]InlineResponse200174, *http.Response, error) {
	var (
