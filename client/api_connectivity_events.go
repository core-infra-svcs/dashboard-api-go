...
func (r ConnectivityEventsApiGetNetworkWirelessClientConnectivityEventsRequest) SortOrder(sortOrder string) ConnectivityEventsApiGetNetworkWirelessClientConnectivityEventsRequest {
...
func (r ConnectivityEventsApiGetNetworkWirelessClientConnectivityEventsRequest) Execute() ([]InlineResponse200189, *http.Response, error) {
...
func (a *ConnectivityEventsApiService) GetNetworkWirelessClientConnectivityEventsExecute(r ConnectivityEventsApiGetNetworkWirelessClientConnectivityEventsRequest) ([]InlineResponse200189, *http.Response, error) {
	var (
