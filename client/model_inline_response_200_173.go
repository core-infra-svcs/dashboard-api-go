...
type InlineResponse200173 struct {
	...
	ConnectionStats *InlineResponse200173ConnectionStats `json:"connectionStats,omitempty"`
}
...
func (o *InlineResponse200173) GetConnectionStats() InlineResponse200173ConnectionStats {
	if o == nil || isNil(o.ConnectionStats) {
		var ret InlineResponse200173ConnectionStats
		return ret
	}
...
// SetConnectionStats gets a reference to the given InlineResponse200173ConnectionStats and assigns it to the ConnectionStats field.
