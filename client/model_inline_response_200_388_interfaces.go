...
type InlineResponse200388Interfaces struct {
	...
	Readings []InlineResponse200388Readings `json:"readings,omitempty"`
}
...
func (o *InlineResponse200388Interfaces) GetReadings() []InlineResponse200388Readings {
	if o == nil || isNil(o.Readings) {
		var ret []InlineResponse200388Readings
		return ret
	}
	return o.Readings
}
...
// SetReadings gets a reference to the given []InlineResponse200388Readings and assigns it to the Readings field.
