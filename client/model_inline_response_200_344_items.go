...
type InlineResponse200344Items struct {
	...
	Intervals []InlineResponse200344Intervals `json:"intervals,omitempty"`
}
...
func (o *InlineResponse200344Items) GetIntervals() []InlineResponse200344Intervals {
	if o == nil || isNil(o.Intervals) {
		var ret []InlineResponse200344Intervals
		return ret
	}
	return o.Intervals
}
...
// SetIntervals gets a reference to the given []InlineResponse200344Intervals and assigns it to the Intervals field.
