...
// InlineResponse200255LicenseTypes struct for InlineResponse200255LicenseTypes
type InlineResponse200255LicenseTypes struct {
	// License type
...
func NewInlineResponse200255LicenseTypes() *InlineResponse200255LicenseTypes {
	this := InlineResponse200255LicenseTypes{}
	return &this
}
...
func (o InlineResponse200255LicenseTypes) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200255LicenseTypes struct {
	value *InlineResponse200255LicenseTypes
	isSet bool
}

func (v NullableInlineResponse200255LicenseTypes) Get() *InlineResponse200255LicenseTypes {
	return v.value
}

func (v *NullableInlineResponse200255LicenseTypes) Set(val *InlineResponse200255LicenseTypes) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200255LicenseTypes) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200255LicenseTypes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200255LicenseTypes(val *InlineResponse200255LicenseTypes) *NullableInlineResponse200255LicenseTypes {
	return &NullableInlineResponse200255LicenseTypes{value: val, isSet: true}
}

func (v NullableInlineResponse200255LicenseTypes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200255LicenseTypes) UnmarshalJSON(src []byte) error {
	v.isSet = true
