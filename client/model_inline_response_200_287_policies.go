...
// InlineResponse200287Policies struct for InlineResponse200287Policies
type InlineResponse200287Policies struct {
...
func NewInlineResponse200287Policies() *InlineResponse200287Policies {
	this := InlineResponse200287Policies{}
	return &this
}
...
func (o InlineResponse200287Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200287Policies struct {
	value *InlineResponse200287Policies
	isSet bool
}

func (v NullableInlineResponse200287Policies) Get() *InlineResponse200287Policies {
	return v.value
}

func (v *NullableInlineResponse200287Policies) Set(val *InlineResponse200287Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200287Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200287Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200287Policies(val *InlineResponse200287Policies) *NullableInlineResponse200287Policies {
	return &NullableInlineResponse200287Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200287Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200287Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
