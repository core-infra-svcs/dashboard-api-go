...
// InlineResponse200277Records struct for InlineResponse200277Records
type InlineResponse200277Records struct {
	Network *InlineResponse200277Network `json:"network,omitempty"`
	...
	ClientVpnConnections []InlineResponse200277ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200277Records() *InlineResponse200277Records {
	this := InlineResponse200277Records{}
	return &this
}
...
func (o *InlineResponse200277Records) GetNetwork() InlineResponse200277Network {
	if o == nil || isNil(o.Network) {
		var ret InlineResponse200277Network
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given InlineResponse200277Network and assigns it to the Network field.
...
func (o *InlineResponse200277Records) GetClientVpnConnections() []InlineResponse200277ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200277ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200277ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200277Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200277Records struct {
	value *InlineResponse200277Records
	isSet bool
}

func (v NullableInlineResponse200277Records) Get() *InlineResponse200277Records {
	return v.value
}

func (v *NullableInlineResponse200277Records) Set(val *InlineResponse200277Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200277Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200277Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200277Records(val *InlineResponse200277Records) *NullableInlineResponse200277Records {
	return &NullableInlineResponse200277Records{value: val, isSet: true}
}

func (v NullableInlineResponse200277Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200277Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
