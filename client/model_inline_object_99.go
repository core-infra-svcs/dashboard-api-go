...
func (o *InlineObject99) GetUpgradeWindow() NetworksNetworkIdFirmwareUpgradesUpgradeWindow {
...
func (o *InlineObject99) GetUpgradeWindowOk() (*NetworksNetworkIdFirmwareUpgradesUpgradeWindow, bool) {
	if o == nil || isNil(o.UpgradeWindow) {
    return nil, false
	}
...
func (o *InlineObject99) HasUpgradeWindow() bool {
	if o != nil && !isNil(o.UpgradeWindow) {
		return true
	}
...
func (o *InlineObject99) SetUpgradeWindow(v NetworksNetworkIdFirmwareUpgradesUpgradeWindow) {
	o.UpgradeWindow = &v
}

// GetTimezone returns the Timezone field value if set, zero value otherwise.
func (o *InlineObject99) GetTimezone() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject99) GetTimezoneOk() (*string, bool) {
	if o == nil || isNil(o.Timezone) {
    return nil, false
	}
...
func (o *InlineObject99) HasTimezone() bool {
	if o != nil && !isNil(o.Timezone) {
		return true
	}
...
func (o *InlineObject99) SetTimezone(v string) {
	o.Timezone = &v
}

// GetProducts returns the Products field value if set, zero value otherwise.
func (o *InlineObject99) GetProducts() NetworksNetworkIdFirmwareUpgradesProducts {
...
// and a boolean to check if the value has been set.
func (o *InlineObject99) GetProductsOk() (*NetworksNetworkIdFirmwareUpgradesProducts, bool) {
	if o == nil || isNil(o.Products) {
    return nil, false
	}
...
func (o *InlineObject99) HasProducts() bool {
	if o != nil && !isNil(o.Products) {
		return true
	}
...
func (o *InlineObject99) SetProducts(v NetworksNetworkIdFirmwareUpgradesProducts) {
	o.Products = &v
}
