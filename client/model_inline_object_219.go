...
func (o *InlineObject219) GetAdminSettings() OrganizationsOrganizationIdBrandingPoliciesAdminSettings {
...
// and a boolean to check if the value has been set.
func (o *InlineObject219) GetAdminSettingsOk() (*OrganizationsOrganizationIdBrandingPoliciesAdminSettings, bool) {
	if o == nil || isNil(o.AdminSettings) {
    return nil, false
	}
...
func (o *InlineObject219) HasAdminSettings() bool {
	if o != nil && !isNil(o.AdminSettings) {
		return true
	}
...
func (o *InlineObject219) SetAdminSettings(v OrganizationsOrganizationIdBrandingPoliciesAdminSettings) {
	o.AdminSettings = &v
}

// GetHelpSettings returns the HelpSettings field value if set, zero value otherwise.
func (o *InlineObject219) GetHelpSettings() OrganizationsOrganizationIdBrandingPoliciesHelpSettings {
...
// and a boolean to check if the value has been set.
func (o *InlineObject219) GetHelpSettingsOk() (*OrganizationsOrganizationIdBrandingPoliciesHelpSettings, bool) {
	if o == nil || isNil(o.HelpSettings) {
    return nil, false
	}
...
func (o *InlineObject219) HasHelpSettings() bool {
	if o != nil && !isNil(o.HelpSettings) {
		return true
	}
...
func (o *InlineObject219) SetHelpSettings(v OrganizationsOrganizationIdBrandingPoliciesHelpSettings) {
	o.HelpSettings = &v
}

// GetCustomLogo returns the CustomLogo field value if set, zero value otherwise.
func (o *InlineObject219) GetCustomLogo() OrganizationsOrganizationIdBrandingPoliciesCustomLogo1 {
...
// and a boolean to check if the value has been set.
func (o *InlineObject219) GetCustomLogoOk() (*OrganizationsOrganizationIdBrandingPoliciesCustomLogo1, bool) {
	if o == nil || isNil(o.CustomLogo) {
    return nil, false
	}
...
func (o *InlineObject219) HasCustomLogo() bool {
	if o != nil && !isNil(o.CustomLogo) {
		return true
	}
...
func (o *InlineObject219) SetCustomLogo(v OrganizationsOrganizationIdBrandingPoliciesCustomLogo1) {
	o.CustomLogo = &v
}
