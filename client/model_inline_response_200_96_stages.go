...
// InlineResponse20096Stages struct for InlineResponse20096Stages
type InlineResponse20096Stages struct {
	Group *InlineResponse20096Group `json:"group,omitempty"`
	Milestones *InlineResponse20096Milestones `json:"milestones,omitempty"`
...
func NewInlineResponse20096Stages() *InlineResponse20096Stages {
	this := InlineResponse20096Stages{}
	return &this
}
...
func (o *InlineResponse20096Stages) GetGroup() InlineResponse20096Group {
	if o == nil || isNil(o.Group) {
		var ret InlineResponse20096Group
		return ret
	}
	return *o.Group
}
...
// SetGroup gets a reference to the given InlineResponse20096Group and assigns it to the Group field.
...
func (o *InlineResponse20096Stages) GetMilestones() InlineResponse20096Milestones {
	if o == nil || isNil(o.Milestones) {
		var ret InlineResponse20096Milestones
		return ret
	}
	return *o.Milestones
}
...
// SetMilestones gets a reference to the given InlineResponse20096Milestones and assigns it to the Milestones field.
...
func (o InlineResponse20096Stages) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20096Stages struct {
	value *InlineResponse20096Stages
	isSet bool
}

func (v NullableInlineResponse20096Stages) Get() *InlineResponse20096Stages {
	return v.value
}

func (v *NullableInlineResponse20096Stages) Set(val *InlineResponse20096Stages) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20096Stages) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20096Stages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20096Stages(val *InlineResponse20096Stages) *NullableInlineResponse20096Stages {
	return &NullableInlineResponse20096Stages{value: val, isSet: true}
}

func (v NullableInlineResponse20096Stages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20096Stages) UnmarshalJSON(src []byte) error {
	v.isSet = true
