...
// InlineResponse200369Usage The usage on the interfaces of the wireless LAN controller
type InlineResponse200369Usage struct {
...
func NewInlineResponse200369Usage() *InlineResponse200369Usage {
	this := InlineResponse200369Usage{}
	return &this
}
...
func (o InlineResponse200369Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200369Usage struct {
	value *InlineResponse200369Usage
	isSet bool
}

func (v NullableInlineResponse200369Usage) Get() *InlineResponse200369Usage {
	return v.value
}

func (v *NullableInlineResponse200369Usage) Set(val *InlineResponse200369Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200369Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200369Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200369Usage(val *InlineResponse200369Usage) *NullableInlineResponse200369Usage {
	return &NullableInlineResponse200369Usage{value: val, isSet: true}
}

func (v NullableInlineResponse200369Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200369Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
