...
// InlineResponse200137Rules struct for InlineResponse200137Rules
type InlineResponse200137Rules struct {
...
func NewInlineResponse200137Rules() *InlineResponse200137Rules {
	this := InlineResponse200137Rules{}
	return &this
}
...
func (o InlineResponse200137Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200137Rules struct {
	value *InlineResponse200137Rules
	isSet bool
}

func (v NullableInlineResponse200137Rules) Get() *InlineResponse200137Rules {
	return v.value
}

func (v *NullableInlineResponse200137Rules) Set(val *InlineResponse200137Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200137Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200137Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200137Rules(val *InlineResponse200137Rules) *NullableInlineResponse200137Rules {
	return &NullableInlineResponse200137Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200137Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200137Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
