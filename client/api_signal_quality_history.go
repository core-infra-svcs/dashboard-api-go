...
func (r SignalQualityHistoryApiGetNetworkWirelessSignalQualityHistoryRequest) Execute() ([]InlineResponse200186, *http.Response, error) {
...
func (a *SignalQualityHistoryApiService) GetNetworkWirelessSignalQualityHistoryExecute(r SignalQualityHistoryApiGetNetworkWirelessSignalQualityHistoryRequest) ([]InlineResponse200186, *http.Response, error) {
	var (
