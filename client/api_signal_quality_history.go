...
func (r SignalQualityHistoryApiGetNetworkWirelessSignalQualityHistoryRequest) Execute() ([]InlineResponse200181, *http.Response, error) {
...
func (a *SignalQualityHistoryApiService) GetNetworkWirelessSignalQualityHistoryExecute(r SignalQualityHistoryApiGetNetworkWirelessSignalQualityHistoryRequest) ([]InlineResponse200181, *http.Response, error) {
	var (
