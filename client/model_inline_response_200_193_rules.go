...
// InlineResponse200193Rules struct for InlineResponse200193Rules
type InlineResponse200193Rules struct {
...
func NewInlineResponse200193Rules() *InlineResponse200193Rules {
	this := InlineResponse200193Rules{}
	return &this
}
...
func (o InlineResponse200193Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200193Rules struct {
	value *InlineResponse200193Rules
	isSet bool
}

func (v NullableInlineResponse200193Rules) Get() *InlineResponse200193Rules {
	return v.value
}

func (v *NullableInlineResponse200193Rules) Set(val *InlineResponse200193Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200193Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200193Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200193Rules(val *InlineResponse200193Rules) *NullableInlineResponse200193Rules {
	return &NullableInlineResponse200193Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200193Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200193Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
