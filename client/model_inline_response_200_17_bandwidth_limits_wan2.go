...
// InlineResponse20017BandwidthLimitsWan2 uplink wan2 configured limits [optional]
type InlineResponse20017BandwidthLimitsWan2 struct {
...
func NewInlineResponse20017BandwidthLimitsWan2() *InlineResponse20017BandwidthLimitsWan2 {
	this := InlineResponse20017BandwidthLimitsWan2{}
	return &this
}
...
func (o InlineResponse20017BandwidthLimitsWan2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20017BandwidthLimitsWan2 struct {
	value *InlineResponse20017BandwidthLimitsWan2
	isSet bool
}

func (v NullableInlineResponse20017BandwidthLimitsWan2) Get() *InlineResponse20017BandwidthLimitsWan2 {
	return v.value
}

func (v *NullableInlineResponse20017BandwidthLimitsWan2) Set(val *InlineResponse20017BandwidthLimitsWan2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20017BandwidthLimitsWan2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20017BandwidthLimitsWan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20017BandwidthLimitsWan2(val *InlineResponse20017BandwidthLimitsWan2) *NullableInlineResponse20017BandwidthLimitsWan2 {
	return &NullableInlineResponse20017BandwidthLimitsWan2{value: val, isSet: true}
}

func (v NullableInlineResponse20017BandwidthLimitsWan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20017BandwidthLimitsWan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
