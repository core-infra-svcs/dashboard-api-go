...
type InlineResponse20061 struct {
	...
	ResultingNetworks []InlineResponse20010 `json:"resultingNetworks,omitempty"`
}
...
// SetResultingNetworks gets a reference to the given []InlineResponse20010 and assigns it to the ResultingNetworks field.
