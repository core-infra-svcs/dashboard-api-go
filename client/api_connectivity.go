...
func (r ConnectivityApiGetNetworkSmDeviceConnectivityRequest) Execute() ([]InlineResponse200126, *http.Response, error) {
...
func (a *ConnectivityApiService) GetNetworkSmDeviceConnectivityExecute(r ConnectivityApiGetNetworkSmDeviceConnectivityRequest) ([]InlineResponse200126, *http.Response, error) {
	var (
