...
func (r ConnectivityApiGetNetworkSmDeviceConnectivityRequest) Execute() ([]InlineResponse20061, *http.Response, error) {
...
func (a *ConnectivityApiService) GetNetworkSmDeviceConnectivityExecute(r ConnectivityApiGetNetworkSmDeviceConnectivityRequest) ([]InlineResponse20061, *http.Response, error) {
	var (
