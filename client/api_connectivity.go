...
func (r ConnectivityApiGetNetworkSmDeviceConnectivityRequest) Execute() ([]InlineResponse200131, *http.Response, error) {
...
func (a *ConnectivityApiService) GetNetworkSmDeviceConnectivityExecute(r ConnectivityApiGetNetworkSmDeviceConnectivityRequest) ([]InlineResponse200131, *http.Response, error) {
	var (
