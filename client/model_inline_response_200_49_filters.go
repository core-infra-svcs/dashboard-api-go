...
// InlineResponse20049Filters A hash of specific configuration data for the alert. Only filters specific to the alert will be updated.
type InlineResponse20049Filters struct {
	// Conditions
	Conditions []InlineResponse20049FiltersConditions `json:"conditions,omitempty"`
	// Failure Type
...
func NewInlineResponse20049Filters() *InlineResponse20049Filters {
	this := InlineResponse20049Filters{}
	return &this
}
...
func (o *InlineResponse20049Filters) GetConditions() []InlineResponse20049FiltersConditions {
	if o == nil || isNil(o.Conditions) {
		var ret []InlineResponse20049FiltersConditions
		return ret
	}
	return o.Conditions
}
...
// SetConditions gets a reference to the given []InlineResponse20049FiltersConditions and assigns it to the Conditions field.
...
func (o InlineResponse20049Filters) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20049Filters struct {
	value *InlineResponse20049Filters
	isSet bool
}

func (v NullableInlineResponse20049Filters) Get() *InlineResponse20049Filters {
	return v.value
}

func (v *NullableInlineResponse20049Filters) Set(val *InlineResponse20049Filters) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20049Filters) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20049Filters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20049Filters(val *InlineResponse20049Filters) *NullableInlineResponse20049Filters {
	return &NullableInlineResponse20049Filters{value: val, isSet: true}
}

func (v NullableInlineResponse20049Filters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20049Filters) UnmarshalJSON(src []byte) error {
	v.isSet = true
