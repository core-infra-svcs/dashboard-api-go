...
// InlineResponse200307MetaCountsItems The count metadata.
type InlineResponse200307MetaCountsItems struct {
...
func NewInlineResponse200307MetaCountsItems() *InlineResponse200307MetaCountsItems {
	this := InlineResponse200307MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200307MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200307MetaCountsItems struct {
	value *InlineResponse200307MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200307MetaCountsItems) Get() *InlineResponse200307MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200307MetaCountsItems) Set(val *InlineResponse200307MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200307MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200307MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200307MetaCountsItems(val *InlineResponse200307MetaCountsItems) *NullableInlineResponse200307MetaCountsItems {
	return &NullableInlineResponse200307MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200307MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200307MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
