...
type InlineResponse200286 struct {
	...
	LimitScopeToNetworks []InlineResponse200286LimitScopeToNetworks `json:"limitScopeToNetworks,omitempty"`
	OptOutEligibility *InlineResponse200286OptOutEligibility `json:"optOutEligibility,omitempty"`
...
func (o *InlineResponse200286) GetLimitScopeToNetworks() []InlineResponse200286LimitScopeToNetworks {
	if o == nil || isNil(o.LimitScopeToNetworks) {
		var ret []InlineResponse200286LimitScopeToNetworks
		return ret
	}
...
// SetLimitScopeToNetworks gets a reference to the given []InlineResponse200286LimitScopeToNetworks and assigns it to the LimitScopeToNetworks field.
...
func (o *InlineResponse200286) GetOptOutEligibility() InlineResponse200286OptOutEligibility {
	if o == nil || isNil(o.OptOutEligibility) {
		var ret InlineResponse200286OptOutEligibility
		return ret
	}
...
// SetOptOutEligibility gets a reference to the given InlineResponse200286OptOutEligibility and assigns it to the OptOutEligibility field.
