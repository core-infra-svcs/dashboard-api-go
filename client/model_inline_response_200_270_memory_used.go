...
// InlineResponse200270MemoryUsed Information regarding memory usage on the device over the interval
type InlineResponse200270MemoryUsed struct {
	...
	Percentages *InlineResponse200270MemoryUsedPercentages `json:"percentages,omitempty"`
}
...
func NewInlineResponse200270MemoryUsed() *InlineResponse200270MemoryUsed {
	this := InlineResponse200270MemoryUsed{}
	return &this
}
...
func (o *InlineResponse200270MemoryUsed) GetPercentages() InlineResponse200270MemoryUsedPercentages {
	if o == nil || isNil(o.Percentages) {
		var ret InlineResponse200270MemoryUsedPercentages
		return ret
	}
...
// SetPercentages gets a reference to the given InlineResponse200270MemoryUsedPercentages and assigns it to the Percentages field.
func (o *InlineResponse200270MemoryUsed) SetPercentages(v InlineResponse200270MemoryUsedPercentages) {
	o.Percentages = &v
}

func (o InlineResponse200270MemoryUsed) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200270MemoryUsed struct {
	value *InlineResponse200270MemoryUsed
	isSet bool
}

func (v NullableInlineResponse200270MemoryUsed) Get() *InlineResponse200270MemoryUsed {
	return v.value
}

func (v *NullableInlineResponse200270MemoryUsed) Set(val *InlineResponse200270MemoryUsed) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200270MemoryUsed) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200270MemoryUsed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200270MemoryUsed(val *InlineResponse200270MemoryUsed) *NullableInlineResponse200270MemoryUsed {
	return &NullableInlineResponse200270MemoryUsed{value: val, isSet: true}
}

func (v NullableInlineResponse200270MemoryUsed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200270MemoryUsed) UnmarshalJSON(src []byte) error {
	v.isSet = true
