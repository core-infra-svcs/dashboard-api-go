...
// InlineResponse200198Rules struct for InlineResponse200198Rules
type InlineResponse200198Rules struct {
...
func NewInlineResponse200198Rules() *InlineResponse200198Rules {
	this := InlineResponse200198Rules{}
	return &this
}
...
func (o InlineResponse200198Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200198Rules struct {
	value *InlineResponse200198Rules
	isSet bool
}

func (v NullableInlineResponse200198Rules) Get() *InlineResponse200198Rules {
	return v.value
}

func (v *NullableInlineResponse200198Rules) Set(val *InlineResponse200198Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200198Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200198Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200198Rules(val *InlineResponse200198Rules) *NullableInlineResponse200198Rules {
	return &NullableInlineResponse200198Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200198Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200198Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
