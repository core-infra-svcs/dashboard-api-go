...
func (r SamlApiCreateOrganizationSamlIdpRequest) CreateOrganizationSamlIdp(createOrganizationSamlIdp InlineObject263) SamlApiCreateOrganizationSamlIdpRequest {
	r.createOrganizationSamlIdp = &createOrganizationSamlIdp
	return r
}

func (r SamlApiCreateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200281, *http.Response, error) {
...
func (a *SamlApiService) CreateOrganizationSamlIdpExecute(r SamlApiCreateOrganizationSamlIdpRequest) ([]InlineResponse200281, *http.Response, error) {
	var (
...
func (r SamlApiGetOrganizationSamlRequest) Execute() (*InlineResponse200280, *http.Response, error) {
...
func (a *SamlApiService) GetOrganizationSamlExecute(r SamlApiGetOrganizationSamlRequest) (*InlineResponse200280, *http.Response, error) {
	var (
...
func (r SamlApiGetOrganizationSamlIdpRequest) Execute() (*InlineResponse200281, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200281
func (a *SamlApiService) GetOrganizationSamlIdpExecute(r SamlApiGetOrganizationSamlIdpRequest) (*InlineResponse200281, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SamlApiGetOrganizationSamlIdpsRequest) Execute() ([]InlineResponse200281, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200281
func (a *SamlApiService) GetOrganizationSamlIdpsExecute(r SamlApiGetOrganizationSamlIdpsRequest) ([]InlineResponse200281, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SamlApiUpdateOrganizationSamlRequest) UpdateOrganizationSaml(updateOrganizationSaml InlineObject262) SamlApiUpdateOrganizationSamlRequest {
	r.updateOrganizationSaml = &updateOrganizationSaml
	return r
}

func (r SamlApiUpdateOrganizationSamlRequest) Execute() (*InlineResponse200280, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200280
func (a *SamlApiService) UpdateOrganizationSamlExecute(r SamlApiUpdateOrganizationSamlRequest) (*InlineResponse200280, *http.Response, error) {
	var (
...
func (r SamlApiUpdateOrganizationSamlIdpRequest) UpdateOrganizationSamlIdp(updateOrganizationSamlIdp InlineObject264) SamlApiUpdateOrganizationSamlIdpRequest {
	r.updateOrganizationSamlIdp = &updateOrganizationSamlIdp
	return r
}

func (r SamlApiUpdateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200281, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200281
func (a *SamlApiService) UpdateOrganizationSamlIdpExecute(r SamlApiUpdateOrganizationSamlIdpRequest) ([]InlineResponse200281, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
