...
func (r SamlApiCreateOrganizationSamlIdpRequest) CreateOrganizationSamlIdp(createOrganizationSamlIdp InlineObject275) SamlApiCreateOrganizationSamlIdpRequest {
	r.createOrganizationSamlIdp = &createOrganizationSamlIdp
	return r
}

func (r SamlApiCreateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200296, *http.Response, error) {
...
func (a *SamlApiService) CreateOrganizationSamlIdpExecute(r SamlApiCreateOrganizationSamlIdpRequest) ([]InlineResponse200296, *http.Response, error) {
	var (
...
func (r SamlApiGetOrganizationSamlRequest) Execute() (*InlineResponse200295, *http.Response, error) {
...
func (a *SamlApiService) GetOrganizationSamlExecute(r SamlApiGetOrganizationSamlRequest) (*InlineResponse200295, *http.Response, error) {
	var (
...
func (r SamlApiGetOrganizationSamlIdpRequest) Execute() (*InlineResponse200296, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200296
func (a *SamlApiService) GetOrganizationSamlIdpExecute(r SamlApiGetOrganizationSamlIdpRequest) (*InlineResponse200296, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SamlApiGetOrganizationSamlIdpsRequest) Execute() ([]InlineResponse200296, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200296
func (a *SamlApiService) GetOrganizationSamlIdpsExecute(r SamlApiGetOrganizationSamlIdpsRequest) ([]InlineResponse200296, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SamlApiUpdateOrganizationSamlRequest) UpdateOrganizationSaml(updateOrganizationSaml InlineObject274) SamlApiUpdateOrganizationSamlRequest {
	r.updateOrganizationSaml = &updateOrganizationSaml
	return r
}

func (r SamlApiUpdateOrganizationSamlRequest) Execute() (*InlineResponse200295, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200295
func (a *SamlApiService) UpdateOrganizationSamlExecute(r SamlApiUpdateOrganizationSamlRequest) (*InlineResponse200295, *http.Response, error) {
	var (
...
func (r SamlApiUpdateOrganizationSamlIdpRequest) UpdateOrganizationSamlIdp(updateOrganizationSamlIdp InlineObject276) SamlApiUpdateOrganizationSamlIdpRequest {
	r.updateOrganizationSamlIdp = &updateOrganizationSamlIdp
	return r
}

func (r SamlApiUpdateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200296, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200296
func (a *SamlApiService) UpdateOrganizationSamlIdpExecute(r SamlApiUpdateOrganizationSamlIdpRequest) ([]InlineResponse200296, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
