...
type InlineObject160 struct {
	...
	TwoFourGhzSettings *InlineResponse200102TwoFourGhzSettings `json:"twoFourGhzSettings,omitempty"`
	FiveGhzSettings *InlineResponse200102FiveGhzSettings `json:"fiveGhzSettings,omitempty"`
	SixGhzSettings *NetworksNetworkIdWirelessRfProfilesSixGhzSettings `json:"sixGhzSettings,omitempty"`
	Transmission *InlineResponse200102Transmission `json:"transmission,omitempty"`
...
func (o *InlineObject160) GetTwoFourGhzSettings() InlineResponse200102TwoFourGhzSettings {
	if o == nil || isNil(o.TwoFourGhzSettings) {
		var ret InlineResponse200102TwoFourGhzSettings
		return ret
	}
...
// SetTwoFourGhzSettings gets a reference to the given InlineResponse200102TwoFourGhzSettings and assigns it to the TwoFourGhzSettings field.
...
func (o *InlineObject160) GetFiveGhzSettings() InlineResponse200102FiveGhzSettings {
	if o == nil || isNil(o.FiveGhzSettings) {
		var ret InlineResponse200102FiveGhzSettings
		return ret
	}
...
// SetFiveGhzSettings gets a reference to the given InlineResponse200102FiveGhzSettings and assigns it to the FiveGhzSettings field.
...
func (o *InlineObject160) GetTransmission() InlineResponse200102Transmission {
	if o == nil || isNil(o.Transmission) {
		var ret InlineResponse200102Transmission
		return ret
	}
...
// SetTransmission gets a reference to the given InlineResponse200102Transmission and assigns it to the Transmission field.
