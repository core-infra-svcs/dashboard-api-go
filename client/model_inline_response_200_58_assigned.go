...
// InlineResponse20058Assigned struct for InlineResponse20058Assigned
type InlineResponse20058Assigned struct {
	...
	TwoFourGhzSettings *InlineResponse20058TwoFourGhzSettings `json:"twoFourGhzSettings,omitempty"`
	FiveGhzSettings *InlineResponse20058FiveGhzSettings `json:"fiveGhzSettings,omitempty"`
	PerSsidSettings *InlineResponse20058PerSsidSettings `json:"perSsidSettings,omitempty"`
}
...
func NewInlineResponse20058Assigned() *InlineResponse20058Assigned {
	this := InlineResponse20058Assigned{}
	return &this
}
...
func (o *InlineResponse20058Assigned) GetTwoFourGhzSettings() InlineResponse20058TwoFourGhzSettings {
	if o == nil || isNil(o.TwoFourGhzSettings) {
		var ret InlineResponse20058TwoFourGhzSettings
		return ret
	}
...
// SetTwoFourGhzSettings gets a reference to the given InlineResponse20058TwoFourGhzSettings and assigns it to the TwoFourGhzSettings field.
...
func (o *InlineResponse20058Assigned) GetFiveGhzSettings() InlineResponse20058FiveGhzSettings {
	if o == nil || isNil(o.FiveGhzSettings) {
		var ret InlineResponse20058FiveGhzSettings
		return ret
	}
...
// SetFiveGhzSettings gets a reference to the given InlineResponse20058FiveGhzSettings and assigns it to the FiveGhzSettings field.
...
func (o *InlineResponse20058Assigned) GetPerSsidSettings() InlineResponse20058PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse20058PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse20058PerSsidSettings and assigns it to the PerSsidSettings field.
func (o *InlineResponse20058Assigned) SetPerSsidSettings(v InlineResponse20058PerSsidSettings) {
	o.PerSsidSettings = &v
}

func (o InlineResponse20058Assigned) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20058Assigned struct {
	value *InlineResponse20058Assigned
	isSet bool
}

func (v NullableInlineResponse20058Assigned) Get() *InlineResponse20058Assigned {
	return v.value
}

func (v *NullableInlineResponse20058Assigned) Set(val *InlineResponse20058Assigned) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20058Assigned) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20058Assigned) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20058Assigned(val *InlineResponse20058Assigned) *NullableInlineResponse20058Assigned {
	return &NullableInlineResponse20058Assigned{value: val, isSet: true}
}

func (v NullableInlineResponse20058Assigned) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20058Assigned) UnmarshalJSON(src []byte) error {
	v.isSet = true
