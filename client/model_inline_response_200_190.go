...
type InlineResponse200190 struct {
	...
	ApBandSettings *InlineResponse200190ApBandSettings `json:"apBandSettings,omitempty"`
	...
	SixGhzSettings *InlineResponse200190SixGhzSettings `json:"sixGhzSettings,omitempty"`
	Transmission *InlineResponse200190Transmission `json:"transmission,omitempty"`
	PerSsidSettings *InlineResponse200190PerSsidSettings `json:"perSsidSettings,omitempty"`
...
func (o *InlineResponse200190) GetApBandSettings() InlineResponse200190ApBandSettings {
	if o == nil || isNil(o.ApBandSettings) {
		var ret InlineResponse200190ApBandSettings
		return ret
	}
...
// SetApBandSettings gets a reference to the given InlineResponse200190ApBandSettings and assigns it to the ApBandSettings field.
...
func (o *InlineResponse200190) GetSixGhzSettings() InlineResponse200190SixGhzSettings {
	if o == nil || isNil(o.SixGhzSettings) {
		var ret InlineResponse200190SixGhzSettings
		return ret
	}
...
// SetSixGhzSettings gets a reference to the given InlineResponse200190SixGhzSettings and assigns it to the SixGhzSettings field.
...
func (o *InlineResponse200190) GetPerSsidSettings() InlineResponse200190PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse200190PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse200190PerSsidSettings and assigns it to the PerSsidSettings field.
