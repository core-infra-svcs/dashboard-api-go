...
// InlineResponse200329Changes struct for InlineResponse200329Changes
type InlineResponse200329Changes struct {
...
func NewInlineResponse200329Changes() *InlineResponse200329Changes {
	this := InlineResponse200329Changes{}
	return &this
}
...
func (o InlineResponse200329Changes) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200329Changes struct {
	value *InlineResponse200329Changes
	isSet bool
}

func (v NullableInlineResponse200329Changes) Get() *InlineResponse200329Changes {
	return v.value
}

func (v *NullableInlineResponse200329Changes) Set(val *InlineResponse200329Changes) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200329Changes) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200329Changes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200329Changes(val *InlineResponse200329Changes) *NullableInlineResponse200329Changes {
	return &NullableInlineResponse200329Changes{value: val, isSet: true}
}

func (v NullableInlineResponse200329Changes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200329Changes) UnmarshalJSON(src []byte) error {
	v.isSet = true
