...
func (r FloorPlansApiGetOrganizationFloorPlansAutoLocateDevicesRequest) Execute() ([]InlineResponse200263, *http.Response, error) {
...
func (a *FloorPlansApiService) GetOrganizationFloorPlansAutoLocateDevicesExecute(r FloorPlansApiGetOrganizationFloorPlansAutoLocateDevicesRequest) ([]InlineResponse200263, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r FloorPlansApiGetOrganizationFloorPlansAutoLocateStatusesRequest) Execute() ([]InlineResponse200264, *http.Response, error) {
...
func (a *FloorPlansApiService) GetOrganizationFloorPlansAutoLocateStatusesExecute(r FloorPlansApiGetOrganizationFloorPlansAutoLocateStatusesRequest) ([]InlineResponse200264, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
