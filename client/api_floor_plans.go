...
func (r FloorPlansApiCreateNetworkFloorPlanRequest) CreateNetworkFloorPlan(createNetworkFloorPlan InlineObject99) FloorPlansApiCreateNetworkFloorPlanRequest {
	r.createNetworkFloorPlan = &createNetworkFloorPlan
	return r
}

func (r FloorPlansApiCreateNetworkFloorPlanRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
func (a *FloorPlansApiService) CreateNetworkFloorPlanExecute(r FloorPlansApiCreateNetworkFloorPlanRequest) (*InlineResponse20093, *http.Response, error) {
	var (
...
func (r FloorPlansApiDeleteNetworkFloorPlanRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20093
func (a *FloorPlansApiService) DeleteNetworkFloorPlanExecute(r FloorPlansApiDeleteNetworkFloorPlanRequest) (*InlineResponse20093, *http.Response, error) {
	var (
...
func (r FloorPlansApiGetNetworkFloorPlanRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20093
func (a *FloorPlansApiService) GetNetworkFloorPlanExecute(r FloorPlansApiGetNetworkFloorPlanRequest) (*InlineResponse20093, *http.Response, error) {
	var (
...
func (r FloorPlansApiGetNetworkFloorPlansRequest) Execute() ([]InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20093
func (a *FloorPlansApiService) GetNetworkFloorPlansExecute(r FloorPlansApiGetNetworkFloorPlansRequest) ([]InlineResponse20093, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r FloorPlansApiUpdateNetworkFloorPlanRequest) UpdateNetworkFloorPlan(updateNetworkFloorPlan InlineObject100) FloorPlansApiUpdateNetworkFloorPlanRequest {
	r.updateNetworkFloorPlan = &updateNetworkFloorPlan
	return r
}

func (r FloorPlansApiUpdateNetworkFloorPlanRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20093
func (a *FloorPlansApiService) UpdateNetworkFloorPlanExecute(r FloorPlansApiUpdateNetworkFloorPlanRequest) (*InlineResponse20093, *http.Response, error) {
	var (
