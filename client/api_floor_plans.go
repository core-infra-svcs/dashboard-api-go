...
func (r FloorPlansApiCreateNetworkFloorPlanRequest) CreateNetworkFloorPlan(createNetworkFloorPlan InlineObject93) FloorPlansApiCreateNetworkFloorPlanRequest {
	r.createNetworkFloorPlan = &createNetworkFloorPlan
	return r
}

func (r FloorPlansApiCreateNetworkFloorPlanRequest) Execute() (*InlineResponse20044, *http.Response, error) {
...
func (a *FloorPlansApiService) CreateNetworkFloorPlanExecute(r FloorPlansApiCreateNetworkFloorPlanRequest) (*InlineResponse20044, *http.Response, error) {
	var (
...
func (r FloorPlansApiDeleteNetworkFloorPlanRequest) Execute() (*InlineResponse20044, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20044
func (a *FloorPlansApiService) DeleteNetworkFloorPlanExecute(r FloorPlansApiDeleteNetworkFloorPlanRequest) (*InlineResponse20044, *http.Response, error) {
	var (
...
func (r FloorPlansApiGetNetworkFloorPlanRequest) Execute() (*InlineResponse20044, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20044
func (a *FloorPlansApiService) GetNetworkFloorPlanExecute(r FloorPlansApiGetNetworkFloorPlanRequest) (*InlineResponse20044, *http.Response, error) {
	var (
...
func (r FloorPlansApiGetNetworkFloorPlansRequest) Execute() ([]InlineResponse20044, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20044
func (a *FloorPlansApiService) GetNetworkFloorPlansExecute(r FloorPlansApiGetNetworkFloorPlansRequest) ([]InlineResponse20044, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r FloorPlansApiUpdateNetworkFloorPlanRequest) UpdateNetworkFloorPlan(updateNetworkFloorPlan InlineObject94) FloorPlansApiUpdateNetworkFloorPlanRequest {
	r.updateNetworkFloorPlan = &updateNetworkFloorPlan
	return r
}

func (r FloorPlansApiUpdateNetworkFloorPlanRequest) Execute() (*InlineResponse20044, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20044
func (a *FloorPlansApiService) UpdateNetworkFloorPlanExecute(r FloorPlansApiUpdateNetworkFloorPlanRequest) (*InlineResponse20044, *http.Response, error) {
	var (
