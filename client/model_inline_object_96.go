...
type InlineObject96 struct {
	...
	SecurePort *NetworksNetworkIdSettingsSecurePort `json:"securePort,omitempty"`
...
func (o *InlineObject96) GetSecurePort() NetworksNetworkIdSettingsSecurePort {
	if o == nil || isNil(o.SecurePort) {
		var ret NetworksNetworkIdSettingsSecurePort
		return ret
	}
	return *o.SecurePort
}
...
// SetSecurePort gets a reference to the given NetworksNetworkIdSettingsSecurePort and assigns it to the SecurePort field.
