...
// InlineResponse200130Usage Usage information of all clients across organization
type InlineResponse200130Usage struct {
	Overall *InlineResponse200130UsageOverall `json:"overall,omitempty"`
...
func NewInlineResponse200130Usage() *InlineResponse200130Usage {
	this := InlineResponse200130Usage{}
	return &this
}
...
func (o *InlineResponse200130Usage) GetOverall() InlineResponse200130UsageOverall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200130UsageOverall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200130UsageOverall and assigns it to the Overall field.
...
func (o InlineResponse200130Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200130Usage struct {
	value *InlineResponse200130Usage
	isSet bool
}

func (v NullableInlineResponse200130Usage) Get() *InlineResponse200130Usage {
	return v.value
}

func (v *NullableInlineResponse200130Usage) Set(val *InlineResponse200130Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200130Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200130Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200130Usage(val *InlineResponse200130Usage) *NullableInlineResponse200130Usage {
	return &NullableInlineResponse200130Usage{value: val, isSet: true}
}

func (v NullableInlineResponse200130Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200130Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
