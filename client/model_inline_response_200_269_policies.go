...
// InlineResponse200269Policies struct for InlineResponse200269Policies
type InlineResponse200269Policies struct {
...
func NewInlineResponse200269Policies() *InlineResponse200269Policies {
	this := InlineResponse200269Policies{}
	return &this
}
...
func (o InlineResponse200269Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200269Policies struct {
	value *InlineResponse200269Policies
	isSet bool
}

func (v NullableInlineResponse200269Policies) Get() *InlineResponse200269Policies {
	return v.value
}

func (v *NullableInlineResponse200269Policies) Set(val *InlineResponse200269Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200269Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200269Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200269Policies(val *InlineResponse200269Policies) *NullableInlineResponse200269Policies {
	return &NullableInlineResponse200269Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200269Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200269Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
