...
func (r SnmpApiGetNetworkSnmpRequest) Execute() (*InlineResponse200153, *http.Response, error) {
...
func (a *SnmpApiService) GetNetworkSnmpExecute(r SnmpApiGetNetworkSnmpRequest) (*InlineResponse200153, *http.Response, error) {
	var (
...
func (r SnmpApiGetOrganizationSnmpRequest) Execute() (*InlineResponse200339, *http.Response, error) {
...
func (a *SnmpApiService) GetOrganizationSnmpExecute(r SnmpApiGetOrganizationSnmpRequest) (*InlineResponse200339, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SnmpApiUpdateNetworkSnmpRequest) Execute() (*InlineResponse200153, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200153
func (a *SnmpApiService) UpdateNetworkSnmpExecute(r SnmpApiUpdateNetworkSnmpRequest) (*InlineResponse200153, *http.Response, error) {
	var (
...
type SnmpApiUpdateOrganizationSnmpRequest struct {
	...
	ApiService *SnmpApiService
	organizationId string
	updateOrganizationSnmp *InlineObject304
}

func (r SnmpApiUpdateOrganizationSnmpRequest) UpdateOrganizationSnmp(updateOrganizationSnmp InlineObject304) SnmpApiUpdateOrganizationSnmpRequest {
	r.updateOrganizationSnmp = &updateOrganizationSnmp
	return r
}

func (r SnmpApiUpdateOrganizationSnmpRequest) Execute() (*InlineResponse200339, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200339
func (a *SnmpApiService) UpdateOrganizationSnmpExecute(r SnmpApiUpdateOrganizationSnmpRequest) (*InlineResponse200339, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
