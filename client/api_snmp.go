...
func (r SnmpApiGetNetworkSnmpRequest) Execute() (*InlineResponse200135, *http.Response, error) {
...
func (a *SnmpApiService) GetNetworkSnmpExecute(r SnmpApiGetNetworkSnmpRequest) (*InlineResponse200135, *http.Response, error) {
	var (
...
func (r SnmpApiGetOrganizationSnmpRequest) Execute() (*InlineResponse200272, *http.Response, error) {
...
func (a *SnmpApiService) GetOrganizationSnmpExecute(r SnmpApiGetOrganizationSnmpRequest) (*InlineResponse200272, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SnmpApiUpdateNetworkSnmpRequest) Execute() (*InlineResponse200135, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200135
func (a *SnmpApiService) UpdateNetworkSnmpExecute(r SnmpApiUpdateNetworkSnmpRequest) (*InlineResponse200135, *http.Response, error) {
	var (
...
func (r SnmpApiUpdateOrganizationSnmpRequest) UpdateOrganizationSnmp(updateOrganizationSnmp InlineObject258) SnmpApiUpdateOrganizationSnmpRequest {
	r.updateOrganizationSnmp = &updateOrganizationSnmp
	return r
}

func (r SnmpApiUpdateOrganizationSnmpRequest) Execute() (*InlineResponse200272, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200272
func (a *SnmpApiService) UpdateOrganizationSnmpExecute(r SnmpApiUpdateOrganizationSnmpRequest) (*InlineResponse200272, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
