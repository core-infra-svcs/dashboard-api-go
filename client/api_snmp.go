...
func (r SnmpApiGetNetworkSnmpRequest) Execute() (*InlineResponse200134, *http.Response, error) {
...
func (a *SnmpApiService) GetNetworkSnmpExecute(r SnmpApiGetNetworkSnmpRequest) (*InlineResponse200134, *http.Response, error) {
	var (
...
func (r SnmpApiGetOrganizationSnmpRequest) Execute() (*InlineResponse200264, *http.Response, error) {
...
func (a *SnmpApiService) GetOrganizationSnmpExecute(r SnmpApiGetOrganizationSnmpRequest) (*InlineResponse200264, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SnmpApiUpdateNetworkSnmpRequest) UpdateNetworkSnmp(updateNetworkSnmp InlineObject126) SnmpApiUpdateNetworkSnmpRequest {
	r.updateNetworkSnmp = &updateNetworkSnmp
	return r
}

func (r SnmpApiUpdateNetworkSnmpRequest) Execute() (*InlineResponse200134, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200134
func (a *SnmpApiService) UpdateNetworkSnmpExecute(r SnmpApiUpdateNetworkSnmpRequest) (*InlineResponse200134, *http.Response, error) {
	var (
...
func (r SnmpApiUpdateOrganizationSnmpRequest) UpdateOrganizationSnmp(updateOrganizationSnmp InlineObject253) SnmpApiUpdateOrganizationSnmpRequest {
	r.updateOrganizationSnmp = &updateOrganizationSnmp
	return r
}

func (r SnmpApiUpdateOrganizationSnmpRequest) Execute() (*InlineResponse200264, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200264
func (a *SnmpApiService) UpdateOrganizationSnmpExecute(r SnmpApiUpdateOrganizationSnmpRequest) (*InlineResponse200264, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
