...
func (r SnmpApiGetNetworkSnmpRequest) Execute() (*InlineResponse200148, *http.Response, error) {
...
func (a *SnmpApiService) GetNetworkSnmpExecute(r SnmpApiGetNetworkSnmpRequest) (*InlineResponse200148, *http.Response, error) {
	var (
...
func (r SnmpApiGetOrganizationSnmpRequest) Execute() (*InlineResponse200323, *http.Response, error) {
...
func (a *SnmpApiService) GetOrganizationSnmpExecute(r SnmpApiGetOrganizationSnmpRequest) (*InlineResponse200323, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SnmpApiUpdateNetworkSnmpRequest) UpdateNetworkSnmp(updateNetworkSnmp InlineObject136) SnmpApiUpdateNetworkSnmpRequest {
	r.updateNetworkSnmp = &updateNetworkSnmp
	return r
}

func (r SnmpApiUpdateNetworkSnmpRequest) Execute() (*InlineResponse200148, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200148
func (a *SnmpApiService) UpdateNetworkSnmpExecute(r SnmpApiUpdateNetworkSnmpRequest) (*InlineResponse200148, *http.Response, error) {
	var (
...
type SnmpApiUpdateOrganizationSnmpRequest struct {
	...
	ApiService *SnmpApiService
	organizationId string
	updateOrganizationSnmp *InlineObject298
}

func (r SnmpApiUpdateOrganizationSnmpRequest) UpdateOrganizationSnmp(updateOrganizationSnmp InlineObject298) SnmpApiUpdateOrganizationSnmpRequest {
	r.updateOrganizationSnmp = &updateOrganizationSnmp
	return r
}

func (r SnmpApiUpdateOrganizationSnmpRequest) Execute() (*InlineResponse200323, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200323
func (a *SnmpApiService) UpdateOrganizationSnmpExecute(r SnmpApiUpdateOrganizationSnmpRequest) (*InlineResponse200323, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
