...
func (r SnmpApiGetNetworkSnmpRequest) Execute() (*InlineResponse200137, *http.Response, error) {
...
func (a *SnmpApiService) GetNetworkSnmpExecute(r SnmpApiGetNetworkSnmpRequest) (*InlineResponse200137, *http.Response, error) {
	var (
...
func (r SnmpApiGetOrganizationSnmpRequest) Execute() (*InlineResponse200276, *http.Response, error) {
...
func (a *SnmpApiService) GetOrganizationSnmpExecute(r SnmpApiGetOrganizationSnmpRequest) (*InlineResponse200276, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SnmpApiUpdateNetworkSnmpRequest) UpdateNetworkSnmp(updateNetworkSnmp InlineObject127) SnmpApiUpdateNetworkSnmpRequest {
	r.updateNetworkSnmp = &updateNetworkSnmp
	return r
}

func (r SnmpApiUpdateNetworkSnmpRequest) Execute() (*InlineResponse200137, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200137
func (a *SnmpApiService) UpdateNetworkSnmpExecute(r SnmpApiUpdateNetworkSnmpRequest) (*InlineResponse200137, *http.Response, error) {
	var (
...
func (r SnmpApiUpdateOrganizationSnmpRequest) UpdateOrganizationSnmp(updateOrganizationSnmp InlineObject261) SnmpApiUpdateOrganizationSnmpRequest {
	r.updateOrganizationSnmp = &updateOrganizationSnmp
	return r
}

func (r SnmpApiUpdateOrganizationSnmpRequest) Execute() (*InlineResponse200276, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200276
func (a *SnmpApiService) UpdateOrganizationSnmpExecute(r SnmpApiUpdateOrganizationSnmpRequest) (*InlineResponse200276, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
