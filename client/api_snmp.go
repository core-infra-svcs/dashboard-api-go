...
func (r SnmpApiGetOrganizationSnmpRequest) Execute() (*InlineResponse200275, *http.Response, error) {
...
func (a *SnmpApiService) GetOrganizationSnmpExecute(r SnmpApiGetOrganizationSnmpRequest) (*InlineResponse200275, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SnmpApiUpdateOrganizationSnmpRequest) Execute() (*InlineResponse200275, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200275
func (a *SnmpApiService) UpdateOrganizationSnmpExecute(r SnmpApiUpdateOrganizationSnmpRequest) (*InlineResponse200275, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
