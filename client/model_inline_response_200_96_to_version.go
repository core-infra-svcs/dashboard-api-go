...
// InlineResponse20096ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20096ToVersion struct {
...
func NewInlineResponse20096ToVersion() *InlineResponse20096ToVersion {
	this := InlineResponse20096ToVersion{}
	return &this
}
...
func (o InlineResponse20096ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20096ToVersion struct {
	value *InlineResponse20096ToVersion
	isSet bool
}

func (v NullableInlineResponse20096ToVersion) Get() *InlineResponse20096ToVersion {
	return v.value
}

func (v *NullableInlineResponse20096ToVersion) Set(val *InlineResponse20096ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20096ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20096ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20096ToVersion(val *InlineResponse20096ToVersion) *NullableInlineResponse20096ToVersion {
	return &NullableInlineResponse20096ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20096ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20096ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
