...
// InlineResponse200350Events struct for InlineResponse200350Events
type InlineResponse200350Events struct {
...
func NewInlineResponse200350Events() *InlineResponse200350Events {
	this := InlineResponse200350Events{}
	return &this
}
...
func (o InlineResponse200350Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200350Events struct {
	value *InlineResponse200350Events
	isSet bool
}

func (v NullableInlineResponse200350Events) Get() *InlineResponse200350Events {
	return v.value
}

func (v *NullableInlineResponse200350Events) Set(val *InlineResponse200350Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200350Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200350Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200350Events(val *InlineResponse200350Events) *NullableInlineResponse200350Events {
	return &NullableInlineResponse200350Events{value: val, isSet: true}
}

func (v NullableInlineResponse200350Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200350Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
