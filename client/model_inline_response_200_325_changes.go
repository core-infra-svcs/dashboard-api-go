...
// InlineResponse200325Changes struct for InlineResponse200325Changes
type InlineResponse200325Changes struct {
...
func NewInlineResponse200325Changes() *InlineResponse200325Changes {
	this := InlineResponse200325Changes{}
	return &this
}
...
func (o InlineResponse200325Changes) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200325Changes struct {
	value *InlineResponse200325Changes
	isSet bool
}

func (v NullableInlineResponse200325Changes) Get() *InlineResponse200325Changes {
	return v.value
}

func (v *NullableInlineResponse200325Changes) Set(val *InlineResponse200325Changes) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200325Changes) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200325Changes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200325Changes(val *InlineResponse200325Changes) *NullableInlineResponse200325Changes {
	return &NullableInlineResponse200325Changes{value: val, isSet: true}
}

func (v NullableInlineResponse200325Changes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200325Changes) UnmarshalJSON(src []byte) error {
	v.isSet = true
