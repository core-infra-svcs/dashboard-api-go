...
type InsightApiCreateOrganizationInsightMonitoredMediaServerRequest struct {
	...
	createOrganizationInsightMonitoredMediaServer *InlineObject221
}

func (r InsightApiCreateOrganizationInsightMonitoredMediaServerRequest) CreateOrganizationInsightMonitoredMediaServer(createOrganizationInsightMonitoredMediaServer InlineObject221) InsightApiCreateOrganizationInsightMonitoredMediaServerRequest {
...
func (r InsightApiGetNetworkInsightApplicationHealthByTimeRequest) Execute() ([]InlineResponse20049, *http.Response, error) {
...
func (a *InsightApiService) GetNetworkInsightApplicationHealthByTimeExecute(r InsightApiGetNetworkInsightApplicationHealthByTimeRequest) ([]InlineResponse20049, *http.Response, error) {
	var (
...
func (r InsightApiGetOrganizationInsightApplicationsRequest) Execute() ([]InlineResponse200160, *http.Response, error) {
...
func (a *InsightApiService) GetOrganizationInsightApplicationsExecute(r InsightApiGetOrganizationInsightApplicationsRequest) ([]InlineResponse200160, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InsightApiGetOrganizationInsightMonitoredMediaServersRequest) Execute() ([]InlineResponse200161, *http.Response, error) {
...
func (a *InsightApiService) GetOrganizationInsightMonitoredMediaServersExecute(r InsightApiGetOrganizationInsightMonitoredMediaServersRequest) ([]InlineResponse200161, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type InsightApiUpdateOrganizationInsightMonitoredMediaServerRequest struct {
	...
	organizationId string
	monitoredMediaServerId string
	updateOrganizationInsightMonitoredMediaServer *InlineObject222
}

func (r InsightApiUpdateOrganizationInsightMonitoredMediaServerRequest) UpdateOrganizationInsightMonitoredMediaServer(updateOrganizationInsightMonitoredMediaServer InlineObject222) InsightApiUpdateOrganizationInsightMonitoredMediaServerRequest {
