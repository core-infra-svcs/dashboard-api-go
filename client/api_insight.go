...
func (r InsightApiCreateOrganizationInsightMonitoredMediaServerRequest) Execute() (*InlineResponse200250, *http.Response, error) {
...
func (a *InsightApiService) CreateOrganizationInsightMonitoredMediaServerExecute(r InsightApiCreateOrganizationInsightMonitoredMediaServerRequest) (*InlineResponse200250, *http.Response, error) {
	var (
...
func (r InsightApiGetOrganizationInsightApplicationsRequest) Execute() ([]InlineResponse200249, *http.Response, error) {
...
func (a *InsightApiService) GetOrganizationInsightApplicationsExecute(r InsightApiGetOrganizationInsightApplicationsRequest) ([]InlineResponse200249, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InsightApiGetOrganizationInsightMonitoredMediaServerRequest) Execute() (*InlineResponse200250, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200250
func (a *InsightApiService) GetOrganizationInsightMonitoredMediaServerExecute(r InsightApiGetOrganizationInsightMonitoredMediaServerRequest) (*InlineResponse200250, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InsightApiGetOrganizationInsightMonitoredMediaServersRequest) Execute() ([]InlineResponse200250, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200250
func (a *InsightApiService) GetOrganizationInsightMonitoredMediaServersExecute(r InsightApiGetOrganizationInsightMonitoredMediaServersRequest) ([]InlineResponse200250, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InsightApiUpdateOrganizationInsightMonitoredMediaServerRequest) Execute() (*InlineResponse200250, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200250
func (a *InsightApiService) UpdateOrganizationInsightMonitoredMediaServerExecute(r InsightApiUpdateOrganizationInsightMonitoredMediaServerRequest) (*InlineResponse200250, *http.Response, error) {
	var (
