...
type InsightApiCreateOrganizationInsightMonitoredMediaServerRequest struct {
	...
	createOrganizationInsightMonitoredMediaServer *InlineObject216
}

func (r InsightApiCreateOrganizationInsightMonitoredMediaServerRequest) CreateOrganizationInsightMonitoredMediaServer(createOrganizationInsightMonitoredMediaServer InlineObject216) InsightApiCreateOrganizationInsightMonitoredMediaServerRequest {
...
func (r InsightApiGetNetworkInsightApplicationHealthByTimeRequest) Execute() ([]InlineResponse20046, *http.Response, error) {
...
func (a *InsightApiService) GetNetworkInsightApplicationHealthByTimeExecute(r InsightApiGetNetworkInsightApplicationHealthByTimeRequest) ([]InlineResponse20046, *http.Response, error) {
	var (
...
func (r InsightApiGetOrganizationInsightApplicationsRequest) Execute() ([]InlineResponse200151, *http.Response, error) {
...
func (a *InsightApiService) GetOrganizationInsightApplicationsExecute(r InsightApiGetOrganizationInsightApplicationsRequest) ([]InlineResponse200151, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InsightApiGetOrganizationInsightMonitoredMediaServersRequest) Execute() ([]InlineResponse200152, *http.Response, error) {
...
func (a *InsightApiService) GetOrganizationInsightMonitoredMediaServersExecute(r InsightApiGetOrganizationInsightMonitoredMediaServersRequest) ([]InlineResponse200152, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type InsightApiUpdateOrganizationInsightMonitoredMediaServerRequest struct {
	...
	organizationId string
	monitoredMediaServerId string
	updateOrganizationInsightMonitoredMediaServer *InlineObject217
}

func (r InsightApiUpdateOrganizationInsightMonitoredMediaServerRequest) UpdateOrganizationInsightMonitoredMediaServer(updateOrganizationInsightMonitoredMediaServer InlineObject217) InsightApiUpdateOrganizationInsightMonitoredMediaServerRequest {
