...
func (r EntriesApiCreateOrganizationWirelessSsidsFirewallIsolationAllowlistEntryRequest) Execute() (*InlineResponse200367Items, *http.Response, error) {
...
func (a *EntriesApiService) CreateOrganizationWirelessSsidsFirewallIsolationAllowlistEntryExecute(r EntriesApiCreateOrganizationWirelessSsidsFirewallIsolationAllowlistEntryRequest) (*InlineResponse200367Items, *http.Response, error) {
	var (
...
func (r EntriesApiGetOrganizationWirelessSsidsFirewallIsolationAllowlistEntriesRequest) Execute() (*InlineResponse200367, *http.Response, error) {
...
func (a *EntriesApiService) GetOrganizationWirelessSsidsFirewallIsolationAllowlistEntriesExecute(r EntriesApiGetOrganizationWirelessSsidsFirewallIsolationAllowlistEntriesRequest) (*InlineResponse200367, *http.Response, error) {
	var (
...
func (r EntriesApiUpdateOrganizationWirelessSsidsFirewallIsolationAllowlistEntryRequest) Execute() (*InlineResponse200367Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200367Items
func (a *EntriesApiService) UpdateOrganizationWirelessSsidsFirewallIsolationAllowlistEntryExecute(r EntriesApiUpdateOrganizationWirelessSsidsFirewallIsolationAllowlistEntryRequest) (*InlineResponse200367Items, *http.Response, error) {
	var (
