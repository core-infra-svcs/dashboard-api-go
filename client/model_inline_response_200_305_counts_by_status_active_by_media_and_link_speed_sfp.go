...
// InlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp The count data for SFP ports, indexed by speed in Mb
type InlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp struct {
...
func NewInlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp() *InlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp {
	this := InlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp{}
	return &this
}
...
func (o InlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp struct {
	value *InlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp
	isSet bool
}

func (v NullableInlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp) Get() *InlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp {
	return v.value
}

func (v *NullableInlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp) Set(val *InlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp(val *InlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp) *NullableInlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp {
	return &NullableInlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp{value: val, isSet: true}
}

func (v NullableInlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200305CountsByStatusActiveByMediaAndLinkSpeedSfp) UnmarshalJSON(src []byte) error {
	v.isSet = true
