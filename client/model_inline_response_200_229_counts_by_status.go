...
// InlineResponse200229CountsByStatus byStatus
type InlineResponse200229CountsByStatus struct {
...
func NewInlineResponse200229CountsByStatus() *InlineResponse200229CountsByStatus {
	this := InlineResponse200229CountsByStatus{}
	return &this
}
...
func (o InlineResponse200229CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200229CountsByStatus struct {
	value *InlineResponse200229CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200229CountsByStatus) Get() *InlineResponse200229CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200229CountsByStatus) Set(val *InlineResponse200229CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200229CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200229CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200229CountsByStatus(val *InlineResponse200229CountsByStatus) *NullableInlineResponse200229CountsByStatus {
	return &NullableInlineResponse200229CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200229CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200229CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
