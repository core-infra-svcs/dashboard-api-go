...
// InlineResponse200103Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse200103Counts struct {
	...
	Noise *InlineResponse200103CountsNoise `json:"noise,omitempty"`
...
func (o *InlineResponse200103Counts) GetNoise() InlineResponse200103CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse200103CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse200103CountsNoise and assigns it to the Noise field.
