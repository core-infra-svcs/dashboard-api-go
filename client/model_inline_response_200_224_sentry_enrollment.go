...
// InlineResponse200224SentryEnrollment Systems Manager sentry enrollment splash settings.
type InlineResponse200224SentryEnrollment struct {
	SystemsManagerNetwork *InlineResponse200224SentryEnrollmentSystemsManagerNetwork `json:"systemsManagerNetwork,omitempty"`
...
func NewInlineResponse200224SentryEnrollment() *InlineResponse200224SentryEnrollment {
	this := InlineResponse200224SentryEnrollment{}
	return &this
}
...
func (o *InlineResponse200224SentryEnrollment) GetSystemsManagerNetwork() InlineResponse200224SentryEnrollmentSystemsManagerNetwork {
	if o == nil || isNil(o.SystemsManagerNetwork) {
		var ret InlineResponse200224SentryEnrollmentSystemsManagerNetwork
		return ret
	}
...
// SetSystemsManagerNetwork gets a reference to the given InlineResponse200224SentryEnrollmentSystemsManagerNetwork and assigns it to the SystemsManagerNetwork field.
...
func (o InlineResponse200224SentryEnrollment) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200224SentryEnrollment struct {
	value *InlineResponse200224SentryEnrollment
	isSet bool
}

func (v NullableInlineResponse200224SentryEnrollment) Get() *InlineResponse200224SentryEnrollment {
	return v.value
}

func (v *NullableInlineResponse200224SentryEnrollment) Set(val *InlineResponse200224SentryEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200224SentryEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200224SentryEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200224SentryEnrollment(val *InlineResponse200224SentryEnrollment) *NullableInlineResponse200224SentryEnrollment {
	return &NullableInlineResponse200224SentryEnrollment{value: val, isSet: true}
}

func (v NullableInlineResponse200224SentryEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200224SentryEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
