...
// InlineResponse20086EventData An object containing more data related to the event.
type InlineResponse20086EventData struct {
...
func NewInlineResponse20086EventData() *InlineResponse20086EventData {
	this := InlineResponse20086EventData{}
	return &this
}
...
func (o InlineResponse20086EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20086EventData struct {
	value *InlineResponse20086EventData
	isSet bool
}

func (v NullableInlineResponse20086EventData) Get() *InlineResponse20086EventData {
	return v.value
}

func (v *NullableInlineResponse20086EventData) Set(val *InlineResponse20086EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20086EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20086EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20086EventData(val *InlineResponse20086EventData) *NullableInlineResponse20086EventData {
	return &NullableInlineResponse20086EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20086EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20086EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
