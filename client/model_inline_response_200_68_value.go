...
// InlineResponse20068Value Value of traffic filter
type InlineResponse20068Value struct {
	// Protocol of 'custom' type traffic filter. Must be one of: 'tcp', 'udp', 'icmp6' or 'any'
	Protocol *string `json:"protocol,omitempty"`
	Source InlineResponse20068ValueSource `json:"source"`
...
func (o *InlineResponse20068Value) GetSource() InlineResponse20068ValueSource {
	if o == nil {
		var ret InlineResponse20068ValueSource
		return ret
	}
...
func (o InlineResponse20068Value) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20068Value struct {
	value *InlineResponse20068Value
	isSet bool
}

func (v NullableInlineResponse20068Value) Get() *InlineResponse20068Value {
	return v.value
}

func (v *NullableInlineResponse20068Value) Set(val *InlineResponse20068Value) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20068Value) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20068Value) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20068Value(val *InlineResponse20068Value) *NullableInlineResponse20068Value {
	return &NullableInlineResponse20068Value{value: val, isSet: true}
}

func (v NullableInlineResponse20068Value) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20068Value) UnmarshalJSON(src []byte) error {
	v.isSet = true
