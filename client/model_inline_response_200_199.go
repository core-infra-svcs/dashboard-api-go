...
type InlineResponse200199 struct {
	...
	ConnectionStats *InlineResponse200199ConnectionStats `json:"connectionStats,omitempty"`
}
...
func (o *InlineResponse200199) GetMac() string {
...
func (o *InlineResponse200199) GetMacOk() (*string, bool) {
	if o == nil || isNil(o.Mac) {
    return nil, false
	}
	return o.Mac, true
...
func (o *InlineResponse200199) HasMac() bool {
	if o != nil && !isNil(o.Mac) {
		return true
	}
...
func (o *InlineResponse200199) SetMac(v string) {
	o.Mac = &v
}

// GetConnectionStats returns the ConnectionStats field value if set, zero value otherwise.
func (o *InlineResponse200199) GetConnectionStats() InlineResponse200199ConnectionStats {
	if o == nil || isNil(o.ConnectionStats) {
		var ret InlineResponse200199ConnectionStats
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200199) GetConnectionStatsOk() (*InlineResponse200199ConnectionStats, bool) {
	if o == nil || isNil(o.ConnectionStats) {
    return nil, false
	}
...
func (o *InlineResponse200199) HasConnectionStats() bool {
	if o != nil && !isNil(o.ConnectionStats) {
		return true
	}
...
// SetConnectionStats gets a reference to the given InlineResponse200199ConnectionStats and assigns it to the ConnectionStats field.
func (o *InlineResponse200199) SetConnectionStats(v InlineResponse200199ConnectionStats) {
	o.ConnectionStats = &v
}
