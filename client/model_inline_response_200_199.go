...
type InlineResponse200199 struct {
	...
	SplashLogo *InlineResponse200199SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200199SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200199SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200199GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200199Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200199SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200199SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200199) GetSplashLogo() InlineResponse200199SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200199SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200199SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200199) GetSplashImage() InlineResponse200199SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200199SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200199SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200199) GetSplashPrepaidFront() InlineResponse200199SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200199SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200199SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200199) GetGuestSponsorship() InlineResponse200199GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200199GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200199GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200199) GetBilling() InlineResponse200199Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200199Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200199Billing and assigns it to the Billing field.
...
func (o *InlineResponse200199) GetSentryEnrollment() InlineResponse200199SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200199SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200199SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200199) GetSelfRegistration() InlineResponse200199SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200199SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200199SelfRegistration and assigns it to the SelfRegistration field.
