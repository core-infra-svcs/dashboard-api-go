...
// InlineResponse20095VlanProfile The VLAN Profile
type InlineResponse20095VlanProfile struct {
...
func NewInlineResponse20095VlanProfile() *InlineResponse20095VlanProfile {
	this := InlineResponse20095VlanProfile{}
	return &this
}
...
func (o InlineResponse20095VlanProfile) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20095VlanProfile struct {
	value *InlineResponse20095VlanProfile
	isSet bool
}

func (v NullableInlineResponse20095VlanProfile) Get() *InlineResponse20095VlanProfile {
	return v.value
}

func (v *NullableInlineResponse20095VlanProfile) Set(val *InlineResponse20095VlanProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20095VlanProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20095VlanProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20095VlanProfile(val *InlineResponse20095VlanProfile) *NullableInlineResponse20095VlanProfile {
	return &NullableInlineResponse20095VlanProfile{value: val, isSet: true}
}

func (v NullableInlineResponse20095VlanProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20095VlanProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
