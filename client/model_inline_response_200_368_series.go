...
// InlineResponse200368Series struct for InlineResponse200368Series
type InlineResponse200368Series struct {
...
func NewInlineResponse200368Series() *InlineResponse200368Series {
	this := InlineResponse200368Series{}
	return &this
}
...
func (o InlineResponse200368Series) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200368Series struct {
	value *InlineResponse200368Series
	isSet bool
}

func (v NullableInlineResponse200368Series) Get() *InlineResponse200368Series {
	return v.value
}

func (v *NullableInlineResponse200368Series) Set(val *InlineResponse200368Series) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200368Series) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200368Series) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200368Series(val *InlineResponse200368Series) *NullableInlineResponse200368Series {
	return &NullableInlineResponse200368Series{value: val, isSet: true}
}

func (v NullableInlineResponse200368Series) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200368Series) UnmarshalJSON(src []byte) error {
	v.isSet = true
