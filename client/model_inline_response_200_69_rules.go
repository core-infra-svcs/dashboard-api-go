...
// InlineResponse20069Rules struct for InlineResponse20069Rules
type InlineResponse20069Rules struct {
...
func (o InlineResponse20069Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20069Rules struct {
	value *InlineResponse20069Rules
	isSet bool
}

func (v NullableInlineResponse20069Rules) Get() *InlineResponse20069Rules {
	return v.value
}

func (v *NullableInlineResponse20069Rules) Set(val *InlineResponse20069Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20069Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20069Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20069Rules(val *InlineResponse20069Rules) *NullableInlineResponse20069Rules {
	return &NullableInlineResponse20069Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20069Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20069Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
