...
func (r ByClientApiGetNetworkPoliciesByClientRequest) Execute() ([]InlineResponse200110, *http.Response, error) {
...
func (a *ByClientApiService) GetNetworkPoliciesByClientExecute(r ByClientApiGetNetworkPoliciesByClientRequest) ([]InlineResponse200110, *http.Response, error) {
	var (
...
func (r ByClientApiGetOrganizationWirelessDevicesPacketLossByClientRequest) Execute() ([]InlineResponse200322, *http.Response, error) {
...
func (a *ByClientApiService) GetOrganizationWirelessDevicesPacketLossByClientExecute(r ByClientApiGetOrganizationWirelessDevicesPacketLossByClientRequest) ([]InlineResponse200322, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
