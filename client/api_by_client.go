...
func (r ByClientApiGetNetworkPoliciesByClientRequest) Execute() ([]InlineResponse20045, *http.Response, error) {
...
func (a *ByClientApiService) GetNetworkPoliciesByClientExecute(r ByClientApiGetNetworkPoliciesByClientRequest) ([]InlineResponse20045, *http.Response, error) {
	var (
...
func (r ByClientApiGetOrganizationWirelessDevicesPacketLossByClientRequest) Execute() ([]InlineResponse200182, *http.Response, error) {
...
func (a *ByClientApiService) GetOrganizationWirelessDevicesPacketLossByClientExecute(r ByClientApiGetOrganizationWirelessDevicesPacketLossByClientRequest) ([]InlineResponse200182, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
