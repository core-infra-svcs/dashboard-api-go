...
func (r ByClientApiGetNetworkPoliciesByClientRequest) Execute() ([]InlineResponse200109, *http.Response, error) {
...
func (a *ByClientApiService) GetNetworkPoliciesByClientExecute(r ByClientApiGetNetworkPoliciesByClientRequest) ([]InlineResponse200109, *http.Response, error) {
	var (
...
func (r ByClientApiGetOrganizationWirelessDevicesPacketLossByClientRequest) Execute() ([]InlineResponse200318, *http.Response, error) {
...
func (a *ByClientApiService) GetOrganizationWirelessDevicesPacketLossByClientExecute(r ByClientApiGetOrganizationWirelessDevicesPacketLossByClientRequest) ([]InlineResponse200318, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
