...
func (r ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest) Execute() ([]InlineResponse200312, *http.Response, error) {
...
func (a *ByClientApiService) GetOrganizationPoliciesAssignmentsByClientExecute(r ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest) ([]InlineResponse200312, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ByClientApiGetOrganizationWirelessDevicesPacketLossByClientRequest) Execute() ([]InlineResponse200361, *http.Response, error) {
...
func (a *ByClientApiService) GetOrganizationWirelessDevicesPacketLossByClientExecute(r ByClientApiGetOrganizationWirelessDevicesPacketLossByClientRequest) ([]InlineResponse200361, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
