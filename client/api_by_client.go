...
func (r ByClientApiGetNetworkPoliciesByClientRequest) Execute() ([]InlineResponse200118, *http.Response, error) {
...
func (a *ByClientApiService) GetNetworkPoliciesByClientExecute(r ByClientApiGetNetworkPoliciesByClientRequest) ([]InlineResponse200118, *http.Response, error) {
	var (
...
type ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest struct {
	ctx context.Context
	ApiService *ByClientApiService
...
func (r ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest) NetworkIds(networkIds []string) ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest {
	r.networkIds = &networkIds
	return r
}

// The number of entries per page returned. Acceptable range is 3 - 1000. Default is 50.
func (r ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest) PerPage(perPage int32) ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest {
	r.perPage = &perPage
	return r
}

// A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest) StartingAfter(startingAfter string) ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest {
	r.startingAfter = &startingAfter
	return r
}

// A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest) EndingBefore(endingBefore string) ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest {
	r.endingBefore = &endingBefore
	return r
}

// The beginning of the timespan for the data. The maximum lookback period is 31 days from today.
func (r ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest) T0(t0 string) ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest {
	r.t0 = &t0
	return r
}

// The timespan for which the information will be fetched. If specifying timespan, do not specify parameter t0. The value must be in seconds and be less than or equal to 31 days. The default is 1 day.
func (r ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest) Timespan(timespan float32) ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest {
	r.timespan = &timespan
	return r
}

// Include provisioned clients that have not associated to the network. Default: false
func (r ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest) IncludeUndetectedClients(includeUndetectedClients bool) ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest {
	r.includeUndetectedClients = &includeUndetectedClients
	return r
}

func (r ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest) Execute() ([]InlineResponse200313, *http.Response, error) {
...
Get policies for all clients with policies
 ...
 @return ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest
*/
func (a *ByClientApiService) GetOrganizationPoliciesAssignmentsByClient(ctx context.Context, organizationId string) ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest {
	return ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *ByClientApiService) GetOrganizationPoliciesAssignmentsByClientExecute(r ByClientApiGetOrganizationPoliciesAssignmentsByClientRequest) ([]InlineResponse200313, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ByClientApiService.GetOrganizationPoliciesAssignmentsByClient")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ByClientApiGetOrganizationWirelessDevicesPacketLossByClientRequest) Execute() ([]InlineResponse200362, *http.Response, error) {
...
func (a *ByClientApiService) GetOrganizationWirelessDevicesPacketLossByClientExecute(r ByClientApiGetOrganizationWirelessDevicesPacketLossByClientRequest) ([]InlineResponse200362, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
