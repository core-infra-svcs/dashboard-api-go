...
// InlineResponse200331Counts The count data of all ports
type InlineResponse200331Counts struct {
	// The total number of ports
	Total *int32 `json:"total,omitempty"`
	ByStatus *InlineResponse200331CountsByStatus `json:"byStatus,omitempty"`
}
...
func NewInlineResponse200331Counts() *InlineResponse200331Counts {
	this := InlineResponse200331Counts{}
	return &this
}
...
func (o *InlineResponse200331Counts) GetByStatus() InlineResponse200331CountsByStatus {
	if o == nil || isNil(o.ByStatus) {
		var ret InlineResponse200331CountsByStatus
		return ret
	}
	return *o.ByStatus
}
...
// SetByStatus gets a reference to the given InlineResponse200331CountsByStatus and assigns it to the ByStatus field.
func (o *InlineResponse200331Counts) SetByStatus(v InlineResponse200331CountsByStatus) {
	o.ByStatus = &v
}

func (o InlineResponse200331Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200331Counts struct {
	value *InlineResponse200331Counts
	isSet bool
}

func (v NullableInlineResponse200331Counts) Get() *InlineResponse200331Counts {
	return v.value
}

func (v *NullableInlineResponse200331Counts) Set(val *InlineResponse200331Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200331Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200331Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200331Counts(val *InlineResponse200331Counts) *NullableInlineResponse200331Counts {
	return &NullableInlineResponse200331Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200331Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200331Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
