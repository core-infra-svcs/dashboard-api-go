...
// InlineResponse20060Ipv6 IPv6 configuration on the single LAN
type InlineResponse20060Ipv6 struct {
	// Enable IPv6 on single LAN
	Enabled *bool `json:"enabled,omitempty"`
	// Prefix assignments on the single LAN
	PrefixAssignments []InlineResponse20060Ipv6PrefixAssignments `json:"prefixAssignments,omitempty"`
}
...
func (o *InlineResponse20060Ipv6) GetPrefixAssignments() []InlineResponse20060Ipv6PrefixAssignments {
	if o == nil || isNil(o.PrefixAssignments) {
		var ret []InlineResponse20060Ipv6PrefixAssignments
		return ret
	}
...
// SetPrefixAssignments gets a reference to the given []InlineResponse20060Ipv6PrefixAssignments and assigns it to the PrefixAssignments field.
func (o *InlineResponse20060Ipv6) SetPrefixAssignments(v []InlineResponse20060Ipv6PrefixAssignments) {
	o.PrefixAssignments = v
}

func (o InlineResponse20060Ipv6) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20060Ipv6 struct {
	value *InlineResponse20060Ipv6
	isSet bool
}

func (v NullableInlineResponse20060Ipv6) Get() *InlineResponse20060Ipv6 {
	return v.value
}

func (v *NullableInlineResponse20060Ipv6) Set(val *InlineResponse20060Ipv6) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20060Ipv6) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20060Ipv6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20060Ipv6(val *InlineResponse20060Ipv6) *NullableInlineResponse20060Ipv6 {
	return &NullableInlineResponse20060Ipv6{value: val, isSet: true}
}

func (v NullableInlineResponse20060Ipv6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20060Ipv6) UnmarshalJSON(src []byte) error {
	v.isSet = true
