...
// InlineResponse200276UpdatedPriorities struct for InlineResponse200276UpdatedPriorities
type InlineResponse200276UpdatedPriorities struct {
...
func NewInlineResponse200276UpdatedPriorities() *InlineResponse200276UpdatedPriorities {
	this := InlineResponse200276UpdatedPriorities{}
	return &this
}
...
func (o InlineResponse200276UpdatedPriorities) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200276UpdatedPriorities struct {
	value *InlineResponse200276UpdatedPriorities
	isSet bool
}

func (v NullableInlineResponse200276UpdatedPriorities) Get() *InlineResponse200276UpdatedPriorities {
	return v.value
}

func (v *NullableInlineResponse200276UpdatedPriorities) Set(val *InlineResponse200276UpdatedPriorities) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200276UpdatedPriorities) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200276UpdatedPriorities) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200276UpdatedPriorities(val *InlineResponse200276UpdatedPriorities) *NullableInlineResponse200276UpdatedPriorities {
	return &NullableInlineResponse200276UpdatedPriorities{value: val, isSet: true}
}

func (v NullableInlineResponse200276UpdatedPriorities) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200276UpdatedPriorities) UnmarshalJSON(src []byte) error {
	v.isSet = true
