...
func (r LinesApiGetOrganizationCameraBoundariesLinesByDeviceRequest) Execute() ([]InlineResponse200242, *http.Response, error) {
...
func (a *LinesApiService) GetOrganizationCameraBoundariesLinesByDeviceExecute(r LinesApiGetOrganizationCameraBoundariesLinesByDeviceRequest) ([]InlineResponse200242, *http.Response, error) {
	var (
