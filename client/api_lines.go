...
func (r LinesApiGetOrganizationCameraBoundariesLinesByDeviceRequest) Execute() ([]InlineResponse200213, *http.Response, error) {
...
func (a *LinesApiService) GetOrganizationCameraBoundariesLinesByDeviceExecute(r LinesApiGetOrganizationCameraBoundariesLinesByDeviceRequest) ([]InlineResponse200213, *http.Response, error) {
	var (
