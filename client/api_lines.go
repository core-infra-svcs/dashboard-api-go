...
func (r LinesApiGetOrganizationCameraBoundariesLinesByDeviceRequest) Execute() ([]InlineResponse200148, *http.Response, error) {
...
func (a *LinesApiService) GetOrganizationCameraBoundariesLinesByDeviceExecute(r LinesApiGetOrganizationCameraBoundariesLinesByDeviceRequest) ([]InlineResponse200148, *http.Response, error) {
	var (
