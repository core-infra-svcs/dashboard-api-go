...
func (r UplinksApiGetDeviceApplianceUplinksSettingsRequest) Execute() (*InlineResponse20010, *http.Response, error) {
...
func (a *UplinksApiService) GetDeviceApplianceUplinksSettingsExecute(r UplinksApiGetDeviceApplianceUplinksSettingsRequest) (*InlineResponse20010, *http.Response, error) {
	var (
...
func (r UplinksApiGetDeviceLossAndLatencyHistoryRequest) Execute() ([]InlineResponse20037, *http.Response, error) {
...
func (a *UplinksApiService) GetDeviceLossAndLatencyHistoryExecute(r UplinksApiGetDeviceLossAndLatencyHistoryRequest) ([]InlineResponse20037, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetNetworkApplianceUplinksUsageHistoryRequest) Execute() ([]InlineResponse20082, *http.Response, error) {
...
func (a *UplinksApiService) GetNetworkApplianceUplinksUsageHistoryExecute(r UplinksApiGetNetworkApplianceUplinksUsageHistoryRequest) ([]InlineResponse20082, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetOrganizationApplianceUplinkStatusesRequest) Execute() ([]InlineResponse200248, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationApplianceUplinkStatusesExecute(r UplinksApiGetOrganizationApplianceUplinkStatusesRequest) ([]InlineResponse200248, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// A list of network IDs. The returned devices will be filtered to only include these networks.
func (r UplinksApiGetOrganizationApplianceUplinksStatusesOverviewRequest) NetworkIds(networkIds []string) UplinksApiGetOrganizationApplianceUplinksStatusesOverviewRequest {
	r.networkIds = &networkIds
	return r
}

func (r UplinksApiGetOrganizationApplianceUplinksStatusesOverviewRequest) Execute() (*InlineResponse200249, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationApplianceUplinksStatusesOverviewExecute(r UplinksApiGetOrganizationApplianceUplinksStatusesOverviewRequest) (*InlineResponse200249, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetOrganizationApplianceUplinksUsageByNetworkRequest) Execute() ([]InlineResponse200250, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationApplianceUplinksUsageByNetworkExecute(r UplinksApiGetOrganizationApplianceUplinksUsageByNetworkRequest) ([]InlineResponse200250, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest struct {
	ctx context.Context
	ApiService *UplinksApiService
	organizationId string
	serials *[]string
...
// A list of serial numbers. The returned devices will be filtered to only include these serials.
func (r UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest) Serials(serials []string) UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest {
	r.serials = &serials
	return r
}

// The number of entries per page returned. Acceptable range is 3 - 1000. Default is 1000.
func (r UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest) PerPage(perPage int32) UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest {
	r.perPage = &perPage
	return r
}

// A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest) StartingAfter(startingAfter string) UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest {
	r.startingAfter = &startingAfter
	return r
}

// A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest) EndingBefore(endingBefore string) UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest {
	r.endingBefore = &endingBefore
	return r
}

func (r UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest) Execute() (*InlineResponse200274, *http.Response, error) {
...
Uplink overrides configured locally on Campus Gateway devices in an organization.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId Organization ID
 @return UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest
*/
func (a *UplinksApiService) GetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDevice(ctx context.Context, organizationId string) UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest {
	return UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
func (a *UplinksApiService) GetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceExecute(r UplinksApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest) (*InlineResponse200274, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UplinksApiService.GetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDevice")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r UplinksApiGetOrganizationDevicesUplinksAddressesByDeviceRequest) Execute() ([]InlineResponse200304, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationDevicesUplinksAddressesByDeviceExecute(r UplinksApiGetOrganizationDevicesUplinksAddressesByDeviceRequest) ([]InlineResponse200304, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetOrganizationDevicesUplinksLossAndLatencyRequest) Execute() ([]InlineResponse200305, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationDevicesUplinksLossAndLatencyExecute(r UplinksApiGetOrganizationDevicesUplinksLossAndLatencyRequest) ([]InlineResponse200305, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetOrganizationUplinksStatusesRequest) Execute() ([]InlineResponse200373, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationUplinksStatusesExecute(r UplinksApiGetOrganizationUplinksStatusesRequest) ([]InlineResponse200373, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiUpdateDeviceApplianceUplinksSettingsRequest) UpdateDeviceApplianceUplinksSettings(updateDeviceApplianceUplinksSettings InlineObject5) UplinksApiUpdateDeviceApplianceUplinksSettingsRequest {
	r.updateDeviceApplianceUplinksSettings = &updateDeviceApplianceUplinksSettings
	return r
}

func (r UplinksApiUpdateDeviceApplianceUplinksSettingsRequest) Execute() (*InlineResponse20010, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20010
func (a *UplinksApiService) UpdateDeviceApplianceUplinksSettingsExecute(r UplinksApiUpdateDeviceApplianceUplinksSettingsRequest) (*InlineResponse20010, *http.Response, error) {
	var (
