...
func (r UplinksApiGetDeviceApplianceUplinksSettingsRequest) Execute() (*InlineResponse2004, *http.Response, error) {
...
func (a *UplinksApiService) GetDeviceApplianceUplinksSettingsExecute(r UplinksApiGetDeviceApplianceUplinksSettingsRequest) (*InlineResponse2004, *http.Response, error) {
	var (
...
func (r UplinksApiGetOrganizationApplianceUplinksStatusesOverviewRequest) Execute() (*InlineResponse200131, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationApplianceUplinksStatusesOverviewExecute(r UplinksApiGetOrganizationApplianceUplinksStatusesOverviewRequest) (*InlineResponse200131, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetOrganizationApplianceUplinksUsageByNetworkRequest) Execute() ([]InlineResponse200132, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationApplianceUplinksUsageByNetworkExecute(r UplinksApiGetOrganizationApplianceUplinksUsageByNetworkRequest) ([]InlineResponse200132, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetOrganizationDevicesUplinksAddressesByDeviceRequest) Execute() ([]InlineResponse200155, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationDevicesUplinksAddressesByDeviceExecute(r UplinksApiGetOrganizationDevicesUplinksAddressesByDeviceRequest) ([]InlineResponse200155, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetOrganizationDevicesUplinksLossAndLatencyRequest) Execute() ([]InlineResponse200156, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationDevicesUplinksLossAndLatencyExecute(r UplinksApiGetOrganizationDevicesUplinksLossAndLatencyRequest) ([]InlineResponse200156, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetOrganizationUplinksStatusesRequest) Execute() ([]InlineResponse200192, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationUplinksStatusesExecute(r UplinksApiGetOrganizationUplinksStatusesRequest) ([]InlineResponse200192, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiUpdateDeviceApplianceUplinksSettingsRequest) Execute() (*InlineResponse2004, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2004
func (a *UplinksApiService) UpdateDeviceApplianceUplinksSettingsExecute(r UplinksApiUpdateDeviceApplianceUplinksSettingsRequest) (*InlineResponse2004, *http.Response, error) {
	var (
