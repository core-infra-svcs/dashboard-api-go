...
func (r UplinksApiGetDeviceApplianceUplinksSettingsRequest) Execute() (*InlineResponse2006, *http.Response, error) {
...
func (a *UplinksApiService) GetDeviceApplianceUplinksSettingsExecute(r UplinksApiGetDeviceApplianceUplinksSettingsRequest) (*InlineResponse2006, *http.Response, error) {
	var (
...
func (r UplinksApiGetOrganizationApplianceUplinksStatusesOverviewRequest) Execute() (*InlineResponse200141, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationApplianceUplinksStatusesOverviewExecute(r UplinksApiGetOrganizationApplianceUplinksStatusesOverviewRequest) (*InlineResponse200141, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetOrganizationApplianceUplinksUsageByNetworkRequest) Execute() ([]InlineResponse200142, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationApplianceUplinksUsageByNetworkExecute(r UplinksApiGetOrganizationApplianceUplinksUsageByNetworkRequest) ([]InlineResponse200142, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetOrganizationDevicesUplinksAddressesByDeviceRequest) Execute() ([]InlineResponse200165, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationDevicesUplinksAddressesByDeviceExecute(r UplinksApiGetOrganizationDevicesUplinksAddressesByDeviceRequest) ([]InlineResponse200165, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetOrganizationDevicesUplinksLossAndLatencyRequest) Execute() ([]InlineResponse200166, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationDevicesUplinksLossAndLatencyExecute(r UplinksApiGetOrganizationDevicesUplinksLossAndLatencyRequest) ([]InlineResponse200166, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiGetOrganizationUplinksStatusesRequest) Execute() ([]InlineResponse200202, *http.Response, error) {
...
func (a *UplinksApiService) GetOrganizationUplinksStatusesExecute(r UplinksApiGetOrganizationUplinksStatusesRequest) ([]InlineResponse200202, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinksApiUpdateDeviceApplianceUplinksSettingsRequest) Execute() (*InlineResponse2006, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2006
func (a *UplinksApiService) UpdateDeviceApplianceUplinksSettingsExecute(r UplinksApiUpdateDeviceApplianceUplinksSettingsRequest) (*InlineResponse2006, *http.Response, error) {
	var (
