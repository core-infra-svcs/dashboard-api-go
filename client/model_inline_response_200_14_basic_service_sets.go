...
// InlineResponse20014BasicServiceSets struct for InlineResponse20014BasicServiceSets
type InlineResponse20014BasicServiceSets struct {
...
func NewInlineResponse20014BasicServiceSets() *InlineResponse20014BasicServiceSets {
	this := InlineResponse20014BasicServiceSets{}
	return &this
}
...
func (o InlineResponse20014BasicServiceSets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20014BasicServiceSets struct {
	value *InlineResponse20014BasicServiceSets
	isSet bool
}

func (v NullableInlineResponse20014BasicServiceSets) Get() *InlineResponse20014BasicServiceSets {
	return v.value
}

func (v *NullableInlineResponse20014BasicServiceSets) Set(val *InlineResponse20014BasicServiceSets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20014BasicServiceSets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20014BasicServiceSets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20014BasicServiceSets(val *InlineResponse20014BasicServiceSets) *NullableInlineResponse20014BasicServiceSets {
	return &NullableInlineResponse20014BasicServiceSets{value: val, isSet: true}
}

func (v NullableInlineResponse20014BasicServiceSets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20014BasicServiceSets) UnmarshalJSON(src []byte) error {
	v.isSet = true
