...
// InlineResponse200286CountsByStatusInactiveByMedia The inactive count data, indexed by media type (RJ45 or SFP)
type InlineResponse200286CountsByStatusInactiveByMedia struct {
	Rj45 *InlineResponse200286CountsByStatusInactiveByMediaRj45 `json:"rj45,omitempty"`
	Sfp *InlineResponse200286CountsByStatusInactiveByMediaSfp `json:"sfp,omitempty"`
}
...
func NewInlineResponse200286CountsByStatusInactiveByMedia() *InlineResponse200286CountsByStatusInactiveByMedia {
	this := InlineResponse200286CountsByStatusInactiveByMedia{}
	return &this
}
...
func (o *InlineResponse200286CountsByStatusInactiveByMedia) GetRj45() InlineResponse200286CountsByStatusInactiveByMediaRj45 {
	if o == nil || isNil(o.Rj45) {
		var ret InlineResponse200286CountsByStatusInactiveByMediaRj45
		return ret
	}
	return *o.Rj45
}
...
// SetRj45 gets a reference to the given InlineResponse200286CountsByStatusInactiveByMediaRj45 and assigns it to the Rj45 field.
...
func (o *InlineResponse200286CountsByStatusInactiveByMedia) GetSfp() InlineResponse200286CountsByStatusInactiveByMediaSfp {
	if o == nil || isNil(o.Sfp) {
		var ret InlineResponse200286CountsByStatusInactiveByMediaSfp
		return ret
	}
	return *o.Sfp
}
...
// SetSfp gets a reference to the given InlineResponse200286CountsByStatusInactiveByMediaSfp and assigns it to the Sfp field.
func (o *InlineResponse200286CountsByStatusInactiveByMedia) SetSfp(v InlineResponse200286CountsByStatusInactiveByMediaSfp) {
	o.Sfp = &v
}

func (o InlineResponse200286CountsByStatusInactiveByMedia) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200286CountsByStatusInactiveByMedia struct {
	value *InlineResponse200286CountsByStatusInactiveByMedia
	isSet bool
}

func (v NullableInlineResponse200286CountsByStatusInactiveByMedia) Get() *InlineResponse200286CountsByStatusInactiveByMedia {
	return v.value
}

func (v *NullableInlineResponse200286CountsByStatusInactiveByMedia) Set(val *InlineResponse200286CountsByStatusInactiveByMedia) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200286CountsByStatusInactiveByMedia) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200286CountsByStatusInactiveByMedia) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200286CountsByStatusInactiveByMedia(val *InlineResponse200286CountsByStatusInactiveByMedia) *NullableInlineResponse200286CountsByStatusInactiveByMedia {
	return &NullableInlineResponse200286CountsByStatusInactiveByMedia{value: val, isSet: true}
}

func (v NullableInlineResponse200286CountsByStatusInactiveByMedia) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200286CountsByStatusInactiveByMedia) UnmarshalJSON(src []byte) error {
	v.isSet = true
