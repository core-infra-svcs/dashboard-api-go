...
// InlineResponse200287Intervals struct for InlineResponse200287Intervals
type InlineResponse200287Intervals struct {
	...
	Memory *InlineResponse200287Memory `json:"memory,omitempty"`
}
...
func NewInlineResponse200287Intervals() *InlineResponse200287Intervals {
	this := InlineResponse200287Intervals{}
	return &this
}
...
func (o *InlineResponse200287Intervals) GetMemory() InlineResponse200287Memory {
	if o == nil || isNil(o.Memory) {
		var ret InlineResponse200287Memory
		return ret
	}
	return *o.Memory
}
...
// SetMemory gets a reference to the given InlineResponse200287Memory and assigns it to the Memory field.
func (o *InlineResponse200287Intervals) SetMemory(v InlineResponse200287Memory) {
	o.Memory = &v
}

func (o InlineResponse200287Intervals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200287Intervals struct {
	value *InlineResponse200287Intervals
	isSet bool
}

func (v NullableInlineResponse200287Intervals) Get() *InlineResponse200287Intervals {
	return v.value
}

func (v *NullableInlineResponse200287Intervals) Set(val *InlineResponse200287Intervals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200287Intervals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200287Intervals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200287Intervals(val *InlineResponse200287Intervals) *NullableInlineResponse200287Intervals {
	return &NullableInlineResponse200287Intervals{value: val, isSet: true}
}

func (v NullableInlineResponse200287Intervals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200287Intervals) UnmarshalJSON(src []byte) error {
	v.isSet = true
