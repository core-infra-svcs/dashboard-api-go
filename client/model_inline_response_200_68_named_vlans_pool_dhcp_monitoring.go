...
// InlineResponse20068NamedVlansPoolDhcpMonitoring Named VLAN Pool DHCP Monitoring settings.
type InlineResponse20068NamedVlansPoolDhcpMonitoring struct {
...
func NewInlineResponse20068NamedVlansPoolDhcpMonitoring() *InlineResponse20068NamedVlansPoolDhcpMonitoring {
	this := InlineResponse20068NamedVlansPoolDhcpMonitoring{}
	return &this
}
...
func (o InlineResponse20068NamedVlansPoolDhcpMonitoring) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20068NamedVlansPoolDhcpMonitoring struct {
	value *InlineResponse20068NamedVlansPoolDhcpMonitoring
	isSet bool
}

func (v NullableInlineResponse20068NamedVlansPoolDhcpMonitoring) Get() *InlineResponse20068NamedVlansPoolDhcpMonitoring {
	return v.value
}

func (v *NullableInlineResponse20068NamedVlansPoolDhcpMonitoring) Set(val *InlineResponse20068NamedVlansPoolDhcpMonitoring) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20068NamedVlansPoolDhcpMonitoring) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20068NamedVlansPoolDhcpMonitoring) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20068NamedVlansPoolDhcpMonitoring(val *InlineResponse20068NamedVlansPoolDhcpMonitoring) *NullableInlineResponse20068NamedVlansPoolDhcpMonitoring {
	return &NullableInlineResponse20068NamedVlansPoolDhcpMonitoring{value: val, isSet: true}
}

func (v NullableInlineResponse20068NamedVlansPoolDhcpMonitoring) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20068NamedVlansPoolDhcpMonitoring) UnmarshalJSON(src []byte) error {
	v.isSet = true
