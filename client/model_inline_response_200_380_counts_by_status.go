...
// InlineResponse200380CountsByStatus Client counts by its status
type InlineResponse200380CountsByStatus struct {
...
func NewInlineResponse200380CountsByStatus() *InlineResponse200380CountsByStatus {
	this := InlineResponse200380CountsByStatus{}
	return &this
}
...
func (o InlineResponse200380CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200380CountsByStatus struct {
	value *InlineResponse200380CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200380CountsByStatus) Get() *InlineResponse200380CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200380CountsByStatus) Set(val *InlineResponse200380CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200380CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200380CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200380CountsByStatus(val *InlineResponse200380CountsByStatus) *NullableInlineResponse200380CountsByStatus {
	return &NullableInlineResponse200380CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200380CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200380CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
