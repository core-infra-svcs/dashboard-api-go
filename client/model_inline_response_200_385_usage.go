...
// InlineResponse200385Usage The usage on the interfaces of the wireless LAN controller
type InlineResponse200385Usage struct {
...
func NewInlineResponse200385Usage() *InlineResponse200385Usage {
	this := InlineResponse200385Usage{}
	return &this
}
...
func (o InlineResponse200385Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200385Usage struct {
	value *InlineResponse200385Usage
	isSet bool
}

func (v NullableInlineResponse200385Usage) Get() *InlineResponse200385Usage {
	return v.value
}

func (v *NullableInlineResponse200385Usage) Set(val *InlineResponse200385Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200385Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200385Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200385Usage(val *InlineResponse200385Usage) *NullableInlineResponse200385Usage {
	return &NullableInlineResponse200385Usage{value: val, isSet: true}
}

func (v NullableInlineResponse200385Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200385Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
