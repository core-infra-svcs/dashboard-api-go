...
// InlineResponse20095ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20095ToVersion struct {
...
func NewInlineResponse20095ToVersion() *InlineResponse20095ToVersion {
	this := InlineResponse20095ToVersion{}
	return &this
}
...
func (o InlineResponse20095ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20095ToVersion struct {
	value *InlineResponse20095ToVersion
	isSet bool
}

func (v NullableInlineResponse20095ToVersion) Get() *InlineResponse20095ToVersion {
	return v.value
}

func (v *NullableInlineResponse20095ToVersion) Set(val *InlineResponse20095ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20095ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20095ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20095ToVersion(val *InlineResponse20095ToVersion) *NullableInlineResponse20095ToVersion {
	return &NullableInlineResponse20095ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20095ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20095ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
