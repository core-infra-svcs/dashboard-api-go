...
// InlineResponse200158Servers struct for InlineResponse200158Servers
type InlineResponse200158Servers struct {
...
func NewInlineResponse200158Servers() *InlineResponse200158Servers {
	this := InlineResponse200158Servers{}
	return &this
}
...
func (o InlineResponse200158Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200158Servers struct {
	value *InlineResponse200158Servers
	isSet bool
}

func (v NullableInlineResponse200158Servers) Get() *InlineResponse200158Servers {
	return v.value
}

func (v *NullableInlineResponse200158Servers) Set(val *InlineResponse200158Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200158Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200158Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200158Servers(val *InlineResponse200158Servers) *NullableInlineResponse200158Servers {
	return &NullableInlineResponse200158Servers{value: val, isSet: true}
}

func (v NullableInlineResponse200158Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200158Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
