...
// InlineResponse200258ApiAuthenticationIpRestrictionsForKeys Details for API-only IP restrictions.
type InlineResponse200258ApiAuthenticationIpRestrictionsForKeys struct {
...
func NewInlineResponse200258ApiAuthenticationIpRestrictionsForKeys() *InlineResponse200258ApiAuthenticationIpRestrictionsForKeys {
	this := InlineResponse200258ApiAuthenticationIpRestrictionsForKeys{}
	return &this
}
...
func (o InlineResponse200258ApiAuthenticationIpRestrictionsForKeys) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200258ApiAuthenticationIpRestrictionsForKeys struct {
	value *InlineResponse200258ApiAuthenticationIpRestrictionsForKeys
	isSet bool
}

func (v NullableInlineResponse200258ApiAuthenticationIpRestrictionsForKeys) Get() *InlineResponse200258ApiAuthenticationIpRestrictionsForKeys {
	return v.value
}

func (v *NullableInlineResponse200258ApiAuthenticationIpRestrictionsForKeys) Set(val *InlineResponse200258ApiAuthenticationIpRestrictionsForKeys) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200258ApiAuthenticationIpRestrictionsForKeys) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200258ApiAuthenticationIpRestrictionsForKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200258ApiAuthenticationIpRestrictionsForKeys(val *InlineResponse200258ApiAuthenticationIpRestrictionsForKeys) *NullableInlineResponse200258ApiAuthenticationIpRestrictionsForKeys {
	return &NullableInlineResponse200258ApiAuthenticationIpRestrictionsForKeys{value: val, isSet: true}
}

func (v NullableInlineResponse200258ApiAuthenticationIpRestrictionsForKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200258ApiAuthenticationIpRestrictionsForKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
