...
// InlineResponse200179Policies struct for InlineResponse200179Policies
type InlineResponse200179Policies struct {
...
func NewInlineResponse200179Policies() *InlineResponse200179Policies {
	this := InlineResponse200179Policies{}
	return &this
}
...
func (o InlineResponse200179Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200179Policies struct {
	value *InlineResponse200179Policies
	isSet bool
}

func (v NullableInlineResponse200179Policies) Get() *InlineResponse200179Policies {
	return v.value
}

func (v *NullableInlineResponse200179Policies) Set(val *InlineResponse200179Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200179Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200179Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200179Policies(val *InlineResponse200179Policies) *NullableInlineResponse200179Policies {
	return &NullableInlineResponse200179Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200179Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200179Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
