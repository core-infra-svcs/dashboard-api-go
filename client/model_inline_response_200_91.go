...
type InlineResponse20091 struct {
	...
	ClientVpnConnections []InlineResponse20091ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20091) GetClientVpnConnections() []InlineResponse20091ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20091ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20091ClientVpnConnections and assigns it to the ClientVpnConnections field.
