...
func (r TrustedAccessConfigsApiGetNetworkSmTrustedAccessConfigsRequest) Execute() ([]InlineResponse200156, *http.Response, error) {
...
func (a *TrustedAccessConfigsApiService) GetNetworkSmTrustedAccessConfigsExecute(r TrustedAccessConfigsApiGetNetworkSmTrustedAccessConfigsRequest) ([]InlineResponse200156, *http.Response, error) {
	var (
