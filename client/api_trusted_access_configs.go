...
func (r TrustedAccessConfigsApiGetNetworkSmTrustedAccessConfigsRequest) Execute() ([]InlineResponse200144, *http.Response, error) {
...
func (a *TrustedAccessConfigsApiService) GetNetworkSmTrustedAccessConfigsExecute(r TrustedAccessConfigsApiGetNetworkSmTrustedAccessConfigsRequest) ([]InlineResponse200144, *http.Response, error) {
	var (
