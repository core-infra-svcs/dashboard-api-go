...
// InlineResponse200226MetaCountsItems Counts relating to the paginated items
type InlineResponse200226MetaCountsItems struct {
...
func NewInlineResponse200226MetaCountsItems() *InlineResponse200226MetaCountsItems {
	this := InlineResponse200226MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200226MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200226MetaCountsItems struct {
	value *InlineResponse200226MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200226MetaCountsItems) Get() *InlineResponse200226MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200226MetaCountsItems) Set(val *InlineResponse200226MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200226MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200226MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200226MetaCountsItems(val *InlineResponse200226MetaCountsItems) *NullableInlineResponse200226MetaCountsItems {
	return &NullableInlineResponse200226MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200226MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200226MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
