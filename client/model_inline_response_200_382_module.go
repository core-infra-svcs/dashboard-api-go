...
// InlineResponse200382Module The module of this wireless LAN controller interface
type InlineResponse200382Module struct {
...
func NewInlineResponse200382Module() *InlineResponse200382Module {
	this := InlineResponse200382Module{}
	return &this
}
...
func (o InlineResponse200382Module) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200382Module struct {
	value *InlineResponse200382Module
	isSet bool
}

func (v NullableInlineResponse200382Module) Get() *InlineResponse200382Module {
	return v.value
}

func (v *NullableInlineResponse200382Module) Set(val *InlineResponse200382Module) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200382Module) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200382Module) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200382Module(val *InlineResponse200382Module) *NullableInlineResponse200382Module {
	return &NullableInlineResponse200382Module{value: val, isSet: true}
}

func (v NullableInlineResponse200382Module) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200382Module) UnmarshalJSON(src []byte) error {
	v.isSet = true
