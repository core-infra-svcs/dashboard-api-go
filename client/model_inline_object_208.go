...
func (o *InlineObject208) GetAppliedOnDevices() []OrganizationsOrganizationIdCameraRolesAppliedOnDevices {
...
// and a boolean to check if the value has been set.
func (o *InlineObject208) GetAppliedOnDevicesOk() ([]OrganizationsOrganizationIdCameraRolesAppliedOnDevices, bool) {
	if o == nil || isNil(o.AppliedOnDevices) {
    return nil, false
	}
...
func (o *InlineObject208) HasAppliedOnDevices() bool {
	if o != nil && !isNil(o.AppliedOnDevices) {
		return true
	}
...
func (o *InlineObject208) SetAppliedOnDevices(v []OrganizationsOrganizationIdCameraRolesAppliedOnDevices) {
	o.AppliedOnDevices = v
}

// GetAppliedOnNetworks returns the AppliedOnNetworks field value if set, zero value otherwise.
func (o *InlineObject208) GetAppliedOnNetworks() []OrganizationsOrganizationIdCameraRolesRoleIdAppliedOnNetworks {
...
// and a boolean to check if the value has been set.
func (o *InlineObject208) GetAppliedOnNetworksOk() ([]OrganizationsOrganizationIdCameraRolesRoleIdAppliedOnNetworks, bool) {
	if o == nil || isNil(o.AppliedOnNetworks) {
    return nil, false
	}
...
func (o *InlineObject208) HasAppliedOnNetworks() bool {
	if o != nil && !isNil(o.AppliedOnNetworks) {
		return true
	}
...
func (o *InlineObject208) SetAppliedOnNetworks(v []OrganizationsOrganizationIdCameraRolesRoleIdAppliedOnNetworks) {
	o.AppliedOnNetworks = v
}

// GetAppliedOrgWide returns the AppliedOrgWide field value if set, zero value otherwise.
func (o *InlineObject208) GetAppliedOrgWide() []OrganizationsOrganizationIdCameraRolesAppliedOrgWide {
...
// and a boolean to check if the value has been set.
func (o *InlineObject208) GetAppliedOrgWideOk() ([]OrganizationsOrganizationIdCameraRolesAppliedOrgWide, bool) {
	if o == nil || isNil(o.AppliedOrgWide) {
    return nil, false
	}
...
func (o *InlineObject208) HasAppliedOrgWide() bool {
	if o != nil && !isNil(o.AppliedOrgWide) {
		return true
	}
...
func (o *InlineObject208) SetAppliedOrgWide(v []OrganizationsOrganizationIdCameraRolesAppliedOrgWide) {
	o.AppliedOrgWide = v
}
