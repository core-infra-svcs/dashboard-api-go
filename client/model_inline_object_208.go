...
func (o *InlineObject208) GetAdminSettings() OrganizationsOrganizationIdBrandingPoliciesAdminSettings {
...
// and a boolean to check if the value has been set.
func (o *InlineObject208) GetAdminSettingsOk() (*OrganizationsOrganizationIdBrandingPoliciesAdminSettings, bool) {
	if o == nil || isNil(o.AdminSettings) {
    return nil, false
	}
...
func (o *InlineObject208) HasAdminSettings() bool {
	if o != nil && !isNil(o.AdminSettings) {
		return true
	}
...
func (o *InlineObject208) SetAdminSettings(v OrganizationsOrganizationIdBrandingPoliciesAdminSettings) {
	o.AdminSettings = &v
}

// GetHelpSettings returns the HelpSettings field value if set, zero value otherwise.
func (o *InlineObject208) GetHelpSettings() OrganizationsOrganizationIdBrandingPoliciesHelpSettings1 {
...
// and a boolean to check if the value has been set.
func (o *InlineObject208) GetHelpSettingsOk() (*OrganizationsOrganizationIdBrandingPoliciesHelpSettings1, bool) {
	if o == nil || isNil(o.HelpSettings) {
    return nil, false
	}
...
func (o *InlineObject208) HasHelpSettings() bool {
	if o != nil && !isNil(o.HelpSettings) {
		return true
	}
...
func (o *InlineObject208) SetHelpSettings(v OrganizationsOrganizationIdBrandingPoliciesHelpSettings1) {
	o.HelpSettings = &v
}

// GetCustomLogo returns the CustomLogo field value if set, zero value otherwise.
func (o *InlineObject208) GetCustomLogo() OrganizationsOrganizationIdBrandingPoliciesCustomLogo1 {
...
// and a boolean to check if the value has been set.
func (o *InlineObject208) GetCustomLogoOk() (*OrganizationsOrganizationIdBrandingPoliciesCustomLogo1, bool) {
	if o == nil || isNil(o.CustomLogo) {
    return nil, false
	}
...
func (o *InlineObject208) HasCustomLogo() bool {
	if o != nil && !isNil(o.CustomLogo) {
		return true
	}
...
func (o *InlineObject208) SetCustomLogo(v OrganizationsOrganizationIdBrandingPoliciesCustomLogo1) {
	o.CustomLogo = &v
}
