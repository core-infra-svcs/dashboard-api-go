...
// InlineResponse20046CountsNoise Object containing the number of sensors that are currently alerting due to noise readings
type InlineResponse20046CountsNoise struct {
...
func NewInlineResponse20046CountsNoise() *InlineResponse20046CountsNoise {
	this := InlineResponse20046CountsNoise{}
	return &this
}
...
func (o InlineResponse20046CountsNoise) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20046CountsNoise struct {
	value *InlineResponse20046CountsNoise
	isSet bool
}

func (v NullableInlineResponse20046CountsNoise) Get() *InlineResponse20046CountsNoise {
	return v.value
}

func (v *NullableInlineResponse20046CountsNoise) Set(val *InlineResponse20046CountsNoise) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20046CountsNoise) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20046CountsNoise) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20046CountsNoise(val *InlineResponse20046CountsNoise) *NullableInlineResponse20046CountsNoise {
	return &NullableInlineResponse20046CountsNoise{value: val, isSet: true}
}

func (v NullableInlineResponse20046CountsNoise) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20046CountsNoise) UnmarshalJSON(src []byte) error {
	v.isSet = true
