...
// InlineResponse20057DynamicDns Dynamic DNS settings for a network
type InlineResponse20057DynamicDns struct {
	// Dynamic DNS enabled
...
func NewInlineResponse20057DynamicDns() *InlineResponse20057DynamicDns {
	this := InlineResponse20057DynamicDns{}
	return &this
}
...
func (o InlineResponse20057DynamicDns) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20057DynamicDns struct {
	value *InlineResponse20057DynamicDns
	isSet bool
}

func (v NullableInlineResponse20057DynamicDns) Get() *InlineResponse20057DynamicDns {
	return v.value
}

func (v *NullableInlineResponse20057DynamicDns) Set(val *InlineResponse20057DynamicDns) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20057DynamicDns) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20057DynamicDns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20057DynamicDns(val *InlineResponse20057DynamicDns) *NullableInlineResponse20057DynamicDns {
	return &NullableInlineResponse20057DynamicDns{value: val, isSet: true}
}

func (v NullableInlineResponse20057DynamicDns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20057DynamicDns) UnmarshalJSON(src []byte) error {
	v.isSet = true
