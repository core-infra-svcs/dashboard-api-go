...
func (r CampusGatewayApiGetOrganizationCampusGatewayClustersRequest) Execute() (*InlineResponse200257, *http.Response, error) {
...
func (a *CampusGatewayApiService) GetOrganizationCampusGatewayClustersExecute(r CampusGatewayApiGetOrganizationCampusGatewayClustersRequest) (*InlineResponse200257, *http.Response, error) {
	var (
...
func (r CampusGatewayApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest) Execute() (*InlineResponse200258, *http.Response, error) {
...
func (a *CampusGatewayApiService) GetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceExecute(r CampusGatewayApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest) (*InlineResponse200258, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
