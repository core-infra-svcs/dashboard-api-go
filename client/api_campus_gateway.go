...
func (r CampusGatewayApiGetOrganizationCampusGatewayClustersRequest) Execute() (*InlineResponse200265, *http.Response, error) {
...
func (a *CampusGatewayApiService) GetOrganizationCampusGatewayClustersExecute(r CampusGatewayApiGetOrganizationCampusGatewayClustersRequest) (*InlineResponse200265, *http.Response, error) {
	var (
...
func (r CampusGatewayApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest) Execute() (*InlineResponse200266, *http.Response, error) {
...
func (a *CampusGatewayApiService) GetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceExecute(r CampusGatewayApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest) (*InlineResponse200266, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
