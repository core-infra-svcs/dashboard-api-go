...
func (r CampusGatewayApiCreateNetworkCampusGatewayClusterRequest) Execute() (*InlineResponse20111, *http.Response, error) {
...
func (a *CampusGatewayApiService) CreateNetworkCampusGatewayClusterExecute(r CampusGatewayApiCreateNetworkCampusGatewayClusterRequest) (*InlineResponse20111, *http.Response, error) {
	var (
...
func (r CampusGatewayApiGetOrganizationCampusGatewayClustersRequest) Execute() (*InlineResponse200254, *http.Response, error) {
...
func (a *CampusGatewayApiService) GetOrganizationCampusGatewayClustersExecute(r CampusGatewayApiGetOrganizationCampusGatewayClustersRequest) (*InlineResponse200254, *http.Response, error) {
	var (
...
func (r CampusGatewayApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest) Execute() (*InlineResponse200255, *http.Response, error) {
...
func (a *CampusGatewayApiService) GetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceExecute(r CampusGatewayApiGetOrganizationCampusGatewayDevicesUplinksLocalOverridesByDeviceRequest) (*InlineResponse200255, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CampusGatewayApiUpdateNetworkCampusGatewayClusterRequest) Execute() (*InlineResponse20111, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20111
func (a *CampusGatewayApiService) UpdateNetworkCampusGatewayClusterExecute(r CampusGatewayApiUpdateNetworkCampusGatewayClusterRequest) (*InlineResponse20111, *http.Response, error) {
	var (
