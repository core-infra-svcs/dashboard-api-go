...
type InlineResponse200358Intervals struct {
	...
	Overall *InlineResponse200358Overall `json:"overall,omitempty"`
	// The CPU usage per core of the wireless LAN controller
	ByCore []InlineResponse200358ByCore `json:"byCore,omitempty"`
}
...
func (o *InlineResponse200358Intervals) GetOverall() InlineResponse200358Overall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200358Overall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200358Overall and assigns it to the Overall field.
...
func (o *InlineResponse200358Intervals) GetByCore() []InlineResponse200358ByCore {
	if o == nil || isNil(o.ByCore) {
		var ret []InlineResponse200358ByCore
		return ret
	}
	return o.ByCore
}
...
// SetByCore gets a reference to the given []InlineResponse200358ByCore and assigns it to the ByCore field.
