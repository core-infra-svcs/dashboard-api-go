...
func (r GatewaysApiGetOrganizationSensorGatewaysConnectionsLatestRequest) Execute() (*InlineResponse200315, *http.Response, error) {
...
func (a *GatewaysApiService) GetOrganizationSensorGatewaysConnectionsLatestExecute(r GatewaysApiGetOrganizationSensorGatewaysConnectionsLatestRequest) (*InlineResponse200315, *http.Response, error) {
	var (
