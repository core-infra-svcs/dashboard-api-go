...
func (r GatewaysApiGetOrganizationSensorGatewaysConnectionsLatestRequest) Execute() (*InlineResponse200342, *http.Response, error) {
...
func (a *GatewaysApiService) GetOrganizationSensorGatewaysConnectionsLatestExecute(r GatewaysApiGetOrganizationSensorGatewaysConnectionsLatestRequest) (*InlineResponse200342, *http.Response, error) {
	var (
