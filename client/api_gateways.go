...
func (r GatewaysApiGetOrganizationSensorGatewaysConnectionsLatestRequest) Execute() (*InlineResponse200319, *http.Response, error) {
...
func (a *GatewaysApiService) GetOrganizationSensorGatewaysConnectionsLatestExecute(r GatewaysApiGetOrganizationSensorGatewaysConnectionsLatestRequest) (*InlineResponse200319, *http.Response, error) {
	var (
