...
func (r GatewaysApiGetOrganizationSensorGatewaysConnectionsLatestRequest) Execute() (*InlineResponse200331, *http.Response, error) {
...
func (a *GatewaysApiService) GetOrganizationSensorGatewaysConnectionsLatestExecute(r GatewaysApiGetOrganizationSensorGatewaysConnectionsLatestRequest) (*InlineResponse200331, *http.Response, error) {
	var (
