...
// InlineResponse200270Network Information regarding the network the device belongs to
type InlineResponse200270Network struct {
	// The network ID
...
func NewInlineResponse200270Network() *InlineResponse200270Network {
	this := InlineResponse200270Network{}
	return &this
}
...
func (o InlineResponse200270Network) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200270Network struct {
	value *InlineResponse200270Network
	isSet bool
}

func (v NullableInlineResponse200270Network) Get() *InlineResponse200270Network {
	return v.value
}

func (v *NullableInlineResponse200270Network) Set(val *InlineResponse200270Network) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200270Network) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200270Network) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200270Network(val *InlineResponse200270Network) *NullableInlineResponse200270Network {
	return &NullableInlineResponse200270Network{value: val, isSet: true}
}

func (v NullableInlineResponse200270Network) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200270Network) UnmarshalJSON(src []byte) error {
	v.isSet = true
