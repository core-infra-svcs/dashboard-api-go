...
// InlineResponse20079UsageOverall Overall data usage of all clients across organization
type InlineResponse20079UsageOverall struct {
...
func NewInlineResponse20079UsageOverall() *InlineResponse20079UsageOverall {
	this := InlineResponse20079UsageOverall{}
	return &this
}
...
func (o InlineResponse20079UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20079UsageOverall struct {
	value *InlineResponse20079UsageOverall
	isSet bool
}

func (v NullableInlineResponse20079UsageOverall) Get() *InlineResponse20079UsageOverall {
	return v.value
}

func (v *NullableInlineResponse20079UsageOverall) Set(val *InlineResponse20079UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20079UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20079UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20079UsageOverall(val *InlineResponse20079UsageOverall) *NullableInlineResponse20079UsageOverall {
	return &NullableInlineResponse20079UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse20079UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20079UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
