...
func (r ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest) CreateDeviceLiveToolsThroughputTest(createDeviceLiveToolsThroughputTest InlineObject22) ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest {
	r.createDeviceLiveToolsThroughputTest = &createDeviceLiveToolsThroughputTest
	return r
}

func (r ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest) Execute() (*InlineResponse2017, *http.Response, error) {
...
func (a *ThroughputTestApiService) CreateDeviceLiveToolsThroughputTestExecute(r ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest) (*InlineResponse2017, *http.Response, error) {
	var (
...
func (r ThroughputTestApiGetDeviceLiveToolsThroughputTestRequest) Execute() (*InlineResponse20028, *http.Response, error) {
...
func (a *ThroughputTestApiService) GetDeviceLiveToolsThroughputTestExecute(r ThroughputTestApiGetDeviceLiveToolsThroughputTestRequest) (*InlineResponse20028, *http.Response, error) {
	var (
