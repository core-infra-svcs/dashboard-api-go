...
func (r ThroughputTestApiGetDeviceLiveToolsThroughputTestRequest) Execute() (*InlineResponse20025, *http.Response, error) {
...
func (a *ThroughputTestApiService) GetDeviceLiveToolsThroughputTestExecute(r ThroughputTestApiGetDeviceLiveToolsThroughputTestRequest) (*InlineResponse20025, *http.Response, error) {
	var (
