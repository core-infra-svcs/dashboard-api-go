...
func (r ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest) CreateDeviceLiveToolsThroughputTest(createDeviceLiveToolsThroughputTest InlineObject21) ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest {
	r.createDeviceLiveToolsThroughputTest = &createDeviceLiveToolsThroughputTest
	return r
}

func (r ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest) Execute() (*InlineResponse2016, *http.Response, error) {
...
func (a *ThroughputTestApiService) CreateDeviceLiveToolsThroughputTestExecute(r ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest) (*InlineResponse2016, *http.Response, error) {
	var (
...
func (r ThroughputTestApiGetDeviceLiveToolsThroughputTestRequest) Execute() (*InlineResponse20027, *http.Response, error) {
...
func (a *ThroughputTestApiService) GetDeviceLiveToolsThroughputTestExecute(r ThroughputTestApiGetDeviceLiveToolsThroughputTestRequest) (*InlineResponse20027, *http.Response, error) {
	var (
