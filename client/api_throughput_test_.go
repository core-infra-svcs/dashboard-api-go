...
func (r ThroughputTestApiGetDeviceLiveToolsThroughputTestRequest) Execute() (*InlineResponse20023, *http.Response, error) {
...
func (a *ThroughputTestApiService) GetDeviceLiveToolsThroughputTestExecute(r ThroughputTestApiGetDeviceLiveToolsThroughputTestRequest) (*InlineResponse20023, *http.Response, error) {
	var (
