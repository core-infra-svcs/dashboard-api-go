...
func (r ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest) CreateDeviceLiveToolsThroughputTest(createDeviceLiveToolsThroughputTest InlineObject23) ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest {
	r.createDeviceLiveToolsThroughputTest = &createDeviceLiveToolsThroughputTest
	return r
}

func (r ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest) Execute() (*InlineResponse2018, *http.Response, error) {
...
func (a *ThroughputTestApiService) CreateDeviceLiveToolsThroughputTestExecute(r ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest) (*InlineResponse2018, *http.Response, error) {
	var (
...
func (r ThroughputTestApiGetDeviceLiveToolsThroughputTestRequest) Execute() (*InlineResponse20029, *http.Response, error) {
...
func (a *ThroughputTestApiService) GetDeviceLiveToolsThroughputTestExecute(r ThroughputTestApiGetDeviceLiveToolsThroughputTestRequest) (*InlineResponse20029, *http.Response, error) {
	var (
