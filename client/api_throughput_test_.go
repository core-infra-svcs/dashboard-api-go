...
func (r ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest) Execute() (*InlineResponse2015, *http.Response, error) {
...
func (a *ThroughputTestApiService) CreateDeviceLiveToolsThroughputTestExecute(r ThroughputTestApiCreateDeviceLiveToolsThroughputTestRequest) (*InlineResponse2015, *http.Response, error) {
	var (
