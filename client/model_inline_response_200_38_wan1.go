...
// InlineResponse20038Wan1 WAN 1 settings
type InlineResponse20038Wan1 struct {
...
func (o *InlineResponse20038Wan1) SetVrfNil() {
	o.Vrf.Set(nil)
}
...
func (o InlineResponse20038Wan1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20038Wan1 struct {
	value *InlineResponse20038Wan1
	isSet bool
}

func (v NullableInlineResponse20038Wan1) Get() *InlineResponse20038Wan1 {
	return v.value
}

func (v *NullableInlineResponse20038Wan1) Set(val *InlineResponse20038Wan1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20038Wan1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20038Wan1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20038Wan1(val *InlineResponse20038Wan1) *NullableInlineResponse20038Wan1 {
	return &NullableInlineResponse20038Wan1{value: val, isSet: true}
}

func (v NullableInlineResponse20038Wan1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20038Wan1) UnmarshalJSON(src []byte) error {
	v.isSet = true
