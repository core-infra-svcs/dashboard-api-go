...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20026, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20026, *http.Response, error) {
	var (
