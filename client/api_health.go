...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse200105, *http.Response, error) {
...
// Deprecated
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse200105, *http.Response, error) {
	var (
