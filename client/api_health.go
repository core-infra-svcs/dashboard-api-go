...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20094, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20094, *http.Response, error) {
	var (
