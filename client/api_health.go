...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20057, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20057, *http.Response, error) {
	var (
