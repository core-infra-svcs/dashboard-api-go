...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20096, *http.Response, error) {
...
// Deprecated
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20096, *http.Response, error) {
	var (
