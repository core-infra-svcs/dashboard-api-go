...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20097, *http.Response, error) {
...
// Deprecated
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20097, *http.Response, error) {
	var (
