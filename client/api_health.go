...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20037, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20037, *http.Response, error) {
	var (
