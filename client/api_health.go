...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse200106, *http.Response, error) {
...
// Deprecated
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse200106, *http.Response, error) {
	var (
