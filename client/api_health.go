...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20048, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20048, *http.Response, error) {
	var (
