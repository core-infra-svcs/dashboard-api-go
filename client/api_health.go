...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20041, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20041, *http.Response, error) {
	var (
