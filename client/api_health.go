...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse200108, *http.Response, error) {
...
// Deprecated
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse200108, *http.Response, error) {
	var (
