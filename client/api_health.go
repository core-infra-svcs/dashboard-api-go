...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse200110, *http.Response, error) {
...
// Deprecated
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse200110, *http.Response, error) {
	var (
