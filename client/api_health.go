...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20042, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20042, *http.Response, error) {
	var (
