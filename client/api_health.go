...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse200113, *http.Response, error) {
...
// Deprecated
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse200113, *http.Response, error) {
	var (
