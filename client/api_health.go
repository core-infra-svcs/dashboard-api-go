...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20095, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20095, *http.Response, error) {
	var (
