...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20024, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20024, *http.Response, error) {
	var (
