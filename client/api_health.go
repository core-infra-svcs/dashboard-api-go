...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse200102, *http.Response, error) {
...
// Deprecated
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse200102, *http.Response, error) {
	var (
