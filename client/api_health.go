...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse200101, *http.Response, error) {
...
// Deprecated
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse200101, *http.Response, error) {
	var (
