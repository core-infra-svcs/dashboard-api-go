...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20043, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20043, *http.Response, error) {
	var (
