...
// InlineResponse200332Ports struct for InlineResponse200332Ports
type InlineResponse200332Ports struct {
	...
	SecurePort *InlineResponse200332SecurePort `json:"securePort,omitempty"`
}
...
func NewInlineResponse200332Ports() *InlineResponse200332Ports {
	this := InlineResponse200332Ports{}
	return &this
}
...
func (o *InlineResponse200332Ports) GetSecurePort() InlineResponse200332SecurePort {
	if o == nil || isNil(o.SecurePort) {
		var ret InlineResponse200332SecurePort
		return ret
	}
	return *o.SecurePort
}
...
// SetSecurePort gets a reference to the given InlineResponse200332SecurePort and assigns it to the SecurePort field.
func (o *InlineResponse200332Ports) SetSecurePort(v InlineResponse200332SecurePort) {
	o.SecurePort = &v
}

func (o InlineResponse200332Ports) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200332Ports struct {
	value *InlineResponse200332Ports
	isSet bool
}

func (v NullableInlineResponse200332Ports) Get() *InlineResponse200332Ports {
	return v.value
}

func (v *NullableInlineResponse200332Ports) Set(val *InlineResponse200332Ports) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200332Ports) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200332Ports) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200332Ports(val *InlineResponse200332Ports) *NullableInlineResponse200332Ports {
	return &NullableInlineResponse200332Ports{value: val, isSet: true}
}

func (v NullableInlineResponse200332Ports) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200332Ports) UnmarshalJSON(src []byte) error {
	v.isSet = true
