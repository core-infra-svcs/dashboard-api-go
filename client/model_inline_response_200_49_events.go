...
// InlineResponse20049Events struct for InlineResponse20049Events
type InlineResponse20049Events struct {
	...
	EventData *InlineResponse20049EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20049Events() *InlineResponse20049Events {
	this := InlineResponse20049Events{}
	return &this
}
...
func (o *InlineResponse20049Events) GetEventData() InlineResponse20049EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20049EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20049EventData and assigns it to the EventData field.
func (o *InlineResponse20049Events) SetEventData(v InlineResponse20049EventData) {
	o.EventData = &v
}

func (o InlineResponse20049Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20049Events struct {
	value *InlineResponse20049Events
	isSet bool
}

func (v NullableInlineResponse20049Events) Get() *InlineResponse20049Events {
	return v.value
}

func (v *NullableInlineResponse20049Events) Set(val *InlineResponse20049Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20049Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20049Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20049Events(val *InlineResponse20049Events) *NullableInlineResponse20049Events {
	return &NullableInlineResponse20049Events{value: val, isSet: true}
}

func (v NullableInlineResponse20049Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20049Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
