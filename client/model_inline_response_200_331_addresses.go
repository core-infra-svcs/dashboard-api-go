...
// InlineResponse200331Addresses struct for InlineResponse200331Addresses
type InlineResponse200331Addresses struct {
...
func NewInlineResponse200331Addresses() *InlineResponse200331Addresses {
	this := InlineResponse200331Addresses{}
	return &this
}
...
func (o InlineResponse200331Addresses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200331Addresses struct {
	value *InlineResponse200331Addresses
	isSet bool
}

func (v NullableInlineResponse200331Addresses) Get() *InlineResponse200331Addresses {
	return v.value
}

func (v *NullableInlineResponse200331Addresses) Set(val *InlineResponse200331Addresses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200331Addresses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200331Addresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200331Addresses(val *InlineResponse200331Addresses) *NullableInlineResponse200331Addresses {
	return &NullableInlineResponse200331Addresses{value: val, isSet: true}
}

func (v NullableInlineResponse200331Addresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200331Addresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
