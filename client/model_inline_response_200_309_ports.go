...
type InlineResponse200309Ports struct {
	...
	SecurePort *InlineResponse200309SecurePort `json:"securePort,omitempty"`
}
...
func (o *InlineResponse200309Ports) GetSecurePort() InlineResponse200309SecurePort {
	if o == nil || isNil(o.SecurePort) {
		var ret InlineResponse200309SecurePort
		return ret
	}
	return *o.SecurePort
}
...
// SetSecurePort gets a reference to the given InlineResponse200309SecurePort and assigns it to the SecurePort field.
