...
// InlineResponse200309Ports struct for InlineResponse200309Ports
type InlineResponse200309Ports struct {
	...
	Cdp []InlineResponse200309Cdp `json:"cdp,omitempty"`
	// The Link Layer Discovery Protocol (LLDP) information of the connected device.
	Lldp []InlineResponse200309Lldp `json:"lldp,omitempty"`
}
...
func NewInlineResponse200309Ports() *InlineResponse200309Ports {
	this := InlineResponse200309Ports{}
	return &this
}
...
func (o *InlineResponse200309Ports) GetCdp() []InlineResponse200309Cdp {
	if o == nil || isNil(o.Cdp) {
		var ret []InlineResponse200309Cdp
		return ret
	}
	return o.Cdp
}
...
// SetCdp gets a reference to the given []InlineResponse200309Cdp and assigns it to the Cdp field.
...
func (o *InlineResponse200309Ports) GetLldp() []InlineResponse200309Lldp {
	if o == nil || isNil(o.Lldp) {
		var ret []InlineResponse200309Lldp
		return ret
	}
	return o.Lldp
}
...
// SetLldp gets a reference to the given []InlineResponse200309Lldp and assigns it to the Lldp field.
func (o *InlineResponse200309Ports) SetLldp(v []InlineResponse200309Lldp) {
	o.Lldp = v
}

func (o InlineResponse200309Ports) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200309Ports struct {
	value *InlineResponse200309Ports
	isSet bool
}

func (v NullableInlineResponse200309Ports) Get() *InlineResponse200309Ports {
	return v.value
}

func (v *NullableInlineResponse200309Ports) Set(val *InlineResponse200309Ports) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200309Ports) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200309Ports) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200309Ports(val *InlineResponse200309Ports) *NullableInlineResponse200309Ports {
	return &NullableInlineResponse200309Ports{value: val, isSet: true}
}

func (v NullableInlineResponse200309Ports) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200309Ports) UnmarshalJSON(src []byte) error {
	v.isSet = true
