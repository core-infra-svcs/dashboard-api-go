...
// InlineResponse200140Rules struct for InlineResponse200140Rules
type InlineResponse200140Rules struct {
...
func NewInlineResponse200140Rules() *InlineResponse200140Rules {
	this := InlineResponse200140Rules{}
	return &this
}
...
func (o InlineResponse200140Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200140Rules struct {
	value *InlineResponse200140Rules
	isSet bool
}

func (v NullableInlineResponse200140Rules) Get() *InlineResponse200140Rules {
	return v.value
}

func (v *NullableInlineResponse200140Rules) Set(val *InlineResponse200140Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200140Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200140Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200140Rules(val *InlineResponse200140Rules) *NullableInlineResponse200140Rules {
	return &NullableInlineResponse200140Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200140Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200140Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
