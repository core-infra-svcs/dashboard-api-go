...
func (r V4ApiGetNetworkSwitchDhcpV4ServersSeenRequest) Execute() ([]InlineResponse200156, *http.Response, error) {
...
func (a *V4ApiService) GetNetworkSwitchDhcpV4ServersSeenExecute(r V4ApiGetNetworkSwitchDhcpV4ServersSeenRequest) ([]InlineResponse200156, *http.Response, error) {
	var (
