...
func (r V4ApiGetNetworkSwitchDhcpV4ServersSeenRequest) Execute() ([]InlineResponse20055, *http.Response, error) {
...
func (a *V4ApiService) GetNetworkSwitchDhcpV4ServersSeenExecute(r V4ApiGetNetworkSwitchDhcpV4ServersSeenRequest) ([]InlineResponse20055, *http.Response, error) {
	var (
