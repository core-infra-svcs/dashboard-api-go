...
// InlineResponse200119ResultingNetwork Network after the combination
type InlineResponse200119ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200119ResultingNetwork() *InlineResponse200119ResultingNetwork {
	this := InlineResponse200119ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200119ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200119ResultingNetwork struct {
	value *InlineResponse200119ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200119ResultingNetwork) Get() *InlineResponse200119ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200119ResultingNetwork) Set(val *InlineResponse200119ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200119ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200119ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200119ResultingNetwork(val *InlineResponse200119ResultingNetwork) *NullableInlineResponse200119ResultingNetwork {
	return &NullableInlineResponse200119ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200119ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200119ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
