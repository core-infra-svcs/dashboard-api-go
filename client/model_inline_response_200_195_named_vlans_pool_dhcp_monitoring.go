...
// InlineResponse200195NamedVlansPoolDhcpMonitoring Named VLAN Pool DHCP Monitoring settings.
type InlineResponse200195NamedVlansPoolDhcpMonitoring struct {
...
func NewInlineResponse200195NamedVlansPoolDhcpMonitoring() *InlineResponse200195NamedVlansPoolDhcpMonitoring {
	this := InlineResponse200195NamedVlansPoolDhcpMonitoring{}
	return &this
}
...
func (o InlineResponse200195NamedVlansPoolDhcpMonitoring) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200195NamedVlansPoolDhcpMonitoring struct {
	value *InlineResponse200195NamedVlansPoolDhcpMonitoring
	isSet bool
}

func (v NullableInlineResponse200195NamedVlansPoolDhcpMonitoring) Get() *InlineResponse200195NamedVlansPoolDhcpMonitoring {
	return v.value
}

func (v *NullableInlineResponse200195NamedVlansPoolDhcpMonitoring) Set(val *InlineResponse200195NamedVlansPoolDhcpMonitoring) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200195NamedVlansPoolDhcpMonitoring) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200195NamedVlansPoolDhcpMonitoring) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200195NamedVlansPoolDhcpMonitoring(val *InlineResponse200195NamedVlansPoolDhcpMonitoring) *NullableInlineResponse200195NamedVlansPoolDhcpMonitoring {
	return &NullableInlineResponse200195NamedVlansPoolDhcpMonitoring{value: val, isSet: true}
}

func (v NullableInlineResponse200195NamedVlansPoolDhcpMonitoring) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200195NamedVlansPoolDhcpMonitoring) UnmarshalJSON(src []byte) error {
	v.isSet = true
