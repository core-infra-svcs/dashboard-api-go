...
// InlineResponse200114SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200114SixGhzSettings struct {
...
func NewInlineResponse200114SixGhzSettings() *InlineResponse200114SixGhzSettings {
	this := InlineResponse200114SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200114SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200114SixGhzSettings struct {
	value *InlineResponse200114SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200114SixGhzSettings) Get() *InlineResponse200114SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200114SixGhzSettings) Set(val *InlineResponse200114SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200114SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200114SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200114SixGhzSettings(val *InlineResponse200114SixGhzSettings) *NullableInlineResponse200114SixGhzSettings {
	return &NullableInlineResponse200114SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200114SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200114SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
