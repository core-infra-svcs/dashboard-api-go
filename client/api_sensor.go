...
func (r SensorApiGetOrganizationSensorReadingsHistoryRequest) Execute() ([]InlineResponse200301, *http.Response, error) {
...
func (a *SensorApiService) GetOrganizationSensorReadingsHistoryExecute(r SensorApiGetOrganizationSensorReadingsHistoryRequest) ([]InlineResponse200301, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SensorApiGetOrganizationSensorReadingsLatestRequest) Execute() ([]InlineResponse200302, *http.Response, error) {
...
func (a *SensorApiService) GetOrganizationSensorReadingsLatestExecute(r SensorApiGetOrganizationSensorReadingsLatestRequest) ([]InlineResponse200302, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
