...
// InlineResponse20110Addresses1 struct for InlineResponse20110Addresses1
type InlineResponse20110Addresses1 struct {
...
func NewInlineResponse20110Addresses1() *InlineResponse20110Addresses1 {
	this := InlineResponse20110Addresses1{}
	return &this
}
...
func (o InlineResponse20110Addresses1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20110Addresses1 struct {
	value *InlineResponse20110Addresses1
	isSet bool
}

func (v NullableInlineResponse20110Addresses1) Get() *InlineResponse20110Addresses1 {
	return v.value
}

func (v *NullableInlineResponse20110Addresses1) Set(val *InlineResponse20110Addresses1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20110Addresses1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20110Addresses1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20110Addresses1(val *InlineResponse20110Addresses1) *NullableInlineResponse20110Addresses1 {
	return &NullableInlineResponse20110Addresses1{value: val, isSet: true}
}

func (v NullableInlineResponse20110Addresses1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20110Addresses1) UnmarshalJSON(src []byte) error {
	v.isSet = true
