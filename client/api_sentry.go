...
func (r SentryApiGetOrganizationSmSentryPoliciesAssignmentsByNetworkRequest) Execute() ([]InlineResponse200273, *http.Response, error) {
...
func (a *SentryApiService) GetOrganizationSmSentryPoliciesAssignmentsByNetworkExecute(r SentryApiGetOrganizationSmSentryPoliciesAssignmentsByNetworkRequest) ([]InlineResponse200273, *http.Response, error) {
	var (
...
func (r SentryApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) Execute() (*InlineResponse200272, *http.Response, error) {
...
func (a *SentryApiService) UpdateOrganizationSmSentryPoliciesAssignmentsExecute(r SentryApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) (*InlineResponse200272, *http.Response, error) {
	var (
