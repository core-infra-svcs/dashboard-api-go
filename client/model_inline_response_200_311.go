...
func (o *InlineResponse200311) GetTotal() float32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200311) GetTotalOk() (*float32, bool) {
	if o == nil || isNil(o.Total) {
    return nil, false
	}
	return o.Total, true
...
func (o *InlineResponse200311) HasTotal() bool {
	if o != nil && !isNil(o.Total) {
		return true
	}
...
func (o *InlineResponse200311) SetTotal(v float32) {
	o.Total = &v
}

// GetDownstream returns the Downstream field value if set, zero value otherwise.
func (o *InlineResponse200311) GetDownstream() float32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200311) GetDownstreamOk() (*float32, bool) {
	if o == nil || isNil(o.Downstream) {
    return nil, false
	}
...
func (o *InlineResponse200311) SetDownstream(v float32) {
	o.Downstream = &v
}

// GetUpstream returns the Upstream field value if set, zero value otherwise.
func (o *InlineResponse200311) GetUpstream() float32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200311) GetUpstreamOk() (*float32, bool) {
	if o == nil || isNil(o.Upstream) {
    return nil, false
	}
...
func (o *InlineResponse200311) SetUpstream(v float32) {
	o.Upstream = &v
}

// GetPercentage returns the Percentage field value if set, zero value otherwise.
func (o *InlineResponse200311) GetPercentage() float32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200311) GetPercentageOk() (*float32, bool) {
	if o == nil || isNil(o.Percentage) {
    return nil, false
	}
...
func (o *InlineResponse200311) HasPercentage() bool {
	if o != nil && !isNil(o.Percentage) {
		return true
	}
...
func (o *InlineResponse200311) SetPercentage(v float32) {
	o.Percentage = &v
}
