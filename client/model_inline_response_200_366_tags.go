...
// InlineResponse200366Tags struct for InlineResponse200366Tags
type InlineResponse200366Tags struct {
	// Policy tag
...
func (o InlineResponse200366Tags) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200366Tags struct {
	value *InlineResponse200366Tags
	isSet bool
}

func (v NullableInlineResponse200366Tags) Get() *InlineResponse200366Tags {
	return v.value
}

func (v *NullableInlineResponse200366Tags) Set(val *InlineResponse200366Tags) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200366Tags) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200366Tags) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200366Tags(val *InlineResponse200366Tags) *NullableInlineResponse200366Tags {
	return &NullableInlineResponse200366Tags{value: val, isSet: true}
}

func (v NullableInlineResponse200366Tags) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200366Tags) UnmarshalJSON(src []byte) error {
	v.isSet = true
