...
// InlineResponse200159CustomPieChartItems struct for InlineResponse200159CustomPieChartItems
type InlineResponse200159CustomPieChartItems struct {
...
func NewInlineResponse200159CustomPieChartItems(name string, type_ string, value string) *InlineResponse200159CustomPieChartItems {
	this := InlineResponse200159CustomPieChartItems{}
	this.Name = name
	this.Type = type_
	this.Value = value
	return &this
...
func (o InlineResponse200159CustomPieChartItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200159CustomPieChartItems struct {
	value *InlineResponse200159CustomPieChartItems
	isSet bool
}

func (v NullableInlineResponse200159CustomPieChartItems) Get() *InlineResponse200159CustomPieChartItems {
	return v.value
}

func (v *NullableInlineResponse200159CustomPieChartItems) Set(val *InlineResponse200159CustomPieChartItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200159CustomPieChartItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200159CustomPieChartItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200159CustomPieChartItems(val *InlineResponse200159CustomPieChartItems) *NullableInlineResponse200159CustomPieChartItems {
	return &NullableInlineResponse200159CustomPieChartItems{value: val, isSet: true}
}

func (v NullableInlineResponse200159CustomPieChartItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200159CustomPieChartItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
