...
// InlineResponse20094ProductsWirelessCurrentVersion Details of the current version on the device
type InlineResponse20094ProductsWirelessCurrentVersion struct {
...
func NewInlineResponse20094ProductsWirelessCurrentVersion() *InlineResponse20094ProductsWirelessCurrentVersion {
	this := InlineResponse20094ProductsWirelessCurrentVersion{}
	return &this
}
...
func (o InlineResponse20094ProductsWirelessCurrentVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20094ProductsWirelessCurrentVersion struct {
	value *InlineResponse20094ProductsWirelessCurrentVersion
	isSet bool
}

func (v NullableInlineResponse20094ProductsWirelessCurrentVersion) Get() *InlineResponse20094ProductsWirelessCurrentVersion {
	return v.value
}

func (v *NullableInlineResponse20094ProductsWirelessCurrentVersion) Set(val *InlineResponse20094ProductsWirelessCurrentVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20094ProductsWirelessCurrentVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20094ProductsWirelessCurrentVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20094ProductsWirelessCurrentVersion(val *InlineResponse20094ProductsWirelessCurrentVersion) *NullableInlineResponse20094ProductsWirelessCurrentVersion {
	return &NullableInlineResponse20094ProductsWirelessCurrentVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20094ProductsWirelessCurrentVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20094ProductsWirelessCurrentVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
