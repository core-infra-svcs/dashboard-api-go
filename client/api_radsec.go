...
func (r RadsecApiCreateOrganizationWirelessDevicesRadsecCertificatesAuthorityRequest) Execute() (*InlineResponse200358, *http.Response, error) {
...
func (a *RadsecApiService) CreateOrganizationWirelessDevicesRadsecCertificatesAuthorityExecute(r RadsecApiCreateOrganizationWirelessDevicesRadsecCertificatesAuthorityRequest) (*InlineResponse200358, *http.Response, error) {
	var (
...
func (r RadsecApiGetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesRequest) Execute() ([]InlineResponse200357, *http.Response, error) {
...
func (a *RadsecApiService) GetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesExecute(r RadsecApiGetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesRequest) ([]InlineResponse200357, *http.Response, error) {
	var (
...
func (r RadsecApiGetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrlsRequest) Execute() (*InlineResponse200359, *http.Response, error) {
...
func (a *RadsecApiService) GetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrlsExecute(r RadsecApiGetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrlsRequest) (*InlineResponse200359, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RadsecApiGetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrlsDeltasRequest) Execute() (*InlineResponse200359, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200359
func (a *RadsecApiService) GetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrlsDeltasExecute(r RadsecApiGetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrlsDeltasRequest) (*InlineResponse200359, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RadsecApiUpdateOrganizationWirelessDevicesRadsecCertificatesAuthoritiesRequest) Execute() (*InlineResponse200358, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200358
func (a *RadsecApiService) UpdateOrganizationWirelessDevicesRadsecCertificatesAuthoritiesExecute(r RadsecApiUpdateOrganizationWirelessDevicesRadsecCertificatesAuthoritiesRequest) (*InlineResponse200358, *http.Response, error) {
	var (
