...
// InlineResponse20035ProductsWirelessLastUpgradeToVersion Details of the version the device upgraded to
type InlineResponse20035ProductsWirelessLastUpgradeToVersion struct {
...
func NewInlineResponse20035ProductsWirelessLastUpgradeToVersion() *InlineResponse20035ProductsWirelessLastUpgradeToVersion {
	this := InlineResponse20035ProductsWirelessLastUpgradeToVersion{}
	return &this
}
...
func (o InlineResponse20035ProductsWirelessLastUpgradeToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20035ProductsWirelessLastUpgradeToVersion struct {
	value *InlineResponse20035ProductsWirelessLastUpgradeToVersion
	isSet bool
}

func (v NullableInlineResponse20035ProductsWirelessLastUpgradeToVersion) Get() *InlineResponse20035ProductsWirelessLastUpgradeToVersion {
	return v.value
}

func (v *NullableInlineResponse20035ProductsWirelessLastUpgradeToVersion) Set(val *InlineResponse20035ProductsWirelessLastUpgradeToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20035ProductsWirelessLastUpgradeToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20035ProductsWirelessLastUpgradeToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20035ProductsWirelessLastUpgradeToVersion(val *InlineResponse20035ProductsWirelessLastUpgradeToVersion) *NullableInlineResponse20035ProductsWirelessLastUpgradeToVersion {
	return &NullableInlineResponse20035ProductsWirelessLastUpgradeToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20035ProductsWirelessLastUpgradeToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20035ProductsWirelessLastUpgradeToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
