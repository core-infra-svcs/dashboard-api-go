...
// InlineResponse200235MetaCountsItems Counts relating to the paginated items
type InlineResponse200235MetaCountsItems struct {
...
func NewInlineResponse200235MetaCountsItems() *InlineResponse200235MetaCountsItems {
	this := InlineResponse200235MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200235MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200235MetaCountsItems struct {
	value *InlineResponse200235MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200235MetaCountsItems) Get() *InlineResponse200235MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200235MetaCountsItems) Set(val *InlineResponse200235MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200235MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200235MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200235MetaCountsItems(val *InlineResponse200235MetaCountsItems) *NullableInlineResponse200235MetaCountsItems {
	return &NullableInlineResponse200235MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200235MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200235MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
