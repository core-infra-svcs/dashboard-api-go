...
// InlineResponse200307Ssid Wireless access point and network identifier.
type InlineResponse200307Ssid struct {
...
func (o InlineResponse200307Ssid) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200307Ssid struct {
	value *InlineResponse200307Ssid
	isSet bool
}

func (v NullableInlineResponse200307Ssid) Get() *InlineResponse200307Ssid {
	return v.value
}

func (v *NullableInlineResponse200307Ssid) Set(val *InlineResponse200307Ssid) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200307Ssid) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200307Ssid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200307Ssid(val *InlineResponse200307Ssid) *NullableInlineResponse200307Ssid {
	return &NullableInlineResponse200307Ssid{value: val, isSet: true}
}

func (v NullableInlineResponse200307Ssid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200307Ssid) UnmarshalJSON(src []byte) error {
	v.isSet = true
