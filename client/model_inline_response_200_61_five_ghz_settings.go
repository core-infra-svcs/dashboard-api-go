...
// InlineResponse20061FiveGhzSettings Settings related to 5Ghz band.
type InlineResponse20061FiveGhzSettings struct {
...
func NewInlineResponse20061FiveGhzSettings() *InlineResponse20061FiveGhzSettings {
	this := InlineResponse20061FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse20061FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20061FiveGhzSettings struct {
	value *InlineResponse20061FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse20061FiveGhzSettings) Get() *InlineResponse20061FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse20061FiveGhzSettings) Set(val *InlineResponse20061FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20061FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20061FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20061FiveGhzSettings(val *InlineResponse20061FiveGhzSettings) *NullableInlineResponse20061FiveGhzSettings {
	return &NullableInlineResponse20061FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20061FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20061FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
