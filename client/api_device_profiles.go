...
func (r DeviceProfilesApiGetNetworkSmDeviceDeviceProfilesRequest) Execute() ([]InlineResponse200121, *http.Response, error) {
...
func (a *DeviceProfilesApiService) GetNetworkSmDeviceDeviceProfilesExecute(r DeviceProfilesApiGetNetworkSmDeviceDeviceProfilesRequest) ([]InlineResponse200121, *http.Response, error) {
	var (
...
func (r DeviceProfilesApiGetNetworkSmUserDeviceProfilesRequest) Execute() ([]InlineResponse200121, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200121
func (a *DeviceProfilesApiService) GetNetworkSmUserDeviceProfilesExecute(r DeviceProfilesApiGetNetworkSmUserDeviceProfilesRequest) ([]InlineResponse200121, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
