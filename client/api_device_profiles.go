...
func (r DeviceProfilesApiGetNetworkSmDeviceDeviceProfilesRequest) Execute() ([]InlineResponse20064, *http.Response, error) {
...
func (a *DeviceProfilesApiService) GetNetworkSmDeviceDeviceProfilesExecute(r DeviceProfilesApiGetNetworkSmDeviceDeviceProfilesRequest) ([]InlineResponse20064, *http.Response, error) {
	var (
...
func (r DeviceProfilesApiGetNetworkSmUserDeviceProfilesRequest) Execute() ([]InlineResponse20064, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20064
func (a *DeviceProfilesApiService) GetNetworkSmUserDeviceProfilesExecute(r DeviceProfilesApiGetNetworkSmUserDeviceProfilesRequest) ([]InlineResponse20064, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
