...
func (r DeviceProfilesApiGetNetworkSmDeviceDeviceProfilesRequest) Execute() ([]InlineResponse20045, *http.Response, error) {
...
func (a *DeviceProfilesApiService) GetNetworkSmDeviceDeviceProfilesExecute(r DeviceProfilesApiGetNetworkSmDeviceDeviceProfilesRequest) ([]InlineResponse20045, *http.Response, error) {
	var (
...
func (r DeviceProfilesApiGetNetworkSmUserDeviceProfilesRequest) Execute() ([]InlineResponse20045, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20045
func (a *DeviceProfilesApiService) GetNetworkSmUserDeviceProfilesExecute(r DeviceProfilesApiGetNetworkSmUserDeviceProfilesRequest) ([]InlineResponse20045, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
