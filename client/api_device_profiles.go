...
func (r DeviceProfilesApiGetNetworkSmDeviceDeviceProfilesRequest) Execute() ([]InlineResponse20070, *http.Response, error) {
...
func (a *DeviceProfilesApiService) GetNetworkSmDeviceDeviceProfilesExecute(r DeviceProfilesApiGetNetworkSmDeviceDeviceProfilesRequest) ([]InlineResponse20070, *http.Response, error) {
	var (
...
func (r DeviceProfilesApiGetNetworkSmUserDeviceProfilesRequest) Execute() ([]InlineResponse20070, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20070
func (a *DeviceProfilesApiService) GetNetworkSmUserDeviceProfilesExecute(r DeviceProfilesApiGetNetworkSmUserDeviceProfilesRequest) ([]InlineResponse20070, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
