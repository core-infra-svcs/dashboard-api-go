...
// InlineResponse20020Results struct for InlineResponse20020Results
type InlineResponse20020Results struct {
	...
	Pairs []InlineResponse20020Pairs `json:"pairs,omitempty"`
}
...
func NewInlineResponse20020Results() *InlineResponse20020Results {
	this := InlineResponse20020Results{}
	return &this
}
...
func (o *InlineResponse20020Results) GetPairs() []InlineResponse20020Pairs {
	if o == nil || isNil(o.Pairs) {
		var ret []InlineResponse20020Pairs
		return ret
	}
	return o.Pairs
}
...
// SetPairs gets a reference to the given []InlineResponse20020Pairs and assigns it to the Pairs field.
func (o *InlineResponse20020Results) SetPairs(v []InlineResponse20020Pairs) {
	o.Pairs = v
}

func (o InlineResponse20020Results) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20020Results struct {
	value *InlineResponse20020Results
	isSet bool
}

func (v NullableInlineResponse20020Results) Get() *InlineResponse20020Results {
	return v.value
}

func (v *NullableInlineResponse20020Results) Set(val *InlineResponse20020Results) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20020Results) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20020Results) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20020Results(val *InlineResponse20020Results) *NullableInlineResponse20020Results {
	return &NullableInlineResponse20020Results{value: val, isSet: true}
}

func (v NullableInlineResponse20020Results) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20020Results) UnmarshalJSON(src []byte) error {
	v.isSet = true
