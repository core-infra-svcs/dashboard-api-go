...
// InlineResponse20020Entries struct for InlineResponse20020Entries
type InlineResponse20020Entries struct {
...
func NewInlineResponse20020Entries() *InlineResponse20020Entries {
	this := InlineResponse20020Entries{}
	return &this
}
...
func (o InlineResponse20020Entries) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20020Entries struct {
	value *InlineResponse20020Entries
	isSet bool
}

func (v NullableInlineResponse20020Entries) Get() *InlineResponse20020Entries {
	return v.value
}

func (v *NullableInlineResponse20020Entries) Set(val *InlineResponse20020Entries) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20020Entries) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20020Entries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20020Entries(val *InlineResponse20020Entries) *NullableInlineResponse20020Entries {
	return &NullableInlineResponse20020Entries{value: val, isSet: true}
}

func (v NullableInlineResponse20020Entries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20020Entries) UnmarshalJSON(src []byte) error {
	v.isSet = true
