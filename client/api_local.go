...
func (r LocalApiCreateOrganizationApplianceDnsLocalProfilesAssignmentsBulkCreateRequest) Execute() (*InlineResponse200221, *http.Response, error) {
...
func (a *LocalApiService) CreateOrganizationApplianceDnsLocalProfilesAssignmentsBulkCreateExecute(r LocalApiCreateOrganizationApplianceDnsLocalProfilesAssignmentsBulkCreateRequest) (*InlineResponse200221, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
