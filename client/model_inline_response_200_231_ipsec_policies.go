...
// InlineResponse200231IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200231IpsecPolicies struct {
...
func NewInlineResponse200231IpsecPolicies() *InlineResponse200231IpsecPolicies {
	this := InlineResponse200231IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200231IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200231IpsecPolicies struct {
	value *InlineResponse200231IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200231IpsecPolicies) Get() *InlineResponse200231IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200231IpsecPolicies) Set(val *InlineResponse200231IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200231IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200231IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200231IpsecPolicies(val *InlineResponse200231IpsecPolicies) *NullableInlineResponse200231IpsecPolicies {
	return &NullableInlineResponse200231IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200231IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200231IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
