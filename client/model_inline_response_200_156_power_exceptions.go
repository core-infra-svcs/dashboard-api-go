...
// InlineResponse200156PowerExceptions struct for InlineResponse200156PowerExceptions
type InlineResponse200156PowerExceptions struct {
...
func NewInlineResponse200156PowerExceptions() *InlineResponse200156PowerExceptions {
	this := InlineResponse200156PowerExceptions{}
	return &this
}
...
func (o InlineResponse200156PowerExceptions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200156PowerExceptions struct {
	value *InlineResponse200156PowerExceptions
	isSet bool
}

func (v NullableInlineResponse200156PowerExceptions) Get() *InlineResponse200156PowerExceptions {
	return v.value
}

func (v *NullableInlineResponse200156PowerExceptions) Set(val *InlineResponse200156PowerExceptions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200156PowerExceptions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200156PowerExceptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200156PowerExceptions(val *InlineResponse200156PowerExceptions) *NullableInlineResponse200156PowerExceptions {
	return &NullableInlineResponse200156PowerExceptions{value: val, isSet: true}
}

func (v NullableInlineResponse200156PowerExceptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200156PowerExceptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
