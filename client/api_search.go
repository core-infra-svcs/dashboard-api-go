...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200230, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200230, *http.Response, error) {
	var (
