...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200237, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200237, *http.Response, error) {
	var (
