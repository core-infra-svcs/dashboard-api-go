...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200266, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200266, *http.Response, error) {
	var (
