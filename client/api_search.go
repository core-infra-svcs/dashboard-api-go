...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200256, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200256, *http.Response, error) {
	var (
