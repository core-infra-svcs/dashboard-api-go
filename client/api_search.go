...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200277, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200277, *http.Response, error) {
	var (
