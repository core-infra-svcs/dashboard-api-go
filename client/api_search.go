...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200242, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200242, *http.Response, error) {
	var (
