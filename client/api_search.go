...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200254, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200254, *http.Response, error) {
	var (
