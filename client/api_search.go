...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200276, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200276, *http.Response, error) {
	var (
