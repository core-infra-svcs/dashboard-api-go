...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200231, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200231, *http.Response, error) {
	var (
