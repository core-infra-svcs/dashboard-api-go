...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200221, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200221, *http.Response, error) {
	var (
