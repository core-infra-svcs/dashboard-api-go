...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200228, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200228, *http.Response, error) {
	var (
