...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200285, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200285, *http.Response, error) {
	var (
