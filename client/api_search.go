...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200268, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200268, *http.Response, error) {
	var (
