...
func (r SearchApiGetOrganizationClientsSearchRequest) Execute() (*InlineResponse200264, *http.Response, error) {
...
func (a *SearchApiService) GetOrganizationClientsSearchExecute(r SearchApiGetOrganizationClientsSearchRequest) (*InlineResponse200264, *http.Response, error) {
	var (
