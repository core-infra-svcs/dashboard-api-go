...
// InlineResponse200154UsageOverall Overall data usage of all clients across organization
type InlineResponse200154UsageOverall struct {
...
func NewInlineResponse200154UsageOverall() *InlineResponse200154UsageOverall {
	this := InlineResponse200154UsageOverall{}
	return &this
}
...
func (o InlineResponse200154UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200154UsageOverall struct {
	value *InlineResponse200154UsageOverall
	isSet bool
}

func (v NullableInlineResponse200154UsageOverall) Get() *InlineResponse200154UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200154UsageOverall) Set(val *InlineResponse200154UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200154UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200154UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200154UsageOverall(val *InlineResponse200154UsageOverall) *NullableInlineResponse200154UsageOverall {
	return &NullableInlineResponse200154UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200154UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200154UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
