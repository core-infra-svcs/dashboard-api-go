...
type InlineResponse200382Interfaces struct {
	...
	Changes []InlineResponse200382Changes `json:"changes,omitempty"`
}
...
func (o *InlineResponse200382Interfaces) GetChanges() []InlineResponse200382Changes {
	if o == nil || isNil(o.Changes) {
		var ret []InlineResponse200382Changes
		return ret
	}
	return o.Changes
}
...
// SetChanges gets a reference to the given []InlineResponse200382Changes and assigns it to the Changes field.
