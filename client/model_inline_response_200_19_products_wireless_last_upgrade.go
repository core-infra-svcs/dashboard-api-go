...
// InlineResponse20019ProductsWirelessLastUpgrade Details of the last firmware upgrade on the device
type InlineResponse20019ProductsWirelessLastUpgrade struct {
	// Timestamp of the last successful firmware upgrade
	Time *time.Time `json:"time,omitempty"`
	FromVersion *InlineResponse20019ProductsWirelessLastUpgradeFromVersion `json:"fromVersion,omitempty"`
	ToVersion *InlineResponse20019ProductsWirelessLastUpgradeToVersion `json:"toVersion,omitempty"`
}
...
func NewInlineResponse20019ProductsWirelessLastUpgrade() *InlineResponse20019ProductsWirelessLastUpgrade {
	this := InlineResponse20019ProductsWirelessLastUpgrade{}
	return &this
}
...
func (o *InlineResponse20019ProductsWirelessLastUpgrade) GetFromVersion() InlineResponse20019ProductsWirelessLastUpgradeFromVersion {
	if o == nil || isNil(o.FromVersion) {
		var ret InlineResponse20019ProductsWirelessLastUpgradeFromVersion
		return ret
	}
...
// SetFromVersion gets a reference to the given InlineResponse20019ProductsWirelessLastUpgradeFromVersion and assigns it to the FromVersion field.
...
func (o *InlineResponse20019ProductsWirelessLastUpgrade) GetToVersion() InlineResponse20019ProductsWirelessLastUpgradeToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20019ProductsWirelessLastUpgradeToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20019ProductsWirelessLastUpgradeToVersion and assigns it to the ToVersion field.
...
func (o InlineResponse20019ProductsWirelessLastUpgrade) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20019ProductsWirelessLastUpgrade struct {
	value *InlineResponse20019ProductsWirelessLastUpgrade
	isSet bool
}

func (v NullableInlineResponse20019ProductsWirelessLastUpgrade) Get() *InlineResponse20019ProductsWirelessLastUpgrade {
	return v.value
}

func (v *NullableInlineResponse20019ProductsWirelessLastUpgrade) Set(val *InlineResponse20019ProductsWirelessLastUpgrade) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20019ProductsWirelessLastUpgrade) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20019ProductsWirelessLastUpgrade) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20019ProductsWirelessLastUpgrade(val *InlineResponse20019ProductsWirelessLastUpgrade) *NullableInlineResponse20019ProductsWirelessLastUpgrade {
	return &NullableInlineResponse20019ProductsWirelessLastUpgrade{value: val, isSet: true}
}

func (v NullableInlineResponse20019ProductsWirelessLastUpgrade) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20019ProductsWirelessLastUpgrade) UnmarshalJSON(src []byte) error {
	v.isSet = true
