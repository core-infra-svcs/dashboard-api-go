...
// InlineResponse200212MerakiVpnPeers struct for InlineResponse200212MerakiVpnPeers
type InlineResponse200212MerakiVpnPeers struct {
	// Network ID
...
func NewInlineResponse200212MerakiVpnPeers() *InlineResponse200212MerakiVpnPeers {
	this := InlineResponse200212MerakiVpnPeers{}
	return &this
}
...
func (o InlineResponse200212MerakiVpnPeers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200212MerakiVpnPeers struct {
	value *InlineResponse200212MerakiVpnPeers
	isSet bool
}

func (v NullableInlineResponse200212MerakiVpnPeers) Get() *InlineResponse200212MerakiVpnPeers {
	return v.value
}

func (v *NullableInlineResponse200212MerakiVpnPeers) Set(val *InlineResponse200212MerakiVpnPeers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200212MerakiVpnPeers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200212MerakiVpnPeers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200212MerakiVpnPeers(val *InlineResponse200212MerakiVpnPeers) *NullableInlineResponse200212MerakiVpnPeers {
	return &NullableInlineResponse200212MerakiVpnPeers{value: val, isSet: true}
}

func (v NullableInlineResponse200212MerakiVpnPeers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200212MerakiVpnPeers) UnmarshalJSON(src []byte) error {
	v.isSet = true
