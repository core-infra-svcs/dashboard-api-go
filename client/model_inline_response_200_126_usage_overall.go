...
// InlineResponse200126UsageOverall Overall data usage of all clients across organization
type InlineResponse200126UsageOverall struct {
...
func NewInlineResponse200126UsageOverall() *InlineResponse200126UsageOverall {
	this := InlineResponse200126UsageOverall{}
	return &this
}
...
func (o InlineResponse200126UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200126UsageOverall struct {
	value *InlineResponse200126UsageOverall
	isSet bool
}

func (v NullableInlineResponse200126UsageOverall) Get() *InlineResponse200126UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200126UsageOverall) Set(val *InlineResponse200126UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200126UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200126UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200126UsageOverall(val *InlineResponse200126UsageOverall) *NullableInlineResponse200126UsageOverall {
	return &NullableInlineResponse200126UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200126UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200126UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
