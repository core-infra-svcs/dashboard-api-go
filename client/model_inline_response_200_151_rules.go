...
// InlineResponse200151Rules struct for InlineResponse200151Rules
type InlineResponse200151Rules struct {
...
func NewInlineResponse200151Rules() *InlineResponse200151Rules {
	this := InlineResponse200151Rules{}
	return &this
}
...
func (o InlineResponse200151Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200151Rules struct {
	value *InlineResponse200151Rules
	isSet bool
}

func (v NullableInlineResponse200151Rules) Get() *InlineResponse200151Rules {
	return v.value
}

func (v *NullableInlineResponse200151Rules) Set(val *InlineResponse200151Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200151Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200151Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200151Rules(val *InlineResponse200151Rules) *NullableInlineResponse200151Rules {
	return &NullableInlineResponse200151Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200151Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200151Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
