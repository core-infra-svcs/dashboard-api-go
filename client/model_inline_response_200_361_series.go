...
// InlineResponse200361Series struct for InlineResponse200361Series
type InlineResponse200361Series struct {
...
func NewInlineResponse200361Series() *InlineResponse200361Series {
	this := InlineResponse200361Series{}
	return &this
}
...
func (o InlineResponse200361Series) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200361Series struct {
	value *InlineResponse200361Series
	isSet bool
}

func (v NullableInlineResponse200361Series) Get() *InlineResponse200361Series {
	return v.value
}

func (v *NullableInlineResponse200361Series) Set(val *InlineResponse200361Series) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200361Series) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200361Series) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200361Series(val *InlineResponse200361Series) *NullableInlineResponse200361Series {
	return &NullableInlineResponse200361Series{value: val, isSet: true}
}

func (v NullableInlineResponse200361Series) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200361Series) UnmarshalJSON(src []byte) error {
	v.isSet = true
