...
// InlineResponse20012BasicServiceSets struct for InlineResponse20012BasicServiceSets
type InlineResponse20012BasicServiceSets struct {
...
func NewInlineResponse20012BasicServiceSets() *InlineResponse20012BasicServiceSets {
	this := InlineResponse20012BasicServiceSets{}
	return &this
}
...
func (o InlineResponse20012BasicServiceSets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20012BasicServiceSets struct {
	value *InlineResponse20012BasicServiceSets
	isSet bool
}

func (v NullableInlineResponse20012BasicServiceSets) Get() *InlineResponse20012BasicServiceSets {
	return v.value
}

func (v *NullableInlineResponse20012BasicServiceSets) Set(val *InlineResponse20012BasicServiceSets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20012BasicServiceSets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20012BasicServiceSets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20012BasicServiceSets(val *InlineResponse20012BasicServiceSets) *NullableInlineResponse20012BasicServiceSets {
	return &NullableInlineResponse20012BasicServiceSets{value: val, isSet: true}
}

func (v NullableInlineResponse20012BasicServiceSets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20012BasicServiceSets) UnmarshalJSON(src []byte) error {
	v.isSet = true
