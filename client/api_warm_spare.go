...
func (r WarmSpareApiGetNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20078, *http.Response, error) {
...
func (a *WarmSpareApiService) GetNetworkApplianceWarmSpareExecute(r WarmSpareApiGetNetworkApplianceWarmSpareRequest) (*InlineResponse20078, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WarmSpareApiSwapNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20078, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20078
func (a *WarmSpareApiService) SwapNetworkApplianceWarmSpareExecute(r WarmSpareApiSwapNetworkApplianceWarmSpareRequest) (*InlineResponse20078, *http.Response, error) {
	var (
...
func (r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20078, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20078
func (a *WarmSpareApiService) UpdateNetworkApplianceWarmSpareExecute(r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) (*InlineResponse20078, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
