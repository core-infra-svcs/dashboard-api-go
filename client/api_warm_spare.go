...
func (r WarmSpareApiGetDeviceSwitchWarmSpareRequest) Execute() (*InlineResponse20043, *http.Response, error) {
...
func (a *WarmSpareApiService) GetDeviceSwitchWarmSpareExecute(r WarmSpareApiGetDeviceSwitchWarmSpareRequest) (*InlineResponse20043, *http.Response, error) {
	var (
...
func (r WarmSpareApiGetNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20080, *http.Response, error) {
...
func (a *WarmSpareApiService) GetNetworkApplianceWarmSpareExecute(r WarmSpareApiGetNetworkApplianceWarmSpareRequest) (*InlineResponse20080, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WarmSpareApiSwapNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20080, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20080
func (a *WarmSpareApiService) SwapNetworkApplianceWarmSpareExecute(r WarmSpareApiSwapNetworkApplianceWarmSpareRequest) (*InlineResponse20080, *http.Response, error) {
	var (
...
func (r WarmSpareApiUpdateDeviceSwitchWarmSpareRequest) Execute() (*InlineResponse20043, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20043
func (a *WarmSpareApiService) UpdateDeviceSwitchWarmSpareExecute(r WarmSpareApiUpdateDeviceSwitchWarmSpareRequest) (*InlineResponse20043, *http.Response, error) {
	var (
...
func (r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) UpdateNetworkApplianceWarmSpare(updateNetworkApplianceWarmSpare InlineObject80) WarmSpareApiUpdateNetworkApplianceWarmSpareRequest {
	r.updateNetworkApplianceWarmSpare = &updateNetworkApplianceWarmSpare
	return r
}

func (r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20080, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20080
func (a *WarmSpareApiService) UpdateNetworkApplianceWarmSpareExecute(r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) (*InlineResponse20080, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
