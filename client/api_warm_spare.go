...
func (r WarmSpareApiGetDeviceSwitchWarmSpareRequest) Execute() (*InlineResponse20042, *http.Response, error) {
...
func (a *WarmSpareApiService) GetDeviceSwitchWarmSpareExecute(r WarmSpareApiGetDeviceSwitchWarmSpareRequest) (*InlineResponse20042, *http.Response, error) {
	var (
...
func (r WarmSpareApiGetNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20077, *http.Response, error) {
...
func (a *WarmSpareApiService) GetNetworkApplianceWarmSpareExecute(r WarmSpareApiGetNetworkApplianceWarmSpareRequest) (*InlineResponse20077, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WarmSpareApiSwapNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20077, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20077
func (a *WarmSpareApiService) SwapNetworkApplianceWarmSpareExecute(r WarmSpareApiSwapNetworkApplianceWarmSpareRequest) (*InlineResponse20077, *http.Response, error) {
	var (
...
func (r WarmSpareApiUpdateDeviceSwitchWarmSpareRequest) UpdateDeviceSwitchWarmSpare(updateDeviceSwitchWarmSpare InlineObject34) WarmSpareApiUpdateDeviceSwitchWarmSpareRequest {
	r.updateDeviceSwitchWarmSpare = &updateDeviceSwitchWarmSpare
	return r
}

func (r WarmSpareApiUpdateDeviceSwitchWarmSpareRequest) Execute() (*InlineResponse20042, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20042
func (a *WarmSpareApiService) UpdateDeviceSwitchWarmSpareExecute(r WarmSpareApiUpdateDeviceSwitchWarmSpareRequest) (*InlineResponse20042, *http.Response, error) {
	var (
...
func (r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) UpdateNetworkApplianceWarmSpare(updateNetworkApplianceWarmSpare InlineObject79) WarmSpareApiUpdateNetworkApplianceWarmSpareRequest {
	r.updateNetworkApplianceWarmSpare = &updateNetworkApplianceWarmSpare
	return r
}

func (r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20077, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20077
func (a *WarmSpareApiService) UpdateNetworkApplianceWarmSpareExecute(r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) (*InlineResponse20077, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
