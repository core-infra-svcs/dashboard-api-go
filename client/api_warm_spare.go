...
func (r WarmSpareApiGetDeviceSwitchWarmSpareRequest) Execute() (*InlineResponse20048, *http.Response, error) {
...
func (a *WarmSpareApiService) GetDeviceSwitchWarmSpareExecute(r WarmSpareApiGetDeviceSwitchWarmSpareRequest) (*InlineResponse20048, *http.Response, error) {
	var (
...
func (r WarmSpareApiGetNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20087, *http.Response, error) {
...
func (a *WarmSpareApiService) GetNetworkApplianceWarmSpareExecute(r WarmSpareApiGetNetworkApplianceWarmSpareRequest) (*InlineResponse20087, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WarmSpareApiSwapNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20087, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20087
func (a *WarmSpareApiService) SwapNetworkApplianceWarmSpareExecute(r WarmSpareApiSwapNetworkApplianceWarmSpareRequest) (*InlineResponse20087, *http.Response, error) {
	var (
...
func (r WarmSpareApiUpdateDeviceSwitchWarmSpareRequest) UpdateDeviceSwitchWarmSpare(updateDeviceSwitchWarmSpare InlineObject35) WarmSpareApiUpdateDeviceSwitchWarmSpareRequest {
	r.updateDeviceSwitchWarmSpare = &updateDeviceSwitchWarmSpare
	return r
}

func (r WarmSpareApiUpdateDeviceSwitchWarmSpareRequest) Execute() (*InlineResponse20048, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20048
func (a *WarmSpareApiService) UpdateDeviceSwitchWarmSpareExecute(r WarmSpareApiUpdateDeviceSwitchWarmSpareRequest) (*InlineResponse20048, *http.Response, error) {
	var (
...
func (r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) UpdateNetworkApplianceWarmSpare(updateNetworkApplianceWarmSpare InlineObject81) WarmSpareApiUpdateNetworkApplianceWarmSpareRequest {
	r.updateNetworkApplianceWarmSpare = &updateNetworkApplianceWarmSpare
	return r
}

func (r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20087, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20087
func (a *WarmSpareApiService) UpdateNetworkApplianceWarmSpareExecute(r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) (*InlineResponse20087, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
