...
func (r WarmSpareApiGetNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20076, *http.Response, error) {
...
func (a *WarmSpareApiService) GetNetworkApplianceWarmSpareExecute(r WarmSpareApiGetNetworkApplianceWarmSpareRequest) (*InlineResponse20076, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WarmSpareApiSwapNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20076, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20076
func (a *WarmSpareApiService) SwapNetworkApplianceWarmSpareExecute(r WarmSpareApiSwapNetworkApplianceWarmSpareRequest) (*InlineResponse20076, *http.Response, error) {
	var (
...
func (r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) UpdateNetworkApplianceWarmSpare(updateNetworkApplianceWarmSpare InlineObject78) WarmSpareApiUpdateNetworkApplianceWarmSpareRequest {
	r.updateNetworkApplianceWarmSpare = &updateNetworkApplianceWarmSpare
	return r
}

func (r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) Execute() (*InlineResponse20076, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20076
func (a *WarmSpareApiService) UpdateNetworkApplianceWarmSpareExecute(r WarmSpareApiUpdateNetworkApplianceWarmSpareRequest) (*InlineResponse20076, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
