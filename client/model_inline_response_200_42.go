...
func (o *InlineResponse20042) GetPorts() []string {
...
func (o *InlineResponse20042) GetPortsOk() ([]string, bool) {
	if o == nil || isNil(o.Ports) {
    return nil, false
	}
	return o.Ports, true
...
func (o *InlineResponse20042) HasPorts() bool {
	if o != nil && !isNil(o.Ports) {
		return true
	}
...
func (o *InlineResponse20042) SetPorts(v []string) {
	o.Ports = v
}
