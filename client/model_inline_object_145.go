...
func NewInlineObject145(interfaceIp string, multicastGroup string) *InlineObject145 {
...
func (o *InlineObject145) GetInterfaceIp() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InlineObject145) GetInterfaceIpOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *InlineObject145) SetInterfaceIp(v string) {
	o.InterfaceIp = v
}

// GetMulticastGroup returns the MulticastGroup field value
func (o *InlineObject145) GetMulticastGroup() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InlineObject145) GetMulticastGroupOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *InlineObject145) SetMulticastGroup(v string) {
	o.MulticastGroup = v
}
