...
type InlineResponse200388Intervals struct {
	...
	ByCore []InlineResponse200388ByCore `json:"byCore,omitempty"`
}
...
func (o *InlineResponse200388Intervals) GetByCore() []InlineResponse200388ByCore {
	if o == nil || isNil(o.ByCore) {
		var ret []InlineResponse200388ByCore
		return ret
	}
	return o.ByCore
}
...
// SetByCore gets a reference to the given []InlineResponse200388ByCore and assigns it to the ByCore field.
