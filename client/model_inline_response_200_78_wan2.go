...
// InlineResponse20078Wan2 WAN 2 IP and subnet
type InlineResponse20078Wan2 struct {
...
func (o InlineResponse20078Wan2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20078Wan2 struct {
	value *InlineResponse20078Wan2
	isSet bool
}

func (v NullableInlineResponse20078Wan2) Get() *InlineResponse20078Wan2 {
	return v.value
}

func (v *NullableInlineResponse20078Wan2) Set(val *InlineResponse20078Wan2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20078Wan2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20078Wan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20078Wan2(val *InlineResponse20078Wan2) *NullableInlineResponse20078Wan2 {
	return &NullableInlineResponse20078Wan2{value: val, isSet: true}
}

func (v NullableInlineResponse20078Wan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20078Wan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
