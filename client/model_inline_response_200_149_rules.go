...
// InlineResponse200149Rules struct for InlineResponse200149Rules
type InlineResponse200149Rules struct {
...
func NewInlineResponse200149Rules() *InlineResponse200149Rules {
	this := InlineResponse200149Rules{}
	return &this
}
...
func (o InlineResponse200149Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200149Rules struct {
	value *InlineResponse200149Rules
	isSet bool
}

func (v NullableInlineResponse200149Rules) Get() *InlineResponse200149Rules {
	return v.value
}

func (v *NullableInlineResponse200149Rules) Set(val *InlineResponse200149Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200149Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200149Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200149Rules(val *InlineResponse200149Rules) *NullableInlineResponse200149Rules {
	return &NullableInlineResponse200149Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200149Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200149Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
