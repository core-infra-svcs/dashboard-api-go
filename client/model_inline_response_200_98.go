...
func (o *InlineResponse20098) GetDestOrganizationId() string {
...
func (o *InlineResponse20098) GetDestOrganizationIdOk() (*string, bool) {
	if o == nil || isNil(o.DestOrganizationId) {
    return nil, false
	}
...
func (o *InlineResponse20098) HasDestOrganizationId() bool {
	if o != nil && !isNil(o.DestOrganizationId) {
		return true
	}
...
func (o *InlineResponse20098) SetDestOrganizationId(v string) {
	o.DestOrganizationId = &v
}

// GetLicenseIds returns the LicenseIds field value if set, zero value otherwise.
func (o *InlineResponse20098) GetLicenseIds() []string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20098) GetLicenseIdsOk() ([]string, bool) {
	if o == nil || isNil(o.LicenseIds) {
    return nil, false
	}
...
func (o *InlineResponse20098) HasLicenseIds() bool {
	if o != nil && !isNil(o.LicenseIds) {
		return true
	}
...
func (o *InlineResponse20098) SetLicenseIds(v []string) {
	o.LicenseIds = v
}
