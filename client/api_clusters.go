...
func (r ClustersApiCreateNetworkCampusGatewayClusterRequest) Execute() (*InlineResponse20111, *http.Response, error) {
...
func (a *ClustersApiService) CreateNetworkCampusGatewayClusterExecute(r ClustersApiCreateNetworkCampusGatewayClusterRequest) (*InlineResponse20111, *http.Response, error) {
	var (
...
func (r ClustersApiGetOrganizationCampusGatewayClustersRequest) Execute() (*InlineResponse200254, *http.Response, error) {
...
func (a *ClustersApiService) GetOrganizationCampusGatewayClustersExecute(r ClustersApiGetOrganizationCampusGatewayClustersRequest) (*InlineResponse200254, *http.Response, error) {
	var (
...
func (r ClustersApiUpdateNetworkCampusGatewayClusterRequest) Execute() (*InlineResponse20111, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20111
func (a *ClustersApiService) UpdateNetworkCampusGatewayClusterExecute(r ClustersApiUpdateNetworkCampusGatewayClusterRequest) (*InlineResponse20111, *http.Response, error) {
	var (
