...
func (r ClustersApiCreateNetworkCampusGatewayClusterRequest) CreateNetworkCampusGatewayCluster(createNetworkCampusGatewayCluster InlineObject87) ClustersApiCreateNetworkCampusGatewayClusterRequest {
...
func (r ClustersApiGetOrganizationCampusGatewayClustersRequest) Execute() (*InlineResponse200273, *http.Response, error) {
...
func (a *ClustersApiService) GetOrganizationCampusGatewayClustersExecute(r ClustersApiGetOrganizationCampusGatewayClustersRequest) (*InlineResponse200273, *http.Response, error) {
	var (
...
func (r ClustersApiUpdateNetworkCampusGatewayClusterRequest) UpdateNetworkCampusGatewayCluster(updateNetworkCampusGatewayCluster InlineObject88) ClustersApiUpdateNetworkCampusGatewayClusterRequest {
