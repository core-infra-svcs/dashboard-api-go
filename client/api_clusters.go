...
func (r ClustersApiGetOrganizationCampusGatewayClustersRequest) Execute() (*InlineResponse200257, *http.Response, error) {
...
func (a *ClustersApiService) GetOrganizationCampusGatewayClustersExecute(r ClustersApiGetOrganizationCampusGatewayClustersRequest) (*InlineResponse200257, *http.Response, error) {
	var (
