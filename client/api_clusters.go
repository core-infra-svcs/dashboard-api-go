...
func (r ClustersApiGetOrganizationCampusGatewayClustersRequest) Execute() (*InlineResponse200252, *http.Response, error) {
...
func (a *ClustersApiService) GetOrganizationCampusGatewayClustersExecute(r ClustersApiGetOrganizationCampusGatewayClustersRequest) (*InlineResponse200252, *http.Response, error) {
	var (
