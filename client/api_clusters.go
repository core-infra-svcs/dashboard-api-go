...
func (r ClustersApiGetOrganizationCampusGatewayClustersRequest) Execute() (*InlineResponse200265, *http.Response, error) {
...
func (a *ClustersApiService) GetOrganizationCampusGatewayClustersExecute(r ClustersApiGetOrganizationCampusGatewayClustersRequest) (*InlineResponse200265, *http.Response, error) {
	var (
