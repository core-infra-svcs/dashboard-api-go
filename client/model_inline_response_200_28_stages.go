...
// InlineResponse20028Stages struct for InlineResponse20028Stages
type InlineResponse20028Stages struct {
	Group *InlineResponse20028Group `json:"group,omitempty"`
	Milestones *InlineResponse20028Milestones `json:"milestones,omitempty"`
...
func NewInlineResponse20028Stages() *InlineResponse20028Stages {
	this := InlineResponse20028Stages{}
	return &this
}
...
func (o *InlineResponse20028Stages) GetGroup() InlineResponse20028Group {
	if o == nil || isNil(o.Group) {
		var ret InlineResponse20028Group
		return ret
	}
	return *o.Group
}
...
// SetGroup gets a reference to the given InlineResponse20028Group and assigns it to the Group field.
...
func (o *InlineResponse20028Stages) GetMilestones() InlineResponse20028Milestones {
	if o == nil || isNil(o.Milestones) {
		var ret InlineResponse20028Milestones
		return ret
	}
	return *o.Milestones
}
...
// SetMilestones gets a reference to the given InlineResponse20028Milestones and assigns it to the Milestones field.
...
func (o InlineResponse20028Stages) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20028Stages struct {
	value *InlineResponse20028Stages
	isSet bool
}

func (v NullableInlineResponse20028Stages) Get() *InlineResponse20028Stages {
	return v.value
}

func (v *NullableInlineResponse20028Stages) Set(val *InlineResponse20028Stages) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20028Stages) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20028Stages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20028Stages(val *InlineResponse20028Stages) *NullableInlineResponse20028Stages {
	return &NullableInlineResponse20028Stages{value: val, isSet: true}
}

func (v NullableInlineResponse20028Stages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20028Stages) UnmarshalJSON(src []byte) error {
	v.isSet = true
