...
// InlineResponse20091ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20091ToVersion struct {
...
func NewInlineResponse20091ToVersion() *InlineResponse20091ToVersion {
	this := InlineResponse20091ToVersion{}
	return &this
}
...
func (o InlineResponse20091ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20091ToVersion struct {
	value *InlineResponse20091ToVersion
	isSet bool
}

func (v NullableInlineResponse20091ToVersion) Get() *InlineResponse20091ToVersion {
	return v.value
}

func (v *NullableInlineResponse20091ToVersion) Set(val *InlineResponse20091ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20091ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20091ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20091ToVersion(val *InlineResponse20091ToVersion) *NullableInlineResponse20091ToVersion {
	return &NullableInlineResponse20091ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20091ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20091ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
