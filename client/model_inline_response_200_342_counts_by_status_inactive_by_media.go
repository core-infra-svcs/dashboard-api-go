...
// InlineResponse200342CountsByStatusInactiveByMedia The inactive count data, indexed by media type (RJ45 or SFP)
type InlineResponse200342CountsByStatusInactiveByMedia struct {
	Rj45 *InlineResponse200342CountsByStatusInactiveByMediaRj45 `json:"rj45,omitempty"`
	Sfp *InlineResponse200342CountsByStatusInactiveByMediaSfp `json:"sfp,omitempty"`
}
...
func NewInlineResponse200342CountsByStatusInactiveByMedia() *InlineResponse200342CountsByStatusInactiveByMedia {
	this := InlineResponse200342CountsByStatusInactiveByMedia{}
	return &this
}
...
func (o *InlineResponse200342CountsByStatusInactiveByMedia) GetRj45() InlineResponse200342CountsByStatusInactiveByMediaRj45 {
	if o == nil || isNil(o.Rj45) {
		var ret InlineResponse200342CountsByStatusInactiveByMediaRj45
		return ret
	}
	return *o.Rj45
}
...
// SetRj45 gets a reference to the given InlineResponse200342CountsByStatusInactiveByMediaRj45 and assigns it to the Rj45 field.
...
func (o *InlineResponse200342CountsByStatusInactiveByMedia) GetSfp() InlineResponse200342CountsByStatusInactiveByMediaSfp {
	if o == nil || isNil(o.Sfp) {
		var ret InlineResponse200342CountsByStatusInactiveByMediaSfp
		return ret
	}
	return *o.Sfp
}
...
// SetSfp gets a reference to the given InlineResponse200342CountsByStatusInactiveByMediaSfp and assigns it to the Sfp field.
func (o *InlineResponse200342CountsByStatusInactiveByMedia) SetSfp(v InlineResponse200342CountsByStatusInactiveByMediaSfp) {
	o.Sfp = &v
}

func (o InlineResponse200342CountsByStatusInactiveByMedia) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200342CountsByStatusInactiveByMedia struct {
	value *InlineResponse200342CountsByStatusInactiveByMedia
	isSet bool
}

func (v NullableInlineResponse200342CountsByStatusInactiveByMedia) Get() *InlineResponse200342CountsByStatusInactiveByMedia {
	return v.value
}

func (v *NullableInlineResponse200342CountsByStatusInactiveByMedia) Set(val *InlineResponse200342CountsByStatusInactiveByMedia) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200342CountsByStatusInactiveByMedia) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200342CountsByStatusInactiveByMedia) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200342CountsByStatusInactiveByMedia(val *InlineResponse200342CountsByStatusInactiveByMedia) *NullableInlineResponse200342CountsByStatusInactiveByMedia {
	return &NullableInlineResponse200342CountsByStatusInactiveByMedia{value: val, isSet: true}
}

func (v NullableInlineResponse200342CountsByStatusInactiveByMedia) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200342CountsByStatusInactiveByMedia) UnmarshalJSON(src []byte) error {
	v.isSet = true
