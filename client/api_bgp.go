...
func (r BgpApiGetNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20073, *http.Response, error) {
...
func (a *BgpApiService) GetNetworkApplianceVpnBgpExecute(r BgpApiGetNetworkApplianceVpnBgpRequest) (*InlineResponse20073, *http.Response, error) {
	var (
...
func (r BgpApiUpdateNetworkApplianceVpnBgpRequest) UpdateNetworkApplianceVpnBgp(updateNetworkApplianceVpnBgp InlineObject75) BgpApiUpdateNetworkApplianceVpnBgpRequest {
	r.updateNetworkApplianceVpnBgp = &updateNetworkApplianceVpnBgp
	return r
}

func (r BgpApiUpdateNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20073, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20073
func (a *BgpApiService) UpdateNetworkApplianceVpnBgpExecute(r BgpApiUpdateNetworkApplianceVpnBgpRequest) (*InlineResponse20073, *http.Response, error) {
	var (
