...
func (r BgpApiGetNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20079, *http.Response, error) {
...
func (a *BgpApiService) GetNetworkApplianceVpnBgpExecute(r BgpApiGetNetworkApplianceVpnBgpRequest) (*InlineResponse20079, *http.Response, error) {
	var (
...
func (r BgpApiUpdateNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20079, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20079
func (a *BgpApiService) UpdateNetworkApplianceVpnBgpExecute(r BgpApiUpdateNetworkApplianceVpnBgpRequest) (*InlineResponse20079, *http.Response, error) {
	var (
