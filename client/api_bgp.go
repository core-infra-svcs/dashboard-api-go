...
func (r BgpApiGetNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20069, *http.Response, error) {
...
func (a *BgpApiService) GetNetworkApplianceVpnBgpExecute(r BgpApiGetNetworkApplianceVpnBgpRequest) (*InlineResponse20069, *http.Response, error) {
	var (
...
func (r BgpApiUpdateNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20069, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20069
func (a *BgpApiService) UpdateNetworkApplianceVpnBgpExecute(r BgpApiUpdateNetworkApplianceVpnBgpRequest) (*InlineResponse20069, *http.Response, error) {
	var (
