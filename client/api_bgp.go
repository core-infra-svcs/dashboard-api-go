...
func (r BgpApiGetNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20075, *http.Response, error) {
...
func (a *BgpApiService) GetNetworkApplianceVpnBgpExecute(r BgpApiGetNetworkApplianceVpnBgpRequest) (*InlineResponse20075, *http.Response, error) {
	var (
...
func (r BgpApiUpdateNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20075, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20075
func (a *BgpApiService) UpdateNetworkApplianceVpnBgpExecute(r BgpApiUpdateNetworkApplianceVpnBgpRequest) (*InlineResponse20075, *http.Response, error) {
	var (
