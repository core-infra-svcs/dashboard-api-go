...
func (r BgpApiGetNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20076, *http.Response, error) {
...
func (a *BgpApiService) GetNetworkApplianceVpnBgpExecute(r BgpApiGetNetworkApplianceVpnBgpRequest) (*InlineResponse20076, *http.Response, error) {
	var (
...
func (r BgpApiUpdateNetworkApplianceVpnBgpRequest) UpdateNetworkApplianceVpnBgp(updateNetworkApplianceVpnBgp InlineObject77) BgpApiUpdateNetworkApplianceVpnBgpRequest {
	r.updateNetworkApplianceVpnBgp = &updateNetworkApplianceVpnBgp
	return r
}

func (r BgpApiUpdateNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20076, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20076
func (a *BgpApiService) UpdateNetworkApplianceVpnBgpExecute(r BgpApiUpdateNetworkApplianceVpnBgpRequest) (*InlineResponse20076, *http.Response, error) {
	var (
