...
func (r BgpApiGetNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20068, *http.Response, error) {
...
func (a *BgpApiService) GetNetworkApplianceVpnBgpExecute(r BgpApiGetNetworkApplianceVpnBgpRequest) (*InlineResponse20068, *http.Response, error) {
	var (
...
func (r BgpApiUpdateNetworkApplianceVpnBgpRequest) UpdateNetworkApplianceVpnBgp(updateNetworkApplianceVpnBgp InlineObject74) BgpApiUpdateNetworkApplianceVpnBgpRequest {
	r.updateNetworkApplianceVpnBgp = &updateNetworkApplianceVpnBgp
	return r
}

func (r BgpApiUpdateNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20068, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20068
func (a *BgpApiService) UpdateNetworkApplianceVpnBgpExecute(r BgpApiUpdateNetworkApplianceVpnBgpRequest) (*InlineResponse20068, *http.Response, error) {
	var (
