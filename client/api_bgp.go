...
func (r BgpApiGetNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20070, *http.Response, error) {
...
func (a *BgpApiService) GetNetworkApplianceVpnBgpExecute(r BgpApiGetNetworkApplianceVpnBgpRequest) (*InlineResponse20070, *http.Response, error) {
	var (
...
func (r BgpApiUpdateNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20070, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20070
func (a *BgpApiService) UpdateNetworkApplianceVpnBgpExecute(r BgpApiUpdateNetworkApplianceVpnBgpRequest) (*InlineResponse20070, *http.Response, error) {
	var (
