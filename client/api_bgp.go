...
func (r BgpApiGetNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20074, *http.Response, error) {
...
func (a *BgpApiService) GetNetworkApplianceVpnBgpExecute(r BgpApiGetNetworkApplianceVpnBgpRequest) (*InlineResponse20074, *http.Response, error) {
	var (
...
func (r BgpApiUpdateNetworkApplianceVpnBgpRequest) UpdateNetworkApplianceVpnBgp(updateNetworkApplianceVpnBgp InlineObject76) BgpApiUpdateNetworkApplianceVpnBgpRequest {
	r.updateNetworkApplianceVpnBgp = &updateNetworkApplianceVpnBgp
	return r
}

func (r BgpApiUpdateNetworkApplianceVpnBgpRequest) Execute() (*InlineResponse20074, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20074
func (a *BgpApiService) UpdateNetworkApplianceVpnBgpExecute(r BgpApiUpdateNetworkApplianceVpnBgpRequest) (*InlineResponse20074, *http.Response, error) {
	var (
