...
// InlineResponse20074Limits The current limits of various adaptive policy objects.
type InlineResponse20074Limits struct {
...
func NewInlineResponse20074Limits() *InlineResponse20074Limits {
	this := InlineResponse20074Limits{}
	return &this
}
...
func (o InlineResponse20074Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20074Limits struct {
	value *InlineResponse20074Limits
	isSet bool
}

func (v NullableInlineResponse20074Limits) Get() *InlineResponse20074Limits {
	return v.value
}

func (v *NullableInlineResponse20074Limits) Set(val *InlineResponse20074Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20074Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20074Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20074Limits(val *InlineResponse20074Limits) *NullableInlineResponse20074Limits {
	return &NullableInlineResponse20074Limits{value: val, isSet: true}
}

func (v NullableInlineResponse20074Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20074Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
