...
// InlineResponse200315MetaCountsItems The count metadata.
type InlineResponse200315MetaCountsItems struct {
...
func NewInlineResponse200315MetaCountsItems() *InlineResponse200315MetaCountsItems {
	this := InlineResponse200315MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200315MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200315MetaCountsItems struct {
	value *InlineResponse200315MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200315MetaCountsItems) Get() *InlineResponse200315MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200315MetaCountsItems) Set(val *InlineResponse200315MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200315MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200315MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200315MetaCountsItems(val *InlineResponse200315MetaCountsItems) *NullableInlineResponse200315MetaCountsItems {
	return &NullableInlineResponse200315MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200315MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200315MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
