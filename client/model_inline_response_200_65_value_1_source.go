...
// InlineResponse20065Value1Source Source of 'custom' type traffic filter
type InlineResponse20065Value1Source struct {
...
func NewInlineResponse20065Value1Source() *InlineResponse20065Value1Source {
	this := InlineResponse20065Value1Source{}
	return &this
}
...
func (o InlineResponse20065Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20065Value1Source struct {
	value *InlineResponse20065Value1Source
	isSet bool
}

func (v NullableInlineResponse20065Value1Source) Get() *InlineResponse20065Value1Source {
	return v.value
}

func (v *NullableInlineResponse20065Value1Source) Set(val *InlineResponse20065Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20065Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20065Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20065Value1Source(val *InlineResponse20065Value1Source) *NullableInlineResponse20065Value1Source {
	return &NullableInlineResponse20065Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20065Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20065Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
