...
// InlineResponse200359Redundancy Wireless LAN controller redundancy information
type InlineResponse200359Redundancy struct {
	...
	Management *InlineResponse200359RedundancyManagement `json:"management,omitempty"`
}
...
func NewInlineResponse200359Redundancy() *InlineResponse200359Redundancy {
	this := InlineResponse200359Redundancy{}
	return &this
}
...
func (o *InlineResponse200359Redundancy) GetManagement() InlineResponse200359RedundancyManagement {
	if o == nil || isNil(o.Management) {
		var ret InlineResponse200359RedundancyManagement
		return ret
	}
	return *o.Management
}
...
// SetManagement gets a reference to the given InlineResponse200359RedundancyManagement and assigns it to the Management field.
func (o *InlineResponse200359Redundancy) SetManagement(v InlineResponse200359RedundancyManagement) {
	o.Management = &v
}

func (o InlineResponse200359Redundancy) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200359Redundancy struct {
	value *InlineResponse200359Redundancy
	isSet bool
}

func (v NullableInlineResponse200359Redundancy) Get() *InlineResponse200359Redundancy {
	return v.value
}

func (v *NullableInlineResponse200359Redundancy) Set(val *InlineResponse200359Redundancy) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200359Redundancy) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200359Redundancy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200359Redundancy(val *InlineResponse200359Redundancy) *NullableInlineResponse200359Redundancy {
	return &NullableInlineResponse200359Redundancy{value: val, isSet: true}
}

func (v NullableInlineResponse200359Redundancy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200359Redundancy) UnmarshalJSON(src []byte) error {
	v.isSet = true
