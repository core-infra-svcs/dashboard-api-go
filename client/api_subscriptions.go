...
func (r SubscriptionsApiBindAdministeredLicensingSubscriptionSubscriptionRequest) Execute() (*InlineResponse2002, *http.Response, error) {
...
func (a *SubscriptionsApiService) BindAdministeredLicensingSubscriptionSubscriptionExecute(r SubscriptionsApiBindAdministeredLicensingSubscriptionSubscriptionRequest) (*InlineResponse2002, *http.Response, error) {
	var (
...
func (r SubscriptionsApiClaimAdministeredLicensingSubscriptionSubscriptionsRequest) Execute() (*InlineResponse2001, *http.Response, error) {
...
func (a *SubscriptionsApiService) ClaimAdministeredLicensingSubscriptionSubscriptionsExecute(r SubscriptionsApiClaimAdministeredLicensingSubscriptionSubscriptionsRequest) (*InlineResponse2001, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SubscriptionsApiGetAdministeredLicensingSubscriptionSubscriptionsRequest) Execute() ([]InlineResponse2001, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse2001
func (a *SubscriptionsApiService) GetAdministeredLicensingSubscriptionSubscriptionsExecute(r SubscriptionsApiGetAdministeredLicensingSubscriptionSubscriptionsRequest) ([]InlineResponse2001, *http.Response, error) {
	var (
...
func (r SubscriptionsApiValidateAdministeredLicensingSubscriptionSubscriptionsClaimKeyRequest) Execute() (*InlineResponse2001, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2001
func (a *SubscriptionsApiService) ValidateAdministeredLicensingSubscriptionSubscriptionsClaimKeyExecute(r SubscriptionsApiValidateAdministeredLicensingSubscriptionSubscriptionsClaimKeyRequest) (*InlineResponse2001, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
