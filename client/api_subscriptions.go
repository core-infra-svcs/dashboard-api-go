...
func (r SubscriptionsApiGetAdministeredLicensingSubscriptionSubscriptionsRequest) Skus(skus []string) SubscriptionsApiGetAdministeredLicensingSubscriptionSubscriptionsRequest {
	r.skus = &skus
	return r
}
