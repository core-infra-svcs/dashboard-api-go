...
func (r SubscriptionsApiBindAdministeredLicensingSubscriptionSubscriptionRequest) Execute() (*InlineResponse2004, *http.Response, error) {
...
func (a *SubscriptionsApiService) BindAdministeredLicensingSubscriptionSubscriptionExecute(r SubscriptionsApiBindAdministeredLicensingSubscriptionSubscriptionRequest) (*InlineResponse2004, *http.Response, error) {
	var (
...
func (r SubscriptionsApiClaimAdministeredLicensingSubscriptionSubscriptionsRequest) Execute() (*InlineResponse2002, *http.Response, error) {
...
func (a *SubscriptionsApiService) ClaimAdministeredLicensingSubscriptionSubscriptionsExecute(r SubscriptionsApiClaimAdministeredLicensingSubscriptionSubscriptionsRequest) (*InlineResponse2002, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SubscriptionsApiGetAdministeredLicensingSubscriptionSubscriptionsRequest) Execute() ([]InlineResponse2002, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse2002
func (a *SubscriptionsApiService) GetAdministeredLicensingSubscriptionSubscriptionsExecute(r SubscriptionsApiGetAdministeredLicensingSubscriptionSubscriptionsRequest) ([]InlineResponse2002, *http.Response, error) {
	var (
...
func (r SubscriptionsApiGetAdministeredLicensingSubscriptionSubscriptionsComplianceStatusesRequest) Execute() ([]InlineResponse2003, *http.Response, error) {
...
func (a *SubscriptionsApiService) GetAdministeredLicensingSubscriptionSubscriptionsComplianceStatusesExecute(r SubscriptionsApiGetAdministeredLicensingSubscriptionSubscriptionsComplianceStatusesRequest) ([]InlineResponse2003, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SubscriptionsApiValidateAdministeredLicensingSubscriptionSubscriptionsClaimKeyRequest) Execute() (*InlineResponse2002, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2002
func (a *SubscriptionsApiService) ValidateAdministeredLicensingSubscriptionSubscriptionsClaimKeyExecute(r SubscriptionsApiValidateAdministeredLicensingSubscriptionSubscriptionsClaimKeyRequest) (*InlineResponse2002, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
