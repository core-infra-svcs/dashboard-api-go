...
// InlineResponse200355Usage The usage on the interfaces of the wireless LAN controller
type InlineResponse200355Usage struct {
...
func NewInlineResponse200355Usage() *InlineResponse200355Usage {
	this := InlineResponse200355Usage{}
	return &this
}
...
func (o InlineResponse200355Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200355Usage struct {
	value *InlineResponse200355Usage
	isSet bool
}

func (v NullableInlineResponse200355Usage) Get() *InlineResponse200355Usage {
	return v.value
}

func (v *NullableInlineResponse200355Usage) Set(val *InlineResponse200355Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200355Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200355Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200355Usage(val *InlineResponse200355Usage) *NullableInlineResponse200355Usage {
	return &NullableInlineResponse200355Usage{value: val, isSet: true}
}

func (v NullableInlineResponse200355Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200355Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
