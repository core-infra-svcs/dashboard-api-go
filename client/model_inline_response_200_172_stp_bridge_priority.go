...
// InlineResponse200172StpBridgePriority struct for InlineResponse200172StpBridgePriority
type InlineResponse200172StpBridgePriority struct {
...
func NewInlineResponse200172StpBridgePriority() *InlineResponse200172StpBridgePriority {
	this := InlineResponse200172StpBridgePriority{}
	return &this
}
...
func (o InlineResponse200172StpBridgePriority) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200172StpBridgePriority struct {
	value *InlineResponse200172StpBridgePriority
	isSet bool
}

func (v NullableInlineResponse200172StpBridgePriority) Get() *InlineResponse200172StpBridgePriority {
	return v.value
}

func (v *NullableInlineResponse200172StpBridgePriority) Set(val *InlineResponse200172StpBridgePriority) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200172StpBridgePriority) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200172StpBridgePriority) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200172StpBridgePriority(val *InlineResponse200172StpBridgePriority) *NullableInlineResponse200172StpBridgePriority {
	return &NullableInlineResponse200172StpBridgePriority{value: val, isSet: true}
}

func (v NullableInlineResponse200172StpBridgePriority) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200172StpBridgePriority) UnmarshalJSON(src []byte) error {
	v.isSet = true
