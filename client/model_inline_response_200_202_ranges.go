...
// InlineResponse200202Ranges struct for InlineResponse200202Ranges
type InlineResponse200202Ranges struct {
...
func NewInlineResponse200202Ranges(startDay string, startTime string, endDay string, endTime string) *InlineResponse200202Ranges {
	this := InlineResponse200202Ranges{}
...
func (o InlineResponse200202Ranges) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200202Ranges struct {
	value *InlineResponse200202Ranges
	isSet bool
}

func (v NullableInlineResponse200202Ranges) Get() *InlineResponse200202Ranges {
	return v.value
}

func (v *NullableInlineResponse200202Ranges) Set(val *InlineResponse200202Ranges) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200202Ranges) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200202Ranges) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200202Ranges(val *InlineResponse200202Ranges) *NullableInlineResponse200202Ranges {
	return &NullableInlineResponse200202Ranges{value: val, isSet: true}
}

func (v NullableInlineResponse200202Ranges) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200202Ranges) UnmarshalJSON(src []byte) error {
	v.isSet = true
