...
// InlineResponse20082ClientVpnConnections struct for InlineResponse20082ClientVpnConnections
type InlineResponse20082ClientVpnConnections struct {
...
func NewInlineResponse20082ClientVpnConnections() *InlineResponse20082ClientVpnConnections {
	this := InlineResponse20082ClientVpnConnections{}
	return &this
}
...
func (o InlineResponse20082ClientVpnConnections) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20082ClientVpnConnections struct {
	value *InlineResponse20082ClientVpnConnections
	isSet bool
}

func (v NullableInlineResponse20082ClientVpnConnections) Get() *InlineResponse20082ClientVpnConnections {
	return v.value
}

func (v *NullableInlineResponse20082ClientVpnConnections) Set(val *InlineResponse20082ClientVpnConnections) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20082ClientVpnConnections) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20082ClientVpnConnections) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20082ClientVpnConnections(val *InlineResponse20082ClientVpnConnections) *NullableInlineResponse20082ClientVpnConnections {
	return &NullableInlineResponse20082ClientVpnConnections{value: val, isSet: true}
}

func (v NullableInlineResponse20082ClientVpnConnections) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20082ClientVpnConnections) UnmarshalJSON(src []byte) error {
	v.isSet = true
