...
// InlineResponse200286Network Information regarding the network the device belongs to
type InlineResponse200286Network struct {
	// The network ID
...
func NewInlineResponse200286Network() *InlineResponse200286Network {
	this := InlineResponse200286Network{}
	return &this
}
...
func (o InlineResponse200286Network) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200286Network struct {
	value *InlineResponse200286Network
	isSet bool
}

func (v NullableInlineResponse200286Network) Get() *InlineResponse200286Network {
	return v.value
}

func (v *NullableInlineResponse200286Network) Set(val *InlineResponse200286Network) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200286Network) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200286Network) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200286Network(val *InlineResponse200286Network) *NullableInlineResponse200286Network {
	return &NullableInlineResponse200286Network{value: val, isSet: true}
}

func (v NullableInlineResponse200286Network) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200286Network) UnmarshalJSON(src []byte) error {
	v.isSet = true
