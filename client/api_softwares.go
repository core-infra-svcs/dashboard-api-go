...
func (r SoftwaresApiGetNetworkSmDeviceSoftwaresRequest) Execute() ([]InlineResponse200142, *http.Response, error) {
...
func (a *SoftwaresApiService) GetNetworkSmDeviceSoftwaresExecute(r SoftwaresApiGetNetworkSmDeviceSoftwaresRequest) ([]InlineResponse200142, *http.Response, error) {
	var (
...
func (r SoftwaresApiGetNetworkSmUserSoftwaresRequest) Execute() ([]InlineResponse200142, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200142
func (a *SoftwaresApiService) GetNetworkSmUserSoftwaresExecute(r SoftwaresApiGetNetworkSmUserSoftwaresRequest) ([]InlineResponse200142, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
