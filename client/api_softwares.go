...
func (r SoftwaresApiGetNetworkSmDeviceSoftwaresRequest) Execute() ([]InlineResponse20070, *http.Response, error) {
...
func (a *SoftwaresApiService) GetNetworkSmDeviceSoftwaresExecute(r SoftwaresApiGetNetworkSmDeviceSoftwaresRequest) ([]InlineResponse20070, *http.Response, error) {
	var (
...
func (r SoftwaresApiGetNetworkSmUserSoftwaresRequest) Execute() ([]InlineResponse20070, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20070
func (a *SoftwaresApiService) GetNetworkSmUserSoftwaresExecute(r SoftwaresApiGetNetworkSmUserSoftwaresRequest) ([]InlineResponse20070, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
