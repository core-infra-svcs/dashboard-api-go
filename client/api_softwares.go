...
func (r SoftwaresApiGetNetworkSmDeviceSoftwaresRequest) Execute() ([]InlineResponse20049, *http.Response, error) {
...
func (a *SoftwaresApiService) GetNetworkSmDeviceSoftwaresExecute(r SoftwaresApiGetNetworkSmDeviceSoftwaresRequest) ([]InlineResponse20049, *http.Response, error) {
	var (
...
func (r SoftwaresApiGetNetworkSmUserSoftwaresRequest) Execute() ([]InlineResponse20049, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20049
func (a *SoftwaresApiService) GetNetworkSmUserSoftwaresExecute(r SoftwaresApiGetNetworkSmUserSoftwaresRequest) ([]InlineResponse20049, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
