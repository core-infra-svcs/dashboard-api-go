...
func (r SoftwaresApiGetNetworkSmDeviceSoftwaresRequest) Execute() ([]InlineResponse20055, *http.Response, error) {
...
func (a *SoftwaresApiService) GetNetworkSmDeviceSoftwaresExecute(r SoftwaresApiGetNetworkSmDeviceSoftwaresRequest) ([]InlineResponse20055, *http.Response, error) {
	var (
...
func (r SoftwaresApiGetNetworkSmUserSoftwaresRequest) Execute() ([]InlineResponse20055, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20055
func (a *SoftwaresApiService) GetNetworkSmUserSoftwaresExecute(r SoftwaresApiGetNetworkSmUserSoftwaresRequest) ([]InlineResponse20055, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
