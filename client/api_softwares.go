...
func (r SoftwaresApiGetNetworkSmDeviceSoftwaresRequest) Execute() ([]InlineResponse200137, *http.Response, error) {
...
func (a *SoftwaresApiService) GetNetworkSmDeviceSoftwaresExecute(r SoftwaresApiGetNetworkSmDeviceSoftwaresRequest) ([]InlineResponse200137, *http.Response, error) {
	var (
...
func (r SoftwaresApiGetNetworkSmUserSoftwaresRequest) Execute() ([]InlineResponse200137, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200137
func (a *SoftwaresApiService) GetNetworkSmUserSoftwaresExecute(r SoftwaresApiGetNetworkSmUserSoftwaresRequest) ([]InlineResponse200137, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
