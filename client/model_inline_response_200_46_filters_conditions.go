...
// InlineResponse20046FiltersConditions struct for InlineResponse20046FiltersConditions
type InlineResponse20046FiltersConditions struct {
	// Type of condition
...
func NewInlineResponse20046FiltersConditions() *InlineResponse20046FiltersConditions {
	this := InlineResponse20046FiltersConditions{}
	return &this
}
...
func (o InlineResponse20046FiltersConditions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20046FiltersConditions struct {
	value *InlineResponse20046FiltersConditions
	isSet bool
}

func (v NullableInlineResponse20046FiltersConditions) Get() *InlineResponse20046FiltersConditions {
	return v.value
}

func (v *NullableInlineResponse20046FiltersConditions) Set(val *InlineResponse20046FiltersConditions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20046FiltersConditions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20046FiltersConditions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20046FiltersConditions(val *InlineResponse20046FiltersConditions) *NullableInlineResponse20046FiltersConditions {
	return &NullableInlineResponse20046FiltersConditions{value: val, isSet: true}
}

func (v NullableInlineResponse20046FiltersConditions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20046FiltersConditions) UnmarshalJSON(src []byte) error {
	v.isSet = true
