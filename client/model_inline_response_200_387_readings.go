...
// InlineResponse200387Readings struct for InlineResponse200387Readings
type InlineResponse200387Readings struct {
	...
	Rate *InlineResponse200387Rate `json:"rate,omitempty"`
}
...
func NewInlineResponse200387Readings() *InlineResponse200387Readings {
	this := InlineResponse200387Readings{}
	return &this
}
...
func (o *InlineResponse200387Readings) GetRate() InlineResponse200387Rate {
	if o == nil || isNil(o.Rate) {
		var ret InlineResponse200387Rate
		return ret
	}
	return *o.Rate
}
...
// SetRate gets a reference to the given InlineResponse200387Rate and assigns it to the Rate field.
func (o *InlineResponse200387Readings) SetRate(v InlineResponse200387Rate) {
	o.Rate = &v
}

func (o InlineResponse200387Readings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200387Readings struct {
	value *InlineResponse200387Readings
	isSet bool
}

func (v NullableInlineResponse200387Readings) Get() *InlineResponse200387Readings {
	return v.value
}

func (v *NullableInlineResponse200387Readings) Set(val *InlineResponse200387Readings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200387Readings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200387Readings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200387Readings(val *InlineResponse200387Readings) *NullableInlineResponse200387Readings {
	return &NullableInlineResponse200387Readings{value: val, isSet: true}
}

func (v NullableInlineResponse200387Readings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200387Readings) UnmarshalJSON(src []byte) error {
	v.isSet = true
