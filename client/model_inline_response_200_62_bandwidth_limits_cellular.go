...
// InlineResponse20062BandwidthLimitsCellular uplink cellular configured limits [optional]
type InlineResponse20062BandwidthLimitsCellular struct {
...
func NewInlineResponse20062BandwidthLimitsCellular() *InlineResponse20062BandwidthLimitsCellular {
	this := InlineResponse20062BandwidthLimitsCellular{}
	return &this
}
...
func (o InlineResponse20062BandwidthLimitsCellular) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20062BandwidthLimitsCellular struct {
	value *InlineResponse20062BandwidthLimitsCellular
	isSet bool
}

func (v NullableInlineResponse20062BandwidthLimitsCellular) Get() *InlineResponse20062BandwidthLimitsCellular {
	return v.value
}

func (v *NullableInlineResponse20062BandwidthLimitsCellular) Set(val *InlineResponse20062BandwidthLimitsCellular) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20062BandwidthLimitsCellular) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20062BandwidthLimitsCellular) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20062BandwidthLimitsCellular(val *InlineResponse20062BandwidthLimitsCellular) *NullableInlineResponse20062BandwidthLimitsCellular {
	return &NullableInlineResponse20062BandwidthLimitsCellular{value: val, isSet: true}
}

func (v NullableInlineResponse20062BandwidthLimitsCellular) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20062BandwidthLimitsCellular) UnmarshalJSON(src []byte) error {
	v.isSet = true
