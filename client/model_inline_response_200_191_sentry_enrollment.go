...
// InlineResponse200191SentryEnrollment Systems Manager sentry enrollment splash settings.
type InlineResponse200191SentryEnrollment struct {
	SystemsManagerNetwork *InlineResponse200191SentryEnrollmentSystemsManagerNetwork `json:"systemsManagerNetwork,omitempty"`
...
func NewInlineResponse200191SentryEnrollment() *InlineResponse200191SentryEnrollment {
	this := InlineResponse200191SentryEnrollment{}
	return &this
}
...
func (o *InlineResponse200191SentryEnrollment) GetSystemsManagerNetwork() InlineResponse200191SentryEnrollmentSystemsManagerNetwork {
	if o == nil || isNil(o.SystemsManagerNetwork) {
		var ret InlineResponse200191SentryEnrollmentSystemsManagerNetwork
		return ret
	}
...
// SetSystemsManagerNetwork gets a reference to the given InlineResponse200191SentryEnrollmentSystemsManagerNetwork and assigns it to the SystemsManagerNetwork field.
...
func (o InlineResponse200191SentryEnrollment) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200191SentryEnrollment struct {
	value *InlineResponse200191SentryEnrollment
	isSet bool
}

func (v NullableInlineResponse200191SentryEnrollment) Get() *InlineResponse200191SentryEnrollment {
	return v.value
}

func (v *NullableInlineResponse200191SentryEnrollment) Set(val *InlineResponse200191SentryEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200191SentryEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200191SentryEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200191SentryEnrollment(val *InlineResponse200191SentryEnrollment) *NullableInlineResponse200191SentryEnrollment {
	return &NullableInlineResponse200191SentryEnrollment{value: val, isSet: true}
}

func (v NullableInlineResponse200191SentryEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200191SentryEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
