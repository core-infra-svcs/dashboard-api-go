...
// InlineResponse20024Events struct for InlineResponse20024Events
type InlineResponse20024Events struct {
	...
	EventData *InlineResponse20024EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20024Events() *InlineResponse20024Events {
	this := InlineResponse20024Events{}
	return &this
}
...
func (o *InlineResponse20024Events) GetEventData() InlineResponse20024EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20024EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20024EventData and assigns it to the EventData field.
func (o *InlineResponse20024Events) SetEventData(v InlineResponse20024EventData) {
	o.EventData = &v
}

func (o InlineResponse20024Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20024Events struct {
	value *InlineResponse20024Events
	isSet bool
}

func (v NullableInlineResponse20024Events) Get() *InlineResponse20024Events {
	return v.value
}

func (v *NullableInlineResponse20024Events) Set(val *InlineResponse20024Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20024Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20024Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20024Events(val *InlineResponse20024Events) *NullableInlineResponse20024Events {
	return &NullableInlineResponse20024Events{value: val, isSet: true}
}

func (v NullableInlineResponse20024Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20024Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
