...
// InlineResponse200373Readings struct for InlineResponse200373Readings
type InlineResponse200373Readings struct {
...
func NewInlineResponse200373Readings() *InlineResponse200373Readings {
	this := InlineResponse200373Readings{}
	return &this
}
...
func (o InlineResponse200373Readings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200373Readings struct {
	value *InlineResponse200373Readings
	isSet bool
}

func (v NullableInlineResponse200373Readings) Get() *InlineResponse200373Readings {
	return v.value
}

func (v *NullableInlineResponse200373Readings) Set(val *InlineResponse200373Readings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200373Readings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200373Readings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200373Readings(val *InlineResponse200373Readings) *NullableInlineResponse200373Readings {
	return &NullableInlineResponse200373Readings{value: val, isSet: true}
}

func (v NullableInlineResponse200373Readings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200373Readings) UnmarshalJSON(src []byte) error {
	v.isSet = true
