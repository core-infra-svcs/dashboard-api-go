...
// InlineResponse20036ValueSource Source of 'custom' type traffic filter
type InlineResponse20036ValueSource struct {
...
func NewInlineResponse20036ValueSource() *InlineResponse20036ValueSource {
	this := InlineResponse20036ValueSource{}
	return &this
}
...
func (o InlineResponse20036ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20036ValueSource struct {
	value *InlineResponse20036ValueSource
	isSet bool
}

func (v NullableInlineResponse20036ValueSource) Get() *InlineResponse20036ValueSource {
	return v.value
}

func (v *NullableInlineResponse20036ValueSource) Set(val *InlineResponse20036ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20036ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20036ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20036ValueSource(val *InlineResponse20036ValueSource) *NullableInlineResponse20036ValueSource {
	return &NullableInlineResponse20036ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20036ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20036ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
