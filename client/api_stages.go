...
func (r StagesApiGetNetworkFirmwareUpgradesStagedStagesRequest) Execute() ([]InlineResponse20092, *http.Response, error) {
...
func (a *StagesApiService) GetNetworkFirmwareUpgradesStagedStagesExecute(r StagesApiGetNetworkFirmwareUpgradesStagedStagesRequest) ([]InlineResponse20092, *http.Response, error) {
	var (
...
func (r StagesApiUpdateNetworkFirmwareUpgradesStagedStagesRequest) Execute() ([]InlineResponse20092, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20092
func (a *StagesApiService) UpdateNetworkFirmwareUpgradesStagedStagesExecute(r StagesApiUpdateNetworkFirmwareUpgradesStagedStagesRequest) ([]InlineResponse20092, *http.Response, error) {
	var (
