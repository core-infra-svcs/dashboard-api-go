...
func (r StagesApiGetNetworkFirmwareUpgradesStagedStagesRequest) Execute() ([]InlineResponse20035, *http.Response, error) {
...
func (a *StagesApiService) GetNetworkFirmwareUpgradesStagedStagesExecute(r StagesApiGetNetworkFirmwareUpgradesStagedStagesRequest) ([]InlineResponse20035, *http.Response, error) {
	var (
...
func (r StagesApiUpdateNetworkFirmwareUpgradesStagedStagesRequest) Execute() ([]InlineResponse20035, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20035
func (a *StagesApiService) UpdateNetworkFirmwareUpgradesStagedStagesExecute(r StagesApiUpdateNetworkFirmwareUpgradesStagedStagesRequest) ([]InlineResponse20035, *http.Response, error) {
	var (
