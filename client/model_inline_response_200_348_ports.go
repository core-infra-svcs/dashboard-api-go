...
type InlineResponse200348Ports struct {
	...
	Cdp []InlineResponse200348Cdp `json:"cdp,omitempty"`
	// The Link Layer Discovery Protocol (LLDP) information of the connected device.
	Lldp []InlineResponse200348Lldp `json:"lldp,omitempty"`
}
...
func (o *InlineResponse200348Ports) GetCdp() []InlineResponse200348Cdp {
	if o == nil || isNil(o.Cdp) {
		var ret []InlineResponse200348Cdp
		return ret
	}
	return o.Cdp
}
...
// SetCdp gets a reference to the given []InlineResponse200348Cdp and assigns it to the Cdp field.
...
func (o *InlineResponse200348Ports) GetLldp() []InlineResponse200348Lldp {
	if o == nil || isNil(o.Lldp) {
		var ret []InlineResponse200348Lldp
		return ret
	}
	return o.Lldp
}
...
// SetLldp gets a reference to the given []InlineResponse200348Lldp and assigns it to the Lldp field.
