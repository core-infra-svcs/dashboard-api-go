...
// InlineResponse200104Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse200104Counts struct {
	...
	Noise *InlineResponse200104CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse200104Counts() *InlineResponse200104Counts {
	this := InlineResponse200104Counts{}
	return &this
}
...
func (o *InlineResponse200104Counts) GetNoise() InlineResponse200104CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse200104CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse200104CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse200104Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200104Counts struct {
	value *InlineResponse200104Counts
	isSet bool
}

func (v NullableInlineResponse200104Counts) Get() *InlineResponse200104Counts {
	return v.value
}

func (v *NullableInlineResponse200104Counts) Set(val *InlineResponse200104Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200104Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200104Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200104Counts(val *InlineResponse200104Counts) *NullableInlineResponse200104Counts {
	return &NullableInlineResponse200104Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200104Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200104Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
