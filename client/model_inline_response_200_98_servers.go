...
// InlineResponse20098Servers struct for InlineResponse20098Servers
type InlineResponse20098Servers struct {
...
func NewInlineResponse20098Servers() *InlineResponse20098Servers {
	this := InlineResponse20098Servers{}
	return &this
}
...
func (o InlineResponse20098Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20098Servers struct {
	value *InlineResponse20098Servers
	isSet bool
}

func (v NullableInlineResponse20098Servers) Get() *InlineResponse20098Servers {
	return v.value
}

func (v *NullableInlineResponse20098Servers) Set(val *InlineResponse20098Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20098Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20098Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20098Servers(val *InlineResponse20098Servers) *NullableInlineResponse20098Servers {
	return &NullableInlineResponse20098Servers{value: val, isSet: true}
}

func (v NullableInlineResponse20098Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20098Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
