...
// InlineResponse200175Servers struct for InlineResponse200175Servers
type InlineResponse200175Servers struct {
...
func NewInlineResponse200175Servers() *InlineResponse200175Servers {
	this := InlineResponse200175Servers{}
	return &this
}
...
func (o InlineResponse200175Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200175Servers struct {
	value *InlineResponse200175Servers
	isSet bool
}

func (v NullableInlineResponse200175Servers) Get() *InlineResponse200175Servers {
	return v.value
}

func (v *NullableInlineResponse200175Servers) Set(val *InlineResponse200175Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200175Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200175Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200175Servers(val *InlineResponse200175Servers) *NullableInlineResponse200175Servers {
	return &NullableInlineResponse200175Servers{value: val, isSet: true}
}

func (v NullableInlineResponse200175Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200175Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
