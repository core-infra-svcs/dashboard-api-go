...
// InlineResponse200151Mappings struct for InlineResponse200151Mappings
type InlineResponse200151Mappings struct {
...
func NewInlineResponse200151Mappings() *InlineResponse200151Mappings {
	this := InlineResponse200151Mappings{}
	return &this
}
...
func (o InlineResponse200151Mappings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200151Mappings struct {
	value *InlineResponse200151Mappings
	isSet bool
}

func (v NullableInlineResponse200151Mappings) Get() *InlineResponse200151Mappings {
	return v.value
}

func (v *NullableInlineResponse200151Mappings) Set(val *InlineResponse200151Mappings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200151Mappings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200151Mappings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200151Mappings(val *InlineResponse200151Mappings) *NullableInlineResponse200151Mappings {
	return &NullableInlineResponse200151Mappings{value: val, isSet: true}
}

func (v NullableInlineResponse200151Mappings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200151Mappings) UnmarshalJSON(src []byte) error {
	v.isSet = true
