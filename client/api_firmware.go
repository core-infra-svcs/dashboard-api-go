...
func (r FirmwareApiGetOrganizationFirmwareUpgradesRequest) Execute() ([]InlineResponse200292, *http.Response, error) {
...
func (a *FirmwareApiService) GetOrganizationFirmwareUpgradesExecute(r FirmwareApiGetOrganizationFirmwareUpgradesRequest) ([]InlineResponse200292, *http.Response, error) {
	var (
...
func (r FirmwareApiGetOrganizationFirmwareUpgradesByDeviceRequest) CurrentUpgradesOnly(currentUpgradesOnly bool) FirmwareApiGetOrganizationFirmwareUpgradesByDeviceRequest {
...
func (r FirmwareApiGetOrganizationFirmwareUpgradesByDeviceRequest) LimitPerDevice(limitPerDevice int32) FirmwareApiGetOrganizationFirmwareUpgradesByDeviceRequest {
	r.limitPerDevice = &limitPerDevice
	return r
}

func (r FirmwareApiGetOrganizationFirmwareUpgradesByDeviceRequest) Execute() ([]InlineResponse200293, *http.Response, error) {
...
func (a *FirmwareApiService) GetOrganizationFirmwareUpgradesByDeviceExecute(r FirmwareApiGetOrganizationFirmwareUpgradesByDeviceRequest) ([]InlineResponse200293, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
