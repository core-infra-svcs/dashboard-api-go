...
func (r FirmwareApiGetOrganizationFirmwareUpgradesRequest) Execute() ([]InlineResponse200132, *http.Response, error) {
...
func (a *FirmwareApiService) GetOrganizationFirmwareUpgradesExecute(r FirmwareApiGetOrganizationFirmwareUpgradesRequest) ([]InlineResponse200132, *http.Response, error) {
	var (
...
func (r FirmwareApiGetOrganizationFirmwareUpgradesByDeviceRequest) Execute() ([]InlineResponse200133, *http.Response, error) {
...
func (a *FirmwareApiService) GetOrganizationFirmwareUpgradesByDeviceExecute(r FirmwareApiGetOrganizationFirmwareUpgradesByDeviceRequest) ([]InlineResponse200133, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
