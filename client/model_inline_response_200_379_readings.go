...
// InlineResponse200379Readings struct for InlineResponse200379Readings
type InlineResponse200379Readings struct {
...
func NewInlineResponse200379Readings() *InlineResponse200379Readings {
	this := InlineResponse200379Readings{}
	return &this
}
...
func (o InlineResponse200379Readings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200379Readings struct {
	value *InlineResponse200379Readings
	isSet bool
}

func (v NullableInlineResponse200379Readings) Get() *InlineResponse200379Readings {
	return v.value
}

func (v *NullableInlineResponse200379Readings) Set(val *InlineResponse200379Readings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200379Readings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200379Readings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200379Readings(val *InlineResponse200379Readings) *NullableInlineResponse200379Readings {
	return &NullableInlineResponse200379Readings{value: val, isSet: true}
}

func (v NullableInlineResponse200379Readings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200379Readings) UnmarshalJSON(src []byte) error {
	v.isSet = true
