...
// InlineResponse200290BasicServiceSets struct for InlineResponse200290BasicServiceSets
type InlineResponse200290BasicServiceSets struct {
	// Unique identifier for wireless access point.
	Bssid *string `json:"bssid,omitempty"`
	Ssid *InlineResponse200290Ssid `json:"ssid,omitempty"`
	Radio *InlineResponse200290Radio `json:"radio,omitempty"`
}
...
func NewInlineResponse200290BasicServiceSets() *InlineResponse200290BasicServiceSets {
	this := InlineResponse200290BasicServiceSets{}
	return &this
}
...
func (o *InlineResponse200290BasicServiceSets) GetSsid() InlineResponse200290Ssid {
	if o == nil || isNil(o.Ssid) {
		var ret InlineResponse200290Ssid
		return ret
	}
	return *o.Ssid
}
...
// SetSsid gets a reference to the given InlineResponse200290Ssid and assigns it to the Ssid field.
...
func (o *InlineResponse200290BasicServiceSets) GetRadio() InlineResponse200290Radio {
	if o == nil || isNil(o.Radio) {
		var ret InlineResponse200290Radio
		return ret
	}
	return *o.Radio
}
...
// SetRadio gets a reference to the given InlineResponse200290Radio and assigns it to the Radio field.
func (o *InlineResponse200290BasicServiceSets) SetRadio(v InlineResponse200290Radio) {
	o.Radio = &v
}

func (o InlineResponse200290BasicServiceSets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200290BasicServiceSets struct {
	value *InlineResponse200290BasicServiceSets
	isSet bool
}

func (v NullableInlineResponse200290BasicServiceSets) Get() *InlineResponse200290BasicServiceSets {
	return v.value
}

func (v *NullableInlineResponse200290BasicServiceSets) Set(val *InlineResponse200290BasicServiceSets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200290BasicServiceSets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200290BasicServiceSets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200290BasicServiceSets(val *InlineResponse200290BasicServiceSets) *NullableInlineResponse200290BasicServiceSets {
	return &NullableInlineResponse200290BasicServiceSets{value: val, isSet: true}
}

func (v NullableInlineResponse200290BasicServiceSets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200290BasicServiceSets) UnmarshalJSON(src []byte) error {
	v.isSet = true
