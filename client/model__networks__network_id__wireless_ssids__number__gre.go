...
type NetworksNetworkIdWirelessSsidsNumberGre struct {
	...
	Key NullableInt32 `json:"key,omitempty"`
}
...
// SetKey gets a reference to the given NullableInt32 and assigns it to the Key field.
func (o *NetworksNetworkIdWirelessSsidsNumberGre) SetKey(v int32) {
	o.Key.Set(&v)
}
// SetKeyNil sets the value for Key to be an explicit nil
func (o *NetworksNetworkIdWirelessSsidsNumberGre) SetKeyNil() {
	o.Key.Set(nil)
}
