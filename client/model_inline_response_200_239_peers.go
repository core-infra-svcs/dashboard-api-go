...
// InlineResponse200239Peers struct for InlineResponse200239Peers
type InlineResponse200239Peers struct {
	...
	IpsecPolicies *InlineResponse200239IpsecPolicies `json:"ipsecPolicies,omitempty"`
	SlaPolicy *InlineResponse200239SlaPolicy `json:"slaPolicy,omitempty"`
	...
	Network *InlineResponse200239Network `json:"network,omitempty"`
	...
	EbgpNeighbor *InlineResponse200239EbgpNeighbor `json:"ebgpNeighbor,omitempty"`
	// [optional] Represents the order of peer inside a group.
	PriorityInGroup *int32 `json:"priorityInGroup,omitempty"`
	Group *InlineResponse200239Group `json:"group,omitempty"`
}
...
func NewInlineResponse200239Peers() *InlineResponse200239Peers {
	this := InlineResponse200239Peers{}
...
func (o *InlineResponse200239Peers) GetIpsecPolicies() InlineResponse200239IpsecPolicies {
	if o == nil || isNil(o.IpsecPolicies) {
		var ret InlineResponse200239IpsecPolicies
		return ret
	}
...
// SetIpsecPolicies gets a reference to the given InlineResponse200239IpsecPolicies and assigns it to the IpsecPolicies field.
...
func (o *InlineResponse200239Peers) GetSlaPolicy() InlineResponse200239SlaPolicy {
	if o == nil || isNil(o.SlaPolicy) {
		var ret InlineResponse200239SlaPolicy
		return ret
	}
	return *o.SlaPolicy
}
...
// SetSlaPolicy gets a reference to the given InlineResponse200239SlaPolicy and assigns it to the SlaPolicy field.
...
func (o *InlineResponse200239Peers) GetNetwork() InlineResponse200239Network {
	if o == nil || isNil(o.Network) {
		var ret InlineResponse200239Network
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given InlineResponse200239Network and assigns it to the Network field.
...
func (o *InlineResponse200239Peers) GetEbgpNeighbor() InlineResponse200239EbgpNeighbor {
	if o == nil || isNil(o.EbgpNeighbor) {
		var ret InlineResponse200239EbgpNeighbor
		return ret
	}
...
// SetEbgpNeighbor gets a reference to the given InlineResponse200239EbgpNeighbor and assigns it to the EbgpNeighbor field.
...
func (o *InlineResponse200239Peers) GetGroup() InlineResponse200239Group {
	if o == nil || isNil(o.Group) {
		var ret InlineResponse200239Group
		return ret
	}
	return *o.Group
}
...
// SetGroup gets a reference to the given InlineResponse200239Group and assigns it to the Group field.
func (o *InlineResponse200239Peers) SetGroup(v InlineResponse200239Group) {
	o.Group = &v
}

func (o InlineResponse200239Peers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200239Peers struct {
	value *InlineResponse200239Peers
	isSet bool
}

func (v NullableInlineResponse200239Peers) Get() *InlineResponse200239Peers {
	return v.value
}

func (v *NullableInlineResponse200239Peers) Set(val *InlineResponse200239Peers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200239Peers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200239Peers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200239Peers(val *InlineResponse200239Peers) *NullableInlineResponse200239Peers {
	return &NullableInlineResponse200239Peers{value: val, isSet: true}
}

func (v NullableInlineResponse200239Peers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200239Peers) UnmarshalJSON(src []byte) error {
	v.isSet = true
