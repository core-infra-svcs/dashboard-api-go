...
type SecurityCentersApiApiGetNetworkSmDeviceSecurityCentersRequest struct {
...
func (r SecurityCentersApiApiGetNetworkSmDeviceSecurityCentersRequest) Execute() ([]map[string]interface{}, *_nethttp.Response, error) {
...
List the security centers on a device
 ...
 @param networkId
 @param deviceId
 @return SecurityCentersApiApiGetNetworkSmDeviceSecurityCentersRequest
*/
func (a *SecurityCentersApiService) GetNetworkSmDeviceSecurityCenters(ctx _context.Context, networkId string, deviceId string) SecurityCentersApiApiGetNetworkSmDeviceSecurityCentersRequest {
	return SecurityCentersApiApiGetNetworkSmDeviceSecurityCentersRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *SecurityCentersApiService) GetNetworkSmDeviceSecurityCentersExecute(r SecurityCentersApiApiGetNetworkSmDeviceSecurityCentersRequest) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
