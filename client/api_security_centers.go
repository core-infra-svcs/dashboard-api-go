...
func (r SecurityCentersApiGetNetworkSmDeviceSecurityCentersRequest) Execute() ([]InlineResponse200136, *http.Response, error) {
...
func (a *SecurityCentersApiService) GetNetworkSmDeviceSecurityCentersExecute(r SecurityCentersApiGetNetworkSmDeviceSecurityCentersRequest) ([]InlineResponse200136, *http.Response, error) {
	var (
