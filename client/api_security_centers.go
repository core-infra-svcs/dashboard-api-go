...
func (r SecurityCentersApiApiGetNetworkSmDeviceSecurityCentersRequest) Execute() ([]InlineResponse20038, *_nethttp.Response, error) {
...
func (a *SecurityCentersApiService) GetNetworkSmDeviceSecurityCentersExecute(r SecurityCentersApiApiGetNetworkSmDeviceSecurityCentersRequest) ([]InlineResponse20038, *_nethttp.Response, error) {
	var (
