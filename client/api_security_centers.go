...
func (r SecurityCentersApiGetNetworkSmDeviceSecurityCentersRequest) Execute() ([]InlineResponse20065, *http.Response, error) {
...
func (a *SecurityCentersApiService) GetNetworkSmDeviceSecurityCentersExecute(r SecurityCentersApiGetNetworkSmDeviceSecurityCentersRequest) ([]InlineResponse20065, *http.Response, error) {
	var (
