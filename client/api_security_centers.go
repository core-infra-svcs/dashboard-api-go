...
func (r SecurityCentersApiGetNetworkSmDeviceSecurityCentersRequest) Execute() ([]InlineResponse200128, *http.Response, error) {
...
func (a *SecurityCentersApiService) GetNetworkSmDeviceSecurityCentersExecute(r SecurityCentersApiGetNetworkSmDeviceSecurityCentersRequest) ([]InlineResponse200128, *http.Response, error) {
	var (
