...
func (r SecurityCentersApiGetNetworkSmDeviceSecurityCentersRequest) Execute() ([]InlineResponse20073, *http.Response, error) {
...
func (a *SecurityCentersApiService) GetNetworkSmDeviceSecurityCentersExecute(r SecurityCentersApiGetNetworkSmDeviceSecurityCentersRequest) ([]InlineResponse20073, *http.Response, error) {
	var (
