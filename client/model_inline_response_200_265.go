...
type InlineResponse200265 struct {
	...
	States *InlineResponse200265States `json:"states,omitempty"`
	// Data by license type (Per-device licensing only)
	LicenseTypes []InlineResponse200265LicenseTypes `json:"licenseTypes,omitempty"`
	SystemsManager *InlineResponse200265SystemsManager `json:"systemsManager,omitempty"`
}
...
func (o *InlineResponse200265) GetStates() InlineResponse200265States {
	if o == nil || isNil(o.States) {
		var ret InlineResponse200265States
		return ret
	}
	return *o.States
}
...
// SetStates gets a reference to the given InlineResponse200265States and assigns it to the States field.
...
func (o *InlineResponse200265) GetLicenseTypes() []InlineResponse200265LicenseTypes {
	if o == nil || isNil(o.LicenseTypes) {
		var ret []InlineResponse200265LicenseTypes
		return ret
	}
...
// SetLicenseTypes gets a reference to the given []InlineResponse200265LicenseTypes and assigns it to the LicenseTypes field.
...
func (o *InlineResponse200265) GetSystemsManager() InlineResponse200265SystemsManager {
	if o == nil || isNil(o.SystemsManager) {
		var ret InlineResponse200265SystemsManager
		return ret
	}
...
// SetSystemsManager gets a reference to the given InlineResponse200265SystemsManager and assigns it to the SystemsManager field.
