...
func (r WirelessProfilesApiCreateNetworkCameraWirelessProfileRequest) CreateNetworkCameraWirelessProfile(createNetworkCameraWirelessProfile InlineObject83) WirelessProfilesApiCreateNetworkCameraWirelessProfileRequest {
	r.createNetworkCameraWirelessProfile = &createNetworkCameraWirelessProfile
	return r
}

func (r WirelessProfilesApiCreateNetworkCameraWirelessProfileRequest) Execute() (*InlineResponse20081, *http.Response, error) {
...
func (a *WirelessProfilesApiService) CreateNetworkCameraWirelessProfileExecute(r WirelessProfilesApiCreateNetworkCameraWirelessProfileRequest) (*InlineResponse20081, *http.Response, error) {
	var (
...
func (r WirelessProfilesApiGetNetworkCameraWirelessProfileRequest) Execute() (*InlineResponse20081, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20081
func (a *WirelessProfilesApiService) GetNetworkCameraWirelessProfileExecute(r WirelessProfilesApiGetNetworkCameraWirelessProfileRequest) (*InlineResponse20081, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WirelessProfilesApiGetNetworkCameraWirelessProfilesRequest) Execute() ([]InlineResponse20081, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20081
func (a *WirelessProfilesApiService) GetNetworkCameraWirelessProfilesExecute(r WirelessProfilesApiGetNetworkCameraWirelessProfilesRequest) ([]InlineResponse20081, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WirelessProfilesApiUpdateNetworkCameraWirelessProfileRequest) UpdateNetworkCameraWirelessProfile(updateNetworkCameraWirelessProfile InlineObject84) WirelessProfilesApiUpdateNetworkCameraWirelessProfileRequest {
	r.updateNetworkCameraWirelessProfile = &updateNetworkCameraWirelessProfile
	return r
}

func (r WirelessProfilesApiUpdateNetworkCameraWirelessProfileRequest) Execute() (*InlineResponse20081, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20081
func (a *WirelessProfilesApiService) UpdateNetworkCameraWirelessProfileExecute(r WirelessProfilesApiUpdateNetworkCameraWirelessProfileRequest) (*InlineResponse20081, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
