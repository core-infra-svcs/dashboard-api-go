...
func (r WirelessProfilesApiCreateNetworkCameraWirelessProfileRequest) CreateNetworkCameraWirelessProfile(createNetworkCameraWirelessProfile InlineObject81) WirelessProfilesApiCreateNetworkCameraWirelessProfileRequest {
	r.createNetworkCameraWirelessProfile = &createNetworkCameraWirelessProfile
	return r
}

func (r WirelessProfilesApiCreateNetworkCameraWirelessProfileRequest) Execute() (*InlineResponse20079, *http.Response, error) {
...
func (a *WirelessProfilesApiService) CreateNetworkCameraWirelessProfileExecute(r WirelessProfilesApiCreateNetworkCameraWirelessProfileRequest) (*InlineResponse20079, *http.Response, error) {
	var (
...
func (r WirelessProfilesApiGetNetworkCameraWirelessProfileRequest) Execute() (*InlineResponse20079, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20079
func (a *WirelessProfilesApiService) GetNetworkCameraWirelessProfileExecute(r WirelessProfilesApiGetNetworkCameraWirelessProfileRequest) (*InlineResponse20079, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WirelessProfilesApiGetNetworkCameraWirelessProfilesRequest) Execute() ([]InlineResponse20079, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20079
func (a *WirelessProfilesApiService) GetNetworkCameraWirelessProfilesExecute(r WirelessProfilesApiGetNetworkCameraWirelessProfilesRequest) ([]InlineResponse20079, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WirelessProfilesApiUpdateNetworkCameraWirelessProfileRequest) UpdateNetworkCameraWirelessProfile(updateNetworkCameraWirelessProfile InlineObject82) WirelessProfilesApiUpdateNetworkCameraWirelessProfileRequest {
	r.updateNetworkCameraWirelessProfile = &updateNetworkCameraWirelessProfile
	return r
}

func (r WirelessProfilesApiUpdateNetworkCameraWirelessProfileRequest) Execute() (*InlineResponse20079, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20079
func (a *WirelessProfilesApiService) UpdateNetworkCameraWirelessProfileExecute(r WirelessProfilesApiUpdateNetworkCameraWirelessProfileRequest) (*InlineResponse20079, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
