...
func (r WirelessProfilesApiCreateNetworkCameraWirelessProfileRequest) Execute() (*InlineResponse20086, *http.Response, error) {
...
func (a *WirelessProfilesApiService) CreateNetworkCameraWirelessProfileExecute(r WirelessProfilesApiCreateNetworkCameraWirelessProfileRequest) (*InlineResponse20086, *http.Response, error) {
	var (
...
func (r WirelessProfilesApiGetNetworkCameraWirelessProfileRequest) Execute() (*InlineResponse20086, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20086
func (a *WirelessProfilesApiService) GetNetworkCameraWirelessProfileExecute(r WirelessProfilesApiGetNetworkCameraWirelessProfileRequest) (*InlineResponse20086, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WirelessProfilesApiGetNetworkCameraWirelessProfilesRequest) Execute() ([]InlineResponse20086, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20086
func (a *WirelessProfilesApiService) GetNetworkCameraWirelessProfilesExecute(r WirelessProfilesApiGetNetworkCameraWirelessProfilesRequest) ([]InlineResponse20086, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WirelessProfilesApiUpdateNetworkCameraWirelessProfileRequest) Execute() (*InlineResponse20086, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20086
func (a *WirelessProfilesApiService) UpdateNetworkCameraWirelessProfileExecute(r WirelessProfilesApiUpdateNetworkCameraWirelessProfileRequest) (*InlineResponse20086, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
