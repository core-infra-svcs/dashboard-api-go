...
// InlineResponse20021Group The staged upgrade group
type InlineResponse20021Group struct {
...
func (o InlineResponse20021Group) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20021Group struct {
	value *InlineResponse20021Group
	isSet bool
}

func (v NullableInlineResponse20021Group) Get() *InlineResponse20021Group {
	return v.value
}

func (v *NullableInlineResponse20021Group) Set(val *InlineResponse20021Group) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20021Group) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20021Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20021Group(val *InlineResponse20021Group) *NullableInlineResponse20021Group {
	return &NullableInlineResponse20021Group{value: val, isSet: true}
}

func (v NullableInlineResponse20021Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20021Group) UnmarshalJSON(src []byte) error {
	v.isSet = true
