...
// InlineResponse200162ResultingNetwork Network after the combination
type InlineResponse200162ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200162ResultingNetwork() *InlineResponse200162ResultingNetwork {
	this := InlineResponse200162ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200162ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200162ResultingNetwork struct {
	value *InlineResponse200162ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200162ResultingNetwork) Get() *InlineResponse200162ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200162ResultingNetwork) Set(val *InlineResponse200162ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200162ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200162ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200162ResultingNetwork(val *InlineResponse200162ResultingNetwork) *NullableInlineResponse200162ResultingNetwork {
	return &NullableInlineResponse200162ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200162ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200162ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
