...
func (r WebhookTestsApiCreateNetworkWebhooksWebhookTestRequest) CreateNetworkWebhooksWebhookTest(createNetworkWebhooksWebhookTest InlineObject173) WebhookTestsApiCreateNetworkWebhooksWebhookTestRequest {
	r.createNetworkWebhooksWebhookTest = &createNetworkWebhooksWebhookTest
	return r
}

func (r WebhookTestsApiCreateNetworkWebhooksWebhookTestRequest) Execute() (*InlineResponse2019, *http.Response, error) {
...
func (a *WebhookTestsApiService) CreateNetworkWebhooksWebhookTestExecute(r WebhookTestsApiCreateNetworkWebhooksWebhookTestRequest) (*InlineResponse2019, *http.Response, error) {
	var (
...
func (r WebhookTestsApiGetNetworkWebhooksWebhookTestRequest) Execute() (*InlineResponse2019, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2019
func (a *WebhookTestsApiService) GetNetworkWebhooksWebhookTestExecute(r WebhookTestsApiGetNetworkWebhooksWebhookTestRequest) (*InlineResponse2019, *http.Response, error) {
	var (
