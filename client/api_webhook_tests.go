...
func (r WebhookTestsApiCreateNetworkWebhooksWebhookTestRequest) CreateNetworkWebhooksWebhookTest(createNetworkWebhooksWebhookTest InlineObject178) WebhookTestsApiCreateNetworkWebhooksWebhookTestRequest {
	r.createNetworkWebhooksWebhookTest = &createNetworkWebhooksWebhookTest
	return r
}

func (r WebhookTestsApiCreateNetworkWebhooksWebhookTestRequest) Execute() (*InlineResponse20113, *http.Response, error) {
...
func (a *WebhookTestsApiService) CreateNetworkWebhooksWebhookTestExecute(r WebhookTestsApiCreateNetworkWebhooksWebhookTestRequest) (*InlineResponse20113, *http.Response, error) {
	var (
...
func (r WebhookTestsApiGetNetworkWebhooksWebhookTestRequest) Execute() (*InlineResponse20113, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20113
func (a *WebhookTestsApiService) GetNetworkWebhooksWebhookTestExecute(r WebhookTestsApiGetNetworkWebhooksWebhookTestRequest) (*InlineResponse20113, *http.Response, error) {
	var (
