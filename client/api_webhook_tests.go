...
func (r WebhookTestsApiCreateNetworkWebhooksWebhookTestRequest) CreateNetworkWebhooksWebhookTest(createNetworkWebhooksWebhookTest InlineObject165) WebhookTestsApiCreateNetworkWebhooksWebhookTestRequest {
	r.createNetworkWebhooksWebhookTest = &createNetworkWebhooksWebhookTest
	return r
}

func (r WebhookTestsApiCreateNetworkWebhooksWebhookTestRequest) Execute() (*InlineResponse2016, *http.Response, error) {
...
func (a *WebhookTestsApiService) CreateNetworkWebhooksWebhookTestExecute(r WebhookTestsApiCreateNetworkWebhooksWebhookTestRequest) (*InlineResponse2016, *http.Response, error) {
	var (
...
func (r WebhookTestsApiGetNetworkWebhooksWebhookTestRequest) Execute() (*InlineResponse2016, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2016
func (a *WebhookTestsApiService) GetNetworkWebhooksWebhookTestExecute(r WebhookTestsApiGetNetworkWebhooksWebhookTestRequest) (*InlineResponse2016, *http.Response, error) {
	var (
