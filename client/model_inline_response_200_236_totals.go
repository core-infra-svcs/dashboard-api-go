...
// InlineResponse200236Totals Totals by Severity
type InlineResponse200236Totals struct {
...
func NewInlineResponse200236Totals() *InlineResponse200236Totals {
	this := InlineResponse200236Totals{}
	return &this
}
...
func (o InlineResponse200236Totals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200236Totals struct {
	value *InlineResponse200236Totals
	isSet bool
}

func (v NullableInlineResponse200236Totals) Get() *InlineResponse200236Totals {
	return v.value
}

func (v *NullableInlineResponse200236Totals) Set(val *InlineResponse200236Totals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200236Totals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200236Totals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200236Totals(val *InlineResponse200236Totals) *NullableInlineResponse200236Totals {
	return &NullableInlineResponse200236Totals{value: val, isSet: true}
}

func (v NullableInlineResponse200236Totals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200236Totals) UnmarshalJSON(src []byte) error {
	v.isSet = true
