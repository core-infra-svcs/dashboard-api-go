...
func (r DnsApiBulkOrganizationApplianceDnsLocalProfilesAssignmentsCreateRequest) BulkOrganizationApplianceDnsLocalProfilesAssignmentsCreate(bulkOrganizationApplianceDnsLocalProfilesAssignmentsCreate InlineObject219) DnsApiBulkOrganizationApplianceDnsLocalProfilesAssignmentsCreateRequest {
	r.bulkOrganizationApplianceDnsLocalProfilesAssignmentsCreate = &bulkOrganizationApplianceDnsLocalProfilesAssignmentsCreate
	return r
}

func (r DnsApiBulkOrganizationApplianceDnsLocalProfilesAssignmentsCreateRequest) Execute() (*InlineResponse200221, *http.Response, error) {
...
func (a *DnsApiService) BulkOrganizationApplianceDnsLocalProfilesAssignmentsCreateExecute(r DnsApiBulkOrganizationApplianceDnsLocalProfilesAssignmentsCreateRequest) (*InlineResponse200221, *http.Response, error) {
	var (
