...
// InlineResponse20014ConnectionStats The connection stats of the device
type InlineResponse20014ConnectionStats struct {
...
func NewInlineResponse20014ConnectionStats() *InlineResponse20014ConnectionStats {
	this := InlineResponse20014ConnectionStats{}
	return &this
}
...
func (o InlineResponse20014ConnectionStats) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20014ConnectionStats struct {
	value *InlineResponse20014ConnectionStats
	isSet bool
}

func (v NullableInlineResponse20014ConnectionStats) Get() *InlineResponse20014ConnectionStats {
	return v.value
}

func (v *NullableInlineResponse20014ConnectionStats) Set(val *InlineResponse20014ConnectionStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20014ConnectionStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20014ConnectionStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20014ConnectionStats(val *InlineResponse20014ConnectionStats) *NullableInlineResponse20014ConnectionStats {
	return &NullableInlineResponse20014ConnectionStats{value: val, isSet: true}
}

func (v NullableInlineResponse20014ConnectionStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20014ConnectionStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
