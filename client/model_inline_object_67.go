...
type InlineObject67 struct {
	...
	// Gateway VLAN ID
	GatewayVlanId NullableString `json:"gatewayVlanId,omitempty"`
	// Whether the route should be enabled or not
	Enabled *bool `json:"enabled,omitempty"`
	// Fixed DHCP IP assignments on the route
	FixedIpAssignments *map[string]NetworksNetworkIdApplianceStaticRoutesStaticRouteIdFixedIpAssignments `json:"fixedIpAssignments,omitempty"`
...
// GetGatewayVlanId returns the GatewayVlanId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *InlineObject67) GetGatewayVlanId() string {
	if o == nil || isNil(o.GatewayVlanId.Get()) {
		var ret string
		return ret
	}
	return *o.GatewayVlanId.Get()
}
...
func (o *InlineObject67) GetGatewayVlanIdOk() (*string, bool) {
	...
	return o.GatewayVlanId.Get(), o.GatewayVlanId.IsSet()
}

// HasGatewayVlanId returns a boolean if a field has been set.
func (o *InlineObject67) HasGatewayVlanId() bool {
	if o != nil && o.GatewayVlanId.IsSet() {
		return true
	}
...
// SetGatewayVlanId gets a reference to the given NullableString and assigns it to the GatewayVlanId field.
func (o *InlineObject67) SetGatewayVlanId(v string) {
	o.GatewayVlanId.Set(&v)
}
// SetGatewayVlanIdNil sets the value for GatewayVlanId to be an explicit nil
func (o *InlineObject67) SetGatewayVlanIdNil() {
	o.GatewayVlanId.Set(nil)
}
...
func (o *InlineObject67) GetFixedIpAssignments() map[string]NetworksNetworkIdApplianceStaticRoutesStaticRouteIdFixedIpAssignments {
	if o == nil || isNil(o.FixedIpAssignments) {
		var ret map[string]NetworksNetworkIdApplianceStaticRoutesStaticRouteIdFixedIpAssignments
		return ret
	}
...
// SetFixedIpAssignments gets a reference to the given map[string]NetworksNetworkIdApplianceStaticRoutesStaticRouteIdFixedIpAssignments and assigns it to the FixedIpAssignments field.
...
func (o InlineObject67) MarshalJSON() ([]byte, error) {
	...
	if o.GatewayVlanId.IsSet() {
		toSerialize["gatewayVlanId"] = o.GatewayVlanId.Get()
	}
	if !isNil(o.Enabled) {
