...
// InlineResponse20049Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse20049Counts struct {
	...
	Noise *InlineResponse20049CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse20049Counts() *InlineResponse20049Counts {
	this := InlineResponse20049Counts{}
	return &this
}
...
func (o *InlineResponse20049Counts) GetNoise() InlineResponse20049CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse20049CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse20049CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse20049Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20049Counts struct {
	value *InlineResponse20049Counts
	isSet bool
}

func (v NullableInlineResponse20049Counts) Get() *InlineResponse20049Counts {
	return v.value
}

func (v *NullableInlineResponse20049Counts) Set(val *InlineResponse20049Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20049Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20049Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20049Counts(val *InlineResponse20049Counts) *NullableInlineResponse20049Counts {
	return &NullableInlineResponse20049Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20049Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20049Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
