...
// InlineResponse20021DynamicDns Dynamic DNS settings for a network
type InlineResponse20021DynamicDns struct {
	// Dynamic DNS enabled
...
func NewInlineResponse20021DynamicDns() *InlineResponse20021DynamicDns {
	this := InlineResponse20021DynamicDns{}
	return &this
}
...
func (o InlineResponse20021DynamicDns) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20021DynamicDns struct {
	value *InlineResponse20021DynamicDns
	isSet bool
}

func (v NullableInlineResponse20021DynamicDns) Get() *InlineResponse20021DynamicDns {
	return v.value
}

func (v *NullableInlineResponse20021DynamicDns) Set(val *InlineResponse20021DynamicDns) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20021DynamicDns) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20021DynamicDns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20021DynamicDns(val *InlineResponse20021DynamicDns) *NullableInlineResponse20021DynamicDns {
	return &NullableInlineResponse20021DynamicDns{value: val, isSet: true}
}

func (v NullableInlineResponse20021DynamicDns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20021DynamicDns) UnmarshalJSON(src []byte) error {
	v.isSet = true
