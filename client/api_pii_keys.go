...
func (r PiiKeysApiGetNetworkPiiPiiKeysRequest) Execute() (*map[string]InlineResponse200114, *http.Response, error) {
...
func (a *PiiKeysApiService) GetNetworkPiiPiiKeysExecute(r PiiKeysApiGetNetworkPiiPiiKeysRequest) (*map[string]InlineResponse200114, *http.Response, error) {
	var (
