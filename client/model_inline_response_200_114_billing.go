...
// InlineResponse200114Billing Details associated with billing splash
type InlineResponse200114Billing struct {
	FreeAccess *InlineResponse200114BillingFreeAccess `json:"freeAccess,omitempty"`
...
func NewInlineResponse200114Billing() *InlineResponse200114Billing {
	this := InlineResponse200114Billing{}
	return &this
}
...
func (o *InlineResponse200114Billing) GetFreeAccess() InlineResponse200114BillingFreeAccess {
	if o == nil || isNil(o.FreeAccess) {
		var ret InlineResponse200114BillingFreeAccess
		return ret
	}
	return *o.FreeAccess
}
...
// SetFreeAccess gets a reference to the given InlineResponse200114BillingFreeAccess and assigns it to the FreeAccess field.
...
func (o InlineResponse200114Billing) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200114Billing struct {
	value *InlineResponse200114Billing
	isSet bool
}

func (v NullableInlineResponse200114Billing) Get() *InlineResponse200114Billing {
	return v.value
}

func (v *NullableInlineResponse200114Billing) Set(val *InlineResponse200114Billing) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200114Billing) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200114Billing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200114Billing(val *InlineResponse200114Billing) *NullableInlineResponse200114Billing {
	return &NullableInlineResponse200114Billing{value: val, isSet: true}
}

func (v NullableInlineResponse200114Billing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200114Billing) UnmarshalJSON(src []byte) error {
	v.isSet = true
