...
// InlineResponse200353Interfaces struct for InlineResponse200353Interfaces
type InlineResponse200353Interfaces struct {
	...
	Addresses []InlineResponse200353Addresses `json:"addresses,omitempty"`
	Vrf *InlineResponse200353Vrf `json:"vrf,omitempty"`
...
func NewInlineResponse200353Interfaces() *InlineResponse200353Interfaces {
	this := InlineResponse200353Interfaces{}
	return &this
}
...
func (o *InlineResponse200353Interfaces) GetAddresses() []InlineResponse200353Addresses {
	if o == nil || isNil(o.Addresses) {
		var ret []InlineResponse200353Addresses
		return ret
	}
	return o.Addresses
}
...
// SetAddresses gets a reference to the given []InlineResponse200353Addresses and assigns it to the Addresses field.
...
func (o *InlineResponse200353Interfaces) GetVrf() InlineResponse200353Vrf {
	if o == nil || isNil(o.Vrf) {
		var ret InlineResponse200353Vrf
		return ret
	}
	return *o.Vrf
}
...
// SetVrf gets a reference to the given InlineResponse200353Vrf and assigns it to the Vrf field.
...
func (o InlineResponse200353Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200353Interfaces struct {
	value *InlineResponse200353Interfaces
	isSet bool
}

func (v NullableInlineResponse200353Interfaces) Get() *InlineResponse200353Interfaces {
	return v.value
}

func (v *NullableInlineResponse200353Interfaces) Set(val *InlineResponse200353Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200353Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200353Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200353Interfaces(val *InlineResponse200353Interfaces) *NullableInlineResponse200353Interfaces {
	return &NullableInlineResponse200353Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200353Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200353Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
