...
type InlineResponse200169 struct {
	...
	RemainderLicenses []InlineResponse200168 `json:"remainderLicenses,omitempty"`
	// Newly moved licenses created in the destination organization of the license move operation
	MovedLicenses []InlineResponse200168 `json:"movedLicenses,omitempty"`
}
...
// SetRemainderLicenses gets a reference to the given []InlineResponse200168 and assigns it to the RemainderLicenses field.
...
// SetMovedLicenses gets a reference to the given []InlineResponse200168 and assigns it to the MovedLicenses field.
