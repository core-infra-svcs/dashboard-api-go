...
// InlineResponse200237IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200237IpsecPolicies struct {
...
func NewInlineResponse200237IpsecPolicies() *InlineResponse200237IpsecPolicies {
	this := InlineResponse200237IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200237IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200237IpsecPolicies struct {
	value *InlineResponse200237IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200237IpsecPolicies) Get() *InlineResponse200237IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200237IpsecPolicies) Set(val *InlineResponse200237IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200237IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200237IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200237IpsecPolicies(val *InlineResponse200237IpsecPolicies) *NullableInlineResponse200237IpsecPolicies {
	return &NullableInlineResponse200237IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200237IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200237IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
