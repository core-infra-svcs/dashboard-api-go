...
// InlineResponse200127IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200127IpsecPolicies struct {
...
func NewInlineResponse200127IpsecPolicies() *InlineResponse200127IpsecPolicies {
	this := InlineResponse200127IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200127IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200127IpsecPolicies struct {
	value *InlineResponse200127IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200127IpsecPolicies) Get() *InlineResponse200127IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200127IpsecPolicies) Set(val *InlineResponse200127IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200127IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200127IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200127IpsecPolicies(val *InlineResponse200127IpsecPolicies) *NullableInlineResponse200127IpsecPolicies {
	return &NullableInlineResponse200127IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200127IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200127IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
