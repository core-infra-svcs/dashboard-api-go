...
// InlineResponse20095EventData An object containing more data related to the event.
type InlineResponse20095EventData struct {
...
func NewInlineResponse20095EventData() *InlineResponse20095EventData {
	this := InlineResponse20095EventData{}
	return &this
}
...
func (o InlineResponse20095EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20095EventData struct {
	value *InlineResponse20095EventData
	isSet bool
}

func (v NullableInlineResponse20095EventData) Get() *InlineResponse20095EventData {
	return v.value
}

func (v *NullableInlineResponse20095EventData) Set(val *InlineResponse20095EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20095EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20095EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20095EventData(val *InlineResponse20095EventData) *NullableInlineResponse20095EventData {
	return &NullableInlineResponse20095EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20095EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20095EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
