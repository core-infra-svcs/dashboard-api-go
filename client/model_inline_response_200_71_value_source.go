...
// InlineResponse20071ValueSource Source of 'custom' type traffic filter
type InlineResponse20071ValueSource struct {
...
func NewInlineResponse20071ValueSource() *InlineResponse20071ValueSource {
	this := InlineResponse20071ValueSource{}
	return &this
}
...
func (o InlineResponse20071ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20071ValueSource struct {
	value *InlineResponse20071ValueSource
	isSet bool
}

func (v NullableInlineResponse20071ValueSource) Get() *InlineResponse20071ValueSource {
	return v.value
}

func (v *NullableInlineResponse20071ValueSource) Set(val *InlineResponse20071ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20071ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20071ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20071ValueSource(val *InlineResponse20071ValueSource) *NullableInlineResponse20071ValueSource {
	return &NullableInlineResponse20071ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20071ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20071ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
