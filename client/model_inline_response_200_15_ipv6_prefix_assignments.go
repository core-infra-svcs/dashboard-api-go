...
// InlineResponse20015Ipv6PrefixAssignments struct for InlineResponse20015Ipv6PrefixAssignments
type InlineResponse20015Ipv6PrefixAssignments struct {
...
func NewInlineResponse20015Ipv6PrefixAssignments() *InlineResponse20015Ipv6PrefixAssignments {
	this := InlineResponse20015Ipv6PrefixAssignments{}
	return &this
}
...
func (o InlineResponse20015Ipv6PrefixAssignments) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20015Ipv6PrefixAssignments struct {
	value *InlineResponse20015Ipv6PrefixAssignments
	isSet bool
}

func (v NullableInlineResponse20015Ipv6PrefixAssignments) Get() *InlineResponse20015Ipv6PrefixAssignments {
	return v.value
}

func (v *NullableInlineResponse20015Ipv6PrefixAssignments) Set(val *InlineResponse20015Ipv6PrefixAssignments) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20015Ipv6PrefixAssignments) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20015Ipv6PrefixAssignments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20015Ipv6PrefixAssignments(val *InlineResponse20015Ipv6PrefixAssignments) *NullableInlineResponse20015Ipv6PrefixAssignments {
	return &NullableInlineResponse20015Ipv6PrefixAssignments{value: val, isSet: true}
}

func (v NullableInlineResponse20015Ipv6PrefixAssignments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20015Ipv6PrefixAssignments) UnmarshalJSON(src []byte) error {
	v.isSet = true
