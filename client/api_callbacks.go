...
func (r CallbacksApiGetOrganizationWebhooksCallbacksStatusRequest) Execute() (*InlineResponse200344, *http.Response, error) {
...
func (a *CallbacksApiService) GetOrganizationWebhooksCallbacksStatusExecute(r CallbacksApiGetOrganizationWebhooksCallbacksStatusRequest) (*InlineResponse200344, *http.Response, error) {
	var (
