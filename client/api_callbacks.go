...
func (r CallbacksApiGetOrganizationWebhooksCallbacksStatusRequest) Execute() (*InlineResponse200364, *http.Response, error) {
...
func (a *CallbacksApiService) GetOrganizationWebhooksCallbacksStatusExecute(r CallbacksApiGetOrganizationWebhooksCallbacksStatusRequest) (*InlineResponse200364, *http.Response, error) {
	var (
