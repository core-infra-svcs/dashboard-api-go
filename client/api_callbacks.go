...
func (r CallbacksApiGetOrganizationWebhooksCallbacksStatusRequest) Execute() (*InlineResponse200331, *http.Response, error) {
...
func (a *CallbacksApiService) GetOrganizationWebhooksCallbacksStatusExecute(r CallbacksApiGetOrganizationWebhooksCallbacksStatusRequest) (*InlineResponse200331, *http.Response, error) {
	var (
