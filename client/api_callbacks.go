...
func (r CallbacksApiGetOrganizationWebhooksCallbacksStatusRequest) Execute() (*InlineResponse200348, *http.Response, error) {
...
func (a *CallbacksApiService) GetOrganizationWebhooksCallbacksStatusExecute(r CallbacksApiGetOrganizationWebhooksCallbacksStatusRequest) (*InlineResponse200348, *http.Response, error) {
	var (
