...
// InlineResponse20098ResultingNetwork Network after the combination
type InlineResponse20098ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse20098ResultingNetwork() *InlineResponse20098ResultingNetwork {
	this := InlineResponse20098ResultingNetwork{}
	return &this
}
...
func (o InlineResponse20098ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20098ResultingNetwork struct {
	value *InlineResponse20098ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse20098ResultingNetwork) Get() *InlineResponse20098ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse20098ResultingNetwork) Set(val *InlineResponse20098ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20098ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20098ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20098ResultingNetwork(val *InlineResponse20098ResultingNetwork) *NullableInlineResponse20098ResultingNetwork {
	return &NullableInlineResponse20098ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse20098ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20098ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
