...
// InlineResponse200179ApBandSettings Settings that will be enabled if selectionType is set to 'ap'.
type InlineResponse200179ApBandSettings struct {
...
func NewInlineResponse200179ApBandSettings() *InlineResponse200179ApBandSettings {
	this := InlineResponse200179ApBandSettings{}
	return &this
}
...
func (o InlineResponse200179ApBandSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200179ApBandSettings struct {
	value *InlineResponse200179ApBandSettings
	isSet bool
}

func (v NullableInlineResponse200179ApBandSettings) Get() *InlineResponse200179ApBandSettings {
	return v.value
}

func (v *NullableInlineResponse200179ApBandSettings) Set(val *InlineResponse200179ApBandSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200179ApBandSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200179ApBandSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200179ApBandSettings(val *InlineResponse200179ApBandSettings) *NullableInlineResponse200179ApBandSettings {
	return &NullableInlineResponse200179ApBandSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200179ApBandSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200179ApBandSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
