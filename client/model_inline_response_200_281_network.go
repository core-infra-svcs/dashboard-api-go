...
// InlineResponse200281Network Information regarding the network the device belongs to
type InlineResponse200281Network struct {
	// The network ID
...
func NewInlineResponse200281Network() *InlineResponse200281Network {
	this := InlineResponse200281Network{}
	return &this
}
...
func (o InlineResponse200281Network) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200281Network struct {
	value *InlineResponse200281Network
	isSet bool
}

func (v NullableInlineResponse200281Network) Get() *InlineResponse200281Network {
	return v.value
}

func (v *NullableInlineResponse200281Network) Set(val *InlineResponse200281Network) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200281Network) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200281Network) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200281Network(val *InlineResponse200281Network) *NullableInlineResponse200281Network {
	return &NullableInlineResponse200281Network{value: val, isSet: true}
}

func (v NullableInlineResponse200281Network) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200281Network) UnmarshalJSON(src []byte) error {
	v.isSet = true
