...
func (r L7FirewallRulesApiGetNetworkApplianceFirewallL7FirewallRulesApplicationCategoriesRequest) Execute() (*InlineResponse20058, *http.Response, error) {
...
func (a *L7FirewallRulesApiService) GetNetworkApplianceFirewallL7FirewallRulesApplicationCategoriesExecute(r L7FirewallRulesApiGetNetworkApplianceFirewallL7FirewallRulesApplicationCategoriesRequest) (*InlineResponse20058, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r L7FirewallRulesApiGetNetworkWirelessSsidFirewallL7FirewallRulesRequest) Execute() (*InlineResponse200207, *http.Response, error) {
...
func (a *L7FirewallRulesApiService) GetNetworkWirelessSsidFirewallL7FirewallRulesExecute(r L7FirewallRulesApiGetNetworkWirelessSsidFirewallL7FirewallRulesRequest) (*InlineResponse200207, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r L7FirewallRulesApiUpdateNetworkApplianceFirewallL7FirewallRulesRequest) UpdateNetworkApplianceFirewallL7FirewallRules(updateNetworkApplianceFirewallL7FirewallRules InlineObject49) L7FirewallRulesApiUpdateNetworkApplianceFirewallL7FirewallRulesRequest {
...
func (r L7FirewallRulesApiUpdateNetworkWirelessSsidFirewallL7FirewallRulesRequest) UpdateNetworkWirelessSsidFirewallL7FirewallRules(updateNetworkWirelessSsidFirewallL7FirewallRules InlineObject200) L7FirewallRulesApiUpdateNetworkWirelessSsidFirewallL7FirewallRulesRequest {
	r.updateNetworkWirelessSsidFirewallL7FirewallRules = &updateNetworkWirelessSsidFirewallL7FirewallRules
	return r
}

func (r L7FirewallRulesApiUpdateNetworkWirelessSsidFirewallL7FirewallRulesRequest) Execute() (*InlineResponse200207, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200207
func (a *L7FirewallRulesApiService) UpdateNetworkWirelessSsidFirewallL7FirewallRulesExecute(r L7FirewallRulesApiUpdateNetworkWirelessSsidFirewallL7FirewallRulesRequest) (*InlineResponse200207, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
