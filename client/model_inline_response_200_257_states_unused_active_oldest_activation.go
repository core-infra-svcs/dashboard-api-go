...
// InlineResponse200257StatesUnusedActiveOldestActivation Information about the oldest historical license activation
type InlineResponse200257StatesUnusedActiveOldestActivation struct {
...
func NewInlineResponse200257StatesUnusedActiveOldestActivation() *InlineResponse200257StatesUnusedActiveOldestActivation {
	this := InlineResponse200257StatesUnusedActiveOldestActivation{}
	return &this
}
...
func (o InlineResponse200257StatesUnusedActiveOldestActivation) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200257StatesUnusedActiveOldestActivation struct {
	value *InlineResponse200257StatesUnusedActiveOldestActivation
	isSet bool
}

func (v NullableInlineResponse200257StatesUnusedActiveOldestActivation) Get() *InlineResponse200257StatesUnusedActiveOldestActivation {
	return v.value
}

func (v *NullableInlineResponse200257StatesUnusedActiveOldestActivation) Set(val *InlineResponse200257StatesUnusedActiveOldestActivation) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200257StatesUnusedActiveOldestActivation) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200257StatesUnusedActiveOldestActivation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200257StatesUnusedActiveOldestActivation(val *InlineResponse200257StatesUnusedActiveOldestActivation) *NullableInlineResponse200257StatesUnusedActiveOldestActivation {
	return &NullableInlineResponse200257StatesUnusedActiveOldestActivation{value: val, isSet: true}
}

func (v NullableInlineResponse200257StatesUnusedActiveOldestActivation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200257StatesUnusedActiveOldestActivation) UnmarshalJSON(src []byte) error {
	v.isSet = true
