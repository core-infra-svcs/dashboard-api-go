...
// InlineResponse200189PerSsidSettings5 Settings for SSID 5
type InlineResponse200189PerSsidSettings5 struct {
	// Name of SSID
...
func NewInlineResponse200189PerSsidSettings5() *InlineResponse200189PerSsidSettings5 {
	this := InlineResponse200189PerSsidSettings5{}
	return &this
}
...
func (o InlineResponse200189PerSsidSettings5) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200189PerSsidSettings5 struct {
	value *InlineResponse200189PerSsidSettings5
	isSet bool
}

func (v NullableInlineResponse200189PerSsidSettings5) Get() *InlineResponse200189PerSsidSettings5 {
	return v.value
}

func (v *NullableInlineResponse200189PerSsidSettings5) Set(val *InlineResponse200189PerSsidSettings5) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200189PerSsidSettings5) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200189PerSsidSettings5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200189PerSsidSettings5(val *InlineResponse200189PerSsidSettings5) *NullableInlineResponse200189PerSsidSettings5 {
	return &NullableInlineResponse200189PerSsidSettings5{value: val, isSet: true}
}

func (v NullableInlineResponse200189PerSsidSettings5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200189PerSsidSettings5) UnmarshalJSON(src []byte) error {
	v.isSet = true
