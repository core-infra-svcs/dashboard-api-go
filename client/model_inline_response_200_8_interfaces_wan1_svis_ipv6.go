...
// InlineResponse2008InterfacesWan1SvisIpv6 IPv6 settings for static/dynamic mode.
type InlineResponse2008InterfacesWan1SvisIpv6 struct {
	...
	Nameservers *InlineResponse2008InterfacesWan1SvisIpv4Nameservers `json:"nameservers,omitempty"`
}
...
func NewInlineResponse2008InterfacesWan1SvisIpv6() *InlineResponse2008InterfacesWan1SvisIpv6 {
	this := InlineResponse2008InterfacesWan1SvisIpv6{}
	return &this
}
...
func (o *InlineResponse2008InterfacesWan1SvisIpv6) GetNameservers() InlineResponse2008InterfacesWan1SvisIpv4Nameservers {
	if o == nil || isNil(o.Nameservers) {
		var ret InlineResponse2008InterfacesWan1SvisIpv4Nameservers
		return ret
	}
...
// SetNameservers gets a reference to the given InlineResponse2008InterfacesWan1SvisIpv4Nameservers and assigns it to the Nameservers field.
func (o *InlineResponse2008InterfacesWan1SvisIpv6) SetNameservers(v InlineResponse2008InterfacesWan1SvisIpv4Nameservers) {
	o.Nameservers = &v
}

func (o InlineResponse2008InterfacesWan1SvisIpv6) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2008InterfacesWan1SvisIpv6 struct {
	value *InlineResponse2008InterfacesWan1SvisIpv6
	isSet bool
}

func (v NullableInlineResponse2008InterfacesWan1SvisIpv6) Get() *InlineResponse2008InterfacesWan1SvisIpv6 {
	return v.value
}

func (v *NullableInlineResponse2008InterfacesWan1SvisIpv6) Set(val *InlineResponse2008InterfacesWan1SvisIpv6) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2008InterfacesWan1SvisIpv6) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2008InterfacesWan1SvisIpv6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2008InterfacesWan1SvisIpv6(val *InlineResponse2008InterfacesWan1SvisIpv6) *NullableInlineResponse2008InterfacesWan1SvisIpv6 {
	return &NullableInlineResponse2008InterfacesWan1SvisIpv6{value: val, isSet: true}
}

func (v NullableInlineResponse2008InterfacesWan1SvisIpv6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2008InterfacesWan1SvisIpv6) UnmarshalJSON(src []byte) error {
	v.isSet = true
