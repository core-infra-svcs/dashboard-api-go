...
// InlineResponse200234MetaCountsItems Counts relating to the paginated items
type InlineResponse200234MetaCountsItems struct {
...
func NewInlineResponse200234MetaCountsItems() *InlineResponse200234MetaCountsItems {
	this := InlineResponse200234MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200234MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200234MetaCountsItems struct {
	value *InlineResponse200234MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200234MetaCountsItems) Get() *InlineResponse200234MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200234MetaCountsItems) Set(val *InlineResponse200234MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200234MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200234MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200234MetaCountsItems(val *InlineResponse200234MetaCountsItems) *NullableInlineResponse200234MetaCountsItems {
	return &NullableInlineResponse200234MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200234MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200234MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
