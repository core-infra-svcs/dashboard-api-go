...
func (r EthernetApiGetOrganizationWirelessDevicesEthernetStatusesRequest) Execute() ([]InlineResponse200167, *http.Response, error) {
...
func (a *EthernetApiService) GetOrganizationWirelessDevicesEthernetStatusesExecute(r EthernetApiGetOrganizationWirelessDevicesEthernetStatusesRequest) ([]InlineResponse200167, *http.Response, error) {
	var (
