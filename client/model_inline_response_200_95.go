...
type InlineResponse20095 struct {
	...
	ToVersion *InlineResponse20095ToVersion `json:"toVersion,omitempty"`
...
func (o *InlineResponse20095) GetToVersion() InlineResponse20095ToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20095ToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20095ToVersion and assigns it to the ToVersion field.
