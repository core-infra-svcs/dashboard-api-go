...
type InlineResponse20095 struct {
	Alerts *InlineResponse20095Alerts `json:"alerts,omitempty"`
	...
	ArpInspection *InlineResponse20095ArpInspection `json:"arpInspection,omitempty"`
}
...
func (o *InlineResponse20095) GetAlerts() InlineResponse20095Alerts {
	if o == nil || isNil(o.Alerts) {
		var ret InlineResponse20095Alerts
		return ret
	}
	return *o.Alerts
}
...
// SetAlerts gets a reference to the given InlineResponse20095Alerts and assigns it to the Alerts field.
...
func (o *InlineResponse20095) GetArpInspection() InlineResponse20095ArpInspection {
	if o == nil || isNil(o.ArpInspection) {
		var ret InlineResponse20095ArpInspection
		return ret
	}
...
// SetArpInspection gets a reference to the given InlineResponse20095ArpInspection and assigns it to the ArpInspection field.
