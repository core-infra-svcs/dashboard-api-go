...
type InlineResponse20095 struct {
	...
	// The name of the node that the device was last connected to
	RecentDeviceName *string `json:"recentDeviceName,omitempty"`
	// The serial of the node that the device was last connected to
	...
	ClientVpnConnections []InlineResponse20095ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20095) GetClientVpnConnections() []InlineResponse20095ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20095ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20095ClientVpnConnections and assigns it to the ClientVpnConnections field.
