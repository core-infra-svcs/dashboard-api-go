...
// InlineResponse200367MetaCountsItems Counts of the CRLs
type InlineResponse200367MetaCountsItems struct {
...
func NewInlineResponse200367MetaCountsItems() *InlineResponse200367MetaCountsItems {
	this := InlineResponse200367MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200367MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200367MetaCountsItems struct {
	value *InlineResponse200367MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200367MetaCountsItems) Get() *InlineResponse200367MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200367MetaCountsItems) Set(val *InlineResponse200367MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200367MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200367MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200367MetaCountsItems(val *InlineResponse200367MetaCountsItems) *NullableInlineResponse200367MetaCountsItems {
	return &NullableInlineResponse200367MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200367MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200367MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
