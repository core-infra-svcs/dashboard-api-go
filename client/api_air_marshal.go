...
func (r AirMarshalApiCreateNetworkWirelessAirMarshalRuleRequest) CreateNetworkWirelessAirMarshalRule(createNetworkWirelessAirMarshalRule InlineObject174) AirMarshalApiCreateNetworkWirelessAirMarshalRuleRequest {
	r.createNetworkWirelessAirMarshalRule = &createNetworkWirelessAirMarshalRule
	return r
}

func (r AirMarshalApiCreateNetworkWirelessAirMarshalRuleRequest) Execute() (*InlineResponse20110, *http.Response, error) {
...
func (a *AirMarshalApiService) CreateNetworkWirelessAirMarshalRuleExecute(r AirMarshalApiCreateNetworkWirelessAirMarshalRuleRequest) (*InlineResponse20110, *http.Response, error) {
	var (
...
func (r AirMarshalApiGetOrganizationWirelessAirMarshalRulesRequest) Execute() (*InlineResponse200310, *http.Response, error) {
...
func (a *AirMarshalApiService) GetOrganizationWirelessAirMarshalRulesExecute(r AirMarshalApiGetOrganizationWirelessAirMarshalRulesRequest) (*InlineResponse200310, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AirMarshalApiGetOrganizationWirelessAirMarshalSettingsByNetworkRequest) Execute() (*InlineResponse200311, *http.Response, error) {
...
func (a *AirMarshalApiService) GetOrganizationWirelessAirMarshalSettingsByNetworkExecute(r AirMarshalApiGetOrganizationWirelessAirMarshalSettingsByNetworkRequest) (*InlineResponse200311, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AirMarshalApiUpdateNetworkWirelessAirMarshalRuleRequest) UpdateNetworkWirelessAirMarshalRule(updateNetworkWirelessAirMarshalRule InlineObject175) AirMarshalApiUpdateNetworkWirelessAirMarshalRuleRequest {
	r.updateNetworkWirelessAirMarshalRule = &updateNetworkWirelessAirMarshalRule
	return r
}

func (r AirMarshalApiUpdateNetworkWirelessAirMarshalRuleRequest) Execute() (*InlineResponse20110, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20110
func (a *AirMarshalApiService) UpdateNetworkWirelessAirMarshalRuleExecute(r AirMarshalApiUpdateNetworkWirelessAirMarshalRuleRequest) (*InlineResponse20110, *http.Response, error) {
	var (
...
func (r AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest) UpdateNetworkWirelessAirMarshalSettings(updateNetworkWirelessAirMarshalSettings InlineObject176) AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest {
	r.updateNetworkWirelessAirMarshalSettings = &updateNetworkWirelessAirMarshalSettings
	return r
}

func (r AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest) Execute() (*InlineResponse200173, *http.Response, error) {
...
func (a *AirMarshalApiService) UpdateNetworkWirelessAirMarshalSettingsExecute(r AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest) (*InlineResponse200173, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
