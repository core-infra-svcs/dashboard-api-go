...
func (r AirMarshalApiCreateNetworkWirelessAirMarshalRuleRequest) Execute() (*InlineResponse20113, *http.Response, error) {
...
func (a *AirMarshalApiService) CreateNetworkWirelessAirMarshalRuleExecute(r AirMarshalApiCreateNetworkWirelessAirMarshalRuleRequest) (*InlineResponse20113, *http.Response, error) {
	var (
...
func (r AirMarshalApiGetOrganizationWirelessAirMarshalRulesRequest) Execute() (*InlineResponse200346, *http.Response, error) {
...
func (a *AirMarshalApiService) GetOrganizationWirelessAirMarshalRulesExecute(r AirMarshalApiGetOrganizationWirelessAirMarshalRulesRequest) (*InlineResponse200346, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AirMarshalApiGetOrganizationWirelessAirMarshalSettingsByNetworkRequest) Execute() (*InlineResponse200347, *http.Response, error) {
...
func (a *AirMarshalApiService) GetOrganizationWirelessAirMarshalSettingsByNetworkExecute(r AirMarshalApiGetOrganizationWirelessAirMarshalSettingsByNetworkRequest) (*InlineResponse200347, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AirMarshalApiUpdateNetworkWirelessAirMarshalRuleRequest) Execute() (*InlineResponse20113, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20113
func (a *AirMarshalApiService) UpdateNetworkWirelessAirMarshalRuleExecute(r AirMarshalApiUpdateNetworkWirelessAirMarshalRuleRequest) (*InlineResponse20113, *http.Response, error) {
	var (
...
func (r AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest) Execute() (*InlineResponse200179, *http.Response, error) {
...
func (a *AirMarshalApiService) UpdateNetworkWirelessAirMarshalSettingsExecute(r AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest) (*InlineResponse200179, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
