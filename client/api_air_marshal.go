...
func (r AirMarshalApiCreateNetworkWirelessAirMarshalRuleRequest) CreateNetworkWirelessAirMarshalRule(createNetworkWirelessAirMarshalRule InlineObject181) AirMarshalApiCreateNetworkWirelessAirMarshalRuleRequest {
...
func (r AirMarshalApiGetNetworkWirelessAirMarshalRequest) Execute() ([]InlineResponse200193, *http.Response, error) {
...
func (a *AirMarshalApiService) GetNetworkWirelessAirMarshalExecute(r AirMarshalApiGetNetworkWirelessAirMarshalRequest) ([]InlineResponse200193, *http.Response, error) {
	var (
...
func (r AirMarshalApiGetOrganizationWirelessAirMarshalRulesRequest) Execute() (*InlineResponse200377, *http.Response, error) {
...
func (a *AirMarshalApiService) GetOrganizationWirelessAirMarshalRulesExecute(r AirMarshalApiGetOrganizationWirelessAirMarshalRulesRequest) (*InlineResponse200377, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AirMarshalApiGetOrganizationWirelessAirMarshalSettingsByNetworkRequest) Execute() (*InlineResponse200378, *http.Response, error) {
...
func (a *AirMarshalApiService) GetOrganizationWirelessAirMarshalSettingsByNetworkExecute(r AirMarshalApiGetOrganizationWirelessAirMarshalSettingsByNetworkRequest) (*InlineResponse200378, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AirMarshalApiUpdateNetworkWirelessAirMarshalRuleRequest) UpdateNetworkWirelessAirMarshalRule(updateNetworkWirelessAirMarshalRule InlineObject182) AirMarshalApiUpdateNetworkWirelessAirMarshalRuleRequest {
...
func (r AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest) UpdateNetworkWirelessAirMarshalSettings(updateNetworkWirelessAirMarshalSettings InlineObject183) AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest {
	r.updateNetworkWirelessAirMarshalSettings = &updateNetworkWirelessAirMarshalSettings
	return r
}

func (r AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest) Execute() (*InlineResponse200194, *http.Response, error) {
...
func (a *AirMarshalApiService) UpdateNetworkWirelessAirMarshalSettingsExecute(r AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest) (*InlineResponse200194, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
