...
func (r AirMarshalApiCreateNetworkWirelessAirMarshalRuleRequest) CreateNetworkWirelessAirMarshalRule(createNetworkWirelessAirMarshalRule InlineObject169) AirMarshalApiCreateNetworkWirelessAirMarshalRuleRequest {
...
func (r AirMarshalApiGetOrganizationWirelessAirMarshalRulesRequest) Execute() (*InlineResponse200291, *http.Response, error) {
...
func (a *AirMarshalApiService) GetOrganizationWirelessAirMarshalRulesExecute(r AirMarshalApiGetOrganizationWirelessAirMarshalRulesRequest) (*InlineResponse200291, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AirMarshalApiGetOrganizationWirelessAirMarshalSettingsByNetworkRequest) Execute() (*InlineResponse200292, *http.Response, error) {
...
func (a *AirMarshalApiService) GetOrganizationWirelessAirMarshalSettingsByNetworkExecute(r AirMarshalApiGetOrganizationWirelessAirMarshalSettingsByNetworkRequest) (*InlineResponse200292, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AirMarshalApiUpdateNetworkWirelessAirMarshalRuleRequest) UpdateNetworkWirelessAirMarshalRule(updateNetworkWirelessAirMarshalRule InlineObject170) AirMarshalApiUpdateNetworkWirelessAirMarshalRuleRequest {
...
func (r AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest) UpdateNetworkWirelessAirMarshalSettings(updateNetworkWirelessAirMarshalSettings InlineObject171) AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest {
	r.updateNetworkWirelessAirMarshalSettings = &updateNetworkWirelessAirMarshalSettings
	return r
}

func (r AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest) Execute() (*InlineResponse200166, *http.Response, error) {
...
func (a *AirMarshalApiService) UpdateNetworkWirelessAirMarshalSettingsExecute(r AirMarshalApiUpdateNetworkWirelessAirMarshalSettingsRequest) (*InlineResponse200166, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
