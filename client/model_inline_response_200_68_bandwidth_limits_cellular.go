...
// InlineResponse20068BandwidthLimitsCellular uplink cellular configured limits [optional]
type InlineResponse20068BandwidthLimitsCellular struct {
...
func NewInlineResponse20068BandwidthLimitsCellular() *InlineResponse20068BandwidthLimitsCellular {
	this := InlineResponse20068BandwidthLimitsCellular{}
	return &this
}
...
func (o InlineResponse20068BandwidthLimitsCellular) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20068BandwidthLimitsCellular struct {
	value *InlineResponse20068BandwidthLimitsCellular
	isSet bool
}

func (v NullableInlineResponse20068BandwidthLimitsCellular) Get() *InlineResponse20068BandwidthLimitsCellular {
	return v.value
}

func (v *NullableInlineResponse20068BandwidthLimitsCellular) Set(val *InlineResponse20068BandwidthLimitsCellular) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20068BandwidthLimitsCellular) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20068BandwidthLimitsCellular) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20068BandwidthLimitsCellular(val *InlineResponse20068BandwidthLimitsCellular) *NullableInlineResponse20068BandwidthLimitsCellular {
	return &NullableInlineResponse20068BandwidthLimitsCellular{value: val, isSet: true}
}

func (v NullableInlineResponse20068BandwidthLimitsCellular) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20068BandwidthLimitsCellular) UnmarshalJSON(src []byte) error {
	v.isSet = true
