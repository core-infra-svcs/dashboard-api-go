...
type InlineResponse200347Items struct {
	...
	Policies []InlineResponse200347Policies `json:"policies,omitempty"`
}
...
func (o *InlineResponse200347Items) GetNetworkId() string {
...
func (o *InlineResponse200347Items) GetNetworkIdOk() (*string, bool) {
	if o == nil || isNil(o.NetworkId) {
    return nil, false
	}
...
func (o *InlineResponse200347Items) HasNetworkId() bool {
	if o != nil && !isNil(o.NetworkId) {
		return true
	}
...
func (o *InlineResponse200347Items) SetNetworkId(v string) {
	o.NetworkId = &v
}

// GetPolicies returns the Policies field value if set, zero value otherwise.
func (o *InlineResponse200347Items) GetPolicies() []InlineResponse200347Policies {
	if o == nil || isNil(o.Policies) {
		var ret []InlineResponse200347Policies
		return ret
	}
	return o.Policies
}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200347Items) GetPoliciesOk() ([]InlineResponse200347Policies, bool) {
	if o == nil || isNil(o.Policies) {
    return nil, false
	}
...
func (o *InlineResponse200347Items) HasPolicies() bool {
	if o != nil && !isNil(o.Policies) {
		return true
	}
...
// SetPolicies gets a reference to the given []InlineResponse200347Policies and assigns it to the Policies field.
func (o *InlineResponse200347Items) SetPolicies(v []InlineResponse200347Policies) {
	o.Policies = v
}
