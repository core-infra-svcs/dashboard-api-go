...
type InlineResponse200212 struct {
	...
	ApBandSettings *InlineResponse200212ApBandSettings `json:"apBandSettings,omitempty"`
	TwoFourGhzSettings *InlineResponse200212TwoFourGhzSettings `json:"twoFourGhzSettings,omitempty"`
	FiveGhzSettings *InlineResponse200212FiveGhzSettings `json:"fiveGhzSettings,omitempty"`
	SixGhzSettings *InlineResponse200212SixGhzSettings `json:"sixGhzSettings,omitempty"`
	Transmission *InlineResponse200212Transmission `json:"transmission,omitempty"`
	PerSsidSettings *InlineResponse200212PerSsidSettings `json:"perSsidSettings,omitempty"`
...
func (o *InlineResponse200212) GetApBandSettings() InlineResponse200212ApBandSettings {
	if o == nil || isNil(o.ApBandSettings) {
		var ret InlineResponse200212ApBandSettings
		return ret
	}
...
// SetApBandSettings gets a reference to the given InlineResponse200212ApBandSettings and assigns it to the ApBandSettings field.
...
func (o *InlineResponse200212) GetFiveGhzSettings() InlineResponse200212FiveGhzSettings {
	if o == nil || isNil(o.FiveGhzSettings) {
		var ret InlineResponse200212FiveGhzSettings
		return ret
	}
...
// SetFiveGhzSettings gets a reference to the given InlineResponse200212FiveGhzSettings and assigns it to the FiveGhzSettings field.
...
func (o *InlineResponse200212) GetSixGhzSettings() InlineResponse200212SixGhzSettings {
	if o == nil || isNil(o.SixGhzSettings) {
		var ret InlineResponse200212SixGhzSettings
		return ret
	}
...
// SetSixGhzSettings gets a reference to the given InlineResponse200212SixGhzSettings and assigns it to the SixGhzSettings field.
...
func (o *InlineResponse200212) GetPerSsidSettings() InlineResponse200212PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse200212PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse200212PerSsidSettings and assigns it to the PerSsidSettings field.
