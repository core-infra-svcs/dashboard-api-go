...
type NetworksNetworkIdWirelessSsidsNumberLocalRadiusCertificateAuthentication struct {
	...
	OcspResponderUrl NullableString `json:"ocspResponderUrl,omitempty"`
...
// GetOcspResponderUrl returns the OcspResponderUrl field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *NetworksNetworkIdWirelessSsidsNumberLocalRadiusCertificateAuthentication) GetOcspResponderUrl() string {
	if o == nil || isNil(o.OcspResponderUrl.Get()) {
		var ret string
		return ret
	}
	return *o.OcspResponderUrl.Get()
}
...
func (o *NetworksNetworkIdWirelessSsidsNumberLocalRadiusCertificateAuthentication) GetOcspResponderUrlOk() (*string, bool) {
	...
	return o.OcspResponderUrl.Get(), o.OcspResponderUrl.IsSet()
}
...
func (o *NetworksNetworkIdWirelessSsidsNumberLocalRadiusCertificateAuthentication) HasOcspResponderUrl() bool {
	if o != nil && o.OcspResponderUrl.IsSet() {
		return true
	}
...
// SetOcspResponderUrl gets a reference to the given NullableString and assigns it to the OcspResponderUrl field.
func (o *NetworksNetworkIdWirelessSsidsNumberLocalRadiusCertificateAuthentication) SetOcspResponderUrl(v string) {
	o.OcspResponderUrl.Set(&v)
}
// SetOcspResponderUrlNil sets the value for OcspResponderUrl to be an explicit nil
func (o *NetworksNetworkIdWirelessSsidsNumberLocalRadiusCertificateAuthentication) SetOcspResponderUrlNil() {
	o.OcspResponderUrl.Set(nil)
}
...
func (o NetworksNetworkIdWirelessSsidsNumberLocalRadiusCertificateAuthentication) MarshalJSON() ([]byte, error) {
	...
	if o.OcspResponderUrl.IsSet() {
		toSerialize["ocspResponderUrl"] = o.OcspResponderUrl.Get()
	}
