...
// InlineResponse200198Counts The current amount of various adaptive policy objects.
type InlineResponse200198Counts struct {
...
func NewInlineResponse200198Counts() *InlineResponse200198Counts {
	this := InlineResponse200198Counts{}
	return &this
}
...
func (o InlineResponse200198Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200198Counts struct {
	value *InlineResponse200198Counts
	isSet bool
}

func (v NullableInlineResponse200198Counts) Get() *InlineResponse200198Counts {
	return v.value
}

func (v *NullableInlineResponse200198Counts) Set(val *InlineResponse200198Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200198Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200198Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200198Counts(val *InlineResponse200198Counts) *NullableInlineResponse200198Counts {
	return &NullableInlineResponse200198Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200198Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200198Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
