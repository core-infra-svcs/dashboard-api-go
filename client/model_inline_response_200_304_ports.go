...
// InlineResponse200304Ports struct for InlineResponse200304Ports
type InlineResponse200304Ports struct {
...
func NewInlineResponse200304Ports() *InlineResponse200304Ports {
	this := InlineResponse200304Ports{}
	return &this
}
...
func (o InlineResponse200304Ports) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200304Ports struct {
	value *InlineResponse200304Ports
	isSet bool
}

func (v NullableInlineResponse200304Ports) Get() *InlineResponse200304Ports {
	return v.value
}

func (v *NullableInlineResponse200304Ports) Set(val *InlineResponse200304Ports) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200304Ports) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200304Ports) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200304Ports(val *InlineResponse200304Ports) *NullableInlineResponse200304Ports {
	return &NullableInlineResponse200304Ports{value: val, isSet: true}
}

func (v NullableInlineResponse200304Ports) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200304Ports) UnmarshalJSON(src []byte) error {
	v.isSet = true
