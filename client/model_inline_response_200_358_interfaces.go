...
// InlineResponse200358Interfaces struct for InlineResponse200358Interfaces
type InlineResponse200358Interfaces struct {
...
func NewInlineResponse200358Interfaces() *InlineResponse200358Interfaces {
	this := InlineResponse200358Interfaces{}
	return &this
}
...
func (o InlineResponse200358Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200358Interfaces struct {
	value *InlineResponse200358Interfaces
	isSet bool
}

func (v NullableInlineResponse200358Interfaces) Get() *InlineResponse200358Interfaces {
	return v.value
}

func (v *NullableInlineResponse200358Interfaces) Set(val *InlineResponse200358Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200358Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200358Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200358Interfaces(val *InlineResponse200358Interfaces) *NullableInlineResponse200358Interfaces {
	return &NullableInlineResponse200358Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200358Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200358Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
