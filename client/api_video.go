...
func (r VideoApiGetDeviceCameraVideoSettingsRequest) Execute() (*InlineResponse20017, *http.Response, error) {
...
func (a *VideoApiService) GetDeviceCameraVideoSettingsExecute(r VideoApiGetDeviceCameraVideoSettingsRequest) (*InlineResponse20017, *http.Response, error) {
	var (
...
func (r VideoApiUpdateDeviceCameraVideoSettingsRequest) UpdateDeviceCameraVideoSettings(updateDeviceCameraVideoSettings InlineObject11) VideoApiUpdateDeviceCameraVideoSettingsRequest {
	r.updateDeviceCameraVideoSettings = &updateDeviceCameraVideoSettings
	return r
}

func (r VideoApiUpdateDeviceCameraVideoSettingsRequest) Execute() (*InlineResponse20017, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20017
func (a *VideoApiService) UpdateDeviceCameraVideoSettingsExecute(r VideoApiUpdateDeviceCameraVideoSettingsRequest) (*InlineResponse20017, *http.Response, error) {
	var (
