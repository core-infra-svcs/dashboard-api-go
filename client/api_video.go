...
func (r VideoApiApiGetDeviceCameraVideoSettingsRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *VideoApiService) GetDeviceCameraVideoSettings(ctx context.Context, serial string) VideoApiApiGetDeviceCameraVideoSettingsRequest {
	return VideoApiApiGetDeviceCameraVideoSettingsRequest{
		ApiService: a,
		ctx: ctx,
		serial: serial,
...
func (a *VideoApiService) GetDeviceCameraVideoSettingsExecute(r VideoApiApiGetDeviceCameraVideoSettingsRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r VideoApiApiUpdateDeviceCameraVideoSettingsRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *VideoApiService) UpdateDeviceCameraVideoSettings(ctx context.Context, serial string) VideoApiApiUpdateDeviceCameraVideoSettingsRequest {
	return VideoApiApiUpdateDeviceCameraVideoSettingsRequest{
		ApiService: a,
		ctx: ctx,
		serial: serial,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *VideoApiService) UpdateDeviceCameraVideoSettingsExecute(r VideoApiApiUpdateDeviceCameraVideoSettingsRequest) (map[string]interface{}, *http.Response, error) {
	var (
