...
func (r VideoApiGetDeviceCameraVideoSettingsRequest) Execute() (*InlineResponse20015, *http.Response, error) {
...
func (a *VideoApiService) GetDeviceCameraVideoSettingsExecute(r VideoApiGetDeviceCameraVideoSettingsRequest) (*InlineResponse20015, *http.Response, error) {
	var (
...
func (r VideoApiUpdateDeviceCameraVideoSettingsRequest) Execute() (*InlineResponse20015, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20015
func (a *VideoApiService) UpdateDeviceCameraVideoSettingsExecute(r VideoApiUpdateDeviceCameraVideoSettingsRequest) (*InlineResponse20015, *http.Response, error) {
	var (
