...
func (r VideoApiGetDeviceCameraVideoSettingsRequest) Execute() (*InlineResponse20020, *http.Response, error) {
...
func (a *VideoApiService) GetDeviceCameraVideoSettingsExecute(r VideoApiGetDeviceCameraVideoSettingsRequest) (*InlineResponse20020, *http.Response, error) {
	var (
...
func (r VideoApiUpdateDeviceCameraVideoSettingsRequest) Execute() (*InlineResponse20020, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20020
func (a *VideoApiService) UpdateDeviceCameraVideoSettingsExecute(r VideoApiUpdateDeviceCameraVideoSettingsRequest) (*InlineResponse20020, *http.Response, error) {
	var (
