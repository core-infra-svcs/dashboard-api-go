...
func (r VideoApiGetDeviceCameraVideoSettingsRequest) Execute() (*InlineResponse20014, *http.Response, error) {
...
func (a *VideoApiService) GetDeviceCameraVideoSettingsExecute(r VideoApiGetDeviceCameraVideoSettingsRequest) (*InlineResponse20014, *http.Response, error) {
	var (
...
func (r VideoApiUpdateDeviceCameraVideoSettingsRequest) Execute() (*InlineResponse20014, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20014
func (a *VideoApiService) UpdateDeviceCameraVideoSettingsExecute(r VideoApiUpdateDeviceCameraVideoSettingsRequest) (*InlineResponse20014, *http.Response, error) {
	var (
