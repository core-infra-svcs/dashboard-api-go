...
type InlineResponse20034 struct {
	...
	ClientVpnConnections []InlineResponse20034ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20034) GetClientVpnConnections() []InlineResponse20034ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20034ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20034ClientVpnConnections and assigns it to the ClientVpnConnections field.
