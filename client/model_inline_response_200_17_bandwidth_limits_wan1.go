...
// InlineResponse20017BandwidthLimitsWan1 uplink wan1 configured limits [optional]
type InlineResponse20017BandwidthLimitsWan1 struct {
...
func NewInlineResponse20017BandwidthLimitsWan1() *InlineResponse20017BandwidthLimitsWan1 {
	this := InlineResponse20017BandwidthLimitsWan1{}
	return &this
}
...
func (o InlineResponse20017BandwidthLimitsWan1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20017BandwidthLimitsWan1 struct {
	value *InlineResponse20017BandwidthLimitsWan1
	isSet bool
}

func (v NullableInlineResponse20017BandwidthLimitsWan1) Get() *InlineResponse20017BandwidthLimitsWan1 {
	return v.value
}

func (v *NullableInlineResponse20017BandwidthLimitsWan1) Set(val *InlineResponse20017BandwidthLimitsWan1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20017BandwidthLimitsWan1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20017BandwidthLimitsWan1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20017BandwidthLimitsWan1(val *InlineResponse20017BandwidthLimitsWan1) *NullableInlineResponse20017BandwidthLimitsWan1 {
	return &NullableInlineResponse20017BandwidthLimitsWan1{value: val, isSet: true}
}

func (v NullableInlineResponse20017BandwidthLimitsWan1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20017BandwidthLimitsWan1) UnmarshalJSON(src []byte) error {
	v.isSet = true
