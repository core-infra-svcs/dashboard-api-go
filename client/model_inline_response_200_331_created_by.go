...
// InlineResponse200331CreatedBy Information around who initiated the callback
type InlineResponse200331CreatedBy struct {
...
func NewInlineResponse200331CreatedBy() *InlineResponse200331CreatedBy {
	this := InlineResponse200331CreatedBy{}
	return &this
}
...
func (o InlineResponse200331CreatedBy) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200331CreatedBy struct {
	value *InlineResponse200331CreatedBy
	isSet bool
}

func (v NullableInlineResponse200331CreatedBy) Get() *InlineResponse200331CreatedBy {
	return v.value
}

func (v *NullableInlineResponse200331CreatedBy) Set(val *InlineResponse200331CreatedBy) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200331CreatedBy) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200331CreatedBy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200331CreatedBy(val *InlineResponse200331CreatedBy) *NullableInlineResponse200331CreatedBy {
	return &NullableInlineResponse200331CreatedBy{value: val, isSet: true}
}

func (v NullableInlineResponse200331CreatedBy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200331CreatedBy) UnmarshalJSON(src []byte) error {
	v.isSet = true
