...
// InlineResponse20090ProductsWirelessNextUpgrade Details of the next firmware upgrade on the device
type InlineResponse20090ProductsWirelessNextUpgrade struct {
	// Timestamp of the next scheduled firmware upgrade
	Time *time.Time `json:"time,omitempty"`
	ToVersion *InlineResponse20090ProductsWirelessNextUpgradeToVersion `json:"toVersion,omitempty"`
}
...
func NewInlineResponse20090ProductsWirelessNextUpgrade() *InlineResponse20090ProductsWirelessNextUpgrade {
	this := InlineResponse20090ProductsWirelessNextUpgrade{}
	return &this
}
...
func (o *InlineResponse20090ProductsWirelessNextUpgrade) GetToVersion() InlineResponse20090ProductsWirelessNextUpgradeToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20090ProductsWirelessNextUpgradeToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20090ProductsWirelessNextUpgradeToVersion and assigns it to the ToVersion field.
...
func (o InlineResponse20090ProductsWirelessNextUpgrade) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20090ProductsWirelessNextUpgrade struct {
	value *InlineResponse20090ProductsWirelessNextUpgrade
	isSet bool
}

func (v NullableInlineResponse20090ProductsWirelessNextUpgrade) Get() *InlineResponse20090ProductsWirelessNextUpgrade {
	return v.value
}

func (v *NullableInlineResponse20090ProductsWirelessNextUpgrade) Set(val *InlineResponse20090ProductsWirelessNextUpgrade) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20090ProductsWirelessNextUpgrade) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20090ProductsWirelessNextUpgrade) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20090ProductsWirelessNextUpgrade(val *InlineResponse20090ProductsWirelessNextUpgrade) *NullableInlineResponse20090ProductsWirelessNextUpgrade {
	return &NullableInlineResponse20090ProductsWirelessNextUpgrade{value: val, isSet: true}
}

func (v NullableInlineResponse20090ProductsWirelessNextUpgrade) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20090ProductsWirelessNextUpgrade) UnmarshalJSON(src []byte) error {
	v.isSet = true
