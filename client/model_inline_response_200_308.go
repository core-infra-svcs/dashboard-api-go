...
type InlineResponse200308 struct {
	...
	States *InlineResponse200308States `json:"states,omitempty"`
	// Data by license type (Per-device licensing only)
	LicenseTypes []InlineResponse200308LicenseTypes `json:"licenseTypes,omitempty"`
	SystemsManager *InlineResponse200308SystemsManager `json:"systemsManager,omitempty"`
}
...
func (o *InlineResponse200308) GetStates() InlineResponse200308States {
	if o == nil || isNil(o.States) {
		var ret InlineResponse200308States
		return ret
	}
	return *o.States
}
...
// SetStates gets a reference to the given InlineResponse200308States and assigns it to the States field.
...
func (o *InlineResponse200308) GetLicenseTypes() []InlineResponse200308LicenseTypes {
	if o == nil || isNil(o.LicenseTypes) {
		var ret []InlineResponse200308LicenseTypes
		return ret
	}
...
// SetLicenseTypes gets a reference to the given []InlineResponse200308LicenseTypes and assigns it to the LicenseTypes field.
...
func (o *InlineResponse200308) GetSystemsManager() InlineResponse200308SystemsManager {
	if o == nil || isNil(o.SystemsManager) {
		var ret InlineResponse200308SystemsManager
		return ret
	}
...
// SetSystemsManager gets a reference to the given InlineResponse200308SystemsManager and assigns it to the SystemsManager field.
