...
// InlineResponse200105Counts The current amount of various adaptive policy objects.
type InlineResponse200105Counts struct {
...
func NewInlineResponse200105Counts() *InlineResponse200105Counts {
	this := InlineResponse200105Counts{}
	return &this
}
...
func (o InlineResponse200105Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200105Counts struct {
	value *InlineResponse200105Counts
	isSet bool
}

func (v NullableInlineResponse200105Counts) Get() *InlineResponse200105Counts {
	return v.value
}

func (v *NullableInlineResponse200105Counts) Set(val *InlineResponse200105Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200105Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200105Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200105Counts(val *InlineResponse200105Counts) *NullableInlineResponse200105Counts {
	return &NullableInlineResponse200105Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200105Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200105Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
