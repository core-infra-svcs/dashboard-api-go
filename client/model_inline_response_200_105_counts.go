...
// InlineResponse200105Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse200105Counts struct {
	...
	Noise *InlineResponse200105CountsNoise `json:"noise,omitempty"`
...
func (o *InlineResponse200105Counts) GetNoise() InlineResponse200105CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse200105CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse200105CountsNoise and assigns it to the Noise field.
