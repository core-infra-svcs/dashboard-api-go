...
// InlineResponse200311Ports struct for InlineResponse200311Ports
type InlineResponse200311Ports struct {
	...
	Intervals []InlineResponse200311Intervals `json:"intervals,omitempty"`
}
...
func NewInlineResponse200311Ports() *InlineResponse200311Ports {
	this := InlineResponse200311Ports{}
	return &this
}
...
func (o *InlineResponse200311Ports) GetIntervals() []InlineResponse200311Intervals {
	if o == nil || isNil(o.Intervals) {
		var ret []InlineResponse200311Intervals
		return ret
	}
	return o.Intervals
}
...
// SetIntervals gets a reference to the given []InlineResponse200311Intervals and assigns it to the Intervals field.
func (o *InlineResponse200311Ports) SetIntervals(v []InlineResponse200311Intervals) {
	o.Intervals = v
}

func (o InlineResponse200311Ports) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200311Ports struct {
	value *InlineResponse200311Ports
	isSet bool
}

func (v NullableInlineResponse200311Ports) Get() *InlineResponse200311Ports {
	return v.value
}

func (v *NullableInlineResponse200311Ports) Set(val *InlineResponse200311Ports) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200311Ports) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200311Ports) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200311Ports(val *InlineResponse200311Ports) *NullableInlineResponse200311Ports {
	return &NullableInlineResponse200311Ports{value: val, isSet: true}
}

func (v NullableInlineResponse200311Ports) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200311Ports) UnmarshalJSON(src []byte) error {
	v.isSet = true
