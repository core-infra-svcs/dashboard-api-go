...
// InlineResponse200113Plans struct for InlineResponse200113Plans
type InlineResponse200113Plans struct {
	// The id of the pricing plan to update.
	Id *string `json:"id,omitempty"`
	// The price of the billing plan.
	Price *float32 `json:"price,omitempty"`
	BandwidthLimits *InlineResponse200113BandwidthLimits `json:"bandwidthLimits,omitempty"`
...
func NewInlineResponse200113Plans() *InlineResponse200113Plans {
	this := InlineResponse200113Plans{}
	return &this
}
...
func (o *InlineResponse200113Plans) GetBandwidthLimits() InlineResponse200113BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse200113BandwidthLimits
		return ret
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse200113BandwidthLimits and assigns it to the BandwidthLimits field.
...
func (o InlineResponse200113Plans) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200113Plans struct {
	value *InlineResponse200113Plans
	isSet bool
}

func (v NullableInlineResponse200113Plans) Get() *InlineResponse200113Plans {
	return v.value
}

func (v *NullableInlineResponse200113Plans) Set(val *InlineResponse200113Plans) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200113Plans) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200113Plans) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200113Plans(val *InlineResponse200113Plans) *NullableInlineResponse200113Plans {
	return &NullableInlineResponse200113Plans{value: val, isSet: true}
}

func (v NullableInlineResponse200113Plans) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200113Plans) UnmarshalJSON(src []byte) error {
	v.isSet = true
