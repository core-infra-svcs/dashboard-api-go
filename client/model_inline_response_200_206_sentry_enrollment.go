...
// InlineResponse200206SentryEnrollment Systems Manager sentry enrollment splash settings.
type InlineResponse200206SentryEnrollment struct {
	SystemsManagerNetwork *InlineResponse200206SentryEnrollmentSystemsManagerNetwork `json:"systemsManagerNetwork,omitempty"`
...
func NewInlineResponse200206SentryEnrollment() *InlineResponse200206SentryEnrollment {
	this := InlineResponse200206SentryEnrollment{}
	return &this
}
...
func (o *InlineResponse200206SentryEnrollment) GetSystemsManagerNetwork() InlineResponse200206SentryEnrollmentSystemsManagerNetwork {
	if o == nil || isNil(o.SystemsManagerNetwork) {
		var ret InlineResponse200206SentryEnrollmentSystemsManagerNetwork
		return ret
	}
...
// SetSystemsManagerNetwork gets a reference to the given InlineResponse200206SentryEnrollmentSystemsManagerNetwork and assigns it to the SystemsManagerNetwork field.
...
func (o InlineResponse200206SentryEnrollment) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200206SentryEnrollment struct {
	value *InlineResponse200206SentryEnrollment
	isSet bool
}

func (v NullableInlineResponse200206SentryEnrollment) Get() *InlineResponse200206SentryEnrollment {
	return v.value
}

func (v *NullableInlineResponse200206SentryEnrollment) Set(val *InlineResponse200206SentryEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200206SentryEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200206SentryEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200206SentryEnrollment(val *InlineResponse200206SentryEnrollment) *NullableInlineResponse200206SentryEnrollment {
	return &NullableInlineResponse200206SentryEnrollment{value: val, isSet: true}
}

func (v NullableInlineResponse200206SentryEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200206SentryEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
