...
// InlineResponse200179SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200179SixGhzSettings struct {
...
func NewInlineResponse200179SixGhzSettings() *InlineResponse200179SixGhzSettings {
	this := InlineResponse200179SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200179SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200179SixGhzSettings struct {
	value *InlineResponse200179SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200179SixGhzSettings) Get() *InlineResponse200179SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200179SixGhzSettings) Set(val *InlineResponse200179SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200179SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200179SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200179SixGhzSettings(val *InlineResponse200179SixGhzSettings) *NullableInlineResponse200179SixGhzSettings {
	return &NullableInlineResponse200179SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200179SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200179SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
