...
// InlineResponse200225ByAlertType struct for InlineResponse200225ByAlertType
type InlineResponse200225ByAlertType struct {
	// Alert Type
...
func NewInlineResponse200225ByAlertType() *InlineResponse200225ByAlertType {
	this := InlineResponse200225ByAlertType{}
	return &this
}
...
func (o InlineResponse200225ByAlertType) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200225ByAlertType struct {
	value *InlineResponse200225ByAlertType
	isSet bool
}

func (v NullableInlineResponse200225ByAlertType) Get() *InlineResponse200225ByAlertType {
	return v.value
}

func (v *NullableInlineResponse200225ByAlertType) Set(val *InlineResponse200225ByAlertType) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200225ByAlertType) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200225ByAlertType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200225ByAlertType(val *InlineResponse200225ByAlertType) *NullableInlineResponse200225ByAlertType {
	return &NullableInlineResponse200225ByAlertType{value: val, isSet: true}
}

func (v NullableInlineResponse200225ByAlertType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200225ByAlertType) UnmarshalJSON(src []byte) error {
	v.isSet = true
