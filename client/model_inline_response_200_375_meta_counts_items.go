...
// InlineResponse200375MetaCountsItems The count metadata.
type InlineResponse200375MetaCountsItems struct {
...
func NewInlineResponse200375MetaCountsItems() *InlineResponse200375MetaCountsItems {
	this := InlineResponse200375MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200375MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200375MetaCountsItems struct {
	value *InlineResponse200375MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200375MetaCountsItems) Get() *InlineResponse200375MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200375MetaCountsItems) Set(val *InlineResponse200375MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200375MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200375MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200375MetaCountsItems(val *InlineResponse200375MetaCountsItems) *NullableInlineResponse200375MetaCountsItems {
	return &NullableInlineResponse200375MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200375MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200375MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
