...
// InlineResponse200275Schedule Schedule of the packet capture
type InlineResponse200275Schedule struct {
...
func NewInlineResponse200275Schedule() *InlineResponse200275Schedule {
	this := InlineResponse200275Schedule{}
	return &this
}
...
func (o InlineResponse200275Schedule) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200275Schedule struct {
	value *InlineResponse200275Schedule
	isSet bool
}

func (v NullableInlineResponse200275Schedule) Get() *InlineResponse200275Schedule {
	return v.value
}

func (v *NullableInlineResponse200275Schedule) Set(val *InlineResponse200275Schedule) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200275Schedule) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200275Schedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200275Schedule(val *InlineResponse200275Schedule) *NullableInlineResponse200275Schedule {
	return &NullableInlineResponse200275Schedule{value: val, isSet: true}
}

func (v NullableInlineResponse200275Schedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200275Schedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
