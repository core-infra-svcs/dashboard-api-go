...
type InlineResponse200167 struct {
	...
	PowerExceptions []InlineResponse200167PowerExceptions `json:"powerExceptions,omitempty"`
	UplinkClientSampling *InlineResponse200167UplinkClientSampling `json:"uplinkClientSampling,omitempty"`
	MacBlocklist *InlineResponse200167MacBlocklist `json:"macBlocklist,omitempty"`
}
...
func (o *InlineResponse200167) GetPowerExceptions() []InlineResponse200167PowerExceptions {
	if o == nil || isNil(o.PowerExceptions) {
		var ret []InlineResponse200167PowerExceptions
		return ret
	}
...
// SetPowerExceptions gets a reference to the given []InlineResponse200167PowerExceptions and assigns it to the PowerExceptions field.
...
func (o *InlineResponse200167) GetUplinkClientSampling() InlineResponse200167UplinkClientSampling {
	if o == nil || isNil(o.UplinkClientSampling) {
		var ret InlineResponse200167UplinkClientSampling
		return ret
	}
...
// SetUplinkClientSampling gets a reference to the given InlineResponse200167UplinkClientSampling and assigns it to the UplinkClientSampling field.
...
func (o *InlineResponse200167) GetMacBlocklist() InlineResponse200167MacBlocklist {
	if o == nil || isNil(o.MacBlocklist) {
		var ret InlineResponse200167MacBlocklist
		return ret
	}
...
// SetMacBlocklist gets a reference to the given InlineResponse200167MacBlocklist and assigns it to the MacBlocklist field.
