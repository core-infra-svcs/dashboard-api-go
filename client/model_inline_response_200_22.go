...
type InlineResponse20022 struct {
	...
	ToVersion *InlineResponse20022ToVersion `json:"toVersion,omitempty"`
...
func (o *InlineResponse20022) GetToVersion() InlineResponse20022ToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20022ToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20022ToVersion and assigns it to the ToVersion field.
