...
// InlineResponse200122Limits The current limits of various adaptive policy objects.
type InlineResponse200122Limits struct {
...
func NewInlineResponse200122Limits() *InlineResponse200122Limits {
	this := InlineResponse200122Limits{}
	return &this
}
...
func (o InlineResponse200122Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200122Limits struct {
	value *InlineResponse200122Limits
	isSet bool
}

func (v NullableInlineResponse200122Limits) Get() *InlineResponse200122Limits {
	return v.value
}

func (v *NullableInlineResponse200122Limits) Set(val *InlineResponse200122Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200122Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200122Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200122Limits(val *InlineResponse200122Limits) *NullableInlineResponse200122Limits {
	return &NullableInlineResponse200122Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200122Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200122Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
