...
// InlineResponse200236ByAlertType struct for InlineResponse200236ByAlertType
type InlineResponse200236ByAlertType struct {
	// Alert Type
...
func NewInlineResponse200236ByAlertType() *InlineResponse200236ByAlertType {
	this := InlineResponse200236ByAlertType{}
	return &this
}
...
func (o InlineResponse200236ByAlertType) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200236ByAlertType struct {
	value *InlineResponse200236ByAlertType
	isSet bool
}

func (v NullableInlineResponse200236ByAlertType) Get() *InlineResponse200236ByAlertType {
	return v.value
}

func (v *NullableInlineResponse200236ByAlertType) Set(val *InlineResponse200236ByAlertType) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200236ByAlertType) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200236ByAlertType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200236ByAlertType(val *InlineResponse200236ByAlertType) *NullableInlineResponse200236ByAlertType {
	return &NullableInlineResponse200236ByAlertType{value: val, isSet: true}
}

func (v NullableInlineResponse200236ByAlertType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200236ByAlertType) UnmarshalJSON(src []byte) error {
	v.isSet = true
