...
type InlineResponse200171 struct {
	ResultingNetwork *InlineResponse200171ResultingNetwork `json:"resultingNetwork,omitempty"`
}
...
func (o *InlineResponse200171) GetResultingNetwork() InlineResponse200171ResultingNetwork {
	if o == nil || isNil(o.ResultingNetwork) {
		var ret InlineResponse200171ResultingNetwork
		return ret
	}
...
// SetResultingNetwork gets a reference to the given InlineResponse200171ResultingNetwork and assigns it to the ResultingNetwork field.
