...
// InlineResponse20092ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20092ToVersion struct {
...
func NewInlineResponse20092ToVersion() *InlineResponse20092ToVersion {
	this := InlineResponse20092ToVersion{}
	return &this
}
...
func (o InlineResponse20092ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20092ToVersion struct {
	value *InlineResponse20092ToVersion
	isSet bool
}

func (v NullableInlineResponse20092ToVersion) Get() *InlineResponse20092ToVersion {
	return v.value
}

func (v *NullableInlineResponse20092ToVersion) Set(val *InlineResponse20092ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20092ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20092ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20092ToVersion(val *InlineResponse20092ToVersion) *NullableInlineResponse20092ToVersion {
	return &NullableInlineResponse20092ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20092ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20092ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
