...
func (r ObjectDetectionModelsApiGetDeviceCameraSenseObjectDetectionModelsRequest) Execute() ([]InlineResponse20019, *http.Response, error) {
...
func (a *ObjectDetectionModelsApiService) GetDeviceCameraSenseObjectDetectionModelsExecute(r ObjectDetectionModelsApiGetDeviceCameraSenseObjectDetectionModelsRequest) ([]InlineResponse20019, *http.Response, error) {
	var (
