...
// InlineResponse20046Destinations struct for InlineResponse20046Destinations
type InlineResponse20046Destinations struct {
...
func NewInlineResponse20046Destinations() *InlineResponse20046Destinations {
	this := InlineResponse20046Destinations{}
	return &this
}
...
func (o InlineResponse20046Destinations) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20046Destinations struct {
	value *InlineResponse20046Destinations
	isSet bool
}

func (v NullableInlineResponse20046Destinations) Get() *InlineResponse20046Destinations {
	return v.value
}

func (v *NullableInlineResponse20046Destinations) Set(val *InlineResponse20046Destinations) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20046Destinations) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20046Destinations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20046Destinations(val *InlineResponse20046Destinations) *NullableInlineResponse20046Destinations {
	return &NullableInlineResponse20046Destinations{value: val, isSet: true}
}

func (v NullableInlineResponse20046Destinations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20046Destinations) UnmarshalJSON(src []byte) error {
	v.isSet = true
