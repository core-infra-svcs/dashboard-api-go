...
// InlineResponse200336Interfaces struct for InlineResponse200336Interfaces
type InlineResponse200336Interfaces struct {
...
func NewInlineResponse200336Interfaces() *InlineResponse200336Interfaces {
	this := InlineResponse200336Interfaces{}
	return &this
}
...
func (o InlineResponse200336Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200336Interfaces struct {
	value *InlineResponse200336Interfaces
	isSet bool
}

func (v NullableInlineResponse200336Interfaces) Get() *InlineResponse200336Interfaces {
	return v.value
}

func (v *NullableInlineResponse200336Interfaces) Set(val *InlineResponse200336Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200336Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200336Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200336Interfaces(val *InlineResponse200336Interfaces) *NullableInlineResponse200336Interfaces {
	return &NullableInlineResponse200336Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200336Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200336Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
