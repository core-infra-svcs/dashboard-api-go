...
func (r MonitoredMediaServersApiCreateOrganizationInsightMonitoredMediaServerRequest) Execute() (*InlineResponse200304, *http.Response, error) {
...
func (a *MonitoredMediaServersApiService) CreateOrganizationInsightMonitoredMediaServerExecute(r MonitoredMediaServersApiCreateOrganizationInsightMonitoredMediaServerRequest) (*InlineResponse200304, *http.Response, error) {
	var (
...
func (r MonitoredMediaServersApiGetOrganizationInsightMonitoredMediaServerRequest) Execute() (*InlineResponse200304, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200304
func (a *MonitoredMediaServersApiService) GetOrganizationInsightMonitoredMediaServerExecute(r MonitoredMediaServersApiGetOrganizationInsightMonitoredMediaServerRequest) (*InlineResponse200304, *http.Response, error) {
	var (
...
func (r MonitoredMediaServersApiGetOrganizationInsightMonitoredMediaServersRequest) Execute() ([]InlineResponse200304, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200304
func (a *MonitoredMediaServersApiService) GetOrganizationInsightMonitoredMediaServersExecute(r MonitoredMediaServersApiGetOrganizationInsightMonitoredMediaServersRequest) ([]InlineResponse200304, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MonitoredMediaServersApiUpdateOrganizationInsightMonitoredMediaServerRequest) Execute() (*InlineResponse200304, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200304
func (a *MonitoredMediaServersApiService) UpdateOrganizationInsightMonitoredMediaServerExecute(r MonitoredMediaServersApiUpdateOrganizationInsightMonitoredMediaServerRequest) (*InlineResponse200304, *http.Response, error) {
	var (
