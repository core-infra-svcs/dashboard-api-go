...
func (r MonitoredMediaServersApiCreateOrganizationInsightMonitoredMediaServerRequest) Execute() (*InlineResponse200251, *http.Response, error) {
...
func (a *MonitoredMediaServersApiService) CreateOrganizationInsightMonitoredMediaServerExecute(r MonitoredMediaServersApiCreateOrganizationInsightMonitoredMediaServerRequest) (*InlineResponse200251, *http.Response, error) {
	var (
...
func (r MonitoredMediaServersApiGetOrganizationInsightMonitoredMediaServerRequest) Execute() (*InlineResponse200251, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200251
func (a *MonitoredMediaServersApiService) GetOrganizationInsightMonitoredMediaServerExecute(r MonitoredMediaServersApiGetOrganizationInsightMonitoredMediaServerRequest) (*InlineResponse200251, *http.Response, error) {
	var (
...
func (r MonitoredMediaServersApiGetOrganizationInsightMonitoredMediaServersRequest) Execute() ([]InlineResponse200251, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200251
func (a *MonitoredMediaServersApiService) GetOrganizationInsightMonitoredMediaServersExecute(r MonitoredMediaServersApiGetOrganizationInsightMonitoredMediaServersRequest) ([]InlineResponse200251, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MonitoredMediaServersApiUpdateOrganizationInsightMonitoredMediaServerRequest) Execute() (*InlineResponse200251, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200251
func (a *MonitoredMediaServersApiService) UpdateOrganizationInsightMonitoredMediaServerExecute(r MonitoredMediaServersApiUpdateOrganizationInsightMonitoredMediaServerRequest) (*InlineResponse200251, *http.Response, error) {
	var (
