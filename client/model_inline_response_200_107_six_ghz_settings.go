...
// InlineResponse200107SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200107SixGhzSettings struct {
...
func NewInlineResponse200107SixGhzSettings() *InlineResponse200107SixGhzSettings {
	this := InlineResponse200107SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200107SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200107SixGhzSettings struct {
	value *InlineResponse200107SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200107SixGhzSettings) Get() *InlineResponse200107SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200107SixGhzSettings) Set(val *InlineResponse200107SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200107SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200107SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200107SixGhzSettings(val *InlineResponse200107SixGhzSettings) *NullableInlineResponse200107SixGhzSettings {
	return &NullableInlineResponse200107SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200107SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200107SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
