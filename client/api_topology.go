...
func (r TopologyApiGetOrganizationSwitchPortsTopologyDiscoveryByDeviceRequest) Execute() (*InlineResponse200327, *http.Response, error) {
...
func (a *TopologyApiService) GetOrganizationSwitchPortsTopologyDiscoveryByDeviceExecute(r TopologyApiGetOrganizationSwitchPortsTopologyDiscoveryByDeviceRequest) (*InlineResponse200327, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
