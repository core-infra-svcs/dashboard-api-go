...
// InlineResponse20025ResultsReplies struct for InlineResponse20025ResultsReplies
type InlineResponse20025ResultsReplies struct {
...
func NewInlineResponse20025ResultsReplies() *InlineResponse20025ResultsReplies {
	this := InlineResponse20025ResultsReplies{}
	return &this
}
...
func (o InlineResponse20025ResultsReplies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20025ResultsReplies struct {
	value *InlineResponse20025ResultsReplies
	isSet bool
}

func (v NullableInlineResponse20025ResultsReplies) Get() *InlineResponse20025ResultsReplies {
	return v.value
}

func (v *NullableInlineResponse20025ResultsReplies) Set(val *InlineResponse20025ResultsReplies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20025ResultsReplies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20025ResultsReplies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20025ResultsReplies(val *InlineResponse20025ResultsReplies) *NullableInlineResponse20025ResultsReplies {
	return &NullableInlineResponse20025ResultsReplies{value: val, isSet: true}
}

func (v NullableInlineResponse20025ResultsReplies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20025ResultsReplies) UnmarshalJSON(src []byte) error {
	v.isSet = true
