...
type InlineResponse200122 struct {
	...
	Networks []InlineResponse200122Networks `json:"networks,omitempty"`
	// The list of tags that the SAML administrator has privleges on
	Tags []InlineResponse200122Tags `json:"tags,omitempty"`
}
...
func (o *InlineResponse200122) GetNetworks() []InlineResponse200122Networks {
	if o == nil || isNil(o.Networks) {
		var ret []InlineResponse200122Networks
		return ret
	}
	return o.Networks
}
...
// SetNetworks gets a reference to the given []InlineResponse200122Networks and assigns it to the Networks field.
...
func (o *InlineResponse200122) GetTags() []InlineResponse200122Tags {
	if o == nil || isNil(o.Tags) {
		var ret []InlineResponse200122Tags
		return ret
	}
	return o.Tags
}
...
// SetTags gets a reference to the given []InlineResponse200122Tags and assigns it to the Tags field.
