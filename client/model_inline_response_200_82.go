...
type InlineResponse20082 struct {
	Alerts *InlineResponse20082Alerts `json:"alerts,omitempty"`
	...
	ArpInspection *InlineResponse20082ArpInspection `json:"arpInspection,omitempty"`
}
...
func (o *InlineResponse20082) GetAlerts() InlineResponse20082Alerts {
	if o == nil || isNil(o.Alerts) {
		var ret InlineResponse20082Alerts
		return ret
	}
	return *o.Alerts
}
...
// SetAlerts gets a reference to the given InlineResponse20082Alerts and assigns it to the Alerts field.
...
func (o *InlineResponse20082) GetArpInspection() InlineResponse20082ArpInspection {
	if o == nil || isNil(o.ArpInspection) {
		var ret InlineResponse20082ArpInspection
		return ret
	}
...
// SetArpInspection gets a reference to the given InlineResponse20082ArpInspection and assigns it to the ArpInspection field.
