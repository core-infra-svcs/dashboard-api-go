...
type InlineResponse20082 struct {
	...
	Rules []InlineResponse20082Rules `json:"rules,omitempty"`
}
...
func (o *InlineResponse20082) GetRules() []InlineResponse20082Rules {
	if o == nil || isNil(o.Rules) {
		var ret []InlineResponse20082Rules
		return ret
	}
	return o.Rules
}
...
func (o *InlineResponse20082) GetRulesOk() ([]InlineResponse20082Rules, bool) {
	if o == nil || isNil(o.Rules) {
    return nil, false
	}
	return o.Rules, true
...
func (o *InlineResponse20082) HasRules() bool {
	if o != nil && !isNil(o.Rules) {
		return true
	}
...
// SetRules gets a reference to the given []InlineResponse20082Rules and assigns it to the Rules field.
func (o *InlineResponse20082) SetRules(v []InlineResponse20082Rules) {
	o.Rules = v
}
