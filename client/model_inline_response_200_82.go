...
type InlineResponse20082 struct {
	Usage *InlineResponse20082Usage `json:"usage,omitempty"`
...
func (o *InlineResponse20082) GetUsage() InlineResponse20082Usage {
	if o == nil || isNil(o.Usage) {
		var ret InlineResponse20082Usage
		return ret
	}
	return *o.Usage
}
...
// SetUsage gets a reference to the given InlineResponse20082Usage and assigns it to the Usage field.
