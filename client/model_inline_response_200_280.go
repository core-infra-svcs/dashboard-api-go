...
type InlineResponse200280 struct {
	...
	LimitScopeToNetworks []InlineResponse200280LimitScopeToNetworks `json:"limitScopeToNetworks,omitempty"`
	OptOutEligibility *InlineResponse200280OptOutEligibility `json:"optOutEligibility,omitempty"`
...
func (o *InlineResponse200280) GetLimitScopeToNetworks() []InlineResponse200280LimitScopeToNetworks {
	if o == nil || isNil(o.LimitScopeToNetworks) {
		var ret []InlineResponse200280LimitScopeToNetworks
		return ret
	}
...
// SetLimitScopeToNetworks gets a reference to the given []InlineResponse200280LimitScopeToNetworks and assigns it to the LimitScopeToNetworks field.
...
func (o *InlineResponse200280) GetOptOutEligibility() InlineResponse200280OptOutEligibility {
	if o == nil || isNil(o.OptOutEligibility) {
		var ret InlineResponse200280OptOutEligibility
		return ret
	}
...
// SetOptOutEligibility gets a reference to the given InlineResponse200280OptOutEligibility and assigns it to the OptOutEligibility field.
