...
// InlineResponse200263UsageOverall Overall data usage of all clients across organization
type InlineResponse200263UsageOverall struct {
...
func NewInlineResponse200263UsageOverall() *InlineResponse200263UsageOverall {
	this := InlineResponse200263UsageOverall{}
	return &this
}
...
func (o InlineResponse200263UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200263UsageOverall struct {
	value *InlineResponse200263UsageOverall
	isSet bool
}

func (v NullableInlineResponse200263UsageOverall) Get() *InlineResponse200263UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200263UsageOverall) Set(val *InlineResponse200263UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200263UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200263UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200263UsageOverall(val *InlineResponse200263UsageOverall) *NullableInlineResponse200263UsageOverall {
	return &NullableInlineResponse200263UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200263UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200263UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
