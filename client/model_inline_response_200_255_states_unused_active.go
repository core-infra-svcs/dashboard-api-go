...
// InlineResponse200255StatesUnusedActive Data for unused, active licenses
type InlineResponse200255StatesUnusedActive struct {
	// The number of unused, active licenses
	Count *int32 `json:"count,omitempty"`
	OldestActivation *InlineResponse200255StatesUnusedActiveOldestActivation `json:"oldestActivation,omitempty"`
}
...
func NewInlineResponse200255StatesUnusedActive() *InlineResponse200255StatesUnusedActive {
	this := InlineResponse200255StatesUnusedActive{}
	return &this
}
...
func (o *InlineResponse200255StatesUnusedActive) GetOldestActivation() InlineResponse200255StatesUnusedActiveOldestActivation {
	if o == nil || isNil(o.OldestActivation) {
		var ret InlineResponse200255StatesUnusedActiveOldestActivation
		return ret
	}
...
// SetOldestActivation gets a reference to the given InlineResponse200255StatesUnusedActiveOldestActivation and assigns it to the OldestActivation field.
...
func (o InlineResponse200255StatesUnusedActive) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200255StatesUnusedActive struct {
	value *InlineResponse200255StatesUnusedActive
	isSet bool
}

func (v NullableInlineResponse200255StatesUnusedActive) Get() *InlineResponse200255StatesUnusedActive {
	return v.value
}

func (v *NullableInlineResponse200255StatesUnusedActive) Set(val *InlineResponse200255StatesUnusedActive) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200255StatesUnusedActive) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200255StatesUnusedActive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200255StatesUnusedActive(val *InlineResponse200255StatesUnusedActive) *NullableInlineResponse200255StatesUnusedActive {
	return &NullableInlineResponse200255StatesUnusedActive{value: val, isSet: true}
}

func (v NullableInlineResponse200255StatesUnusedActive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200255StatesUnusedActive) UnmarshalJSON(src []byte) error {
	v.isSet = true
