...
// InlineResponse20080Overrides struct for InlineResponse20080Overrides
type InlineResponse20080Overrides struct {
...
func NewInlineResponse20080Overrides() *InlineResponse20080Overrides {
	this := InlineResponse20080Overrides{}
	return &this
}
...
func (o InlineResponse20080Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20080Overrides struct {
	value *InlineResponse20080Overrides
	isSet bool
}

func (v NullableInlineResponse20080Overrides) Get() *InlineResponse20080Overrides {
	return v.value
}

func (v *NullableInlineResponse20080Overrides) Set(val *InlineResponse20080Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20080Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20080Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20080Overrides(val *InlineResponse20080Overrides) *NullableInlineResponse20080Overrides {
	return &NullableInlineResponse20080Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse20080Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20080Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
