...
// InlineResponse200331Changes struct for InlineResponse200331Changes
type InlineResponse200331Changes struct {
...
func NewInlineResponse200331Changes() *InlineResponse200331Changes {
	this := InlineResponse200331Changes{}
	return &this
}
...
func (o InlineResponse200331Changes) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200331Changes struct {
	value *InlineResponse200331Changes
	isSet bool
}

func (v NullableInlineResponse200331Changes) Get() *InlineResponse200331Changes {
	return v.value
}

func (v *NullableInlineResponse200331Changes) Set(val *InlineResponse200331Changes) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200331Changes) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200331Changes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200331Changes(val *InlineResponse200331Changes) *NullableInlineResponse200331Changes {
	return &NullableInlineResponse200331Changes{value: val, isSet: true}
}

func (v NullableInlineResponse200331Changes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200331Changes) UnmarshalJSON(src []byte) error {
	v.isSet = true
