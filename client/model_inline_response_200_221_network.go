...
// InlineResponse200221Network The network upon which a client with the given MAC address was found
type InlineResponse200221Network struct {
...
func NewInlineResponse200221Network() *InlineResponse200221Network {
	this := InlineResponse200221Network{}
	return &this
}
...
func (o InlineResponse200221Network) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200221Network struct {
	value *InlineResponse200221Network
	isSet bool
}

func (v NullableInlineResponse200221Network) Get() *InlineResponse200221Network {
	return v.value
}

func (v *NullableInlineResponse200221Network) Set(val *InlineResponse200221Network) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200221Network) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200221Network) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200221Network(val *InlineResponse200221Network) *NullableInlineResponse200221Network {
	return &NullableInlineResponse200221Network{value: val, isSet: true}
}

func (v NullableInlineResponse200221Network) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200221Network) UnmarshalJSON(src []byte) error {
	v.isSet = true
