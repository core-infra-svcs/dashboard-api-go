...
// InlineResponse200104Milestones The Staged Upgrade Milestones for the stage
type InlineResponse200104Milestones struct {
...
func NewInlineResponse200104Milestones() *InlineResponse200104Milestones {
	this := InlineResponse200104Milestones{}
	return &this
}
...
func (o InlineResponse200104Milestones) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200104Milestones struct {
	value *InlineResponse200104Milestones
	isSet bool
}

func (v NullableInlineResponse200104Milestones) Get() *InlineResponse200104Milestones {
	return v.value
}

func (v *NullableInlineResponse200104Milestones) Set(val *InlineResponse200104Milestones) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200104Milestones) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200104Milestones) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200104Milestones(val *InlineResponse200104Milestones) *NullableInlineResponse200104Milestones {
	return &NullableInlineResponse200104Milestones{value: val, isSet: true}
}

func (v NullableInlineResponse200104Milestones) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200104Milestones) UnmarshalJSON(src []byte) error {
	v.isSet = true
