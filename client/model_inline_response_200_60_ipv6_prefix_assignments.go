...
// InlineResponse20060Ipv6PrefixAssignments struct for InlineResponse20060Ipv6PrefixAssignments
type InlineResponse20060Ipv6PrefixAssignments struct {
...
func NewInlineResponse20060Ipv6PrefixAssignments() *InlineResponse20060Ipv6PrefixAssignments {
	this := InlineResponse20060Ipv6PrefixAssignments{}
	return &this
}
...
func (o InlineResponse20060Ipv6PrefixAssignments) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20060Ipv6PrefixAssignments struct {
	value *InlineResponse20060Ipv6PrefixAssignments
	isSet bool
}

func (v NullableInlineResponse20060Ipv6PrefixAssignments) Get() *InlineResponse20060Ipv6PrefixAssignments {
	return v.value
}

func (v *NullableInlineResponse20060Ipv6PrefixAssignments) Set(val *InlineResponse20060Ipv6PrefixAssignments) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20060Ipv6PrefixAssignments) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20060Ipv6PrefixAssignments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20060Ipv6PrefixAssignments(val *InlineResponse20060Ipv6PrefixAssignments) *NullableInlineResponse20060Ipv6PrefixAssignments {
	return &NullableInlineResponse20060Ipv6PrefixAssignments{value: val, isSet: true}
}

func (v NullableInlineResponse20060Ipv6PrefixAssignments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20060Ipv6PrefixAssignments) UnmarshalJSON(src []byte) error {
	v.isSet = true
