...
// InlineResponse20045DefaultDestinations The network-wide destinations for all alerts on the network.
type InlineResponse20045DefaultDestinations struct {
...
func NewInlineResponse20045DefaultDestinations() *InlineResponse20045DefaultDestinations {
	this := InlineResponse20045DefaultDestinations{}
	return &this
}
...
func (o InlineResponse20045DefaultDestinations) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20045DefaultDestinations struct {
	value *InlineResponse20045DefaultDestinations
	isSet bool
}

func (v NullableInlineResponse20045DefaultDestinations) Get() *InlineResponse20045DefaultDestinations {
	return v.value
}

func (v *NullableInlineResponse20045DefaultDestinations) Set(val *InlineResponse20045DefaultDestinations) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20045DefaultDestinations) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20045DefaultDestinations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20045DefaultDestinations(val *InlineResponse20045DefaultDestinations) *NullableInlineResponse20045DefaultDestinations {
	return &NullableInlineResponse20045DefaultDestinations{value: val, isSet: true}
}

func (v NullableInlineResponse20045DefaultDestinations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20045DefaultDestinations) UnmarshalJSON(src []byte) error {
	v.isSet = true
