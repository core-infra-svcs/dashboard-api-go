...
type InlineResponse20084 struct {
	Counts *InlineResponse20084Counts `json:"counts,omitempty"`
}
...
func (o *InlineResponse20084) GetCounts() InlineResponse20084Counts {
	if o == nil || isNil(o.Counts) {
		var ret InlineResponse20084Counts
		return ret
	}
	return *o.Counts
}
...
func (o *InlineResponse20084) GetCountsOk() (*InlineResponse20084Counts, bool) {
	if o == nil || isNil(o.Counts) {
    return nil, false
	}
...
func (o *InlineResponse20084) HasCounts() bool {
	if o != nil && !isNil(o.Counts) {
		return true
	}
...
// SetCounts gets a reference to the given InlineResponse20084Counts and assigns it to the Counts field.
func (o *InlineResponse20084) SetCounts(v InlineResponse20084Counts) {
	o.Counts = &v
}
