...
type InlineResponse200105 struct {
	...
	ApBandSettings *InlineResponse200105ApBandSettings `json:"apBandSettings,omitempty"`
	...
	SixGhzSettings *InlineResponse200105SixGhzSettings `json:"sixGhzSettings,omitempty"`
	Transmission *InlineResponse200105Transmission `json:"transmission,omitempty"`
	PerSsidSettings *InlineResponse200105PerSsidSettings `json:"perSsidSettings,omitempty"`
}
...
func (o *InlineResponse200105) GetApBandSettings() InlineResponse200105ApBandSettings {
	if o == nil || isNil(o.ApBandSettings) {
		var ret InlineResponse200105ApBandSettings
		return ret
	}
...
// SetApBandSettings gets a reference to the given InlineResponse200105ApBandSettings and assigns it to the ApBandSettings field.
...
func (o *InlineResponse200105) GetSixGhzSettings() InlineResponse200105SixGhzSettings {
	if o == nil || isNil(o.SixGhzSettings) {
		var ret InlineResponse200105SixGhzSettings
		return ret
	}
...
// SetSixGhzSettings gets a reference to the given InlineResponse200105SixGhzSettings and assigns it to the SixGhzSettings field.
...
func (o *InlineResponse200105) GetPerSsidSettings() InlineResponse200105PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse200105PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse200105PerSsidSettings and assigns it to the PerSsidSettings field.
