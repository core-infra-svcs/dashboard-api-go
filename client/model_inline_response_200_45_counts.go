...
// InlineResponse20045Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse20045Counts struct {
	...
	Noise *InlineResponse20045CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse20045Counts() *InlineResponse20045Counts {
	this := InlineResponse20045Counts{}
	return &this
}
...
func (o *InlineResponse20045Counts) GetNoise() InlineResponse20045CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse20045CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse20045CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse20045Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20045Counts struct {
	value *InlineResponse20045Counts
	isSet bool
}

func (v NullableInlineResponse20045Counts) Get() *InlineResponse20045Counts {
	return v.value
}

func (v *NullableInlineResponse20045Counts) Set(val *InlineResponse20045Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20045Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20045Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20045Counts(val *InlineResponse20045Counts) *NullableInlineResponse20045Counts {
	return &NullableInlineResponse20045Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20045Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20045Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
