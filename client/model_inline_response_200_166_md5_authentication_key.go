...
// InlineResponse200166Md5AuthenticationKey MD5 authentication credentials. This param is only relevant if md5AuthenticationEnabled is true
type InlineResponse200166Md5AuthenticationKey struct {
...
func NewInlineResponse200166Md5AuthenticationKey() *InlineResponse200166Md5AuthenticationKey {
	this := InlineResponse200166Md5AuthenticationKey{}
	return &this
}
...
func (o InlineResponse200166Md5AuthenticationKey) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200166Md5AuthenticationKey struct {
	value *InlineResponse200166Md5AuthenticationKey
	isSet bool
}

func (v NullableInlineResponse200166Md5AuthenticationKey) Get() *InlineResponse200166Md5AuthenticationKey {
	return v.value
}

func (v *NullableInlineResponse200166Md5AuthenticationKey) Set(val *InlineResponse200166Md5AuthenticationKey) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200166Md5AuthenticationKey) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200166Md5AuthenticationKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200166Md5AuthenticationKey(val *InlineResponse200166Md5AuthenticationKey) *NullableInlineResponse200166Md5AuthenticationKey {
	return &NullableInlineResponse200166Md5AuthenticationKey{value: val, isSet: true}
}

func (v NullableInlineResponse200166Md5AuthenticationKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200166Md5AuthenticationKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
