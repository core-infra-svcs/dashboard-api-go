...
func (r SyslogServersApiGetNetworkSyslogServersRequest) Execute() (*InlineResponse20054, *http.Response, error) {
...
func (a *SyslogServersApiService) GetNetworkSyslogServersExecute(r SyslogServersApiGetNetworkSyslogServersRequest) (*InlineResponse20054, *http.Response, error) {
	var (
...
func (r SyslogServersApiUpdateNetworkSyslogServersRequest) Execute() (*InlineResponse20054, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20054
func (a *SyslogServersApiService) UpdateNetworkSyslogServersExecute(r SyslogServersApiUpdateNetworkSyslogServersRequest) (*InlineResponse20054, *http.Response, error) {
	var (
