...
func (r SyslogServersApiGetNetworkSyslogServersRequest) Execute() (*InlineResponse200170, *http.Response, error) {
...
func (a *SyslogServersApiService) GetNetworkSyslogServersExecute(r SyslogServersApiGetNetworkSyslogServersRequest) (*InlineResponse200170, *http.Response, error) {
	var (
...
func (r SyslogServersApiUpdateNetworkSyslogServersRequest) UpdateNetworkSyslogServers(updateNetworkSyslogServers InlineObject165) SyslogServersApiUpdateNetworkSyslogServersRequest {
	r.updateNetworkSyslogServers = &updateNetworkSyslogServers
	return r
}

func (r SyslogServersApiUpdateNetworkSyslogServersRequest) Execute() (*InlineResponse200170, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200170
func (a *SyslogServersApiService) UpdateNetworkSyslogServersExecute(r SyslogServersApiUpdateNetworkSyslogServersRequest) (*InlineResponse200170, *http.Response, error) {
	var (
