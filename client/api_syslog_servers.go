...
func (r SyslogServersApiGetNetworkSyslogServersRequest) Execute() (*InlineResponse200107, *http.Response, error) {
...
func (a *SyslogServersApiService) GetNetworkSyslogServersExecute(r SyslogServersApiGetNetworkSyslogServersRequest) (*InlineResponse200107, *http.Response, error) {
	var (
...
func (r SyslogServersApiUpdateNetworkSyslogServersRequest) UpdateNetworkSyslogServers(updateNetworkSyslogServers InlineObject156) SyslogServersApiUpdateNetworkSyslogServersRequest {
	r.updateNetworkSyslogServers = &updateNetworkSyslogServers
	return r
}

func (r SyslogServersApiUpdateNetworkSyslogServersRequest) Execute() (*InlineResponse200107, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200107
func (a *SyslogServersApiService) UpdateNetworkSyslogServersExecute(r SyslogServersApiUpdateNetworkSyslogServersRequest) (*InlineResponse200107, *http.Response, error) {
	var (
