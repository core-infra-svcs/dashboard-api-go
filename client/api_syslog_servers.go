...
func (r SyslogServersApiGetNetworkSyslogServersRequest) Execute() (*InlineResponse20091, *http.Response, error) {
...
func (a *SyslogServersApiService) GetNetworkSyslogServersExecute(r SyslogServersApiGetNetworkSyslogServersRequest) (*InlineResponse20091, *http.Response, error) {
	var (
...
func (r SyslogServersApiUpdateNetworkSyslogServersRequest) Execute() (*InlineResponse20091, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20091
func (a *SyslogServersApiService) UpdateNetworkSyslogServersExecute(r SyslogServersApiUpdateNetworkSyslogServersRequest) (*InlineResponse20091, *http.Response, error) {
	var (
