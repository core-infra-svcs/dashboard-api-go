...
func (r SyslogServersApiGetNetworkSyslogServersRequest) Execute() (*InlineResponse200161, *http.Response, error) {
...
func (a *SyslogServersApiService) GetNetworkSyslogServersExecute(r SyslogServersApiGetNetworkSyslogServersRequest) (*InlineResponse200161, *http.Response, error) {
	var (
...
func (r SyslogServersApiUpdateNetworkSyslogServersRequest) UpdateNetworkSyslogServers(updateNetworkSyslogServers InlineObject159) SyslogServersApiUpdateNetworkSyslogServersRequest {
	r.updateNetworkSyslogServers = &updateNetworkSyslogServers
	return r
}

func (r SyslogServersApiUpdateNetworkSyslogServersRequest) Execute() (*InlineResponse200161, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200161
func (a *SyslogServersApiService) UpdateNetworkSyslogServersExecute(r SyslogServersApiUpdateNetworkSyslogServersRequest) (*InlineResponse200161, *http.Response, error) {
	var (
