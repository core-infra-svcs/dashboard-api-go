...
func (r SyslogServersApiGetNetworkSyslogServersRequest) Execute() (*InlineResponse20071, *http.Response, error) {
...
func (a *SyslogServersApiService) GetNetworkSyslogServersExecute(r SyslogServersApiGetNetworkSyslogServersRequest) (*InlineResponse20071, *http.Response, error) {
	var (
...
func (r SyslogServersApiUpdateNetworkSyslogServersRequest) Execute() (*InlineResponse20071, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20071
func (a *SyslogServersApiService) UpdateNetworkSyslogServersExecute(r SyslogServersApiUpdateNetworkSyslogServersRequest) (*InlineResponse20071, *http.Response, error) {
	var (
