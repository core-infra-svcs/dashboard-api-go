...
// InlineResponse200311Example Example alert type
type InlineResponse200311Example struct {
...
func NewInlineResponse200311Example() *InlineResponse200311Example {
	this := InlineResponse200311Example{}
	return &this
}
...
func (o InlineResponse200311Example) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200311Example struct {
	value *InlineResponse200311Example
	isSet bool
}

func (v NullableInlineResponse200311Example) Get() *InlineResponse200311Example {
	return v.value
}

func (v *NullableInlineResponse200311Example) Set(val *InlineResponse200311Example) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200311Example) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200311Example) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200311Example(val *InlineResponse200311Example) *NullableInlineResponse200311Example {
	return &NullableInlineResponse200311Example{value: val, isSet: true}
}

func (v NullableInlineResponse200311Example) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200311Example) UnmarshalJSON(src []byte) error {
	v.isSet = true
