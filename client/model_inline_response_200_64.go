...
type InlineResponse20064 struct {
	...
	AllowedUrls []InlineResponse20064AllowedUrls `json:"allowedUrls,omitempty"`
	// Sha256 digests of files permitted by the malware detection engine
	AllowedFiles []InlineResponse20064AllowedFiles `json:"allowedFiles,omitempty"`
}
...
func (o *InlineResponse20064) GetAllowedUrls() []InlineResponse20064AllowedUrls {
	if o == nil || isNil(o.AllowedUrls) {
		var ret []InlineResponse20064AllowedUrls
		return ret
	}
...
// SetAllowedUrls gets a reference to the given []InlineResponse20064AllowedUrls and assigns it to the AllowedUrls field.
...
func (o *InlineResponse20064) GetAllowedFiles() []InlineResponse20064AllowedFiles {
	if o == nil || isNil(o.AllowedFiles) {
		var ret []InlineResponse20064AllowedFiles
		return ret
	}
...
// SetAllowedFiles gets a reference to the given []InlineResponse20064AllowedFiles and assigns it to the AllowedFiles field.
