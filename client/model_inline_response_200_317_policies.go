...
// InlineResponse200317Policies struct for InlineResponse200317Policies
type InlineResponse200317Policies struct {
...
func NewInlineResponse200317Policies() *InlineResponse200317Policies {
	this := InlineResponse200317Policies{}
	return &this
}
...
func (o InlineResponse200317Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200317Policies struct {
	value *InlineResponse200317Policies
	isSet bool
}

func (v NullableInlineResponse200317Policies) Get() *InlineResponse200317Policies {
	return v.value
}

func (v *NullableInlineResponse200317Policies) Set(val *InlineResponse200317Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200317Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200317Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200317Policies(val *InlineResponse200317Policies) *NullableInlineResponse200317Policies {
	return &NullableInlineResponse200317Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200317Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200317Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
