...
// InlineResponse200266Records struct for InlineResponse200266Records
type InlineResponse200266Records struct {
	Network *InlineResponse200266Network `json:"network,omitempty"`
	...
	ClientVpnConnections []InlineResponse200266ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200266Records() *InlineResponse200266Records {
	this := InlineResponse200266Records{}
	return &this
}
...
func (o *InlineResponse200266Records) GetNetwork() InlineResponse200266Network {
	if o == nil || isNil(o.Network) {
		var ret InlineResponse200266Network
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given InlineResponse200266Network and assigns it to the Network field.
...
func (o *InlineResponse200266Records) GetClientVpnConnections() []InlineResponse200266ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200266ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200266ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200266Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200266Records struct {
	value *InlineResponse200266Records
	isSet bool
}

func (v NullableInlineResponse200266Records) Get() *InlineResponse200266Records {
	return v.value
}

func (v *NullableInlineResponse200266Records) Set(val *InlineResponse200266Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200266Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200266Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200266Records(val *InlineResponse200266Records) *NullableInlineResponse200266Records {
	return &NullableInlineResponse200266Records{value: val, isSet: true}
}

func (v NullableInlineResponse200266Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200266Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
