...
// InlineResponse20078Usage Usage, sent and received
type InlineResponse20078Usage struct {
...
func (o InlineResponse20078Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20078Usage struct {
	value *InlineResponse20078Usage
	isSet bool
}

func (v NullableInlineResponse20078Usage) Get() *InlineResponse20078Usage {
	return v.value
}

func (v *NullableInlineResponse20078Usage) Set(val *InlineResponse20078Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20078Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20078Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20078Usage(val *InlineResponse20078Usage) *NullableInlineResponse20078Usage {
	return &NullableInlineResponse20078Usage{value: val, isSet: true}
}

func (v NullableInlineResponse20078Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20078Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
