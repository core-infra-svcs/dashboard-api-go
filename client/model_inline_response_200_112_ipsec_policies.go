...
// InlineResponse200112IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200112IpsecPolicies struct {
...
func NewInlineResponse200112IpsecPolicies() *InlineResponse200112IpsecPolicies {
	this := InlineResponse200112IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200112IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200112IpsecPolicies struct {
	value *InlineResponse200112IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200112IpsecPolicies) Get() *InlineResponse200112IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200112IpsecPolicies) Set(val *InlineResponse200112IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200112IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200112IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200112IpsecPolicies(val *InlineResponse200112IpsecPolicies) *NullableInlineResponse200112IpsecPolicies {
	return &NullableInlineResponse200112IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200112IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200112IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
