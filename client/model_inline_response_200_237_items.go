...
type InlineResponse200237Items struct {
	...
	Ipsec *InlineResponse200237Ipsec `json:"ipsec,omitempty"`
}
...
func (o *InlineResponse200237Items) GetIpsec() InlineResponse200237Ipsec {
	if o == nil || isNil(o.Ipsec) {
		var ret InlineResponse200237Ipsec
		return ret
	}
	return *o.Ipsec
}
...
// SetIpsec gets a reference to the given InlineResponse200237Ipsec and assigns it to the Ipsec field.
