...
func (r AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) RecalculateOrganizationWirelessRadioAutoRfChannels(recalculateOrganizationWirelessRadioAutoRfChannels InlineObject306) AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest {
	r.recalculateOrganizationWirelessRadioAutoRfChannels = &recalculateOrganizationWirelessRadioAutoRfChannels
	return r
}

func (r AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) Execute() (*InlineResponse200372, *http.Response, error) {
...
func (a *AutoRfApiService) RecalculateOrganizationWirelessRadioAutoRfChannelsExecute(r AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) (*InlineResponse200372, *http.Response, error) {
	var (
