...
func (r AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) RecalculateOrganizationWirelessRadioAutoRfChannels(recalculateOrganizationWirelessRadioAutoRfChannels InlineObject312) AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest {
	r.recalculateOrganizationWirelessRadioAutoRfChannels = &recalculateOrganizationWirelessRadioAutoRfChannels
	return r
}

func (r AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) Execute() (*InlineResponse200386, *http.Response, error) {
...
func (a *AutoRfApiService) RecalculateOrganizationWirelessRadioAutoRfChannelsExecute(r AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) (*InlineResponse200386, *http.Response, error) {
	var (
