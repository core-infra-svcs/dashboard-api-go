...
func (r AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) RecalculateOrganizationWirelessRadioAutoRfChannels(recalculateOrganizationWirelessRadioAutoRfChannels InlineObject288) AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest {
	r.recalculateOrganizationWirelessRadioAutoRfChannels = &recalculateOrganizationWirelessRadioAutoRfChannels
	return r
}

func (r AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) Execute() (*InlineResponse200347, *http.Response, error) {
...
func (a *AutoRfApiService) RecalculateOrganizationWirelessRadioAutoRfChannelsExecute(r AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) (*InlineResponse200347, *http.Response, error) {
	var (
