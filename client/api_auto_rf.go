...
func (r AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) RecalculateOrganizationWirelessRadioAutoRfChannels(recalculateOrganizationWirelessRadioAutoRfChannels InlineObject286) AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest {
	r.recalculateOrganizationWirelessRadioAutoRfChannels = &recalculateOrganizationWirelessRadioAutoRfChannels
	return r
}

func (r AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) Execute() (*InlineResponse200344, *http.Response, error) {
...
func (a *AutoRfApiService) RecalculateOrganizationWirelessRadioAutoRfChannelsExecute(r AutoRfApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) (*InlineResponse200344, *http.Response, error) {
	var (
