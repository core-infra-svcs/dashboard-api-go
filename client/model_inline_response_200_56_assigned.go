...
// InlineResponse20056Assigned struct for InlineResponse20056Assigned
type InlineResponse20056Assigned struct {
	...
	TwoFourGhzSettings *InlineResponse20056TwoFourGhzSettings `json:"twoFourGhzSettings,omitempty"`
	FiveGhzSettings *InlineResponse20056FiveGhzSettings `json:"fiveGhzSettings,omitempty"`
	PerSsidSettings *InlineResponse20056PerSsidSettings `json:"perSsidSettings,omitempty"`
}
...
func NewInlineResponse20056Assigned() *InlineResponse20056Assigned {
	this := InlineResponse20056Assigned{}
	return &this
}
...
func (o *InlineResponse20056Assigned) GetTwoFourGhzSettings() InlineResponse20056TwoFourGhzSettings {
	if o == nil || isNil(o.TwoFourGhzSettings) {
		var ret InlineResponse20056TwoFourGhzSettings
		return ret
	}
...
// SetTwoFourGhzSettings gets a reference to the given InlineResponse20056TwoFourGhzSettings and assigns it to the TwoFourGhzSettings field.
...
func (o *InlineResponse20056Assigned) GetFiveGhzSettings() InlineResponse20056FiveGhzSettings {
	if o == nil || isNil(o.FiveGhzSettings) {
		var ret InlineResponse20056FiveGhzSettings
		return ret
	}
...
// SetFiveGhzSettings gets a reference to the given InlineResponse20056FiveGhzSettings and assigns it to the FiveGhzSettings field.
...
func (o *InlineResponse20056Assigned) GetPerSsidSettings() InlineResponse20056PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse20056PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse20056PerSsidSettings and assigns it to the PerSsidSettings field.
func (o *InlineResponse20056Assigned) SetPerSsidSettings(v InlineResponse20056PerSsidSettings) {
	o.PerSsidSettings = &v
}

func (o InlineResponse20056Assigned) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20056Assigned struct {
	value *InlineResponse20056Assigned
	isSet bool
}

func (v NullableInlineResponse20056Assigned) Get() *InlineResponse20056Assigned {
	return v.value
}

func (v *NullableInlineResponse20056Assigned) Set(val *InlineResponse20056Assigned) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20056Assigned) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20056Assigned) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20056Assigned(val *InlineResponse20056Assigned) *NullableInlineResponse20056Assigned {
	return &NullableInlineResponse20056Assigned{value: val, isSet: true}
}

func (v NullableInlineResponse20056Assigned) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20056Assigned) UnmarshalJSON(src []byte) error {
	v.isSet = true
