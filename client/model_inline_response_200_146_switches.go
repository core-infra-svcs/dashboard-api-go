...
// InlineResponse200146Switches struct for InlineResponse200146Switches
type InlineResponse200146Switches struct {
...
func NewInlineResponse200146Switches() *InlineResponse200146Switches {
	this := InlineResponse200146Switches{}
	return &this
}
...
func (o InlineResponse200146Switches) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200146Switches struct {
	value *InlineResponse200146Switches
	isSet bool
}

func (v NullableInlineResponse200146Switches) Get() *InlineResponse200146Switches {
	return v.value
}

func (v *NullableInlineResponse200146Switches) Set(val *InlineResponse200146Switches) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200146Switches) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200146Switches) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200146Switches(val *InlineResponse200146Switches) *NullableInlineResponse200146Switches {
	return &NullableInlineResponse200146Switches{value: val, isSet: true}
}

func (v NullableInlineResponse200146Switches) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200146Switches) UnmarshalJSON(src []byte) error {
	v.isSet = true
