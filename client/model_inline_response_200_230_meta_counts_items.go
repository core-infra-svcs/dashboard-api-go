...
// InlineResponse200230MetaCountsItems Count of Communication Plans available
type InlineResponse200230MetaCountsItems struct {
...
func NewInlineResponse200230MetaCountsItems() *InlineResponse200230MetaCountsItems {
	this := InlineResponse200230MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200230MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200230MetaCountsItems struct {
	value *InlineResponse200230MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200230MetaCountsItems) Get() *InlineResponse200230MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200230MetaCountsItems) Set(val *InlineResponse200230MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200230MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200230MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200230MetaCountsItems(val *InlineResponse200230MetaCountsItems) *NullableInlineResponse200230MetaCountsItems {
	return &NullableInlineResponse200230MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200230MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200230MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
