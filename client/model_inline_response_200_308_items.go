...
// InlineResponse200308Items struct for InlineResponse200308Items
type InlineResponse200308Items struct {
	// Unique serial number for device.
	Serial *string `json:"serial,omitempty"`
	// Name of device.
	Name *string `json:"name,omitempty"`
	Network *InlineResponse200308Network `json:"network,omitempty"`
	// Status information for wireless access points.
	BasicServiceSets []InlineResponse200308BasicServiceSets `json:"basicServiceSets,omitempty"`
}
...
func NewInlineResponse200308Items() *InlineResponse200308Items {
	this := InlineResponse200308Items{}
	return &this
}
...
func (o *InlineResponse200308Items) GetNetwork() InlineResponse200308Network {
	if o == nil || isNil(o.Network) {
		var ret InlineResponse200308Network
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given InlineResponse200308Network and assigns it to the Network field.
...
func (o *InlineResponse200308Items) GetBasicServiceSets() []InlineResponse200308BasicServiceSets {
	if o == nil || isNil(o.BasicServiceSets) {
		var ret []InlineResponse200308BasicServiceSets
		return ret
	}
...
// SetBasicServiceSets gets a reference to the given []InlineResponse200308BasicServiceSets and assigns it to the BasicServiceSets field.
func (o *InlineResponse200308Items) SetBasicServiceSets(v []InlineResponse200308BasicServiceSets) {
	o.BasicServiceSets = v
}

func (o InlineResponse200308Items) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200308Items struct {
	value *InlineResponse200308Items
	isSet bool
}

func (v NullableInlineResponse200308Items) Get() *InlineResponse200308Items {
	return v.value
}

func (v *NullableInlineResponse200308Items) Set(val *InlineResponse200308Items) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200308Items) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200308Items) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200308Items(val *InlineResponse200308Items) *NullableInlineResponse200308Items {
	return &NullableInlineResponse200308Items{value: val, isSet: true}
}

func (v NullableInlineResponse200308Items) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200308Items) UnmarshalJSON(src []byte) error {
	v.isSet = true
