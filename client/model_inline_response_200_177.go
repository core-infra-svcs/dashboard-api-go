...
type InlineResponse200177 struct {
	...
	V3 *InlineResponse200177V3 `json:"v3,omitempty"`
	...
	Vrf *InlineResponse200177Vrf `json:"vrf,omitempty"`
}
...
func (o *InlineResponse200177) GetV3() InlineResponse200177V3 {
	if o == nil || isNil(o.V3) {
		var ret InlineResponse200177V3
		return ret
	}
	return *o.V3
}
...
// SetV3 gets a reference to the given InlineResponse200177V3 and assigns it to the V3 field.
...
func (o *InlineResponse200177) GetVrf() InlineResponse200177Vrf {
	if o == nil || isNil(o.Vrf) {
		var ret InlineResponse200177Vrf
		return ret
	}
	return *o.Vrf
}
...
// SetVrf gets a reference to the given InlineResponse200177Vrf and assigns it to the Vrf field.
