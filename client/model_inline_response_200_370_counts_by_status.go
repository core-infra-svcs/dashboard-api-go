...
// InlineResponse200370CountsByStatus Client counts by its status
type InlineResponse200370CountsByStatus struct {
...
func NewInlineResponse200370CountsByStatus() *InlineResponse200370CountsByStatus {
	this := InlineResponse200370CountsByStatus{}
	return &this
}
...
func (o InlineResponse200370CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200370CountsByStatus struct {
	value *InlineResponse200370CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200370CountsByStatus) Get() *InlineResponse200370CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200370CountsByStatus) Set(val *InlineResponse200370CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200370CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200370CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200370CountsByStatus(val *InlineResponse200370CountsByStatus) *NullableInlineResponse200370CountsByStatus {
	return &NullableInlineResponse200370CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200370CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200370CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
