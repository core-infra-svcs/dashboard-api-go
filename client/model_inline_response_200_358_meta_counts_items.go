...
// InlineResponse200358MetaCountsItems The count metadata.
type InlineResponse200358MetaCountsItems struct {
...
func NewInlineResponse200358MetaCountsItems() *InlineResponse200358MetaCountsItems {
	this := InlineResponse200358MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200358MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200358MetaCountsItems struct {
	value *InlineResponse200358MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200358MetaCountsItems) Get() *InlineResponse200358MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200358MetaCountsItems) Set(val *InlineResponse200358MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200358MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200358MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200358MetaCountsItems(val *InlineResponse200358MetaCountsItems) *NullableInlineResponse200358MetaCountsItems {
	return &NullableInlineResponse200358MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200358MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200358MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
