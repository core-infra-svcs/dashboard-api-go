...
func (r OspfApiGetNetworkSwitchRoutingOspfRequest) Execute() (*InlineResponse200153, *http.Response, error) {
...
func (a *OspfApiService) GetNetworkSwitchRoutingOspfExecute(r OspfApiGetNetworkSwitchRoutingOspfRequest) (*InlineResponse200153, *http.Response, error) {
	var (
...
func (r OspfApiUpdateNetworkSwitchRoutingOspfRequest) Execute() (*InlineResponse200153, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200153
func (a *OspfApiService) UpdateNetworkSwitchRoutingOspfExecute(r OspfApiUpdateNetworkSwitchRoutingOspfRequest) (*InlineResponse200153, *http.Response, error) {
	var (
