...
func (r OspfApiApiGetNetworkSwitchRoutingOspfRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *OspfApiService) GetNetworkSwitchRoutingOspf(ctx context.Context, networkId string) OspfApiApiGetNetworkSwitchRoutingOspfRequest {
	return OspfApiApiGetNetworkSwitchRoutingOspfRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *OspfApiService) GetNetworkSwitchRoutingOspfExecute(r OspfApiApiGetNetworkSwitchRoutingOspfRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r OspfApiApiUpdateNetworkSwitchRoutingOspfRequest) UpdateNetworkSwitchRoutingOspf(updateNetworkSwitchRoutingOspf InlineObject108) OspfApiApiUpdateNetworkSwitchRoutingOspfRequest {
	r.updateNetworkSwitchRoutingOspf = &updateNetworkSwitchRoutingOspf
	return r
}

func (r OspfApiApiUpdateNetworkSwitchRoutingOspfRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *OspfApiService) UpdateNetworkSwitchRoutingOspf(ctx context.Context, networkId string) OspfApiApiUpdateNetworkSwitchRoutingOspfRequest {
	return OspfApiApiUpdateNetworkSwitchRoutingOspfRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *OspfApiService) UpdateNetworkSwitchRoutingOspfExecute(r OspfApiApiUpdateNetworkSwitchRoutingOspfRequest) (map[string]interface{}, *http.Response, error) {
	var (
