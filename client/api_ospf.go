...
func (r OspfApiGetNetworkSwitchRoutingOspfRequest) Vrf(vrf string) OspfApiGetNetworkSwitchRoutingOspfRequest {
	r.vrf = &vrf
	return r
}

func (r OspfApiGetNetworkSwitchRoutingOspfRequest) Execute() (*InlineResponse200168, *http.Response, error) {
...
func (a *OspfApiService) GetNetworkSwitchRoutingOspfExecute(r OspfApiGetNetworkSwitchRoutingOspfRequest) (*InlineResponse200168, *http.Response, error) {
	var (
...
func (r OspfApiUpdateNetworkSwitchRoutingOspfRequest) Vrf(vrf string) OspfApiUpdateNetworkSwitchRoutingOspfRequest {
	r.vrf = &vrf
	return r
}

func (r OspfApiUpdateNetworkSwitchRoutingOspfRequest) UpdateNetworkSwitchRoutingOspf(updateNetworkSwitchRoutingOspf InlineObject157) OspfApiUpdateNetworkSwitchRoutingOspfRequest {
	r.updateNetworkSwitchRoutingOspf = &updateNetworkSwitchRoutingOspf
	return r
}

func (r OspfApiUpdateNetworkSwitchRoutingOspfRequest) Execute() (*InlineResponse200168, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200168
func (a *OspfApiService) UpdateNetworkSwitchRoutingOspfExecute(r OspfApiUpdateNetworkSwitchRoutingOspfRequest) (*InlineResponse200168, *http.Response, error) {
	var (
