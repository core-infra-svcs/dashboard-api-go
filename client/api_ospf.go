...
func (r OspfApiGetNetworkSwitchRoutingOspfRequest) Execute() (*InlineResponse200171, *http.Response, error) {
...
func (a *OspfApiService) GetNetworkSwitchRoutingOspfExecute(r OspfApiGetNetworkSwitchRoutingOspfRequest) (*InlineResponse200171, *http.Response, error) {
	var (
...
func (r OspfApiUpdateNetworkSwitchRoutingOspfRequest) Execute() (*InlineResponse200171, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200171
func (a *OspfApiService) UpdateNetworkSwitchRoutingOspfExecute(r OspfApiUpdateNetworkSwitchRoutingOspfRequest) (*InlineResponse200171, *http.Response, error) {
	var (
