...
func (r OspfApiGetNetworkSwitchRoutingOspfRequest) Execute() (*InlineResponse200164, *http.Response, error) {
...
func (a *OspfApiService) GetNetworkSwitchRoutingOspfExecute(r OspfApiGetNetworkSwitchRoutingOspfRequest) (*InlineResponse200164, *http.Response, error) {
	var (
...
func (r OspfApiUpdateNetworkSwitchRoutingOspfRequest) UpdateNetworkSwitchRoutingOspf(updateNetworkSwitchRoutingOspf InlineObject153) OspfApiUpdateNetworkSwitchRoutingOspfRequest {
	r.updateNetworkSwitchRoutingOspf = &updateNetworkSwitchRoutingOspf
	return r
}

func (r OspfApiUpdateNetworkSwitchRoutingOspfRequest) Execute() (*InlineResponse200164, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200164
func (a *OspfApiService) UpdateNetworkSwitchRoutingOspfExecute(r OspfApiUpdateNetworkSwitchRoutingOspfRequest) (*InlineResponse200164, *http.Response, error) {
	var (
