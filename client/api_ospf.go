...
func (r OspfApiGetNetworkSwitchRoutingOspfRequest) Execute() (*InlineResponse200155, *http.Response, error) {
...
func (a *OspfApiService) GetNetworkSwitchRoutingOspfExecute(r OspfApiGetNetworkSwitchRoutingOspfRequest) (*InlineResponse200155, *http.Response, error) {
	var (
...
func (r OspfApiUpdateNetworkSwitchRoutingOspfRequest) Execute() (*InlineResponse200155, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200155
func (a *OspfApiService) UpdateNetworkSwitchRoutingOspfExecute(r OspfApiUpdateNetworkSwitchRoutingOspfRequest) (*InlineResponse200155, *http.Response, error) {
	var (
