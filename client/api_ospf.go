...
func (r OspfApiGetNetworkSwitchRoutingOspfRequest) Execute() (*InlineResponse200165, *http.Response, error) {
...
func (a *OspfApiService) GetNetworkSwitchRoutingOspfExecute(r OspfApiGetNetworkSwitchRoutingOspfRequest) (*InlineResponse200165, *http.Response, error) {
	var (
...
func (r OspfApiUpdateNetworkSwitchRoutingOspfRequest) Execute() (*InlineResponse200165, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200165
func (a *OspfApiService) UpdateNetworkSwitchRoutingOspfExecute(r OspfApiUpdateNetworkSwitchRoutingOspfRequest) (*InlineResponse200165, *http.Response, error) {
	var (
