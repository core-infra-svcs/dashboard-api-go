...
func (r InternetPoliciesApiUpdateNetworkApplianceSdwanInternetPoliciesRequest) UpdateNetworkApplianceSdwanInternetPolicies(updateNetworkApplianceSdwanInternetPolicies InlineObject55) InternetPoliciesApiUpdateNetworkApplianceSdwanInternetPoliciesRequest {
	r.updateNetworkApplianceSdwanInternetPolicies = &updateNetworkApplianceSdwanInternetPolicies
	return r
}

func (r InternetPoliciesApiUpdateNetworkApplianceSdwanInternetPoliciesRequest) Execute() (*InlineResponse20054, *http.Response, error) {
...
func (a *InternetPoliciesApiService) UpdateNetworkApplianceSdwanInternetPoliciesExecute(r InternetPoliciesApiUpdateNetworkApplianceSdwanInternetPoliciesRequest) (*InlineResponse20054, *http.Response, error) {
	var (
