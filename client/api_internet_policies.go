...
func (r InternetPoliciesApiUpdateNetworkApplianceSdwanInternetPoliciesRequest) Execute() (*InlineResponse20055, *http.Response, error) {
...
func (a *InternetPoliciesApiService) UpdateNetworkApplianceSdwanInternetPoliciesExecute(r InternetPoliciesApiUpdateNetworkApplianceSdwanInternetPoliciesRequest) (*InlineResponse20055, *http.Response, error) {
	var (
