...
func (r InternetPoliciesApiUpdateNetworkApplianceSdwanInternetPoliciesRequest) Execute() (*InlineResponse20065, *http.Response, error) {
...
func (a *InternetPoliciesApiService) UpdateNetworkApplianceSdwanInternetPoliciesExecute(r InternetPoliciesApiUpdateNetworkApplianceSdwanInternetPoliciesRequest) (*InlineResponse20065, *http.Response, error) {
	var (
