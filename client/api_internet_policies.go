...
func (r InternetPoliciesApiUpdateNetworkApplianceSdwanInternetPoliciesRequest) UpdateNetworkApplianceSdwanInternetPolicies(updateNetworkApplianceSdwanInternetPolicies InlineObject57) InternetPoliciesApiUpdateNetworkApplianceSdwanInternetPoliciesRequest {
	r.updateNetworkApplianceSdwanInternetPolicies = &updateNetworkApplianceSdwanInternetPolicies
	return r
}

func (r InternetPoliciesApiUpdateNetworkApplianceSdwanInternetPoliciesRequest) Execute() (*InlineResponse20057, *http.Response, error) {
...
func (a *InternetPoliciesApiService) UpdateNetworkApplianceSdwanInternetPoliciesExecute(r InternetPoliciesApiUpdateNetworkApplianceSdwanInternetPoliciesRequest) (*InlineResponse20057, *http.Response, error) {
	var (
