...
// InlineResponse20085EventData An object containing more data related to the event.
type InlineResponse20085EventData struct {
...
func NewInlineResponse20085EventData() *InlineResponse20085EventData {
	this := InlineResponse20085EventData{}
	return &this
}
...
func (o InlineResponse20085EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20085EventData struct {
	value *InlineResponse20085EventData
	isSet bool
}

func (v NullableInlineResponse20085EventData) Get() *InlineResponse20085EventData {
	return v.value
}

func (v *NullableInlineResponse20085EventData) Set(val *InlineResponse20085EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20085EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20085EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20085EventData(val *InlineResponse20085EventData) *NullableInlineResponse20085EventData {
	return &NullableInlineResponse20085EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20085EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20085EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
