...
func (r VideoLinkApiApiGetDeviceCameraVideoLinkRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *VideoLinkApiService) GetDeviceCameraVideoLink(ctx context.Context, serial string) VideoLinkApiApiGetDeviceCameraVideoLinkRequest {
	return VideoLinkApiApiGetDeviceCameraVideoLinkRequest{
		ApiService: a,
		ctx: ctx,
		serial: serial,
...
func (a *VideoLinkApiService) GetDeviceCameraVideoLinkExecute(r VideoLinkApiApiGetDeviceCameraVideoLinkRequest) (map[string]interface{}, *http.Response, error) {
	var (
