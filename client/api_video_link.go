...
func (r VideoLinkApiGetDeviceCameraVideoLinkRequest) Execute() (*InlineResponse20021, *http.Response, error) {
...
func (a *VideoLinkApiService) GetDeviceCameraVideoLinkExecute(r VideoLinkApiGetDeviceCameraVideoLinkRequest) (*InlineResponse20021, *http.Response, error) {
	var (
