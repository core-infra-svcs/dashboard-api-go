...
// InlineResponse200328BandwidthUsage Bandwidth usage data for the given interval.
type InlineResponse200328BandwidthUsage struct {
...
func NewInlineResponse200328BandwidthUsage() *InlineResponse200328BandwidthUsage {
	this := InlineResponse200328BandwidthUsage{}
	return &this
}
...
func (o InlineResponse200328BandwidthUsage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200328BandwidthUsage struct {
	value *InlineResponse200328BandwidthUsage
	isSet bool
}

func (v NullableInlineResponse200328BandwidthUsage) Get() *InlineResponse200328BandwidthUsage {
	return v.value
}

func (v *NullableInlineResponse200328BandwidthUsage) Set(val *InlineResponse200328BandwidthUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200328BandwidthUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200328BandwidthUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200328BandwidthUsage(val *InlineResponse200328BandwidthUsage) *NullableInlineResponse200328BandwidthUsage {
	return &NullableInlineResponse200328BandwidthUsage{value: val, isSet: true}
}

func (v NullableInlineResponse200328BandwidthUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200328BandwidthUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
