...
// InlineResponse20087Plans struct for InlineResponse20087Plans
type InlineResponse20087Plans struct {
...
func (o InlineResponse20087Plans) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20087Plans struct {
	value *InlineResponse20087Plans
	isSet bool
}

func (v NullableInlineResponse20087Plans) Get() *InlineResponse20087Plans {
	return v.value
}

func (v *NullableInlineResponse20087Plans) Set(val *InlineResponse20087Plans) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20087Plans) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20087Plans) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20087Plans(val *InlineResponse20087Plans) *NullableInlineResponse20087Plans {
	return &NullableInlineResponse20087Plans{value: val, isSet: true}
}

func (v NullableInlineResponse20087Plans) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20087Plans) UnmarshalJSON(src []byte) error {
	v.isSet = true
