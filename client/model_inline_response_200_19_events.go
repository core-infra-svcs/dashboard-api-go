...
// InlineResponse20019Events struct for InlineResponse20019Events
type InlineResponse20019Events struct {
	...
	EventData *InlineResponse20019EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20019Events() *InlineResponse20019Events {
	this := InlineResponse20019Events{}
	return &this
}
...
func (o *InlineResponse20019Events) GetEventData() InlineResponse20019EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20019EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20019EventData and assigns it to the EventData field.
func (o *InlineResponse20019Events) SetEventData(v InlineResponse20019EventData) {
	o.EventData = &v
}

func (o InlineResponse20019Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20019Events struct {
	value *InlineResponse20019Events
	isSet bool
}

func (v NullableInlineResponse20019Events) Get() *InlineResponse20019Events {
	return v.value
}

func (v *NullableInlineResponse20019Events) Set(val *InlineResponse20019Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20019Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20019Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20019Events(val *InlineResponse20019Events) *NullableInlineResponse20019Events {
	return &NullableInlineResponse20019Events{value: val, isSet: true}
}

func (v NullableInlineResponse20019Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20019Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
