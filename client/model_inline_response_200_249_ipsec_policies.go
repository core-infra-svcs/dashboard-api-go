...
// InlineResponse200249IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200249IpsecPolicies struct {
...
func NewInlineResponse200249IpsecPolicies() *InlineResponse200249IpsecPolicies {
	this := InlineResponse200249IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200249IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200249IpsecPolicies struct {
	value *InlineResponse200249IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200249IpsecPolicies) Get() *InlineResponse200249IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200249IpsecPolicies) Set(val *InlineResponse200249IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200249IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200249IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200249IpsecPolicies(val *InlineResponse200249IpsecPolicies) *NullableInlineResponse200249IpsecPolicies {
	return &NullableInlineResponse200249IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200249IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200249IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
