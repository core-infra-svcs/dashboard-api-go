...
// InlineResponse20058Rules struct for InlineResponse20058Rules
type InlineResponse20058Rules struct {
...
func (o InlineResponse20058Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20058Rules struct {
	value *InlineResponse20058Rules
	isSet bool
}

func (v NullableInlineResponse20058Rules) Get() *InlineResponse20058Rules {
	return v.value
}

func (v *NullableInlineResponse20058Rules) Set(val *InlineResponse20058Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20058Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20058Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20058Rules(val *InlineResponse20058Rules) *NullableInlineResponse20058Rules {
	return &NullableInlineResponse20058Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20058Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20058Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
