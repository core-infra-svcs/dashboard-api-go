...
// InlineResponse200191Rules struct for InlineResponse200191Rules
type InlineResponse200191Rules struct {
...
func NewInlineResponse200191Rules() *InlineResponse200191Rules {
	this := InlineResponse200191Rules{}
	return &this
}
...
func (o InlineResponse200191Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200191Rules struct {
	value *InlineResponse200191Rules
	isSet bool
}

func (v NullableInlineResponse200191Rules) Get() *InlineResponse200191Rules {
	return v.value
}

func (v *NullableInlineResponse200191Rules) Set(val *InlineResponse200191Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200191Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200191Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200191Rules(val *InlineResponse200191Rules) *NullableInlineResponse200191Rules {
	return &NullableInlineResponse200191Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200191Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200191Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
