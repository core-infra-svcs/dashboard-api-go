...
// InlineResponse200248MetaCountsItems Count of eSIM Devices available
type InlineResponse200248MetaCountsItems struct {
...
func NewInlineResponse200248MetaCountsItems() *InlineResponse200248MetaCountsItems {
	this := InlineResponse200248MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200248MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200248MetaCountsItems struct {
	value *InlineResponse200248MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200248MetaCountsItems) Get() *InlineResponse200248MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200248MetaCountsItems) Set(val *InlineResponse200248MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200248MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200248MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200248MetaCountsItems(val *InlineResponse200248MetaCountsItems) *NullableInlineResponse200248MetaCountsItems {
	return &NullableInlineResponse200248MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200248MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200248MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
