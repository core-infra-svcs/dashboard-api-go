...
// InlineResponse200295MetaCountsItems Meta data of the items
type InlineResponse200295MetaCountsItems struct {
...
func NewInlineResponse200295MetaCountsItems() *InlineResponse200295MetaCountsItems {
	this := InlineResponse200295MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200295MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200295MetaCountsItems struct {
	value *InlineResponse200295MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200295MetaCountsItems) Get() *InlineResponse200295MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200295MetaCountsItems) Set(val *InlineResponse200295MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200295MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200295MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200295MetaCountsItems(val *InlineResponse200295MetaCountsItems) *NullableInlineResponse200295MetaCountsItems {
	return &NullableInlineResponse200295MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200295MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200295MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
