...
type InlineResponse200369Items struct {
	...
	Changes []InlineResponse200369Changes `json:"changes,omitempty"`
}
...
func (o *InlineResponse200369Items) GetChanges() []InlineResponse200369Changes {
	if o == nil || isNil(o.Changes) {
		var ret []InlineResponse200369Changes
		return ret
	}
	return o.Changes
}
...
// SetChanges gets a reference to the given []InlineResponse200369Changes and assigns it to the Changes field.
