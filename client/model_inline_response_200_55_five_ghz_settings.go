...
// InlineResponse20055FiveGhzSettings Settings related to 5Ghz band.
type InlineResponse20055FiveGhzSettings struct {
...
func NewInlineResponse20055FiveGhzSettings() *InlineResponse20055FiveGhzSettings {
	this := InlineResponse20055FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse20055FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20055FiveGhzSettings struct {
	value *InlineResponse20055FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse20055FiveGhzSettings) Get() *InlineResponse20055FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse20055FiveGhzSettings) Set(val *InlineResponse20055FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20055FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20055FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20055FiveGhzSettings(val *InlineResponse20055FiveGhzSettings) *NullableInlineResponse20055FiveGhzSettings {
	return &NullableInlineResponse20055FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20055FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20055FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
