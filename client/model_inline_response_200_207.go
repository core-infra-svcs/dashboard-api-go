...
type InlineResponse200207 struct {
	...
	MulticastToUnicastConversion *InlineResponse200207MulticastToUnicastConversion `json:"multicastToUnicastConversion,omitempty"`
	NamedVlans *InlineResponse200207NamedVlans `json:"namedVlans,omitempty"`
	RegulatoryDomain *InlineResponse200207RegulatoryDomain `json:"regulatoryDomain,omitempty"`
}
...
func (o *InlineResponse200207) GetMulticastToUnicastConversion() InlineResponse200207MulticastToUnicastConversion {
	if o == nil || isNil(o.MulticastToUnicastConversion) {
		var ret InlineResponse200207MulticastToUnicastConversion
		return ret
	}
...
// SetMulticastToUnicastConversion gets a reference to the given InlineResponse200207MulticastToUnicastConversion and assigns it to the MulticastToUnicastConversion field.
...
func (o *InlineResponse200207) GetNamedVlans() InlineResponse200207NamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret InlineResponse200207NamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given InlineResponse200207NamedVlans and assigns it to the NamedVlans field.
...
func (o *InlineResponse200207) GetRegulatoryDomain() InlineResponse200207RegulatoryDomain {
	if o == nil || isNil(o.RegulatoryDomain) {
		var ret InlineResponse200207RegulatoryDomain
		return ret
	}
...
// SetRegulatoryDomain gets a reference to the given InlineResponse200207RegulatoryDomain and assigns it to the RegulatoryDomain field.
