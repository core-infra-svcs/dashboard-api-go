...
// InlineResponse200224ByAlertType struct for InlineResponse200224ByAlertType
type InlineResponse200224ByAlertType struct {
	// Alert Type
...
func NewInlineResponse200224ByAlertType() *InlineResponse200224ByAlertType {
	this := InlineResponse200224ByAlertType{}
	return &this
}
...
func (o InlineResponse200224ByAlertType) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200224ByAlertType struct {
	value *InlineResponse200224ByAlertType
	isSet bool
}

func (v NullableInlineResponse200224ByAlertType) Get() *InlineResponse200224ByAlertType {
	return v.value
}

func (v *NullableInlineResponse200224ByAlertType) Set(val *InlineResponse200224ByAlertType) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200224ByAlertType) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200224ByAlertType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200224ByAlertType(val *InlineResponse200224ByAlertType) *NullableInlineResponse200224ByAlertType {
	return &NullableInlineResponse200224ByAlertType{value: val, isSet: true}
}

func (v NullableInlineResponse200224ByAlertType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200224ByAlertType) UnmarshalJSON(src []byte) error {
	v.isSet = true
