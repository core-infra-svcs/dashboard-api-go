...
// InlineResponse200198PerSsidSettings14 Settings for SSID 14
type InlineResponse200198PerSsidSettings14 struct {
	// Name of SSID
...
func NewInlineResponse200198PerSsidSettings14() *InlineResponse200198PerSsidSettings14 {
	this := InlineResponse200198PerSsidSettings14{}
	return &this
}
...
func (o InlineResponse200198PerSsidSettings14) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200198PerSsidSettings14 struct {
	value *InlineResponse200198PerSsidSettings14
	isSet bool
}

func (v NullableInlineResponse200198PerSsidSettings14) Get() *InlineResponse200198PerSsidSettings14 {
	return v.value
}

func (v *NullableInlineResponse200198PerSsidSettings14) Set(val *InlineResponse200198PerSsidSettings14) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200198PerSsidSettings14) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200198PerSsidSettings14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200198PerSsidSettings14(val *InlineResponse200198PerSsidSettings14) *NullableInlineResponse200198PerSsidSettings14 {
	return &NullableInlineResponse200198PerSsidSettings14{value: val, isSet: true}
}

func (v NullableInlineResponse200198PerSsidSettings14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200198PerSsidSettings14) UnmarshalJSON(src []byte) error {
	v.isSet = true
