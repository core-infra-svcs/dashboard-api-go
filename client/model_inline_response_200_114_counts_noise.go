...
// InlineResponse200114CountsNoise Object containing the number of sensors that are currently alerting due to noise readings
type InlineResponse200114CountsNoise struct {
...
func NewInlineResponse200114CountsNoise() *InlineResponse200114CountsNoise {
	this := InlineResponse200114CountsNoise{}
	return &this
}
...
func (o InlineResponse200114CountsNoise) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200114CountsNoise struct {
	value *InlineResponse200114CountsNoise
	isSet bool
}

func (v NullableInlineResponse200114CountsNoise) Get() *InlineResponse200114CountsNoise {
	return v.value
}

func (v *NullableInlineResponse200114CountsNoise) Set(val *InlineResponse200114CountsNoise) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200114CountsNoise) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200114CountsNoise) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200114CountsNoise(val *InlineResponse200114CountsNoise) *NullableInlineResponse200114CountsNoise {
	return &NullableInlineResponse200114CountsNoise{value: val, isSet: true}
}

func (v NullableInlineResponse200114CountsNoise) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200114CountsNoise) UnmarshalJSON(src []byte) error {
	v.isSet = true
