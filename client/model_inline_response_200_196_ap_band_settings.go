...
// InlineResponse200196ApBandSettings Settings that will be enabled if selectionType is set to 'ap'.
type InlineResponse200196ApBandSettings struct {
...
func NewInlineResponse200196ApBandSettings() *InlineResponse200196ApBandSettings {
	this := InlineResponse200196ApBandSettings{}
	return &this
}
...
func (o InlineResponse200196ApBandSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200196ApBandSettings struct {
	value *InlineResponse200196ApBandSettings
	isSet bool
}

func (v NullableInlineResponse200196ApBandSettings) Get() *InlineResponse200196ApBandSettings {
	return v.value
}

func (v *NullableInlineResponse200196ApBandSettings) Set(val *InlineResponse200196ApBandSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200196ApBandSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200196ApBandSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200196ApBandSettings(val *InlineResponse200196ApBandSettings) *NullableInlineResponse200196ApBandSettings {
	return &NullableInlineResponse200196ApBandSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200196ApBandSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200196ApBandSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
