...
`func NewInlineObject279(licenseId string, networkId string, seatCount int32, ) *InlineObject279`
...
`func (o *InlineObject279) GetNetworkId() string`

GetNetworkId returns the NetworkId field if non-nil, zero value otherwise.

### GetNetworkIdOk

`func (o *InlineObject279) GetNetworkIdOk() (*string, bool)`
...
`func (o *InlineObject279) SetNetworkId(v string)`
