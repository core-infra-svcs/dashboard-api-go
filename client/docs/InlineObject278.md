...
`func NewInlineObject278(destOrganizationId string, licenseIds []string, ) *InlineObject278`
...
`func (o *InlineObject278) GetLicenseIds() []string`

GetLicenseIds returns the LicenseIds field if non-nil, zero value otherwise.

### GetLicenseIdsOk

`func (o *InlineObject278) GetLicenseIdsOk() (*[]string, bool)`
...
`func (o *InlineObject278) SetLicenseIds(v []string)`
