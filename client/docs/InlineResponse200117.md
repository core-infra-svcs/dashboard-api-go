...
`func (o *InlineResponse200117) GetMqttBrokerId() string`

GetMqttBrokerId returns the MqttBrokerId field if non-nil, zero value otherwise.

### GetMqttBrokerIdOk

`func (o *InlineResponse200117) GetMqttBrokerIdOk() (*string, bool)`
...
`func (o *InlineResponse200117) SetMqttBrokerId(v string)`

SetMqttBrokerId sets MqttBrokerId field to given value.

### HasMqttBrokerId

`func (o *InlineResponse200117) HasMqttBrokerId() bool`
