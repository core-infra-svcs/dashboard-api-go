...
`func (o *InlineResponse200124) GetIds() []string`

GetIds returns the Ids field if non-nil, zero value otherwise.

### GetIdsOk

`func (o *InlineResponse200124) GetIdsOk() (*[]string, bool)`
...
`func (o *InlineResponse200124) SetIds(v []string)`

SetIds sets Ids field to given value.

### HasIds

`func (o *InlineResponse200124) HasIds() bool`

HasIds returns a boolean if a field has been set.

### GetNewNetwork

`func (o *InlineResponse200124) GetNewNetwork() string`

GetNewNetwork returns the NewNetwork field if non-nil, zero value otherwise.

### GetNewNetworkOk

`func (o *InlineResponse200124) GetNewNetworkOk() (*string, bool)`
...
`func (o *InlineResponse200124) SetNewNetwork(v string)`

SetNewNetwork sets NewNetwork field to given value.

### HasNewNetwork

`func (o *InlineResponse200124) HasNewNetwork() bool`
