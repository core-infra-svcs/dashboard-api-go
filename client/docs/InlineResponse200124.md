...
`func (o *InlineResponse200124) GetNotValidAfter() string`

GetNotValidAfter returns the NotValidAfter field if non-nil, zero value otherwise.

### GetNotValidAfterOk

`func (o *InlineResponse200124) GetNotValidAfterOk() (*string, bool)`
...
`func (o *InlineResponse200124) SetNotValidAfter(v string)`

SetNotValidAfter sets NotValidAfter field to given value.

### HasNotValidAfter

`func (o *InlineResponse200124) HasNotValidAfter() bool`

HasNotValidAfter returns a boolean if a field has been set.

### GetNotValidBefore

`func (o *InlineResponse200124) GetNotValidBefore() string`

GetNotValidBefore returns the NotValidBefore field if non-nil, zero value otherwise.

### GetNotValidBeforeOk

`func (o *InlineResponse200124) GetNotValidBeforeOk() (*string, bool)`
...
`func (o *InlineResponse200124) SetNotValidBefore(v string)`

SetNotValidBefore sets NotValidBefore field to given value.

### HasNotValidBefore

`func (o *InlineResponse200124) HasNotValidBefore() bool`

HasNotValidBefore returns a boolean if a field has been set.

### GetCertPem

`func (o *InlineResponse200124) GetCertPem() string`

GetCertPem returns the CertPem field if non-nil, zero value otherwise.

### GetCertPemOk

`func (o *InlineResponse200124) GetCertPemOk() (*string, bool)`
...
`func (o *InlineResponse200124) SetCertPem(v string)`

SetCertPem sets CertPem field to given value.

### HasCertPem

`func (o *InlineResponse200124) HasCertPem() bool`

HasCertPem returns a boolean if a field has been set.

### GetDeviceId

`func (o *InlineResponse200124) GetDeviceId() string`

GetDeviceId returns the DeviceId field if non-nil, zero value otherwise.

### GetDeviceIdOk

`func (o *InlineResponse200124) GetDeviceIdOk() (*string, bool)`
...
`func (o *InlineResponse200124) SetDeviceId(v string)`

SetDeviceId sets DeviceId field to given value.

### HasDeviceId

`func (o *InlineResponse200124) HasDeviceId() bool`

HasDeviceId returns a boolean if a field has been set.

### GetIssuer

`func (o *InlineResponse200124) GetIssuer() string`

GetIssuer returns the Issuer field if non-nil, zero value otherwise.

### GetIssuerOk

`func (o *InlineResponse200124) GetIssuerOk() (*string, bool)`
...
`func (o *InlineResponse200124) SetIssuer(v string)`

SetIssuer sets Issuer field to given value.

### HasIssuer

`func (o *InlineResponse200124) HasIssuer() bool`

HasIssuer returns a boolean if a field has been set.

### GetSubject

`func (o *InlineResponse200124) GetSubject() string`

GetSubject returns the Subject field if non-nil, zero value otherwise.

### GetSubjectOk

`func (o *InlineResponse200124) GetSubjectOk() (*string, bool)`
...
`func (o *InlineResponse200124) SetSubject(v string)`

SetSubject sets Subject field to given value.

### HasSubject

`func (o *InlineResponse200124) HasSubject() bool`
