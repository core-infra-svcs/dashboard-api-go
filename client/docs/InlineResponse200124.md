...
`func (o *InlineResponse200124) GetIsEncrypted() bool`

GetIsEncrypted returns the IsEncrypted field if non-nil, zero value otherwise.

### GetIsEncryptedOk

`func (o *InlineResponse200124) GetIsEncryptedOk() (*bool, bool)`
...
`func (o *InlineResponse200124) SetIsEncrypted(v bool)`

SetIsEncrypted sets IsEncrypted field to given value.

### HasIsEncrypted

`func (o *InlineResponse200124) HasIsEncrypted() bool`

HasIsEncrypted returns a boolean if a field has been set.

### GetIsManaged

`func (o *InlineResponse200124) GetIsManaged() bool`

GetIsManaged returns the IsManaged field if non-nil, zero value otherwise.

### GetIsManagedOk

`func (o *InlineResponse200124) GetIsManagedOk() (*bool, bool)`
...
`func (o *InlineResponse200124) SetIsManaged(v bool)`

SetIsManaged sets IsManaged field to given value.

### HasIsManaged

`func (o *InlineResponse200124) HasIsManaged() bool`

HasIsManaged returns a boolean if a field has been set.

### GetProfileData

`func (o *InlineResponse200124) GetProfileData() string`

GetProfileData returns the ProfileData field if non-nil, zero value otherwise.

### GetProfileDataOk

`func (o *InlineResponse200124) GetProfileDataOk() (*string, bool)`
...
`func (o *InlineResponse200124) SetProfileIdentifier(v string)`

SetProfileIdentifier sets ProfileIdentifier field to given value.

### HasProfileIdentifier

`func (o *InlineResponse200124) HasProfileIdentifier() bool`
...
`func (o *InlineResponse200124) GetVersion() string`

GetVersion returns the Version field if non-nil, zero value otherwise.

### GetVersionOk

`func (o *InlineResponse200124) GetVersionOk() (*string, bool)`
...
`func (o *InlineResponse200124) SetVersion(v string)`
