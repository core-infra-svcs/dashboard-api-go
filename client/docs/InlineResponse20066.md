...
`func (o *InlineResponse20066) GetSystemType() string`

GetSystemType returns the SystemType field if non-nil, zero value otherwise.

### GetSystemTypeOk

`func (o *InlineResponse20066) GetSystemTypeOk() (*string, bool)`
...
`func (o *InlineResponse20066) SetSystemType(v string)`

SetSystemType sets SystemType field to given value.

### HasSystemType

`func (o *InlineResponse20066) HasSystemType() bool`
...
`func (o *InlineResponse20066) GetUsername() string`

GetUsername returns the Username field if non-nil, zero value otherwise.

### GetUsernameOk

`func (o *InlineResponse20066) GetUsernameOk() (*string, bool)`
...
`func (o *InlineResponse20066) SetUsername(v string)`

SetUsername sets Username field to given value.

### HasUsername

`func (o *InlineResponse20066) HasUsername() bool`

HasUsername returns a boolean if a field has been set.

### GetEmail

`func (o *InlineResponse20066) GetEmail() string`

GetEmail returns the Email field if non-nil, zero value otherwise.

### GetEmailOk

`func (o *InlineResponse20066) GetEmailOk() (*string, bool)`
...
`func (o *InlineResponse20066) SetEmail(v string)`

SetEmail sets Email field to given value.

### HasEmail

`func (o *InlineResponse20066) HasEmail() bool`

HasEmail returns a boolean if a field has been set.

### GetTags

`func (o *InlineResponse20066) GetTags() []string`

GetTags returns the Tags field if non-nil, zero value otherwise.

### GetTagsOk

`func (o *InlineResponse20066) GetTagsOk() (*[]string, bool)`
...
`func (o *InlineResponse20066) SetTags(v []string)`

SetTags sets Tags field to given value.

### HasTags

`func (o *InlineResponse20066) HasTags() bool`

HasTags returns a boolean if a field has been set.

### GetTrustedAccessConnections

`func (o *InlineResponse20066) GetTrustedAccessConnections() []NetworksNetworkIdSmUserAccessDevicesTrustedAccessConnections`
...
`func (o *InlineResponse20066) GetTrustedAccessConnectionsOk() (*[]NetworksNetworkIdSmUserAccessDevicesTrustedAccessConnections, bool)`
...
`func (o *InlineResponse20066) SetTrustedAccessConnections(v []NetworksNetworkIdSmUserAccessDevicesTrustedAccessConnections)`

SetTrustedAccessConnections sets TrustedAccessConnections field to given value.

### HasTrustedAccessConnections

`func (o *InlineResponse20066) HasTrustedAccessConnections() bool`
