...
`func (o *InlineResponse200137) GetDescription() string`

GetDescription returns the Description field if non-nil, zero value otherwise.

### GetDescriptionOk

`func (o *InlineResponse200137) GetDescriptionOk() (*string, bool)`
...
`func (o *InlineResponse200137) SetDescription(v string)`

SetDescription sets Description field to given value.

### HasDescription

`func (o *InlineResponse200137) HasDescription() bool`
...
`func (o *InlineResponse200137) GetPayloadTypes() []string`

GetPayloadTypes returns the PayloadTypes field if non-nil, zero value otherwise.

### GetPayloadTypesOk

`func (o *InlineResponse200137) GetPayloadTypesOk() (*[]string, bool)`
...
`func (o *InlineResponse200137) SetPayloadTypes(v []string)`

SetPayloadTypes sets PayloadTypes field to given value.

### HasPayloadTypes

`func (o *InlineResponse200137) HasPayloadTypes() bool`
