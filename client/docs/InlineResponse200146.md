...
`func (o *InlineResponse200146) GetDeviceId() string`

GetDeviceId returns the DeviceId field if non-nil, zero value otherwise.

### GetDeviceIdOk

`func (o *InlineResponse200146) GetDeviceIdOk() (*string, bool)`
...
`func (o *InlineResponse200146) SetDeviceId(v string)`

SetDeviceId sets DeviceId field to given value.

### HasDeviceId

`func (o *InlineResponse200146) HasDeviceId() bool`
...
`func (o *InlineResponse200146) GetIsEncrypted() bool`

GetIsEncrypted returns the IsEncrypted field if non-nil, zero value otherwise.

### GetIsEncryptedOk

`func (o *InlineResponse200146) GetIsEncryptedOk() (*bool, bool)`
...
`func (o *InlineResponse200146) SetIsEncrypted(v bool)`

SetIsEncrypted sets IsEncrypted field to given value.

### HasIsEncrypted

`func (o *InlineResponse200146) HasIsEncrypted() bool`

HasIsEncrypted returns a boolean if a field has been set.

### GetIsManaged

`func (o *InlineResponse200146) GetIsManaged() bool`

GetIsManaged returns the IsManaged field if non-nil, zero value otherwise.

### GetIsManagedOk

`func (o *InlineResponse200146) GetIsManagedOk() (*bool, bool)`
...
`func (o *InlineResponse200146) SetIsManaged(v bool)`

SetIsManaged sets IsManaged field to given value.

### HasIsManaged

`func (o *InlineResponse200146) HasIsManaged() bool`

HasIsManaged returns a boolean if a field has been set.

### GetProfileData

`func (o *InlineResponse200146) GetProfileData() string`

GetProfileData returns the ProfileData field if non-nil, zero value otherwise.

### GetProfileDataOk

`func (o *InlineResponse200146) GetProfileDataOk() (*string, bool)`
...
`func (o *InlineResponse200146) SetProfileIdentifier(v string)`

SetProfileIdentifier sets ProfileIdentifier field to given value.

### HasProfileIdentifier

`func (o *InlineResponse200146) HasProfileIdentifier() bool`
...
`func (o *InlineResponse200146) GetVersion() string`

GetVersion returns the Version field if non-nil, zero value otherwise.

### GetVersionOk

`func (o *InlineResponse200146) GetVersionOk() (*string, bool)`
...
`func (o *InlineResponse200146) SetVersion(v string)`

SetVersion sets Version field to given value.

### HasVersion

`func (o *InlineResponse200146) HasVersion() bool`
