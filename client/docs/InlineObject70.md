...
`func NewInlineObject70(id string, name string, ) *InlineObject70`
...
`func (o *InlineObject70) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *InlineObject70) GetIdOk() (*string, bool)`
...
`func (o *InlineObject70) SetId(v string)`
