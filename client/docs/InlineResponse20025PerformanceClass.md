# InlineResponse20025PerformanceClass
...
### NewInlineResponse20025PerformanceClass

`func NewInlineResponse20025PerformanceClass(type_ string, ) *InlineResponse20025PerformanceClass`

NewInlineResponse20025PerformanceClass instantiates a new InlineResponse20025PerformanceClass object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewInlineResponse20025PerformanceClassWithDefaults

`func NewInlineResponse20025PerformanceClassWithDefaults() *InlineResponse20025PerformanceClass`

NewInlineResponse20025PerformanceClassWithDefaults instantiates a new InlineResponse20025PerformanceClass object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetType

`func (o *InlineResponse20025PerformanceClass) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InlineResponse20025PerformanceClass) GetTypeOk() (*string, bool)`
...
`func (o *InlineResponse20025PerformanceClass) SetType(v string)`
...
`func (o *InlineResponse20025PerformanceClass) GetBuiltinPerformanceClassName() string`
...
`func (o *InlineResponse20025PerformanceClass) GetBuiltinPerformanceClassNameOk() (*string, bool)`
...
`func (o *InlineResponse20025PerformanceClass) SetBuiltinPerformanceClassName(v string)`

SetBuiltinPerformanceClassName sets BuiltinPerformanceClassName field to given value.

### HasBuiltinPerformanceClassName

`func (o *InlineResponse20025PerformanceClass) HasBuiltinPerformanceClassName() bool`

HasBuiltinPerformanceClassName returns a boolean if a field has been set.

### GetCustomPerformanceClassId

`func (o *InlineResponse20025PerformanceClass) GetCustomPerformanceClassId() string`
...
`func (o *InlineResponse20025PerformanceClass) GetCustomPerformanceClassIdOk() (*string, bool)`
...
`func (o *InlineResponse20025PerformanceClass) SetCustomPerformanceClassId(v string)`

SetCustomPerformanceClassId sets CustomPerformanceClassId field to given value.

### HasCustomPerformanceClassId

`func (o *InlineResponse20025PerformanceClass) HasCustomPerformanceClassId() bool`
