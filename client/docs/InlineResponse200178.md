...
`func (o *InlineResponse200178) GetSsidNumber() int32`

GetSsidNumber returns the SsidNumber field if non-nil, zero value otherwise.

### GetSsidNumberOk

`func (o *InlineResponse200178) GetSsidNumberOk() (*int32, bool)`
...
`func (o *InlineResponse200178) SetSsidNumber(v int32)`

SetSsidNumber sets SsidNumber field to given value.

### HasSsidNumber

`func (o *InlineResponse200178) HasSsidNumber() bool`
...
`func (o *InlineResponse200178) GetClientMac() string`

GetClientMac returns the ClientMac field if non-nil, zero value otherwise.

### GetClientMacOk

`func (o *InlineResponse200178) GetClientMacOk() (*string, bool)`
...
`func (o *InlineResponse200178) SetClientMac(v string)`

SetClientMac sets ClientMac field to given value.

### HasClientMac

`func (o *InlineResponse200178) HasClientMac() bool`
...
`func (o *InlineResponse200178) GetFailureStep() string`

GetFailureStep returns the FailureStep field if non-nil, zero value otherwise.

### GetFailureStepOk

`func (o *InlineResponse200178) GetFailureStepOk() (*string, bool)`
...
`func (o *InlineResponse200178) SetFailureStep(v string)`

SetFailureStep sets FailureStep field to given value.

### HasFailureStep

`func (o *InlineResponse200178) HasFailureStep() bool`
...
`func (o *InlineResponse200178) GetTs() time.Time`

GetTs returns the Ts field if non-nil, zero value otherwise.

### GetTsOk

`func (o *InlineResponse200178) GetTsOk() (*time.Time, bool)`
...
`func (o *InlineResponse200178) SetTs(v time.Time)`

SetTs sets Ts field to given value.

### HasTs

`func (o *InlineResponse200178) HasTs() bool`
