...
`func NewInlineObject129(newNetwork string, ) *InlineObject129`
...
`func (o *InlineObject129) GetNewNetwork() string`

GetNewNetwork returns the NewNetwork field if non-nil, zero value otherwise.

### GetNewNetworkOk

`func (o *InlineObject129) GetNewNetworkOk() (*string, bool)`
...
`func (o *InlineObject129) SetNewNetwork(v string)`
