...
------------ | ------------- | ------------- | -------------
**Contents** | Pointer to **NullableString** | The contents of the Client CA Certificate. Must be in PEM or DER format. | [optional] 
...
`func (o *NetworksNetworkIdWirelessSsidsNumberLocalRadiusCertificateAuthenticationClientRootCaCertificate) SetContentsNil(b bool)`

 SetContentsNil sets the value for Contents to be an explicit nil

### UnsetContents
`func (o *NetworksNetworkIdWirelessSsidsNumberLocalRadiusCertificateAuthenticationClientRootCaCertificate) UnsetContents()`
