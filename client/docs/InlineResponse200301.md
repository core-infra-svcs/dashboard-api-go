...
`func (o *InlineResponse200301) GetClaimedAt() time.Time`

GetClaimedAt returns the ClaimedAt field if non-nil, zero value otherwise.

### GetClaimedAtOk

`func (o *InlineResponse200301) GetClaimedAtOk() (*time.Time, bool)`
...
`func (o *InlineResponse200301) SetClaimedAt(v time.Time)`

SetClaimedAt sets ClaimedAt field to given value.

### HasClaimedAt

`func (o *InlineResponse200301) HasClaimedAt() bool`

HasClaimedAt returns a boolean if a field has been set.

### GetLicenseExpirationDate

`func (o *InlineResponse200301) GetLicenseExpirationDate() time.Time`
...
`func (o *InlineResponse200301) GetLicenseExpirationDateOk() (*time.Time, bool)`
...
`func (o *InlineResponse200301) SetLicenseExpirationDate(v time.Time)`

SetLicenseExpirationDate sets LicenseExpirationDate field to given value.

### HasLicenseExpirationDate

`func (o *InlineResponse200301) HasLicenseExpirationDate() bool`
...
`func (o *InlineResponse200301) GetCountryCode() string`

GetCountryCode returns the CountryCode field if non-nil, zero value otherwise.

### GetCountryCodeOk

`func (o *InlineResponse200301) GetCountryCodeOk() (*string, bool)`
...
`func (o *InlineResponse200301) SetCountryCode(v string)`

SetCountryCode sets CountryCode field to given value.

### HasCountryCode

`func (o *InlineResponse200301) HasCountryCode() bool`

HasCountryCode returns a boolean if a field has been set.

### GetDetails

`func (o *InlineResponse200301) GetDetails() []InlineResponse2006Details`

GetDetails returns the Details field if non-nil, zero value otherwise.

### GetDetailsOk

`func (o *InlineResponse200301) GetDetailsOk() (*[]InlineResponse2006Details, bool)`
...
`func (o *InlineResponse200301) SetDetails(v []InlineResponse2006Details)`

SetDetails sets Details field to given value.

### HasDetails

`func (o *InlineResponse200301) HasDetails() bool`
