# InlineResponse20065PerformanceClass
...
### NewInlineResponse20065PerformanceClass

`func NewInlineResponse20065PerformanceClass(type_ string, ) *InlineResponse20065PerformanceClass`

NewInlineResponse20065PerformanceClass instantiates a new InlineResponse20065PerformanceClass object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewInlineResponse20065PerformanceClassWithDefaults

`func NewInlineResponse20065PerformanceClassWithDefaults() *InlineResponse20065PerformanceClass`

NewInlineResponse20065PerformanceClassWithDefaults instantiates a new InlineResponse20065PerformanceClass object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetType

`func (o *InlineResponse20065PerformanceClass) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InlineResponse20065PerformanceClass) GetTypeOk() (*string, bool)`
...
`func (o *InlineResponse20065PerformanceClass) SetType(v string)`
...
`func (o *InlineResponse20065PerformanceClass) GetBuiltinPerformanceClassName() string`
...
`func (o *InlineResponse20065PerformanceClass) GetBuiltinPerformanceClassNameOk() (*string, bool)`
...
`func (o *InlineResponse20065PerformanceClass) SetBuiltinPerformanceClassName(v string)`

SetBuiltinPerformanceClassName sets BuiltinPerformanceClassName field to given value.

### HasBuiltinPerformanceClassName

`func (o *InlineResponse20065PerformanceClass) HasBuiltinPerformanceClassName() bool`

HasBuiltinPerformanceClassName returns a boolean if a field has been set.

### GetCustomPerformanceClassId

`func (o *InlineResponse20065PerformanceClass) GetCustomPerformanceClassId() string`
...
`func (o *InlineResponse20065PerformanceClass) GetCustomPerformanceClassIdOk() (*string, bool)`
...
`func (o *InlineResponse20065PerformanceClass) SetCustomPerformanceClassId(v string)`

SetCustomPerformanceClassId sets CustomPerformanceClassId field to given value.

### HasCustomPerformanceClassId

`func (o *InlineResponse20065PerformanceClass) HasCustomPerformanceClassId() bool`
