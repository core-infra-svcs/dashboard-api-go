...
`func NewInlineObject173(name string, vlanNames []NetworksNetworkIdVlanProfilesVlanNames1, vlanGroups []NetworksNetworkIdVlanProfilesVlanGroups1, iname string, ) *InlineObject173`
...
`func (o *InlineObject173) GetIname() string`

GetIname returns the Iname field if non-nil, zero value otherwise.

### GetInameOk

`func (o *InlineObject173) GetInameOk() (*string, bool)`
...
`func (o *InlineObject173) SetIname(v string)`
