...
`func NewInlineObject130(newNetwork string, ) *InlineObject130`
...
`func (o *InlineObject130) GetNewNetwork() string`

GetNewNetwork returns the NewNetwork field if non-nil, zero value otherwise.

### GetNewNetworkOk

`func (o *InlineObject130) GetNewNetworkOk() (*string, bool)`
...
`func (o *InlineObject130) SetNewNetwork(v string)`
