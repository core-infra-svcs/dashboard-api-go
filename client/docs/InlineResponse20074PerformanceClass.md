# InlineResponse20074PerformanceClass
...
### NewInlineResponse20074PerformanceClass

`func NewInlineResponse20074PerformanceClass(type_ string, ) *InlineResponse20074PerformanceClass`

NewInlineResponse20074PerformanceClass instantiates a new InlineResponse20074PerformanceClass object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewInlineResponse20074PerformanceClassWithDefaults

`func NewInlineResponse20074PerformanceClassWithDefaults() *InlineResponse20074PerformanceClass`

NewInlineResponse20074PerformanceClassWithDefaults instantiates a new InlineResponse20074PerformanceClass object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetType

`func (o *InlineResponse20074PerformanceClass) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InlineResponse20074PerformanceClass) GetTypeOk() (*string, bool)`
...
`func (o *InlineResponse20074PerformanceClass) SetType(v string)`
...
`func (o *InlineResponse20074PerformanceClass) GetBuiltinPerformanceClassName() string`
...
`func (o *InlineResponse20074PerformanceClass) GetBuiltinPerformanceClassNameOk() (*string, bool)`
...
`func (o *InlineResponse20074PerformanceClass) SetBuiltinPerformanceClassName(v string)`

SetBuiltinPerformanceClassName sets BuiltinPerformanceClassName field to given value.

### HasBuiltinPerformanceClassName

`func (o *InlineResponse20074PerformanceClass) HasBuiltinPerformanceClassName() bool`

HasBuiltinPerformanceClassName returns a boolean if a field has been set.

### GetCustomPerformanceClassId

`func (o *InlineResponse20074PerformanceClass) GetCustomPerformanceClassId() string`
...
`func (o *InlineResponse20074PerformanceClass) GetCustomPerformanceClassIdOk() (*string, bool)`
...
`func (o *InlineResponse20074PerformanceClass) SetCustomPerformanceClassId(v string)`

SetCustomPerformanceClassId sets CustomPerformanceClassId field to given value.

### HasCustomPerformanceClassId

`func (o *InlineResponse20074PerformanceClass) HasCustomPerformanceClassId() bool`
