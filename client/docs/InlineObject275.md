...
`func NewInlineObject275(logEvent string, timestamp int32, ) *InlineObject275`
...
`func (o *InlineObject275) GetLogEvent() string`

GetLogEvent returns the LogEvent field if non-nil, zero value otherwise.

### GetLogEventOk

`func (o *InlineObject275) GetLogEventOk() (*string, bool)`
...
`func (o *InlineObject275) SetLogEvent(v string)`
...
`func (o *InlineObject275) GetTimestamp() int32`

GetTimestamp returns the Timestamp field if non-nil, zero value otherwise.

### GetTimestampOk

`func (o *InlineObject275) GetTimestampOk() (*int32, bool)`
...
`func (o *InlineObject275) SetTimestamp(v int32)`
...
`func (o *InlineObject275) GetTargetOS() string`

GetTargetOS returns the TargetOS field if non-nil, zero value otherwise.

### GetTargetOSOk

`func (o *InlineObject275) GetTargetOSOk() (*string, bool)`
...
`func (o *InlineObject275) SetTargetOS(v string)`

SetTargetOS sets TargetOS field to given value.

### HasTargetOS

`func (o *InlineObject275) HasTargetOS() bool`

HasTargetOS returns a boolean if a field has been set.

### GetRequest

`func (o *InlineObject275) GetRequest() string`

GetRequest returns the Request field if non-nil, zero value otherwise.

### GetRequestOk

`func (o *InlineObject275) GetRequestOk() (*string, bool)`
...
`func (o *InlineObject275) SetRequest(v string)`

SetRequest sets Request field to given value.

### HasRequest

`func (o *InlineObject275) HasRequest() bool`
