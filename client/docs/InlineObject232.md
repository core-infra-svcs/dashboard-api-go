...
`func (o *InlineObject232) GetDeviceSerial() string`

GetDeviceSerial returns the DeviceSerial field if non-nil, zero value otherwise.

### GetDeviceSerialOk

`func (o *InlineObject232) GetDeviceSerialOk() (*string, bool)`
...
`func (o *InlineObject232) SetDeviceSerial(v string)`

SetDeviceSerial sets DeviceSerial field to given value.

### HasDeviceSerial

`func (o *InlineObject232) HasDeviceSerial() bool`
