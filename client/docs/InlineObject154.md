...
`func (o *InlineObject154) SetVlanNil(b bool)`

 SetVlanNil sets the value for Vlan to be an explicit nil

### UnsetVlan
`func (o *InlineObject154) UnsetVlan()`

UnsetVlan ensures that no value is present for Vlan, not even an explicit nil
### GetProtocol

`func (o *InlineObject154) GetProtocol() string`

GetProtocol returns the Protocol field if non-nil, zero value otherwise.

### GetProtocolOk

`func (o *InlineObject154) GetProtocolOk() (*string, bool)`
...
`func (o *InlineObject154) SetProtocol(v string)`

SetProtocol sets Protocol field to given value.

### HasProtocol

`func (o *InlineObject154) HasProtocol() bool`

HasProtocol returns a boolean if a field has been set.

### GetSrcPort

`func (o *InlineObject154) GetSrcPort() int32`

GetSrcPort returns the SrcPort field if non-nil, zero value otherwise.

### GetSrcPortOk

`func (o *InlineObject154) GetSrcPortOk() (*int32, bool)`
...
`func (o *InlineObject154) SetSrcPort(v int32)`

SetSrcPort sets SrcPort field to given value.

### HasSrcPort

`func (o *InlineObject154) HasSrcPort() bool`

HasSrcPort returns a boolean if a field has been set.

### SetSrcPortNil

`func (o *InlineObject154) SetSrcPortNil(b bool)`

 SetSrcPortNil sets the value for SrcPort to be an explicit nil

### UnsetSrcPort
`func (o *InlineObject154) UnsetSrcPort()`

UnsetSrcPort ensures that no value is present for SrcPort, not even an explicit nil
### GetSrcPortRange

`func (o *InlineObject154) GetSrcPortRange() string`

GetSrcPortRange returns the SrcPortRange field if non-nil, zero value otherwise.

### GetSrcPortRangeOk

`func (o *InlineObject154) GetSrcPortRangeOk() (*string, bool)`
...
`func (o *InlineObject154) SetSrcPortRange(v string)`

SetSrcPortRange sets SrcPortRange field to given value.

### HasSrcPortRange

`func (o *InlineObject154) HasSrcPortRange() bool`

HasSrcPortRange returns a boolean if a field has been set.

### GetDstPort

`func (o *InlineObject154) GetDstPort() int32`

GetDstPort returns the DstPort field if non-nil, zero value otherwise.

### GetDstPortOk

`func (o *InlineObject154) GetDstPortOk() (*int32, bool)`
...
`func (o *InlineObject154) SetDstPort(v int32)`

SetDstPort sets DstPort field to given value.

### HasDstPort

`func (o *InlineObject154) HasDstPort() bool`

HasDstPort returns a boolean if a field has been set.

### SetDstPortNil

`func (o *InlineObject154) SetDstPortNil(b bool)`

 SetDstPortNil sets the value for DstPort to be an explicit nil

### UnsetDstPort
`func (o *InlineObject154) UnsetDstPort()`

UnsetDstPort ensures that no value is present for DstPort, not even an explicit nil
### GetDstPortRange

`func (o *InlineObject154) GetDstPortRange() string`

GetDstPortRange returns the DstPortRange field if non-nil, zero value otherwise.

### GetDstPortRangeOk

`func (o *InlineObject154) GetDstPortRangeOk() (*string, bool)`
...
`func (o *InlineObject154) SetDstPortRange(v string)`

SetDstPortRange sets DstPortRange field to given value.

### HasDstPortRange

`func (o *InlineObject154) HasDstPortRange() bool`

HasDstPortRange returns a boolean if a field has been set.

### GetDscp

`func (o *InlineObject154) GetDscp() int32`

GetDscp returns the Dscp field if non-nil, zero value otherwise.

### GetDscpOk

`func (o *InlineObject154) GetDscpOk() (*int32, bool)`
...
`func (o *InlineObject154) SetDscp(v int32)`

SetDscp sets Dscp field to given value.

### HasDscp

`func (o *InlineObject154) HasDscp() bool`
