...
`func (o *InlineObject305) GetName() string`

GetName returns the Name field if non-nil, zero value otherwise.

### GetNameOk

`func (o *InlineObject305) GetNameOk() (*string, bool)`
...
`func (o *InlineObject305) SetName(v string)`

SetName sets Name field to given value.

### HasName

`func (o *InlineObject305) HasName() bool`

HasName returns a boolean if a field has been set.

### GetBaseTheme

`func (o *InlineObject305) GetBaseTheme() string`

GetBaseTheme returns the BaseTheme field if non-nil, zero value otherwise.

### GetBaseThemeOk

`func (o *InlineObject305) GetBaseThemeOk() (*string, bool)`
...
`func (o *InlineObject305) SetBaseTheme(v string)`

SetBaseTheme sets BaseTheme field to given value.

### HasBaseTheme

`func (o *InlineObject305) HasBaseTheme() bool`
