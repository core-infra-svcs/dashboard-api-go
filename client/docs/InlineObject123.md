...
`func NewInlineObject123(tags []string, updateAction string, ) *InlineObject123`
...
`func (o *InlineObject123) GetWifiMacs() []string`

GetWifiMacs returns the WifiMacs field if non-nil, zero value otherwise.

### GetWifiMacsOk

`func (o *InlineObject123) GetWifiMacsOk() (*[]string, bool)`
...
`func (o *InlineObject123) SetWifiMacs(v []string)`

SetWifiMacs sets WifiMacs field to given value.

### HasWifiMacs

`func (o *InlineObject123) HasWifiMacs() bool`
...
`func (o *InlineObject123) HasIds() bool`

HasIds returns a boolean if a field has been set.

### GetSerials

`func (o *InlineObject123) GetSerials() []string`

GetSerials returns the Serials field if non-nil, zero value otherwise.

### GetSerialsOk

`func (o *InlineObject123) GetSerialsOk() (*[]string, bool)`
...
`func (o *InlineObject123) SetSerials(v []string)`

SetSerials sets Serials field to given value.

### HasSerials

`func (o *InlineObject123) HasSerials() bool`
...
`func (o *InlineObject123) GetTags() []string`

GetTags returns the Tags field if non-nil, zero value otherwise.

### GetTagsOk

`func (o *InlineObject123) GetTagsOk() (*[]string, bool)`
...
`func (o *InlineObject123) SetTags(v []string)`
...
`func (o *InlineObject123) GetUpdateAction() string`

GetUpdateAction returns the UpdateAction field if non-nil, zero value otherwise.

### GetUpdateActionOk

`func (o *InlineObject123) GetUpdateActionOk() (*string, bool)`
...
`func (o *InlineObject123) SetUpdateAction(v string)`
