...
`func NewInlineObject123(newNetwork string, ) *InlineObject123`
...
`func (o *InlineObject123) GetNewNetwork() string`

GetNewNetwork returns the NewNetwork field if non-nil, zero value otherwise.

### GetNewNetworkOk

`func (o *InlineObject123) GetNewNetworkOk() (*string, bool)`
...
`func (o *InlineObject123) SetNewNetwork(v string)`
