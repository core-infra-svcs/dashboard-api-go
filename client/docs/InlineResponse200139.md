...
`func (o *InlineResponse200139) GetSystemType() string`

GetSystemType returns the SystemType field if non-nil, zero value otherwise.

### GetSystemTypeOk

`func (o *InlineResponse200139) GetSystemTypeOk() (*string, bool)`
...
`func (o *InlineResponse200139) SetSystemType(v string)`

SetSystemType sets SystemType field to given value.

### HasSystemType

`func (o *InlineResponse200139) HasSystemType() bool`
...
`func (o *InlineResponse200139) GetUsername() string`

GetUsername returns the Username field if non-nil, zero value otherwise.

### GetUsernameOk

`func (o *InlineResponse200139) GetUsernameOk() (*string, bool)`
...
`func (o *InlineResponse200139) SetUsername(v string)`

SetUsername sets Username field to given value.

### HasUsername

`func (o *InlineResponse200139) HasUsername() bool`

HasUsername returns a boolean if a field has been set.

### GetEmail

`func (o *InlineResponse200139) GetEmail() string`

GetEmail returns the Email field if non-nil, zero value otherwise.

### GetEmailOk

`func (o *InlineResponse200139) GetEmailOk() (*string, bool)`
...
`func (o *InlineResponse200139) SetEmail(v string)`

SetEmail sets Email field to given value.

### HasEmail

`func (o *InlineResponse200139) HasEmail() bool`
...
`func (o *InlineResponse200139) GetTrustedAccessConnections() []NetworksNetworkIdSmUserAccessDevicesTrustedAccessConnections`
...
`func (o *InlineResponse200139) GetTrustedAccessConnectionsOk() (*[]NetworksNetworkIdSmUserAccessDevicesTrustedAccessConnections, bool)`
...
`func (o *InlineResponse200139) SetTrustedAccessConnections(v []NetworksNetworkIdSmUserAccessDevicesTrustedAccessConnections)`

SetTrustedAccessConnections sets TrustedAccessConnections field to given value.

### HasTrustedAccessConnections

`func (o *InlineResponse200139) HasTrustedAccessConnections() bool`
