...
`func NewInlineObject240(name string, networkIds []string, ) *InlineObject240`
...
`func (o *InlineObject240) GetNetworkIds() []string`

GetNetworkIds returns the NetworkIds field if non-nil, zero value otherwise.

### GetNetworkIdsOk

`func (o *InlineObject240) GetNetworkIdsOk() (*[]string, bool)`
...
`func (o *InlineObject240) SetNetworkIds(v []string)`
...
`func (o *InlineObject240) GetEnrollmentString() string`

GetEnrollmentString returns the EnrollmentString field if non-nil, zero value otherwise.

### GetEnrollmentStringOk

`func (o *InlineObject240) GetEnrollmentStringOk() (*string, bool)`
...
`func (o *InlineObject240) SetEnrollmentString(v string)`

SetEnrollmentString sets EnrollmentString field to given value.

### HasEnrollmentString

`func (o *InlineObject240) HasEnrollmentString() bool`
