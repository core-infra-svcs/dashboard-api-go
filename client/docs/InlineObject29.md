...
`func NewInlineObject29(access string, ) *InlineObject29`
...
`func (o *InlineObject29) GetAccess() string`

GetAccess returns the Access field if non-nil, zero value otherwise.

### GetAccessOk

`func (o *InlineObject29) GetAccessOk() (*string, bool)`
...
`func (o *InlineObject29) SetAccess(v string)`
...
`func (o *InlineObject29) GetAllowedIps() []string`

GetAllowedIps returns the AllowedIps field if non-nil, zero value otherwise.

### GetAllowedIpsOk

`func (o *InlineObject29) GetAllowedIpsOk() (*[]string, bool)`
...
`func (o *InlineObject29) SetAllowedIps(v []string)`

SetAllowedIps sets AllowedIps field to given value.

### HasAllowedIps

`func (o *InlineObject29) HasAllowedIps() bool`
