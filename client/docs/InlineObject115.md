...
`func (o *InlineObject115) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InlineObject115) GetTypeOk() (*string, bool)`
...
`func (o *InlineObject115) SetType(v string)`

SetType sets Type field to given value.

### HasType

`func (o *InlineObject115) HasType() bool`

HasType returns a boolean if a field has been set.

### GetDatasets

`func (o *InlineObject115) GetDatasets() []string`

GetDatasets returns the Datasets field if non-nil, zero value otherwise.

### GetDatasetsOk

`func (o *InlineObject115) GetDatasetsOk() (*[]string, bool)`
...
`func (o *InlineObject115) SetDatasets(v []string)`

SetDatasets sets Datasets field to given value.

### HasDatasets

`func (o *InlineObject115) HasDatasets() bool`

HasDatasets returns a boolean if a field has been set.

### GetUsername

`func (o *InlineObject115) GetUsername() string`

GetUsername returns the Username field if non-nil, zero value otherwise.

### GetUsernameOk

`func (o *InlineObject115) GetUsernameOk() (*string, bool)`
...
`func (o *InlineObject115) SetUsername(v string)`

SetUsername sets Username field to given value.

### HasUsername

`func (o *InlineObject115) HasUsername() bool`
...
`func (o *InlineObject115) HasEmail() bool`
...
`func (o *InlineObject115) GetSmDeviceId() string`

GetSmDeviceId returns the SmDeviceId field if non-nil, zero value otherwise.

### GetSmDeviceIdOk

`func (o *InlineObject115) GetSmDeviceIdOk() (*string, bool)`
...
`func (o *InlineObject115) SetSmDeviceId(v string)`

SetSmDeviceId sets SmDeviceId field to given value.

### HasSmDeviceId

`func (o *InlineObject115) HasSmDeviceId() bool`

HasSmDeviceId returns a boolean if a field has been set.

### GetSmUserId

`func (o *InlineObject115) GetSmUserId() string`

GetSmUserId returns the SmUserId field if non-nil, zero value otherwise.

### GetSmUserIdOk

`func (o *InlineObject115) GetSmUserIdOk() (*string, bool)`
...
`func (o *InlineObject115) SetSmUserId(v string)`

SetSmUserId sets SmUserId field to given value.

### HasSmUserId

`func (o *InlineObject115) HasSmUserId() bool`
