...
`func NewInlineObject87(name string, uplinks []NetworksNetworkIdCampusGatewayClustersUplinks, tunnels []NetworksNetworkIdCampusGatewayClustersTunnels, nameservers NetworksNetworkIdCampusGatewayClustersNameservers, portChannels []NetworksNetworkIdCampusGatewayClustersPortChannels, ) *InlineObject87`
...
`func (o *InlineObject87) GetUplinks() []NetworksNetworkIdCampusGatewayClustersUplinks`

GetUplinks returns the Uplinks field if non-nil, zero value otherwise.

### GetUplinksOk

`func (o *InlineObject87) GetUplinksOk() (*[]NetworksNetworkIdCampusGatewayClustersUplinks, bool)`
...
`func (o *InlineObject87) SetUplinks(v []NetworksNetworkIdCampusGatewayClustersUplinks)`
...
`func (o *InlineObject87) GetTunnels() []NetworksNetworkIdCampusGatewayClustersTunnels`

GetTunnels returns the Tunnels field if non-nil, zero value otherwise.

### GetTunnelsOk

`func (o *InlineObject87) GetTunnelsOk() (*[]NetworksNetworkIdCampusGatewayClustersTunnels, bool)`
...
`func (o *InlineObject87) SetTunnels(v []NetworksNetworkIdCampusGatewayClustersTunnels)`
...
`func (o *InlineObject87) GetNameservers() NetworksNetworkIdCampusGatewayClustersNameservers`

GetNameservers returns the Nameservers field if non-nil, zero value otherwise.

### GetNameserversOk

`func (o *InlineObject87) GetNameserversOk() (*NetworksNetworkIdCampusGatewayClustersNameservers, bool)`
...
`func (o *InlineObject87) SetNameservers(v NetworksNetworkIdCampusGatewayClustersNameservers)`
...
`func (o *InlineObject87) GetPortChannels() []NetworksNetworkIdCampusGatewayClustersPortChannels`

GetPortChannels returns the PortChannels field if non-nil, zero value otherwise.

### GetPortChannelsOk

`func (o *InlineObject87) GetPortChannelsOk() (*[]NetworksNetworkIdCampusGatewayClustersPortChannels, bool)`
...
`func (o *InlineObject87) SetPortChannels(v []NetworksNetworkIdCampusGatewayClustersPortChannels)`
...
`func (o *InlineObject87) GetDevices() []NetworksNetworkIdCampusGatewayClustersDevices`

GetDevices returns the Devices field if non-nil, zero value otherwise.

### GetDevicesOk

`func (o *InlineObject87) GetDevicesOk() (*[]NetworksNetworkIdCampusGatewayClustersDevices, bool)`
...
`func (o *InlineObject87) SetDevices(v []NetworksNetworkIdCampusGatewayClustersDevices)`
