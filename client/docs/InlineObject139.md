...
`func NewInlineObject139(ruleIds []string, ) *InlineObject139`
...
`func (o *InlineObject139) GetRuleIds() []string`

GetRuleIds returns the RuleIds field if non-nil, zero value otherwise.

### GetRuleIdsOk

`func (o *InlineObject139) GetRuleIdsOk() (*[]string, bool)`
...
`func (o *InlineObject139) SetRuleIds(v []string)`
