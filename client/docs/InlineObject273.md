...
`func NewInlineObject273(logEvent string, timestamp int32, ) *InlineObject273`
...
`func (o *InlineObject273) GetLogEvent() string`

GetLogEvent returns the LogEvent field if non-nil, zero value otherwise.

### GetLogEventOk

`func (o *InlineObject273) GetLogEventOk() (*string, bool)`
...
`func (o *InlineObject273) SetLogEvent(v string)`
...
`func (o *InlineObject273) GetTimestamp() int32`

GetTimestamp returns the Timestamp field if non-nil, zero value otherwise.

### GetTimestampOk

`func (o *InlineObject273) GetTimestampOk() (*int32, bool)`
...
`func (o *InlineObject273) SetTimestamp(v int32)`
...
`func (o *InlineObject273) GetTargetOS() string`

GetTargetOS returns the TargetOS field if non-nil, zero value otherwise.

### GetTargetOSOk

`func (o *InlineObject273) GetTargetOSOk() (*string, bool)`
...
`func (o *InlineObject273) SetTargetOS(v string)`

SetTargetOS sets TargetOS field to given value.

### HasTargetOS

`func (o *InlineObject273) HasTargetOS() bool`

HasTargetOS returns a boolean if a field has been set.

### GetRequest

`func (o *InlineObject273) GetRequest() string`

GetRequest returns the Request field if non-nil, zero value otherwise.

### GetRequestOk

`func (o *InlineObject273) GetRequestOk() (*string, bool)`
...
`func (o *InlineObject273) SetRequest(v string)`

SetRequest sets Request field to given value.

### HasRequest

`func (o *InlineObject273) HasRequest() bool`
