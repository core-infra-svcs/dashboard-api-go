# InlineResponse20063PerformanceClass
...
### NewInlineResponse20063PerformanceClass

`func NewInlineResponse20063PerformanceClass(type_ string, ) *InlineResponse20063PerformanceClass`

NewInlineResponse20063PerformanceClass instantiates a new InlineResponse20063PerformanceClass object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewInlineResponse20063PerformanceClassWithDefaults

`func NewInlineResponse20063PerformanceClassWithDefaults() *InlineResponse20063PerformanceClass`

NewInlineResponse20063PerformanceClassWithDefaults instantiates a new InlineResponse20063PerformanceClass object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetType

`func (o *InlineResponse20063PerformanceClass) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InlineResponse20063PerformanceClass) GetTypeOk() (*string, bool)`
...
`func (o *InlineResponse20063PerformanceClass) SetType(v string)`
...
`func (o *InlineResponse20063PerformanceClass) GetBuiltinPerformanceClassName() string`
...
`func (o *InlineResponse20063PerformanceClass) GetBuiltinPerformanceClassNameOk() (*string, bool)`
...
`func (o *InlineResponse20063PerformanceClass) SetBuiltinPerformanceClassName(v string)`

SetBuiltinPerformanceClassName sets BuiltinPerformanceClassName field to given value.

### HasBuiltinPerformanceClassName

`func (o *InlineResponse20063PerformanceClass) HasBuiltinPerformanceClassName() bool`

HasBuiltinPerformanceClassName returns a boolean if a field has been set.

### GetCustomPerformanceClassId

`func (o *InlineResponse20063PerformanceClass) GetCustomPerformanceClassId() string`
...
`func (o *InlineResponse20063PerformanceClass) GetCustomPerformanceClassIdOk() (*string, bool)`
...
`func (o *InlineResponse20063PerformanceClass) SetCustomPerformanceClassId(v string)`

SetCustomPerformanceClassId sets CustomPerformanceClassId field to given value.

### HasCustomPerformanceClassId

`func (o *InlineResponse20063PerformanceClass) HasCustomPerformanceClassId() bool`
