# NetworksNetworkIdWirelessSsidsNumberLocalAuthFallbackServerCaCertificate

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Contents** | Pointer to **NullableString** | The contents of the Server CA Certificate. Must be in PEM or DER format. | [optional] 
...
`func (o *NetworksNetworkIdWirelessSsidsNumberLocalAuthFallbackServerCaCertificate) SetContentsNil(b bool)`

 SetContentsNil sets the value for Contents to be an explicit nil

### UnsetContents
`func (o *NetworksNetworkIdWirelessSsidsNumberLocalAuthFallbackServerCaCertificate) UnsetContents()`
