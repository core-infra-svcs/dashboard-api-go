# InlineResponse20018PerformanceClass
...
### NewInlineResponse20018PerformanceClass

`func NewInlineResponse20018PerformanceClass(type_ string, ) *InlineResponse20018PerformanceClass`

NewInlineResponse20018PerformanceClass instantiates a new InlineResponse20018PerformanceClass object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewInlineResponse20018PerformanceClassWithDefaults

`func NewInlineResponse20018PerformanceClassWithDefaults() *InlineResponse20018PerformanceClass`

NewInlineResponse20018PerformanceClassWithDefaults instantiates a new InlineResponse20018PerformanceClass object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetType

`func (o *InlineResponse20018PerformanceClass) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InlineResponse20018PerformanceClass) GetTypeOk() (*string, bool)`
...
`func (o *InlineResponse20018PerformanceClass) SetType(v string)`
...
`func (o *InlineResponse20018PerformanceClass) GetBuiltinPerformanceClassName() string`
...
`func (o *InlineResponse20018PerformanceClass) GetBuiltinPerformanceClassNameOk() (*string, bool)`
...
`func (o *InlineResponse20018PerformanceClass) SetBuiltinPerformanceClassName(v string)`

SetBuiltinPerformanceClassName sets BuiltinPerformanceClassName field to given value.

### HasBuiltinPerformanceClassName

`func (o *InlineResponse20018PerformanceClass) HasBuiltinPerformanceClassName() bool`

HasBuiltinPerformanceClassName returns a boolean if a field has been set.

### GetCustomPerformanceClassId

`func (o *InlineResponse20018PerformanceClass) GetCustomPerformanceClassId() string`
...
`func (o *InlineResponse20018PerformanceClass) GetCustomPerformanceClassIdOk() (*string, bool)`
...
`func (o *InlineResponse20018PerformanceClass) SetCustomPerformanceClassId(v string)`

SetCustomPerformanceClassId sets CustomPerformanceClassId field to given value.

### HasCustomPerformanceClassId

`func (o *InlineResponse20018PerformanceClass) HasCustomPerformanceClassId() bool`
