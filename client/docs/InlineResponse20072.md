...
`func (o *InlineResponse20072) GetSsidName() string`

GetSsidName returns the SsidName field if non-nil, zero value otherwise.

### GetSsidNameOk

`func (o *InlineResponse20072) GetSsidNameOk() (*string, bool)`
...
`func (o *InlineResponse20072) SetSsidName(v string)`

SetSsidName sets SsidName field to given value.

### HasSsidName

`func (o *InlineResponse20072) HasSsidName() bool`
...
`func (o *InlineResponse20072) GetScope() string`

GetScope returns the Scope field if non-nil, zero value otherwise.

### GetScopeOk

`func (o *InlineResponse20072) GetScopeOk() (*string, bool)`
...
`func (o *InlineResponse20072) SetScope(v string)`

SetScope sets Scope field to given value.

### HasScope

`func (o *InlineResponse20072) HasScope() bool`
...
`func (o *InlineResponse20072) GetTimeboundType() string`

GetTimeboundType returns the TimeboundType field if non-nil, zero value otherwise.

### GetTimeboundTypeOk

`func (o *InlineResponse20072) GetTimeboundTypeOk() (*string, bool)`
...
`func (o *InlineResponse20072) GetNotifyTimeBeforeAccessEndsOk() (*int32, bool)`
...
`func (o *InlineResponse20072) SetAccessStartAt(v time.Time)`

SetAccessStartAt sets AccessStartAt field to given value.

### HasAccessStartAt

`func (o *InlineResponse20072) HasAccessStartAt() bool`

HasAccessStartAt returns a boolean if a field has been set.

### GetAccessEndAt

`func (o *InlineResponse20072) GetAccessEndAt() time.Time`

GetAccessEndAt returns the AccessEndAt field if non-nil, zero value otherwise.

### GetAccessEndAtOk

`func (o *InlineResponse20072) GetAccessEndAtOk() (*time.Time, bool)`
...
`func (o *InlineResponse20072) SetAccessEndAt(v time.Time)`

SetAccessEndAt sets AccessEndAt field to given value.

### HasAccessEndAt

`func (o *InlineResponse20072) HasAccessEndAt() bool`
