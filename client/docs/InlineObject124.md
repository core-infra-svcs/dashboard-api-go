...
`func NewInlineObject124(interfaceIp string, multicastGroup string, ) *InlineObject124`
...
`func (o *InlineObject124) GetInterfaceIp() string`

GetInterfaceIp returns the InterfaceIp field if non-nil, zero value otherwise.

### GetInterfaceIpOk

`func (o *InlineObject124) GetInterfaceIpOk() (*string, bool)`
...
`func (o *InlineObject124) SetInterfaceIp(v string)`
...
`func (o *InlineObject124) GetMulticastGroup() string`

GetMulticastGroup returns the MulticastGroup field if non-nil, zero value otherwise.

### GetMulticastGroupOk

`func (o *InlineObject124) GetMulticastGroupOk() (*string, bool)`
...
`func (o *InlineObject124) SetMulticastGroup(v string)`
