...
`func (o *InlineResponse200244) GetMac() string`

GetMac returns the Mac field if non-nil, zero value otherwise.

### GetMacOk

`func (o *InlineResponse200244) GetMacOk() (*string, bool)`
...
`func (o *InlineResponse200244) SetMac(v string)`

SetMac sets Mac field to given value.

### HasMac

`func (o *InlineResponse200244) HasMac() bool`
...
`func (o *InlineResponse200244) GetNetwork() OrganizationsOrganizationIdDevicesAvailabilitiesNetwork`

GetNetwork returns the Network field if non-nil, zero value otherwise.

### GetNetworkOk

`func (o *InlineResponse200244) GetNetworkOk() (*OrganizationsOrganizationIdDevicesAvailabilitiesNetwork, bool)`
...
`func (o *InlineResponse200244) SetNetwork(v OrganizationsOrganizationIdDevicesAvailabilitiesNetwork)`
...
`func (o *InlineResponse200244) GetProductType() string`

GetProductType returns the ProductType field if non-nil, zero value otherwise.

### GetProductTypeOk

`func (o *InlineResponse200244) GetProductTypeOk() (*string, bool)`
...
`func (o *InlineResponse200244) SetProductType(v string)`

SetProductType sets ProductType field to given value.

### HasProductType

`func (o *InlineResponse200244) HasProductType() bool`
...
`func (o *InlineResponse200244) GetTags() []string`

GetTags returns the Tags field if non-nil, zero value otherwise.

### GetTagsOk

`func (o *InlineResponse200244) GetTagsOk() (*[]string, bool)`
...
`func (o *InlineResponse200244) SetTags(v []string)`

SetTags sets Tags field to given value.

### HasTags

`func (o *InlineResponse200244) HasTags() bool`

HasTags returns a boolean if a field has been set.

### GetUplinks

`func (o *InlineResponse200244) GetUplinks() []OrganizationsOrganizationIdDevicesUplinksAddressesByDeviceUplinks`

GetUplinks returns the Uplinks field if non-nil, zero value otherwise.

### GetUplinksOk

`func (o *InlineResponse200244) GetUplinksOk() (*[]OrganizationsOrganizationIdDevicesUplinksAddressesByDeviceUplinks, bool)`
...
`func (o *InlineResponse200244) SetUplinks(v []OrganizationsOrganizationIdDevicesUplinksAddressesByDeviceUplinks)`

SetUplinks sets Uplinks field to given value.

### HasUplinks

`func (o *InlineResponse200244) HasUplinks() bool`
