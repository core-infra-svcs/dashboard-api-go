...
`func NewInlineObject282(destOrganizationId string, licenseIds []string, ) *InlineObject282`
...
`func (o *InlineObject282) GetDestOrganizationId() string`

GetDestOrganizationId returns the DestOrganizationId field if non-nil, zero value otherwise.

### GetDestOrganizationIdOk

`func (o *InlineObject282) GetDestOrganizationIdOk() (*string, bool)`
...
`func (o *InlineObject282) SetDestOrganizationId(v string)`
...
`func (o *InlineObject282) GetLicenseIds() []string`

GetLicenseIds returns the LicenseIds field if non-nil, zero value otherwise.

### GetLicenseIdsOk

`func (o *InlineObject282) GetLicenseIdsOk() (*[]string, bool)`
...
`func (o *InlineObject282) SetLicenseIds(v []string)`
