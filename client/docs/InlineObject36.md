...
`func NewInlineObject36(access string, ) *InlineObject36`
...
`func (o *InlineObject36) GetAccess() string`

GetAccess returns the Access field if non-nil, zero value otherwise.

### GetAccessOk

`func (o *InlineObject36) GetAccessOk() (*string, bool)`
...
`func (o *InlineObject36) SetAccess(v string)`
...
`func (o *InlineObject36) GetAllowedIps() []string`

GetAllowedIps returns the AllowedIps field if non-nil, zero value otherwise.

### GetAllowedIpsOk

`func (o *InlineObject36) GetAllowedIpsOk() (*[]string, bool)`
...
`func (o *InlineObject36) SetAllowedIps(v []string)`

SetAllowedIps sets AllowedIps field to given value.

### HasAllowedIps

`func (o *InlineObject36) HasAllowedIps() bool`
