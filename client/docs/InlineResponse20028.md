...
**ClientVpnConnections** | Pointer to [**[]InlineResponse20028ClientVpnConnections**](InlineResponse20028ClientVpnConnections.md) | VPN connections associated with the client | [optional] 
...
`func (o *InlineResponse20028) GetMac() string`

GetMac returns the Mac field if non-nil, zero value otherwise.

### GetMacOk

`func (o *InlineResponse20028) GetMacOk() (*string, bool)`
...
`func (o *InlineResponse20028) SetMac(v string)`

SetMac sets Mac field to given value.

### HasMac

`func (o *InlineResponse20028) HasMac() bool`
...
`func (o *InlineResponse20028) GetIp6() string`

GetIp6 returns the Ip6 field if non-nil, zero value otherwise.

### GetIp6Ok

`func (o *InlineResponse20028) GetIp6Ok() (*string, bool)`
...
`func (o *InlineResponse20028) SetIp6(v string)`

SetIp6 sets Ip6 field to given value.

### HasIp6

`func (o *InlineResponse20028) HasIp6() bool`
...
`func (o *InlineResponse20028) GetFirstSeen() int32`

GetFirstSeen returns the FirstSeen field if non-nil, zero value otherwise.

### GetFirstSeenOk

`func (o *InlineResponse20028) GetFirstSeenOk() (*int32, bool)`
...
`func (o *InlineResponse20028) SetFirstSeen(v int32)`

SetFirstSeen sets FirstSeen field to given value.

### HasFirstSeen

`func (o *InlineResponse20028) HasFirstSeen() bool`

HasFirstSeen returns a boolean if a field has been set.

### GetLastSeen

`func (o *InlineResponse20028) GetLastSeen() int32`

GetLastSeen returns the LastSeen field if non-nil, zero value otherwise.

### GetLastSeenOk

`func (o *InlineResponse20028) GetLastSeenOk() (*int32, bool)`
...
`func (o *InlineResponse20028) SetLastSeen(v int32)`

SetLastSeen sets LastSeen field to given value.

### HasLastSeen

`func (o *InlineResponse20028) HasLastSeen() bool`

HasLastSeen returns a boolean if a field has been set.

### GetManufacturer

`func (o *InlineResponse20028) GetManufacturer() string`

GetManufacturer returns the Manufacturer field if non-nil, zero value otherwise.

### GetManufacturerOk

`func (o *InlineResponse20028) GetManufacturerOk() (*string, bool)`
...
`func (o *InlineResponse20028) SetManufacturer(v string)`

SetManufacturer sets Manufacturer field to given value.

### HasManufacturer

`func (o *InlineResponse20028) HasManufacturer() bool`

HasManufacturer returns a boolean if a field has been set.

### GetOs

`func (o *InlineResponse20028) GetOs() string`

GetOs returns the Os field if non-nil, zero value otherwise.

### GetOsOk

`func (o *InlineResponse20028) GetOsOk() (*string, bool)`
...
`func (o *InlineResponse20028) SetOs(v string)`

SetOs sets Os field to given value.

### HasOs

`func (o *InlineResponse20028) HasOs() bool`

HasOs returns a boolean if a field has been set.

### GetUser

`func (o *InlineResponse20028) GetUser() string`

GetUser returns the User field if non-nil, zero value otherwise.

### GetUserOk

`func (o *InlineResponse20028) GetUserOk() (*string, bool)`
...
`func (o *InlineResponse20028) SetUser(v string)`

SetUser sets User field to given value.

### HasUser

`func (o *InlineResponse20028) HasUser() bool`

HasUser returns a boolean if a field has been set.

### GetVlan

`func (o *InlineResponse20028) GetVlan() string`

GetVlan returns the Vlan field if non-nil, zero value otherwise.

### GetVlanOk

`func (o *InlineResponse20028) GetVlanOk() (*string, bool)`
...
`func (o *InlineResponse20028) SetVlan(v string)`

SetVlan sets Vlan field to given value.

### HasVlan

`func (o *InlineResponse20028) HasVlan() bool`
...
`func (o *InlineResponse20028) GetSwitchport() string`

GetSwitchport returns the Switchport field if non-nil, zero value otherwise.

### GetSwitchportOk

`func (o *InlineResponse20028) GetSwitchportOk() (*string, bool)`
...
`func (o *InlineResponse20028) SetRecentDeviceMac(v string)`

SetRecentDeviceMac sets RecentDeviceMac field to given value.

### HasRecentDeviceMac

`func (o *InlineResponse20028) HasRecentDeviceMac() bool`

HasRecentDeviceMac returns a boolean if a field has been set.

### GetClientVpnConnections

`func (o *InlineResponse20028) GetClientVpnConnections() []InlineResponse20028ClientVpnConnections`

GetClientVpnConnections returns the ClientVpnConnections field if non-nil, zero value otherwise.

### GetClientVpnConnectionsOk

`func (o *InlineResponse20028) GetClientVpnConnectionsOk() (*[]InlineResponse20028ClientVpnConnections, bool)`
...
`func (o *InlineResponse20028) SetClientVpnConnections(v []InlineResponse20028ClientVpnConnections)`

SetClientVpnConnections sets ClientVpnConnections field to given value.

### HasClientVpnConnections

`func (o *InlineResponse20028) HasClientVpnConnections() bool`

HasClientVpnConnections returns a boolean if a field has been set.

### GetLldp

`func (o *InlineResponse20028) GetLldp() [][]string`

GetLldp returns the Lldp field if non-nil, zero value otherwise.

### GetLldpOk

`func (o *InlineResponse20028) GetLldpOk() (*[][]string, bool)`
...
`func (o *InlineResponse20028) SetLldp(v [][]string)`

SetLldp sets Lldp field to given value.

### HasLldp

`func (o *InlineResponse20028) HasLldp() bool`

HasLldp returns a boolean if a field has been set.

### GetCdp

`func (o *InlineResponse20028) GetCdp() [][]string`

GetCdp returns the Cdp field if non-nil, zero value otherwise.

### GetCdpOk

`func (o *InlineResponse20028) GetCdpOk() (*[][]string, bool)`
...
`func (o *InlineResponse20028) SetCdp(v [][]string)`

SetCdp sets Cdp field to given value.

### HasCdp

`func (o *InlineResponse20028) HasCdp() bool`
