...
`func (o *InlineResponse200171) GetClientCount() int32`

GetClientCount returns the ClientCount field if non-nil, zero value otherwise.

### GetClientCountOk

`func (o *InlineResponse200171) GetClientCountOk() (*int32, bool)`
...
`func (o *InlineResponse200171) SetClientCount(v int32)`

SetClientCount sets ClientCount field to given value.

### HasClientCount

`func (o *InlineResponse200171) HasClientCount() bool`
