...
`func (o *InlineResponse20059) GetDhcpServer() string`

GetDhcpServer returns the DhcpServer field if non-nil, zero value otherwise.

### GetDhcpServerOk

`func (o *InlineResponse20059) GetDhcpServerOk() (*string, bool)`
...
`func (o *InlineResponse20059) SetDhcpServer(v string)`

SetDhcpServer sets DhcpServer field to given value.

### HasDhcpServer

`func (o *InlineResponse20059) HasDhcpServer() bool`

HasDhcpServer returns a boolean if a field has been set.

### GetDnsServer

`func (o *InlineResponse20059) GetDnsServer() string`

GetDnsServer returns the DnsServer field if non-nil, zero value otherwise.

### GetDnsServerOk

`func (o *InlineResponse20059) GetDnsServerOk() (*string, bool)`
...
`func (o *InlineResponse20059) SetDnsServer(v string)`

SetDnsServer sets DnsServer field to given value.

### HasDnsServer

`func (o *InlineResponse20059) HasDnsServer() bool`

HasDnsServer returns a boolean if a field has been set.

### GetGateway

`func (o *InlineResponse20059) GetGateway() string`

GetGateway returns the Gateway field if non-nil, zero value otherwise.

### GetGatewayOk

`func (o *InlineResponse20059) GetGatewayOk() (*string, bool)`
...
`func (o *InlineResponse20059) SetGateway(v string)`

SetGateway sets Gateway field to given value.

### HasGateway

`func (o *InlineResponse20059) HasGateway() bool`
...
`func (o *InlineResponse20059) GetIp() string`

GetIp returns the Ip field if non-nil, zero value otherwise.

### GetIpOk

`func (o *InlineResponse20059) GetIpOk() (*string, bool)`
...
`func (o *InlineResponse20059) SetIp(v string)`

SetIp sets Ip field to given value.

### HasIp

`func (o *InlineResponse20059) HasIp() bool`

HasIp returns a boolean if a field has been set.

### GetMac

`func (o *InlineResponse20059) GetMac() string`

GetMac returns the Mac field if non-nil, zero value otherwise.

### GetMacOk

`func (o *InlineResponse20059) GetMacOk() (*string, bool)`
...
`func (o *InlineResponse20059) SetMac(v string)`

SetMac sets Mac field to given value.

### HasMac

`func (o *InlineResponse20059) HasMac() bool`
