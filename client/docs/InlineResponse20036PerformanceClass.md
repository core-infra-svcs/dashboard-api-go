# InlineResponse20036PerformanceClass
...
### NewInlineResponse20036PerformanceClass

`func NewInlineResponse20036PerformanceClass(type_ string, ) *InlineResponse20036PerformanceClass`

NewInlineResponse20036PerformanceClass instantiates a new InlineResponse20036PerformanceClass object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewInlineResponse20036PerformanceClassWithDefaults

`func NewInlineResponse20036PerformanceClassWithDefaults() *InlineResponse20036PerformanceClass`

NewInlineResponse20036PerformanceClassWithDefaults instantiates a new InlineResponse20036PerformanceClass object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetType

`func (o *InlineResponse20036PerformanceClass) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InlineResponse20036PerformanceClass) GetTypeOk() (*string, bool)`
...
`func (o *InlineResponse20036PerformanceClass) SetType(v string)`
...
`func (o *InlineResponse20036PerformanceClass) GetBuiltinPerformanceClassName() string`
...
`func (o *InlineResponse20036PerformanceClass) GetBuiltinPerformanceClassNameOk() (*string, bool)`
...
`func (o *InlineResponse20036PerformanceClass) SetBuiltinPerformanceClassName(v string)`

SetBuiltinPerformanceClassName sets BuiltinPerformanceClassName field to given value.

### HasBuiltinPerformanceClassName

`func (o *InlineResponse20036PerformanceClass) HasBuiltinPerformanceClassName() bool`

HasBuiltinPerformanceClassName returns a boolean if a field has been set.

### GetCustomPerformanceClassId

`func (o *InlineResponse20036PerformanceClass) GetCustomPerformanceClassId() string`
...
`func (o *InlineResponse20036PerformanceClass) GetCustomPerformanceClassIdOk() (*string, bool)`
...
`func (o *InlineResponse20036PerformanceClass) SetCustomPerformanceClassId(v string)`

SetCustomPerformanceClassId sets CustomPerformanceClassId field to given value.

### HasCustomPerformanceClassId

`func (o *InlineResponse20036PerformanceClass) HasCustomPerformanceClassId() bool`
