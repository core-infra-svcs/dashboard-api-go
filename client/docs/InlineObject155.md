...
`func (o *InlineObject155) GetSubnet() string`

GetSubnet returns the Subnet field if non-nil, zero value otherwise.

### GetSubnetOk

`func (o *InlineObject155) GetSubnetOk() (*string, bool)`
...
`func (o *InlineObject155) SetSubnet(v string)`

SetSubnet sets Subnet field to given value.

### HasSubnet

`func (o *InlineObject155) HasSubnet() bool`

HasSubnet returns a boolean if a field has been set.

### GetNextHopIp

`func (o *InlineObject155) GetNextHopIp() string`

GetNextHopIp returns the NextHopIp field if non-nil, zero value otherwise.

### GetNextHopIpOk

`func (o *InlineObject155) GetNextHopIpOk() (*string, bool)`
...
`func (o *InlineObject155) SetNextHopIp(v string)`

SetNextHopIp sets NextHopIp field to given value.

### HasNextHopIp

`func (o *InlineObject155) HasNextHopIp() bool`

HasNextHopIp returns a boolean if a field has been set.

### GetAdvertiseViaOspfEnabled

`func (o *InlineObject155) GetAdvertiseViaOspfEnabled() bool`
...
`func (o *InlineObject155) GetAdvertiseViaOspfEnabledOk() (*bool, bool)`
...
`func (o *InlineObject155) SetAdvertiseViaOspfEnabled(v bool)`

SetAdvertiseViaOspfEnabled sets AdvertiseViaOspfEnabled field to given value.

### HasAdvertiseViaOspfEnabled

`func (o *InlineObject155) HasAdvertiseViaOspfEnabled() bool`

HasAdvertiseViaOspfEnabled returns a boolean if a field has been set.

### GetPreferOverOspfRoutesEnabled

`func (o *InlineObject155) GetPreferOverOspfRoutesEnabled() bool`
...
`func (o *InlineObject155) GetPreferOverOspfRoutesEnabledOk() (*bool, bool)`
...
`func (o *InlineObject155) SetPreferOverOspfRoutesEnabled(v bool)`

SetPreferOverOspfRoutesEnabled sets PreferOverOspfRoutesEnabled field to given value.

### HasPreferOverOspfRoutesEnabled

`func (o *InlineObject155) HasPreferOverOspfRoutesEnabled() bool`
