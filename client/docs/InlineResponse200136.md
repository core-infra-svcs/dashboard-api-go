...
`func (o *InlineResponse200136) GetDhcpServer() string`

GetDhcpServer returns the DhcpServer field if non-nil, zero value otherwise.

### GetDhcpServerOk

`func (o *InlineResponse200136) GetDhcpServerOk() (*string, bool)`
...
`func (o *InlineResponse200136) SetDhcpServer(v string)`

SetDhcpServer sets DhcpServer field to given value.

### HasDhcpServer

`func (o *InlineResponse200136) HasDhcpServer() bool`

HasDhcpServer returns a boolean if a field has been set.

### GetDnsServer

`func (o *InlineResponse200136) GetDnsServer() string`

GetDnsServer returns the DnsServer field if non-nil, zero value otherwise.

### GetDnsServerOk

`func (o *InlineResponse200136) GetDnsServerOk() (*string, bool)`
...
`func (o *InlineResponse200136) SetDnsServer(v string)`

SetDnsServer sets DnsServer field to given value.

### HasDnsServer

`func (o *InlineResponse200136) HasDnsServer() bool`

HasDnsServer returns a boolean if a field has been set.

### GetGateway

`func (o *InlineResponse200136) GetGateway() string`

GetGateway returns the Gateway field if non-nil, zero value otherwise.

### GetGatewayOk

`func (o *InlineResponse200136) GetGatewayOk() (*string, bool)`
...
`func (o *InlineResponse200136) SetGateway(v string)`

SetGateway sets Gateway field to given value.

### HasGateway

`func (o *InlineResponse200136) HasGateway() bool`
...
`func (o *InlineResponse200136) GetIp() string`

GetIp returns the Ip field if non-nil, zero value otherwise.

### GetIpOk

`func (o *InlineResponse200136) GetIpOk() (*string, bool)`
...
`func (o *InlineResponse200136) SetIp(v string)`

SetIp sets Ip field to given value.

### HasIp

`func (o *InlineResponse200136) HasIp() bool`
...
`func (o *InlineResponse200136) GetSubnet() string`

GetSubnet returns the Subnet field if non-nil, zero value otherwise.

### GetSubnetOk

`func (o *InlineResponse200136) GetSubnetOk() (*string, bool)`
...
`func (o *InlineResponse200136) SetSubnet(v string)`

SetSubnet sets Subnet field to given value.

### HasSubnet

`func (o *InlineResponse200136) HasSubnet() bool`
