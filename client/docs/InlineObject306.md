...
`func (o *InlineObject306) GetBaseTheme() string`

GetBaseTheme returns the BaseTheme field if non-nil, zero value otherwise.

### GetBaseThemeOk

`func (o *InlineObject306) GetBaseThemeOk() (*string, bool)`
...
`func (o *InlineObject306) SetBaseTheme(v string)`

SetBaseTheme sets BaseTheme field to given value.

### HasBaseTheme

`func (o *InlineObject306) HasBaseTheme() bool`
