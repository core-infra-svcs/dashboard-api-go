...
`func (o *NetworksNetworkIdWirelessRfProfilesRfProfileIdSixGhzSettings) SetRxsopNil(b bool)`

 SetRxsopNil sets the value for Rxsop to be an explicit nil

### UnsetRxsop
`func (o *NetworksNetworkIdWirelessRfProfilesRfProfileIdSixGhzSettings) UnsetRxsop()`
