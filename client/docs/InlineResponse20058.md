...
`func (o *InlineResponse20058) GetReceived() float32`

GetReceived returns the Received field if non-nil, zero value otherwise.

### GetReceivedOk

`func (o *InlineResponse20058) GetReceivedOk() (*float32, bool)`
...
`func (o *InlineResponse20058) SetReceived(v float32)`

SetReceived sets Received field to given value.

### HasReceived

`func (o *InlineResponse20058) HasReceived() bool`

HasReceived returns a boolean if a field has been set.

### GetSent

`func (o *InlineResponse20058) GetSent() float32`

GetSent returns the Sent field if non-nil, zero value otherwise.

### GetSentOk

`func (o *InlineResponse20058) GetSentOk() (*float32, bool)`
...
`func (o *InlineResponse20058) SetSent(v float32)`
