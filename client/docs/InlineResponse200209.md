...
**Rules** | Pointer to [**[]InlineResponse200209Rules**](InlineResponse200209Rules.md) |     An array of traffic shaping rules. Rules are applied in the order that     they are specified in. An empty list (or null) means no rules. Note that     you are allowed a maximum of 8 rules.  | [optional] 
