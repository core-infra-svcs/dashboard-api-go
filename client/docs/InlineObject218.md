...
`func (o *InlineObject218) GetV2cEnabled() bool`

GetV2cEnabled returns the V2cEnabled field if non-nil, zero value otherwise.

### GetV2cEnabledOk

`func (o *InlineObject218) GetV2cEnabledOk() (*bool, bool)`
...
`func (o *InlineObject218) SetV3AuthMode(v string)`

SetV3AuthMode sets V3AuthMode field to given value.

### HasV3AuthMode

`func (o *InlineObject218) HasV3AuthMode() bool`

HasV3AuthMode returns a boolean if a field has been set.

### GetV3AuthPass

`func (o *InlineObject218) GetV3AuthPass() string`

GetV3AuthPass returns the V3AuthPass field if non-nil, zero value otherwise.

### GetV3AuthPassOk

`func (o *InlineObject218) GetV3AuthPassOk() (*string, bool)`
...
`func (o *InlineObject218) SetV3AuthPass(v string)`

SetV3AuthPass sets V3AuthPass field to given value.

### HasV3AuthPass

`func (o *InlineObject218) HasV3AuthPass() bool`

HasV3AuthPass returns a boolean if a field has been set.

### GetV3PrivMode

`func (o *InlineObject218) GetV3PrivMode() string`

GetV3PrivMode returns the V3PrivMode field if non-nil, zero value otherwise.

### GetV3PrivModeOk

`func (o *InlineObject218) GetV3PrivModeOk() (*string, bool)`
...
`func (o *InlineObject218) SetV3PrivMode(v string)`

SetV3PrivMode sets V3PrivMode field to given value.

### HasV3PrivMode

`func (o *InlineObject218) HasV3PrivMode() bool`

HasV3PrivMode returns a boolean if a field has been set.

### GetV3PrivPass

`func (o *InlineObject218) GetV3PrivPass() string`

GetV3PrivPass returns the V3PrivPass field if non-nil, zero value otherwise.

### GetV3PrivPassOk

`func (o *InlineObject218) GetV3PrivPassOk() (*string, bool)`
...
`func (o *InlineObject218) SetV3PrivPass(v string)`

SetV3PrivPass sets V3PrivPass field to given value.

### HasV3PrivPass

`func (o *InlineObject218) HasV3PrivPass() bool`

HasV3PrivPass returns a boolean if a field has been set.

### GetPeerIps

`func (o *InlineObject218) GetPeerIps() []string`

GetPeerIps returns the PeerIps field if non-nil, zero value otherwise.

### GetPeerIpsOk

`func (o *InlineObject218) GetPeerIpsOk() (*[]string, bool)`
...
`func (o *InlineObject218) SetPeerIps(v []string)`

SetPeerIps sets PeerIps field to given value.

### HasPeerIps

`func (o *InlineObject218) HasPeerIps() bool`
