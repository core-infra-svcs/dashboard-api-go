...
`func (o *InlineObject218) GetTimeZone() string`

GetTimeZone returns the TimeZone field if non-nil, zero value otherwise.

### GetTimeZoneOk

`func (o *InlineObject218) GetTimeZoneOk() (*string, bool)`
...
`func (o *InlineObject218) SetTimeZone(v string)`

SetTimeZone sets TimeZone field to given value.

### HasTimeZone

`func (o *InlineObject218) HasTimeZone() bool`
