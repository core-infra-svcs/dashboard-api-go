...
`func (o *InlineResponse200110) GetGroupPolicyId() string`

GetGroupPolicyId returns the GroupPolicyId field if non-nil, zero value otherwise.

### GetGroupPolicyIdOk

`func (o *InlineResponse200110) GetGroupPolicyIdOk() (*string, bool)`
...
`func (o *InlineResponse200110) SetGroupPolicyId(v string)`

SetGroupPolicyId sets GroupPolicyId field to given value.

### HasGroupPolicyId

`func (o *InlineResponse200110) HasGroupPolicyId() bool`

HasGroupPolicyId returns a boolean if a field has been set.

### GetPassphrase

`func (o *InlineResponse200110) GetPassphrase() string`

GetPassphrase returns the Passphrase field if non-nil, zero value otherwise.

### GetPassphraseOk

`func (o *InlineResponse200110) GetPassphraseOk() (*string, bool)`
...
`func (o *InlineResponse200110) SetPassphrase(v string)`

SetPassphrase sets Passphrase field to given value.

### HasPassphrase

`func (o *InlineResponse200110) HasPassphrase() bool`

HasPassphrase returns a boolean if a field has been set.

### GetWifiPersonalNetworkId

`func (o *InlineResponse200110) GetWifiPersonalNetworkId() string`
...
`func (o *InlineResponse200110) GetWifiPersonalNetworkIdOk() (*string, bool)`
...
`func (o *InlineResponse200110) SetWifiPersonalNetworkId(v string)`

SetWifiPersonalNetworkId sets WifiPersonalNetworkId field to given value.

### HasWifiPersonalNetworkId

`func (o *InlineResponse200110) HasWifiPersonalNetworkId() bool`
...
`func (o *InlineResponse200110) GetExpiresAt() time.Time`

GetExpiresAt returns the ExpiresAt field if non-nil, zero value otherwise.

### GetExpiresAtOk

`func (o *InlineResponse200110) GetExpiresAtOk() (*time.Time, bool)`
...
`func (o *InlineResponse200110) SetExpiresAt(v time.Time)`

SetExpiresAt sets ExpiresAt field to given value.

### HasExpiresAt

`func (o *InlineResponse200110) HasExpiresAt() bool`
