...
`func (o *InlineObject204) GetTimeZone() string`

GetTimeZone returns the TimeZone field if non-nil, zero value otherwise.

### GetTimeZoneOk

`func (o *InlineObject204) GetTimeZoneOk() (*string, bool)`
...
`func (o *InlineObject204) SetTimeZone(v string)`

SetTimeZone sets TimeZone field to given value.

### HasTimeZone

`func (o *InlineObject204) HasTimeZone() bool`
