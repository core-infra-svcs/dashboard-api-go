...
`func NewInlineObject61(id string, name string, ) *InlineObject61`
...
`func (o *InlineObject61) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *InlineObject61) GetIdOk() (*string, bool)`
...
`func (o *InlineObject61) SetId(v string)`
