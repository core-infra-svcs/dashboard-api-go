...
------------ | ------------- | ------------- | -------------
**Md5** | Pointer to **NullableString** | The MD5 value of the prepaid front image file. Setting this to null will remove the prepaid front from the splash page. | [optional] 
...
`func (o *NetworksNetworkIdWirelessSsidsNumberSplashSettingsSplashPrepaidFront) SetMd5Nil(b bool)`
