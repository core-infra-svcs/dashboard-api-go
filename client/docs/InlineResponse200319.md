...
`func (o *InlineResponse200319) GetMac() string`

GetMac returns the Mac field if non-nil, zero value otherwise.

### GetMacOk

`func (o *InlineResponse200319) GetMacOk() (*string, bool)`
...
`func (o *InlineResponse200319) SetMac(v string)`

SetMac sets Mac field to given value.

### HasMac

`func (o *InlineResponse200319) HasMac() bool`
...
`func (o *InlineResponse200319) GetModel() string`

GetModel returns the Model field if non-nil, zero value otherwise.

### GetModelOk

`func (o *InlineResponse200319) GetModelOk() (*string, bool)`
...
`func (o *InlineResponse200319) SetModel(v string)`

SetModel sets Model field to given value.

### HasModel

`func (o *InlineResponse200319) HasModel() bool`
...
`func (o *InlineResponse200319) GetOrderNumber() string`

GetOrderNumber returns the OrderNumber field if non-nil, zero value otherwise.

### GetOrderNumberOk

`func (o *InlineResponse200319) GetOrderNumberOk() (*string, bool)`
...
`func (o *InlineResponse200319) SetOrderNumber(v string)`

SetOrderNumber sets OrderNumber field to given value.

### HasOrderNumber

`func (o *InlineResponse200319) HasOrderNumber() bool`

HasOrderNumber returns a boolean if a field has been set.

### GetClaimedAt

`func (o *InlineResponse200319) GetClaimedAt() time.Time`

GetClaimedAt returns the ClaimedAt field if non-nil, zero value otherwise.

### GetClaimedAtOk

`func (o *InlineResponse200319) GetClaimedAtOk() (*time.Time, bool)`
...
`func (o *InlineResponse200319) SetClaimedAt(v time.Time)`

SetClaimedAt sets ClaimedAt field to given value.

### HasClaimedAt

`func (o *InlineResponse200319) HasClaimedAt() bool`

HasClaimedAt returns a boolean if a field has been set.

### GetLicenseExpirationDate

`func (o *InlineResponse200319) GetLicenseExpirationDate() time.Time`
...
`func (o *InlineResponse200319) GetLicenseExpirationDateOk() (*time.Time, bool)`
...
`func (o *InlineResponse200319) SetLicenseExpirationDate(v time.Time)`

SetLicenseExpirationDate sets LicenseExpirationDate field to given value.

### HasLicenseExpirationDate

`func (o *InlineResponse200319) HasLicenseExpirationDate() bool`
...
`func (o *InlineResponse200319) GetProductType() string`

GetProductType returns the ProductType field if non-nil, zero value otherwise.

### GetProductTypeOk

`func (o *InlineResponse200319) GetProductTypeOk() (*string, bool)`
...
`func (o *InlineResponse200319) SetProductType(v string)`

SetProductType sets ProductType field to given value.

### HasProductType

`func (o *InlineResponse200319) HasProductType() bool`

HasProductType returns a boolean if a field has been set.

### GetCountryCode

`func (o *InlineResponse200319) GetCountryCode() string`

GetCountryCode returns the CountryCode field if non-nil, zero value otherwise.

### GetCountryCodeOk

`func (o *InlineResponse200319) GetCountryCodeOk() (*string, bool)`
...
`func (o *InlineResponse200319) SetCountryCode(v string)`

SetCountryCode sets CountryCode field to given value.

### HasCountryCode

`func (o *InlineResponse200319) HasCountryCode() bool`

HasCountryCode returns a boolean if a field has been set.

### GetDetails

`func (o *InlineResponse200319) GetDetails() []InlineResponse2006Details`

GetDetails returns the Details field if non-nil, zero value otherwise.

### GetDetailsOk

`func (o *InlineResponse200319) GetDetailsOk() (*[]InlineResponse2006Details, bool)`
...
`func (o *InlineResponse200319) SetDetails(v []InlineResponse2006Details)`

SetDetails sets Details field to given value.

### HasDetails

`func (o *InlineResponse200319) HasDetails() bool`

HasDetails returns a boolean if a field has been set.

### GetEox

`func (o *InlineResponse200319) GetEox() OrganizationsOrganizationIdInventoryDevicesEox`

GetEox returns the Eox field if non-nil, zero value otherwise.

### GetEoxOk

`func (o *InlineResponse200319) GetEoxOk() (*OrganizationsOrganizationIdInventoryDevicesEox, bool)`
...
`func (o *InlineResponse200319) SetEox(v OrganizationsOrganizationIdInventoryDevicesEox)`

SetEox sets Eox field to given value.

### HasEox

`func (o *InlineResponse200319) HasEox() bool`
