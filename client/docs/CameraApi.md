...
func main() {
    ...
    createOrganizationCameraCustomAnalyticsArtifact := *openapiclient.NewInlineObject202() // InlineObject202 |  (optional)
 ...
 **createOrganizationCameraCustomAnalyticsArtifact** | [**InlineObject202**](InlineObject202.md) |  | 
...
func main() {
    organizationId := "organizationId_example" // string | Organization ID
    createOrganizationCameraRole := *openapiclient.NewInlineObject204("Name_example") // InlineObject204 | 
 ...
 **createOrganizationCameraRole** | [**InlineObject204**](InlineObject204.md) |  | 
...
> []InlineResponse20030 GetNetworkCameraSchedules(ctx, networkId).Execute()
...
func main() {
    ...
    // response from `GetNetworkCameraSchedules`: []InlineResponse20030
...
> InlineResponse200128 GetOrganizationCameraPermission(ctx, organizationId, permissionScopeId).Execute()
...
func main() {
    ...
    // response from `GetOrganizationCameraPermission`: InlineResponse200128
...
> []InlineResponse200128 GetOrganizationCameraPermissions(ctx, organizationId).Execute()
...
func main() {
    ...
    // response from `GetOrganizationCameraPermissions`: []InlineResponse200128
...
func main() {
    organizationId := "organizationId_example" // string | Organization ID
    roleId := "roleId_example" // string | Role ID
    updateOrganizationCameraRole := *openapiclient.NewInlineObject205() // InlineObject205 |  (optional)
 ...
 **updateOrganizationCameraRole** | [**InlineObject205**](InlineObject205.md) |  | 
