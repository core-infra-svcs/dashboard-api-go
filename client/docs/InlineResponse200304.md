...
`func (o *InlineResponse200304) GetVppAccountId() string`

GetVppAccountId returns the VppAccountId field if non-nil, zero value otherwise.

### GetVppAccountIdOk

`func (o *InlineResponse200304) GetVppAccountIdOk() (*string, bool)`
...
`func (o *InlineResponse200304) SetVppAccountId(v string)`

SetVppAccountId sets VppAccountId field to given value.

### HasVppAccountId

`func (o *InlineResponse200304) HasVppAccountId() bool`

HasVppAccountId returns a boolean if a field has been set.

### GetContentToken

`func (o *InlineResponse200304) GetContentToken() string`

GetContentToken returns the ContentToken field if non-nil, zero value otherwise.

### GetContentTokenOk

`func (o *InlineResponse200304) GetContentTokenOk() (*string, bool)`
...
`func (o *InlineResponse200304) SetContentToken(v string)`

SetContentToken sets ContentToken field to given value.

### HasContentToken

`func (o *InlineResponse200304) HasContentToken() bool`

HasContentToken returns a boolean if a field has been set.

### GetEmail

`func (o *InlineResponse200304) GetEmail() string`

GetEmail returns the Email field if non-nil, zero value otherwise.

### GetEmailOk

`func (o *InlineResponse200304) GetEmailOk() (*string, bool)`
...
`func (o *InlineResponse200304) SetEmail(v string)`

SetEmail sets Email field to given value.

### HasEmail

`func (o *InlineResponse200304) HasEmail() bool`
...
`func (o *InlineResponse200304) GetAllowedAdmins() string`

GetAllowedAdmins returns the AllowedAdmins field if non-nil, zero value otherwise.

### GetAllowedAdminsOk

`func (o *InlineResponse200304) GetAllowedAdminsOk() (*string, bool)`
...
`func (o *InlineResponse200304) SetVppLocationName(v string)`

SetVppLocationName sets VppLocationName field to given value.

### HasVppLocationName

`func (o *InlineResponse200304) HasVppLocationName() bool`

HasVppLocationName returns a boolean if a field has been set.

### GetLastSyncedAt

`func (o *InlineResponse200304) GetLastSyncedAt() string`

GetLastSyncedAt returns the LastSyncedAt field if non-nil, zero value otherwise.

### GetLastSyncedAtOk

`func (o *InlineResponse200304) GetLastSyncedAtOk() (*string, bool)`
...
`func (o *InlineResponse200304) SetLastForceSyncedAt(v string)`

SetLastForceSyncedAt sets LastForceSyncedAt field to given value.

### HasLastForceSyncedAt

`func (o *InlineResponse200304) HasLastForceSyncedAt() bool`

HasLastForceSyncedAt returns a boolean if a field has been set.

### GetParsedToken

`func (o *InlineResponse200304) GetParsedToken() OrganizationsOrganizationIdSmVppAccountsParsedToken`

GetParsedToken returns the ParsedToken field if non-nil, zero value otherwise.

### GetParsedTokenOk

`func (o *InlineResponse200304) GetParsedTokenOk() (*OrganizationsOrganizationIdSmVppAccountsParsedToken, bool)`
...
`func (o *InlineResponse200304) SetParsedToken(v OrganizationsOrganizationIdSmVppAccountsParsedToken)`

SetParsedToken sets ParsedToken field to given value.

### HasParsedToken

`func (o *InlineResponse200304) HasParsedToken() bool`
...
`func (o *InlineResponse200304) GetVppServiceToken() string`

GetVppServiceToken returns the VppServiceToken field if non-nil, zero value otherwise.

### GetVppServiceTokenOk

`func (o *InlineResponse200304) GetVppServiceTokenOk() (*string, bool)`
...
`func (o *InlineResponse200304) SetVppServiceToken(v string)`

SetVppServiceToken sets VppServiceToken field to given value.

### HasVppServiceToken

`func (o *InlineResponse200304) HasVppServiceToken() bool`
