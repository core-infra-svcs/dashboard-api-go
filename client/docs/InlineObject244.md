...
`func NewInlineObject244(name string, productTypes []string, ) *InlineObject244`
...
`func (o *InlineObject244) GetProductTypes() []string`

GetProductTypes returns the ProductTypes field if non-nil, zero value otherwise.

### GetProductTypesOk

`func (o *InlineObject244) GetProductTypesOk() (*[]string, bool)`
...
`func (o *InlineObject244) SetProductTypes(v []string)`
...
`func (o *InlineObject244) GetTags() []string`

GetTags returns the Tags field if non-nil, zero value otherwise.

### GetTagsOk

`func (o *InlineObject244) GetTagsOk() (*[]string, bool)`
...
`func (o *InlineObject244) SetTags(v []string)`
...
`func (o *InlineObject244) GetTimeZone() string`

GetTimeZone returns the TimeZone field if non-nil, zero value otherwise.

### GetTimeZoneOk

`func (o *InlineObject244) GetTimeZoneOk() (*string, bool)`
...
`func (o *InlineObject244) SetTimeZone(v string)`

SetTimeZone sets TimeZone field to given value.

### HasTimeZone

`func (o *InlineObject244) HasTimeZone() bool`

HasTimeZone returns a boolean if a field has been set.

### GetCopyFromNetworkId

`func (o *InlineObject244) GetCopyFromNetworkId() string`

GetCopyFromNetworkId returns the CopyFromNetworkId field if non-nil, zero value otherwise.

### GetCopyFromNetworkIdOk

`func (o *InlineObject244) GetCopyFromNetworkIdOk() (*string, bool)`
...
`func (o *InlineObject244) SetCopyFromNetworkId(v string)`

SetCopyFromNetworkId sets CopyFromNetworkId field to given value.

### HasCopyFromNetworkId

`func (o *InlineObject244) HasCopyFromNetworkId() bool`

HasCopyFromNetworkId returns a boolean if a field has been set.

### GetNotes

`func (o *InlineObject244) GetNotes() string`

GetNotes returns the Notes field if non-nil, zero value otherwise.

### GetNotesOk

`func (o *InlineObject244) GetNotesOk() (*string, bool)`
...
`func (o *InlineObject244) SetNotes(v string)`

SetNotes sets Notes field to given value.

### HasNotes

`func (o *InlineObject244) HasNotes() bool`
