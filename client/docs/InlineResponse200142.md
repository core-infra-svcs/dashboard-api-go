...
`func (o *InlineResponse200142) GetDescription() string`

GetDescription returns the Description field if non-nil, zero value otherwise.

### GetDescriptionOk

`func (o *InlineResponse200142) GetDescriptionOk() (*string, bool)`
...
`func (o *InlineResponse200142) SetDescription(v string)`

SetDescription sets Description field to given value.

### HasDescription

`func (o *InlineResponse200142) HasDescription() bool`
...
`func (o *InlineResponse200142) GetPayloadTypes() []string`

GetPayloadTypes returns the PayloadTypes field if non-nil, zero value otherwise.

### GetPayloadTypesOk

`func (o *InlineResponse200142) GetPayloadTypesOk() (*[]string, bool)`
...
`func (o *InlineResponse200142) SetPayloadTypes(v []string)`

SetPayloadTypes sets PayloadTypes field to given value.

### HasPayloadTypes

`func (o *InlineResponse200142) HasPayloadTypes() bool`
