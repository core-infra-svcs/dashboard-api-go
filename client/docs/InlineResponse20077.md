...
`func (o *InlineResponse20077) GetCustomPerformanceClassId() string`
...
`func (o *InlineResponse20077) GetCustomPerformanceClassIdOk() (*string, bool)`
...
`func (o *InlineResponse20077) SetMaxLatency(v int32)`

SetMaxLatency sets MaxLatency field to given value.

### HasMaxLatency

`func (o *InlineResponse20077) HasMaxLatency() bool`

HasMaxLatency returns a boolean if a field has been set.

### GetMaxJitter

`func (o *InlineResponse20077) GetMaxJitter() int32`

GetMaxJitter returns the MaxJitter field if non-nil, zero value otherwise.

### GetMaxJitterOk

`func (o *InlineResponse20077) GetMaxJitterOk() (*int32, bool)`
...
`func (o *InlineResponse20077) SetMaxLossPercentage(v int32)`

SetMaxLossPercentage sets MaxLossPercentage field to given value.

### HasMaxLossPercentage

`func (o *InlineResponse20077) HasMaxLossPercentage() bool`
