...
`func NewInlineObject106(interfaceIp string, multicastGroup string, ) *InlineObject106`
...
`func (o *InlineObject106) GetInterfaceIp() string`

GetInterfaceIp returns the InterfaceIp field if non-nil, zero value otherwise.

### GetInterfaceIpOk

`func (o *InlineObject106) GetInterfaceIpOk() (*string, bool)`
...
`func (o *InlineObject106) SetInterfaceIp(v string)`
...
`func (o *InlineObject106) GetMulticastGroup() string`

GetMulticastGroup returns the MulticastGroup field if non-nil, zero value otherwise.

### GetMulticastGroupOk

`func (o *InlineObject106) GetMulticastGroupOk() (*string, bool)`
...
`func (o *InlineObject106) SetMulticastGroup(v string)`
