...
`func NewInlineObject98(serial string, ) *InlineObject98`
...
`func (o *InlineObject98) GetSerial() string`

GetSerial returns the Serial field if non-nil, zero value otherwise.

### GetSerialOk

`func (o *InlineObject98) GetSerialOk() (*string, bool)`
...
`func (o *InlineObject98) SetSerial(v string)`
