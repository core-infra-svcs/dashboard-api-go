...
`func (o *InlineResponse200270Items) GetTarget() string`

GetTarget returns the Target field if non-nil, zero value otherwise.

### GetTargetOk

`func (o *InlineResponse200270Items) GetTargetOk() (*string, bool)`
...
`func (o *InlineResponse200270Items) SetTarget(v string)`

SetTarget sets Target field to given value.

### HasTarget

`func (o *InlineResponse200270Items) HasTarget() bool`

HasTarget returns a boolean if a field has been set.

### GetCreatedAt

`func (o *InlineResponse200270Items) GetCreatedAt() time.Time`

GetCreatedAt returns the CreatedAt field if non-nil, zero value otherwise.

### GetCreatedAtOk

`func (o *InlineResponse200270Items) GetCreatedAtOk() (*time.Time, bool)`
...
`func (o *InlineResponse200270Items) SetCreatedAt(v time.Time)`
...
`func (o *InlineResponse200270Items) GetMigratedAt() time.Time`

GetMigratedAt returns the MigratedAt field if non-nil, zero value otherwise.

### GetMigratedAtOk

`func (o *InlineResponse200270Items) GetMigratedAtOk() (*time.Time, bool)`
...
`func (o *InlineResponse200270Items) SetMigratedAt(v time.Time)`

SetMigratedAt sets MigratedAt field to given value.

### HasMigratedAt

`func (o *InlineResponse200270Items) HasMigratedAt() bool`
