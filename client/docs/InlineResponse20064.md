...
`func (o *InlineResponse20064) GetCustomPerformanceClassId() string`
...
`func (o *InlineResponse20064) GetCustomPerformanceClassIdOk() (*string, bool)`
...
`func (o *InlineResponse20064) SetMaxLatency(v int32)`

SetMaxLatency sets MaxLatency field to given value.

### HasMaxLatency

`func (o *InlineResponse20064) HasMaxLatency() bool`

HasMaxLatency returns a boolean if a field has been set.

### GetMaxJitter

`func (o *InlineResponse20064) GetMaxJitter() int32`

GetMaxJitter returns the MaxJitter field if non-nil, zero value otherwise.

### GetMaxJitterOk

`func (o *InlineResponse20064) GetMaxJitterOk() (*int32, bool)`
...
`func (o *InlineResponse20064) SetMaxLossPercentage(v int32)`

SetMaxLossPercentage sets MaxLossPercentage field to given value.

### HasMaxLossPercentage

`func (o *InlineResponse20064) HasMaxLossPercentage() bool`
