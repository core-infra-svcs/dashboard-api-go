...
`func (o *InlineResponse200306) GetShortName() string`

GetShortName returns the ShortName field if non-nil, zero value otherwise.

### GetShortNameOk

`func (o *InlineResponse200306) GetShortNameOk() (*string, bool)`
...
`func (o *InlineResponse200306) SetShortName(v string)`

SetShortName sets ShortName field to given value.

### HasShortName

`func (o *InlineResponse200306) HasShortName() bool`
...
`func (o *InlineResponse200306) GetDescriptions() OrganizationsOrganizationIdEarlyAccessFeaturesDescriptions`

GetDescriptions returns the Descriptions field if non-nil, zero value otherwise.

### GetDescriptionsOk

`func (o *InlineResponse200306) GetDescriptionsOk() (*OrganizationsOrganizationIdEarlyAccessFeaturesDescriptions, bool)`
...
`func (o *InlineResponse200306) SetDescriptions(v OrganizationsOrganizationIdEarlyAccessFeaturesDescriptions)`

SetDescriptions sets Descriptions field to given value.

### HasDescriptions

`func (o *InlineResponse200306) HasDescriptions() bool`

HasDescriptions returns a boolean if a field has been set.

### GetTopic

`func (o *InlineResponse200306) GetTopic() string`

GetTopic returns the Topic field if non-nil, zero value otherwise.

### GetTopicOk

`func (o *InlineResponse200306) GetTopicOk() (*string, bool)`
...
`func (o *InlineResponse200306) SetTopic(v string)`

SetTopic sets Topic field to given value.

### HasTopic

`func (o *InlineResponse200306) HasTopic() bool`

HasTopic returns a boolean if a field has been set.

### GetIsOrgScopedOnly

`func (o *InlineResponse200306) GetIsOrgScopedOnly() bool`

GetIsOrgScopedOnly returns the IsOrgScopedOnly field if non-nil, zero value otherwise.

### GetIsOrgScopedOnlyOk

`func (o *InlineResponse200306) GetIsOrgScopedOnlyOk() (*bool, bool)`
...
`func (o *InlineResponse200306) SetSupportLink(v string)`

SetSupportLink sets SupportLink field to given value.

### HasSupportLink

`func (o *InlineResponse200306) HasSupportLink() bool`

HasSupportLink returns a boolean if a field has been set.

### GetPrivacyLink

`func (o *InlineResponse200306) GetPrivacyLink() string`

GetPrivacyLink returns the PrivacyLink field if non-nil, zero value otherwise.

### GetPrivacyLinkOk

`func (o *InlineResponse200306) GetPrivacyLinkOk() (*string, bool)`
...
`func (o *InlineResponse200306) SetPrivacyLink(v string)`

SetPrivacyLink sets PrivacyLink field to given value.

### HasPrivacyLink

`func (o *InlineResponse200306) HasPrivacyLink() bool`
