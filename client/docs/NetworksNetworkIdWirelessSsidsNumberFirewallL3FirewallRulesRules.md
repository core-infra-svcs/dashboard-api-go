...
**IpVer** | Pointer to **string** | IP version to which this rule applies (must be one of &#39;both&#39;, &#39;ipv4&#39; or &#39;ipv6&#39;). Defaults to &#39;both&#39; if not specified. | [optional] [default to "both"]
...
`func (o *NetworksNetworkIdWirelessSsidsNumberFirewallL3FirewallRulesRules) GetIpVer() string`

GetIpVer returns the IpVer field if non-nil, zero value otherwise.

### GetIpVerOk

`func (o *NetworksNetworkIdWirelessSsidsNumberFirewallL3FirewallRulesRules) GetIpVerOk() (*string, bool)`
...
`func (o *NetworksNetworkIdWirelessSsidsNumberFirewallL3FirewallRulesRules) SetIpVer(v string)`

SetIpVer sets IpVer field to given value.

### HasIpVer

`func (o *NetworksNetworkIdWirelessSsidsNumberFirewallL3FirewallRulesRules) HasIpVer() bool`
