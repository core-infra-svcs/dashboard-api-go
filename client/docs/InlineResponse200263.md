...
------------ | ------------- | ------------- | -------------
**ResultingNetwork** | Pointer to [**InlineResponse200263ResultingNetwork**](InlineResponse200263ResultingNetwork.md) |  | [optional] 
...
`func (o *InlineResponse200263) GetResultingNetwork() InlineResponse200263ResultingNetwork`

GetResultingNetwork returns the ResultingNetwork field if non-nil, zero value otherwise.

### GetResultingNetworkOk

`func (o *InlineResponse200263) GetResultingNetworkOk() (*InlineResponse200263ResultingNetwork, bool)`
...
`func (o *InlineResponse200263) SetResultingNetwork(v InlineResponse200263ResultingNetwork)`

SetResultingNetwork sets ResultingNetwork field to given value.

### HasResultingNetwork

`func (o *InlineResponse200263) HasResultingNetwork() bool`
