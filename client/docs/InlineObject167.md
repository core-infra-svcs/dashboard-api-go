...
`func (o *InlineObject167) GetSubnet() string`

GetSubnet returns the Subnet field if non-nil, zero value otherwise.

### GetSubnetOk

`func (o *InlineObject167) GetSubnetOk() (*string, bool)`
...
`func (o *InlineObject167) SetSubnet(v string)`

SetSubnet sets Subnet field to given value.

### HasSubnet

`func (o *InlineObject167) HasSubnet() bool`

HasSubnet returns a boolean if a field has been set.

### GetNextHopIp

`func (o *InlineObject167) GetNextHopIp() string`

GetNextHopIp returns the NextHopIp field if non-nil, zero value otherwise.

### GetNextHopIpOk

`func (o *InlineObject167) GetNextHopIpOk() (*string, bool)`
...
`func (o *InlineObject167) GetAdvertiseViaOspfEnabled() bool`
...
`func (o *InlineObject167) GetAdvertiseViaOspfEnabledOk() (*bool, bool)`
...
`func (o *InlineObject167) SetAdvertiseViaOspfEnabled(v bool)`

SetAdvertiseViaOspfEnabled sets AdvertiseViaOspfEnabled field to given value.

### HasAdvertiseViaOspfEnabled

`func (o *InlineObject167) HasAdvertiseViaOspfEnabled() bool`

HasAdvertiseViaOspfEnabled returns a boolean if a field has been set.

### GetPreferOverOspfRoutesEnabled

`func (o *InlineObject167) GetPreferOverOspfRoutesEnabled() bool`
...
`func (o *InlineObject167) GetPreferOverOspfRoutesEnabledOk() (*bool, bool)`
...
`func (o *InlineObject167) SetPreferOverOspfRoutesEnabled(v bool)`

SetPreferOverOspfRoutesEnabled sets PreferOverOspfRoutesEnabled field to given value.

### HasPreferOverOspfRoutesEnabled

`func (o *InlineObject167) HasPreferOverOspfRoutesEnabled() bool`

HasPreferOverOspfRoutesEnabled returns a boolean if a field has been set.

### GetVrf

`func (o *InlineObject167) GetVrf() DevicesSerialSwitchRoutingStaticRoutesVrf1`

GetVrf returns the Vrf field if non-nil, zero value otherwise.

### GetVrfOk

`func (o *InlineObject167) GetVrfOk() (*DevicesSerialSwitchRoutingStaticRoutesVrf1, bool)`
...
`func (o *InlineObject167) SetVrf(v DevicesSerialSwitchRoutingStaticRoutesVrf1)`

SetVrf sets Vrf field to given value.

### HasVrf

`func (o *InlineObject167) HasVrf() bool`
