...
`func (o *InlineObject167) GetMode() string`

GetMode returns the Mode field if non-nil, zero value otherwise.

### GetModeOk

`func (o *InlineObject167) GetModeOk() (*string, bool)`
...
`func (o *InlineObject167) SetMode(v string)`

SetMode sets Mode field to given value.

### HasMode

`func (o *InlineObject167) HasMode() bool`

HasMode returns a boolean if a field has been set.

### GetCustomPieChartItems

`func (o *InlineObject167) GetCustomPieChartItems() []InlineResponse200173CustomPieChartItems`

GetCustomPieChartItems returns the CustomPieChartItems field if non-nil, zero value otherwise.

### GetCustomPieChartItemsOk

`func (o *InlineObject167) GetCustomPieChartItemsOk() (*[]InlineResponse200173CustomPieChartItems, bool)`
...
`func (o *InlineObject167) SetCustomPieChartItems(v []InlineResponse200173CustomPieChartItems)`

SetCustomPieChartItems sets CustomPieChartItems field to given value.

### HasCustomPieChartItems

`func (o *InlineObject167) HasCustomPieChartItems() bool`
