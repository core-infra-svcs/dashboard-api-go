...
`func (o *InlineResponse20041) GetApEslId() int32`

GetApEslId returns the ApEslId field if non-nil, zero value otherwise.

### GetApEslIdOk

`func (o *InlineResponse20041) GetApEslIdOk() (*int32, bool)`
...
`func (o *InlineResponse20041) SetApEslId(v int32)`

SetApEslId sets ApEslId field to given value.

### HasApEslId

`func (o *InlineResponse20041) HasApEslId() bool`
...
`func (o *InlineResponse20041) GetChannel() string`

GetChannel returns the Channel field if non-nil, zero value otherwise.

### GetChannelOk

`func (o *InlineResponse20041) GetChannelOk() (*string, bool)`
...
`func (o *InlineResponse20041) SetChannel(v string)`

SetChannel sets Channel field to given value.

### HasChannel

`func (o *InlineResponse20041) HasChannel() bool`
...
`func (o *InlineResponse20041) GetNetworkId() string`

GetNetworkId returns the NetworkId field if non-nil, zero value otherwise.

### GetNetworkIdOk

`func (o *InlineResponse20041) GetNetworkIdOk() (*string, bool)`
...
`func (o *InlineResponse20041) SetNetworkId(v string)`

SetNetworkId sets NetworkId field to given value.

### HasNetworkId

`func (o *InlineResponse20041) HasNetworkId() bool`

HasNetworkId returns a boolean if a field has been set.

### GetHostname

`func (o *InlineResponse20041) GetHostname() string`

GetHostname returns the Hostname field if non-nil, zero value otherwise.

### GetHostnameOk

`func (o *InlineResponse20041) GetHostnameOk() (*string, bool)`
...
`func (o *InlineResponse20041) SetHostname(v string)`

SetHostname sets Hostname field to given value.

### HasHostname

`func (o *InlineResponse20041) HasHostname() bool`

HasHostname returns a boolean if a field has been set.

### GetProvider

`func (o *InlineResponse20041) GetProvider() string`

GetProvider returns the Provider field if non-nil, zero value otherwise.

### GetProviderOk

`func (o *InlineResponse20041) GetProviderOk() (*string, bool)`
...
`func (o *InlineResponse20041) SetProvider(v string)`

SetProvider sets Provider field to given value.

### HasProvider

`func (o *InlineResponse20041) HasProvider() bool`
