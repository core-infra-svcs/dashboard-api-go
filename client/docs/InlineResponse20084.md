...
`func (o *InlineResponse20084) GetPortSchedule() NetworksNetworkIdSwitchPortSchedulesPortSchedule`

GetPortSchedule returns the PortSchedule field if non-nil, zero value otherwise.

### GetPortScheduleOk

`func (o *InlineResponse20084) GetPortScheduleOk() (*NetworksNetworkIdSwitchPortSchedulesPortSchedule, bool)`
...
`func (o *InlineResponse20084) SetPortSchedule(v NetworksNetworkIdSwitchPortSchedulesPortSchedule)`

SetPortSchedule sets PortSchedule field to given value.

### HasPortSchedule

`func (o *InlineResponse20084) HasPortSchedule() bool`
