...
`func (o *InlineObject59) GetMaxLatency() int32`

GetMaxLatency returns the MaxLatency field if non-nil, zero value otherwise.

### GetMaxLatencyOk

`func (o *InlineObject59) GetMaxLatencyOk() (*int32, bool)`
...
`func (o *InlineObject59) SetMaxLossPercentage(v int32)`

SetMaxLossPercentage sets MaxLossPercentage field to given value.

### HasMaxLossPercentage

`func (o *InlineObject59) HasMaxLossPercentage() bool`
