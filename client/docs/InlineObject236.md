...
`func NewInlineObject236(name string, networkIds []string, ) *InlineObject236`
...
`func (o *InlineObject236) GetNetworkIds() []string`

GetNetworkIds returns the NetworkIds field if non-nil, zero value otherwise.

### GetNetworkIdsOk

`func (o *InlineObject236) GetNetworkIdsOk() (*[]string, bool)`
...
`func (o *InlineObject236) SetNetworkIds(v []string)`
...
`func (o *InlineObject236) GetEnrollmentString() string`

GetEnrollmentString returns the EnrollmentString field if non-nil, zero value otherwise.

### GetEnrollmentStringOk

`func (o *InlineObject236) GetEnrollmentStringOk() (*string, bool)`
...
`func (o *InlineObject236) SetEnrollmentString(v string)`

SetEnrollmentString sets EnrollmentString field to given value.

### HasEnrollmentString

`func (o *InlineObject236) HasEnrollmentString() bool`
