...
**States** | Pointer to [**InlineResponse200272States**](InlineResponse200272States.md) |  | [optional] 
**LicenseTypes** | Pointer to [**[]InlineResponse200272LicenseTypes**](InlineResponse200272LicenseTypes.md) | Data by license type (Per-device licensing only) | [optional] 
**SystemsManager** | Pointer to [**InlineResponse200272SystemsManager**](InlineResponse200272SystemsManager.md) |  | [optional] 
...
`func (o *InlineResponse200272) HasStatus() bool`

HasStatus returns a boolean if a field has been set.

### GetExpirationDate

`func (o *InlineResponse200272) GetExpirationDate() string`

GetExpirationDate returns the ExpirationDate field if non-nil, zero value otherwise.

### GetExpirationDateOk

`func (o *InlineResponse200272) GetExpirationDateOk() (*string, bool)`
...
`func (o *InlineResponse200272) SetExpirationDate(v string)`

SetExpirationDate sets ExpirationDate field to given value.

### HasExpirationDate

`func (o *InlineResponse200272) HasExpirationDate() bool`

HasExpirationDate returns a boolean if a field has been set.

### GetLicensedDeviceCounts

`func (o *InlineResponse200272) GetLicensedDeviceCounts() map[string]int32`

GetLicensedDeviceCounts returns the LicensedDeviceCounts field if non-nil, zero value otherwise.

### GetLicensedDeviceCountsOk

`func (o *InlineResponse200272) GetLicensedDeviceCountsOk() (*map[string]int32, bool)`
...
`func (o *InlineResponse200272) SetLicenseCount(v int32)`

SetLicenseCount sets LicenseCount field to given value.

### HasLicenseCount

`func (o *InlineResponse200272) HasLicenseCount() bool`

HasLicenseCount returns a boolean if a field has been set.

### GetStates

`func (o *InlineResponse200272) GetStates() InlineResponse200272States`

GetStates returns the States field if non-nil, zero value otherwise.

### GetStatesOk

`func (o *InlineResponse200272) GetStatesOk() (*InlineResponse200272States, bool)`
...
`func (o *InlineResponse200272) SetStates(v InlineResponse200272States)`

SetStates sets States field to given value.

### HasStates

`func (o *InlineResponse200272) HasStates() bool`

HasStates returns a boolean if a field has been set.

### GetLicenseTypes

`func (o *InlineResponse200272) GetLicenseTypes() []InlineResponse200272LicenseTypes`

GetLicenseTypes returns the LicenseTypes field if non-nil, zero value otherwise.

### GetLicenseTypesOk

`func (o *InlineResponse200272) GetLicenseTypesOk() (*[]InlineResponse200272LicenseTypes, bool)`
...
`func (o *InlineResponse200272) SetLicenseTypes(v []InlineResponse200272LicenseTypes)`

SetLicenseTypes sets LicenseTypes field to given value.

### HasLicenseTypes

`func (o *InlineResponse200272) HasLicenseTypes() bool`

HasLicenseTypes returns a boolean if a field has been set.

### GetSystemsManager

`func (o *InlineResponse200272) GetSystemsManager() InlineResponse200272SystemsManager`

GetSystemsManager returns the SystemsManager field if non-nil, zero value otherwise.

### GetSystemsManagerOk

`func (o *InlineResponse200272) GetSystemsManagerOk() (*InlineResponse200272SystemsManager, bool)`
...
`func (o *InlineResponse200272) SetSystemsManager(v InlineResponse200272SystemsManager)`

SetSystemsManager sets SystemsManager field to given value.

### HasSystemsManager

`func (o *InlineResponse200272) HasSystemsManager() bool`
