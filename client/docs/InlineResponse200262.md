...
`func NewInlineResponse200262(type_ string, title string, categoryType string, severities []OrganizationsOrganizationIdAssuranceAlertsTaxonomyTypesSeverities, deviceTypes []string, ) *InlineResponse200262`
...
`func (o *InlineResponse200262) GetTitle() string`

GetTitle returns the Title field if non-nil, zero value otherwise.

### GetTitleOk

`func (o *InlineResponse200262) GetTitleOk() (*string, bool)`
...
`func (o *InlineResponse200262) SetTitle(v string)`
...
`func (o *InlineResponse200262) GetCategoryType() string`

GetCategoryType returns the CategoryType field if non-nil, zero value otherwise.

### GetCategoryTypeOk

`func (o *InlineResponse200262) GetCategoryTypeOk() (*string, bool)`
...
`func (o *InlineResponse200262) SetCategoryType(v string)`
...
`func (o *InlineResponse200262) GetSeverities() []OrganizationsOrganizationIdAssuranceAlertsTaxonomyTypesSeverities`

GetSeverities returns the Severities field if non-nil, zero value otherwise.

### GetSeveritiesOk

`func (o *InlineResponse200262) GetSeveritiesOk() (*[]OrganizationsOrganizationIdAssuranceAlertsTaxonomyTypesSeverities, bool)`
...
`func (o *InlineResponse200262) SetSeverities(v []OrganizationsOrganizationIdAssuranceAlertsTaxonomyTypesSeverities)`
...
`func (o *InlineResponse200262) GetDeviceTypes() []string`

GetDeviceTypes returns the DeviceTypes field if non-nil, zero value otherwise.

### GetDeviceTypesOk

`func (o *InlineResponse200262) GetDeviceTypesOk() (*[]string, bool)`
...
`func (o *InlineResponse200262) SetDeviceTypes(v []string)`
