...
**States** | Pointer to [**InlineResponse200286States**](InlineResponse200286States.md) |  | [optional] 
**LicenseTypes** | Pointer to [**[]InlineResponse200286LicenseTypes**](InlineResponse200286LicenseTypes.md) | Data by license type (Per-device licensing only) | [optional] 
**SystemsManager** | Pointer to [**InlineResponse200286SystemsManager**](InlineResponse200286SystemsManager.md) |  | [optional] 
...
`func (o *InlineResponse200286) GetExpirationDate() string`

GetExpirationDate returns the ExpirationDate field if non-nil, zero value otherwise.

### GetExpirationDateOk

`func (o *InlineResponse200286) GetExpirationDateOk() (*string, bool)`
...
`func (o *InlineResponse200286) SetExpirationDate(v string)`

SetExpirationDate sets ExpirationDate field to given value.

### HasExpirationDate

`func (o *InlineResponse200286) HasExpirationDate() bool`

HasExpirationDate returns a boolean if a field has been set.

### GetLicensedDeviceCounts

`func (o *InlineResponse200286) GetLicensedDeviceCounts() map[string]int32`

GetLicensedDeviceCounts returns the LicensedDeviceCounts field if non-nil, zero value otherwise.

### GetLicensedDeviceCountsOk

`func (o *InlineResponse200286) GetLicensedDeviceCountsOk() (*map[string]int32, bool)`
...
`func (o *InlineResponse200286) SetLicenseCount(v int32)`

SetLicenseCount sets LicenseCount field to given value.

### HasLicenseCount

`func (o *InlineResponse200286) HasLicenseCount() bool`

HasLicenseCount returns a boolean if a field has been set.

### GetStates

`func (o *InlineResponse200286) GetStates() InlineResponse200286States`

GetStates returns the States field if non-nil, zero value otherwise.

### GetStatesOk

`func (o *InlineResponse200286) GetStatesOk() (*InlineResponse200286States, bool)`
...
`func (o *InlineResponse200286) SetStates(v InlineResponse200286States)`

SetStates sets States field to given value.

### HasStates

`func (o *InlineResponse200286) HasStates() bool`

HasStates returns a boolean if a field has been set.

### GetLicenseTypes

`func (o *InlineResponse200286) GetLicenseTypes() []InlineResponse200286LicenseTypes`

GetLicenseTypes returns the LicenseTypes field if non-nil, zero value otherwise.

### GetLicenseTypesOk

`func (o *InlineResponse200286) GetLicenseTypesOk() (*[]InlineResponse200286LicenseTypes, bool)`
...
`func (o *InlineResponse200286) SetLicenseTypes(v []InlineResponse200286LicenseTypes)`

SetLicenseTypes sets LicenseTypes field to given value.

### HasLicenseTypes

`func (o *InlineResponse200286) HasLicenseTypes() bool`

HasLicenseTypes returns a boolean if a field has been set.

### GetSystemsManager

`func (o *InlineResponse200286) GetSystemsManager() InlineResponse200286SystemsManager`

GetSystemsManager returns the SystemsManager field if non-nil, zero value otherwise.

### GetSystemsManagerOk

`func (o *InlineResponse200286) GetSystemsManagerOk() (*InlineResponse200286SystemsManager, bool)`
...
`func (o *InlineResponse200286) SetSystemsManager(v InlineResponse200286SystemsManager)`

SetSystemsManager sets SystemsManager field to given value.

### HasSystemsManager

`func (o *InlineResponse200286) HasSystemsManager() bool`
