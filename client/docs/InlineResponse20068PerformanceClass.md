# InlineResponse20068PerformanceClass
...
### NewInlineResponse20068PerformanceClass

`func NewInlineResponse20068PerformanceClass(type_ string, ) *InlineResponse20068PerformanceClass`

NewInlineResponse20068PerformanceClass instantiates a new InlineResponse20068PerformanceClass object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewInlineResponse20068PerformanceClassWithDefaults

`func NewInlineResponse20068PerformanceClassWithDefaults() *InlineResponse20068PerformanceClass`

NewInlineResponse20068PerformanceClassWithDefaults instantiates a new InlineResponse20068PerformanceClass object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetType

`func (o *InlineResponse20068PerformanceClass) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InlineResponse20068PerformanceClass) GetTypeOk() (*string, bool)`
...
`func (o *InlineResponse20068PerformanceClass) SetType(v string)`
...
`func (o *InlineResponse20068PerformanceClass) GetBuiltinPerformanceClassName() string`
...
`func (o *InlineResponse20068PerformanceClass) GetBuiltinPerformanceClassNameOk() (*string, bool)`
...
`func (o *InlineResponse20068PerformanceClass) SetBuiltinPerformanceClassName(v string)`

SetBuiltinPerformanceClassName sets BuiltinPerformanceClassName field to given value.

### HasBuiltinPerformanceClassName

`func (o *InlineResponse20068PerformanceClass) HasBuiltinPerformanceClassName() bool`

HasBuiltinPerformanceClassName returns a boolean if a field has been set.

### GetCustomPerformanceClassId

`func (o *InlineResponse20068PerformanceClass) GetCustomPerformanceClassId() string`
...
`func (o *InlineResponse20068PerformanceClass) GetCustomPerformanceClassIdOk() (*string, bool)`
...
`func (o *InlineResponse20068PerformanceClass) SetCustomPerformanceClassId(v string)`

SetCustomPerformanceClassId sets CustomPerformanceClassId field to given value.

### HasCustomPerformanceClassId

`func (o *InlineResponse20068PerformanceClass) HasCustomPerformanceClassId() bool`
