...
`func (o *InlineResponse200126) GetVppServiceToken() string`

GetVppServiceToken returns the VppServiceToken field if non-nil, zero value otherwise.

### GetVppServiceTokenOk

`func (o *InlineResponse200126) GetVppServiceTokenOk() (*string, bool)`
...
`func (o *InlineResponse200126) SetVppServiceToken(v string)`

SetVppServiceToken sets VppServiceToken field to given value.

### HasVppServiceToken

`func (o *InlineResponse200126) HasVppServiceToken() bool`
