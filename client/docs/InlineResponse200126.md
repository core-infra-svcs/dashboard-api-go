...
`func (o *InlineResponse200126) GetNewNetwork() string`

GetNewNetwork returns the NewNetwork field if non-nil, zero value otherwise.

### GetNewNetworkOk

`func (o *InlineResponse200126) GetNewNetworkOk() (*string, bool)`
...
`func (o *InlineResponse200126) SetNewNetwork(v string)`

SetNewNetwork sets NewNetwork field to given value.

### HasNewNetwork

`func (o *InlineResponse200126) HasNewNetwork() bool`
