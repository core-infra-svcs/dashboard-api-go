...
`func NewInlineObject214(sourceSerial string, targetSerials []string, ) *InlineObject214`
...
`func (o *InlineObject214) GetSourceSerial() string`

GetSourceSerial returns the SourceSerial field if non-nil, zero value otherwise.

### GetSourceSerialOk

`func (o *InlineObject214) GetSourceSerialOk() (*string, bool)`
...
`func (o *InlineObject214) SetSourceSerial(v string)`
...
`func (o *InlineObject214) GetTargetSerials() []string`

GetTargetSerials returns the TargetSerials field if non-nil, zero value otherwise.

### GetTargetSerialsOk

`func (o *InlineObject214) GetTargetSerialsOk() (*[]string, bool)`
...
`func (o *InlineObject214) SetTargetSerials(v []string)`
