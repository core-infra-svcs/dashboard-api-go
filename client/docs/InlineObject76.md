...
`func NewInlineObject76(id string, name string, ) *InlineObject76`
...
`func (o *InlineObject76) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *InlineObject76) GetIdOk() (*string, bool)`
...
`func (o *InlineObject76) SetId(v string)`
