# NetworksNetworkIdWirelessEthernetPortsProfilesProfileIdPorts
...
`func (o *NetworksNetworkIdWirelessEthernetPortsProfilesProfileIdPorts) SetSsidNil(b bool)`

 SetSsidNil sets the value for Ssid to be an explicit nil

### UnsetSsid
`func (o *NetworksNetworkIdWirelessEthernetPortsProfilesProfileIdPorts) UnsetSsid()`
