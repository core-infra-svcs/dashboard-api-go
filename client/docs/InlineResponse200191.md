...
`func (o *InlineResponse200191) GetGroupPolicyId() string`

GetGroupPolicyId returns the GroupPolicyId field if non-nil, zero value otherwise.

### GetGroupPolicyIdOk

`func (o *InlineResponse200191) GetGroupPolicyIdOk() (*string, bool)`
...
`func (o *InlineResponse200191) SetGroupPolicyId(v string)`

SetGroupPolicyId sets GroupPolicyId field to given value.

### HasGroupPolicyId

`func (o *InlineResponse200191) HasGroupPolicyId() bool`

HasGroupPolicyId returns a boolean if a field has been set.

### GetPassphrase

`func (o *InlineResponse200191) GetPassphrase() string`

GetPassphrase returns the Passphrase field if non-nil, zero value otherwise.

### GetPassphraseOk

`func (o *InlineResponse200191) GetPassphraseOk() (*string, bool)`
...
`func (o *InlineResponse200191) SetPassphrase(v string)`

SetPassphrase sets Passphrase field to given value.

### HasPassphrase

`func (o *InlineResponse200191) HasPassphrase() bool`

HasPassphrase returns a boolean if a field has been set.

### GetWifiPersonalNetworkId

`func (o *InlineResponse200191) GetWifiPersonalNetworkId() string`
...
`func (o *InlineResponse200191) GetWifiPersonalNetworkIdOk() (*string, bool)`
...
`func (o *InlineResponse200191) SetWifiPersonalNetworkId(v string)`

SetWifiPersonalNetworkId sets WifiPersonalNetworkId field to given value.

### HasWifiPersonalNetworkId

`func (o *InlineResponse200191) HasWifiPersonalNetworkId() bool`
...
`func (o *InlineResponse200191) GetExpiresAt() time.Time`

GetExpiresAt returns the ExpiresAt field if non-nil, zero value otherwise.

### GetExpiresAtOk

`func (o *InlineResponse200191) GetExpiresAtOk() (*time.Time, bool)`
...
`func (o *InlineResponse200191) SetExpiresAt(v time.Time)`

SetExpiresAt sets ExpiresAt field to given value.

### HasExpiresAt

`func (o *InlineResponse200191) HasExpiresAt() bool`
