...
`func NewInlineObject258(name string, networkIds []string, ) *InlineObject258`
...
`func (o *InlineObject258) GetNetworkIds() []string`

GetNetworkIds returns the NetworkIds field if non-nil, zero value otherwise.

### GetNetworkIdsOk

`func (o *InlineObject258) GetNetworkIdsOk() (*[]string, bool)`
...
`func (o *InlineObject258) SetNetworkIds(v []string)`
...
`func (o *InlineObject258) GetEnrollmentString() string`

GetEnrollmentString returns the EnrollmentString field if non-nil, zero value otherwise.

### GetEnrollmentStringOk

`func (o *InlineObject258) GetEnrollmentStringOk() (*string, bool)`
...
`func (o *InlineObject258) SetEnrollmentString(v string)`

SetEnrollmentString sets EnrollmentString field to given value.

### HasEnrollmentString

`func (o *InlineObject258) HasEnrollmentString() bool`
