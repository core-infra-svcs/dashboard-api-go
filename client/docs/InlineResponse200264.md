...
`func (o *InlineResponse200264) GetRole() string`

GetRole returns the Role field if non-nil, zero value otherwise.

### GetRoleOk

`func (o *InlineResponse200264) GetRoleOk() (*string, bool)`
...
`func (o *InlineResponse200264) SetRole(v string)`

SetRole sets Role field to given value.

### HasRole

`func (o *InlineResponse200264) HasRole() bool`

HasRole returns a boolean if a field has been set.

### GetOrgAccess

`func (o *InlineResponse200264) GetOrgAccess() string`

GetOrgAccess returns the OrgAccess field if non-nil, zero value otherwise.

### GetOrgAccessOk

`func (o *InlineResponse200264) GetOrgAccessOk() (*string, bool)`
...
`func (o *InlineResponse200264) SetOrgAccess(v string)`

SetOrgAccess sets OrgAccess field to given value.

### HasOrgAccess

`func (o *InlineResponse200264) HasOrgAccess() bool`

HasOrgAccess returns a boolean if a field has been set.

### GetNetworks

`func (o *InlineResponse200264) GetNetworks() []OrganizationsOrganizationIdSamlRolesNetworks`

GetNetworks returns the Networks field if non-nil, zero value otherwise.

### GetNetworksOk

`func (o *InlineResponse200264) GetNetworksOk() (*[]OrganizationsOrganizationIdSamlRolesNetworks, bool)`
...
`func (o *InlineResponse200264) SetNetworks(v []OrganizationsOrganizationIdSamlRolesNetworks)`

SetNetworks sets Networks field to given value.

### HasNetworks

`func (o *InlineResponse200264) HasNetworks() bool`

HasNetworks returns a boolean if a field has been set.

### GetTags

`func (o *InlineResponse200264) GetTags() []OrganizationsOrganizationIdSamlRolesTags`

GetTags returns the Tags field if non-nil, zero value otherwise.

### GetTagsOk

`func (o *InlineResponse200264) GetTagsOk() (*[]OrganizationsOrganizationIdSamlRolesTags, bool)`
...
`func (o *InlineResponse200264) SetTags(v []OrganizationsOrganizationIdSamlRolesTags)`
...
`func (o *InlineResponse200264) GetCamera() []OrganizationsOrganizationIdSamlRolesCamera`

GetCamera returns the Camera field if non-nil, zero value otherwise.

### GetCameraOk

`func (o *InlineResponse200264) GetCameraOk() (*[]OrganizationsOrganizationIdSamlRolesCamera, bool)`
...
`func (o *InlineResponse200264) SetCamera(v []OrganizationsOrganizationIdSamlRolesCamera)`

SetCamera sets Camera field to given value.

### HasCamera

`func (o *InlineResponse200264) HasCamera() bool`
