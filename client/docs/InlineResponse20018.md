...
**ClientVpnConnections** | Pointer to [**[]InlineResponse20018ClientVpnConnections**](InlineResponse20018ClientVpnConnections.md) | VPN connections associated with the client | [optional] 
...
`func (o *InlineResponse20018) GetIp6() string`

GetIp6 returns the Ip6 field if non-nil, zero value otherwise.

### GetIp6Ok

`func (o *InlineResponse20018) GetIp6Ok() (*string, bool)`
...
`func (o *InlineResponse20018) SetIp6(v string)`

SetIp6 sets Ip6 field to given value.

### HasIp6

`func (o *InlineResponse20018) HasIp6() bool`
...
`func (o *InlineResponse20018) GetFirstSeen() int32`

GetFirstSeen returns the FirstSeen field if non-nil, zero value otherwise.

### GetFirstSeenOk

`func (o *InlineResponse20018) GetFirstSeenOk() (*int32, bool)`
...
`func (o *InlineResponse20018) SetFirstSeen(v int32)`

SetFirstSeen sets FirstSeen field to given value.

### HasFirstSeen

`func (o *InlineResponse20018) HasFirstSeen() bool`

HasFirstSeen returns a boolean if a field has been set.

### GetLastSeen

`func (o *InlineResponse20018) GetLastSeen() int32`

GetLastSeen returns the LastSeen field if non-nil, zero value otherwise.

### GetLastSeenOk

`func (o *InlineResponse20018) GetLastSeenOk() (*int32, bool)`
...
`func (o *InlineResponse20018) SetLastSeen(v int32)`

SetLastSeen sets LastSeen field to given value.

### HasLastSeen

`func (o *InlineResponse20018) HasLastSeen() bool`

HasLastSeen returns a boolean if a field has been set.

### GetManufacturer

`func (o *InlineResponse20018) GetManufacturer() string`

GetManufacturer returns the Manufacturer field if non-nil, zero value otherwise.

### GetManufacturerOk

`func (o *InlineResponse20018) GetManufacturerOk() (*string, bool)`
...
`func (o *InlineResponse20018) SetManufacturer(v string)`

SetManufacturer sets Manufacturer field to given value.

### HasManufacturer

`func (o *InlineResponse20018) HasManufacturer() bool`

HasManufacturer returns a boolean if a field has been set.

### GetOs

`func (o *InlineResponse20018) GetOs() string`

GetOs returns the Os field if non-nil, zero value otherwise.

### GetOsOk

`func (o *InlineResponse20018) GetOsOk() (*string, bool)`
...
`func (o *InlineResponse20018) SetOs(v string)`

SetOs sets Os field to given value.

### HasOs

`func (o *InlineResponse20018) HasOs() bool`
...
`func (o *InlineResponse20018) GetSsid() string`

GetSsid returns the Ssid field if non-nil, zero value otherwise.

### GetSsidOk

`func (o *InlineResponse20018) GetSsidOk() (*string, bool)`
...
`func (o *InlineResponse20018) SetSsid(v string)`

SetSsid sets Ssid field to given value.

### HasSsid

`func (o *InlineResponse20018) HasSsid() bool`
...
`func (o *InlineResponse20018) GetWirelessCapabilities() string`

GetWirelessCapabilities returns the WirelessCapabilities field if non-nil, zero value otherwise.

### GetWirelessCapabilitiesOk

`func (o *InlineResponse20018) GetWirelessCapabilitiesOk() (*string, bool)`
...
`func (o *InlineResponse20018) SetRecentDeviceMac(v string)`

SetRecentDeviceMac sets RecentDeviceMac field to given value.

### HasRecentDeviceMac

`func (o *InlineResponse20018) HasRecentDeviceMac() bool`

HasRecentDeviceMac returns a boolean if a field has been set.

### GetClientVpnConnections

`func (o *InlineResponse20018) GetClientVpnConnections() []InlineResponse20018ClientVpnConnections`

GetClientVpnConnections returns the ClientVpnConnections field if non-nil, zero value otherwise.

### GetClientVpnConnectionsOk

`func (o *InlineResponse20018) GetClientVpnConnectionsOk() (*[]InlineResponse20018ClientVpnConnections, bool)`
...
`func (o *InlineResponse20018) SetClientVpnConnections(v []InlineResponse20018ClientVpnConnections)`

SetClientVpnConnections sets ClientVpnConnections field to given value.

### HasClientVpnConnections

`func (o *InlineResponse20018) HasClientVpnConnections() bool`

HasClientVpnConnections returns a boolean if a field has been set.

### GetLldp

`func (o *InlineResponse20018) GetLldp() [][]string`

GetLldp returns the Lldp field if non-nil, zero value otherwise.

### GetLldpOk

`func (o *InlineResponse20018) GetLldpOk() (*[][]string, bool)`
...
`func (o *InlineResponse20018) SetLldp(v [][]string)`
...
`func (o *InlineResponse20018) GetCdp() [][]string`

GetCdp returns the Cdp field if non-nil, zero value otherwise.

### GetCdpOk

`func (o *InlineResponse20018) GetCdpOk() (*[][]string, bool)`
...
`func (o *InlineResponse20018) SetCdp(v [][]string)`
