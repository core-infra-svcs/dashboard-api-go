...
`func (o *InlineResponse20098) GetClientCount() int32`

GetClientCount returns the ClientCount field if non-nil, zero value otherwise.

### GetClientCountOk

`func (o *InlineResponse20098) GetClientCountOk() (*int32, bool)`
...
`func (o *InlineResponse20098) SetClientCount(v int32)`

SetClientCount sets ClientCount field to given value.

### HasClientCount

`func (o *InlineResponse20098) HasClientCount() bool`
