...
`func (o *InlineResponse200256) GetLicenseIds() []string`

GetLicenseIds returns the LicenseIds field if non-nil, zero value otherwise.

### GetLicenseIdsOk

`func (o *InlineResponse200256) GetLicenseIdsOk() (*[]string, bool)`
...
`func (o *InlineResponse200256) SetLicenseIds(v []string)`

SetLicenseIds sets LicenseIds field to given value.

### HasLicenseIds

`func (o *InlineResponse200256) HasLicenseIds() bool`
