...
`func NewInlineObject238(name string, networkIds []string, ) *InlineObject238`
...
`func (o *InlineObject238) GetNetworkIds() []string`

GetNetworkIds returns the NetworkIds field if non-nil, zero value otherwise.

### GetNetworkIdsOk

`func (o *InlineObject238) GetNetworkIdsOk() (*[]string, bool)`
...
`func (o *InlineObject238) SetNetworkIds(v []string)`
...
`func (o *InlineObject238) GetEnrollmentString() string`

GetEnrollmentString returns the EnrollmentString field if non-nil, zero value otherwise.

### GetEnrollmentStringOk

`func (o *InlineObject238) GetEnrollmentStringOk() (*string, bool)`
...
`func (o *InlineObject238) SetEnrollmentString(v string)`

SetEnrollmentString sets EnrollmentString field to given value.

### HasEnrollmentString

`func (o *InlineObject238) HasEnrollmentString() bool`
