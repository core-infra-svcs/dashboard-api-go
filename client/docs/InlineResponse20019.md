...
`func (o *InlineResponse20019) GetInterfaceId() string`

GetInterfaceId returns the InterfaceId field if non-nil, zero value otherwise.

### GetInterfaceIdOk

`func (o *InlineResponse20019) GetInterfaceIdOk() (*string, bool)`
...
`func (o *InlineResponse20019) SetInterfaceId(v string)`

SetInterfaceId sets InterfaceId field to given value.

### HasInterfaceId

`func (o *InlineResponse20019) HasInterfaceId() bool`
...
`func (o *InlineResponse20019) HasName() bool`
...
`func (o *InlineResponse20019) GetGroupPolicyId() string`

GetGroupPolicyId returns the GroupPolicyId field if non-nil, zero value otherwise.

### GetGroupPolicyIdOk

`func (o *InlineResponse20019) GetGroupPolicyIdOk() (*string, bool)`
...
`func (o *InlineResponse20019) SetGroupPolicyId(v string)`

SetGroupPolicyId sets GroupPolicyId field to given value.

### HasGroupPolicyId

`func (o *InlineResponse20019) HasGroupPolicyId() bool`

HasGroupPolicyId returns a boolean if a field has been set.

### GetTemplateVlanType

`func (o *InlineResponse20019) GetTemplateVlanType() string`

GetTemplateVlanType returns the TemplateVlanType field if non-nil, zero value otherwise.

### GetTemplateVlanTypeOk

`func (o *InlineResponse20019) GetTemplateVlanTypeOk() (*string, bool)`
...
`func (o *InlineResponse20019) SetTemplateVlanType(v string)`

SetTemplateVlanType sets TemplateVlanType field to given value.

### HasTemplateVlanType

`func (o *InlineResponse20019) HasTemplateVlanType() bool`

HasTemplateVlanType returns a boolean if a field has been set.

### GetCidr

`func (o *InlineResponse20019) GetCidr() string`

GetCidr returns the Cidr field if non-nil, zero value otherwise.

### GetCidrOk

`func (o *InlineResponse20019) GetCidrOk() (*string, bool)`
...
`func (o *InlineResponse20019) SetCidr(v string)`

SetCidr sets Cidr field to given value.

### HasCidr

`func (o *InlineResponse20019) HasCidr() bool`

HasCidr returns a boolean if a field has been set.

### GetMask

`func (o *InlineResponse20019) GetMask() int32`

GetMask returns the Mask field if non-nil, zero value otherwise.

### GetMaskOk

`func (o *InlineResponse20019) GetMaskOk() (*int32, bool)`
...
`func (o *InlineResponse20019) SetMask(v int32)`

SetMask sets Mask field to given value.

### HasMask

`func (o *InlineResponse20019) HasMask() bool`

HasMask returns a boolean if a field has been set.

### GetDhcpRelayServerIps

`func (o *InlineResponse20019) GetDhcpRelayServerIps() []string`

GetDhcpRelayServerIps returns the DhcpRelayServerIps field if non-nil, zero value otherwise.

### GetDhcpRelayServerIpsOk

`func (o *InlineResponse20019) GetDhcpRelayServerIpsOk() (*[]string, bool)`
...
`func (o *InlineResponse20019) SetDhcpHandling(v string)`

SetDhcpHandling sets DhcpHandling field to given value.

### HasDhcpHandling

`func (o *InlineResponse20019) HasDhcpHandling() bool`
...
`func (o *InlineResponse20019) GetDhcpBootOptionsEnabled() bool`
...
`func (o *InlineResponse20019) GetDhcpBootOptionsEnabledOk() (*bool, bool)`
...
`func (o *InlineResponse20019) SetDhcpBootFilename(v string)`

SetDhcpBootFilename sets DhcpBootFilename field to given value.

### HasDhcpBootFilename

`func (o *InlineResponse20019) HasDhcpBootFilename() bool`

HasDhcpBootFilename returns a boolean if a field has been set.

### GetFixedIpAssignments

`func (o *InlineResponse20019) GetFixedIpAssignments() map[string]interface{}`

GetFixedIpAssignments returns the FixedIpAssignments field if non-nil, zero value otherwise.

### GetFixedIpAssignmentsOk

`func (o *InlineResponse20019) GetFixedIpAssignmentsOk() (*map[string]interface{}, bool)`
...
`func (o *InlineResponse20019) SetFixedIpAssignments(v map[string]interface{})`
...
`func (o *InlineResponse20019) GetReservedIpRanges() []NetworksNetworkIdApplianceVlansReservedIpRanges`

GetReservedIpRanges returns the ReservedIpRanges field if non-nil, zero value otherwise.

### GetReservedIpRangesOk

`func (o *InlineResponse20019) GetReservedIpRangesOk() (*[]NetworksNetworkIdApplianceVlansReservedIpRanges, bool)`
...
`func (o *InlineResponse20019) SetReservedIpRanges(v []NetworksNetworkIdApplianceVlansReservedIpRanges)`
...
`func (o *InlineResponse20019) GetDhcpOptions() []NetworksNetworkIdApplianceVlansDhcpOptions`

GetDhcpOptions returns the DhcpOptions field if non-nil, zero value otherwise.

### GetDhcpOptionsOk

`func (o *InlineResponse20019) GetDhcpOptionsOk() (*[]NetworksNetworkIdApplianceVlansDhcpOptions, bool)`
...
`func (o *InlineResponse20019) SetDhcpOptions(v []NetworksNetworkIdApplianceVlansDhcpOptions)`

SetDhcpOptions sets DhcpOptions field to given value.

### HasDhcpOptions

`func (o *InlineResponse20019) HasDhcpOptions() bool`

HasDhcpOptions returns a boolean if a field has been set.

### GetVpnNatSubnet

`func (o *InlineResponse20019) GetVpnNatSubnet() string`

GetVpnNatSubnet returns the VpnNatSubnet field if non-nil, zero value otherwise.

### GetVpnNatSubnetOk

`func (o *InlineResponse20019) GetVpnNatSubnetOk() (*string, bool)`
...
`func (o *InlineResponse20019) SetVpnNatSubnet(v string)`

SetVpnNatSubnet sets VpnNatSubnet field to given value.

### HasVpnNatSubnet

`func (o *InlineResponse20019) HasVpnNatSubnet() bool`

HasVpnNatSubnet returns a boolean if a field has been set.

### GetMandatoryDhcp

`func (o *InlineResponse20019) GetMandatoryDhcp() NetworksNetworkIdApplianceVlansMandatoryDhcp`

GetMandatoryDhcp returns the MandatoryDhcp field if non-nil, zero value otherwise.

### GetMandatoryDhcpOk

`func (o *InlineResponse20019) GetMandatoryDhcpOk() (*NetworksNetworkIdApplianceVlansMandatoryDhcp, bool)`
...
`func (o *InlineResponse20019) SetMandatoryDhcp(v NetworksNetworkIdApplianceVlansMandatoryDhcp)`
...
`func (o *InlineResponse20019) GetIpv6() NetworksNetworkIdApplianceVlansIpv6`

GetIpv6 returns the Ipv6 field if non-nil, zero value otherwise.

### GetIpv6Ok

`func (o *InlineResponse20019) GetIpv6Ok() (*NetworksNetworkIdApplianceVlansIpv6, bool)`
...
`func (o *InlineResponse20019) SetIpv6(v NetworksNetworkIdApplianceVlansIpv6)`
