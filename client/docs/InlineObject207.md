...
`func (o *InlineObject207) GetDeviceSerial() string`

GetDeviceSerial returns the DeviceSerial field if non-nil, zero value otherwise.

### GetDeviceSerialOk

`func (o *InlineObject207) GetDeviceSerialOk() (*string, bool)`
...
`func (o *InlineObject207) SetDeviceSerial(v string)`

SetDeviceSerial sets DeviceSerial field to given value.

### HasDeviceSerial

`func (o *InlineObject207) HasDeviceSerial() bool`
