...
`func (o *InlineResponse200133) GetNotValidAfter() string`

GetNotValidAfter returns the NotValidAfter field if non-nil, zero value otherwise.

### GetNotValidAfterOk

`func (o *InlineResponse200133) GetNotValidAfterOk() (*string, bool)`
...
`func (o *InlineResponse200133) SetNotValidAfter(v string)`

SetNotValidAfter sets NotValidAfter field to given value.

### HasNotValidAfter

`func (o *InlineResponse200133) HasNotValidAfter() bool`

HasNotValidAfter returns a boolean if a field has been set.

### GetNotValidBefore

`func (o *InlineResponse200133) GetNotValidBefore() string`

GetNotValidBefore returns the NotValidBefore field if non-nil, zero value otherwise.

### GetNotValidBeforeOk

`func (o *InlineResponse200133) GetNotValidBeforeOk() (*string, bool)`
...
`func (o *InlineResponse200133) SetNotValidBefore(v string)`

SetNotValidBefore sets NotValidBefore field to given value.

### HasNotValidBefore

`func (o *InlineResponse200133) HasNotValidBefore() bool`

HasNotValidBefore returns a boolean if a field has been set.

### GetCertPem

`func (o *InlineResponse200133) GetCertPem() string`

GetCertPem returns the CertPem field if non-nil, zero value otherwise.

### GetCertPemOk

`func (o *InlineResponse200133) GetCertPemOk() (*string, bool)`
...
`func (o *InlineResponse200133) SetCertPem(v string)`

SetCertPem sets CertPem field to given value.

### HasCertPem

`func (o *InlineResponse200133) HasCertPem() bool`
...
`func (o *InlineResponse200133) GetIssuer() string`

GetIssuer returns the Issuer field if non-nil, zero value otherwise.

### GetIssuerOk

`func (o *InlineResponse200133) GetIssuerOk() (*string, bool)`
...
`func (o *InlineResponse200133) SetIssuer(v string)`

SetIssuer sets Issuer field to given value.

### HasIssuer

`func (o *InlineResponse200133) HasIssuer() bool`

HasIssuer returns a boolean if a field has been set.

### GetSubject

`func (o *InlineResponse200133) GetSubject() string`

GetSubject returns the Subject field if non-nil, zero value otherwise.

### GetSubjectOk

`func (o *InlineResponse200133) GetSubjectOk() (*string, bool)`
...
`func (o *InlineResponse200133) SetSubject(v string)`

SetSubject sets Subject field to given value.

### HasSubject

`func (o *InlineResponse200133) HasSubject() bool`
