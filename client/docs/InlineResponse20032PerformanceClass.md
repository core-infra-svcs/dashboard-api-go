# InlineResponse20032PerformanceClass
...
### NewInlineResponse20032PerformanceClass

`func NewInlineResponse20032PerformanceClass(type_ string, ) *InlineResponse20032PerformanceClass`

NewInlineResponse20032PerformanceClass instantiates a new InlineResponse20032PerformanceClass object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewInlineResponse20032PerformanceClassWithDefaults

`func NewInlineResponse20032PerformanceClassWithDefaults() *InlineResponse20032PerformanceClass`

NewInlineResponse20032PerformanceClassWithDefaults instantiates a new InlineResponse20032PerformanceClass object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetType

`func (o *InlineResponse20032PerformanceClass) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InlineResponse20032PerformanceClass) GetTypeOk() (*string, bool)`
...
`func (o *InlineResponse20032PerformanceClass) SetType(v string)`
...
`func (o *InlineResponse20032PerformanceClass) GetBuiltinPerformanceClassName() string`
...
`func (o *InlineResponse20032PerformanceClass) GetBuiltinPerformanceClassNameOk() (*string, bool)`
...
`func (o *InlineResponse20032PerformanceClass) SetBuiltinPerformanceClassName(v string)`

SetBuiltinPerformanceClassName sets BuiltinPerformanceClassName field to given value.

### HasBuiltinPerformanceClassName

`func (o *InlineResponse20032PerformanceClass) HasBuiltinPerformanceClassName() bool`

HasBuiltinPerformanceClassName returns a boolean if a field has been set.

### GetCustomPerformanceClassId

`func (o *InlineResponse20032PerformanceClass) GetCustomPerformanceClassId() string`
...
`func (o *InlineResponse20032PerformanceClass) GetCustomPerformanceClassIdOk() (*string, bool)`
...
`func (o *InlineResponse20032PerformanceClass) SetCustomPerformanceClassId(v string)`

SetCustomPerformanceClassId sets CustomPerformanceClassId field to given value.

### HasCustomPerformanceClassId

`func (o *InlineResponse20032PerformanceClass) HasCustomPerformanceClassId() bool`
