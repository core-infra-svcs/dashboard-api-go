...
`func NewInlineObject206(email string, name string, orgAccess string, ) *InlineObject206`
...
`func (o *InlineObject206) GetEmail() string`

GetEmail returns the Email field if non-nil, zero value otherwise.

### GetEmailOk

`func (o *InlineObject206) GetEmailOk() (*string, bool)`
...
`func (o *InlineObject206) SetEmail(v string)`
...
`func (o *InlineObject206) GetOrgAccess() string`

GetOrgAccess returns the OrgAccess field if non-nil, zero value otherwise.

### GetOrgAccessOk

`func (o *InlineObject206) GetOrgAccessOk() (*string, bool)`
...
`func (o *InlineObject206) SetOrgAccess(v string)`
...
`func (o *InlineObject206) GetTags() []OrganizationsOrganizationIdAdminsTags1`

GetTags returns the Tags field if non-nil, zero value otherwise.

### GetTagsOk

`func (o *InlineObject206) GetTagsOk() (*[]OrganizationsOrganizationIdAdminsTags1, bool)`
...
`func (o *InlineObject206) SetTags(v []OrganizationsOrganizationIdAdminsTags1)`
...
`func (o *InlineObject206) GetNetworks() []OrganizationsOrganizationIdAdminsNetworks1`

GetNetworks returns the Networks field if non-nil, zero value otherwise.

### GetNetworksOk

`func (o *InlineObject206) GetNetworksOk() (*[]OrganizationsOrganizationIdAdminsNetworks1, bool)`
...
`func (o *InlineObject206) SetNetworks(v []OrganizationsOrganizationIdAdminsNetworks1)`

SetNetworks sets Networks field to given value.

### HasNetworks

`func (o *InlineObject206) HasNetworks() bool`

HasNetworks returns a boolean if a field has been set.

### GetAuthenticationMethod

`func (o *InlineObject206) GetAuthenticationMethod() string`

GetAuthenticationMethod returns the AuthenticationMethod field if non-nil, zero value otherwise.

### GetAuthenticationMethodOk

`func (o *InlineObject206) GetAuthenticationMethodOk() (*string, bool)`
...
`func (o *InlineObject206) SetAuthenticationMethod(v string)`

SetAuthenticationMethod sets AuthenticationMethod field to given value.

### HasAuthenticationMethod

`func (o *InlineObject206) HasAuthenticationMethod() bool`
