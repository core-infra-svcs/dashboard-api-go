# InlineResponse200194Billing

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**FreeAccess** | Pointer to [**InlineResponse200194BillingFreeAccess**](InlineResponse200194BillingFreeAccess.md) |  | [optional] 
...
### NewInlineResponse200194Billing

`func NewInlineResponse200194Billing() *InlineResponse200194Billing`

NewInlineResponse200194Billing instantiates a new InlineResponse200194Billing object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewInlineResponse200194BillingWithDefaults

`func NewInlineResponse200194BillingWithDefaults() *InlineResponse200194Billing`

NewInlineResponse200194BillingWithDefaults instantiates a new InlineResponse200194Billing object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetFreeAccess

`func (o *InlineResponse200194Billing) GetFreeAccess() InlineResponse200194BillingFreeAccess`

GetFreeAccess returns the FreeAccess field if non-nil, zero value otherwise.

### GetFreeAccessOk

`func (o *InlineResponse200194Billing) GetFreeAccessOk() (*InlineResponse200194BillingFreeAccess, bool)`
...
`func (o *InlineResponse200194Billing) SetFreeAccess(v InlineResponse200194BillingFreeAccess)`

SetFreeAccess sets FreeAccess field to given value.

### HasFreeAccess

`func (o *InlineResponse200194Billing) HasFreeAccess() bool`

HasFreeAccess returns a boolean if a field has been set.

### GetPrepaidAccessFastLoginEnabled

`func (o *InlineResponse200194Billing) GetPrepaidAccessFastLoginEnabled() bool`
...
`func (o *InlineResponse200194Billing) GetPrepaidAccessFastLoginEnabledOk() (*bool, bool)`
...
`func (o *InlineResponse200194Billing) SetReplyToEmailAddress(v string)`

SetReplyToEmailAddress sets ReplyToEmailAddress field to given value.

### HasReplyToEmailAddress

`func (o *InlineResponse200194Billing) HasReplyToEmailAddress() bool`
