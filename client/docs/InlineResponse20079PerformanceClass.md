# InlineResponse20079PerformanceClass
...
### NewInlineResponse20079PerformanceClass

`func NewInlineResponse20079PerformanceClass(type_ string, ) *InlineResponse20079PerformanceClass`

NewInlineResponse20079PerformanceClass instantiates a new InlineResponse20079PerformanceClass object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewInlineResponse20079PerformanceClassWithDefaults

`func NewInlineResponse20079PerformanceClassWithDefaults() *InlineResponse20079PerformanceClass`

NewInlineResponse20079PerformanceClassWithDefaults instantiates a new InlineResponse20079PerformanceClass object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetType

`func (o *InlineResponse20079PerformanceClass) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InlineResponse20079PerformanceClass) GetTypeOk() (*string, bool)`
...
`func (o *InlineResponse20079PerformanceClass) SetType(v string)`
...
`func (o *InlineResponse20079PerformanceClass) GetBuiltinPerformanceClassName() string`
...
`func (o *InlineResponse20079PerformanceClass) GetBuiltinPerformanceClassNameOk() (*string, bool)`
...
`func (o *InlineResponse20079PerformanceClass) SetBuiltinPerformanceClassName(v string)`

SetBuiltinPerformanceClassName sets BuiltinPerformanceClassName field to given value.

### HasBuiltinPerformanceClassName

`func (o *InlineResponse20079PerformanceClass) HasBuiltinPerformanceClassName() bool`

HasBuiltinPerformanceClassName returns a boolean if a field has been set.

### GetCustomPerformanceClassId

`func (o *InlineResponse20079PerformanceClass) GetCustomPerformanceClassId() string`
...
`func (o *InlineResponse20079PerformanceClass) GetCustomPerformanceClassIdOk() (*string, bool)`
...
`func (o *InlineResponse20079PerformanceClass) SetCustomPerformanceClassId(v string)`

SetCustomPerformanceClassId sets CustomPerformanceClassId field to given value.

### HasCustomPerformanceClassId

`func (o *InlineResponse20079PerformanceClass) HasCustomPerformanceClassId() bool`
