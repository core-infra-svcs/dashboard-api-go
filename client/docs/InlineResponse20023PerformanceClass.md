# InlineResponse20023PerformanceClass
...
### NewInlineResponse20023PerformanceClass

`func NewInlineResponse20023PerformanceClass(type_ string, ) *InlineResponse20023PerformanceClass`

NewInlineResponse20023PerformanceClass instantiates a new InlineResponse20023PerformanceClass object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewInlineResponse20023PerformanceClassWithDefaults

`func NewInlineResponse20023PerformanceClassWithDefaults() *InlineResponse20023PerformanceClass`

NewInlineResponse20023PerformanceClassWithDefaults instantiates a new InlineResponse20023PerformanceClass object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetType

`func (o *InlineResponse20023PerformanceClass) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InlineResponse20023PerformanceClass) GetTypeOk() (*string, bool)`
...
`func (o *InlineResponse20023PerformanceClass) SetType(v string)`
...
`func (o *InlineResponse20023PerformanceClass) GetBuiltinPerformanceClassName() string`
...
`func (o *InlineResponse20023PerformanceClass) GetBuiltinPerformanceClassNameOk() (*string, bool)`
...
`func (o *InlineResponse20023PerformanceClass) SetBuiltinPerformanceClassName(v string)`

SetBuiltinPerformanceClassName sets BuiltinPerformanceClassName field to given value.

### HasBuiltinPerformanceClassName

`func (o *InlineResponse20023PerformanceClass) HasBuiltinPerformanceClassName() bool`

HasBuiltinPerformanceClassName returns a boolean if a field has been set.

### GetCustomPerformanceClassId

`func (o *InlineResponse20023PerformanceClass) GetCustomPerformanceClassId() string`
...
`func (o *InlineResponse20023PerformanceClass) GetCustomPerformanceClassIdOk() (*string, bool)`
...
`func (o *InlineResponse20023PerformanceClass) SetCustomPerformanceClassId(v string)`

SetCustomPerformanceClassId sets CustomPerformanceClassId field to given value.

### HasCustomPerformanceClassId

`func (o *InlineResponse20023PerformanceClass) HasCustomPerformanceClassId() bool`
