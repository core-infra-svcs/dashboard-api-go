...
`func (o *InlineResponse200181) GetAvgLatencyMs() int32`

GetAvgLatencyMs returns the AvgLatencyMs field if non-nil, zero value otherwise.

### GetAvgLatencyMsOk

`func (o *InlineResponse200181) GetAvgLatencyMsOk() (*int32, bool)`
...
`func (o *InlineResponse200181) SetAvgLatencyMs(v int32)`

SetAvgLatencyMs sets AvgLatencyMs field to given value.

### HasAvgLatencyMs

`func (o *InlineResponse200181) HasAvgLatencyMs() bool`
