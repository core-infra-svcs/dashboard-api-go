...
`func (o *InlineObject105) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InlineObject105) GetTypeOk() (*string, bool)`
...
`func (o *InlineObject105) SetType(v string)`

SetType sets Type field to given value.

### HasType

`func (o *InlineObject105) HasType() bool`

HasType returns a boolean if a field has been set.

### GetDatasets

`func (o *InlineObject105) GetDatasets() []string`

GetDatasets returns the Datasets field if non-nil, zero value otherwise.

### GetDatasetsOk

`func (o *InlineObject105) GetDatasetsOk() (*[]string, bool)`
...
`func (o *InlineObject105) SetDatasets(v []string)`

SetDatasets sets Datasets field to given value.

### HasDatasets

`func (o *InlineObject105) HasDatasets() bool`

HasDatasets returns a boolean if a field has been set.

### GetUsername

`func (o *InlineObject105) GetUsername() string`

GetUsername returns the Username field if non-nil, zero value otherwise.

### GetUsernameOk

`func (o *InlineObject105) GetUsernameOk() (*string, bool)`
...
`func (o *InlineObject105) SetUsername(v string)`

SetUsername sets Username field to given value.

### HasUsername

`func (o *InlineObject105) HasUsername() bool`

HasUsername returns a boolean if a field has been set.

### GetEmail

`func (o *InlineObject105) GetEmail() string`

GetEmail returns the Email field if non-nil, zero value otherwise.

### GetEmailOk

`func (o *InlineObject105) GetEmailOk() (*string, bool)`
...
`func (o *InlineObject105) SetEmail(v string)`

SetEmail sets Email field to given value.

### HasEmail

`func (o *InlineObject105) HasEmail() bool`

HasEmail returns a boolean if a field has been set.

### GetMac

`func (o *InlineObject105) GetMac() string`

GetMac returns the Mac field if non-nil, zero value otherwise.

### GetMacOk

`func (o *InlineObject105) GetMacOk() (*string, bool)`
...
`func (o *InlineObject105) SetMac(v string)`

SetMac sets Mac field to given value.

### HasMac

`func (o *InlineObject105) HasMac() bool`

HasMac returns a boolean if a field has been set.

### GetSmDeviceId

`func (o *InlineObject105) GetSmDeviceId() string`

GetSmDeviceId returns the SmDeviceId field if non-nil, zero value otherwise.

### GetSmDeviceIdOk

`func (o *InlineObject105) GetSmDeviceIdOk() (*string, bool)`
...
`func (o *InlineObject105) SetSmDeviceId(v string)`

SetSmDeviceId sets SmDeviceId field to given value.

### HasSmDeviceId

`func (o *InlineObject105) HasSmDeviceId() bool`

HasSmDeviceId returns a boolean if a field has been set.

### GetSmUserId

`func (o *InlineObject105) GetSmUserId() string`

GetSmUserId returns the SmUserId field if non-nil, zero value otherwise.

### GetSmUserIdOk

`func (o *InlineObject105) GetSmUserIdOk() (*string, bool)`
...
`func (o *InlineObject105) SetSmUserId(v string)`

SetSmUserId sets SmUserId field to given value.

### HasSmUserId

`func (o *InlineObject105) HasSmUserId() bool`
