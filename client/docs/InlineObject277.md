...
`func NewInlineObject277(destOrganizationId string, licenseIds []string, ) *InlineObject277`
...
`func (o *InlineObject277) GetDestOrganizationId() string`

GetDestOrganizationId returns the DestOrganizationId field if non-nil, zero value otherwise.

### GetDestOrganizationIdOk

`func (o *InlineObject277) GetDestOrganizationIdOk() (*string, bool)`
...
`func (o *InlineObject277) SetDestOrganizationId(v string)`
...
`func (o *InlineObject277) GetLicenseIds() []string`

GetLicenseIds returns the LicenseIds field if non-nil, zero value otherwise.

### GetLicenseIdsOk

`func (o *InlineObject277) GetLicenseIdsOk() (*[]string, bool)`
...
`func (o *InlineObject277) SetLicenseIds(v []string)`
