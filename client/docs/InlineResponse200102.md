...
**Components** | Pointer to [**InlineResponse200102Components**](InlineResponse200102Components.md) |  | [optional] 
...
`func (o *InlineResponse200102) GetPublicIp() string`

GetPublicIp returns the PublicIp field if non-nil, zero value otherwise.

### GetPublicIpOk

`func (o *InlineResponse200102) GetPublicIpOk() (*string, bool)`
...
`func (o *InlineResponse200102) SetPublicIp(v string)`

SetPublicIp sets PublicIp field to given value.

### HasPublicIp

`func (o *InlineResponse200102) HasPublicIp() bool`
...
`func (o *InlineResponse200102) GetLastReportedAt() string`

GetLastReportedAt returns the LastReportedAt field if non-nil, zero value otherwise.

### GetLastReportedAtOk

`func (o *InlineResponse200102) GetLastReportedAtOk() (*string, bool)`
...
`func (o *InlineResponse200102) SetLastReportedAt(v string)`

SetLastReportedAt sets LastReportedAt field to given value.

### HasLastReportedAt

`func (o *InlineResponse200102) HasLastReportedAt() bool`

HasLastReportedAt returns a boolean if a field has been set.

### GetLanIp

`func (o *InlineResponse200102) GetLanIp() string`

GetLanIp returns the LanIp field if non-nil, zero value otherwise.

### GetLanIpOk

`func (o *InlineResponse200102) GetLanIpOk() (*string, bool)`
...
`func (o *InlineResponse200102) SetLanIp(v string)`

SetLanIp sets LanIp field to given value.

### HasLanIp

`func (o *InlineResponse200102) HasLanIp() bool`

HasLanIp returns a boolean if a field has been set.

### GetGateway

`func (o *InlineResponse200102) GetGateway() string`

GetGateway returns the Gateway field if non-nil, zero value otherwise.

### GetGatewayOk

`func (o *InlineResponse200102) GetGatewayOk() (*string, bool)`
...
`func (o *InlineResponse200102) SetGateway(v string)`

SetGateway sets Gateway field to given value.

### HasGateway

`func (o *InlineResponse200102) HasGateway() bool`

HasGateway returns a boolean if a field has been set.

### GetIpType

`func (o *InlineResponse200102) GetIpType() string`

GetIpType returns the IpType field if non-nil, zero value otherwise.

### GetIpTypeOk

`func (o *InlineResponse200102) GetIpTypeOk() (*string, bool)`
...
`func (o *InlineResponse200102) SetIpType(v string)`

SetIpType sets IpType field to given value.

### HasIpType

`func (o *InlineResponse200102) HasIpType() bool`

HasIpType returns a boolean if a field has been set.

### GetPrimaryDns

`func (o *InlineResponse200102) GetPrimaryDns() string`

GetPrimaryDns returns the PrimaryDns field if non-nil, zero value otherwise.

### GetPrimaryDnsOk

`func (o *InlineResponse200102) GetPrimaryDnsOk() (*string, bool)`
...
`func (o *InlineResponse200102) SetPrimaryDns(v string)`

SetPrimaryDns sets PrimaryDns field to given value.

### HasPrimaryDns

`func (o *InlineResponse200102) HasPrimaryDns() bool`

HasPrimaryDns returns a boolean if a field has been set.

### GetSecondaryDns

`func (o *InlineResponse200102) GetSecondaryDns() string`

GetSecondaryDns returns the SecondaryDns field if non-nil, zero value otherwise.

### GetSecondaryDnsOk

`func (o *InlineResponse200102) GetSecondaryDnsOk() (*string, bool)`
...
`func (o *InlineResponse200102) SetSecondaryDns(v string)`

SetSecondaryDns sets SecondaryDns field to given value.

### HasSecondaryDns

`func (o *InlineResponse200102) HasSecondaryDns() bool`
...
`func (o *InlineResponse200102) GetComponents() InlineResponse200102Components`

GetComponents returns the Components field if non-nil, zero value otherwise.

### GetComponentsOk

`func (o *InlineResponse200102) GetComponentsOk() (*InlineResponse200102Components, bool)`
...
`func (o *InlineResponse200102) SetComponents(v InlineResponse200102Components)`

SetComponents sets Components field to given value.

### HasComponents

`func (o *InlineResponse200102) HasComponents() bool`
