...
`func (o *InlineObject248) GetStatus() string`

GetStatus returns the Status field if non-nil, zero value otherwise.

### GetStatusOk

`func (o *InlineObject248) GetStatusOk() (*string, bool)`
...
`func (o *InlineObject248) SetStatus(v string)`

SetStatus sets Status field to given value.

### HasStatus

`func (o *InlineObject248) HasStatus() bool`
