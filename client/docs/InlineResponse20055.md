...
`func (o *InlineResponse20055) GetIds() []string`

GetIds returns the Ids field if non-nil, zero value otherwise.

### GetIdsOk

`func (o *InlineResponse20055) GetIdsOk() (*[]string, bool)`
...
`func (o *InlineResponse20055) SetIds(v []string)`

SetIds sets Ids field to given value.

### HasIds

`func (o *InlineResponse20055) HasIds() bool`

HasIds returns a boolean if a field has been set.

### GetNewNetwork

`func (o *InlineResponse20055) GetNewNetwork() string`

GetNewNetwork returns the NewNetwork field if non-nil, zero value otherwise.

### GetNewNetworkOk

`func (o *InlineResponse20055) GetNewNetworkOk() (*string, bool)`
...
`func (o *InlineResponse20055) SetNewNetwork(v string)`

SetNewNetwork sets NewNetwork field to given value.

### HasNewNetwork

`func (o *InlineResponse20055) HasNewNetwork() bool`
