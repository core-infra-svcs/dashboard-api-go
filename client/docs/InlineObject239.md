...
`func NewInlineObject239(name string, productTypes []string, ) *InlineObject239`
...
`func (o *InlineObject239) GetProductTypes() []string`

GetProductTypes returns the ProductTypes field if non-nil, zero value otherwise.

### GetProductTypesOk

`func (o *InlineObject239) GetProductTypesOk() (*[]string, bool)`
...
`func (o *InlineObject239) SetProductTypes(v []string)`
...
`func (o *InlineObject239) GetTags() []string`

GetTags returns the Tags field if non-nil, zero value otherwise.

### GetTagsOk

`func (o *InlineObject239) GetTagsOk() (*[]string, bool)`
...
`func (o *InlineObject239) SetTags(v []string)`
...
`func (o *InlineObject239) GetTimeZone() string`

GetTimeZone returns the TimeZone field if non-nil, zero value otherwise.

### GetTimeZoneOk

`func (o *InlineObject239) GetTimeZoneOk() (*string, bool)`
...
`func (o *InlineObject239) SetTimeZone(v string)`

SetTimeZone sets TimeZone field to given value.

### HasTimeZone

`func (o *InlineObject239) HasTimeZone() bool`

HasTimeZone returns a boolean if a field has been set.

### GetCopyFromNetworkId

`func (o *InlineObject239) GetCopyFromNetworkId() string`

GetCopyFromNetworkId returns the CopyFromNetworkId field if non-nil, zero value otherwise.

### GetCopyFromNetworkIdOk

`func (o *InlineObject239) GetCopyFromNetworkIdOk() (*string, bool)`
...
`func (o *InlineObject239) SetCopyFromNetworkId(v string)`

SetCopyFromNetworkId sets CopyFromNetworkId field to given value.

### HasCopyFromNetworkId

`func (o *InlineObject239) HasCopyFromNetworkId() bool`

HasCopyFromNetworkId returns a boolean if a field has been set.

### GetNotes

`func (o *InlineObject239) GetNotes() string`

GetNotes returns the Notes field if non-nil, zero value otherwise.

### GetNotesOk

`func (o *InlineObject239) GetNotesOk() (*string, bool)`
...
`func (o *InlineObject239) SetNotes(v string)`

SetNotes sets Notes field to given value.

### HasNotes

`func (o *InlineObject239) HasNotes() bool`
