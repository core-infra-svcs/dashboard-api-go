...
**Nat** | Pointer to [**InlineResponse20086Nat**](InlineResponse20086Nat.md) |  | [optional] 
...
`func (o *InlineResponse20086Subnets) GetLocalSubnet() string`

GetLocalSubnet returns the LocalSubnet field if non-nil, zero value otherwise.

### GetLocalSubnetOk

`func (o *InlineResponse20086Subnets) GetLocalSubnetOk() (*string, bool)`
...
`func (o *InlineResponse20086Subnets) SetLocalSubnet(v string)`

SetLocalSubnet sets LocalSubnet field to given value.

### HasLocalSubnet

`func (o *InlineResponse20086Subnets) HasLocalSubnet() bool`

HasLocalSubnet returns a boolean if a field has been set.

### GetUseVpn

`func (o *InlineResponse20086Subnets) GetUseVpn() bool`

GetUseVpn returns the UseVpn field if non-nil, zero value otherwise.

### GetUseVpnOk

`func (o *InlineResponse20086Subnets) GetUseVpnOk() (*bool, bool)`
...
`func (o *InlineResponse20086Subnets) SetUseVpn(v bool)`

SetUseVpn sets UseVpn field to given value.

### HasUseVpn

`func (o *InlineResponse20086Subnets) HasUseVpn() bool`

HasUseVpn returns a boolean if a field has been set.

### GetNat

`func (o *InlineResponse20086Subnets) GetNat() InlineResponse20086Nat`

GetNat returns the Nat field if non-nil, zero value otherwise.

### GetNatOk

`func (o *InlineResponse20086Subnets) GetNatOk() (*InlineResponse20086Nat, bool)`
...
`func (o *InlineResponse20086Subnets) SetNat(v InlineResponse20086Nat)`

SetNat sets Nat field to given value.

### HasNat

`func (o *InlineResponse20086Subnets) HasNat() bool`
