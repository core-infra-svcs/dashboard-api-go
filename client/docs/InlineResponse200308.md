...
`func (o *InlineResponse200308) GetV2cEnabled() bool`

GetV2cEnabled returns the V2cEnabled field if non-nil, zero value otherwise.

### GetV2cEnabledOk

`func (o *InlineResponse200308) GetV2cEnabledOk() (*bool, bool)`
...
`func (o *InlineResponse200308) SetV3Enabled(v bool)`

SetV3Enabled sets V3Enabled field to given value.

### HasV3Enabled

`func (o *InlineResponse200308) HasV3Enabled() bool`

HasV3Enabled returns a boolean if a field has been set.

### GetV3User

`func (o *InlineResponse200308) GetV3User() string`

GetV3User returns the V3User field if non-nil, zero value otherwise.

### GetV3UserOk

`func (o *InlineResponse200308) GetV3UserOk() (*string, bool)`
...
`func (o *InlineResponse200308) SetV3User(v string)`

SetV3User sets V3User field to given value.

### HasV3User

`func (o *InlineResponse200308) HasV3User() bool`

HasV3User returns a boolean if a field has been set.

### GetV3AuthMode

`func (o *InlineResponse200308) GetV3AuthMode() string`

GetV3AuthMode returns the V3AuthMode field if non-nil, zero value otherwise.

### GetV3AuthModeOk

`func (o *InlineResponse200308) GetV3AuthModeOk() (*string, bool)`
...
`func (o *InlineResponse200308) SetV3AuthMode(v string)`

SetV3AuthMode sets V3AuthMode field to given value.

### HasV3AuthMode

`func (o *InlineResponse200308) HasV3AuthMode() bool`

HasV3AuthMode returns a boolean if a field has been set.

### GetV3PrivMode

`func (o *InlineResponse200308) GetV3PrivMode() string`

GetV3PrivMode returns the V3PrivMode field if non-nil, zero value otherwise.

### GetV3PrivModeOk

`func (o *InlineResponse200308) GetV3PrivModeOk() (*string, bool)`
...
`func (o *InlineResponse200308) SetV3PrivMode(v string)`

SetV3PrivMode sets V3PrivMode field to given value.

### HasV3PrivMode

`func (o *InlineResponse200308) HasV3PrivMode() bool`

HasV3PrivMode returns a boolean if a field has been set.

### GetPeerIps

`func (o *InlineResponse200308) GetPeerIps() []string`

GetPeerIps returns the PeerIps field if non-nil, zero value otherwise.

### GetPeerIpsOk

`func (o *InlineResponse200308) GetPeerIpsOk() (*[]string, bool)`
...
`func (o *InlineResponse200308) SetPeerIps(v []string)`

SetPeerIps sets PeerIps field to given value.

### HasPeerIps

`func (o *InlineResponse200308) HasPeerIps() bool`

HasPeerIps returns a boolean if a field has been set.

### GetHostname

`func (o *InlineResponse200308) GetHostname() string`

GetHostname returns the Hostname field if non-nil, zero value otherwise.

### GetHostnameOk

`func (o *InlineResponse200308) GetHostnameOk() (*string, bool)`
...
`func (o *InlineResponse200308) SetHostname(v string)`

SetHostname sets Hostname field to given value.

### HasHostname

`func (o *InlineResponse200308) HasHostname() bool`

HasHostname returns a boolean if a field has been set.

### GetPort

`func (o *InlineResponse200308) GetPort() int32`

GetPort returns the Port field if non-nil, zero value otherwise.

### GetPortOk

`func (o *InlineResponse200308) GetPortOk() (*int32, bool)`
...
`func (o *InlineResponse200308) SetPort(v int32)`

SetPort sets Port field to given value.

### HasPort

`func (o *InlineResponse200308) HasPort() bool`
