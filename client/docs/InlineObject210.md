...
`func (o *InlineObject210) GetConcentrator() NetworksNetworkIdWirelessSsidsNumberVpnConcentrator`

GetConcentrator returns the Concentrator field if non-nil, zero value otherwise.

### GetConcentratorOk

`func (o *InlineObject210) GetConcentratorOk() (*NetworksNetworkIdWirelessSsidsNumberVpnConcentrator, bool)`
...
`func (o *InlineObject210) SetConcentrator(v NetworksNetworkIdWirelessSsidsNumberVpnConcentrator)`

SetConcentrator sets Concentrator field to given value.

### HasConcentrator

`func (o *InlineObject210) HasConcentrator() bool`

HasConcentrator returns a boolean if a field has been set.

### GetSplitTunnel

`func (o *InlineObject210) GetSplitTunnel() NetworksNetworkIdWirelessSsidsNumberVpnSplitTunnel`

GetSplitTunnel returns the SplitTunnel field if non-nil, zero value otherwise.

### GetSplitTunnelOk

`func (o *InlineObject210) GetSplitTunnelOk() (*NetworksNetworkIdWirelessSsidsNumberVpnSplitTunnel, bool)`
...
`func (o *InlineObject210) SetSplitTunnel(v NetworksNetworkIdWirelessSsidsNumberVpnSplitTunnel)`

SetSplitTunnel sets SplitTunnel field to given value.

### HasSplitTunnel

`func (o *InlineObject210) HasSplitTunnel() bool`

HasSplitTunnel returns a boolean if a field has been set.

### GetFailover

`func (o *InlineObject210) GetFailover() NetworksNetworkIdWirelessSsidsNumberVpnFailover`

GetFailover returns the Failover field if non-nil, zero value otherwise.

### GetFailoverOk

`func (o *InlineObject210) GetFailoverOk() (*NetworksNetworkIdWirelessSsidsNumberVpnFailover, bool)`
...
`func (o *InlineObject210) SetFailover(v NetworksNetworkIdWirelessSsidsNumberVpnFailover)`

SetFailover sets Failover field to given value.

### HasFailover

`func (o *InlineObject210) HasFailover() bool`
