...
`func (o *InlineResponse200121) GetSwitchProfileId() string`

GetSwitchProfileId returns the SwitchProfileId field if non-nil, zero value otherwise.

### GetSwitchProfileIdOk

`func (o *InlineResponse200121) GetSwitchProfileIdOk() (*string, bool)`
...
`func (o *InlineResponse200121) SetSwitchProfileId(v string)`

SetSwitchProfileId sets SwitchProfileId field to given value.

### HasSwitchProfileId

`func (o *InlineResponse200121) HasSwitchProfileId() bool`
...
`func (o *InlineResponse200121) GetModel() string`

GetModel returns the Model field if non-nil, zero value otherwise.

### GetModelOk

`func (o *InlineResponse200121) GetModelOk() (*string, bool)`
...
`func (o *InlineResponse200121) SetModel(v string)`

SetModel sets Model field to given value.

### HasModel

`func (o *InlineResponse200121) HasModel() bool`
