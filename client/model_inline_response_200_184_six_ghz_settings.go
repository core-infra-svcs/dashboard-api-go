...
// InlineResponse200184SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200184SixGhzSettings struct {
...
func NewInlineResponse200184SixGhzSettings() *InlineResponse200184SixGhzSettings {
	this := InlineResponse200184SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200184SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200184SixGhzSettings struct {
	value *InlineResponse200184SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200184SixGhzSettings) Get() *InlineResponse200184SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200184SixGhzSettings) Set(val *InlineResponse200184SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200184SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200184SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200184SixGhzSettings(val *InlineResponse200184SixGhzSettings) *NullableInlineResponse200184SixGhzSettings {
	return &NullableInlineResponse200184SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200184SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200184SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
