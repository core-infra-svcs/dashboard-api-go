...
// InlineResponse200194EapolKey EAPOL Key settings.
type InlineResponse200194EapolKey struct {
...
func NewInlineResponse200194EapolKey() *InlineResponse200194EapolKey {
	this := InlineResponse200194EapolKey{}
	return &this
}
...
func (o InlineResponse200194EapolKey) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200194EapolKey struct {
	value *InlineResponse200194EapolKey
	isSet bool
}

func (v NullableInlineResponse200194EapolKey) Get() *InlineResponse200194EapolKey {
	return v.value
}

func (v *NullableInlineResponse200194EapolKey) Set(val *InlineResponse200194EapolKey) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200194EapolKey) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200194EapolKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200194EapolKey(val *InlineResponse200194EapolKey) *NullableInlineResponse200194EapolKey {
	return &NullableInlineResponse200194EapolKey{value: val, isSet: true}
}

func (v NullableInlineResponse200194EapolKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200194EapolKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
