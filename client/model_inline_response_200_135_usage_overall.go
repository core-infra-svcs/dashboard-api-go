...
// InlineResponse200135UsageOverall Overall data usage of all clients across organization
type InlineResponse200135UsageOverall struct {
...
func NewInlineResponse200135UsageOverall() *InlineResponse200135UsageOverall {
	this := InlineResponse200135UsageOverall{}
	return &this
}
...
func (o InlineResponse200135UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200135UsageOverall struct {
	value *InlineResponse200135UsageOverall
	isSet bool
}

func (v NullableInlineResponse200135UsageOverall) Get() *InlineResponse200135UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200135UsageOverall) Set(val *InlineResponse200135UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200135UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200135UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200135UsageOverall(val *InlineResponse200135UsageOverall) *NullableInlineResponse200135UsageOverall {
	return &NullableInlineResponse200135UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200135UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200135UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
