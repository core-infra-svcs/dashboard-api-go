...
// InlineResponse20097VlanProfile The VLAN Profile
type InlineResponse20097VlanProfile struct {
...
func NewInlineResponse20097VlanProfile() *InlineResponse20097VlanProfile {
	this := InlineResponse20097VlanProfile{}
	return &this
}
...
func (o InlineResponse20097VlanProfile) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20097VlanProfile struct {
	value *InlineResponse20097VlanProfile
	isSet bool
}

func (v NullableInlineResponse20097VlanProfile) Get() *InlineResponse20097VlanProfile {
	return v.value
}

func (v *NullableInlineResponse20097VlanProfile) Set(val *InlineResponse20097VlanProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20097VlanProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20097VlanProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20097VlanProfile(val *InlineResponse20097VlanProfile) *NullableInlineResponse20097VlanProfile {
	return &NullableInlineResponse20097VlanProfile{value: val, isSet: true}
}

func (v NullableInlineResponse20097VlanProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20097VlanProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
