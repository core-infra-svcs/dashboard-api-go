...
type NetworksNetworkIdWirelessSsidsNumberRadiusServers struct {
	...
	OpenRoamingCertificateId NullableInt32 `json:"openRoamingCertificateId,omitempty"`
...
// GetOpenRoamingCertificateId returns the OpenRoamingCertificateId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *NetworksNetworkIdWirelessSsidsNumberRadiusServers) GetOpenRoamingCertificateId() int32 {
	if o == nil || isNil(o.OpenRoamingCertificateId.Get()) {
		var ret int32
		return ret
	}
	return *o.OpenRoamingCertificateId.Get()
}
...
func (o *NetworksNetworkIdWirelessSsidsNumberRadiusServers) GetOpenRoamingCertificateIdOk() (*int32, bool) {
	...
	return o.OpenRoamingCertificateId.Get(), o.OpenRoamingCertificateId.IsSet()
}
...
func (o *NetworksNetworkIdWirelessSsidsNumberRadiusServers) HasOpenRoamingCertificateId() bool {
	if o != nil && o.OpenRoamingCertificateId.IsSet() {
		return true
	}
...
// SetOpenRoamingCertificateId gets a reference to the given NullableInt32 and assigns it to the OpenRoamingCertificateId field.
func (o *NetworksNetworkIdWirelessSsidsNumberRadiusServers) SetOpenRoamingCertificateId(v int32) {
	o.OpenRoamingCertificateId.Set(&v)
}
// SetOpenRoamingCertificateIdNil sets the value for OpenRoamingCertificateId to be an explicit nil
func (o *NetworksNetworkIdWirelessSsidsNumberRadiusServers) SetOpenRoamingCertificateIdNil() {
	o.OpenRoamingCertificateId.Set(nil)
}
...
func (o *NetworksNetworkIdWirelessSsidsNumberRadiusServers) UnsetOpenRoamingCertificateId() {
	o.OpenRoamingCertificateId.Unset()
}
...
func (o *NetworksNetworkIdWirelessSsidsNumberRadiusServers) SetCaCertificateNil() {
...
func (o NetworksNetworkIdWirelessSsidsNumberRadiusServers) MarshalJSON() ([]byte, error) {
	...
	if o.OpenRoamingCertificateId.IsSet() {
		toSerialize["openRoamingCertificateId"] = o.OpenRoamingCertificateId.Get()
	}
