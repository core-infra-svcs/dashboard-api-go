...
// InlineResponse20089ProductsWirelessCurrentVersion Details of the current version on the device
type InlineResponse20089ProductsWirelessCurrentVersion struct {
...
func NewInlineResponse20089ProductsWirelessCurrentVersion() *InlineResponse20089ProductsWirelessCurrentVersion {
	this := InlineResponse20089ProductsWirelessCurrentVersion{}
	return &this
}
...
func (o InlineResponse20089ProductsWirelessCurrentVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20089ProductsWirelessCurrentVersion struct {
	value *InlineResponse20089ProductsWirelessCurrentVersion
	isSet bool
}

func (v NullableInlineResponse20089ProductsWirelessCurrentVersion) Get() *InlineResponse20089ProductsWirelessCurrentVersion {
	return v.value
}

func (v *NullableInlineResponse20089ProductsWirelessCurrentVersion) Set(val *InlineResponse20089ProductsWirelessCurrentVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20089ProductsWirelessCurrentVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20089ProductsWirelessCurrentVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20089ProductsWirelessCurrentVersion(val *InlineResponse20089ProductsWirelessCurrentVersion) *NullableInlineResponse20089ProductsWirelessCurrentVersion {
	return &NullableInlineResponse20089ProductsWirelessCurrentVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20089ProductsWirelessCurrentVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20089ProductsWirelessCurrentVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
