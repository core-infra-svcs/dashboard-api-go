...
func (r InterfacesApiGetNetworkSwitchStackRoutingInterfaceDhcpRequest) Execute() (*InlineResponse20089, *http.Response, error) {
...
func (a *InterfacesApiService) GetNetworkSwitchStackRoutingInterfaceDhcpExecute(r InterfacesApiGetNetworkSwitchStackRoutingInterfaceDhcpRequest) (*InlineResponse20089, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
