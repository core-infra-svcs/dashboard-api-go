...
func (r InterfacesApiGetNetworkSwitchStackRoutingInterfaceDhcpRequest) Execute() (*InlineResponse20082, *http.Response, error) {
...
func (a *InterfacesApiService) GetNetworkSwitchStackRoutingInterfaceDhcpExecute(r InterfacesApiGetNetworkSwitchStackRoutingInterfaceDhcpRequest) (*InlineResponse20082, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
