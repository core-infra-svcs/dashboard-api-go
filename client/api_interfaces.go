...
func (r InterfacesApiCreateNetworkSwitchStackRoutingInterfaceRequest) CreateNetworkSwitchStackRoutingInterface(createNetworkSwitchStackRoutingInterface InlineObject152) InterfacesApiCreateNetworkSwitchStackRoutingInterfaceRequest {
...
func (r InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceRequest) UpdateNetworkSwitchStackRoutingInterface(updateNetworkSwitchStackRoutingInterface InlineObject153) InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceRequest {
	r.updateNetworkSwitchStackRoutingInterface = &updateNetworkSwitchStackRoutingInterface
	return r
}

func (r InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceRequest) Execute() (*InlineResponse200158, *http.Response, error) {
...
func (a *InterfacesApiService) UpdateNetworkSwitchStackRoutingInterfaceExecute(r InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceRequest) (*InlineResponse200158, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceDhcpRequest) UpdateNetworkSwitchStackRoutingInterfaceDhcp(updateNetworkSwitchStackRoutingInterfaceDhcp InlineObject154) InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceDhcpRequest {
