...
func (r InterfacesApiCreateDeviceSwitchRoutingInterfaceRequest) Execute() (*InlineResponse20010, *http.Response, error) {
...
func (a *InterfacesApiService) CreateDeviceSwitchRoutingInterfaceExecute(r InterfacesApiCreateDeviceSwitchRoutingInterfaceRequest) (*InlineResponse20010, *http.Response, error) {
	var (
...
func (r InterfacesApiCreateNetworkSwitchStackRoutingInterfaceRequest) CreateNetworkSwitchStackRoutingInterface(createNetworkSwitchStackRoutingInterface InlineObject140) InterfacesApiCreateNetworkSwitchStackRoutingInterfaceRequest {
...
func (r InterfacesApiGetDeviceSwitchRoutingInterfaceRequest) Execute() (*InlineResponse20010, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20010
func (a *InterfacesApiService) GetDeviceSwitchRoutingInterfaceExecute(r InterfacesApiGetDeviceSwitchRoutingInterfaceRequest) (*InlineResponse20010, *http.Response, error) {
	var (
...
func (r InterfacesApiGetDeviceSwitchRoutingInterfacesRequest) Execute() ([]InlineResponse20010, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20010
func (a *InterfacesApiService) GetDeviceSwitchRoutingInterfacesExecute(r InterfacesApiGetDeviceSwitchRoutingInterfacesRequest) ([]InlineResponse20010, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InterfacesApiGetNetworkSwitchStackRoutingInterfaceDhcpRequest) Execute() (*InlineResponse20090, *http.Response, error) {
...
func (a *InterfacesApiService) GetNetworkSwitchStackRoutingInterfaceDhcpExecute(r InterfacesApiGetNetworkSwitchStackRoutingInterfaceDhcpRequest) (*InlineResponse20090, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InterfacesApiUpdateDeviceSwitchRoutingInterfaceRequest) Execute() (*InlineResponse20010, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20010
func (a *InterfacesApiService) UpdateDeviceSwitchRoutingInterfaceExecute(r InterfacesApiUpdateDeviceSwitchRoutingInterfaceRequest) (*InlineResponse20010, *http.Response, error) {
	var (
...
func (r InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceRequest) UpdateNetworkSwitchStackRoutingInterface(updateNetworkSwitchStackRoutingInterface InlineObject141) InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceRequest {
...
func (r InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceDhcpRequest) UpdateNetworkSwitchStackRoutingInterfaceDhcp(updateNetworkSwitchStackRoutingInterfaceDhcp InlineObject142) InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceDhcpRequest {
