...
func (r InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceRequest) Execute() (*InlineResponse200157, *http.Response, error) {
...
func (a *InterfacesApiService) UpdateNetworkSwitchStackRoutingInterfaceExecute(r InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceRequest) (*InlineResponse200157, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
