...
// InlineResponse200368Radio Wireless access point radio identifier.
...
func (o *InlineResponse200368Radio) GetBand() string {
...
func (o *InlineResponse200368Radio) GetBandOk() (*string, bool) {
	if o == nil || isNil(o.Band) {
    return nil, false
	}
	return o.Band, true
...
func (o *InlineResponse200368Radio) HasBand() bool {
	if o != nil && !isNil(o.Band) {
		return true
	}
...
func (o *InlineResponse200368Radio) SetBand(v string) {
	o.Band = &v
}

// GetChannel returns the Channel field value if set, zero value otherwise.
func (o *InlineResponse200368Radio) GetChannel() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200368Radio) GetChannelOk() (*int32, bool) {
	if o == nil || isNil(o.Channel) {
    return nil, false
	}
...
func (o *InlineResponse200368Radio) HasChannel() bool {
	if o != nil && !isNil(o.Channel) {
		return true
	}
...
func (o *InlineResponse200368Radio) SetChannel(v int32) {
	o.Channel = &v
}

// GetChannelWidth returns the ChannelWidth field value if set, zero value otherwise.
func (o *InlineResponse200368Radio) GetChannelWidth() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200368Radio) GetChannelWidthOk() (*int32, bool) {
	if o == nil || isNil(o.ChannelWidth) {
    return nil, false
	}
...
func (o *InlineResponse200368Radio) HasChannelWidth() bool {
	if o != nil && !isNil(o.ChannelWidth) {
		return true
	}
...
func (o *InlineResponse200368Radio) SetChannelWidth(v int32) {
	o.ChannelWidth = &v
}

// GetPower returns the Power field value if set, zero value otherwise.
func (o *InlineResponse200368Radio) GetPower() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200368Radio) GetPowerOk() (*int32, bool) {
	if o == nil || isNil(o.Power) {
    return nil, false
	}
	return o.Power, true
...
func (o *InlineResponse200368Radio) HasPower() bool {
	if o != nil && !isNil(o.Power) {
		return true
	}
...
func (o *InlineResponse200368Radio) SetPower(v int32) {
	o.Power = &v
}

// GetIsBroadcasting returns the IsBroadcasting field value if set, zero value otherwise.
func (o *InlineResponse200368Radio) GetIsBroadcasting() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200368Radio) GetIsBroadcastingOk() (*bool, bool) {
	if o == nil || isNil(o.IsBroadcasting) {
    return nil, false
	}
...
func (o *InlineResponse200368Radio) HasIsBroadcasting() bool {
	if o != nil && !isNil(o.IsBroadcasting) {
		return true
	}
...
func (o *InlineResponse200368Radio) SetIsBroadcasting(v bool) {
	o.IsBroadcasting = &v
}

// GetIndex returns the Index field value if set, zero value otherwise.
func (o *InlineResponse200368Radio) GetIndex() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200368Radio) GetIndexOk() (*string, bool) {
	if o == nil || isNil(o.Index) {
    return nil, false
	}
	return o.Index, true
...
func (o *InlineResponse200368Radio) HasIndex() bool {
	if o != nil && !isNil(o.Index) {
		return true
	}
...
func (o *InlineResponse200368Radio) SetIndex(v string) {
	o.Index = &v
}
