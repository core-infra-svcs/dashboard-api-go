...
func (r AppliancesApiGetOrganizationSummaryTopAppliancesByUtilizationRequest) Execute() ([]InlineResponse200167, *http.Response, error) {
...
func (a *AppliancesApiService) GetOrganizationSummaryTopAppliancesByUtilizationExecute(r AppliancesApiGetOrganizationSummaryTopAppliancesByUtilizationRequest) ([]InlineResponse200167, *http.Response, error) {
	var (
