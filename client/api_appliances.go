...
func (r AppliancesApiGetOrganizationSummaryTopAppliancesByUtilizationRequest) Execute() ([]InlineResponse200101, *http.Response, error) {
...
func (a *AppliancesApiService) GetOrganizationSummaryTopAppliancesByUtilizationExecute(r AppliancesApiGetOrganizationSummaryTopAppliancesByUtilizationRequest) ([]InlineResponse200101, *http.Response, error) {
	var (
