...
func (r AppliancesApiGetOrganizationSummaryTopAppliancesByUtilizationRequest) Execute() ([]InlineResponse200171, *http.Response, error) {
...
func (a *AppliancesApiService) GetOrganizationSummaryTopAppliancesByUtilizationExecute(r AppliancesApiGetOrganizationSummaryTopAppliancesByUtilizationRequest) ([]InlineResponse200171, *http.Response, error) {
	var (
