...
// InlineResponse200276Counts Object containing counts
type InlineResponse200276Counts struct {
	Packets *InlineResponse200276CountsPackets `json:"packets,omitempty"`
}
...
func (o *InlineResponse200276Counts) GetPackets() InlineResponse200276CountsPackets {
	if o == nil || isNil(o.Packets) {
		var ret InlineResponse200276CountsPackets
		return ret
	}
	return *o.Packets
}
...
// SetPackets gets a reference to the given InlineResponse200276CountsPackets and assigns it to the Packets field.
