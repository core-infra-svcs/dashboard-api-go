...
// InlineResponse20094Servers struct for InlineResponse20094Servers
type InlineResponse20094Servers struct {
...
func NewInlineResponse20094Servers() *InlineResponse20094Servers {
	this := InlineResponse20094Servers{}
	return &this
}
...
func (o InlineResponse20094Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20094Servers struct {
	value *InlineResponse20094Servers
	isSet bool
}

func (v NullableInlineResponse20094Servers) Get() *InlineResponse20094Servers {
	return v.value
}

func (v *NullableInlineResponse20094Servers) Set(val *InlineResponse20094Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20094Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20094Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20094Servers(val *InlineResponse20094Servers) *NullableInlineResponse20094Servers {
	return &NullableInlineResponse20094Servers{value: val, isSet: true}
}

func (v NullableInlineResponse20094Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20094Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
