...
// InlineResponse20025BandwidthLimitsCellular uplink cellular configured limits [optional]
type InlineResponse20025BandwidthLimitsCellular struct {
...
func NewInlineResponse20025BandwidthLimitsCellular() *InlineResponse20025BandwidthLimitsCellular {
	this := InlineResponse20025BandwidthLimitsCellular{}
	return &this
}
...
func (o InlineResponse20025BandwidthLimitsCellular) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20025BandwidthLimitsCellular struct {
	value *InlineResponse20025BandwidthLimitsCellular
	isSet bool
}

func (v NullableInlineResponse20025BandwidthLimitsCellular) Get() *InlineResponse20025BandwidthLimitsCellular {
	return v.value
}

func (v *NullableInlineResponse20025BandwidthLimitsCellular) Set(val *InlineResponse20025BandwidthLimitsCellular) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20025BandwidthLimitsCellular) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20025BandwidthLimitsCellular) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20025BandwidthLimitsCellular(val *InlineResponse20025BandwidthLimitsCellular) *NullableInlineResponse20025BandwidthLimitsCellular {
	return &NullableInlineResponse20025BandwidthLimitsCellular{value: val, isSet: true}
}

func (v NullableInlineResponse20025BandwidthLimitsCellular) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20025BandwidthLimitsCellular) UnmarshalJSON(src []byte) error {
	v.isSet = true
