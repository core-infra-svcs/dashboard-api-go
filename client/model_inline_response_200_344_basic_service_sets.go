...
// InlineResponse200344BasicServiceSets struct for InlineResponse200344BasicServiceSets
type InlineResponse200344BasicServiceSets struct {
	// Unique identifier for wireless access point.
	Bssid *string `json:"bssid,omitempty"`
	Ssid *InlineResponse200344Ssid `json:"ssid,omitempty"`
	Radio *InlineResponse200344Radio `json:"radio,omitempty"`
}
...
func NewInlineResponse200344BasicServiceSets() *InlineResponse200344BasicServiceSets {
	this := InlineResponse200344BasicServiceSets{}
	return &this
}
...
func (o *InlineResponse200344BasicServiceSets) GetSsid() InlineResponse200344Ssid {
	if o == nil || isNil(o.Ssid) {
		var ret InlineResponse200344Ssid
		return ret
	}
	return *o.Ssid
}
...
// SetSsid gets a reference to the given InlineResponse200344Ssid and assigns it to the Ssid field.
...
func (o *InlineResponse200344BasicServiceSets) GetRadio() InlineResponse200344Radio {
	if o == nil || isNil(o.Radio) {
		var ret InlineResponse200344Radio
		return ret
	}
	return *o.Radio
}
...
// SetRadio gets a reference to the given InlineResponse200344Radio and assigns it to the Radio field.
func (o *InlineResponse200344BasicServiceSets) SetRadio(v InlineResponse200344Radio) {
	o.Radio = &v
}

func (o InlineResponse200344BasicServiceSets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200344BasicServiceSets struct {
	value *InlineResponse200344BasicServiceSets
	isSet bool
}

func (v NullableInlineResponse200344BasicServiceSets) Get() *InlineResponse200344BasicServiceSets {
	return v.value
}

func (v *NullableInlineResponse200344BasicServiceSets) Set(val *InlineResponse200344BasicServiceSets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200344BasicServiceSets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200344BasicServiceSets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200344BasicServiceSets(val *InlineResponse200344BasicServiceSets) *NullableInlineResponse200344BasicServiceSets {
	return &NullableInlineResponse200344BasicServiceSets{value: val, isSet: true}
}

func (v NullableInlineResponse200344BasicServiceSets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200344BasicServiceSets) UnmarshalJSON(src []byte) error {
	v.isSet = true
