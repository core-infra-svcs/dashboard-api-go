...
func (r TargetGroupsApiCreateNetworkSmTargetGroupRequest) CreateNetworkSmTargetGroup(createNetworkSmTargetGroup InlineObject134) TargetGroupsApiCreateNetworkSmTargetGroupRequest {
	r.createNetworkSmTargetGroup = &createNetworkSmTargetGroup
	return r
}

func (r TargetGroupsApiCreateNetworkSmTargetGroupRequest) Execute() (*InlineResponse200143, *http.Response, error) {
...
func (a *TargetGroupsApiService) CreateNetworkSmTargetGroupExecute(r TargetGroupsApiCreateNetworkSmTargetGroupRequest) (*InlineResponse200143, *http.Response, error) {
	var (
...
func (r TargetGroupsApiGetNetworkSmTargetGroupRequest) Execute() (*InlineResponse200143, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200143
func (a *TargetGroupsApiService) GetNetworkSmTargetGroupExecute(r TargetGroupsApiGetNetworkSmTargetGroupRequest) (*InlineResponse200143, *http.Response, error) {
	var (
...
func (r TargetGroupsApiGetNetworkSmTargetGroupsRequest) Execute() ([]InlineResponse200143, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200143
func (a *TargetGroupsApiService) GetNetworkSmTargetGroupsExecute(r TargetGroupsApiGetNetworkSmTargetGroupsRequest) ([]InlineResponse200143, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r TargetGroupsApiUpdateNetworkSmTargetGroupRequest) UpdateNetworkSmTargetGroup(updateNetworkSmTargetGroup InlineObject135) TargetGroupsApiUpdateNetworkSmTargetGroupRequest {
	r.updateNetworkSmTargetGroup = &updateNetworkSmTargetGroup
	return r
}

func (r TargetGroupsApiUpdateNetworkSmTargetGroupRequest) Execute() (*InlineResponse200143, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200143
func (a *TargetGroupsApiService) UpdateNetworkSmTargetGroupExecute(r TargetGroupsApiUpdateNetworkSmTargetGroupRequest) (*InlineResponse200143, *http.Response, error) {
	var (
