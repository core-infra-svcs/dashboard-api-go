...
func (r TargetGroupsApiCreateNetworkSmTargetGroupRequest) Execute() (*InlineResponse200133, *http.Response, error) {
...
func (a *TargetGroupsApiService) CreateNetworkSmTargetGroupExecute(r TargetGroupsApiCreateNetworkSmTargetGroupRequest) (*InlineResponse200133, *http.Response, error) {
	var (
...
func (r TargetGroupsApiGetNetworkSmTargetGroupRequest) Execute() (*InlineResponse200133, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200133
func (a *TargetGroupsApiService) GetNetworkSmTargetGroupExecute(r TargetGroupsApiGetNetworkSmTargetGroupRequest) (*InlineResponse200133, *http.Response, error) {
	var (
...
func (r TargetGroupsApiGetNetworkSmTargetGroupsRequest) Execute() ([]InlineResponse200133, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200133
func (a *TargetGroupsApiService) GetNetworkSmTargetGroupsExecute(r TargetGroupsApiGetNetworkSmTargetGroupsRequest) ([]InlineResponse200133, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r TargetGroupsApiUpdateNetworkSmTargetGroupRequest) Execute() (*InlineResponse200133, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200133
func (a *TargetGroupsApiService) UpdateNetworkSmTargetGroupExecute(r TargetGroupsApiUpdateNetworkSmTargetGroupRequest) (*InlineResponse200133, *http.Response, error) {
	var (
