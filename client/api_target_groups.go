...
func (r TargetGroupsApiCreateNetworkSmTargetGroupRequest) Execute() (*InlineResponse200144, *http.Response, error) {
...
func (a *TargetGroupsApiService) CreateNetworkSmTargetGroupExecute(r TargetGroupsApiCreateNetworkSmTargetGroupRequest) (*InlineResponse200144, *http.Response, error) {
	var (
...
func (r TargetGroupsApiGetNetworkSmTargetGroupRequest) Execute() (*InlineResponse200144, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200144
func (a *TargetGroupsApiService) GetNetworkSmTargetGroupExecute(r TargetGroupsApiGetNetworkSmTargetGroupRequest) (*InlineResponse200144, *http.Response, error) {
	var (
...
func (r TargetGroupsApiGetNetworkSmTargetGroupsRequest) Execute() ([]InlineResponse200144, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200144
func (a *TargetGroupsApiService) GetNetworkSmTargetGroupsExecute(r TargetGroupsApiGetNetworkSmTargetGroupsRequest) ([]InlineResponse200144, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r TargetGroupsApiUpdateNetworkSmTargetGroupRequest) Execute() (*InlineResponse200144, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200144
func (a *TargetGroupsApiService) UpdateNetworkSmTargetGroupExecute(r TargetGroupsApiUpdateNetworkSmTargetGroupRequest) (*InlineResponse200144, *http.Response, error) {
	var (
