...
func (r StacksApiGetNetworkSwitchStackRequest) Execute() (*InlineResponse20069, *http.Response, error) {
...
func (a *StacksApiService) GetNetworkSwitchStackExecute(r StacksApiGetNetworkSwitchStackRequest) (*InlineResponse20069, *http.Response, error) {
	var (
