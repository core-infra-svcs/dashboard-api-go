...
func (r StacksApiAddNetworkSwitchStackRequest) Execute() (*InlineResponse20082, *http.Response, error) {
...
func (a *StacksApiService) AddNetworkSwitchStackExecute(r StacksApiAddNetworkSwitchStackRequest) (*InlineResponse20082, *http.Response, error) {
	var (
...
func (r StacksApiGetNetworkSwitchStackRequest) Execute() (*InlineResponse20082, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20082
func (a *StacksApiService) GetNetworkSwitchStackExecute(r StacksApiGetNetworkSwitchStackRequest) (*InlineResponse20082, *http.Response, error) {
	var (
...
func (r StacksApiGetNetworkSwitchStackRoutingInterfaceDhcpRequest) Execute() (*InlineResponse20083, *http.Response, error) {
...
func (a *StacksApiService) GetNetworkSwitchStackRoutingInterfaceDhcpExecute(r StacksApiGetNetworkSwitchStackRoutingInterfaceDhcpRequest) (*InlineResponse20083, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
