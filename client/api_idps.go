...
func (r IdpsApiCreateOrganizationSamlIdpRequest) CreateOrganizationSamlIdp(createOrganizationSamlIdp InlineObject254) IdpsApiCreateOrganizationSamlIdpRequest {
	r.createOrganizationSamlIdp = &createOrganizationSamlIdp
	return r
}

func (r IdpsApiCreateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200266, *http.Response, error) {
...
func (a *IdpsApiService) CreateOrganizationSamlIdpExecute(r IdpsApiCreateOrganizationSamlIdpRequest) ([]InlineResponse200266, *http.Response, error) {
	var (
...
func (r IdpsApiGetOrganizationSamlIdpRequest) Execute() (*InlineResponse200266, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200266
func (a *IdpsApiService) GetOrganizationSamlIdpExecute(r IdpsApiGetOrganizationSamlIdpRequest) (*InlineResponse200266, *http.Response, error) {
	var (
...
func (r IdpsApiGetOrganizationSamlIdpsRequest) Execute() ([]InlineResponse200266, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200266
func (a *IdpsApiService) GetOrganizationSamlIdpsExecute(r IdpsApiGetOrganizationSamlIdpsRequest) ([]InlineResponse200266, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r IdpsApiUpdateOrganizationSamlIdpRequest) UpdateOrganizationSamlIdp(updateOrganizationSamlIdp InlineObject255) IdpsApiUpdateOrganizationSamlIdpRequest {
	r.updateOrganizationSamlIdp = &updateOrganizationSamlIdp
	return r
}

func (r IdpsApiUpdateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200266, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200266
func (a *IdpsApiService) UpdateOrganizationSamlIdpExecute(r IdpsApiUpdateOrganizationSamlIdpRequest) ([]InlineResponse200266, *http.Response, error) {
	var (
