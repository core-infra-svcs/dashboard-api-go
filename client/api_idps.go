...
func (r IdpsApiCreateOrganizationSamlIdpRequest) CreateOrganizationSamlIdp(createOrganizationSamlIdp InlineObject290) IdpsApiCreateOrganizationSamlIdpRequest {
	r.createOrganizationSamlIdp = &createOrganizationSamlIdp
	return r
}

func (r IdpsApiCreateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200310, *http.Response, error) {
...
func (a *IdpsApiService) CreateOrganizationSamlIdpExecute(r IdpsApiCreateOrganizationSamlIdpRequest) ([]InlineResponse200310, *http.Response, error) {
	var (
...
func (r IdpsApiGetOrganizationSamlIdpRequest) Execute() (*InlineResponse200310, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200310
func (a *IdpsApiService) GetOrganizationSamlIdpExecute(r IdpsApiGetOrganizationSamlIdpRequest) (*InlineResponse200310, *http.Response, error) {
	var (
...
func (r IdpsApiGetOrganizationSamlIdpsRequest) Execute() ([]InlineResponse200310, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200310
func (a *IdpsApiService) GetOrganizationSamlIdpsExecute(r IdpsApiGetOrganizationSamlIdpsRequest) ([]InlineResponse200310, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r IdpsApiUpdateOrganizationSamlIdpRequest) UpdateOrganizationSamlIdp(updateOrganizationSamlIdp InlineObject291) IdpsApiUpdateOrganizationSamlIdpRequest {
	r.updateOrganizationSamlIdp = &updateOrganizationSamlIdp
	return r
}

func (r IdpsApiUpdateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200310, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200310
func (a *IdpsApiService) UpdateOrganizationSamlIdpExecute(r IdpsApiUpdateOrganizationSamlIdpRequest) ([]InlineResponse200310, *http.Response, error) {
	var (
