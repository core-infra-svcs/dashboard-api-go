...
func (r IdpsApiCreateOrganizationSamlIdpRequest) Execute() ([]InlineResponse20095, *http.Response, error) {
...
func (a *IdpsApiService) CreateOrganizationSamlIdpExecute(r IdpsApiCreateOrganizationSamlIdpRequest) ([]InlineResponse20095, *http.Response, error) {
	var (
...
func (r IdpsApiGetOrganizationSamlIdpRequest) Execute() (*InlineResponse20095, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20095
func (a *IdpsApiService) GetOrganizationSamlIdpExecute(r IdpsApiGetOrganizationSamlIdpRequest) (*InlineResponse20095, *http.Response, error) {
	var (
...
func (r IdpsApiGetOrganizationSamlIdpsRequest) Execute() ([]InlineResponse20095, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20095
func (a *IdpsApiService) GetOrganizationSamlIdpsExecute(r IdpsApiGetOrganizationSamlIdpsRequest) ([]InlineResponse20095, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r IdpsApiUpdateOrganizationSamlIdpRequest) Execute() ([]InlineResponse20095, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20095
func (a *IdpsApiService) UpdateOrganizationSamlIdpExecute(r IdpsApiUpdateOrganizationSamlIdpRequest) ([]InlineResponse20095, *http.Response, error) {
	var (
