...
func (r IdpsApiCreateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200145, *http.Response, error) {
...
func (a *IdpsApiService) CreateOrganizationSamlIdpExecute(r IdpsApiCreateOrganizationSamlIdpRequest) ([]InlineResponse200145, *http.Response, error) {
	var (
...
func (r IdpsApiGetOrganizationSamlIdpRequest) Execute() (*InlineResponse200145, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200145
func (a *IdpsApiService) GetOrganizationSamlIdpExecute(r IdpsApiGetOrganizationSamlIdpRequest) (*InlineResponse200145, *http.Response, error) {
	var (
...
func (r IdpsApiGetOrganizationSamlIdpsRequest) Execute() ([]InlineResponse200145, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200145
func (a *IdpsApiService) GetOrganizationSamlIdpsExecute(r IdpsApiGetOrganizationSamlIdpsRequest) ([]InlineResponse200145, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r IdpsApiUpdateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200145, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200145
func (a *IdpsApiService) UpdateOrganizationSamlIdpExecute(r IdpsApiUpdateOrganizationSamlIdpRequest) ([]InlineResponse200145, *http.Response, error) {
	var (
