...
func (r IdpsApiApiCreateOrganizationSamlIdpRequest) CreateOrganizationSamlIdp(createOrganizationSamlIdp InlineObject209) IdpsApiApiCreateOrganizationSamlIdpRequest {
	r.createOrganizationSamlIdp = &createOrganizationSamlIdp
	return r
}

func (r IdpsApiApiCreateOrganizationSamlIdpRequest) Execute() ([]InlineResponse20085, *_nethttp.Response, error) {
...
func (a *IdpsApiService) CreateOrganizationSamlIdpExecute(r IdpsApiApiCreateOrganizationSamlIdpRequest) ([]InlineResponse20085, *_nethttp.Response, error) {
	var (
...
func (r IdpsApiApiGetOrganizationSamlIdpRequest) Execute() (InlineResponse20085, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20085
func (a *IdpsApiService) GetOrganizationSamlIdpExecute(r IdpsApiApiGetOrganizationSamlIdpRequest) (InlineResponse20085, *_nethttp.Response, error) {
	var (
...
func (r IdpsApiApiGetOrganizationSamlIdpsRequest) Execute() ([]InlineResponse20085, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20085
func (a *IdpsApiService) GetOrganizationSamlIdpsExecute(r IdpsApiApiGetOrganizationSamlIdpsRequest) ([]InlineResponse20085, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r IdpsApiApiUpdateOrganizationSamlIdpRequest) UpdateOrganizationSamlIdp(updateOrganizationSamlIdp InlineObject210) IdpsApiApiUpdateOrganizationSamlIdpRequest {
	r.updateOrganizationSamlIdp = &updateOrganizationSamlIdp
	return r
}

func (r IdpsApiApiUpdateOrganizationSamlIdpRequest) Execute() ([]InlineResponse20085, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20085
func (a *IdpsApiService) UpdateOrganizationSamlIdpExecute(r IdpsApiApiUpdateOrganizationSamlIdpRequest) ([]InlineResponse20085, *_nethttp.Response, error) {
	var (
