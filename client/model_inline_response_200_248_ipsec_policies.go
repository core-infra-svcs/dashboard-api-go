...
// InlineResponse200248IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200248IpsecPolicies struct {
...
func NewInlineResponse200248IpsecPolicies() *InlineResponse200248IpsecPolicies {
	this := InlineResponse200248IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200248IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200248IpsecPolicies struct {
	value *InlineResponse200248IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200248IpsecPolicies) Get() *InlineResponse200248IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200248IpsecPolicies) Set(val *InlineResponse200248IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200248IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200248IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200248IpsecPolicies(val *InlineResponse200248IpsecPolicies) *NullableInlineResponse200248IpsecPolicies {
	return &NullableInlineResponse200248IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200248IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200248IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
