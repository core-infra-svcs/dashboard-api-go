...
type InlineResponse200234Items struct {
	...
	Logo *InlineResponse200234Logo `json:"logo,omitempty"`
	// Indicates if service provider is the bootstrap provider.
	IsBootstrap *bool `json:"isBootstrap,omitempty"`
	Terms *InlineResponse200234Terms `json:"terms,omitempty"`
}
...
func (o *InlineResponse200234Items) GetLogo() InlineResponse200234Logo {
	if o == nil || isNil(o.Logo) {
		var ret InlineResponse200234Logo
		return ret
	}
	return *o.Logo
}
...
// SetLogo gets a reference to the given InlineResponse200234Logo and assigns it to the Logo field.
...
func (o *InlineResponse200234Items) GetTerms() InlineResponse200234Terms {
	if o == nil || isNil(o.Terms) {
		var ret InlineResponse200234Terms
		return ret
	}
	return *o.Terms
}
...
// SetTerms gets a reference to the given InlineResponse200234Terms and assigns it to the Terms field.
