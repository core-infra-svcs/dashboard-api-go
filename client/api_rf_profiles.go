...
func (r RfProfilesApiGetOrganizationWirelessRfProfilesAssignmentsByDeviceRequest) Execute() ([]InlineResponse200345, *http.Response, error) {
...
func (a *RfProfilesApiService) GetOrganizationWirelessRfProfilesAssignmentsByDeviceExecute(r RfProfilesApiGetOrganizationWirelessRfProfilesAssignmentsByDeviceRequest) ([]InlineResponse200345, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
