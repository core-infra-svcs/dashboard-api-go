...
func (r RfProfilesApiGetOrganizationWirelessRfProfilesAssignmentsByDeviceRequest) Execute() ([]InlineResponse200307, *http.Response, error) {
...
func (a *RfProfilesApiService) GetOrganizationWirelessRfProfilesAssignmentsByDeviceExecute(r RfProfilesApiGetOrganizationWirelessRfProfilesAssignmentsByDeviceRequest) ([]InlineResponse200307, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
