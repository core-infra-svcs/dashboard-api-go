...
// InlineResponse20045Destinations struct for InlineResponse20045Destinations
type InlineResponse20045Destinations struct {
...
func NewInlineResponse20045Destinations() *InlineResponse20045Destinations {
	this := InlineResponse20045Destinations{}
	return &this
}
...
func (o InlineResponse20045Destinations) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20045Destinations struct {
	value *InlineResponse20045Destinations
	isSet bool
}

func (v NullableInlineResponse20045Destinations) Get() *InlineResponse20045Destinations {
	return v.value
}

func (v *NullableInlineResponse20045Destinations) Set(val *InlineResponse20045Destinations) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20045Destinations) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20045Destinations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20045Destinations(val *InlineResponse20045Destinations) *NullableInlineResponse20045Destinations {
	return &NullableInlineResponse20045Destinations{value: val, isSet: true}
}

func (v NullableInlineResponse20045Destinations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20045Destinations) UnmarshalJSON(src []byte) error {
	v.isSet = true
