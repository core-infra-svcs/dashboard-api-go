...
func (r AdminsApiCreateOrganizationAdminRequest) Execute() (*InlineResponse200106, *http.Response, error) {
...
func (a *AdminsApiService) CreateOrganizationAdminExecute(r AdminsApiCreateOrganizationAdminRequest) (*InlineResponse200106, *http.Response, error) {
	var (
...
func (r AdminsApiGetOrganizationAdminsRequest) Execute() ([]InlineResponse200106, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200106
func (a *AdminsApiService) GetOrganizationAdminsExecute(r AdminsApiGetOrganizationAdminsRequest) ([]InlineResponse200106, *http.Response, error) {
	var (
...
func (r AdminsApiUpdateOrganizationAdminRequest) Execute() (*InlineResponse200106, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200106
func (a *AdminsApiService) UpdateOrganizationAdminExecute(r AdminsApiUpdateOrganizationAdminRequest) (*InlineResponse200106, *http.Response, error) {
	var (
