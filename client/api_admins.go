...
func (r AdminsApiCreateOrganizationAdminRequest) CreateOrganizationAdmin(createOrganizationAdmin InlineObject195) AdminsApiCreateOrganizationAdminRequest {
	r.createOrganizationAdmin = &createOrganizationAdmin
	return r
}

func (r AdminsApiCreateOrganizationAdminRequest) Execute() (*InlineResponse200123, *http.Response, error) {
...
func (a *AdminsApiService) CreateOrganizationAdminExecute(r AdminsApiCreateOrganizationAdminRequest) (*InlineResponse200123, *http.Response, error) {
	var (
...
func (r AdminsApiGetOrganizationAdminsRequest) Execute() ([]InlineResponse200123, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200123
func (a *AdminsApiService) GetOrganizationAdminsExecute(r AdminsApiGetOrganizationAdminsRequest) ([]InlineResponse200123, *http.Response, error) {
	var (
...
func (r AdminsApiUpdateOrganizationAdminRequest) UpdateOrganizationAdmin(updateOrganizationAdmin InlineObject196) AdminsApiUpdateOrganizationAdminRequest {
	r.updateOrganizationAdmin = &updateOrganizationAdmin
	return r
}

func (r AdminsApiUpdateOrganizationAdminRequest) Execute() (*InlineResponse200123, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200123
func (a *AdminsApiService) UpdateOrganizationAdminExecute(r AdminsApiUpdateOrganizationAdminRequest) (*InlineResponse200123, *http.Response, error) {
	var (
