...
func (r AdminsApiCreateOrganizationAdminRequest) CreateOrganizationAdmin(createOrganizationAdmin InlineObject192) AdminsApiCreateOrganizationAdminRequest {
	r.createOrganizationAdmin = &createOrganizationAdmin
	return r
}

func (r AdminsApiCreateOrganizationAdminRequest) Execute() (*InlineResponse200117, *http.Response, error) {
...
func (a *AdminsApiService) CreateOrganizationAdminExecute(r AdminsApiCreateOrganizationAdminRequest) (*InlineResponse200117, *http.Response, error) {
	var (
...
func (r AdminsApiGetOrganizationAdminsRequest) Execute() ([]InlineResponse200117, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200117
func (a *AdminsApiService) GetOrganizationAdminsExecute(r AdminsApiGetOrganizationAdminsRequest) ([]InlineResponse200117, *http.Response, error) {
	var (
...
func (r AdminsApiUpdateOrganizationAdminRequest) UpdateOrganizationAdmin(updateOrganizationAdmin InlineObject193) AdminsApiUpdateOrganizationAdminRequest {
	r.updateOrganizationAdmin = &updateOrganizationAdmin
	return r
}

func (r AdminsApiUpdateOrganizationAdminRequest) Execute() (*InlineResponse200117, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200117
func (a *AdminsApiService) UpdateOrganizationAdminExecute(r AdminsApiUpdateOrganizationAdminRequest) (*InlineResponse200117, *http.Response, error) {
	var (
