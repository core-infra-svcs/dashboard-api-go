...
func (r AdminsApiCreateOrganizationAdminRequest) CreateOrganizationAdmin(createOrganizationAdmin InlineObject187) AdminsApiCreateOrganizationAdminRequest {
	r.createOrganizationAdmin = &createOrganizationAdmin
	return r
}

func (r AdminsApiCreateOrganizationAdminRequest) Execute() (*InlineResponse200113, *http.Response, error) {
...
func (a *AdminsApiService) CreateOrganizationAdminExecute(r AdminsApiCreateOrganizationAdminRequest) (*InlineResponse200113, *http.Response, error) {
	var (
...
func (r AdminsApiGetOrganizationAdminsRequest) Execute() ([]InlineResponse200113, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200113
func (a *AdminsApiService) GetOrganizationAdminsExecute(r AdminsApiGetOrganizationAdminsRequest) ([]InlineResponse200113, *http.Response, error) {
	var (
...
func (r AdminsApiUpdateOrganizationAdminRequest) UpdateOrganizationAdmin(updateOrganizationAdmin InlineObject188) AdminsApiUpdateOrganizationAdminRequest {
	r.updateOrganizationAdmin = &updateOrganizationAdmin
	return r
}

func (r AdminsApiUpdateOrganizationAdminRequest) Execute() (*InlineResponse200113, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200113
func (a *AdminsApiService) UpdateOrganizationAdminExecute(r AdminsApiUpdateOrganizationAdminRequest) (*InlineResponse200113, *http.Response, error) {
	var (
