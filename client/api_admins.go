...
func (r AdminsApiCreateOrganizationAdminRequest) Execute() (*InlineResponse200107, *http.Response, error) {
...
func (a *AdminsApiService) CreateOrganizationAdminExecute(r AdminsApiCreateOrganizationAdminRequest) (*InlineResponse200107, *http.Response, error) {
	var (
...
func (r AdminsApiGetOrganizationAdminsRequest) Execute() ([]InlineResponse200107, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200107
func (a *AdminsApiService) GetOrganizationAdminsExecute(r AdminsApiGetOrganizationAdminsRequest) ([]InlineResponse200107, *http.Response, error) {
	var (
...
func (r AdminsApiUpdateOrganizationAdminRequest) Execute() (*InlineResponse200107, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200107
func (a *AdminsApiService) UpdateOrganizationAdminExecute(r AdminsApiUpdateOrganizationAdminRequest) (*InlineResponse200107, *http.Response, error) {
	var (
