...
func (r VpnFirewallRulesApiGetOrganizationApplianceVpnVpnFirewallRulesRequest) Execute() (*InlineResponse20062, *http.Response, error) {
...
func (a *VpnFirewallRulesApiService) GetOrganizationApplianceVpnVpnFirewallRulesExecute(r VpnFirewallRulesApiGetOrganizationApplianceVpnVpnFirewallRulesRequest) (*InlineResponse20062, *http.Response, error) {
	var (
...
func (r VpnFirewallRulesApiUpdateOrganizationApplianceVpnVpnFirewallRulesRequest) UpdateOrganizationApplianceVpnVpnFirewallRules(updateOrganizationApplianceVpnVpnFirewallRules InlineObject240) VpnFirewallRulesApiUpdateOrganizationApplianceVpnVpnFirewallRulesRequest {
	r.updateOrganizationApplianceVpnVpnFirewallRules = &updateOrganizationApplianceVpnVpnFirewallRules
	return r
}

func (r VpnFirewallRulesApiUpdateOrganizationApplianceVpnVpnFirewallRulesRequest) Execute() (*InlineResponse20062, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20062
func (a *VpnFirewallRulesApiService) UpdateOrganizationApplianceVpnVpnFirewallRulesExecute(r VpnFirewallRulesApiUpdateOrganizationApplianceVpnVpnFirewallRulesRequest) (*InlineResponse20062, *http.Response, error) {
	var (
