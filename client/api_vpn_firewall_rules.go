...
func (r VpnFirewallRulesApiGetOrganizationApplianceVpnVpnFirewallRulesRequest) Execute() (*InlineResponse20056, *http.Response, error) {
...
func (a *VpnFirewallRulesApiService) GetOrganizationApplianceVpnVpnFirewallRulesExecute(r VpnFirewallRulesApiGetOrganizationApplianceVpnVpnFirewallRulesRequest) (*InlineResponse20056, *http.Response, error) {
	var (
...
func (r VpnFirewallRulesApiUpdateOrganizationApplianceVpnVpnFirewallRulesRequest) UpdateOrganizationApplianceVpnVpnFirewallRules(updateOrganizationApplianceVpnVpnFirewallRules InlineObject238) VpnFirewallRulesApiUpdateOrganizationApplianceVpnVpnFirewallRulesRequest {
	r.updateOrganizationApplianceVpnVpnFirewallRules = &updateOrganizationApplianceVpnVpnFirewallRules
	return r
}

func (r VpnFirewallRulesApiUpdateOrganizationApplianceVpnVpnFirewallRulesRequest) Execute() (*InlineResponse20056, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20056
func (a *VpnFirewallRulesApiService) UpdateOrganizationApplianceVpnVpnFirewallRulesExecute(r VpnFirewallRulesApiUpdateOrganizationApplianceVpnVpnFirewallRulesRequest) (*InlineResponse20056, *http.Response, error) {
	var (
