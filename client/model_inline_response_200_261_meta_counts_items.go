...
// InlineResponse200261MetaCountsItems Count of Communication Plans available
type InlineResponse200261MetaCountsItems struct {
...
func NewInlineResponse200261MetaCountsItems() *InlineResponse200261MetaCountsItems {
	this := InlineResponse200261MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200261MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200261MetaCountsItems struct {
	value *InlineResponse200261MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200261MetaCountsItems) Get() *InlineResponse200261MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200261MetaCountsItems) Set(val *InlineResponse200261MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200261MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200261MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200261MetaCountsItems(val *InlineResponse200261MetaCountsItems) *NullableInlineResponse200261MetaCountsItems {
	return &NullableInlineResponse200261MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200261MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200261MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
