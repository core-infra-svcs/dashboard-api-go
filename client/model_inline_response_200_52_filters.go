...
// InlineResponse20052Filters A hash of specific configuration data for the alert. Only filters specific to the alert will be updated.
type InlineResponse20052Filters struct {
	// Conditions
	Conditions []InlineResponse20052FiltersConditions `json:"conditions,omitempty"`
	// Failure Type
...
func NewInlineResponse20052Filters() *InlineResponse20052Filters {
	this := InlineResponse20052Filters{}
	return &this
}
...
func (o *InlineResponse20052Filters) GetConditions() []InlineResponse20052FiltersConditions {
	if o == nil || isNil(o.Conditions) {
		var ret []InlineResponse20052FiltersConditions
		return ret
	}
	return o.Conditions
}
...
// SetConditions gets a reference to the given []InlineResponse20052FiltersConditions and assigns it to the Conditions field.
...
func (o InlineResponse20052Filters) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20052Filters struct {
	value *InlineResponse20052Filters
	isSet bool
}

func (v NullableInlineResponse20052Filters) Get() *InlineResponse20052Filters {
	return v.value
}

func (v *NullableInlineResponse20052Filters) Set(val *InlineResponse20052Filters) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20052Filters) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20052Filters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20052Filters(val *InlineResponse20052Filters) *NullableInlineResponse20052Filters {
	return &NullableInlineResponse20052Filters{value: val, isSet: true}
}

func (v NullableInlineResponse20052Filters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20052Filters) UnmarshalJSON(src []byte) error {
	v.isSet = true
