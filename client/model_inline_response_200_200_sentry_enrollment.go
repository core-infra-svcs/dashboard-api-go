...
// InlineResponse200200SentryEnrollment Systems Manager sentry enrollment splash settings.
type InlineResponse200200SentryEnrollment struct {
	SystemsManagerNetwork *InlineResponse200200SentryEnrollmentSystemsManagerNetwork `json:"systemsManagerNetwork,omitempty"`
...
func NewInlineResponse200200SentryEnrollment() *InlineResponse200200SentryEnrollment {
	this := InlineResponse200200SentryEnrollment{}
	return &this
}
...
func (o *InlineResponse200200SentryEnrollment) GetSystemsManagerNetwork() InlineResponse200200SentryEnrollmentSystemsManagerNetwork {
	if o == nil || isNil(o.SystemsManagerNetwork) {
		var ret InlineResponse200200SentryEnrollmentSystemsManagerNetwork
		return ret
	}
...
// SetSystemsManagerNetwork gets a reference to the given InlineResponse200200SentryEnrollmentSystemsManagerNetwork and assigns it to the SystemsManagerNetwork field.
...
func (o InlineResponse200200SentryEnrollment) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200200SentryEnrollment struct {
	value *InlineResponse200200SentryEnrollment
	isSet bool
}

func (v NullableInlineResponse200200SentryEnrollment) Get() *InlineResponse200200SentryEnrollment {
	return v.value
}

func (v *NullableInlineResponse200200SentryEnrollment) Set(val *InlineResponse200200SentryEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200200SentryEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200200SentryEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200200SentryEnrollment(val *InlineResponse200200SentryEnrollment) *NullableInlineResponse200200SentryEnrollment {
	return &NullableInlineResponse200200SentryEnrollment{value: val, isSet: true}
}

func (v NullableInlineResponse200200SentryEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200200SentryEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
