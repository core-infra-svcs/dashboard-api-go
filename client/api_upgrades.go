...
func (r UpgradesApiGetOrganizationFirmwareUpgradesRequest) Execute() ([]InlineResponse200146, *http.Response, error) {
...
func (a *UpgradesApiService) GetOrganizationFirmwareUpgradesExecute(r UpgradesApiGetOrganizationFirmwareUpgradesRequest) ([]InlineResponse200146, *http.Response, error) {
	var (
...
func (r UpgradesApiGetOrganizationFirmwareUpgradesByDeviceRequest) Execute() ([]InlineResponse200147, *http.Response, error) {
...
func (a *UpgradesApiService) GetOrganizationFirmwareUpgradesByDeviceExecute(r UpgradesApiGetOrganizationFirmwareUpgradesByDeviceRequest) ([]InlineResponse200147, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
