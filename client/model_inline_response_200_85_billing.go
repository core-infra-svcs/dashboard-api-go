...
// InlineResponse20085Billing Details associated with billing splash
type InlineResponse20085Billing struct {
	FreeAccess *InlineResponse20085BillingFreeAccess `json:"freeAccess,omitempty"`
...
func NewInlineResponse20085Billing() *InlineResponse20085Billing {
	this := InlineResponse20085Billing{}
	return &this
}
...
func (o *InlineResponse20085Billing) GetFreeAccess() InlineResponse20085BillingFreeAccess {
	if o == nil || isNil(o.FreeAccess) {
		var ret InlineResponse20085BillingFreeAccess
		return ret
	}
	return *o.FreeAccess
}
...
// SetFreeAccess gets a reference to the given InlineResponse20085BillingFreeAccess and assigns it to the FreeAccess field.
...
func (o InlineResponse20085Billing) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20085Billing struct {
	value *InlineResponse20085Billing
	isSet bool
}

func (v NullableInlineResponse20085Billing) Get() *InlineResponse20085Billing {
	return v.value
}

func (v *NullableInlineResponse20085Billing) Set(val *InlineResponse20085Billing) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20085Billing) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20085Billing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20085Billing(val *InlineResponse20085Billing) *NullableInlineResponse20085Billing {
	return &NullableInlineResponse20085Billing{value: val, isSet: true}
}

func (v NullableInlineResponse20085Billing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20085Billing) UnmarshalJSON(src []byte) error {
	v.isSet = true
