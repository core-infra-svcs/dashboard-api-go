...
// InlineResponse20090DhcpOptions struct for InlineResponse20090DhcpOptions
type InlineResponse20090DhcpOptions struct {
...
func NewInlineResponse20090DhcpOptions() *InlineResponse20090DhcpOptions {
	this := InlineResponse20090DhcpOptions{}
	return &this
}
...
func (o InlineResponse20090DhcpOptions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20090DhcpOptions struct {
	value *InlineResponse20090DhcpOptions
	isSet bool
}

func (v NullableInlineResponse20090DhcpOptions) Get() *InlineResponse20090DhcpOptions {
	return v.value
}

func (v *NullableInlineResponse20090DhcpOptions) Set(val *InlineResponse20090DhcpOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20090DhcpOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20090DhcpOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20090DhcpOptions(val *InlineResponse20090DhcpOptions) *NullableInlineResponse20090DhcpOptions {
	return &NullableInlineResponse20090DhcpOptions{value: val, isSet: true}
}

func (v NullableInlineResponse20090DhcpOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20090DhcpOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
