...
// InlineResponse20061ProtectedNetworks Networks included in and excluded from the detection engine
type InlineResponse20061ProtectedNetworks struct {
...
func NewInlineResponse20061ProtectedNetworks() *InlineResponse20061ProtectedNetworks {
	this := InlineResponse20061ProtectedNetworks{}
	return &this
}
...
func (o InlineResponse20061ProtectedNetworks) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20061ProtectedNetworks struct {
	value *InlineResponse20061ProtectedNetworks
	isSet bool
}

func (v NullableInlineResponse20061ProtectedNetworks) Get() *InlineResponse20061ProtectedNetworks {
	return v.value
}

func (v *NullableInlineResponse20061ProtectedNetworks) Set(val *InlineResponse20061ProtectedNetworks) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20061ProtectedNetworks) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20061ProtectedNetworks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20061ProtectedNetworks(val *InlineResponse20061ProtectedNetworks) *NullableInlineResponse20061ProtectedNetworks {
	return &NullableInlineResponse20061ProtectedNetworks{value: val, isSet: true}
}

func (v NullableInlineResponse20061ProtectedNetworks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20061ProtectedNetworks) UnmarshalJSON(src []byte) error {
	v.isSet = true
