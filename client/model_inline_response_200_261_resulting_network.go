...
// InlineResponse200261ResultingNetwork Network after the combination
type InlineResponse200261ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200261ResultingNetwork() *InlineResponse200261ResultingNetwork {
	this := InlineResponse200261ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200261ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200261ResultingNetwork struct {
	value *InlineResponse200261ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200261ResultingNetwork) Get() *InlineResponse200261ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200261ResultingNetwork) Set(val *InlineResponse200261ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200261ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200261ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200261ResultingNetwork(val *InlineResponse200261ResultingNetwork) *NullableInlineResponse200261ResultingNetwork {
	return &NullableInlineResponse200261ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200261ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200261ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
