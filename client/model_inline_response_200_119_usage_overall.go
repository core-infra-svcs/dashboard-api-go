...
// InlineResponse200119UsageOverall Overall data usage of all clients across organization
type InlineResponse200119UsageOverall struct {
...
func NewInlineResponse200119UsageOverall() *InlineResponse200119UsageOverall {
	this := InlineResponse200119UsageOverall{}
	return &this
}
...
func (o InlineResponse200119UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200119UsageOverall struct {
	value *InlineResponse200119UsageOverall
	isSet bool
}

func (v NullableInlineResponse200119UsageOverall) Get() *InlineResponse200119UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200119UsageOverall) Set(val *InlineResponse200119UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200119UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200119UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200119UsageOverall(val *InlineResponse200119UsageOverall) *NullableInlineResponse200119UsageOverall {
	return &NullableInlineResponse200119UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200119UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200119UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
