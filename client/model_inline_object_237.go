...
func (o *InlineObject237) GetAdminSettings() OrganizationsOrganizationIdBrandingPoliciesAdminSettings {
...
// and a boolean to check if the value has been set.
func (o *InlineObject237) GetAdminSettingsOk() (*OrganizationsOrganizationIdBrandingPoliciesAdminSettings, bool) {
	if o == nil || isNil(o.AdminSettings) {
    return nil, false
	}
...
func (o *InlineObject237) HasAdminSettings() bool {
	if o != nil && !isNil(o.AdminSettings) {
		return true
	}
...
func (o *InlineObject237) SetAdminSettings(v OrganizationsOrganizationIdBrandingPoliciesAdminSettings) {
	o.AdminSettings = &v
}

// GetHelpSettings returns the HelpSettings field value if set, zero value otherwise.
func (o *InlineObject237) GetHelpSettings() OrganizationsOrganizationIdBrandingPoliciesHelpSettings {
...
// and a boolean to check if the value has been set.
func (o *InlineObject237) GetHelpSettingsOk() (*OrganizationsOrganizationIdBrandingPoliciesHelpSettings, bool) {
	if o == nil || isNil(o.HelpSettings) {
    return nil, false
	}
...
func (o *InlineObject237) HasHelpSettings() bool {
	if o != nil && !isNil(o.HelpSettings) {
		return true
	}
...
func (o *InlineObject237) SetHelpSettings(v OrganizationsOrganizationIdBrandingPoliciesHelpSettings) {
	o.HelpSettings = &v
}

// GetCustomLogo returns the CustomLogo field value if set, zero value otherwise.
func (o *InlineObject237) GetCustomLogo() OrganizationsOrganizationIdBrandingPoliciesCustomLogo1 {
...
// and a boolean to check if the value has been set.
func (o *InlineObject237) GetCustomLogoOk() (*OrganizationsOrganizationIdBrandingPoliciesCustomLogo1, bool) {
	if o == nil || isNil(o.CustomLogo) {
    return nil, false
	}
...
func (o *InlineObject237) HasCustomLogo() bool {
	if o != nil && !isNil(o.CustomLogo) {
		return true
	}
...
func (o *InlineObject237) SetCustomLogo(v OrganizationsOrganizationIdBrandingPoliciesCustomLogo1) {
	o.CustomLogo = &v
}
