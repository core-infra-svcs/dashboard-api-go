...
func (r ApplicationsApiGetOrganizationSummaryTopApplicationsByUsageRequest) Execute() ([]InlineResponse200313, *http.Response, error) {
...
func (a *ApplicationsApiService) GetOrganizationSummaryTopApplicationsByUsageExecute(r ApplicationsApiGetOrganizationSummaryTopApplicationsByUsageRequest) ([]InlineResponse200313, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApplicationsApiGetOrganizationSummaryTopApplicationsCategoriesByUsageRequest) Execute() ([]InlineResponse200314, *http.Response, error) {
...
func (a *ApplicationsApiService) GetOrganizationSummaryTopApplicationsCategoriesByUsageExecute(r ApplicationsApiGetOrganizationSummaryTopApplicationsCategoriesByUsageRequest) ([]InlineResponse200314, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
