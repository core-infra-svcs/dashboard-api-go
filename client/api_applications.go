...
func (r ApplicationsApiGetNetworkInsightApplicationHealthByTimeRequest) Execute() ([]InlineResponse20095, *http.Response, error) {
...
func (a *ApplicationsApiService) GetNetworkInsightApplicationHealthByTimeExecute(r ApplicationsApiGetNetworkInsightApplicationHealthByTimeRequest) ([]InlineResponse20095, *http.Response, error) {
	var (
...
func (r ApplicationsApiGetOrganizationInsightApplicationsRequest) Execute() ([]InlineResponse200238, *http.Response, error) {
...
func (a *ApplicationsApiService) GetOrganizationInsightApplicationsExecute(r ApplicationsApiGetOrganizationInsightApplicationsRequest) ([]InlineResponse200238, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
