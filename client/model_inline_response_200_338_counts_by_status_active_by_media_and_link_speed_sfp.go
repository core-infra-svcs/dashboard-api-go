...
// InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp The count data for SFP ports, indexed by speed in Mb
type InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp struct {
...
func NewInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp() *InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp {
	this := InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp{}
	return &this
}
...
func (o InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp struct {
	value *InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp
	isSet bool
}

func (v NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp) Get() *InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp {
	return v.value
}

func (v *NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp) Set(val *InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp(val *InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp) *NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp {
	return &NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp{value: val, isSet: true}
}

func (v NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedSfp) UnmarshalJSON(src []byte) error {
	v.isSet = true
