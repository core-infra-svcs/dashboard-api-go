...
func (r UplinkSelectionApiGetNetworkApplianceTrafficShapingUplinkSelectionRequest) Execute() (*InlineResponse20066, *http.Response, error) {
...
func (a *UplinkSelectionApiService) GetNetworkApplianceTrafficShapingUplinkSelectionExecute(r UplinkSelectionApiGetNetworkApplianceTrafficShapingUplinkSelectionRequest) (*InlineResponse20066, *http.Response, error) {
	var (
...
func (r UplinkSelectionApiUpdateNetworkApplianceTrafficShapingUplinkSelectionRequest) Execute() (*InlineResponse20066, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20066
func (a *UplinkSelectionApiService) UpdateNetworkApplianceTrafficShapingUplinkSelectionExecute(r UplinkSelectionApiUpdateNetworkApplianceTrafficShapingUplinkSelectionRequest) (*InlineResponse20066, *http.Response, error) {
	var (
