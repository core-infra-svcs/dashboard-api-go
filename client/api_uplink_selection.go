...
func (r UplinkSelectionApiGetNetworkApplianceTrafficShapingUplinkSelectionRequest) Execute() (*InlineResponse20079, *http.Response, error) {
...
func (a *UplinkSelectionApiService) GetNetworkApplianceTrafficShapingUplinkSelectionExecute(r UplinkSelectionApiGetNetworkApplianceTrafficShapingUplinkSelectionRequest) (*InlineResponse20079, *http.Response, error) {
	var (
...
func (r UplinkSelectionApiUpdateNetworkApplianceTrafficShapingUplinkSelectionRequest) Execute() (*InlineResponse20079, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20079
func (a *UplinkSelectionApiService) UpdateNetworkApplianceTrafficShapingUplinkSelectionExecute(r UplinkSelectionApiUpdateNetworkApplianceTrafficShapingUplinkSelectionRequest) (*InlineResponse20079, *http.Response, error) {
	var (
