...
type InlineResponse20033 struct {
	...
	LocalStatusPage *InlineResponse20033LocalStatusPage `json:"localStatusPage,omitempty"`
	SecurePort *InlineResponse20033SecurePort `json:"securePort,omitempty"`
	Fips *InlineResponse20033Fips `json:"fips,omitempty"`
	NamedVlans *InlineResponse20033NamedVlans `json:"namedVlans,omitempty"`
	ClientPrivacy *InlineResponse20033ClientPrivacy `json:"clientPrivacy,omitempty"`
}
...
func (o *InlineResponse20033) GetLocalStatusPage() InlineResponse20033LocalStatusPage {
	if o == nil || isNil(o.LocalStatusPage) {
		var ret InlineResponse20033LocalStatusPage
		return ret
	}
...
// SetLocalStatusPage gets a reference to the given InlineResponse20033LocalStatusPage and assigns it to the LocalStatusPage field.
...
func (o *InlineResponse20033) GetFips() InlineResponse20033Fips {
	if o == nil || isNil(o.Fips) {
		var ret InlineResponse20033Fips
		return ret
	}
	return *o.Fips
}
...
// SetFips gets a reference to the given InlineResponse20033Fips and assigns it to the Fips field.
...
func (o *InlineResponse20033) GetNamedVlans() InlineResponse20033NamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret InlineResponse20033NamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given InlineResponse20033NamedVlans and assigns it to the NamedVlans field.
...
func (o *InlineResponse20033) GetClientPrivacy() InlineResponse20033ClientPrivacy {
	if o == nil || isNil(o.ClientPrivacy) {
		var ret InlineResponse20033ClientPrivacy
		return ret
	}
...
// SetClientPrivacy gets a reference to the given InlineResponse20033ClientPrivacy and assigns it to the ClientPrivacy field.
