...
type InlineResponse20033 struct {
	Products *InlineResponse20033Products `json:"products,omitempty"`
	// The ordered stages in the network
	Stages []InlineResponse20033Stages `json:"stages,omitempty"`
...
func (o *InlineResponse20033) GetProducts() InlineResponse20033Products {
	if o == nil || isNil(o.Products) {
		var ret InlineResponse20033Products
		return ret
	}
	return *o.Products
}
...
// SetProducts gets a reference to the given InlineResponse20033Products and assigns it to the Products field.
...
func (o *InlineResponse20033) GetStages() []InlineResponse20033Stages {
	if o == nil || isNil(o.Stages) {
		var ret []InlineResponse20033Stages
		return ret
	}
	return o.Stages
}
...
// SetStages gets a reference to the given []InlineResponse20033Stages and assigns it to the Stages field.
