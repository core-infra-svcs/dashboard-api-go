...
type InlineResponse20033 struct {
	...
	ClientVpnConnections []InlineResponse20033ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20033) GetClientVpnConnections() []InlineResponse20033ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20033ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20033ClientVpnConnections and assigns it to the ClientVpnConnections field.
