...
// InlineResponse200276Free Information regarding memory availability on the device over the entire timespan
type InlineResponse200276Free struct {
...
func (o InlineResponse200276Free) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200276Free struct {
	value *InlineResponse200276Free
	isSet bool
}

func (v NullableInlineResponse200276Free) Get() *InlineResponse200276Free {
	return v.value
}

func (v *NullableInlineResponse200276Free) Set(val *InlineResponse200276Free) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200276Free) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200276Free) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200276Free(val *InlineResponse200276Free) *NullableInlineResponse200276Free {
	return &NullableInlineResponse200276Free{value: val, isSet: true}
}

func (v NullableInlineResponse200276Free) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200276Free) UnmarshalJSON(src []byte) error {
	v.isSet = true
