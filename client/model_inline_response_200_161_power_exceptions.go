...
// InlineResponse200161PowerExceptions struct for InlineResponse200161PowerExceptions
type InlineResponse200161PowerExceptions struct {
...
func NewInlineResponse200161PowerExceptions() *InlineResponse200161PowerExceptions {
	this := InlineResponse200161PowerExceptions{}
	return &this
}
...
func (o InlineResponse200161PowerExceptions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200161PowerExceptions struct {
	value *InlineResponse200161PowerExceptions
	isSet bool
}

func (v NullableInlineResponse200161PowerExceptions) Get() *InlineResponse200161PowerExceptions {
	return v.value
}

func (v *NullableInlineResponse200161PowerExceptions) Set(val *InlineResponse200161PowerExceptions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200161PowerExceptions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200161PowerExceptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200161PowerExceptions(val *InlineResponse200161PowerExceptions) *NullableInlineResponse200161PowerExceptions {
	return &NullableInlineResponse200161PowerExceptions{value: val, isSet: true}
}

func (v NullableInlineResponse200161PowerExceptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200161PowerExceptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
