...
// InlineResponse20088ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20088ToVersion struct {
...
func NewInlineResponse20088ToVersion() *InlineResponse20088ToVersion {
	this := InlineResponse20088ToVersion{}
	return &this
}
...
func (o InlineResponse20088ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20088ToVersion struct {
	value *InlineResponse20088ToVersion
	isSet bool
}

func (v NullableInlineResponse20088ToVersion) Get() *InlineResponse20088ToVersion {
	return v.value
}

func (v *NullableInlineResponse20088ToVersion) Set(val *InlineResponse20088ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20088ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20088ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20088ToVersion(val *InlineResponse20088ToVersion) *NullableInlineResponse20088ToVersion {
	return &NullableInlineResponse20088ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20088ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20088ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
