...
// InlineResponse20046AlertDestinations A hash of destinations for this specific alert
type InlineResponse20046AlertDestinations struct {
...
func NewInlineResponse20046AlertDestinations() *InlineResponse20046AlertDestinations {
	this := InlineResponse20046AlertDestinations{}
	return &this
}
...
func (o InlineResponse20046AlertDestinations) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20046AlertDestinations struct {
	value *InlineResponse20046AlertDestinations
	isSet bool
}

func (v NullableInlineResponse20046AlertDestinations) Get() *InlineResponse20046AlertDestinations {
	return v.value
}

func (v *NullableInlineResponse20046AlertDestinations) Set(val *InlineResponse20046AlertDestinations) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20046AlertDestinations) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20046AlertDestinations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20046AlertDestinations(val *InlineResponse20046AlertDestinations) *NullableInlineResponse20046AlertDestinations {
	return &NullableInlineResponse20046AlertDestinations{value: val, isSet: true}
}

func (v NullableInlineResponse20046AlertDestinations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20046AlertDestinations) UnmarshalJSON(src []byte) error {
	v.isSet = true
