...
// InlineResponse200304MetaCountsItems Items
type InlineResponse200304MetaCountsItems struct {
...
func NewInlineResponse200304MetaCountsItems() *InlineResponse200304MetaCountsItems {
	this := InlineResponse200304MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200304MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200304MetaCountsItems struct {
	value *InlineResponse200304MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200304MetaCountsItems) Get() *InlineResponse200304MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200304MetaCountsItems) Set(val *InlineResponse200304MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200304MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200304MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200304MetaCountsItems(val *InlineResponse200304MetaCountsItems) *NullableInlineResponse200304MetaCountsItems {
	return &NullableInlineResponse200304MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200304MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200304MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
