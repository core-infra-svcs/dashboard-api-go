...
// InlineResponse20039Stages struct for InlineResponse20039Stages
type InlineResponse20039Stages struct {
	Group *InlineResponse20039Group `json:"group,omitempty"`
	Milestones *InlineResponse20039Milestones `json:"milestones,omitempty"`
...
func NewInlineResponse20039Stages() *InlineResponse20039Stages {
	this := InlineResponse20039Stages{}
	return &this
}
...
func (o *InlineResponse20039Stages) GetGroup() InlineResponse20039Group {
	if o == nil || isNil(o.Group) {
		var ret InlineResponse20039Group
		return ret
	}
	return *o.Group
}
...
// SetGroup gets a reference to the given InlineResponse20039Group and assigns it to the Group field.
...
func (o *InlineResponse20039Stages) GetMilestones() InlineResponse20039Milestones {
	if o == nil || isNil(o.Milestones) {
		var ret InlineResponse20039Milestones
		return ret
	}
	return *o.Milestones
}
...
// SetMilestones gets a reference to the given InlineResponse20039Milestones and assigns it to the Milestones field.
...
func (o InlineResponse20039Stages) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20039Stages struct {
	value *InlineResponse20039Stages
	isSet bool
}

func (v NullableInlineResponse20039Stages) Get() *InlineResponse20039Stages {
	return v.value
}

func (v *NullableInlineResponse20039Stages) Set(val *InlineResponse20039Stages) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20039Stages) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20039Stages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20039Stages(val *InlineResponse20039Stages) *NullableInlineResponse20039Stages {
	return &NullableInlineResponse20039Stages{value: val, isSet: true}
}

func (v NullableInlineResponse20039Stages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20039Stages) UnmarshalJSON(src []byte) error {
	v.isSet = true
