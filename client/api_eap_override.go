...
func (r EapOverrideApiGetNetworkWirelessSsidEapOverrideRequest) Execute() (*InlineResponse200205, *http.Response, error) {
...
func (a *EapOverrideApiService) GetNetworkWirelessSsidEapOverrideExecute(r EapOverrideApiGetNetworkWirelessSsidEapOverrideRequest) (*InlineResponse200205, *http.Response, error) {
	var (
...
func (r EapOverrideApiUpdateNetworkWirelessSsidEapOverrideRequest) UpdateNetworkWirelessSsidEapOverride(updateNetworkWirelessSsidEapOverride InlineObject198) EapOverrideApiUpdateNetworkWirelessSsidEapOverrideRequest {
	r.updateNetworkWirelessSsidEapOverride = &updateNetworkWirelessSsidEapOverride
	return r
}

func (r EapOverrideApiUpdateNetworkWirelessSsidEapOverrideRequest) Execute() (*InlineResponse200205, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200205
func (a *EapOverrideApiService) UpdateNetworkWirelessSsidEapOverrideExecute(r EapOverrideApiUpdateNetworkWirelessSsidEapOverrideRequest) (*InlineResponse200205, *http.Response, error) {
	var (
