...
func (r EapOverrideApiGetNetworkWirelessSsidEapOverrideRequest) Execute() (*InlineResponse200194, *http.Response, error) {
...
func (a *EapOverrideApiService) GetNetworkWirelessSsidEapOverrideExecute(r EapOverrideApiGetNetworkWirelessSsidEapOverrideRequest) (*InlineResponse200194, *http.Response, error) {
	var (
...
func (r EapOverrideApiUpdateNetworkWirelessSsidEapOverrideRequest) UpdateNetworkWirelessSsidEapOverride(updateNetworkWirelessSsidEapOverride InlineObject191) EapOverrideApiUpdateNetworkWirelessSsidEapOverrideRequest {
	r.updateNetworkWirelessSsidEapOverride = &updateNetworkWirelessSsidEapOverride
	return r
}

func (r EapOverrideApiUpdateNetworkWirelessSsidEapOverrideRequest) Execute() (*InlineResponse200194, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200194
func (a *EapOverrideApiService) UpdateNetworkWirelessSsidEapOverrideExecute(r EapOverrideApiUpdateNetworkWirelessSsidEapOverrideRequest) (*InlineResponse200194, *http.Response, error) {
	var (
