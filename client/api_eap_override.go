...
func (r EapOverrideApiGetNetworkWirelessSsidEapOverrideRequest) Execute() (*InlineResponse200186, *http.Response, error) {
...
func (a *EapOverrideApiService) GetNetworkWirelessSsidEapOverrideExecute(r EapOverrideApiGetNetworkWirelessSsidEapOverrideRequest) (*InlineResponse200186, *http.Response, error) {
	var (
...
func (r EapOverrideApiUpdateNetworkWirelessSsidEapOverrideRequest) UpdateNetworkWirelessSsidEapOverride(updateNetworkWirelessSsidEapOverride InlineObject185) EapOverrideApiUpdateNetworkWirelessSsidEapOverrideRequest {
	r.updateNetworkWirelessSsidEapOverride = &updateNetworkWirelessSsidEapOverride
	return r
}

func (r EapOverrideApiUpdateNetworkWirelessSsidEapOverrideRequest) Execute() (*InlineResponse200186, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200186
func (a *EapOverrideApiService) UpdateNetworkWirelessSsidEapOverrideExecute(r EapOverrideApiUpdateNetworkWirelessSsidEapOverrideRequest) (*InlineResponse200186, *http.Response, error) {
	var (
