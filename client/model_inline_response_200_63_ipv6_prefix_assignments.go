...
// InlineResponse20063Ipv6PrefixAssignments struct for InlineResponse20063Ipv6PrefixAssignments
type InlineResponse20063Ipv6PrefixAssignments struct {
...
func NewInlineResponse20063Ipv6PrefixAssignments() *InlineResponse20063Ipv6PrefixAssignments {
	this := InlineResponse20063Ipv6PrefixAssignments{}
	return &this
}
...
func (o InlineResponse20063Ipv6PrefixAssignments) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20063Ipv6PrefixAssignments struct {
	value *InlineResponse20063Ipv6PrefixAssignments
	isSet bool
}

func (v NullableInlineResponse20063Ipv6PrefixAssignments) Get() *InlineResponse20063Ipv6PrefixAssignments {
	return v.value
}

func (v *NullableInlineResponse20063Ipv6PrefixAssignments) Set(val *InlineResponse20063Ipv6PrefixAssignments) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20063Ipv6PrefixAssignments) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20063Ipv6PrefixAssignments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20063Ipv6PrefixAssignments(val *InlineResponse20063Ipv6PrefixAssignments) *NullableInlineResponse20063Ipv6PrefixAssignments {
	return &NullableInlineResponse20063Ipv6PrefixAssignments{value: val, isSet: true}
}

func (v NullableInlineResponse20063Ipv6PrefixAssignments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20063Ipv6PrefixAssignments) UnmarshalJSON(src []byte) error {
	v.isSet = true
