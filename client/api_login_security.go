...
func (r LoginSecurityApiGetOrganizationLoginSecurityRequest) Execute() (*InlineResponse20092, *http.Response, error) {
...
func (a *LoginSecurityApiService) GetOrganizationLoginSecurityExecute(r LoginSecurityApiGetOrganizationLoginSecurityRequest) (*InlineResponse20092, *http.Response, error) {
	var (
...
func (r LoginSecurityApiUpdateOrganizationLoginSecurityRequest) Execute() (*InlineResponse20092, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20092
func (a *LoginSecurityApiService) UpdateOrganizationLoginSecurityExecute(r LoginSecurityApiUpdateOrganizationLoginSecurityRequest) (*InlineResponse20092, *http.Response, error) {
	var (
