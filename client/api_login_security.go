...
func (r LoginSecurityApiApiGetOrganizationLoginSecurityRequest) Execute() (InlineResponse2003, *_nethttp.Response, error) {
...
func (a *LoginSecurityApiService) GetOrganizationLoginSecurityExecute(r LoginSecurityApiApiGetOrganizationLoginSecurityRequest) (InlineResponse2003, *_nethttp.Response, error) {
	var (
...
func (r LoginSecurityApiApiUpdateOrganizationLoginSecurityRequest) Execute() (InlineResponse2003, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2003
func (a *LoginSecurityApiService) UpdateOrganizationLoginSecurityExecute(r LoginSecurityApiApiUpdateOrganizationLoginSecurityRequest) (InlineResponse2003, *_nethttp.Response, error) {
	var (
