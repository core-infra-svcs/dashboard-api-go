...
func (r LoginSecurityApiGetOrganizationLoginSecurityRequest) Execute() (*InlineResponse200261, *http.Response, error) {
...
func (a *LoginSecurityApiService) GetOrganizationLoginSecurityExecute(r LoginSecurityApiGetOrganizationLoginSecurityRequest) (*InlineResponse200261, *http.Response, error) {
	var (
...
func (r LoginSecurityApiUpdateOrganizationLoginSecurityRequest) Execute() (*InlineResponse200261, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200261
func (a *LoginSecurityApiService) UpdateOrganizationLoginSecurityExecute(r LoginSecurityApiUpdateOrganizationLoginSecurityRequest) (*InlineResponse200261, *http.Response, error) {
	var (
