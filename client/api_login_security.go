...
func (r LoginSecurityApiGetOrganizationLoginSecurityRequest) Execute() (*InlineResponse200161, *http.Response, error) {
...
func (a *LoginSecurityApiService) GetOrganizationLoginSecurityExecute(r LoginSecurityApiGetOrganizationLoginSecurityRequest) (*InlineResponse200161, *http.Response, error) {
	var (
...
func (r LoginSecurityApiUpdateOrganizationLoginSecurityRequest) UpdateOrganizationLoginSecurity(updateOrganizationLoginSecurity InlineObject229) LoginSecurityApiUpdateOrganizationLoginSecurityRequest {
	r.updateOrganizationLoginSecurity = &updateOrganizationLoginSecurity
	return r
}

func (r LoginSecurityApiUpdateOrganizationLoginSecurityRequest) Execute() (*InlineResponse200161, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200161
func (a *LoginSecurityApiService) UpdateOrganizationLoginSecurityExecute(r LoginSecurityApiUpdateOrganizationLoginSecurityRequest) (*InlineResponse200161, *http.Response, error) {
	var (
