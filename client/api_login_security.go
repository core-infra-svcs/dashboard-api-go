...
func (r LoginSecurityApiGetOrganizationLoginSecurityRequest) Execute() (*InlineResponse200155, *http.Response, error) {
...
func (a *LoginSecurityApiService) GetOrganizationLoginSecurityExecute(r LoginSecurityApiGetOrganizationLoginSecurityRequest) (*InlineResponse200155, *http.Response, error) {
	var (
...
func (r LoginSecurityApiUpdateOrganizationLoginSecurityRequest) UpdateOrganizationLoginSecurity(updateOrganizationLoginSecurity InlineObject226) LoginSecurityApiUpdateOrganizationLoginSecurityRequest {
	r.updateOrganizationLoginSecurity = &updateOrganizationLoginSecurity
	return r
}

func (r LoginSecurityApiUpdateOrganizationLoginSecurityRequest) Execute() (*InlineResponse200155, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200155
func (a *LoginSecurityApiService) UpdateOrganizationLoginSecurityExecute(r LoginSecurityApiUpdateOrganizationLoginSecurityRequest) (*InlineResponse200155, *http.Response, error) {
	var (
