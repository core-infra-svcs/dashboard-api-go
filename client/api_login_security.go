...
func (r LoginSecurityApiApiGetOrganizationLoginSecurityRequest) Execute() (InlineResponse20082, *_nethttp.Response, error) {
...
func (a *LoginSecurityApiService) GetOrganizationLoginSecurityExecute(r LoginSecurityApiApiGetOrganizationLoginSecurityRequest) (InlineResponse20082, *_nethttp.Response, error) {
	var (
...
func (r LoginSecurityApiApiUpdateOrganizationLoginSecurityRequest) UpdateOrganizationLoginSecurity(updateOrganizationLoginSecurity InlineObject205) LoginSecurityApiApiUpdateOrganizationLoginSecurityRequest {
	r.updateOrganizationLoginSecurity = &updateOrganizationLoginSecurity
	return r
}

func (r LoginSecurityApiApiUpdateOrganizationLoginSecurityRequest) Execute() (InlineResponse20082, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20082
func (a *LoginSecurityApiService) UpdateOrganizationLoginSecurityExecute(r LoginSecurityApiApiUpdateOrganizationLoginSecurityRequest) (InlineResponse20082, *_nethttp.Response, error) {
	var (
