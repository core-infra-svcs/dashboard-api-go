...
// InlineResponse200237MetaCountsItems Counts relating to the paginated items
type InlineResponse200237MetaCountsItems struct {
...
func NewInlineResponse200237MetaCountsItems() *InlineResponse200237MetaCountsItems {
	this := InlineResponse200237MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200237MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200237MetaCountsItems struct {
	value *InlineResponse200237MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200237MetaCountsItems) Get() *InlineResponse200237MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200237MetaCountsItems) Set(val *InlineResponse200237MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200237MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200237MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200237MetaCountsItems(val *InlineResponse200237MetaCountsItems) *NullableInlineResponse200237MetaCountsItems {
	return &NullableInlineResponse200237MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200237MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200237MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
