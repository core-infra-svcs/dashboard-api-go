...
func (r SsidsApiGetOrganizationSummaryTopSsidsByUsageRequest) Execute() ([]InlineResponse200177, *http.Response, error) {
...
func (a *SsidsApiService) GetOrganizationSummaryTopSsidsByUsageExecute(r SsidsApiGetOrganizationSummaryTopSsidsByUsageRequest) ([]InlineResponse200177, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
