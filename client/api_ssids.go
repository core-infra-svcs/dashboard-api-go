...
func (r SsidsApiGetNetworkWirelessSsidIdentityPskRequest) Execute() (*InlineResponse20073, *http.Response, error) {
...
func (a *SsidsApiService) GetNetworkWirelessSsidIdentityPskExecute(r SsidsApiGetNetworkWirelessSsidIdentityPskRequest) (*InlineResponse20073, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsApiGetNetworkWirelessSsidIdentityPsksRequest) Execute() ([]InlineResponse20073, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20073
func (a *SsidsApiService) GetNetworkWirelessSsidIdentityPsksExecute(r SsidsApiGetNetworkWirelessSsidIdentityPsksRequest) ([]InlineResponse20073, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsApiGetNetworkWirelessSsidSplashSettingsRequest) Execute() (*InlineResponse20074, *http.Response, error) {
...
func (a *SsidsApiService) GetNetworkWirelessSsidSplashSettingsExecute(r SsidsApiGetNetworkWirelessSsidSplashSettingsRequest) (*InlineResponse20074, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsApiGetOrganizationSummaryTopSsidsByUsageRequest) Execute() ([]InlineResponse200116, *http.Response, error) {
...
func (a *SsidsApiService) GetOrganizationSummaryTopSsidsByUsageExecute(r SsidsApiGetOrganizationSummaryTopSsidsByUsageRequest) ([]InlineResponse200116, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsApiUpdateNetworkWirelessSsidSplashSettingsRequest) Execute() (*InlineResponse20074, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20074
func (a *SsidsApiService) UpdateNetworkWirelessSsidSplashSettingsExecute(r SsidsApiUpdateNetworkWirelessSsidSplashSettingsRequest) (*InlineResponse20074, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
