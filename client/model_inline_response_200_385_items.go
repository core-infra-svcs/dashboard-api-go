...
type InlineResponse200385Items struct {
	...
	Intervals []InlineResponse200385Intervals `json:"intervals,omitempty"`
}
...
func (o *InlineResponse200385Items) GetIntervals() []InlineResponse200385Intervals {
	if o == nil || isNil(o.Intervals) {
		var ret []InlineResponse200385Intervals
		return ret
	}
	return o.Intervals
}
...
// SetIntervals gets a reference to the given []InlineResponse200385Intervals and assigns it to the Intervals field.
