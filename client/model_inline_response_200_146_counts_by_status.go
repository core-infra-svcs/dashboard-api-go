...
// InlineResponse200146CountsByStatus byStatus
type InlineResponse200146CountsByStatus struct {
	// online count
...
func NewInlineResponse200146CountsByStatus() *InlineResponse200146CountsByStatus {
	this := InlineResponse200146CountsByStatus{}
	return &this
}
...
func (o InlineResponse200146CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200146CountsByStatus struct {
	value *InlineResponse200146CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200146CountsByStatus) Get() *InlineResponse200146CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200146CountsByStatus) Set(val *InlineResponse200146CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200146CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200146CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200146CountsByStatus(val *InlineResponse200146CountsByStatus) *NullableInlineResponse200146CountsByStatus {
	return &NullableInlineResponse200146CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200146CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200146CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
