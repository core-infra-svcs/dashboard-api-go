...
// InlineResponse200198SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200198SixGhzSettings struct {
...
func NewInlineResponse200198SixGhzSettings() *InlineResponse200198SixGhzSettings {
	this := InlineResponse200198SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200198SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200198SixGhzSettings struct {
	value *InlineResponse200198SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200198SixGhzSettings) Get() *InlineResponse200198SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200198SixGhzSettings) Set(val *InlineResponse200198SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200198SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200198SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200198SixGhzSettings(val *InlineResponse200198SixGhzSettings) *NullableInlineResponse200198SixGhzSettings {
	return &NullableInlineResponse200198SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200198SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200198SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
