...
// InlineResponse20029Events struct for InlineResponse20029Events
type InlineResponse20029Events struct {
	...
	EventData *InlineResponse20029EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20029Events() *InlineResponse20029Events {
	this := InlineResponse20029Events{}
	return &this
}
...
func (o *InlineResponse20029Events) GetEventData() InlineResponse20029EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20029EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20029EventData and assigns it to the EventData field.
func (o *InlineResponse20029Events) SetEventData(v InlineResponse20029EventData) {
	o.EventData = &v
}

func (o InlineResponse20029Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20029Events struct {
	value *InlineResponse20029Events
	isSet bool
}

func (v NullableInlineResponse20029Events) Get() *InlineResponse20029Events {
	return v.value
}

func (v *NullableInlineResponse20029Events) Set(val *InlineResponse20029Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20029Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20029Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20029Events(val *InlineResponse20029Events) *NullableInlineResponse20029Events {
	return &NullableInlineResponse20029Events{value: val, isSet: true}
}

func (v NullableInlineResponse20029Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20029Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
