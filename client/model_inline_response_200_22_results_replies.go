...
// InlineResponse20022ResultsReplies struct for InlineResponse20022ResultsReplies
type InlineResponse20022ResultsReplies struct {
...
func NewInlineResponse20022ResultsReplies() *InlineResponse20022ResultsReplies {
	this := InlineResponse20022ResultsReplies{}
	return &this
}
...
func (o InlineResponse20022ResultsReplies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20022ResultsReplies struct {
	value *InlineResponse20022ResultsReplies
	isSet bool
}

func (v NullableInlineResponse20022ResultsReplies) Get() *InlineResponse20022ResultsReplies {
	return v.value
}

func (v *NullableInlineResponse20022ResultsReplies) Set(val *InlineResponse20022ResultsReplies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20022ResultsReplies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20022ResultsReplies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20022ResultsReplies(val *InlineResponse20022ResultsReplies) *NullableInlineResponse20022ResultsReplies {
	return &NullableInlineResponse20022ResultsReplies{value: val, isSet: true}
}

func (v NullableInlineResponse20022ResultsReplies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20022ResultsReplies) UnmarshalJSON(src []byte) error {
	v.isSet = true
