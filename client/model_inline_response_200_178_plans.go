...
// InlineResponse200178Plans struct for InlineResponse200178Plans
type InlineResponse200178Plans struct {
	// The id of the pricing plan to update.
	Id *string `json:"id,omitempty"`
	// The price of the billing plan.
	Price *float32 `json:"price,omitempty"`
	BandwidthLimits *InlineResponse200178BandwidthLimits `json:"bandwidthLimits,omitempty"`
...
func NewInlineResponse200178Plans() *InlineResponse200178Plans {
	this := InlineResponse200178Plans{}
	return &this
}
...
func (o *InlineResponse200178Plans) GetBandwidthLimits() InlineResponse200178BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse200178BandwidthLimits
		return ret
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse200178BandwidthLimits and assigns it to the BandwidthLimits field.
...
func (o InlineResponse200178Plans) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200178Plans struct {
	value *InlineResponse200178Plans
	isSet bool
}

func (v NullableInlineResponse200178Plans) Get() *InlineResponse200178Plans {
	return v.value
}

func (v *NullableInlineResponse200178Plans) Set(val *InlineResponse200178Plans) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200178Plans) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200178Plans) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200178Plans(val *InlineResponse200178Plans) *NullableInlineResponse200178Plans {
	return &NullableInlineResponse200178Plans{value: val, isSet: true}
}

func (v NullableInlineResponse200178Plans) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200178Plans) UnmarshalJSON(src []byte) error {
	v.isSet = true
