...
// InlineResponse200104Plans struct for InlineResponse200104Plans
type InlineResponse200104Plans struct {
	// The id of the pricing plan to update.
	Id *string `json:"id,omitempty"`
	// The price of the billing plan.
	Price *float32 `json:"price,omitempty"`
	BandwidthLimits *InlineResponse200104BandwidthLimits `json:"bandwidthLimits,omitempty"`
...
func NewInlineResponse200104Plans() *InlineResponse200104Plans {
	this := InlineResponse200104Plans{}
	return &this
}
...
func (o *InlineResponse200104Plans) GetBandwidthLimits() InlineResponse200104BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse200104BandwidthLimits
		return ret
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse200104BandwidthLimits and assigns it to the BandwidthLimits field.
...
func (o InlineResponse200104Plans) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200104Plans struct {
	value *InlineResponse200104Plans
	isSet bool
}

func (v NullableInlineResponse200104Plans) Get() *InlineResponse200104Plans {
	return v.value
}

func (v *NullableInlineResponse200104Plans) Set(val *InlineResponse200104Plans) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200104Plans) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200104Plans) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200104Plans(val *InlineResponse200104Plans) *NullableInlineResponse200104Plans {
	return &NullableInlineResponse200104Plans{value: val, isSet: true}
}

func (v NullableInlineResponse200104Plans) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200104Plans) UnmarshalJSON(src []byte) error {
	v.isSet = true
