...
// InlineResponse20069Limits The current limits of various adaptive policy objects.
type InlineResponse20069Limits struct {
...
func NewInlineResponse20069Limits() *InlineResponse20069Limits {
	this := InlineResponse20069Limits{}
	return &this
}
...
func (o InlineResponse20069Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20069Limits struct {
	value *InlineResponse20069Limits
	isSet bool
}

func (v NullableInlineResponse20069Limits) Get() *InlineResponse20069Limits {
	return v.value
}

func (v *NullableInlineResponse20069Limits) Set(val *InlineResponse20069Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20069Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20069Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20069Limits(val *InlineResponse20069Limits) *NullableInlineResponse20069Limits {
	return &NullableInlineResponse20069Limits{value: val, isSet: true}
}

func (v NullableInlineResponse20069Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20069Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
