...
func (r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) CreateNetworkSwitchLinkAggregation(createNetworkSwitchLinkAggregation InlineObject141) LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest {
	r.createNetworkSwitchLinkAggregation = &createNetworkSwitchLinkAggregation
	return r
}

func (r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) Execute() (*InlineResponse200153, *http.Response, error) {
...
func (a *LinkAggregationsApiService) CreateNetworkSwitchLinkAggregationExecute(r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) (*InlineResponse200153, *http.Response, error) {
	var (
...
func (r LinkAggregationsApiGetNetworkSwitchLinkAggregationsRequest) Execute() ([]InlineResponse200153, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200153
func (a *LinkAggregationsApiService) GetNetworkSwitchLinkAggregationsExecute(r LinkAggregationsApiGetNetworkSwitchLinkAggregationsRequest) ([]InlineResponse200153, *http.Response, error) {
	var (
...
func (r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) UpdateNetworkSwitchLinkAggregation(updateNetworkSwitchLinkAggregation InlineObject142) LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest {
	r.updateNetworkSwitchLinkAggregation = &updateNetworkSwitchLinkAggregation
	return r
}

func (r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) Execute() (*InlineResponse200153, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200153
func (a *LinkAggregationsApiService) UpdateNetworkSwitchLinkAggregationExecute(r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) (*InlineResponse200153, *http.Response, error) {
	var (
