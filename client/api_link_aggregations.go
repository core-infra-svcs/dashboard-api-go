...
func (r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) Execute() (*InlineResponse200164, *http.Response, error) {
...
func (a *LinkAggregationsApiService) CreateNetworkSwitchLinkAggregationExecute(r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) (*InlineResponse200164, *http.Response, error) {
	var (
...
func (r LinkAggregationsApiGetNetworkSwitchLinkAggregationsRequest) Execute() ([]InlineResponse200164, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200164
func (a *LinkAggregationsApiService) GetNetworkSwitchLinkAggregationsExecute(r LinkAggregationsApiGetNetworkSwitchLinkAggregationsRequest) ([]InlineResponse200164, *http.Response, error) {
	var (
...
func (r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) Execute() (*InlineResponse200164, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200164
func (a *LinkAggregationsApiService) UpdateNetworkSwitchLinkAggregationExecute(r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) (*InlineResponse200164, *http.Response, error) {
	var (
