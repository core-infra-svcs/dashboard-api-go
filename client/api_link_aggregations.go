...
func (r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) CreateNetworkSwitchLinkAggregation(createNetworkSwitchLinkAggregation InlineObject146) LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest {
	r.createNetworkSwitchLinkAggregation = &createNetworkSwitchLinkAggregation
	return r
}

func (r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) Execute() (*InlineResponse200161, *http.Response, error) {
...
func (a *LinkAggregationsApiService) CreateNetworkSwitchLinkAggregationExecute(r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) (*InlineResponse200161, *http.Response, error) {
	var (
...
func (r LinkAggregationsApiGetNetworkSwitchLinkAggregationsRequest) Execute() ([]InlineResponse200161, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200161
func (a *LinkAggregationsApiService) GetNetworkSwitchLinkAggregationsExecute(r LinkAggregationsApiGetNetworkSwitchLinkAggregationsRequest) ([]InlineResponse200161, *http.Response, error) {
	var (
...
func (r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) UpdateNetworkSwitchLinkAggregation(updateNetworkSwitchLinkAggregation InlineObject147) LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest {
	r.updateNetworkSwitchLinkAggregation = &updateNetworkSwitchLinkAggregation
	return r
}

func (r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) Execute() (*InlineResponse200161, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200161
func (a *LinkAggregationsApiService) UpdateNetworkSwitchLinkAggregationExecute(r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) (*InlineResponse200161, *http.Response, error) {
	var (
