...
func (r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) CreateNetworkSwitchLinkAggregation(createNetworkSwitchLinkAggregation InlineObject135) LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest {
	r.createNetworkSwitchLinkAggregation = &createNetworkSwitchLinkAggregation
	return r
}

func (r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) Execute() (*InlineResponse200146, *http.Response, error) {
...
func (a *LinkAggregationsApiService) CreateNetworkSwitchLinkAggregationExecute(r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) (*InlineResponse200146, *http.Response, error) {
	var (
...
func (r LinkAggregationsApiGetNetworkSwitchLinkAggregationsRequest) Execute() ([]InlineResponse200146, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200146
func (a *LinkAggregationsApiService) GetNetworkSwitchLinkAggregationsExecute(r LinkAggregationsApiGetNetworkSwitchLinkAggregationsRequest) ([]InlineResponse200146, *http.Response, error) {
	var (
...
func (r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) UpdateNetworkSwitchLinkAggregation(updateNetworkSwitchLinkAggregation InlineObject136) LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest {
	r.updateNetworkSwitchLinkAggregation = &updateNetworkSwitchLinkAggregation
	return r
}

func (r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) Execute() (*InlineResponse200146, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200146
func (a *LinkAggregationsApiService) UpdateNetworkSwitchLinkAggregationExecute(r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) (*InlineResponse200146, *http.Response, error) {
	var (
