...
func (r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
func (a *LinkAggregationsApiService) CreateNetworkSwitchLinkAggregationExecute(r LinkAggregationsApiCreateNetworkSwitchLinkAggregationRequest) (*InlineResponse200159, *http.Response, error) {
	var (
...
func (r LinkAggregationsApiGetNetworkSwitchLinkAggregationsRequest) Execute() ([]InlineResponse200159, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200159
func (a *LinkAggregationsApiService) GetNetworkSwitchLinkAggregationsExecute(r LinkAggregationsApiGetNetworkSwitchLinkAggregationsRequest) ([]InlineResponse200159, *http.Response, error) {
	var (
...
func (r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200159
func (a *LinkAggregationsApiService) UpdateNetworkSwitchLinkAggregationExecute(r LinkAggregationsApiUpdateNetworkSwitchLinkAggregationRequest) (*InlineResponse200159, *http.Response, error) {
	var (
