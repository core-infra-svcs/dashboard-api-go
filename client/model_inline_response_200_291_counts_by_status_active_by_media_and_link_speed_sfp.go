...
// InlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp The count data for SFP ports, indexed by speed in Mb
type InlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp struct {
...
func NewInlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp() *InlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp {
	this := InlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp{}
	return &this
}
...
func (o InlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp struct {
	value *InlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp
	isSet bool
}

func (v NullableInlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp) Get() *InlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp {
	return v.value
}

func (v *NullableInlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp) Set(val *InlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp(val *InlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp) *NullableInlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp {
	return &NullableInlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp{value: val, isSet: true}
}

func (v NullableInlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200291CountsByStatusActiveByMediaAndLinkSpeedSfp) UnmarshalJSON(src []byte) error {
	v.isSet = true
