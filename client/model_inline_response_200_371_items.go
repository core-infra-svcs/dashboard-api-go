...
type InlineResponse200371Items struct {
	...
	Failover *InlineResponse200371Failover `json:"failover,omitempty"`
...
func (o *InlineResponse200371Items) GetFailover() InlineResponse200371Failover {
	if o == nil || isNil(o.Failover) {
		var ret InlineResponse200371Failover
		return ret
	}
	return *o.Failover
}
...
// SetFailover gets a reference to the given InlineResponse200371Failover and assigns it to the Failover field.
