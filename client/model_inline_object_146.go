...
type InlineObject146 struct {
	...
	Md5AuthenticationKey *InlineResponse200152Md5AuthenticationKey `json:"md5AuthenticationKey,omitempty"`
}
...
func (o *InlineObject146) GetMd5AuthenticationKey() InlineResponse200152Md5AuthenticationKey {
	if o == nil || isNil(o.Md5AuthenticationKey) {
		var ret InlineResponse200152Md5AuthenticationKey
		return ret
	}
...
// SetMd5AuthenticationKey gets a reference to the given InlineResponse200152Md5AuthenticationKey and assigns it to the Md5AuthenticationKey field.
