...
// InlineResponse200209IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200209IpsecPolicies struct {
...
func NewInlineResponse200209IpsecPolicies() *InlineResponse200209IpsecPolicies {
	this := InlineResponse200209IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200209IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200209IpsecPolicies struct {
	value *InlineResponse200209IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200209IpsecPolicies) Get() *InlineResponse200209IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200209IpsecPolicies) Set(val *InlineResponse200209IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200209IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200209IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200209IpsecPolicies(val *InlineResponse200209IpsecPolicies) *NullableInlineResponse200209IpsecPolicies {
	return &NullableInlineResponse200209IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200209IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200209IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
