...
type InlineResponse200160 struct {
	Alerts *InlineResponse200160Alerts `json:"alerts,omitempty"`
	...
	ArpInspection *InlineResponse200160ArpInspection `json:"arpInspection,omitempty"`
}
...
func (o *InlineResponse200160) GetAlerts() InlineResponse200160Alerts {
	if o == nil || isNil(o.Alerts) {
		var ret InlineResponse200160Alerts
		return ret
	}
	return *o.Alerts
}
...
// SetAlerts gets a reference to the given InlineResponse200160Alerts and assigns it to the Alerts field.
...
func (o *InlineResponse200160) GetArpInspection() InlineResponse200160ArpInspection {
	if o == nil || isNil(o.ArpInspection) {
		var ret InlineResponse200160ArpInspection
		return ret
	}
...
// SetArpInspection gets a reference to the given InlineResponse200160ArpInspection and assigns it to the ArpInspection field.
