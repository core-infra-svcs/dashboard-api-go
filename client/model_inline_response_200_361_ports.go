...
// InlineResponse200361Ports struct for InlineResponse200361Ports
type InlineResponse200361Ports struct {
...
func NewInlineResponse200361Ports() *InlineResponse200361Ports {
	this := InlineResponse200361Ports{}
	return &this
}
...
func (o InlineResponse200361Ports) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200361Ports struct {
	value *InlineResponse200361Ports
	isSet bool
}

func (v NullableInlineResponse200361Ports) Get() *InlineResponse200361Ports {
	return v.value
}

func (v *NullableInlineResponse200361Ports) Set(val *InlineResponse200361Ports) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200361Ports) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200361Ports) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200361Ports(val *InlineResponse200361Ports) *NullableInlineResponse200361Ports {
	return &NullableInlineResponse200361Ports{value: val, isSet: true}
}

func (v NullableInlineResponse200361Ports) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200361Ports) UnmarshalJSON(src []byte) error {
	v.isSet = true
