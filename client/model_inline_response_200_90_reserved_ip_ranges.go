...
// InlineResponse20090ReservedIpRanges struct for InlineResponse20090ReservedIpRanges
type InlineResponse20090ReservedIpRanges struct {
...
func NewInlineResponse20090ReservedIpRanges() *InlineResponse20090ReservedIpRanges {
	this := InlineResponse20090ReservedIpRanges{}
	return &this
}
...
func (o InlineResponse20090ReservedIpRanges) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20090ReservedIpRanges struct {
	value *InlineResponse20090ReservedIpRanges
	isSet bool
}

func (v NullableInlineResponse20090ReservedIpRanges) Get() *InlineResponse20090ReservedIpRanges {
	return v.value
}

func (v *NullableInlineResponse20090ReservedIpRanges) Set(val *InlineResponse20090ReservedIpRanges) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20090ReservedIpRanges) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20090ReservedIpRanges) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20090ReservedIpRanges(val *InlineResponse20090ReservedIpRanges) *NullableInlineResponse20090ReservedIpRanges {
	return &NullableInlineResponse20090ReservedIpRanges{value: val, isSet: true}
}

func (v NullableInlineResponse20090ReservedIpRanges) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20090ReservedIpRanges) UnmarshalJSON(src []byte) error {
	v.isSet = true
