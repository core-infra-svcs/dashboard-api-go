...
// InlineResponse200107Servers struct for InlineResponse200107Servers
type InlineResponse200107Servers struct {
...
func NewInlineResponse200107Servers() *InlineResponse200107Servers {
	this := InlineResponse200107Servers{}
	return &this
}
...
func (o InlineResponse200107Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200107Servers struct {
	value *InlineResponse200107Servers
	isSet bool
}

func (v NullableInlineResponse200107Servers) Get() *InlineResponse200107Servers {
	return v.value
}

func (v *NullableInlineResponse200107Servers) Set(val *InlineResponse200107Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200107Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200107Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200107Servers(val *InlineResponse200107Servers) *NullableInlineResponse200107Servers {
	return &NullableInlineResponse200107Servers{value: val, isSet: true}
}

func (v NullableInlineResponse200107Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200107Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
