...
// InlineResponse200164VlanProfile The VLAN Profile
type InlineResponse200164VlanProfile struct {
...
func NewInlineResponse200164VlanProfile() *InlineResponse200164VlanProfile {
	this := InlineResponse200164VlanProfile{}
	return &this
}
...
func (o InlineResponse200164VlanProfile) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200164VlanProfile struct {
	value *InlineResponse200164VlanProfile
	isSet bool
}

func (v NullableInlineResponse200164VlanProfile) Get() *InlineResponse200164VlanProfile {
	return v.value
}

func (v *NullableInlineResponse200164VlanProfile) Set(val *InlineResponse200164VlanProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200164VlanProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200164VlanProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200164VlanProfile(val *InlineResponse200164VlanProfile) *NullableInlineResponse200164VlanProfile {
	return &NullableInlineResponse200164VlanProfile{value: val, isSet: true}
}

func (v NullableInlineResponse200164VlanProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200164VlanProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
