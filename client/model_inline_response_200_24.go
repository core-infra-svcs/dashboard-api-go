...
type InlineResponse20024 struct {
	...
	Result *InlineResponse2015Result `json:"result,omitempty"`
...
func (o *InlineResponse20024) GetResult() InlineResponse2015Result {
	if o == nil || isNil(o.Result) {
		var ret InlineResponse2015Result
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given InlineResponse2015Result and assigns it to the Result field.
