...
type InlineResponse200159 struct {
	...
	V3 *InlineResponse200159V3 `json:"v3,omitempty"`
...
func (o *InlineResponse200159) GetV3() InlineResponse200159V3 {
	if o == nil || isNil(o.V3) {
		var ret InlineResponse200159V3
		return ret
	}
	return *o.V3
}
...
// SetV3 gets a reference to the given InlineResponse200159V3 and assigns it to the V3 field.
