...
// InlineResponse20036ProductsWirelessCurrentVersion Details of the current version on the device
type InlineResponse20036ProductsWirelessCurrentVersion struct {
...
func NewInlineResponse20036ProductsWirelessCurrentVersion() *InlineResponse20036ProductsWirelessCurrentVersion {
	this := InlineResponse20036ProductsWirelessCurrentVersion{}
	return &this
}
...
func (o InlineResponse20036ProductsWirelessCurrentVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20036ProductsWirelessCurrentVersion struct {
	value *InlineResponse20036ProductsWirelessCurrentVersion
	isSet bool
}

func (v NullableInlineResponse20036ProductsWirelessCurrentVersion) Get() *InlineResponse20036ProductsWirelessCurrentVersion {
	return v.value
}

func (v *NullableInlineResponse20036ProductsWirelessCurrentVersion) Set(val *InlineResponse20036ProductsWirelessCurrentVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20036ProductsWirelessCurrentVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20036ProductsWirelessCurrentVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20036ProductsWirelessCurrentVersion(val *InlineResponse20036ProductsWirelessCurrentVersion) *NullableInlineResponse20036ProductsWirelessCurrentVersion {
	return &NullableInlineResponse20036ProductsWirelessCurrentVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20036ProductsWirelessCurrentVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20036ProductsWirelessCurrentVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
