...
// InlineResponse200269MetaCountsItems Counts relating to the paginated items
type InlineResponse200269MetaCountsItems struct {
...
func NewInlineResponse200269MetaCountsItems() *InlineResponse200269MetaCountsItems {
	this := InlineResponse200269MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200269MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200269MetaCountsItems struct {
	value *InlineResponse200269MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200269MetaCountsItems) Get() *InlineResponse200269MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200269MetaCountsItems) Set(val *InlineResponse200269MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200269MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200269MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200269MetaCountsItems(val *InlineResponse200269MetaCountsItems) *NullableInlineResponse200269MetaCountsItems {
	return &NullableInlineResponse200269MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200269MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200269MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
