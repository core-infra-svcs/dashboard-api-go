...
// InlineResponse20053Assigned struct for InlineResponse20053Assigned
type InlineResponse20053Assigned struct {
	...
	TwoFourGhzSettings *InlineResponse20053TwoFourGhzSettings `json:"twoFourGhzSettings,omitempty"`
	FiveGhzSettings *InlineResponse20053FiveGhzSettings `json:"fiveGhzSettings,omitempty"`
	PerSsidSettings *InlineResponse20053PerSsidSettings `json:"perSsidSettings,omitempty"`
}
...
func NewInlineResponse20053Assigned() *InlineResponse20053Assigned {
	this := InlineResponse20053Assigned{}
	return &this
}
...
func (o *InlineResponse20053Assigned) GetTwoFourGhzSettings() InlineResponse20053TwoFourGhzSettings {
	if o == nil || isNil(o.TwoFourGhzSettings) {
		var ret InlineResponse20053TwoFourGhzSettings
		return ret
	}
...
// SetTwoFourGhzSettings gets a reference to the given InlineResponse20053TwoFourGhzSettings and assigns it to the TwoFourGhzSettings field.
...
func (o *InlineResponse20053Assigned) GetFiveGhzSettings() InlineResponse20053FiveGhzSettings {
	if o == nil || isNil(o.FiveGhzSettings) {
		var ret InlineResponse20053FiveGhzSettings
		return ret
	}
...
// SetFiveGhzSettings gets a reference to the given InlineResponse20053FiveGhzSettings and assigns it to the FiveGhzSettings field.
...
func (o *InlineResponse20053Assigned) GetPerSsidSettings() InlineResponse20053PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse20053PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse20053PerSsidSettings and assigns it to the PerSsidSettings field.
func (o *InlineResponse20053Assigned) SetPerSsidSettings(v InlineResponse20053PerSsidSettings) {
	o.PerSsidSettings = &v
}

func (o InlineResponse20053Assigned) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20053Assigned struct {
	value *InlineResponse20053Assigned
	isSet bool
}

func (v NullableInlineResponse20053Assigned) Get() *InlineResponse20053Assigned {
	return v.value
}

func (v *NullableInlineResponse20053Assigned) Set(val *InlineResponse20053Assigned) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20053Assigned) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20053Assigned) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20053Assigned(val *InlineResponse20053Assigned) *NullableInlineResponse20053Assigned {
	return &NullableInlineResponse20053Assigned{value: val, isSet: true}
}

func (v NullableInlineResponse20053Assigned) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20053Assigned) UnmarshalJSON(src []byte) error {
	v.isSet = true
