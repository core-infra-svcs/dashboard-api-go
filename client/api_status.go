...
func (r StatusApiGetDeviceWirelessStatusRequest) Execute() (*InlineResponse20020, *http.Response, error) {
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiGetDeviceWirelessStatusRequest) (*InlineResponse20020, *http.Response, error) {
	var (
