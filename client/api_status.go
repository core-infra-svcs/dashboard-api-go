...
func (r StatusApiGetDeviceWirelessStatusRequest) Execute() (*InlineResponse20042, *http.Response, error) {
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiGetDeviceWirelessStatusRequest) (*InlineResponse20042, *http.Response, error) {
	var (
