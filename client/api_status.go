...
func (r StatusApiGetDeviceWirelessStatusRequest) Execute() (*InlineResponse20046, *http.Response, error) {
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiGetDeviceWirelessStatusRequest) (*InlineResponse20046, *http.Response, error) {
	var (
