...
func (r StatusApiGetDeviceWirelessStatusRequest) Execute() (*InlineResponse20044, *http.Response, error) {
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiGetDeviceWirelessStatusRequest) (*InlineResponse20044, *http.Response, error) {
	var (
