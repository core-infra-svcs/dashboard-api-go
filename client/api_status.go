...
func (r StatusApiGetDeviceWirelessStatusRequest) Execute() (*InlineResponse20041, *http.Response, error) {
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiGetDeviceWirelessStatusRequest) (*InlineResponse20041, *http.Response, error) {
	var (
