...
func (r StatusApiGetDeviceWirelessStatusRequest) Execute() (*InlineResponse20043, *http.Response, error) {
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiGetDeviceWirelessStatusRequest) (*InlineResponse20043, *http.Response, error) {
	var (
