...
func (r StatusApiGetDeviceWirelessStatusRequest) Execute() (*InlineResponse20024, *http.Response, error) {
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiGetDeviceWirelessStatusRequest) (*InlineResponse20024, *http.Response, error) {
	var (
