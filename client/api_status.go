...
func (r StatusApiGetDeviceWirelessStatusRequest) Execute() (*InlineResponse20017, *http.Response, error) {
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiGetDeviceWirelessStatusRequest) (*InlineResponse20017, *http.Response, error) {
	var (
