...
func (r StatusApiGetDeviceWirelessStatusRequest) Execute() (*InlineResponse20012, *http.Response, error) {
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiGetDeviceWirelessStatusRequest) (*InlineResponse20012, *http.Response, error) {
	var (
