...
func (r StatusApiApiGetDeviceWirelessStatusRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *StatusApiService) GetDeviceWirelessStatus(ctx context.Context, serial string) StatusApiApiGetDeviceWirelessStatusRequest {
	return StatusApiApiGetDeviceWirelessStatusRequest{
		ApiService: a,
		ctx: ctx,
		serial: serial,
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiApiGetDeviceWirelessStatusRequest) (map[string]interface{}, *http.Response, error) {
	var (
