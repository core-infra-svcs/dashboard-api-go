...
func (r StatusApiGetDeviceWirelessStatusRequest) Execute() (*InlineResponse20014, *http.Response, error) {
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiGetDeviceWirelessStatusRequest) (*InlineResponse20014, *http.Response, error) {
	var (
