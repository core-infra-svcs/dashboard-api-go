...
func (r StatusApiGetDeviceWirelessStatusRequest) Execute() (*InlineResponse20015, *http.Response, error) {
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiGetDeviceWirelessStatusRequest) (*InlineResponse20015, *http.Response, error) {
	var (
