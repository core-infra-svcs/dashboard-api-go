...
// InlineResponse200160Servers struct for InlineResponse200160Servers
type InlineResponse200160Servers struct {
...
func NewInlineResponse200160Servers() *InlineResponse200160Servers {
	this := InlineResponse200160Servers{}
	return &this
}
...
func (o InlineResponse200160Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200160Servers struct {
	value *InlineResponse200160Servers
	isSet bool
}

func (v NullableInlineResponse200160Servers) Get() *InlineResponse200160Servers {
	return v.value
}

func (v *NullableInlineResponse200160Servers) Set(val *InlineResponse200160Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200160Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200160Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200160Servers(val *InlineResponse200160Servers) *NullableInlineResponse200160Servers {
	return &NullableInlineResponse200160Servers{value: val, isSet: true}
}

func (v NullableInlineResponse200160Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200160Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
