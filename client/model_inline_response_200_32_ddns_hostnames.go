...
// InlineResponse20032DdnsHostnames Dynamic DNS hostnames.
type InlineResponse20032DdnsHostnames struct {
...
func NewInlineResponse20032DdnsHostnames() *InlineResponse20032DdnsHostnames {
	this := InlineResponse20032DdnsHostnames{}
	return &this
}
...
func (o InlineResponse20032DdnsHostnames) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20032DdnsHostnames struct {
	value *InlineResponse20032DdnsHostnames
	isSet bool
}

func (v NullableInlineResponse20032DdnsHostnames) Get() *InlineResponse20032DdnsHostnames {
	return v.value
}

func (v *NullableInlineResponse20032DdnsHostnames) Set(val *InlineResponse20032DdnsHostnames) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20032DdnsHostnames) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20032DdnsHostnames) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20032DdnsHostnames(val *InlineResponse20032DdnsHostnames) *NullableInlineResponse20032DdnsHostnames {
	return &NullableInlineResponse20032DdnsHostnames{value: val, isSet: true}
}

func (v NullableInlineResponse20032DdnsHostnames) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20032DdnsHostnames) UnmarshalJSON(src []byte) error {
	v.isSet = true
