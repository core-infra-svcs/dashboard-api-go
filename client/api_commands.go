...
func (r CommandsApiCreateDeviceSensorCommandRequest) Execute() (*InlineResponse20030, *http.Response, error) {
...
func (a *CommandsApiService) CreateDeviceSensorCommandExecute(r CommandsApiCreateDeviceSensorCommandRequest) (*InlineResponse20030, *http.Response, error) {
	var (
...
func (r CommandsApiGetDeviceSensorCommandRequest) Execute() (*InlineResponse20030, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20030
func (a *CommandsApiService) GetDeviceSensorCommandExecute(r CommandsApiGetDeviceSensorCommandRequest) (*InlineResponse20030, *http.Response, error) {
	var (
...
func (r CommandsApiGetDeviceSensorCommandsRequest) Execute() ([]InlineResponse20030, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20030
func (a *CommandsApiService) GetDeviceSensorCommandsExecute(r CommandsApiGetDeviceSensorCommandsRequest) ([]InlineResponse20030, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
