...
func (r CommandsApiCreateDeviceSensorCommandRequest) CreateDeviceSensorCommand(createDeviceSensorCommand InlineObject25) CommandsApiCreateDeviceSensorCommandRequest {
	r.createDeviceSensorCommand = &createDeviceSensorCommand
	return r
}

func (r CommandsApiCreateDeviceSensorCommandRequest) Execute() (*InlineResponse20033, *http.Response, error) {
...
func (a *CommandsApiService) CreateDeviceSensorCommandExecute(r CommandsApiCreateDeviceSensorCommandRequest) (*InlineResponse20033, *http.Response, error) {
	var (
...
func (r CommandsApiGetDeviceSensorCommandRequest) Execute() (*InlineResponse20033, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20033
func (a *CommandsApiService) GetDeviceSensorCommandExecute(r CommandsApiGetDeviceSensorCommandRequest) (*InlineResponse20033, *http.Response, error) {
	var (
...
func (r CommandsApiGetDeviceSensorCommandsRequest) Execute() ([]InlineResponse20033, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20033
func (a *CommandsApiService) GetDeviceSensorCommandsExecute(r CommandsApiGetDeviceSensorCommandsRequest) ([]InlineResponse20033, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
