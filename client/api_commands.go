...
func (r CommandsApiCreateDeviceSensorCommandRequest) CreateDeviceSensorCommand(createDeviceSensorCommand InlineObject24) CommandsApiCreateDeviceSensorCommandRequest {
	r.createDeviceSensorCommand = &createDeviceSensorCommand
	return r
}

func (r CommandsApiCreateDeviceSensorCommandRequest) Execute() (*InlineResponse20032, *http.Response, error) {
...
func (a *CommandsApiService) CreateDeviceSensorCommandExecute(r CommandsApiCreateDeviceSensorCommandRequest) (*InlineResponse20032, *http.Response, error) {
	var (
...
func (r CommandsApiGetDeviceSensorCommandRequest) Execute() (*InlineResponse20032, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20032
func (a *CommandsApiService) GetDeviceSensorCommandExecute(r CommandsApiGetDeviceSensorCommandRequest) (*InlineResponse20032, *http.Response, error) {
	var (
...
func (r CommandsApiGetDeviceSensorCommandsRequest) Execute() ([]InlineResponse20032, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20032
func (a *CommandsApiService) GetDeviceSensorCommandsExecute(r CommandsApiGetDeviceSensorCommandsRequest) ([]InlineResponse20032, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
