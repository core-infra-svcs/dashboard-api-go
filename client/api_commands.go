...
func (r CommandsApiCreateDeviceSensorCommandRequest) CreateDeviceSensorCommand(createDeviceSensorCommand InlineObject26) CommandsApiCreateDeviceSensorCommandRequest {
	r.createDeviceSensorCommand = &createDeviceSensorCommand
	return r
}

func (r CommandsApiCreateDeviceSensorCommandRequest) Execute() (*InlineResponse20034, *http.Response, error) {
...
func (a *CommandsApiService) CreateDeviceSensorCommandExecute(r CommandsApiCreateDeviceSensorCommandRequest) (*InlineResponse20034, *http.Response, error) {
	var (
...
func (r CommandsApiGetDeviceSensorCommandRequest) Execute() (*InlineResponse20034, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20034
func (a *CommandsApiService) GetDeviceSensorCommandExecute(r CommandsApiGetDeviceSensorCommandRequest) (*InlineResponse20034, *http.Response, error) {
	var (
...
func (r CommandsApiGetDeviceSensorCommandsRequest) Execute() ([]InlineResponse20034, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20034
func (a *CommandsApiService) GetDeviceSensorCommandsExecute(r CommandsApiGetDeviceSensorCommandsRequest) ([]InlineResponse20034, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
