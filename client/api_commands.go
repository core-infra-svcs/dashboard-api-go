...
func (r CommandsApiCreateDeviceSensorCommandRequest) Execute() (*InlineResponse20039, *http.Response, error) {
...
func (a *CommandsApiService) CreateDeviceSensorCommandExecute(r CommandsApiCreateDeviceSensorCommandRequest) (*InlineResponse20039, *http.Response, error) {
	var (
...
func (r CommandsApiGetDeviceSensorCommandRequest) Execute() (*InlineResponse20039, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20039
func (a *CommandsApiService) GetDeviceSensorCommandExecute(r CommandsApiGetDeviceSensorCommandRequest) (*InlineResponse20039, *http.Response, error) {
	var (
...
func (r CommandsApiGetDeviceSensorCommandsRequest) Execute() ([]InlineResponse20039, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20039
func (a *CommandsApiService) GetDeviceSensorCommandsExecute(r CommandsApiGetDeviceSensorCommandsRequest) ([]InlineResponse20039, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
