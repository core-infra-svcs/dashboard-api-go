...
type NetworksNetworkIdApplianceTrafficShapingGlobalBandwidthLimits struct {
	...
	LimitUp int32 `json:"limitUp"`
	// The download bandwidth limit in Kbps. (0 represents no limit.)
	LimitDown int32 `json:"limitDown"`
}
...
// GetLimitUp returns the LimitUp field value
...
// GetLimitUpOk returns a tuple with the LimitUp field value
...
// GetLimitDownOk returns a tuple with the LimitDown field value
// and a boolean to check if the value has been set.
