...
type InlineResponse200235Items struct {
	...
	Ipsec *InlineResponse200235Ipsec `json:"ipsec,omitempty"`
}
...
func (o *InlineResponse200235Items) GetIpsec() InlineResponse200235Ipsec {
	if o == nil || isNil(o.Ipsec) {
		var ret InlineResponse200235Ipsec
		return ret
	}
	return *o.Ipsec
}
...
// SetIpsec gets a reference to the given InlineResponse200235Ipsec and assigns it to the Ipsec field.
