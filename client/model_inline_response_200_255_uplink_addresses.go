...
// InlineResponse200255UplinkAddresses struct for InlineResponse200255UplinkAddresses
type InlineResponse200255UplinkAddresses struct {
...
func NewInlineResponse200255UplinkAddresses() *InlineResponse200255UplinkAddresses {
	this := InlineResponse200255UplinkAddresses{}
	return &this
}
...
func (o InlineResponse200255UplinkAddresses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200255UplinkAddresses struct {
	value *InlineResponse200255UplinkAddresses
	isSet bool
}

func (v NullableInlineResponse200255UplinkAddresses) Get() *InlineResponse200255UplinkAddresses {
	return v.value
}

func (v *NullableInlineResponse200255UplinkAddresses) Set(val *InlineResponse200255UplinkAddresses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200255UplinkAddresses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200255UplinkAddresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200255UplinkAddresses(val *InlineResponse200255UplinkAddresses) *NullableInlineResponse200255UplinkAddresses {
	return &NullableInlineResponse200255UplinkAddresses{value: val, isSet: true}
}

func (v NullableInlineResponse200255UplinkAddresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200255UplinkAddresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
