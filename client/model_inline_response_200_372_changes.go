...
// InlineResponse200372Changes struct for InlineResponse200372Changes
type InlineResponse200372Changes struct {
...
func NewInlineResponse200372Changes() *InlineResponse200372Changes {
	this := InlineResponse200372Changes{}
	return &this
}
...
func (o InlineResponse200372Changes) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200372Changes struct {
	value *InlineResponse200372Changes
	isSet bool
}

func (v NullableInlineResponse200372Changes) Get() *InlineResponse200372Changes {
	return v.value
}

func (v *NullableInlineResponse200372Changes) Set(val *InlineResponse200372Changes) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200372Changes) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200372Changes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200372Changes(val *InlineResponse200372Changes) *NullableInlineResponse200372Changes {
	return &NullableInlineResponse200372Changes{value: val, isSet: true}
}

func (v NullableInlineResponse200372Changes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200372Changes) UnmarshalJSON(src []byte) error {
	v.isSet = true
