...
// InlineResponse20051ProductsWirelessLastUpgradeFromVersion Details of the version the device upgraded from
type InlineResponse20051ProductsWirelessLastUpgradeFromVersion struct {
...
func NewInlineResponse20051ProductsWirelessLastUpgradeFromVersion() *InlineResponse20051ProductsWirelessLastUpgradeFromVersion {
	this := InlineResponse20051ProductsWirelessLastUpgradeFromVersion{}
	return &this
}
...
func (o InlineResponse20051ProductsWirelessLastUpgradeFromVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20051ProductsWirelessLastUpgradeFromVersion struct {
	value *InlineResponse20051ProductsWirelessLastUpgradeFromVersion
	isSet bool
}

func (v NullableInlineResponse20051ProductsWirelessLastUpgradeFromVersion) Get() *InlineResponse20051ProductsWirelessLastUpgradeFromVersion {
	return v.value
}

func (v *NullableInlineResponse20051ProductsWirelessLastUpgradeFromVersion) Set(val *InlineResponse20051ProductsWirelessLastUpgradeFromVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20051ProductsWirelessLastUpgradeFromVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20051ProductsWirelessLastUpgradeFromVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20051ProductsWirelessLastUpgradeFromVersion(val *InlineResponse20051ProductsWirelessLastUpgradeFromVersion) *NullableInlineResponse20051ProductsWirelessLastUpgradeFromVersion {
	return &NullableInlineResponse20051ProductsWirelessLastUpgradeFromVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20051ProductsWirelessLastUpgradeFromVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20051ProductsWirelessLastUpgradeFromVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
