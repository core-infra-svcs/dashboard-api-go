...
func (o *InlineResponse20081) GetSerials() []string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20081) GetSerialsOk() ([]string, bool) {
	if o == nil || isNil(o.Serials) {
    return nil, false
	}
...
func (o *InlineResponse20081) HasSerials() bool {
	if o != nil && !isNil(o.Serials) {
		return true
	}
...
func (o *InlineResponse20081) SetSerials(v []string) {
	o.Serials = v
}
