...
type InlineResponse20081 struct {
	...
	NamedVlans *InlineResponse20081NamedVlans `json:"namedVlans,omitempty"`
}
...
func (o *InlineResponse20081) GetNamedVlans() InlineResponse20081NamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret InlineResponse20081NamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given InlineResponse20081NamedVlans and assigns it to the NamedVlans field.
