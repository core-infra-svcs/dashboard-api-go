...
type InlineResponse20081 struct {
	...
	ClientVpnConnections []InlineResponse20081ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20081) GetClientVpnConnections() []InlineResponse20081ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20081ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20081ClientVpnConnections and assigns it to the ClientVpnConnections field.
