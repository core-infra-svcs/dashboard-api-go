...
// InlineResponse200203SentryEnrollment Systems Manager sentry enrollment splash settings.
type InlineResponse200203SentryEnrollment struct {
	SystemsManagerNetwork *InlineResponse200203SentryEnrollmentSystemsManagerNetwork `json:"systemsManagerNetwork,omitempty"`
...
func NewInlineResponse200203SentryEnrollment() *InlineResponse200203SentryEnrollment {
	this := InlineResponse200203SentryEnrollment{}
	return &this
}
...
func (o *InlineResponse200203SentryEnrollment) GetSystemsManagerNetwork() InlineResponse200203SentryEnrollmentSystemsManagerNetwork {
	if o == nil || isNil(o.SystemsManagerNetwork) {
		var ret InlineResponse200203SentryEnrollmentSystemsManagerNetwork
		return ret
	}
...
// SetSystemsManagerNetwork gets a reference to the given InlineResponse200203SentryEnrollmentSystemsManagerNetwork and assigns it to the SystemsManagerNetwork field.
...
func (o InlineResponse200203SentryEnrollment) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200203SentryEnrollment struct {
	value *InlineResponse200203SentryEnrollment
	isSet bool
}

func (v NullableInlineResponse200203SentryEnrollment) Get() *InlineResponse200203SentryEnrollment {
	return v.value
}

func (v *NullableInlineResponse200203SentryEnrollment) Set(val *InlineResponse200203SentryEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200203SentryEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200203SentryEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200203SentryEnrollment(val *InlineResponse200203SentryEnrollment) *NullableInlineResponse200203SentryEnrollment {
	return &NullableInlineResponse200203SentryEnrollment{value: val, isSet: true}
}

func (v NullableInlineResponse200203SentryEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200203SentryEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
