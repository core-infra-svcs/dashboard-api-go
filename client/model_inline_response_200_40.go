...
type InlineResponse20040 struct {
	...
	ToVersion *InlineResponse20040ToVersion `json:"toVersion,omitempty"`
...
func (o *InlineResponse20040) GetToVersion() InlineResponse20040ToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20040ToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20040ToVersion and assigns it to the ToVersion field.
