...
type InlineResponse20040 struct {
	...
	DhcpOptions []InlineResponse20040DhcpOptions `json:"dhcpOptions,omitempty"`
	// Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
	ReservedIpRanges []InlineResponse20040ReservedIpRanges `json:"reservedIpRanges,omitempty"`
	// Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
	FixedIpAssignments []InlineResponse20040FixedIpAssignments `json:"fixedIpAssignments,omitempty"`
}
...
func (o *InlineResponse20040) GetDhcpOptions() []InlineResponse20040DhcpOptions {
	if o == nil || isNil(o.DhcpOptions) {
		var ret []InlineResponse20040DhcpOptions
		return ret
	}
...
// SetDhcpOptions gets a reference to the given []InlineResponse20040DhcpOptions and assigns it to the DhcpOptions field.
...
func (o *InlineResponse20040) GetReservedIpRanges() []InlineResponse20040ReservedIpRanges {
	if o == nil || isNil(o.ReservedIpRanges) {
		var ret []InlineResponse20040ReservedIpRanges
		return ret
	}
...
// SetReservedIpRanges gets a reference to the given []InlineResponse20040ReservedIpRanges and assigns it to the ReservedIpRanges field.
...
func (o *InlineResponse20040) GetFixedIpAssignments() []InlineResponse20040FixedIpAssignments {
	if o == nil || isNil(o.FixedIpAssignments) {
		var ret []InlineResponse20040FixedIpAssignments
		return ret
	}
...
// SetFixedIpAssignments gets a reference to the given []InlineResponse20040FixedIpAssignments and assigns it to the FixedIpAssignments field.
