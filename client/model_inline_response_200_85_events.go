...
// InlineResponse20085Events struct for InlineResponse20085Events
type InlineResponse20085Events struct {
	...
	EventData *InlineResponse20085EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20085Events() *InlineResponse20085Events {
	this := InlineResponse20085Events{}
	return &this
}
...
func (o *InlineResponse20085Events) GetEventData() InlineResponse20085EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20085EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20085EventData and assigns it to the EventData field.
func (o *InlineResponse20085Events) SetEventData(v InlineResponse20085EventData) {
	o.EventData = &v
}

func (o InlineResponse20085Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20085Events struct {
	value *InlineResponse20085Events
	isSet bool
}

func (v NullableInlineResponse20085Events) Get() *InlineResponse20085Events {
	return v.value
}

func (v *NullableInlineResponse20085Events) Set(val *InlineResponse20085Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20085Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20085Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20085Events(val *InlineResponse20085Events) *NullableInlineResponse20085Events {
	return &NullableInlineResponse20085Events{value: val, isSet: true}
}

func (v NullableInlineResponse20085Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20085Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
