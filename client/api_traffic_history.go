...
func (r TrafficHistoryApiGetNetworkClientTrafficHistoryRequest) Execute() ([]InlineResponse20088, *http.Response, error) {
...
func (a *TrafficHistoryApiService) GetNetworkClientTrafficHistoryExecute(r TrafficHistoryApiGetNetworkClientTrafficHistoryRequest) ([]InlineResponse20088, *http.Response, error) {
	var (
