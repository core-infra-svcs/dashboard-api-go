...
func (r TrafficHistoryApiGetNetworkClientTrafficHistoryRequest) Execute() ([]InlineResponse20097, *http.Response, error) {
...
func (a *TrafficHistoryApiService) GetNetworkClientTrafficHistoryExecute(r TrafficHistoryApiGetNetworkClientTrafficHistoryRequest) ([]InlineResponse20097, *http.Response, error) {
	var (
