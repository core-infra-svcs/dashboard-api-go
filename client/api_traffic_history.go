...
func (r TrafficHistoryApiGetNetworkClientTrafficHistoryRequest) Execute() ([]InlineResponse20090, *http.Response, error) {
...
func (a *TrafficHistoryApiService) GetNetworkClientTrafficHistoryExecute(r TrafficHistoryApiGetNetworkClientTrafficHistoryRequest) ([]InlineResponse20090, *http.Response, error) {
	var (
