...
func (r TrafficHistoryApiGetNetworkClientTrafficHistoryRequest) Execute() ([]InlineResponse20081, *http.Response, error) {
...
func (a *TrafficHistoryApiService) GetNetworkClientTrafficHistoryExecute(r TrafficHistoryApiGetNetworkClientTrafficHistoryRequest) ([]InlineResponse20081, *http.Response, error) {
	var (
