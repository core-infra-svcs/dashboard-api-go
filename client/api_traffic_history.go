...
func (r TrafficHistoryApiGetNetworkClientTrafficHistoryRequest) Execute() ([]InlineResponse20084, *http.Response, error) {
...
func (a *TrafficHistoryApiService) GetNetworkClientTrafficHistoryExecute(r TrafficHistoryApiGetNetworkClientTrafficHistoryRequest) ([]InlineResponse20084, *http.Response, error) {
	var (
