...
type InlineResponse200276 struct {
	Usage *InlineResponse200276Usage `json:"usage,omitempty"`
...
func (o *InlineResponse200276) GetUsage() InlineResponse200276Usage {
	if o == nil || isNil(o.Usage) {
		var ret InlineResponse200276Usage
		return ret
	}
	return *o.Usage
}
...
func (o *InlineResponse200276) GetUsageOk() (*InlineResponse200276Usage, bool) {
	if o == nil || isNil(o.Usage) {
    return nil, false
	}
	return o.Usage, true
...
func (o *InlineResponse200276) HasUsage() bool {
	if o != nil && !isNil(o.Usage) {
		return true
	}
...
// SetUsage gets a reference to the given InlineResponse200276Usage and assigns it to the Usage field.
func (o *InlineResponse200276) SetUsage(v InlineResponse200276Usage) {
	o.Usage = &v
}
