...
// InlineResponse200322Ports struct for InlineResponse200322Ports
type InlineResponse200322Ports struct {
	...
	Cdp []InlineResponse200322Cdp `json:"cdp,omitempty"`
	// The Link Layer Discovery Protocol (LLDP) information of the connected device.
	Lldp []InlineResponse200322Lldp `json:"lldp,omitempty"`
}
...
func NewInlineResponse200322Ports() *InlineResponse200322Ports {
	this := InlineResponse200322Ports{}
	return &this
}
...
func (o *InlineResponse200322Ports) GetCdp() []InlineResponse200322Cdp {
	if o == nil || isNil(o.Cdp) {
		var ret []InlineResponse200322Cdp
		return ret
	}
	return o.Cdp
}
...
// SetCdp gets a reference to the given []InlineResponse200322Cdp and assigns it to the Cdp field.
...
func (o *InlineResponse200322Ports) GetLldp() []InlineResponse200322Lldp {
	if o == nil || isNil(o.Lldp) {
		var ret []InlineResponse200322Lldp
		return ret
	}
	return o.Lldp
}
...
// SetLldp gets a reference to the given []InlineResponse200322Lldp and assigns it to the Lldp field.
func (o *InlineResponse200322Ports) SetLldp(v []InlineResponse200322Lldp) {
	o.Lldp = v
}

func (o InlineResponse200322Ports) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200322Ports struct {
	value *InlineResponse200322Ports
	isSet bool
}

func (v NullableInlineResponse200322Ports) Get() *InlineResponse200322Ports {
	return v.value
}

func (v *NullableInlineResponse200322Ports) Set(val *InlineResponse200322Ports) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200322Ports) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200322Ports) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200322Ports(val *InlineResponse200322Ports) *NullableInlineResponse200322Ports {
	return &NullableInlineResponse200322Ports{value: val, isSet: true}
}

func (v NullableInlineResponse200322Ports) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200322Ports) UnmarshalJSON(src []byte) error {
	v.isSet = true
