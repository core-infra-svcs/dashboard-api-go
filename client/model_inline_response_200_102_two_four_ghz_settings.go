...
// InlineResponse200102TwoFourGhzSettings Settings related to 2.4Ghz band
type InlineResponse200102TwoFourGhzSettings struct {
...
func NewInlineResponse200102TwoFourGhzSettings() *InlineResponse200102TwoFourGhzSettings {
	this := InlineResponse200102TwoFourGhzSettings{}
	return &this
}
...
func (o InlineResponse200102TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200102TwoFourGhzSettings struct {
	value *InlineResponse200102TwoFourGhzSettings
	isSet bool
}

func (v NullableInlineResponse200102TwoFourGhzSettings) Get() *InlineResponse200102TwoFourGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200102TwoFourGhzSettings) Set(val *InlineResponse200102TwoFourGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200102TwoFourGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200102TwoFourGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200102TwoFourGhzSettings(val *InlineResponse200102TwoFourGhzSettings) *NullableInlineResponse200102TwoFourGhzSettings {
	return &NullableInlineResponse200102TwoFourGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200102TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200102TwoFourGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
