...
// InlineResponse200311ResultingNetwork Network after the combination
type InlineResponse200311ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200311ResultingNetwork() *InlineResponse200311ResultingNetwork {
	this := InlineResponse200311ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200311ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200311ResultingNetwork struct {
	value *InlineResponse200311ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200311ResultingNetwork) Get() *InlineResponse200311ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200311ResultingNetwork) Set(val *InlineResponse200311ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200311ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200311ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200311ResultingNetwork(val *InlineResponse200311ResultingNetwork) *NullableInlineResponse200311ResultingNetwork {
	return &NullableInlineResponse200311ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200311ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200311ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
