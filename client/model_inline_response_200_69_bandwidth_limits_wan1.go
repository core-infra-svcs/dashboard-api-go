...
// InlineResponse20069BandwidthLimitsWan1 uplink wan1 configured limits [optional]
type InlineResponse20069BandwidthLimitsWan1 struct {
...
func NewInlineResponse20069BandwidthLimitsWan1() *InlineResponse20069BandwidthLimitsWan1 {
	this := InlineResponse20069BandwidthLimitsWan1{}
	return &this
}
...
func (o InlineResponse20069BandwidthLimitsWan1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20069BandwidthLimitsWan1 struct {
	value *InlineResponse20069BandwidthLimitsWan1
	isSet bool
}

func (v NullableInlineResponse20069BandwidthLimitsWan1) Get() *InlineResponse20069BandwidthLimitsWan1 {
	return v.value
}

func (v *NullableInlineResponse20069BandwidthLimitsWan1) Set(val *InlineResponse20069BandwidthLimitsWan1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20069BandwidthLimitsWan1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20069BandwidthLimitsWan1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20069BandwidthLimitsWan1(val *InlineResponse20069BandwidthLimitsWan1) *NullableInlineResponse20069BandwidthLimitsWan1 {
	return &NullableInlineResponse20069BandwidthLimitsWan1{value: val, isSet: true}
}

func (v NullableInlineResponse20069BandwidthLimitsWan1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20069BandwidthLimitsWan1) UnmarshalJSON(src []byte) error {
	v.isSet = true
