...
func (o *InlineObject271) GetContent() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject271) GetContentOk() (*string, bool) {
	if o == nil || isNil(o.Content) {
    return nil, false
	}
...
func (o *InlineObject271) HasContent() bool {
	if o != nil && !isNil(o.Content) {
		return true
	}
...
func (o *InlineObject271) SetContent(v string) {
	o.Content = &v
}
