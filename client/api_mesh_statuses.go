...
func (r MeshStatusesApiGetNetworkWirelessMeshStatusesRequest) Execute() ([]InlineResponse200199, *http.Response, error) {
...
func (a *MeshStatusesApiService) GetNetworkWirelessMeshStatusesExecute(r MeshStatusesApiGetNetworkWirelessMeshStatusesRequest) ([]InlineResponse200199, *http.Response, error) {
	var (
