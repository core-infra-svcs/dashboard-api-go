...
func (r MeshStatusesApiGetNetworkWirelessMeshStatusesRequest) Execute() ([]InlineResponse200183, *http.Response, error) {
...
func (a *MeshStatusesApiService) GetNetworkWirelessMeshStatusesExecute(r MeshStatusesApiGetNetworkWirelessMeshStatusesRequest) ([]InlineResponse200183, *http.Response, error) {
	var (
