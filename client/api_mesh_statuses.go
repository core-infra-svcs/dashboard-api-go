...
func (r MeshStatusesApiGetNetworkWirelessMeshStatusesRequest) Execute() ([]InlineResponse200182, *http.Response, error) {
...
func (a *MeshStatusesApiService) GetNetworkWirelessMeshStatusesExecute(r MeshStatusesApiGetNetworkWirelessMeshStatusesRequest) ([]InlineResponse200182, *http.Response, error) {
	var (
