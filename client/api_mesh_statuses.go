...
func (r MeshStatusesApiGetNetworkWirelessMeshStatusesRequest) Execute() ([]InlineResponse200195, *http.Response, error) {
...
func (a *MeshStatusesApiService) GetNetworkWirelessMeshStatusesExecute(r MeshStatusesApiGetNetworkWirelessMeshStatusesRequest) ([]InlineResponse200195, *http.Response, error) {
	var (
