...
func (r MeshStatusesApiApiGetNetworkWirelessMeshStatusesRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *MeshStatusesApiService) GetNetworkWirelessMeshStatuses(ctx context.Context, networkId string) MeshStatusesApiApiGetNetworkWirelessMeshStatusesRequest {
	return MeshStatusesApiApiGetNetworkWirelessMeshStatusesRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *MeshStatusesApiService) GetNetworkWirelessMeshStatusesExecute(r MeshStatusesApiApiGetNetworkWirelessMeshStatusesRequest) (map[string]interface{}, *http.Response, error) {
	var (
