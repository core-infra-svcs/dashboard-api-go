...
func (r MeshStatusesApiGetNetworkWirelessMeshStatusesRequest) Execute() ([]InlineResponse200188, *http.Response, error) {
...
func (a *MeshStatusesApiService) GetNetworkWirelessMeshStatusesExecute(r MeshStatusesApiGetNetworkWirelessMeshStatusesRequest) ([]InlineResponse200188, *http.Response, error) {
	var (
