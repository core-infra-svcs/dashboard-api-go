...
// InlineResponse20033DdnsHostnames Dynamic DNS hostnames.
type InlineResponse20033DdnsHostnames struct {
...
func NewInlineResponse20033DdnsHostnames() *InlineResponse20033DdnsHostnames {
	this := InlineResponse20033DdnsHostnames{}
	return &this
}
...
func (o InlineResponse20033DdnsHostnames) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20033DdnsHostnames struct {
	value *InlineResponse20033DdnsHostnames
	isSet bool
}

func (v NullableInlineResponse20033DdnsHostnames) Get() *InlineResponse20033DdnsHostnames {
	return v.value
}

func (v *NullableInlineResponse20033DdnsHostnames) Set(val *InlineResponse20033DdnsHostnames) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20033DdnsHostnames) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20033DdnsHostnames) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20033DdnsHostnames(val *InlineResponse20033DdnsHostnames) *NullableInlineResponse20033DdnsHostnames {
	return &NullableInlineResponse20033DdnsHostnames{value: val, isSet: true}
}

func (v NullableInlineResponse20033DdnsHostnames) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20033DdnsHostnames) UnmarshalJSON(src []byte) error {
	v.isSet = true
