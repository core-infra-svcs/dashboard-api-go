...
// InlineResponse200198TwoFourGhzSettings Settings related to 2.4Ghz band
type InlineResponse200198TwoFourGhzSettings struct {
...
func NewInlineResponse200198TwoFourGhzSettings() *InlineResponse200198TwoFourGhzSettings {
	this := InlineResponse200198TwoFourGhzSettings{}
	return &this
}
...
func (o InlineResponse200198TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200198TwoFourGhzSettings struct {
	value *InlineResponse200198TwoFourGhzSettings
	isSet bool
}

func (v NullableInlineResponse200198TwoFourGhzSettings) Get() *InlineResponse200198TwoFourGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200198TwoFourGhzSettings) Set(val *InlineResponse200198TwoFourGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200198TwoFourGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200198TwoFourGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200198TwoFourGhzSettings(val *InlineResponse200198TwoFourGhzSettings) *NullableInlineResponse200198TwoFourGhzSettings {
	return &NullableInlineResponse200198TwoFourGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200198TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200198TwoFourGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
