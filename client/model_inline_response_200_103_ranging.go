...
// InlineResponse200103Ranging Ranging status and progress information
type InlineResponse200103Ranging struct {
	// Ranging status. Possible values: 'scheduled', 'in progress', 'error', 'finished', 'no neighbors'
	Status *string `json:"status,omitempty"`
	Completed *InlineResponse200103RangingCompleted `json:"completed,omitempty"`
}
...
func NewInlineResponse200103Ranging() *InlineResponse200103Ranging {
	this := InlineResponse200103Ranging{}
	return &this
}
...
func (o *InlineResponse200103Ranging) GetCompleted() InlineResponse200103RangingCompleted {
	if o == nil || isNil(o.Completed) {
		var ret InlineResponse200103RangingCompleted
		return ret
	}
	return *o.Completed
}
...
// SetCompleted gets a reference to the given InlineResponse200103RangingCompleted and assigns it to the Completed field.
func (o *InlineResponse200103Ranging) SetCompleted(v InlineResponse200103RangingCompleted) {
	o.Completed = &v
}

func (o InlineResponse200103Ranging) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200103Ranging struct {
	value *InlineResponse200103Ranging
	isSet bool
}

func (v NullableInlineResponse200103Ranging) Get() *InlineResponse200103Ranging {
	return v.value
}

func (v *NullableInlineResponse200103Ranging) Set(val *InlineResponse200103Ranging) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200103Ranging) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200103Ranging) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200103Ranging(val *InlineResponse200103Ranging) *NullableInlineResponse200103Ranging {
	return &NullableInlineResponse200103Ranging{value: val, isSet: true}
}

func (v NullableInlineResponse200103Ranging) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200103Ranging) UnmarshalJSON(src []byte) error {
	v.isSet = true
