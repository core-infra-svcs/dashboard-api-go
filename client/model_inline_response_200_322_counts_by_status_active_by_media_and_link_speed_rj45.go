...
// InlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45 The count data for RJ45 ports, indexed by speed in Mb
type InlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45 struct {
...
func NewInlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45() *InlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45 {
	this := InlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45{}
	return &this
}
...
func (o InlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45 struct {
	value *InlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45
	isSet bool
}

func (v NullableInlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45) Get() *InlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45 {
	return v.value
}

func (v *NullableInlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45) Set(val *InlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45(val *InlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45) *NullableInlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45 {
	return &NullableInlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45{value: val, isSet: true}
}

func (v NullableInlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200322CountsByStatusActiveByMediaAndLinkSpeedRj45) UnmarshalJSON(src []byte) error {
	v.isSet = true
