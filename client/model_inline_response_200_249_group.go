...
// InlineResponse200249Group [optional] Contains the mapping between primary tunnel and backup tunnels.
type InlineResponse200249Group struct {
	...
	Failover *InlineResponse200249GroupFailover `json:"failover,omitempty"`
...
func NewInlineResponse200249Group() *InlineResponse200249Group {
	this := InlineResponse200249Group{}
	return &this
}
...
func (o *InlineResponse200249Group) GetFailover() InlineResponse200249GroupFailover {
	if o == nil || isNil(o.Failover) {
		var ret InlineResponse200249GroupFailover
		return ret
	}
	return *o.Failover
}
...
// SetFailover gets a reference to the given InlineResponse200249GroupFailover and assigns it to the Failover field.
...
func (o InlineResponse200249Group) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200249Group struct {
	value *InlineResponse200249Group
	isSet bool
}

func (v NullableInlineResponse200249Group) Get() *InlineResponse200249Group {
	return v.value
}

func (v *NullableInlineResponse200249Group) Set(val *InlineResponse200249Group) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200249Group) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200249Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200249Group(val *InlineResponse200249Group) *NullableInlineResponse200249Group {
	return &NullableInlineResponse200249Group{value: val, isSet: true}
}

func (v NullableInlineResponse200249Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200249Group) UnmarshalJSON(src []byte) error {
	v.isSet = true
