...
// InlineResponse200187Items struct for InlineResponse200187Items
type InlineResponse200187Items struct {
...
func NewInlineResponse200187Items() *InlineResponse200187Items {
	this := InlineResponse200187Items{}
	return &this
}
...
func (o InlineResponse200187Items) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200187Items struct {
	value *InlineResponse200187Items
	isSet bool
}

func (v NullableInlineResponse200187Items) Get() *InlineResponse200187Items {
	return v.value
}

func (v *NullableInlineResponse200187Items) Set(val *InlineResponse200187Items) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200187Items) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200187Items) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200187Items(val *InlineResponse200187Items) *NullableInlineResponse200187Items {
	return &NullableInlineResponse200187Items{value: val, isSet: true}
}

func (v NullableInlineResponse200187Items) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200187Items) UnmarshalJSON(src []byte) error {
	v.isSet = true
