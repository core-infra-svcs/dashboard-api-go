...
// InlineResponse200102Jobs struct for InlineResponse200102Jobs
type InlineResponse200102Jobs struct {
	// Auto locate job ID
...
func (o InlineResponse200102Jobs) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200102Jobs struct {
	value *InlineResponse200102Jobs
	isSet bool
}

func (v NullableInlineResponse200102Jobs) Get() *InlineResponse200102Jobs {
	return v.value
}

func (v *NullableInlineResponse200102Jobs) Set(val *InlineResponse200102Jobs) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200102Jobs) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200102Jobs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200102Jobs(val *InlineResponse200102Jobs) *NullableInlineResponse200102Jobs {
	return &NullableInlineResponse200102Jobs{value: val, isSet: true}
}

func (v NullableInlineResponse200102Jobs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200102Jobs) UnmarshalJSON(src []byte) error {
	v.isSet = true
