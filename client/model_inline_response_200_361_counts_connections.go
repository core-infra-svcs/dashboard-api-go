...
// InlineResponse200361CountsConnections Wireless LAN controller associated access point counts
type InlineResponse200361CountsConnections struct {
	// Wireless LAN controller associated total access point count
	Total *int32 `json:"total,omitempty"`
	ByStatus *InlineResponse200361CountsConnectionsByStatus `json:"byStatus,omitempty"`
}
...
func NewInlineResponse200361CountsConnections() *InlineResponse200361CountsConnections {
	this := InlineResponse200361CountsConnections{}
	return &this
}
...
func (o *InlineResponse200361CountsConnections) GetByStatus() InlineResponse200361CountsConnectionsByStatus {
	if o == nil || isNil(o.ByStatus) {
		var ret InlineResponse200361CountsConnectionsByStatus
		return ret
	}
	return *o.ByStatus
}
...
// SetByStatus gets a reference to the given InlineResponse200361CountsConnectionsByStatus and assigns it to the ByStatus field.
func (o *InlineResponse200361CountsConnections) SetByStatus(v InlineResponse200361CountsConnectionsByStatus) {
	o.ByStatus = &v
}

func (o InlineResponse200361CountsConnections) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200361CountsConnections struct {
	value *InlineResponse200361CountsConnections
	isSet bool
}

func (v NullableInlineResponse200361CountsConnections) Get() *InlineResponse200361CountsConnections {
	return v.value
}

func (v *NullableInlineResponse200361CountsConnections) Set(val *InlineResponse200361CountsConnections) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200361CountsConnections) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200361CountsConnections) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200361CountsConnections(val *InlineResponse200361CountsConnections) *NullableInlineResponse200361CountsConnections {
	return &NullableInlineResponse200361CountsConnections{value: val, isSet: true}
}

func (v NullableInlineResponse200361CountsConnections) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200361CountsConnections) UnmarshalJSON(src []byte) error {
	v.isSet = true
