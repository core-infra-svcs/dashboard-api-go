...
// InlineResponse20050Servers struct for InlineResponse20050Servers
type InlineResponse20050Servers struct {
...
func NewInlineResponse20050Servers() *InlineResponse20050Servers {
	this := InlineResponse20050Servers{}
	return &this
}
...
func (o InlineResponse20050Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20050Servers struct {
	value *InlineResponse20050Servers
	isSet bool
}

func (v NullableInlineResponse20050Servers) Get() *InlineResponse20050Servers {
	return v.value
}

func (v *NullableInlineResponse20050Servers) Set(val *InlineResponse20050Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20050Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20050Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20050Servers(val *InlineResponse20050Servers) *NullableInlineResponse20050Servers {
	return &NullableInlineResponse20050Servers{value: val, isSet: true}
}

func (v NullableInlineResponse20050Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20050Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
