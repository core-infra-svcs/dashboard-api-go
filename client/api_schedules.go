...
func (r SchedulesApiGetNetworkCameraSchedulesRequest) Execute() ([]InlineResponse20031, *http.Response, error) {
...
func (a *SchedulesApiService) GetNetworkCameraSchedulesExecute(r SchedulesApiGetNetworkCameraSchedulesRequest) ([]InlineResponse20031, *http.Response, error) {
	var (
...
func (r SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest) UpdateNetworkWirelessSsidSchedules(updateNetworkWirelessSsidSchedules InlineObject177) SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest {
