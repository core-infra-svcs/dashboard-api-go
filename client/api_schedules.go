...
func (r SchedulesApiCreateOrganizationDevicesPacketCaptureScheduleRequest) Execute() (*InlineResponse200275Items, *http.Response, error) {
...
func (a *SchedulesApiService) CreateOrganizationDevicesPacketCaptureScheduleExecute(r SchedulesApiCreateOrganizationDevicesPacketCaptureScheduleRequest) (*InlineResponse200275Items, *http.Response, error) {
	var (
...
func (r SchedulesApiGetOrganizationDevicesPacketCaptureSchedulesRequest) Execute() (*InlineResponse200275, *http.Response, error) {
...
func (a *SchedulesApiService) GetOrganizationDevicesPacketCaptureSchedulesExecute(r SchedulesApiGetOrganizationDevicesPacketCaptureSchedulesRequest) (*InlineResponse200275, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SchedulesApiReorderOrganizationDevicesPacketCaptureSchedulesRequest) Execute() (*InlineResponse200276, *http.Response, error) {
...
func (a *SchedulesApiService) ReorderOrganizationDevicesPacketCaptureSchedulesExecute(r SchedulesApiReorderOrganizationDevicesPacketCaptureSchedulesRequest) (*InlineResponse200276, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SchedulesApiUpdateOrganizationDevicesPacketCaptureScheduleRequest) Execute() (*InlineResponse200275Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200275Items
func (a *SchedulesApiService) UpdateOrganizationDevicesPacketCaptureScheduleExecute(r SchedulesApiUpdateOrganizationDevicesPacketCaptureScheduleRequest) (*InlineResponse200275Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
