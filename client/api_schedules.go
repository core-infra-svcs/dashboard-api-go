...
func (r SchedulesApiGetNetworkCameraSchedulesRequest) Execute() ([]InlineResponse20074, *http.Response, error) {
...
func (a *SchedulesApiService) GetNetworkCameraSchedulesExecute(r SchedulesApiGetNetworkCameraSchedulesRequest) ([]InlineResponse20074, *http.Response, error) {
	var (
...
func (r SchedulesApiGetNetworkWirelessSsidSchedulesRequest) Execute() (*InlineResponse200198, *http.Response, error) {
...
func (a *SchedulesApiService) GetNetworkWirelessSsidSchedulesExecute(r SchedulesApiGetNetworkWirelessSsidSchedulesRequest) (*InlineResponse200198, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest) UpdateNetworkWirelessSsidSchedules(updateNetworkWirelessSsidSchedules InlineObject197) SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest {
	r.updateNetworkWirelessSsidSchedules = &updateNetworkWirelessSsidSchedules
	return r
}

func (r SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest) Execute() (*InlineResponse200198, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200198
func (a *SchedulesApiService) UpdateNetworkWirelessSsidSchedulesExecute(r SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest) (*InlineResponse200198, *http.Response, error) {
	var (
