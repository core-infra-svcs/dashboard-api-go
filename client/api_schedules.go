...
func (r SchedulesApiGetNetworkCameraSchedulesRequest) Execute() ([]InlineResponse20029, *http.Response, error) {
...
func (a *SchedulesApiService) GetNetworkCameraSchedulesExecute(r SchedulesApiGetNetworkCameraSchedulesRequest) ([]InlineResponse20029, *http.Response, error) {
	var (
