...
func (r SchedulesApiGetNetworkCameraSchedulesRequest) Execute() ([]InlineResponse20040, *http.Response, error) {
...
func (a *SchedulesApiService) GetNetworkCameraSchedulesExecute(r SchedulesApiGetNetworkCameraSchedulesRequest) ([]InlineResponse20040, *http.Response, error) {
	var (
...
func (r SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest) UpdateNetworkWirelessSsidSchedules(updateNetworkWirelessSsidSchedules InlineObject186) SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest {
