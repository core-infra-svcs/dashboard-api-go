...
func (r SchedulesApiGetNetworkCameraSchedulesRequest) Execute() ([]InlineResponse20078, *http.Response, error) {
...
func (a *SchedulesApiService) GetNetworkCameraSchedulesExecute(r SchedulesApiGetNetworkCameraSchedulesRequest) ([]InlineResponse20078, *http.Response, error) {
	var (
...
func (r SchedulesApiGetNetworkWirelessSsidSchedulesRequest) Execute() (*InlineResponse200202, *http.Response, error) {
...
func (a *SchedulesApiService) GetNetworkWirelessSsidSchedulesExecute(r SchedulesApiGetNetworkWirelessSsidSchedulesRequest) (*InlineResponse200202, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest) Execute() (*InlineResponse200202, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200202
func (a *SchedulesApiService) UpdateNetworkWirelessSsidSchedulesExecute(r SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest) (*InlineResponse200202, *http.Response, error) {
	var (
