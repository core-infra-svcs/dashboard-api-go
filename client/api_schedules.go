...
func (r SchedulesApiGetNetworkCameraSchedulesRequest) Execute() ([]InlineResponse20079, *http.Response, error) {
...
func (a *SchedulesApiService) GetNetworkCameraSchedulesExecute(r SchedulesApiGetNetworkCameraSchedulesRequest) ([]InlineResponse20079, *http.Response, error) {
	var (
...
func (r SchedulesApiGetNetworkWirelessSsidSchedulesRequest) Execute() (*InlineResponse200203, *http.Response, error) {
...
func (a *SchedulesApiService) GetNetworkWirelessSsidSchedulesExecute(r SchedulesApiGetNetworkWirelessSsidSchedulesRequest) (*InlineResponse200203, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest) UpdateNetworkWirelessSsidSchedules(updateNetworkWirelessSsidSchedules InlineObject199) SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest {
	r.updateNetworkWirelessSsidSchedules = &updateNetworkWirelessSsidSchedules
	return r
}

func (r SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest) Execute() (*InlineResponse200203, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200203
func (a *SchedulesApiService) UpdateNetworkWirelessSsidSchedulesExecute(r SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest) (*InlineResponse200203, *http.Response, error) {
	var (
