...
func (r SchedulesApiGetNetworkWirelessSsidSchedulesRequest) Execute() (*InlineResponse200193, *http.Response, error) {
...
func (a *SchedulesApiService) GetNetworkWirelessSsidSchedulesExecute(r SchedulesApiGetNetworkWirelessSsidSchedulesRequest) (*InlineResponse200193, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest) Execute() (*InlineResponse200193, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200193
func (a *SchedulesApiService) UpdateNetworkWirelessSsidSchedulesExecute(r SchedulesApiUpdateNetworkWirelessSsidSchedulesRequest) (*InlineResponse200193, *http.Response, error) {
	var (
