...
type InlineResponse200379Items struct {
	...
	Readings []InlineResponse200379Readings `json:"readings,omitempty"`
}
...
func (o *InlineResponse200379Items) GetReadings() []InlineResponse200379Readings {
	if o == nil || isNil(o.Readings) {
		var ret []InlineResponse200379Readings
		return ret
	}
	return o.Readings
}
...
// SetReadings gets a reference to the given []InlineResponse200379Readings and assigns it to the Readings field.
