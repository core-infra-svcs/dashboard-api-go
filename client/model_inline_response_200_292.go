...
func (o *InlineResponse200292) GetNetwork() OrganizationsOrganizationIdDevicesAvailabilitiesNetwork {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200292) GetNetworkOk() (*OrganizationsOrganizationIdDevicesAvailabilitiesNetwork, bool) {
	if o == nil || isNil(o.Network) {
    return nil, false
	}
...
func (o *InlineResponse200292) SetNetwork(v OrganizationsOrganizationIdDevicesAvailabilitiesNetwork) {
	o.Network = &v
}
