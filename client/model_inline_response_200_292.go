...
type InlineResponse200292 struct {
	...
	Items []InlineResponse200292Items `json:"items,omitempty"`
...
// SetItems gets a reference to the given []InlineResponse200292Items and assigns it to the Items field.
