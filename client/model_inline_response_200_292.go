...
type InlineResponse200292 struct {
	...
	Example *InlineResponse200292Example `json:"example,omitempty"`
}
...
func (o *InlineResponse200292) GetExample() InlineResponse200292Example {
	if o == nil || isNil(o.Example) {
		var ret InlineResponse200292Example
		return ret
	}
	return *o.Example
}
...
// SetExample gets a reference to the given InlineResponse200292Example and assigns it to the Example field.
