...
type InlineResponse200292 struct {
	Counts *InlineResponse200292Counts `json:"counts,omitempty"`
}
...
func (o *InlineResponse200292) GetCounts() InlineResponse200292Counts {
	if o == nil || isNil(o.Counts) {
		var ret InlineResponse200292Counts
		return ret
	}
	return *o.Counts
}
...
func (o *InlineResponse200292) GetCountsOk() (*InlineResponse200292Counts, bool) {
	if o == nil || isNil(o.Counts) {
    return nil, false
	}
...
// SetCounts gets a reference to the given InlineResponse200292Counts and assigns it to the Counts field.
func (o *InlineResponse200292) SetCounts(v InlineResponse200292Counts) {
	o.Counts = &v
}
