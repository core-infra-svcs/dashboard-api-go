...
type InlineResponse200292 struct {
	// List of settings
	Items []InlineResponse200166 `json:"items,omitempty"`
	Meta *InlineResponse200292Meta `json:"meta,omitempty"`
}
...
// SetItems gets a reference to the given []InlineResponse200166 and assigns it to the Items field.
...
func (o *InlineResponse200292) GetMeta() InlineResponse200292Meta {
	if o == nil || isNil(o.Meta) {
		var ret InlineResponse200292Meta
		return ret
	}
	return *o.Meta
}
...
// SetMeta gets a reference to the given InlineResponse200292Meta and assigns it to the Meta field.
