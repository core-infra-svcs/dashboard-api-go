...
// InlineResponse20041Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse20041Counts struct {
	...
	Noise *InlineResponse20041CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse20041Counts() *InlineResponse20041Counts {
	this := InlineResponse20041Counts{}
	return &this
}
...
func (o *InlineResponse20041Counts) GetNoise() InlineResponse20041CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse20041CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse20041CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse20041Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20041Counts struct {
	value *InlineResponse20041Counts
	isSet bool
}

func (v NullableInlineResponse20041Counts) Get() *InlineResponse20041Counts {
	return v.value
}

func (v *NullableInlineResponse20041Counts) Set(val *InlineResponse20041Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20041Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20041Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20041Counts(val *InlineResponse20041Counts) *NullableInlineResponse20041Counts {
	return &NullableInlineResponse20041Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20041Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20041Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
