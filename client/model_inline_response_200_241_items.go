...
// InlineResponse200241Items struct for InlineResponse200241Items
type InlineResponse200241Items struct {
	// Alert Type
...
func NewInlineResponse200241Items(type_ string, count int32) *InlineResponse200241Items {
	this := InlineResponse200241Items{}
	this.Type = type_
	this.Count = count
	return &this
}
...
func (o InlineResponse200241Items) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200241Items struct {
	value *InlineResponse200241Items
	isSet bool
}

func (v NullableInlineResponse200241Items) Get() *InlineResponse200241Items {
	return v.value
}

func (v *NullableInlineResponse200241Items) Set(val *InlineResponse200241Items) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200241Items) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200241Items) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200241Items(val *InlineResponse200241Items) *NullableInlineResponse200241Items {
	return &NullableInlineResponse200241Items{value: val, isSet: true}
}

func (v NullableInlineResponse200241Items) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200241Items) UnmarshalJSON(src []byte) error {
	v.isSet = true
