...
// InlineResponse20043ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20043ToVersion struct {
...
func NewInlineResponse20043ToVersion() *InlineResponse20043ToVersion {
	this := InlineResponse20043ToVersion{}
	return &this
}
...
func (o InlineResponse20043ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20043ToVersion struct {
	value *InlineResponse20043ToVersion
	isSet bool
}

func (v NullableInlineResponse20043ToVersion) Get() *InlineResponse20043ToVersion {
	return v.value
}

func (v *NullableInlineResponse20043ToVersion) Set(val *InlineResponse20043ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20043ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20043ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20043ToVersion(val *InlineResponse20043ToVersion) *NullableInlineResponse20043ToVersion {
	return &NullableInlineResponse20043ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20043ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20043ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
