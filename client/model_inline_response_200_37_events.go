...
// InlineResponse20037Events struct for InlineResponse20037Events
type InlineResponse20037Events struct {
	...
	EventData *InlineResponse20037EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20037Events() *InlineResponse20037Events {
	this := InlineResponse20037Events{}
	return &this
}
...
func (o *InlineResponse20037Events) GetEventData() InlineResponse20037EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20037EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20037EventData and assigns it to the EventData field.
func (o *InlineResponse20037Events) SetEventData(v InlineResponse20037EventData) {
	o.EventData = &v
}

func (o InlineResponse20037Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20037Events struct {
	value *InlineResponse20037Events
	isSet bool
}

func (v NullableInlineResponse20037Events) Get() *InlineResponse20037Events {
	return v.value
}

func (v *NullableInlineResponse20037Events) Set(val *InlineResponse20037Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20037Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20037Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20037Events(val *InlineResponse20037Events) *NullableInlineResponse20037Events {
	return &NullableInlineResponse20037Events{value: val, isSet: true}
}

func (v NullableInlineResponse20037Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20037Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
