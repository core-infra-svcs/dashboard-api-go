...
func (o *InlineResponse200123) GetByUplink() []OrganizationsOrganizationIdApplianceUplinksUsageByNetworkByUplink {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200123) GetByUplinkOk() ([]OrganizationsOrganizationIdApplianceUplinksUsageByNetworkByUplink, bool) {
	if o == nil || isNil(o.ByUplink) {
    return nil, false
	}
...
func (o *InlineResponse200123) HasByUplink() bool {
	if o != nil && !isNil(o.ByUplink) {
		return true
	}
...
func (o *InlineResponse200123) SetByUplink(v []OrganizationsOrganizationIdApplianceUplinksUsageByNetworkByUplink) {
	o.ByUplink = v
}
