...
// InlineResponse200144Usage Usage information of all clients across organization
type InlineResponse200144Usage struct {
	Overall *InlineResponse200144UsageOverall `json:"overall,omitempty"`
...
func NewInlineResponse200144Usage() *InlineResponse200144Usage {
	this := InlineResponse200144Usage{}
	return &this
}
...
func (o *InlineResponse200144Usage) GetOverall() InlineResponse200144UsageOverall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200144UsageOverall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200144UsageOverall and assigns it to the Overall field.
...
func (o InlineResponse200144Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200144Usage struct {
	value *InlineResponse200144Usage
	isSet bool
}

func (v NullableInlineResponse200144Usage) Get() *InlineResponse200144Usage {
	return v.value
}

func (v *NullableInlineResponse200144Usage) Set(val *InlineResponse200144Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200144Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200144Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200144Usage(val *InlineResponse200144Usage) *NullableInlineResponse200144Usage {
	return &NullableInlineResponse200144Usage{value: val, isSet: true}
}

func (v NullableInlineResponse200144Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200144Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
