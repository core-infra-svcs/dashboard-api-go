...
func (r PoliciesApiGetNetworkPoliciesByClientRequest) Execute() ([]InlineResponse20040, *http.Response, error) {
...
func (a *PoliciesApiService) GetNetworkPoliciesByClientExecute(r PoliciesApiGetNetworkPoliciesByClientRequest) ([]InlineResponse20040, *http.Response, error) {
	var (
