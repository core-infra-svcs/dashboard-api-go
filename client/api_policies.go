...
func (r PoliciesApiGetNetworkPoliciesByClientRequest) Execute() ([]InlineResponse20046, *http.Response, error) {
...
func (a *PoliciesApiService) GetNetworkPoliciesByClientExecute(r PoliciesApiGetNetworkPoliciesByClientRequest) ([]InlineResponse20046, *http.Response, error) {
	var (
