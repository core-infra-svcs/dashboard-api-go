...
func (r PoliciesApiGetOrganizationSmSentryPoliciesAssignmentsByNetworkRequest) Execute() ([]InlineResponse200273, *http.Response, error) {
...
func (a *PoliciesApiService) GetOrganizationSmSentryPoliciesAssignmentsByNetworkExecute(r PoliciesApiGetOrganizationSmSentryPoliciesAssignmentsByNetworkRequest) ([]InlineResponse200273, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PoliciesApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) UpdateOrganizationSmSentryPoliciesAssignments(updateOrganizationSmSentryPoliciesAssignments InlineObject260) PoliciesApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest {
	r.updateOrganizationSmSentryPoliciesAssignments = &updateOrganizationSmSentryPoliciesAssignments
	return r
}

func (r PoliciesApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) Execute() (*InlineResponse200272, *http.Response, error) {
...
func (a *PoliciesApiService) UpdateOrganizationSmSentryPoliciesAssignmentsExecute(r PoliciesApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) (*InlineResponse200272, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
