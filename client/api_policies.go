...
func (r PoliciesApiGetOrganizationSmSentryPoliciesAssignmentsByNetworkRequest) Execute() ([]InlineResponse200280, *http.Response, error) {
...
func (a *PoliciesApiService) GetOrganizationSmSentryPoliciesAssignmentsByNetworkExecute(r PoliciesApiGetOrganizationSmSentryPoliciesAssignmentsByNetworkRequest) ([]InlineResponse200280, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PoliciesApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) UpdateOrganizationSmSentryPoliciesAssignments(updateOrganizationSmSentryPoliciesAssignments InlineObject264) PoliciesApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest {
	r.updateOrganizationSmSentryPoliciesAssignments = &updateOrganizationSmSentryPoliciesAssignments
	return r
}

func (r PoliciesApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) Execute() (*InlineResponse200279, *http.Response, error) {
...
func (a *PoliciesApiService) UpdateOrganizationSmSentryPoliciesAssignmentsExecute(r PoliciesApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) (*InlineResponse200279, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
