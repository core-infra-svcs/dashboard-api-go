...
func (r PoliciesApiCreateOrganizationAdaptivePolicyPolicyRequest) CreateOrganizationAdaptivePolicyPolicy(createOrganizationAdaptivePolicyPolicy InlineObject184) PoliciesApiCreateOrganizationAdaptivePolicyPolicyRequest {
...
func (r PoliciesApiGetNetworkPoliciesByClientRequest) Execute() ([]InlineResponse20044, *http.Response, error) {
...
func (a *PoliciesApiService) GetNetworkPoliciesByClientExecute(r PoliciesApiGetNetworkPoliciesByClientRequest) ([]InlineResponse20044, *http.Response, error) {
	var (
...
func (r PoliciesApiUpdateOrganizationAdaptivePolicyPolicyRequest) UpdateOrganizationAdaptivePolicyPolicy(updateOrganizationAdaptivePolicyPolicy InlineObject185) PoliciesApiUpdateOrganizationAdaptivePolicyPolicyRequest {
