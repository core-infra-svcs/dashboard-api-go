...
func (r PoliciesApiGetOrganizationSmSentryPoliciesAssignmentsByNetworkRequest) Execute() ([]InlineResponse200317, *http.Response, error) {
...
func (a *PoliciesApiService) GetOrganizationSmSentryPoliciesAssignmentsByNetworkExecute(r PoliciesApiGetOrganizationSmSentryPoliciesAssignmentsByNetworkRequest) ([]InlineResponse200317, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PoliciesApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) Execute() (*InlineResponse200316, *http.Response, error) {
...
func (a *PoliciesApiService) UpdateOrganizationSmSentryPoliciesAssignmentsExecute(r PoliciesApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) (*InlineResponse200316, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
