...
func (r PoliciesApiGetNetworkPoliciesByClientRequest) Execute() ([]InlineResponse20024, *http.Response, error) {
...
func (a *PoliciesApiService) GetNetworkPoliciesByClientExecute(r PoliciesApiGetNetworkPoliciesByClientRequest) ([]InlineResponse20024, *http.Response, error) {
	var (
