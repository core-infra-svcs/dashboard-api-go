...
func (r PoliciesApiCreateOrganizationAdaptivePolicyPolicyRequest) CreateOrganizationAdaptivePolicyPolicy(createOrganizationAdaptivePolicyPolicy InlineObject192) PoliciesApiCreateOrganizationAdaptivePolicyPolicyRequest {
...
func (r PoliciesApiGetNetworkPoliciesByClientRequest) Execute() ([]InlineResponse20048, *http.Response, error) {
...
func (a *PoliciesApiService) GetNetworkPoliciesByClientExecute(r PoliciesApiGetNetworkPoliciesByClientRequest) ([]InlineResponse20048, *http.Response, error) {
	var (
...
func (r PoliciesApiUpdateOrganizationAdaptivePolicyPolicyRequest) UpdateOrganizationAdaptivePolicyPolicy(updateOrganizationAdaptivePolicyPolicy InlineObject193) PoliciesApiUpdateOrganizationAdaptivePolicyPolicyRequest {
