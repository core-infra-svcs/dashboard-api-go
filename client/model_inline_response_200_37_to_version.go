...
// InlineResponse20037ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20037ToVersion struct {
...
func NewInlineResponse20037ToVersion() *InlineResponse20037ToVersion {
	this := InlineResponse20037ToVersion{}
	return &this
}
...
func (o InlineResponse20037ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20037ToVersion struct {
	value *InlineResponse20037ToVersion
	isSet bool
}

func (v NullableInlineResponse20037ToVersion) Get() *InlineResponse20037ToVersion {
	return v.value
}

func (v *NullableInlineResponse20037ToVersion) Set(val *InlineResponse20037ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20037ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20037ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20037ToVersion(val *InlineResponse20037ToVersion) *NullableInlineResponse20037ToVersion {
	return &NullableInlineResponse20037ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20037ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20037ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
