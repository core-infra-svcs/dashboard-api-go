...
// InlineResponse200392Redundancy Wireless LAN controller redundancy information
type InlineResponse200392Redundancy struct {
	...
	Management *InlineResponse200392RedundancyManagement `json:"management,omitempty"`
}
...
func NewInlineResponse200392Redundancy() *InlineResponse200392Redundancy {
	this := InlineResponse200392Redundancy{}
	return &this
}
...
func (o *InlineResponse200392Redundancy) GetManagement() InlineResponse200392RedundancyManagement {
	if o == nil || isNil(o.Management) {
		var ret InlineResponse200392RedundancyManagement
		return ret
	}
	return *o.Management
}
...
// SetManagement gets a reference to the given InlineResponse200392RedundancyManagement and assigns it to the Management field.
func (o *InlineResponse200392Redundancy) SetManagement(v InlineResponse200392RedundancyManagement) {
	o.Management = &v
}

func (o InlineResponse200392Redundancy) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200392Redundancy struct {
	value *InlineResponse200392Redundancy
	isSet bool
}

func (v NullableInlineResponse200392Redundancy) Get() *InlineResponse200392Redundancy {
	return v.value
}

func (v *NullableInlineResponse200392Redundancy) Set(val *InlineResponse200392Redundancy) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200392Redundancy) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200392Redundancy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200392Redundancy(val *InlineResponse200392Redundancy) *NullableInlineResponse200392Redundancy {
	return &NullableInlineResponse200392Redundancy{value: val, isSet: true}
}

func (v NullableInlineResponse200392Redundancy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200392Redundancy) UnmarshalJSON(src []byte) error {
	v.isSet = true
