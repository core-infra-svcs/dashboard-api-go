...
// InlineResponse20087DhcpOptions struct for InlineResponse20087DhcpOptions
type InlineResponse20087DhcpOptions struct {
...
func NewInlineResponse20087DhcpOptions() *InlineResponse20087DhcpOptions {
	this := InlineResponse20087DhcpOptions{}
	return &this
}
...
func (o InlineResponse20087DhcpOptions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20087DhcpOptions struct {
	value *InlineResponse20087DhcpOptions
	isSet bool
}

func (v NullableInlineResponse20087DhcpOptions) Get() *InlineResponse20087DhcpOptions {
	return v.value
}

func (v *NullableInlineResponse20087DhcpOptions) Set(val *InlineResponse20087DhcpOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20087DhcpOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20087DhcpOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20087DhcpOptions(val *InlineResponse20087DhcpOptions) *NullableInlineResponse20087DhcpOptions {
	return &NullableInlineResponse20087DhcpOptions{value: val, isSet: true}
}

func (v NullableInlineResponse20087DhcpOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20087DhcpOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
