...
// InlineResponse20019ConnectionStats The connection stats of the device
type InlineResponse20019ConnectionStats struct {
...
func NewInlineResponse20019ConnectionStats() *InlineResponse20019ConnectionStats {
	this := InlineResponse20019ConnectionStats{}
	return &this
}
...
func (o InlineResponse20019ConnectionStats) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20019ConnectionStats struct {
	value *InlineResponse20019ConnectionStats
	isSet bool
}

func (v NullableInlineResponse20019ConnectionStats) Get() *InlineResponse20019ConnectionStats {
	return v.value
}

func (v *NullableInlineResponse20019ConnectionStats) Set(val *InlineResponse20019ConnectionStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20019ConnectionStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20019ConnectionStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20019ConnectionStats(val *InlineResponse20019ConnectionStats) *NullableInlineResponse20019ConnectionStats {
	return &NullableInlineResponse20019ConnectionStats{value: val, isSet: true}
}

func (v NullableInlineResponse20019ConnectionStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20019ConnectionStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
