...
// InlineResponse200280CountsByStatus byStatus
type InlineResponse200280CountsByStatus struct {
	// online count
...
func NewInlineResponse200280CountsByStatus() *InlineResponse200280CountsByStatus {
	this := InlineResponse200280CountsByStatus{}
	return &this
}
...
func (o InlineResponse200280CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200280CountsByStatus struct {
	value *InlineResponse200280CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200280CountsByStatus) Get() *InlineResponse200280CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200280CountsByStatus) Set(val *InlineResponse200280CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200280CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200280CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200280CountsByStatus(val *InlineResponse200280CountsByStatus) *NullableInlineResponse200280CountsByStatus {
	return &NullableInlineResponse200280CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200280CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200280CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
