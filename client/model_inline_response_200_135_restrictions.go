...
// InlineResponse200135Restrictions struct for InlineResponse200135Restrictions
type InlineResponse200135Restrictions struct {
...
func NewInlineResponse200135Restrictions() *InlineResponse200135Restrictions {
	this := InlineResponse200135Restrictions{}
	return &this
}
...
func (o InlineResponse200135Restrictions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200135Restrictions struct {
	value *InlineResponse200135Restrictions
	isSet bool
}

func (v NullableInlineResponse200135Restrictions) Get() *InlineResponse200135Restrictions {
	return v.value
}

func (v *NullableInlineResponse200135Restrictions) Set(val *InlineResponse200135Restrictions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200135Restrictions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200135Restrictions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200135Restrictions(val *InlineResponse200135Restrictions) *NullableInlineResponse200135Restrictions {
	return &NullableInlineResponse200135Restrictions{value: val, isSet: true}
}

func (v NullableInlineResponse200135Restrictions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200135Restrictions) UnmarshalJSON(src []byte) error {
	v.isSet = true
