...
// InlineResponse200125IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200125IpsecPolicies struct {
...
func NewInlineResponse200125IpsecPolicies() *InlineResponse200125IpsecPolicies {
	this := InlineResponse200125IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200125IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200125IpsecPolicies struct {
	value *InlineResponse200125IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200125IpsecPolicies) Get() *InlineResponse200125IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200125IpsecPolicies) Set(val *InlineResponse200125IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200125IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200125IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200125IpsecPolicies(val *InlineResponse200125IpsecPolicies) *NullableInlineResponse200125IpsecPolicies {
	return &NullableInlineResponse200125IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200125IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200125IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
