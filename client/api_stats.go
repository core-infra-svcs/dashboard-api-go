...
func (r StatsApiApiGetOrganizationApplianceVpnStatsRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *StatsApiService) GetOrganizationApplianceVpnStats(ctx context.Context, organizationId string) StatsApiApiGetOrganizationApplianceVpnStatsRequest {
	return StatsApiApiGetOrganizationApplianceVpnStatsRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *StatsApiService) GetOrganizationApplianceVpnStatsExecute(r StatsApiApiGetOrganizationApplianceVpnStatsRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
