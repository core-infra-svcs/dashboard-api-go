...
func (r StatsApiGetOrganizationApplianceVpnStatsRequest) Execute() ([]InlineResponse200229, *http.Response, error) {
...
func (a *StatsApiService) GetOrganizationApplianceVpnStatsExecute(r StatsApiGetOrganizationApplianceVpnStatsRequest) ([]InlineResponse200229, *http.Response, error) {
	var (
