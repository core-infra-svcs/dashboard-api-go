...
func (r StatsApiGetOrganizationApplianceVpnStatsRequest) Execute() ([]InlineResponse200237, *http.Response, error) {
...
func (a *StatsApiService) GetOrganizationApplianceVpnStatsExecute(r StatsApiGetOrganizationApplianceVpnStatsRequest) ([]InlineResponse200237, *http.Response, error) {
	var (
