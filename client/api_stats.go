...
func (r StatsApiGetOrganizationApplianceVpnStatsRequest) Execute() ([]InlineResponse200239, *http.Response, error) {
...
func (a *StatsApiService) GetOrganizationApplianceVpnStatsExecute(r StatsApiGetOrganizationApplianceVpnStatsRequest) ([]InlineResponse200239, *http.Response, error) {
	var (
