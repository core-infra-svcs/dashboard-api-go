...
func (r StatsApiGetOrganizationApplianceVpnStatsRequest) Execute() ([]InlineResponse200247, *http.Response, error) {
...
func (a *StatsApiService) GetOrganizationApplianceVpnStatsExecute(r StatsApiGetOrganizationApplianceVpnStatsRequest) ([]InlineResponse200247, *http.Response, error) {
	var (
