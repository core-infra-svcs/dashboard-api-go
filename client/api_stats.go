...
func (r StatsApiGetOrganizationApplianceVpnStatsRequest) Execute() ([]InlineResponse200246, *http.Response, error) {
...
func (a *StatsApiService) GetOrganizationApplianceVpnStatsExecute(r StatsApiGetOrganizationApplianceVpnStatsRequest) ([]InlineResponse200246, *http.Response, error) {
	var (
