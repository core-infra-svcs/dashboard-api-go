...
// InlineResponse200345BandwidthUsage Bandwidth usage data for the given interval.
type InlineResponse200345BandwidthUsage struct {
...
func NewInlineResponse200345BandwidthUsage() *InlineResponse200345BandwidthUsage {
	this := InlineResponse200345BandwidthUsage{}
	return &this
}
...
func (o InlineResponse200345BandwidthUsage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200345BandwidthUsage struct {
	value *InlineResponse200345BandwidthUsage
	isSet bool
}

func (v NullableInlineResponse200345BandwidthUsage) Get() *InlineResponse200345BandwidthUsage {
	return v.value
}

func (v *NullableInlineResponse200345BandwidthUsage) Set(val *InlineResponse200345BandwidthUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200345BandwidthUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200345BandwidthUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200345BandwidthUsage(val *InlineResponse200345BandwidthUsage) *NullableInlineResponse200345BandwidthUsage {
	return &NullableInlineResponse200345BandwidthUsage{value: val, isSet: true}
}

func (v NullableInlineResponse200345BandwidthUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200345BandwidthUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
