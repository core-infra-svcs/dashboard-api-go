...
// InlineResponse20097Plans struct for InlineResponse20097Plans
type InlineResponse20097Plans struct {
	// The id of the pricing plan to update.
	Id *string `json:"id,omitempty"`
	// The price of the billing plan.
	Price *float32 `json:"price,omitempty"`
	BandwidthLimits *InlineResponse20097BandwidthLimits `json:"bandwidthLimits,omitempty"`
...
func (o *InlineResponse20097Plans) GetBandwidthLimits() InlineResponse20097BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse20097BandwidthLimits
		return ret
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse20097BandwidthLimits and assigns it to the BandwidthLimits field.
...
func (o InlineResponse20097Plans) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20097Plans struct {
	value *InlineResponse20097Plans
	isSet bool
}

func (v NullableInlineResponse20097Plans) Get() *InlineResponse20097Plans {
	return v.value
}

func (v *NullableInlineResponse20097Plans) Set(val *InlineResponse20097Plans) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20097Plans) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20097Plans) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20097Plans(val *InlineResponse20097Plans) *NullableInlineResponse20097Plans {
	return &NullableInlineResponse20097Plans{value: val, isSet: true}
}

func (v NullableInlineResponse20097Plans) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20097Plans) UnmarshalJSON(src []byte) error {
	v.isSet = true
