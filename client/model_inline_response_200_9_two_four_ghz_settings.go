...
// InlineResponse2009TwoFourGhzSettings Manual radio settings for 2.4 GHz
type InlineResponse2009TwoFourGhzSettings struct {
...
func NewInlineResponse2009TwoFourGhzSettings() *InlineResponse2009TwoFourGhzSettings {
	this := InlineResponse2009TwoFourGhzSettings{}
	return &this
}
...
func (o InlineResponse2009TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2009TwoFourGhzSettings struct {
	value *InlineResponse2009TwoFourGhzSettings
	isSet bool
}

func (v NullableInlineResponse2009TwoFourGhzSettings) Get() *InlineResponse2009TwoFourGhzSettings {
	return v.value
}

func (v *NullableInlineResponse2009TwoFourGhzSettings) Set(val *InlineResponse2009TwoFourGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2009TwoFourGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2009TwoFourGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2009TwoFourGhzSettings(val *InlineResponse2009TwoFourGhzSettings) *NullableInlineResponse2009TwoFourGhzSettings {
	return &NullableInlineResponse2009TwoFourGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse2009TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2009TwoFourGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
