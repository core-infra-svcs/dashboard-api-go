...
type InlineResponse20080 struct {
	...
	ClientVpnConnections []InlineResponse20080ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20080) GetClientVpnConnections() []InlineResponse20080ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20080ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20080ClientVpnConnections and assigns it to the ClientVpnConnections field.
