...
// InlineResponse200166Overrides struct for InlineResponse200166Overrides
type InlineResponse200166Overrides struct {
...
func NewInlineResponse200166Overrides() *InlineResponse200166Overrides {
	this := InlineResponse200166Overrides{}
	return &this
}
...
func (o InlineResponse200166Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200166Overrides struct {
	value *InlineResponse200166Overrides
	isSet bool
}

func (v NullableInlineResponse200166Overrides) Get() *InlineResponse200166Overrides {
	return v.value
}

func (v *NullableInlineResponse200166Overrides) Set(val *InlineResponse200166Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200166Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200166Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200166Overrides(val *InlineResponse200166Overrides) *NullableInlineResponse200166Overrides {
	return &NullableInlineResponse200166Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse200166Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200166Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
