...
// InlineResponse200100Errors struct for InlineResponse200100Errors
type InlineResponse200100Errors struct {
...
func NewInlineResponse200100Errors() *InlineResponse200100Errors {
	this := InlineResponse200100Errors{}
	return &this
}
...
func (o InlineResponse200100Errors) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200100Errors struct {
	value *InlineResponse200100Errors
	isSet bool
}

func (v NullableInlineResponse200100Errors) Get() *InlineResponse200100Errors {
	return v.value
}

func (v *NullableInlineResponse200100Errors) Set(val *InlineResponse200100Errors) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200100Errors) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200100Errors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200100Errors(val *InlineResponse200100Errors) *NullableInlineResponse200100Errors {
	return &NullableInlineResponse200100Errors{value: val, isSet: true}
}

func (v NullableInlineResponse200100Errors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200100Errors) UnmarshalJSON(src []byte) error {
	v.isSet = true
