...
type InlineResponse200172 struct {
	...
	StpBridgePriority []InlineResponse200172StpBridgePriority `json:"stpBridgePriority,omitempty"`
}
...
func (o *InlineResponse200172) GetStpBridgePriority() []InlineResponse200172StpBridgePriority {
	if o == nil || isNil(o.StpBridgePriority) {
		var ret []InlineResponse200172StpBridgePriority
		return ret
	}
...
// SetStpBridgePriority gets a reference to the given []InlineResponse200172StpBridgePriority and assigns it to the StpBridgePriority field.
