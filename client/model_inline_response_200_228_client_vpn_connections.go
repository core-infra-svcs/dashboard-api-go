...
// InlineResponse200228ClientVpnConnections struct for InlineResponse200228ClientVpnConnections
type InlineResponse200228ClientVpnConnections struct {
...
func NewInlineResponse200228ClientVpnConnections() *InlineResponse200228ClientVpnConnections {
	this := InlineResponse200228ClientVpnConnections{}
	return &this
}
...
func (o InlineResponse200228ClientVpnConnections) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200228ClientVpnConnections struct {
	value *InlineResponse200228ClientVpnConnections
	isSet bool
}

func (v NullableInlineResponse200228ClientVpnConnections) Get() *InlineResponse200228ClientVpnConnections {
	return v.value
}

func (v *NullableInlineResponse200228ClientVpnConnections) Set(val *InlineResponse200228ClientVpnConnections) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200228ClientVpnConnections) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200228ClientVpnConnections) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200228ClientVpnConnections(val *InlineResponse200228ClientVpnConnections) *NullableInlineResponse200228ClientVpnConnections {
	return &NullableInlineResponse200228ClientVpnConnections{value: val, isSet: true}
}

func (v NullableInlineResponse200228ClientVpnConnections) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200228ClientVpnConnections) UnmarshalJSON(src []byte) error {
	v.isSet = true
