...
// InlineResponse200297StatesUnusedActive Data for unused, active licenses
type InlineResponse200297StatesUnusedActive struct {
	// The number of unused, active licenses
	Count *int32 `json:"count,omitempty"`
	OldestActivation *InlineResponse200297StatesUnusedActiveOldestActivation `json:"oldestActivation,omitempty"`
}
...
func NewInlineResponse200297StatesUnusedActive() *InlineResponse200297StatesUnusedActive {
	this := InlineResponse200297StatesUnusedActive{}
	return &this
}
...
func (o *InlineResponse200297StatesUnusedActive) GetOldestActivation() InlineResponse200297StatesUnusedActiveOldestActivation {
	if o == nil || isNil(o.OldestActivation) {
		var ret InlineResponse200297StatesUnusedActiveOldestActivation
		return ret
	}
...
// SetOldestActivation gets a reference to the given InlineResponse200297StatesUnusedActiveOldestActivation and assigns it to the OldestActivation field.
...
func (o InlineResponse200297StatesUnusedActive) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200297StatesUnusedActive struct {
	value *InlineResponse200297StatesUnusedActive
	isSet bool
}

func (v NullableInlineResponse200297StatesUnusedActive) Get() *InlineResponse200297StatesUnusedActive {
	return v.value
}

func (v *NullableInlineResponse200297StatesUnusedActive) Set(val *InlineResponse200297StatesUnusedActive) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200297StatesUnusedActive) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200297StatesUnusedActive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200297StatesUnusedActive(val *InlineResponse200297StatesUnusedActive) *NullableInlineResponse200297StatesUnusedActive {
	return &NullableInlineResponse200297StatesUnusedActive{value: val, isSet: true}
}

func (v NullableInlineResponse200297StatesUnusedActive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200297StatesUnusedActive) UnmarshalJSON(src []byte) error {
	v.isSet = true
