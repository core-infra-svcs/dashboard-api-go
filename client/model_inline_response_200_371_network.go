...
// InlineResponse200371Network The network that allowlist SSID belongs to
type InlineResponse200371Network struct {
...
func NewInlineResponse200371Network(id string) *InlineResponse200371Network {
	this := InlineResponse200371Network{}
	this.Id = id
	return &this
}
...
func (o InlineResponse200371Network) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200371Network struct {
	value *InlineResponse200371Network
	isSet bool
}

func (v NullableInlineResponse200371Network) Get() *InlineResponse200371Network {
	return v.value
}

func (v *NullableInlineResponse200371Network) Set(val *InlineResponse200371Network) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200371Network) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200371Network) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200371Network(val *InlineResponse200371Network) *NullableInlineResponse200371Network {
	return &NullableInlineResponse200371Network{value: val, isSet: true}
}

func (v NullableInlineResponse200371Network) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200371Network) UnmarshalJSON(src []byte) error {
	v.isSet = true
