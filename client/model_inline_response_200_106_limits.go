...
// InlineResponse200106Limits The current limits of various adaptive policy objects.
type InlineResponse200106Limits struct {
...
func NewInlineResponse200106Limits() *InlineResponse200106Limits {
	this := InlineResponse200106Limits{}
	return &this
}
...
func (o InlineResponse200106Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200106Limits struct {
	value *InlineResponse200106Limits
	isSet bool
}

func (v NullableInlineResponse200106Limits) Get() *InlineResponse200106Limits {
	return v.value
}

func (v *NullableInlineResponse200106Limits) Set(val *InlineResponse200106Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200106Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200106Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200106Limits(val *InlineResponse200106Limits) *NullableInlineResponse200106Limits {
	return &NullableInlineResponse200106Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200106Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200106Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
