...
func (r SplashLoginAttemptsApiGetNetworkSplashLoginAttemptsRequest) Execute() ([]InlineResponse200154, *http.Response, error) {
...
func (a *SplashLoginAttemptsApiService) GetNetworkSplashLoginAttemptsExecute(r SplashLoginAttemptsApiGetNetworkSplashLoginAttemptsRequest) ([]InlineResponse200154, *http.Response, error) {
	var (
