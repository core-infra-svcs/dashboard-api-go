...
func (r SplashLoginAttemptsApiGetNetworkSplashLoginAttemptsRequest) Execute() ([]InlineResponse200148, *http.Response, error) {
...
func (a *SplashLoginAttemptsApiService) GetNetworkSplashLoginAttemptsExecute(r SplashLoginAttemptsApiGetNetworkSplashLoginAttemptsRequest) ([]InlineResponse200148, *http.Response, error) {
	var (
