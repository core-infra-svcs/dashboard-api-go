...
func (r SplashLoginAttemptsApiGetNetworkSplashLoginAttemptsRequest) Execute() ([]InlineResponse200137, *http.Response, error) {
...
func (a *SplashLoginAttemptsApiService) GetNetworkSplashLoginAttemptsExecute(r SplashLoginAttemptsApiGetNetworkSplashLoginAttemptsRequest) ([]InlineResponse200137, *http.Response, error) {
	var (
