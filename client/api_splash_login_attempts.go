...
func (r SplashLoginAttemptsApiGetNetworkSplashLoginAttemptsRequest) Execute() ([]InlineResponse200136, *http.Response, error) {
...
func (a *SplashLoginAttemptsApiService) GetNetworkSplashLoginAttemptsExecute(r SplashLoginAttemptsApiGetNetworkSplashLoginAttemptsRequest) ([]InlineResponse200136, *http.Response, error) {
	var (
