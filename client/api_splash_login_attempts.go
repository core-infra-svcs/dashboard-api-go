...
func (r SplashLoginAttemptsApiGetNetworkSplashLoginAttemptsRequest) Execute() ([]InlineResponse200149, *http.Response, error) {
...
func (a *SplashLoginAttemptsApiService) GetNetworkSplashLoginAttemptsExecute(r SplashLoginAttemptsApiGetNetworkSplashLoginAttemptsRequest) ([]InlineResponse200149, *http.Response, error) {
	var (
