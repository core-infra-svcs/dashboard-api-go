...
// InlineResponse200281Schedule Schedule of the packet capture
type InlineResponse200281Schedule struct {
...
func NewInlineResponse200281Schedule() *InlineResponse200281Schedule {
	this := InlineResponse200281Schedule{}
	return &this
}
...
func (o InlineResponse200281Schedule) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200281Schedule struct {
	value *InlineResponse200281Schedule
	isSet bool
}

func (v NullableInlineResponse200281Schedule) Get() *InlineResponse200281Schedule {
	return v.value
}

func (v *NullableInlineResponse200281Schedule) Set(val *InlineResponse200281Schedule) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200281Schedule) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200281Schedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200281Schedule(val *InlineResponse200281Schedule) *NullableInlineResponse200281Schedule {
	return &NullableInlineResponse200281Schedule{value: val, isSet: true}
}

func (v NullableInlineResponse200281Schedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200281Schedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
