...
// InlineResponse20022Results Results of the ping request.
type InlineResponse20022Results struct {
	// Number of packets sent
	Sent *int32 `json:"sent,omitempty"`
	// Number of packets received
	Received *int32 `json:"received,omitempty"`
	Loss *InlineResponse20022ResultsLoss `json:"loss,omitempty"`
	Latencies *InlineResponse20022ResultsLatencies `json:"latencies,omitempty"`
	// Received packets
	Replies []InlineResponse20022ResultsReplies `json:"replies,omitempty"`
}
...
func NewInlineResponse20022Results() *InlineResponse20022Results {
	this := InlineResponse20022Results{}
	return &this
}
...
func (o *InlineResponse20022Results) GetLoss() InlineResponse20022ResultsLoss {
	if o == nil || isNil(o.Loss) {
		var ret InlineResponse20022ResultsLoss
		return ret
	}
	return *o.Loss
}
...
// SetLoss gets a reference to the given InlineResponse20022ResultsLoss and assigns it to the Loss field.
...
func (o *InlineResponse20022Results) GetLatencies() InlineResponse20022ResultsLatencies {
	if o == nil || isNil(o.Latencies) {
		var ret InlineResponse20022ResultsLatencies
		return ret
	}
	return *o.Latencies
}
...
// SetLatencies gets a reference to the given InlineResponse20022ResultsLatencies and assigns it to the Latencies field.
...
func (o *InlineResponse20022Results) GetReplies() []InlineResponse20022ResultsReplies {
	if o == nil || isNil(o.Replies) {
		var ret []InlineResponse20022ResultsReplies
		return ret
	}
	return o.Replies
}
...
// SetReplies gets a reference to the given []InlineResponse20022ResultsReplies and assigns it to the Replies field.
func (o *InlineResponse20022Results) SetReplies(v []InlineResponse20022ResultsReplies) {
	o.Replies = v
}

func (o InlineResponse20022Results) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20022Results struct {
	value *InlineResponse20022Results
	isSet bool
}

func (v NullableInlineResponse20022Results) Get() *InlineResponse20022Results {
	return v.value
}

func (v *NullableInlineResponse20022Results) Set(val *InlineResponse20022Results) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20022Results) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20022Results) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20022Results(val *InlineResponse20022Results) *NullableInlineResponse20022Results {
	return &NullableInlineResponse20022Results{value: val, isSet: true}
}

func (v NullableInlineResponse20022Results) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20022Results) UnmarshalJSON(src []byte) error {
	v.isSet = true
