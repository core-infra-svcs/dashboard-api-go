...
// InlineResponse200156ResultingNetwork Network after the combination
type InlineResponse200156ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200156ResultingNetwork() *InlineResponse200156ResultingNetwork {
	this := InlineResponse200156ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200156ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200156ResultingNetwork struct {
	value *InlineResponse200156ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200156ResultingNetwork) Get() *InlineResponse200156ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200156ResultingNetwork) Set(val *InlineResponse200156ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200156ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200156ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200156ResultingNetwork(val *InlineResponse200156ResultingNetwork) *NullableInlineResponse200156ResultingNetwork {
	return &NullableInlineResponse200156ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200156ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200156ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
