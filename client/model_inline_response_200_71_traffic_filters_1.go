...
// InlineResponse20071TrafficFilters1 struct for InlineResponse20071TrafficFilters1
type InlineResponse20071TrafficFilters1 struct {
	// Traffic filter type. Must be one of: 'applicationCategory', 'application' or 'custom'
	Type string `json:"type"`
	Value InlineResponse20071Value1 `json:"value"`
}
...
func NewInlineResponse20071TrafficFilters1(type_ string, value InlineResponse20071Value1) *InlineResponse20071TrafficFilters1 {
	this := InlineResponse20071TrafficFilters1{}
	this.Type = type_
	this.Value = value
	return &this
}
...
func (o *InlineResponse20071TrafficFilters1) GetValue() InlineResponse20071Value1 {
	if o == nil {
		var ret InlineResponse20071Value1
		return ret
	}
...
func (o InlineResponse20071TrafficFilters1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20071TrafficFilters1 struct {
	value *InlineResponse20071TrafficFilters1
	isSet bool
}

func (v NullableInlineResponse20071TrafficFilters1) Get() *InlineResponse20071TrafficFilters1 {
	return v.value
}

func (v *NullableInlineResponse20071TrafficFilters1) Set(val *InlineResponse20071TrafficFilters1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20071TrafficFilters1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20071TrafficFilters1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20071TrafficFilters1(val *InlineResponse20071TrafficFilters1) *NullableInlineResponse20071TrafficFilters1 {
	return &NullableInlineResponse20071TrafficFilters1{value: val, isSet: true}
}

func (v NullableInlineResponse20071TrafficFilters1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20071TrafficFilters1) UnmarshalJSON(src []byte) error {
	v.isSet = true
