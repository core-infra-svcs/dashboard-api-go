...
type InlineResponse200204 struct {
	...
	SplashLogo *InlineResponse200204SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200204SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200204SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200204GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200204Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200204SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200204SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200204) GetSplashLogo() InlineResponse200204SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200204SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200204SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200204) GetSplashImage() InlineResponse200204SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200204SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200204SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200204) GetSplashPrepaidFront() InlineResponse200204SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200204SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200204SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200204) GetGuestSponsorship() InlineResponse200204GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200204GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200204GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200204) GetBilling() InlineResponse200204Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200204Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200204Billing and assigns it to the Billing field.
...
func (o *InlineResponse200204) GetSentryEnrollment() InlineResponse200204SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200204SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200204SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200204) GetSelfRegistration() InlineResponse200204SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200204SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200204SelfRegistration and assigns it to the SelfRegistration field.
