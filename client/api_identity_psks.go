...
func (r IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest) CreateNetworkWirelessSsidIdentityPsk(createNetworkWirelessSsidIdentityPsk InlineObject201) IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest {
	r.createNetworkWirelessSsidIdentityPsk = &createNetworkWirelessSsidIdentityPsk
	return r
}

func (r IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest) Execute() (*InlineResponse200206, *http.Response, error) {
...
func (a *IdentityPsksApiService) CreateNetworkWirelessSsidIdentityPskExecute(r IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest) (*InlineResponse200206, *http.Response, error) {
	var (
...
func (r IdentityPsksApiGetNetworkWirelessSsidIdentityPskRequest) Execute() (*InlineResponse200206, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200206
func (a *IdentityPsksApiService) GetNetworkWirelessSsidIdentityPskExecute(r IdentityPsksApiGetNetworkWirelessSsidIdentityPskRequest) (*InlineResponse200206, *http.Response, error) {
	var (
...
func (r IdentityPsksApiGetNetworkWirelessSsidIdentityPsksRequest) Execute() ([]InlineResponse200206, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200206
func (a *IdentityPsksApiService) GetNetworkWirelessSsidIdentityPsksExecute(r IdentityPsksApiGetNetworkWirelessSsidIdentityPsksRequest) ([]InlineResponse200206, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest) UpdateNetworkWirelessSsidIdentityPsk(updateNetworkWirelessSsidIdentityPsk InlineObject202) IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest {
	r.updateNetworkWirelessSsidIdentityPsk = &updateNetworkWirelessSsidIdentityPsk
	return r
}

func (r IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest) Execute() (*InlineResponse200206, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200206
func (a *IdentityPsksApiService) UpdateNetworkWirelessSsidIdentityPskExecute(r IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest) (*InlineResponse200206, *http.Response, error) {
	var (
