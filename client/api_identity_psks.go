...
func (r IdentityPsksApiApiGetNetworkWirelessSsidIdentityPskRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *IdentityPsksApiService) GetNetworkWirelessSsidIdentityPskExecute(r IdentityPsksApiApiGetNetworkWirelessSsidIdentityPskRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
func (r IdentityPsksApiApiGetNetworkWirelessSsidIdentityPsksRequest) Execute() ([]map[string]interface{}, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *IdentityPsksApiService) GetNetworkWirelessSsidIdentityPsksExecute(r IdentityPsksApiApiGetNetworkWirelessSsidIdentityPsksRequest) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
