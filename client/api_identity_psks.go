...
func (r IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest) CreateNetworkWirelessSsidIdentityPsk(createNetworkWirelessSsidIdentityPsk InlineObject196) IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest {
	r.createNetworkWirelessSsidIdentityPsk = &createNetworkWirelessSsidIdentityPsk
	return r
}

func (r IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest) Execute() (*InlineResponse200201, *http.Response, error) {
...
func (a *IdentityPsksApiService) CreateNetworkWirelessSsidIdentityPskExecute(r IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest) (*InlineResponse200201, *http.Response, error) {
	var (
...
func (r IdentityPsksApiGetNetworkWirelessSsidIdentityPskRequest) Execute() (*InlineResponse200201, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200201
func (a *IdentityPsksApiService) GetNetworkWirelessSsidIdentityPskExecute(r IdentityPsksApiGetNetworkWirelessSsidIdentityPskRequest) (*InlineResponse200201, *http.Response, error) {
	var (
...
func (r IdentityPsksApiGetNetworkWirelessSsidIdentityPsksRequest) Execute() ([]InlineResponse200201, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200201
func (a *IdentityPsksApiService) GetNetworkWirelessSsidIdentityPsksExecute(r IdentityPsksApiGetNetworkWirelessSsidIdentityPsksRequest) ([]InlineResponse200201, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest) UpdateNetworkWirelessSsidIdentityPsk(updateNetworkWirelessSsidIdentityPsk InlineObject197) IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest {
	r.updateNetworkWirelessSsidIdentityPsk = &updateNetworkWirelessSsidIdentityPsk
	return r
}

func (r IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest) Execute() (*InlineResponse200201, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200201
func (a *IdentityPsksApiService) UpdateNetworkWirelessSsidIdentityPskExecute(r IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest) (*InlineResponse200201, *http.Response, error) {
	var (
