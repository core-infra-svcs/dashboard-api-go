...
func (r IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest) CreateNetworkWirelessSsidIdentityPsk(createNetworkWirelessSsidIdentityPsk InlineObject175) IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest {
...
func (r IdentityPsksApiGetNetworkWirelessSsidIdentityPskRequest) Execute() (*InlineResponse200110, *http.Response, error) {
...
func (a *IdentityPsksApiService) GetNetworkWirelessSsidIdentityPskExecute(r IdentityPsksApiGetNetworkWirelessSsidIdentityPskRequest) (*InlineResponse200110, *http.Response, error) {
	var (
...
func (r IdentityPsksApiGetNetworkWirelessSsidIdentityPsksRequest) Execute() ([]InlineResponse200110, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200110
func (a *IdentityPsksApiService) GetNetworkWirelessSsidIdentityPsksExecute(r IdentityPsksApiGetNetworkWirelessSsidIdentityPsksRequest) ([]InlineResponse200110, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest) UpdateNetworkWirelessSsidIdentityPsk(updateNetworkWirelessSsidIdentityPsk InlineObject176) IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest {
