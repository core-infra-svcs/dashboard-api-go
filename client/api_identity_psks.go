...
func (r IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest) CreateNetworkWirelessSsidIdentityPsk(createNetworkWirelessSsidIdentityPsk InlineObject197) IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest {
	r.createNetworkWirelessSsidIdentityPsk = &createNetworkWirelessSsidIdentityPsk
	return r
}

func (r IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest) Execute() (*InlineResponse200202, *http.Response, error) {
...
func (a *IdentityPsksApiService) CreateNetworkWirelessSsidIdentityPskExecute(r IdentityPsksApiCreateNetworkWirelessSsidIdentityPskRequest) (*InlineResponse200202, *http.Response, error) {
	var (
...
func (r IdentityPsksApiGetNetworkWirelessSsidIdentityPskRequest) Execute() (*InlineResponse200202, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200202
func (a *IdentityPsksApiService) GetNetworkWirelessSsidIdentityPskExecute(r IdentityPsksApiGetNetworkWirelessSsidIdentityPskRequest) (*InlineResponse200202, *http.Response, error) {
	var (
...
func (r IdentityPsksApiGetNetworkWirelessSsidIdentityPsksRequest) Execute() ([]InlineResponse200202, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200202
func (a *IdentityPsksApiService) GetNetworkWirelessSsidIdentityPsksExecute(r IdentityPsksApiGetNetworkWirelessSsidIdentityPsksRequest) ([]InlineResponse200202, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest) UpdateNetworkWirelessSsidIdentityPsk(updateNetworkWirelessSsidIdentityPsk InlineObject198) IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest {
	r.updateNetworkWirelessSsidIdentityPsk = &updateNetworkWirelessSsidIdentityPsk
	return r
}

func (r IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest) Execute() (*InlineResponse200202, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200202
func (a *IdentityPsksApiService) UpdateNetworkWirelessSsidIdentityPskExecute(r IdentityPsksApiUpdateNetworkWirelessSsidIdentityPskRequest) (*InlineResponse200202, *http.Response, error) {
	var (
