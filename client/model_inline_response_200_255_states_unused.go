...
// InlineResponse200255StatesUnused Data for unused licenses
type InlineResponse200255StatesUnused struct {
	// The number of unused licenses
	Count *int32 `json:"count,omitempty"`
	SoonestActivation *InlineResponse200255StatesUnusedSoonestActivation `json:"soonestActivation,omitempty"`
}
...
func NewInlineResponse200255StatesUnused() *InlineResponse200255StatesUnused {
	this := InlineResponse200255StatesUnused{}
	return &this
}
...
func (o *InlineResponse200255StatesUnused) GetSoonestActivation() InlineResponse200255StatesUnusedSoonestActivation {
	if o == nil || isNil(o.SoonestActivation) {
		var ret InlineResponse200255StatesUnusedSoonestActivation
		return ret
	}
...
// SetSoonestActivation gets a reference to the given InlineResponse200255StatesUnusedSoonestActivation and assigns it to the SoonestActivation field.
...
func (o InlineResponse200255StatesUnused) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200255StatesUnused struct {
	value *InlineResponse200255StatesUnused
	isSet bool
}

func (v NullableInlineResponse200255StatesUnused) Get() *InlineResponse200255StatesUnused {
	return v.value
}

func (v *NullableInlineResponse200255StatesUnused) Set(val *InlineResponse200255StatesUnused) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200255StatesUnused) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200255StatesUnused) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200255StatesUnused(val *InlineResponse200255StatesUnused) *NullableInlineResponse200255StatesUnused {
	return &NullableInlineResponse200255StatesUnused{value: val, isSet: true}
}

func (v NullableInlineResponse200255StatesUnused) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200255StatesUnused) UnmarshalJSON(src []byte) error {
	v.isSet = true
