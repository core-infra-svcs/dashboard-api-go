...
// InlineResponse20034EventData An object containing more data related to the event.
type InlineResponse20034EventData struct {
...
func NewInlineResponse20034EventData() *InlineResponse20034EventData {
	this := InlineResponse20034EventData{}
	return &this
}
...
func (o InlineResponse20034EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20034EventData struct {
	value *InlineResponse20034EventData
	isSet bool
}

func (v NullableInlineResponse20034EventData) Get() *InlineResponse20034EventData {
	return v.value
}

func (v *NullableInlineResponse20034EventData) Set(val *InlineResponse20034EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20034EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20034EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20034EventData(val *InlineResponse20034EventData) *NullableInlineResponse20034EventData {
	return &NullableInlineResponse20034EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20034EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20034EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
