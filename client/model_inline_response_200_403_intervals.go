...
// InlineResponse200403Intervals struct for InlineResponse200403Intervals
type InlineResponse200403Intervals struct {
	// The start time of the query range with iso8601 format
	StartTs *string `json:"startTs,omitempty"`
	// The end time of the query range  with iso8601 format
	EndTs *string `json:"endTs,omitempty"`
	Overall *InlineResponse200403Overall `json:"overall,omitempty"`
	// The CPU usage per core of the wireless LAN controller
	ByCore []InlineResponse200403ByCore `json:"byCore,omitempty"`
}
...
func NewInlineResponse200403Intervals() *InlineResponse200403Intervals {
	this := InlineResponse200403Intervals{}
	return &this
}
...
func (o *InlineResponse200403Intervals) GetOverall() InlineResponse200403Overall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200403Overall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200403Overall and assigns it to the Overall field.
...
func (o *InlineResponse200403Intervals) GetByCore() []InlineResponse200403ByCore {
	if o == nil || isNil(o.ByCore) {
		var ret []InlineResponse200403ByCore
		return ret
	}
	return o.ByCore
}
...
// SetByCore gets a reference to the given []InlineResponse200403ByCore and assigns it to the ByCore field.
func (o *InlineResponse200403Intervals) SetByCore(v []InlineResponse200403ByCore) {
	o.ByCore = v
}

func (o InlineResponse200403Intervals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200403Intervals struct {
	value *InlineResponse200403Intervals
	isSet bool
}

func (v NullableInlineResponse200403Intervals) Get() *InlineResponse200403Intervals {
	return v.value
}

func (v *NullableInlineResponse200403Intervals) Set(val *InlineResponse200403Intervals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200403Intervals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200403Intervals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200403Intervals(val *InlineResponse200403Intervals) *NullableInlineResponse200403Intervals {
	return &NullableInlineResponse200403Intervals{value: val, isSet: true}
}

func (v NullableInlineResponse200403Intervals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200403Intervals) UnmarshalJSON(src []byte) error {
	v.isSet = true
