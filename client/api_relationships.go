...
func (r RelationshipsApiGetDeviceSensorRelationshipsRequest) Execute() (*InlineResponse2008, *http.Response, error) {
...
func (a *RelationshipsApiService) GetDeviceSensorRelationshipsExecute(r RelationshipsApiGetDeviceSensorRelationshipsRequest) (*InlineResponse2008, *http.Response, error) {
	var (
...
func (r RelationshipsApiGetNetworkSensorRelationshipsRequest) Execute() ([]InlineResponse20053, *http.Response, error) {
...
func (a *RelationshipsApiService) GetNetworkSensorRelationshipsExecute(r RelationshipsApiGetNetworkSensorRelationshipsRequest) ([]InlineResponse20053, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) UpdateDeviceSensorRelationships(updateDeviceSensorRelationships InlineObject19) RelationshipsApiUpdateDeviceSensorRelationshipsRequest {
	r.updateDeviceSensorRelationships = &updateDeviceSensorRelationships
	return r
}

func (r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) Execute() (*InlineResponse2008, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2008
func (a *RelationshipsApiService) UpdateDeviceSensorRelationshipsExecute(r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) (*InlineResponse2008, *http.Response, error) {
	var (
