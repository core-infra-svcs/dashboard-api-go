...
func (r RelationshipsApiGetDeviceSensorRelationshipsRequest) Execute() (*InlineResponse20040, *http.Response, error) {
...
func (a *RelationshipsApiService) GetDeviceSensorRelationshipsExecute(r RelationshipsApiGetDeviceSensorRelationshipsRequest) (*InlineResponse20040, *http.Response, error) {
	var (
...
func (r RelationshipsApiGetNetworkSensorRelationshipsRequest) Execute() ([]InlineResponse200132, *http.Response, error) {
...
func (a *RelationshipsApiService) GetNetworkSensorRelationshipsExecute(r RelationshipsApiGetNetworkSensorRelationshipsRequest) ([]InlineResponse200132, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) Execute() (*InlineResponse20040, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20040
func (a *RelationshipsApiService) UpdateDeviceSensorRelationshipsExecute(r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) (*InlineResponse20040, *http.Response, error) {
	var (
