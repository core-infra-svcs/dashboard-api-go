...
func (r RelationshipsApiGetDeviceSensorRelationshipsRequest) Execute() (*InlineResponse20034, *http.Response, error) {
...
func (a *RelationshipsApiService) GetDeviceSensorRelationshipsExecute(r RelationshipsApiGetDeviceSensorRelationshipsRequest) (*InlineResponse20034, *http.Response, error) {
	var (
...
func (r RelationshipsApiGetNetworkSensorRelationshipsRequest) Execute() ([]InlineResponse200120, *http.Response, error) {
...
func (a *RelationshipsApiService) GetNetworkSensorRelationshipsExecute(r RelationshipsApiGetNetworkSensorRelationshipsRequest) ([]InlineResponse200120, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) UpdateDeviceSensorRelationships(updateDeviceSensorRelationships InlineObject26) RelationshipsApiUpdateDeviceSensorRelationshipsRequest {
	r.updateDeviceSensorRelationships = &updateDeviceSensorRelationships
	return r
}

func (r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) Execute() (*InlineResponse20034, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20034
func (a *RelationshipsApiService) UpdateDeviceSensorRelationshipsExecute(r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) (*InlineResponse20034, *http.Response, error) {
	var (
