...
func (r RelationshipsApiGetDeviceSensorRelationshipsRequest) Execute() (*InlineResponse20015, *http.Response, error) {
...
func (a *RelationshipsApiService) GetDeviceSensorRelationshipsExecute(r RelationshipsApiGetDeviceSensorRelationshipsRequest) (*InlineResponse20015, *http.Response, error) {
	var (
...
func (r RelationshipsApiGetNetworkSensorRelationshipsRequest) Execute() ([]InlineResponse20065, *http.Response, error) {
...
func (a *RelationshipsApiService) GetNetworkSensorRelationshipsExecute(r RelationshipsApiGetNetworkSensorRelationshipsRequest) ([]InlineResponse20065, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) UpdateDeviceSensorRelationships(updateDeviceSensorRelationships InlineObject23) RelationshipsApiUpdateDeviceSensorRelationshipsRequest {
	r.updateDeviceSensorRelationships = &updateDeviceSensorRelationships
	return r
}

func (r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) Execute() (*InlineResponse20015, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20015
func (a *RelationshipsApiService) UpdateDeviceSensorRelationshipsExecute(r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) (*InlineResponse20015, *http.Response, error) {
	var (
