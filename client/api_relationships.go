...
func (r RelationshipsApiGetDeviceSensorRelationshipsRequest) Execute() (*InlineResponse2006, *http.Response, error) {
...
func (a *RelationshipsApiService) GetDeviceSensorRelationshipsExecute(r RelationshipsApiGetDeviceSensorRelationshipsRequest) (*InlineResponse2006, *http.Response, error) {
	var (
...
func (r RelationshipsApiGetNetworkSensorRelationshipsRequest) Execute() ([]InlineResponse20051, *http.Response, error) {
...
func (a *RelationshipsApiService) GetNetworkSensorRelationshipsExecute(r RelationshipsApiGetNetworkSensorRelationshipsRequest) ([]InlineResponse20051, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) Execute() (*InlineResponse2006, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2006
func (a *RelationshipsApiService) UpdateDeviceSensorRelationshipsExecute(r RelationshipsApiUpdateDeviceSensorRelationshipsRequest) (*InlineResponse2006, *http.Response, error) {
	var (
