...
// InlineResponse20069Neighbors struct for InlineResponse20069Neighbors
type InlineResponse20069Neighbors struct {
	// The IPv4 address of the neighbor
	Ip *string `json:"ip,omitempty"`
	Ipv6 *InlineResponse20069Ipv6 `json:"ipv6,omitempty"`
	...
	TtlSecurity *InlineResponse20069TtlSecurity `json:"ttlSecurity,omitempty"`
	Authentication *InlineResponse20069Authentication `json:"authentication,omitempty"`
}
...
func NewInlineResponse20069Neighbors() *InlineResponse20069Neighbors {
	this := InlineResponse20069Neighbors{}
	return &this
}
...
func (o *InlineResponse20069Neighbors) GetIpv6() InlineResponse20069Ipv6 {
	if o == nil || isNil(o.Ipv6) {
		var ret InlineResponse20069Ipv6
		return ret
	}
	return *o.Ipv6
}
...
// SetIpv6 gets a reference to the given InlineResponse20069Ipv6 and assigns it to the Ipv6 field.
...
func (o *InlineResponse20069Neighbors) GetTtlSecurity() InlineResponse20069TtlSecurity {
	if o == nil || isNil(o.TtlSecurity) {
		var ret InlineResponse20069TtlSecurity
		return ret
	}
...
// SetTtlSecurity gets a reference to the given InlineResponse20069TtlSecurity and assigns it to the TtlSecurity field.
...
func (o *InlineResponse20069Neighbors) GetAuthentication() InlineResponse20069Authentication {
	if o == nil || isNil(o.Authentication) {
		var ret InlineResponse20069Authentication
		return ret
	}
...
// SetAuthentication gets a reference to the given InlineResponse20069Authentication and assigns it to the Authentication field.
func (o *InlineResponse20069Neighbors) SetAuthentication(v InlineResponse20069Authentication) {
	o.Authentication = &v
}

func (o InlineResponse20069Neighbors) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20069Neighbors struct {
	value *InlineResponse20069Neighbors
	isSet bool
}

func (v NullableInlineResponse20069Neighbors) Get() *InlineResponse20069Neighbors {
	return v.value
}

func (v *NullableInlineResponse20069Neighbors) Set(val *InlineResponse20069Neighbors) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20069Neighbors) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20069Neighbors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20069Neighbors(val *InlineResponse20069Neighbors) *NullableInlineResponse20069Neighbors {
	return &NullableInlineResponse20069Neighbors{value: val, isSet: true}
}

func (v NullableInlineResponse20069Neighbors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20069Neighbors) UnmarshalJSON(src []byte) error {
	v.isSet = true
