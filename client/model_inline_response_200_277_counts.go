...
// InlineResponse200277Counts struct for InlineResponse200277Counts
type InlineResponse200277Counts struct {
	// Device model
...
func NewInlineResponse200277Counts() *InlineResponse200277Counts {
	this := InlineResponse200277Counts{}
	return &this
}
...
func (o InlineResponse200277Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200277Counts struct {
	value *InlineResponse200277Counts
	isSet bool
}

func (v NullableInlineResponse200277Counts) Get() *InlineResponse200277Counts {
	return v.value
}

func (v *NullableInlineResponse200277Counts) Set(val *InlineResponse200277Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200277Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200277Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200277Counts(val *InlineResponse200277Counts) *NullableInlineResponse200277Counts {
	return &NullableInlineResponse200277Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200277Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200277Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
