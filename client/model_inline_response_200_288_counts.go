...
// InlineResponse200288Counts Aggregated count data for the license type
type InlineResponse200288Counts struct {
...
func NewInlineResponse200288Counts() *InlineResponse200288Counts {
	this := InlineResponse200288Counts{}
	return &this
}
...
func (o InlineResponse200288Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200288Counts struct {
	value *InlineResponse200288Counts
	isSet bool
}

func (v NullableInlineResponse200288Counts) Get() *InlineResponse200288Counts {
	return v.value
}

func (v *NullableInlineResponse200288Counts) Set(val *InlineResponse200288Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200288Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200288Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200288Counts(val *InlineResponse200288Counts) *NullableInlineResponse200288Counts {
	return &NullableInlineResponse200288Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200288Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200288Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
