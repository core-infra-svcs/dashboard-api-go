...
// InlineResponse200294Networks struct for InlineResponse200294Networks
type InlineResponse200294Networks struct {
	// Network ID
...
func NewInlineResponse200294Networks() *InlineResponse200294Networks {
	this := InlineResponse200294Networks{}
	return &this
}
...
func (o InlineResponse200294Networks) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200294Networks struct {
	value *InlineResponse200294Networks
	isSet bool
}

func (v NullableInlineResponse200294Networks) Get() *InlineResponse200294Networks {
	return v.value
}

func (v *NullableInlineResponse200294Networks) Set(val *InlineResponse200294Networks) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200294Networks) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200294Networks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200294Networks(val *InlineResponse200294Networks) *NullableInlineResponse200294Networks {
	return &NullableInlineResponse200294Networks{value: val, isSet: true}
}

func (v NullableInlineResponse200294Networks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200294Networks) UnmarshalJSON(src []byte) error {
	v.isSet = true
