...
// InlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45 The count data for RJ45 ports, indexed by speed in Mb
type InlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45 struct {
...
func NewInlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45() *InlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45 {
	this := InlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45{}
	return &this
}
...
func (o InlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45 struct {
	value *InlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45
	isSet bool
}

func (v NullableInlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45) Get() *InlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45 {
	return v.value
}

func (v *NullableInlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45) Set(val *InlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45(val *InlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45) *NullableInlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45 {
	return &NullableInlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45{value: val, isSet: true}
}

func (v NullableInlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200290CountsByStatusActiveByMediaAndLinkSpeedRj45) UnmarshalJSON(src []byte) error {
	v.isSet = true
