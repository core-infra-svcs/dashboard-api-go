...
// InlineResponse200335Addresses struct for InlineResponse200335Addresses
type InlineResponse200335Addresses struct {
...
func NewInlineResponse200335Addresses() *InlineResponse200335Addresses {
	this := InlineResponse200335Addresses{}
	return &this
}
...
func (o InlineResponse200335Addresses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200335Addresses struct {
	value *InlineResponse200335Addresses
	isSet bool
}

func (v NullableInlineResponse200335Addresses) Get() *InlineResponse200335Addresses {
	return v.value
}

func (v *NullableInlineResponse200335Addresses) Set(val *InlineResponse200335Addresses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200335Addresses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200335Addresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200335Addresses(val *InlineResponse200335Addresses) *NullableInlineResponse200335Addresses {
	return &NullableInlineResponse200335Addresses{value: val, isSet: true}
}

func (v NullableInlineResponse200335Addresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200335Addresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
