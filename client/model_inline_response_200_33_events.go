...
// InlineResponse20033Events struct for InlineResponse20033Events
type InlineResponse20033Events struct {
	...
	EventData *InlineResponse20033EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20033Events() *InlineResponse20033Events {
	this := InlineResponse20033Events{}
	return &this
}
...
func (o *InlineResponse20033Events) GetEventData() InlineResponse20033EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20033EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20033EventData and assigns it to the EventData field.
func (o *InlineResponse20033Events) SetEventData(v InlineResponse20033EventData) {
	o.EventData = &v
}

func (o InlineResponse20033Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20033Events struct {
	value *InlineResponse20033Events
	isSet bool
}

func (v NullableInlineResponse20033Events) Get() *InlineResponse20033Events {
	return v.value
}

func (v *NullableInlineResponse20033Events) Set(val *InlineResponse20033Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20033Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20033Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20033Events(val *InlineResponse20033Events) *NullableInlineResponse20033Events {
	return &NullableInlineResponse20033Events{value: val, isSet: true}
}

func (v NullableInlineResponse20033Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20033Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
