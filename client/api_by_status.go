...
func (r ByStatusApiGetOrganizationSummaryTopNetworksByStatusRequest) Execute() ([]InlineResponse200302, *http.Response, error) {
...
func (a *ByStatusApiService) GetOrganizationSummaryTopNetworksByStatusExecute(r ByStatusApiGetOrganizationSummaryTopNetworksByStatusRequest) ([]InlineResponse200302, *http.Response, error) {
	var (
