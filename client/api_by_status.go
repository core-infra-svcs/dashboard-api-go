...
func (r ByStatusApiGetOrganizationSummaryTopNetworksByStatusRequest) Execute() ([]InlineResponse200271, *http.Response, error) {
...
func (a *ByStatusApiService) GetOrganizationSummaryTopNetworksByStatusExecute(r ByStatusApiGetOrganizationSummaryTopNetworksByStatusRequest) ([]InlineResponse200271, *http.Response, error) {
	var (
