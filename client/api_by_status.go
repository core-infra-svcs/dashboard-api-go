...
func (r ByStatusApiGetOrganizationSummaryTopNetworksByStatusRequest) Execute() ([]InlineResponse200352, *http.Response, error) {
...
func (a *ByStatusApiService) GetOrganizationSummaryTopNetworksByStatusExecute(r ByStatusApiGetOrganizationSummaryTopNetworksByStatusRequest) ([]InlineResponse200352, *http.Response, error) {
	var (
