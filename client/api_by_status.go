...
func (r ByStatusApiGetOrganizationSummaryTopNetworksByStatusRequest) Execute() ([]InlineResponse200319, *http.Response, error) {
...
func (a *ByStatusApiService) GetOrganizationSummaryTopNetworksByStatusExecute(r ByStatusApiGetOrganizationSummaryTopNetworksByStatusRequest) ([]InlineResponse200319, *http.Response, error) {
	var (
