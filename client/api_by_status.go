...
func (r ByStatusApiGetOrganizationSummaryTopNetworksByStatusRequest) Execute() ([]InlineResponse200314, *http.Response, error) {
...
func (a *ByStatusApiService) GetOrganizationSummaryTopNetworksByStatusExecute(r ByStatusApiGetOrganizationSummaryTopNetworksByStatusRequest) ([]InlineResponse200314, *http.Response, error) {
	var (
