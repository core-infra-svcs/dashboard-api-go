...
func (r XdrApiDisableOrganizationIntegrationsXdrNetworksRequest) DisableOrganizationIntegrationsXdrNetworks(disableOrganizationIntegrationsXdrNetworks InlineObject255) XdrApiDisableOrganizationIntegrationsXdrNetworksRequest {
	r.disableOrganizationIntegrationsXdrNetworks = &disableOrganizationIntegrationsXdrNetworks
	return r
}

func (r XdrApiDisableOrganizationIntegrationsXdrNetworksRequest) Execute() (*InlineResponse200282, *http.Response, error) {
...
func (a *XdrApiService) DisableOrganizationIntegrationsXdrNetworksExecute(r XdrApiDisableOrganizationIntegrationsXdrNetworksRequest) (*InlineResponse200282, *http.Response, error) {
	var (
...
func (r XdrApiEnableOrganizationIntegrationsXdrNetworksRequest) EnableOrganizationIntegrationsXdrNetworks(enableOrganizationIntegrationsXdrNetworks InlineObject256) XdrApiEnableOrganizationIntegrationsXdrNetworksRequest {
	r.enableOrganizationIntegrationsXdrNetworks = &enableOrganizationIntegrationsXdrNetworks
	return r
}

func (r XdrApiEnableOrganizationIntegrationsXdrNetworksRequest) Execute() (*InlineResponse200283, *http.Response, error) {
...
func (a *XdrApiService) EnableOrganizationIntegrationsXdrNetworksExecute(r XdrApiEnableOrganizationIntegrationsXdrNetworksRequest) (*InlineResponse200283, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r XdrApiGetOrganizationIntegrationsXdrNetworksRequest) Execute() (*InlineResponse200281, *http.Response, error) {
...
func (a *XdrApiService) GetOrganizationIntegrationsXdrNetworksExecute(r XdrApiGetOrganizationIntegrationsXdrNetworksRequest) (*InlineResponse200281, *http.Response, error) {
	var (
