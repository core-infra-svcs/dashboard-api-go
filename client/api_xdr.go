...
func (r XdrApiDisableOrganizationIntegrationsXdrNetworksRequest) DisableOrganizationIntegrationsXdrNetworks(disableOrganizationIntegrationsXdrNetworks InlineObject265) XdrApiDisableOrganizationIntegrationsXdrNetworksRequest {
	r.disableOrganizationIntegrationsXdrNetworks = &disableOrganizationIntegrationsXdrNetworks
	return r
}

func (r XdrApiDisableOrganizationIntegrationsXdrNetworksRequest) Execute() (*InlineResponse200288, *http.Response, error) {
...
func (a *XdrApiService) DisableOrganizationIntegrationsXdrNetworksExecute(r XdrApiDisableOrganizationIntegrationsXdrNetworksRequest) (*InlineResponse200288, *http.Response, error) {
	var (
...
func (r XdrApiEnableOrganizationIntegrationsXdrNetworksRequest) EnableOrganizationIntegrationsXdrNetworks(enableOrganizationIntegrationsXdrNetworks InlineObject266) XdrApiEnableOrganizationIntegrationsXdrNetworksRequest {
	r.enableOrganizationIntegrationsXdrNetworks = &enableOrganizationIntegrationsXdrNetworks
	return r
}

func (r XdrApiEnableOrganizationIntegrationsXdrNetworksRequest) Execute() (*InlineResponse200289, *http.Response, error) {
...
func (a *XdrApiService) EnableOrganizationIntegrationsXdrNetworksExecute(r XdrApiEnableOrganizationIntegrationsXdrNetworksRequest) (*InlineResponse200289, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r XdrApiGetOrganizationIntegrationsXdrNetworksRequest) Execute() (*InlineResponse200287, *http.Response, error) {
...
func (a *XdrApiService) GetOrganizationIntegrationsXdrNetworksExecute(r XdrApiGetOrganizationIntegrationsXdrNetworksRequest) (*InlineResponse200287, *http.Response, error) {
	var (
