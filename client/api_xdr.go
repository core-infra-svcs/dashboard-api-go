...
func (r XdrApiDisableOrganizationIntegrationsXdrNetworksRequest) Execute() (*InlineResponse200294, *http.Response, error) {
...
func (a *XdrApiService) DisableOrganizationIntegrationsXdrNetworksExecute(r XdrApiDisableOrganizationIntegrationsXdrNetworksRequest) (*InlineResponse200294, *http.Response, error) {
	var (
...
func (r XdrApiEnableOrganizationIntegrationsXdrNetworksRequest) Execute() (*InlineResponse200295, *http.Response, error) {
...
func (a *XdrApiService) EnableOrganizationIntegrationsXdrNetworksExecute(r XdrApiEnableOrganizationIntegrationsXdrNetworksRequest) (*InlineResponse200295, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r XdrApiGetOrganizationIntegrationsXdrNetworksRequest) Execute() (*InlineResponse200293, *http.Response, error) {
...
func (a *XdrApiService) GetOrganizationIntegrationsXdrNetworksExecute(r XdrApiGetOrganizationIntegrationsXdrNetworksRequest) (*InlineResponse200293, *http.Response, error) {
	var (
