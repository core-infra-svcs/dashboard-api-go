...
func (r XdrApiDisableOrganizationIntegrationsXdrNetworksRequest) DisableOrganizationIntegrationsXdrNetworks(disableOrganizationIntegrationsXdrNetworks InlineObject271) XdrApiDisableOrganizationIntegrationsXdrNetworksRequest {
	r.disableOrganizationIntegrationsXdrNetworks = &disableOrganizationIntegrationsXdrNetworks
	return r
}

func (r XdrApiDisableOrganizationIntegrationsXdrNetworksRequest) Execute() (*InlineResponse200299, *http.Response, error) {
...
func (a *XdrApiService) DisableOrganizationIntegrationsXdrNetworksExecute(r XdrApiDisableOrganizationIntegrationsXdrNetworksRequest) (*InlineResponse200299, *http.Response, error) {
	var (
...
func (r XdrApiEnableOrganizationIntegrationsXdrNetworksRequest) EnableOrganizationIntegrationsXdrNetworks(enableOrganizationIntegrationsXdrNetworks InlineObject272) XdrApiEnableOrganizationIntegrationsXdrNetworksRequest {
	r.enableOrganizationIntegrationsXdrNetworks = &enableOrganizationIntegrationsXdrNetworks
	return r
}

func (r XdrApiEnableOrganizationIntegrationsXdrNetworksRequest) Execute() (*InlineResponse200300, *http.Response, error) {
...
func (a *XdrApiService) EnableOrganizationIntegrationsXdrNetworksExecute(r XdrApiEnableOrganizationIntegrationsXdrNetworksRequest) (*InlineResponse200300, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r XdrApiGetOrganizationIntegrationsXdrNetworksRequest) Execute() (*InlineResponse200298, *http.Response, error) {
...
func (a *XdrApiService) GetOrganizationIntegrationsXdrNetworksExecute(r XdrApiGetOrganizationIntegrationsXdrNetworksRequest) (*InlineResponse200298, *http.Response, error) {
	var (
