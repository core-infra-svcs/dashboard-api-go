...
// InlineResponse200255CountsByStatus byStatus
type InlineResponse200255CountsByStatus struct {
	// online count
...
func NewInlineResponse200255CountsByStatus() *InlineResponse200255CountsByStatus {
	this := InlineResponse200255CountsByStatus{}
	return &this
}
...
func (o InlineResponse200255CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200255CountsByStatus struct {
	value *InlineResponse200255CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200255CountsByStatus) Get() *InlineResponse200255CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200255CountsByStatus) Set(val *InlineResponse200255CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200255CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200255CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200255CountsByStatus(val *InlineResponse200255CountsByStatus) *NullableInlineResponse200255CountsByStatus {
	return &NullableInlineResponse200255CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200255CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200255CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
