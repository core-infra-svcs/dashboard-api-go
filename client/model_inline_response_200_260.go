...
func (o *InlineResponse200260) GetCertificate() string {
...
func (o *InlineResponse200260) GetCertificateOk() (*string, bool) {
	if o == nil || isNil(o.Certificate) {
    return nil, false
	}
...
func (o *InlineResponse200260) HasCertificate() bool {
	if o != nil && !isNil(o.Certificate) {
		return true
	}
...
func (o *InlineResponse200260) SetCertificate(v string) {
	o.Certificate = &v
}
