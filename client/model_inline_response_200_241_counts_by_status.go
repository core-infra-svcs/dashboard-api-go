...
// InlineResponse200241CountsByStatus byStatus
type InlineResponse200241CountsByStatus struct {
	// online count
...
func NewInlineResponse200241CountsByStatus() *InlineResponse200241CountsByStatus {
	this := InlineResponse200241CountsByStatus{}
	return &this
}
...
func (o InlineResponse200241CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200241CountsByStatus struct {
	value *InlineResponse200241CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200241CountsByStatus) Get() *InlineResponse200241CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200241CountsByStatus) Set(val *InlineResponse200241CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200241CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200241CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200241CountsByStatus(val *InlineResponse200241CountsByStatus) *NullableInlineResponse200241CountsByStatus {
	return &NullableInlineResponse200241CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200241CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200241CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
