...
// InlineResponse20083ClientVpnConnections struct for InlineResponse20083ClientVpnConnections
type InlineResponse20083ClientVpnConnections struct {
...
func NewInlineResponse20083ClientVpnConnections() *InlineResponse20083ClientVpnConnections {
	this := InlineResponse20083ClientVpnConnections{}
	return &this
}
...
func (o InlineResponse20083ClientVpnConnections) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20083ClientVpnConnections struct {
	value *InlineResponse20083ClientVpnConnections
	isSet bool
}

func (v NullableInlineResponse20083ClientVpnConnections) Get() *InlineResponse20083ClientVpnConnections {
	return v.value
}

func (v *NullableInlineResponse20083ClientVpnConnections) Set(val *InlineResponse20083ClientVpnConnections) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20083ClientVpnConnections) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20083ClientVpnConnections) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20083ClientVpnConnections(val *InlineResponse20083ClientVpnConnections) *NullableInlineResponse20083ClientVpnConnections {
	return &NullableInlineResponse20083ClientVpnConnections{value: val, isSet: true}
}

func (v NullableInlineResponse20083ClientVpnConnections) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20083ClientVpnConnections) UnmarshalJSON(src []byte) error {
	v.isSet = true
