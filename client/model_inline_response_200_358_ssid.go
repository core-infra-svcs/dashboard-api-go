...
// InlineResponse200358Ssid Wireless access point and network identifier.
type InlineResponse200358Ssid struct {
...
func (o InlineResponse200358Ssid) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200358Ssid struct {
	value *InlineResponse200358Ssid
	isSet bool
}

func (v NullableInlineResponse200358Ssid) Get() *InlineResponse200358Ssid {
	return v.value
}

func (v *NullableInlineResponse200358Ssid) Set(val *InlineResponse200358Ssid) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200358Ssid) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200358Ssid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200358Ssid(val *InlineResponse200358Ssid) *NullableInlineResponse200358Ssid {
	return &NullableInlineResponse200358Ssid{value: val, isSet: true}
}

func (v NullableInlineResponse200358Ssid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200358Ssid) UnmarshalJSON(src []byte) error {
	v.isSet = true
