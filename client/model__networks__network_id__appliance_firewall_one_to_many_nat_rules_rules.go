...
type NetworksNetworkIdApplianceFirewallOneToManyNatRulesRules struct {
	...
	// The physical WAN interface on which the traffic will arrive, formatted as 'internetN' where N is an integer representing a valid uplink for the network's appliance
