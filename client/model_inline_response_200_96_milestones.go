...
// InlineResponse20096Milestones The Staged Upgrade Milestones for the stage
type InlineResponse20096Milestones struct {
...
func NewInlineResponse20096Milestones() *InlineResponse20096Milestones {
	this := InlineResponse20096Milestones{}
	return &this
}
...
func (o InlineResponse20096Milestones) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20096Milestones struct {
	value *InlineResponse20096Milestones
	isSet bool
}

func (v NullableInlineResponse20096Milestones) Get() *InlineResponse20096Milestones {
	return v.value
}

func (v *NullableInlineResponse20096Milestones) Set(val *InlineResponse20096Milestones) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20096Milestones) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20096Milestones) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20096Milestones(val *InlineResponse20096Milestones) *NullableInlineResponse20096Milestones {
	return &NullableInlineResponse20096Milestones{value: val, isSet: true}
}

func (v NullableInlineResponse20096Milestones) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20096Milestones) UnmarshalJSON(src []byte) error {
	v.isSet = true
