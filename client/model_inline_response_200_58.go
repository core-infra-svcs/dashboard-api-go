...
func (o *InlineResponse20058) GetStaticDelegatedPrefixId() string {
...
func (o *InlineResponse20058) GetStaticDelegatedPrefixIdOk() (*string, bool) {
	if o == nil || isNil(o.StaticDelegatedPrefixId) {
    return nil, false
	}
...
func (o *InlineResponse20058) HasStaticDelegatedPrefixId() bool {
	if o != nil && !isNil(o.StaticDelegatedPrefixId) {
		return true
	}
...
func (o *InlineResponse20058) SetStaticDelegatedPrefixId(v string) {
	o.StaticDelegatedPrefixId = &v
}

// GetPrefix returns the Prefix field value if set, zero value otherwise.
func (o *InlineResponse20058) GetPrefix() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20058) GetPrefixOk() (*string, bool) {
	if o == nil || isNil(o.Prefix) {
    return nil, false
	}
...
func (o *InlineResponse20058) HasPrefix() bool {
	if o != nil && !isNil(o.Prefix) {
		return true
	}
...
func (o *InlineResponse20058) SetPrefix(v string) {
	o.Prefix = &v
}

// GetOrigin returns the Origin field value if set, zero value otherwise.
func (o *InlineResponse20058) GetOrigin() NetworksNetworkIdAppliancePrefixesDelegatedStaticsOrigin {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20058) GetOriginOk() (*NetworksNetworkIdAppliancePrefixesDelegatedStaticsOrigin, bool) {
	if o == nil || isNil(o.Origin) {
    return nil, false
	}
...
func (o *InlineResponse20058) HasOrigin() bool {
	if o != nil && !isNil(o.Origin) {
		return true
	}
...
func (o *InlineResponse20058) SetOrigin(v NetworksNetworkIdAppliancePrefixesDelegatedStaticsOrigin) {
	o.Origin = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *InlineResponse20058) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20058) GetDescriptionOk() (*string, bool) {
	if o == nil || isNil(o.Description) {
    return nil, false
	}
...
func (o *InlineResponse20058) HasDescription() bool {
	if o != nil && !isNil(o.Description) {
		return true
	}
...
func (o *InlineResponse20058) SetDescription(v string) {
	o.Description = &v
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *InlineResponse20058) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20058) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || isNil(o.CreatedAt) {
    return nil, false
	}
...
func (o *InlineResponse20058) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}

// GetUpdatedAt returns the UpdatedAt field value if set, zero value otherwise.
func (o *InlineResponse20058) GetUpdatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20058) GetUpdatedAtOk() (*time.Time, bool) {
	if o == nil || isNil(o.UpdatedAt) {
    return nil, false
	}
...
func (o *InlineResponse20058) HasUpdatedAt() bool {
	if o != nil && !isNil(o.UpdatedAt) {
		return true
	}
...
func (o *InlineResponse20058) SetUpdatedAt(v time.Time) {
	o.UpdatedAt = &v
}
