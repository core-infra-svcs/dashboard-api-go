...
type InlineResponse20058 struct {
	// RF Profiles
	Assigned []InlineResponse20058Assigned `json:"assigned,omitempty"`
}
...
func (o *InlineResponse20058) GetAssigned() []InlineResponse20058Assigned {
	if o == nil || isNil(o.Assigned) {
		var ret []InlineResponse20058Assigned
		return ret
	}
	return o.Assigned
}
...
func (o *InlineResponse20058) GetAssignedOk() ([]InlineResponse20058Assigned, bool) {
	if o == nil || isNil(o.Assigned) {
    return nil, false
	}
...
func (o *InlineResponse20058) HasAssigned() bool {
	if o != nil && !isNil(o.Assigned) {
		return true
	}
...
// SetAssigned gets a reference to the given []InlineResponse20058Assigned and assigns it to the Assigned field.
func (o *InlineResponse20058) SetAssigned(v []InlineResponse20058Assigned) {
	o.Assigned = v
}
