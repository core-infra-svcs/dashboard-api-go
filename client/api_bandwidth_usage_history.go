...
func (r BandwidthUsageHistoryApiGetNetworkClientsBandwidthUsageHistoryRequest) Execute() ([]InlineResponse20079, *http.Response, error) {
...
func (a *BandwidthUsageHistoryApiService) GetNetworkClientsBandwidthUsageHistoryExecute(r BandwidthUsageHistoryApiGetNetworkClientsBandwidthUsageHistoryRequest) ([]InlineResponse20079, *http.Response, error) {
	var (
...
func (r BandwidthUsageHistoryApiGetOrganizationClientsBandwidthUsageHistoryRequest) Execute() ([]InlineResponse200228, *http.Response, error) {
...
func (a *BandwidthUsageHistoryApiService) GetOrganizationClientsBandwidthUsageHistoryExecute(r BandwidthUsageHistoryApiGetOrganizationClientsBandwidthUsageHistoryRequest) ([]InlineResponse200228, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
