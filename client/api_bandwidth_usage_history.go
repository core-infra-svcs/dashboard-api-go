...
func (r BandwidthUsageHistoryApiGetNetworkClientsBandwidthUsageHistoryRequest) Execute() ([]InlineResponse20098, *http.Response, error) {
...
func (a *BandwidthUsageHistoryApiService) GetNetworkClientsBandwidthUsageHistoryExecute(r BandwidthUsageHistoryApiGetNetworkClientsBandwidthUsageHistoryRequest) ([]InlineResponse20098, *http.Response, error) {
	var (
...
func (r BandwidthUsageHistoryApiGetOrganizationClientsBandwidthUsageHistoryRequest) Execute() ([]InlineResponse200283, *http.Response, error) {
...
func (a *BandwidthUsageHistoryApiService) GetOrganizationClientsBandwidthUsageHistoryExecute(r BandwidthUsageHistoryApiGetOrganizationClientsBandwidthUsageHistoryRequest) ([]InlineResponse200283, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
