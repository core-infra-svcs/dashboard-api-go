...
func (r BandwidthUsageHistoryApiApiGetNetworkClientsBandwidthUsageHistoryRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *BandwidthUsageHistoryApiService) GetNetworkClientsBandwidthUsageHistory(ctx context.Context, networkId string) BandwidthUsageHistoryApiApiGetNetworkClientsBandwidthUsageHistoryRequest {
	return BandwidthUsageHistoryApiApiGetNetworkClientsBandwidthUsageHistoryRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *BandwidthUsageHistoryApiService) GetNetworkClientsBandwidthUsageHistoryExecute(r BandwidthUsageHistoryApiApiGetNetworkClientsBandwidthUsageHistoryRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
...
func (r BandwidthUsageHistoryApiApiGetOrganizationClientsBandwidthUsageHistoryRequest) Execute() ([]InlineResponse2002, *http.Response, error) {
...
*/
func (a *BandwidthUsageHistoryApiService) GetOrganizationClientsBandwidthUsageHistory(ctx context.Context, organizationId string) BandwidthUsageHistoryApiApiGetOrganizationClientsBandwidthUsageHistoryRequest {
	return BandwidthUsageHistoryApiApiGetOrganizationClientsBandwidthUsageHistoryRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *BandwidthUsageHistoryApiService) GetOrganizationClientsBandwidthUsageHistoryExecute(r BandwidthUsageHistoryApiApiGetOrganizationClientsBandwidthUsageHistoryRequest) ([]InlineResponse2002, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
