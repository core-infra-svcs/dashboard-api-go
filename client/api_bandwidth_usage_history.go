...
func (r BandwidthUsageHistoryApiGetOrganizationClientsBandwidthUsageHistoryRequest) Execute() ([]InlineResponse200143, *http.Response, error) {
...
func (a *BandwidthUsageHistoryApiService) GetOrganizationClientsBandwidthUsageHistoryExecute(r BandwidthUsageHistoryApiGetOrganizationClientsBandwidthUsageHistoryRequest) ([]InlineResponse200143, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
