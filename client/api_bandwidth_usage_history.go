...
func (r BandwidthUsageHistoryApiGetNetworkClientsBandwidthUsageHistoryRequest) Execute() ([]InlineResponse20085, *http.Response, error) {
...
func (a *BandwidthUsageHistoryApiService) GetNetworkClientsBandwidthUsageHistoryExecute(r BandwidthUsageHistoryApiGetNetworkClientsBandwidthUsageHistoryRequest) ([]InlineResponse20085, *http.Response, error) {
	var (
...
func (r BandwidthUsageHistoryApiGetOrganizationClientsBandwidthUsageHistoryRequest) Execute() ([]InlineResponse200254, *http.Response, error) {
...
func (a *BandwidthUsageHistoryApiService) GetOrganizationClientsBandwidthUsageHistoryExecute(r BandwidthUsageHistoryApiGetOrganizationClientsBandwidthUsageHistoryRequest) ([]InlineResponse200254, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
