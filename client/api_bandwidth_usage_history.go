...
func (r BandwidthUsageHistoryApiApiGetOrganizationClientsBandwidthUsageHistoryRequest) Execute() ([]InlineResponse20066, *_nethttp.Response, error) {
...
func (a *BandwidthUsageHistoryApiService) GetOrganizationClientsBandwidthUsageHistoryExecute(r BandwidthUsageHistoryApiApiGetOrganizationClientsBandwidthUsageHistoryRequest) ([]InlineResponse20066, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
