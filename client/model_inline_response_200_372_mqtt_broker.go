...
// InlineResponse200372MqttBroker MQTT Broker Settings for network
type InlineResponse200372MqttBroker struct {
	// Broker Config ID
...
func NewInlineResponse200372MqttBroker() *InlineResponse200372MqttBroker {
	this := InlineResponse200372MqttBroker{}
	return &this
}
...
func (o InlineResponse200372MqttBroker) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200372MqttBroker struct {
	value *InlineResponse200372MqttBroker
	isSet bool
}

func (v NullableInlineResponse200372MqttBroker) Get() *InlineResponse200372MqttBroker {
	return v.value
}

func (v *NullableInlineResponse200372MqttBroker) Set(val *InlineResponse200372MqttBroker) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200372MqttBroker) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200372MqttBroker) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200372MqttBroker(val *InlineResponse200372MqttBroker) *NullableInlineResponse200372MqttBroker {
	return &NullableInlineResponse200372MqttBroker{value: val, isSet: true}
}

func (v NullableInlineResponse200372MqttBroker) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200372MqttBroker) UnmarshalJSON(src []byte) error {
	v.isSet = true
