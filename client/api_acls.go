...
func (r AclsApiApiCreateOrganizationAdaptivePolicyAclRequest) CreateOrganizationAdaptivePolicyAcl(createOrganizationAdaptivePolicyAcl InlineObject170) AclsApiApiCreateOrganizationAdaptivePolicyAclRequest {
...
*/
func (a *AclsApiService) DeleteOrganizationAdaptivePolicyAcl(ctx _context.Context, organizationId string, aclId string) AclsApiApiDeleteOrganizationAdaptivePolicyAclRequest {
	return AclsApiApiDeleteOrganizationAdaptivePolicyAclRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
*/
func (a *AclsApiService) GetOrganizationAdaptivePolicyAcl(ctx _context.Context, organizationId string, aclId string) AclsApiApiGetOrganizationAdaptivePolicyAclRequest {
	return AclsApiApiGetOrganizationAdaptivePolicyAclRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
func (r AclsApiApiUpdateOrganizationAdaptivePolicyAclRequest) UpdateOrganizationAdaptivePolicyAcl(updateOrganizationAdaptivePolicyAcl InlineObject171) AclsApiApiUpdateOrganizationAdaptivePolicyAclRequest {
...
*/
func (a *AclsApiService) UpdateOrganizationAdaptivePolicyAcl(ctx _context.Context, organizationId string, aclId string) AclsApiApiUpdateOrganizationAdaptivePolicyAclRequest {
	return AclsApiApiUpdateOrganizationAdaptivePolicyAclRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
