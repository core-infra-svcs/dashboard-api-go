...
func (r AclsApiCreateOrganizationAdaptivePolicyAclRequest) CreateOrganizationAdaptivePolicyAcl(createOrganizationAdaptivePolicyAcl InlineObject196) AclsApiCreateOrganizationAdaptivePolicyAclRequest {
	r.createOrganizationAdaptivePolicyAcl = &createOrganizationAdaptivePolicyAcl
	return r
}

func (r AclsApiCreateOrganizationAdaptivePolicyAclRequest) Execute() (*InlineResponse200194, *http.Response, error) {
...
func (a *AclsApiService) CreateOrganizationAdaptivePolicyAclExecute(r AclsApiCreateOrganizationAdaptivePolicyAclRequest) (*InlineResponse200194, *http.Response, error) {
	var (
...
func (r AclsApiGetOrganizationAdaptivePolicyAclRequest) Execute() (*InlineResponse200194, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200194
func (a *AclsApiService) GetOrganizationAdaptivePolicyAclExecute(r AclsApiGetOrganizationAdaptivePolicyAclRequest) (*InlineResponse200194, *http.Response, error) {
	var (
...
func (r AclsApiGetOrganizationAdaptivePolicyAclsRequest) Execute() ([]InlineResponse200194, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200194
func (a *AclsApiService) GetOrganizationAdaptivePolicyAclsExecute(r AclsApiGetOrganizationAdaptivePolicyAclsRequest) ([]InlineResponse200194, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AclsApiUpdateOrganizationAdaptivePolicyAclRequest) UpdateOrganizationAdaptivePolicyAcl(updateOrganizationAdaptivePolicyAcl InlineObject197) AclsApiUpdateOrganizationAdaptivePolicyAclRequest {
	r.updateOrganizationAdaptivePolicyAcl = &updateOrganizationAdaptivePolicyAcl
	return r
}

func (r AclsApiUpdateOrganizationAdaptivePolicyAclRequest) Execute() (*InlineResponse200194, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200194
func (a *AclsApiService) UpdateOrganizationAdaptivePolicyAclExecute(r AclsApiUpdateOrganizationAdaptivePolicyAclRequest) (*InlineResponse200194, *http.Response, error) {
	var (
