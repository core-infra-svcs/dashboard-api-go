...
type InlineResponse20041 struct {
	// SSID status list
	BasicServiceSets []InlineResponse20041BasicServiceSets `json:"basicServiceSets,omitempty"`
}
...
func (o *InlineResponse20041) GetBasicServiceSets() []InlineResponse20041BasicServiceSets {
	if o == nil || isNil(o.BasicServiceSets) {
		var ret []InlineResponse20041BasicServiceSets
		return ret
	}
...
func (o *InlineResponse20041) GetBasicServiceSetsOk() ([]InlineResponse20041BasicServiceSets, bool) {
	if o == nil || isNil(o.BasicServiceSets) {
    return nil, false
	}
...
func (o *InlineResponse20041) HasBasicServiceSets() bool {
	if o != nil && !isNil(o.BasicServiceSets) {
		return true
	}
...
// SetBasicServiceSets gets a reference to the given []InlineResponse20041BasicServiceSets and assigns it to the BasicServiceSets field.
func (o *InlineResponse20041) SetBasicServiceSets(v []InlineResponse20041BasicServiceSets) {
