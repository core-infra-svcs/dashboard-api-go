...
func (r LiveToolsApiApiBlinkDeviceLedsRequest) BlinkDeviceLeds(blinkDeviceLeds InlineObject2) LiveToolsApiApiBlinkDeviceLedsRequest {
...
func (r LiveToolsApiApiCreateDeviceLiveToolsPingRequest) CreateDeviceLiveToolsPing(createDeviceLiveToolsPing InlineObject11) LiveToolsApiApiCreateDeviceLiveToolsPingRequest {
	r.createDeviceLiveToolsPing = &createDeviceLiveToolsPing
	return r
}

func (r LiveToolsApiApiCreateDeviceLiveToolsPingRequest) Execute() (InlineResponse2011, *_nethttp.Response, error) {
...
func (a *LiveToolsApiService) CreateDeviceLiveToolsPingExecute(r LiveToolsApiApiCreateDeviceLiveToolsPingRequest) (InlineResponse2011, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r LiveToolsApiApiCreateDeviceLiveToolsPingDeviceRequest) CreateDeviceLiveToolsPingDevice(createDeviceLiveToolsPingDevice InlineObject12) LiveToolsApiApiCreateDeviceLiveToolsPingDeviceRequest {
	r.createDeviceLiveToolsPingDevice = &createDeviceLiveToolsPingDevice
	return r
}

func (r LiveToolsApiApiCreateDeviceLiveToolsPingDeviceRequest) Execute() (InlineResponse2011, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2011
func (a *LiveToolsApiService) CreateDeviceLiveToolsPingDeviceExecute(r LiveToolsApiApiCreateDeviceLiveToolsPingDeviceRequest) (InlineResponse2011, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r LiveToolsApiApiCycleDeviceSwitchPortsRequest) CycleDeviceSwitchPorts(cycleDeviceSwitchPorts InlineObject14) LiveToolsApiApiCycleDeviceSwitchPortsRequest {
...
func (r LiveToolsApiApiGetDeviceLiveToolsPingRequest) Execute() (InlineResponse2002, *_nethttp.Response, error) {
...
func (a *LiveToolsApiService) GetDeviceLiveToolsPingExecute(r LiveToolsApiApiGetDeviceLiveToolsPingRequest) (InlineResponse2002, *_nethttp.Response, error) {
	var (
...
func (r LiveToolsApiApiGetDeviceLiveToolsPingDeviceRequest) Execute() (InlineResponse2002, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2002
func (a *LiveToolsApiService) GetDeviceLiveToolsPingDeviceExecute(r LiveToolsApiApiGetDeviceLiveToolsPingDeviceRequest) (InlineResponse2002, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
