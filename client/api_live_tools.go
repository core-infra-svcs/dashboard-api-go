...
func (r LiveToolsApiCreateDeviceLiveToolsPingRequest) CreateDeviceLiveToolsPing(createDeviceLiveToolsPing InlineObject16) LiveToolsApiCreateDeviceLiveToolsPingRequest {
...
func (r LiveToolsApiCreateDeviceLiveToolsPingDeviceRequest) CreateDeviceLiveToolsPingDevice(createDeviceLiveToolsPingDevice InlineObject17) LiveToolsApiCreateDeviceLiveToolsPingDeviceRequest {
...
func (r LiveToolsApiCycleDeviceSwitchPortsRequest) CycleDeviceSwitchPorts(cycleDeviceSwitchPorts InlineObject20) LiveToolsApiCycleDeviceSwitchPortsRequest {
	r.cycleDeviceSwitchPorts = &cycleDeviceSwitchPorts
	return r
}

func (r LiveToolsApiCycleDeviceSwitchPortsRequest) Execute() (*InlineResponse20010, *http.Response, error) {
...
func (a *LiveToolsApiService) CycleDeviceSwitchPortsExecute(r LiveToolsApiCycleDeviceSwitchPortsRequest) (*InlineResponse20010, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r LiveToolsApiGetDeviceLiveToolsPingRequest) Execute() (*InlineResponse2006, *http.Response, error) {
...
func (a *LiveToolsApiService) GetDeviceLiveToolsPingExecute(r LiveToolsApiGetDeviceLiveToolsPingRequest) (*InlineResponse2006, *http.Response, error) {
	var (
...
func (r LiveToolsApiGetDeviceLiveToolsPingDeviceRequest) Execute() (*InlineResponse2007, *http.Response, error) {
...
func (a *LiveToolsApiService) GetDeviceLiveToolsPingDeviceExecute(r LiveToolsApiGetDeviceLiveToolsPingDeviceRequest) (*InlineResponse2007, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
