...
func (r LiveToolsApiCycleDeviceSwitchPortsRequest) Execute() (*InlineResponse2007, *http.Response, error) {
...
func (a *LiveToolsApiService) CycleDeviceSwitchPortsExecute(r LiveToolsApiCycleDeviceSwitchPortsRequest) (*InlineResponse2007, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r LiveToolsApiGetDeviceLiveToolsPingRequest) Execute() (*InlineResponse2004, *http.Response, error) {
...
func (a *LiveToolsApiService) GetDeviceLiveToolsPingExecute(r LiveToolsApiGetDeviceLiveToolsPingRequest) (*InlineResponse2004, *http.Response, error) {
	var (
...
func (r LiveToolsApiGetDeviceLiveToolsPingDeviceRequest) Execute() (*InlineResponse2004, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2004
func (a *LiveToolsApiService) GetDeviceLiveToolsPingDeviceExecute(r LiveToolsApiGetDeviceLiveToolsPingDeviceRequest) (*InlineResponse2004, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
