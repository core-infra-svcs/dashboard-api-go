...
// InlineResponse20059PerSsidSettings Per-SSID radio settings by number.
type InlineResponse20059PerSsidSettings struct {
	Var1 *InlineResponse20059PerSsidSettings1 `json:"1,omitempty"`
	Var2 *InlineResponse20059PerSsidSettings2 `json:"2,omitempty"`
	Var3 *InlineResponse20059PerSsidSettings3 `json:"3,omitempty"`
	Var4 *InlineResponse20059PerSsidSettings4 `json:"4,omitempty"`
}
...
func NewInlineResponse20059PerSsidSettings() *InlineResponse20059PerSsidSettings {
	this := InlineResponse20059PerSsidSettings{}
	return &this
}
...
func (o *InlineResponse20059PerSsidSettings) GetVar1() InlineResponse20059PerSsidSettings1 {
	if o == nil || isNil(o.Var1) {
		var ret InlineResponse20059PerSsidSettings1
		return ret
	}
	return *o.Var1
}
...
// SetVar1 gets a reference to the given InlineResponse20059PerSsidSettings1 and assigns it to the Var1 field.
...
func (o *InlineResponse20059PerSsidSettings) GetVar2() InlineResponse20059PerSsidSettings2 {
	if o == nil || isNil(o.Var2) {
		var ret InlineResponse20059PerSsidSettings2
		return ret
	}
	return *o.Var2
}
...
// SetVar2 gets a reference to the given InlineResponse20059PerSsidSettings2 and assigns it to the Var2 field.
...
func (o *InlineResponse20059PerSsidSettings) GetVar3() InlineResponse20059PerSsidSettings3 {
	if o == nil || isNil(o.Var3) {
		var ret InlineResponse20059PerSsidSettings3
		return ret
	}
	return *o.Var3
}
...
// SetVar3 gets a reference to the given InlineResponse20059PerSsidSettings3 and assigns it to the Var3 field.
...
func (o *InlineResponse20059PerSsidSettings) GetVar4() InlineResponse20059PerSsidSettings4 {
	if o == nil || isNil(o.Var4) {
		var ret InlineResponse20059PerSsidSettings4
		return ret
	}
	return *o.Var4
}
...
// SetVar4 gets a reference to the given InlineResponse20059PerSsidSettings4 and assigns it to the Var4 field.
func (o *InlineResponse20059PerSsidSettings) SetVar4(v InlineResponse20059PerSsidSettings4) {
	o.Var4 = &v
}

func (o InlineResponse20059PerSsidSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20059PerSsidSettings struct {
	value *InlineResponse20059PerSsidSettings
	isSet bool
}

func (v NullableInlineResponse20059PerSsidSettings) Get() *InlineResponse20059PerSsidSettings {
	return v.value
}

func (v *NullableInlineResponse20059PerSsidSettings) Set(val *InlineResponse20059PerSsidSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20059PerSsidSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20059PerSsidSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20059PerSsidSettings(val *InlineResponse20059PerSsidSettings) *NullableInlineResponse20059PerSsidSettings {
	return &NullableInlineResponse20059PerSsidSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20059PerSsidSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20059PerSsidSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
