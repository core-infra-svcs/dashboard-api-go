...
// InlineResponse20023TrafficFilters1 struct for InlineResponse20023TrafficFilters1
type InlineResponse20023TrafficFilters1 struct {
	// Traffic filter type. Must be one of: 'applicationCategory', 'application' or 'custom'
	Type string `json:"type"`
	Value InlineResponse20023Value1 `json:"value"`
}
...
func NewInlineResponse20023TrafficFilters1(type_ string, value InlineResponse20023Value1) *InlineResponse20023TrafficFilters1 {
	this := InlineResponse20023TrafficFilters1{}
	this.Type = type_
	this.Value = value
	return &this
}
...
func (o *InlineResponse20023TrafficFilters1) GetValue() InlineResponse20023Value1 {
	if o == nil {
		var ret InlineResponse20023Value1
		return ret
	}
...
func (o InlineResponse20023TrafficFilters1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20023TrafficFilters1 struct {
	value *InlineResponse20023TrafficFilters1
	isSet bool
}

func (v NullableInlineResponse20023TrafficFilters1) Get() *InlineResponse20023TrafficFilters1 {
	return v.value
}

func (v *NullableInlineResponse20023TrafficFilters1) Set(val *InlineResponse20023TrafficFilters1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20023TrafficFilters1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20023TrafficFilters1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20023TrafficFilters1(val *InlineResponse20023TrafficFilters1) *NullableInlineResponse20023TrafficFilters1 {
	return &NullableInlineResponse20023TrafficFilters1{value: val, isSet: true}
}

func (v NullableInlineResponse20023TrafficFilters1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20023TrafficFilters1) UnmarshalJSON(src []byte) error {
	v.isSet = true
