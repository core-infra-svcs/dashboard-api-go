...
func (r BulkDeleteApiCreateOrganizationApplianceDnsLocalProfilesAssignmentsBulkDeleteRequest) Execute() (*InlineResponse200234, *http.Response, error) {
...
func (a *BulkDeleteApiService) CreateOrganizationApplianceDnsLocalProfilesAssignmentsBulkDeleteExecute(r BulkDeleteApiCreateOrganizationApplianceDnsLocalProfilesAssignmentsBulkDeleteRequest) (*InlineResponse200234, *http.Response, error) {
	var (
...
func (r BulkDeleteApiCreateOrganizationApplianceDnsSplitProfilesAssignmentsBulkDeleteRequest) Execute() (*InlineResponse200238, *http.Response, error) {
...
func (a *BulkDeleteApiService) CreateOrganizationApplianceDnsSplitProfilesAssignmentsBulkDeleteExecute(r BulkDeleteApiCreateOrganizationApplianceDnsSplitProfilesAssignmentsBulkDeleteRequest) (*InlineResponse200238, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
