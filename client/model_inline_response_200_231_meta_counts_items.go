...
// InlineResponse200231MetaCountsItems Count of Rate Plans available
type InlineResponse200231MetaCountsItems struct {
...
func NewInlineResponse200231MetaCountsItems() *InlineResponse200231MetaCountsItems {
	this := InlineResponse200231MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200231MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200231MetaCountsItems struct {
	value *InlineResponse200231MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200231MetaCountsItems) Get() *InlineResponse200231MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200231MetaCountsItems) Set(val *InlineResponse200231MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200231MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200231MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200231MetaCountsItems(val *InlineResponse200231MetaCountsItems) *NullableInlineResponse200231MetaCountsItems {
	return &NullableInlineResponse200231MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200231MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200231MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
