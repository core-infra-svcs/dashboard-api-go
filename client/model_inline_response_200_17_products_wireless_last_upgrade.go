...
// InlineResponse20017ProductsWirelessLastUpgrade Details of the last firmware upgrade on the device
type InlineResponse20017ProductsWirelessLastUpgrade struct {
	// Timestamp of the last successful firmware upgrade
	Time *time.Time `json:"time,omitempty"`
	FromVersion *InlineResponse20017ProductsWirelessLastUpgradeFromVersion `json:"fromVersion,omitempty"`
	ToVersion *InlineResponse20017ProductsWirelessLastUpgradeToVersion `json:"toVersion,omitempty"`
}
...
func NewInlineResponse20017ProductsWirelessLastUpgrade() *InlineResponse20017ProductsWirelessLastUpgrade {
	this := InlineResponse20017ProductsWirelessLastUpgrade{}
	return &this
}
...
func (o *InlineResponse20017ProductsWirelessLastUpgrade) GetFromVersion() InlineResponse20017ProductsWirelessLastUpgradeFromVersion {
	if o == nil || isNil(o.FromVersion) {
		var ret InlineResponse20017ProductsWirelessLastUpgradeFromVersion
		return ret
	}
...
// SetFromVersion gets a reference to the given InlineResponse20017ProductsWirelessLastUpgradeFromVersion and assigns it to the FromVersion field.
...
func (o *InlineResponse20017ProductsWirelessLastUpgrade) GetToVersion() InlineResponse20017ProductsWirelessLastUpgradeToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20017ProductsWirelessLastUpgradeToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20017ProductsWirelessLastUpgradeToVersion and assigns it to the ToVersion field.
...
func (o InlineResponse20017ProductsWirelessLastUpgrade) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20017ProductsWirelessLastUpgrade struct {
	value *InlineResponse20017ProductsWirelessLastUpgrade
	isSet bool
}

func (v NullableInlineResponse20017ProductsWirelessLastUpgrade) Get() *InlineResponse20017ProductsWirelessLastUpgrade {
	return v.value
}

func (v *NullableInlineResponse20017ProductsWirelessLastUpgrade) Set(val *InlineResponse20017ProductsWirelessLastUpgrade) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20017ProductsWirelessLastUpgrade) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20017ProductsWirelessLastUpgrade) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20017ProductsWirelessLastUpgrade(val *InlineResponse20017ProductsWirelessLastUpgrade) *NullableInlineResponse20017ProductsWirelessLastUpgrade {
	return &NullableInlineResponse20017ProductsWirelessLastUpgrade{value: val, isSet: true}
}

func (v NullableInlineResponse20017ProductsWirelessLastUpgrade) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20017ProductsWirelessLastUpgrade) UnmarshalJSON(src []byte) error {
	v.isSet = true
