...
// InlineResponse200143IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200143IpsecPolicies struct {
...
func NewInlineResponse200143IpsecPolicies() *InlineResponse200143IpsecPolicies {
	this := InlineResponse200143IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200143IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200143IpsecPolicies struct {
	value *InlineResponse200143IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200143IpsecPolicies) Get() *InlineResponse200143IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200143IpsecPolicies) Set(val *InlineResponse200143IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200143IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200143IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200143IpsecPolicies(val *InlineResponse200143IpsecPolicies) *NullableInlineResponse200143IpsecPolicies {
	return &NullableInlineResponse200143IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200143IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200143IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
