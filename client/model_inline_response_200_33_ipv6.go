...
// InlineResponse20033Ipv6 IPv6 configuration on the single LAN
type InlineResponse20033Ipv6 struct {
	// Enable IPv6 on single LAN
	Enabled *bool `json:"enabled,omitempty"`
	// Prefix assignments on the single LAN
	PrefixAssignments []InlineResponse20033Ipv6PrefixAssignments `json:"prefixAssignments,omitempty"`
}
...
func (o *InlineResponse20033Ipv6) GetPrefixAssignments() []InlineResponse20033Ipv6PrefixAssignments {
	if o == nil || isNil(o.PrefixAssignments) {
		var ret []InlineResponse20033Ipv6PrefixAssignments
		return ret
	}
...
// SetPrefixAssignments gets a reference to the given []InlineResponse20033Ipv6PrefixAssignments and assigns it to the PrefixAssignments field.
func (o *InlineResponse20033Ipv6) SetPrefixAssignments(v []InlineResponse20033Ipv6PrefixAssignments) {
	o.PrefixAssignments = v
}

func (o InlineResponse20033Ipv6) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20033Ipv6 struct {
	value *InlineResponse20033Ipv6
	isSet bool
}

func (v NullableInlineResponse20033Ipv6) Get() *InlineResponse20033Ipv6 {
	return v.value
}

func (v *NullableInlineResponse20033Ipv6) Set(val *InlineResponse20033Ipv6) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20033Ipv6) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20033Ipv6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20033Ipv6(val *InlineResponse20033Ipv6) *NullableInlineResponse20033Ipv6 {
	return &NullableInlineResponse20033Ipv6{value: val, isSet: true}
}

func (v NullableInlineResponse20033Ipv6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20033Ipv6) UnmarshalJSON(src []byte) error {
	v.isSet = true
