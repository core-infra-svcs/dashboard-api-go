...
// InlineResponse20049AlertDestinations A hash of destinations for this specific alert
type InlineResponse20049AlertDestinations struct {
...
func NewInlineResponse20049AlertDestinations() *InlineResponse20049AlertDestinations {
	this := InlineResponse20049AlertDestinations{}
	return &this
}
...
func (o InlineResponse20049AlertDestinations) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20049AlertDestinations struct {
	value *InlineResponse20049AlertDestinations
	isSet bool
}

func (v NullableInlineResponse20049AlertDestinations) Get() *InlineResponse20049AlertDestinations {
	return v.value
}

func (v *NullableInlineResponse20049AlertDestinations) Set(val *InlineResponse20049AlertDestinations) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20049AlertDestinations) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20049AlertDestinations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20049AlertDestinations(val *InlineResponse20049AlertDestinations) *NullableInlineResponse20049AlertDestinations {
	return &NullableInlineResponse20049AlertDestinations{value: val, isSet: true}
}

func (v NullableInlineResponse20049AlertDestinations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20049AlertDestinations) UnmarshalJSON(src []byte) error {
	v.isSet = true
