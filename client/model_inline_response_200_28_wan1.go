...
// InlineResponse20028Wan1 WAN 1 settings
type InlineResponse20028Wan1 struct {
...
func (o InlineResponse20028Wan1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20028Wan1 struct {
	value *InlineResponse20028Wan1
	isSet bool
}

func (v NullableInlineResponse20028Wan1) Get() *InlineResponse20028Wan1 {
	return v.value
}

func (v *NullableInlineResponse20028Wan1) Set(val *InlineResponse20028Wan1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20028Wan1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20028Wan1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20028Wan1(val *InlineResponse20028Wan1) *NullableInlineResponse20028Wan1 {
	return &NullableInlineResponse20028Wan1{value: val, isSet: true}
}

func (v NullableInlineResponse20028Wan1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20028Wan1) UnmarshalJSON(src []byte) error {
	v.isSet = true
