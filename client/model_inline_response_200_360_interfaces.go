...
// InlineResponse200360Interfaces struct for InlineResponse200360Interfaces
type InlineResponse200360Interfaces struct {
...
func NewInlineResponse200360Interfaces() *InlineResponse200360Interfaces {
	this := InlineResponse200360Interfaces{}
	return &this
}
...
func (o InlineResponse200360Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200360Interfaces struct {
	value *InlineResponse200360Interfaces
	isSet bool
}

func (v NullableInlineResponse200360Interfaces) Get() *InlineResponse200360Interfaces {
	return v.value
}

func (v *NullableInlineResponse200360Interfaces) Set(val *InlineResponse200360Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200360Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200360Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200360Interfaces(val *InlineResponse200360Interfaces) *NullableInlineResponse200360Interfaces {
	return &NullableInlineResponse200360Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200360Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200360Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
