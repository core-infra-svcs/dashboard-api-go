...
func (r AccessPoliciesApiCreateNetworkSwitchAccessPolicyRequest) CreateNetworkSwitchAccessPolicy(createNetworkSwitchAccessPolicy InlineObject126) AccessPoliciesApiCreateNetworkSwitchAccessPolicyRequest {
	r.createNetworkSwitchAccessPolicy = &createNetworkSwitchAccessPolicy
	return r
}

func (r AccessPoliciesApiCreateNetworkSwitchAccessPolicyRequest) Execute() (*InlineResponse20092, *http.Response, error) {
...
func (a *AccessPoliciesApiService) CreateNetworkSwitchAccessPolicyExecute(r AccessPoliciesApiCreateNetworkSwitchAccessPolicyRequest) (*InlineResponse20092, *http.Response, error) {
	var (
...
func (r AccessPoliciesApiGetNetworkSwitchAccessPoliciesRequest) Execute() ([]InlineResponse20092, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20092
func (a *AccessPoliciesApiService) GetNetworkSwitchAccessPoliciesExecute(r AccessPoliciesApiGetNetworkSwitchAccessPoliciesRequest) ([]InlineResponse20092, *http.Response, error) {
	var (
...
func (r AccessPoliciesApiGetNetworkSwitchAccessPolicyRequest) Execute() (*InlineResponse20092, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20092
func (a *AccessPoliciesApiService) GetNetworkSwitchAccessPolicyExecute(r AccessPoliciesApiGetNetworkSwitchAccessPolicyRequest) (*InlineResponse20092, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AccessPoliciesApiUpdateNetworkSwitchAccessPolicyRequest) UpdateNetworkSwitchAccessPolicy(updateNetworkSwitchAccessPolicy InlineObject127) AccessPoliciesApiUpdateNetworkSwitchAccessPolicyRequest {
	r.updateNetworkSwitchAccessPolicy = &updateNetworkSwitchAccessPolicy
	return r
}

func (r AccessPoliciesApiUpdateNetworkSwitchAccessPolicyRequest) Execute() (*InlineResponse20092, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20092
func (a *AccessPoliciesApiService) UpdateNetworkSwitchAccessPolicyExecute(r AccessPoliciesApiUpdateNetworkSwitchAccessPolicyRequest) (*InlineResponse20092, *http.Response, error) {
	var (
