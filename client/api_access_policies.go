...
func (r AccessPoliciesApiCreateNetworkSwitchAccessPolicyRequest) Execute() (*InlineResponse200152, *http.Response, error) {
...
func (a *AccessPoliciesApiService) CreateNetworkSwitchAccessPolicyExecute(r AccessPoliciesApiCreateNetworkSwitchAccessPolicyRequest) (*InlineResponse200152, *http.Response, error) {
	var (
...
func (r AccessPoliciesApiGetNetworkSwitchAccessPoliciesRequest) Execute() ([]InlineResponse200152, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200152
func (a *AccessPoliciesApiService) GetNetworkSwitchAccessPoliciesExecute(r AccessPoliciesApiGetNetworkSwitchAccessPoliciesRequest) ([]InlineResponse200152, *http.Response, error) {
	var (
...
func (r AccessPoliciesApiGetNetworkSwitchAccessPolicyRequest) Execute() (*InlineResponse200152, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200152
func (a *AccessPoliciesApiService) GetNetworkSwitchAccessPolicyExecute(r AccessPoliciesApiGetNetworkSwitchAccessPolicyRequest) (*InlineResponse200152, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AccessPoliciesApiUpdateNetworkSwitchAccessPolicyRequest) Execute() (*InlineResponse200152, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200152
func (a *AccessPoliciesApiService) UpdateNetworkSwitchAccessPolicyExecute(r AccessPoliciesApiUpdateNetworkSwitchAccessPolicyRequest) (*InlineResponse200152, *http.Response, error) {
	var (
