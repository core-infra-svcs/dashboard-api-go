...
func (r ThirdPartyVPNPeersApiGetOrganizationApplianceVpnThirdPartyVPNPeersRequest) Execute() (*InlineResponse200248, *http.Response, error) {
...
func (a *ThirdPartyVPNPeersApiService) GetOrganizationApplianceVpnThirdPartyVPNPeersExecute(r ThirdPartyVPNPeersApiGetOrganizationApplianceVpnThirdPartyVPNPeersRequest) (*InlineResponse200248, *http.Response, error) {
	var (
...
func (r ThirdPartyVPNPeersApiUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequest) Execute() (*InlineResponse200248, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200248
func (a *ThirdPartyVPNPeersApiService) UpdateOrganizationApplianceVpnThirdPartyVPNPeersExecute(r ThirdPartyVPNPeersApiUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequest) (*InlineResponse200248, *http.Response, error) {
	var (
