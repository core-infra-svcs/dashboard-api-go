...
type InlineResponse200277 struct {
	...
	Counts []InlineResponse200277Counts `json:"counts,omitempty"`
}
...
func (o *InlineResponse200277) GetCounts() []InlineResponse200277Counts {
	if o == nil || isNil(o.Counts) {
		var ret []InlineResponse200277Counts
		return ret
	}
	return o.Counts
}
...
func (o *InlineResponse200277) GetCountsOk() ([]InlineResponse200277Counts, bool) {
	if o == nil || isNil(o.Counts) {
    return nil, false
	}
...
func (o *InlineResponse200277) HasCounts() bool {
	if o != nil && !isNil(o.Counts) {
		return true
	}
...
// SetCounts gets a reference to the given []InlineResponse200277Counts and assigns it to the Counts field.
func (o *InlineResponse200277) SetCounts(v []InlineResponse200277Counts) {
	o.Counts = v
}
