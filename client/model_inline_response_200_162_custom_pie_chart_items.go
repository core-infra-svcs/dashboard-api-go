...
// InlineResponse200162CustomPieChartItems struct for InlineResponse200162CustomPieChartItems
type InlineResponse200162CustomPieChartItems struct {
...
func NewInlineResponse200162CustomPieChartItems(name string, type_ string, value string) *InlineResponse200162CustomPieChartItems {
	this := InlineResponse200162CustomPieChartItems{}
	this.Name = name
	this.Type = type_
	this.Value = value
	return &this
...
func (o InlineResponse200162CustomPieChartItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200162CustomPieChartItems struct {
	value *InlineResponse200162CustomPieChartItems
	isSet bool
}

func (v NullableInlineResponse200162CustomPieChartItems) Get() *InlineResponse200162CustomPieChartItems {
	return v.value
}

func (v *NullableInlineResponse200162CustomPieChartItems) Set(val *InlineResponse200162CustomPieChartItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200162CustomPieChartItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200162CustomPieChartItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200162CustomPieChartItems(val *InlineResponse200162CustomPieChartItems) *NullableInlineResponse200162CustomPieChartItems {
	return &NullableInlineResponse200162CustomPieChartItems{value: val, isSet: true}
}

func (v NullableInlineResponse200162CustomPieChartItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200162CustomPieChartItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
