...
func (r ClientCountHistoryApiGetNetworkWirelessClientCountHistoryRequest) Execute() ([]InlineResponse20059, *http.Response, error) {
...
func (a *ClientCountHistoryApiService) GetNetworkWirelessClientCountHistoryExecute(r ClientCountHistoryApiGetNetworkWirelessClientCountHistoryRequest) ([]InlineResponse20059, *http.Response, error) {
	var (
