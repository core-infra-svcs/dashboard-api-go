...
func (r ClientCountHistoryApiGetNetworkWirelessClientCountHistoryRequest) Execute() ([]InlineResponse200116, *http.Response, error) {
...
func (a *ClientCountHistoryApiService) GetNetworkWirelessClientCountHistoryExecute(r ClientCountHistoryApiGetNetworkWirelessClientCountHistoryRequest) ([]InlineResponse200116, *http.Response, error) {
	var (
