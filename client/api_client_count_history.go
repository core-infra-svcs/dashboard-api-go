...
func (r ClientCountHistoryApiGetNetworkWirelessClientCountHistoryRequest) Execute() ([]InlineResponse20091, *http.Response, error) {
...
func (a *ClientCountHistoryApiService) GetNetworkWirelessClientCountHistoryExecute(r ClientCountHistoryApiGetNetworkWirelessClientCountHistoryRequest) ([]InlineResponse20091, *http.Response, error) {
	var (
