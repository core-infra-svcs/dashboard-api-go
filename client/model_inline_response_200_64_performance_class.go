...
// InlineResponse20064PerformanceClass Performance class setting for uplink preference rule
type InlineResponse20064PerformanceClass struct {
...
func NewInlineResponse20064PerformanceClass(type_ string) *InlineResponse20064PerformanceClass {
	this := InlineResponse20064PerformanceClass{}
	this.Type = type_
	return &this
}
...
func (o InlineResponse20064PerformanceClass) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20064PerformanceClass struct {
	value *InlineResponse20064PerformanceClass
	isSet bool
}

func (v NullableInlineResponse20064PerformanceClass) Get() *InlineResponse20064PerformanceClass {
	return v.value
}

func (v *NullableInlineResponse20064PerformanceClass) Set(val *InlineResponse20064PerformanceClass) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20064PerformanceClass) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20064PerformanceClass) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20064PerformanceClass(val *InlineResponse20064PerformanceClass) *NullableInlineResponse20064PerformanceClass {
	return &NullableInlineResponse20064PerformanceClass{value: val, isSet: true}
}

func (v NullableInlineResponse20064PerformanceClass) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20064PerformanceClass) UnmarshalJSON(src []byte) error {
	v.isSet = true
