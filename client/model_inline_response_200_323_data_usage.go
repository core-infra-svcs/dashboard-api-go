...
// InlineResponse200323DataUsage Usage data for the given interval.
type InlineResponse200323DataUsage struct {
...
func NewInlineResponse200323DataUsage() *InlineResponse200323DataUsage {
	this := InlineResponse200323DataUsage{}
	return &this
}
...
func (o InlineResponse200323DataUsage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200323DataUsage struct {
	value *InlineResponse200323DataUsage
	isSet bool
}

func (v NullableInlineResponse200323DataUsage) Get() *InlineResponse200323DataUsage {
	return v.value
}

func (v *NullableInlineResponse200323DataUsage) Set(val *InlineResponse200323DataUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200323DataUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200323DataUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200323DataUsage(val *InlineResponse200323DataUsage) *NullableInlineResponse200323DataUsage {
	return &NullableInlineResponse200323DataUsage{value: val, isSet: true}
}

func (v NullableInlineResponse200323DataUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200323DataUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
