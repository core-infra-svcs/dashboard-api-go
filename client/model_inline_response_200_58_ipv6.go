...
// InlineResponse20058Ipv6 IPv6 configuration on the single LAN
type InlineResponse20058Ipv6 struct {
	// Enable IPv6 on single LAN
	Enabled *bool `json:"enabled,omitempty"`
	// Prefix assignments on the single LAN
	PrefixAssignments []InlineResponse20058Ipv6PrefixAssignments `json:"prefixAssignments,omitempty"`
}
...
func (o *InlineResponse20058Ipv6) GetPrefixAssignments() []InlineResponse20058Ipv6PrefixAssignments {
	if o == nil || isNil(o.PrefixAssignments) {
		var ret []InlineResponse20058Ipv6PrefixAssignments
		return ret
	}
...
// SetPrefixAssignments gets a reference to the given []InlineResponse20058Ipv6PrefixAssignments and assigns it to the PrefixAssignments field.
func (o *InlineResponse20058Ipv6) SetPrefixAssignments(v []InlineResponse20058Ipv6PrefixAssignments) {
	o.PrefixAssignments = v
}

func (o InlineResponse20058Ipv6) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20058Ipv6 struct {
	value *InlineResponse20058Ipv6
	isSet bool
}

func (v NullableInlineResponse20058Ipv6) Get() *InlineResponse20058Ipv6 {
	return v.value
}

func (v *NullableInlineResponse20058Ipv6) Set(val *InlineResponse20058Ipv6) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20058Ipv6) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20058Ipv6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20058Ipv6(val *InlineResponse20058Ipv6) *NullableInlineResponse20058Ipv6 {
	return &NullableInlineResponse20058Ipv6{value: val, isSet: true}
}

func (v NullableInlineResponse20058Ipv6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20058Ipv6) UnmarshalJSON(src []byte) error {
	v.isSet = true
