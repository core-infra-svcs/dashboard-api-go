...
func (r ConfigurationChangesApiGetOrganizationConfigurationChangesRequest) Execute() ([]InlineResponse200225, *http.Response, error) {
...
func (a *ConfigurationChangesApiService) GetOrganizationConfigurationChangesExecute(r ConfigurationChangesApiGetOrganizationConfigurationChangesRequest) ([]InlineResponse200225, *http.Response, error) {
	var (
