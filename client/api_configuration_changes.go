...
func (r ConfigurationChangesApiGetOrganizationConfigurationChangesRequest) Execute() ([]InlineResponse200268, *http.Response, error) {
...
func (a *ConfigurationChangesApiService) GetOrganizationConfigurationChangesExecute(r ConfigurationChangesApiGetOrganizationConfigurationChangesRequest) ([]InlineResponse200268, *http.Response, error) {
	var (
