...
func (r ConfigurationChangesApiGetOrganizationConfigurationChangesRequest) Execute() ([]InlineResponse200247, *http.Response, error) {
...
func (a *ConfigurationChangesApiService) GetOrganizationConfigurationChangesExecute(r ConfigurationChangesApiGetOrganizationConfigurationChangesRequest) ([]InlineResponse200247, *http.Response, error) {
	var (
