...
// InlineResponse200293Items struct for InlineResponse200293Items
type InlineResponse200293Items struct {
	// Network ID
...
func NewInlineResponse200293Items() *InlineResponse200293Items {
	this := InlineResponse200293Items{}
	return &this
}
...
func (o InlineResponse200293Items) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200293Items struct {
	value *InlineResponse200293Items
	isSet bool
}

func (v NullableInlineResponse200293Items) Get() *InlineResponse200293Items {
	return v.value
}

func (v *NullableInlineResponse200293Items) Set(val *InlineResponse200293Items) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200293Items) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200293Items) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200293Items(val *InlineResponse200293Items) *NullableInlineResponse200293Items {
	return &NullableInlineResponse200293Items{value: val, isSet: true}
}

func (v NullableInlineResponse200293Items) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200293Items) UnmarshalJSON(src []byte) error {
	v.isSet = true
