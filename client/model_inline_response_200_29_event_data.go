...
// InlineResponse20029EventData An object containing more data related to the event.
type InlineResponse20029EventData struct {
...
func NewInlineResponse20029EventData() *InlineResponse20029EventData {
	this := InlineResponse20029EventData{}
	return &this
}
...
func (o InlineResponse20029EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20029EventData struct {
	value *InlineResponse20029EventData
	isSet bool
}

func (v NullableInlineResponse20029EventData) Get() *InlineResponse20029EventData {
	return v.value
}

func (v *NullableInlineResponse20029EventData) Set(val *InlineResponse20029EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20029EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20029EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20029EventData(val *InlineResponse20029EventData) *NullableInlineResponse20029EventData {
	return &NullableInlineResponse20029EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20029EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20029EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
