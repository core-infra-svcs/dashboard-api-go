...
func (o *InlineResponse200147) GetCreatedAt() string {
...
func (o *InlineResponse200147) GetCreatedAtOk() (*string, bool) {
	if o == nil || isNil(o.CreatedAt) {
    return nil, false
	}
...
func (o *InlineResponse200147) HasCreatedAt() bool {
	if o != nil && !isNil(o.CreatedAt) {
		return true
	}
...
func (o *InlineResponse200147) SetCreatedAt(v string) {
	o.CreatedAt = &v
}
...
func (o *InlineResponse200147) GetXml() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200147) GetXmlOk() (*string, bool) {
	if o == nil || isNil(o.Xml) {
    return nil, false
	}
	return o.Xml, true
...
func (o *InlineResponse200147) HasXml() bool {
	if o != nil && !isNil(o.Xml) {
		return true
	}
...
func (o *InlineResponse200147) SetXml(v string) {
	o.Xml = &v
}
