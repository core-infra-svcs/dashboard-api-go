...
func (o *InlineResponse200147) GetDeviceStatus() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200147) GetDeviceStatusOk() (*string, bool) {
	if o == nil || isNil(o.DeviceStatus) {
    return nil, false
	}
...
func (o *InlineResponse200147) HasDeviceStatus() bool {
	if o != nil && !isNil(o.DeviceStatus) {
		return true
	}
...
func (o *InlineResponse200147) SetDeviceStatus(v string) {
	o.DeviceStatus = &v
}

// GetUpgrade returns the Upgrade field value if set, zero value otherwise.
func (o *InlineResponse200147) GetUpgrade() OrganizationsOrganizationIdFirmwareUpgradesByDeviceUpgrade {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200147) GetUpgradeOk() (*OrganizationsOrganizationIdFirmwareUpgradesByDeviceUpgrade, bool) {
	if o == nil || isNil(o.Upgrade) {
    return nil, false
	}
...
func (o *InlineResponse200147) HasUpgrade() bool {
	if o != nil && !isNil(o.Upgrade) {
		return true
	}
...
func (o *InlineResponse200147) SetUpgrade(v OrganizationsOrganizationIdFirmwareUpgradesByDeviceUpgrade) {
	o.Upgrade = &v
}
