...
type InlineResponse200324Ports struct {
	...
	Cdp []InlineResponse200324Cdp `json:"cdp,omitempty"`
	// The Link Layer Discovery Protocol (LLDP) information of the connected device.
	Lldp []InlineResponse200324Lldp `json:"lldp,omitempty"`
}
...
func (o *InlineResponse200324Ports) GetCdp() []InlineResponse200324Cdp {
	if o == nil || isNil(o.Cdp) {
		var ret []InlineResponse200324Cdp
		return ret
	}
	return o.Cdp
}
...
// SetCdp gets a reference to the given []InlineResponse200324Cdp and assigns it to the Cdp field.
...
func (o *InlineResponse200324Ports) GetLldp() []InlineResponse200324Lldp {
	if o == nil || isNil(o.Lldp) {
		var ret []InlineResponse200324Lldp
		return ret
	}
	return o.Lldp
}
...
// SetLldp gets a reference to the given []InlineResponse200324Lldp and assigns it to the Lldp field.
