...
// InlineResponse200262ResultingNetwork Network after the combination
type InlineResponse200262ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200262ResultingNetwork() *InlineResponse200262ResultingNetwork {
	this := InlineResponse200262ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200262ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200262ResultingNetwork struct {
	value *InlineResponse200262ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200262ResultingNetwork) Get() *InlineResponse200262ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200262ResultingNetwork) Set(val *InlineResponse200262ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200262ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200262ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200262ResultingNetwork(val *InlineResponse200262ResultingNetwork) *NullableInlineResponse200262ResultingNetwork {
	return &NullableInlineResponse200262ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200262ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200262ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
