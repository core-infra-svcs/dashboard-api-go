...
// InlineResponse20055PerSsidSettings Per-SSID radio settings by number.
type InlineResponse20055PerSsidSettings struct {
	Var1 *InlineResponse20055PerSsidSettings1 `json:"1,omitempty"`
	Var2 *InlineResponse20055PerSsidSettings2 `json:"2,omitempty"`
	Var3 *InlineResponse20055PerSsidSettings3 `json:"3,omitempty"`
	Var4 *InlineResponse20055PerSsidSettings4 `json:"4,omitempty"`
}
...
func NewInlineResponse20055PerSsidSettings() *InlineResponse20055PerSsidSettings {
	this := InlineResponse20055PerSsidSettings{}
	return &this
}
...
func (o *InlineResponse20055PerSsidSettings) GetVar1() InlineResponse20055PerSsidSettings1 {
	if o == nil || isNil(o.Var1) {
		var ret InlineResponse20055PerSsidSettings1
		return ret
	}
	return *o.Var1
}
...
// SetVar1 gets a reference to the given InlineResponse20055PerSsidSettings1 and assigns it to the Var1 field.
...
func (o *InlineResponse20055PerSsidSettings) GetVar2() InlineResponse20055PerSsidSettings2 {
	if o == nil || isNil(o.Var2) {
		var ret InlineResponse20055PerSsidSettings2
		return ret
	}
	return *o.Var2
}
...
// SetVar2 gets a reference to the given InlineResponse20055PerSsidSettings2 and assigns it to the Var2 field.
...
func (o *InlineResponse20055PerSsidSettings) GetVar3() InlineResponse20055PerSsidSettings3 {
	if o == nil || isNil(o.Var3) {
		var ret InlineResponse20055PerSsidSettings3
		return ret
	}
	return *o.Var3
}
...
// SetVar3 gets a reference to the given InlineResponse20055PerSsidSettings3 and assigns it to the Var3 field.
...
func (o *InlineResponse20055PerSsidSettings) GetVar4() InlineResponse20055PerSsidSettings4 {
	if o == nil || isNil(o.Var4) {
		var ret InlineResponse20055PerSsidSettings4
		return ret
	}
	return *o.Var4
}
...
// SetVar4 gets a reference to the given InlineResponse20055PerSsidSettings4 and assigns it to the Var4 field.
func (o *InlineResponse20055PerSsidSettings) SetVar4(v InlineResponse20055PerSsidSettings4) {
	o.Var4 = &v
}

func (o InlineResponse20055PerSsidSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20055PerSsidSettings struct {
	value *InlineResponse20055PerSsidSettings
	isSet bool
}

func (v NullableInlineResponse20055PerSsidSettings) Get() *InlineResponse20055PerSsidSettings {
	return v.value
}

func (v *NullableInlineResponse20055PerSsidSettings) Set(val *InlineResponse20055PerSsidSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20055PerSsidSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20055PerSsidSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20055PerSsidSettings(val *InlineResponse20055PerSsidSettings) *NullableInlineResponse20055PerSsidSettings {
	return &NullableInlineResponse20055PerSsidSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20055PerSsidSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20055PerSsidSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
