...
// InlineResponse20037Group The staged upgrade group
type InlineResponse20037Group struct {
...
func (o InlineResponse20037Group) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20037Group struct {
	value *InlineResponse20037Group
	isSet bool
}

func (v NullableInlineResponse20037Group) Get() *InlineResponse20037Group {
	return v.value
}

func (v *NullableInlineResponse20037Group) Set(val *InlineResponse20037Group) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20037Group) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20037Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20037Group(val *InlineResponse20037Group) *NullableInlineResponse20037Group {
	return &NullableInlineResponse20037Group{value: val, isSet: true}
}

func (v NullableInlineResponse20037Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20037Group) UnmarshalJSON(src []byte) error {
	v.isSet = true
