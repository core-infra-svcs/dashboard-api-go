...
// InlineResponse20046ConnectionStats The connection stats of the device
type InlineResponse20046ConnectionStats struct {
...
func NewInlineResponse20046ConnectionStats() *InlineResponse20046ConnectionStats {
	this := InlineResponse20046ConnectionStats{}
	return &this
}
...
func (o InlineResponse20046ConnectionStats) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20046ConnectionStats struct {
	value *InlineResponse20046ConnectionStats
	isSet bool
}

func (v NullableInlineResponse20046ConnectionStats) Get() *InlineResponse20046ConnectionStats {
	return v.value
}

func (v *NullableInlineResponse20046ConnectionStats) Set(val *InlineResponse20046ConnectionStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20046ConnectionStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20046ConnectionStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20046ConnectionStats(val *InlineResponse20046ConnectionStats) *NullableInlineResponse20046ConnectionStats {
	return &NullableInlineResponse20046ConnectionStats{value: val, isSet: true}
}

func (v NullableInlineResponse20046ConnectionStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20046ConnectionStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
