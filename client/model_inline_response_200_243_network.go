...
// InlineResponse200243Network The network upon which a client with the given MAC address was found
type InlineResponse200243Network struct {
...
func NewInlineResponse200243Network() *InlineResponse200243Network {
	this := InlineResponse200243Network{}
	return &this
}
...
func (o InlineResponse200243Network) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200243Network struct {
	value *InlineResponse200243Network
	isSet bool
}

func (v NullableInlineResponse200243Network) Get() *InlineResponse200243Network {
	return v.value
}

func (v *NullableInlineResponse200243Network) Set(val *InlineResponse200243Network) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200243Network) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200243Network) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200243Network(val *InlineResponse200243Network) *NullableInlineResponse200243Network {
	return &NullableInlineResponse200243Network{value: val, isSet: true}
}

func (v NullableInlineResponse200243Network) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200243Network) UnmarshalJSON(src []byte) error {
	v.isSet = true
