...
func (o *InlineObject240) GetStatus() string {
...
func (o *InlineObject240) GetStatusOk() (*string, bool) {
	if o == nil || isNil(o.Status) {
    return nil, false
	}
...
func (o *InlineObject240) HasStatus() bool {
	if o != nil && !isNil(o.Status) {
		return true
	}
...
func (o *InlineObject240) SetStatus(v string) {
	o.Status = &v
}
