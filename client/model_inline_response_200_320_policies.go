...
// InlineResponse200320Policies struct for InlineResponse200320Policies
type InlineResponse200320Policies struct {
...
func NewInlineResponse200320Policies() *InlineResponse200320Policies {
	this := InlineResponse200320Policies{}
	return &this
}
...
func (o InlineResponse200320Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200320Policies struct {
	value *InlineResponse200320Policies
	isSet bool
}

func (v NullableInlineResponse200320Policies) Get() *InlineResponse200320Policies {
	return v.value
}

func (v *NullableInlineResponse200320Policies) Set(val *InlineResponse200320Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200320Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200320Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200320Policies(val *InlineResponse200320Policies) *NullableInlineResponse200320Policies {
	return &NullableInlineResponse200320Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200320Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200320Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
