...
// InlineResponse200351MetaCountsItems Items
type InlineResponse200351MetaCountsItems struct {
...
func NewInlineResponse200351MetaCountsItems() *InlineResponse200351MetaCountsItems {
	this := InlineResponse200351MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200351MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200351MetaCountsItems struct {
	value *InlineResponse200351MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200351MetaCountsItems) Get() *InlineResponse200351MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200351MetaCountsItems) Set(val *InlineResponse200351MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200351MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200351MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200351MetaCountsItems(val *InlineResponse200351MetaCountsItems) *NullableInlineResponse200351MetaCountsItems {
	return &NullableInlineResponse200351MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200351MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200351MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
