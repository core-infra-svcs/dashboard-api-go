...
func (r ManufacturersApiGetOrganizationSummaryTopClientsManufacturersByUsageRequest) Execute() ([]InlineResponse200328, *http.Response, error) {
...
func (a *ManufacturersApiService) GetOrganizationSummaryTopClientsManufacturersByUsageExecute(r ManufacturersApiGetOrganizationSummaryTopClientsManufacturersByUsageRequest) ([]InlineResponse200328, *http.Response, error) {
	var (
