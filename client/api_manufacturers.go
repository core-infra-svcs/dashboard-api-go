...
func (r ManufacturersApiGetOrganizationSummaryTopClientsManufacturersByUsageRequest) Execute() ([]InlineResponse200171, *http.Response, error) {
...
func (a *ManufacturersApiService) GetOrganizationSummaryTopClientsManufacturersByUsageExecute(r ManufacturersApiGetOrganizationSummaryTopClientsManufacturersByUsageRequest) ([]InlineResponse200171, *http.Response, error) {
	var (
