...
func (r ManufacturersApiGetOrganizationSummaryTopClientsManufacturersByUsageRequest) Execute() ([]InlineResponse200155, *http.Response, error) {
...
func (a *ManufacturersApiService) GetOrganizationSummaryTopClientsManufacturersByUsageExecute(r ManufacturersApiGetOrganizationSummaryTopClientsManufacturersByUsageRequest) ([]InlineResponse200155, *http.Response, error) {
	var (
