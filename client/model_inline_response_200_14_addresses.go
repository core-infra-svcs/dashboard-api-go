...
// InlineResponse20014Addresses struct for InlineResponse20014Addresses
type InlineResponse20014Addresses struct {
...
func NewInlineResponse20014Addresses() *InlineResponse20014Addresses {
	this := InlineResponse20014Addresses{}
	return &this
}
...
func (o InlineResponse20014Addresses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20014Addresses struct {
	value *InlineResponse20014Addresses
	isSet bool
}

func (v NullableInlineResponse20014Addresses) Get() *InlineResponse20014Addresses {
	return v.value
}

func (v *NullableInlineResponse20014Addresses) Set(val *InlineResponse20014Addresses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20014Addresses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20014Addresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20014Addresses(val *InlineResponse20014Addresses) *NullableInlineResponse20014Addresses {
	return &NullableInlineResponse20014Addresses{value: val, isSet: true}
}

func (v NullableInlineResponse20014Addresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20014Addresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
