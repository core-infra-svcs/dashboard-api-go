...
// InlineResponse200164Overrides struct for InlineResponse200164Overrides
type InlineResponse200164Overrides struct {
...
// NewInlineResponse200164Overrides instantiates a new InlineResponse200164Overrides object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInlineResponse200164Overrides() *InlineResponse200164Overrides {
	this := InlineResponse200164Overrides{}
	return &this
}

// NewInlineResponse200164OverridesWithDefaults instantiates a new InlineResponse200164Overrides object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInlineResponse200164OverridesWithDefaults() *InlineResponse200164Overrides {
	this := InlineResponse200164Overrides{}
	return &this
}

// GetSwitches returns the Switches field value if set, zero value otherwise.
func (o *InlineResponse200164Overrides) GetSwitches() []string {
...
func (o *InlineResponse200164Overrides) GetSwitchesOk() ([]string, bool) {
	if o == nil || isNil(o.Switches) {
    return nil, false
	}
...
func (o *InlineResponse200164Overrides) HasSwitches() bool {
	if o != nil && !isNil(o.Switches) {
		return true
	}
...
func (o *InlineResponse200164Overrides) SetSwitches(v []string) {
	o.Switches = v
}

// GetStacks returns the Stacks field value if set, zero value otherwise.
func (o *InlineResponse200164Overrides) GetStacks() []string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200164Overrides) GetStacksOk() ([]string, bool) {
	if o == nil || isNil(o.Stacks) {
    return nil, false
	}
...
func (o *InlineResponse200164Overrides) HasStacks() bool {
	if o != nil && !isNil(o.Stacks) {
		return true
	}
...
func (o *InlineResponse200164Overrides) SetStacks(v []string) {
	o.Stacks = v
}

// GetSwitchProfiles returns the SwitchProfiles field value if set, zero value otherwise.
func (o *InlineResponse200164Overrides) GetSwitchProfiles() []string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200164Overrides) GetSwitchProfilesOk() ([]string, bool) {
	if o == nil || isNil(o.SwitchProfiles) {
    return nil, false
	}
...
func (o *InlineResponse200164Overrides) HasSwitchProfiles() bool {
	if o != nil && !isNil(o.SwitchProfiles) {
		return true
	}
...
func (o *InlineResponse200164Overrides) SetSwitchProfiles(v []string) {
	o.SwitchProfiles = v
}

// GetIgmpSnoopingEnabled returns the IgmpSnoopingEnabled field value if set, zero value otherwise.
func (o *InlineResponse200164Overrides) GetIgmpSnoopingEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200164Overrides) GetIgmpSnoopingEnabledOk() (*bool, bool) {
	if o == nil || isNil(o.IgmpSnoopingEnabled) {
    return nil, false
	}
...
func (o *InlineResponse200164Overrides) HasIgmpSnoopingEnabled() bool {
	if o != nil && !isNil(o.IgmpSnoopingEnabled) {
		return true
	}
...
func (o *InlineResponse200164Overrides) SetIgmpSnoopingEnabled(v bool) {
...
func (o *InlineResponse200164Overrides) GetFloodUnknownMulticastTrafficEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200164Overrides) GetFloodUnknownMulticastTrafficEnabledOk() (*bool, bool) {
	if o == nil || isNil(o.FloodUnknownMulticastTrafficEnabled) {
    return nil, false
	}
...
func (o *InlineResponse200164Overrides) HasFloodUnknownMulticastTrafficEnabled() bool {
	if o != nil && !isNil(o.FloodUnknownMulticastTrafficEnabled) {
		return true
	}
...
func (o *InlineResponse200164Overrides) SetFloodUnknownMulticastTrafficEnabled(v bool) {
	o.FloodUnknownMulticastTrafficEnabled = &v
}

func (o InlineResponse200164Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200164Overrides struct {
	value *InlineResponse200164Overrides
	isSet bool
}

func (v NullableInlineResponse200164Overrides) Get() *InlineResponse200164Overrides {
	return v.value
}

func (v *NullableInlineResponse200164Overrides) Set(val *InlineResponse200164Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200164Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200164Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200164Overrides(val *InlineResponse200164Overrides) *NullableInlineResponse200164Overrides {
	return &NullableInlineResponse200164Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse200164Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200164Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
