...
type InlineResponse20079 struct {
	...
	FailoverAndFailback *InlineResponse20079FailoverAndFailback `json:"failoverAndFailback,omitempty"`
	// Uplink preference rules for WAN traffic
	WanTrafficUplinkPreferences []InlineResponse20079WanTrafficUplinkPreferences `json:"wanTrafficUplinkPreferences,omitempty"`
	// Uplink preference rules for VPN traffic
	VpnTrafficUplinkPreferences []InlineResponse20079VpnTrafficUplinkPreferences `json:"vpnTrafficUplinkPreferences,omitempty"`
}
...
func (o *InlineResponse20079) GetFailoverAndFailback() InlineResponse20079FailoverAndFailback {
	if o == nil || isNil(o.FailoverAndFailback) {
		var ret InlineResponse20079FailoverAndFailback
		return ret
	}
...
// SetFailoverAndFailback gets a reference to the given InlineResponse20079FailoverAndFailback and assigns it to the FailoverAndFailback field.
...
func (o *InlineResponse20079) GetWanTrafficUplinkPreferences() []InlineResponse20079WanTrafficUplinkPreferences {
	if o == nil || isNil(o.WanTrafficUplinkPreferences) {
		var ret []InlineResponse20079WanTrafficUplinkPreferences
		return ret
	}
...
// SetWanTrafficUplinkPreferences gets a reference to the given []InlineResponse20079WanTrafficUplinkPreferences and assigns it to the WanTrafficUplinkPreferences field.
...
func (o *InlineResponse20079) GetVpnTrafficUplinkPreferences() []InlineResponse20079VpnTrafficUplinkPreferences {
	if o == nil || isNil(o.VpnTrafficUplinkPreferences) {
		var ret []InlineResponse20079VpnTrafficUplinkPreferences
		return ret
	}
...
// SetVpnTrafficUplinkPreferences gets a reference to the given []InlineResponse20079VpnTrafficUplinkPreferences and assigns it to the VpnTrafficUplinkPreferences field.
