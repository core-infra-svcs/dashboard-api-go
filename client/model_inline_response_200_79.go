...
type InlineResponse20079 struct {
	...
	Neighbors []InlineResponse20079Neighbors `json:"neighbors,omitempty"`
}
...
func (o *InlineResponse20079) GetNeighbors() []InlineResponse20079Neighbors {
	if o == nil || isNil(o.Neighbors) {
		var ret []InlineResponse20079Neighbors
		return ret
	}
	return o.Neighbors
}
...
// SetNeighbors gets a reference to the given []InlineResponse20079Neighbors and assigns it to the Neighbors field.
