...
type InlineResponse20079 struct {
	Alerts *InlineResponse20079Alerts `json:"alerts,omitempty"`
	...
	ArpInspection *InlineResponse20079ArpInspection `json:"arpInspection,omitempty"`
}
...
func (o *InlineResponse20079) GetAlerts() InlineResponse20079Alerts {
	if o == nil || isNil(o.Alerts) {
		var ret InlineResponse20079Alerts
		return ret
	}
	return *o.Alerts
}
...
// SetAlerts gets a reference to the given InlineResponse20079Alerts and assigns it to the Alerts field.
...
func (o *InlineResponse20079) GetArpInspection() InlineResponse20079ArpInspection {
	if o == nil || isNil(o.ArpInspection) {
		var ret InlineResponse20079ArpInspection
		return ret
	}
...
// SetArpInspection gets a reference to the given InlineResponse20079ArpInspection and assigns it to the ArpInspection field.
