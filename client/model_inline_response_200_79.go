...
type InlineResponse20079 struct {
	...
	ClientVpnConnections []InlineResponse20079ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20079) GetClientVpnConnections() []InlineResponse20079ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20079ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20079ClientVpnConnections and assigns it to the ClientVpnConnections field.
