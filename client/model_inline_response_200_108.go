...
type InlineResponse200108 struct {
	...
	RegulatoryDomain *InlineResponse200108RegulatoryDomain `json:"regulatoryDomain,omitempty"`
}
...
func (o *InlineResponse200108) GetRegulatoryDomain() InlineResponse200108RegulatoryDomain {
	if o == nil || isNil(o.RegulatoryDomain) {
		var ret InlineResponse200108RegulatoryDomain
		return ret
	}
...
// SetRegulatoryDomain gets a reference to the given InlineResponse200108RegulatoryDomain and assigns it to the RegulatoryDomain field.
