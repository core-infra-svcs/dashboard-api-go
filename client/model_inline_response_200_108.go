...
type InlineResponse200108 struct {
	...
	LocalStatusPage *InlineResponse200108LocalStatusPage `json:"localStatusPage,omitempty"`
	SecurePort *InlineResponse200108SecurePort `json:"securePort,omitempty"`
	Fips *InlineResponse200108Fips `json:"fips,omitempty"`
	NamedVlans *InlineResponse200108NamedVlans `json:"namedVlans,omitempty"`
}
...
func (o *InlineResponse200108) GetLocalStatusPage() InlineResponse200108LocalStatusPage {
	if o == nil || isNil(o.LocalStatusPage) {
		var ret InlineResponse200108LocalStatusPage
		return ret
	}
...
// SetLocalStatusPage gets a reference to the given InlineResponse200108LocalStatusPage and assigns it to the LocalStatusPage field.
...
func (o *InlineResponse200108) GetSecurePort() InlineResponse200108SecurePort {
	if o == nil || isNil(o.SecurePort) {
		var ret InlineResponse200108SecurePort
		return ret
	}
	return *o.SecurePort
}
...
// SetSecurePort gets a reference to the given InlineResponse200108SecurePort and assigns it to the SecurePort field.
...
func (o *InlineResponse200108) GetFips() InlineResponse200108Fips {
	if o == nil || isNil(o.Fips) {
		var ret InlineResponse200108Fips
		return ret
	}
	return *o.Fips
}
...
// SetFips gets a reference to the given InlineResponse200108Fips and assigns it to the Fips field.
...
func (o *InlineResponse200108) GetNamedVlans() InlineResponse200108NamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret InlineResponse200108NamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given InlineResponse200108NamedVlans and assigns it to the NamedVlans field.
