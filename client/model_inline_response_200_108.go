...
type InlineResponse200108 struct {
	...
	SplashLogo *InlineResponse200108SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200108SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200108SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200108GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200108Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200108SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200108SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200108) GetSplashLogo() InlineResponse200108SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200108SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200108SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200108) GetSplashImage() InlineResponse200108SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200108SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200108SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200108) GetSplashPrepaidFront() InlineResponse200108SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200108SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200108SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200108) GetGuestSponsorship() InlineResponse200108GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200108GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200108GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200108) GetBilling() InlineResponse200108Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200108Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200108Billing and assigns it to the Billing field.
...
func (o *InlineResponse200108) GetSentryEnrollment() InlineResponse200108SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200108SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200108SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200108) GetSelfRegistration() InlineResponse200108SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200108SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200108SelfRegistration and assigns it to the SelfRegistration field.
