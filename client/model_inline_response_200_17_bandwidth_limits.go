...
// InlineResponse20017BandwidthLimits A hash uplink keys and their configured settings for the Appliance
type InlineResponse20017BandwidthLimits struct {
	Wan1 *InlineResponse20017BandwidthLimitsWan1 `json:"wan1,omitempty"`
	Wan2 *InlineResponse20017BandwidthLimitsWan2 `json:"wan2,omitempty"`
	Cellular *InlineResponse20017BandwidthLimitsCellular `json:"cellular,omitempty"`
}
...
func NewInlineResponse20017BandwidthLimits() *InlineResponse20017BandwidthLimits {
	this := InlineResponse20017BandwidthLimits{}
	return &this
}
...
func (o *InlineResponse20017BandwidthLimits) GetWan1() InlineResponse20017BandwidthLimitsWan1 {
	if o == nil || isNil(o.Wan1) {
		var ret InlineResponse20017BandwidthLimitsWan1
		return ret
	}
	return *o.Wan1
}
...
// SetWan1 gets a reference to the given InlineResponse20017BandwidthLimitsWan1 and assigns it to the Wan1 field.
...
func (o *InlineResponse20017BandwidthLimits) GetWan2() InlineResponse20017BandwidthLimitsWan2 {
	if o == nil || isNil(o.Wan2) {
		var ret InlineResponse20017BandwidthLimitsWan2
		return ret
	}
	return *o.Wan2
}
...
// SetWan2 gets a reference to the given InlineResponse20017BandwidthLimitsWan2 and assigns it to the Wan2 field.
...
func (o *InlineResponse20017BandwidthLimits) GetCellular() InlineResponse20017BandwidthLimitsCellular {
	if o == nil || isNil(o.Cellular) {
		var ret InlineResponse20017BandwidthLimitsCellular
		return ret
	}
	return *o.Cellular
}
...
// SetCellular gets a reference to the given InlineResponse20017BandwidthLimitsCellular and assigns it to the Cellular field.
func (o *InlineResponse20017BandwidthLimits) SetCellular(v InlineResponse20017BandwidthLimitsCellular) {
	o.Cellular = &v
}

func (o InlineResponse20017BandwidthLimits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20017BandwidthLimits struct {
	value *InlineResponse20017BandwidthLimits
	isSet bool
}

func (v NullableInlineResponse20017BandwidthLimits) Get() *InlineResponse20017BandwidthLimits {
	return v.value
}

func (v *NullableInlineResponse20017BandwidthLimits) Set(val *InlineResponse20017BandwidthLimits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20017BandwidthLimits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20017BandwidthLimits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20017BandwidthLimits(val *InlineResponse20017BandwidthLimits) *NullableInlineResponse20017BandwidthLimits {
	return &NullableInlineResponse20017BandwidthLimits{value: val, isSet: true}
}

func (v NullableInlineResponse20017BandwidthLimits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20017BandwidthLimits) UnmarshalJSON(src []byte) error {
	v.isSet = true
