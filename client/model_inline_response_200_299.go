...
type InlineResponse200299 struct {
	...
	RemainderLicenses []InlineResponse200298 `json:"remainderLicenses,omitempty"`
	// Newly moved licenses created in the destination organization of the license move operation
	MovedLicenses []InlineResponse200298 `json:"movedLicenses,omitempty"`
}
...
// SetRemainderLicenses gets a reference to the given []InlineResponse200298 and assigns it to the RemainderLicenses field.
...
// SetMovedLicenses gets a reference to the given []InlineResponse200298 and assigns it to the MovedLicenses field.
