...
// InlineResponse200179Plans struct for InlineResponse200179Plans
type InlineResponse200179Plans struct {
	// The id of the pricing plan to update.
	Id *string `json:"id,omitempty"`
	// The price of the billing plan.
	Price *float32 `json:"price,omitempty"`
	BandwidthLimits *InlineResponse200179BandwidthLimits `json:"bandwidthLimits,omitempty"`
...
func NewInlineResponse200179Plans() *InlineResponse200179Plans {
	this := InlineResponse200179Plans{}
	return &this
}
...
func (o *InlineResponse200179Plans) GetBandwidthLimits() InlineResponse200179BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse200179BandwidthLimits
		return ret
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse200179BandwidthLimits and assigns it to the BandwidthLimits field.
...
func (o InlineResponse200179Plans) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200179Plans struct {
	value *InlineResponse200179Plans
	isSet bool
}

func (v NullableInlineResponse200179Plans) Get() *InlineResponse200179Plans {
	return v.value
}

func (v *NullableInlineResponse200179Plans) Set(val *InlineResponse200179Plans) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200179Plans) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200179Plans) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200179Plans(val *InlineResponse200179Plans) *NullableInlineResponse200179Plans {
	return &NullableInlineResponse200179Plans{value: val, isSet: true}
}

func (v NullableInlineResponse200179Plans) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200179Plans) UnmarshalJSON(src []byte) error {
	v.isSet = true
