...
// InlineResponse200280Schedule Schedule of the packet capture
type InlineResponse200280Schedule struct {
...
func NewInlineResponse200280Schedule() *InlineResponse200280Schedule {
	this := InlineResponse200280Schedule{}
	return &this
}
...
func (o InlineResponse200280Schedule) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200280Schedule struct {
	value *InlineResponse200280Schedule
	isSet bool
}

func (v NullableInlineResponse200280Schedule) Get() *InlineResponse200280Schedule {
	return v.value
}

func (v *NullableInlineResponse200280Schedule) Set(val *InlineResponse200280Schedule) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200280Schedule) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200280Schedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200280Schedule(val *InlineResponse200280Schedule) *NullableInlineResponse200280Schedule {
	return &NullableInlineResponse200280Schedule{value: val, isSet: true}
}

func (v NullableInlineResponse200280Schedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200280Schedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
