...
func (r BySwitchApiApiGetOrganizationSwitchPortsBySwitchRequest) Execute() ([]InlineResponse20098, *_nethttp.Response, error) {
...
func (a *BySwitchApiService) GetOrganizationSwitchPortsBySwitchExecute(r BySwitchApiApiGetOrganizationSwitchPortsBySwitchRequest) ([]InlineResponse20098, *_nethttp.Response, error) {
	var (
