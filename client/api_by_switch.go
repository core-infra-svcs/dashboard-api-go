...
func (r BySwitchApiGetOrganizationSwitchPortsBySwitchRequest) Execute() (*InlineResponse200340, *http.Response, error) {
...
func (a *BySwitchApiService) GetOrganizationSwitchPortsBySwitchExecute(r BySwitchApiGetOrganizationSwitchPortsBySwitchRequest) (*InlineResponse200340, *http.Response, error) {
	var (
...
func (r BySwitchApiGetOrganizationSwitchPortsStatusesBySwitchRequest) Execute() (*InlineResponse200343, *http.Response, error) {
...
func (a *BySwitchApiService) GetOrganizationSwitchPortsStatusesBySwitchExecute(r BySwitchApiGetOrganizationSwitchPortsStatusesBySwitchRequest) (*InlineResponse200343, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
