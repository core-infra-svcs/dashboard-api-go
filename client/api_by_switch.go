...
func (r BySwitchApiGetOrganizationSwitchPortsBySwitchRequest) Execute() ([]InlineResponse200171, *http.Response, error) {
...
func (a *BySwitchApiService) GetOrganizationSwitchPortsBySwitchExecute(r BySwitchApiGetOrganizationSwitchPortsBySwitchRequest) ([]InlineResponse200171, *http.Response, error) {
	var (
