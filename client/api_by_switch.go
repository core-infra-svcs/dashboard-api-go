...
func (r BySwitchApiGetOrganizationSwitchPortsBySwitchRequest) Execute() (*InlineResponse200353, *http.Response, error) {
...
func (a *BySwitchApiService) GetOrganizationSwitchPortsBySwitchExecute(r BySwitchApiGetOrganizationSwitchPortsBySwitchRequest) (*InlineResponse200353, *http.Response, error) {
	var (
...
func (r BySwitchApiGetOrganizationSwitchPortsStatusesBySwitchRequest) Execute() (*InlineResponse200356, *http.Response, error) {
...
func (a *BySwitchApiService) GetOrganizationSwitchPortsStatusesBySwitchExecute(r BySwitchApiGetOrganizationSwitchPortsStatusesBySwitchRequest) (*InlineResponse200356, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
