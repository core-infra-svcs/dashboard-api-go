...
func (r BySwitchApiGetOrganizationSwitchPortsBySwitchRequest) Execute() ([]InlineResponse200291, *http.Response, error) {
...
func (a *BySwitchApiService) GetOrganizationSwitchPortsBySwitchExecute(r BySwitchApiGetOrganizationSwitchPortsBySwitchRequest) ([]InlineResponse200291, *http.Response, error) {
	var (
