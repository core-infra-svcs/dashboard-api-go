...
func (r BySwitchApiApiGetOrganizationSwitchPortsBySwitchRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *BySwitchApiService) GetOrganizationSwitchPortsBySwitch(ctx context.Context, organizationId string) BySwitchApiApiGetOrganizationSwitchPortsBySwitchRequest {
	return BySwitchApiApiGetOrganizationSwitchPortsBySwitchRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *BySwitchApiService) GetOrganizationSwitchPortsBySwitchExecute(r BySwitchApiApiGetOrganizationSwitchPortsBySwitchRequest) (map[string]interface{}, *http.Response, error) {
	var (
