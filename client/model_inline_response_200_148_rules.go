...
// InlineResponse200148Rules struct for InlineResponse200148Rules
type InlineResponse200148Rules struct {
...
func NewInlineResponse200148Rules() *InlineResponse200148Rules {
	this := InlineResponse200148Rules{}
	return &this
}
...
func (o InlineResponse200148Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200148Rules struct {
	value *InlineResponse200148Rules
	isSet bool
}

func (v NullableInlineResponse200148Rules) Get() *InlineResponse200148Rules {
	return v.value
}

func (v *NullableInlineResponse200148Rules) Set(val *InlineResponse200148Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200148Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200148Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200148Rules(val *InlineResponse200148Rules) *NullableInlineResponse200148Rules {
	return &NullableInlineResponse200148Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200148Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200148Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
