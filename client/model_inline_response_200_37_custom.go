...
// InlineResponse20037Custom struct for InlineResponse20037Custom
type InlineResponse20037Custom struct {
	// Protocol.
...
func NewInlineResponse20037Custom(protocol string, destination string, port string) *InlineResponse20037Custom {
	this := InlineResponse20037Custom{}
...
func (o InlineResponse20037Custom) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20037Custom struct {
	value *InlineResponse20037Custom
	isSet bool
}

func (v NullableInlineResponse20037Custom) Get() *InlineResponse20037Custom {
	return v.value
}

func (v *NullableInlineResponse20037Custom) Set(val *InlineResponse20037Custom) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20037Custom) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20037Custom) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20037Custom(val *InlineResponse20037Custom) *NullableInlineResponse20037Custom {
	return &NullableInlineResponse20037Custom{value: val, isSet: true}
}

func (v NullableInlineResponse20037Custom) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20037Custom) UnmarshalJSON(src []byte) error {
	v.isSet = true
