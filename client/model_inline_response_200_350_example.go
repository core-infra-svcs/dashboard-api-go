...
// InlineResponse200350Example Example alert type
type InlineResponse200350Example struct {
...
func NewInlineResponse200350Example() *InlineResponse200350Example {
	this := InlineResponse200350Example{}
	return &this
}
...
func (o InlineResponse200350Example) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200350Example struct {
	value *InlineResponse200350Example
	isSet bool
}

func (v NullableInlineResponse200350Example) Get() *InlineResponse200350Example {
	return v.value
}

func (v *NullableInlineResponse200350Example) Set(val *InlineResponse200350Example) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200350Example) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200350Example) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200350Example(val *InlineResponse200350Example) *NullableInlineResponse200350Example {
	return &NullableInlineResponse200350Example{value: val, isSet: true}
}

func (v NullableInlineResponse200350Example) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200350Example) UnmarshalJSON(src []byte) error {
	v.isSet = true
