...
// InlineResponse20051Filters A hash of specific configuration data for the alert. Only filters specific to the alert will be updated.
type InlineResponse20051Filters struct {
	// Conditions
	Conditions []InlineResponse20051FiltersConditions `json:"conditions,omitempty"`
	// Failure Type
...
func NewInlineResponse20051Filters() *InlineResponse20051Filters {
	this := InlineResponse20051Filters{}
	return &this
}
...
func (o *InlineResponse20051Filters) GetConditions() []InlineResponse20051FiltersConditions {
	if o == nil || isNil(o.Conditions) {
		var ret []InlineResponse20051FiltersConditions
		return ret
	}
	return o.Conditions
}
...
// SetConditions gets a reference to the given []InlineResponse20051FiltersConditions and assigns it to the Conditions field.
...
func (o InlineResponse20051Filters) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20051Filters struct {
	value *InlineResponse20051Filters
	isSet bool
}

func (v NullableInlineResponse20051Filters) Get() *InlineResponse20051Filters {
	return v.value
}

func (v *NullableInlineResponse20051Filters) Set(val *InlineResponse20051Filters) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20051Filters) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20051Filters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20051Filters(val *InlineResponse20051Filters) *NullableInlineResponse20051Filters {
	return &NullableInlineResponse20051Filters{value: val, isSet: true}
}

func (v NullableInlineResponse20051Filters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20051Filters) UnmarshalJSON(src []byte) error {
	v.isSet = true
