...
// InlineResponse200259StatesUnusedActive Data for unused, active licenses
type InlineResponse200259StatesUnusedActive struct {
	// The number of unused, active licenses
	Count *int32 `json:"count,omitempty"`
	OldestActivation *InlineResponse200259StatesUnusedActiveOldestActivation `json:"oldestActivation,omitempty"`
}
...
func NewInlineResponse200259StatesUnusedActive() *InlineResponse200259StatesUnusedActive {
	this := InlineResponse200259StatesUnusedActive{}
	return &this
}
...
func (o *InlineResponse200259StatesUnusedActive) GetOldestActivation() InlineResponse200259StatesUnusedActiveOldestActivation {
	if o == nil || isNil(o.OldestActivation) {
		var ret InlineResponse200259StatesUnusedActiveOldestActivation
		return ret
	}
...
// SetOldestActivation gets a reference to the given InlineResponse200259StatesUnusedActiveOldestActivation and assigns it to the OldestActivation field.
...
func (o InlineResponse200259StatesUnusedActive) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200259StatesUnusedActive struct {
	value *InlineResponse200259StatesUnusedActive
	isSet bool
}

func (v NullableInlineResponse200259StatesUnusedActive) Get() *InlineResponse200259StatesUnusedActive {
	return v.value
}

func (v *NullableInlineResponse200259StatesUnusedActive) Set(val *InlineResponse200259StatesUnusedActive) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200259StatesUnusedActive) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200259StatesUnusedActive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200259StatesUnusedActive(val *InlineResponse200259StatesUnusedActive) *NullableInlineResponse200259StatesUnusedActive {
	return &NullableInlineResponse200259StatesUnusedActive{value: val, isSet: true}
}

func (v NullableInlineResponse200259StatesUnusedActive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200259StatesUnusedActive) UnmarshalJSON(src []byte) error {
	v.isSet = true
