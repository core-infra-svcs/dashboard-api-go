...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse20054, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse20054, *http.Response, error) {
	var (
