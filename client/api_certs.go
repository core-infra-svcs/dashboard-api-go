...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse200125, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse200125, *http.Response, error) {
	var (
