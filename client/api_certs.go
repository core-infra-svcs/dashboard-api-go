...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse20047, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse20047, *http.Response, error) {
	var (
