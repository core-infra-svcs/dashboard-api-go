...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse20059, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse20059, *http.Response, error) {
	var (
