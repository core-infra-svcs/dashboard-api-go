...
func (r CertsApiApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse20031, *_nethttp.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse20031, *_nethttp.Response, error) {
	var (
