...
type CertsApiApiGetNetworkSmDeviceCertsRequest struct {
...
func (r CertsApiApiGetNetworkSmDeviceCertsRequest) Execute() ([]map[string]interface{}, *_nethttp.Response, error) {
...
List the certs on a device
 ...
 @param networkId
 @param deviceId
 @return CertsApiApiGetNetworkSmDeviceCertsRequest
*/
func (a *CertsApiService) GetNetworkSmDeviceCerts(ctx _context.Context, networkId string, deviceId string) CertsApiApiGetNetworkSmDeviceCertsRequest {
	return CertsApiApiGetNetworkSmDeviceCertsRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiApiGetNetworkSmDeviceCertsRequest) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
