...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse200128, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse200128, *http.Response, error) {
	var (
