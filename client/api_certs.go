...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse20062, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse20062, *http.Response, error) {
	var (
