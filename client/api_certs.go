...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse20041, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse20041, *http.Response, error) {
	var (
