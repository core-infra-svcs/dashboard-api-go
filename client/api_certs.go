...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse200130, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse200130, *http.Response, error) {
	var (
