...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse20066, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse20066, *http.Response, error) {
	var (
