...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse20039, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse20039, *http.Response, error) {
	var (
