...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse200124, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse200124, *http.Response, error) {
	var (
