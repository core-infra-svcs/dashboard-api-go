...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse200117, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse200117, *http.Response, error) {
	var (
