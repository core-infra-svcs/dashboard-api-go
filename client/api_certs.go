...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse20060, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse20060, *http.Response, error) {
	var (
