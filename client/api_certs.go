...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse20058, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse20058, *http.Response, error) {
	var (
