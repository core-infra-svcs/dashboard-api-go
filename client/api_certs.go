...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse200119, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse200119, *http.Response, error) {
	var (
