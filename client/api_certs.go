...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse200129, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse200129, *http.Response, error) {
	var (
