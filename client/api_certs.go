...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse200120, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse200120, *http.Response, error) {
	var (
