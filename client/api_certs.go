...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse200131, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse200131, *http.Response, error) {
	var (
