...
// InlineResponse200255Terms Service provider terms.
type InlineResponse200255Terms struct {
...
func NewInlineResponse200255Terms() *InlineResponse200255Terms {
	this := InlineResponse200255Terms{}
	return &this
}
...
func (o InlineResponse200255Terms) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200255Terms struct {
	value *InlineResponse200255Terms
	isSet bool
}

func (v NullableInlineResponse200255Terms) Get() *InlineResponse200255Terms {
	return v.value
}

func (v *NullableInlineResponse200255Terms) Set(val *InlineResponse200255Terms) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200255Terms) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200255Terms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200255Terms(val *InlineResponse200255Terms) *NullableInlineResponse200255Terms {
	return &NullableInlineResponse200255Terms{value: val, isSet: true}
}

func (v NullableInlineResponse200255Terms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200255Terms) UnmarshalJSON(src []byte) error {
	v.isSet = true
