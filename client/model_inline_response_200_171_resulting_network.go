...
// InlineResponse200171ResultingNetwork Network after the combination
type InlineResponse200171ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200171ResultingNetwork() *InlineResponse200171ResultingNetwork {
	this := InlineResponse200171ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200171ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200171ResultingNetwork struct {
	value *InlineResponse200171ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200171ResultingNetwork) Get() *InlineResponse200171ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200171ResultingNetwork) Set(val *InlineResponse200171ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200171ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200171ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200171ResultingNetwork(val *InlineResponse200171ResultingNetwork) *NullableInlineResponse200171ResultingNetwork {
	return &NullableInlineResponse200171ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200171ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200171ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
