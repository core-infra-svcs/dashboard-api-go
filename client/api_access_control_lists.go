...
func (r AccessControlListsApiGetNetworkSwitchAccessControlListsRequest) Execute() (*InlineResponse20073, *http.Response, error) {
...
func (a *AccessControlListsApiService) GetNetworkSwitchAccessControlListsExecute(r AccessControlListsApiGetNetworkSwitchAccessControlListsRequest) (*InlineResponse20073, *http.Response, error) {
	var (
...
func (r AccessControlListsApiUpdateNetworkSwitchAccessControlListsRequest) UpdateNetworkSwitchAccessControlLists(updateNetworkSwitchAccessControlLists InlineObject116) AccessControlListsApiUpdateNetworkSwitchAccessControlListsRequest {
	r.updateNetworkSwitchAccessControlLists = &updateNetworkSwitchAccessControlLists
	return r
}

func (r AccessControlListsApiUpdateNetworkSwitchAccessControlListsRequest) Execute() (*InlineResponse20073, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20073
func (a *AccessControlListsApiService) UpdateNetworkSwitchAccessControlListsExecute(r AccessControlListsApiUpdateNetworkSwitchAccessControlListsRequest) (*InlineResponse20073, *http.Response, error) {
	var (
