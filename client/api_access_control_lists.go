...
func (r AccessControlListsApiGetNetworkSwitchAccessControlListsRequest) Execute() (*InlineResponse200149, *http.Response, error) {
...
func (a *AccessControlListsApiService) GetNetworkSwitchAccessControlListsExecute(r AccessControlListsApiGetNetworkSwitchAccessControlListsRequest) (*InlineResponse200149, *http.Response, error) {
	var (
...
func (r AccessControlListsApiUpdateNetworkSwitchAccessControlListsRequest) UpdateNetworkSwitchAccessControlLists(updateNetworkSwitchAccessControlLists InlineObject134) AccessControlListsApiUpdateNetworkSwitchAccessControlListsRequest {
	r.updateNetworkSwitchAccessControlLists = &updateNetworkSwitchAccessControlLists
	return r
}

func (r AccessControlListsApiUpdateNetworkSwitchAccessControlListsRequest) Execute() (*InlineResponse200149, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200149
func (a *AccessControlListsApiService) UpdateNetworkSwitchAccessControlListsExecute(r AccessControlListsApiUpdateNetworkSwitchAccessControlListsRequest) (*InlineResponse200149, *http.Response, error) {
	var (
