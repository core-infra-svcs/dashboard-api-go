...
// InlineResponse200233Counts counts
type InlineResponse200233Counts struct {
	ByStatus *InlineResponse200233CountsByStatus `json:"byStatus,omitempty"`
}
...
func (o *InlineResponse200233Counts) GetByStatus() InlineResponse200233CountsByStatus {
	if o == nil || isNil(o.ByStatus) {
		var ret InlineResponse200233CountsByStatus
		return ret
	}
	return *o.ByStatus
}
...
// SetByStatus gets a reference to the given InlineResponse200233CountsByStatus and assigns it to the ByStatus field.
