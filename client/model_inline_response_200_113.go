...
type InlineResponse200113 struct {
	...
	Devices []InlineResponse200105 `json:"devices,omitempty"`
...
// SetDevices gets a reference to the given []InlineResponse200105 and assigns it to the Devices field.
