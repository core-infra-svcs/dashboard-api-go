...
// InlineResponse20050FiltersConditions struct for InlineResponse20050FiltersConditions
type InlineResponse20050FiltersConditions struct {
	// Type of condition
...
func NewInlineResponse20050FiltersConditions() *InlineResponse20050FiltersConditions {
	this := InlineResponse20050FiltersConditions{}
	return &this
}
...
func (o InlineResponse20050FiltersConditions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20050FiltersConditions struct {
	value *InlineResponse20050FiltersConditions
	isSet bool
}

func (v NullableInlineResponse20050FiltersConditions) Get() *InlineResponse20050FiltersConditions {
	return v.value
}

func (v *NullableInlineResponse20050FiltersConditions) Set(val *InlineResponse20050FiltersConditions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20050FiltersConditions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20050FiltersConditions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20050FiltersConditions(val *InlineResponse20050FiltersConditions) *NullableInlineResponse20050FiltersConditions {
	return &NullableInlineResponse20050FiltersConditions{value: val, isSet: true}
}

func (v NullableInlineResponse20050FiltersConditions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20050FiltersConditions) UnmarshalJSON(src []byte) error {
	v.isSet = true
