...
type HistoryApiApiGetNetworkAlertsHistoryRequest struct {
	ctx _context.Context
	ApiService *HistoryApiService
	networkId string
	perPage *int32
...
func (r HistoryApiApiGetNetworkAlertsHistoryRequest) PerPage(perPage int32) HistoryApiApiGetNetworkAlertsHistoryRequest {
	r.perPage = &perPage
	return r
}
// A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r HistoryApiApiGetNetworkAlertsHistoryRequest) StartingAfter(startingAfter string) HistoryApiApiGetNetworkAlertsHistoryRequest {
	r.startingAfter = &startingAfter
	return r
}
// A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r HistoryApiApiGetNetworkAlertsHistoryRequest) EndingBefore(endingBefore string) HistoryApiApiGetNetworkAlertsHistoryRequest {
	r.endingBefore = &endingBefore
	return r
}

func (r HistoryApiApiGetNetworkAlertsHistoryRequest) Execute() ([]InlineResponse2008, *_nethttp.Response, error) {
...
Return the alert history for this network
 ...
 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param networkId
 @return HistoryApiApiGetNetworkAlertsHistoryRequest
*/
func (a *HistoryApiService) GetNetworkAlertsHistory(ctx _context.Context, networkId string) HistoryApiApiGetNetworkAlertsHistoryRequest {
	return HistoryApiApiGetNetworkAlertsHistoryRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *HistoryApiService) GetNetworkAlertsHistoryExecute(r HistoryApiApiGetNetworkAlertsHistoryRequest) ([]InlineResponse2008, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r HistoryApiApiGetOrganizationSensorReadingsHistoryRequest) Execute() ([]InlineResponse20087, *_nethttp.Response, error) {
...
func (a *HistoryApiService) GetOrganizationSensorReadingsHistoryExecute(r HistoryApiApiGetOrganizationSensorReadingsHistoryRequest) ([]InlineResponse20087, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
