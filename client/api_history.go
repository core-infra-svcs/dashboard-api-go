...
func (r HistoryApiGetNetworkAlertsHistoryRequest) Execute() ([]InlineResponse2008, *http.Response, error) {
...
func (a *HistoryApiService) GetNetworkAlertsHistoryExecute(r HistoryApiGetNetworkAlertsHistoryRequest) ([]InlineResponse2008, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r HistoryApiGetOrganizationSensorReadingsHistoryRequest) Execute() ([]InlineResponse200107, *http.Response, error) {
...
func (a *HistoryApiService) GetOrganizationSensorReadingsHistoryExecute(r HistoryApiGetOrganizationSensorReadingsHistoryRequest) ([]InlineResponse200107, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
