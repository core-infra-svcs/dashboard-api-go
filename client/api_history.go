...
func (r HistoryApiGetOrganizationSensorReadingsHistoryRequest) Execute() ([]InlineResponse20097, *http.Response, error) {
...
func (a *HistoryApiService) GetOrganizationSensorReadingsHistoryExecute(r HistoryApiGetOrganizationSensorReadingsHistoryRequest) ([]InlineResponse20097, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
