...
func (r HistoryApiGetNetworkAlertsHistoryRequest) Execute() ([]InlineResponse20011, *http.Response, error) {
...
func (a *HistoryApiService) GetNetworkAlertsHistoryExecute(r HistoryApiGetNetworkAlertsHistoryRequest) ([]InlineResponse20011, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r HistoryApiGetOrganizationSensorReadingsHistoryRequest) Execute() ([]InlineResponse200123, *http.Response, error) {
...
func (a *HistoryApiService) GetOrganizationSensorReadingsHistoryExecute(r HistoryApiGetOrganizationSensorReadingsHistoryRequest) ([]InlineResponse200123, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
