...
// InlineResponse200111CountsNoise Object containing the number of sensors that are currently alerting due to noise readings
type InlineResponse200111CountsNoise struct {
...
func NewInlineResponse200111CountsNoise() *InlineResponse200111CountsNoise {
	this := InlineResponse200111CountsNoise{}
	return &this
}
...
func (o InlineResponse200111CountsNoise) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200111CountsNoise struct {
	value *InlineResponse200111CountsNoise
	isSet bool
}

func (v NullableInlineResponse200111CountsNoise) Get() *InlineResponse200111CountsNoise {
	return v.value
}

func (v *NullableInlineResponse200111CountsNoise) Set(val *InlineResponse200111CountsNoise) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200111CountsNoise) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200111CountsNoise) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200111CountsNoise(val *InlineResponse200111CountsNoise) *NullableInlineResponse200111CountsNoise {
	return &NullableInlineResponse200111CountsNoise{value: val, isSet: true}
}

func (v NullableInlineResponse200111CountsNoise) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200111CountsNoise) UnmarshalJSON(src []byte) error {
	v.isSet = true
