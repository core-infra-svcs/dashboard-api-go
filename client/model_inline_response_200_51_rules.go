...
// InlineResponse20051Rules struct for InlineResponse20051Rules
type InlineResponse20051Rules struct {
...
func (o InlineResponse20051Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20051Rules struct {
	value *InlineResponse20051Rules
	isSet bool
}

func (v NullableInlineResponse20051Rules) Get() *InlineResponse20051Rules {
	return v.value
}

func (v *NullableInlineResponse20051Rules) Set(val *InlineResponse20051Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20051Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20051Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20051Rules(val *InlineResponse20051Rules) *NullableInlineResponse20051Rules {
	return &NullableInlineResponse20051Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20051Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20051Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
