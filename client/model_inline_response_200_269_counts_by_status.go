...
// InlineResponse200269CountsByStatus byStatus
type InlineResponse200269CountsByStatus struct {
	// online count
...
func NewInlineResponse200269CountsByStatus() *InlineResponse200269CountsByStatus {
	this := InlineResponse200269CountsByStatus{}
	return &this
}
...
func (o InlineResponse200269CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200269CountsByStatus struct {
	value *InlineResponse200269CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200269CountsByStatus) Get() *InlineResponse200269CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200269CountsByStatus) Set(val *InlineResponse200269CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200269CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200269CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200269CountsByStatus(val *InlineResponse200269CountsByStatus) *NullableInlineResponse200269CountsByStatus {
	return &NullableInlineResponse200269CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200269CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200269CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
