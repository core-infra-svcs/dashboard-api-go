...
func (r SubnetPoolApiGetNetworkCellularGatewaySubnetPoolRequest) Execute() (*InlineResponse20084, *http.Response, error) {
...
func (a *SubnetPoolApiService) GetNetworkCellularGatewaySubnetPoolExecute(r SubnetPoolApiGetNetworkCellularGatewaySubnetPoolRequest) (*InlineResponse20084, *http.Response, error) {
	var (
...
func (r SubnetPoolApiUpdateNetworkCellularGatewaySubnetPoolRequest) Execute() (*InlineResponse20084, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20084
func (a *SubnetPoolApiService) UpdateNetworkCellularGatewaySubnetPoolExecute(r SubnetPoolApiUpdateNetworkCellularGatewaySubnetPoolRequest) (*InlineResponse20084, *http.Response, error) {
	var (
