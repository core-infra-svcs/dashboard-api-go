...
func (r SubnetPoolApiGetNetworkCellularGatewaySubnetPoolRequest) Execute() (*InlineResponse20088, *http.Response, error) {
...
func (a *SubnetPoolApiService) GetNetworkCellularGatewaySubnetPoolExecute(r SubnetPoolApiGetNetworkCellularGatewaySubnetPoolRequest) (*InlineResponse20088, *http.Response, error) {
	var (
...
func (r SubnetPoolApiUpdateNetworkCellularGatewaySubnetPoolRequest) Execute() (*InlineResponse20088, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20088
func (a *SubnetPoolApiService) UpdateNetworkCellularGatewaySubnetPoolExecute(r SubnetPoolApiUpdateNetworkCellularGatewaySubnetPoolRequest) (*InlineResponse20088, *http.Response, error) {
	var (
