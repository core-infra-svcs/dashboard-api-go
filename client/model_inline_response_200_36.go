...
type InlineResponse20036 struct {
	...
	ClientVpnConnections []InlineResponse20036ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20036) GetClientVpnConnections() []InlineResponse20036ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20036ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20036ClientVpnConnections and assigns it to the ClientVpnConnections field.
