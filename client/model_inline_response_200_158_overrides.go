...
// InlineResponse200158Overrides struct for InlineResponse200158Overrides
type InlineResponse200158Overrides struct {
...
func NewInlineResponse200158Overrides() *InlineResponse200158Overrides {
	this := InlineResponse200158Overrides{}
	return &this
}
...
func (o InlineResponse200158Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200158Overrides struct {
	value *InlineResponse200158Overrides
	isSet bool
}

func (v NullableInlineResponse200158Overrides) Get() *InlineResponse200158Overrides {
	return v.value
}

func (v *NullableInlineResponse200158Overrides) Set(val *InlineResponse200158Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200158Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200158Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200158Overrides(val *InlineResponse200158Overrides) *NullableInlineResponse200158Overrides {
	return &NullableInlineResponse200158Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse200158Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200158Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
