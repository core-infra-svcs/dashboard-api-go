...
// InlineResponse200276Schedule Schedule of the packet capture
type InlineResponse200276Schedule struct {
...
func NewInlineResponse200276Schedule() *InlineResponse200276Schedule {
	this := InlineResponse200276Schedule{}
	return &this
}
...
func (o InlineResponse200276Schedule) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200276Schedule struct {
	value *InlineResponse200276Schedule
	isSet bool
}

func (v NullableInlineResponse200276Schedule) Get() *InlineResponse200276Schedule {
	return v.value
}

func (v *NullableInlineResponse200276Schedule) Set(val *InlineResponse200276Schedule) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200276Schedule) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200276Schedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200276Schedule(val *InlineResponse200276Schedule) *NullableInlineResponse200276Schedule {
	return &NullableInlineResponse200276Schedule{value: val, isSet: true}
}

func (v NullableInlineResponse200276Schedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200276Schedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
