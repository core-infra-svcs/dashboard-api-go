...
// InlineResponse200397Wifi MQTT Wi-Fi Settings for network
type InlineResponse200397Wifi struct {
	// Wi-Fi Enabled
	Enabled *bool `json:"enabled,omitempty"`
	// Wi-Fi client type. Valid types are: visible, associated
	Type *string `json:"type,omitempty"`
	Flush *InlineResponse200397WifiFlush `json:"flush,omitempty"`
	AllowLists *InlineResponse200397WifiAllowLists `json:"allowLists,omitempty"`
	Hysteresis *InlineResponse200397WifiHysteresis `json:"hysteresis,omitempty"`
}
...
func (o *InlineResponse200397Wifi) GetFlush() InlineResponse200397WifiFlush {
	if o == nil || isNil(o.Flush) {
		var ret InlineResponse200397WifiFlush
		return ret
	}
	return *o.Flush
}
...
// SetFlush gets a reference to the given InlineResponse200397WifiFlush and assigns it to the Flush field.
...
func (o *InlineResponse200397Wifi) GetAllowLists() InlineResponse200397WifiAllowLists {
	if o == nil || isNil(o.AllowLists) {
		var ret InlineResponse200397WifiAllowLists
		return ret
	}
	return *o.AllowLists
}
...
// SetAllowLists gets a reference to the given InlineResponse200397WifiAllowLists and assigns it to the AllowLists field.
...
func (o *InlineResponse200397Wifi) GetHysteresis() InlineResponse200397WifiHysteresis {
	if o == nil || isNil(o.Hysteresis) {
		var ret InlineResponse200397WifiHysteresis
		return ret
	}
	return *o.Hysteresis
}
...
// SetHysteresis gets a reference to the given InlineResponse200397WifiHysteresis and assigns it to the Hysteresis field.
func (o *InlineResponse200397Wifi) SetHysteresis(v InlineResponse200397WifiHysteresis) {
	o.Hysteresis = &v
}

func (o InlineResponse200397Wifi) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200397Wifi struct {
	value *InlineResponse200397Wifi
	isSet bool
}

func (v NullableInlineResponse200397Wifi) Get() *InlineResponse200397Wifi {
	return v.value
}

func (v *NullableInlineResponse200397Wifi) Set(val *InlineResponse200397Wifi) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200397Wifi) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200397Wifi) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200397Wifi(val *InlineResponse200397Wifi) *NullableInlineResponse200397Wifi {
	return &NullableInlineResponse200397Wifi{value: val, isSet: true}
}

func (v NullableInlineResponse200397Wifi) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200397Wifi) UnmarshalJSON(src []byte) error {
	v.isSet = true
