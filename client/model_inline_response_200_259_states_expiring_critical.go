...
// InlineResponse200259StatesExpiringCritical Data for the critical threshold
type InlineResponse200259StatesExpiringCritical struct {
...
func NewInlineResponse200259StatesExpiringCritical() *InlineResponse200259StatesExpiringCritical {
	this := InlineResponse200259StatesExpiringCritical{}
	return &this
}
...
func (o InlineResponse200259StatesExpiringCritical) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200259StatesExpiringCritical struct {
	value *InlineResponse200259StatesExpiringCritical
	isSet bool
}

func (v NullableInlineResponse200259StatesExpiringCritical) Get() *InlineResponse200259StatesExpiringCritical {
	return v.value
}

func (v *NullableInlineResponse200259StatesExpiringCritical) Set(val *InlineResponse200259StatesExpiringCritical) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200259StatesExpiringCritical) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200259StatesExpiringCritical) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200259StatesExpiringCritical(val *InlineResponse200259StatesExpiringCritical) *NullableInlineResponse200259StatesExpiringCritical {
	return &NullableInlineResponse200259StatesExpiringCritical{value: val, isSet: true}
}

func (v NullableInlineResponse200259StatesExpiringCritical) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200259StatesExpiringCritical) UnmarshalJSON(src []byte) error {
	v.isSet = true
