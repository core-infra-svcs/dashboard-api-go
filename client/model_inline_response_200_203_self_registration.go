...
// InlineResponse200203SelfRegistration Self-registration for splash with Meraki authentication.
type InlineResponse200203SelfRegistration struct {
...
func NewInlineResponse200203SelfRegistration() *InlineResponse200203SelfRegistration {
	this := InlineResponse200203SelfRegistration{}
	return &this
}
...
func (o InlineResponse200203SelfRegistration) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200203SelfRegistration struct {
	value *InlineResponse200203SelfRegistration
	isSet bool
}

func (v NullableInlineResponse200203SelfRegistration) Get() *InlineResponse200203SelfRegistration {
	return v.value
}

func (v *NullableInlineResponse200203SelfRegistration) Set(val *InlineResponse200203SelfRegistration) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200203SelfRegistration) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200203SelfRegistration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200203SelfRegistration(val *InlineResponse200203SelfRegistration) *NullableInlineResponse200203SelfRegistration {
	return &NullableInlineResponse200203SelfRegistration{value: val, isSet: true}
}

func (v NullableInlineResponse200203SelfRegistration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200203SelfRegistration) UnmarshalJSON(src []byte) error {
	v.isSet = true
