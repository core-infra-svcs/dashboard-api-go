...
type InlineResponse20053 struct {
	// SSID status list
	BasicServiceSets []InlineResponse20053BasicServiceSets `json:"basicServiceSets,omitempty"`
}
...
func (o *InlineResponse20053) GetBasicServiceSets() []InlineResponse20053BasicServiceSets {
	if o == nil || isNil(o.BasicServiceSets) {
		var ret []InlineResponse20053BasicServiceSets
		return ret
	}
...
// SetBasicServiceSets gets a reference to the given []InlineResponse20053BasicServiceSets and assigns it to the BasicServiceSets field.
