...
// InlineResponse20041BasicServiceSets struct for InlineResponse20041BasicServiceSets
type InlineResponse20041BasicServiceSets struct {
...
func NewInlineResponse20041BasicServiceSets() *InlineResponse20041BasicServiceSets {
	this := InlineResponse20041BasicServiceSets{}
	return &this
}
...
func (o InlineResponse20041BasicServiceSets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20041BasicServiceSets struct {
	value *InlineResponse20041BasicServiceSets
	isSet bool
}

func (v NullableInlineResponse20041BasicServiceSets) Get() *InlineResponse20041BasicServiceSets {
	return v.value
}

func (v *NullableInlineResponse20041BasicServiceSets) Set(val *InlineResponse20041BasicServiceSets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20041BasicServiceSets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20041BasicServiceSets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20041BasicServiceSets(val *InlineResponse20041BasicServiceSets) *NullableInlineResponse20041BasicServiceSets {
	return &NullableInlineResponse20041BasicServiceSets{value: val, isSet: true}
}

func (v NullableInlineResponse20041BasicServiceSets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20041BasicServiceSets) UnmarshalJSON(src []byte) error {
	v.isSet = true
