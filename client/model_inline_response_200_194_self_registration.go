...
// InlineResponse200194SelfRegistration Self-registration for splash with Meraki authentication.
type InlineResponse200194SelfRegistration struct {
...
func NewInlineResponse200194SelfRegistration() *InlineResponse200194SelfRegistration {
	this := InlineResponse200194SelfRegistration{}
	return &this
}
...
func (o InlineResponse200194SelfRegistration) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200194SelfRegistration struct {
	value *InlineResponse200194SelfRegistration
	isSet bool
}

func (v NullableInlineResponse200194SelfRegistration) Get() *InlineResponse200194SelfRegistration {
	return v.value
}

func (v *NullableInlineResponse200194SelfRegistration) Set(val *InlineResponse200194SelfRegistration) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200194SelfRegistration) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200194SelfRegistration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200194SelfRegistration(val *InlineResponse200194SelfRegistration) *NullableInlineResponse200194SelfRegistration {
	return &NullableInlineResponse200194SelfRegistration{value: val, isSet: true}
}

func (v NullableInlineResponse200194SelfRegistration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200194SelfRegistration) UnmarshalJSON(src []byte) error {
	v.isSet = true
