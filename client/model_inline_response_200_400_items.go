...
type InlineResponse200400Items struct {
	...
	Intervals []InlineResponse200400Intervals `json:"intervals,omitempty"`
}
...
func (o *InlineResponse200400Items) GetIntervals() []InlineResponse200400Intervals {
	if o == nil || isNil(o.Intervals) {
		var ret []InlineResponse200400Intervals
		return ret
	}
	return o.Intervals
}
...
// SetIntervals gets a reference to the given []InlineResponse200400Intervals and assigns it to the Intervals field.
