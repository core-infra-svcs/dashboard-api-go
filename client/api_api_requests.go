...
func (r ApiRequestsApiGetOrganizationApiRequestsRequest) Execute() ([]InlineResponse20075, *http.Response, error) {
...
func (a *ApiRequestsApiService) GetOrganizationApiRequestsExecute(r ApiRequestsApiGetOrganizationApiRequestsRequest) ([]InlineResponse20075, *http.Response, error) {
	var (
