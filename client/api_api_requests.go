...
func (r ApiRequestsApiApiGetOrganizationApiRequestsRequest) Version(version int32) ApiRequestsApiApiGetOrganizationApiRequestsRequest {
	r.version = &version
	return r
}
// Filter the results by one or more operation IDs for the API request
func (r ApiRequestsApiApiGetOrganizationApiRequestsRequest) OperationIds(operationIds []string) ApiRequestsApiApiGetOrganizationApiRequestsRequest {
	r.operationIds = &operationIds
	return r
}

func (r ApiRequestsApiApiGetOrganizationApiRequestsRequest) Execute() ([]InlineResponse20065, *_nethttp.Response, error) {
...
func (a *ApiRequestsApiService) GetOrganizationApiRequestsExecute(r ApiRequestsApiApiGetOrganizationApiRequestsRequest) ([]InlineResponse20065, *_nethttp.Response, error) {
	var (
