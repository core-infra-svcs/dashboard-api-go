...
func (r ApiRequestsApiApiGetOrganizationApiRequestsRequest) Execute() ([]InlineResponse2002, *_nethttp.Response, error) {
...
func (a *ApiRequestsApiService) GetOrganizationApiRequestsExecute(r ApiRequestsApiApiGetOrganizationApiRequestsRequest) ([]InlineResponse2002, *_nethttp.Response, error) {
	var (
