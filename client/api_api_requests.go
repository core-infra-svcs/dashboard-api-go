...
func (r ApiRequestsApiApiGetOrganizationApiRequestsRequest) Execute() ([]InlineResponse2001, *http.Response, error) {
...
*/
func (a *ApiRequestsApiService) GetOrganizationApiRequests(ctx context.Context, organizationId string) ApiRequestsApiApiGetOrganizationApiRequestsRequest {
	return ApiRequestsApiApiGetOrganizationApiRequestsRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *ApiRequestsApiService) GetOrganizationApiRequestsExecute(r ApiRequestsApiApiGetOrganizationApiRequestsRequest) ([]InlineResponse2001, *http.Response, error) {
	var (
...
func (r ApiRequestsApiApiGetOrganizationApiRequestsOverviewRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *ApiRequestsApiService) GetOrganizationApiRequestsOverview(ctx context.Context, organizationId string) ApiRequestsApiApiGetOrganizationApiRequestsOverviewRequest {
	return ApiRequestsApiApiGetOrganizationApiRequestsOverviewRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
func (a *ApiRequestsApiService) GetOrganizationApiRequestsOverviewExecute(r ApiRequestsApiApiGetOrganizationApiRequestsOverviewRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
