...
// InlineResponse20069Value1Source Source of 'custom' type traffic filter
type InlineResponse20069Value1Source struct {
...
func NewInlineResponse20069Value1Source() *InlineResponse20069Value1Source {
	this := InlineResponse20069Value1Source{}
	return &this
}
...
func (o InlineResponse20069Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20069Value1Source struct {
	value *InlineResponse20069Value1Source
	isSet bool
}

func (v NullableInlineResponse20069Value1Source) Get() *InlineResponse20069Value1Source {
	return v.value
}

func (v *NullableInlineResponse20069Value1Source) Set(val *InlineResponse20069Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20069Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20069Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20069Value1Source(val *InlineResponse20069Value1Source) *NullableInlineResponse20069Value1Source {
	return &NullableInlineResponse20069Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20069Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20069Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
