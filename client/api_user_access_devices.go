...
func (r UserAccessDevicesApiGetNetworkSmUserAccessDevicesRequest) Execute() ([]InlineResponse200148, *http.Response, error) {
...
func (a *UserAccessDevicesApiService) GetNetworkSmUserAccessDevicesExecute(r UserAccessDevicesApiGetNetworkSmUserAccessDevicesRequest) ([]InlineResponse200148, *http.Response, error) {
	var (
