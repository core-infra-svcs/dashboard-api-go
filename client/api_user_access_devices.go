...
func (r UserAccessDevicesApiGetNetworkSmUserAccessDevicesRequest) Execute() ([]InlineResponse20059, *http.Response, error) {
...
func (a *UserAccessDevicesApiService) GetNetworkSmUserAccessDevicesExecute(r UserAccessDevicesApiGetNetworkSmUserAccessDevicesRequest) ([]InlineResponse20059, *http.Response, error) {
	var (
