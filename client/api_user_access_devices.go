...
func (r UserAccessDevicesApiGetNetworkSmUserAccessDevicesRequest) Execute() ([]InlineResponse20072, *http.Response, error) {
...
func (a *UserAccessDevicesApiService) GetNetworkSmUserAccessDevicesExecute(r UserAccessDevicesApiGetNetworkSmUserAccessDevicesRequest) ([]InlineResponse20072, *http.Response, error) {
	var (
