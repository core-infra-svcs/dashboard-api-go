...
func (r WebhooksApiCreateNetworkWebhooksHttpServerRequest) CreateNetworkWebhooksHttpServer(createNetworkWebhooksHttpServer InlineObject172) WebhooksApiCreateNetworkWebhooksHttpServerRequest {
...
func (r WebhooksApiCreateNetworkWebhooksPayloadTemplateRequest) CreateNetworkWebhooksPayloadTemplate(createNetworkWebhooksPayloadTemplate InlineObject174) WebhooksApiCreateNetworkWebhooksPayloadTemplateRequest {
...
func (r WebhooksApiCreateNetworkWebhooksWebhookTestRequest) CreateNetworkWebhooksWebhookTest(createNetworkWebhooksWebhookTest InlineObject176) WebhooksApiCreateNetworkWebhooksWebhookTestRequest {
	r.createNetworkWebhooksWebhookTest = &createNetworkWebhooksWebhookTest
	return r
}

func (r WebhooksApiCreateNetworkWebhooksWebhookTestRequest) Execute() (*InlineResponse20111, *http.Response, error) {
...
func (a *WebhooksApiService) CreateNetworkWebhooksWebhookTestExecute(r WebhooksApiCreateNetworkWebhooksWebhookTestRequest) (*InlineResponse20111, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WebhooksApiGetNetworkWebhooksWebhookTestRequest) Execute() (*InlineResponse20111, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20111
func (a *WebhooksApiService) GetNetworkWebhooksWebhookTestExecute(r WebhooksApiGetNetworkWebhooksWebhookTestRequest) (*InlineResponse20111, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WebhooksApiGetOrganizationWebhooksAlertTypesRequest) Execute() (*InlineResponse200336, *http.Response, error) {
...
func (a *WebhooksApiService) GetOrganizationWebhooksAlertTypesExecute(r WebhooksApiGetOrganizationWebhooksAlertTypesRequest) (*InlineResponse200336, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WebhooksApiGetOrganizationWebhooksCallbacksStatusRequest) Execute() (*InlineResponse200337, *http.Response, error) {
...
func (a *WebhooksApiService) GetOrganizationWebhooksCallbacksStatusExecute(r WebhooksApiGetOrganizationWebhooksCallbacksStatusRequest) (*InlineResponse200337, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WebhooksApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200338, *http.Response, error) {
...
func (a *WebhooksApiService) GetOrganizationWebhooksLogsExecute(r WebhooksApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200338, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WebhooksApiUpdateNetworkWebhooksHttpServerRequest) UpdateNetworkWebhooksHttpServer(updateNetworkWebhooksHttpServer InlineObject173) WebhooksApiUpdateNetworkWebhooksHttpServerRequest {
...
func (r WebhooksApiUpdateNetworkWebhooksPayloadTemplateRequest) UpdateNetworkWebhooksPayloadTemplate(updateNetworkWebhooksPayloadTemplate InlineObject175) WebhooksApiUpdateNetworkWebhooksPayloadTemplateRequest {
