...
func (r WebhooksApiGetOrganizationWebhooksAlertTypesRequest) Execute() (*InlineResponse200181, *http.Response, error) {
...
func (a *WebhooksApiService) GetOrganizationWebhooksAlertTypesExecute(r WebhooksApiGetOrganizationWebhooksAlertTypesRequest) (*InlineResponse200181, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WebhooksApiGetOrganizationWebhooksCallbacksStatusRequest) Execute() (*InlineResponse200182, *http.Response, error) {
...
func (a *WebhooksApiService) GetOrganizationWebhooksCallbacksStatusExecute(r WebhooksApiGetOrganizationWebhooksCallbacksStatusRequest) (*InlineResponse200182, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r WebhooksApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200183, *http.Response, error) {
...
func (a *WebhooksApiService) GetOrganizationWebhooksLogsExecute(r WebhooksApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200183, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
