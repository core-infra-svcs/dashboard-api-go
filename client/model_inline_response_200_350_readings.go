...
// InlineResponse200350Readings struct for InlineResponse200350Readings
type InlineResponse200350Readings struct {
...
func NewInlineResponse200350Readings() *InlineResponse200350Readings {
	this := InlineResponse200350Readings{}
	return &this
}
...
func (o InlineResponse200350Readings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200350Readings struct {
	value *InlineResponse200350Readings
	isSet bool
}

func (v NullableInlineResponse200350Readings) Get() *InlineResponse200350Readings {
	return v.value
}

func (v *NullableInlineResponse200350Readings) Set(val *InlineResponse200350Readings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200350Readings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200350Readings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200350Readings(val *InlineResponse200350Readings) *NullableInlineResponse200350Readings {
	return &NullableInlineResponse200350Readings{value: val, isSet: true}
}

func (v NullableInlineResponse200350Readings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200350Readings) UnmarshalJSON(src []byte) error {
	v.isSet = true
