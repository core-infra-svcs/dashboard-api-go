...
// InlineResponse20083DhcpOptions struct for InlineResponse20083DhcpOptions
type InlineResponse20083DhcpOptions struct {
...
func NewInlineResponse20083DhcpOptions() *InlineResponse20083DhcpOptions {
	this := InlineResponse20083DhcpOptions{}
	return &this
}
...
func (o InlineResponse20083DhcpOptions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20083DhcpOptions struct {
	value *InlineResponse20083DhcpOptions
	isSet bool
}

func (v NullableInlineResponse20083DhcpOptions) Get() *InlineResponse20083DhcpOptions {
	return v.value
}

func (v *NullableInlineResponse20083DhcpOptions) Set(val *InlineResponse20083DhcpOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20083DhcpOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20083DhcpOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20083DhcpOptions(val *InlineResponse20083DhcpOptions) *NullableInlineResponse20083DhcpOptions {
	return &NullableInlineResponse20083DhcpOptions{value: val, isSet: true}
}

func (v NullableInlineResponse20083DhcpOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20083DhcpOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
