...
func (r PolicyApiGetNetworkClientPolicyRequest) Execute() (*InlineResponse20083, *http.Response, error) {
...
func (a *PolicyApiService) GetNetworkClientPolicyExecute(r PolicyApiGetNetworkClientPolicyRequest) (*InlineResponse20083, *http.Response, error) {
	var (
...
func (r PolicyApiUpdateNetworkClientPolicyRequest) Execute() (*InlineResponse20083, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20083
func (a *PolicyApiService) UpdateNetworkClientPolicyExecute(r PolicyApiUpdateNetworkClientPolicyRequest) (*InlineResponse20083, *http.Response, error) {
	var (
