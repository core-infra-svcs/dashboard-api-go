...
func (r PolicyApiGetNetworkClientPolicyRequest) Execute() (*InlineResponse20081, *http.Response, error) {
...
func (a *PolicyApiService) GetNetworkClientPolicyExecute(r PolicyApiGetNetworkClientPolicyRequest) (*InlineResponse20081, *http.Response, error) {
	var (
...
func (r PolicyApiUpdateNetworkClientPolicyRequest) Execute() (*InlineResponse20081, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20081
func (a *PolicyApiService) UpdateNetworkClientPolicyExecute(r PolicyApiUpdateNetworkClientPolicyRequest) (*InlineResponse20081, *http.Response, error) {
	var (
