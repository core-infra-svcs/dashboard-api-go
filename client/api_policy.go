...
func (r PolicyApiGetNetworkClientPolicyRequest) Execute() (*InlineResponse200102, *http.Response, error) {
...
func (a *PolicyApiService) GetNetworkClientPolicyExecute(r PolicyApiGetNetworkClientPolicyRequest) (*InlineResponse200102, *http.Response, error) {
	var (
...
func (r PolicyApiUpdateNetworkClientPolicyRequest) UpdateNetworkClientPolicy(updateNetworkClientPolicy InlineObject94) PolicyApiUpdateNetworkClientPolicyRequest {
	r.updateNetworkClientPolicy = &updateNetworkClientPolicy
	return r
}

func (r PolicyApiUpdateNetworkClientPolicyRequest) Execute() (*InlineResponse200102, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200102
func (a *PolicyApiService) UpdateNetworkClientPolicyExecute(r PolicyApiUpdateNetworkClientPolicyRequest) (*InlineResponse200102, *http.Response, error) {
	var (
