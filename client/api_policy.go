...
func (r PolicyApiGetNetworkClientPolicyRequest) Execute() (*InlineResponse20090, *http.Response, error) {
...
func (a *PolicyApiService) GetNetworkClientPolicyExecute(r PolicyApiGetNetworkClientPolicyRequest) (*InlineResponse20090, *http.Response, error) {
	var (
...
func (r PolicyApiUpdateNetworkClientPolicyRequest) Execute() (*InlineResponse20090, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20090
func (a *PolicyApiService) UpdateNetworkClientPolicyExecute(r PolicyApiUpdateNetworkClientPolicyRequest) (*InlineResponse20090, *http.Response, error) {
	var (
