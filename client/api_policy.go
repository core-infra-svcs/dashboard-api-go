...
func (r PolicyApiGetNetworkClientPolicyRequest) Execute() (*InlineResponse20088, *http.Response, error) {
...
func (a *PolicyApiService) GetNetworkClientPolicyExecute(r PolicyApiGetNetworkClientPolicyRequest) (*InlineResponse20088, *http.Response, error) {
	var (
...
func (r PolicyApiUpdateNetworkClientPolicyRequest) UpdateNetworkClientPolicy(updateNetworkClientPolicy InlineObject89) PolicyApiUpdateNetworkClientPolicyRequest {
	r.updateNetworkClientPolicy = &updateNetworkClientPolicy
	return r
}

func (r PolicyApiUpdateNetworkClientPolicyRequest) Execute() (*InlineResponse20088, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20088
func (a *PolicyApiService) UpdateNetworkClientPolicyExecute(r PolicyApiUpdateNetworkClientPolicyRequest) (*InlineResponse20088, *http.Response, error) {
	var (
