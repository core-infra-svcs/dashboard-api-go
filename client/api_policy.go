...
func (r PolicyApiGetNetworkClientPolicyRequest) Execute() (*InlineResponse20084, *http.Response, error) {
...
func (a *PolicyApiService) GetNetworkClientPolicyExecute(r PolicyApiGetNetworkClientPolicyRequest) (*InlineResponse20084, *http.Response, error) {
	var (
...
func (r PolicyApiUpdateNetworkClientPolicyRequest) Execute() (*InlineResponse20084, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20084
func (a *PolicyApiService) UpdateNetworkClientPolicyExecute(r PolicyApiUpdateNetworkClientPolicyRequest) (*InlineResponse20084, *http.Response, error) {
	var (
