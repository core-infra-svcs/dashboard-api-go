...
func (r PolicyApiGetNetworkClientPolicyRequest) Execute() (*InlineResponse20092, *http.Response, error) {
...
func (a *PolicyApiService) GetNetworkClientPolicyExecute(r PolicyApiGetNetworkClientPolicyRequest) (*InlineResponse20092, *http.Response, error) {
	var (
...
func (r PolicyApiUpdateNetworkClientPolicyRequest) UpdateNetworkClientPolicy(updateNetworkClientPolicy InlineObject93) PolicyApiUpdateNetworkClientPolicyRequest {
	r.updateNetworkClientPolicy = &updateNetworkClientPolicy
	return r
}

func (r PolicyApiUpdateNetworkClientPolicyRequest) Execute() (*InlineResponse20092, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20092
func (a *PolicyApiService) UpdateNetworkClientPolicyExecute(r PolicyApiUpdateNetworkClientPolicyRequest) (*InlineResponse20092, *http.Response, error) {
	var (
