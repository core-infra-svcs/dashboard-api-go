...
func (r PolicyApiGetNetworkClientPolicyRequest) Execute() (*InlineResponse20096, *http.Response, error) {
...
func (a *PolicyApiService) GetNetworkClientPolicyExecute(r PolicyApiGetNetworkClientPolicyRequest) (*InlineResponse20096, *http.Response, error) {
	var (
...
func (r PolicyApiUpdateNetworkClientPolicyRequest) Execute() (*InlineResponse20096, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20096
func (a *PolicyApiService) UpdateNetworkClientPolicyExecute(r PolicyApiUpdateNetworkClientPolicyRequest) (*InlineResponse20096, *http.Response, error) {
	var (
