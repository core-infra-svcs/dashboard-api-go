...
func (r PolicyApiGetNetworkClientPolicyRequest) Execute() (*InlineResponse20082, *http.Response, error) {
...
func (a *PolicyApiService) GetNetworkClientPolicyExecute(r PolicyApiGetNetworkClientPolicyRequest) (*InlineResponse20082, *http.Response, error) {
	var (
...
func (r PolicyApiUpdateNetworkClientPolicyRequest) UpdateNetworkClientPolicy(updateNetworkClientPolicy InlineObject87) PolicyApiUpdateNetworkClientPolicyRequest {
	r.updateNetworkClientPolicy = &updateNetworkClientPolicy
	return r
}

func (r PolicyApiUpdateNetworkClientPolicyRequest) Execute() (*InlineResponse20082, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20082
func (a *PolicyApiService) UpdateNetworkClientPolicyExecute(r PolicyApiUpdateNetworkClientPolicyRequest) (*InlineResponse20082, *http.Response, error) {
	var (
