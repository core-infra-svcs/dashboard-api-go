...
func (r PolicyApiGetNetworkClientPolicyRequest) Execute() (*InlineResponse20046, *http.Response, error) {
...
func (a *PolicyApiService) GetNetworkClientPolicyExecute(r PolicyApiGetNetworkClientPolicyRequest) (*InlineResponse20046, *http.Response, error) {
	var (
...
func (r PolicyApiUpdateNetworkClientPolicyRequest) UpdateNetworkClientPolicy(updateNetworkClientPolicy InlineObject84) PolicyApiUpdateNetworkClientPolicyRequest {
