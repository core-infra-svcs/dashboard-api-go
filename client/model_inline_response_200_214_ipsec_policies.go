...
// InlineResponse200214IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200214IpsecPolicies struct {
...
func NewInlineResponse200214IpsecPolicies() *InlineResponse200214IpsecPolicies {
	this := InlineResponse200214IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200214IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200214IpsecPolicies struct {
	value *InlineResponse200214IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200214IpsecPolicies) Get() *InlineResponse200214IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200214IpsecPolicies) Set(val *InlineResponse200214IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200214IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200214IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200214IpsecPolicies(val *InlineResponse200214IpsecPolicies) *NullableInlineResponse200214IpsecPolicies {
	return &NullableInlineResponse200214IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200214IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200214IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
