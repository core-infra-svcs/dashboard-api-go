...
func (r WarningsApiGetNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDeviceRequest) Execute() ([]InlineResponse20082, *http.Response, error) {
...
func (a *WarningsApiService) GetNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDeviceExecute(r WarningsApiGetNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDeviceRequest) ([]InlineResponse20082, *http.Response, error) {
	var (
