...
// InlineResponse200338SecurePort The Secure Port status of the port.
type InlineResponse200338SecurePort struct {
...
func NewInlineResponse200338SecurePort() *InlineResponse200338SecurePort {
	this := InlineResponse200338SecurePort{}
	return &this
}
...
func (o InlineResponse200338SecurePort) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200338SecurePort struct {
	value *InlineResponse200338SecurePort
	isSet bool
}

func (v NullableInlineResponse200338SecurePort) Get() *InlineResponse200338SecurePort {
	return v.value
}

func (v *NullableInlineResponse200338SecurePort) Set(val *InlineResponse200338SecurePort) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200338SecurePort) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200338SecurePort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200338SecurePort(val *InlineResponse200338SecurePort) *NullableInlineResponse200338SecurePort {
	return &NullableInlineResponse200338SecurePort{value: val, isSet: true}
}

func (v NullableInlineResponse200338SecurePort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200338SecurePort) UnmarshalJSON(src []byte) error {
	v.isSet = true
