...
// InlineResponse200389Usage The usage on the interfaces of the wireless LAN controller
type InlineResponse200389Usage struct {
...
func NewInlineResponse200389Usage() *InlineResponse200389Usage {
	this := InlineResponse200389Usage{}
	return &this
}
...
func (o InlineResponse200389Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200389Usage struct {
	value *InlineResponse200389Usage
	isSet bool
}

func (v NullableInlineResponse200389Usage) Get() *InlineResponse200389Usage {
	return v.value
}

func (v *NullableInlineResponse200389Usage) Set(val *InlineResponse200389Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200389Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200389Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200389Usage(val *InlineResponse200389Usage) *NullableInlineResponse200389Usage {
	return &NullableInlineResponse200389Usage{value: val, isSet: true}
}

func (v NullableInlineResponse200389Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200389Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
