...
// InlineResponse200258Records struct for InlineResponse200258Records
type InlineResponse200258Records struct {
	...
	ClientVpnConnections []InlineResponse200258ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200258Records() *InlineResponse200258Records {
	this := InlineResponse200258Records{}
	return &this
}
...
func (o *InlineResponse200258Records) GetClientVpnConnections() []InlineResponse200258ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200258ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200258ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200258Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200258Records struct {
	value *InlineResponse200258Records
	isSet bool
}

func (v NullableInlineResponse200258Records) Get() *InlineResponse200258Records {
	return v.value
}

func (v *NullableInlineResponse200258Records) Set(val *InlineResponse200258Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200258Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200258Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200258Records(val *InlineResponse200258Records) *NullableInlineResponse200258Records {
	return &NullableInlineResponse200258Records{value: val, isSet: true}
}

func (v NullableInlineResponse200258Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200258Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
