...
// InlineResponse200151Overrides struct for InlineResponse200151Overrides
type InlineResponse200151Overrides struct {
...
func NewInlineResponse200151Overrides() *InlineResponse200151Overrides {
	this := InlineResponse200151Overrides{}
	return &this
}
...
func (o InlineResponse200151Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200151Overrides struct {
	value *InlineResponse200151Overrides
	isSet bool
}

func (v NullableInlineResponse200151Overrides) Get() *InlineResponse200151Overrides {
	return v.value
}

func (v *NullableInlineResponse200151Overrides) Set(val *InlineResponse200151Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200151Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200151Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200151Overrides(val *InlineResponse200151Overrides) *NullableInlineResponse200151Overrides {
	return &NullableInlineResponse200151Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse200151Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200151Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
