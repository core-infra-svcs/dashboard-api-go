...
func (r RulesApiGetNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*InlineResponse200112, *http.Response, error) {
...
func (a *RulesApiService) GetNetworkWirelessSsidTrafficShapingRulesExecute(r RulesApiGetNetworkWirelessSsidTrafficShapingRulesRequest) (*InlineResponse200112, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*InlineResponse200112, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200112
func (a *RulesApiService) UpdateNetworkWirelessSsidTrafficShapingRulesExecute(r RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) (*InlineResponse200112, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
