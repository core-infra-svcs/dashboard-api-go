...
func (r RulesApiGetOrganizationWirelessAirMarshalRulesRequest) Execute() (*InlineResponse200330, *http.Response, error) {
...
func (a *RulesApiService) GetOrganizationWirelessAirMarshalRulesExecute(r RulesApiGetOrganizationWirelessAirMarshalRulesRequest) (*InlineResponse200330, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
