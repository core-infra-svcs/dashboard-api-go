...
func (r RulesApiCreateNetworkWirelessAirMarshalRuleRequest) Execute() (*InlineResponse20114, *http.Response, error) {
...
func (a *RulesApiService) CreateNetworkWirelessAirMarshalRuleExecute(r RulesApiCreateNetworkWirelessAirMarshalRuleRequest) (*InlineResponse20114, *http.Response, error) {
	var (
...
func (r RulesApiGetNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*InlineResponse200209, *http.Response, error) {
...
func (a *RulesApiService) GetNetworkWirelessSsidTrafficShapingRulesExecute(r RulesApiGetNetworkWirelessSsidTrafficShapingRulesRequest) (*InlineResponse200209, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RulesApiGetOrganizationWirelessAirMarshalRulesRequest) Execute() (*InlineResponse200350, *http.Response, error) {
...
func (a *RulesApiService) GetOrganizationWirelessAirMarshalRulesExecute(r RulesApiGetOrganizationWirelessAirMarshalRulesRequest) (*InlineResponse200350, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RulesApiUpdateNetworkWirelessAirMarshalRuleRequest) Execute() (*InlineResponse20114, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20114
func (a *RulesApiService) UpdateNetworkWirelessAirMarshalRuleExecute(r RulesApiUpdateNetworkWirelessAirMarshalRuleRequest) (*InlineResponse20114, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*InlineResponse200209, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200209
func (a *RulesApiService) UpdateNetworkWirelessSsidTrafficShapingRulesExecute(r RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) (*InlineResponse200209, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
