...
func (r RulesApiCreateNetworkWirelessAirMarshalRuleRequest) CreateNetworkWirelessAirMarshalRule(createNetworkWirelessAirMarshalRule InlineObject177) RulesApiCreateNetworkWirelessAirMarshalRuleRequest {
	r.createNetworkWirelessAirMarshalRule = &createNetworkWirelessAirMarshalRule
	return r
}

func (r RulesApiCreateNetworkWirelessAirMarshalRuleRequest) Execute() (*InlineResponse20112, *http.Response, error) {
...
func (a *RulesApiService) CreateNetworkWirelessAirMarshalRuleExecute(r RulesApiCreateNetworkWirelessAirMarshalRuleRequest) (*InlineResponse20112, *http.Response, error) {
	var (
...
func (r RulesApiGetOrganizationWirelessAirMarshalRulesRequest) Execute() (*InlineResponse200339, *http.Response, error) {
...
func (a *RulesApiService) GetOrganizationWirelessAirMarshalRulesExecute(r RulesApiGetOrganizationWirelessAirMarshalRulesRequest) (*InlineResponse200339, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RulesApiUpdateNetworkWirelessAirMarshalRuleRequest) UpdateNetworkWirelessAirMarshalRule(updateNetworkWirelessAirMarshalRule InlineObject178) RulesApiUpdateNetworkWirelessAirMarshalRuleRequest {
	r.updateNetworkWirelessAirMarshalRule = &updateNetworkWirelessAirMarshalRule
	return r
}

func (r RulesApiUpdateNetworkWirelessAirMarshalRuleRequest) Execute() (*InlineResponse20112, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20112
func (a *RulesApiService) UpdateNetworkWirelessAirMarshalRuleExecute(r RulesApiUpdateNetworkWirelessAirMarshalRuleRequest) (*InlineResponse20112, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) UpdateNetworkWirelessSsidTrafficShapingRules(updateNetworkWirelessSsidTrafficShapingRules InlineObject203) RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest {
