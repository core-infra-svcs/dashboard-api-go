...
func (r RulesApiCreateNetworkWirelessAirMarshalRuleRequest) CreateNetworkWirelessAirMarshalRule(createNetworkWirelessAirMarshalRule InlineObject174) RulesApiCreateNetworkWirelessAirMarshalRuleRequest {
	r.createNetworkWirelessAirMarshalRule = &createNetworkWirelessAirMarshalRule
	return r
}

func (r RulesApiCreateNetworkWirelessAirMarshalRuleRequest) Execute() (*InlineResponse20110, *http.Response, error) {
...
func (a *RulesApiService) CreateNetworkWirelessAirMarshalRuleExecute(r RulesApiCreateNetworkWirelessAirMarshalRuleRequest) (*InlineResponse20110, *http.Response, error) {
	var (
...
func (r RulesApiGetNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*InlineResponse200200, *http.Response, error) {
...
func (a *RulesApiService) GetNetworkWirelessSsidTrafficShapingRulesExecute(r RulesApiGetNetworkWirelessSsidTrafficShapingRulesRequest) (*InlineResponse200200, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RulesApiGetOrganizationWirelessAirMarshalRulesRequest) Execute() (*InlineResponse200310, *http.Response, error) {
...
func (a *RulesApiService) GetOrganizationWirelessAirMarshalRulesExecute(r RulesApiGetOrganizationWirelessAirMarshalRulesRequest) (*InlineResponse200310, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RulesApiUpdateNetworkWirelessAirMarshalRuleRequest) UpdateNetworkWirelessAirMarshalRule(updateNetworkWirelessAirMarshalRule InlineObject175) RulesApiUpdateNetworkWirelessAirMarshalRuleRequest {
	r.updateNetworkWirelessAirMarshalRule = &updateNetworkWirelessAirMarshalRule
	return r
}

func (r RulesApiUpdateNetworkWirelessAirMarshalRuleRequest) Execute() (*InlineResponse20110, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20110
func (a *RulesApiService) UpdateNetworkWirelessAirMarshalRuleExecute(r RulesApiUpdateNetworkWirelessAirMarshalRuleRequest) (*InlineResponse20110, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) UpdateNetworkWirelessSsidTrafficShapingRules(updateNetworkWirelessSsidTrafficShapingRules InlineObject199) RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest {
	r.updateNetworkWirelessSsidTrafficShapingRules = &updateNetworkWirelessSsidTrafficShapingRules
	return r
}

func (r RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*InlineResponse200200, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200200
func (a *RulesApiService) UpdateNetworkWirelessSsidTrafficShapingRulesExecute(r RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) (*InlineResponse200200, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
