...
func (r RulesApiCreateNetworkWirelessAirMarshalRuleRequest) CreateNetworkWirelessAirMarshalRule(createNetworkWirelessAirMarshalRule InlineObject179) RulesApiCreateNetworkWirelessAirMarshalRuleRequest {
	r.createNetworkWirelessAirMarshalRule = &createNetworkWirelessAirMarshalRule
	return r
}

func (r RulesApiCreateNetworkWirelessAirMarshalRuleRequest) Execute() (*InlineResponse20113, *http.Response, error) {
...
func (a *RulesApiService) CreateNetworkWirelessAirMarshalRuleExecute(r RulesApiCreateNetworkWirelessAirMarshalRuleRequest) (*InlineResponse20113, *http.Response, error) {
	var (
...
func (r RulesApiGetNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*InlineResponse200207, *http.Response, error) {
...
func (a *RulesApiService) GetNetworkWirelessSsidTrafficShapingRulesExecute(r RulesApiGetNetworkWirelessSsidTrafficShapingRulesRequest) (*InlineResponse200207, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RulesApiGetOrganizationWirelessAirMarshalRulesRequest) Execute() (*InlineResponse200346, *http.Response, error) {
...
func (a *RulesApiService) GetOrganizationWirelessAirMarshalRulesExecute(r RulesApiGetOrganizationWirelessAirMarshalRulesRequest) (*InlineResponse200346, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RulesApiUpdateNetworkApplianceTrafficShapingRulesRequest) UpdateNetworkApplianceTrafficShapingRules(updateNetworkApplianceTrafficShapingRules InlineObject70) RulesApiUpdateNetworkApplianceTrafficShapingRulesRequest {
...
func (r RulesApiUpdateNetworkWirelessAirMarshalRuleRequest) UpdateNetworkWirelessAirMarshalRule(updateNetworkWirelessAirMarshalRule InlineObject180) RulesApiUpdateNetworkWirelessAirMarshalRuleRequest {
	r.updateNetworkWirelessAirMarshalRule = &updateNetworkWirelessAirMarshalRule
	return r
}

func (r RulesApiUpdateNetworkWirelessAirMarshalRuleRequest) Execute() (*InlineResponse20113, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20113
func (a *RulesApiService) UpdateNetworkWirelessAirMarshalRuleExecute(r RulesApiUpdateNetworkWirelessAirMarshalRuleRequest) (*InlineResponse20113, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) UpdateNetworkWirelessSsidTrafficShapingRules(updateNetworkWirelessSsidTrafficShapingRules InlineObject205) RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest {
	r.updateNetworkWirelessSsidTrafficShapingRules = &updateNetworkWirelessSsidTrafficShapingRules
	return r
}

func (r RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*InlineResponse200207, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200207
func (a *RulesApiService) UpdateNetworkWirelessSsidTrafficShapingRulesExecute(r RulesApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) (*InlineResponse200207, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
