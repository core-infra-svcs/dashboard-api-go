...
// InlineResponse20041Group The staged upgrade group
type InlineResponse20041Group struct {
...
func (o InlineResponse20041Group) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20041Group struct {
	value *InlineResponse20041Group
	isSet bool
}

func (v NullableInlineResponse20041Group) Get() *InlineResponse20041Group {
	return v.value
}

func (v *NullableInlineResponse20041Group) Set(val *InlineResponse20041Group) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20041Group) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20041Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20041Group(val *InlineResponse20041Group) *NullableInlineResponse20041Group {
	return &NullableInlineResponse20041Group{value: val, isSet: true}
}

func (v NullableInlineResponse20041Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20041Group) UnmarshalJSON(src []byte) error {
	v.isSet = true
