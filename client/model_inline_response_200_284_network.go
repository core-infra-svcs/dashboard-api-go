...
// InlineResponse200284Network Information regarding the network the device belongs to
type InlineResponse200284Network struct {
	// The network ID
...
func NewInlineResponse200284Network() *InlineResponse200284Network {
	this := InlineResponse200284Network{}
	return &this
}
...
func (o InlineResponse200284Network) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200284Network struct {
	value *InlineResponse200284Network
	isSet bool
}

func (v NullableInlineResponse200284Network) Get() *InlineResponse200284Network {
	return v.value
}

func (v *NullableInlineResponse200284Network) Set(val *InlineResponse200284Network) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200284Network) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200284Network) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200284Network(val *InlineResponse200284Network) *NullableInlineResponse200284Network {
	return &NullableInlineResponse200284Network{value: val, isSet: true}
}

func (v NullableInlineResponse200284Network) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200284Network) UnmarshalJSON(src []byte) error {
	v.isSet = true
