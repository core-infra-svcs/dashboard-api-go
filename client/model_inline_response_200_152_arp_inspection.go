...
// InlineResponse200152ArpInspection Dynamic ARP Inspection settings
type InlineResponse200152ArpInspection struct {
...
func NewInlineResponse200152ArpInspection() *InlineResponse200152ArpInspection {
	this := InlineResponse200152ArpInspection{}
	return &this
}
...
func (o InlineResponse200152ArpInspection) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200152ArpInspection struct {
	value *InlineResponse200152ArpInspection
	isSet bool
}

func (v NullableInlineResponse200152ArpInspection) Get() *InlineResponse200152ArpInspection {
	return v.value
}

func (v *NullableInlineResponse200152ArpInspection) Set(val *InlineResponse200152ArpInspection) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200152ArpInspection) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200152ArpInspection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200152ArpInspection(val *InlineResponse200152ArpInspection) *NullableInlineResponse200152ArpInspection {
	return &NullableInlineResponse200152ArpInspection{value: val, isSet: true}
}

func (v NullableInlineResponse200152ArpInspection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200152ArpInspection) UnmarshalJSON(src []byte) error {
	v.isSet = true
