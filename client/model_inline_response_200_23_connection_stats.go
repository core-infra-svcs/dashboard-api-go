...
// InlineResponse20023ConnectionStats The connection stats of the device
type InlineResponse20023ConnectionStats struct {
...
func NewInlineResponse20023ConnectionStats() *InlineResponse20023ConnectionStats {
	this := InlineResponse20023ConnectionStats{}
	return &this
}
...
func (o InlineResponse20023ConnectionStats) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20023ConnectionStats struct {
	value *InlineResponse20023ConnectionStats
	isSet bool
}

func (v NullableInlineResponse20023ConnectionStats) Get() *InlineResponse20023ConnectionStats {
	return v.value
}

func (v *NullableInlineResponse20023ConnectionStats) Set(val *InlineResponse20023ConnectionStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20023ConnectionStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20023ConnectionStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20023ConnectionStats(val *InlineResponse20023ConnectionStats) *NullableInlineResponse20023ConnectionStats {
	return &NullableInlineResponse20023ConnectionStats{value: val, isSet: true}
}

func (v NullableInlineResponse20023ConnectionStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20023ConnectionStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
