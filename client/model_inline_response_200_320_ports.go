...
// InlineResponse200320Ports struct for InlineResponse200320Ports
type InlineResponse200320Ports struct {
...
func NewInlineResponse200320Ports() *InlineResponse200320Ports {
	this := InlineResponse200320Ports{}
	return &this
}
...
func (o InlineResponse200320Ports) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200320Ports struct {
	value *InlineResponse200320Ports
	isSet bool
}

func (v NullableInlineResponse200320Ports) Get() *InlineResponse200320Ports {
	return v.value
}

func (v *NullableInlineResponse200320Ports) Set(val *InlineResponse200320Ports) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200320Ports) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200320Ports) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200320Ports(val *InlineResponse200320Ports) *NullableInlineResponse200320Ports {
	return &NullableInlineResponse200320Ports{value: val, isSet: true}
}

func (v NullableInlineResponse200320Ports) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200320Ports) UnmarshalJSON(src []byte) error {
	v.isSet = true
