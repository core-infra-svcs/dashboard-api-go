...
func (r PiiApiCreateNetworkPiiRequestRequest) Execute() (*InlineResponse200112, *http.Response, error) {
...
func (a *PiiApiService) CreateNetworkPiiRequestExecute(r PiiApiCreateNetworkPiiRequestRequest) (*InlineResponse200112, *http.Response, error) {
	var (
...
func (r PiiApiGetNetworkPiiPiiKeysRequest) Execute() (*map[string]InlineResponse200111, *http.Response, error) {
...
func (a *PiiApiService) GetNetworkPiiPiiKeysExecute(r PiiApiGetNetworkPiiPiiKeysRequest) (*map[string]InlineResponse200111, *http.Response, error) {
	var (
...
func (r PiiApiGetNetworkPiiRequestRequest) Execute() (*InlineResponse200112, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200112
func (a *PiiApiService) GetNetworkPiiRequestExecute(r PiiApiGetNetworkPiiRequestRequest) (*InlineResponse200112, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PiiApiGetNetworkPiiRequestsRequest) Execute() ([]InlineResponse200112, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200112
func (a *PiiApiService) GetNetworkPiiRequestsExecute(r PiiApiGetNetworkPiiRequestsRequest) ([]InlineResponse200112, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
