...
func (r PiiApiCreateNetworkPiiRequestRequest) CreateNetworkPiiRequest(createNetworkPiiRequest InlineObject119) PiiApiCreateNetworkPiiRequestRequest {
	r.createNetworkPiiRequest = &createNetworkPiiRequest
	return r
}

func (r PiiApiCreateNetworkPiiRequestRequest) Execute() (*InlineResponse200117, *http.Response, error) {
...
func (a *PiiApiService) CreateNetworkPiiRequestExecute(r PiiApiCreateNetworkPiiRequestRequest) (*InlineResponse200117, *http.Response, error) {
	var (
...
func (r PiiApiGetNetworkPiiPiiKeysRequest) Execute() (*map[string]InlineResponse200116, *http.Response, error) {
...
func (a *PiiApiService) GetNetworkPiiPiiKeysExecute(r PiiApiGetNetworkPiiPiiKeysRequest) (*map[string]InlineResponse200116, *http.Response, error) {
	var (
...
func (r PiiApiGetNetworkPiiRequestRequest) Execute() (*InlineResponse200117, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200117
func (a *PiiApiService) GetNetworkPiiRequestExecute(r PiiApiGetNetworkPiiRequestRequest) (*InlineResponse200117, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PiiApiGetNetworkPiiRequestsRequest) Execute() ([]InlineResponse200117, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200117
func (a *PiiApiService) GetNetworkPiiRequestsExecute(r PiiApiGetNetworkPiiRequestsRequest) ([]InlineResponse200117, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
