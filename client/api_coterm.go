...
func (r CotermApiGetOrganizationLicensingCotermLicensesRequest) Execute() ([]InlineResponse200149, *http.Response, error) {
...
func (a *CotermApiService) GetOrganizationLicensingCotermLicensesExecute(r CotermApiGetOrganizationLicensingCotermLicensesRequest) ([]InlineResponse200149, *http.Response, error) {
	var (
...
func (r CotermApiMoveOrganizationLicensingCotermLicensesRequest) MoveOrganizationLicensingCotermLicenses(moveOrganizationLicensingCotermLicenses InlineObject220) CotermApiMoveOrganizationLicensingCotermLicensesRequest {
	r.moveOrganizationLicensingCotermLicenses = &moveOrganizationLicensingCotermLicenses
	return r
}

func (r CotermApiMoveOrganizationLicensingCotermLicensesRequest) Execute() (*InlineResponse200150, *http.Response, error) {
...
func (a *CotermApiService) MoveOrganizationLicensingCotermLicensesExecute(r CotermApiMoveOrganizationLicensingCotermLicensesRequest) (*InlineResponse200150, *http.Response, error) {
	var (
