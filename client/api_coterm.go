...
func (r CotermApiGetOrganizationLicensingCotermLicensesRequest) Execute() ([]InlineResponse200275, *http.Response, error) {
...
func (a *CotermApiService) GetOrganizationLicensingCotermLicensesExecute(r CotermApiGetOrganizationLicensingCotermLicensesRequest) ([]InlineResponse200275, *http.Response, error) {
	var (
...
func (r CotermApiMoveOrganizationLicensingCotermLicensesRequest) MoveOrganizationLicensingCotermLicenses(moveOrganizationLicensingCotermLicenses InlineObject255) CotermApiMoveOrganizationLicensingCotermLicensesRequest {
	r.moveOrganizationLicensingCotermLicenses = &moveOrganizationLicensingCotermLicenses
	return r
}

func (r CotermApiMoveOrganizationLicensingCotermLicensesRequest) Execute() (*InlineResponse200276, *http.Response, error) {
...
func (a *CotermApiService) MoveOrganizationLicensingCotermLicensesExecute(r CotermApiMoveOrganizationLicensingCotermLicensesRequest) (*InlineResponse200276, *http.Response, error) {
	var (
