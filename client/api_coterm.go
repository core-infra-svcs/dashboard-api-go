...
func (r CotermApiGetOrganizationLicensingCotermLicensesRequest) Execute() ([]InlineResponse200178, *http.Response, error) {
...
func (a *CotermApiService) GetOrganizationLicensingCotermLicensesExecute(r CotermApiGetOrganizationLicensingCotermLicensesRequest) ([]InlineResponse200178, *http.Response, error) {
	var (
...
func (r CotermApiMoveOrganizationLicensingCotermLicensesRequest) MoveOrganizationLicensingCotermLicenses(moveOrganizationLicensingCotermLicenses InlineObject235) CotermApiMoveOrganizationLicensingCotermLicensesRequest {
	r.moveOrganizationLicensingCotermLicenses = &moveOrganizationLicensingCotermLicenses
	return r
}

func (r CotermApiMoveOrganizationLicensingCotermLicensesRequest) Execute() (*InlineResponse200179, *http.Response, error) {
...
func (a *CotermApiService) MoveOrganizationLicensingCotermLicensesExecute(r CotermApiMoveOrganizationLicensingCotermLicensesRequest) (*InlineResponse200179, *http.Response, error) {
	var (
