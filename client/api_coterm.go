...
func (r CotermApiGetOrganizationLicensingCotermLicensesRequest) Execute() ([]InlineResponse200156, *http.Response, error) {
...
func (a *CotermApiService) GetOrganizationLicensingCotermLicensesExecute(r CotermApiGetOrganizationLicensingCotermLicensesRequest) ([]InlineResponse200156, *http.Response, error) {
	var (
...
func (r CotermApiMoveOrganizationLicensingCotermLicensesRequest) MoveOrganizationLicensingCotermLicenses(moveOrganizationLicensingCotermLicenses InlineObject225) CotermApiMoveOrganizationLicensingCotermLicensesRequest {
	r.moveOrganizationLicensingCotermLicenses = &moveOrganizationLicensingCotermLicenses
	return r
}

func (r CotermApiMoveOrganizationLicensingCotermLicensesRequest) Execute() (*InlineResponse200157, *http.Response, error) {
...
func (a *CotermApiService) MoveOrganizationLicensingCotermLicensesExecute(r CotermApiMoveOrganizationLicensingCotermLicensesRequest) (*InlineResponse200157, *http.Response, error) {
	var (
