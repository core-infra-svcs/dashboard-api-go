...
func (o *InlineResponse200303) GetDevice() OrganizationsOrganizationIdWirelessDevicesPacketLossByDeviceDevice {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200303) GetDeviceOk() (*OrganizationsOrganizationIdWirelessDevicesPacketLossByDeviceDevice, bool) {
	if o == nil || isNil(o.Device) {
    return nil, false
	}
...
func (o *InlineResponse200303) HasDevice() bool {
	if o != nil && !isNil(o.Device) {
		return true
	}
...
func (o *InlineResponse200303) SetDevice(v OrganizationsOrganizationIdWirelessDevicesPacketLossByDeviceDevice) {
	o.Device = &v
}
