...
type InlineResponse200303 struct {
	...
	States *InlineResponse200303States `json:"states,omitempty"`
	// Data by license type (Per-device licensing only)
	LicenseTypes []InlineResponse200303LicenseTypes `json:"licenseTypes,omitempty"`
	SystemsManager *InlineResponse200303SystemsManager `json:"systemsManager,omitempty"`
}
...
func (o *InlineResponse200303) GetStates() InlineResponse200303States {
	if o == nil || isNil(o.States) {
		var ret InlineResponse200303States
		return ret
	}
	return *o.States
}
...
// SetStates gets a reference to the given InlineResponse200303States and assigns it to the States field.
...
func (o *InlineResponse200303) GetLicenseTypes() []InlineResponse200303LicenseTypes {
	if o == nil || isNil(o.LicenseTypes) {
		var ret []InlineResponse200303LicenseTypes
		return ret
	}
...
// SetLicenseTypes gets a reference to the given []InlineResponse200303LicenseTypes and assigns it to the LicenseTypes field.
...
func (o *InlineResponse200303) GetSystemsManager() InlineResponse200303SystemsManager {
	if o == nil || isNil(o.SystemsManager) {
		var ret InlineResponse200303SystemsManager
		return ret
	}
...
// SetSystemsManager gets a reference to the given InlineResponse200303SystemsManager and assigns it to the SystemsManager field.
