...
// InlineResponse200328MetaCountsItems The count metadata.
type InlineResponse200328MetaCountsItems struct {
...
func NewInlineResponse200328MetaCountsItems() *InlineResponse200328MetaCountsItems {
	this := InlineResponse200328MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200328MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200328MetaCountsItems struct {
	value *InlineResponse200328MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200328MetaCountsItems) Get() *InlineResponse200328MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200328MetaCountsItems) Set(val *InlineResponse200328MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200328MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200328MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200328MetaCountsItems(val *InlineResponse200328MetaCountsItems) *NullableInlineResponse200328MetaCountsItems {
	return &NullableInlineResponse200328MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200328MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200328MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
