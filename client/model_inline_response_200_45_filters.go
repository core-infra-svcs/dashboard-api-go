...
// InlineResponse20045Filters A hash of specific configuration data for the alert. Only filters specific to the alert will be updated.
type InlineResponse20045Filters struct {
	// Conditions
	Conditions []InlineResponse20045FiltersConditions `json:"conditions,omitempty"`
	// Failure Type
...
func NewInlineResponse20045Filters() *InlineResponse20045Filters {
	this := InlineResponse20045Filters{}
	return &this
}
...
func (o *InlineResponse20045Filters) GetConditions() []InlineResponse20045FiltersConditions {
	if o == nil || isNil(o.Conditions) {
		var ret []InlineResponse20045FiltersConditions
		return ret
	}
	return o.Conditions
}
...
// SetConditions gets a reference to the given []InlineResponse20045FiltersConditions and assigns it to the Conditions field.
...
func (o InlineResponse20045Filters) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20045Filters struct {
	value *InlineResponse20045Filters
	isSet bool
}

func (v NullableInlineResponse20045Filters) Get() *InlineResponse20045Filters {
	return v.value
}

func (v *NullableInlineResponse20045Filters) Set(val *InlineResponse20045Filters) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20045Filters) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20045Filters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20045Filters(val *InlineResponse20045Filters) *NullableInlineResponse20045Filters {
	return &NullableInlineResponse20045Filters{value: val, isSet: true}
}

func (v NullableInlineResponse20045Filters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20045Filters) UnmarshalJSON(src []byte) error {
	v.isSet = true
