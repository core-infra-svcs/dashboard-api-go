...
// InlineResponse20017ApplicationCategories struct for InlineResponse20017ApplicationCategories
type InlineResponse20017ApplicationCategories struct {
	// The id of the category
	Id *string `json:"id,omitempty"`
	// The name of the category
	Name *string `json:"name,omitempty"`
	// Details of the associated applications
	Applications []InlineResponse20017Applications `json:"applications,omitempty"`
}
...
func NewInlineResponse20017ApplicationCategories() *InlineResponse20017ApplicationCategories {
	this := InlineResponse20017ApplicationCategories{}
	return &this
}
...
func (o *InlineResponse20017ApplicationCategories) GetApplications() []InlineResponse20017Applications {
	if o == nil || isNil(o.Applications) {
		var ret []InlineResponse20017Applications
		return ret
	}
...
// SetApplications gets a reference to the given []InlineResponse20017Applications and assigns it to the Applications field.
func (o *InlineResponse20017ApplicationCategories) SetApplications(v []InlineResponse20017Applications) {
	o.Applications = v
}

func (o InlineResponse20017ApplicationCategories) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20017ApplicationCategories struct {
	value *InlineResponse20017ApplicationCategories
	isSet bool
}

func (v NullableInlineResponse20017ApplicationCategories) Get() *InlineResponse20017ApplicationCategories {
	return v.value
}

func (v *NullableInlineResponse20017ApplicationCategories) Set(val *InlineResponse20017ApplicationCategories) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20017ApplicationCategories) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20017ApplicationCategories) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20017ApplicationCategories(val *InlineResponse20017ApplicationCategories) *NullableInlineResponse20017ApplicationCategories {
	return &NullableInlineResponse20017ApplicationCategories{value: val, isSet: true}
}

func (v NullableInlineResponse20017ApplicationCategories) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20017ApplicationCategories) UnmarshalJSON(src []byte) error {
	v.isSet = true
