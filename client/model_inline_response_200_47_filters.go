...
// InlineResponse20047Filters A hash of specific configuration data for the alert. Only filters specific to the alert will be updated.
type InlineResponse20047Filters struct {
	// Conditions
	Conditions []InlineResponse20047FiltersConditions `json:"conditions,omitempty"`
	// Failure Type
...
func NewInlineResponse20047Filters() *InlineResponse20047Filters {
	this := InlineResponse20047Filters{}
	return &this
}
...
func (o *InlineResponse20047Filters) GetConditions() []InlineResponse20047FiltersConditions {
	if o == nil || isNil(o.Conditions) {
		var ret []InlineResponse20047FiltersConditions
		return ret
	}
	return o.Conditions
}
...
// SetConditions gets a reference to the given []InlineResponse20047FiltersConditions and assigns it to the Conditions field.
...
func (o InlineResponse20047Filters) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20047Filters struct {
	value *InlineResponse20047Filters
	isSet bool
}

func (v NullableInlineResponse20047Filters) Get() *InlineResponse20047Filters {
	return v.value
}

func (v *NullableInlineResponse20047Filters) Set(val *InlineResponse20047Filters) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20047Filters) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20047Filters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20047Filters(val *InlineResponse20047Filters) *NullableInlineResponse20047Filters {
	return &NullableInlineResponse20047Filters{value: val, isSet: true}
}

func (v NullableInlineResponse20047Filters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20047Filters) UnmarshalJSON(src []byte) error {
	v.isSet = true
