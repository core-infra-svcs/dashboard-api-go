...
// InlineResponse200392CountsClientsByStatus Client counts by their status
type InlineResponse200392CountsClientsByStatus struct {
...
func NewInlineResponse200392CountsClientsByStatus() *InlineResponse200392CountsClientsByStatus {
	this := InlineResponse200392CountsClientsByStatus{}
	return &this
}
...
func (o InlineResponse200392CountsClientsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200392CountsClientsByStatus struct {
	value *InlineResponse200392CountsClientsByStatus
	isSet bool
}

func (v NullableInlineResponse200392CountsClientsByStatus) Get() *InlineResponse200392CountsClientsByStatus {
	return v.value
}

func (v *NullableInlineResponse200392CountsClientsByStatus) Set(val *InlineResponse200392CountsClientsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200392CountsClientsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200392CountsClientsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200392CountsClientsByStatus(val *InlineResponse200392CountsClientsByStatus) *NullableInlineResponse200392CountsClientsByStatus {
	return &NullableInlineResponse200392CountsClientsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200392CountsClientsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200392CountsClientsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
