...
// InlineResponse20079Neighbors struct for InlineResponse20079Neighbors
type InlineResponse20079Neighbors struct {
	// The IPv4 address of the neighbor
	Ip *string `json:"ip,omitempty"`
	Ipv6 *InlineResponse20079Ipv6 `json:"ipv6,omitempty"`
	...
	TtlSecurity *InlineResponse20079TtlSecurity `json:"ttlSecurity,omitempty"`
	Authentication *InlineResponse20079Authentication `json:"authentication,omitempty"`
...
func NewInlineResponse20079Neighbors() *InlineResponse20079Neighbors {
	this := InlineResponse20079Neighbors{}
	return &this
}
...
func (o *InlineResponse20079Neighbors) GetIpv6() InlineResponse20079Ipv6 {
	if o == nil || isNil(o.Ipv6) {
		var ret InlineResponse20079Ipv6
		return ret
	}
	return *o.Ipv6
}
...
// SetIpv6 gets a reference to the given InlineResponse20079Ipv6 and assigns it to the Ipv6 field.
...
func (o *InlineResponse20079Neighbors) GetTtlSecurity() InlineResponse20079TtlSecurity {
	if o == nil || isNil(o.TtlSecurity) {
		var ret InlineResponse20079TtlSecurity
		return ret
	}
...
// SetTtlSecurity gets a reference to the given InlineResponse20079TtlSecurity and assigns it to the TtlSecurity field.
...
func (o *InlineResponse20079Neighbors) GetAuthentication() InlineResponse20079Authentication {
	if o == nil || isNil(o.Authentication) {
		var ret InlineResponse20079Authentication
		return ret
	}
...
// SetAuthentication gets a reference to the given InlineResponse20079Authentication and assigns it to the Authentication field.
...
func (o InlineResponse20079Neighbors) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20079Neighbors struct {
	value *InlineResponse20079Neighbors
	isSet bool
}

func (v NullableInlineResponse20079Neighbors) Get() *InlineResponse20079Neighbors {
	return v.value
}

func (v *NullableInlineResponse20079Neighbors) Set(val *InlineResponse20079Neighbors) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20079Neighbors) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20079Neighbors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20079Neighbors(val *InlineResponse20079Neighbors) *NullableInlineResponse20079Neighbors {
	return &NullableInlineResponse20079Neighbors{value: val, isSet: true}
}

func (v NullableInlineResponse20079Neighbors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20079Neighbors) UnmarshalJSON(src []byte) error {
	v.isSet = true
