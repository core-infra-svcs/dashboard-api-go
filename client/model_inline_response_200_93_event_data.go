...
// InlineResponse20093EventData An object containing more data related to the event.
type InlineResponse20093EventData struct {
...
func NewInlineResponse20093EventData() *InlineResponse20093EventData {
	this := InlineResponse20093EventData{}
	return &this
}
...
func (o InlineResponse20093EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20093EventData struct {
	value *InlineResponse20093EventData
	isSet bool
}

func (v NullableInlineResponse20093EventData) Get() *InlineResponse20093EventData {
	return v.value
}

func (v *NullableInlineResponse20093EventData) Set(val *InlineResponse20093EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20093EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20093EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20093EventData(val *InlineResponse20093EventData) *NullableInlineResponse20093EventData {
	return &NullableInlineResponse20093EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20093EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20093EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
