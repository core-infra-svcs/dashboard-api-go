...
// InlineResponse200210SplashImage The image used in the splash page.
type InlineResponse200210SplashImage struct {
...
func NewInlineResponse200210SplashImage() *InlineResponse200210SplashImage {
	this := InlineResponse200210SplashImage{}
	return &this
}
...
func (o InlineResponse200210SplashImage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200210SplashImage struct {
	value *InlineResponse200210SplashImage
	isSet bool
}

func (v NullableInlineResponse200210SplashImage) Get() *InlineResponse200210SplashImage {
	return v.value
}

func (v *NullableInlineResponse200210SplashImage) Set(val *InlineResponse200210SplashImage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200210SplashImage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200210SplashImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200210SplashImage(val *InlineResponse200210SplashImage) *NullableInlineResponse200210SplashImage {
	return &NullableInlineResponse200210SplashImage{value: val, isSet: true}
}

func (v NullableInlineResponse200210SplashImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200210SplashImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
