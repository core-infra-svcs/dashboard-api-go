...
// InlineResponse200344CountsByStatus Associated client count on access point by status.
type InlineResponse200344CountsByStatus struct {
	// Active client count.
...
func NewInlineResponse200344CountsByStatus() *InlineResponse200344CountsByStatus {
	this := InlineResponse200344CountsByStatus{}
	return &this
}
...
func (o InlineResponse200344CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200344CountsByStatus struct {
	value *InlineResponse200344CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200344CountsByStatus) Get() *InlineResponse200344CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200344CountsByStatus) Set(val *InlineResponse200344CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200344CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200344CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200344CountsByStatus(val *InlineResponse200344CountsByStatus) *NullableInlineResponse200344CountsByStatus {
	return &NullableInlineResponse200344CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200344CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200344CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
