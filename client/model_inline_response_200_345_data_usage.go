...
// InlineResponse200345DataUsage Usage data for the given interval.
type InlineResponse200345DataUsage struct {
...
func NewInlineResponse200345DataUsage() *InlineResponse200345DataUsage {
	this := InlineResponse200345DataUsage{}
	return &this
}
...
func (o InlineResponse200345DataUsage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200345DataUsage struct {
	value *InlineResponse200345DataUsage
	isSet bool
}

func (v NullableInlineResponse200345DataUsage) Get() *InlineResponse200345DataUsage {
	return v.value
}

func (v *NullableInlineResponse200345DataUsage) Set(val *InlineResponse200345DataUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200345DataUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200345DataUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200345DataUsage(val *InlineResponse200345DataUsage) *NullableInlineResponse200345DataUsage {
	return &NullableInlineResponse200345DataUsage{value: val, isSet: true}
}

func (v NullableInlineResponse200345DataUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200345DataUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
