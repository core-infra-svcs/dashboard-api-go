...
// InlineResponse200233MetaCountsItems Counts relating to the paginated items
type InlineResponse200233MetaCountsItems struct {
...
func NewInlineResponse200233MetaCountsItems() *InlineResponse200233MetaCountsItems {
	this := InlineResponse200233MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200233MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200233MetaCountsItems struct {
	value *InlineResponse200233MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200233MetaCountsItems) Get() *InlineResponse200233MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200233MetaCountsItems) Set(val *InlineResponse200233MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200233MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200233MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200233MetaCountsItems(val *InlineResponse200233MetaCountsItems) *NullableInlineResponse200233MetaCountsItems {
	return &NullableInlineResponse200233MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200233MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200233MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
