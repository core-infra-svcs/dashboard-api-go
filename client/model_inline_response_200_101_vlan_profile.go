...
// InlineResponse200101VlanProfile The VLAN Profile
type InlineResponse200101VlanProfile struct {
...
func NewInlineResponse200101VlanProfile() *InlineResponse200101VlanProfile {
	this := InlineResponse200101VlanProfile{}
	return &this
}
...
func (o InlineResponse200101VlanProfile) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200101VlanProfile struct {
	value *InlineResponse200101VlanProfile
	isSet bool
}

func (v NullableInlineResponse200101VlanProfile) Get() *InlineResponse200101VlanProfile {
	return v.value
}

func (v *NullableInlineResponse200101VlanProfile) Set(val *InlineResponse200101VlanProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200101VlanProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200101VlanProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200101VlanProfile(val *InlineResponse200101VlanProfile) *NullableInlineResponse200101VlanProfile {
	return &NullableInlineResponse200101VlanProfile{value: val, isSet: true}
}

func (v NullableInlineResponse200101VlanProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200101VlanProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
