...
func (r PortForwardingRulesApiGetDeviceCellularGatewayPortForwardingRulesRequest) Execute() (*InlineResponse20018, *http.Response, error) {
...
func (a *PortForwardingRulesApiService) GetDeviceCellularGatewayPortForwardingRulesExecute(r PortForwardingRulesApiGetDeviceCellularGatewayPortForwardingRulesRequest) (*InlineResponse20018, *http.Response, error) {
	var (
...
func (r PortForwardingRulesApiGetNetworkApplianceFirewallPortForwardingRulesRequest) Execute() (*InlineResponse20053, *http.Response, error) {
...
func (a *PortForwardingRulesApiService) GetNetworkApplianceFirewallPortForwardingRulesExecute(r PortForwardingRulesApiGetNetworkApplianceFirewallPortForwardingRulesRequest) (*InlineResponse20053, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PortForwardingRulesApiUpdateDeviceCellularGatewayPortForwardingRulesRequest) Execute() (*InlineResponse20018, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20018
func (a *PortForwardingRulesApiService) UpdateDeviceCellularGatewayPortForwardingRulesExecute(r PortForwardingRulesApiUpdateDeviceCellularGatewayPortForwardingRulesRequest) (*InlineResponse20018, *http.Response, error) {
	var (
...
func (r PortForwardingRulesApiUpdateNetworkApplianceFirewallPortForwardingRulesRequest) UpdateNetworkApplianceFirewallPortForwardingRules(updateNetworkApplianceFirewallPortForwardingRules InlineObject50) PortForwardingRulesApiUpdateNetworkApplianceFirewallPortForwardingRulesRequest {
	r.updateNetworkApplianceFirewallPortForwardingRules = &updateNetworkApplianceFirewallPortForwardingRules
	return r
}

func (r PortForwardingRulesApiUpdateNetworkApplianceFirewallPortForwardingRulesRequest) Execute() (*InlineResponse20053, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20053
func (a *PortForwardingRulesApiService) UpdateNetworkApplianceFirewallPortForwardingRulesExecute(r PortForwardingRulesApiUpdateNetworkApplianceFirewallPortForwardingRulesRequest) (*InlineResponse20053, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
