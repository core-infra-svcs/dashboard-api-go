...
func (r PortForwardingRulesApiGetDeviceCellularGatewayPortForwardingRulesRequest) Execute() (*InlineResponse20025, *http.Response, error) {
...
func (a *PortForwardingRulesApiService) GetDeviceCellularGatewayPortForwardingRulesExecute(r PortForwardingRulesApiGetDeviceCellularGatewayPortForwardingRulesRequest) (*InlineResponse20025, *http.Response, error) {
	var (
...
func (r PortForwardingRulesApiGetNetworkApplianceFirewallPortForwardingRulesRequest) Execute() (*InlineResponse20066, *http.Response, error) {
...
func (a *PortForwardingRulesApiService) GetNetworkApplianceFirewallPortForwardingRulesExecute(r PortForwardingRulesApiGetNetworkApplianceFirewallPortForwardingRulesRequest) (*InlineResponse20066, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PortForwardingRulesApiUpdateDeviceCellularGatewayPortForwardingRulesRequest) Execute() (*InlineResponse20025, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20025
func (a *PortForwardingRulesApiService) UpdateDeviceCellularGatewayPortForwardingRulesExecute(r PortForwardingRulesApiUpdateDeviceCellularGatewayPortForwardingRulesRequest) (*InlineResponse20025, *http.Response, error) {
	var (
...
func (r PortForwardingRulesApiUpdateNetworkApplianceFirewallPortForwardingRulesRequest) Execute() (*InlineResponse20066, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20066
func (a *PortForwardingRulesApiService) UpdateNetworkApplianceFirewallPortForwardingRulesExecute(r PortForwardingRulesApiUpdateNetworkApplianceFirewallPortForwardingRulesRequest) (*InlineResponse20066, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
