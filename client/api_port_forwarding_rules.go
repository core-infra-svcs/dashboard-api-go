...
func (r PortForwardingRulesApiGetDeviceCellularGatewayPortForwardingRulesRequest) Execute() (*InlineResponse20020, *http.Response, error) {
...
func (a *PortForwardingRulesApiService) GetDeviceCellularGatewayPortForwardingRulesExecute(r PortForwardingRulesApiGetDeviceCellularGatewayPortForwardingRulesRequest) (*InlineResponse20020, *http.Response, error) {
	var (
...
func (r PortForwardingRulesApiGetNetworkApplianceFirewallPortForwardingRulesRequest) Execute() (*InlineResponse20060, *http.Response, error) {
...
func (a *PortForwardingRulesApiService) GetNetworkApplianceFirewallPortForwardingRulesExecute(r PortForwardingRulesApiGetNetworkApplianceFirewallPortForwardingRulesRequest) (*InlineResponse20060, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PortForwardingRulesApiUpdateDeviceCellularGatewayPortForwardingRulesRequest) UpdateDeviceCellularGatewayPortForwardingRules(updateDeviceCellularGatewayPortForwardingRules InlineObject15) PortForwardingRulesApiUpdateDeviceCellularGatewayPortForwardingRulesRequest {
	r.updateDeviceCellularGatewayPortForwardingRules = &updateDeviceCellularGatewayPortForwardingRules
	return r
}

func (r PortForwardingRulesApiUpdateDeviceCellularGatewayPortForwardingRulesRequest) Execute() (*InlineResponse20020, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20020
func (a *PortForwardingRulesApiService) UpdateDeviceCellularGatewayPortForwardingRulesExecute(r PortForwardingRulesApiUpdateDeviceCellularGatewayPortForwardingRulesRequest) (*InlineResponse20020, *http.Response, error) {
	var (
...
func (r PortForwardingRulesApiUpdateNetworkApplianceFirewallPortForwardingRulesRequest) UpdateNetworkApplianceFirewallPortForwardingRules(updateNetworkApplianceFirewallPortForwardingRules InlineObject53) PortForwardingRulesApiUpdateNetworkApplianceFirewallPortForwardingRulesRequest {
	r.updateNetworkApplianceFirewallPortForwardingRules = &updateNetworkApplianceFirewallPortForwardingRules
	return r
}

func (r PortForwardingRulesApiUpdateNetworkApplianceFirewallPortForwardingRulesRequest) Execute() (*InlineResponse20060, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20060
func (a *PortForwardingRulesApiService) UpdateNetworkApplianceFirewallPortForwardingRulesExecute(r PortForwardingRulesApiUpdateNetworkApplianceFirewallPortForwardingRulesRequest) (*InlineResponse20060, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
