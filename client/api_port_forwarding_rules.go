...
func (r PortForwardingRulesApiGetNetworkApplianceFirewallPortForwardingRulesRequest) Execute() (*InlineResponse20051, *http.Response, error) {
...
func (a *PortForwardingRulesApiService) GetNetworkApplianceFirewallPortForwardingRulesExecute(r PortForwardingRulesApiGetNetworkApplianceFirewallPortForwardingRulesRequest) (*InlineResponse20051, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PortForwardingRulesApiUpdateNetworkApplianceFirewallPortForwardingRulesRequest) Execute() (*InlineResponse20051, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20051
func (a *PortForwardingRulesApiService) UpdateNetworkApplianceFirewallPortForwardingRulesExecute(r PortForwardingRulesApiUpdateNetworkApplianceFirewallPortForwardingRulesRequest) (*InlineResponse20051, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
