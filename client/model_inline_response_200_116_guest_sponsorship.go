...
// InlineResponse200116GuestSponsorship Details associated with guest sponsored splash
type InlineResponse200116GuestSponsorship struct {
...
func NewInlineResponse200116GuestSponsorship() *InlineResponse200116GuestSponsorship {
	this := InlineResponse200116GuestSponsorship{}
	return &this
}
...
func (o InlineResponse200116GuestSponsorship) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200116GuestSponsorship struct {
	value *InlineResponse200116GuestSponsorship
	isSet bool
}

func (v NullableInlineResponse200116GuestSponsorship) Get() *InlineResponse200116GuestSponsorship {
	return v.value
}

func (v *NullableInlineResponse200116GuestSponsorship) Set(val *InlineResponse200116GuestSponsorship) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200116GuestSponsorship) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200116GuestSponsorship) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200116GuestSponsorship(val *InlineResponse200116GuestSponsorship) *NullableInlineResponse200116GuestSponsorship {
	return &NullableInlineResponse200116GuestSponsorship{value: val, isSet: true}
}

func (v NullableInlineResponse200116GuestSponsorship) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200116GuestSponsorship) UnmarshalJSON(src []byte) error {
	v.isSet = true
