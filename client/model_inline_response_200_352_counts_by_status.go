...
// InlineResponse200352CountsByStatus Associated client count on access point by status
type InlineResponse200352CountsByStatus struct {
	// Active client count
...
func NewInlineResponse200352CountsByStatus() *InlineResponse200352CountsByStatus {
	this := InlineResponse200352CountsByStatus{}
	return &this
}
...
func (o InlineResponse200352CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200352CountsByStatus struct {
	value *InlineResponse200352CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200352CountsByStatus) Get() *InlineResponse200352CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200352CountsByStatus) Set(val *InlineResponse200352CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200352CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200352CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200352CountsByStatus(val *InlineResponse200352CountsByStatus) *NullableInlineResponse200352CountsByStatus {
	return &NullableInlineResponse200352CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200352CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200352CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
