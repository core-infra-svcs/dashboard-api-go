...
// InlineResponse20018Value1Destination Destination of 'custom' type traffic filter
type InlineResponse20018Value1Destination struct {
...
func NewInlineResponse20018Value1Destination() *InlineResponse20018Value1Destination {
	this := InlineResponse20018Value1Destination{}
	return &this
}
...
func (o InlineResponse20018Value1Destination) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20018Value1Destination struct {
	value *InlineResponse20018Value1Destination
	isSet bool
}

func (v NullableInlineResponse20018Value1Destination) Get() *InlineResponse20018Value1Destination {
	return v.value
}

func (v *NullableInlineResponse20018Value1Destination) Set(val *InlineResponse20018Value1Destination) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20018Value1Destination) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20018Value1Destination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20018Value1Destination(val *InlineResponse20018Value1Destination) *NullableInlineResponse20018Value1Destination {
	return &NullableInlineResponse20018Value1Destination{value: val, isSet: true}
}

func (v NullableInlineResponse20018Value1Destination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20018Value1Destination) UnmarshalJSON(src []byte) error {
	v.isSet = true
