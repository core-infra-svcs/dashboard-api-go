...
type OrganizationsOrganizationIdFloorPlansAutoLocateStatusesJobs struct {
	...
	Completed *InlineResponse200102Completed `json:"completed,omitempty"`
	Ranging *InlineResponse200102Ranging `json:"ranging,omitempty"`
	Gnss *InlineResponse200102Gnss `json:"gnss,omitempty"`
	// List of errors that occurred during a failed run of auto locate
	Errors []InlineResponse200102Errors `json:"errors,omitempty"`
}
...
func (o *OrganizationsOrganizationIdFloorPlansAutoLocateStatusesJobs) GetCompleted() InlineResponse200102Completed {
	if o == nil || isNil(o.Completed) {
		var ret InlineResponse200102Completed
		return ret
	}
	return *o.Completed
}
...
// SetCompleted gets a reference to the given InlineResponse200102Completed and assigns it to the Completed field.
...
func (o *OrganizationsOrganizationIdFloorPlansAutoLocateStatusesJobs) GetRanging() InlineResponse200102Ranging {
	if o == nil || isNil(o.Ranging) {
		var ret InlineResponse200102Ranging
		return ret
	}
	return *o.Ranging
}
...
// SetRanging gets a reference to the given InlineResponse200102Ranging and assigns it to the Ranging field.
...
func (o *OrganizationsOrganizationIdFloorPlansAutoLocateStatusesJobs) GetGnss() InlineResponse200102Gnss {
	if o == nil || isNil(o.Gnss) {
		var ret InlineResponse200102Gnss
		return ret
	}
	return *o.Gnss
}
...
// SetGnss gets a reference to the given InlineResponse200102Gnss and assigns it to the Gnss field.
...
func (o *OrganizationsOrganizationIdFloorPlansAutoLocateStatusesJobs) GetErrors() []InlineResponse200102Errors {
	if o == nil || isNil(o.Errors) {
		var ret []InlineResponse200102Errors
		return ret
	}
	return o.Errors
}
...
// SetErrors gets a reference to the given []InlineResponse200102Errors and assigns it to the Errors field.
