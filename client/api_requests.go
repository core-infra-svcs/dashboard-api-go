...
func (r RequestsApiCreateNetworkPiiRequestRequest) CreateNetworkPiiRequest(createNetworkPiiRequest InlineObject115) RequestsApiCreateNetworkPiiRequestRequest {
	r.createNetworkPiiRequest = &createNetworkPiiRequest
	return r
}

func (r RequestsApiCreateNetworkPiiRequestRequest) Execute() (*InlineResponse200113, *http.Response, error) {
...
func (a *RequestsApiService) CreateNetworkPiiRequestExecute(r RequestsApiCreateNetworkPiiRequestRequest) (*InlineResponse200113, *http.Response, error) {
	var (
...
func (r RequestsApiGetNetworkPiiRequestRequest) Execute() (*InlineResponse200113, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200113
func (a *RequestsApiService) GetNetworkPiiRequestExecute(r RequestsApiGetNetworkPiiRequestRequest) (*InlineResponse200113, *http.Response, error) {
	var (
...
func (r RequestsApiGetNetworkPiiRequestsRequest) Execute() ([]InlineResponse200113, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200113
func (a *RequestsApiService) GetNetworkPiiRequestsExecute(r RequestsApiGetNetworkPiiRequestsRequest) ([]InlineResponse200113, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
