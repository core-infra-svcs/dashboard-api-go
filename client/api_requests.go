...
func (r RequestsApiCreateNetworkPiiRequestRequest) CreateNetworkPiiRequest(createNetworkPiiRequest InlineObject113) RequestsApiCreateNetworkPiiRequestRequest {
	r.createNetworkPiiRequest = &createNetworkPiiRequest
	return r
}

func (r RequestsApiCreateNetworkPiiRequestRequest) Execute() (*InlineResponse200108, *http.Response, error) {
...
func (a *RequestsApiService) CreateNetworkPiiRequestExecute(r RequestsApiCreateNetworkPiiRequestRequest) (*InlineResponse200108, *http.Response, error) {
	var (
...
func (r RequestsApiGetNetworkPiiRequestRequest) Execute() (*InlineResponse200108, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200108
func (a *RequestsApiService) GetNetworkPiiRequestExecute(r RequestsApiGetNetworkPiiRequestRequest) (*InlineResponse200108, *http.Response, error) {
	var (
...
func (r RequestsApiGetNetworkPiiRequestsRequest) Execute() ([]InlineResponse200108, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200108
func (a *RequestsApiService) GetNetworkPiiRequestsExecute(r RequestsApiGetNetworkPiiRequestsRequest) ([]InlineResponse200108, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
