...
func (r RequestsApiCreateNetworkPiiRequestRequest) Execute() (*InlineResponse200103, *http.Response, error) {
...
func (a *RequestsApiService) CreateNetworkPiiRequestExecute(r RequestsApiCreateNetworkPiiRequestRequest) (*InlineResponse200103, *http.Response, error) {
	var (
...
func (r RequestsApiGetNetworkPiiRequestRequest) Execute() (*InlineResponse200103, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200103
func (a *RequestsApiService) GetNetworkPiiRequestExecute(r RequestsApiGetNetworkPiiRequestRequest) (*InlineResponse200103, *http.Response, error) {
	var (
...
func (r RequestsApiGetNetworkPiiRequestsRequest) Execute() ([]InlineResponse200103, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200103
func (a *RequestsApiService) GetNetworkPiiRequestsExecute(r RequestsApiGetNetworkPiiRequestsRequest) ([]InlineResponse200103, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
