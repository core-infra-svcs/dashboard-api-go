...
type InlineResponse20048 struct {
	// SSID status list
	BasicServiceSets []InlineResponse20048BasicServiceSets `json:"basicServiceSets,omitempty"`
}
...
func (o *InlineResponse20048) GetBasicServiceSets() []InlineResponse20048BasicServiceSets {
	if o == nil || isNil(o.BasicServiceSets) {
		var ret []InlineResponse20048BasicServiceSets
		return ret
	}
...
// SetBasicServiceSets gets a reference to the given []InlineResponse20048BasicServiceSets and assigns it to the BasicServiceSets field.
