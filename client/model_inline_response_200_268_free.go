...
// InlineResponse200268Free Information regarding memory availability on the device over the entire timespan
type InlineResponse200268Free struct {
...
func (o InlineResponse200268Free) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200268Free struct {
	value *InlineResponse200268Free
	isSet bool
}

func (v NullableInlineResponse200268Free) Get() *InlineResponse200268Free {
	return v.value
}

func (v *NullableInlineResponse200268Free) Set(val *InlineResponse200268Free) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200268Free) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200268Free) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200268Free(val *InlineResponse200268Free) *NullableInlineResponse200268Free {
	return &NullableInlineResponse200268Free{value: val, isSet: true}
}

func (v NullableInlineResponse200268Free) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200268Free) UnmarshalJSON(src []byte) error {
	v.isSet = true
