...
// InlineResponse200275Profiles struct for InlineResponse200275Profiles
type InlineResponse200275Profiles struct {
	...
	ServiceProvider *InlineResponse200275ServiceProvider `json:"serviceProvider,omitempty"`
}
...
func NewInlineResponse200275Profiles() *InlineResponse200275Profiles {
	this := InlineResponse200275Profiles{}
	return &this
}
...
func (o *InlineResponse200275Profiles) GetServiceProvider() InlineResponse200275ServiceProvider {
	if o == nil || isNil(o.ServiceProvider) {
		var ret InlineResponse200275ServiceProvider
		return ret
	}
...
// SetServiceProvider gets a reference to the given InlineResponse200275ServiceProvider and assigns it to the ServiceProvider field.
func (o *InlineResponse200275Profiles) SetServiceProvider(v InlineResponse200275ServiceProvider) {
	o.ServiceProvider = &v
}

func (o InlineResponse200275Profiles) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200275Profiles struct {
	value *InlineResponse200275Profiles
	isSet bool
}

func (v NullableInlineResponse200275Profiles) Get() *InlineResponse200275Profiles {
	return v.value
}

func (v *NullableInlineResponse200275Profiles) Set(val *InlineResponse200275Profiles) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200275Profiles) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200275Profiles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200275Profiles(val *InlineResponse200275Profiles) *NullableInlineResponse200275Profiles {
	return &NullableInlineResponse200275Profiles{value: val, isSet: true}
}

func (v NullableInlineResponse200275Profiles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200275Profiles) UnmarshalJSON(src []byte) error {
	v.isSet = true
