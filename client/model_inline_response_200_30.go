...
type InlineResponse20030 struct {
	...
	Entries []InlineResponse20030Entries `json:"entries,omitempty"`
...
func (o *InlineResponse20030) GetEntries() []InlineResponse20030Entries {
	if o == nil || isNil(o.Entries) {
		var ret []InlineResponse20030Entries
		return ret
	}
	return o.Entries
}
...
// SetEntries gets a reference to the given []InlineResponse20030Entries and assigns it to the Entries field.
