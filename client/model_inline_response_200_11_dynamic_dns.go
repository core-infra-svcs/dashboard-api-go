...
// InlineResponse20011DynamicDns Dynamic DNS settings for a network
type InlineResponse20011DynamicDns struct {
	// Dynamic DNS enabled
...
func NewInlineResponse20011DynamicDns() *InlineResponse20011DynamicDns {
	this := InlineResponse20011DynamicDns{}
	return &this
}
...
func (o InlineResponse20011DynamicDns) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20011DynamicDns struct {
	value *InlineResponse20011DynamicDns
	isSet bool
}

func (v NullableInlineResponse20011DynamicDns) Get() *InlineResponse20011DynamicDns {
	return v.value
}

func (v *NullableInlineResponse20011DynamicDns) Set(val *InlineResponse20011DynamicDns) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20011DynamicDns) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20011DynamicDns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20011DynamicDns(val *InlineResponse20011DynamicDns) *NullableInlineResponse20011DynamicDns {
	return &NullableInlineResponse20011DynamicDns{value: val, isSet: true}
}

func (v NullableInlineResponse20011DynamicDns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20011DynamicDns) UnmarshalJSON(src []byte) error {
	v.isSet = true
