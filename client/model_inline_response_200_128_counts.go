...
// InlineResponse200128Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse200128Counts struct {
	...
	Noise *InlineResponse200128CountsNoise `json:"noise,omitempty"`
...
func (o *InlineResponse200128Counts) GetNoise() InlineResponse200128CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse200128CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse200128CountsNoise and assigns it to the Noise field.
