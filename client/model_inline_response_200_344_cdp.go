...
// InlineResponse200344Cdp struct for InlineResponse200344Cdp
type InlineResponse200344Cdp struct {
...
func (o InlineResponse200344Cdp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200344Cdp struct {
	value *InlineResponse200344Cdp
	isSet bool
}

func (v NullableInlineResponse200344Cdp) Get() *InlineResponse200344Cdp {
	return v.value
}

func (v *NullableInlineResponse200344Cdp) Set(val *InlineResponse200344Cdp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200344Cdp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200344Cdp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200344Cdp(val *InlineResponse200344Cdp) *NullableInlineResponse200344Cdp {
	return &NullableInlineResponse200344Cdp{value: val, isSet: true}
}

func (v NullableInlineResponse200344Cdp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200344Cdp) UnmarshalJSON(src []byte) error {
	v.isSet = true
