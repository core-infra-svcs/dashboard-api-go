...
// InlineResponse200192Ranges struct for InlineResponse200192Ranges
type InlineResponse200192Ranges struct {
...
func NewInlineResponse200192Ranges(startDay string, startTime string, endDay string, endTime string) *InlineResponse200192Ranges {
	this := InlineResponse200192Ranges{}
...
func (o InlineResponse200192Ranges) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200192Ranges struct {
	value *InlineResponse200192Ranges
	isSet bool
}

func (v NullableInlineResponse200192Ranges) Get() *InlineResponse200192Ranges {
	return v.value
}

func (v *NullableInlineResponse200192Ranges) Set(val *InlineResponse200192Ranges) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200192Ranges) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200192Ranges) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200192Ranges(val *InlineResponse200192Ranges) *NullableInlineResponse200192Ranges {
	return &NullableInlineResponse200192Ranges{value: val, isSet: true}
}

func (v NullableInlineResponse200192Ranges) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200192Ranges) UnmarshalJSON(src []byte) error {
	v.isSet = true
