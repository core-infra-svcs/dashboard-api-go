...
// InlineResponse20031ProductsWirelessAvailableVersions struct for InlineResponse20031ProductsWirelessAvailableVersions
type InlineResponse20031ProductsWirelessAvailableVersions struct {
...
func NewInlineResponse20031ProductsWirelessAvailableVersions() *InlineResponse20031ProductsWirelessAvailableVersions {
	this := InlineResponse20031ProductsWirelessAvailableVersions{}
	return &this
}
...
func (o InlineResponse20031ProductsWirelessAvailableVersions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20031ProductsWirelessAvailableVersions struct {
	value *InlineResponse20031ProductsWirelessAvailableVersions
	isSet bool
}

func (v NullableInlineResponse20031ProductsWirelessAvailableVersions) Get() *InlineResponse20031ProductsWirelessAvailableVersions {
	return v.value
}

func (v *NullableInlineResponse20031ProductsWirelessAvailableVersions) Set(val *InlineResponse20031ProductsWirelessAvailableVersions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20031ProductsWirelessAvailableVersions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20031ProductsWirelessAvailableVersions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20031ProductsWirelessAvailableVersions(val *InlineResponse20031ProductsWirelessAvailableVersions) *NullableInlineResponse20031ProductsWirelessAvailableVersions {
	return &NullableInlineResponse20031ProductsWirelessAvailableVersions{value: val, isSet: true}
}

func (v NullableInlineResponse20031ProductsWirelessAvailableVersions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20031ProductsWirelessAvailableVersions) UnmarshalJSON(src []byte) error {
	v.isSet = true
