...
// InlineResponse20080Mappings struct for InlineResponse20080Mappings
type InlineResponse20080Mappings struct {
...
func NewInlineResponse20080Mappings() *InlineResponse20080Mappings {
	this := InlineResponse20080Mappings{}
	return &this
}
...
func (o InlineResponse20080Mappings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20080Mappings struct {
	value *InlineResponse20080Mappings
	isSet bool
}

func (v NullableInlineResponse20080Mappings) Get() *InlineResponse20080Mappings {
	return v.value
}

func (v *NullableInlineResponse20080Mappings) Set(val *InlineResponse20080Mappings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20080Mappings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20080Mappings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20080Mappings(val *InlineResponse20080Mappings) *NullableInlineResponse20080Mappings {
	return &NullableInlineResponse20080Mappings{value: val, isSet: true}
}

func (v NullableInlineResponse20080Mappings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20080Mappings) UnmarshalJSON(src []byte) error {
	v.isSet = true
