...
func (r RollbacksApiApiCreateNetworkFirmwareUpgradesRollbackRequest) CreateNetworkFirmwareUpgradesRollback(createNetworkFirmwareUpgradesRollback InlineObject76) RollbacksApiApiCreateNetworkFirmwareUpgradesRollbackRequest {
	r.createNetworkFirmwareUpgradesRollback = &createNetworkFirmwareUpgradesRollback
	return r
}

func (r RollbacksApiApiCreateNetworkFirmwareUpgradesRollbackRequest) Execute() (InlineResponse20016, *_nethttp.Response, error) {
...
func (a *RollbacksApiService) CreateNetworkFirmwareUpgradesRollbackExecute(r RollbacksApiApiCreateNetworkFirmwareUpgradesRollbackRequest) (InlineResponse20016, *_nethttp.Response, error) {
	var (
