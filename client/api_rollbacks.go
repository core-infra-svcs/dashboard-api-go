...
func (r RollbacksApiCreateNetworkFirmwareUpgradesRollbackRequest) Execute() (*InlineResponse200103, *http.Response, error) {
...
func (a *RollbacksApiService) CreateNetworkFirmwareUpgradesRollbackExecute(r RollbacksApiCreateNetworkFirmwareUpgradesRollbackRequest) (*InlineResponse200103, *http.Response, error) {
	var (
