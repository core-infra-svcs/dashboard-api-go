...
// InlineResponse200133IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200133IpsecPolicies struct {
...
func NewInlineResponse200133IpsecPolicies() *InlineResponse200133IpsecPolicies {
	this := InlineResponse200133IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200133IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200133IpsecPolicies struct {
	value *InlineResponse200133IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200133IpsecPolicies) Get() *InlineResponse200133IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200133IpsecPolicies) Set(val *InlineResponse200133IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200133IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200133IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200133IpsecPolicies(val *InlineResponse200133IpsecPolicies) *NullableInlineResponse200133IpsecPolicies {
	return &NullableInlineResponse200133IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200133IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200133IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
