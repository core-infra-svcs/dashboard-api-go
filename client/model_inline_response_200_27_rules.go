...
// InlineResponse20027Rules struct for InlineResponse20027Rules
type InlineResponse20027Rules struct {
...
func (o InlineResponse20027Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20027Rules struct {
	value *InlineResponse20027Rules
	isSet bool
}

func (v NullableInlineResponse20027Rules) Get() *InlineResponse20027Rules {
	return v.value
}

func (v *NullableInlineResponse20027Rules) Set(val *InlineResponse20027Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20027Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20027Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20027Rules(val *InlineResponse20027Rules) *NullableInlineResponse20027Rules {
	return &NullableInlineResponse20027Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20027Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20027Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
