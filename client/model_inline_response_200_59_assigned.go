...
// InlineResponse20059Assigned struct for InlineResponse20059Assigned
type InlineResponse20059Assigned struct {
	...
	TwoFourGhzSettings *InlineResponse20059TwoFourGhzSettings `json:"twoFourGhzSettings,omitempty"`
	FiveGhzSettings *InlineResponse20059FiveGhzSettings `json:"fiveGhzSettings,omitempty"`
	PerSsidSettings *InlineResponse20059PerSsidSettings `json:"perSsidSettings,omitempty"`
}
...
func NewInlineResponse20059Assigned() *InlineResponse20059Assigned {
	this := InlineResponse20059Assigned{}
	return &this
}
...
func (o *InlineResponse20059Assigned) GetTwoFourGhzSettings() InlineResponse20059TwoFourGhzSettings {
	if o == nil || isNil(o.TwoFourGhzSettings) {
		var ret InlineResponse20059TwoFourGhzSettings
		return ret
	}
...
// SetTwoFourGhzSettings gets a reference to the given InlineResponse20059TwoFourGhzSettings and assigns it to the TwoFourGhzSettings field.
...
func (o *InlineResponse20059Assigned) GetFiveGhzSettings() InlineResponse20059FiveGhzSettings {
	if o == nil || isNil(o.FiveGhzSettings) {
		var ret InlineResponse20059FiveGhzSettings
		return ret
	}
...
// SetFiveGhzSettings gets a reference to the given InlineResponse20059FiveGhzSettings and assigns it to the FiveGhzSettings field.
...
func (o *InlineResponse20059Assigned) GetPerSsidSettings() InlineResponse20059PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse20059PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse20059PerSsidSettings and assigns it to the PerSsidSettings field.
func (o *InlineResponse20059Assigned) SetPerSsidSettings(v InlineResponse20059PerSsidSettings) {
	o.PerSsidSettings = &v
}

func (o InlineResponse20059Assigned) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20059Assigned struct {
	value *InlineResponse20059Assigned
	isSet bool
}

func (v NullableInlineResponse20059Assigned) Get() *InlineResponse20059Assigned {
	return v.value
}

func (v *NullableInlineResponse20059Assigned) Set(val *InlineResponse20059Assigned) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20059Assigned) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20059Assigned) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20059Assigned(val *InlineResponse20059Assigned) *NullableInlineResponse20059Assigned {
	return &NullableInlineResponse20059Assigned{value: val, isSet: true}
}

func (v NullableInlineResponse20059Assigned) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20059Assigned) UnmarshalJSON(src []byte) error {
	v.isSet = true
