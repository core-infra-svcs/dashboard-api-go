...
func NewInlineObject174(profileId string) *InlineObject174 {
...
func (o *InlineObject174) GetProfileId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InlineObject174) GetProfileIdOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *InlineObject174) SetProfileId(v string) {
	o.ProfileId = v
}
