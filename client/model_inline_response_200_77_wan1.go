...
// InlineResponse20077Wan1 WAN 1 IP and subnet
type InlineResponse20077Wan1 struct {
...
func (o InlineResponse20077Wan1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20077Wan1 struct {
	value *InlineResponse20077Wan1
	isSet bool
}

func (v NullableInlineResponse20077Wan1) Get() *InlineResponse20077Wan1 {
	return v.value
}

func (v *NullableInlineResponse20077Wan1) Set(val *InlineResponse20077Wan1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20077Wan1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20077Wan1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20077Wan1(val *InlineResponse20077Wan1) *NullableInlineResponse20077Wan1 {
	return &NullableInlineResponse20077Wan1{value: val, isSet: true}
}

func (v NullableInlineResponse20077Wan1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20077Wan1) UnmarshalJSON(src []byte) error {
	v.isSet = true
