...
// InlineResponse200255Uplink Uplink setting of the cluster
type InlineResponse200255Uplink struct {
	// Name of the interface
	Interface *string `json:"interface,omitempty"`
	// VLAN of the interface
	Vlan *int32 `json:"vlan,omitempty"`
	// Addresses of the interface
	Addresses []InlineResponse200255UplinkAddresses `json:"addresses,omitempty"`
}
...
func NewInlineResponse200255Uplink() *InlineResponse200255Uplink {
	this := InlineResponse200255Uplink{}
	return &this
}
...
func (o *InlineResponse200255Uplink) GetAddresses() []InlineResponse200255UplinkAddresses {
	if o == nil || isNil(o.Addresses) {
		var ret []InlineResponse200255UplinkAddresses
		return ret
	}
	return o.Addresses
}
...
// SetAddresses gets a reference to the given []InlineResponse200255UplinkAddresses and assigns it to the Addresses field.
func (o *InlineResponse200255Uplink) SetAddresses(v []InlineResponse200255UplinkAddresses) {
	o.Addresses = v
}

func (o InlineResponse200255Uplink) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200255Uplink struct {
	value *InlineResponse200255Uplink
	isSet bool
}

func (v NullableInlineResponse200255Uplink) Get() *InlineResponse200255Uplink {
	return v.value
}

func (v *NullableInlineResponse200255Uplink) Set(val *InlineResponse200255Uplink) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200255Uplink) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200255Uplink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200255Uplink(val *InlineResponse200255Uplink) *NullableInlineResponse200255Uplink {
	return &NullableInlineResponse200255Uplink{value: val, isSet: true}
}

func (v NullableInlineResponse200255Uplink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200255Uplink) UnmarshalJSON(src []byte) error {
	v.isSet = true
