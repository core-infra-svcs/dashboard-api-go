...
type InlineResponse20019 struct {
	...
	ConnectionStats *InlineResponse20019ConnectionStats `json:"connectionStats,omitempty"`
}
...
func (o *InlineResponse20019) GetConnectionStats() InlineResponse20019ConnectionStats {
	if o == nil || isNil(o.ConnectionStats) {
		var ret InlineResponse20019ConnectionStats
		return ret
	}
...
// SetConnectionStats gets a reference to the given InlineResponse20019ConnectionStats and assigns it to the ConnectionStats field.
