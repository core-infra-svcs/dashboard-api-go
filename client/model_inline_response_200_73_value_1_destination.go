...
// InlineResponse20073Value1Destination Destination of 'custom' type traffic filter
type InlineResponse20073Value1Destination struct {
...
func NewInlineResponse20073Value1Destination() *InlineResponse20073Value1Destination {
	this := InlineResponse20073Value1Destination{}
	return &this
}
...
func (o InlineResponse20073Value1Destination) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20073Value1Destination struct {
	value *InlineResponse20073Value1Destination
	isSet bool
}

func (v NullableInlineResponse20073Value1Destination) Get() *InlineResponse20073Value1Destination {
	return v.value
}

func (v *NullableInlineResponse20073Value1Destination) Set(val *InlineResponse20073Value1Destination) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20073Value1Destination) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20073Value1Destination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20073Value1Destination(val *InlineResponse20073Value1Destination) *NullableInlineResponse20073Value1Destination {
	return &NullableInlineResponse20073Value1Destination{value: val, isSet: true}
}

func (v NullableInlineResponse20073Value1Destination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20073Value1Destination) UnmarshalJSON(src []byte) error {
	v.isSet = true
