...
// InlineResponse200114Rules struct for InlineResponse200114Rules
type InlineResponse200114Rules struct {
...
func NewInlineResponse200114Rules(definitions []NetworksNetworkIdApplianceTrafficShapingRulesDefinitions) *InlineResponse200114Rules {
	this := InlineResponse200114Rules{}
...
func (o InlineResponse200114Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200114Rules struct {
	value *InlineResponse200114Rules
	isSet bool
}

func (v NullableInlineResponse200114Rules) Get() *InlineResponse200114Rules {
	return v.value
}

func (v *NullableInlineResponse200114Rules) Set(val *InlineResponse200114Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200114Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200114Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200114Rules(val *InlineResponse200114Rules) *NullableInlineResponse200114Rules {
	return &NullableInlineResponse200114Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200114Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200114Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
