...
// InlineResponse200340MetaCountsItems Items
type InlineResponse200340MetaCountsItems struct {
...
func NewInlineResponse200340MetaCountsItems() *InlineResponse200340MetaCountsItems {
	this := InlineResponse200340MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200340MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200340MetaCountsItems struct {
	value *InlineResponse200340MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200340MetaCountsItems) Get() *InlineResponse200340MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200340MetaCountsItems) Set(val *InlineResponse200340MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200340MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200340MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200340MetaCountsItems(val *InlineResponse200340MetaCountsItems) *NullableInlineResponse200340MetaCountsItems {
	return &NullableInlineResponse200340MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200340MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200340MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
