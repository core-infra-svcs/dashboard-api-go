...
type InlineResponse200205 struct {
	...
	ApBandSettings *InlineResponse200205ApBandSettings `json:"apBandSettings,omitempty"`
	TwoFourGhzSettings *InlineResponse200205TwoFourGhzSettings `json:"twoFourGhzSettings,omitempty"`
	FiveGhzSettings *InlineResponse200205FiveGhzSettings `json:"fiveGhzSettings,omitempty"`
	SixGhzSettings *InlineResponse200205SixGhzSettings `json:"sixGhzSettings,omitempty"`
	Transmission *InlineResponse200205Transmission `json:"transmission,omitempty"`
	PerSsidSettings *InlineResponse200205PerSsidSettings `json:"perSsidSettings,omitempty"`
...
func (o *InlineResponse200205) GetApBandSettings() InlineResponse200205ApBandSettings {
	if o == nil || isNil(o.ApBandSettings) {
		var ret InlineResponse200205ApBandSettings
		return ret
	}
...
// SetApBandSettings gets a reference to the given InlineResponse200205ApBandSettings and assigns it to the ApBandSettings field.
...
func (o *InlineResponse200205) GetTwoFourGhzSettings() InlineResponse200205TwoFourGhzSettings {
	if o == nil || isNil(o.TwoFourGhzSettings) {
		var ret InlineResponse200205TwoFourGhzSettings
		return ret
	}
...
// SetTwoFourGhzSettings gets a reference to the given InlineResponse200205TwoFourGhzSettings and assigns it to the TwoFourGhzSettings field.
...
func (o *InlineResponse200205) GetFiveGhzSettings() InlineResponse200205FiveGhzSettings {
	if o == nil || isNil(o.FiveGhzSettings) {
		var ret InlineResponse200205FiveGhzSettings
		return ret
	}
...
// SetFiveGhzSettings gets a reference to the given InlineResponse200205FiveGhzSettings and assigns it to the FiveGhzSettings field.
...
func (o *InlineResponse200205) GetSixGhzSettings() InlineResponse200205SixGhzSettings {
	if o == nil || isNil(o.SixGhzSettings) {
		var ret InlineResponse200205SixGhzSettings
		return ret
	}
...
// SetSixGhzSettings gets a reference to the given InlineResponse200205SixGhzSettings and assigns it to the SixGhzSettings field.
...
func (o *InlineResponse200205) GetTransmission() InlineResponse200205Transmission {
	if o == nil || isNil(o.Transmission) {
		var ret InlineResponse200205Transmission
		return ret
	}
...
// SetTransmission gets a reference to the given InlineResponse200205Transmission and assigns it to the Transmission field.
...
func (o *InlineResponse200205) GetPerSsidSettings() InlineResponse200205PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse200205PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse200205PerSsidSettings and assigns it to the PerSsidSettings field.
