...
func (o *InlineObject205) GetEnabledNetworks() []string {
...
func (o *InlineObject205) GetEnabledNetworksOk() ([]string, bool) {
	if o == nil || isNil(o.EnabledNetworks) {
    return nil, false
	}
...
func (o *InlineObject205) HasEnabledNetworks() bool {
	if o != nil && !isNil(o.EnabledNetworks) {
		return true
	}
...
func (o *InlineObject205) SetEnabledNetworks(v []string) {
	o.EnabledNetworks = v
}
