...
type InlineObject205 struct {
	...
	Ranges []InlineResponse200216Ranges `json:"ranges,omitempty"`
	...
	RangesInSeconds []InlineResponse200216RangesInSeconds `json:"rangesInSeconds,omitempty"`
}
...
func (o *InlineObject205) GetRanges() []InlineResponse200216Ranges {
	if o == nil || isNil(o.Ranges) {
		var ret []InlineResponse200216Ranges
		return ret
	}
	return o.Ranges
}
...
// SetRanges gets a reference to the given []InlineResponse200216Ranges and assigns it to the Ranges field.
...
func (o *InlineObject205) GetRangesInSeconds() []InlineResponse200216RangesInSeconds {
	if o == nil || isNil(o.RangesInSeconds) {
		var ret []InlineResponse200216RangesInSeconds
		return ret
	}
...
// SetRangesInSeconds gets a reference to the given []InlineResponse200216RangesInSeconds and assigns it to the RangesInSeconds field.
