...
func (r L3FirewallRulesApiGetNetworkWirelessSsidFirewallL3FirewallRulesRequest) Execute() (*InlineResponse200211, *http.Response, error) {
...
func (a *L3FirewallRulesApiService) GetNetworkWirelessSsidFirewallL3FirewallRulesExecute(r L3FirewallRulesApiGetNetworkWirelessSsidFirewallL3FirewallRulesRequest) (*InlineResponse200211, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r L3FirewallRulesApiUpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest) Execute() (*InlineResponse200211, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200211
func (a *L3FirewallRulesApiService) UpdateNetworkWirelessSsidFirewallL3FirewallRulesExecute(r L3FirewallRulesApiUpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest) (*InlineResponse200211, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
