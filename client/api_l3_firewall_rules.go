...
func (r L3FirewallRulesApiGetNetworkWirelessSsidFirewallL3FirewallRulesRequest) Execute() (*InlineResponse200206, *http.Response, error) {
...
func (a *L3FirewallRulesApiService) GetNetworkWirelessSsidFirewallL3FirewallRulesExecute(r L3FirewallRulesApiGetNetworkWirelessSsidFirewallL3FirewallRulesRequest) (*InlineResponse200206, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r L3FirewallRulesApiUpdateNetworkApplianceFirewallL3FirewallRulesRequest) UpdateNetworkApplianceFirewallL3FirewallRules(updateNetworkApplianceFirewallL3FirewallRules InlineObject48) L3FirewallRulesApiUpdateNetworkApplianceFirewallL3FirewallRulesRequest {
...
func (r L3FirewallRulesApiUpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest) UpdateNetworkWirelessSsidFirewallL3FirewallRules(updateNetworkWirelessSsidFirewallL3FirewallRules InlineObject199) L3FirewallRulesApiUpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest {
	r.updateNetworkWirelessSsidFirewallL3FirewallRules = &updateNetworkWirelessSsidFirewallL3FirewallRules
	return r
}

func (r L3FirewallRulesApiUpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest) Execute() (*InlineResponse200206, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200206
func (a *L3FirewallRulesApiService) UpdateNetworkWirelessSsidFirewallL3FirewallRulesExecute(r L3FirewallRulesApiUpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest) (*InlineResponse200206, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
