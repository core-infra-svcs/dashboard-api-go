...
type InlineResponse200138 struct {
	...
	Restrictions []InlineResponse200138Restrictions `json:"restrictions,omitempty"`
}
...
func (o *InlineResponse200138) GetRestrictions() []InlineResponse200138Restrictions {
	if o == nil || isNil(o.Restrictions) {
		var ret []InlineResponse200138Restrictions
		return ret
	}
...
func (o *InlineResponse200138) GetRestrictionsOk() ([]InlineResponse200138Restrictions, bool) {
	if o == nil || isNil(o.Restrictions) {
    return nil, false
	}
...
func (o *InlineResponse200138) HasRestrictions() bool {
	if o != nil && !isNil(o.Restrictions) {
		return true
	}
...
// SetRestrictions gets a reference to the given []InlineResponse200138Restrictions and assigns it to the Restrictions field.
func (o *InlineResponse200138) SetRestrictions(v []InlineResponse200138Restrictions) {
	o.Restrictions = v
}
