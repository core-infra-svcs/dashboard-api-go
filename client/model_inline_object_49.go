...
func NewInlineObject49(rules []NetworksNetworkIdApplianceFirewallOneToOneNatRulesRules) *InlineObject49 {
	this := InlineObject49{}
	this.Rules = rules
	return &this
}
...
func (o *InlineObject49) GetRules() []NetworksNetworkIdApplianceFirewallOneToOneNatRulesRules {
	if o == nil {
...
func (o *InlineObject49) GetRulesOk() ([]NetworksNetworkIdApplianceFirewallOneToOneNatRulesRules, bool) {
	if o == nil {
    return nil, false
	}
	return o.Rules, true
...
func (o *InlineObject49) SetRules(v []NetworksNetworkIdApplianceFirewallOneToOneNatRulesRules) {
	o.Rules = v
}
