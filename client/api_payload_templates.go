...
func (r PayloadTemplatesApiCreateNetworkWebhooksPayloadTemplateRequest) CreateNetworkWebhooksPayloadTemplate(createNetworkWebhooksPayloadTemplate InlineObject164) PayloadTemplatesApiCreateNetworkWebhooksPayloadTemplateRequest {
	r.createNetworkWebhooksPayloadTemplate = &createNetworkWebhooksPayloadTemplate
	return r
}

func (r PayloadTemplatesApiCreateNetworkWebhooksPayloadTemplateRequest) Execute() (*InlineResponse200112, *http.Response, error) {
...
func (a *PayloadTemplatesApiService) CreateNetworkWebhooksPayloadTemplateExecute(r PayloadTemplatesApiCreateNetworkWebhooksPayloadTemplateRequest) (*InlineResponse200112, *http.Response, error) {
	var (
...
func (r PayloadTemplatesApiGetNetworkWebhooksPayloadTemplateRequest) Execute() (*InlineResponse200112, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200112
func (a *PayloadTemplatesApiService) GetNetworkWebhooksPayloadTemplateExecute(r PayloadTemplatesApiGetNetworkWebhooksPayloadTemplateRequest) (*InlineResponse200112, *http.Response, error) {
	var (
...
func (r PayloadTemplatesApiGetNetworkWebhooksPayloadTemplatesRequest) Execute() ([]InlineResponse200112, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200112
func (a *PayloadTemplatesApiService) GetNetworkWebhooksPayloadTemplatesExecute(r PayloadTemplatesApiGetNetworkWebhooksPayloadTemplatesRequest) ([]InlineResponse200112, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PayloadTemplatesApiUpdateNetworkWebhooksPayloadTemplateRequest) UpdateNetworkWebhooksPayloadTemplate(updateNetworkWebhooksPayloadTemplate InlineObject165) PayloadTemplatesApiUpdateNetworkWebhooksPayloadTemplateRequest {
	r.updateNetworkWebhooksPayloadTemplate = &updateNetworkWebhooksPayloadTemplate
	return r
}

func (r PayloadTemplatesApiUpdateNetworkWebhooksPayloadTemplateRequest) Execute() (*InlineResponse200112, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200112
func (a *PayloadTemplatesApiService) UpdateNetworkWebhooksPayloadTemplateExecute(r PayloadTemplatesApiUpdateNetworkWebhooksPayloadTemplateRequest) (*InlineResponse200112, *http.Response, error) {
	var (
