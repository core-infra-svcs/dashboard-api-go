...
func (r PayloadTemplatesApiCreateNetworkWebhooksPayloadTemplateRequest) Execute() (*InlineResponse20060, *http.Response, error) {
...
func (a *PayloadTemplatesApiService) CreateNetworkWebhooksPayloadTemplateExecute(r PayloadTemplatesApiCreateNetworkWebhooksPayloadTemplateRequest) (*InlineResponse20060, *http.Response, error) {
	var (
...
func (r PayloadTemplatesApiGetNetworkWebhooksPayloadTemplateRequest) Execute() (*InlineResponse20060, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20060
func (a *PayloadTemplatesApiService) GetNetworkWebhooksPayloadTemplateExecute(r PayloadTemplatesApiGetNetworkWebhooksPayloadTemplateRequest) (*InlineResponse20060, *http.Response, error) {
	var (
...
func (r PayloadTemplatesApiGetNetworkWebhooksPayloadTemplatesRequest) Execute() ([]InlineResponse20060, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20060
func (a *PayloadTemplatesApiService) GetNetworkWebhooksPayloadTemplatesExecute(r PayloadTemplatesApiGetNetworkWebhooksPayloadTemplatesRequest) ([]InlineResponse20060, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PayloadTemplatesApiUpdateNetworkWebhooksPayloadTemplateRequest) Execute() (*InlineResponse20060, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20060
func (a *PayloadTemplatesApiService) UpdateNetworkWebhooksPayloadTemplateExecute(r PayloadTemplatesApiUpdateNetworkWebhooksPayloadTemplateRequest) (*InlineResponse20060, *http.Response, error) {
	var (
