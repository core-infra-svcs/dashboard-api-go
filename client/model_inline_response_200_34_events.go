...
// InlineResponse20034Events struct for InlineResponse20034Events
type InlineResponse20034Events struct {
	...
	EventData *InlineResponse20034EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20034Events() *InlineResponse20034Events {
	this := InlineResponse20034Events{}
	return &this
}
...
func (o *InlineResponse20034Events) GetEventData() InlineResponse20034EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20034EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20034EventData and assigns it to the EventData field.
func (o *InlineResponse20034Events) SetEventData(v InlineResponse20034EventData) {
	o.EventData = &v
}

func (o InlineResponse20034Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20034Events struct {
	value *InlineResponse20034Events
	isSet bool
}

func (v NullableInlineResponse20034Events) Get() *InlineResponse20034Events {
	return v.value
}

func (v *NullableInlineResponse20034Events) Set(val *InlineResponse20034Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20034Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20034Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20034Events(val *InlineResponse20034Events) *NullableInlineResponse20034Events {
	return &NullableInlineResponse20034Events{value: val, isSet: true}
}

func (v NullableInlineResponse20034Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20034Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
