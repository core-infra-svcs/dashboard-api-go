...
// InlineResponse20025Value1Source Source of 'custom' type traffic filter
type InlineResponse20025Value1Source struct {
...
func NewInlineResponse20025Value1Source() *InlineResponse20025Value1Source {
	this := InlineResponse20025Value1Source{}
	return &this
}
...
func (o InlineResponse20025Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20025Value1Source struct {
	value *InlineResponse20025Value1Source
	isSet bool
}

func (v NullableInlineResponse20025Value1Source) Get() *InlineResponse20025Value1Source {
	return v.value
}

func (v *NullableInlineResponse20025Value1Source) Set(val *InlineResponse20025Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20025Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20025Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20025Value1Source(val *InlineResponse20025Value1Source) *NullableInlineResponse20025Value1Source {
	return &NullableInlineResponse20025Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20025Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20025Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
