...
// InlineResponse200126CountsByStatus byStatus
type InlineResponse200126CountsByStatus struct {
	// online count
...
func NewInlineResponse200126CountsByStatus() *InlineResponse200126CountsByStatus {
	this := InlineResponse200126CountsByStatus{}
	return &this
}
...
func (o InlineResponse200126CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200126CountsByStatus struct {
	value *InlineResponse200126CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200126CountsByStatus) Get() *InlineResponse200126CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200126CountsByStatus) Set(val *InlineResponse200126CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200126CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200126CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200126CountsByStatus(val *InlineResponse200126CountsByStatus) *NullableInlineResponse200126CountsByStatus {
	return &NullableInlineResponse200126CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200126CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200126CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
