...
// InlineResponse200258ServiceProviderPlans struct for InlineResponse200258ServiceProviderPlans
type InlineResponse200258ServiceProviderPlans struct {
	// Plan name
...
func NewInlineResponse200258ServiceProviderPlans() *InlineResponse200258ServiceProviderPlans {
	this := InlineResponse200258ServiceProviderPlans{}
	return &this
}
...
func (o InlineResponse200258ServiceProviderPlans) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200258ServiceProviderPlans struct {
	value *InlineResponse200258ServiceProviderPlans
	isSet bool
}

func (v NullableInlineResponse200258ServiceProviderPlans) Get() *InlineResponse200258ServiceProviderPlans {
	return v.value
}

func (v *NullableInlineResponse200258ServiceProviderPlans) Set(val *InlineResponse200258ServiceProviderPlans) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200258ServiceProviderPlans) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200258ServiceProviderPlans) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200258ServiceProviderPlans(val *InlineResponse200258ServiceProviderPlans) *NullableInlineResponse200258ServiceProviderPlans {
	return &NullableInlineResponse200258ServiceProviderPlans{value: val, isSet: true}
}

func (v NullableInlineResponse200258ServiceProviderPlans) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200258ServiceProviderPlans) UnmarshalJSON(src []byte) error {
	v.isSet = true
