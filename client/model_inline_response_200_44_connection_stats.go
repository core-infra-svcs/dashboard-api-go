...
// InlineResponse20044ConnectionStats The connection stats of the device
type InlineResponse20044ConnectionStats struct {
...
func NewInlineResponse20044ConnectionStats() *InlineResponse20044ConnectionStats {
	this := InlineResponse20044ConnectionStats{}
	return &this
}
...
func (o InlineResponse20044ConnectionStats) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20044ConnectionStats struct {
	value *InlineResponse20044ConnectionStats
	isSet bool
}

func (v NullableInlineResponse20044ConnectionStats) Get() *InlineResponse20044ConnectionStats {
	return v.value
}

func (v *NullableInlineResponse20044ConnectionStats) Set(val *InlineResponse20044ConnectionStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20044ConnectionStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20044ConnectionStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20044ConnectionStats(val *InlineResponse20044ConnectionStats) *NullableInlineResponse20044ConnectionStats {
	return &NullableInlineResponse20044ConnectionStats{value: val, isSet: true}
}

func (v NullableInlineResponse20044ConnectionStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20044ConnectionStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
