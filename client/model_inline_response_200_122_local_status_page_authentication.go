...
// InlineResponse200122LocalStatusPageAuthentication A hash of Local Status page(s)' authentication options applied to the Network.
type InlineResponse200122LocalStatusPageAuthentication struct {
...
func NewInlineResponse200122LocalStatusPageAuthentication() *InlineResponse200122LocalStatusPageAuthentication {
	this := InlineResponse200122LocalStatusPageAuthentication{}
	return &this
}
...
func (o InlineResponse200122LocalStatusPageAuthentication) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200122LocalStatusPageAuthentication struct {
	value *InlineResponse200122LocalStatusPageAuthentication
	isSet bool
}

func (v NullableInlineResponse200122LocalStatusPageAuthentication) Get() *InlineResponse200122LocalStatusPageAuthentication {
	return v.value
}

func (v *NullableInlineResponse200122LocalStatusPageAuthentication) Set(val *InlineResponse200122LocalStatusPageAuthentication) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200122LocalStatusPageAuthentication) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200122LocalStatusPageAuthentication) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200122LocalStatusPageAuthentication(val *InlineResponse200122LocalStatusPageAuthentication) *NullableInlineResponse200122LocalStatusPageAuthentication {
	return &NullableInlineResponse200122LocalStatusPageAuthentication{value: val, isSet: true}
}

func (v NullableInlineResponse200122LocalStatusPageAuthentication) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200122LocalStatusPageAuthentication) UnmarshalJSON(src []byte) error {
	v.isSet = true
