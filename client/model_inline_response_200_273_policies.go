...
// InlineResponse200273Policies struct for InlineResponse200273Policies
type InlineResponse200273Policies struct {
...
func NewInlineResponse200273Policies() *InlineResponse200273Policies {
	this := InlineResponse200273Policies{}
	return &this
}
...
func (o InlineResponse200273Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200273Policies struct {
	value *InlineResponse200273Policies
	isSet bool
}

func (v NullableInlineResponse200273Policies) Get() *InlineResponse200273Policies {
	return v.value
}

func (v *NullableInlineResponse200273Policies) Set(val *InlineResponse200273Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200273Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200273Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200273Policies(val *InlineResponse200273Policies) *NullableInlineResponse200273Policies {
	return &NullableInlineResponse200273Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200273Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200273Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
