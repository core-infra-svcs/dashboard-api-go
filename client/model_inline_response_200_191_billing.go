...
// InlineResponse200191Billing Details associated with billing splash
type InlineResponse200191Billing struct {
	FreeAccess *InlineResponse200191BillingFreeAccess `json:"freeAccess,omitempty"`
...
func NewInlineResponse200191Billing() *InlineResponse200191Billing {
	this := InlineResponse200191Billing{}
	return &this
}
...
func (o *InlineResponse200191Billing) GetFreeAccess() InlineResponse200191BillingFreeAccess {
	if o == nil || isNil(o.FreeAccess) {
		var ret InlineResponse200191BillingFreeAccess
		return ret
	}
	return *o.FreeAccess
}
...
// SetFreeAccess gets a reference to the given InlineResponse200191BillingFreeAccess and assigns it to the FreeAccess field.
...
func (o InlineResponse200191Billing) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200191Billing struct {
	value *InlineResponse200191Billing
	isSet bool
}

func (v NullableInlineResponse200191Billing) Get() *InlineResponse200191Billing {
	return v.value
}

func (v *NullableInlineResponse200191Billing) Set(val *InlineResponse200191Billing) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200191Billing) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200191Billing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200191Billing(val *InlineResponse200191Billing) *NullableInlineResponse200191Billing {
	return &NullableInlineResponse200191Billing{value: val, isSet: true}
}

func (v NullableInlineResponse200191Billing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200191Billing) UnmarshalJSON(src []byte) error {
	v.isSet = true
