...
func (o *InlineObject272) GetContent() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject272) GetContentOk() (*string, bool) {
	if o == nil || isNil(o.Content) {
    return nil, false
	}
...
func (o *InlineObject272) HasContent() bool {
	if o != nil && !isNil(o.Content) {
		return true
	}
...
func (o *InlineObject272) SetContent(v string) {
	o.Content = &v
}
