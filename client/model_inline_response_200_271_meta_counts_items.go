...
// InlineResponse200271MetaCountsItems Counts relating to the paginated items
type InlineResponse200271MetaCountsItems struct {
...
func NewInlineResponse200271MetaCountsItems() *InlineResponse200271MetaCountsItems {
	this := InlineResponse200271MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200271MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200271MetaCountsItems struct {
	value *InlineResponse200271MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200271MetaCountsItems) Get() *InlineResponse200271MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200271MetaCountsItems) Set(val *InlineResponse200271MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200271MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200271MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200271MetaCountsItems(val *InlineResponse200271MetaCountsItems) *NullableInlineResponse200271MetaCountsItems {
	return &NullableInlineResponse200271MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200271MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200271MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
