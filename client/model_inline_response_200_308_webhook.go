...
// InlineResponse200308Webhook The webhook receiver used by the callback to send results
type InlineResponse200308Webhook struct {
	// The webhook receiver URL where the callback will be sent
	Url *string `json:"url,omitempty"`
	HttpServer *InlineResponse200308WebhookHttpServer `json:"httpServer,omitempty"`
	PayloadTemplate *InlineResponse200308WebhookPayloadTemplate `json:"payloadTemplate,omitempty"`
...
func NewInlineResponse200308Webhook() *InlineResponse200308Webhook {
	this := InlineResponse200308Webhook{}
	return &this
}
...
func (o *InlineResponse200308Webhook) GetHttpServer() InlineResponse200308WebhookHttpServer {
	if o == nil || isNil(o.HttpServer) {
		var ret InlineResponse200308WebhookHttpServer
		return ret
	}
	return *o.HttpServer
}
...
// SetHttpServer gets a reference to the given InlineResponse200308WebhookHttpServer and assigns it to the HttpServer field.
...
func (o *InlineResponse200308Webhook) GetPayloadTemplate() InlineResponse200308WebhookPayloadTemplate {
	if o == nil || isNil(o.PayloadTemplate) {
		var ret InlineResponse200308WebhookPayloadTemplate
		return ret
	}
...
// SetPayloadTemplate gets a reference to the given InlineResponse200308WebhookPayloadTemplate and assigns it to the PayloadTemplate field.
...
func (o InlineResponse200308Webhook) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200308Webhook struct {
	value *InlineResponse200308Webhook
	isSet bool
}

func (v NullableInlineResponse200308Webhook) Get() *InlineResponse200308Webhook {
	return v.value
}

func (v *NullableInlineResponse200308Webhook) Set(val *InlineResponse200308Webhook) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200308Webhook) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200308Webhook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200308Webhook(val *InlineResponse200308Webhook) *NullableInlineResponse200308Webhook {
	return &NullableInlineResponse200308Webhook{value: val, isSet: true}
}

func (v NullableInlineResponse200308Webhook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200308Webhook) UnmarshalJSON(src []byte) error {
	v.isSet = true
