...
type InlineResponse200258 struct {
	...
	States *InlineResponse200258States `json:"states,omitempty"`
	// Data by license type (Per-device licensing only)
	LicenseTypes []InlineResponse200258LicenseTypes `json:"licenseTypes,omitempty"`
	SystemsManager *InlineResponse200258SystemsManager `json:"systemsManager,omitempty"`
}
...
func (o *InlineResponse200258) GetStates() InlineResponse200258States {
	if o == nil || isNil(o.States) {
		var ret InlineResponse200258States
		return ret
	}
	return *o.States
}
...
// SetStates gets a reference to the given InlineResponse200258States and assigns it to the States field.
...
func (o *InlineResponse200258) GetLicenseTypes() []InlineResponse200258LicenseTypes {
	if o == nil || isNil(o.LicenseTypes) {
		var ret []InlineResponse200258LicenseTypes
		return ret
	}
...
// SetLicenseTypes gets a reference to the given []InlineResponse200258LicenseTypes and assigns it to the LicenseTypes field.
...
func (o *InlineResponse200258) GetSystemsManager() InlineResponse200258SystemsManager {
	if o == nil || isNil(o.SystemsManager) {
		var ret InlineResponse200258SystemsManager
		return ret
	}
...
// SetSystemsManager gets a reference to the given InlineResponse200258SystemsManager and assigns it to the SystemsManager field.
