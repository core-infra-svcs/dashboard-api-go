...
type InlineResponse200258 struct {
	...
	Items []InlineResponse200258Items `json:"items,omitempty"`
...
// SetItems gets a reference to the given []InlineResponse200258Items and assigns it to the Items field.
