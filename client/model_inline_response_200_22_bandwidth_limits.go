...
// InlineResponse20022BandwidthLimits A hash uplink keys and their configured settings for the Appliance
type InlineResponse20022BandwidthLimits struct {
	Wan1 *InlineResponse20022BandwidthLimitsWan1 `json:"wan1,omitempty"`
	Wan2 *InlineResponse20022BandwidthLimitsWan2 `json:"wan2,omitempty"`
	Cellular *InlineResponse20022BandwidthLimitsCellular `json:"cellular,omitempty"`
}
...
func NewInlineResponse20022BandwidthLimits() *InlineResponse20022BandwidthLimits {
	this := InlineResponse20022BandwidthLimits{}
	return &this
}
...
func (o *InlineResponse20022BandwidthLimits) GetWan1() InlineResponse20022BandwidthLimitsWan1 {
	if o == nil || isNil(o.Wan1) {
		var ret InlineResponse20022BandwidthLimitsWan1
		return ret
	}
	return *o.Wan1
}
...
// SetWan1 gets a reference to the given InlineResponse20022BandwidthLimitsWan1 and assigns it to the Wan1 field.
...
func (o *InlineResponse20022BandwidthLimits) GetWan2() InlineResponse20022BandwidthLimitsWan2 {
	if o == nil || isNil(o.Wan2) {
		var ret InlineResponse20022BandwidthLimitsWan2
		return ret
	}
	return *o.Wan2
}
...
// SetWan2 gets a reference to the given InlineResponse20022BandwidthLimitsWan2 and assigns it to the Wan2 field.
...
func (o *InlineResponse20022BandwidthLimits) GetCellular() InlineResponse20022BandwidthLimitsCellular {
	if o == nil || isNil(o.Cellular) {
		var ret InlineResponse20022BandwidthLimitsCellular
		return ret
	}
	return *o.Cellular
}
...
// SetCellular gets a reference to the given InlineResponse20022BandwidthLimitsCellular and assigns it to the Cellular field.
func (o *InlineResponse20022BandwidthLimits) SetCellular(v InlineResponse20022BandwidthLimitsCellular) {
	o.Cellular = &v
}

func (o InlineResponse20022BandwidthLimits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20022BandwidthLimits struct {
	value *InlineResponse20022BandwidthLimits
	isSet bool
}

func (v NullableInlineResponse20022BandwidthLimits) Get() *InlineResponse20022BandwidthLimits {
	return v.value
}

func (v *NullableInlineResponse20022BandwidthLimits) Set(val *InlineResponse20022BandwidthLimits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20022BandwidthLimits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20022BandwidthLimits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20022BandwidthLimits(val *InlineResponse20022BandwidthLimits) *NullableInlineResponse20022BandwidthLimits {
	return &NullableInlineResponse20022BandwidthLimits{value: val, isSet: true}
}

func (v NullableInlineResponse20022BandwidthLimits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20022BandwidthLimits) UnmarshalJSON(src []byte) error {
	v.isSet = true
