...
// InlineResponse200255UsageOverall Overall data usage of all clients across organization
type InlineResponse200255UsageOverall struct {
...
func NewInlineResponse200255UsageOverall() *InlineResponse200255UsageOverall {
	this := InlineResponse200255UsageOverall{}
	return &this
}
...
func (o InlineResponse200255UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200255UsageOverall struct {
	value *InlineResponse200255UsageOverall
	isSet bool
}

func (v NullableInlineResponse200255UsageOverall) Get() *InlineResponse200255UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200255UsageOverall) Set(val *InlineResponse200255UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200255UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200255UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200255UsageOverall(val *InlineResponse200255UsageOverall) *NullableInlineResponse200255UsageOverall {
	return &NullableInlineResponse200255UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200255UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200255UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
