...
// InlineResponse20018ValueSource Source of 'custom' type traffic filter
type InlineResponse20018ValueSource struct {
...
func NewInlineResponse20018ValueSource() *InlineResponse20018ValueSource {
	this := InlineResponse20018ValueSource{}
	return &this
}
...
func (o InlineResponse20018ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20018ValueSource struct {
	value *InlineResponse20018ValueSource
	isSet bool
}

func (v NullableInlineResponse20018ValueSource) Get() *InlineResponse20018ValueSource {
	return v.value
}

func (v *NullableInlineResponse20018ValueSource) Set(val *InlineResponse20018ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20018ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20018ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20018ValueSource(val *InlineResponse20018ValueSource) *NullableInlineResponse20018ValueSource {
	return &NullableInlineResponse20018ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20018ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20018ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
