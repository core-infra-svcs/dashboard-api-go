...
type InlineResponse20068 struct {
	...
	Neighbors []InlineResponse20068Neighbors `json:"neighbors,omitempty"`
}
...
func (o *InlineResponse20068) GetNeighbors() []InlineResponse20068Neighbors {
	if o == nil || isNil(o.Neighbors) {
		var ret []InlineResponse20068Neighbors
		return ret
	}
	return o.Neighbors
}
...
// SetNeighbors gets a reference to the given []InlineResponse20068Neighbors and assigns it to the Neighbors field.
