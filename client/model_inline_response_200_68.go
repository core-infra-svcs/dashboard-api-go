...
type InlineResponse20068 struct {
	...
	NamedVlans *InlineResponse20068NamedVlans `json:"namedVlans,omitempty"`
}
...
func (o *InlineResponse20068) GetNamedVlans() InlineResponse20068NamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret InlineResponse20068NamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given InlineResponse20068NamedVlans and assigns it to the NamedVlans field.
