...
func (r PingApiCreateDeviceLiveToolsPingRequest) CreateDeviceLiveToolsPing(createDeviceLiveToolsPing InlineObject18) PingApiCreateDeviceLiveToolsPingRequest {
	r.createDeviceLiveToolsPing = &createDeviceLiveToolsPing
	return r
}

func (r PingApiCreateDeviceLiveToolsPingRequest) Execute() (*InlineResponse2013, *http.Response, error) {
...
func (a *PingApiService) CreateDeviceLiveToolsPingExecute(r PingApiCreateDeviceLiveToolsPingRequest) (*InlineResponse2013, *http.Response, error) {
	var (
...
func (r PingApiGetDeviceLiveToolsPingRequest) Execute() (*InlineResponse20021, *http.Response, error) {
...
func (a *PingApiService) GetDeviceLiveToolsPingExecute(r PingApiGetDeviceLiveToolsPingRequest) (*InlineResponse20021, *http.Response, error) {
	var (
