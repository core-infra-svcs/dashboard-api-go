...
func (r PingApiCreateDeviceLiveToolsPingRequest) CreateDeviceLiveToolsPing(createDeviceLiveToolsPing InlineObject20) PingApiCreateDeviceLiveToolsPingRequest {
	r.createDeviceLiveToolsPing = &createDeviceLiveToolsPing
	return r
}

func (r PingApiCreateDeviceLiveToolsPingRequest) Execute() (*InlineResponse2015, *http.Response, error) {
...
func (a *PingApiService) CreateDeviceLiveToolsPingExecute(r PingApiCreateDeviceLiveToolsPingRequest) (*InlineResponse2015, *http.Response, error) {
	var (
...
func (r PingApiGetDeviceLiveToolsPingRequest) Execute() (*InlineResponse20026, *http.Response, error) {
...
func (a *PingApiService) GetDeviceLiveToolsPingExecute(r PingApiGetDeviceLiveToolsPingRequest) (*InlineResponse20026, *http.Response, error) {
	var (
