...
func (r PingApiCreateDeviceLiveToolsPingRequest) CreateDeviceLiveToolsPing(createDeviceLiveToolsPing InlineObject16) PingApiCreateDeviceLiveToolsPingRequest {
...
func (r PingApiGetDeviceLiveToolsPingRequest) Execute() (*InlineResponse2006, *http.Response, error) {
...
func (a *PingApiService) GetDeviceLiveToolsPingExecute(r PingApiGetDeviceLiveToolsPingRequest) (*InlineResponse2006, *http.Response, error) {
	var (
