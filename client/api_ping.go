...
func (r PingApiGetDeviceLiveToolsPingRequest) Execute() (*InlineResponse20022, *http.Response, error) {
...
func (a *PingApiService) GetDeviceLiveToolsPingExecute(r PingApiGetDeviceLiveToolsPingRequest) (*InlineResponse20022, *http.Response, error) {
	var (
