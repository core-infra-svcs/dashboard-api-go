...
func (r PingApiCreateDeviceLiveToolsPingRequest) CreateDeviceLiveToolsPing(createDeviceLiveToolsPing InlineObject19) PingApiCreateDeviceLiveToolsPingRequest {
	r.createDeviceLiveToolsPing = &createDeviceLiveToolsPing
	return r
}

func (r PingApiCreateDeviceLiveToolsPingRequest) Execute() (*InlineResponse2014, *http.Response, error) {
...
func (a *PingApiService) CreateDeviceLiveToolsPingExecute(r PingApiCreateDeviceLiveToolsPingRequest) (*InlineResponse2014, *http.Response, error) {
	var (
...
func (r PingApiGetDeviceLiveToolsPingRequest) Execute() (*InlineResponse20025, *http.Response, error) {
...
func (a *PingApiService) GetDeviceLiveToolsPingExecute(r PingApiGetDeviceLiveToolsPingRequest) (*InlineResponse20025, *http.Response, error) {
	var (
