...
func (r PingApiGetDeviceLiveToolsPingRequest) Execute() (*InlineResponse20023, *http.Response, error) {
...
func (a *PingApiService) GetDeviceLiveToolsPingExecute(r PingApiGetDeviceLiveToolsPingRequest) (*InlineResponse20023, *http.Response, error) {
	var (
