...
type ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest struct {
	ctx context.Context
...
func (r ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest) SensorSerials(sensorSerials []string) ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest {
	r.sensorSerials = &sensorSerials
	return r
}

// The number of entries per page returned. Acceptable range is 3 - 1000. Default is 1000.
func (r ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest) PerPage(perPage int32) ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest {
	r.perPage = &perPage
	return r
}

// A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest) StartingAfter(startingAfter string) ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest {
	r.startingAfter = &startingAfter
	return r
}

// A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest) EndingBefore(endingBefore string) ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest {
	r.endingBefore = &endingBefore
	return r
}

func (r ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest) Execute() (*InlineResponse200342, *http.Response, error) {
...
Returns latest sensor-gateway connectivity data.
 ...
 @return ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest
*/
func (a *ConnectionsApiService) GetOrganizationSensorGatewaysConnectionsLatest(ctx context.Context, organizationId string) ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest {
	return ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *ConnectionsApiService) GetOrganizationSensorGatewaysConnectionsLatestExecute(r ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest) (*InlineResponse200342, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConnectionsApiService.GetOrganizationSensorGatewaysConnectionsLatest")
	if err != nil {
...
func (r ConnectionsApiGetOrganizationWirelessControllerConnectionsRequest) Execute() (*InlineResponse200408, *http.Response, error) {
...
func (a *ConnectionsApiService) GetOrganizationWirelessControllerConnectionsExecute(r ConnectionsApiGetOrganizationWirelessControllerConnectionsRequest) (*InlineResponse200408, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
