...
func (r ConnectionsApiGetOrganizationWirelessControllerConnectionsRequest) Execute() (*InlineResponse200380, *http.Response, error) {
...
func (a *ConnectionsApiService) GetOrganizationWirelessControllerConnectionsExecute(r ConnectionsApiGetOrganizationWirelessControllerConnectionsRequest) (*InlineResponse200380, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
