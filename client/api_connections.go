...
func (r ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest) Execute() (*InlineResponse200328, *http.Response, error) {
...
func (a *ConnectionsApiService) GetOrganizationSensorGatewaysConnectionsLatestExecute(r ConnectionsApiGetOrganizationSensorGatewaysConnectionsLatestRequest) (*InlineResponse200328, *http.Response, error) {
	var (
...
func (r ConnectionsApiGetOrganizationWirelessControllerConnectionsRequest) Execute() (*InlineResponse200392, *http.Response, error) {
...
func (a *ConnectionsApiService) GetOrganizationWirelessControllerConnectionsExecute(r ConnectionsApiGetOrganizationWirelessControllerConnectionsRequest) (*InlineResponse200392, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
