...
// InlineResponse20045AlertDestinations A hash of destinations for this specific alert
type InlineResponse20045AlertDestinations struct {
...
func NewInlineResponse20045AlertDestinations() *InlineResponse20045AlertDestinations {
	this := InlineResponse20045AlertDestinations{}
	return &this
}
...
func (o InlineResponse20045AlertDestinations) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20045AlertDestinations struct {
	value *InlineResponse20045AlertDestinations
	isSet bool
}

func (v NullableInlineResponse20045AlertDestinations) Get() *InlineResponse20045AlertDestinations {
	return v.value
}

func (v *NullableInlineResponse20045AlertDestinations) Set(val *InlineResponse20045AlertDestinations) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20045AlertDestinations) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20045AlertDestinations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20045AlertDestinations(val *InlineResponse20045AlertDestinations) *NullableInlineResponse20045AlertDestinations {
	return &NullableInlineResponse20045AlertDestinations{value: val, isSet: true}
}

func (v NullableInlineResponse20045AlertDestinations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20045AlertDestinations) UnmarshalJSON(src []byte) error {
	v.isSet = true
