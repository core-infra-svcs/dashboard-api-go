...
// InlineResponse200278Schedule Schedule of the packet capture
type InlineResponse200278Schedule struct {
...
func NewInlineResponse200278Schedule() *InlineResponse200278Schedule {
	this := InlineResponse200278Schedule{}
	return &this
}
...
func (o InlineResponse200278Schedule) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200278Schedule struct {
	value *InlineResponse200278Schedule
	isSet bool
}

func (v NullableInlineResponse200278Schedule) Get() *InlineResponse200278Schedule {
	return v.value
}

func (v *NullableInlineResponse200278Schedule) Set(val *InlineResponse200278Schedule) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200278Schedule) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200278Schedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200278Schedule(val *InlineResponse200278Schedule) *NullableInlineResponse200278Schedule {
	return &NullableInlineResponse200278Schedule{value: val, isSet: true}
}

func (v NullableInlineResponse200278Schedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200278Schedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
