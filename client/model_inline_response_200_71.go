...
type InlineResponse20071 struct {
	...
	SplashLogo *InlineResponse20071SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse20071SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse20071SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse20071GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse20071Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse20071SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse20071SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse20071) GetSplashLogo() InlineResponse20071SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse20071SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse20071SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse20071) GetSplashImage() InlineResponse20071SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse20071SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse20071SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse20071) GetSplashPrepaidFront() InlineResponse20071SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse20071SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse20071SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse20071) GetGuestSponsorship() InlineResponse20071GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse20071GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse20071GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse20071) GetBilling() InlineResponse20071Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse20071Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse20071Billing and assigns it to the Billing field.
...
func (o *InlineResponse20071) GetSentryEnrollment() InlineResponse20071SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse20071SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse20071SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse20071) GetSelfRegistration() InlineResponse20071SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse20071SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse20071SelfRegistration and assigns it to the SelfRegistration field.
