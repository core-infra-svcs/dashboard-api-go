...
type InlineResponse20071 struct {
	...
	ProtectedNetworks *InlineResponse20071ProtectedNetworks `json:"protectedNetworks,omitempty"`
}
...
func (o *InlineResponse20071) GetProtectedNetworks() InlineResponse20071ProtectedNetworks {
	if o == nil || isNil(o.ProtectedNetworks) {
		var ret InlineResponse20071ProtectedNetworks
		return ret
	}
...
// SetProtectedNetworks gets a reference to the given InlineResponse20071ProtectedNetworks and assigns it to the ProtectedNetworks field.
