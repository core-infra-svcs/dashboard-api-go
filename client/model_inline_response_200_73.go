...
type InlineResponse20073 struct {
	...
	Neighbors []InlineResponse20073Neighbors `json:"neighbors,omitempty"`
}
...
func (o *InlineResponse20073) GetNeighbors() []InlineResponse20073Neighbors {
	if o == nil || isNil(o.Neighbors) {
		var ret []InlineResponse20073Neighbors
		return ret
	}
	return o.Neighbors
}
...
// SetNeighbors gets a reference to the given []InlineResponse20073Neighbors and assigns it to the Neighbors field.
