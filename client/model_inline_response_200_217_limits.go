...
// InlineResponse200217Limits The current limits of various adaptive policy objects.
type InlineResponse200217Limits struct {
...
func NewInlineResponse200217Limits() *InlineResponse200217Limits {
	this := InlineResponse200217Limits{}
	return &this
}
...
func (o InlineResponse200217Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200217Limits struct {
	value *InlineResponse200217Limits
	isSet bool
}

func (v NullableInlineResponse200217Limits) Get() *InlineResponse200217Limits {
	return v.value
}

func (v *NullableInlineResponse200217Limits) Set(val *InlineResponse200217Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200217Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200217Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200217Limits(val *InlineResponse200217Limits) *NullableInlineResponse200217Limits {
	return &NullableInlineResponse200217Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200217Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200217Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
