...
// InlineResponse200286Free Information regarding memory availability on the device over the entire timespan
type InlineResponse200286Free struct {
...
func (o InlineResponse200286Free) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200286Free struct {
	value *InlineResponse200286Free
	isSet bool
}

func (v NullableInlineResponse200286Free) Get() *InlineResponse200286Free {
	return v.value
}

func (v *NullableInlineResponse200286Free) Set(val *InlineResponse200286Free) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200286Free) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200286Free) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200286Free(val *InlineResponse200286Free) *NullableInlineResponse200286Free {
	return &NullableInlineResponse200286Free{value: val, isSet: true}
}

func (v NullableInlineResponse200286Free) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200286Free) UnmarshalJSON(src []byte) error {
	v.isSet = true
