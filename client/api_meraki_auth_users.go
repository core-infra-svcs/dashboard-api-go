...
func (r MerakiAuthUsersApiCreateNetworkMerakiAuthUserRequest) CreateNetworkMerakiAuthUser(createNetworkMerakiAuthUser InlineObject100) MerakiAuthUsersApiCreateNetworkMerakiAuthUserRequest {
	r.createNetworkMerakiAuthUser = &createNetworkMerakiAuthUser
	return r
}

func (r MerakiAuthUsersApiCreateNetworkMerakiAuthUserRequest) Execute() (*InlineResponse20050, *http.Response, error) {
...
func (a *MerakiAuthUsersApiService) CreateNetworkMerakiAuthUserExecute(r MerakiAuthUsersApiCreateNetworkMerakiAuthUserRequest) (*InlineResponse20050, *http.Response, error) {
	var (
...
func (r MerakiAuthUsersApiGetNetworkMerakiAuthUserRequest) Execute() (*InlineResponse20050, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20050
func (a *MerakiAuthUsersApiService) GetNetworkMerakiAuthUserExecute(r MerakiAuthUsersApiGetNetworkMerakiAuthUserRequest) (*InlineResponse20050, *http.Response, error) {
	var (
...
func (r MerakiAuthUsersApiGetNetworkMerakiAuthUsersRequest) Execute() ([]InlineResponse20050, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20050
func (a *MerakiAuthUsersApiService) GetNetworkMerakiAuthUsersExecute(r MerakiAuthUsersApiGetNetworkMerakiAuthUsersRequest) ([]InlineResponse20050, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MerakiAuthUsersApiUpdateNetworkMerakiAuthUserRequest) UpdateNetworkMerakiAuthUser(updateNetworkMerakiAuthUser InlineObject101) MerakiAuthUsersApiUpdateNetworkMerakiAuthUserRequest {
	r.updateNetworkMerakiAuthUser = &updateNetworkMerakiAuthUser
	return r
}

func (r MerakiAuthUsersApiUpdateNetworkMerakiAuthUserRequest) Execute() (*InlineResponse20050, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20050
func (a *MerakiAuthUsersApiService) UpdateNetworkMerakiAuthUserExecute(r MerakiAuthUsersApiUpdateNetworkMerakiAuthUserRequest) (*InlineResponse20050, *http.Response, error) {
	var (
