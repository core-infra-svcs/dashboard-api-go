...
// InlineResponse200128IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200128IpsecPolicies struct {
...
func NewInlineResponse200128IpsecPolicies() *InlineResponse200128IpsecPolicies {
	this := InlineResponse200128IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200128IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200128IpsecPolicies struct {
	value *InlineResponse200128IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200128IpsecPolicies) Get() *InlineResponse200128IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200128IpsecPolicies) Set(val *InlineResponse200128IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200128IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200128IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200128IpsecPolicies(val *InlineResponse200128IpsecPolicies) *NullableInlineResponse200128IpsecPolicies {
	return &NullableInlineResponse200128IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200128IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200128IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
