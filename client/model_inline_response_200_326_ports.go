...
// InlineResponse200326Ports struct for InlineResponse200326Ports
type InlineResponse200326Ports struct {
	...
	SecurePort *InlineResponse200326SecurePort `json:"securePort,omitempty"`
}
...
func NewInlineResponse200326Ports() *InlineResponse200326Ports {
	this := InlineResponse200326Ports{}
	return &this
}
...
func (o *InlineResponse200326Ports) GetSecurePort() InlineResponse200326SecurePort {
	if o == nil || isNil(o.SecurePort) {
		var ret InlineResponse200326SecurePort
		return ret
	}
	return *o.SecurePort
}
...
// SetSecurePort gets a reference to the given InlineResponse200326SecurePort and assigns it to the SecurePort field.
func (o *InlineResponse200326Ports) SetSecurePort(v InlineResponse200326SecurePort) {
	o.SecurePort = &v
}

func (o InlineResponse200326Ports) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200326Ports struct {
	value *InlineResponse200326Ports
	isSet bool
}

func (v NullableInlineResponse200326Ports) Get() *InlineResponse200326Ports {
	return v.value
}

func (v *NullableInlineResponse200326Ports) Set(val *InlineResponse200326Ports) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200326Ports) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200326Ports) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200326Ports(val *InlineResponse200326Ports) *NullableInlineResponse200326Ports {
	return &NullableInlineResponse200326Ports{value: val, isSet: true}
}

func (v NullableInlineResponse200326Ports) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200326Ports) UnmarshalJSON(src []byte) error {
	v.isSet = true
