...
// InlineResponse20071Value Value of traffic filter
type InlineResponse20071Value struct {
	// Protocol of 'custom' type traffic filter. Must be one of: 'tcp', 'udp', 'icmp6' or 'any'
	Protocol *string `json:"protocol,omitempty"`
	Source InlineResponse20071ValueSource `json:"source"`
...
func (o *InlineResponse20071Value) GetSource() InlineResponse20071ValueSource {
	if o == nil {
		var ret InlineResponse20071ValueSource
		return ret
	}
...
func (o InlineResponse20071Value) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20071Value struct {
	value *InlineResponse20071Value
	isSet bool
}

func (v NullableInlineResponse20071Value) Get() *InlineResponse20071Value {
	return v.value
}

func (v *NullableInlineResponse20071Value) Set(val *InlineResponse20071Value) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20071Value) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20071Value) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20071Value(val *InlineResponse20071Value) *NullableInlineResponse20071Value {
	return &NullableInlineResponse20071Value{value: val, isSet: true}
}

func (v NullableInlineResponse20071Value) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20071Value) UnmarshalJSON(src []byte) error {
	v.isSet = true
