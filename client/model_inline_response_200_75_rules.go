...
// InlineResponse20075Rules struct for InlineResponse20075Rules
type InlineResponse20075Rules struct {
...
func (o InlineResponse20075Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20075Rules struct {
	value *InlineResponse20075Rules
	isSet bool
}

func (v NullableInlineResponse20075Rules) Get() *InlineResponse20075Rules {
	return v.value
}

func (v *NullableInlineResponse20075Rules) Set(val *InlineResponse20075Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20075Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20075Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20075Rules(val *InlineResponse20075Rules) *NullableInlineResponse20075Rules {
	return &NullableInlineResponse20075Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20075Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20075Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
