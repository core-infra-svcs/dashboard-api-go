...
// InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45 The count data for RJ45 ports, indexed by speed in Mb
type InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45 struct {
...
func NewInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45() *InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45 {
	this := InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45{}
	return &this
}
...
func (o InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45 struct {
	value *InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45
	isSet bool
}

func (v NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45) Get() *InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45 {
	return v.value
}

func (v *NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45) Set(val *InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45(val *InlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45) *NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45 {
	return &NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45{value: val, isSet: true}
}

func (v NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200338CountsByStatusActiveByMediaAndLinkSpeedRj45) UnmarshalJSON(src []byte) error {
	v.isSet = true
