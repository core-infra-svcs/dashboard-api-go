...
func NewInlineObject50(rules []NetworksNetworkIdApplianceFirewallMulticastForwardingRules) *InlineObject50 {
	this := InlineObject50{}
	this.Rules = rules
	return &this
}
...
func (o *InlineObject50) GetRules() []NetworksNetworkIdApplianceFirewallMulticastForwardingRules {
	if o == nil {
...
func (o *InlineObject50) GetRulesOk() ([]NetworksNetworkIdApplianceFirewallMulticastForwardingRules, bool) {
	if o == nil {
    return nil, false
	}
	return o.Rules, true
...
func (o *InlineObject50) SetRules(v []NetworksNetworkIdApplianceFirewallMulticastForwardingRules) {
	o.Rules = v
}
