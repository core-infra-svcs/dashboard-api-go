...
func (o *InlineResponse200283) GetFileData() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200283) GetFileDataOk() (*string, bool) {
	if o == nil || isNil(o.FileData) {
    return nil, false
	}
...
func (o *InlineResponse200283) HasFileData() bool {
	if o != nil && !isNil(o.FileData) {
		return true
	}
...
func (o *InlineResponse200283) SetFileData(v string) {
	o.FileData = &v
}
