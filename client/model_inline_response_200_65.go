...
type InlineResponse20065 struct {
	...
	MandatoryDhcp *InlineResponse20065MandatoryDhcp `json:"mandatoryDhcp,omitempty"`
	Ipv6 *InlineResponse20065Ipv6 `json:"ipv6,omitempty"`
}
...
func (o *InlineResponse20065) GetMandatoryDhcp() InlineResponse20065MandatoryDhcp {
	if o == nil || isNil(o.MandatoryDhcp) {
		var ret InlineResponse20065MandatoryDhcp
		return ret
	}
...
// SetMandatoryDhcp gets a reference to the given InlineResponse20065MandatoryDhcp and assigns it to the MandatoryDhcp field.
...
func (o *InlineResponse20065) GetIpv6() InlineResponse20065Ipv6 {
	if o == nil || isNil(o.Ipv6) {
		var ret InlineResponse20065Ipv6
		return ret
	}
	return *o.Ipv6
}
...
// SetIpv6 gets a reference to the given InlineResponse20065Ipv6 and assigns it to the Ipv6 field.
