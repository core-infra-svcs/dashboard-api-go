...
type InlineResponse200338Items struct {
	...
	Intervals []InlineResponse200338Intervals `json:"intervals,omitempty"`
}
...
func (o *InlineResponse200338Items) GetIntervals() []InlineResponse200338Intervals {
	if o == nil || isNil(o.Intervals) {
		var ret []InlineResponse200338Intervals
		return ret
	}
	return o.Intervals
}
...
// SetIntervals gets a reference to the given []InlineResponse200338Intervals and assigns it to the Intervals field.
