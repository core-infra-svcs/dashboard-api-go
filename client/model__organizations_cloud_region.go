...
type OrganizationsCloudRegion struct {
	...
	Host *OrganizationsCloudRegionHost `json:"host,omitempty"`
}
...
func (o *OrganizationsCloudRegion) GetHost() OrganizationsCloudRegionHost {
	if o == nil || isNil(o.Host) {
		var ret OrganizationsCloudRegionHost
		return ret
	}
	return *o.Host
}
...
// SetHost gets a reference to the given OrganizationsCloudRegionHost and assigns it to the Host field.
