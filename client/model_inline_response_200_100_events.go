...
// InlineResponse200100Events struct for InlineResponse200100Events
type InlineResponse200100Events struct {
	...
	EventData *InlineResponse200100EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse200100Events() *InlineResponse200100Events {
	this := InlineResponse200100Events{}
	return &this
}
...
func (o *InlineResponse200100Events) GetEventData() InlineResponse200100EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse200100EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse200100EventData and assigns it to the EventData field.
func (o *InlineResponse200100Events) SetEventData(v InlineResponse200100EventData) {
	o.EventData = &v
}

func (o InlineResponse200100Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200100Events struct {
	value *InlineResponse200100Events
	isSet bool
}

func (v NullableInlineResponse200100Events) Get() *InlineResponse200100Events {
	return v.value
}

func (v *NullableInlineResponse200100Events) Set(val *InlineResponse200100Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200100Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200100Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200100Events(val *InlineResponse200100Events) *NullableInlineResponse200100Events {
	return &NullableInlineResponse200100Events{value: val, isSet: true}
}

func (v NullableInlineResponse200100Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200100Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
