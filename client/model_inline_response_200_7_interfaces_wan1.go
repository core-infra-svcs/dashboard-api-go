...
// InlineResponse2007InterfacesWan1 WAN 1 settings.
type InlineResponse2007InterfacesWan1 struct {
...
func NewInlineResponse2007InterfacesWan1() *InlineResponse2007InterfacesWan1 {
	this := InlineResponse2007InterfacesWan1{}
	return &this
}
...
func (o InlineResponse2007InterfacesWan1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2007InterfacesWan1 struct {
	value *InlineResponse2007InterfacesWan1
	isSet bool
}

func (v NullableInlineResponse2007InterfacesWan1) Get() *InlineResponse2007InterfacesWan1 {
	return v.value
}

func (v *NullableInlineResponse2007InterfacesWan1) Set(val *InlineResponse2007InterfacesWan1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2007InterfacesWan1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2007InterfacesWan1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2007InterfacesWan1(val *InlineResponse2007InterfacesWan1) *NullableInlineResponse2007InterfacesWan1 {
	return &NullableInlineResponse2007InterfacesWan1{value: val, isSet: true}
}

func (v NullableInlineResponse2007InterfacesWan1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2007InterfacesWan1) UnmarshalJSON(src []byte) error {
	v.isSet = true
