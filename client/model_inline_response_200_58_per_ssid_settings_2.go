...
// InlineResponse20058PerSsidSettings2 Settings for SSID 2.
type InlineResponse20058PerSsidSettings2 struct {
...
func NewInlineResponse20058PerSsidSettings2() *InlineResponse20058PerSsidSettings2 {
	this := InlineResponse20058PerSsidSettings2{}
	return &this
}
...
func (o InlineResponse20058PerSsidSettings2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20058PerSsidSettings2 struct {
	value *InlineResponse20058PerSsidSettings2
	isSet bool
}

func (v NullableInlineResponse20058PerSsidSettings2) Get() *InlineResponse20058PerSsidSettings2 {
	return v.value
}

func (v *NullableInlineResponse20058PerSsidSettings2) Set(val *InlineResponse20058PerSsidSettings2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20058PerSsidSettings2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20058PerSsidSettings2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20058PerSsidSettings2(val *InlineResponse20058PerSsidSettings2) *NullableInlineResponse20058PerSsidSettings2 {
	return &NullableInlineResponse20058PerSsidSettings2{value: val, isSet: true}
}

func (v NullableInlineResponse20058PerSsidSettings2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20058PerSsidSettings2) UnmarshalJSON(src []byte) error {
	v.isSet = true
