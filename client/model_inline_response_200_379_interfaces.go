...
// InlineResponse200379Interfaces struct for InlineResponse200379Interfaces
type InlineResponse200379Interfaces struct {
...
func NewInlineResponse200379Interfaces() *InlineResponse200379Interfaces {
	this := InlineResponse200379Interfaces{}
	return &this
}
...
func (o InlineResponse200379Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200379Interfaces struct {
	value *InlineResponse200379Interfaces
	isSet bool
}

func (v NullableInlineResponse200379Interfaces) Get() *InlineResponse200379Interfaces {
	return v.value
}

func (v *NullableInlineResponse200379Interfaces) Set(val *InlineResponse200379Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200379Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200379Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200379Interfaces(val *InlineResponse200379Interfaces) *NullableInlineResponse200379Interfaces {
	return &NullableInlineResponse200379Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200379Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200379Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
