...
// InlineResponse200199SentryEnrollment Systems Manager sentry enrollment splash settings.
type InlineResponse200199SentryEnrollment struct {
	SystemsManagerNetwork *InlineResponse200199SentryEnrollmentSystemsManagerNetwork `json:"systemsManagerNetwork,omitempty"`
...
func NewInlineResponse200199SentryEnrollment() *InlineResponse200199SentryEnrollment {
	this := InlineResponse200199SentryEnrollment{}
	return &this
}
...
func (o *InlineResponse200199SentryEnrollment) GetSystemsManagerNetwork() InlineResponse200199SentryEnrollmentSystemsManagerNetwork {
	if o == nil || isNil(o.SystemsManagerNetwork) {
		var ret InlineResponse200199SentryEnrollmentSystemsManagerNetwork
		return ret
	}
...
// SetSystemsManagerNetwork gets a reference to the given InlineResponse200199SentryEnrollmentSystemsManagerNetwork and assigns it to the SystemsManagerNetwork field.
...
func (o InlineResponse200199SentryEnrollment) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200199SentryEnrollment struct {
	value *InlineResponse200199SentryEnrollment
	isSet bool
}

func (v NullableInlineResponse200199SentryEnrollment) Get() *InlineResponse200199SentryEnrollment {
	return v.value
}

func (v *NullableInlineResponse200199SentryEnrollment) Set(val *InlineResponse200199SentryEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200199SentryEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200199SentryEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200199SentryEnrollment(val *InlineResponse200199SentryEnrollment) *NullableInlineResponse200199SentryEnrollment {
	return &NullableInlineResponse200199SentryEnrollment{value: val, isSet: true}
}

func (v NullableInlineResponse200199SentryEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200199SentryEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
