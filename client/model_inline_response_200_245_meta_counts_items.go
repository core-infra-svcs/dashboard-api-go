...
// InlineResponse200245MetaCountsItems Counts relating to the paginated items
type InlineResponse200245MetaCountsItems struct {
...
func NewInlineResponse200245MetaCountsItems() *InlineResponse200245MetaCountsItems {
	this := InlineResponse200245MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200245MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200245MetaCountsItems struct {
	value *InlineResponse200245MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200245MetaCountsItems) Get() *InlineResponse200245MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200245MetaCountsItems) Set(val *InlineResponse200245MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200245MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200245MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200245MetaCountsItems(val *InlineResponse200245MetaCountsItems) *NullableInlineResponse200245MetaCountsItems {
	return &NullableInlineResponse200245MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200245MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200245MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
