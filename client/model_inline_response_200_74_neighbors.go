...
// InlineResponse20074Neighbors struct for InlineResponse20074Neighbors
type InlineResponse20074Neighbors struct {
	...
	TtlSecurity *InlineResponse20074TtlSecurity `json:"ttlSecurity,omitempty"`
	Authentication *InlineResponse20074Authentication `json:"authentication,omitempty"`
}
...
func NewInlineResponse20074Neighbors() *InlineResponse20074Neighbors {
	this := InlineResponse20074Neighbors{}
	return &this
}
...
func (o *InlineResponse20074Neighbors) GetTtlSecurity() InlineResponse20074TtlSecurity {
	if o == nil || isNil(o.TtlSecurity) {
		var ret InlineResponse20074TtlSecurity
		return ret
	}
...
// SetTtlSecurity gets a reference to the given InlineResponse20074TtlSecurity and assigns it to the TtlSecurity field.
...
func (o *InlineResponse20074Neighbors) GetAuthentication() InlineResponse20074Authentication {
	if o == nil || isNil(o.Authentication) {
		var ret InlineResponse20074Authentication
		return ret
	}
...
// SetAuthentication gets a reference to the given InlineResponse20074Authentication and assigns it to the Authentication field.
func (o *InlineResponse20074Neighbors) SetAuthentication(v InlineResponse20074Authentication) {
	o.Authentication = &v
}

func (o InlineResponse20074Neighbors) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20074Neighbors struct {
	value *InlineResponse20074Neighbors
	isSet bool
}

func (v NullableInlineResponse20074Neighbors) Get() *InlineResponse20074Neighbors {
	return v.value
}

func (v *NullableInlineResponse20074Neighbors) Set(val *InlineResponse20074Neighbors) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20074Neighbors) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20074Neighbors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20074Neighbors(val *InlineResponse20074Neighbors) *NullableInlineResponse20074Neighbors {
	return &NullableInlineResponse20074Neighbors{value: val, isSet: true}
}

func (v NullableInlineResponse20074Neighbors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20074Neighbors) UnmarshalJSON(src []byte) error {
	v.isSet = true
