...
func (r StpApiGetNetworkSwitchStpRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
func (a *StpApiService) GetNetworkSwitchStpExecute(r StpApiGetNetworkSwitchStpRequest) (*InlineResponse200159, *http.Response, error) {
	var (
...
func (r StpApiUpdateNetworkSwitchStpRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200159
func (a *StpApiService) UpdateNetworkSwitchStpExecute(r StpApiUpdateNetworkSwitchStpRequest) (*InlineResponse200159, *http.Response, error) {
	var (
