...
func (r StpApiGetNetworkSwitchStpRequest) Execute() (*InlineResponse200177, *http.Response, error) {
...
func (a *StpApiService) GetNetworkSwitchStpExecute(r StpApiGetNetworkSwitchStpRequest) (*InlineResponse200177, *http.Response, error) {
	var (
...
func (r StpApiUpdateNetworkSwitchStpRequest) Execute() (*InlineResponse200177, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200177
func (a *StpApiService) UpdateNetworkSwitchStpExecute(r StpApiUpdateNetworkSwitchStpRequest) (*InlineResponse200177, *http.Response, error) {
	var (
