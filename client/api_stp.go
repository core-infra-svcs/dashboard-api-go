...
func (r StpApiGetNetworkSwitchStpRequest) Execute() (*InlineResponse200172, *http.Response, error) {
...
func (a *StpApiService) GetNetworkSwitchStpExecute(r StpApiGetNetworkSwitchStpRequest) (*InlineResponse200172, *http.Response, error) {
	var (
...
func (r StpApiUpdateNetworkSwitchStpRequest) Execute() (*InlineResponse200172, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200172
func (a *StpApiService) UpdateNetworkSwitchStpExecute(r StpApiUpdateNetworkSwitchStpRequest) (*InlineResponse200172, *http.Response, error) {
	var (
