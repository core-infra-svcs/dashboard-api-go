...
func (r StpApiGetNetworkSwitchStpRequest) Execute() (*InlineResponse200183, *http.Response, error) {
...
func (a *StpApiService) GetNetworkSwitchStpExecute(r StpApiGetNetworkSwitchStpRequest) (*InlineResponse200183, *http.Response, error) {
	var (
...
func (r StpApiUpdateNetworkSwitchStpRequest) UpdateNetworkSwitchStp(updateNetworkSwitchStp InlineObject169) StpApiUpdateNetworkSwitchStpRequest {
	r.updateNetworkSwitchStp = &updateNetworkSwitchStp
	return r
}

func (r StpApiUpdateNetworkSwitchStpRequest) Execute() (*InlineResponse200183, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200183
func (a *StpApiService) UpdateNetworkSwitchStpExecute(r StpApiUpdateNetworkSwitchStpRequest) (*InlineResponse200183, *http.Response, error) {
	var (
