...
func (r StpApiGetNetworkSwitchStpRequest) Execute() (*InlineResponse200168, *http.Response, error) {
...
func (a *StpApiService) GetNetworkSwitchStpExecute(r StpApiGetNetworkSwitchStpRequest) (*InlineResponse200168, *http.Response, error) {
	var (
...
func (r StpApiUpdateNetworkSwitchStpRequest) Execute() (*InlineResponse200168, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200168
func (a *StpApiService) UpdateNetworkSwitchStpExecute(r StpApiUpdateNetworkSwitchStpRequest) (*InlineResponse200168, *http.Response, error) {
	var (
