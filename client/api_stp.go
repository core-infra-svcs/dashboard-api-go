...
func (r StpApiGetNetworkSwitchStpRequest) Execute() (*InlineResponse200158, *http.Response, error) {
...
func (a *StpApiService) GetNetworkSwitchStpExecute(r StpApiGetNetworkSwitchStpRequest) (*InlineResponse200158, *http.Response, error) {
	var (
...
func (r StpApiUpdateNetworkSwitchStpRequest) Execute() (*InlineResponse200158, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200158
func (a *StpApiService) UpdateNetworkSwitchStpExecute(r StpApiUpdateNetworkSwitchStpRequest) (*InlineResponse200158, *http.Response, error) {
	var (
