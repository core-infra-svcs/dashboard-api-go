...
func (r StpApiGetNetworkSwitchStpRequest) Execute() (*InlineResponse200160, *http.Response, error) {
...
func (a *StpApiService) GetNetworkSwitchStpExecute(r StpApiGetNetworkSwitchStpRequest) (*InlineResponse200160, *http.Response, error) {
	var (
...
func (r StpApiUpdateNetworkSwitchStpRequest) UpdateNetworkSwitchStp(updateNetworkSwitchStp InlineObject158) StpApiUpdateNetworkSwitchStpRequest {
	r.updateNetworkSwitchStp = &updateNetworkSwitchStp
	return r
}

func (r StpApiUpdateNetworkSwitchStpRequest) Execute() (*InlineResponse200160, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200160
func (a *StpApiService) UpdateNetworkSwitchStpExecute(r StpApiUpdateNetworkSwitchStpRequest) (*InlineResponse200160, *http.Response, error) {
	var (
