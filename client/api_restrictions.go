...
func (r RestrictionsApiGetNetworkSmDeviceRestrictionsRequest) Execute() (*InlineResponse200143, *http.Response, error) {
...
func (a *RestrictionsApiService) GetNetworkSmDeviceRestrictionsExecute(r RestrictionsApiGetNetworkSmDeviceRestrictionsRequest) (*InlineResponse200143, *http.Response, error) {
	var (
