...
type RestrictionsApiApiGetNetworkSmDeviceRestrictionsRequest struct {
...
func (r RestrictionsApiApiGetNetworkSmDeviceRestrictionsRequest) Execute() ([]map[string]interface{}, *_nethttp.Response, error) {
...
List the restrictions on a device
 ...
 @param networkId
 @param deviceId
 @return RestrictionsApiApiGetNetworkSmDeviceRestrictionsRequest
*/
func (a *RestrictionsApiService) GetNetworkSmDeviceRestrictions(ctx _context.Context, networkId string, deviceId string) RestrictionsApiApiGetNetworkSmDeviceRestrictionsRequest {
	return RestrictionsApiApiGetNetworkSmDeviceRestrictionsRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *RestrictionsApiService) GetNetworkSmDeviceRestrictionsExecute(r RestrictionsApiApiGetNetworkSmDeviceRestrictionsRequest) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
