...
func (r RestrictionsApiGetNetworkSmDeviceRestrictionsRequest) Execute() (*InlineResponse200126, *http.Response, error) {
...
func (a *RestrictionsApiService) GetNetworkSmDeviceRestrictionsExecute(r RestrictionsApiGetNetworkSmDeviceRestrictionsRequest) (*InlineResponse200126, *http.Response, error) {
	var (
