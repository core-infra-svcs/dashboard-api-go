...
func (r RestrictionsApiGetNetworkSmDeviceRestrictionsRequest) Execute() (*InlineResponse200124, *http.Response, error) {
...
func (a *RestrictionsApiService) GetNetworkSmDeviceRestrictionsExecute(r RestrictionsApiGetNetworkSmDeviceRestrictionsRequest) (*InlineResponse200124, *http.Response, error) {
	var (
