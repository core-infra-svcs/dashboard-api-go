...
func (r RestrictionsApiGetNetworkSmDeviceRestrictionsRequest) Execute() (*InlineResponse200149, *http.Response, error) {
...
func (a *RestrictionsApiService) GetNetworkSmDeviceRestrictionsExecute(r RestrictionsApiGetNetworkSmDeviceRestrictionsRequest) (*InlineResponse200149, *http.Response, error) {
	var (
