...
func (r RestrictionsApiGetNetworkSmDeviceRestrictionsRequest) Execute() (*InlineResponse200127, *http.Response, error) {
...
func (a *RestrictionsApiService) GetNetworkSmDeviceRestrictionsExecute(r RestrictionsApiGetNetworkSmDeviceRestrictionsRequest) (*InlineResponse200127, *http.Response, error) {
	var (
