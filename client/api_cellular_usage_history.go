...
func (r CellularUsageHistoryApiGetNetworkSmDeviceCellularUsageHistoryRequest) Execute() ([]InlineResponse20038, *http.Response, error) {
...
func (a *CellularUsageHistoryApiService) GetNetworkSmDeviceCellularUsageHistoryExecute(r CellularUsageHistoryApiGetNetworkSmDeviceCellularUsageHistoryRequest) ([]InlineResponse20038, *http.Response, error) {
	var (
