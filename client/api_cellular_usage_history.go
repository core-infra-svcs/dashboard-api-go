...
func (r CellularUsageHistoryApiGetNetworkSmDeviceCellularUsageHistoryRequest) Execute() ([]InlineResponse20058, *http.Response, error) {
...
func (a *CellularUsageHistoryApiService) GetNetworkSmDeviceCellularUsageHistoryExecute(r CellularUsageHistoryApiGetNetworkSmDeviceCellularUsageHistoryRequest) ([]InlineResponse20058, *http.Response, error) {
	var (
