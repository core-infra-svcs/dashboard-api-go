...
func (r CellularUsageHistoryApiApiGetNetworkSmDeviceCellularUsageHistoryRequest) Execute() ([]map[string]interface{}, *_nethttp.Response, error) {
...
func (a *CellularUsageHistoryApiService) GetNetworkSmDeviceCellularUsageHistoryExecute(r CellularUsageHistoryApiApiGetNetworkSmDeviceCellularUsageHistoryRequest) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
