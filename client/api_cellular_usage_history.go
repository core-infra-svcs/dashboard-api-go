...
func (r CellularUsageHistoryApiGetNetworkSmDeviceCellularUsageHistoryRequest) Execute() ([]InlineResponse200119, *http.Response, error) {
...
func (a *CellularUsageHistoryApiService) GetNetworkSmDeviceCellularUsageHistoryExecute(r CellularUsageHistoryApiGetNetworkSmDeviceCellularUsageHistoryRequest) ([]InlineResponse200119, *http.Response, error) {
	var (
