...
// InlineResponse20021ProductsWirelessNextUpgrade Details of the next firmware upgrade on the device
type InlineResponse20021ProductsWirelessNextUpgrade struct {
	// Timestamp of the next scheduled firmware upgrade
	Time *time.Time `json:"time,omitempty"`
	ToVersion *InlineResponse20021ProductsWirelessNextUpgradeToVersion `json:"toVersion,omitempty"`
}
...
func NewInlineResponse20021ProductsWirelessNextUpgrade() *InlineResponse20021ProductsWirelessNextUpgrade {
	this := InlineResponse20021ProductsWirelessNextUpgrade{}
	return &this
}
...
func (o *InlineResponse20021ProductsWirelessNextUpgrade) GetToVersion() InlineResponse20021ProductsWirelessNextUpgradeToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20021ProductsWirelessNextUpgradeToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20021ProductsWirelessNextUpgradeToVersion and assigns it to the ToVersion field.
...
func (o InlineResponse20021ProductsWirelessNextUpgrade) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20021ProductsWirelessNextUpgrade struct {
	value *InlineResponse20021ProductsWirelessNextUpgrade
	isSet bool
}

func (v NullableInlineResponse20021ProductsWirelessNextUpgrade) Get() *InlineResponse20021ProductsWirelessNextUpgrade {
	return v.value
}

func (v *NullableInlineResponse20021ProductsWirelessNextUpgrade) Set(val *InlineResponse20021ProductsWirelessNextUpgrade) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20021ProductsWirelessNextUpgrade) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20021ProductsWirelessNextUpgrade) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20021ProductsWirelessNextUpgrade(val *InlineResponse20021ProductsWirelessNextUpgrade) *NullableInlineResponse20021ProductsWirelessNextUpgrade {
	return &NullableInlineResponse20021ProductsWirelessNextUpgrade{value: val, isSet: true}
}

func (v NullableInlineResponse20021ProductsWirelessNextUpgrade) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20021ProductsWirelessNextUpgrade) UnmarshalJSON(src []byte) error {
	v.isSet = true
