...
// InlineResponse200349Ssid The SSID that allowlist belongs to
type InlineResponse200349Ssid struct {
	// The index of SSID
	Id string `json:"id"`
	// The name of SSID
...
func (o InlineResponse200349Ssid) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200349Ssid struct {
	value *InlineResponse200349Ssid
	isSet bool
}

func (v NullableInlineResponse200349Ssid) Get() *InlineResponse200349Ssid {
	return v.value
}

func (v *NullableInlineResponse200349Ssid) Set(val *InlineResponse200349Ssid) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200349Ssid) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200349Ssid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200349Ssid(val *InlineResponse200349Ssid) *NullableInlineResponse200349Ssid {
	return &NullableInlineResponse200349Ssid{value: val, isSet: true}
}

func (v NullableInlineResponse200349Ssid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200349Ssid) UnmarshalJSON(src []byte) error {
	v.isSet = true
