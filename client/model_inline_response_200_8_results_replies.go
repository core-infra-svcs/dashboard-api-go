...
// InlineResponse2008ResultsReplies struct for InlineResponse2008ResultsReplies
type InlineResponse2008ResultsReplies struct {
...
func NewInlineResponse2008ResultsReplies() *InlineResponse2008ResultsReplies {
	this := InlineResponse2008ResultsReplies{}
	return &this
}
...
func (o InlineResponse2008ResultsReplies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2008ResultsReplies struct {
	value *InlineResponse2008ResultsReplies
	isSet bool
}

func (v NullableInlineResponse2008ResultsReplies) Get() *InlineResponse2008ResultsReplies {
	return v.value
}

func (v *NullableInlineResponse2008ResultsReplies) Set(val *InlineResponse2008ResultsReplies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2008ResultsReplies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2008ResultsReplies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2008ResultsReplies(val *InlineResponse2008ResultsReplies) *NullableInlineResponse2008ResultsReplies {
	return &NullableInlineResponse2008ResultsReplies{value: val, isSet: true}
}

func (v NullableInlineResponse2008ResultsReplies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2008ResultsReplies) UnmarshalJSON(src []byte) error {
	v.isSet = true
