...
func (r SubnetsApiGetDeviceApplianceDhcpSubnetsRequest) Execute() ([]InlineResponse2007, *http.Response, error) {
...
func (a *SubnetsApiService) GetDeviceApplianceDhcpSubnetsExecute(r SubnetsApiGetDeviceApplianceDhcpSubnetsRequest) ([]InlineResponse2007, *http.Response, error) {
	var (
