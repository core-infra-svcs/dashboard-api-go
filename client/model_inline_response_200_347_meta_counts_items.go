...
// InlineResponse200347MetaCountsItems Items
type InlineResponse200347MetaCountsItems struct {
...
func NewInlineResponse200347MetaCountsItems() *InlineResponse200347MetaCountsItems {
	this := InlineResponse200347MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200347MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200347MetaCountsItems struct {
	value *InlineResponse200347MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200347MetaCountsItems) Get() *InlineResponse200347MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200347MetaCountsItems) Set(val *InlineResponse200347MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200347MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200347MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200347MetaCountsItems(val *InlineResponse200347MetaCountsItems) *NullableInlineResponse200347MetaCountsItems {
	return &NullableInlineResponse200347MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200347MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200347MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
