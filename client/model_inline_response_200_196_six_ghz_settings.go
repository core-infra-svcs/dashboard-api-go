...
// InlineResponse200196SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200196SixGhzSettings struct {
...
func NewInlineResponse200196SixGhzSettings() *InlineResponse200196SixGhzSettings {
	this := InlineResponse200196SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200196SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200196SixGhzSettings struct {
	value *InlineResponse200196SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200196SixGhzSettings) Get() *InlineResponse200196SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200196SixGhzSettings) Set(val *InlineResponse200196SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200196SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200196SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200196SixGhzSettings(val *InlineResponse200196SixGhzSettings) *NullableInlineResponse200196SixGhzSettings {
	return &NullableInlineResponse200196SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200196SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200196SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
