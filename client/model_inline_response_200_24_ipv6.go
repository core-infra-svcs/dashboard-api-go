...
// InlineResponse20024Ipv6 IPv6 configuration on the single LAN
type InlineResponse20024Ipv6 struct {
	// Enable IPv6 on single LAN
	Enabled *bool `json:"enabled,omitempty"`
	// Prefix assignments on the single LAN
	PrefixAssignments []InlineResponse20024Ipv6PrefixAssignments `json:"prefixAssignments,omitempty"`
}
...
func (o *InlineResponse20024Ipv6) GetPrefixAssignments() []InlineResponse20024Ipv6PrefixAssignments {
	if o == nil || isNil(o.PrefixAssignments) {
		var ret []InlineResponse20024Ipv6PrefixAssignments
		return ret
	}
...
// SetPrefixAssignments gets a reference to the given []InlineResponse20024Ipv6PrefixAssignments and assigns it to the PrefixAssignments field.
func (o *InlineResponse20024Ipv6) SetPrefixAssignments(v []InlineResponse20024Ipv6PrefixAssignments) {
	o.PrefixAssignments = v
}

func (o InlineResponse20024Ipv6) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20024Ipv6 struct {
	value *InlineResponse20024Ipv6
	isSet bool
}

func (v NullableInlineResponse20024Ipv6) Get() *InlineResponse20024Ipv6 {
	return v.value
}

func (v *NullableInlineResponse20024Ipv6) Set(val *InlineResponse20024Ipv6) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20024Ipv6) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20024Ipv6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20024Ipv6(val *InlineResponse20024Ipv6) *NullableInlineResponse20024Ipv6 {
	return &NullableInlineResponse20024Ipv6{value: val, isSet: true}
}

func (v NullableInlineResponse20024Ipv6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20024Ipv6) UnmarshalJSON(src []byte) error {
	v.isSet = true
