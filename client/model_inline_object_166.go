...
func (o *InlineObject166) GetApi() OrganizationsOrganizationIdApi {
...
// and a boolean to check if the value has been set.
func (o *InlineObject166) GetApiOk() (*OrganizationsOrganizationIdApi, bool) {
	if o == nil || isNil(o.Api) {
    return nil, false
	}
	return o.Api, true
...
func (o *InlineObject166) HasApi() bool {
	if o != nil && !isNil(o.Api) {
		return true
	}
...
func (o *InlineObject166) SetApi(v OrganizationsOrganizationIdApi) {
	o.Api = &v
}
