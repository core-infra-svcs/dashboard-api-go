...
// InlineResponse200303StatesExpiringWarning Data for the warning threshold
type InlineResponse200303StatesExpiringWarning struct {
...
func NewInlineResponse200303StatesExpiringWarning() *InlineResponse200303StatesExpiringWarning {
	this := InlineResponse200303StatesExpiringWarning{}
	return &this
}
...
func (o InlineResponse200303StatesExpiringWarning) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200303StatesExpiringWarning struct {
	value *InlineResponse200303StatesExpiringWarning
	isSet bool
}

func (v NullableInlineResponse200303StatesExpiringWarning) Get() *InlineResponse200303StatesExpiringWarning {
	return v.value
}

func (v *NullableInlineResponse200303StatesExpiringWarning) Set(val *InlineResponse200303StatesExpiringWarning) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200303StatesExpiringWarning) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200303StatesExpiringWarning) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200303StatesExpiringWarning(val *InlineResponse200303StatesExpiringWarning) *NullableInlineResponse200303StatesExpiringWarning {
	return &NullableInlineResponse200303StatesExpiringWarning{value: val, isSet: true}
}

func (v NullableInlineResponse200303StatesExpiringWarning) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200303StatesExpiringWarning) UnmarshalJSON(src []byte) error {
	v.isSet = true
