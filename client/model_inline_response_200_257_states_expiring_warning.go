...
// InlineResponse200257StatesExpiringWarning Data for the warning threshold
type InlineResponse200257StatesExpiringWarning struct {
...
func NewInlineResponse200257StatesExpiringWarning() *InlineResponse200257StatesExpiringWarning {
	this := InlineResponse200257StatesExpiringWarning{}
	return &this
}
...
func (o InlineResponse200257StatesExpiringWarning) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200257StatesExpiringWarning struct {
	value *InlineResponse200257StatesExpiringWarning
	isSet bool
}

func (v NullableInlineResponse200257StatesExpiringWarning) Get() *InlineResponse200257StatesExpiringWarning {
	return v.value
}

func (v *NullableInlineResponse200257StatesExpiringWarning) Set(val *InlineResponse200257StatesExpiringWarning) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200257StatesExpiringWarning) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200257StatesExpiringWarning) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200257StatesExpiringWarning(val *InlineResponse200257StatesExpiringWarning) *NullableInlineResponse200257StatesExpiringWarning {
	return &NullableInlineResponse200257StatesExpiringWarning{value: val, isSet: true}
}

func (v NullableInlineResponse200257StatesExpiringWarning) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200257StatesExpiringWarning) UnmarshalJSON(src []byte) error {
	v.isSet = true
