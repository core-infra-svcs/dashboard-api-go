...
// InlineResponse20056Applications struct for InlineResponse20056Applications
type InlineResponse20056Applications struct {
...
func NewInlineResponse20056Applications() *InlineResponse20056Applications {
	this := InlineResponse20056Applications{}
	return &this
}
...
func (o InlineResponse20056Applications) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20056Applications struct {
	value *InlineResponse20056Applications
	isSet bool
}

func (v NullableInlineResponse20056Applications) Get() *InlineResponse20056Applications {
	return v.value
}

func (v *NullableInlineResponse20056Applications) Set(val *InlineResponse20056Applications) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20056Applications) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20056Applications) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20056Applications(val *InlineResponse20056Applications) *NullableInlineResponse20056Applications {
	return &NullableInlineResponse20056Applications{value: val, isSet: true}
}

func (v NullableInlineResponse20056Applications) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20056Applications) UnmarshalJSON(src []byte) error {
	v.isSet = true
