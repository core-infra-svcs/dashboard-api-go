...
// InlineResponse20090ProductsWirelessNextUpgradeToVersion Details of the version the device will upgrade to if it exists
type InlineResponse20090ProductsWirelessNextUpgradeToVersion struct {
...
func NewInlineResponse20090ProductsWirelessNextUpgradeToVersion() *InlineResponse20090ProductsWirelessNextUpgradeToVersion {
	this := InlineResponse20090ProductsWirelessNextUpgradeToVersion{}
	return &this
}
...
func (o InlineResponse20090ProductsWirelessNextUpgradeToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20090ProductsWirelessNextUpgradeToVersion struct {
	value *InlineResponse20090ProductsWirelessNextUpgradeToVersion
	isSet bool
}

func (v NullableInlineResponse20090ProductsWirelessNextUpgradeToVersion) Get() *InlineResponse20090ProductsWirelessNextUpgradeToVersion {
	return v.value
}

func (v *NullableInlineResponse20090ProductsWirelessNextUpgradeToVersion) Set(val *InlineResponse20090ProductsWirelessNextUpgradeToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20090ProductsWirelessNextUpgradeToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20090ProductsWirelessNextUpgradeToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20090ProductsWirelessNextUpgradeToVersion(val *InlineResponse20090ProductsWirelessNextUpgradeToVersion) *NullableInlineResponse20090ProductsWirelessNextUpgradeToVersion {
	return &NullableInlineResponse20090ProductsWirelessNextUpgradeToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20090ProductsWirelessNextUpgradeToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20090ProductsWirelessNextUpgradeToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
