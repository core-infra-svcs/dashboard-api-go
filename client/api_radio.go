...
func (r RadioApiGetDeviceApplianceRadioSettingsRequest) Execute() (*InlineResponse2007, *http.Response, error) {
...
func (a *RadioApiService) GetDeviceApplianceRadioSettingsExecute(r RadioApiGetDeviceApplianceRadioSettingsRequest) (*InlineResponse2007, *http.Response, error) {
	var (
...
func (r RadioApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) RecalculateOrganizationWirelessRadioAutoRfChannels(recalculateOrganizationWirelessRadioAutoRfChannels InlineObject273) RadioApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest {
	r.recalculateOrganizationWirelessRadioAutoRfChannels = &recalculateOrganizationWirelessRadioAutoRfChannels
	return r
}

func (r RadioApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) Execute() (*InlineResponse200322, *http.Response, error) {
...
func (a *RadioApiService) RecalculateOrganizationWirelessRadioAutoRfChannelsExecute(r RadioApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) (*InlineResponse200322, *http.Response, error) {
	var (
...
func (r RadioApiUpdateDeviceApplianceRadioSettingsRequest) Execute() (*InlineResponse2007, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2007
func (a *RadioApiService) UpdateDeviceApplianceRadioSettingsExecute(r RadioApiUpdateDeviceApplianceRadioSettingsRequest) (*InlineResponse2007, *http.Response, error) {
	var (
...
func (r RadioApiUpdateDeviceWirelessRadioSettingsRequest) UpdateDeviceWirelessRadioSettings(updateDeviceWirelessRadioSettings InlineObject36) RadioApiUpdateDeviceWirelessRadioSettingsRequest {
