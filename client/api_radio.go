...
func (r RadioApiGetDeviceApplianceRadioSettingsRequest) Execute() (*InlineResponse2003, *http.Response, error) {
...
func (a *RadioApiService) GetDeviceApplianceRadioSettingsExecute(r RadioApiGetDeviceApplianceRadioSettingsRequest) (*InlineResponse2003, *http.Response, error) {
	var (
...
func (r RadioApiUpdateDeviceApplianceRadioSettingsRequest) Execute() (*InlineResponse2003, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2003
func (a *RadioApiService) UpdateDeviceApplianceRadioSettingsExecute(r RadioApiUpdateDeviceApplianceRadioSettingsRequest) (*InlineResponse2003, *http.Response, error) {
	var (
...
func (r RadioApiUpdateDeviceWirelessRadioSettingsRequest) UpdateDeviceWirelessRadioSettings(updateDeviceWirelessRadioSettings InlineObject30) RadioApiUpdateDeviceWirelessRadioSettingsRequest {
