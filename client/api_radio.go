...
func (r RadioApiGetDeviceApplianceRadioSettingsRequest) Execute() (*InlineResponse2005, *http.Response, error) {
...
func (a *RadioApiService) GetDeviceApplianceRadioSettingsExecute(r RadioApiGetDeviceApplianceRadioSettingsRequest) (*InlineResponse2005, *http.Response, error) {
	var (
...
func (r RadioApiUpdateDeviceApplianceRadioSettingsRequest) Execute() (*InlineResponse2005, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2005
func (a *RadioApiService) UpdateDeviceApplianceRadioSettingsExecute(r RadioApiUpdateDeviceApplianceRadioSettingsRequest) (*InlineResponse2005, *http.Response, error) {
	var (
...
func (r RadioApiUpdateDeviceWirelessRadioSettingsRequest) UpdateDeviceWirelessRadioSettings(updateDeviceWirelessRadioSettings InlineObject34) RadioApiUpdateDeviceWirelessRadioSettingsRequest {
