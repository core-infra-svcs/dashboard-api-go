...
func (r RadioApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) RecalculateOrganizationWirelessRadioAutoRfChannels(recalculateOrganizationWirelessRadioAutoRfChannels InlineObject304) RadioApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest {
	r.recalculateOrganizationWirelessRadioAutoRfChannels = &recalculateOrganizationWirelessRadioAutoRfChannels
	return r
}

func (r RadioApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) Execute() (*InlineResponse200365, *http.Response, error) {
...
func (a *RadioApiService) RecalculateOrganizationWirelessRadioAutoRfChannelsExecute(r RadioApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) (*InlineResponse200365, *http.Response, error) {
	var (
...
func (r RadioApiUpdateDeviceWirelessRadioSettingsRequest) UpdateDeviceWirelessRadioSettings(updateDeviceWirelessRadioSettings InlineObject38) RadioApiUpdateDeviceWirelessRadioSettingsRequest {
