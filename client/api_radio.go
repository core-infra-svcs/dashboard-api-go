...
func (r RadioApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) Execute() (*InlineResponse200364, *http.Response, error) {
...
func (a *RadioApiService) RecalculateOrganizationWirelessRadioAutoRfChannelsExecute(r RadioApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) (*InlineResponse200364, *http.Response, error) {
	var (
