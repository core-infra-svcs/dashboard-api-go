...
func (r PrefixesApiCreateNetworkAppliancePrefixesDelegatedStaticRequest) CreateNetworkAppliancePrefixesDelegatedStatic(createNetworkAppliancePrefixesDelegatedStatic InlineObject50) PrefixesApiCreateNetworkAppliancePrefixesDelegatedStaticRequest {
...
func (r PrefixesApiGetNetworkAppliancePrefixesDelegatedStaticRequest) Execute() (*InlineResponse20030, *http.Response, error) {
...
func (a *PrefixesApiService) GetNetworkAppliancePrefixesDelegatedStaticExecute(r PrefixesApiGetNetworkAppliancePrefixesDelegatedStaticRequest) (*InlineResponse20030, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PrefixesApiGetNetworkAppliancePrefixesDelegatedStaticsRequest) Execute() ([]InlineResponse20030, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20030
func (a *PrefixesApiService) GetNetworkAppliancePrefixesDelegatedStaticsExecute(r PrefixesApiGetNetworkAppliancePrefixesDelegatedStaticsRequest) ([]InlineResponse20030, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PrefixesApiUpdateNetworkAppliancePrefixesDelegatedStaticRequest) UpdateNetworkAppliancePrefixesDelegatedStatic(updateNetworkAppliancePrefixesDelegatedStatic InlineObject51) PrefixesApiUpdateNetworkAppliancePrefixesDelegatedStaticRequest {
