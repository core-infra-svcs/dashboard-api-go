...
// InlineResponse200365CountsConnectionsByStatus Access point counts by their status
type InlineResponse200365CountsConnectionsByStatus struct {
...
func NewInlineResponse200365CountsConnectionsByStatus() *InlineResponse200365CountsConnectionsByStatus {
	this := InlineResponse200365CountsConnectionsByStatus{}
	return &this
}
...
func (o InlineResponse200365CountsConnectionsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200365CountsConnectionsByStatus struct {
	value *InlineResponse200365CountsConnectionsByStatus
	isSet bool
}

func (v NullableInlineResponse200365CountsConnectionsByStatus) Get() *InlineResponse200365CountsConnectionsByStatus {
	return v.value
}

func (v *NullableInlineResponse200365CountsConnectionsByStatus) Set(val *InlineResponse200365CountsConnectionsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200365CountsConnectionsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200365CountsConnectionsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200365CountsConnectionsByStatus(val *InlineResponse200365CountsConnectionsByStatus) *NullableInlineResponse200365CountsConnectionsByStatus {
	return &NullableInlineResponse200365CountsConnectionsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200365CountsConnectionsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200365CountsConnectionsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
