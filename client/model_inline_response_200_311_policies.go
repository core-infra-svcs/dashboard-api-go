...
// InlineResponse200311Policies struct for InlineResponse200311Policies
type InlineResponse200311Policies struct {
...
func NewInlineResponse200311Policies() *InlineResponse200311Policies {
	this := InlineResponse200311Policies{}
	return &this
}
...
func (o InlineResponse200311Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200311Policies struct {
	value *InlineResponse200311Policies
	isSet bool
}

func (v NullableInlineResponse200311Policies) Get() *InlineResponse200311Policies {
	return v.value
}

func (v *NullableInlineResponse200311Policies) Set(val *InlineResponse200311Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200311Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200311Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200311Policies(val *InlineResponse200311Policies) *NullableInlineResponse200311Policies {
	return &NullableInlineResponse200311Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200311Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200311Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
