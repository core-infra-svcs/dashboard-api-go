...
type InlineResponse200345Ports struct {
	...
	Intervals []InlineResponse200345Intervals `json:"intervals,omitempty"`
}
...
func (o *InlineResponse200345Ports) GetIntervals() []InlineResponse200345Intervals {
	if o == nil || isNil(o.Intervals) {
		var ret []InlineResponse200345Intervals
		return ret
	}
	return o.Intervals
}
...
// SetIntervals gets a reference to the given []InlineResponse200345Intervals and assigns it to the Intervals field.
