...
// InlineResponse200296Networks struct for InlineResponse200296Networks
type InlineResponse200296Networks struct {
	// Network ID
...
func NewInlineResponse200296Networks() *InlineResponse200296Networks {
	this := InlineResponse200296Networks{}
	return &this
}
...
func (o InlineResponse200296Networks) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200296Networks struct {
	value *InlineResponse200296Networks
	isSet bool
}

func (v NullableInlineResponse200296Networks) Get() *InlineResponse200296Networks {
	return v.value
}

func (v *NullableInlineResponse200296Networks) Set(val *InlineResponse200296Networks) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200296Networks) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200296Networks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200296Networks(val *InlineResponse200296Networks) *NullableInlineResponse200296Networks {
	return &NullableInlineResponse200296Networks{value: val, isSet: true}
}

func (v NullableInlineResponse200296Networks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200296Networks) UnmarshalJSON(src []byte) error {
	v.isSet = true
