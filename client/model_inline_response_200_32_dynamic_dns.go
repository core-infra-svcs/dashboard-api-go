...
// InlineResponse20032DynamicDns Dynamic DNS settings for a network
type InlineResponse20032DynamicDns struct {
	// Dynamic DNS enabled
...
func NewInlineResponse20032DynamicDns() *InlineResponse20032DynamicDns {
	this := InlineResponse20032DynamicDns{}
	return &this
}
...
func (o InlineResponse20032DynamicDns) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20032DynamicDns struct {
	value *InlineResponse20032DynamicDns
	isSet bool
}

func (v NullableInlineResponse20032DynamicDns) Get() *InlineResponse20032DynamicDns {
	return v.value
}

func (v *NullableInlineResponse20032DynamicDns) Set(val *InlineResponse20032DynamicDns) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20032DynamicDns) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20032DynamicDns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20032DynamicDns(val *InlineResponse20032DynamicDns) *NullableInlineResponse20032DynamicDns {
	return &NullableInlineResponse20032DynamicDns{value: val, isSet: true}
}

func (v NullableInlineResponse20032DynamicDns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20032DynamicDns) UnmarshalJSON(src []byte) error {
	v.isSet = true
