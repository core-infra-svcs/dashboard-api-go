...
type InlineResponse200229 struct {
	...
	Items []InlineResponse20071 `json:"items,omitempty"`
}
...
// SetItems gets a reference to the given []InlineResponse20071 and assigns it to the Items field.
