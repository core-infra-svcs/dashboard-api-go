...
// InlineResponse200333Match Indicates whether or not clients are allowed to        connect to rogue SSIDs by default. (blocked by default)
type InlineResponse200333Match struct {
...
func NewInlineResponse200333Match() *InlineResponse200333Match {
	this := InlineResponse200333Match{}
	return &this
}
...
func (o InlineResponse200333Match) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200333Match struct {
	value *InlineResponse200333Match
	isSet bool
}

func (v NullableInlineResponse200333Match) Get() *InlineResponse200333Match {
	return v.value
}

func (v *NullableInlineResponse200333Match) Set(val *InlineResponse200333Match) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200333Match) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200333Match) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200333Match(val *InlineResponse200333Match) *NullableInlineResponse200333Match {
	return &NullableInlineResponse200333Match{value: val, isSet: true}
}

func (v NullableInlineResponse200333Match) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200333Match) UnmarshalJSON(src []byte) error {
	v.isSet = true
