...
// InlineResponse200381Intervals struct for InlineResponse200381Intervals
type InlineResponse200381Intervals struct {
	// The start time of the query range with iso8601 format
	StartTs *string `json:"startTs,omitempty"`
	// The end time of the query range  with iso8601 format
	EndTs *string `json:"endTs,omitempty"`
	Overall *InlineResponse200381Overall `json:"overall,omitempty"`
	// The CPU usage per core of the wireless LAN controller
	ByCore []InlineResponse200381ByCore `json:"byCore,omitempty"`
}
...
func NewInlineResponse200381Intervals() *InlineResponse200381Intervals {
	this := InlineResponse200381Intervals{}
	return &this
}
...
func (o *InlineResponse200381Intervals) GetOverall() InlineResponse200381Overall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200381Overall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200381Overall and assigns it to the Overall field.
...
func (o *InlineResponse200381Intervals) GetByCore() []InlineResponse200381ByCore {
	if o == nil || isNil(o.ByCore) {
		var ret []InlineResponse200381ByCore
		return ret
	}
	return o.ByCore
}
...
// SetByCore gets a reference to the given []InlineResponse200381ByCore and assigns it to the ByCore field.
func (o *InlineResponse200381Intervals) SetByCore(v []InlineResponse200381ByCore) {
	o.ByCore = v
}

func (o InlineResponse200381Intervals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200381Intervals struct {
	value *InlineResponse200381Intervals
	isSet bool
}

func (v NullableInlineResponse200381Intervals) Get() *InlineResponse200381Intervals {
	return v.value
}

func (v *NullableInlineResponse200381Intervals) Set(val *InlineResponse200381Intervals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200381Intervals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200381Intervals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200381Intervals(val *InlineResponse200381Intervals) *NullableInlineResponse200381Intervals {
	return &NullableInlineResponse200381Intervals{value: val, isSet: true}
}

func (v NullableInlineResponse200381Intervals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200381Intervals) UnmarshalJSON(src []byte) error {
	v.isSet = true
