...
func (r LicensingApiGetOrganizationLicensingCotermLicensesRequest) Execute() ([]InlineResponse200168, *http.Response, error) {
...
func (a *LicensingApiService) GetOrganizationLicensingCotermLicensesExecute(r LicensingApiGetOrganizationLicensingCotermLicensesRequest) ([]InlineResponse200168, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type LicensingApiMoveOrganizationLicensingCotermLicensesRequest struct {
	...
	ApiService *LicensingApiService
	organizationId string
	moveOrganizationLicensingCotermLicenses *InlineObject233
}

func (r LicensingApiMoveOrganizationLicensingCotermLicensesRequest) MoveOrganizationLicensingCotermLicenses(moveOrganizationLicensingCotermLicenses InlineObject233) LicensingApiMoveOrganizationLicensingCotermLicensesRequest {
	r.moveOrganizationLicensingCotermLicenses = &moveOrganizationLicensingCotermLicenses
	return r
}

func (r LicensingApiMoveOrganizationLicensingCotermLicensesRequest) Execute() (*InlineResponse200169, *http.Response, error) {
...
func (a *LicensingApiService) MoveOrganizationLicensingCotermLicensesExecute(r LicensingApiMoveOrganizationLicensingCotermLicensesRequest) (*InlineResponse200169, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
