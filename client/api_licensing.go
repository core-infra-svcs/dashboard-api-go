...
func (r LicensingApiBindAdministeredLicensingSubscriptionSubscriptionRequest) Execute() (*InlineResponse2002, *http.Response, error) {
...
func (a *LicensingApiService) BindAdministeredLicensingSubscriptionSubscriptionExecute(r LicensingApiBindAdministeredLicensingSubscriptionSubscriptionRequest) (*InlineResponse2002, *http.Response, error) {
	var (
...
func (r LicensingApiClaimAdministeredLicensingSubscriptionSubscriptionsRequest) Execute() (*InlineResponse2001, *http.Response, error) {
...
func (a *LicensingApiService) ClaimAdministeredLicensingSubscriptionSubscriptionsExecute(r LicensingApiClaimAdministeredLicensingSubscriptionSubscriptionsRequest) (*InlineResponse2001, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r LicensingApiGetAdministeredLicensingSubscriptionSubscriptionsRequest) Execute() ([]InlineResponse2001, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse2001
func (a *LicensingApiService) GetAdministeredLicensingSubscriptionSubscriptionsExecute(r LicensingApiGetAdministeredLicensingSubscriptionSubscriptionsRequest) ([]InlineResponse2001, *http.Response, error) {
	var (
...
func (r LicensingApiGetOrganizationLicensingCotermLicensesRequest) Execute() ([]InlineResponse200160, *http.Response, error) {
...
func (a *LicensingApiService) GetOrganizationLicensingCotermLicensesExecute(r LicensingApiGetOrganizationLicensingCotermLicensesRequest) ([]InlineResponse200160, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type LicensingApiMoveOrganizationLicensingCotermLicensesRequest struct {
	...
	ApiService *LicensingApiService
	organizationId string
	moveOrganizationLicensingCotermLicenses *InlineObject228
}

func (r LicensingApiMoveOrganizationLicensingCotermLicensesRequest) MoveOrganizationLicensingCotermLicenses(moveOrganizationLicensingCotermLicenses InlineObject228) LicensingApiMoveOrganizationLicensingCotermLicensesRequest {
	r.moveOrganizationLicensingCotermLicenses = &moveOrganizationLicensingCotermLicenses
	return r
}

func (r LicensingApiMoveOrganizationLicensingCotermLicensesRequest) Execute() (*InlineResponse200161, *http.Response, error) {
...
func (a *LicensingApiService) MoveOrganizationLicensingCotermLicensesExecute(r LicensingApiMoveOrganizationLicensingCotermLicensesRequest) (*InlineResponse200161, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r LicensingApiValidateAdministeredLicensingSubscriptionSubscriptionsClaimKeyRequest) Execute() (*InlineResponse2001, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2001
func (a *LicensingApiService) ValidateAdministeredLicensingSubscriptionSubscriptionsClaimKeyExecute(r LicensingApiValidateAdministeredLicensingSubscriptionSubscriptionsClaimKeyRequest) (*InlineResponse2001, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
