...
func (r LicensingApiGetOrganizationLicensingCotermLicensesRequest) Execute() ([]InlineResponse200153, *http.Response, error) {
...
func (a *LicensingApiService) GetOrganizationLicensingCotermLicensesExecute(r LicensingApiGetOrganizationLicensingCotermLicensesRequest) ([]InlineResponse200153, *http.Response, error) {
	var (
...
func (r LicensingApiMoveOrganizationLicensingCotermLicensesRequest) Execute() (*InlineResponse200154, *http.Response, error) {
...
func (a *LicensingApiService) MoveOrganizationLicensingCotermLicensesExecute(r LicensingApiMoveOrganizationLicensingCotermLicensesRequest) (*InlineResponse200154, *http.Response, error) {
	var (
