...
// InlineResponse200116Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse200116Counts struct {
	...
	Noise *InlineResponse200116CountsNoise `json:"noise,omitempty"`
...
func (o *InlineResponse200116Counts) GetNoise() InlineResponse200116CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse200116CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse200116CountsNoise and assigns it to the Noise field.
