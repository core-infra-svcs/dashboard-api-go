...
// InlineResponse20092Servers struct for InlineResponse20092Servers
type InlineResponse20092Servers struct {
...
func NewInlineResponse20092Servers() *InlineResponse20092Servers {
	this := InlineResponse20092Servers{}
	return &this
}
...
func (o InlineResponse20092Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20092Servers struct {
	value *InlineResponse20092Servers
	isSet bool
}

func (v NullableInlineResponse20092Servers) Get() *InlineResponse20092Servers {
	return v.value
}

func (v *NullableInlineResponse20092Servers) Set(val *InlineResponse20092Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20092Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20092Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20092Servers(val *InlineResponse20092Servers) *NullableInlineResponse20092Servers {
	return &NullableInlineResponse20092Servers{value: val, isSet: true}
}

func (v NullableInlineResponse20092Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20092Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
