...
// InlineResponse200375Radio Wireless access point radio identifier.
type InlineResponse200375Radio struct {
...
func NewInlineResponse200375Radio() *InlineResponse200375Radio {
	this := InlineResponse200375Radio{}
	return &this
}
...
func (o InlineResponse200375Radio) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200375Radio struct {
	value *InlineResponse200375Radio
	isSet bool
}

func (v NullableInlineResponse200375Radio) Get() *InlineResponse200375Radio {
	return v.value
}

func (v *NullableInlineResponse200375Radio) Set(val *InlineResponse200375Radio) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200375Radio) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200375Radio) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200375Radio(val *InlineResponse200375Radio) *NullableInlineResponse200375Radio {
	return &NullableInlineResponse200375Radio{value: val, isSet: true}
}

func (v NullableInlineResponse200375Radio) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200375Radio) UnmarshalJSON(src []byte) error {
	v.isSet = true
