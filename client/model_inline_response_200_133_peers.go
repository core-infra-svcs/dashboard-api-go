...
// InlineResponse200133Peers struct for InlineResponse200133Peers
type InlineResponse200133Peers struct {
	...
	IpsecPolicies *InlineResponse200133IpsecPolicies `json:"ipsecPolicies,omitempty"`
...
func NewInlineResponse200133Peers() *InlineResponse200133Peers {
	this := InlineResponse200133Peers{}
...
func (o *InlineResponse200133Peers) GetIpsecPolicies() InlineResponse200133IpsecPolicies {
	if o == nil || isNil(o.IpsecPolicies) {
		var ret InlineResponse200133IpsecPolicies
		return ret
	}
...
// SetIpsecPolicies gets a reference to the given InlineResponse200133IpsecPolicies and assigns it to the IpsecPolicies field.
...
func (o InlineResponse200133Peers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200133Peers struct {
	value *InlineResponse200133Peers
	isSet bool
}

func (v NullableInlineResponse200133Peers) Get() *InlineResponse200133Peers {
	return v.value
}

func (v *NullableInlineResponse200133Peers) Set(val *InlineResponse200133Peers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200133Peers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200133Peers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200133Peers(val *InlineResponse200133Peers) *NullableInlineResponse200133Peers {
	return &NullableInlineResponse200133Peers{value: val, isSet: true}
}

func (v NullableInlineResponse200133Peers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200133Peers) UnmarshalJSON(src []byte) error {
	v.isSet = true
