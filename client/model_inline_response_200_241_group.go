...
// InlineResponse200241Group [optional] Contains the mapping between primary tunnel and backup tunnels.
type InlineResponse200241Group struct {
	...
	Failover *InlineResponse200241GroupFailover `json:"failover,omitempty"`
...
func NewInlineResponse200241Group() *InlineResponse200241Group {
	this := InlineResponse200241Group{}
	return &this
}
...
func (o *InlineResponse200241Group) GetFailover() InlineResponse200241GroupFailover {
	if o == nil || isNil(o.Failover) {
		var ret InlineResponse200241GroupFailover
		return ret
	}
	return *o.Failover
}
...
// SetFailover gets a reference to the given InlineResponse200241GroupFailover and assigns it to the Failover field.
...
func (o InlineResponse200241Group) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200241Group struct {
	value *InlineResponse200241Group
	isSet bool
}

func (v NullableInlineResponse200241Group) Get() *InlineResponse200241Group {
	return v.value
}

func (v *NullableInlineResponse200241Group) Set(val *InlineResponse200241Group) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200241Group) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200241Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200241Group(val *InlineResponse200241Group) *NullableInlineResponse200241Group {
	return &NullableInlineResponse200241Group{value: val, isSet: true}
}

func (v NullableInlineResponse200241Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200241Group) UnmarshalJSON(src []byte) error {
	v.isSet = true
