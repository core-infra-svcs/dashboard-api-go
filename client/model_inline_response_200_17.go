...
type InlineResponse20017 struct {
	...
	ClientVpnConnections []InlineResponse20017ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20017) GetClientVpnConnections() []InlineResponse20017ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20017ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20017ClientVpnConnections and assigns it to the ClientVpnConnections field.
