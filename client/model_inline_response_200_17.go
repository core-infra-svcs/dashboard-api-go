...
type InlineResponse20017 struct {
	BandwidthLimits *InlineResponse20017BandwidthLimits `json:"bandwidthLimits,omitempty"`
}
...
func (o *InlineResponse20017) GetBandwidthLimits() InlineResponse20017BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse20017BandwidthLimits
		return ret
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse20017BandwidthLimits and assigns it to the BandwidthLimits field.
