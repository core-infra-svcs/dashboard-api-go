...
func (r ClientsApiGetNetworkClientRequest) Execute() (*InlineResponse20018, *http.Response, error) {
...
func (a *ClientsApiService) GetNetworkClientExecute(r ClientsApiGetNetworkClientRequest) (*InlineResponse20018, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ClientsApiGetOrganizationClientsBandwidthUsageHistoryRequest) Execute() ([]InlineResponse20081, *http.Response, error) {
...
func (a *ClientsApiService) GetOrganizationClientsBandwidthUsageHistoryExecute(r ClientsApiGetOrganizationClientsBandwidthUsageHistoryRequest) ([]InlineResponse20081, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ClientsApiGetOrganizationClientsOverviewRequest) Execute() (*InlineResponse20082, *http.Response, error) {
...
func (a *ClientsApiService) GetOrganizationClientsOverviewExecute(r ClientsApiGetOrganizationClientsOverviewRequest) (*InlineResponse20082, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ClientsApiGetOrganizationSummaryTopClientsByUsageRequest) Execute() ([]InlineResponse200112, *http.Response, error) {
...
func (a *ClientsApiService) GetOrganizationSummaryTopClientsByUsageExecute(r ClientsApiGetOrganizationSummaryTopClientsByUsageRequest) ([]InlineResponse200112, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ClientsApiGetOrganizationSummaryTopClientsManufacturersByUsageRequest) Execute() ([]InlineResponse200113, *http.Response, error) {
...
func (a *ClientsApiService) GetOrganizationSummaryTopClientsManufacturersByUsageExecute(r ClientsApiGetOrganizationSummaryTopClientsManufacturersByUsageRequest) ([]InlineResponse200113, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ClientsApiProvisionNetworkClientsRequest) ProvisionNetworkClients(provisionNetworkClients InlineObject70) ClientsApiProvisionNetworkClientsRequest {
...
func (r ClientsApiUpdateNetworkClientPolicyRequest) UpdateNetworkClientPolicy(updateNetworkClientPolicy InlineObject71) ClientsApiUpdateNetworkClientPolicyRequest {
...
func (r ClientsApiUpdateNetworkClientSplashAuthorizationStatusRequest) UpdateNetworkClientSplashAuthorizationStatus(updateNetworkClientSplashAuthorizationStatus InlineObject72) ClientsApiUpdateNetworkClientSplashAuthorizationStatusRequest {
