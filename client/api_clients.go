...
func (r ClientsApiGetOrganizationWirelessControllerClientsOverviewHistoryByDeviceByIntervalRequest) Execute() (*InlineResponse200379, *http.Response, error) {
...
func (a *ClientsApiService) GetOrganizationWirelessControllerClientsOverviewHistoryByDeviceByIntervalExecute(r ClientsApiGetOrganizationWirelessControllerClientsOverviewHistoryByDeviceByIntervalRequest) (*InlineResponse200379, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
