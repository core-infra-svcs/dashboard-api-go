...
func (o *InlineResponse200321) GetNetwork() OrganizationsOrganizationIdWirelessDevicesEthernetStatusesNetwork {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200321) GetNetworkOk() (*OrganizationsOrganizationIdWirelessDevicesEthernetStatusesNetwork, bool) {
	if o == nil || isNil(o.Network) {
    return nil, false
	}
...
func (o *InlineResponse200321) SetNetwork(v OrganizationsOrganizationIdWirelessDevicesEthernetStatusesNetwork) {
	o.Network = &v
}

// GetPower returns the Power field value if set, zero value otherwise.
func (o *InlineResponse200321) GetPower() OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPower {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200321) GetPowerOk() (*OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPower, bool) {
	if o == nil || isNil(o.Power) {
    return nil, false
	}
	return o.Power, true
...
func (o *InlineResponse200321) HasPower() bool {
	if o != nil && !isNil(o.Power) {
		return true
	}
...
func (o *InlineResponse200321) SetPower(v OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPower) {
	o.Power = &v
}

// GetPorts returns the Ports field value if set, zero value otherwise.
func (o *InlineResponse200321) GetPorts() []OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPorts {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200321) GetPortsOk() ([]OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPorts, bool) {
	if o == nil || isNil(o.Ports) {
    return nil, false
	}
	return o.Ports, true
...
func (o *InlineResponse200321) HasPorts() bool {
	if o != nil && !isNil(o.Ports) {
		return true
	}
...
func (o *InlineResponse200321) SetPorts(v []OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPorts) {
	o.Ports = v
}

// GetAggregation returns the Aggregation field value if set, zero value otherwise.
func (o *InlineResponse200321) GetAggregation() OrganizationsOrganizationIdWirelessDevicesEthernetStatusesAggregation {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200321) GetAggregationOk() (*OrganizationsOrganizationIdWirelessDevicesEthernetStatusesAggregation, bool) {
	if o == nil || isNil(o.Aggregation) {
    return nil, false
	}
...
func (o *InlineResponse200321) HasAggregation() bool {
	if o != nil && !isNil(o.Aggregation) {
		return true
	}
...
func (o *InlineResponse200321) SetAggregation(v OrganizationsOrganizationIdWirelessDevicesEthernetStatusesAggregation) {
	o.Aggregation = &v
}
