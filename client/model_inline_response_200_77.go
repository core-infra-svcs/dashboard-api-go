...
type InlineResponse20077 struct {
	...
	Switches []InlineResponse20077Switches `json:"switches,omitempty"`
}
...
func (o *InlineResponse20077) GetSwitches() []InlineResponse20077Switches {
	if o == nil || isNil(o.Switches) {
		var ret []InlineResponse20077Switches
		return ret
	}
	return o.Switches
}
...
// SetSwitches gets a reference to the given []InlineResponse20077Switches and assigns it to the Switches field.
