...
type InlineResponse20077 struct {
	...
	Hubs []InlineResponse20077Hubs `json:"hubs,omitempty"`
...
func (o *InlineResponse20077) GetHubs() []InlineResponse20077Hubs {
	if o == nil || isNil(o.Hubs) {
		var ret []InlineResponse20077Hubs
		return ret
	}
	return o.Hubs
}
...
// SetHubs gets a reference to the given []InlineResponse20077Hubs and assigns it to the Hubs field.
