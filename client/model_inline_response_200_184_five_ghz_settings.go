...
// InlineResponse200184FiveGhzSettings Settings related to 5Ghz band
type InlineResponse200184FiveGhzSettings struct {
...
func NewInlineResponse200184FiveGhzSettings() *InlineResponse200184FiveGhzSettings {
	this := InlineResponse200184FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse200184FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200184FiveGhzSettings struct {
	value *InlineResponse200184FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse200184FiveGhzSettings) Get() *InlineResponse200184FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200184FiveGhzSettings) Set(val *InlineResponse200184FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200184FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200184FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200184FiveGhzSettings(val *InlineResponse200184FiveGhzSettings) *NullableInlineResponse200184FiveGhzSettings {
	return &NullableInlineResponse200184FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200184FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200184FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
