...
// InlineResponse20091IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse20091IpsecPolicies struct {
...
func NewInlineResponse20091IpsecPolicies() *InlineResponse20091IpsecPolicies {
	this := InlineResponse20091IpsecPolicies{}
	return &this
}
...
func (o InlineResponse20091IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20091IpsecPolicies struct {
	value *InlineResponse20091IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse20091IpsecPolicies) Get() *InlineResponse20091IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse20091IpsecPolicies) Set(val *InlineResponse20091IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20091IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20091IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20091IpsecPolicies(val *InlineResponse20091IpsecPolicies) *NullableInlineResponse20091IpsecPolicies {
	return &NullableInlineResponse20091IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse20091IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20091IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
