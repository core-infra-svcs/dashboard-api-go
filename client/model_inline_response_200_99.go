...
type InlineResponse20099 struct {
	...
	Devices []InlineResponse20091 `json:"devices,omitempty"`
...
// SetDevices gets a reference to the given []InlineResponse20091 and assigns it to the Devices field.
