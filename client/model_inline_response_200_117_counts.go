...
// InlineResponse200117Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse200117Counts struct {
	...
	Noise *InlineResponse200117CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse200117Counts() *InlineResponse200117Counts {
	this := InlineResponse200117Counts{}
	return &this
}
...
func (o *InlineResponse200117Counts) GetNoise() InlineResponse200117CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse200117CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse200117CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse200117Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200117Counts struct {
	value *InlineResponse200117Counts
	isSet bool
}

func (v NullableInlineResponse200117Counts) Get() *InlineResponse200117Counts {
	return v.value
}

func (v *NullableInlineResponse200117Counts) Set(val *InlineResponse200117Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200117Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200117Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200117Counts(val *InlineResponse200117Counts) *NullableInlineResponse200117Counts {
	return &NullableInlineResponse200117Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200117Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200117Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
