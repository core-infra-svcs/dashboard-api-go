...
func (o *InlineResponse200200) GetProfileId() string {
...
func (o *InlineResponse200200) GetProfileIdOk() (*string, bool) {
	if o == nil || isNil(o.ProfileId) {
    return nil, false
	}
...
func (o *InlineResponse200200) HasProfileId() bool {
	if o != nil && !isNil(o.ProfileId) {
		return true
	}
...
func (o *InlineResponse200200) SetProfileId(v string) {
	o.ProfileId = &v
}
