...
type InlineResponse200200 struct {
	...
	ApBandSettings *InlineResponse200200ApBandSettings `json:"apBandSettings,omitempty"`
	...
	SixGhzSettings *InlineResponse200200SixGhzSettings `json:"sixGhzSettings,omitempty"`
	Transmission *InlineResponse200200Transmission `json:"transmission,omitempty"`
	PerSsidSettings *InlineResponse200200PerSsidSettings `json:"perSsidSettings,omitempty"`
...
func (o *InlineResponse200200) GetApBandSettings() InlineResponse200200ApBandSettings {
	if o == nil || isNil(o.ApBandSettings) {
		var ret InlineResponse200200ApBandSettings
		return ret
	}
...
// SetApBandSettings gets a reference to the given InlineResponse200200ApBandSettings and assigns it to the ApBandSettings field.
...
func (o *InlineResponse200200) GetSixGhzSettings() InlineResponse200200SixGhzSettings {
	if o == nil || isNil(o.SixGhzSettings) {
		var ret InlineResponse200200SixGhzSettings
		return ret
	}
...
// SetSixGhzSettings gets a reference to the given InlineResponse200200SixGhzSettings and assigns it to the SixGhzSettings field.
...
func (o *InlineResponse200200) GetPerSsidSettings() InlineResponse200200PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse200200PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse200200PerSsidSettings and assigns it to the PerSsidSettings field.
