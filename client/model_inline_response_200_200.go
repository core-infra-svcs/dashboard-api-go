...
func (o *InlineResponse200200) GetSerial() string {
...
func (o *InlineResponse200200) GetSerialOk() (*string, bool) {
	if o == nil || isNil(o.Serial) {
    return nil, false
	}
...
func (o *InlineResponse200200) HasSerial() bool {
	if o != nil && !isNil(o.Serial) {
		return true
	}
...
func (o *InlineResponse200200) SetSerial(v string) {
	o.Serial = &v
}
...
func (o *InlineResponse200200) GetNetwork() OrganizationsOrganizationIdWirelessDevicesEthernetStatusesNetwork {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200200) GetNetworkOk() (*OrganizationsOrganizationIdWirelessDevicesEthernetStatusesNetwork, bool) {
	if o == nil || isNil(o.Network) {
    return nil, false
	}
...
func (o *InlineResponse200200) SetNetwork(v OrganizationsOrganizationIdWirelessDevicesEthernetStatusesNetwork) {
	o.Network = &v
}

// GetPower returns the Power field value if set, zero value otherwise.
func (o *InlineResponse200200) GetPower() OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPower {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200200) GetPowerOk() (*OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPower, bool) {
	if o == nil || isNil(o.Power) {
    return nil, false
	}
	return o.Power, true
...
func (o *InlineResponse200200) HasPower() bool {
	if o != nil && !isNil(o.Power) {
		return true
	}
...
func (o *InlineResponse200200) SetPower(v OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPower) {
	o.Power = &v
}

// GetPorts returns the Ports field value if set, zero value otherwise.
func (o *InlineResponse200200) GetPorts() []OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPorts {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200200) GetPortsOk() ([]OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPorts, bool) {
	if o == nil || isNil(o.Ports) {
    return nil, false
	}
	return o.Ports, true
...
func (o *InlineResponse200200) HasPorts() bool {
	if o != nil && !isNil(o.Ports) {
		return true
	}
...
func (o *InlineResponse200200) SetPorts(v []OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPorts) {
	o.Ports = v
}

// GetAggregation returns the Aggregation field value if set, zero value otherwise.
func (o *InlineResponse200200) GetAggregation() OrganizationsOrganizationIdWirelessDevicesEthernetStatusesAggregation {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200200) GetAggregationOk() (*OrganizationsOrganizationIdWirelessDevicesEthernetStatusesAggregation, bool) {
	if o == nil || isNil(o.Aggregation) {
    return nil, false
	}
...
func (o *InlineResponse200200) HasAggregation() bool {
	if o != nil && !isNil(o.Aggregation) {
		return true
	}
...
func (o *InlineResponse200200) SetAggregation(v OrganizationsOrganizationIdWirelessDevicesEthernetStatusesAggregation) {
	o.Aggregation = &v
}
