...
type InlineResponse200200 struct {
	...
	SplashLogo *InlineResponse200200SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200200SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200200SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200200GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200200Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200200SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200200SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200200) GetSplashLogo() InlineResponse200200SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200200SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200200SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200200) GetSplashImage() InlineResponse200200SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200200SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200200SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200200) GetSplashPrepaidFront() InlineResponse200200SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200200SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200200SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200200) GetGuestSponsorship() InlineResponse200200GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200200GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200200GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200200) GetBilling() InlineResponse200200Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200200Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200200Billing and assigns it to the Billing field.
...
func (o *InlineResponse200200) GetSentryEnrollment() InlineResponse200200SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200200SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200200SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200200) GetSelfRegistration() InlineResponse200200SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200200SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200200SelfRegistration and assigns it to the SelfRegistration field.
