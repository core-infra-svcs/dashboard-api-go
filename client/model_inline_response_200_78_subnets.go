...
// InlineResponse20078Subnets struct for InlineResponse20078Subnets
type InlineResponse20078Subnets struct {
...
func NewInlineResponse20078Subnets() *InlineResponse20078Subnets {
	this := InlineResponse20078Subnets{}
	return &this
}
...
func (o InlineResponse20078Subnets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20078Subnets struct {
	value *InlineResponse20078Subnets
	isSet bool
}

func (v NullableInlineResponse20078Subnets) Get() *InlineResponse20078Subnets {
	return v.value
}

func (v *NullableInlineResponse20078Subnets) Set(val *InlineResponse20078Subnets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20078Subnets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20078Subnets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20078Subnets(val *InlineResponse20078Subnets) *NullableInlineResponse20078Subnets {
	return &NullableInlineResponse20078Subnets{value: val, isSet: true}
}

func (v NullableInlineResponse20078Subnets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20078Subnets) UnmarshalJSON(src []byte) error {
	v.isSet = true
