...
func (r EarlyAccessApiGetOrganizationEarlyAccessFeaturesRequest) Execute() ([]InlineResponse200129, *http.Response, error) {
...
func (a *EarlyAccessApiService) GetOrganizationEarlyAccessFeaturesExecute(r EarlyAccessApiGetOrganizationEarlyAccessFeaturesRequest) ([]InlineResponse200129, *http.Response, error) {
	var (
