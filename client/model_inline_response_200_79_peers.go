...
// InlineResponse20079Peers struct for InlineResponse20079Peers
type InlineResponse20079Peers struct {
	...
	IpsecPolicies *InlineResponse20079IpsecPolicies `json:"ipsecPolicies,omitempty"`
...
func (o *InlineResponse20079Peers) GetIpsecPolicies() InlineResponse20079IpsecPolicies {
	if o == nil || isNil(o.IpsecPolicies) {
		var ret InlineResponse20079IpsecPolicies
		return ret
	}
...
// SetIpsecPolicies gets a reference to the given InlineResponse20079IpsecPolicies and assigns it to the IpsecPolicies field.
...
func (o InlineResponse20079Peers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20079Peers struct {
	value *InlineResponse20079Peers
	isSet bool
}

func (v NullableInlineResponse20079Peers) Get() *InlineResponse20079Peers {
	return v.value
}

func (v *NullableInlineResponse20079Peers) Set(val *InlineResponse20079Peers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20079Peers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20079Peers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20079Peers(val *InlineResponse20079Peers) *NullableInlineResponse20079Peers {
	return &NullableInlineResponse20079Peers{value: val, isSet: true}
}

func (v NullableInlineResponse20079Peers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20079Peers) UnmarshalJSON(src []byte) error {
	v.isSet = true
