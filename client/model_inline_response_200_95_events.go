...
// InlineResponse20095Events struct for InlineResponse20095Events
type InlineResponse20095Events struct {
	...
	EventData *InlineResponse20095EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20095Events() *InlineResponse20095Events {
	this := InlineResponse20095Events{}
	return &this
}
...
func (o *InlineResponse20095Events) GetEventData() InlineResponse20095EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20095EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20095EventData and assigns it to the EventData field.
func (o *InlineResponse20095Events) SetEventData(v InlineResponse20095EventData) {
	o.EventData = &v
}

func (o InlineResponse20095Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20095Events struct {
	value *InlineResponse20095Events
	isSet bool
}

func (v NullableInlineResponse20095Events) Get() *InlineResponse20095Events {
	return v.value
}

func (v *NullableInlineResponse20095Events) Set(val *InlineResponse20095Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20095Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20095Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20095Events(val *InlineResponse20095Events) *NullableInlineResponse20095Events {
	return &NullableInlineResponse20095Events{value: val, isSet: true}
}

func (v NullableInlineResponse20095Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20095Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
