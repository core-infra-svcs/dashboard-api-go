...
// InlineResponse200194Rules struct for InlineResponse200194Rules
type InlineResponse200194Rules struct {
...
func NewInlineResponse200194Rules(definitions []NetworksNetworkIdApplianceTrafficShapingRulesDefinitions) *InlineResponse200194Rules {
	this := InlineResponse200194Rules{}
...
func (o InlineResponse200194Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200194Rules struct {
	value *InlineResponse200194Rules
	isSet bool
}

func (v NullableInlineResponse200194Rules) Get() *InlineResponse200194Rules {
	return v.value
}

func (v *NullableInlineResponse200194Rules) Set(val *InlineResponse200194Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200194Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200194Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200194Rules(val *InlineResponse200194Rules) *NullableInlineResponse200194Rules {
	return &NullableInlineResponse200194Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200194Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200194Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
