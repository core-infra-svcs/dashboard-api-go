...
type InlineResponse200318 struct {
	...
	Items []InlineResponse200318Items `json:"items,omitempty"`
...
// SetItems gets a reference to the given []InlineResponse200318Items and assigns it to the Items field.
