...
// InlineResponse200249MetaCountsItems Count of Communication Plans available
type InlineResponse200249MetaCountsItems struct {
...
func NewInlineResponse200249MetaCountsItems() *InlineResponse200249MetaCountsItems {
	this := InlineResponse200249MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200249MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200249MetaCountsItems struct {
	value *InlineResponse200249MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200249MetaCountsItems) Get() *InlineResponse200249MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200249MetaCountsItems) Set(val *InlineResponse200249MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200249MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200249MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200249MetaCountsItems(val *InlineResponse200249MetaCountsItems) *NullableInlineResponse200249MetaCountsItems {
	return &NullableInlineResponse200249MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200249MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200249MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
