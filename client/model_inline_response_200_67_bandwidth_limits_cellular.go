...
// InlineResponse20067BandwidthLimitsCellular uplink cellular configured limits [optional]
type InlineResponse20067BandwidthLimitsCellular struct {
...
func NewInlineResponse20067BandwidthLimitsCellular() *InlineResponse20067BandwidthLimitsCellular {
	this := InlineResponse20067BandwidthLimitsCellular{}
	return &this
}
...
func (o InlineResponse20067BandwidthLimitsCellular) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20067BandwidthLimitsCellular struct {
	value *InlineResponse20067BandwidthLimitsCellular
	isSet bool
}

func (v NullableInlineResponse20067BandwidthLimitsCellular) Get() *InlineResponse20067BandwidthLimitsCellular {
	return v.value
}

func (v *NullableInlineResponse20067BandwidthLimitsCellular) Set(val *InlineResponse20067BandwidthLimitsCellular) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20067BandwidthLimitsCellular) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20067BandwidthLimitsCellular) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20067BandwidthLimitsCellular(val *InlineResponse20067BandwidthLimitsCellular) *NullableInlineResponse20067BandwidthLimitsCellular {
	return &NullableInlineResponse20067BandwidthLimitsCellular{value: val, isSet: true}
}

func (v NullableInlineResponse20067BandwidthLimitsCellular) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20067BandwidthLimitsCellular) UnmarshalJSON(src []byte) error {
	v.isSet = true
