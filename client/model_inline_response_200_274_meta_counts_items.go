...
// InlineResponse200274MetaCountsItems Meta data of the items
type InlineResponse200274MetaCountsItems struct {
...
func NewInlineResponse200274MetaCountsItems() *InlineResponse200274MetaCountsItems {
	this := InlineResponse200274MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200274MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200274MetaCountsItems struct {
	value *InlineResponse200274MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200274MetaCountsItems) Get() *InlineResponse200274MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200274MetaCountsItems) Set(val *InlineResponse200274MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200274MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200274MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200274MetaCountsItems(val *InlineResponse200274MetaCountsItems) *NullableInlineResponse200274MetaCountsItems {
	return &NullableInlineResponse200274MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200274MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200274MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
