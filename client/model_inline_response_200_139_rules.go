...
// InlineResponse200139Rules struct for InlineResponse200139Rules
type InlineResponse200139Rules struct {
...
func NewInlineResponse200139Rules() *InlineResponse200139Rules {
	this := InlineResponse200139Rules{}
	return &this
}
...
func (o InlineResponse200139Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200139Rules struct {
	value *InlineResponse200139Rules
	isSet bool
}

func (v NullableInlineResponse200139Rules) Get() *InlineResponse200139Rules {
	return v.value
}

func (v *NullableInlineResponse200139Rules) Set(val *InlineResponse200139Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200139Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200139Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200139Rules(val *InlineResponse200139Rules) *NullableInlineResponse200139Rules {
	return &NullableInlineResponse200139Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200139Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200139Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
