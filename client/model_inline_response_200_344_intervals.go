...
// InlineResponse200344Intervals struct for InlineResponse200344Intervals
type InlineResponse200344Intervals struct {
	// The start time of the query range with iso8601 format
	StartTs *string `json:"startTs,omitempty"`
	// The end time of the query range  with iso8601 format
	EndTs *string `json:"endTs,omitempty"`
	Overall *InlineResponse200344Overall `json:"overall,omitempty"`
	// The CPU usage per core of the wireless LAN controller
	ByCore []InlineResponse200344ByCore `json:"byCore,omitempty"`
}
...
func NewInlineResponse200344Intervals() *InlineResponse200344Intervals {
	this := InlineResponse200344Intervals{}
	return &this
}
...
func (o *InlineResponse200344Intervals) GetOverall() InlineResponse200344Overall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200344Overall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200344Overall and assigns it to the Overall field.
...
func (o *InlineResponse200344Intervals) GetByCore() []InlineResponse200344ByCore {
	if o == nil || isNil(o.ByCore) {
		var ret []InlineResponse200344ByCore
		return ret
	}
	return o.ByCore
}
...
// SetByCore gets a reference to the given []InlineResponse200344ByCore and assigns it to the ByCore field.
func (o *InlineResponse200344Intervals) SetByCore(v []InlineResponse200344ByCore) {
	o.ByCore = v
}

func (o InlineResponse200344Intervals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200344Intervals struct {
	value *InlineResponse200344Intervals
	isSet bool
}

func (v NullableInlineResponse200344Intervals) Get() *InlineResponse200344Intervals {
	return v.value
}

func (v *NullableInlineResponse200344Intervals) Set(val *InlineResponse200344Intervals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200344Intervals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200344Intervals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200344Intervals(val *InlineResponse200344Intervals) *NullableInlineResponse200344Intervals {
	return &NullableInlineResponse200344Intervals{value: val, isSet: true}
}

func (v NullableInlineResponse200344Intervals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200344Intervals) UnmarshalJSON(src []byte) error {
	v.isSet = true
