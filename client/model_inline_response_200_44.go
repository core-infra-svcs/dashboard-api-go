...
type InlineResponse20044 struct {
	...
	ConnectionStats *InlineResponse20044ConnectionStats `json:"connectionStats,omitempty"`
}
...
func (o *InlineResponse20044) GetConnectionStats() InlineResponse20044ConnectionStats {
	if o == nil || isNil(o.ConnectionStats) {
		var ret InlineResponse20044ConnectionStats
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20044) GetConnectionStatsOk() (*InlineResponse20044ConnectionStats, bool) {
	if o == nil || isNil(o.ConnectionStats) {
    return nil, false
	}
...
func (o *InlineResponse20044) HasConnectionStats() bool {
	if o != nil && !isNil(o.ConnectionStats) {
		return true
	}
...
// SetConnectionStats gets a reference to the given InlineResponse20044ConnectionStats and assigns it to the ConnectionStats field.
func (o *InlineResponse20044) SetConnectionStats(v InlineResponse20044ConnectionStats) {
	o.ConnectionStats = &v
}
