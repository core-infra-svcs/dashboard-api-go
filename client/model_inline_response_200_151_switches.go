...
// InlineResponse200151Switches struct for InlineResponse200151Switches
type InlineResponse200151Switches struct {
...
func NewInlineResponse200151Switches() *InlineResponse200151Switches {
	this := InlineResponse200151Switches{}
	return &this
}
...
func (o InlineResponse200151Switches) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200151Switches struct {
	value *InlineResponse200151Switches
	isSet bool
}

func (v NullableInlineResponse200151Switches) Get() *InlineResponse200151Switches {
	return v.value
}

func (v *NullableInlineResponse200151Switches) Set(val *InlineResponse200151Switches) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200151Switches) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200151Switches) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200151Switches(val *InlineResponse200151Switches) *NullableInlineResponse200151Switches {
	return &NullableInlineResponse200151Switches{value: val, isSet: true}
}

func (v NullableInlineResponse200151Switches) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200151Switches) UnmarshalJSON(src []byte) error {
	v.isSet = true
