...
// InlineResponse200377Readings struct for InlineResponse200377Readings
type InlineResponse200377Readings struct {
	...
	Rate *InlineResponse200377Rate `json:"rate,omitempty"`
}
...
func NewInlineResponse200377Readings() *InlineResponse200377Readings {
	this := InlineResponse200377Readings{}
	return &this
}
...
func (o *InlineResponse200377Readings) GetRate() InlineResponse200377Rate {
	if o == nil || isNil(o.Rate) {
		var ret InlineResponse200377Rate
		return ret
	}
	return *o.Rate
}
...
// SetRate gets a reference to the given InlineResponse200377Rate and assigns it to the Rate field.
func (o *InlineResponse200377Readings) SetRate(v InlineResponse200377Rate) {
	o.Rate = &v
}

func (o InlineResponse200377Readings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200377Readings struct {
	value *InlineResponse200377Readings
	isSet bool
}

func (v NullableInlineResponse200377Readings) Get() *InlineResponse200377Readings {
	return v.value
}

func (v *NullableInlineResponse200377Readings) Set(val *InlineResponse200377Readings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200377Readings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200377Readings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200377Readings(val *InlineResponse200377Readings) *NullableInlineResponse200377Readings {
	return &NullableInlineResponse200377Readings{value: val, isSet: true}
}

func (v NullableInlineResponse200377Readings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200377Readings) UnmarshalJSON(src []byte) error {
	v.isSet = true
