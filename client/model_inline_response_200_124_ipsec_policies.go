...
// InlineResponse200124IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200124IpsecPolicies struct {
...
func NewInlineResponse200124IpsecPolicies() *InlineResponse200124IpsecPolicies {
	this := InlineResponse200124IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200124IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200124IpsecPolicies struct {
	value *InlineResponse200124IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200124IpsecPolicies) Get() *InlineResponse200124IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200124IpsecPolicies) Set(val *InlineResponse200124IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200124IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200124IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200124IpsecPolicies(val *InlineResponse200124IpsecPolicies) *NullableInlineResponse200124IpsecPolicies {
	return &NullableInlineResponse200124IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200124IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200124IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
