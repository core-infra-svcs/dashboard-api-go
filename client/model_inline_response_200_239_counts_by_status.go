...
// InlineResponse200239CountsByStatus byStatus
type InlineResponse200239CountsByStatus struct {
	// online count
...
func NewInlineResponse200239CountsByStatus() *InlineResponse200239CountsByStatus {
	this := InlineResponse200239CountsByStatus{}
	return &this
}
...
func (o InlineResponse200239CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200239CountsByStatus struct {
	value *InlineResponse200239CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200239CountsByStatus) Get() *InlineResponse200239CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200239CountsByStatus) Set(val *InlineResponse200239CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200239CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200239CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200239CountsByStatus(val *InlineResponse200239CountsByStatus) *NullableInlineResponse200239CountsByStatus {
	return &NullableInlineResponse200239CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200239CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200239CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
