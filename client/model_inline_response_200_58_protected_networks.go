...
// InlineResponse20058ProtectedNetworks Networks included in and excluded from the detection engine
type InlineResponse20058ProtectedNetworks struct {
...
func NewInlineResponse20058ProtectedNetworks() *InlineResponse20058ProtectedNetworks {
	this := InlineResponse20058ProtectedNetworks{}
	return &this
}
...
func (o InlineResponse20058ProtectedNetworks) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20058ProtectedNetworks struct {
	value *InlineResponse20058ProtectedNetworks
	isSet bool
}

func (v NullableInlineResponse20058ProtectedNetworks) Get() *InlineResponse20058ProtectedNetworks {
	return v.value
}

func (v *NullableInlineResponse20058ProtectedNetworks) Set(val *InlineResponse20058ProtectedNetworks) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20058ProtectedNetworks) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20058ProtectedNetworks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20058ProtectedNetworks(val *InlineResponse20058ProtectedNetworks) *NullableInlineResponse20058ProtectedNetworks {
	return &NullableInlineResponse20058ProtectedNetworks{value: val, isSet: true}
}

func (v NullableInlineResponse20058ProtectedNetworks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20058ProtectedNetworks) UnmarshalJSON(src []byte) error {
	v.isSet = true
