...
// InlineResponse200416Intervals struct for InlineResponse200416Intervals
type InlineResponse200416Intervals struct {
	...
	Overall *InlineResponse200416Overall `json:"overall,omitempty"`
	// The usage data on the interfaces of the wireless LAN controller
	ByInterface []InlineResponse200416ByInterface `json:"byInterface,omitempty"`
}
...
func NewInlineResponse200416Intervals() *InlineResponse200416Intervals {
	this := InlineResponse200416Intervals{}
	return &this
}
...
func (o *InlineResponse200416Intervals) GetOverall() InlineResponse200416Overall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200416Overall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200416Overall and assigns it to the Overall field.
...
func (o *InlineResponse200416Intervals) GetByInterface() []InlineResponse200416ByInterface {
	if o == nil || isNil(o.ByInterface) {
		var ret []InlineResponse200416ByInterface
		return ret
	}
...
// SetByInterface gets a reference to the given []InlineResponse200416ByInterface and assigns it to the ByInterface field.
func (o *InlineResponse200416Intervals) SetByInterface(v []InlineResponse200416ByInterface) {
	o.ByInterface = v
}

func (o InlineResponse200416Intervals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200416Intervals struct {
	value *InlineResponse200416Intervals
	isSet bool
}

func (v NullableInlineResponse200416Intervals) Get() *InlineResponse200416Intervals {
	return v.value
}

func (v *NullableInlineResponse200416Intervals) Set(val *InlineResponse200416Intervals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200416Intervals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200416Intervals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200416Intervals(val *InlineResponse200416Intervals) *NullableInlineResponse200416Intervals {
	return &NullableInlineResponse200416Intervals{value: val, isSet: true}
}

func (v NullableInlineResponse200416Intervals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200416Intervals) UnmarshalJSON(src []byte) error {
	v.isSet = true
