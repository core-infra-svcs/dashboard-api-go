...
// InlineResponse200262Usage Usage information of all clients across organization
type InlineResponse200262Usage struct {
	Overall *InlineResponse200262UsageOverall `json:"overall,omitempty"`
...
func NewInlineResponse200262Usage() *InlineResponse200262Usage {
	this := InlineResponse200262Usage{}
	return &this
}
...
func (o *InlineResponse200262Usage) GetOverall() InlineResponse200262UsageOverall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200262UsageOverall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200262UsageOverall and assigns it to the Overall field.
...
func (o InlineResponse200262Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200262Usage struct {
	value *InlineResponse200262Usage
	isSet bool
}

func (v NullableInlineResponse200262Usage) Get() *InlineResponse200262Usage {
	return v.value
}

func (v *NullableInlineResponse200262Usage) Set(val *InlineResponse200262Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200262Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200262Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200262Usage(val *InlineResponse200262Usage) *NullableInlineResponse200262Usage {
	return &NullableInlineResponse200262Usage{value: val, isSet: true}
}

func (v NullableInlineResponse200262Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200262Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
