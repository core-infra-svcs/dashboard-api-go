...
// InlineResponse20032Value1 Value of traffic filter
type InlineResponse20032Value1 struct {
	...
	Source *InlineResponse20032Value1Source `json:"source,omitempty"`
	Destination *InlineResponse20032Value1Destination `json:"destination,omitempty"`
}
...
func NewInlineResponse20032Value1() *InlineResponse20032Value1 {
	this := InlineResponse20032Value1{}
	return &this
}
...
func (o *InlineResponse20032Value1) GetSource() InlineResponse20032Value1Source {
	if o == nil || isNil(o.Source) {
		var ret InlineResponse20032Value1Source
		return ret
	}
	return *o.Source
}
...
// SetSource gets a reference to the given InlineResponse20032Value1Source and assigns it to the Source field.
...
func (o *InlineResponse20032Value1) GetDestination() InlineResponse20032Value1Destination {
	if o == nil || isNil(o.Destination) {
		var ret InlineResponse20032Value1Destination
		return ret
	}
...
// SetDestination gets a reference to the given InlineResponse20032Value1Destination and assigns it to the Destination field.
func (o *InlineResponse20032Value1) SetDestination(v InlineResponse20032Value1Destination) {
	o.Destination = &v
}

func (o InlineResponse20032Value1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20032Value1 struct {
	value *InlineResponse20032Value1
	isSet bool
}

func (v NullableInlineResponse20032Value1) Get() *InlineResponse20032Value1 {
	return v.value
}

func (v *NullableInlineResponse20032Value1) Set(val *InlineResponse20032Value1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20032Value1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20032Value1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20032Value1(val *InlineResponse20032Value1) *NullableInlineResponse20032Value1 {
	return &NullableInlineResponse20032Value1{value: val, isSet: true}
}

func (v NullableInlineResponse20032Value1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20032Value1) UnmarshalJSON(src []byte) error {
	v.isSet = true
