...
// InlineResponse20077Nat Configuration of NAT for the subnet
type InlineResponse20077Nat struct {
...
func (o InlineResponse20077Nat) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20077Nat struct {
	value *InlineResponse20077Nat
	isSet bool
}

func (v NullableInlineResponse20077Nat) Get() *InlineResponse20077Nat {
	return v.value
}

func (v *NullableInlineResponse20077Nat) Set(val *InlineResponse20077Nat) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20077Nat) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20077Nat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20077Nat(val *InlineResponse20077Nat) *NullableInlineResponse20077Nat {
	return &NullableInlineResponse20077Nat{value: val, isSet: true}
}

func (v NullableInlineResponse20077Nat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20077Nat) UnmarshalJSON(src []byte) error {
	v.isSet = true
