...
type InlineResponse200257Items struct {
	...
	// Available APNs
	Apns []InlineResponse200257Apns `json:"apns,omitempty"`
...
func (o *InlineResponse200257Items) GetApns() []InlineResponse200257Apns {
	if o == nil || isNil(o.Apns) {
		var ret []InlineResponse200257Apns
		return ret
	}
	return o.Apns
}
...
// SetApns gets a reference to the given []InlineResponse200257Apns and assigns it to the Apns field.
