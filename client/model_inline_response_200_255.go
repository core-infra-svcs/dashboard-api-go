...
type InlineResponse200255 struct {
	...
	States *InlineResponse200255States `json:"states,omitempty"`
	// Data by license type (Per-device licensing only)
	LicenseTypes []InlineResponse200255LicenseTypes `json:"licenseTypes,omitempty"`
	SystemsManager *InlineResponse200255SystemsManager `json:"systemsManager,omitempty"`
}
...
func (o *InlineResponse200255) GetStates() InlineResponse200255States {
	if o == nil || isNil(o.States) {
		var ret InlineResponse200255States
		return ret
	}
	return *o.States
}
...
// SetStates gets a reference to the given InlineResponse200255States and assigns it to the States field.
...
func (o *InlineResponse200255) GetLicenseTypes() []InlineResponse200255LicenseTypes {
	if o == nil || isNil(o.LicenseTypes) {
		var ret []InlineResponse200255LicenseTypes
		return ret
	}
...
// SetLicenseTypes gets a reference to the given []InlineResponse200255LicenseTypes and assigns it to the LicenseTypes field.
...
func (o *InlineResponse200255) GetSystemsManager() InlineResponse200255SystemsManager {
	if o == nil || isNil(o.SystemsManager) {
		var ret InlineResponse200255SystemsManager
		return ret
	}
...
// SetSystemsManager gets a reference to the given InlineResponse200255SystemsManager and assigns it to the SystemsManager field.
