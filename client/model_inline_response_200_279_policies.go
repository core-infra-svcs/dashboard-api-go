...
// InlineResponse200279Policies struct for InlineResponse200279Policies
type InlineResponse200279Policies struct {
...
func NewInlineResponse200279Policies() *InlineResponse200279Policies {
	this := InlineResponse200279Policies{}
	return &this
}
...
func (o InlineResponse200279Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200279Policies struct {
	value *InlineResponse200279Policies
	isSet bool
}

func (v NullableInlineResponse200279Policies) Get() *InlineResponse200279Policies {
	return v.value
}

func (v *NullableInlineResponse200279Policies) Set(val *InlineResponse200279Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200279Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200279Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200279Policies(val *InlineResponse200279Policies) *NullableInlineResponse200279Policies {
	return &NullableInlineResponse200279Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200279Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200279Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
