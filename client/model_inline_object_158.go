...
type InlineObject158 struct {
	...
	Md5AuthenticationKey *InlineResponse200177Md5AuthenticationKey `json:"md5AuthenticationKey,omitempty"`
}
...
func (o *InlineObject158) GetMd5AuthenticationKey() InlineResponse200177Md5AuthenticationKey {
	if o == nil || isNil(o.Md5AuthenticationKey) {
		var ret InlineResponse200177Md5AuthenticationKey
		return ret
	}
...
// SetMd5AuthenticationKey gets a reference to the given InlineResponse200177Md5AuthenticationKey and assigns it to the Md5AuthenticationKey field.
