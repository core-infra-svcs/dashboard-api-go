...
func (r ManagementInterfaceApiGetDeviceManagementInterfaceRequest) Execute() (*InlineResponse20031, *http.Response, error) {
...
func (a *ManagementInterfaceApiService) GetDeviceManagementInterfaceExecute(r ManagementInterfaceApiGetDeviceManagementInterfaceRequest) (*InlineResponse20031, *http.Response, error) {
	var (
...
func (r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) UpdateDeviceManagementInterface(updateDeviceManagementInterface InlineObject23) ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest {
	r.updateDeviceManagementInterface = &updateDeviceManagementInterface
	return r
}

func (r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) Execute() (*InlineResponse20031, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20031
func (a *ManagementInterfaceApiService) UpdateDeviceManagementInterfaceExecute(r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) (*InlineResponse20031, *http.Response, error) {
	var (
