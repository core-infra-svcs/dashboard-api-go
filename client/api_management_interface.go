...
func (r ManagementInterfaceApiGetDeviceManagementInterfaceRequest) Execute() (*InlineResponse20032, *http.Response, error) {
...
func (a *ManagementInterfaceApiService) GetDeviceManagementInterfaceExecute(r ManagementInterfaceApiGetDeviceManagementInterfaceRequest) (*InlineResponse20032, *http.Response, error) {
	var (
...
func (r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) UpdateDeviceManagementInterface(updateDeviceManagementInterface InlineObject24) ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest {
	r.updateDeviceManagementInterface = &updateDeviceManagementInterface
	return r
}

func (r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) Execute() (*InlineResponse20032, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20032
func (a *ManagementInterfaceApiService) UpdateDeviceManagementInterfaceExecute(r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) (*InlineResponse20032, *http.Response, error) {
	var (
