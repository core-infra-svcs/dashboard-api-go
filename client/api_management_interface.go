...
func (r ManagementInterfaceApiGetDeviceManagementInterfaceRequest) Execute() (*InlineResponse20033, *http.Response, error) {
...
func (a *ManagementInterfaceApiService) GetDeviceManagementInterfaceExecute(r ManagementInterfaceApiGetDeviceManagementInterfaceRequest) (*InlineResponse20033, *http.Response, error) {
	var (
...
func (r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) UpdateDeviceManagementInterface(updateDeviceManagementInterface InlineObject25) ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest {
	r.updateDeviceManagementInterface = &updateDeviceManagementInterface
	return r
}

func (r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) Execute() (*InlineResponse20033, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20033
func (a *ManagementInterfaceApiService) UpdateDeviceManagementInterfaceExecute(r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) (*InlineResponse20033, *http.Response, error) {
	var (
