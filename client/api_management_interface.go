...
func (r ManagementInterfaceApiGetDeviceManagementInterfaceRequest) Execute() (*InlineResponse20027, *http.Response, error) {
...
func (a *ManagementInterfaceApiService) GetDeviceManagementInterfaceExecute(r ManagementInterfaceApiGetDeviceManagementInterfaceRequest) (*InlineResponse20027, *http.Response, error) {
	var (
...
func (r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) UpdateDeviceManagementInterface(updateDeviceManagementInterface InlineObject22) ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest {
	r.updateDeviceManagementInterface = &updateDeviceManagementInterface
	return r
}

func (r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) Execute() (*InlineResponse20027, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20027
func (a *ManagementInterfaceApiService) UpdateDeviceManagementInterfaceExecute(r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) (*InlineResponse20027, *http.Response, error) {
	var (
