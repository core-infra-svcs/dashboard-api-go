...
func (r ManagementInterfaceApiGetDeviceManagementInterfaceRequest) Execute() (*InlineResponse20029, *http.Response, error) {
...
func (a *ManagementInterfaceApiService) GetDeviceManagementInterfaceExecute(r ManagementInterfaceApiGetDeviceManagementInterfaceRequest) (*InlineResponse20029, *http.Response, error) {
	var (
...
func (r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) Execute() (*InlineResponse20029, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20029
func (a *ManagementInterfaceApiService) UpdateDeviceManagementInterfaceExecute(r ManagementInterfaceApiUpdateDeviceManagementInterfaceRequest) (*InlineResponse20029, *http.Response, error) {
	var (
