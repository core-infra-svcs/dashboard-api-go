...
// InlineResponse200196TwoFourGhzSettings Settings related to 2.4Ghz band
type InlineResponse200196TwoFourGhzSettings struct {
...
func NewInlineResponse200196TwoFourGhzSettings() *InlineResponse200196TwoFourGhzSettings {
	this := InlineResponse200196TwoFourGhzSettings{}
	return &this
}
...
func (o InlineResponse200196TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200196TwoFourGhzSettings struct {
	value *InlineResponse200196TwoFourGhzSettings
	isSet bool
}

func (v NullableInlineResponse200196TwoFourGhzSettings) Get() *InlineResponse200196TwoFourGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200196TwoFourGhzSettings) Set(val *InlineResponse200196TwoFourGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200196TwoFourGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200196TwoFourGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200196TwoFourGhzSettings(val *InlineResponse200196TwoFourGhzSettings) *NullableInlineResponse200196TwoFourGhzSettings {
	return &NullableInlineResponse200196TwoFourGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200196TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200196TwoFourGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
