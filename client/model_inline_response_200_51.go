...
type InlineResponse20051 struct {
	...
	ApplicationCategories []InlineResponse20051ApplicationCategories `json:"applicationCategories,omitempty"`
}
...
func (o *InlineResponse20051) GetApplicationCategories() []InlineResponse20051ApplicationCategories {
	if o == nil || isNil(o.ApplicationCategories) {
		var ret []InlineResponse20051ApplicationCategories
		return ret
	}
...
// SetApplicationCategories gets a reference to the given []InlineResponse20051ApplicationCategories and assigns it to the ApplicationCategories field.
