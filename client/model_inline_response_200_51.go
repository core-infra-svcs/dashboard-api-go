...
type InlineResponse20051 struct {
	...
	LocalStatusPage *InlineResponse20051LocalStatusPage `json:"localStatusPage,omitempty"`
	SecurePort *InlineResponse20051SecurePort `json:"securePort,omitempty"`
	Fips *InlineResponse20051Fips `json:"fips,omitempty"`
	NamedVlans *InlineResponse20051NamedVlans `json:"namedVlans,omitempty"`
}
...
func (o *InlineResponse20051) GetLocalStatusPage() InlineResponse20051LocalStatusPage {
	if o == nil || isNil(o.LocalStatusPage) {
		var ret InlineResponse20051LocalStatusPage
		return ret
	}
...
// SetLocalStatusPage gets a reference to the given InlineResponse20051LocalStatusPage and assigns it to the LocalStatusPage field.
...
func (o *InlineResponse20051) GetSecurePort() InlineResponse20051SecurePort {
	if o == nil || isNil(o.SecurePort) {
		var ret InlineResponse20051SecurePort
		return ret
	}
	return *o.SecurePort
}
...
// SetSecurePort gets a reference to the given InlineResponse20051SecurePort and assigns it to the SecurePort field.
...
func (o *InlineResponse20051) GetFips() InlineResponse20051Fips {
	if o == nil || isNil(o.Fips) {
		var ret InlineResponse20051Fips
		return ret
	}
	return *o.Fips
}
...
// SetFips gets a reference to the given InlineResponse20051Fips and assigns it to the Fips field.
...
func (o *InlineResponse20051) GetNamedVlans() InlineResponse20051NamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret InlineResponse20051NamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given InlineResponse20051NamedVlans and assigns it to the NamedVlans field.
