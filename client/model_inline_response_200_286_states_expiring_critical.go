...
// InlineResponse200286StatesExpiringCritical Data for the critical threshold
type InlineResponse200286StatesExpiringCritical struct {
...
func NewInlineResponse200286StatesExpiringCritical() *InlineResponse200286StatesExpiringCritical {
	this := InlineResponse200286StatesExpiringCritical{}
	return &this
}
...
func (o InlineResponse200286StatesExpiringCritical) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200286StatesExpiringCritical struct {
	value *InlineResponse200286StatesExpiringCritical
	isSet bool
}

func (v NullableInlineResponse200286StatesExpiringCritical) Get() *InlineResponse200286StatesExpiringCritical {
	return v.value
}

func (v *NullableInlineResponse200286StatesExpiringCritical) Set(val *InlineResponse200286StatesExpiringCritical) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200286StatesExpiringCritical) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200286StatesExpiringCritical) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200286StatesExpiringCritical(val *InlineResponse200286StatesExpiringCritical) *NullableInlineResponse200286StatesExpiringCritical {
	return &NullableInlineResponse200286StatesExpiringCritical{value: val, isSet: true}
}

func (v NullableInlineResponse200286StatesExpiringCritical) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200286StatesExpiringCritical) UnmarshalJSON(src []byte) error {
	v.isSet = true
