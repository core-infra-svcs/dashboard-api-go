...
// InlineResponse20032Value1Source Source of 'custom' type traffic filter
type InlineResponse20032Value1Source struct {
...
func NewInlineResponse20032Value1Source() *InlineResponse20032Value1Source {
	this := InlineResponse20032Value1Source{}
	return &this
}
...
func (o InlineResponse20032Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20032Value1Source struct {
	value *InlineResponse20032Value1Source
	isSet bool
}

func (v NullableInlineResponse20032Value1Source) Get() *InlineResponse20032Value1Source {
	return v.value
}

func (v *NullableInlineResponse20032Value1Source) Set(val *InlineResponse20032Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20032Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20032Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20032Value1Source(val *InlineResponse20032Value1Source) *NullableInlineResponse20032Value1Source {
	return &NullableInlineResponse20032Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20032Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20032Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
