...
// InlineResponse20060PowerExceptions struct for InlineResponse20060PowerExceptions
type InlineResponse20060PowerExceptions struct {
...
func NewInlineResponse20060PowerExceptions() *InlineResponse20060PowerExceptions {
	this := InlineResponse20060PowerExceptions{}
	return &this
}
...
func (o InlineResponse20060PowerExceptions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20060PowerExceptions struct {
	value *InlineResponse20060PowerExceptions
	isSet bool
}

func (v NullableInlineResponse20060PowerExceptions) Get() *InlineResponse20060PowerExceptions {
	return v.value
}

func (v *NullableInlineResponse20060PowerExceptions) Set(val *InlineResponse20060PowerExceptions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20060PowerExceptions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20060PowerExceptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20060PowerExceptions(val *InlineResponse20060PowerExceptions) *NullableInlineResponse20060PowerExceptions {
	return &NullableInlineResponse20060PowerExceptions{value: val, isSet: true}
}

func (v NullableInlineResponse20060PowerExceptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20060PowerExceptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
