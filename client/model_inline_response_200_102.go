...
type InlineResponse200102 struct {
	...
	Devices []InlineResponse20094 `json:"devices,omitempty"`
...
// SetDevices gets a reference to the given []InlineResponse20094 and assigns it to the Devices field.
