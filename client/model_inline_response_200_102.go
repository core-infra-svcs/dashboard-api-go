...
type InlineResponse200102 struct {
	...
	SplashLogo *InlineResponse200102SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200102SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200102SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200102GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200102Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200102SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200102SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200102) GetSplashLogo() InlineResponse200102SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200102SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200102SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200102) GetSplashImage() InlineResponse200102SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200102SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200102SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200102) GetSplashPrepaidFront() InlineResponse200102SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200102SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200102SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200102) GetGuestSponsorship() InlineResponse200102GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200102GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200102GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200102) GetBilling() InlineResponse200102Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200102Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200102Billing and assigns it to the Billing field.
...
func (o *InlineResponse200102) GetSentryEnrollment() InlineResponse200102SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200102SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200102SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200102) GetSelfRegistration() InlineResponse200102SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200102SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200102SelfRegistration and assigns it to the SelfRegistration field.
