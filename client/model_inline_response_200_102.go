...
type InlineResponse200102 struct {
	...
	ApBandSettings *InlineResponse200102ApBandSettings `json:"apBandSettings,omitempty"`
	...
	SixGhzSettings *InlineResponse200102SixGhzSettings `json:"sixGhzSettings,omitempty"`
	Transmission *InlineResponse200102Transmission `json:"transmission,omitempty"`
	PerSsidSettings *InlineResponse200102PerSsidSettings `json:"perSsidSettings,omitempty"`
}
...
func (o *InlineResponse200102) GetApBandSettings() InlineResponse200102ApBandSettings {
	if o == nil || isNil(o.ApBandSettings) {
		var ret InlineResponse200102ApBandSettings
		return ret
	}
...
// SetApBandSettings gets a reference to the given InlineResponse200102ApBandSettings and assigns it to the ApBandSettings field.
...
func (o *InlineResponse200102) GetSixGhzSettings() InlineResponse200102SixGhzSettings {
	if o == nil || isNil(o.SixGhzSettings) {
		var ret InlineResponse200102SixGhzSettings
		return ret
	}
...
// SetSixGhzSettings gets a reference to the given InlineResponse200102SixGhzSettings and assigns it to the SixGhzSettings field.
...
func (o *InlineResponse200102) GetPerSsidSettings() InlineResponse200102PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse200102PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse200102PerSsidSettings and assigns it to the PerSsidSettings field.
