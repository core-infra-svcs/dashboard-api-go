...
type InlineResponse200289 struct {
	...
	Items []InlineResponse200289Items `json:"items,omitempty"`
	Meta *InlineResponse200289Meta `json:"meta,omitempty"`
}
...
func (o *InlineResponse200289) GetItems() []InlineResponse200289Items {
	if o == nil || isNil(o.Items) {
		var ret []InlineResponse200289Items
		return ret
	}
	return o.Items
}
...
func (o *InlineResponse200289) GetItemsOk() ([]InlineResponse200289Items, bool) {
	if o == nil || isNil(o.Items) {
    return nil, false
	}
	return o.Items, true
...
// SetItems gets a reference to the given []InlineResponse200289Items and assigns it to the Items field.
func (o *InlineResponse200289) SetItems(v []InlineResponse200289Items) {
	o.Items = v
}

// GetMeta returns the Meta field value if set, zero value otherwise.
func (o *InlineResponse200289) GetMeta() InlineResponse200289Meta {
	if o == nil || isNil(o.Meta) {
		var ret InlineResponse200289Meta
		return ret
	}
	return *o.Meta
}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200289) GetMetaOk() (*InlineResponse200289Meta, bool) {
	if o == nil || isNil(o.Meta) {
    return nil, false
	}
	return o.Meta, true
...
// SetMeta gets a reference to the given InlineResponse200289Meta and assigns it to the Meta field.
func (o *InlineResponse200289) SetMeta(v InlineResponse200289Meta) {
	o.Meta = &v
}
