...
// InlineResponse20096SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse20096SixGhzSettings struct {
...
func NewInlineResponse20096SixGhzSettings() *InlineResponse20096SixGhzSettings {
	this := InlineResponse20096SixGhzSettings{}
	return &this
}
...
func (o InlineResponse20096SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20096SixGhzSettings struct {
	value *InlineResponse20096SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse20096SixGhzSettings) Get() *InlineResponse20096SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse20096SixGhzSettings) Set(val *InlineResponse20096SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20096SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20096SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20096SixGhzSettings(val *InlineResponse20096SixGhzSettings) *NullableInlineResponse20096SixGhzSettings {
	return &NullableInlineResponse20096SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20096SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20096SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
