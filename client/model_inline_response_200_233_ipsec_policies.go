...
// InlineResponse200233IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200233IpsecPolicies struct {
...
func NewInlineResponse200233IpsecPolicies() *InlineResponse200233IpsecPolicies {
	this := InlineResponse200233IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200233IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200233IpsecPolicies struct {
	value *InlineResponse200233IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200233IpsecPolicies) Get() *InlineResponse200233IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200233IpsecPolicies) Set(val *InlineResponse200233IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200233IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200233IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200233IpsecPolicies(val *InlineResponse200233IpsecPolicies) *NullableInlineResponse200233IpsecPolicies {
	return &NullableInlineResponse200233IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200233IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200233IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
