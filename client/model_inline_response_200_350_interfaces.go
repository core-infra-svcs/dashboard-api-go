...
// InlineResponse200350Interfaces struct for InlineResponse200350Interfaces
type InlineResponse200350Interfaces struct {
	...
	ChannelGroup *InlineResponse200350ChannelGroup `json:"channelGroup,omitempty"`
	Module *InlineResponse200350Module `json:"module,omitempty"`
}
...
func NewInlineResponse200350Interfaces() *InlineResponse200350Interfaces {
	this := InlineResponse200350Interfaces{}
	return &this
}
...
func (o *InlineResponse200350Interfaces) GetChannelGroup() InlineResponse200350ChannelGroup {
	if o == nil || isNil(o.ChannelGroup) {
		var ret InlineResponse200350ChannelGroup
		return ret
	}
...
// SetChannelGroup gets a reference to the given InlineResponse200350ChannelGroup and assigns it to the ChannelGroup field.
...
func (o *InlineResponse200350Interfaces) GetModule() InlineResponse200350Module {
	if o == nil || isNil(o.Module) {
		var ret InlineResponse200350Module
		return ret
	}
	return *o.Module
}
...
// SetModule gets a reference to the given InlineResponse200350Module and assigns it to the Module field.
func (o *InlineResponse200350Interfaces) SetModule(v InlineResponse200350Module) {
	o.Module = &v
}

func (o InlineResponse200350Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200350Interfaces struct {
	value *InlineResponse200350Interfaces
	isSet bool
}

func (v NullableInlineResponse200350Interfaces) Get() *InlineResponse200350Interfaces {
	return v.value
}

func (v *NullableInlineResponse200350Interfaces) Set(val *InlineResponse200350Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200350Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200350Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200350Interfaces(val *InlineResponse200350Interfaces) *NullableInlineResponse200350Interfaces {
	return &NullableInlineResponse200350Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200350Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200350Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
