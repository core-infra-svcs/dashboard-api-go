...
func (r GroupsApiCreateOrganizationPolicyObjectsGroupRequest) CreateOrganizationPolicyObjectsGroup(createOrganizationPolicyObjectsGroup InlineObject211) GroupsApiCreateOrganizationPolicyObjectsGroupRequest {
...
func (r GroupsApiGetNetworkFirmwareUpgradesStagedGroupRequest) Execute() (*InlineResponse20024, *http.Response, error) {
...
func (a *GroupsApiService) GetNetworkFirmwareUpgradesStagedGroupExecute(r GroupsApiGetNetworkFirmwareUpgradesStagedGroupRequest) (*InlineResponse20024, *http.Response, error) {
	var (
...
func (r GroupsApiGetNetworkFirmwareUpgradesStagedGroupsRequest) Execute() ([]InlineResponse20024, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20024
func (a *GroupsApiService) GetNetworkFirmwareUpgradesStagedGroupsExecute(r GroupsApiGetNetworkFirmwareUpgradesStagedGroupsRequest) ([]InlineResponse20024, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r GroupsApiUpdateOrganizationPolicyObjectsGroupRequest) UpdateOrganizationPolicyObjectsGroup(updateOrganizationPolicyObjectsGroup InlineObject212) GroupsApiUpdateOrganizationPolicyObjectsGroupRequest {
