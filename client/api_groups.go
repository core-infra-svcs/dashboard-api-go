...
func (r GroupsApiCreateOrganizationAdaptivePolicyGroupRequest) CreateOrganizationAdaptivePolicyGroup(createOrganizationAdaptivePolicyGroup InlineObject182) GroupsApiCreateOrganizationAdaptivePolicyGroupRequest {
...
func (r GroupsApiCreateOrganizationPolicyObjectsGroupRequest) CreateOrganizationPolicyObjectsGroup(createOrganizationPolicyObjectsGroup InlineObject225) GroupsApiCreateOrganizationPolicyObjectsGroupRequest {
...
func (r GroupsApiGetNetworkFirmwareUpgradesStagedGroupRequest) Execute() (*InlineResponse20038, *http.Response, error) {
...
func (a *GroupsApiService) GetNetworkFirmwareUpgradesStagedGroupExecute(r GroupsApiGetNetworkFirmwareUpgradesStagedGroupRequest) (*InlineResponse20038, *http.Response, error) {
	var (
...
func (r GroupsApiGetNetworkFirmwareUpgradesStagedGroupsRequest) Execute() ([]InlineResponse20038, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20038
func (a *GroupsApiService) GetNetworkFirmwareUpgradesStagedGroupsExecute(r GroupsApiGetNetworkFirmwareUpgradesStagedGroupsRequest) ([]InlineResponse20038, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r GroupsApiUpdateOrganizationAdaptivePolicyGroupRequest) UpdateOrganizationAdaptivePolicyGroup(updateOrganizationAdaptivePolicyGroup InlineObject183) GroupsApiUpdateOrganizationAdaptivePolicyGroupRequest {
...
func (r GroupsApiUpdateOrganizationPolicyObjectsGroupRequest) UpdateOrganizationPolicyObjectsGroup(updateOrganizationPolicyObjectsGroup InlineObject226) GroupsApiUpdateOrganizationPolicyObjectsGroupRequest {
