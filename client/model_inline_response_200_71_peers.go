...
// InlineResponse20071Peers struct for InlineResponse20071Peers
type InlineResponse20071Peers struct {
	...
	IpsecPolicies *InlineResponse20071IpsecPolicies `json:"ipsecPolicies,omitempty"`
...
func (o *InlineResponse20071Peers) GetIpsecPolicies() InlineResponse20071IpsecPolicies {
	if o == nil || isNil(o.IpsecPolicies) {
		var ret InlineResponse20071IpsecPolicies
		return ret
	}
...
// SetIpsecPolicies gets a reference to the given InlineResponse20071IpsecPolicies and assigns it to the IpsecPolicies field.
...
func (o InlineResponse20071Peers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20071Peers struct {
	value *InlineResponse20071Peers
	isSet bool
}

func (v NullableInlineResponse20071Peers) Get() *InlineResponse20071Peers {
	return v.value
}

func (v *NullableInlineResponse20071Peers) Set(val *InlineResponse20071Peers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20071Peers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20071Peers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20071Peers(val *InlineResponse20071Peers) *NullableInlineResponse20071Peers {
	return &NullableInlineResponse20071Peers{value: val, isSet: true}
}

func (v NullableInlineResponse20071Peers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20071Peers) UnmarshalJSON(src []byte) error {
	v.isSet = true
