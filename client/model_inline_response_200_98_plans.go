...
// InlineResponse20098Plans struct for InlineResponse20098Plans
type InlineResponse20098Plans struct {
	// The id of the pricing plan to update.
	Id *string `json:"id,omitempty"`
	// The price of the billing plan.
	Price *float32 `json:"price,omitempty"`
	BandwidthLimits *InlineResponse20098BandwidthLimits `json:"bandwidthLimits,omitempty"`
...
func (o *InlineResponse20098Plans) GetBandwidthLimits() InlineResponse20098BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse20098BandwidthLimits
		return ret
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse20098BandwidthLimits and assigns it to the BandwidthLimits field.
...
func (o InlineResponse20098Plans) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20098Plans struct {
	value *InlineResponse20098Plans
	isSet bool
}

func (v NullableInlineResponse20098Plans) Get() *InlineResponse20098Plans {
	return v.value
}

func (v *NullableInlineResponse20098Plans) Set(val *InlineResponse20098Plans) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20098Plans) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20098Plans) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20098Plans(val *InlineResponse20098Plans) *NullableInlineResponse20098Plans {
	return &NullableInlineResponse20098Plans{value: val, isSet: true}
}

func (v NullableInlineResponse20098Plans) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20098Plans) UnmarshalJSON(src []byte) error {
	v.isSet = true
