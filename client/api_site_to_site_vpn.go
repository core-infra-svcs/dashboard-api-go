...
func (r SiteToSiteVpnApiGetNetworkApplianceVpnSiteToSiteVpnRequest) Execute() (*InlineResponse20025, *http.Response, error) {
...
func (a *SiteToSiteVpnApiService) GetNetworkApplianceVpnSiteToSiteVpnExecute(r SiteToSiteVpnApiGetNetworkApplianceVpnSiteToSiteVpnRequest) (*InlineResponse20025, *http.Response, error) {
	var (
...
func (r SiteToSiteVpnApiUpdateNetworkApplianceVpnSiteToSiteVpnRequest) Execute() (*InlineResponse20025, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20025
func (a *SiteToSiteVpnApiService) UpdateNetworkApplianceVpnSiteToSiteVpnExecute(r SiteToSiteVpnApiUpdateNetworkApplianceVpnSiteToSiteVpnRequest) (*InlineResponse20025, *http.Response, error) {
	var (
