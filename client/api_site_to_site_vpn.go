...
func (r SiteToSiteVpnApiGetNetworkApplianceVpnSiteToSiteVpnRequest) Execute() (*InlineResponse20028, *http.Response, error) {
...
func (a *SiteToSiteVpnApiService) GetNetworkApplianceVpnSiteToSiteVpnExecute(r SiteToSiteVpnApiGetNetworkApplianceVpnSiteToSiteVpnRequest) (*InlineResponse20028, *http.Response, error) {
	var (
...
func (r SiteToSiteVpnApiUpdateNetworkApplianceVpnSiteToSiteVpnRequest) Execute() (*InlineResponse20028, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20028
func (a *SiteToSiteVpnApiService) UpdateNetworkApplianceVpnSiteToSiteVpnExecute(r SiteToSiteVpnApiUpdateNetworkApplianceVpnSiteToSiteVpnRequest) (*InlineResponse20028, *http.Response, error) {
	var (
