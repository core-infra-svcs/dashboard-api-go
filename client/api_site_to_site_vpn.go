...
func (r SiteToSiteVpnApiGetNetworkApplianceVpnSiteToSiteVpnRequest) Execute() (*InlineResponse20015, *http.Response, error) {
...
func (a *SiteToSiteVpnApiService) GetNetworkApplianceVpnSiteToSiteVpnExecute(r SiteToSiteVpnApiGetNetworkApplianceVpnSiteToSiteVpnRequest) (*InlineResponse20015, *http.Response, error) {
	var (
...
func (r SiteToSiteVpnApiUpdateNetworkApplianceVpnSiteToSiteVpnRequest) Execute() (*InlineResponse20015, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20015
func (a *SiteToSiteVpnApiService) UpdateNetworkApplianceVpnSiteToSiteVpnExecute(r SiteToSiteVpnApiUpdateNetworkApplianceVpnSiteToSiteVpnRequest) (*InlineResponse20015, *http.Response, error) {
	var (
