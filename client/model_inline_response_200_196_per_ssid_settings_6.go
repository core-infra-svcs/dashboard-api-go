...
// InlineResponse200196PerSsidSettings6 Settings for SSID 6
type InlineResponse200196PerSsidSettings6 struct {
	// Name of SSID
...
func NewInlineResponse200196PerSsidSettings6() *InlineResponse200196PerSsidSettings6 {
	this := InlineResponse200196PerSsidSettings6{}
	return &this
}
...
func (o InlineResponse200196PerSsidSettings6) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200196PerSsidSettings6 struct {
	value *InlineResponse200196PerSsidSettings6
	isSet bool
}

func (v NullableInlineResponse200196PerSsidSettings6) Get() *InlineResponse200196PerSsidSettings6 {
	return v.value
}

func (v *NullableInlineResponse200196PerSsidSettings6) Set(val *InlineResponse200196PerSsidSettings6) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200196PerSsidSettings6) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200196PerSsidSettings6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200196PerSsidSettings6(val *InlineResponse200196PerSsidSettings6) *NullableInlineResponse200196PerSsidSettings6 {
	return &NullableInlineResponse200196PerSsidSettings6{value: val, isSet: true}
}

func (v NullableInlineResponse200196PerSsidSettings6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200196PerSsidSettings6) UnmarshalJSON(src []byte) error {
	v.isSet = true
