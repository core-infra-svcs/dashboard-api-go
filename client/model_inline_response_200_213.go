...
type InlineResponse200213 struct {
	...
	Peers []InlineResponse200213Peers `json:"peers,omitempty"`
}
...
func (o *InlineResponse200213) GetPeers() []InlineResponse200213Peers {
	if o == nil || isNil(o.Peers) {
		var ret []InlineResponse200213Peers
		return ret
	}
	return o.Peers
}
...
// SetPeers gets a reference to the given []InlineResponse200213Peers and assigns it to the Peers field.
