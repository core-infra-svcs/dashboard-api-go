...
// InlineResponse200208SentryEnrollment Systems Manager sentry enrollment splash settings.
type InlineResponse200208SentryEnrollment struct {
	SystemsManagerNetwork *InlineResponse200208SentryEnrollmentSystemsManagerNetwork `json:"systemsManagerNetwork,omitempty"`
...
func NewInlineResponse200208SentryEnrollment() *InlineResponse200208SentryEnrollment {
	this := InlineResponse200208SentryEnrollment{}
	return &this
}
...
func (o *InlineResponse200208SentryEnrollment) GetSystemsManagerNetwork() InlineResponse200208SentryEnrollmentSystemsManagerNetwork {
	if o == nil || isNil(o.SystemsManagerNetwork) {
		var ret InlineResponse200208SentryEnrollmentSystemsManagerNetwork
		return ret
	}
...
// SetSystemsManagerNetwork gets a reference to the given InlineResponse200208SentryEnrollmentSystemsManagerNetwork and assigns it to the SystemsManagerNetwork field.
...
func (o InlineResponse200208SentryEnrollment) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200208SentryEnrollment struct {
	value *InlineResponse200208SentryEnrollment
	isSet bool
}

func (v NullableInlineResponse200208SentryEnrollment) Get() *InlineResponse200208SentryEnrollment {
	return v.value
}

func (v *NullableInlineResponse200208SentryEnrollment) Set(val *InlineResponse200208SentryEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200208SentryEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200208SentryEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200208SentryEnrollment(val *InlineResponse200208SentryEnrollment) *NullableInlineResponse200208SentryEnrollment {
	return &NullableInlineResponse200208SentryEnrollment{value: val, isSet: true}
}

func (v NullableInlineResponse200208SentryEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200208SentryEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
