...
// InlineResponse200261Policies struct for InlineResponse200261Policies
type InlineResponse200261Policies struct {
...
func NewInlineResponse200261Policies() *InlineResponse200261Policies {
	this := InlineResponse200261Policies{}
	return &this
}
...
func (o InlineResponse200261Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200261Policies struct {
	value *InlineResponse200261Policies
	isSet bool
}

func (v NullableInlineResponse200261Policies) Get() *InlineResponse200261Policies {
	return v.value
}

func (v *NullableInlineResponse200261Policies) Set(val *InlineResponse200261Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200261Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200261Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200261Policies(val *InlineResponse200261Policies) *NullableInlineResponse200261Policies {
	return &NullableInlineResponse200261Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200261Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200261Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
