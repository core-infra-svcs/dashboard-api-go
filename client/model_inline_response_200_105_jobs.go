...
// InlineResponse200105Jobs struct for InlineResponse200105Jobs
type InlineResponse200105Jobs struct {
	// Auto locate job ID
...
func (o InlineResponse200105Jobs) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200105Jobs struct {
	value *InlineResponse200105Jobs
	isSet bool
}

func (v NullableInlineResponse200105Jobs) Get() *InlineResponse200105Jobs {
	return v.value
}

func (v *NullableInlineResponse200105Jobs) Set(val *InlineResponse200105Jobs) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200105Jobs) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200105Jobs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200105Jobs(val *InlineResponse200105Jobs) *NullableInlineResponse200105Jobs {
	return &NullableInlineResponse200105Jobs{value: val, isSet: true}
}

func (v NullableInlineResponse200105Jobs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200105Jobs) UnmarshalJSON(src []byte) error {
	v.isSet = true
