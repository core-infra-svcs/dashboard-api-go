...
// InlineResponse20067Neighbors struct for InlineResponse20067Neighbors
type InlineResponse20067Neighbors struct {
	// The IPv4 address of the neighbor
	Ip *string `json:"ip,omitempty"`
	Ipv6 *InlineResponse20067Ipv6 `json:"ipv6,omitempty"`
	...
	TtlSecurity *InlineResponse20067TtlSecurity `json:"ttlSecurity,omitempty"`
	Authentication *InlineResponse20067Authentication `json:"authentication,omitempty"`
}
...
func NewInlineResponse20067Neighbors() *InlineResponse20067Neighbors {
	this := InlineResponse20067Neighbors{}
	return &this
}
...
func (o *InlineResponse20067Neighbors) GetIpv6() InlineResponse20067Ipv6 {
	if o == nil || isNil(o.Ipv6) {
		var ret InlineResponse20067Ipv6
		return ret
	}
	return *o.Ipv6
}
...
// SetIpv6 gets a reference to the given InlineResponse20067Ipv6 and assigns it to the Ipv6 field.
...
func (o *InlineResponse20067Neighbors) GetTtlSecurity() InlineResponse20067TtlSecurity {
	if o == nil || isNil(o.TtlSecurity) {
		var ret InlineResponse20067TtlSecurity
		return ret
	}
...
// SetTtlSecurity gets a reference to the given InlineResponse20067TtlSecurity and assigns it to the TtlSecurity field.
...
func (o *InlineResponse20067Neighbors) GetAuthentication() InlineResponse20067Authentication {
	if o == nil || isNil(o.Authentication) {
		var ret InlineResponse20067Authentication
		return ret
	}
...
// SetAuthentication gets a reference to the given InlineResponse20067Authentication and assigns it to the Authentication field.
func (o *InlineResponse20067Neighbors) SetAuthentication(v InlineResponse20067Authentication) {
	o.Authentication = &v
}

func (o InlineResponse20067Neighbors) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20067Neighbors struct {
	value *InlineResponse20067Neighbors
	isSet bool
}

func (v NullableInlineResponse20067Neighbors) Get() *InlineResponse20067Neighbors {
	return v.value
}

func (v *NullableInlineResponse20067Neighbors) Set(val *InlineResponse20067Neighbors) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20067Neighbors) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20067Neighbors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20067Neighbors(val *InlineResponse20067Neighbors) *NullableInlineResponse20067Neighbors {
	return &NullableInlineResponse20067Neighbors{value: val, isSet: true}
}

func (v NullableInlineResponse20067Neighbors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20067Neighbors) UnmarshalJSON(src []byte) error {
	v.isSet = true
