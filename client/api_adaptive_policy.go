...
func (r AdaptivePolicyApiGetOrganizationAdaptivePolicyOverviewRequest) Execute() (*InlineResponse20088, *http.Response, error) {
...
func (a *AdaptivePolicyApiService) GetOrganizationAdaptivePolicyOverviewExecute(r AdaptivePolicyApiGetOrganizationAdaptivePolicyOverviewRequest) (*InlineResponse20088, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
