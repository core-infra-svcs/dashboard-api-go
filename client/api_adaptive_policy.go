...
func (r AdaptivePolicyApiCreateOrganizationAdaptivePolicyAclRequest) Execute() (*InlineResponse200117, *http.Response, error) {
...
func (a *AdaptivePolicyApiService) CreateOrganizationAdaptivePolicyAclExecute(r AdaptivePolicyApiCreateOrganizationAdaptivePolicyAclRequest) (*InlineResponse200117, *http.Response, error) {
	var (
...
func (r AdaptivePolicyApiGetOrganizationAdaptivePolicyAclRequest) Execute() (*InlineResponse200117, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200117
func (a *AdaptivePolicyApiService) GetOrganizationAdaptivePolicyAclExecute(r AdaptivePolicyApiGetOrganizationAdaptivePolicyAclRequest) (*InlineResponse200117, *http.Response, error) {
	var (
...
func (r AdaptivePolicyApiGetOrganizationAdaptivePolicyAclsRequest) Execute() ([]InlineResponse200117, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200117
func (a *AdaptivePolicyApiService) GetOrganizationAdaptivePolicyAclsExecute(r AdaptivePolicyApiGetOrganizationAdaptivePolicyAclsRequest) ([]InlineResponse200117, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AdaptivePolicyApiGetOrganizationAdaptivePolicyOverviewRequest) Execute() (*InlineResponse200118, *http.Response, error) {
...
func (a *AdaptivePolicyApiService) GetOrganizationAdaptivePolicyOverviewExecute(r AdaptivePolicyApiGetOrganizationAdaptivePolicyOverviewRequest) (*InlineResponse200118, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AdaptivePolicyApiUpdateOrganizationAdaptivePolicyAclRequest) Execute() (*InlineResponse200117, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200117
func (a *AdaptivePolicyApiService) UpdateOrganizationAdaptivePolicyAclExecute(r AdaptivePolicyApiUpdateOrganizationAdaptivePolicyAclRequest) (*InlineResponse200117, *http.Response, error) {
	var (
