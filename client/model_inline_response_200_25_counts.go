...
// InlineResponse20025Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse20025Counts struct {
	...
	Noise *InlineResponse20025CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse20025Counts() *InlineResponse20025Counts {
	this := InlineResponse20025Counts{}
	return &this
}
...
func (o *InlineResponse20025Counts) GetNoise() InlineResponse20025CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse20025CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse20025CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse20025Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20025Counts struct {
	value *InlineResponse20025Counts
	isSet bool
}

func (v NullableInlineResponse20025Counts) Get() *InlineResponse20025Counts {
	return v.value
}

func (v *NullableInlineResponse20025Counts) Set(val *InlineResponse20025Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20025Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20025Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20025Counts(val *InlineResponse20025Counts) *NullableInlineResponse20025Counts {
	return &NullableInlineResponse20025Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20025Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20025Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
