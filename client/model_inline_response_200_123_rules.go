...
// InlineResponse200123Rules struct for InlineResponse200123Rules
type InlineResponse200123Rules struct {
...
func NewInlineResponse200123Rules() *InlineResponse200123Rules {
	this := InlineResponse200123Rules{}
	return &this
}
...
func (o InlineResponse200123Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200123Rules struct {
	value *InlineResponse200123Rules
	isSet bool
}

func (v NullableInlineResponse200123Rules) Get() *InlineResponse200123Rules {
	return v.value
}

func (v *NullableInlineResponse200123Rules) Set(val *InlineResponse200123Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200123Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200123Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200123Rules(val *InlineResponse200123Rules) *NullableInlineResponse200123Rules {
	return &NullableInlineResponse200123Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200123Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200123Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
