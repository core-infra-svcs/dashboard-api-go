...
func (r SenseApiGetDeviceCameraSenseRequest) Execute() (*InlineResponse20018, *http.Response, error) {
...
func (a *SenseApiService) GetDeviceCameraSenseExecute(r SenseApiGetDeviceCameraSenseRequest) (*InlineResponse20018, *http.Response, error) {
	var (
...
func (r SenseApiGetDeviceCameraSenseObjectDetectionModelsRequest) Execute() ([]InlineResponse20019, *http.Response, error) {
...
func (a *SenseApiService) GetDeviceCameraSenseObjectDetectionModelsExecute(r SenseApiGetDeviceCameraSenseObjectDetectionModelsRequest) ([]InlineResponse20019, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SenseApiUpdateDeviceCameraSenseRequest) UpdateDeviceCameraSense(updateDeviceCameraSense InlineObject10) SenseApiUpdateDeviceCameraSenseRequest {
	r.updateDeviceCameraSense = &updateDeviceCameraSense
	return r
}

func (r SenseApiUpdateDeviceCameraSenseRequest) Execute() (*InlineResponse20018, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20018
func (a *SenseApiService) UpdateDeviceCameraSenseExecute(r SenseApiUpdateDeviceCameraSenseRequest) (*InlineResponse20018, *http.Response, error) {
	var (
