...
// InlineResponse200258StatesUnusedActiveOldestActivation Information about the oldest historical license activation
type InlineResponse200258StatesUnusedActiveOldestActivation struct {
...
func NewInlineResponse200258StatesUnusedActiveOldestActivation() *InlineResponse200258StatesUnusedActiveOldestActivation {
	this := InlineResponse200258StatesUnusedActiveOldestActivation{}
	return &this
}
...
func (o InlineResponse200258StatesUnusedActiveOldestActivation) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200258StatesUnusedActiveOldestActivation struct {
	value *InlineResponse200258StatesUnusedActiveOldestActivation
	isSet bool
}

func (v NullableInlineResponse200258StatesUnusedActiveOldestActivation) Get() *InlineResponse200258StatesUnusedActiveOldestActivation {
	return v.value
}

func (v *NullableInlineResponse200258StatesUnusedActiveOldestActivation) Set(val *InlineResponse200258StatesUnusedActiveOldestActivation) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200258StatesUnusedActiveOldestActivation) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200258StatesUnusedActiveOldestActivation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200258StatesUnusedActiveOldestActivation(val *InlineResponse200258StatesUnusedActiveOldestActivation) *NullableInlineResponse200258StatesUnusedActiveOldestActivation {
	return &NullableInlineResponse200258StatesUnusedActiveOldestActivation{value: val, isSet: true}
}

func (v NullableInlineResponse200258StatesUnusedActiveOldestActivation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200258StatesUnusedActiveOldestActivation) UnmarshalJSON(src []byte) error {
	v.isSet = true
