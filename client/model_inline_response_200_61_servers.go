...
// InlineResponse20061Servers struct for InlineResponse20061Servers
type InlineResponse20061Servers struct {
...
func NewInlineResponse20061Servers() *InlineResponse20061Servers {
	this := InlineResponse20061Servers{}
	return &this
}
...
func (o InlineResponse20061Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20061Servers struct {
	value *InlineResponse20061Servers
	isSet bool
}

func (v NullableInlineResponse20061Servers) Get() *InlineResponse20061Servers {
	return v.value
}

func (v *NullableInlineResponse20061Servers) Set(val *InlineResponse20061Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20061Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20061Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20061Servers(val *InlineResponse20061Servers) *NullableInlineResponse20061Servers {
	return &NullableInlineResponse20061Servers{value: val, isSet: true}
}

func (v NullableInlineResponse20061Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20061Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
