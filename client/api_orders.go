...
func (r OrdersApiClaimOrganizationInventoryOrdersRequest) ClaimOrganizationInventoryOrders(claimOrganizationInventoryOrders InlineObject279) OrdersApiClaimOrganizationInventoryOrdersRequest {
	r.claimOrganizationInventoryOrders = &claimOrganizationInventoryOrders
	return r
}

func (r OrdersApiClaimOrganizationInventoryOrdersRequest) Execute() (*InlineResponse200312, *http.Response, error) {
...
func (a *OrdersApiService) ClaimOrganizationInventoryOrdersExecute(r OrdersApiClaimOrganizationInventoryOrdersRequest) (*InlineResponse200312, *http.Response, error) {
	var (
...
func (r OrdersApiPreviewOrganizationInventoryOrdersRequest) PreviewOrganizationInventoryOrders(previewOrganizationInventoryOrders InlineObject280) OrdersApiPreviewOrganizationInventoryOrdersRequest {
	r.previewOrganizationInventoryOrders = &previewOrganizationInventoryOrders
	return r
}

func (r OrdersApiPreviewOrganizationInventoryOrdersRequest) Execute() (*InlineResponse200313, *http.Response, error) {
...
func (a *OrdersApiService) PreviewOrganizationInventoryOrdersExecute(r OrdersApiPreviewOrganizationInventoryOrdersRequest) (*InlineResponse200313, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
