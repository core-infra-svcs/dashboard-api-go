...
// InlineResponse200102SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200102SixGhzSettings struct {
...
func NewInlineResponse200102SixGhzSettings() *InlineResponse200102SixGhzSettings {
	this := InlineResponse200102SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200102SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200102SixGhzSettings struct {
	value *InlineResponse200102SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200102SixGhzSettings) Get() *InlineResponse200102SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200102SixGhzSettings) Set(val *InlineResponse200102SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200102SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200102SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200102SixGhzSettings(val *InlineResponse200102SixGhzSettings) *NullableInlineResponse200102SixGhzSettings {
	return &NullableInlineResponse200102SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200102SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200102SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
