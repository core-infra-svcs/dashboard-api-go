...
// InlineResponse200111IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200111IpsecPolicies struct {
...
func NewInlineResponse200111IpsecPolicies() *InlineResponse200111IpsecPolicies {
	this := InlineResponse200111IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200111IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200111IpsecPolicies struct {
	value *InlineResponse200111IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200111IpsecPolicies) Get() *InlineResponse200111IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200111IpsecPolicies) Set(val *InlineResponse200111IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200111IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200111IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200111IpsecPolicies(val *InlineResponse200111IpsecPolicies) *NullableInlineResponse200111IpsecPolicies {
	return &NullableInlineResponse200111IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200111IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200111IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
