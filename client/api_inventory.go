...
func (r InventoryApiClaimIntoOrganizationInventoryRequest) Execute() (*InlineResponse200266, *http.Response, error) {
...
func (a *InventoryApiService) ClaimIntoOrganizationInventoryExecute(r InventoryApiClaimIntoOrganizationInventoryRequest) (*InlineResponse200266, *http.Response, error) {
	var (
...
func (r InventoryApiGetOrganizationCellularGatewayEsimsInventoryRequest) Execute() (*InlineResponse200259, *http.Response, error) {
...
func (a *InventoryApiService) GetOrganizationCellularGatewayEsimsInventoryExecute(r InventoryApiGetOrganizationCellularGatewayEsimsInventoryRequest) (*InlineResponse200259, *http.Response, error) {
	var (
...
func (r InventoryApiGetOrganizationInventoryDeviceRequest) Execute() (*InlineResponse200301, *http.Response, error) {
...
func (a *InventoryApiService) GetOrganizationInventoryDeviceExecute(r InventoryApiGetOrganizationInventoryDeviceRequest) (*InlineResponse200301, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InventoryApiGetOrganizationInventoryDevicesRequest) Execute() ([]InlineResponse200301, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200301
func (a *InventoryApiService) GetOrganizationInventoryDevicesExecute(r InventoryApiGetOrganizationInventoryDevicesRequest) ([]InlineResponse200301, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InventoryApiGetOrganizationInventoryOnboardingCloudMonitoringImportsRequest) Execute() ([]InlineResponse200302, *http.Response, error) {
...
// Deprecated
func (a *InventoryApiService) GetOrganizationInventoryOnboardingCloudMonitoringImportsExecute(r InventoryApiGetOrganizationInventoryOnboardingCloudMonitoringImportsRequest) ([]InlineResponse200302, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type InventoryApiReleaseFromOrganizationInventoryRequest struct {
	...
	ApiService *InventoryApiService
	organizationId string
	releaseFromOrganizationInventory *InlineObject278
}

func (r InventoryApiReleaseFromOrganizationInventoryRequest) ReleaseFromOrganizationInventory(releaseFromOrganizationInventory InlineObject278) InventoryApiReleaseFromOrganizationInventoryRequest {
	r.releaseFromOrganizationInventory = &releaseFromOrganizationInventory
	return r
}

func (r InventoryApiReleaseFromOrganizationInventoryRequest) Execute() (*InlineResponse200303, *http.Response, error) {
...
func (a *InventoryApiService) ReleaseFromOrganizationInventoryExecute(r InventoryApiReleaseFromOrganizationInventoryRequest) (*InlineResponse200303, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InventoryApiUpdateOrganizationCellularGatewayEsimsInventoryRequest) Execute() (*InlineResponse200259Items, *http.Response, error) {
...
func (a *InventoryApiService) UpdateOrganizationCellularGatewayEsimsInventoryExecute(r InventoryApiUpdateOrganizationCellularGatewayEsimsInventoryRequest) (*InlineResponse200259Items, *http.Response, error) {
	var (
