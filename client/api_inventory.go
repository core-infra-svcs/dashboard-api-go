...
func (r InventoryApiApiClaimIntoOrganizationInventoryRequest) ClaimIntoOrganizationInventory(claimIntoOrganizationInventory InlineObject176) InventoryApiApiClaimIntoOrganizationInventoryRequest {
	r.claimIntoOrganizationInventory = &claimIntoOrganizationInventory
	return r
}

func (r InventoryApiApiClaimIntoOrganizationInventoryRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *InventoryApiService) ClaimIntoOrganizationInventory(ctx context.Context, organizationId string) InventoryApiApiClaimIntoOrganizationInventoryRequest {
	return InventoryApiApiClaimIntoOrganizationInventoryRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *InventoryApiService) ClaimIntoOrganizationInventoryExecute(r InventoryApiApiClaimIntoOrganizationInventoryRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r InventoryApiApiGetOrganizationInventoryDeviceRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *InventoryApiService) GetOrganizationInventoryDevice(ctx context.Context, organizationId string, serial string) InventoryApiApiGetOrganizationInventoryDeviceRequest {
	return InventoryApiApiGetOrganizationInventoryDeviceRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *InventoryApiService) GetOrganizationInventoryDeviceExecute(r InventoryApiApiGetOrganizationInventoryDeviceRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r InventoryApiApiGetOrganizationInventoryDevicesRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *InventoryApiService) GetOrganizationInventoryDevices(ctx context.Context, organizationId string) InventoryApiApiGetOrganizationInventoryDevicesRequest {
	return InventoryApiApiGetOrganizationInventoryDevicesRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *InventoryApiService) GetOrganizationInventoryDevicesExecute(r InventoryApiApiGetOrganizationInventoryDevicesRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InventoryApiApiReleaseFromOrganizationInventoryRequest) ReleaseFromOrganizationInventory(releaseFromOrganizationInventory InlineObject177) InventoryApiApiReleaseFromOrganizationInventoryRequest {
	r.releaseFromOrganizationInventory = &releaseFromOrganizationInventory
	return r
}

func (r InventoryApiApiReleaseFromOrganizationInventoryRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *InventoryApiService) ReleaseFromOrganizationInventory(ctx context.Context, organizationId string) InventoryApiApiReleaseFromOrganizationInventoryRequest {
	return InventoryApiApiReleaseFromOrganizationInventoryRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *InventoryApiService) ReleaseFromOrganizationInventoryExecute(r InventoryApiApiReleaseFromOrganizationInventoryRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
