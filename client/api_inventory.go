...
func (r InventoryApiClaimIntoOrganizationInventoryRequest) Execute() (*InlineResponse200260, *http.Response, error) {
...
func (a *InventoryApiService) ClaimIntoOrganizationInventoryExecute(r InventoryApiClaimIntoOrganizationInventoryRequest) (*InlineResponse200260, *http.Response, error) {
	var (
...
func (r InventoryApiGetOrganizationCellularGatewayEsimsInventoryRequest) Execute() (*InlineResponse200253, *http.Response, error) {
...
func (a *InventoryApiService) GetOrganizationCellularGatewayEsimsInventoryExecute(r InventoryApiGetOrganizationCellularGatewayEsimsInventoryRequest) (*InlineResponse200253, *http.Response, error) {
	var (
...
func (r InventoryApiGetOrganizationInventoryDeviceRequest) Execute() (*InlineResponse200295, *http.Response, error) {
...
func (a *InventoryApiService) GetOrganizationInventoryDeviceExecute(r InventoryApiGetOrganizationInventoryDeviceRequest) (*InlineResponse200295, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InventoryApiGetOrganizationInventoryDevicesRequest) Execute() ([]InlineResponse200295, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200295
func (a *InventoryApiService) GetOrganizationInventoryDevicesExecute(r InventoryApiGetOrganizationInventoryDevicesRequest) ([]InlineResponse200295, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InventoryApiGetOrganizationInventoryOnboardingCloudMonitoringImportsRequest) Execute() ([]InlineResponse200296, *http.Response, error) {
...
// Deprecated
func (a *InventoryApiService) GetOrganizationInventoryOnboardingCloudMonitoringImportsExecute(r InventoryApiGetOrganizationInventoryOnboardingCloudMonitoringImportsRequest) ([]InlineResponse200296, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InventoryApiReleaseFromOrganizationInventoryRequest) Execute() (*InlineResponse200297, *http.Response, error) {
...
func (a *InventoryApiService) ReleaseFromOrganizationInventoryExecute(r InventoryApiReleaseFromOrganizationInventoryRequest) (*InlineResponse200297, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InventoryApiUpdateOrganizationCellularGatewayEsimsInventoryRequest) Execute() (*InlineResponse200253Items, *http.Response, error) {
...
func (a *InventoryApiService) UpdateOrganizationCellularGatewayEsimsInventoryExecute(r InventoryApiUpdateOrganizationCellularGatewayEsimsInventoryRequest) (*InlineResponse200253Items, *http.Response, error) {
	var (
