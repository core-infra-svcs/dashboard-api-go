...
func (r InventoryApiClaimIntoOrganizationInventoryRequest) Execute() (*InlineResponse200117, *http.Response, error) {
...
func (a *InventoryApiService) ClaimIntoOrganizationInventoryExecute(r InventoryApiClaimIntoOrganizationInventoryRequest) (*InlineResponse200117, *http.Response, error) {
	var (
...
func (r InventoryApiGetOrganizationInventoryDeviceRequest) Execute() (*InlineResponse200136, *http.Response, error) {
...
func (a *InventoryApiService) GetOrganizationInventoryDeviceExecute(r InventoryApiGetOrganizationInventoryDeviceRequest) (*InlineResponse200136, *http.Response, error) {
	var (
...
func (r InventoryApiGetOrganizationInventoryDevicesRequest) Execute() ([]InlineResponse200136, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200136
func (a *InventoryApiService) GetOrganizationInventoryDevicesExecute(r InventoryApiGetOrganizationInventoryDevicesRequest) ([]InlineResponse200136, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InventoryApiGetOrganizationInventoryOnboardingCloudMonitoringImportsRequest) Execute() ([]InlineResponse200137, *http.Response, error) {
...
func (a *InventoryApiService) GetOrganizationInventoryOnboardingCloudMonitoringImportsExecute(r InventoryApiGetOrganizationInventoryOnboardingCloudMonitoringImportsRequest) ([]InlineResponse200137, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
