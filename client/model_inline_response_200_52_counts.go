...
// InlineResponse20052Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse20052Counts struct {
	...
	Noise *InlineResponse20052CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse20052Counts() *InlineResponse20052Counts {
	this := InlineResponse20052Counts{}
	return &this
}
...
func (o *InlineResponse20052Counts) GetNoise() InlineResponse20052CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse20052CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse20052CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse20052Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20052Counts struct {
	value *InlineResponse20052Counts
	isSet bool
}

func (v NullableInlineResponse20052Counts) Get() *InlineResponse20052Counts {
	return v.value
}

func (v *NullableInlineResponse20052Counts) Set(val *InlineResponse20052Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20052Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20052Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20052Counts(val *InlineResponse20052Counts) *NullableInlineResponse20052Counts {
	return &NullableInlineResponse20052Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20052Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20052Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
