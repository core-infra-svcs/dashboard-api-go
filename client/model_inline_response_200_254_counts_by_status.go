...
// InlineResponse200254CountsByStatus byStatus
type InlineResponse200254CountsByStatus struct {
	// online count
...
func NewInlineResponse200254CountsByStatus() *InlineResponse200254CountsByStatus {
	this := InlineResponse200254CountsByStatus{}
	return &this
}
...
func (o InlineResponse200254CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200254CountsByStatus struct {
	value *InlineResponse200254CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200254CountsByStatus) Get() *InlineResponse200254CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200254CountsByStatus) Set(val *InlineResponse200254CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200254CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200254CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200254CountsByStatus(val *InlineResponse200254CountsByStatus) *NullableInlineResponse200254CountsByStatus {
	return &NullableInlineResponse200254CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200254CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200254CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
