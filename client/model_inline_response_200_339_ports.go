...
type InlineResponse200339Ports struct {
	...
	SecurePort *InlineResponse200339SecurePort `json:"securePort,omitempty"`
}
...
func (o *InlineResponse200339Ports) GetSecurePort() InlineResponse200339SecurePort {
	if o == nil || isNil(o.SecurePort) {
		var ret InlineResponse200339SecurePort
		return ret
	}
	return *o.SecurePort
}
...
// SetSecurePort gets a reference to the given InlineResponse200339SecurePort and assigns it to the SecurePort field.
