...
// InlineResponse200163VlanProfile The VLAN Profile
type InlineResponse200163VlanProfile struct {
...
func NewInlineResponse200163VlanProfile() *InlineResponse200163VlanProfile {
	this := InlineResponse200163VlanProfile{}
	return &this
}
...
func (o InlineResponse200163VlanProfile) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200163VlanProfile struct {
	value *InlineResponse200163VlanProfile
	isSet bool
}

func (v NullableInlineResponse200163VlanProfile) Get() *InlineResponse200163VlanProfile {
	return v.value
}

func (v *NullableInlineResponse200163VlanProfile) Set(val *InlineResponse200163VlanProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200163VlanProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200163VlanProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200163VlanProfile(val *InlineResponse200163VlanProfile) *NullableInlineResponse200163VlanProfile {
	return &NullableInlineResponse200163VlanProfile{value: val, isSet: true}
}

func (v NullableInlineResponse200163VlanProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200163VlanProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
