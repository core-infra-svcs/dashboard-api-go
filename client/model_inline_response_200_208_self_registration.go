...
// InlineResponse200208SelfRegistration Self-registration for splash with Meraki authentication.
type InlineResponse200208SelfRegistration struct {
...
func NewInlineResponse200208SelfRegistration() *InlineResponse200208SelfRegistration {
	this := InlineResponse200208SelfRegistration{}
	return &this
}
...
func (o InlineResponse200208SelfRegistration) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200208SelfRegistration struct {
	value *InlineResponse200208SelfRegistration
	isSet bool
}

func (v NullableInlineResponse200208SelfRegistration) Get() *InlineResponse200208SelfRegistration {
	return v.value
}

func (v *NullableInlineResponse200208SelfRegistration) Set(val *InlineResponse200208SelfRegistration) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200208SelfRegistration) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200208SelfRegistration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200208SelfRegistration(val *InlineResponse200208SelfRegistration) *NullableInlineResponse200208SelfRegistration {
	return &NullableInlineResponse200208SelfRegistration{value: val, isSet: true}
}

func (v NullableInlineResponse200208SelfRegistration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200208SelfRegistration) UnmarshalJSON(src []byte) error {
	v.isSet = true
