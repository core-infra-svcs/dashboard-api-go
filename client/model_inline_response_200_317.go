...
type InlineResponse200317 struct {
	...
	States *InlineResponse200317States `json:"states,omitempty"`
	// Data by license type (Per-device licensing only)
	LicenseTypes []InlineResponse200317LicenseTypes `json:"licenseTypes,omitempty"`
	SystemsManager *InlineResponse200317SystemsManager `json:"systemsManager,omitempty"`
}
...
func (o *InlineResponse200317) GetStates() InlineResponse200317States {
	if o == nil || isNil(o.States) {
		var ret InlineResponse200317States
		return ret
	}
	return *o.States
}
...
// SetStates gets a reference to the given InlineResponse200317States and assigns it to the States field.
...
func (o *InlineResponse200317) GetLicenseTypes() []InlineResponse200317LicenseTypes {
	if o == nil || isNil(o.LicenseTypes) {
		var ret []InlineResponse200317LicenseTypes
		return ret
	}
...
// SetLicenseTypes gets a reference to the given []InlineResponse200317LicenseTypes and assigns it to the LicenseTypes field.
...
func (o *InlineResponse200317) GetSystemsManager() InlineResponse200317SystemsManager {
	if o == nil || isNil(o.SystemsManager) {
		var ret InlineResponse200317SystemsManager
		return ret
	}
...
// SetSystemsManager gets a reference to the given InlineResponse200317SystemsManager and assigns it to the SystemsManager field.
