...
// InlineResponse20042ConnectionStats The connection stats of the device
type InlineResponse20042ConnectionStats struct {
...
func NewInlineResponse20042ConnectionStats() *InlineResponse20042ConnectionStats {
	this := InlineResponse20042ConnectionStats{}
	return &this
}
...
func (o InlineResponse20042ConnectionStats) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20042ConnectionStats struct {
	value *InlineResponse20042ConnectionStats
	isSet bool
}

func (v NullableInlineResponse20042ConnectionStats) Get() *InlineResponse20042ConnectionStats {
	return v.value
}

func (v *NullableInlineResponse20042ConnectionStats) Set(val *InlineResponse20042ConnectionStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20042ConnectionStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20042ConnectionStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20042ConnectionStats(val *InlineResponse20042ConnectionStats) *NullableInlineResponse20042ConnectionStats {
	return &NullableInlineResponse20042ConnectionStats{value: val, isSet: true}
}

func (v NullableInlineResponse20042ConnectionStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20042ConnectionStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
