...
// InlineResponse200349Interfaces struct for InlineResponse200349Interfaces
type InlineResponse200349Interfaces struct {
...
func NewInlineResponse200349Interfaces() *InlineResponse200349Interfaces {
	this := InlineResponse200349Interfaces{}
	return &this
}
...
func (o InlineResponse200349Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200349Interfaces struct {
	value *InlineResponse200349Interfaces
	isSet bool
}

func (v NullableInlineResponse200349Interfaces) Get() *InlineResponse200349Interfaces {
	return v.value
}

func (v *NullableInlineResponse200349Interfaces) Set(val *InlineResponse200349Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200349Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200349Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200349Interfaces(val *InlineResponse200349Interfaces) *NullableInlineResponse200349Interfaces {
	return &NullableInlineResponse200349Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200349Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200349Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
