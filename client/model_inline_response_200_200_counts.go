...
// InlineResponse200200Counts The current amount of various adaptive policy objects.
type InlineResponse200200Counts struct {
...
func NewInlineResponse200200Counts() *InlineResponse200200Counts {
	this := InlineResponse200200Counts{}
	return &this
}
...
func (o InlineResponse200200Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200200Counts struct {
	value *InlineResponse200200Counts
	isSet bool
}

func (v NullableInlineResponse200200Counts) Get() *InlineResponse200200Counts {
	return v.value
}

func (v *NullableInlineResponse200200Counts) Set(val *InlineResponse200200Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200200Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200200Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200200Counts(val *InlineResponse200200Counts) *NullableInlineResponse200200Counts {
	return &NullableInlineResponse200200Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200200Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200200Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
