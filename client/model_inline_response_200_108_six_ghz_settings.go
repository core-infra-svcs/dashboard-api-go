...
// InlineResponse200108SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200108SixGhzSettings struct {
...
func NewInlineResponse200108SixGhzSettings() *InlineResponse200108SixGhzSettings {
	this := InlineResponse200108SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200108SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200108SixGhzSettings struct {
	value *InlineResponse200108SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200108SixGhzSettings) Get() *InlineResponse200108SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200108SixGhzSettings) Set(val *InlineResponse200108SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200108SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200108SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200108SixGhzSettings(val *InlineResponse200108SixGhzSettings) *NullableInlineResponse200108SixGhzSettings {
	return &NullableInlineResponse200108SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200108SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200108SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
