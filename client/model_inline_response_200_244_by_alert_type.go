...
// InlineResponse200244ByAlertType struct for InlineResponse200244ByAlertType
type InlineResponse200244ByAlertType struct {
	// Alert Type
...
func NewInlineResponse200244ByAlertType() *InlineResponse200244ByAlertType {
	this := InlineResponse200244ByAlertType{}
	return &this
}
...
func (o InlineResponse200244ByAlertType) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200244ByAlertType struct {
	value *InlineResponse200244ByAlertType
	isSet bool
}

func (v NullableInlineResponse200244ByAlertType) Get() *InlineResponse200244ByAlertType {
	return v.value
}

func (v *NullableInlineResponse200244ByAlertType) Set(val *InlineResponse200244ByAlertType) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200244ByAlertType) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200244ByAlertType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200244ByAlertType(val *InlineResponse200244ByAlertType) *NullableInlineResponse200244ByAlertType {
	return &NullableInlineResponse200244ByAlertType{value: val, isSet: true}
}

func (v NullableInlineResponse200244ByAlertType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200244ByAlertType) UnmarshalJSON(src []byte) error {
	v.isSet = true
