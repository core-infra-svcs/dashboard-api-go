...
// InlineResponse200135Limits The current limits of various adaptive policy objects.
type InlineResponse200135Limits struct {
...
func NewInlineResponse200135Limits() *InlineResponse200135Limits {
	this := InlineResponse200135Limits{}
	return &this
}
...
func (o InlineResponse200135Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200135Limits struct {
	value *InlineResponse200135Limits
	isSet bool
}

func (v NullableInlineResponse200135Limits) Get() *InlineResponse200135Limits {
	return v.value
}

func (v *NullableInlineResponse200135Limits) Set(val *InlineResponse200135Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200135Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200135Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200135Limits(val *InlineResponse200135Limits) *NullableInlineResponse200135Limits {
	return &NullableInlineResponse200135Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200135Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200135Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
