...
// InlineResponse200115RegulatoryDomain Regulatory domain information for this network.
type InlineResponse200115RegulatoryDomain struct {
...
func NewInlineResponse200115RegulatoryDomain() *InlineResponse200115RegulatoryDomain {
	this := InlineResponse200115RegulatoryDomain{}
	return &this
}
...
func (o InlineResponse200115RegulatoryDomain) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200115RegulatoryDomain struct {
	value *InlineResponse200115RegulatoryDomain
	isSet bool
}

func (v NullableInlineResponse200115RegulatoryDomain) Get() *InlineResponse200115RegulatoryDomain {
	return v.value
}

func (v *NullableInlineResponse200115RegulatoryDomain) Set(val *InlineResponse200115RegulatoryDomain) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200115RegulatoryDomain) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200115RegulatoryDomain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200115RegulatoryDomain(val *InlineResponse200115RegulatoryDomain) *NullableInlineResponse200115RegulatoryDomain {
	return &NullableInlineResponse200115RegulatoryDomain{value: val, isSet: true}
}

func (v NullableInlineResponse200115RegulatoryDomain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200115RegulatoryDomain) UnmarshalJSON(src []byte) error {
	v.isSet = true
