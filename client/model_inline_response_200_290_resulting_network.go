...
// InlineResponse200290ResultingNetwork Network after the combination
type InlineResponse200290ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200290ResultingNetwork() *InlineResponse200290ResultingNetwork {
	this := InlineResponse200290ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200290ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200290ResultingNetwork struct {
	value *InlineResponse200290ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200290ResultingNetwork) Get() *InlineResponse200290ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200290ResultingNetwork) Set(val *InlineResponse200290ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200290ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200290ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200290ResultingNetwork(val *InlineResponse200290ResultingNetwork) *NullableInlineResponse200290ResultingNetwork {
	return &NullableInlineResponse200290ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200290ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200290ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
