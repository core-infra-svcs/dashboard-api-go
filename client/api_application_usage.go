...
func (r ApplicationUsageApiGetNetworkClientsApplicationUsageRequest) Execute() ([]InlineResponse20097, *http.Response, error) {
...
func (a *ApplicationUsageApiService) GetNetworkClientsApplicationUsageExecute(r ApplicationUsageApiGetNetworkClientsApplicationUsageRequest) ([]InlineResponse20097, *http.Response, error) {
	var (
