...
func (r ApplicationUsageApiApiGetNetworkClientsApplicationUsageRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *ApplicationUsageApiService) GetNetworkClientsApplicationUsage(ctx context.Context, networkId string) ApplicationUsageApiApiGetNetworkClientsApplicationUsageRequest {
	return ApplicationUsageApiApiGetNetworkClientsApplicationUsageRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *ApplicationUsageApiService) GetNetworkClientsApplicationUsageExecute(r ApplicationUsageApiApiGetNetworkClientsApplicationUsageRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
