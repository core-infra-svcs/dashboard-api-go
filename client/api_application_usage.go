...
func (r ApplicationUsageApiGetNetworkClientsApplicationUsageRequest) Execute() ([]InlineResponse20091, *http.Response, error) {
...
func (a *ApplicationUsageApiService) GetNetworkClientsApplicationUsageExecute(r ApplicationUsageApiGetNetworkClientsApplicationUsageRequest) ([]InlineResponse20091, *http.Response, error) {
	var (
