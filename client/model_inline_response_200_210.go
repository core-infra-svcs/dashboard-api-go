...
type InlineResponse200210 struct {
	...
	SplashLogo *InlineResponse200210SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200210SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200210SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200210GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200210Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200210SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200210SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200210) GetSplashLogo() InlineResponse200210SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200210SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200210SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200210) GetSplashImage() InlineResponse200210SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200210SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200210SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200210) GetSplashPrepaidFront() InlineResponse200210SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200210SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200210SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200210) GetGuestSponsorship() InlineResponse200210GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200210GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200210GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200210) GetBilling() InlineResponse200210Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200210Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200210Billing and assigns it to the Billing field.
...
func (o *InlineResponse200210) GetSentryEnrollment() InlineResponse200210SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200210SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200210SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200210) GetSelfRegistration() InlineResponse200210SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200210SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200210SelfRegistration and assigns it to the SelfRegistration field.
