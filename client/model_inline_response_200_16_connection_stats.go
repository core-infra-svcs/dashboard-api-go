...
// InlineResponse20016ConnectionStats The connection stats of the device
type InlineResponse20016ConnectionStats struct {
...
func NewInlineResponse20016ConnectionStats() *InlineResponse20016ConnectionStats {
	this := InlineResponse20016ConnectionStats{}
	return &this
}
...
func (o InlineResponse20016ConnectionStats) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20016ConnectionStats struct {
	value *InlineResponse20016ConnectionStats
	isSet bool
}

func (v NullableInlineResponse20016ConnectionStats) Get() *InlineResponse20016ConnectionStats {
	return v.value
}

func (v *NullableInlineResponse20016ConnectionStats) Set(val *InlineResponse20016ConnectionStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20016ConnectionStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20016ConnectionStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20016ConnectionStats(val *InlineResponse20016ConnectionStats) *NullableInlineResponse20016ConnectionStats {
	return &NullableInlineResponse20016ConnectionStats{value: val, isSet: true}
}

func (v NullableInlineResponse20016ConnectionStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20016ConnectionStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
