...
func (r SingleLanApiGetNetworkApplianceSingleLanRequest) Execute() (*InlineResponse20074, *http.Response, error) {
...
func (a *SingleLanApiService) GetNetworkApplianceSingleLanExecute(r SingleLanApiGetNetworkApplianceSingleLanRequest) (*InlineResponse20074, *http.Response, error) {
	var (
...
func (r SingleLanApiUpdateNetworkApplianceSingleLanRequest) Execute() (*InlineResponse20074, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20074
func (a *SingleLanApiService) UpdateNetworkApplianceSingleLanExecute(r SingleLanApiUpdateNetworkApplianceSingleLanRequest) (*InlineResponse20074, *http.Response, error) {
	var (
