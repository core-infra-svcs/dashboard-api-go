...
func (r SingleLanApiGetNetworkApplianceSingleLanRequest) Execute() (*InlineResponse20023, *http.Response, error) {
...
func (a *SingleLanApiService) GetNetworkApplianceSingleLanExecute(r SingleLanApiGetNetworkApplianceSingleLanRequest) (*InlineResponse20023, *http.Response, error) {
	var (
...
func (r SingleLanApiUpdateNetworkApplianceSingleLanRequest) Execute() (*InlineResponse20023, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20023
func (a *SingleLanApiService) UpdateNetworkApplianceSingleLanExecute(r SingleLanApiUpdateNetworkApplianceSingleLanRequest) (*InlineResponse20023, *http.Response, error) {
	var (
