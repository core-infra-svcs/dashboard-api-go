...
func (r SingleLanApiGetNetworkApplianceSingleLanRequest) Execute() (*InlineResponse20061, *http.Response, error) {
...
func (a *SingleLanApiService) GetNetworkApplianceSingleLanExecute(r SingleLanApiGetNetworkApplianceSingleLanRequest) (*InlineResponse20061, *http.Response, error) {
	var (
...
func (r SingleLanApiUpdateNetworkApplianceSingleLanRequest) UpdateNetworkApplianceSingleLan(updateNetworkApplianceSingleLan InlineObject61) SingleLanApiUpdateNetworkApplianceSingleLanRequest {
	r.updateNetworkApplianceSingleLan = &updateNetworkApplianceSingleLan
	return r
}

func (r SingleLanApiUpdateNetworkApplianceSingleLanRequest) Execute() (*InlineResponse20061, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20061
func (a *SingleLanApiService) UpdateNetworkApplianceSingleLanExecute(r SingleLanApiUpdateNetworkApplianceSingleLanRequest) (*InlineResponse20061, *http.Response, error) {
	var (
