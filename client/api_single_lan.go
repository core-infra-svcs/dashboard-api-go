...
func (r SingleLanApiGetNetworkApplianceSingleLanRequest) Execute() (*InlineResponse20068, *http.Response, error) {
...
func (a *SingleLanApiService) GetNetworkApplianceSingleLanExecute(r SingleLanApiGetNetworkApplianceSingleLanRequest) (*InlineResponse20068, *http.Response, error) {
	var (
...
func (r SingleLanApiUpdateNetworkApplianceSingleLanRequest) UpdateNetworkApplianceSingleLan(updateNetworkApplianceSingleLan InlineObject64) SingleLanApiUpdateNetworkApplianceSingleLanRequest {
	r.updateNetworkApplianceSingleLan = &updateNetworkApplianceSingleLan
	return r
}

func (r SingleLanApiUpdateNetworkApplianceSingleLanRequest) Execute() (*InlineResponse20068, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20068
func (a *SingleLanApiService) UpdateNetworkApplianceSingleLanExecute(r SingleLanApiUpdateNetworkApplianceSingleLanRequest) (*InlineResponse20068, *http.Response, error) {
	var (
