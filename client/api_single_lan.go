...
func (r SingleLanApiGetNetworkApplianceSingleLanRequest) Execute() (*InlineResponse20058, *http.Response, error) {
...
func (a *SingleLanApiService) GetNetworkApplianceSingleLanExecute(r SingleLanApiGetNetworkApplianceSingleLanRequest) (*InlineResponse20058, *http.Response, error) {
	var (
...
func (r SingleLanApiUpdateNetworkApplianceSingleLanRequest) UpdateNetworkApplianceSingleLan(updateNetworkApplianceSingleLan InlineObject59) SingleLanApiUpdateNetworkApplianceSingleLanRequest {
	r.updateNetworkApplianceSingleLan = &updateNetworkApplianceSingleLan
	return r
}

func (r SingleLanApiUpdateNetworkApplianceSingleLanRequest) Execute() (*InlineResponse20058, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20058
func (a *SingleLanApiService) UpdateNetworkApplianceSingleLanExecute(r SingleLanApiUpdateNetworkApplianceSingleLanRequest) (*InlineResponse20058, *http.Response, error) {
	var (
