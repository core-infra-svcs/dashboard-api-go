...
func (o *InlineResponse200332) GetCertificate() string {
...
func (o *InlineResponse200332) GetCertificateOk() (*string, bool) {
	if o == nil || isNil(o.Certificate) {
    return nil, false
	}
...
func (o *InlineResponse200332) HasCertificate() bool {
	if o != nil && !isNil(o.Certificate) {
		return true
	}
...
func (o *InlineResponse200332) SetCertificate(v string) {
	o.Certificate = &v
}
