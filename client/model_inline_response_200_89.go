...
type InlineResponse20089 struct {
	...
	PoliciesBySsid []InlineResponse20089PoliciesBySsid `json:"policiesBySsid,omitempty"`
}
...
func (o *InlineResponse20089) GetPoliciesBySsid() []InlineResponse20089PoliciesBySsid {
	if o == nil || isNil(o.PoliciesBySsid) {
		var ret []InlineResponse20089PoliciesBySsid
		return ret
	}
...
// SetPoliciesBySsid gets a reference to the given []InlineResponse20089PoliciesBySsid and assigns it to the PoliciesBySsid field.
