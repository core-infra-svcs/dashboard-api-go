...
type InlineResponse20089 struct {
	DefaultSettings *InlineResponse20089DefaultSettings `json:"defaultSettings,omitempty"`
	...
	Overrides []InlineResponse20089Overrides `json:"overrides,omitempty"`
}
...
func (o *InlineResponse20089) GetDefaultSettings() InlineResponse20089DefaultSettings {
	if o == nil || isNil(o.DefaultSettings) {
		var ret InlineResponse20089DefaultSettings
		return ret
	}
...
// SetDefaultSettings gets a reference to the given InlineResponse20089DefaultSettings and assigns it to the DefaultSettings field.
...
func (o *InlineResponse20089) GetOverrides() []InlineResponse20089Overrides {
	if o == nil || isNil(o.Overrides) {
		var ret []InlineResponse20089Overrides
		return ret
	}
	return o.Overrides
}
...
// SetOverrides gets a reference to the given []InlineResponse20089Overrides and assigns it to the Overrides field.
