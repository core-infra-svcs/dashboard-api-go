...
type InlineResponse20089 struct {
	...
	ClientVpnConnections []InlineResponse20089ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20089) GetClientVpnConnections() []InlineResponse20089ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20089ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20089ClientVpnConnections and assigns it to the ClientVpnConnections field.
