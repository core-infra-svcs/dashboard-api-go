...
type InlineResponse20089 struct {
	...
	ToVersion *InlineResponse20089ToVersion `json:"toVersion,omitempty"`
...
func (o *InlineResponse20089) GetToVersion() InlineResponse20089ToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20089ToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20089ToVersion and assigns it to the ToVersion field.
