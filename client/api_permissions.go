...
func (r PermissionsApiGetOrganizationCameraPermissionRequest) Execute() (*InlineResponse200132, *http.Response, error) {
...
func (a *PermissionsApiService) GetOrganizationCameraPermissionExecute(r PermissionsApiGetOrganizationCameraPermissionRequest) (*InlineResponse200132, *http.Response, error) {
	var (
...
func (r PermissionsApiGetOrganizationCameraPermissionsRequest) Execute() ([]InlineResponse200132, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200132
func (a *PermissionsApiService) GetOrganizationCameraPermissionsExecute(r PermissionsApiGetOrganizationCameraPermissionsRequest) ([]InlineResponse200132, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
