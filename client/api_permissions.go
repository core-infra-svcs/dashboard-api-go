...
func (r PermissionsApiGetOrganizationCameraPermissionRequest) Execute() (*InlineResponse200216, *http.Response, error) {
...
func (a *PermissionsApiService) GetOrganizationCameraPermissionExecute(r PermissionsApiGetOrganizationCameraPermissionRequest) (*InlineResponse200216, *http.Response, error) {
	var (
...
func (r PermissionsApiGetOrganizationCameraPermissionsRequest) Execute() ([]InlineResponse200216, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200216
func (a *PermissionsApiService) GetOrganizationCameraPermissionsExecute(r PermissionsApiGetOrganizationCameraPermissionsRequest) ([]InlineResponse200216, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
