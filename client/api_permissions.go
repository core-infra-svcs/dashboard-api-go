...
func (r PermissionsApiGetOrganizationCameraPermissionRequest) Execute() (*InlineResponse200126, *http.Response, error) {
...
func (a *PermissionsApiService) GetOrganizationCameraPermissionExecute(r PermissionsApiGetOrganizationCameraPermissionRequest) (*InlineResponse200126, *http.Response, error) {
	var (
...
func (r PermissionsApiGetOrganizationCameraPermissionsRequest) Execute() ([]InlineResponse200126, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200126
func (a *PermissionsApiService) GetOrganizationCameraPermissionsExecute(r PermissionsApiGetOrganizationCameraPermissionsRequest) ([]InlineResponse200126, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
