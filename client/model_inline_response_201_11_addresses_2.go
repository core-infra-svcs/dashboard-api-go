...
// InlineResponse20111Addresses2 struct for InlineResponse20111Addresses2
type InlineResponse20111Addresses2 struct {
...
func NewInlineResponse20111Addresses2() *InlineResponse20111Addresses2 {
	this := InlineResponse20111Addresses2{}
	return &this
}
...
func (o InlineResponse20111Addresses2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20111Addresses2 struct {
	value *InlineResponse20111Addresses2
	isSet bool
}

func (v NullableInlineResponse20111Addresses2) Get() *InlineResponse20111Addresses2 {
	return v.value
}

func (v *NullableInlineResponse20111Addresses2) Set(val *InlineResponse20111Addresses2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20111Addresses2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20111Addresses2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20111Addresses2(val *InlineResponse20111Addresses2) *NullableInlineResponse20111Addresses2 {
	return &NullableInlineResponse20111Addresses2{value: val, isSet: true}
}

func (v NullableInlineResponse20111Addresses2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20111Addresses2) UnmarshalJSON(src []byte) error {
	v.isSet = true
