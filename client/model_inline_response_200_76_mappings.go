...
// InlineResponse20076Mappings struct for InlineResponse20076Mappings
type InlineResponse20076Mappings struct {
...
func NewInlineResponse20076Mappings() *InlineResponse20076Mappings {
	this := InlineResponse20076Mappings{}
	return &this
}
...
func (o InlineResponse20076Mappings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20076Mappings struct {
	value *InlineResponse20076Mappings
	isSet bool
}

func (v NullableInlineResponse20076Mappings) Get() *InlineResponse20076Mappings {
	return v.value
}

func (v *NullableInlineResponse20076Mappings) Set(val *InlineResponse20076Mappings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20076Mappings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20076Mappings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20076Mappings(val *InlineResponse20076Mappings) *NullableInlineResponse20076Mappings {
	return &NullableInlineResponse20076Mappings{value: val, isSet: true}
}

func (v NullableInlineResponse20076Mappings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20076Mappings) UnmarshalJSON(src []byte) error {
	v.isSet = true
