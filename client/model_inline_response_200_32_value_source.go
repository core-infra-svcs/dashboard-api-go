...
// InlineResponse20032ValueSource Source of 'custom' type traffic filter
type InlineResponse20032ValueSource struct {
...
func NewInlineResponse20032ValueSource() *InlineResponse20032ValueSource {
	this := InlineResponse20032ValueSource{}
	return &this
}
...
func (o InlineResponse20032ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20032ValueSource struct {
	value *InlineResponse20032ValueSource
	isSet bool
}

func (v NullableInlineResponse20032ValueSource) Get() *InlineResponse20032ValueSource {
	return v.value
}

func (v *NullableInlineResponse20032ValueSource) Set(val *InlineResponse20032ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20032ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20032ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20032ValueSource(val *InlineResponse20032ValueSource) *NullableInlineResponse20032ValueSource {
	return &NullableInlineResponse20032ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20032ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20032ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
