...
// InlineResponse200278ResultingNetwork Network after the combination
type InlineResponse200278ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200278ResultingNetwork() *InlineResponse200278ResultingNetwork {
	this := InlineResponse200278ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200278ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200278ResultingNetwork struct {
	value *InlineResponse200278ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200278ResultingNetwork) Get() *InlineResponse200278ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200278ResultingNetwork) Set(val *InlineResponse200278ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200278ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200278ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200278ResultingNetwork(val *InlineResponse200278ResultingNetwork) *NullableInlineResponse200278ResultingNetwork {
	return &NullableInlineResponse200278ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200278ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200278ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
