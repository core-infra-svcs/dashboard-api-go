...
// InlineResponse200277ResultingNetwork Network after the combination
type InlineResponse200277ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200277ResultingNetwork() *InlineResponse200277ResultingNetwork {
	this := InlineResponse200277ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200277ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200277ResultingNetwork struct {
	value *InlineResponse200277ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200277ResultingNetwork) Get() *InlineResponse200277ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200277ResultingNetwork) Set(val *InlineResponse200277ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200277ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200277ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200277ResultingNetwork(val *InlineResponse200277ResultingNetwork) *NullableInlineResponse200277ResultingNetwork {
	return &NullableInlineResponse200277ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200277ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200277ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
