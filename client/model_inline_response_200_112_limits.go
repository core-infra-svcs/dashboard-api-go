...
// InlineResponse200112Limits The current limits of various adaptive policy objects.
type InlineResponse200112Limits struct {
...
func NewInlineResponse200112Limits() *InlineResponse200112Limits {
	this := InlineResponse200112Limits{}
	return &this
}
...
func (o InlineResponse200112Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200112Limits struct {
	value *InlineResponse200112Limits
	isSet bool
}

func (v NullableInlineResponse200112Limits) Get() *InlineResponse200112Limits {
	return v.value
}

func (v *NullableInlineResponse200112Limits) Set(val *InlineResponse200112Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200112Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200112Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200112Limits(val *InlineResponse200112Limits) *NullableInlineResponse200112Limits {
	return &NullableInlineResponse200112Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200112Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200112Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
