...
// InlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp The count data for SFP ports, indexed by speed in Mb
type InlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp struct {
...
func NewInlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp() *InlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp {
	this := InlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp{}
	return &this
}
...
func (o InlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp struct {
	value *InlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp
	isSet bool
}

func (v NullableInlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp) Get() *InlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp {
	return v.value
}

func (v *NullableInlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp) Set(val *InlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp(val *InlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp) *NullableInlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp {
	return &NullableInlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp{value: val, isSet: true}
}

func (v NullableInlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200286CountsByStatusActiveByMediaAndLinkSpeedSfp) UnmarshalJSON(src []byte) error {
	v.isSet = true
