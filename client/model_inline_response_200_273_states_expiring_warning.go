...
// InlineResponse200273StatesExpiringWarning Data for the warning threshold
type InlineResponse200273StatesExpiringWarning struct {
...
func NewInlineResponse200273StatesExpiringWarning() *InlineResponse200273StatesExpiringWarning {
	this := InlineResponse200273StatesExpiringWarning{}
	return &this
}
...
func (o InlineResponse200273StatesExpiringWarning) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200273StatesExpiringWarning struct {
	value *InlineResponse200273StatesExpiringWarning
	isSet bool
}

func (v NullableInlineResponse200273StatesExpiringWarning) Get() *InlineResponse200273StatesExpiringWarning {
	return v.value
}

func (v *NullableInlineResponse200273StatesExpiringWarning) Set(val *InlineResponse200273StatesExpiringWarning) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200273StatesExpiringWarning) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200273StatesExpiringWarning) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200273StatesExpiringWarning(val *InlineResponse200273StatesExpiringWarning) *NullableInlineResponse200273StatesExpiringWarning {
	return &NullableInlineResponse200273StatesExpiringWarning{value: val, isSet: true}
}

func (v NullableInlineResponse200273StatesExpiringWarning) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200273StatesExpiringWarning) UnmarshalJSON(src []byte) error {
	v.isSet = true
