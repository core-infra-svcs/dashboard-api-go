...
func (r BluetoothClientsApiGetNetworkBluetoothClientRequest) Execute() (*InlineResponse20077, *http.Response, error) {
...
func (a *BluetoothClientsApiService) GetNetworkBluetoothClientExecute(r BluetoothClientsApiGetNetworkBluetoothClientRequest) (*InlineResponse20077, *http.Response, error) {
	var (
...
func (r BluetoothClientsApiGetNetworkBluetoothClientsRequest) Execute() ([]InlineResponse20077, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20077
func (a *BluetoothClientsApiService) GetNetworkBluetoothClientsExecute(r BluetoothClientsApiGetNetworkBluetoothClientsRequest) ([]InlineResponse20077, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
