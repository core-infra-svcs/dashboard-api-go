...
func (r BluetoothClientsApiGetNetworkBluetoothClientRequest) Execute() (*InlineResponse20089, *http.Response, error) {
...
func (a *BluetoothClientsApiService) GetNetworkBluetoothClientExecute(r BluetoothClientsApiGetNetworkBluetoothClientRequest) (*InlineResponse20089, *http.Response, error) {
	var (
...
func (r BluetoothClientsApiGetNetworkBluetoothClientsRequest) Execute() ([]InlineResponse20089, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20089
func (a *BluetoothClientsApiService) GetNetworkBluetoothClientsExecute(r BluetoothClientsApiGetNetworkBluetoothClientsRequest) ([]InlineResponse20089, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
