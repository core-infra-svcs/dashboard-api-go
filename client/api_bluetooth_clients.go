...
func (r BluetoothClientsApiGetNetworkBluetoothClientRequest) Execute() (*InlineResponse20078, *http.Response, error) {
...
func (a *BluetoothClientsApiService) GetNetworkBluetoothClientExecute(r BluetoothClientsApiGetNetworkBluetoothClientRequest) (*InlineResponse20078, *http.Response, error) {
	var (
...
func (r BluetoothClientsApiGetNetworkBluetoothClientsRequest) Execute() ([]InlineResponse20078, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20078
func (a *BluetoothClientsApiService) GetNetworkBluetoothClientsExecute(r BluetoothClientsApiGetNetworkBluetoothClientsRequest) ([]InlineResponse20078, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
