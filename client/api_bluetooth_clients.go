...
func (r BluetoothClientsApiGetNetworkBluetoothClientRequest) Execute() (*InlineResponse20080, *http.Response, error) {
...
func (a *BluetoothClientsApiService) GetNetworkBluetoothClientExecute(r BluetoothClientsApiGetNetworkBluetoothClientRequest) (*InlineResponse20080, *http.Response, error) {
	var (
...
func (r BluetoothClientsApiGetNetworkBluetoothClientsRequest) Execute() ([]InlineResponse20080, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20080
func (a *BluetoothClientsApiService) GetNetworkBluetoothClientsExecute(r BluetoothClientsApiGetNetworkBluetoothClientsRequest) ([]InlineResponse20080, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
