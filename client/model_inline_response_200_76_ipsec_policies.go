...
// InlineResponse20076IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse20076IpsecPolicies struct {
...
func NewInlineResponse20076IpsecPolicies() *InlineResponse20076IpsecPolicies {
	this := InlineResponse20076IpsecPolicies{}
	return &this
}
...
func (o InlineResponse20076IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20076IpsecPolicies struct {
	value *InlineResponse20076IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse20076IpsecPolicies) Get() *InlineResponse20076IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse20076IpsecPolicies) Set(val *InlineResponse20076IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20076IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20076IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20076IpsecPolicies(val *InlineResponse20076IpsecPolicies) *NullableInlineResponse20076IpsecPolicies {
	return &NullableInlineResponse20076IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse20076IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20076IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
