...
type InlineResponse200141 struct {
	Alerts *InlineResponse200141Alerts `json:"alerts,omitempty"`
	...
	ArpInspection *InlineResponse200141ArpInspection `json:"arpInspection,omitempty"`
}
...
func (o *InlineResponse200141) GetAlerts() InlineResponse200141Alerts {
	if o == nil || isNil(o.Alerts) {
		var ret InlineResponse200141Alerts
		return ret
	}
	return *o.Alerts
}
...
// SetAlerts gets a reference to the given InlineResponse200141Alerts and assigns it to the Alerts field.
...
func (o *InlineResponse200141) GetArpInspection() InlineResponse200141ArpInspection {
	if o == nil || isNil(o.ArpInspection) {
		var ret InlineResponse200141ArpInspection
		return ret
	}
...
// SetArpInspection gets a reference to the given InlineResponse200141ArpInspection and assigns it to the ArpInspection field.
