...
// InlineResponse20089ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20089ToVersion struct {
...
func NewInlineResponse20089ToVersion() *InlineResponse20089ToVersion {
	this := InlineResponse20089ToVersion{}
	return &this
}
...
func (o InlineResponse20089ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20089ToVersion struct {
	value *InlineResponse20089ToVersion
	isSet bool
}

func (v NullableInlineResponse20089ToVersion) Get() *InlineResponse20089ToVersion {
	return v.value
}

func (v *NullableInlineResponse20089ToVersion) Set(val *InlineResponse20089ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20089ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20089ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20089ToVersion(val *InlineResponse20089ToVersion) *NullableInlineResponse20089ToVersion {
	return &NullableInlineResponse20089ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20089ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20089ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
