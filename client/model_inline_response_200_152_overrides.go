...
// InlineResponse200152Overrides struct for InlineResponse200152Overrides
type InlineResponse200152Overrides struct {
...
func NewInlineResponse200152Overrides() *InlineResponse200152Overrides {
	this := InlineResponse200152Overrides{}
	return &this
}
...
func (o InlineResponse200152Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200152Overrides struct {
	value *InlineResponse200152Overrides
	isSet bool
}

func (v NullableInlineResponse200152Overrides) Get() *InlineResponse200152Overrides {
	return v.value
}

func (v *NullableInlineResponse200152Overrides) Set(val *InlineResponse200152Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200152Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200152Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200152Overrides(val *InlineResponse200152Overrides) *NullableInlineResponse200152Overrides {
	return &NullableInlineResponse200152Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse200152Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200152Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
