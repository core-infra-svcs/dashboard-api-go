...
// InlineResponse200282Intervals struct for InlineResponse200282Intervals
type InlineResponse200282Intervals struct {
	...
	Memory *InlineResponse200282Memory `json:"memory,omitempty"`
}
...
func NewInlineResponse200282Intervals() *InlineResponse200282Intervals {
	this := InlineResponse200282Intervals{}
	return &this
}
...
func (o *InlineResponse200282Intervals) GetMemory() InlineResponse200282Memory {
	if o == nil || isNil(o.Memory) {
		var ret InlineResponse200282Memory
		return ret
	}
	return *o.Memory
}
...
// SetMemory gets a reference to the given InlineResponse200282Memory and assigns it to the Memory field.
func (o *InlineResponse200282Intervals) SetMemory(v InlineResponse200282Memory) {
	o.Memory = &v
}

func (o InlineResponse200282Intervals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200282Intervals struct {
	value *InlineResponse200282Intervals
	isSet bool
}

func (v NullableInlineResponse200282Intervals) Get() *InlineResponse200282Intervals {
	return v.value
}

func (v *NullableInlineResponse200282Intervals) Set(val *InlineResponse200282Intervals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200282Intervals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200282Intervals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200282Intervals(val *InlineResponse200282Intervals) *NullableInlineResponse200282Intervals {
	return &NullableInlineResponse200282Intervals{value: val, isSet: true}
}

func (v NullableInlineResponse200282Intervals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200282Intervals) UnmarshalJSON(src []byte) error {
	v.isSet = true
