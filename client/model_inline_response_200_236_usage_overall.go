...
// InlineResponse200236UsageOverall Overall data usage of all clients across organization
type InlineResponse200236UsageOverall struct {
...
func NewInlineResponse200236UsageOverall() *InlineResponse200236UsageOverall {
	this := InlineResponse200236UsageOverall{}
	return &this
}
...
func (o InlineResponse200236UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200236UsageOverall struct {
	value *InlineResponse200236UsageOverall
	isSet bool
}

func (v NullableInlineResponse200236UsageOverall) Get() *InlineResponse200236UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200236UsageOverall) Set(val *InlineResponse200236UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200236UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200236UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200236UsageOverall(val *InlineResponse200236UsageOverall) *NullableInlineResponse200236UsageOverall {
	return &NullableInlineResponse200236UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200236UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200236UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
