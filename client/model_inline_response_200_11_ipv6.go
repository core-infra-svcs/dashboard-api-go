...
// InlineResponse20011Ipv6 IPv6 configuration on the single LAN
type InlineResponse20011Ipv6 struct {
	// Enable IPv6 on single LAN
	Enabled *bool `json:"enabled,omitempty"`
	// Prefix assignments on the single LAN
	PrefixAssignments *[]InlineResponse20011Ipv6PrefixAssignments `json:"prefixAssignments,omitempty"`
}
...
func (o *InlineResponse20011Ipv6) GetPrefixAssignments() []InlineResponse20011Ipv6PrefixAssignments {
	if o == nil || o.PrefixAssignments == nil {
		var ret []InlineResponse20011Ipv6PrefixAssignments
		return ret
	}
...
// SetPrefixAssignments gets a reference to the given []InlineResponse20011Ipv6PrefixAssignments and assigns it to the PrefixAssignments field.
func (o *InlineResponse20011Ipv6) SetPrefixAssignments(v []InlineResponse20011Ipv6PrefixAssignments) {
	o.PrefixAssignments = &v
}

func (o InlineResponse20011Ipv6) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.Enabled != nil {
		toSerialize["enabled"] = o.Enabled
	}
	if o.PrefixAssignments != nil {
		toSerialize["prefixAssignments"] = o.PrefixAssignments
	}
	return json.Marshal(toSerialize)
}

type NullableInlineResponse20011Ipv6 struct {
	value *InlineResponse20011Ipv6
	isSet bool
}

func (v NullableInlineResponse20011Ipv6) Get() *InlineResponse20011Ipv6 {
	return v.value
}

func (v *NullableInlineResponse20011Ipv6) Set(val *InlineResponse20011Ipv6) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20011Ipv6) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20011Ipv6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20011Ipv6(val *InlineResponse20011Ipv6) *NullableInlineResponse20011Ipv6 {
	return &NullableInlineResponse20011Ipv6{value: val, isSet: true}
}

func (v NullableInlineResponse20011Ipv6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20011Ipv6) UnmarshalJSON(src []byte) error {
	v.isSet = true
