...
// InlineResponse20112Addresses1 struct for InlineResponse20112Addresses1
type InlineResponse20112Addresses1 struct {
...
func NewInlineResponse20112Addresses1() *InlineResponse20112Addresses1 {
	this := InlineResponse20112Addresses1{}
	return &this
}
...
func (o InlineResponse20112Addresses1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20112Addresses1 struct {
	value *InlineResponse20112Addresses1
	isSet bool
}

func (v NullableInlineResponse20112Addresses1) Get() *InlineResponse20112Addresses1 {
	return v.value
}

func (v *NullableInlineResponse20112Addresses1) Set(val *InlineResponse20112Addresses1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20112Addresses1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20112Addresses1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20112Addresses1(val *InlineResponse20112Addresses1) *NullableInlineResponse20112Addresses1 {
	return &NullableInlineResponse20112Addresses1{value: val, isSet: true}
}

func (v NullableInlineResponse20112Addresses1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20112Addresses1) UnmarshalJSON(src []byte) error {
	v.isSet = true
