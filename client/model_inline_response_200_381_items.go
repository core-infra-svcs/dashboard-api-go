...
type InlineResponse200381Items struct {
	...
	Intervals []InlineResponse200381Intervals `json:"intervals,omitempty"`
}
...
func (o *InlineResponse200381Items) GetIntervals() []InlineResponse200381Intervals {
	if o == nil || isNil(o.Intervals) {
		var ret []InlineResponse200381Intervals
		return ret
	}
	return o.Intervals
}
...
// SetIntervals gets a reference to the given []InlineResponse200381Intervals and assigns it to the Intervals field.
