...
// InlineResponse200264Records struct for InlineResponse200264Records
type InlineResponse200264Records struct {
	...
	ClientVpnConnections []InlineResponse200264ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200264Records() *InlineResponse200264Records {
	this := InlineResponse200264Records{}
	return &this
}
...
func (o *InlineResponse200264Records) GetClientVpnConnections() []InlineResponse200264ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200264ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200264ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200264Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200264Records struct {
	value *InlineResponse200264Records
	isSet bool
}

func (v NullableInlineResponse200264Records) Get() *InlineResponse200264Records {
	return v.value
}

func (v *NullableInlineResponse200264Records) Set(val *InlineResponse200264Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200264Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200264Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200264Records(val *InlineResponse200264Records) *NullableInlineResponse200264Records {
	return &NullableInlineResponse200264Records{value: val, isSet: true}
}

func (v NullableInlineResponse200264Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200264Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
