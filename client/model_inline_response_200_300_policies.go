...
// InlineResponse200300Policies struct for InlineResponse200300Policies
type InlineResponse200300Policies struct {
...
func NewInlineResponse200300Policies() *InlineResponse200300Policies {
	this := InlineResponse200300Policies{}
	return &this
}
...
func (o InlineResponse200300Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200300Policies struct {
	value *InlineResponse200300Policies
	isSet bool
}

func (v NullableInlineResponse200300Policies) Get() *InlineResponse200300Policies {
	return v.value
}

func (v *NullableInlineResponse200300Policies) Set(val *InlineResponse200300Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200300Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200300Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200300Policies(val *InlineResponse200300Policies) *NullableInlineResponse200300Policies {
	return &NullableInlineResponse200300Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200300Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200300Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
