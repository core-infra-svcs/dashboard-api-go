...
// InlineResponse20019Stages struct for InlineResponse20019Stages
type InlineResponse20019Stages struct {
	Group *InlineResponse20019Group `json:"group,omitempty"`
	Milestones *InlineResponse20019Milestones `json:"milestones,omitempty"`
...
func NewInlineResponse20019Stages() *InlineResponse20019Stages {
	this := InlineResponse20019Stages{}
	return &this
}
...
func (o *InlineResponse20019Stages) GetGroup() InlineResponse20019Group {
	if o == nil || isNil(o.Group) {
		var ret InlineResponse20019Group
		return ret
	}
	return *o.Group
}
...
// SetGroup gets a reference to the given InlineResponse20019Group and assigns it to the Group field.
...
func (o *InlineResponse20019Stages) GetMilestones() InlineResponse20019Milestones {
	if o == nil || isNil(o.Milestones) {
		var ret InlineResponse20019Milestones
		return ret
	}
	return *o.Milestones
}
...
// SetMilestones gets a reference to the given InlineResponse20019Milestones and assigns it to the Milestones field.
...
func (o InlineResponse20019Stages) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20019Stages struct {
	value *InlineResponse20019Stages
	isSet bool
}

func (v NullableInlineResponse20019Stages) Get() *InlineResponse20019Stages {
	return v.value
}

func (v *NullableInlineResponse20019Stages) Set(val *InlineResponse20019Stages) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20019Stages) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20019Stages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20019Stages(val *InlineResponse20019Stages) *NullableInlineResponse20019Stages {
	return &NullableInlineResponse20019Stages{value: val, isSet: true}
}

func (v NullableInlineResponse20019Stages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20019Stages) UnmarshalJSON(src []byte) error {
	v.isSet = true
