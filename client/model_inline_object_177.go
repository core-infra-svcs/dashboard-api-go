...
type InlineObject177 struct {
	...
	Networks []OrganizationsOrganizationIdAdminsAdminIdNetworks `json:"networks,omitempty"`
}
...
func (o *InlineObject177) GetNetworks() []OrganizationsOrganizationIdAdminsAdminIdNetworks {
	if o == nil || isNil(o.Networks) {
		var ret []OrganizationsOrganizationIdAdminsAdminIdNetworks
		return ret
	}
	return o.Networks
}
...
// SetNetworks gets a reference to the given []OrganizationsOrganizationIdAdminsAdminIdNetworks and assigns it to the Networks field.
