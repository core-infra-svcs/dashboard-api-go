...
// InlineResponse200253MetaCountsItems Count of eSIM Devices available
type InlineResponse200253MetaCountsItems struct {
...
func NewInlineResponse200253MetaCountsItems() *InlineResponse200253MetaCountsItems {
	this := InlineResponse200253MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200253MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200253MetaCountsItems struct {
	value *InlineResponse200253MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200253MetaCountsItems) Get() *InlineResponse200253MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200253MetaCountsItems) Set(val *InlineResponse200253MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200253MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200253MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200253MetaCountsItems(val *InlineResponse200253MetaCountsItems) *NullableInlineResponse200253MetaCountsItems {
	return &NullableInlineResponse200253MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200253MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200253MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
