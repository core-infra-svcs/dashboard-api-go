...
func (r AssignmentsApiGetOrganizationSmSentryPoliciesAssignmentsByNetworkRequest) Execute() ([]InlineResponse200274, *http.Response, error) {
...
func (a *AssignmentsApiService) GetOrganizationSmSentryPoliciesAssignmentsByNetworkExecute(r AssignmentsApiGetOrganizationSmSentryPoliciesAssignmentsByNetworkRequest) ([]InlineResponse200274, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AssignmentsApiGetOrganizationWirelessRfProfilesAssignmentsByDeviceRequest) Execute() ([]InlineResponse200307, *http.Response, error) {
...
func (a *AssignmentsApiService) GetOrganizationWirelessRfProfilesAssignmentsByDeviceExecute(r AssignmentsApiGetOrganizationWirelessRfProfilesAssignmentsByDeviceRequest) ([]InlineResponse200307, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AssignmentsApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) Execute() (*InlineResponse200273, *http.Response, error) {
...
func (a *AssignmentsApiService) UpdateOrganizationSmSentryPoliciesAssignmentsExecute(r AssignmentsApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) (*InlineResponse200273, *http.Response, error) {
	var (
