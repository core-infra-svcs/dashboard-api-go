...
func (r AssignmentsApiGetNetworkVlanProfilesAssignmentsByDeviceRequest) Execute() ([]InlineResponse20096, *http.Response, error) {
...
func (a *AssignmentsApiService) GetNetworkVlanProfilesAssignmentsByDeviceExecute(r AssignmentsApiGetNetworkVlanProfilesAssignmentsByDeviceRequest) ([]InlineResponse20096, *http.Response, error) {
	var (
...
func (r AssignmentsApiReassignNetworkVlanProfilesAssignmentsRequest) ReassignNetworkVlanProfilesAssignments(reassignNetworkVlanProfilesAssignments InlineObject154) AssignmentsApiReassignNetworkVlanProfilesAssignmentsRequest {
	r.reassignNetworkVlanProfilesAssignments = &reassignNetworkVlanProfilesAssignments
	return r
}

func (r AssignmentsApiReassignNetworkVlanProfilesAssignmentsRequest) Execute() (*InlineResponse20097, *http.Response, error) {
...
func (a *AssignmentsApiService) ReassignNetworkVlanProfilesAssignmentsExecute(r AssignmentsApiReassignNetworkVlanProfilesAssignmentsRequest) (*InlineResponse20097, *http.Response, error) {
	var (
