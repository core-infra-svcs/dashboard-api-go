...
func (r AssignmentsApiGetNetworkVlanProfilesAssignmentsByDeviceRequest) Execute() ([]InlineResponse200169, *http.Response, error) {
...
func (a *AssignmentsApiService) GetNetworkVlanProfilesAssignmentsByDeviceExecute(r AssignmentsApiGetNetworkVlanProfilesAssignmentsByDeviceRequest) ([]InlineResponse200169, *http.Response, error) {
	var (
...
func (r AssignmentsApiGetOrganizationSmSentryPoliciesAssignmentsByNetworkRequest) Execute() ([]InlineResponse200287, *http.Response, error) {
...
func (a *AssignmentsApiService) GetOrganizationSmSentryPoliciesAssignmentsByNetworkExecute(r AssignmentsApiGetOrganizationSmSentryPoliciesAssignmentsByNetworkRequest) ([]InlineResponse200287, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AssignmentsApiGetOrganizationWirelessRfProfilesAssignmentsByDeviceRequest) Execute() ([]InlineResponse200323, *http.Response, error) {
...
func (a *AssignmentsApiService) GetOrganizationWirelessRfProfilesAssignmentsByDeviceExecute(r AssignmentsApiGetOrganizationWirelessRfProfilesAssignmentsByDeviceRequest) ([]InlineResponse200323, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AssignmentsApiReassignNetworkVlanProfilesAssignmentsRequest) ReassignNetworkVlanProfilesAssignments(reassignNetworkVlanProfilesAssignments InlineObject167) AssignmentsApiReassignNetworkVlanProfilesAssignmentsRequest {
	r.reassignNetworkVlanProfilesAssignments = &reassignNetworkVlanProfilesAssignments
	return r
}

func (r AssignmentsApiReassignNetworkVlanProfilesAssignmentsRequest) Execute() (*InlineResponse200170, *http.Response, error) {
...
func (a *AssignmentsApiService) ReassignNetworkVlanProfilesAssignmentsExecute(r AssignmentsApiReassignNetworkVlanProfilesAssignmentsRequest) (*InlineResponse200170, *http.Response, error) {
	var (
...
func (r AssignmentsApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) UpdateOrganizationSmSentryPoliciesAssignments(updateOrganizationSmSentryPoliciesAssignments InlineObject268) AssignmentsApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest {
	r.updateOrganizationSmSentryPoliciesAssignments = &updateOrganizationSmSentryPoliciesAssignments
	return r
}

func (r AssignmentsApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) Execute() (*InlineResponse200286, *http.Response, error) {
...
func (a *AssignmentsApiService) UpdateOrganizationSmSentryPoliciesAssignmentsExecute(r AssignmentsApiUpdateOrganizationSmSentryPoliciesAssignmentsRequest) (*InlineResponse200286, *http.Response, error) {
	var (
