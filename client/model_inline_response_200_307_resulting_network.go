...
// InlineResponse200307ResultingNetwork Network after the combination
type InlineResponse200307ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200307ResultingNetwork() *InlineResponse200307ResultingNetwork {
	this := InlineResponse200307ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200307ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200307ResultingNetwork struct {
	value *InlineResponse200307ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200307ResultingNetwork) Get() *InlineResponse200307ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200307ResultingNetwork) Set(val *InlineResponse200307ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200307ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200307ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200307ResultingNetwork(val *InlineResponse200307ResultingNetwork) *NullableInlineResponse200307ResultingNetwork {
	return &NullableInlineResponse200307ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200307ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200307ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
