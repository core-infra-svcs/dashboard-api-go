...
// InlineResponse200268Details struct for InlineResponse200268Details
type InlineResponse200268Details struct {
	// Name of detail
...
func NewInlineResponse200268Details() *InlineResponse200268Details {
	this := InlineResponse200268Details{}
	return &this
}
...
func (o InlineResponse200268Details) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200268Details struct {
	value *InlineResponse200268Details
	isSet bool
}

func (v NullableInlineResponse200268Details) Get() *InlineResponse200268Details {
	return v.value
}

func (v *NullableInlineResponse200268Details) Set(val *InlineResponse200268Details) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200268Details) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200268Details) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200268Details(val *InlineResponse200268Details) *NullableInlineResponse200268Details {
	return &NullableInlineResponse200268Details{value: val, isSet: true}
}

func (v NullableInlineResponse200268Details) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200268Details) UnmarshalJSON(src []byte) error {
	v.isSet = true
