...
// InlineResponse200161DefaultSettings Default multicast setting for entire network. IGMP snooping and Flood unknown       multicast traffic settings are enabled by default.
type InlineResponse200161DefaultSettings struct {
...
func NewInlineResponse200161DefaultSettings() *InlineResponse200161DefaultSettings {
	this := InlineResponse200161DefaultSettings{}
	return &this
}
...
func (o InlineResponse200161DefaultSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200161DefaultSettings struct {
	value *InlineResponse200161DefaultSettings
	isSet bool
}

func (v NullableInlineResponse200161DefaultSettings) Get() *InlineResponse200161DefaultSettings {
	return v.value
}

func (v *NullableInlineResponse200161DefaultSettings) Set(val *InlineResponse200161DefaultSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200161DefaultSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200161DefaultSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200161DefaultSettings(val *InlineResponse200161DefaultSettings) *NullableInlineResponse200161DefaultSettings {
	return &NullableInlineResponse200161DefaultSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200161DefaultSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200161DefaultSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
