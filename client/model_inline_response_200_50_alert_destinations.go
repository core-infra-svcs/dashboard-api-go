...
// InlineResponse20050AlertDestinations A hash of destinations for this specific alert
type InlineResponse20050AlertDestinations struct {
...
func NewInlineResponse20050AlertDestinations() *InlineResponse20050AlertDestinations {
	this := InlineResponse20050AlertDestinations{}
	return &this
}
...
func (o InlineResponse20050AlertDestinations) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20050AlertDestinations struct {
	value *InlineResponse20050AlertDestinations
	isSet bool
}

func (v NullableInlineResponse20050AlertDestinations) Get() *InlineResponse20050AlertDestinations {
	return v.value
}

func (v *NullableInlineResponse20050AlertDestinations) Set(val *InlineResponse20050AlertDestinations) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20050AlertDestinations) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20050AlertDestinations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20050AlertDestinations(val *InlineResponse20050AlertDestinations) *NullableInlineResponse20050AlertDestinations {
	return &NullableInlineResponse20050AlertDestinations{value: val, isSet: true}
}

func (v NullableInlineResponse20050AlertDestinations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20050AlertDestinations) UnmarshalJSON(src []byte) error {
	v.isSet = true
