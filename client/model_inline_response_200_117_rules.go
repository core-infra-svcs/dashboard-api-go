...
// InlineResponse200117Rules struct for InlineResponse200117Rules
type InlineResponse200117Rules struct {
...
func NewInlineResponse200117Rules(definitions []NetworksNetworkIdApplianceTrafficShapingRulesDefinitions) *InlineResponse200117Rules {
	this := InlineResponse200117Rules{}
...
func (o InlineResponse200117Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200117Rules struct {
	value *InlineResponse200117Rules
	isSet bool
}

func (v NullableInlineResponse200117Rules) Get() *InlineResponse200117Rules {
	return v.value
}

func (v *NullableInlineResponse200117Rules) Set(val *InlineResponse200117Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200117Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200117Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200117Rules(val *InlineResponse200117Rules) *NullableInlineResponse200117Rules {
	return &NullableInlineResponse200117Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200117Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200117Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
