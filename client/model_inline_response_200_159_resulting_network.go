...
// InlineResponse200159ResultingNetwork Network after the combination
type InlineResponse200159ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200159ResultingNetwork() *InlineResponse200159ResultingNetwork {
	this := InlineResponse200159ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200159ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200159ResultingNetwork struct {
	value *InlineResponse200159ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200159ResultingNetwork) Get() *InlineResponse200159ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200159ResultingNetwork) Set(val *InlineResponse200159ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200159ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200159ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200159ResultingNetwork(val *InlineResponse200159ResultingNetwork) *NullableInlineResponse200159ResultingNetwork {
	return &NullableInlineResponse200159ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200159ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200159ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
