...
func (r IntrusionApiGetNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20060, *http.Response, error) {
...
func (a *IntrusionApiService) GetNetworkApplianceSecurityIntrusionExecute(r IntrusionApiGetNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20060, *http.Response, error) {
	var (
...
func (r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) UpdateNetworkApplianceSecurityIntrusion(updateNetworkApplianceSecurityIntrusion InlineObject58) IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest {
	r.updateNetworkApplianceSecurityIntrusion = &updateNetworkApplianceSecurityIntrusion
	return r
}

func (r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20060, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20060
func (a *IntrusionApiService) UpdateNetworkApplianceSecurityIntrusionExecute(r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20060, *http.Response, error) {
	var (
...
func (r IntrusionApiUpdateOrganizationApplianceSecurityIntrusionRequest) UpdateOrganizationApplianceSecurityIntrusion(updateOrganizationApplianceSecurityIntrusion InlineObject227) IntrusionApiUpdateOrganizationApplianceSecurityIntrusionRequest {
