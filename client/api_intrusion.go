...
func (r IntrusionApiGetNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20056, *http.Response, error) {
...
func (a *IntrusionApiService) GetNetworkApplianceSecurityIntrusionExecute(r IntrusionApiGetNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20056, *http.Response, error) {
	var (
...
func (r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) UpdateNetworkApplianceSecurityIntrusion(updateNetworkApplianceSecurityIntrusion InlineObject57) IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest {
	r.updateNetworkApplianceSecurityIntrusion = &updateNetworkApplianceSecurityIntrusion
	return r
}

func (r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20056, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20056
func (a *IntrusionApiService) UpdateNetworkApplianceSecurityIntrusionExecute(r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20056, *http.Response, error) {
	var (
...
func (r IntrusionApiUpdateOrganizationApplianceSecurityIntrusionRequest) UpdateOrganizationApplianceSecurityIntrusion(updateOrganizationApplianceSecurityIntrusion InlineObject212) IntrusionApiUpdateOrganizationApplianceSecurityIntrusionRequest {
