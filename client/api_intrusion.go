...
func (r IntrusionApiGetNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20055, *http.Response, error) {
...
func (a *IntrusionApiService) GetNetworkApplianceSecurityIntrusionExecute(r IntrusionApiGetNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20055, *http.Response, error) {
	var (
...
func (r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) UpdateNetworkApplianceSecurityIntrusion(updateNetworkApplianceSecurityIntrusion InlineObject56) IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest {
	r.updateNetworkApplianceSecurityIntrusion = &updateNetworkApplianceSecurityIntrusion
	return r
}

func (r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20055, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20055
func (a *IntrusionApiService) UpdateNetworkApplianceSecurityIntrusionExecute(r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20055, *http.Response, error) {
	var (
...
func (r IntrusionApiUpdateOrganizationApplianceSecurityIntrusionRequest) UpdateOrganizationApplianceSecurityIntrusion(updateOrganizationApplianceSecurityIntrusion InlineObject207) IntrusionApiUpdateOrganizationApplianceSecurityIntrusionRequest {
