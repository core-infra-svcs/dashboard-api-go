...
func (r IntrusionApiGetNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20065, *http.Response, error) {
...
func (a *IntrusionApiService) GetNetworkApplianceSecurityIntrusionExecute(r IntrusionApiGetNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20065, *http.Response, error) {
	var (
...
func (r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20065, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20065
func (a *IntrusionApiService) UpdateNetworkApplianceSecurityIntrusionExecute(r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20065, *http.Response, error) {
	var (
...
func (r IntrusionApiUpdateOrganizationApplianceSecurityIntrusionRequest) UpdateOrganizationApplianceSecurityIntrusion(updateOrganizationApplianceSecurityIntrusion InlineObject235) IntrusionApiUpdateOrganizationApplianceSecurityIntrusionRequest {
