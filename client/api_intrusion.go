...
func (r IntrusionApiGetNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20071, *http.Response, error) {
...
func (a *IntrusionApiService) GetNetworkApplianceSecurityIntrusionExecute(r IntrusionApiGetNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20071, *http.Response, error) {
	var (
...
func (r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) UpdateNetworkApplianceSecurityIntrusion(updateNetworkApplianceSecurityIntrusion InlineObject61) IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest {
	r.updateNetworkApplianceSecurityIntrusion = &updateNetworkApplianceSecurityIntrusion
	return r
}

func (r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) Execute() (*InlineResponse20071, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20071
func (a *IntrusionApiService) UpdateNetworkApplianceSecurityIntrusionExecute(r IntrusionApiUpdateNetworkApplianceSecurityIntrusionRequest) (*InlineResponse20071, *http.Response, error) {
	var (
...
func (r IntrusionApiUpdateOrganizationApplianceSecurityIntrusionRequest) UpdateOrganizationApplianceSecurityIntrusion(updateOrganizationApplianceSecurityIntrusion InlineObject237) IntrusionApiUpdateOrganizationApplianceSecurityIntrusionRequest {
