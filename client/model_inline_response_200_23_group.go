...
// InlineResponse20023Group The staged upgrade group
type InlineResponse20023Group struct {
...
func (o InlineResponse20023Group) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20023Group struct {
	value *InlineResponse20023Group
	isSet bool
}

func (v NullableInlineResponse20023Group) Get() *InlineResponse20023Group {
	return v.value
}

func (v *NullableInlineResponse20023Group) Set(val *InlineResponse20023Group) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20023Group) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20023Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20023Group(val *InlineResponse20023Group) *NullableInlineResponse20023Group {
	return &NullableInlineResponse20023Group{value: val, isSet: true}
}

func (v NullableInlineResponse20023Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20023Group) UnmarshalJSON(src []byte) error {
	v.isSet = true
