...
// InlineResponse20110Uplinks1 struct for InlineResponse20110Uplinks1
type InlineResponse20110Uplinks1 struct {
...
func NewInlineResponse20110Uplinks1() *InlineResponse20110Uplinks1 {
	this := InlineResponse20110Uplinks1{}
	return &this
}
...
func (o InlineResponse20110Uplinks1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20110Uplinks1 struct {
	value *InlineResponse20110Uplinks1
	isSet bool
}

func (v NullableInlineResponse20110Uplinks1) Get() *InlineResponse20110Uplinks1 {
	return v.value
}

func (v *NullableInlineResponse20110Uplinks1) Set(val *InlineResponse20110Uplinks1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20110Uplinks1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20110Uplinks1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20110Uplinks1(val *InlineResponse20110Uplinks1) *NullableInlineResponse20110Uplinks1 {
	return &NullableInlineResponse20110Uplinks1{value: val, isSet: true}
}

func (v NullableInlineResponse20110Uplinks1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20110Uplinks1) UnmarshalJSON(src []byte) error {
	v.isSet = true
