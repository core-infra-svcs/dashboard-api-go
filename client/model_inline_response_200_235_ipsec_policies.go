...
// InlineResponse200235IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200235IpsecPolicies struct {
...
func NewInlineResponse200235IpsecPolicies() *InlineResponse200235IpsecPolicies {
	this := InlineResponse200235IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200235IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200235IpsecPolicies struct {
	value *InlineResponse200235IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200235IpsecPolicies) Get() *InlineResponse200235IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200235IpsecPolicies) Set(val *InlineResponse200235IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200235IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200235IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200235IpsecPolicies(val *InlineResponse200235IpsecPolicies) *NullableInlineResponse200235IpsecPolicies {
	return &NullableInlineResponse200235IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200235IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200235IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
