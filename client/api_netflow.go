...
func (r NetflowApiGetNetworkNetflowRequest) Execute() (*InlineResponse20099, *http.Response, error) {
...
func (a *NetflowApiService) GetNetworkNetflowExecute(r NetflowApiGetNetworkNetflowRequest) (*InlineResponse20099, *http.Response, error) {
	var (
...
func (r NetflowApiUpdateNetworkNetflowRequest) UpdateNetworkNetflow(updateNetworkNetflow InlineObject107) NetflowApiUpdateNetworkNetflowRequest {
	r.updateNetworkNetflow = &updateNetworkNetflow
	return r
}

func (r NetflowApiUpdateNetworkNetflowRequest) Execute() (*InlineResponse20099, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20099
func (a *NetflowApiService) UpdateNetworkNetflowExecute(r NetflowApiUpdateNetworkNetflowRequest) (*InlineResponse20099, *http.Response, error) {
	var (
