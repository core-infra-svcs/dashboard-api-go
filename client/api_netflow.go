...
func (r NetflowApiGetNetworkNetflowRequest) Execute() (*InlineResponse200117, *http.Response, error) {
...
func (a *NetflowApiService) GetNetworkNetflowExecute(r NetflowApiGetNetworkNetflowRequest) (*InlineResponse200117, *http.Response, error) {
	var (
...
func (r NetflowApiUpdateNetworkNetflowRequest) Execute() (*InlineResponse200117, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200117
func (a *NetflowApiService) UpdateNetworkNetflowExecute(r NetflowApiUpdateNetworkNetflowRequest) (*InlineResponse200117, *http.Response, error) {
	var (
