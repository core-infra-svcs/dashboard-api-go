...
func (r NetflowApiGetNetworkNetflowRequest) Execute() (*InlineResponse200110, *http.Response, error) {
...
func (a *NetflowApiService) GetNetworkNetflowExecute(r NetflowApiGetNetworkNetflowRequest) (*InlineResponse200110, *http.Response, error) {
	var (
...
func (r NetflowApiUpdateNetworkNetflowRequest) UpdateNetworkNetflow(updateNetworkNetflow InlineObject114) NetflowApiUpdateNetworkNetflowRequest {
	r.updateNetworkNetflow = &updateNetworkNetflow
	return r
}

func (r NetflowApiUpdateNetworkNetflowRequest) Execute() (*InlineResponse200110, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200110
func (a *NetflowApiService) UpdateNetworkNetflowExecute(r NetflowApiUpdateNetworkNetflowRequest) (*InlineResponse200110, *http.Response, error) {
	var (
