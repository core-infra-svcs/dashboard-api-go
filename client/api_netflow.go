...
func (r NetflowApiGetNetworkNetflowRequest) Execute() (*InlineResponse200114, *http.Response, error) {
...
func (a *NetflowApiService) GetNetworkNetflowExecute(r NetflowApiGetNetworkNetflowRequest) (*InlineResponse200114, *http.Response, error) {
	var (
...
func (r NetflowApiUpdateNetworkNetflowRequest) UpdateNetworkNetflow(updateNetworkNetflow InlineObject118) NetflowApiUpdateNetworkNetflowRequest {
	r.updateNetworkNetflow = &updateNetworkNetflow
	return r
}

func (r NetflowApiUpdateNetworkNetflowRequest) Execute() (*InlineResponse200114, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200114
func (a *NetflowApiService) UpdateNetworkNetflowExecute(r NetflowApiUpdateNetworkNetflowRequest) (*InlineResponse200114, *http.Response, error) {
	var (
