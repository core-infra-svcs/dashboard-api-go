...
func (r NetflowApiGetNetworkNetflowRequest) Execute() (*InlineResponse200105, *http.Response, error) {
...
func (a *NetflowApiService) GetNetworkNetflowExecute(r NetflowApiGetNetworkNetflowRequest) (*InlineResponse200105, *http.Response, error) {
	var (
...
func (r NetflowApiUpdateNetworkNetflowRequest) UpdateNetworkNetflow(updateNetworkNetflow InlineObject112) NetflowApiUpdateNetworkNetflowRequest {
	r.updateNetworkNetflow = &updateNetworkNetflow
	return r
}

func (r NetflowApiUpdateNetworkNetflowRequest) Execute() (*InlineResponse200105, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200105
func (a *NetflowApiService) UpdateNetworkNetflowExecute(r NetflowApiUpdateNetworkNetflowRequest) (*InlineResponse200105, *http.Response, error) {
	var (
