...
func (r NetflowApiGetNetworkNetflowRequest) Execute() (*InlineResponse200112, *http.Response, error) {
...
func (a *NetflowApiService) GetNetworkNetflowExecute(r NetflowApiGetNetworkNetflowRequest) (*InlineResponse200112, *http.Response, error) {
	var (
...
func (r NetflowApiUpdateNetworkNetflowRequest) UpdateNetworkNetflow(updateNetworkNetflow InlineObject117) NetflowApiUpdateNetworkNetflowRequest {
	r.updateNetworkNetflow = &updateNetworkNetflow
	return r
}

func (r NetflowApiUpdateNetworkNetflowRequest) Execute() (*InlineResponse200112, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200112
func (a *NetflowApiService) UpdateNetworkNetflowExecute(r NetflowApiUpdateNetworkNetflowRequest) (*InlineResponse200112, *http.Response, error) {
	var (
