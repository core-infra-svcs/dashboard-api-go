...
func (r NetflowApiGetNetworkNetflowRequest) Execute() (*InlineResponse200100, *http.Response, error) {
...
func (a *NetflowApiService) GetNetworkNetflowExecute(r NetflowApiGetNetworkNetflowRequest) (*InlineResponse200100, *http.Response, error) {
	var (
...
func (r NetflowApiUpdateNetworkNetflowRequest) Execute() (*InlineResponse200100, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200100
func (a *NetflowApiService) UpdateNetworkNetflowExecute(r NetflowApiUpdateNetworkNetflowRequest) (*InlineResponse200100, *http.Response, error) {
	var (
