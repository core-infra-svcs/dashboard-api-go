...
func (r NetflowApiGetNetworkNetflowRequest) Execute() (*InlineResponse20098, *http.Response, error) {
...
func (a *NetflowApiService) GetNetworkNetflowExecute(r NetflowApiGetNetworkNetflowRequest) (*InlineResponse20098, *http.Response, error) {
	var (
...
func (r NetflowApiUpdateNetworkNetflowRequest) Execute() (*InlineResponse20098, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20098
func (a *NetflowApiService) UpdateNetworkNetflowExecute(r NetflowApiUpdateNetworkNetflowRequest) (*InlineResponse20098, *http.Response, error) {
	var (
