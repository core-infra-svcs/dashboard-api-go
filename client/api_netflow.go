...
func (r NetflowApiGetNetworkNetflowRequest) Execute() (*InlineResponse200109, *http.Response, error) {
...
func (a *NetflowApiService) GetNetworkNetflowExecute(r NetflowApiGetNetworkNetflowRequest) (*InlineResponse200109, *http.Response, error) {
	var (
...
func (r NetflowApiUpdateNetworkNetflowRequest) Execute() (*InlineResponse200109, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200109
func (a *NetflowApiService) UpdateNetworkNetflowExecute(r NetflowApiUpdateNetworkNetflowRequest) (*InlineResponse200109, *http.Response, error) {
	var (
