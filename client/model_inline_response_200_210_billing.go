...
// InlineResponse200210Billing Details associated with billing splash
type InlineResponse200210Billing struct {
	FreeAccess *InlineResponse200210BillingFreeAccess `json:"freeAccess,omitempty"`
...
func NewInlineResponse200210Billing() *InlineResponse200210Billing {
	this := InlineResponse200210Billing{}
	return &this
}
...
func (o *InlineResponse200210Billing) GetFreeAccess() InlineResponse200210BillingFreeAccess {
	if o == nil || isNil(o.FreeAccess) {
		var ret InlineResponse200210BillingFreeAccess
		return ret
	}
	return *o.FreeAccess
}
...
// SetFreeAccess gets a reference to the given InlineResponse200210BillingFreeAccess and assigns it to the FreeAccess field.
...
func (o InlineResponse200210Billing) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200210Billing struct {
	value *InlineResponse200210Billing
	isSet bool
}

func (v NullableInlineResponse200210Billing) Get() *InlineResponse200210Billing {
	return v.value
}

func (v *NullableInlineResponse200210Billing) Set(val *InlineResponse200210Billing) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200210Billing) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200210Billing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200210Billing(val *InlineResponse200210Billing) *NullableInlineResponse200210Billing {
	return &NullableInlineResponse200210Billing{value: val, isSet: true}
}

func (v NullableInlineResponse200210Billing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200210Billing) UnmarshalJSON(src []byte) error {
	v.isSet = true
