...
// InlineResponse200118IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200118IpsecPolicies struct {
...
func NewInlineResponse200118IpsecPolicies() *InlineResponse200118IpsecPolicies {
	this := InlineResponse200118IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200118IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200118IpsecPolicies struct {
	value *InlineResponse200118IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200118IpsecPolicies) Get() *InlineResponse200118IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200118IpsecPolicies) Set(val *InlineResponse200118IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200118IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200118IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200118IpsecPolicies(val *InlineResponse200118IpsecPolicies) *NullableInlineResponse200118IpsecPolicies {
	return &NullableInlineResponse200118IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200118IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200118IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
