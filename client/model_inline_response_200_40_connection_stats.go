...
// InlineResponse20040ConnectionStats The connection stats of the device
type InlineResponse20040ConnectionStats struct {
...
func NewInlineResponse20040ConnectionStats() *InlineResponse20040ConnectionStats {
	this := InlineResponse20040ConnectionStats{}
	return &this
}
...
func (o InlineResponse20040ConnectionStats) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20040ConnectionStats struct {
	value *InlineResponse20040ConnectionStats
	isSet bool
}

func (v NullableInlineResponse20040ConnectionStats) Get() *InlineResponse20040ConnectionStats {
	return v.value
}

func (v *NullableInlineResponse20040ConnectionStats) Set(val *InlineResponse20040ConnectionStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20040ConnectionStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20040ConnectionStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20040ConnectionStats(val *InlineResponse20040ConnectionStats) *NullableInlineResponse20040ConnectionStats {
	return &NullableInlineResponse20040ConnectionStats{value: val, isSet: true}
}

func (v NullableInlineResponse20040ConnectionStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20040ConnectionStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
