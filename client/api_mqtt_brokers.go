...
func (r MqttBrokersApiCreateNetworkMqttBrokerRequest) CreateNetworkMqttBroker(createNetworkMqttBroker InlineObject103) MqttBrokersApiCreateNetworkMqttBrokerRequest {
...
func (r MqttBrokersApiGetNetworkSensorMqttBrokerRequest) Execute() (*InlineResponse20064, *http.Response, error) {
...
func (a *MqttBrokersApiService) GetNetworkSensorMqttBrokerExecute(r MqttBrokersApiGetNetworkSensorMqttBrokerRequest) (*InlineResponse20064, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MqttBrokersApiGetNetworkSensorMqttBrokersRequest) Execute() ([]InlineResponse20064, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20064
func (a *MqttBrokersApiService) GetNetworkSensorMqttBrokersExecute(r MqttBrokersApiGetNetworkSensorMqttBrokersRequest) ([]InlineResponse20064, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MqttBrokersApiUpdateNetworkMqttBrokerRequest) UpdateNetworkMqttBroker(updateNetworkMqttBroker InlineObject104) MqttBrokersApiUpdateNetworkMqttBrokerRequest {
...
func (r MqttBrokersApiUpdateNetworkSensorMqttBrokerRequest) UpdateNetworkSensorMqttBroker(updateNetworkSensorMqttBroker InlineObject109) MqttBrokersApiUpdateNetworkSensorMqttBrokerRequest {
	r.updateNetworkSensorMqttBroker = &updateNetworkSensorMqttBroker
	return r
}

func (r MqttBrokersApiUpdateNetworkSensorMqttBrokerRequest) Execute() (*InlineResponse20064, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20064
func (a *MqttBrokersApiService) UpdateNetworkSensorMqttBrokerExecute(r MqttBrokersApiUpdateNetworkSensorMqttBrokerRequest) (*InlineResponse20064, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
