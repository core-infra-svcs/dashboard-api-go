...
func (r MqttBrokersApiCreateNetworkMqttBrokerRequest) CreateNetworkMqttBroker(createNetworkMqttBroker InlineObject99) MqttBrokersApiCreateNetworkMqttBrokerRequest {
...
func (r MqttBrokersApiGetNetworkSensorMqttBrokerRequest) Execute() (*InlineResponse20052, *http.Response, error) {
...
func (a *MqttBrokersApiService) GetNetworkSensorMqttBrokerExecute(r MqttBrokersApiGetNetworkSensorMqttBrokerRequest) (*InlineResponse20052, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MqttBrokersApiGetNetworkSensorMqttBrokersRequest) Execute() ([]InlineResponse20052, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20052
func (a *MqttBrokersApiService) GetNetworkSensorMqttBrokersExecute(r MqttBrokersApiGetNetworkSensorMqttBrokersRequest) ([]InlineResponse20052, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MqttBrokersApiUpdateNetworkMqttBrokerRequest) UpdateNetworkMqttBroker(updateNetworkMqttBroker InlineObject100) MqttBrokersApiUpdateNetworkMqttBrokerRequest {
...
func (r MqttBrokersApiUpdateNetworkSensorMqttBrokerRequest) UpdateNetworkSensorMqttBroker(updateNetworkSensorMqttBroker InlineObject105) MqttBrokersApiUpdateNetworkSensorMqttBrokerRequest {
	r.updateNetworkSensorMqttBroker = &updateNetworkSensorMqttBroker
	return r
}

func (r MqttBrokersApiUpdateNetworkSensorMqttBrokerRequest) Execute() (*InlineResponse20052, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20052
func (a *MqttBrokersApiService) UpdateNetworkSensorMqttBrokerExecute(r MqttBrokersApiUpdateNetworkSensorMqttBrokerRequest) (*InlineResponse20052, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
