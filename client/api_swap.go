...
func (r SwapApiCreateOrganizationCellularGatewayEsimsSwapRequest) CreateOrganizationCellularGatewayEsimsSwap(createOrganizationCellularGatewayEsimsSwap InlineObject227) SwapApiCreateOrganizationCellularGatewayEsimsSwapRequest {
	r.createOrganizationCellularGatewayEsimsSwap = &createOrganizationCellularGatewayEsimsSwap
	return r
}

func (r SwapApiCreateOrganizationCellularGatewayEsimsSwapRequest) Execute() (*InlineResponse200232, *http.Response, error) {
...
func (a *SwapApiService) CreateOrganizationCellularGatewayEsimsSwapExecute(r SwapApiCreateOrganizationCellularGatewayEsimsSwapRequest) (*InlineResponse200232, *http.Response, error) {
	var (
...
func (r SwapApiUpdateOrganizationCellularGatewayEsimsSwapRequest) Execute() (*InlineResponse200232, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200232
func (a *SwapApiService) UpdateOrganizationCellularGatewayEsimsSwapExecute(r SwapApiUpdateOrganizationCellularGatewayEsimsSwapRequest) (*InlineResponse200232, *http.Response, error) {
	var (
