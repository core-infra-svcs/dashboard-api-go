...
func (r SwapApiCreateOrganizationCellularGatewayEsimsSwapRequest) CreateOrganizationCellularGatewayEsimsSwap(createOrganizationCellularGatewayEsimsSwap InlineObject253) SwapApiCreateOrganizationCellularGatewayEsimsSwapRequest {
	r.createOrganizationCellularGatewayEsimsSwap = &createOrganizationCellularGatewayEsimsSwap
	return r
}

func (r SwapApiCreateOrganizationCellularGatewayEsimsSwapRequest) Execute() (*InlineResponse200280, *http.Response, error) {
...
func (a *SwapApiService) CreateOrganizationCellularGatewayEsimsSwapExecute(r SwapApiCreateOrganizationCellularGatewayEsimsSwapRequest) (*InlineResponse200280, *http.Response, error) {
	var (
...
func (r SwapApiUpdateOrganizationCellularGatewayEsimsSwapRequest) Execute() (*InlineResponse200280, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200280
func (a *SwapApiService) UpdateOrganizationCellularGatewayEsimsSwapExecute(r SwapApiUpdateOrganizationCellularGatewayEsimsSwapRequest) (*InlineResponse200280, *http.Response, error) {
	var (
