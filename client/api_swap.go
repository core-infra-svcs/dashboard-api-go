...
func (r SwapApiCreateOrganizationCellularGatewayEsimsSwapRequest) CreateOrganizationCellularGatewayEsimsSwap(createOrganizationCellularGatewayEsimsSwap InlineObject250) SwapApiCreateOrganizationCellularGatewayEsimsSwapRequest {
	r.createOrganizationCellularGatewayEsimsSwap = &createOrganizationCellularGatewayEsimsSwap
	return r
}

func (r SwapApiCreateOrganizationCellularGatewayEsimsSwapRequest) Execute() (*InlineResponse200263, *http.Response, error) {
...
func (a *SwapApiService) CreateOrganizationCellularGatewayEsimsSwapExecute(r SwapApiCreateOrganizationCellularGatewayEsimsSwapRequest) (*InlineResponse200263, *http.Response, error) {
	var (
...
func (r SwapApiUpdateOrganizationCellularGatewayEsimsSwapRequest) Execute() (*InlineResponse200263, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200263
func (a *SwapApiService) UpdateOrganizationCellularGatewayEsimsSwapExecute(r SwapApiUpdateOrganizationCellularGatewayEsimsSwapRequest) (*InlineResponse200263, *http.Response, error) {
	var (
