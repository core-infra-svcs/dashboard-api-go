...
// InlineResponse200347Example Example alert type
type InlineResponse200347Example struct {
...
func NewInlineResponse200347Example() *InlineResponse200347Example {
	this := InlineResponse200347Example{}
	return &this
}
...
func (o InlineResponse200347Example) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200347Example struct {
	value *InlineResponse200347Example
	isSet bool
}

func (v NullableInlineResponse200347Example) Get() *InlineResponse200347Example {
	return v.value
}

func (v *NullableInlineResponse200347Example) Set(val *InlineResponse200347Example) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200347Example) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200347Example) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200347Example(val *InlineResponse200347Example) *NullableInlineResponse200347Example {
	return &NullableInlineResponse200347Example{value: val, isSet: true}
}

func (v NullableInlineResponse200347Example) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200347Example) UnmarshalJSON(src []byte) error {
	v.isSet = true
