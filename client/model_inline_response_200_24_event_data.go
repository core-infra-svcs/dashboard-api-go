...
// InlineResponse20024EventData An object containing more data related to the event.
type InlineResponse20024EventData struct {
...
func NewInlineResponse20024EventData() *InlineResponse20024EventData {
	this := InlineResponse20024EventData{}
	return &this
}
...
func (o InlineResponse20024EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20024EventData struct {
	value *InlineResponse20024EventData
	isSet bool
}

func (v NullableInlineResponse20024EventData) Get() *InlineResponse20024EventData {
	return v.value
}

func (v *NullableInlineResponse20024EventData) Set(val *InlineResponse20024EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20024EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20024EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20024EventData(val *InlineResponse20024EventData) *NullableInlineResponse20024EventData {
	return &NullableInlineResponse20024EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20024EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20024EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
