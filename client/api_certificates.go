...
type CertificatesApiCreateOrganizationNacCertificatesAuthoritiesCrlRequest struct {
	ctx context.Context
...
func (r CertificatesApiCreateOrganizationNacCertificatesAuthoritiesCrlRequest) CreateOrganizationNacCertificatesAuthoritiesCrl(createOrganizationNacCertificatesAuthoritiesCrl InlineObject288) CertificatesApiCreateOrganizationNacCertificatesAuthoritiesCrlRequest {
	r.createOrganizationNacCertificatesAuthoritiesCrl = &createOrganizationNacCertificatesAuthoritiesCrl
	return r
}

func (r CertificatesApiCreateOrganizationNacCertificatesAuthoritiesCrlRequest) Execute() (*InlineResponse20124, *http.Response, error) {
...
Create a new CRL (either base or delta) for an existing CA
 ...
 @return CertificatesApiCreateOrganizationNacCertificatesAuthoritiesCrlRequest
*/
func (a *CertificatesApiService) CreateOrganizationNacCertificatesAuthoritiesCrl(ctx context.Context, organizationId string) CertificatesApiCreateOrganizationNacCertificatesAuthoritiesCrlRequest {
	return CertificatesApiCreateOrganizationNacCertificatesAuthoritiesCrlRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *CertificatesApiService) CreateOrganizationNacCertificatesAuthoritiesCrlExecute(r CertificatesApiCreateOrganizationNacCertificatesAuthoritiesCrlRequest) (*InlineResponse20124, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CertificatesApiService.CreateOrganizationNacCertificatesAuthoritiesCrl")
	if err != nil {
...
func (r CertificatesApiCreateOrganizationWirelessDevicesRadsecCertificatesAuthorityRequest) Execute() (*InlineResponse200376, *http.Response, error) {
...
func (a *CertificatesApiService) CreateOrganizationWirelessDevicesRadsecCertificatesAuthorityExecute(r CertificatesApiCreateOrganizationWirelessDevicesRadsecCertificatesAuthorityRequest) (*InlineResponse200376, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CertificatesApiGetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesRequest) Execute() ([]InlineResponse200375, *http.Response, error) {
...
func (a *CertificatesApiService) GetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesExecute(r CertificatesApiGetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesRequest) ([]InlineResponse200375, *http.Response, error) {
	var (
...
func (r CertificatesApiGetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrlsRequest) Execute() (*InlineResponse200377, *http.Response, error) {
...
func (a *CertificatesApiService) GetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrlsExecute(r CertificatesApiGetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrlsRequest) (*InlineResponse200377, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CertificatesApiGetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrlsDeltasRequest) Execute() (*InlineResponse200377, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200377
func (a *CertificatesApiService) GetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrlsDeltasExecute(r CertificatesApiGetOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrlsDeltasRequest) (*InlineResponse200377, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CertificatesApiUpdateOrganizationWirelessDevicesRadsecCertificatesAuthoritiesRequest) UpdateOrganizationWirelessDevicesRadsecCertificatesAuthorities(updateOrganizationWirelessDevicesRadsecCertificatesAuthorities InlineObject307) CertificatesApiUpdateOrganizationWirelessDevicesRadsecCertificatesAuthoritiesRequest {
...
func (r CertificatesApiUpdateOrganizationWirelessDevicesRadsecCertificatesAuthoritiesRequest) Execute() (*InlineResponse200376, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200376
func (a *CertificatesApiService) UpdateOrganizationWirelessDevicesRadsecCertificatesAuthoritiesExecute(r CertificatesApiUpdateOrganizationWirelessDevicesRadsecCertificatesAuthoritiesRequest) (*InlineResponse200376, *http.Response, error) {
	var (
