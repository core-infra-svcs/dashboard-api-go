...
type InlineResponse200255Items struct {
	...
	Logo *InlineResponse200255Logo `json:"logo,omitempty"`
	// Indicates if service provider is the bootstrap provider.
	IsBootstrap *bool `json:"isBootstrap,omitempty"`
	Terms *InlineResponse200255Terms `json:"terms,omitempty"`
}
...
func (o *InlineResponse200255Items) GetLogo() InlineResponse200255Logo {
	if o == nil || isNil(o.Logo) {
		var ret InlineResponse200255Logo
		return ret
	}
	return *o.Logo
}
...
// SetLogo gets a reference to the given InlineResponse200255Logo and assigns it to the Logo field.
...
func (o *InlineResponse200255Items) GetTerms() InlineResponse200255Terms {
	if o == nil || isNil(o.Terms) {
		var ret InlineResponse200255Terms
		return ret
	}
	return *o.Terms
}
...
// SetTerms gets a reference to the given InlineResponse200255Terms and assigns it to the Terms field.
