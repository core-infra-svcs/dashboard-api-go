...
// InlineResponse20027Wan1 WAN 1 settings
type InlineResponse20027Wan1 struct {
...
func (o InlineResponse20027Wan1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20027Wan1 struct {
	value *InlineResponse20027Wan1
	isSet bool
}

func (v NullableInlineResponse20027Wan1) Get() *InlineResponse20027Wan1 {
	return v.value
}

func (v *NullableInlineResponse20027Wan1) Set(val *InlineResponse20027Wan1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20027Wan1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20027Wan1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20027Wan1(val *InlineResponse20027Wan1) *NullableInlineResponse20027Wan1 {
	return &NullableInlineResponse20027Wan1{value: val, isSet: true}
}

func (v NullableInlineResponse20027Wan1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20027Wan1) UnmarshalJSON(src []byte) error {
	v.isSet = true
