...
// InlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp The count data for SFP ports, indexed by speed in Mb
type InlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp struct {
...
func NewInlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp() *InlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp {
	this := InlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp{}
	return &this
}
...
func (o InlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp struct {
	value *InlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp
	isSet bool
}

func (v NullableInlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp) Get() *InlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp {
	return v.value
}

func (v *NullableInlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp) Set(val *InlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp(val *InlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp) *NullableInlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp {
	return &NullableInlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp{value: val, isSet: true}
}

func (v NullableInlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200342CountsByStatusActiveByMediaAndLinkSpeedSfp) UnmarshalJSON(src []byte) error {
	v.isSet = true
