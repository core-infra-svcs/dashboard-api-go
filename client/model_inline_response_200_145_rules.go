...
// InlineResponse200145Rules struct for InlineResponse200145Rules
type InlineResponse200145Rules struct {
...
func NewInlineResponse200145Rules() *InlineResponse200145Rules {
	this := InlineResponse200145Rules{}
	return &this
}
...
func (o InlineResponse200145Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200145Rules struct {
	value *InlineResponse200145Rules
	isSet bool
}

func (v NullableInlineResponse200145Rules) Get() *InlineResponse200145Rules {
	return v.value
}

func (v *NullableInlineResponse200145Rules) Set(val *InlineResponse200145Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200145Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200145Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200145Rules(val *InlineResponse200145Rules) *NullableInlineResponse200145Rules {
	return &NullableInlineResponse200145Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200145Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200145Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
