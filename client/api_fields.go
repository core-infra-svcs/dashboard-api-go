...
func (r FieldsApiUpdateNetworkSmDevicesFieldsRequest) UpdateNetworkSmDevicesFields(updateNetworkSmDevicesFields InlineObject106) FieldsApiUpdateNetworkSmDevicesFieldsRequest {
	r.updateNetworkSmDevicesFields = &updateNetworkSmDevicesFields
	return r
}

func (r FieldsApiUpdateNetworkSmDevicesFieldsRequest) Execute() ([]InlineResponse20053, *http.Response, error) {
...
func (a *FieldsApiService) UpdateNetworkSmDevicesFieldsExecute(r FieldsApiUpdateNetworkSmDevicesFieldsRequest) ([]InlineResponse20053, *http.Response, error) {
	var (
