...
func (r FieldsApiUpdateNetworkSmDevicesFieldsRequest) Execute() ([]InlineResponse20054, *http.Response, error) {
...
func (a *FieldsApiService) UpdateNetworkSmDevicesFieldsExecute(r FieldsApiUpdateNetworkSmDevicesFieldsRequest) ([]InlineResponse20054, *http.Response, error) {
	var (
