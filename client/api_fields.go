...
func (r FieldsApiApiUpdateNetworkSmDevicesFieldsRequest) UpdateNetworkSmDevicesFields(updateNetworkSmDevicesFields InlineObject83) FieldsApiApiUpdateNetworkSmDevicesFieldsRequest {
	r.updateNetworkSmDevicesFields = &updateNetworkSmDevicesFields
	return r
}

func (r FieldsApiApiUpdateNetworkSmDevicesFieldsRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
func (a *FieldsApiService) UpdateNetworkSmDevicesFieldsExecute(r FieldsApiApiUpdateNetworkSmDevicesFieldsRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
