...
type FieldsApiApiUpdateNetworkSmDevicesFieldsRequest struct {
...
func (r FieldsApiApiUpdateNetworkSmDevicesFieldsRequest) UpdateNetworkSmDevicesFields(updateNetworkSmDevicesFields InlineObject101) FieldsApiApiUpdateNetworkSmDevicesFieldsRequest {
	r.updateNetworkSmDevicesFields = &updateNetworkSmDevicesFields
	return r
}

func (r FieldsApiApiUpdateNetworkSmDevicesFieldsRequest) Execute() ([]InlineResponse20026, *_nethttp.Response, error) {
...
Modify the fields of a device
 ...
 @param networkId
 @return FieldsApiApiUpdateNetworkSmDevicesFieldsRequest
*/
func (a *FieldsApiService) UpdateNetworkSmDevicesFields(ctx _context.Context, networkId string) FieldsApiApiUpdateNetworkSmDevicesFieldsRequest {
	return FieldsApiApiUpdateNetworkSmDevicesFieldsRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *FieldsApiService) UpdateNetworkSmDevicesFieldsExecute(r FieldsApiApiUpdateNetworkSmDevicesFieldsRequest) ([]InlineResponse20026, *_nethttp.Response, error) {
	var (
