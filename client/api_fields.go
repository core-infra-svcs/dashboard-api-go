...
func (r FieldsApiUpdateNetworkSmDevicesFieldsRequest) Execute() ([]InlineResponse200119, *http.Response, error) {
...
func (a *FieldsApiService) UpdateNetworkSmDevicesFieldsExecute(r FieldsApiUpdateNetworkSmDevicesFieldsRequest) ([]InlineResponse200119, *http.Response, error) {
	var (
