...
func (o *InlineResponse200133) GetIds() []string {
...
func (o *InlineResponse200133) GetIdsOk() ([]string, bool) {
	if o == nil || isNil(o.Ids) {
    return nil, false
	}
	return o.Ids, true
...
func (o *InlineResponse200133) HasIds() bool {
	if o != nil && !isNil(o.Ids) {
		return true
	}
...
func (o *InlineResponse200133) SetIds(v []string) {
	o.Ids = v
}
