...
func (r StormControlApiGetNetworkSwitchStormControlRequest) Execute() (*InlineResponse200173, *http.Response, error) {
...
func (a *StormControlApiService) GetNetworkSwitchStormControlExecute(r StormControlApiGetNetworkSwitchStormControlRequest) (*InlineResponse200173, *http.Response, error) {
	var (
...
func (r StormControlApiUpdateNetworkSwitchStormControlRequest) UpdateNetworkSwitchStormControl(updateNetworkSwitchStormControl InlineObject167) StormControlApiUpdateNetworkSwitchStormControlRequest {
	r.updateNetworkSwitchStormControl = &updateNetworkSwitchStormControl
	return r
}

func (r StormControlApiUpdateNetworkSwitchStormControlRequest) Execute() (*InlineResponse200173, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200173
func (a *StormControlApiService) UpdateNetworkSwitchStormControlExecute(r StormControlApiUpdateNetworkSwitchStormControlRequest) (*InlineResponse200173, *http.Response, error) {
	var (
