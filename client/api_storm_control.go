...
func (r StormControlApiGetNetworkSwitchStormControlRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
func (a *StormControlApiService) GetNetworkSwitchStormControlExecute(r StormControlApiGetNetworkSwitchStormControlRequest) (*InlineResponse200159, *http.Response, error) {
	var (
...
func (r StormControlApiUpdateNetworkSwitchStormControlRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200159
func (a *StormControlApiService) UpdateNetworkSwitchStormControlExecute(r StormControlApiUpdateNetworkSwitchStormControlRequest) (*InlineResponse200159, *http.Response, error) {
	var (
