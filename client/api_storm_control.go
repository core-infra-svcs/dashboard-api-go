...
func (r StormControlApiGetNetworkSwitchStormControlRequest) Execute() (*InlineResponse200157, *http.Response, error) {
...
func (a *StormControlApiService) GetNetworkSwitchStormControlExecute(r StormControlApiGetNetworkSwitchStormControlRequest) (*InlineResponse200157, *http.Response, error) {
	var (
...
func (r StormControlApiUpdateNetworkSwitchStormControlRequest) Execute() (*InlineResponse200157, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200157
func (a *StormControlApiService) UpdateNetworkSwitchStormControlExecute(r StormControlApiUpdateNetworkSwitchStormControlRequest) (*InlineResponse200157, *http.Response, error) {
	var (
