...
func (r StormControlApiGetNetworkSwitchStormControlRequest) Execute() (*InlineResponse200176, *http.Response, error) {
...
func (a *StormControlApiService) GetNetworkSwitchStormControlExecute(r StormControlApiGetNetworkSwitchStormControlRequest) (*InlineResponse200176, *http.Response, error) {
	var (
...
func (r StormControlApiUpdateNetworkSwitchStormControlRequest) Execute() (*InlineResponse200176, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200176
func (a *StormControlApiService) UpdateNetworkSwitchStormControlExecute(r StormControlApiUpdateNetworkSwitchStormControlRequest) (*InlineResponse200176, *http.Response, error) {
	var (
