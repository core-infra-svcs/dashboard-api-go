...
func (r StormControlApiGetNetworkSwitchStormControlRequest) Execute() (*InlineResponse200158, *http.Response, error) {
...
func (a *StormControlApiService) GetNetworkSwitchStormControlExecute(r StormControlApiGetNetworkSwitchStormControlRequest) (*InlineResponse200158, *http.Response, error) {
	var (
...
func (r StormControlApiUpdateNetworkSwitchStormControlRequest) UpdateNetworkSwitchStormControl(updateNetworkSwitchStormControl InlineObject157) StormControlApiUpdateNetworkSwitchStormControlRequest {
	r.updateNetworkSwitchStormControl = &updateNetworkSwitchStormControl
	return r
}

func (r StormControlApiUpdateNetworkSwitchStormControlRequest) Execute() (*InlineResponse200158, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200158
func (a *StormControlApiService) UpdateNetworkSwitchStormControlExecute(r StormControlApiUpdateNetworkSwitchStormControlRequest) (*InlineResponse200158, *http.Response, error) {
	var (
