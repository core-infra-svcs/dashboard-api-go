...
func (r StormControlApiGetNetworkSwitchStormControlRequest) Execute() (*InlineResponse20090, *http.Response, error) {
...
func (a *StormControlApiService) GetNetworkSwitchStormControlExecute(r StormControlApiGetNetworkSwitchStormControlRequest) (*InlineResponse20090, *http.Response, error) {
	var (
...
func (r StormControlApiUpdateNetworkSwitchStormControlRequest) UpdateNetworkSwitchStormControl(updateNetworkSwitchStormControl InlineObject145) StormControlApiUpdateNetworkSwitchStormControlRequest {
