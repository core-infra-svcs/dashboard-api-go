...
// InlineResponse200241EbgpNeighbor [optional] The BGP neighbor configuration for the VPN peer. Supported only for MX 19.1 and above.
type InlineResponse200241EbgpNeighbor struct {
	// ID of ebgp neighbor
...
func NewInlineResponse200241EbgpNeighbor() *InlineResponse200241EbgpNeighbor {
	this := InlineResponse200241EbgpNeighbor{}
	return &this
}
...
func (o InlineResponse200241EbgpNeighbor) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200241EbgpNeighbor struct {
	value *InlineResponse200241EbgpNeighbor
	isSet bool
}

func (v NullableInlineResponse200241EbgpNeighbor) Get() *InlineResponse200241EbgpNeighbor {
	return v.value
}

func (v *NullableInlineResponse200241EbgpNeighbor) Set(val *InlineResponse200241EbgpNeighbor) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200241EbgpNeighbor) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200241EbgpNeighbor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200241EbgpNeighbor(val *InlineResponse200241EbgpNeighbor) *NullableInlineResponse200241EbgpNeighbor {
	return &NullableInlineResponse200241EbgpNeighbor{value: val, isSet: true}
}

func (v NullableInlineResponse200241EbgpNeighbor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200241EbgpNeighbor) UnmarshalJSON(src []byte) error {
	v.isSet = true
