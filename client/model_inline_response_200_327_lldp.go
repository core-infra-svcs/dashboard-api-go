...
// InlineResponse200327Lldp struct for InlineResponse200327Lldp
type InlineResponse200327Lldp struct {
...
func (o InlineResponse200327Lldp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200327Lldp struct {
	value *InlineResponse200327Lldp
	isSet bool
}

func (v NullableInlineResponse200327Lldp) Get() *InlineResponse200327Lldp {
	return v.value
}

func (v *NullableInlineResponse200327Lldp) Set(val *InlineResponse200327Lldp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200327Lldp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200327Lldp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200327Lldp(val *InlineResponse200327Lldp) *NullableInlineResponse200327Lldp {
	return &NullableInlineResponse200327Lldp{value: val, isSet: true}
}

func (v NullableInlineResponse200327Lldp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200327Lldp) UnmarshalJSON(src []byte) error {
	v.isSet = true
