...
type CameraApiCreateNetworkCameraQualityRetentionProfileRequest struct {
	...
	networkId string
	createNetworkCameraQualityRetentionProfile *InlineObject62
}

func (r CameraApiCreateNetworkCameraQualityRetentionProfileRequest) CreateNetworkCameraQualityRetentionProfile(createNetworkCameraQualityRetentionProfile InlineObject62) CameraApiCreateNetworkCameraQualityRetentionProfileRequest {
...
type CameraApiCreateNetworkCameraWirelessProfileRequest struct {
	...
	ApiService *CameraApiService
	networkId string
	createNetworkCameraWirelessProfile *InlineObject64
}

func (r CameraApiCreateNetworkCameraWirelessProfileRequest) CreateNetworkCameraWirelessProfile(createNetworkCameraWirelessProfile InlineObject64) CameraApiCreateNetworkCameraWirelessProfileRequest {
...
type CameraApiCreateOrganizationCameraCustomAnalyticsArtifactRequest struct {
	...
	createOrganizationCameraCustomAnalyticsArtifact *InlineObject186
}

func (r CameraApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) CreateOrganizationCameraCustomAnalyticsArtifact(createOrganizationCameraCustomAnalyticsArtifact InlineObject186) CameraApiCreateOrganizationCameraCustomAnalyticsArtifactRequest {
...
type CameraApiUpdateNetworkCameraQualityRetentionProfileRequest struct {
	...
	networkId string
	qualityRetentionProfileId string
	updateNetworkCameraQualityRetentionProfile *InlineObject63
}

func (r CameraApiUpdateNetworkCameraQualityRetentionProfileRequest) UpdateNetworkCameraQualityRetentionProfile(updateNetworkCameraQualityRetentionProfile InlineObject63) CameraApiUpdateNetworkCameraQualityRetentionProfileRequest {
...
type CameraApiUpdateNetworkCameraWirelessProfileRequest struct {
	...
	networkId string
	wirelessProfileId string
	updateNetworkCameraWirelessProfile *InlineObject65
}

func (r CameraApiUpdateNetworkCameraWirelessProfileRequest) UpdateNetworkCameraWirelessProfile(updateNetworkCameraWirelessProfile InlineObject65) CameraApiUpdateNetworkCameraWirelessProfileRequest {
...
func (r CameraApiUpdateOrganizationCameraOnboardingStatusesRequest) UpdateOrganizationCameraOnboardingStatuses(updateOrganizationCameraOnboardingStatuses InlineObject187) CameraApiUpdateOrganizationCameraOnboardingStatusesRequest {
