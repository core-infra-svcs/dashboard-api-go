...
// InlineResponse200350MetaCountsItems The count metadata.
type InlineResponse200350MetaCountsItems struct {
...
func NewInlineResponse200350MetaCountsItems() *InlineResponse200350MetaCountsItems {
	this := InlineResponse200350MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200350MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200350MetaCountsItems struct {
	value *InlineResponse200350MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200350MetaCountsItems) Get() *InlineResponse200350MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200350MetaCountsItems) Set(val *InlineResponse200350MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200350MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200350MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200350MetaCountsItems(val *InlineResponse200350MetaCountsItems) *NullableInlineResponse200350MetaCountsItems {
	return &NullableInlineResponse200350MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200350MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200350MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
