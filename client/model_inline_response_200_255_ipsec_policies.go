...
// InlineResponse200255IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200255IpsecPolicies struct {
...
func NewInlineResponse200255IpsecPolicies() *InlineResponse200255IpsecPolicies {
	this := InlineResponse200255IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200255IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200255IpsecPolicies struct {
	value *InlineResponse200255IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200255IpsecPolicies) Get() *InlineResponse200255IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200255IpsecPolicies) Set(val *InlineResponse200255IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200255IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200255IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200255IpsecPolicies(val *InlineResponse200255IpsecPolicies) *NullableInlineResponse200255IpsecPolicies {
	return &NullableInlineResponse200255IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200255IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200255IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
