...
// InlineResponse200335Changes struct for InlineResponse200335Changes
type InlineResponse200335Changes struct {
...
func NewInlineResponse200335Changes() *InlineResponse200335Changes {
	this := InlineResponse200335Changes{}
	return &this
}
...
func (o InlineResponse200335Changes) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200335Changes struct {
	value *InlineResponse200335Changes
	isSet bool
}

func (v NullableInlineResponse200335Changes) Get() *InlineResponse200335Changes {
	return v.value
}

func (v *NullableInlineResponse200335Changes) Set(val *InlineResponse200335Changes) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200335Changes) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200335Changes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200335Changes(val *InlineResponse200335Changes) *NullableInlineResponse200335Changes {
	return &NullableInlineResponse200335Changes{value: val, isSet: true}
}

func (v NullableInlineResponse200335Changes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200335Changes) UnmarshalJSON(src []byte) error {
	v.isSet = true
