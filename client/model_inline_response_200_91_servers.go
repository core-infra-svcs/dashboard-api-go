...
// InlineResponse20091Servers struct for InlineResponse20091Servers
type InlineResponse20091Servers struct {
...
func NewInlineResponse20091Servers() *InlineResponse20091Servers {
	this := InlineResponse20091Servers{}
	return &this
}
...
func (o InlineResponse20091Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20091Servers struct {
	value *InlineResponse20091Servers
	isSet bool
}

func (v NullableInlineResponse20091Servers) Get() *InlineResponse20091Servers {
	return v.value
}

func (v *NullableInlineResponse20091Servers) Set(val *InlineResponse20091Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20091Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20091Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20091Servers(val *InlineResponse20091Servers) *NullableInlineResponse20091Servers {
	return &NullableInlineResponse20091Servers{value: val, isSet: true}
}

func (v NullableInlineResponse20091Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20091Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
