...
func (r MulticastForwardingApiGetOrganizationApplianceFirewallMulticastForwardingByNetworkRequest) Execute() (*InlineResponse200233, *http.Response, error) {
...
func (a *MulticastForwardingApiService) GetOrganizationApplianceFirewallMulticastForwardingByNetworkExecute(r MulticastForwardingApiGetOrganizationApplianceFirewallMulticastForwardingByNetworkRequest) (*InlineResponse200233, *http.Response, error) {
	var (
