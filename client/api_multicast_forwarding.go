...
func (r MulticastForwardingApiGetOrganizationApplianceFirewallMulticastForwardingByNetworkRequest) Execute() (*InlineResponse200239, *http.Response, error) {
...
func (a *MulticastForwardingApiService) GetOrganizationApplianceFirewallMulticastForwardingByNetworkExecute(r MulticastForwardingApiGetOrganizationApplianceFirewallMulticastForwardingByNetworkRequest) (*InlineResponse200239, *http.Response, error) {
	var (
