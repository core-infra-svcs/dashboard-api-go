...
// InlineResponse20049FiltersConditions struct for InlineResponse20049FiltersConditions
type InlineResponse20049FiltersConditions struct {
	// Type of condition
...
func NewInlineResponse20049FiltersConditions() *InlineResponse20049FiltersConditions {
	this := InlineResponse20049FiltersConditions{}
	return &this
}
...
func (o InlineResponse20049FiltersConditions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20049FiltersConditions struct {
	value *InlineResponse20049FiltersConditions
	isSet bool
}

func (v NullableInlineResponse20049FiltersConditions) Get() *InlineResponse20049FiltersConditions {
	return v.value
}

func (v *NullableInlineResponse20049FiltersConditions) Set(val *InlineResponse20049FiltersConditions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20049FiltersConditions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20049FiltersConditions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20049FiltersConditions(val *InlineResponse20049FiltersConditions) *NullableInlineResponse20049FiltersConditions {
	return &NullableInlineResponse20049FiltersConditions{value: val, isSet: true}
}

func (v NullableInlineResponse20049FiltersConditions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20049FiltersConditions) UnmarshalJSON(src []byte) error {
	v.isSet = true
