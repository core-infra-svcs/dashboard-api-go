...
// InlineResponse200194Webhook The webhook receiver used by the callback to send results
type InlineResponse200194Webhook struct {
	// The webhook receiver URL where the callback will be sent
	Url *string `json:"url,omitempty"`
	HttpServer *InlineResponse200194WebhookHttpServer `json:"httpServer,omitempty"`
	PayloadTemplate *InlineResponse200194WebhookPayloadTemplate `json:"payloadTemplate,omitempty"`
...
func NewInlineResponse200194Webhook() *InlineResponse200194Webhook {
	this := InlineResponse200194Webhook{}
	return &this
}
...
func (o *InlineResponse200194Webhook) GetHttpServer() InlineResponse200194WebhookHttpServer {
	if o == nil || isNil(o.HttpServer) {
		var ret InlineResponse200194WebhookHttpServer
		return ret
	}
	return *o.HttpServer
}
...
// SetHttpServer gets a reference to the given InlineResponse200194WebhookHttpServer and assigns it to the HttpServer field.
...
func (o *InlineResponse200194Webhook) GetPayloadTemplate() InlineResponse200194WebhookPayloadTemplate {
	if o == nil || isNil(o.PayloadTemplate) {
		var ret InlineResponse200194WebhookPayloadTemplate
		return ret
	}
...
// SetPayloadTemplate gets a reference to the given InlineResponse200194WebhookPayloadTemplate and assigns it to the PayloadTemplate field.
...
func (o InlineResponse200194Webhook) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200194Webhook struct {
	value *InlineResponse200194Webhook
	isSet bool
}

func (v NullableInlineResponse200194Webhook) Get() *InlineResponse200194Webhook {
	return v.value
}

func (v *NullableInlineResponse200194Webhook) Set(val *InlineResponse200194Webhook) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200194Webhook) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200194Webhook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200194Webhook(val *InlineResponse200194Webhook) *NullableInlineResponse200194Webhook {
	return &NullableInlineResponse200194Webhook{value: val, isSet: true}
}

func (v NullableInlineResponse200194Webhook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200194Webhook) UnmarshalJSON(src []byte) error {
	v.isSet = true
