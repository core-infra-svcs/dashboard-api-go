...
// InlineResponse200118Limits The current limits of various adaptive policy objects.
type InlineResponse200118Limits struct {
...
func NewInlineResponse200118Limits() *InlineResponse200118Limits {
	this := InlineResponse200118Limits{}
	return &this
}
...
func (o InlineResponse200118Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200118Limits struct {
	value *InlineResponse200118Limits
	isSet bool
}

func (v NullableInlineResponse200118Limits) Get() *InlineResponse200118Limits {
	return v.value
}

func (v *NullableInlineResponse200118Limits) Set(val *InlineResponse200118Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200118Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200118Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200118Limits(val *InlineResponse200118Limits) *NullableInlineResponse200118Limits {
	return &NullableInlineResponse200118Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200118Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200118Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
