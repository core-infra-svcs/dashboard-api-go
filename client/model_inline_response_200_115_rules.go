...
// InlineResponse200115Rules struct for InlineResponse200115Rules
type InlineResponse200115Rules struct {
...
func NewInlineResponse200115Rules(definitions []NetworksNetworkIdApplianceTrafficShapingRulesDefinitions) *InlineResponse200115Rules {
	this := InlineResponse200115Rules{}
...
func (o InlineResponse200115Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200115Rules struct {
	value *InlineResponse200115Rules
	isSet bool
}

func (v NullableInlineResponse200115Rules) Get() *InlineResponse200115Rules {
	return v.value
}

func (v *NullableInlineResponse200115Rules) Set(val *InlineResponse200115Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200115Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200115Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200115Rules(val *InlineResponse200115Rules) *NullableInlineResponse200115Rules {
	return &NullableInlineResponse200115Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200115Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200115Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
