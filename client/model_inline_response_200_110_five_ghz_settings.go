...
// InlineResponse200110FiveGhzSettings Settings related to 5Ghz band
type InlineResponse200110FiveGhzSettings struct {
...
func NewInlineResponse200110FiveGhzSettings() *InlineResponse200110FiveGhzSettings {
	this := InlineResponse200110FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse200110FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200110FiveGhzSettings struct {
	value *InlineResponse200110FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse200110FiveGhzSettings) Get() *InlineResponse200110FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200110FiveGhzSettings) Set(val *InlineResponse200110FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200110FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200110FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200110FiveGhzSettings(val *InlineResponse200110FiveGhzSettings) *NullableInlineResponse200110FiveGhzSettings {
	return &NullableInlineResponse200110FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200110FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200110FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
