...
// InlineResponse20020Assigned struct for InlineResponse20020Assigned
type InlineResponse20020Assigned struct {
	...
	TwoFourGhzSettings *InlineResponse20020TwoFourGhzSettings `json:"twoFourGhzSettings,omitempty"`
	FiveGhzSettings *InlineResponse20020FiveGhzSettings `json:"fiveGhzSettings,omitempty"`
	PerSsidSettings *InlineResponse20020PerSsidSettings `json:"perSsidSettings,omitempty"`
}
...
func NewInlineResponse20020Assigned() *InlineResponse20020Assigned {
	this := InlineResponse20020Assigned{}
	return &this
}
...
func (o *InlineResponse20020Assigned) GetTwoFourGhzSettings() InlineResponse20020TwoFourGhzSettings {
	if o == nil || isNil(o.TwoFourGhzSettings) {
		var ret InlineResponse20020TwoFourGhzSettings
		return ret
	}
...
// SetTwoFourGhzSettings gets a reference to the given InlineResponse20020TwoFourGhzSettings and assigns it to the TwoFourGhzSettings field.
...
func (o *InlineResponse20020Assigned) GetFiveGhzSettings() InlineResponse20020FiveGhzSettings {
	if o == nil || isNil(o.FiveGhzSettings) {
		var ret InlineResponse20020FiveGhzSettings
		return ret
	}
...
// SetFiveGhzSettings gets a reference to the given InlineResponse20020FiveGhzSettings and assigns it to the FiveGhzSettings field.
...
func (o *InlineResponse20020Assigned) GetPerSsidSettings() InlineResponse20020PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse20020PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse20020PerSsidSettings and assigns it to the PerSsidSettings field.
func (o *InlineResponse20020Assigned) SetPerSsidSettings(v InlineResponse20020PerSsidSettings) {
	o.PerSsidSettings = &v
}

func (o InlineResponse20020Assigned) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20020Assigned struct {
	value *InlineResponse20020Assigned
	isSet bool
}

func (v NullableInlineResponse20020Assigned) Get() *InlineResponse20020Assigned {
	return v.value
}

func (v *NullableInlineResponse20020Assigned) Set(val *InlineResponse20020Assigned) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20020Assigned) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20020Assigned) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20020Assigned(val *InlineResponse20020Assigned) *NullableInlineResponse20020Assigned {
	return &NullableInlineResponse20020Assigned{value: val, isSet: true}
}

func (v NullableInlineResponse20020Assigned) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20020Assigned) UnmarshalJSON(src []byte) error {
	v.isSet = true
