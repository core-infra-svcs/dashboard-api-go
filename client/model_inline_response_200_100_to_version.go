...
// InlineResponse200100ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse200100ToVersion struct {
...
func NewInlineResponse200100ToVersion() *InlineResponse200100ToVersion {
	this := InlineResponse200100ToVersion{}
	return &this
}
...
func (o InlineResponse200100ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200100ToVersion struct {
	value *InlineResponse200100ToVersion
	isSet bool
}

func (v NullableInlineResponse200100ToVersion) Get() *InlineResponse200100ToVersion {
	return v.value
}

func (v *NullableInlineResponse200100ToVersion) Set(val *InlineResponse200100ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200100ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200100ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200100ToVersion(val *InlineResponse200100ToVersion) *NullableInlineResponse200100ToVersion {
	return &NullableInlineResponse200100ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse200100ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200100ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
