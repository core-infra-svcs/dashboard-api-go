...
// InlineResponse20020ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20020ToVersion struct {
...
func NewInlineResponse20020ToVersion() *InlineResponse20020ToVersion {
	this := InlineResponse20020ToVersion{}
	return &this
}
...
func (o InlineResponse20020ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20020ToVersion struct {
	value *InlineResponse20020ToVersion
	isSet bool
}

func (v NullableInlineResponse20020ToVersion) Get() *InlineResponse20020ToVersion {
	return v.value
}

func (v *NullableInlineResponse20020ToVersion) Set(val *InlineResponse20020ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20020ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20020ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20020ToVersion(val *InlineResponse20020ToVersion) *NullableInlineResponse20020ToVersion {
	return &NullableInlineResponse20020ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20020ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20020ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
