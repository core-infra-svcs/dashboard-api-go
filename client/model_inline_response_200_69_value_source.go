...
// InlineResponse20069ValueSource Source of 'custom' type traffic filter
type InlineResponse20069ValueSource struct {
...
func NewInlineResponse20069ValueSource() *InlineResponse20069ValueSource {
	this := InlineResponse20069ValueSource{}
	return &this
}
...
func (o InlineResponse20069ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20069ValueSource struct {
	value *InlineResponse20069ValueSource
	isSet bool
}

func (v NullableInlineResponse20069ValueSource) Get() *InlineResponse20069ValueSource {
	return v.value
}

func (v *NullableInlineResponse20069ValueSource) Set(val *InlineResponse20069ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20069ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20069ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20069ValueSource(val *InlineResponse20069ValueSource) *NullableInlineResponse20069ValueSource {
	return &NullableInlineResponse20069ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20069ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20069ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
