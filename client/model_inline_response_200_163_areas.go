...
// InlineResponse200163Areas struct for InlineResponse200163Areas
type InlineResponse200163Areas struct {
	// OSPF area ID
...
func NewInlineResponse200163Areas() *InlineResponse200163Areas {
	this := InlineResponse200163Areas{}
	return &this
}
...
func (o InlineResponse200163Areas) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200163Areas struct {
	value *InlineResponse200163Areas
	isSet bool
}

func (v NullableInlineResponse200163Areas) Get() *InlineResponse200163Areas {
	return v.value
}

func (v *NullableInlineResponse200163Areas) Set(val *InlineResponse200163Areas) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200163Areas) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200163Areas) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200163Areas(val *InlineResponse200163Areas) *NullableInlineResponse200163Areas {
	return &NullableInlineResponse200163Areas{value: val, isSet: true}
}

func (v NullableInlineResponse200163Areas) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200163Areas) UnmarshalJSON(src []byte) error {
	v.isSet = true
