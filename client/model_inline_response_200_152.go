...
type InlineResponse200152 struct {
	...
	V3 *InlineResponse200152V3 `json:"v3,omitempty"`
...
func (o *InlineResponse200152) GetV3() InlineResponse200152V3 {
	if o == nil || isNil(o.V3) {
		var ret InlineResponse200152V3
		return ret
	}
	return *o.V3
}
...
// SetV3 gets a reference to the given InlineResponse200152V3 and assigns it to the V3 field.
