...
// InlineResponse20019EventData An object containing more data related to the event.
type InlineResponse20019EventData struct {
...
func NewInlineResponse20019EventData() *InlineResponse20019EventData {
	this := InlineResponse20019EventData{}
	return &this
}
...
func (o InlineResponse20019EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20019EventData struct {
	value *InlineResponse20019EventData
	isSet bool
}

func (v NullableInlineResponse20019EventData) Get() *InlineResponse20019EventData {
	return v.value
}

func (v *NullableInlineResponse20019EventData) Set(val *InlineResponse20019EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20019EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20019EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20019EventData(val *InlineResponse20019EventData) *NullableInlineResponse20019EventData {
	return &NullableInlineResponse20019EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20019EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20019EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
