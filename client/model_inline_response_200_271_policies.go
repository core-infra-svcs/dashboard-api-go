...
// InlineResponse200271Policies struct for InlineResponse200271Policies
type InlineResponse200271Policies struct {
...
func NewInlineResponse200271Policies() *InlineResponse200271Policies {
	this := InlineResponse200271Policies{}
	return &this
}
...
func (o InlineResponse200271Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200271Policies struct {
	value *InlineResponse200271Policies
	isSet bool
}

func (v NullableInlineResponse200271Policies) Get() *InlineResponse200271Policies {
	return v.value
}

func (v *NullableInlineResponse200271Policies) Set(val *InlineResponse200271Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200271Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200271Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200271Policies(val *InlineResponse200271Policies) *NullableInlineResponse200271Policies {
	return &NullableInlineResponse200271Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200271Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200271Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
