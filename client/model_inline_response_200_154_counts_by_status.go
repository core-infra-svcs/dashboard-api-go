...
// InlineResponse200154CountsByStatus byStatus
type InlineResponse200154CountsByStatus struct {
	// online count
...
func NewInlineResponse200154CountsByStatus() *InlineResponse200154CountsByStatus {
	this := InlineResponse200154CountsByStatus{}
	return &this
}
...
func (o InlineResponse200154CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200154CountsByStatus struct {
	value *InlineResponse200154CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200154CountsByStatus) Get() *InlineResponse200154CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200154CountsByStatus) Set(val *InlineResponse200154CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200154CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200154CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200154CountsByStatus(val *InlineResponse200154CountsByStatus) *NullableInlineResponse200154CountsByStatus {
	return &NullableInlineResponse200154CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200154CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200154CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
