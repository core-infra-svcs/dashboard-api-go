...
// InlineResponse200253Uplink Uplink setting of the cluster
type InlineResponse200253Uplink struct {
	// Name of the interface
	Interface *string `json:"interface,omitempty"`
	// VLAN of the interface
	Vlan *int32 `json:"vlan,omitempty"`
	// Addresses of the interface
	Addresses []InlineResponse200253UplinkAddresses `json:"addresses,omitempty"`
}
...
func NewInlineResponse200253Uplink() *InlineResponse200253Uplink {
	this := InlineResponse200253Uplink{}
	return &this
}
...
func (o *InlineResponse200253Uplink) GetAddresses() []InlineResponse200253UplinkAddresses {
	if o == nil || isNil(o.Addresses) {
		var ret []InlineResponse200253UplinkAddresses
		return ret
	}
	return o.Addresses
}
...
// SetAddresses gets a reference to the given []InlineResponse200253UplinkAddresses and assigns it to the Addresses field.
func (o *InlineResponse200253Uplink) SetAddresses(v []InlineResponse200253UplinkAddresses) {
	o.Addresses = v
}

func (o InlineResponse200253Uplink) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200253Uplink struct {
	value *InlineResponse200253Uplink
	isSet bool
}

func (v NullableInlineResponse200253Uplink) Get() *InlineResponse200253Uplink {
	return v.value
}

func (v *NullableInlineResponse200253Uplink) Set(val *InlineResponse200253Uplink) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200253Uplink) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200253Uplink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200253Uplink(val *InlineResponse200253Uplink) *NullableInlineResponse200253Uplink {
	return &NullableInlineResponse200253Uplink{value: val, isSet: true}
}

func (v NullableInlineResponse200253Uplink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200253Uplink) UnmarshalJSON(src []byte) error {
	v.isSet = true
