...
func (r WakeOnLanApiCreateDeviceLiveToolsWakeOnLanRequest) CreateDeviceLiveToolsWakeOnLan(createDeviceLiveToolsWakeOnLan InlineObject20) WakeOnLanApiCreateDeviceLiveToolsWakeOnLanRequest {
	r.createDeviceLiveToolsWakeOnLan = &createDeviceLiveToolsWakeOnLan
	return r
}

func (r WakeOnLanApiCreateDeviceLiveToolsWakeOnLanRequest) Execute() (*InlineResponse2014, *http.Response, error) {
...
func (a *WakeOnLanApiService) CreateDeviceLiveToolsWakeOnLanExecute(r WakeOnLanApiCreateDeviceLiveToolsWakeOnLanRequest) (*InlineResponse2014, *http.Response, error) {
	var (
...
func (r WakeOnLanApiGetDeviceLiveToolsWakeOnLanRequest) Execute() (*InlineResponse20010, *http.Response, error) {
...
func (a *WakeOnLanApiService) GetDeviceLiveToolsWakeOnLanExecute(r WakeOnLanApiGetDeviceLiveToolsWakeOnLanRequest) (*InlineResponse20010, *http.Response, error) {
	var (
