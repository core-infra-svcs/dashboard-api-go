...
func (r WakeOnLanApiGetDeviceLiveToolsWakeOnLanRequest) Execute() (*InlineResponse20014, *http.Response, error) {
...
func (a *WakeOnLanApiService) GetDeviceLiveToolsWakeOnLanExecute(r WakeOnLanApiGetDeviceLiveToolsWakeOnLanRequest) (*InlineResponse20014, *http.Response, error) {
	var (
