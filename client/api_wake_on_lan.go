...
func (r WakeOnLanApiCreateDeviceLiveToolsWakeOnLanRequest) CreateDeviceLiveToolsWakeOnLan(createDeviceLiveToolsWakeOnLan InlineObject22) WakeOnLanApiCreateDeviceLiveToolsWakeOnLanRequest {
	r.createDeviceLiveToolsWakeOnLan = &createDeviceLiveToolsWakeOnLan
	return r
}

func (r WakeOnLanApiCreateDeviceLiveToolsWakeOnLanRequest) Execute() (*InlineResponse2017, *http.Response, error) {
...
func (a *WakeOnLanApiService) CreateDeviceLiveToolsWakeOnLanExecute(r WakeOnLanApiCreateDeviceLiveToolsWakeOnLanRequest) (*InlineResponse2017, *http.Response, error) {
	var (
...
func (r WakeOnLanApiGetDeviceLiveToolsWakeOnLanRequest) Execute() (*InlineResponse20026, *http.Response, error) {
...
func (a *WakeOnLanApiService) GetDeviceLiveToolsWakeOnLanExecute(r WakeOnLanApiGetDeviceLiveToolsWakeOnLanRequest) (*InlineResponse20026, *http.Response, error) {
	var (
