...
func (r WakeOnLanApiCreateDeviceLiveToolsWakeOnLanRequest) CreateDeviceLiveToolsWakeOnLan(createDeviceLiveToolsWakeOnLan InlineObject23) WakeOnLanApiCreateDeviceLiveToolsWakeOnLanRequest {
	r.createDeviceLiveToolsWakeOnLan = &createDeviceLiveToolsWakeOnLan
	return r
}

func (r WakeOnLanApiCreateDeviceLiveToolsWakeOnLanRequest) Execute() (*InlineResponse2018, *http.Response, error) {
...
func (a *WakeOnLanApiService) CreateDeviceLiveToolsWakeOnLanExecute(r WakeOnLanApiCreateDeviceLiveToolsWakeOnLanRequest) (*InlineResponse2018, *http.Response, error) {
	var (
...
func (r WakeOnLanApiGetDeviceLiveToolsWakeOnLanRequest) Execute() (*InlineResponse20029, *http.Response, error) {
...
func (a *WakeOnLanApiService) GetDeviceLiveToolsWakeOnLanExecute(r WakeOnLanApiGetDeviceLiveToolsWakeOnLanRequest) (*InlineResponse20029, *http.Response, error) {
	var (
