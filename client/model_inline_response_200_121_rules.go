...
// InlineResponse200121Rules struct for InlineResponse200121Rules
type InlineResponse200121Rules struct {
...
func NewInlineResponse200121Rules(definitions []NetworksNetworkIdApplianceTrafficShapingRulesDefinitions) *InlineResponse200121Rules {
	this := InlineResponse200121Rules{}
...
func (o InlineResponse200121Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200121Rules struct {
	value *InlineResponse200121Rules
	isSet bool
}

func (v NullableInlineResponse200121Rules) Get() *InlineResponse200121Rules {
	return v.value
}

func (v *NullableInlineResponse200121Rules) Set(val *InlineResponse200121Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200121Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200121Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200121Rules(val *InlineResponse200121Rules) *NullableInlineResponse200121Rules {
	return &NullableInlineResponse200121Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200121Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200121Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
