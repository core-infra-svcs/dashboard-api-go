...
func (r CurrentApiGetNetworkSensorAlertsCurrentOverviewByMetricRequest) Execute() (*InlineResponse200103, *http.Response, error) {
...
func (a *CurrentApiService) GetNetworkSensorAlertsCurrentOverviewByMetricExecute(r CurrentApiGetNetworkSensorAlertsCurrentOverviewByMetricRequest) (*InlineResponse200103, *http.Response, error) {
	var (
