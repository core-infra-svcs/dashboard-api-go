...
func (r CurrentApiGetNetworkSensorAlertsCurrentOverviewByMetricRequest) Execute() (*InlineResponse200104, *http.Response, error) {
...
func (a *CurrentApiService) GetNetworkSensorAlertsCurrentOverviewByMetricExecute(r CurrentApiGetNetworkSensorAlertsCurrentOverviewByMetricRequest) (*InlineResponse200104, *http.Response, error) {
	var (
