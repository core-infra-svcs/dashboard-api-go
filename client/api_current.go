...
func (r CurrentApiGetNetworkSensorAlertsCurrentOverviewByMetricRequest) Execute() (*InlineResponse200111, *http.Response, error) {
...
func (a *CurrentApiService) GetNetworkSensorAlertsCurrentOverviewByMetricExecute(r CurrentApiGetNetworkSensorAlertsCurrentOverviewByMetricRequest) (*InlineResponse200111, *http.Response, error) {
	var (
