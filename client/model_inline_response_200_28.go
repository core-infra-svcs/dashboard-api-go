...
type InlineResponse20028 struct {
	...
	ClientVpnConnections []InlineResponse20028ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20028) GetClientVpnConnections() []InlineResponse20028ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20028ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20028ClientVpnConnections and assigns it to the ClientVpnConnections field.
