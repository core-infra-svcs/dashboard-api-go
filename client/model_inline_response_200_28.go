...
type InlineResponse20028 struct {
	...
	Hubs []InlineResponse20028Hubs `json:"hubs,omitempty"`
	// The list of subnets and their VPN presence.
	Subnets []InlineResponse20028Subnets `json:"subnets,omitempty"`
}
...
func (o *InlineResponse20028) GetHubs() []InlineResponse20028Hubs {
	if o == nil || isNil(o.Hubs) {
		var ret []InlineResponse20028Hubs
		return ret
	}
	return o.Hubs
}
...
// SetHubs gets a reference to the given []InlineResponse20028Hubs and assigns it to the Hubs field.
...
func (o *InlineResponse20028) GetSubnets() []InlineResponse20028Subnets {
	if o == nil || isNil(o.Subnets) {
		var ret []InlineResponse20028Subnets
		return ret
	}
	return o.Subnets
}
...
// SetSubnets gets a reference to the given []InlineResponse20028Subnets and assigns it to the Subnets field.
