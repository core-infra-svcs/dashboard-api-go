...
type InlineResponse20028 struct {
	...
	Result *InlineResponse2017Result `json:"result,omitempty"`
...
func (o *InlineResponse20028) GetResult() InlineResponse2017Result {
	if o == nil || isNil(o.Result) {
		var ret InlineResponse2017Result
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given InlineResponse2017Result and assigns it to the Result field.
