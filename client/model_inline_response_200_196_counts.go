...
// InlineResponse200196Counts The current amount of various adaptive policy objects.
type InlineResponse200196Counts struct {
...
func NewInlineResponse200196Counts() *InlineResponse200196Counts {
	this := InlineResponse200196Counts{}
	return &this
}
...
func (o InlineResponse200196Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200196Counts struct {
	value *InlineResponse200196Counts
	isSet bool
}

func (v NullableInlineResponse200196Counts) Get() *InlineResponse200196Counts {
	return v.value
}

func (v *NullableInlineResponse200196Counts) Set(val *InlineResponse200196Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200196Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200196Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200196Counts(val *InlineResponse200196Counts) *NullableInlineResponse200196Counts {
	return &NullableInlineResponse200196Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200196Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200196Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
