...
type InlineResponse200370Items struct {
	...
	Readings []InlineResponse200370Readings `json:"readings,omitempty"`
}
...
func (o *InlineResponse200370Items) GetReadings() []InlineResponse200370Readings {
	if o == nil || isNil(o.Readings) {
		var ret []InlineResponse200370Readings
		return ret
	}
	return o.Readings
}
...
// SetReadings gets a reference to the given []InlineResponse200370Readings and assigns it to the Readings field.
