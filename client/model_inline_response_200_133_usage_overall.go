...
// InlineResponse200133UsageOverall Overall data usage of all clients across organization
type InlineResponse200133UsageOverall struct {
...
func NewInlineResponse200133UsageOverall() *InlineResponse200133UsageOverall {
	this := InlineResponse200133UsageOverall{}
	return &this
}
...
func (o InlineResponse200133UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200133UsageOverall struct {
	value *InlineResponse200133UsageOverall
	isSet bool
}

func (v NullableInlineResponse200133UsageOverall) Get() *InlineResponse200133UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200133UsageOverall) Set(val *InlineResponse200133UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200133UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200133UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200133UsageOverall(val *InlineResponse200133UsageOverall) *NullableInlineResponse200133UsageOverall {
	return &NullableInlineResponse200133UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200133UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200133UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
