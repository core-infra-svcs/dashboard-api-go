...
func (r BonjourForwardingApiGetNetworkWirelessSsidBonjourForwardingRequest) Execute() (*InlineResponse200209, *http.Response, error) {
...
func (a *BonjourForwardingApiService) GetNetworkWirelessSsidBonjourForwardingExecute(r BonjourForwardingApiGetNetworkWirelessSsidBonjourForwardingRequest) (*InlineResponse200209, *http.Response, error) {
	var (
...
func (r BonjourForwardingApiUpdateNetworkWirelessSsidBonjourForwardingRequest) Execute() (*InlineResponse200209, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200209
func (a *BonjourForwardingApiService) UpdateNetworkWirelessSsidBonjourForwardingExecute(r BonjourForwardingApiUpdateNetworkWirelessSsidBonjourForwardingRequest) (*InlineResponse200209, *http.Response, error) {
	var (
