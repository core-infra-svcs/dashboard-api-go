...
func (r BonjourForwardingApiGetNetworkWirelessSsidBonjourForwardingRequest) Execute() (*InlineResponse200194, *http.Response, error) {
...
func (a *BonjourForwardingApiService) GetNetworkWirelessSsidBonjourForwardingExecute(r BonjourForwardingApiGetNetworkWirelessSsidBonjourForwardingRequest) (*InlineResponse200194, *http.Response, error) {
	var (
...
func (r BonjourForwardingApiUpdateNetworkWirelessSsidBonjourForwardingRequest) Execute() (*InlineResponse200194, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200194
func (a *BonjourForwardingApiService) UpdateNetworkWirelessSsidBonjourForwardingExecute(r BonjourForwardingApiUpdateNetworkWirelessSsidBonjourForwardingRequest) (*InlineResponse200194, *http.Response, error) {
	var (
