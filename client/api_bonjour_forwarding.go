...
func (r BonjourForwardingApiGetNetworkWirelessSsidBonjourForwardingRequest) Execute() (*InlineResponse200202, *http.Response, error) {
...
func (a *BonjourForwardingApiService) GetNetworkWirelessSsidBonjourForwardingExecute(r BonjourForwardingApiGetNetworkWirelessSsidBonjourForwardingRequest) (*InlineResponse200202, *http.Response, error) {
	var (
...
func (r BonjourForwardingApiUpdateNetworkWirelessSsidBonjourForwardingRequest) Execute() (*InlineResponse200202, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200202
func (a *BonjourForwardingApiService) UpdateNetworkWirelessSsidBonjourForwardingExecute(r BonjourForwardingApiUpdateNetworkWirelessSsidBonjourForwardingRequest) (*InlineResponse200202, *http.Response, error) {
	var (
