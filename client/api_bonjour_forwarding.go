...
func (r BonjourForwardingApiGetNetworkWirelessSsidBonjourForwardingRequest) Execute() (*InlineResponse200188, *http.Response, error) {
...
func (a *BonjourForwardingApiService) GetNetworkWirelessSsidBonjourForwardingExecute(r BonjourForwardingApiGetNetworkWirelessSsidBonjourForwardingRequest) (*InlineResponse200188, *http.Response, error) {
	var (
...
func (r BonjourForwardingApiUpdateNetworkWirelessSsidBonjourForwardingRequest) Execute() (*InlineResponse200188, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200188
func (a *BonjourForwardingApiService) UpdateNetworkWirelessSsidBonjourForwardingExecute(r BonjourForwardingApiUpdateNetworkWirelessSsidBonjourForwardingRequest) (*InlineResponse200188, *http.Response, error) {
	var (
