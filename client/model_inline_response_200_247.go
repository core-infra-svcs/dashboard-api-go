...
func (o *InlineResponse200247) GetUpgrade() OrganizationsOrganizationIdFirmwareUpgradesByDeviceUpgrade {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200247) GetUpgradeOk() (*OrganizationsOrganizationIdFirmwareUpgradesByDeviceUpgrade, bool) {
	if o == nil || isNil(o.Upgrade) {
    return nil, false
	}
...
func (o *InlineResponse200247) HasUpgrade() bool {
	if o != nil && !isNil(o.Upgrade) {
		return true
	}
...
func (o *InlineResponse200247) SetUpgrade(v OrganizationsOrganizationIdFirmwareUpgradesByDeviceUpgrade) {
	o.Upgrade = &v
}
