...
// InlineResponse200124Licenses struct for InlineResponse200124Licenses
type InlineResponse200124Licenses struct {
...
func NewInlineResponse200124Licenses() *InlineResponse200124Licenses {
	this := InlineResponse200124Licenses{}
	return &this
}
...
func (o InlineResponse200124Licenses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200124Licenses struct {
	value *InlineResponse200124Licenses
	isSet bool
}

func (v NullableInlineResponse200124Licenses) Get() *InlineResponse200124Licenses {
	return v.value
}

func (v *NullableInlineResponse200124Licenses) Set(val *InlineResponse200124Licenses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200124Licenses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200124Licenses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200124Licenses(val *InlineResponse200124Licenses) *NullableInlineResponse200124Licenses {
	return &NullableInlineResponse200124Licenses{value: val, isSet: true}
}

func (v NullableInlineResponse200124Licenses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200124Licenses) UnmarshalJSON(src []byte) error {
	v.isSet = true
