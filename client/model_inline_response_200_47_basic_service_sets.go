...
// InlineResponse20047BasicServiceSets struct for InlineResponse20047BasicServiceSets
type InlineResponse20047BasicServiceSets struct {
...
func NewInlineResponse20047BasicServiceSets() *InlineResponse20047BasicServiceSets {
	this := InlineResponse20047BasicServiceSets{}
	return &this
}
...
func (o InlineResponse20047BasicServiceSets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20047BasicServiceSets struct {
	value *InlineResponse20047BasicServiceSets
	isSet bool
}

func (v NullableInlineResponse20047BasicServiceSets) Get() *InlineResponse20047BasicServiceSets {
	return v.value
}

func (v *NullableInlineResponse20047BasicServiceSets) Set(val *InlineResponse20047BasicServiceSets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20047BasicServiceSets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20047BasicServiceSets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20047BasicServiceSets(val *InlineResponse20047BasicServiceSets) *NullableInlineResponse20047BasicServiceSets {
	return &NullableInlineResponse20047BasicServiceSets{value: val, isSet: true}
}

func (v NullableInlineResponse20047BasicServiceSets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20047BasicServiceSets) UnmarshalJSON(src []byte) error {
	v.isSet = true
