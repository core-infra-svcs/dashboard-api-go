...
// InlineResponse20079Subnets struct for InlineResponse20079Subnets
type InlineResponse20079Subnets struct {
	// The CIDR notation subnet used within the VPN
	LocalSubnet *string `json:"localSubnet,omitempty"`
	// Indicates the presence of the subnet in the VPN
	UseVpn *bool `json:"useVpn,omitempty"`
	Nat *InlineResponse20079Nat `json:"nat,omitempty"`
}
...
func NewInlineResponse20079Subnets() *InlineResponse20079Subnets {
	this := InlineResponse20079Subnets{}
	return &this
}
...
func (o *InlineResponse20079Subnets) GetNat() InlineResponse20079Nat {
	if o == nil || isNil(o.Nat) {
		var ret InlineResponse20079Nat
		return ret
	}
	return *o.Nat
}
...
// SetNat gets a reference to the given InlineResponse20079Nat and assigns it to the Nat field.
func (o *InlineResponse20079Subnets) SetNat(v InlineResponse20079Nat) {
	o.Nat = &v
}

func (o InlineResponse20079Subnets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20079Subnets struct {
	value *InlineResponse20079Subnets
	isSet bool
}

func (v NullableInlineResponse20079Subnets) Get() *InlineResponse20079Subnets {
	return v.value
}

func (v *NullableInlineResponse20079Subnets) Set(val *InlineResponse20079Subnets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20079Subnets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20079Subnets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20079Subnets(val *InlineResponse20079Subnets) *NullableInlineResponse20079Subnets {
	return &NullableInlineResponse20079Subnets{value: val, isSet: true}
}

func (v NullableInlineResponse20079Subnets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20079Subnets) UnmarshalJSON(src []byte) error {
	v.isSet = true
