...
func (r ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest) CreateOrganizationWirelessLocationScanningReceiver(createOrganizationWirelessLocationScanningReceiver InlineObject298) ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest {
	r.createOrganizationWirelessLocationScanningReceiver = &createOrganizationWirelessLocationScanningReceiver
	return r
}

func (r ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest) Execute() (*InlineResponse200354Items, *http.Response, error) {
...
func (a *ReceiversApiService) CreateOrganizationWirelessLocationScanningReceiverExecute(r ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest) (*InlineResponse200354Items, *http.Response, error) {
	var (
...
func (r ReceiversApiGetOrganizationWirelessLocationScanningReceiversRequest) Execute() (*InlineResponse200354, *http.Response, error) {
...
func (a *ReceiversApiService) GetOrganizationWirelessLocationScanningReceiversExecute(r ReceiversApiGetOrganizationWirelessLocationScanningReceiversRequest) (*InlineResponse200354, *http.Response, error) {
	var (
...
func (r ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest) UpdateOrganizationWirelessLocationScanningReceiver(updateOrganizationWirelessLocationScanningReceiver InlineObject299) ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest {
	r.updateOrganizationWirelessLocationScanningReceiver = &updateOrganizationWirelessLocationScanningReceiver
	return r
}

func (r ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest) Execute() (*InlineResponse200354Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200354Items
func (a *ReceiversApiService) UpdateOrganizationWirelessLocationScanningReceiverExecute(r ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest) (*InlineResponse200354Items, *http.Response, error) {
	var (
