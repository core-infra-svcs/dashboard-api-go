...
func (r ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest) CreateOrganizationWirelessLocationScanningReceiver(createOrganizationWirelessLocationScanningReceiver InlineObject309) ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest {
	r.createOrganizationWirelessLocationScanningReceiver = &createOrganizationWirelessLocationScanningReceiver
	return r
}

func (r ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest) Execute() (*InlineResponse200384Items, *http.Response, error) {
...
func (a *ReceiversApiService) CreateOrganizationWirelessLocationScanningReceiverExecute(r ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest) (*InlineResponse200384Items, *http.Response, error) {
	var (
...
func (r ReceiversApiGetOrganizationWirelessLocationScanningReceiversRequest) Execute() (*InlineResponse200384, *http.Response, error) {
...
func (a *ReceiversApiService) GetOrganizationWirelessLocationScanningReceiversExecute(r ReceiversApiGetOrganizationWirelessLocationScanningReceiversRequest) (*InlineResponse200384, *http.Response, error) {
	var (
...
func (r ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest) UpdateOrganizationWirelessLocationScanningReceiver(updateOrganizationWirelessLocationScanningReceiver InlineObject310) ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest {
	r.updateOrganizationWirelessLocationScanningReceiver = &updateOrganizationWirelessLocationScanningReceiver
	return r
}

func (r ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest) Execute() (*InlineResponse200384Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200384Items
func (a *ReceiversApiService) UpdateOrganizationWirelessLocationScanningReceiverExecute(r ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest) (*InlineResponse200384Items, *http.Response, error) {
	var (
