...
func (r ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest) CreateOrganizationWirelessLocationScanningReceiver(createOrganizationWirelessLocationScanningReceiver InlineObject303) ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest {
	r.createOrganizationWirelessLocationScanningReceiver = &createOrganizationWirelessLocationScanningReceiver
	return r
}

func (r ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest) Execute() (*InlineResponse200368Items, *http.Response, error) {
...
func (a *ReceiversApiService) CreateOrganizationWirelessLocationScanningReceiverExecute(r ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest) (*InlineResponse200368Items, *http.Response, error) {
	var (
...
func (r ReceiversApiGetOrganizationWirelessLocationScanningReceiversRequest) Execute() (*InlineResponse200368, *http.Response, error) {
...
func (a *ReceiversApiService) GetOrganizationWirelessLocationScanningReceiversExecute(r ReceiversApiGetOrganizationWirelessLocationScanningReceiversRequest) (*InlineResponse200368, *http.Response, error) {
	var (
...
func (r ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest) UpdateOrganizationWirelessLocationScanningReceiver(updateOrganizationWirelessLocationScanningReceiver InlineObject304) ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest {
	r.updateOrganizationWirelessLocationScanningReceiver = &updateOrganizationWirelessLocationScanningReceiver
	return r
}

func (r ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest) Execute() (*InlineResponse200368Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200368Items
func (a *ReceiversApiService) UpdateOrganizationWirelessLocationScanningReceiverExecute(r ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest) (*InlineResponse200368Items, *http.Response, error) {
	var (
