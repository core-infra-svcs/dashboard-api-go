...
func (r ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest) CreateOrganizationWirelessLocationScanningReceiver(createOrganizationWirelessLocationScanningReceiver InlineObject304) ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest {
	r.createOrganizationWirelessLocationScanningReceiver = &createOrganizationWirelessLocationScanningReceiver
	return r
}

func (r ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest) Execute() (*InlineResponse200371Items, *http.Response, error) {
...
func (a *ReceiversApiService) CreateOrganizationWirelessLocationScanningReceiverExecute(r ReceiversApiCreateOrganizationWirelessLocationScanningReceiverRequest) (*InlineResponse200371Items, *http.Response, error) {
	var (
...
func (r ReceiversApiGetOrganizationWirelessLocationScanningReceiversRequest) Execute() (*InlineResponse200371, *http.Response, error) {
...
func (a *ReceiversApiService) GetOrganizationWirelessLocationScanningReceiversExecute(r ReceiversApiGetOrganizationWirelessLocationScanningReceiversRequest) (*InlineResponse200371, *http.Response, error) {
	var (
...
func (r ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest) UpdateOrganizationWirelessLocationScanningReceiver(updateOrganizationWirelessLocationScanningReceiver InlineObject305) ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest {
	r.updateOrganizationWirelessLocationScanningReceiver = &updateOrganizationWirelessLocationScanningReceiver
	return r
}

func (r ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest) Execute() (*InlineResponse200371Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200371Items
func (a *ReceiversApiService) UpdateOrganizationWirelessLocationScanningReceiverExecute(r ReceiversApiUpdateOrganizationWirelessLocationScanningReceiverRequest) (*InlineResponse200371Items, *http.Response, error) {
	var (
