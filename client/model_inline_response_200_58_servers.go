...
// InlineResponse20058Servers struct for InlineResponse20058Servers
type InlineResponse20058Servers struct {
...
func NewInlineResponse20058Servers() *InlineResponse20058Servers {
	this := InlineResponse20058Servers{}
	return &this
}
...
func (o InlineResponse20058Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20058Servers struct {
	value *InlineResponse20058Servers
	isSet bool
}

func (v NullableInlineResponse20058Servers) Get() *InlineResponse20058Servers {
	return v.value
}

func (v *NullableInlineResponse20058Servers) Set(val *InlineResponse20058Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20058Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20058Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20058Servers(val *InlineResponse20058Servers) *NullableInlineResponse20058Servers {
	return &NullableInlineResponse20058Servers{value: val, isSet: true}
}

func (v NullableInlineResponse20058Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20058Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
