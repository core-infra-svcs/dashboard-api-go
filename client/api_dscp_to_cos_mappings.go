...
func (r DscpToCosMappingsApiGetNetworkSwitchDscpToCosMappingsRequest) Execute() (*InlineResponse20083, *http.Response, error) {
...
func (a *DscpToCosMappingsApiService) GetNetworkSwitchDscpToCosMappingsExecute(r DscpToCosMappingsApiGetNetworkSwitchDscpToCosMappingsRequest) (*InlineResponse20083, *http.Response, error) {
	var (
