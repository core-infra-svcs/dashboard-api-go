...
func (r DscpToCosMappingsApiGetNetworkSwitchDscpToCosMappingsRequest) Execute() (*InlineResponse20082, *http.Response, error) {
...
func (a *DscpToCosMappingsApiService) GetNetworkSwitchDscpToCosMappingsExecute(r DscpToCosMappingsApiGetNetworkSwitchDscpToCosMappingsRequest) (*InlineResponse20082, *http.Response, error) {
	var (
