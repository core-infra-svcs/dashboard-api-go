...
func (r DscpToCosMappingsApiApiGetNetworkSwitchDscpToCosMappingsRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *DscpToCosMappingsApiService) GetNetworkSwitchDscpToCosMappings(ctx context.Context, networkId string) DscpToCosMappingsApiApiGetNetworkSwitchDscpToCosMappingsRequest {
	return DscpToCosMappingsApiApiGetNetworkSwitchDscpToCosMappingsRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *DscpToCosMappingsApiService) GetNetworkSwitchDscpToCosMappingsExecute(r DscpToCosMappingsApiApiGetNetworkSwitchDscpToCosMappingsRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r DscpToCosMappingsApiApiUpdateNetworkSwitchDscpToCosMappingsRequest) UpdateNetworkSwitchDscpToCosMappings(updateNetworkSwitchDscpToCosMappings InlineObject96) DscpToCosMappingsApiApiUpdateNetworkSwitchDscpToCosMappingsRequest {
	r.updateNetworkSwitchDscpToCosMappings = &updateNetworkSwitchDscpToCosMappings
	return r
}

func (r DscpToCosMappingsApiApiUpdateNetworkSwitchDscpToCosMappingsRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *DscpToCosMappingsApiService) UpdateNetworkSwitchDscpToCosMappings(ctx context.Context, networkId string) DscpToCosMappingsApiApiUpdateNetworkSwitchDscpToCosMappingsRequest {
	return DscpToCosMappingsApiApiUpdateNetworkSwitchDscpToCosMappingsRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *DscpToCosMappingsApiService) UpdateNetworkSwitchDscpToCosMappingsExecute(r DscpToCosMappingsApiApiUpdateNetworkSwitchDscpToCosMappingsRequest) (map[string]interface{}, *http.Response, error) {
	var (
