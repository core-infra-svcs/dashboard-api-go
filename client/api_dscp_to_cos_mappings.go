...
func (r DscpToCosMappingsApiGetNetworkSwitchDscpToCosMappingsRequest) Execute() (*InlineResponse20076, *http.Response, error) {
...
func (a *DscpToCosMappingsApiService) GetNetworkSwitchDscpToCosMappingsExecute(r DscpToCosMappingsApiGetNetworkSwitchDscpToCosMappingsRequest) (*InlineResponse20076, *http.Response, error) {
	var (
