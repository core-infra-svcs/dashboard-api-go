...
func (o *InlineObject109) GetDevices() []NetworksNetworkIdFloorPlansAutoLocateJobsJobIdPublishDevices {
...
func (o *InlineObject109) GetDevicesOk() ([]NetworksNetworkIdFloorPlansAutoLocateJobsJobIdPublishDevices, bool) {
	if o == nil || isNil(o.Devices) {
    return nil, false
	}
...
func (o *InlineObject109) SetDevices(v []NetworksNetworkIdFloorPlansAutoLocateJobsJobIdPublishDevices) {
	o.Devices = v
}
