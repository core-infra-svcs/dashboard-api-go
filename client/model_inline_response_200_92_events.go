...
// InlineResponse20092Events struct for InlineResponse20092Events
type InlineResponse20092Events struct {
	...
	EventData *InlineResponse20092EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20092Events() *InlineResponse20092Events {
	this := InlineResponse20092Events{}
	return &this
}
...
func (o *InlineResponse20092Events) GetEventData() InlineResponse20092EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20092EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20092EventData and assigns it to the EventData field.
func (o *InlineResponse20092Events) SetEventData(v InlineResponse20092EventData) {
	o.EventData = &v
}

func (o InlineResponse20092Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20092Events struct {
	value *InlineResponse20092Events
	isSet bool
}

func (v NullableInlineResponse20092Events) Get() *InlineResponse20092Events {
	return v.value
}

func (v *NullableInlineResponse20092Events) Set(val *InlineResponse20092Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20092Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20092Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20092Events(val *InlineResponse20092Events) *NullableInlineResponse20092Events {
	return &NullableInlineResponse20092Events{value: val, isSet: true}
}

func (v NullableInlineResponse20092Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20092Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
