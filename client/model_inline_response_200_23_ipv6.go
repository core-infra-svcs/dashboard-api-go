...
// InlineResponse20023Ipv6 IPv6 configuration on the single LAN
type InlineResponse20023Ipv6 struct {
	// Enable IPv6 on single LAN
	Enabled *bool `json:"enabled,omitempty"`
	// Prefix assignments on the single LAN
	PrefixAssignments []InlineResponse20023Ipv6PrefixAssignments `json:"prefixAssignments,omitempty"`
}
...
func (o *InlineResponse20023Ipv6) GetPrefixAssignments() []InlineResponse20023Ipv6PrefixAssignments {
	if o == nil || isNil(o.PrefixAssignments) {
		var ret []InlineResponse20023Ipv6PrefixAssignments
		return ret
	}
...
// SetPrefixAssignments gets a reference to the given []InlineResponse20023Ipv6PrefixAssignments and assigns it to the PrefixAssignments field.
func (o *InlineResponse20023Ipv6) SetPrefixAssignments(v []InlineResponse20023Ipv6PrefixAssignments) {
	o.PrefixAssignments = v
}

func (o InlineResponse20023Ipv6) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20023Ipv6 struct {
	value *InlineResponse20023Ipv6
	isSet bool
}

func (v NullableInlineResponse20023Ipv6) Get() *InlineResponse20023Ipv6 {
	return v.value
}

func (v *NullableInlineResponse20023Ipv6) Set(val *InlineResponse20023Ipv6) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20023Ipv6) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20023Ipv6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20023Ipv6(val *InlineResponse20023Ipv6) *NullableInlineResponse20023Ipv6 {
	return &NullableInlineResponse20023Ipv6{value: val, isSet: true}
}

func (v NullableInlineResponse20023Ipv6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20023Ipv6) UnmarshalJSON(src []byte) error {
	v.isSet = true
