...
// InlineResponse20040ReservedIpRanges struct for InlineResponse20040ReservedIpRanges
type InlineResponse20040ReservedIpRanges struct {
...
func NewInlineResponse20040ReservedIpRanges() *InlineResponse20040ReservedIpRanges {
	this := InlineResponse20040ReservedIpRanges{}
	return &this
}
...
func (o InlineResponse20040ReservedIpRanges) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20040ReservedIpRanges struct {
	value *InlineResponse20040ReservedIpRanges
	isSet bool
}

func (v NullableInlineResponse20040ReservedIpRanges) Get() *InlineResponse20040ReservedIpRanges {
	return v.value
}

func (v *NullableInlineResponse20040ReservedIpRanges) Set(val *InlineResponse20040ReservedIpRanges) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20040ReservedIpRanges) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20040ReservedIpRanges) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20040ReservedIpRanges(val *InlineResponse20040ReservedIpRanges) *NullableInlineResponse20040ReservedIpRanges {
	return &NullableInlineResponse20040ReservedIpRanges{value: val, isSet: true}
}

func (v NullableInlineResponse20040ReservedIpRanges) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20040ReservedIpRanges) UnmarshalJSON(src []byte) error {
	v.isSet = true
