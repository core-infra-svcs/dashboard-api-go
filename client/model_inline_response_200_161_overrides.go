...
// InlineResponse200161Overrides struct for InlineResponse200161Overrides
type InlineResponse200161Overrides struct {
...
func NewInlineResponse200161Overrides() *InlineResponse200161Overrides {
	this := InlineResponse200161Overrides{}
	return &this
}
...
func (o InlineResponse200161Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200161Overrides struct {
	value *InlineResponse200161Overrides
	isSet bool
}

func (v NullableInlineResponse200161Overrides) Get() *InlineResponse200161Overrides {
	return v.value
}

func (v *NullableInlineResponse200161Overrides) Set(val *InlineResponse200161Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200161Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200161Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200161Overrides(val *InlineResponse200161Overrides) *NullableInlineResponse200161Overrides {
	return &NullableInlineResponse200161Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse200161Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200161Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
