...
// InlineResponse200165V3 OSPF v3 configuration
type InlineResponse200165V3 struct {
...
func (o InlineResponse200165V3) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200165V3 struct {
	value *InlineResponse200165V3
	isSet bool
}

func (v NullableInlineResponse200165V3) Get() *InlineResponse200165V3 {
	return v.value
}

func (v *NullableInlineResponse200165V3) Set(val *InlineResponse200165V3) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200165V3) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200165V3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200165V3(val *InlineResponse200165V3) *NullableInlineResponse200165V3 {
	return &NullableInlineResponse200165V3{value: val, isSet: true}
}

func (v NullableInlineResponse200165V3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200165V3) UnmarshalJSON(src []byte) error {
	v.isSet = true
