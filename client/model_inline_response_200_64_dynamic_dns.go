...
// InlineResponse20064DynamicDns Dynamic DNS settings for a network
type InlineResponse20064DynamicDns struct {
	// Dynamic DNS enabled
...
func NewInlineResponse20064DynamicDns() *InlineResponse20064DynamicDns {
	this := InlineResponse20064DynamicDns{}
	return &this
}
...
func (o InlineResponse20064DynamicDns) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20064DynamicDns struct {
	value *InlineResponse20064DynamicDns
	isSet bool
}

func (v NullableInlineResponse20064DynamicDns) Get() *InlineResponse20064DynamicDns {
	return v.value
}

func (v *NullableInlineResponse20064DynamicDns) Set(val *InlineResponse20064DynamicDns) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20064DynamicDns) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20064DynamicDns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20064DynamicDns(val *InlineResponse20064DynamicDns) *NullableInlineResponse20064DynamicDns {
	return &NullableInlineResponse20064DynamicDns{value: val, isSet: true}
}

func (v NullableInlineResponse20064DynamicDns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20064DynamicDns) UnmarshalJSON(src []byte) error {
	v.isSet = true
