...
// InlineResponse200105SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200105SixGhzSettings struct {
...
func NewInlineResponse200105SixGhzSettings() *InlineResponse200105SixGhzSettings {
	this := InlineResponse200105SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200105SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200105SixGhzSettings struct {
	value *InlineResponse200105SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200105SixGhzSettings) Get() *InlineResponse200105SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200105SixGhzSettings) Set(val *InlineResponse200105SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200105SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200105SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200105SixGhzSettings(val *InlineResponse200105SixGhzSettings) *NullableInlineResponse200105SixGhzSettings {
	return &NullableInlineResponse200105SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200105SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200105SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
