...
// InlineResponse200141Switches struct for InlineResponse200141Switches
type InlineResponse200141Switches struct {
...
func NewInlineResponse200141Switches() *InlineResponse200141Switches {
	this := InlineResponse200141Switches{}
	return &this
}
...
func (o InlineResponse200141Switches) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200141Switches struct {
	value *InlineResponse200141Switches
	isSet bool
}

func (v NullableInlineResponse200141Switches) Get() *InlineResponse200141Switches {
	return v.value
}

func (v *NullableInlineResponse200141Switches) Set(val *InlineResponse200141Switches) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200141Switches) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200141Switches) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200141Switches(val *InlineResponse200141Switches) *NullableInlineResponse200141Switches {
	return &NullableInlineResponse200141Switches{value: val, isSet: true}
}

func (v NullableInlineResponse200141Switches) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200141Switches) UnmarshalJSON(src []byte) error {
	v.isSet = true
