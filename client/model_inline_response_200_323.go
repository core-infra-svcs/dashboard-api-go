...
func (o *InlineResponse200323) GetNetwork() OrganizationsOrganizationIdWirelessDevicesEthernetStatusesNetwork {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200323) GetNetworkOk() (*OrganizationsOrganizationIdWirelessDevicesEthernetStatusesNetwork, bool) {
	if o == nil || isNil(o.Network) {
    return nil, false
	}
...
func (o *InlineResponse200323) SetNetwork(v OrganizationsOrganizationIdWirelessDevicesEthernetStatusesNetwork) {
	o.Network = &v
}

// GetPower returns the Power field value if set, zero value otherwise.
func (o *InlineResponse200323) GetPower() OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPower {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200323) GetPowerOk() (*OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPower, bool) {
	if o == nil || isNil(o.Power) {
    return nil, false
	}
	return o.Power, true
...
func (o *InlineResponse200323) HasPower() bool {
	if o != nil && !isNil(o.Power) {
		return true
	}
...
func (o *InlineResponse200323) SetPower(v OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPower) {
	o.Power = &v
}

// GetPorts returns the Ports field value if set, zero value otherwise.
func (o *InlineResponse200323) GetPorts() []OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPorts {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200323) GetPortsOk() ([]OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPorts, bool) {
	if o == nil || isNil(o.Ports) {
    return nil, false
	}
	return o.Ports, true
...
func (o *InlineResponse200323) SetPorts(v []OrganizationsOrganizationIdWirelessDevicesEthernetStatusesPorts) {
	o.Ports = v
}

// GetAggregation returns the Aggregation field value if set, zero value otherwise.
func (o *InlineResponse200323) GetAggregation() OrganizationsOrganizationIdWirelessDevicesEthernetStatusesAggregation {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200323) GetAggregationOk() (*OrganizationsOrganizationIdWirelessDevicesEthernetStatusesAggregation, bool) {
	if o == nil || isNil(o.Aggregation) {
    return nil, false
	}
...
func (o *InlineResponse200323) HasAggregation() bool {
	if o != nil && !isNil(o.Aggregation) {
		return true
	}
...
func (o *InlineResponse200323) SetAggregation(v OrganizationsOrganizationIdWirelessDevicesEthernetStatusesAggregation) {
	o.Aggregation = &v
}
