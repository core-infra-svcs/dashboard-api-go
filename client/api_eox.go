...
func (r EoxApiGetOrganizationInventoryDevicesEoxOverviewRequest) Execute() (*InlineResponse200310, *http.Response, error) {
...
func (a *EoxApiService) GetOrganizationInventoryDevicesEoxOverviewExecute(r EoxApiGetOrganizationInventoryDevicesEoxOverviewRequest) (*InlineResponse200310, *http.Response, error) {
	var (
