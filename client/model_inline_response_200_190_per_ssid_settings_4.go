...
// InlineResponse200190PerSsidSettings4 Settings for SSID 4
type InlineResponse200190PerSsidSettings4 struct {
	// Name of SSID
...
func NewInlineResponse200190PerSsidSettings4() *InlineResponse200190PerSsidSettings4 {
	this := InlineResponse200190PerSsidSettings4{}
	return &this
}
...
func (o InlineResponse200190PerSsidSettings4) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200190PerSsidSettings4 struct {
	value *InlineResponse200190PerSsidSettings4
	isSet bool
}

func (v NullableInlineResponse200190PerSsidSettings4) Get() *InlineResponse200190PerSsidSettings4 {
	return v.value
}

func (v *NullableInlineResponse200190PerSsidSettings4) Set(val *InlineResponse200190PerSsidSettings4) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200190PerSsidSettings4) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200190PerSsidSettings4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200190PerSsidSettings4(val *InlineResponse200190PerSsidSettings4) *NullableInlineResponse200190PerSsidSettings4 {
	return &NullableInlineResponse200190PerSsidSettings4{value: val, isSet: true}
}

func (v NullableInlineResponse200190PerSsidSettings4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200190PerSsidSettings4) UnmarshalJSON(src []byte) error {
	v.isSet = true
