...
func (r MulticastRoutingApiGetDeviceLiveToolsMulticastRoutingRequest) Execute() (*InlineResponse20031, *http.Response, error) {
...
func (a *MulticastRoutingApiService) GetDeviceLiveToolsMulticastRoutingExecute(r MulticastRoutingApiGetDeviceLiveToolsMulticastRoutingRequest) (*InlineResponse20031, *http.Response, error) {
	var (
