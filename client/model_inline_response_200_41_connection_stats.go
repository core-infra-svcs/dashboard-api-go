...
// InlineResponse20041ConnectionStats The connection stats of the device
type InlineResponse20041ConnectionStats struct {
...
func NewInlineResponse20041ConnectionStats() *InlineResponse20041ConnectionStats {
	this := InlineResponse20041ConnectionStats{}
	return &this
}
...
func (o InlineResponse20041ConnectionStats) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20041ConnectionStats struct {
	value *InlineResponse20041ConnectionStats
	isSet bool
}

func (v NullableInlineResponse20041ConnectionStats) Get() *InlineResponse20041ConnectionStats {
	return v.value
}

func (v *NullableInlineResponse20041ConnectionStats) Set(val *InlineResponse20041ConnectionStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20041ConnectionStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20041ConnectionStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20041ConnectionStats(val *InlineResponse20041ConnectionStats) *NullableInlineResponse20041ConnectionStats {
	return &NullableInlineResponse20041ConnectionStats{value: val, isSet: true}
}

func (v NullableInlineResponse20041ConnectionStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20041ConnectionStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
