...
// InlineResponse200387Rate The interface packet rates measured in packets per second
type InlineResponse200387Rate struct {
...
func (o InlineResponse200387Rate) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200387Rate struct {
	value *InlineResponse200387Rate
	isSet bool
}

func (v NullableInlineResponse200387Rate) Get() *InlineResponse200387Rate {
	return v.value
}

func (v *NullableInlineResponse200387Rate) Set(val *InlineResponse200387Rate) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200387Rate) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200387Rate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200387Rate(val *InlineResponse200387Rate) *NullableInlineResponse200387Rate {
	return &NullableInlineResponse200387Rate{value: val, isSet: true}
}

func (v NullableInlineResponse200387Rate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200387Rate) UnmarshalJSON(src []byte) error {
	v.isSet = true
