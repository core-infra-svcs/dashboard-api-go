...
// InlineResponse200298MetaCountsItems Counts relating to the paginated networks
type InlineResponse200298MetaCountsItems struct {
...
func NewInlineResponse200298MetaCountsItems() *InlineResponse200298MetaCountsItems {
	this := InlineResponse200298MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200298MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200298MetaCountsItems struct {
	value *InlineResponse200298MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200298MetaCountsItems) Get() *InlineResponse200298MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200298MetaCountsItems) Set(val *InlineResponse200298MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200298MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200298MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200298MetaCountsItems(val *InlineResponse200298MetaCountsItems) *NullableInlineResponse200298MetaCountsItems {
	return &NullableInlineResponse200298MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200298MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200298MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
