...
func (r PerformanceHistoryApiGetNetworkSmDevicePerformanceHistoryRequest) Execute() ([]InlineResponse20068, *http.Response, error) {
...
func (a *PerformanceHistoryApiService) GetNetworkSmDevicePerformanceHistoryExecute(r PerformanceHistoryApiGetNetworkSmDevicePerformanceHistoryRequest) ([]InlineResponse20068, *http.Response, error) {
	var (
