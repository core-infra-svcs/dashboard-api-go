...
func (r PerformanceHistoryApiGetNetworkSmDevicePerformanceHistoryRequest) Execute() ([]InlineResponse200131, *http.Response, error) {
...
func (a *PerformanceHistoryApiService) GetNetworkSmDevicePerformanceHistoryExecute(r PerformanceHistoryApiGetNetworkSmDevicePerformanceHistoryRequest) ([]InlineResponse200131, *http.Response, error) {
	var (
