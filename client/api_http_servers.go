...
func (r HttpServersApiCreateNetworkWebhooksHttpServerRequest) CreateNetworkWebhooksHttpServer(createNetworkWebhooksHttpServer InlineObject176) HttpServersApiCreateNetworkWebhooksHttpServerRequest {
	r.createNetworkWebhooksHttpServer = &createNetworkWebhooksHttpServer
	return r
}

func (r HttpServersApiCreateNetworkWebhooksHttpServerRequest) Execute() (*InlineResponse200191, *http.Response, error) {
...
func (a *HttpServersApiService) CreateNetworkWebhooksHttpServerExecute(r HttpServersApiCreateNetworkWebhooksHttpServerRequest) (*InlineResponse200191, *http.Response, error) {
	var (
...
func (r HttpServersApiGetNetworkWebhooksHttpServerRequest) Execute() (*InlineResponse200191, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200191
func (a *HttpServersApiService) GetNetworkWebhooksHttpServerExecute(r HttpServersApiGetNetworkWebhooksHttpServerRequest) (*InlineResponse200191, *http.Response, error) {
	var (
...
func (r HttpServersApiGetNetworkWebhooksHttpServersRequest) Execute() ([]InlineResponse200191, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200191
func (a *HttpServersApiService) GetNetworkWebhooksHttpServersExecute(r HttpServersApiGetNetworkWebhooksHttpServersRequest) ([]InlineResponse200191, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r HttpServersApiUpdateNetworkWebhooksHttpServerRequest) UpdateNetworkWebhooksHttpServer(updateNetworkWebhooksHttpServer InlineObject177) HttpServersApiUpdateNetworkWebhooksHttpServerRequest {
	r.updateNetworkWebhooksHttpServer = &updateNetworkWebhooksHttpServer
	return r
}

func (r HttpServersApiUpdateNetworkWebhooksHttpServerRequest) Execute() (*InlineResponse200191, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200191
func (a *HttpServersApiService) UpdateNetworkWebhooksHttpServerExecute(r HttpServersApiUpdateNetworkWebhooksHttpServerRequest) (*InlineResponse200191, *http.Response, error) {
	var (
