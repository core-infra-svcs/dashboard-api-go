...
func (r HttpServersApiCreateNetworkWebhooksHttpServerRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
func (a *HttpServersApiService) CreateNetworkWebhooksHttpServerExecute(r HttpServersApiCreateNetworkWebhooksHttpServerRequest) (*InlineResponse20093, *http.Response, error) {
	var (
...
func (r HttpServersApiGetNetworkWebhooksHttpServerRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20093
func (a *HttpServersApiService) GetNetworkWebhooksHttpServerExecute(r HttpServersApiGetNetworkWebhooksHttpServerRequest) (*InlineResponse20093, *http.Response, error) {
	var (
...
func (r HttpServersApiGetNetworkWebhooksHttpServersRequest) Execute() ([]InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20093
func (a *HttpServersApiService) GetNetworkWebhooksHttpServersExecute(r HttpServersApiGetNetworkWebhooksHttpServersRequest) ([]InlineResponse20093, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r HttpServersApiUpdateNetworkWebhooksHttpServerRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20093
func (a *HttpServersApiService) UpdateNetworkWebhooksHttpServerExecute(r HttpServersApiUpdateNetworkWebhooksHttpServerRequest) (*InlineResponse20093, *http.Response, error) {
	var (
