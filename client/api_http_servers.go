...
func (r HttpServersApiCreateNetworkWebhooksHttpServerRequest) Execute() (*InlineResponse200177, *http.Response, error) {
...
func (a *HttpServersApiService) CreateNetworkWebhooksHttpServerExecute(r HttpServersApiCreateNetworkWebhooksHttpServerRequest) (*InlineResponse200177, *http.Response, error) {
	var (
...
func (r HttpServersApiGetNetworkWebhooksHttpServerRequest) Execute() (*InlineResponse200177, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200177
func (a *HttpServersApiService) GetNetworkWebhooksHttpServerExecute(r HttpServersApiGetNetworkWebhooksHttpServerRequest) (*InlineResponse200177, *http.Response, error) {
	var (
...
func (r HttpServersApiGetNetworkWebhooksHttpServersRequest) Execute() ([]InlineResponse200177, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200177
func (a *HttpServersApiService) GetNetworkWebhooksHttpServersExecute(r HttpServersApiGetNetworkWebhooksHttpServersRequest) ([]InlineResponse200177, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r HttpServersApiUpdateNetworkWebhooksHttpServerRequest) Execute() (*InlineResponse200177, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200177
func (a *HttpServersApiService) UpdateNetworkWebhooksHttpServerExecute(r HttpServersApiUpdateNetworkWebhooksHttpServerRequest) (*InlineResponse200177, *http.Response, error) {
	var (
