...
func (r HttpServersApiCreateNetworkWebhooksHttpServerRequest) CreateNetworkWebhooksHttpServer(createNetworkWebhooksHttpServer InlineObject141) HttpServersApiCreateNetworkWebhooksHttpServerRequest {
	r.createNetworkWebhooksHttpServer = &createNetworkWebhooksHttpServer
	return r
}

func (r HttpServersApiCreateNetworkWebhooksHttpServerRequest) Execute() (*InlineResponse20062, *http.Response, error) {
...
func (a *HttpServersApiService) CreateNetworkWebhooksHttpServerExecute(r HttpServersApiCreateNetworkWebhooksHttpServerRequest) (*InlineResponse20062, *http.Response, error) {
	var (
...
func (r HttpServersApiGetNetworkWebhooksHttpServerRequest) Execute() (*InlineResponse20062, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20062
func (a *HttpServersApiService) GetNetworkWebhooksHttpServerExecute(r HttpServersApiGetNetworkWebhooksHttpServerRequest) (*InlineResponse20062, *http.Response, error) {
	var (
...
func (r HttpServersApiGetNetworkWebhooksHttpServersRequest) Execute() ([]InlineResponse20062, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20062
func (a *HttpServersApiService) GetNetworkWebhooksHttpServersExecute(r HttpServersApiGetNetworkWebhooksHttpServersRequest) ([]InlineResponse20062, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r HttpServersApiUpdateNetworkWebhooksHttpServerRequest) UpdateNetworkWebhooksHttpServer(updateNetworkWebhooksHttpServer InlineObject142) HttpServersApiUpdateNetworkWebhooksHttpServerRequest {
	r.updateNetworkWebhooksHttpServer = &updateNetworkWebhooksHttpServer
	return r
}

func (r HttpServersApiUpdateNetworkWebhooksHttpServerRequest) Execute() (*InlineResponse20062, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20062
func (a *HttpServersApiService) UpdateNetworkWebhooksHttpServerExecute(r HttpServersApiUpdateNetworkWebhooksHttpServerRequest) (*InlineResponse20062, *http.Response, error) {
	var (
