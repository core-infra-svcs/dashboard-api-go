...
// InlineResponse20031DdnsHostnames Dynamic DNS hostnames.
type InlineResponse20031DdnsHostnames struct {
...
func NewInlineResponse20031DdnsHostnames() *InlineResponse20031DdnsHostnames {
	this := InlineResponse20031DdnsHostnames{}
	return &this
}
...
func (o InlineResponse20031DdnsHostnames) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20031DdnsHostnames struct {
	value *InlineResponse20031DdnsHostnames
	isSet bool
}

func (v NullableInlineResponse20031DdnsHostnames) Get() *InlineResponse20031DdnsHostnames {
	return v.value
}

func (v *NullableInlineResponse20031DdnsHostnames) Set(val *InlineResponse20031DdnsHostnames) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20031DdnsHostnames) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20031DdnsHostnames) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20031DdnsHostnames(val *InlineResponse20031DdnsHostnames) *NullableInlineResponse20031DdnsHostnames {
	return &NullableInlineResponse20031DdnsHostnames{value: val, isSet: true}
}

func (v NullableInlineResponse20031DdnsHostnames) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20031DdnsHostnames) UnmarshalJSON(src []byte) error {
	v.isSet = true
