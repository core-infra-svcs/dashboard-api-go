...
// InlineResponse20073Neighbors struct for InlineResponse20073Neighbors
type InlineResponse20073Neighbors struct {
	// The IPv4 address of the neighbor
	Ip *string `json:"ip,omitempty"`
	Ipv6 *InlineResponse20073Ipv6 `json:"ipv6,omitempty"`
	...
	TtlSecurity *InlineResponse20073TtlSecurity `json:"ttlSecurity,omitempty"`
	Authentication *InlineResponse20073Authentication `json:"authentication,omitempty"`
}
...
func NewInlineResponse20073Neighbors() *InlineResponse20073Neighbors {
	this := InlineResponse20073Neighbors{}
	return &this
}
...
func (o *InlineResponse20073Neighbors) GetIpv6() InlineResponse20073Ipv6 {
	if o == nil || isNil(o.Ipv6) {
		var ret InlineResponse20073Ipv6
		return ret
	}
	return *o.Ipv6
}
...
// SetIpv6 gets a reference to the given InlineResponse20073Ipv6 and assigns it to the Ipv6 field.
...
func (o *InlineResponse20073Neighbors) GetTtlSecurity() InlineResponse20073TtlSecurity {
	if o == nil || isNil(o.TtlSecurity) {
		var ret InlineResponse20073TtlSecurity
		return ret
	}
...
// SetTtlSecurity gets a reference to the given InlineResponse20073TtlSecurity and assigns it to the TtlSecurity field.
...
func (o *InlineResponse20073Neighbors) GetAuthentication() InlineResponse20073Authentication {
	if o == nil || isNil(o.Authentication) {
		var ret InlineResponse20073Authentication
		return ret
	}
...
// SetAuthentication gets a reference to the given InlineResponse20073Authentication and assigns it to the Authentication field.
func (o *InlineResponse20073Neighbors) SetAuthentication(v InlineResponse20073Authentication) {
	o.Authentication = &v
}

func (o InlineResponse20073Neighbors) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20073Neighbors struct {
	value *InlineResponse20073Neighbors
	isSet bool
}

func (v NullableInlineResponse20073Neighbors) Get() *InlineResponse20073Neighbors {
	return v.value
}

func (v *NullableInlineResponse20073Neighbors) Set(val *InlineResponse20073Neighbors) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20073Neighbors) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20073Neighbors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20073Neighbors(val *InlineResponse20073Neighbors) *NullableInlineResponse20073Neighbors {
	return &NullableInlineResponse20073Neighbors{value: val, isSet: true}
}

func (v NullableInlineResponse20073Neighbors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20073Neighbors) UnmarshalJSON(src []byte) error {
	v.isSet = true
