...
// InlineResponse200368Changes struct for InlineResponse200368Changes
type InlineResponse200368Changes struct {
...
func NewInlineResponse200368Changes() *InlineResponse200368Changes {
	this := InlineResponse200368Changes{}
	return &this
}
...
func (o InlineResponse200368Changes) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200368Changes struct {
	value *InlineResponse200368Changes
	isSet bool
}

func (v NullableInlineResponse200368Changes) Get() *InlineResponse200368Changes {
	return v.value
}

func (v *NullableInlineResponse200368Changes) Set(val *InlineResponse200368Changes) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200368Changes) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200368Changes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200368Changes(val *InlineResponse200368Changes) *NullableInlineResponse200368Changes {
	return &NullableInlineResponse200368Changes{value: val, isSet: true}
}

func (v NullableInlineResponse200368Changes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200368Changes) UnmarshalJSON(src []byte) error {
	v.isSet = true
