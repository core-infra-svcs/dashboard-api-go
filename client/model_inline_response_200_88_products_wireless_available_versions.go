...
// InlineResponse20088ProductsWirelessAvailableVersions struct for InlineResponse20088ProductsWirelessAvailableVersions
type InlineResponse20088ProductsWirelessAvailableVersions struct {
...
func NewInlineResponse20088ProductsWirelessAvailableVersions() *InlineResponse20088ProductsWirelessAvailableVersions {
	this := InlineResponse20088ProductsWirelessAvailableVersions{}
	return &this
}
...
func (o InlineResponse20088ProductsWirelessAvailableVersions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20088ProductsWirelessAvailableVersions struct {
	value *InlineResponse20088ProductsWirelessAvailableVersions
	isSet bool
}

func (v NullableInlineResponse20088ProductsWirelessAvailableVersions) Get() *InlineResponse20088ProductsWirelessAvailableVersions {
	return v.value
}

func (v *NullableInlineResponse20088ProductsWirelessAvailableVersions) Set(val *InlineResponse20088ProductsWirelessAvailableVersions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20088ProductsWirelessAvailableVersions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20088ProductsWirelessAvailableVersions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20088ProductsWirelessAvailableVersions(val *InlineResponse20088ProductsWirelessAvailableVersions) *NullableInlineResponse20088ProductsWirelessAvailableVersions {
	return &NullableInlineResponse20088ProductsWirelessAvailableVersions{value: val, isSet: true}
}

func (v NullableInlineResponse20088ProductsWirelessAvailableVersions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20088ProductsWirelessAvailableVersions) UnmarshalJSON(src []byte) error {
	v.isSet = true
