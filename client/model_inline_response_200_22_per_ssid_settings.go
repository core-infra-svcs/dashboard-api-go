...
// InlineResponse20022PerSsidSettings Per-SSID radio settings by number.
type InlineResponse20022PerSsidSettings struct {
	Var1 *InlineResponse20022PerSsidSettings1 `json:"1,omitempty"`
	Var2 *InlineResponse20022PerSsidSettings2 `json:"2,omitempty"`
	Var3 *InlineResponse20022PerSsidSettings3 `json:"3,omitempty"`
	Var4 *InlineResponse20022PerSsidSettings4 `json:"4,omitempty"`
}
...
func NewInlineResponse20022PerSsidSettings() *InlineResponse20022PerSsidSettings {
	this := InlineResponse20022PerSsidSettings{}
	return &this
}
...
func (o *InlineResponse20022PerSsidSettings) GetVar1() InlineResponse20022PerSsidSettings1 {
	if o == nil || isNil(o.Var1) {
		var ret InlineResponse20022PerSsidSettings1
		return ret
	}
	return *o.Var1
}
...
// SetVar1 gets a reference to the given InlineResponse20022PerSsidSettings1 and assigns it to the Var1 field.
...
func (o *InlineResponse20022PerSsidSettings) GetVar2() InlineResponse20022PerSsidSettings2 {
	if o == nil || isNil(o.Var2) {
		var ret InlineResponse20022PerSsidSettings2
		return ret
	}
	return *o.Var2
}
...
// SetVar2 gets a reference to the given InlineResponse20022PerSsidSettings2 and assigns it to the Var2 field.
...
func (o *InlineResponse20022PerSsidSettings) GetVar3() InlineResponse20022PerSsidSettings3 {
	if o == nil || isNil(o.Var3) {
		var ret InlineResponse20022PerSsidSettings3
		return ret
	}
	return *o.Var3
}
...
// SetVar3 gets a reference to the given InlineResponse20022PerSsidSettings3 and assigns it to the Var3 field.
...
func (o *InlineResponse20022PerSsidSettings) GetVar4() InlineResponse20022PerSsidSettings4 {
	if o == nil || isNil(o.Var4) {
		var ret InlineResponse20022PerSsidSettings4
		return ret
	}
	return *o.Var4
}
...
// SetVar4 gets a reference to the given InlineResponse20022PerSsidSettings4 and assigns it to the Var4 field.
func (o *InlineResponse20022PerSsidSettings) SetVar4(v InlineResponse20022PerSsidSettings4) {
	o.Var4 = &v
}

func (o InlineResponse20022PerSsidSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20022PerSsidSettings struct {
	value *InlineResponse20022PerSsidSettings
	isSet bool
}

func (v NullableInlineResponse20022PerSsidSettings) Get() *InlineResponse20022PerSsidSettings {
	return v.value
}

func (v *NullableInlineResponse20022PerSsidSettings) Set(val *InlineResponse20022PerSsidSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20022PerSsidSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20022PerSsidSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20022PerSsidSettings(val *InlineResponse20022PerSsidSettings) *NullableInlineResponse20022PerSsidSettings {
	return &NullableInlineResponse20022PerSsidSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20022PerSsidSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20022PerSsidSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
