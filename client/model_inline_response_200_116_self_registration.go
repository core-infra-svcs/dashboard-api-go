...
// InlineResponse200116SelfRegistration Self-registration for splash with Meraki authentication.
type InlineResponse200116SelfRegistration struct {
...
func NewInlineResponse200116SelfRegistration() *InlineResponse200116SelfRegistration {
	this := InlineResponse200116SelfRegistration{}
	return &this
}
...
func (o InlineResponse200116SelfRegistration) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200116SelfRegistration struct {
	value *InlineResponse200116SelfRegistration
	isSet bool
}

func (v NullableInlineResponse200116SelfRegistration) Get() *InlineResponse200116SelfRegistration {
	return v.value
}

func (v *NullableInlineResponse200116SelfRegistration) Set(val *InlineResponse200116SelfRegistration) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200116SelfRegistration) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200116SelfRegistration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200116SelfRegistration(val *InlineResponse200116SelfRegistration) *NullableInlineResponse200116SelfRegistration {
	return &NullableInlineResponse200116SelfRegistration{value: val, isSet: true}
}

func (v NullableInlineResponse200116SelfRegistration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200116SelfRegistration) UnmarshalJSON(src []byte) error {
	v.isSet = true
