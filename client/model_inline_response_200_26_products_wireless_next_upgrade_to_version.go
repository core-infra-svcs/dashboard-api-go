...
// InlineResponse20026ProductsWirelessNextUpgradeToVersion Details of the version the device will upgrade to if it exists
type InlineResponse20026ProductsWirelessNextUpgradeToVersion struct {
...
func NewInlineResponse20026ProductsWirelessNextUpgradeToVersion() *InlineResponse20026ProductsWirelessNextUpgradeToVersion {
	this := InlineResponse20026ProductsWirelessNextUpgradeToVersion{}
	return &this
}
...
func (o InlineResponse20026ProductsWirelessNextUpgradeToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20026ProductsWirelessNextUpgradeToVersion struct {
	value *InlineResponse20026ProductsWirelessNextUpgradeToVersion
	isSet bool
}

func (v NullableInlineResponse20026ProductsWirelessNextUpgradeToVersion) Get() *InlineResponse20026ProductsWirelessNextUpgradeToVersion {
	return v.value
}

func (v *NullableInlineResponse20026ProductsWirelessNextUpgradeToVersion) Set(val *InlineResponse20026ProductsWirelessNextUpgradeToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20026ProductsWirelessNextUpgradeToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20026ProductsWirelessNextUpgradeToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20026ProductsWirelessNextUpgradeToVersion(val *InlineResponse20026ProductsWirelessNextUpgradeToVersion) *NullableInlineResponse20026ProductsWirelessNextUpgradeToVersion {
	return &NullableInlineResponse20026ProductsWirelessNextUpgradeToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20026ProductsWirelessNextUpgradeToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20026ProductsWirelessNextUpgradeToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
