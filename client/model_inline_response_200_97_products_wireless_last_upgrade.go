...
// InlineResponse20097ProductsWirelessLastUpgrade Details of the last firmware upgrade on the device
type InlineResponse20097ProductsWirelessLastUpgrade struct {
	// Timestamp of the last successful firmware upgrade
	Time *time.Time `json:"time,omitempty"`
	FromVersion *InlineResponse20097ProductsWirelessLastUpgradeFromVersion `json:"fromVersion,omitempty"`
	ToVersion *InlineResponse20097ProductsWirelessLastUpgradeToVersion `json:"toVersion,omitempty"`
}
...
func NewInlineResponse20097ProductsWirelessLastUpgrade() *InlineResponse20097ProductsWirelessLastUpgrade {
	this := InlineResponse20097ProductsWirelessLastUpgrade{}
	return &this
}
...
func (o *InlineResponse20097ProductsWirelessLastUpgrade) GetFromVersion() InlineResponse20097ProductsWirelessLastUpgradeFromVersion {
	if o == nil || isNil(o.FromVersion) {
		var ret InlineResponse20097ProductsWirelessLastUpgradeFromVersion
		return ret
	}
...
// SetFromVersion gets a reference to the given InlineResponse20097ProductsWirelessLastUpgradeFromVersion and assigns it to the FromVersion field.
...
func (o *InlineResponse20097ProductsWirelessLastUpgrade) GetToVersion() InlineResponse20097ProductsWirelessLastUpgradeToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20097ProductsWirelessLastUpgradeToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20097ProductsWirelessLastUpgradeToVersion and assigns it to the ToVersion field.
...
func (o InlineResponse20097ProductsWirelessLastUpgrade) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20097ProductsWirelessLastUpgrade struct {
	value *InlineResponse20097ProductsWirelessLastUpgrade
	isSet bool
}

func (v NullableInlineResponse20097ProductsWirelessLastUpgrade) Get() *InlineResponse20097ProductsWirelessLastUpgrade {
	return v.value
}

func (v *NullableInlineResponse20097ProductsWirelessLastUpgrade) Set(val *InlineResponse20097ProductsWirelessLastUpgrade) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20097ProductsWirelessLastUpgrade) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20097ProductsWirelessLastUpgrade) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20097ProductsWirelessLastUpgrade(val *InlineResponse20097ProductsWirelessLastUpgrade) *NullableInlineResponse20097ProductsWirelessLastUpgrade {
	return &NullableInlineResponse20097ProductsWirelessLastUpgrade{value: val, isSet: true}
}

func (v NullableInlineResponse20097ProductsWirelessLastUpgrade) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20097ProductsWirelessLastUpgrade) UnmarshalJSON(src []byte) error {
	v.isSet = true
