...
// InlineResponse20097Reasons struct for InlineResponse20097Reasons
type InlineResponse20097Reasons struct {
...
func NewInlineResponse20097Reasons() *InlineResponse20097Reasons {
	this := InlineResponse20097Reasons{}
	return &this
}
...
func (o InlineResponse20097Reasons) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20097Reasons struct {
	value *InlineResponse20097Reasons
	isSet bool
}

func (v NullableInlineResponse20097Reasons) Get() *InlineResponse20097Reasons {
	return v.value
}

func (v *NullableInlineResponse20097Reasons) Set(val *InlineResponse20097Reasons) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20097Reasons) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20097Reasons) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20097Reasons(val *InlineResponse20097Reasons) *NullableInlineResponse20097Reasons {
	return &NullableInlineResponse20097Reasons{value: val, isSet: true}
}

func (v NullableInlineResponse20097Reasons) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20097Reasons) UnmarshalJSON(src []byte) error {
	v.isSet = true
