...
// InlineResponse200361Webhook The webhook receiver used by the callback to send results
type InlineResponse200361Webhook struct {
	// The webhook receiver URL where the callback will be sent
	Url *string `json:"url,omitempty"`
	HttpServer *InlineResponse200361WebhookHttpServer `json:"httpServer,omitempty"`
	PayloadTemplate *InlineResponse200361WebhookPayloadTemplate `json:"payloadTemplate,omitempty"`
...
func NewInlineResponse200361Webhook() *InlineResponse200361Webhook {
	this := InlineResponse200361Webhook{}
	return &this
}
...
func (o *InlineResponse200361Webhook) GetHttpServer() InlineResponse200361WebhookHttpServer {
	if o == nil || isNil(o.HttpServer) {
		var ret InlineResponse200361WebhookHttpServer
		return ret
	}
	return *o.HttpServer
}
...
// SetHttpServer gets a reference to the given InlineResponse200361WebhookHttpServer and assigns it to the HttpServer field.
...
func (o *InlineResponse200361Webhook) GetPayloadTemplate() InlineResponse200361WebhookPayloadTemplate {
	if o == nil || isNil(o.PayloadTemplate) {
		var ret InlineResponse200361WebhookPayloadTemplate
		return ret
	}
...
// SetPayloadTemplate gets a reference to the given InlineResponse200361WebhookPayloadTemplate and assigns it to the PayloadTemplate field.
...
func (o InlineResponse200361Webhook) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200361Webhook struct {
	value *InlineResponse200361Webhook
	isSet bool
}

func (v NullableInlineResponse200361Webhook) Get() *InlineResponse200361Webhook {
	return v.value
}

func (v *NullableInlineResponse200361Webhook) Set(val *InlineResponse200361Webhook) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200361Webhook) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200361Webhook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200361Webhook(val *InlineResponse200361Webhook) *NullableInlineResponse200361Webhook {
	return &NullableInlineResponse200361Webhook{value: val, isSet: true}
}

func (v NullableInlineResponse200361Webhook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200361Webhook) UnmarshalJSON(src []byte) error {
	v.isSet = true
