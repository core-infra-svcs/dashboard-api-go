...
// InlineResponse20029Lldp lldp information
type InlineResponse20029Lldp struct {
	// Device system name
...
func (o InlineResponse20029Lldp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20029Lldp struct {
	value *InlineResponse20029Lldp
	isSet bool
}

func (v NullableInlineResponse20029Lldp) Get() *InlineResponse20029Lldp {
	return v.value
}

func (v *NullableInlineResponse20029Lldp) Set(val *InlineResponse20029Lldp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20029Lldp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20029Lldp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20029Lldp(val *InlineResponse20029Lldp) *NullableInlineResponse20029Lldp {
	return &NullableInlineResponse20029Lldp{value: val, isSet: true}
}

func (v NullableInlineResponse20029Lldp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20029Lldp) UnmarshalJSON(src []byte) error {
	v.isSet = true
