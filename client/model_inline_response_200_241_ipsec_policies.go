...
// InlineResponse200241IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200241IpsecPolicies struct {
...
func NewInlineResponse200241IpsecPolicies() *InlineResponse200241IpsecPolicies {
	this := InlineResponse200241IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200241IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200241IpsecPolicies struct {
	value *InlineResponse200241IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200241IpsecPolicies) Get() *InlineResponse200241IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200241IpsecPolicies) Set(val *InlineResponse200241IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200241IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200241IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200241IpsecPolicies(val *InlineResponse200241IpsecPolicies) *NullableInlineResponse200241IpsecPolicies {
	return &NullableInlineResponse200241IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200241IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200241IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
