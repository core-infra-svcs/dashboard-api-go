...
// InlineResponse200266ServiceProvider Service Provider information
type InlineResponse200266ServiceProvider struct {
	// Service Provider name
	Name *string `json:"name,omitempty"`
	// Plans currently active on the eSIM
	Plans []InlineResponse200266ServiceProviderPlans `json:"plans,omitempty"`
}
...
func NewInlineResponse200266ServiceProvider() *InlineResponse200266ServiceProvider {
	this := InlineResponse200266ServiceProvider{}
	return &this
}
...
func (o *InlineResponse200266ServiceProvider) GetPlans() []InlineResponse200266ServiceProviderPlans {
	if o == nil || isNil(o.Plans) {
		var ret []InlineResponse200266ServiceProviderPlans
		return ret
	}
	return o.Plans
}
...
// SetPlans gets a reference to the given []InlineResponse200266ServiceProviderPlans and assigns it to the Plans field.
func (o *InlineResponse200266ServiceProvider) SetPlans(v []InlineResponse200266ServiceProviderPlans) {
	o.Plans = v
}

func (o InlineResponse200266ServiceProvider) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200266ServiceProvider struct {
	value *InlineResponse200266ServiceProvider
	isSet bool
}

func (v NullableInlineResponse200266ServiceProvider) Get() *InlineResponse200266ServiceProvider {
	return v.value
}

func (v *NullableInlineResponse200266ServiceProvider) Set(val *InlineResponse200266ServiceProvider) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200266ServiceProvider) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200266ServiceProvider) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200266ServiceProvider(val *InlineResponse200266ServiceProvider) *NullableInlineResponse200266ServiceProvider {
	return &NullableInlineResponse200266ServiceProvider{value: val, isSet: true}
}

func (v NullableInlineResponse200266ServiceProvider) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200266ServiceProvider) UnmarshalJSON(src []byte) error {
	v.isSet = true
