...
// InlineResponse20068Value1Source Source of 'custom' type traffic filter
type InlineResponse20068Value1Source struct {
...
func NewInlineResponse20068Value1Source() *InlineResponse20068Value1Source {
	this := InlineResponse20068Value1Source{}
	return &this
}
...
func (o InlineResponse20068Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20068Value1Source struct {
	value *InlineResponse20068Value1Source
	isSet bool
}

func (v NullableInlineResponse20068Value1Source) Get() *InlineResponse20068Value1Source {
	return v.value
}

func (v *NullableInlineResponse20068Value1Source) Set(val *InlineResponse20068Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20068Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20068Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20068Value1Source(val *InlineResponse20068Value1Source) *NullableInlineResponse20068Value1Source {
	return &NullableInlineResponse20068Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20068Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20068Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
