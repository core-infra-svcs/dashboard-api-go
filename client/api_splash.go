...
func (r SplashApiGetNetworkWirelessSsidSplashSettingsRequest) Execute() (*InlineResponse200101, *http.Response, error) {
...
func (a *SplashApiService) GetNetworkWirelessSsidSplashSettingsExecute(r SplashApiGetNetworkWirelessSsidSplashSettingsRequest) (*InlineResponse200101, *http.Response, error) {
	var (
...
func (r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) Execute() (*InlineResponse200101, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200101
func (a *SplashApiService) UpdateNetworkWirelessSsidSplashSettingsExecute(r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) (*InlineResponse200101, *http.Response, error) {
	var (
