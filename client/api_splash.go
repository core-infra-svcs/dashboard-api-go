...
func (r SplashApiCreateOrganizationSplashThemeRequest) CreateOrganizationSplashTheme(createOrganizationSplashTheme InlineObject266) SplashApiCreateOrganizationSplashThemeRequest {
	r.createOrganizationSplashTheme = &createOrganizationSplashTheme
	return r
}

func (r SplashApiCreateOrganizationSplashThemeRequest) Execute() (*InlineResponse200284, *http.Response, error) {
...
func (a *SplashApiService) CreateOrganizationSplashThemeExecute(r SplashApiCreateOrganizationSplashThemeRequest) (*InlineResponse200284, *http.Response, error) {
	var (
...
func (r SplashApiCreateOrganizationSplashThemeAssetRequest) CreateOrganizationSplashThemeAsset(createOrganizationSplashThemeAsset InlineObject267) SplashApiCreateOrganizationSplashThemeAssetRequest {
	r.createOrganizationSplashThemeAsset = &createOrganizationSplashThemeAsset
	return r
}

func (r SplashApiCreateOrganizationSplashThemeAssetRequest) Execute() (*InlineResponse200283, *http.Response, error) {
...
func (a *SplashApiService) CreateOrganizationSplashThemeAssetExecute(r SplashApiCreateOrganizationSplashThemeAssetRequest) (*InlineResponse200283, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SplashApiGetNetworkWirelessSsidSplashSettingsRequest) Execute() (*InlineResponse200194, *http.Response, error) {
...
func (a *SplashApiService) GetNetworkWirelessSsidSplashSettingsExecute(r SplashApiGetNetworkWirelessSsidSplashSettingsRequest) (*InlineResponse200194, *http.Response, error) {
	var (
...
func (r SplashApiGetOrganizationSplashAssetRequest) Execute() (*InlineResponse200283, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200283
func (a *SplashApiService) GetOrganizationSplashAssetExecute(r SplashApiGetOrganizationSplashAssetRequest) (*InlineResponse200283, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SplashApiGetOrganizationSplashThemesRequest) Execute() ([]InlineResponse200284, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200284
func (a *SplashApiService) GetOrganizationSplashThemesExecute(r SplashApiGetOrganizationSplashThemesRequest) ([]InlineResponse200284, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) Execute() (*InlineResponse200194, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200194
func (a *SplashApiService) UpdateNetworkWirelessSsidSplashSettingsExecute(r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) (*InlineResponse200194, *http.Response, error) {
	var (
