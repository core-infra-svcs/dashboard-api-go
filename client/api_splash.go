...
func (r SplashApiCreateOrganizationSplashThemeRequest) CreateOrganizationSplashTheme(createOrganizationSplashTheme InlineObject298) SplashApiCreateOrganizationSplashThemeRequest {
	r.createOrganizationSplashTheme = &createOrganizationSplashTheme
	return r
}

func (r SplashApiCreateOrganizationSplashThemeRequest) Execute() (*InlineResponse200323, *http.Response, error) {
...
func (a *SplashApiService) CreateOrganizationSplashThemeExecute(r SplashApiCreateOrganizationSplashThemeRequest) (*InlineResponse200323, *http.Response, error) {
	var (
...
func (r SplashApiCreateOrganizationSplashThemeAssetRequest) CreateOrganizationSplashThemeAsset(createOrganizationSplashThemeAsset InlineObject299) SplashApiCreateOrganizationSplashThemeAssetRequest {
	r.createOrganizationSplashThemeAsset = &createOrganizationSplashThemeAsset
	return r
}

func (r SplashApiCreateOrganizationSplashThemeAssetRequest) Execute() (*InlineResponse200322, *http.Response, error) {
...
func (a *SplashApiService) CreateOrganizationSplashThemeAssetExecute(r SplashApiCreateOrganizationSplashThemeAssetRequest) (*InlineResponse200322, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SplashApiGetOrganizationSplashAssetRequest) Execute() (*InlineResponse200322, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200322
func (a *SplashApiService) GetOrganizationSplashAssetExecute(r SplashApiGetOrganizationSplashAssetRequest) (*InlineResponse200322, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SplashApiGetOrganizationSplashThemesRequest) Execute() ([]InlineResponse200323, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200323
func (a *SplashApiService) GetOrganizationSplashThemesExecute(r SplashApiGetOrganizationSplashThemesRequest) ([]InlineResponse200323, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
