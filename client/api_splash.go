...
func (r SplashApiCreateOrganizationSplashThemeRequest) CreateOrganizationSplashTheme(createOrganizationSplashTheme InlineObject259) SplashApiCreateOrganizationSplashThemeRequest {
	r.createOrganizationSplashTheme = &createOrganizationSplashTheme
	return r
}

func (r SplashApiCreateOrganizationSplashThemeRequest) Execute() (*InlineResponse200274, *http.Response, error) {
...
func (a *SplashApiService) CreateOrganizationSplashThemeExecute(r SplashApiCreateOrganizationSplashThemeRequest) (*InlineResponse200274, *http.Response, error) {
	var (
...
func (r SplashApiCreateOrganizationSplashThemeAssetRequest) CreateOrganizationSplashThemeAsset(createOrganizationSplashThemeAsset InlineObject260) SplashApiCreateOrganizationSplashThemeAssetRequest {
	r.createOrganizationSplashThemeAsset = &createOrganizationSplashThemeAsset
	return r
}

func (r SplashApiCreateOrganizationSplashThemeAssetRequest) Execute() (*InlineResponse200273, *http.Response, error) {
...
func (a *SplashApiService) CreateOrganizationSplashThemeAssetExecute(r SplashApiCreateOrganizationSplashThemeAssetRequest) (*InlineResponse200273, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SplashApiGetNetworkWirelessSsidSplashSettingsRequest) Execute() (*InlineResponse200191, *http.Response, error) {
...
func (a *SplashApiService) GetNetworkWirelessSsidSplashSettingsExecute(r SplashApiGetNetworkWirelessSsidSplashSettingsRequest) (*InlineResponse200191, *http.Response, error) {
	var (
...
func (r SplashApiGetOrganizationSplashAssetRequest) Execute() (*InlineResponse200273, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200273
func (a *SplashApiService) GetOrganizationSplashAssetExecute(r SplashApiGetOrganizationSplashAssetRequest) (*InlineResponse200273, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SplashApiGetOrganizationSplashThemesRequest) Execute() ([]InlineResponse200274, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200274
func (a *SplashApiService) GetOrganizationSplashThemesExecute(r SplashApiGetOrganizationSplashThemesRequest) ([]InlineResponse200274, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) UpdateNetworkWirelessSsidSplashSettings(updateNetworkWirelessSsidSplashSettings InlineObject192) SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest {
	r.updateNetworkWirelessSsidSplashSettings = &updateNetworkWirelessSsidSplashSettings
	return r
}

func (r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) Execute() (*InlineResponse200191, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200191
func (a *SplashApiService) UpdateNetworkWirelessSsidSplashSettingsExecute(r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) (*InlineResponse200191, *http.Response, error) {
	var (
