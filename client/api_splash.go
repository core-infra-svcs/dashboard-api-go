...
func (r SplashApiCreateOrganizationSplashThemeRequest) CreateOrganizationSplashTheme(createOrganizationSplashTheme InlineObject285) SplashApiCreateOrganizationSplashThemeRequest {
	r.createOrganizationSplashTheme = &createOrganizationSplashTheme
	return r
}

func (r SplashApiCreateOrganizationSplashThemeRequest) Execute() (*InlineResponse200310, *http.Response, error) {
...
func (a *SplashApiService) CreateOrganizationSplashThemeExecute(r SplashApiCreateOrganizationSplashThemeRequest) (*InlineResponse200310, *http.Response, error) {
	var (
...
func (r SplashApiCreateOrganizationSplashThemeAssetRequest) CreateOrganizationSplashThemeAsset(createOrganizationSplashThemeAsset InlineObject286) SplashApiCreateOrganizationSplashThemeAssetRequest {
	r.createOrganizationSplashThemeAsset = &createOrganizationSplashThemeAsset
	return r
}

func (r SplashApiCreateOrganizationSplashThemeAssetRequest) Execute() (*InlineResponse200309, *http.Response, error) {
...
func (a *SplashApiService) CreateOrganizationSplashThemeAssetExecute(r SplashApiCreateOrganizationSplashThemeAssetRequest) (*InlineResponse200309, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SplashApiGetNetworkWirelessSsidSplashSettingsRequest) Execute() (*InlineResponse200204, *http.Response, error) {
...
func (a *SplashApiService) GetNetworkWirelessSsidSplashSettingsExecute(r SplashApiGetNetworkWirelessSsidSplashSettingsRequest) (*InlineResponse200204, *http.Response, error) {
	var (
...
func (r SplashApiGetOrganizationSplashAssetRequest) Execute() (*InlineResponse200309, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200309
func (a *SplashApiService) GetOrganizationSplashAssetExecute(r SplashApiGetOrganizationSplashAssetRequest) (*InlineResponse200309, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SplashApiGetOrganizationSplashThemesRequest) Execute() ([]InlineResponse200310, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200310
func (a *SplashApiService) GetOrganizationSplashThemesExecute(r SplashApiGetOrganizationSplashThemesRequest) ([]InlineResponse200310, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) UpdateNetworkWirelessSsidSplashSettings(updateNetworkWirelessSsidSplashSettings InlineObject200) SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest {
	r.updateNetworkWirelessSsidSplashSettings = &updateNetworkWirelessSsidSplashSettings
	return r
}

func (r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) Execute() (*InlineResponse200204, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200204
func (a *SplashApiService) UpdateNetworkWirelessSsidSplashSettingsExecute(r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) (*InlineResponse200204, *http.Response, error) {
	var (
