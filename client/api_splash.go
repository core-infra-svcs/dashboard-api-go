...
func (r SplashApiGetNetworkWirelessSsidSplashSettingsRequest) Execute() (*InlineResponse200129, *http.Response, error) {
...
func (a *SplashApiService) GetNetworkWirelessSsidSplashSettingsExecute(r SplashApiGetNetworkWirelessSsidSplashSettingsRequest) (*InlineResponse200129, *http.Response, error) {
	var (
...
func (r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) UpdateNetworkWirelessSsidSplashSettings(updateNetworkWirelessSsidSplashSettings InlineObject187) SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest {
	r.updateNetworkWirelessSsidSplashSettings = &updateNetworkWirelessSsidSplashSettings
	return r
}

func (r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) Execute() (*InlineResponse200129, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200129
func (a *SplashApiService) UpdateNetworkWirelessSsidSplashSettingsExecute(r SplashApiUpdateNetworkWirelessSsidSplashSettingsRequest) (*InlineResponse200129, *http.Response, error) {
	var (
