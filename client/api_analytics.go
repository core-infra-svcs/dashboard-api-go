...
func (r AnalyticsApiGetDeviceCameraAnalyticsLiveRequest) Execute() (*InlineResponse20011, *http.Response, error) {
...
// Deprecated
func (a *AnalyticsApiService) GetDeviceCameraAnalyticsLiveExecute(r AnalyticsApiGetDeviceCameraAnalyticsLiveRequest) (*InlineResponse20011, *http.Response, error) {
	var (
...
func (r AnalyticsApiGetDeviceCameraAnalyticsOverviewRequest) Execute() ([]InlineResponse20012, *http.Response, error) {
...
// Deprecated
func (a *AnalyticsApiService) GetDeviceCameraAnalyticsOverviewExecute(r AnalyticsApiGetDeviceCameraAnalyticsOverviewRequest) ([]InlineResponse20012, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AnalyticsApiGetDeviceCameraAnalyticsRecentRequest) Execute() ([]InlineResponse20013, *http.Response, error) {
...
// Deprecated
func (a *AnalyticsApiService) GetDeviceCameraAnalyticsRecentExecute(r AnalyticsApiGetDeviceCameraAnalyticsRecentRequest) ([]InlineResponse20013, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AnalyticsApiGetDeviceCameraAnalyticsZoneHistoryRequest) Execute() ([]InlineResponse20015, *http.Response, error) {
...
// Deprecated
func (a *AnalyticsApiService) GetDeviceCameraAnalyticsZoneHistoryExecute(r AnalyticsApiGetDeviceCameraAnalyticsZoneHistoryRequest) ([]InlineResponse20015, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AnalyticsApiGetDeviceCameraAnalyticsZonesRequest) Execute() ([]InlineResponse20014, *http.Response, error) {
...
// Deprecated
func (a *AnalyticsApiService) GetDeviceCameraAnalyticsZonesExecute(r AnalyticsApiGetDeviceCameraAnalyticsZonesRequest) ([]InlineResponse20014, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
