...
func (r AnalyticsApiGetDeviceCameraAnalyticsLiveRequest) Execute() (*InlineResponse2009, *http.Response, error) {
...
// Deprecated
func (a *AnalyticsApiService) GetDeviceCameraAnalyticsLiveExecute(r AnalyticsApiGetDeviceCameraAnalyticsLiveRequest) (*InlineResponse2009, *http.Response, error) {
	var (
...
func (r AnalyticsApiGetDeviceCameraAnalyticsOverviewRequest) Execute() ([]InlineResponse20010, *http.Response, error) {
...
// Deprecated
func (a *AnalyticsApiService) GetDeviceCameraAnalyticsOverviewExecute(r AnalyticsApiGetDeviceCameraAnalyticsOverviewRequest) ([]InlineResponse20010, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AnalyticsApiGetDeviceCameraAnalyticsRecentRequest) Execute() ([]InlineResponse20011, *http.Response, error) {
...
// Deprecated
func (a *AnalyticsApiService) GetDeviceCameraAnalyticsRecentExecute(r AnalyticsApiGetDeviceCameraAnalyticsRecentRequest) ([]InlineResponse20011, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AnalyticsApiGetDeviceCameraAnalyticsZoneHistoryRequest) Execute() ([]InlineResponse20013, *http.Response, error) {
...
// Deprecated
func (a *AnalyticsApiService) GetDeviceCameraAnalyticsZoneHistoryExecute(r AnalyticsApiGetDeviceCameraAnalyticsZoneHistoryRequest) ([]InlineResponse20013, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AnalyticsApiGetDeviceCameraAnalyticsZonesRequest) Execute() ([]InlineResponse20012, *http.Response, error) {
...
// Deprecated
func (a *AnalyticsApiService) GetDeviceCameraAnalyticsZonesExecute(r AnalyticsApiGetDeviceCameraAnalyticsZonesRequest) ([]InlineResponse20012, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
