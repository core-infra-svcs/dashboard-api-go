...
// InlineResponse2004InterfacesWan2 WAN 2 settings.
type InlineResponse2004InterfacesWan2 struct {
...
func NewInlineResponse2004InterfacesWan2() *InlineResponse2004InterfacesWan2 {
	this := InlineResponse2004InterfacesWan2{}
	return &this
}
...
func (o InlineResponse2004InterfacesWan2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2004InterfacesWan2 struct {
	value *InlineResponse2004InterfacesWan2
	isSet bool
}

func (v NullableInlineResponse2004InterfacesWan2) Get() *InlineResponse2004InterfacesWan2 {
	return v.value
}

func (v *NullableInlineResponse2004InterfacesWan2) Set(val *InlineResponse2004InterfacesWan2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2004InterfacesWan2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2004InterfacesWan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2004InterfacesWan2(val *InlineResponse2004InterfacesWan2) *NullableInlineResponse2004InterfacesWan2 {
	return &NullableInlineResponse2004InterfacesWan2{value: val, isSet: true}
}

func (v NullableInlineResponse2004InterfacesWan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2004InterfacesWan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
