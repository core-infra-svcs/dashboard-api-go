...
func (r SeenApiGetNetworkSwitchDhcpV4ServersSeenRequest) Execute() ([]InlineResponse200142, *http.Response, error) {
...
func (a *SeenApiService) GetNetworkSwitchDhcpV4ServersSeenExecute(r SeenApiGetNetworkSwitchDhcpV4ServersSeenRequest) ([]InlineResponse200142, *http.Response, error) {
	var (
