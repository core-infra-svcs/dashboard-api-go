...
func (r SeenApiGetNetworkSwitchDhcpV4ServersSeenRequest) Execute() ([]InlineResponse200143, *http.Response, error) {
...
func (a *SeenApiService) GetNetworkSwitchDhcpV4ServersSeenExecute(r SeenApiGetNetworkSwitchDhcpV4ServersSeenRequest) ([]InlineResponse200143, *http.Response, error) {
	var (
