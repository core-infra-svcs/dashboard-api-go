...
func (r SeenApiGetNetworkSwitchDhcpV4ServersSeenRequest) Execute() ([]InlineResponse200154, *http.Response, error) {
...
func (a *SeenApiService) GetNetworkSwitchDhcpV4ServersSeenExecute(r SeenApiGetNetworkSwitchDhcpV4ServersSeenRequest) ([]InlineResponse200154, *http.Response, error) {
	var (
