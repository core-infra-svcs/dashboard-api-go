...
func (r SeenApiGetNetworkSwitchDhcpV4ServersSeenRequest) Execute() ([]InlineResponse20064, *http.Response, error) {
...
func (a *SeenApiService) GetNetworkSwitchDhcpV4ServersSeenExecute(r SeenApiGetNetworkSwitchDhcpV4ServersSeenRequest) ([]InlineResponse20064, *http.Response, error) {
	var (
