...
// InlineResponse200201Counts The current amount of various adaptive policy objects.
type InlineResponse200201Counts struct {
...
func NewInlineResponse200201Counts() *InlineResponse200201Counts {
	this := InlineResponse200201Counts{}
	return &this
}
...
func (o InlineResponse200201Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200201Counts struct {
	value *InlineResponse200201Counts
	isSet bool
}

func (v NullableInlineResponse200201Counts) Get() *InlineResponse200201Counts {
	return v.value
}

func (v *NullableInlineResponse200201Counts) Set(val *InlineResponse200201Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200201Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200201Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200201Counts(val *InlineResponse200201Counts) *NullableInlineResponse200201Counts {
	return &NullableInlineResponse200201Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200201Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200201Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
