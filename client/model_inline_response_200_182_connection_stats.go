...
// InlineResponse200182ConnectionStats Connection stats
type InlineResponse200182ConnectionStats struct {
	// Association count
...
func NewInlineResponse200182ConnectionStats() *InlineResponse200182ConnectionStats {
	this := InlineResponse200182ConnectionStats{}
	return &this
}
...
func (o InlineResponse200182ConnectionStats) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200182ConnectionStats struct {
	value *InlineResponse200182ConnectionStats
	isSet bool
}

func (v NullableInlineResponse200182ConnectionStats) Get() *InlineResponse200182ConnectionStats {
	return v.value
}

func (v *NullableInlineResponse200182ConnectionStats) Set(val *InlineResponse200182ConnectionStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200182ConnectionStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200182ConnectionStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200182ConnectionStats(val *InlineResponse200182ConnectionStats) *NullableInlineResponse200182ConnectionStats {
	return &NullableInlineResponse200182ConnectionStats{value: val, isSet: true}
}

func (v NullableInlineResponse200182ConnectionStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200182ConnectionStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
