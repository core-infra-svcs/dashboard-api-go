...
// InlineResponse20056ApplicationCategories struct for InlineResponse20056ApplicationCategories
type InlineResponse20056ApplicationCategories struct {
	// The id of the category
	Id *string `json:"id,omitempty"`
	// The name of the category
	Name *string `json:"name,omitempty"`
	// Details of the associated applications
	Applications []InlineResponse20056Applications `json:"applications,omitempty"`
}
...
func NewInlineResponse20056ApplicationCategories() *InlineResponse20056ApplicationCategories {
	this := InlineResponse20056ApplicationCategories{}
	return &this
}
...
func (o *InlineResponse20056ApplicationCategories) GetApplications() []InlineResponse20056Applications {
	if o == nil || isNil(o.Applications) {
		var ret []InlineResponse20056Applications
		return ret
	}
...
// SetApplications gets a reference to the given []InlineResponse20056Applications and assigns it to the Applications field.
func (o *InlineResponse20056ApplicationCategories) SetApplications(v []InlineResponse20056Applications) {
	o.Applications = v
}

func (o InlineResponse20056ApplicationCategories) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20056ApplicationCategories struct {
	value *InlineResponse20056ApplicationCategories
	isSet bool
}

func (v NullableInlineResponse20056ApplicationCategories) Get() *InlineResponse20056ApplicationCategories {
	return v.value
}

func (v *NullableInlineResponse20056ApplicationCategories) Set(val *InlineResponse20056ApplicationCategories) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20056ApplicationCategories) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20056ApplicationCategories) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20056ApplicationCategories(val *InlineResponse20056ApplicationCategories) *NullableInlineResponse20056ApplicationCategories {
	return &NullableInlineResponse20056ApplicationCategories{value: val, isSet: true}
}

func (v NullableInlineResponse20056ApplicationCategories) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20056ApplicationCategories) UnmarshalJSON(src []byte) error {
	v.isSet = true
