...
func (r LinkLayerApiGetNetworkTopologyLinkLayerRequest) Execute() (*InlineResponse200179, *http.Response, error) {
...
func (a *LinkLayerApiService) GetNetworkTopologyLinkLayerExecute(r LinkLayerApiGetNetworkTopologyLinkLayerRequest) (*InlineResponse200179, *http.Response, error) {
	var (
