...
// InlineResponse200106Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse200106Counts struct {
	...
	Noise *InlineResponse200106CountsNoise `json:"noise,omitempty"`
...
func (o *InlineResponse200106Counts) GetNoise() InlineResponse200106CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse200106CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse200106CountsNoise and assigns it to the Noise field.
