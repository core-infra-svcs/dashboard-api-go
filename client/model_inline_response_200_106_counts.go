...
// InlineResponse200106Counts The current amount of various adaptive policy objects.
type InlineResponse200106Counts struct {
...
func NewInlineResponse200106Counts() *InlineResponse200106Counts {
	this := InlineResponse200106Counts{}
	return &this
}
...
func (o InlineResponse200106Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200106Counts struct {
	value *InlineResponse200106Counts
	isSet bool
}

func (v NullableInlineResponse200106Counts) Get() *InlineResponse200106Counts {
	return v.value
}

func (v *NullableInlineResponse200106Counts) Set(val *InlineResponse200106Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200106Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200106Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200106Counts(val *InlineResponse200106Counts) *NullableInlineResponse200106Counts {
	return &NullableInlineResponse200106Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200106Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200106Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
