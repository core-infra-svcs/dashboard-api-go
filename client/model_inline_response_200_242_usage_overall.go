...
// InlineResponse200242UsageOverall Overall data usage of all clients across organization
type InlineResponse200242UsageOverall struct {
...
func NewInlineResponse200242UsageOverall() *InlineResponse200242UsageOverall {
	this := InlineResponse200242UsageOverall{}
	return &this
}
...
func (o InlineResponse200242UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200242UsageOverall struct {
	value *InlineResponse200242UsageOverall
	isSet bool
}

func (v NullableInlineResponse200242UsageOverall) Get() *InlineResponse200242UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200242UsageOverall) Set(val *InlineResponse200242UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200242UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200242UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200242UsageOverall(val *InlineResponse200242UsageOverall) *NullableInlineResponse200242UsageOverall {
	return &NullableInlineResponse200242UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200242UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200242UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
