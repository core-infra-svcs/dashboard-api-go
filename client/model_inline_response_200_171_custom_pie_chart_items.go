...
// InlineResponse200171CustomPieChartItems struct for InlineResponse200171CustomPieChartItems
type InlineResponse200171CustomPieChartItems struct {
...
func NewInlineResponse200171CustomPieChartItems(name string, type_ string, value string) *InlineResponse200171CustomPieChartItems {
	this := InlineResponse200171CustomPieChartItems{}
	this.Name = name
	this.Type = type_
	this.Value = value
	return &this
...
func (o InlineResponse200171CustomPieChartItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200171CustomPieChartItems struct {
	value *InlineResponse200171CustomPieChartItems
	isSet bool
}

func (v NullableInlineResponse200171CustomPieChartItems) Get() *InlineResponse200171CustomPieChartItems {
	return v.value
}

func (v *NullableInlineResponse200171CustomPieChartItems) Set(val *InlineResponse200171CustomPieChartItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200171CustomPieChartItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200171CustomPieChartItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200171CustomPieChartItems(val *InlineResponse200171CustomPieChartItems) *NullableInlineResponse200171CustomPieChartItems {
	return &NullableInlineResponse200171CustomPieChartItems{value: val, isSet: true}
}

func (v NullableInlineResponse200171CustomPieChartItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200171CustomPieChartItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
