...
// InlineResponse20070PerformanceClass Performance class setting for uplink preference rule
type InlineResponse20070PerformanceClass struct {
...
func NewInlineResponse20070PerformanceClass(type_ string) *InlineResponse20070PerformanceClass {
	this := InlineResponse20070PerformanceClass{}
	this.Type = type_
	return &this
}
...
func (o InlineResponse20070PerformanceClass) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20070PerformanceClass struct {
	value *InlineResponse20070PerformanceClass
	isSet bool
}

func (v NullableInlineResponse20070PerformanceClass) Get() *InlineResponse20070PerformanceClass {
	return v.value
}

func (v *NullableInlineResponse20070PerformanceClass) Set(val *InlineResponse20070PerformanceClass) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20070PerformanceClass) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20070PerformanceClass) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20070PerformanceClass(val *InlineResponse20070PerformanceClass) *NullableInlineResponse20070PerformanceClass {
	return &NullableInlineResponse20070PerformanceClass{value: val, isSet: true}
}

func (v NullableInlineResponse20070PerformanceClass) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20070PerformanceClass) UnmarshalJSON(src []byte) error {
	v.isSet = true
