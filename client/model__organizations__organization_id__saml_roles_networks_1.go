...
type OrganizationsOrganizationIdSamlRolesNetworks1 struct {
	// The network ID
	Id string `json:"id"`
	// The privilege of the SAML administrator on the network. Can be one of 'full', 'read-only', 'guest-ambassador', 'monitor-only', 'ssid-admin' or 'port-tags' or a custom role in the format custom-role:ID.
