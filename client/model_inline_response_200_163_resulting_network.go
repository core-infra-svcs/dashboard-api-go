...
// InlineResponse200163ResultingNetwork Network after the combination
type InlineResponse200163ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200163ResultingNetwork() *InlineResponse200163ResultingNetwork {
	this := InlineResponse200163ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200163ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200163ResultingNetwork struct {
	value *InlineResponse200163ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200163ResultingNetwork) Get() *InlineResponse200163ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200163ResultingNetwork) Set(val *InlineResponse200163ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200163ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200163ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200163ResultingNetwork(val *InlineResponse200163ResultingNetwork) *NullableInlineResponse200163ResultingNetwork {
	return &NullableInlineResponse200163ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200163ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200163ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
