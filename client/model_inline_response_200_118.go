...
func (o *InlineResponse200118) GetWifiMac() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200118) GetWifiMacOk() (*string, bool) {
	if o == nil || isNil(o.WifiMac) {
    return nil, false
	}
...
func (o *InlineResponse200118) HasWifiMac() bool {
	if o != nil && !isNil(o.WifiMac) {
		return true
	}
...
func (o *InlineResponse200118) SetWifiMac(v string) {
	o.WifiMac = &v
}
...
func (o *InlineResponse200118) GetNotes() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200118) GetNotesOk() (*string, bool) {
	if o == nil || isNil(o.Notes) {
    return nil, false
	}
	return o.Notes, true
...
func (o *InlineResponse200118) HasNotes() bool {
	if o != nil && !isNil(o.Notes) {
		return true
	}
...
func (o *InlineResponse200118) SetNotes(v string) {
	o.Notes = &v
}
