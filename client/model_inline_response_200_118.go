...
func (o *InlineResponse200118) GetIds() []string {
...
func (o *InlineResponse200118) GetIdsOk() ([]string, bool) {
	if o == nil || isNil(o.Ids) {
    return nil, false
	}
	return o.Ids, true
...
func (o *InlineResponse200118) HasIds() bool {
	if o != nil && !isNil(o.Ids) {
		return true
	}
...
func (o *InlineResponse200118) SetIds(v []string) {
	o.Ids = v
}
