...
// InlineResponse200365Redundancy Wireless LAN controller redundancy information
type InlineResponse200365Redundancy struct {
	...
	Management *InlineResponse200365RedundancyManagement `json:"management,omitempty"`
}
...
func NewInlineResponse200365Redundancy() *InlineResponse200365Redundancy {
	this := InlineResponse200365Redundancy{}
	return &this
}
...
func (o *InlineResponse200365Redundancy) GetManagement() InlineResponse200365RedundancyManagement {
	if o == nil || isNil(o.Management) {
		var ret InlineResponse200365RedundancyManagement
		return ret
	}
	return *o.Management
}
...
// SetManagement gets a reference to the given InlineResponse200365RedundancyManagement and assigns it to the Management field.
func (o *InlineResponse200365Redundancy) SetManagement(v InlineResponse200365RedundancyManagement) {
	o.Management = &v
}

func (o InlineResponse200365Redundancy) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200365Redundancy struct {
	value *InlineResponse200365Redundancy
	isSet bool
}

func (v NullableInlineResponse200365Redundancy) Get() *InlineResponse200365Redundancy {
	return v.value
}

func (v *NullableInlineResponse200365Redundancy) Set(val *InlineResponse200365Redundancy) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200365Redundancy) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200365Redundancy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200365Redundancy(val *InlineResponse200365Redundancy) *NullableInlineResponse200365Redundancy {
	return &NullableInlineResponse200365Redundancy{value: val, isSet: true}
}

func (v NullableInlineResponse200365Redundancy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200365Redundancy) UnmarshalJSON(src []byte) error {
	v.isSet = true
