...
// InlineResponse20095SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse20095SixGhzSettings struct {
...
func NewInlineResponse20095SixGhzSettings() *InlineResponse20095SixGhzSettings {
	this := InlineResponse20095SixGhzSettings{}
	return &this
}
...
func (o InlineResponse20095SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20095SixGhzSettings struct {
	value *InlineResponse20095SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse20095SixGhzSettings) Get() *InlineResponse20095SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse20095SixGhzSettings) Set(val *InlineResponse20095SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20095SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20095SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20095SixGhzSettings(val *InlineResponse20095SixGhzSettings) *NullableInlineResponse20095SixGhzSettings {
	return &NullableInlineResponse20095SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20095SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20095SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
