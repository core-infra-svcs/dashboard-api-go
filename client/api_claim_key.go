...
func (r ClaimKeyApiValidateAdministeredLicensingSubscriptionSubscriptionsClaimKeyRequest) Execute() (*InlineResponse2001, *http.Response, error) {
...
func (a *ClaimKeyApiService) ValidateAdministeredLicensingSubscriptionSubscriptionsClaimKeyExecute(r ClaimKeyApiValidateAdministeredLicensingSubscriptionSubscriptionsClaimKeyRequest) (*InlineResponse2001, *http.Response, error) {
	var (
