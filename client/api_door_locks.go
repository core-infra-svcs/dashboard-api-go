...
func (r DoorLocksApiGetOrganizationWirelessZigbeeDoorLocksRequest) Execute() ([]InlineResponse20049DoorLocks, *http.Response, error) {
...
func (a *DoorLocksApiService) GetOrganizationWirelessZigbeeDoorLocksExecute(r DoorLocksApiGetOrganizationWirelessZigbeeDoorLocksRequest) ([]InlineResponse20049DoorLocks, *http.Response, error) {
	var (
...
func (r DoorLocksApiUpdateOrganizationWirelessZigbeeDoorLockRequest) UpdateOrganizationWirelessZigbeeDoorLock(updateOrganizationWirelessZigbeeDoorLock InlineObject313) DoorLocksApiUpdateOrganizationWirelessZigbeeDoorLockRequest {
	r.updateOrganizationWirelessZigbeeDoorLock = &updateOrganizationWirelessZigbeeDoorLock
	return r
}

func (r DoorLocksApiUpdateOrganizationWirelessZigbeeDoorLockRequest) Execute() (*InlineResponse20049DoorLocks, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20049DoorLocks
func (a *DoorLocksApiService) UpdateOrganizationWirelessZigbeeDoorLockExecute(r DoorLocksApiUpdateOrganizationWirelessZigbeeDoorLockRequest) (*InlineResponse20049DoorLocks, *http.Response, error) {
	var (
