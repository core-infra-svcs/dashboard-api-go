...
func (r DoorLocksApiGetOrganizationWirelessZigbeeDoorLocksRequest) Execute() ([]InlineResponse20054DoorLocks, *http.Response, error) {
...
func (a *DoorLocksApiService) GetOrganizationWirelessZigbeeDoorLocksExecute(r DoorLocksApiGetOrganizationWirelessZigbeeDoorLocksRequest) ([]InlineResponse20054DoorLocks, *http.Response, error) {
	var (
...
func (r DoorLocksApiUpdateOrganizationWirelessZigbeeDoorLockRequest) UpdateOrganizationWirelessZigbeeDoorLock(updateOrganizationWirelessZigbeeDoorLock InlineObject320) DoorLocksApiUpdateOrganizationWirelessZigbeeDoorLockRequest {
	r.updateOrganizationWirelessZigbeeDoorLock = &updateOrganizationWirelessZigbeeDoorLock
	return r
}

func (r DoorLocksApiUpdateOrganizationWirelessZigbeeDoorLockRequest) Execute() (*InlineResponse20054DoorLocks, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20054DoorLocks
func (a *DoorLocksApiService) UpdateOrganizationWirelessZigbeeDoorLockExecute(r DoorLocksApiUpdateOrganizationWirelessZigbeeDoorLockRequest) (*InlineResponse20054DoorLocks, *http.Response, error) {
	var (
