...
// InlineResponse200331MetaCountsItems The count metadata.
type InlineResponse200331MetaCountsItems struct {
...
func NewInlineResponse200331MetaCountsItems() *InlineResponse200331MetaCountsItems {
	this := InlineResponse200331MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200331MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200331MetaCountsItems struct {
	value *InlineResponse200331MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200331MetaCountsItems) Get() *InlineResponse200331MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200331MetaCountsItems) Set(val *InlineResponse200331MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200331MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200331MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200331MetaCountsItems(val *InlineResponse200331MetaCountsItems) *NullableInlineResponse200331MetaCountsItems {
	return &NullableInlineResponse200331MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200331MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200331MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
