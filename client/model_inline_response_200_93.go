...
type InlineResponse20093 struct {
	...
	Switches []InlineResponse20093Switches `json:"switches,omitempty"`
}
...
func (o *InlineResponse20093) GetSwitches() []InlineResponse20093Switches {
	if o == nil || isNil(o.Switches) {
		var ret []InlineResponse20093Switches
		return ret
	}
	return o.Switches
}
...
// SetSwitches gets a reference to the given []InlineResponse20093Switches and assigns it to the Switches field.
