...
// InlineResponse200181FiveGhzSettings Settings related to 5Ghz band
type InlineResponse200181FiveGhzSettings struct {
...
func NewInlineResponse200181FiveGhzSettings() *InlineResponse200181FiveGhzSettings {
	this := InlineResponse200181FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse200181FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200181FiveGhzSettings struct {
	value *InlineResponse200181FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse200181FiveGhzSettings) Get() *InlineResponse200181FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200181FiveGhzSettings) Set(val *InlineResponse200181FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200181FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200181FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200181FiveGhzSettings(val *InlineResponse200181FiveGhzSettings) *NullableInlineResponse200181FiveGhzSettings {
	return &NullableInlineResponse200181FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200181FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200181FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
