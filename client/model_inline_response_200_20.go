...
type InlineResponse20020 struct {
	...
	ToVersion *InlineResponse20020ToVersion `json:"toVersion,omitempty"`
...
func (o *InlineResponse20020) GetToVersion() InlineResponse20020ToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20020ToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20020ToVersion and assigns it to the ToVersion field.
