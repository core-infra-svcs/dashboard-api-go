...
func (o *InlineResponse20020) GetStaticDelegatedPrefixId() string {
...
func (o *InlineResponse20020) GetStaticDelegatedPrefixIdOk() (*string, bool) {
	if o == nil || isNil(o.StaticDelegatedPrefixId) {
    return nil, false
	}
...
func (o *InlineResponse20020) HasStaticDelegatedPrefixId() bool {
	if o != nil && !isNil(o.StaticDelegatedPrefixId) {
		return true
	}
...
func (o *InlineResponse20020) SetStaticDelegatedPrefixId(v string) {
	o.StaticDelegatedPrefixId = &v
}

// GetPrefix returns the Prefix field value if set, zero value otherwise.
func (o *InlineResponse20020) GetPrefix() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20020) GetPrefixOk() (*string, bool) {
	if o == nil || isNil(o.Prefix) {
    return nil, false
	}
...
func (o *InlineResponse20020) HasPrefix() bool {
	if o != nil && !isNil(o.Prefix) {
		return true
	}
...
func (o *InlineResponse20020) SetPrefix(v string) {
	o.Prefix = &v
}

// GetOrigin returns the Origin field value if set, zero value otherwise.
func (o *InlineResponse20020) GetOrigin() NetworksNetworkIdAppliancePrefixesDelegatedStaticsOrigin {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20020) GetOriginOk() (*NetworksNetworkIdAppliancePrefixesDelegatedStaticsOrigin, bool) {
	if o == nil || isNil(o.Origin) {
    return nil, false
	}
...
func (o *InlineResponse20020) HasOrigin() bool {
	if o != nil && !isNil(o.Origin) {
		return true
	}
...
func (o *InlineResponse20020) SetOrigin(v NetworksNetworkIdAppliancePrefixesDelegatedStaticsOrigin) {
	o.Origin = &v
}
...
func (o *InlineResponse20020) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20020) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || isNil(o.CreatedAt) {
    return nil, false
	}
...
func (o *InlineResponse20020) HasCreatedAt() bool {
	if o != nil && !isNil(o.CreatedAt) {
		return true
	}
...
func (o *InlineResponse20020) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}

// GetUpdatedAt returns the UpdatedAt field value if set, zero value otherwise.
func (o *InlineResponse20020) GetUpdatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20020) GetUpdatedAtOk() (*time.Time, bool) {
	if o == nil || isNil(o.UpdatedAt) {
    return nil, false
	}
...
func (o *InlineResponse20020) HasUpdatedAt() bool {
	if o != nil && !isNil(o.UpdatedAt) {
		return true
	}
...
func (o *InlineResponse20020) SetUpdatedAt(v time.Time) {
	o.UpdatedAt = &v
}
