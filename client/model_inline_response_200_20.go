...
type InlineResponse20020 struct {
	// SSID status list
	BasicServiceSets []InlineResponse20020BasicServiceSets `json:"basicServiceSets,omitempty"`
}
...
func (o *InlineResponse20020) GetBasicServiceSets() []InlineResponse20020BasicServiceSets {
	if o == nil || isNil(o.BasicServiceSets) {
		var ret []InlineResponse20020BasicServiceSets
		return ret
	}
...
// SetBasicServiceSets gets a reference to the given []InlineResponse20020BasicServiceSets and assigns it to the BasicServiceSets field.
