...
// InlineResponse200315Gateway Information about the gateway.
type InlineResponse200315Gateway struct {
...
func NewInlineResponse200315Gateway(name string, mac string) *InlineResponse200315Gateway {
	this := InlineResponse200315Gateway{}
	this.Name = name
	this.Mac = mac
	return &this
}
...
func (o InlineResponse200315Gateway) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200315Gateway struct {
	value *InlineResponse200315Gateway
	isSet bool
}

func (v NullableInlineResponse200315Gateway) Get() *InlineResponse200315Gateway {
	return v.value
}

func (v *NullableInlineResponse200315Gateway) Set(val *InlineResponse200315Gateway) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200315Gateway) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200315Gateway) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200315Gateway(val *InlineResponse200315Gateway) *NullableInlineResponse200315Gateway {
	return &NullableInlineResponse200315Gateway{value: val, isSet: true}
}

func (v NullableInlineResponse200315Gateway) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200315Gateway) UnmarshalJSON(src []byte) error {
	v.isSet = true
