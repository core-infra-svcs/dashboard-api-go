...
type InlineResponse200148 struct {
	Alerts *InlineResponse200148Alerts `json:"alerts,omitempty"`
	...
	ArpInspection *InlineResponse200148ArpInspection `json:"arpInspection,omitempty"`
}
...
func (o *InlineResponse200148) GetAlerts() InlineResponse200148Alerts {
	if o == nil || isNil(o.Alerts) {
		var ret InlineResponse200148Alerts
		return ret
	}
	return *o.Alerts
}
...
// SetAlerts gets a reference to the given InlineResponse200148Alerts and assigns it to the Alerts field.
...
func (o *InlineResponse200148) GetArpInspection() InlineResponse200148ArpInspection {
	if o == nil || isNil(o.ArpInspection) {
		var ret InlineResponse200148ArpInspection
		return ret
	}
...
// SetArpInspection gets a reference to the given InlineResponse200148ArpInspection and assigns it to the ArpInspection field.
