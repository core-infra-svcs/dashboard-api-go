...
func (o *InlineResponse200148) GetLogin() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200148) GetLoginOk() (*string, bool) {
	if o == nil || isNil(o.Login) {
    return nil, false
	}
	return o.Login, true
...
func (o *InlineResponse200148) HasLogin() bool {
	if o != nil && !isNil(o.Login) {
		return true
	}
...
func (o *InlineResponse200148) SetLogin(v string) {
	o.Login = &v
}

// GetSsid returns the Ssid field value if set, zero value otherwise.
func (o *InlineResponse200148) GetSsid() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200148) GetSsidOk() (*string, bool) {
	if o == nil || isNil(o.Ssid) {
    return nil, false
	}
	return o.Ssid, true
...
func (o *InlineResponse200148) HasSsid() bool {
	if o != nil && !isNil(o.Ssid) {
		return true
	}
...
func (o *InlineResponse200148) SetSsid(v string) {
	o.Ssid = &v
}

// GetLoginAt returns the LoginAt field value if set, zero value otherwise.
func (o *InlineResponse200148) GetLoginAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200148) GetLoginAtOk() (*time.Time, bool) {
	if o == nil || isNil(o.LoginAt) {
    return nil, false
	}
...
func (o *InlineResponse200148) HasLoginAt() bool {
	if o != nil && !isNil(o.LoginAt) {
		return true
	}
...
func (o *InlineResponse200148) SetLoginAt(v time.Time) {
	o.LoginAt = &v
}

// GetGatewayDeviceMac returns the GatewayDeviceMac field value if set, zero value otherwise.
func (o *InlineResponse200148) GetGatewayDeviceMac() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200148) GetGatewayDeviceMacOk() (*string, bool) {
	if o == nil || isNil(o.GatewayDeviceMac) {
    return nil, false
	}
...
func (o *InlineResponse200148) HasGatewayDeviceMac() bool {
	if o != nil && !isNil(o.GatewayDeviceMac) {
		return true
	}
...
func (o *InlineResponse200148) SetGatewayDeviceMac(v string) {
	o.GatewayDeviceMac = &v
}

// GetClientMac returns the ClientMac field value if set, zero value otherwise.
func (o *InlineResponse200148) GetClientMac() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200148) GetClientMacOk() (*string, bool) {
	if o == nil || isNil(o.ClientMac) {
    return nil, false
	}
...
func (o *InlineResponse200148) HasClientMac() bool {
	if o != nil && !isNil(o.ClientMac) {
		return true
	}
...
func (o *InlineResponse200148) SetClientMac(v string) {
	o.ClientMac = &v
}
...
func (o *InlineResponse200148) GetAuthorization() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200148) GetAuthorizationOk() (*string, bool) {
	if o == nil || isNil(o.Authorization) {
    return nil, false
	}
...
func (o *InlineResponse200148) HasAuthorization() bool {
	if o != nil && !isNil(o.Authorization) {
		return true
	}
...
func (o *InlineResponse200148) SetAuthorization(v string) {
	o.Authorization = &v
}
