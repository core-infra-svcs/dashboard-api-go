...
func (o *InlineResponse200148) GetImportId() string {
...
func (o *InlineResponse200148) GetImportIdOk() (*string, bool) {
	if o == nil || isNil(o.ImportId) {
    return nil, false
	}
...
func (o *InlineResponse200148) HasImportId() bool {
	if o != nil && !isNil(o.ImportId) {
		return true
	}
...
func (o *InlineResponse200148) SetImportId(v string) {
	o.ImportId = &v
}

// GetDevice returns the Device field value if set, zero value otherwise.
func (o *InlineResponse200148) GetDevice() OrganizationsOrganizationIdInventoryOnboardingCloudMonitoringImportsDevice {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200148) GetDeviceOk() (*OrganizationsOrganizationIdInventoryOnboardingCloudMonitoringImportsDevice, bool) {
	if o == nil || isNil(o.Device) {
    return nil, false
	}
...
func (o *InlineResponse200148) SetDevice(v OrganizationsOrganizationIdInventoryOnboardingCloudMonitoringImportsDevice) {
	o.Device = &v
}
