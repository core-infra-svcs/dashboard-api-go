...
// InlineResponse200263ResultingNetwork Network after the combination
type InlineResponse200263ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200263ResultingNetwork() *InlineResponse200263ResultingNetwork {
	this := InlineResponse200263ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200263ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200263ResultingNetwork struct {
	value *InlineResponse200263ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200263ResultingNetwork) Get() *InlineResponse200263ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200263ResultingNetwork) Set(val *InlineResponse200263ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200263ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200263ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200263ResultingNetwork(val *InlineResponse200263ResultingNetwork) *NullableInlineResponse200263ResultingNetwork {
	return &NullableInlineResponse200263ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200263ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200263ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
