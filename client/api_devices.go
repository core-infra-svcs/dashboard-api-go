...
func (r DevicesApiApiGetOrganizationSummaryTopDevicesByUsageRequest) Execute() ([]InlineResponse2007, *_nethttp.Response, error) {
...
func (a *DevicesApiService) GetOrganizationSummaryTopDevicesByUsageExecute(r DevicesApiApiGetOrganizationSummaryTopDevicesByUsageRequest) ([]InlineResponse2007, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
