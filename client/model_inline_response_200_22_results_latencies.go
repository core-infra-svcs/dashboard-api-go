...
// InlineResponse20022ResultsLatencies Packet latency stats
type InlineResponse20022ResultsLatencies struct {
	// Minimum latency
...
func NewInlineResponse20022ResultsLatencies() *InlineResponse20022ResultsLatencies {
	this := InlineResponse20022ResultsLatencies{}
	return &this
}
...
func (o InlineResponse20022ResultsLatencies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20022ResultsLatencies struct {
	value *InlineResponse20022ResultsLatencies
	isSet bool
}

func (v NullableInlineResponse20022ResultsLatencies) Get() *InlineResponse20022ResultsLatencies {
	return v.value
}

func (v *NullableInlineResponse20022ResultsLatencies) Set(val *InlineResponse20022ResultsLatencies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20022ResultsLatencies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20022ResultsLatencies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20022ResultsLatencies(val *InlineResponse20022ResultsLatencies) *NullableInlineResponse20022ResultsLatencies {
	return &NullableInlineResponse20022ResultsLatencies{value: val, isSet: true}
}

func (v NullableInlineResponse20022ResultsLatencies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20022ResultsLatencies) UnmarshalJSON(src []byte) error {
	v.isSet = true
