...
// InlineResponse200297StatesUnusedSoonestActivation Information about the soonest forthcoming license activation
type InlineResponse200297StatesUnusedSoonestActivation struct {
...
func NewInlineResponse200297StatesUnusedSoonestActivation() *InlineResponse200297StatesUnusedSoonestActivation {
	this := InlineResponse200297StatesUnusedSoonestActivation{}
	return &this
}
...
func (o InlineResponse200297StatesUnusedSoonestActivation) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200297StatesUnusedSoonestActivation struct {
	value *InlineResponse200297StatesUnusedSoonestActivation
	isSet bool
}

func (v NullableInlineResponse200297StatesUnusedSoonestActivation) Get() *InlineResponse200297StatesUnusedSoonestActivation {
	return v.value
}

func (v *NullableInlineResponse200297StatesUnusedSoonestActivation) Set(val *InlineResponse200297StatesUnusedSoonestActivation) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200297StatesUnusedSoonestActivation) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200297StatesUnusedSoonestActivation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200297StatesUnusedSoonestActivation(val *InlineResponse200297StatesUnusedSoonestActivation) *NullableInlineResponse200297StatesUnusedSoonestActivation {
	return &NullableInlineResponse200297StatesUnusedSoonestActivation{value: val, isSet: true}
}

func (v NullableInlineResponse200297StatesUnusedSoonestActivation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200297StatesUnusedSoonestActivation) UnmarshalJSON(src []byte) error {
	v.isSet = true
