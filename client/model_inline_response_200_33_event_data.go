...
// InlineResponse20033EventData An object containing more data related to the event.
type InlineResponse20033EventData struct {
...
func NewInlineResponse20033EventData() *InlineResponse20033EventData {
	this := InlineResponse20033EventData{}
	return &this
}
...
func (o InlineResponse20033EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20033EventData struct {
	value *InlineResponse20033EventData
	isSet bool
}

func (v NullableInlineResponse20033EventData) Get() *InlineResponse20033EventData {
	return v.value
}

func (v *NullableInlineResponse20033EventData) Set(val *InlineResponse20033EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20033EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20033EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20033EventData(val *InlineResponse20033EventData) *NullableInlineResponse20033EventData {
	return &NullableInlineResponse20033EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20033EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20033EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
