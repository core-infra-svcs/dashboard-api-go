...
// InlineResponse20087EventData An object containing more data related to the event.
type InlineResponse20087EventData struct {
...
func NewInlineResponse20087EventData() *InlineResponse20087EventData {
	this := InlineResponse20087EventData{}
	return &this
}
...
func (o InlineResponse20087EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20087EventData struct {
	value *InlineResponse20087EventData
	isSet bool
}

func (v NullableInlineResponse20087EventData) Get() *InlineResponse20087EventData {
	return v.value
}

func (v *NullableInlineResponse20087EventData) Set(val *InlineResponse20087EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20087EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20087EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20087EventData(val *InlineResponse20087EventData) *NullableInlineResponse20087EventData {
	return &NullableInlineResponse20087EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20087EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20087EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
