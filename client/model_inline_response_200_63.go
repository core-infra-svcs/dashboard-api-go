...
type InlineResponse20063 struct {
	...
	FailoverAndFailback *InlineResponse20063FailoverAndFailback `json:"failoverAndFailback,omitempty"`
	// Uplink preference rules for WAN traffic
	WanTrafficUplinkPreferences []InlineResponse20063WanTrafficUplinkPreferences `json:"wanTrafficUplinkPreferences,omitempty"`
	// Uplink preference rules for VPN traffic
	VpnTrafficUplinkPreferences []InlineResponse20063VpnTrafficUplinkPreferences `json:"vpnTrafficUplinkPreferences,omitempty"`
}
...
func (o *InlineResponse20063) GetFailoverAndFailback() InlineResponse20063FailoverAndFailback {
	if o == nil || isNil(o.FailoverAndFailback) {
		var ret InlineResponse20063FailoverAndFailback
		return ret
	}
...
// SetFailoverAndFailback gets a reference to the given InlineResponse20063FailoverAndFailback and assigns it to the FailoverAndFailback field.
...
func (o *InlineResponse20063) GetWanTrafficUplinkPreferences() []InlineResponse20063WanTrafficUplinkPreferences {
	if o == nil || isNil(o.WanTrafficUplinkPreferences) {
		var ret []InlineResponse20063WanTrafficUplinkPreferences
		return ret
	}
...
// SetWanTrafficUplinkPreferences gets a reference to the given []InlineResponse20063WanTrafficUplinkPreferences and assigns it to the WanTrafficUplinkPreferences field.
...
func (o *InlineResponse20063) GetVpnTrafficUplinkPreferences() []InlineResponse20063VpnTrafficUplinkPreferences {
	if o == nil || isNil(o.VpnTrafficUplinkPreferences) {
		var ret []InlineResponse20063VpnTrafficUplinkPreferences
		return ret
	}
...
// SetVpnTrafficUplinkPreferences gets a reference to the given []InlineResponse20063VpnTrafficUplinkPreferences and assigns it to the VpnTrafficUplinkPreferences field.
