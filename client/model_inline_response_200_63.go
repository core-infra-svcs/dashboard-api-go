...
type InlineResponse20063 struct {
	...
	ProtectedNetworks *InlineResponse20063ProtectedNetworks `json:"protectedNetworks,omitempty"`
}
...
func (o *InlineResponse20063) GetProtectedNetworks() InlineResponse20063ProtectedNetworks {
	if o == nil || isNil(o.ProtectedNetworks) {
		var ret InlineResponse20063ProtectedNetworks
		return ret
	}
...
// SetProtectedNetworks gets a reference to the given InlineResponse20063ProtectedNetworks and assigns it to the ProtectedNetworks field.
