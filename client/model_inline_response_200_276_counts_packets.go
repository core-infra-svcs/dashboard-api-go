...
// InlineResponse200276CountsPackets Object containing packet counts
type InlineResponse200276CountsPackets struct {
...
func NewInlineResponse200276CountsPackets() *InlineResponse200276CountsPackets {
	this := InlineResponse200276CountsPackets{}
	return &this
}
...
func (o InlineResponse200276CountsPackets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200276CountsPackets struct {
	value *InlineResponse200276CountsPackets
	isSet bool
}

func (v NullableInlineResponse200276CountsPackets) Get() *InlineResponse200276CountsPackets {
	return v.value
}

func (v *NullableInlineResponse200276CountsPackets) Set(val *InlineResponse200276CountsPackets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200276CountsPackets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200276CountsPackets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200276CountsPackets(val *InlineResponse200276CountsPackets) *NullableInlineResponse200276CountsPackets {
	return &NullableInlineResponse200276CountsPackets{value: val, isSet: true}
}

func (v NullableInlineResponse200276CountsPackets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200276CountsPackets) UnmarshalJSON(src []byte) error {
	v.isSet = true
