...
// InlineResponse200102FiveGhzSettings Settings related to 5Ghz band
type InlineResponse200102FiveGhzSettings struct {
...
func NewInlineResponse200102FiveGhzSettings() *InlineResponse200102FiveGhzSettings {
	this := InlineResponse200102FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse200102FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200102FiveGhzSettings struct {
	value *InlineResponse200102FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse200102FiveGhzSettings) Get() *InlineResponse200102FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200102FiveGhzSettings) Set(val *InlineResponse200102FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200102FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200102FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200102FiveGhzSettings(val *InlineResponse200102FiveGhzSettings) *NullableInlineResponse200102FiveGhzSettings {
	return &NullableInlineResponse200102FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200102FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200102FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
