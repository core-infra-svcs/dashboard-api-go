...
func (r ReadingsApiGetOrganizationSensorReadingsHistoryRequest) Execute() ([]InlineResponse200282, *http.Response, error) {
...
func (a *ReadingsApiService) GetOrganizationSensorReadingsHistoryExecute(r ReadingsApiGetOrganizationSensorReadingsHistoryRequest) ([]InlineResponse200282, *http.Response, error) {
	var (
...
func (r ReadingsApiGetOrganizationSensorReadingsLatestRequest) Execute() ([]InlineResponse200283, *http.Response, error) {
...
func (a *ReadingsApiService) GetOrganizationSensorReadingsLatestExecute(r ReadingsApiGetOrganizationSensorReadingsLatestRequest) ([]InlineResponse200283, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
