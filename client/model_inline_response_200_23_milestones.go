...
// InlineResponse20023Milestones The Staged Upgrade Milestones for the stage
type InlineResponse20023Milestones struct {
...
func NewInlineResponse20023Milestones() *InlineResponse20023Milestones {
	this := InlineResponse20023Milestones{}
	return &this
}
...
func (o InlineResponse20023Milestones) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20023Milestones struct {
	value *InlineResponse20023Milestones
	isSet bool
}

func (v NullableInlineResponse20023Milestones) Get() *InlineResponse20023Milestones {
	return v.value
}

func (v *NullableInlineResponse20023Milestones) Set(val *InlineResponse20023Milestones) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20023Milestones) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20023Milestones) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20023Milestones(val *InlineResponse20023Milestones) *NullableInlineResponse20023Milestones {
	return &NullableInlineResponse20023Milestones{value: val, isSet: true}
}

func (v NullableInlineResponse20023Milestones) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20023Milestones) UnmarshalJSON(src []byte) error {
	v.isSet = true
