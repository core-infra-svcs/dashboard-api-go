...
// InlineResponse20032VpnTrafficUplinkPreferences struct for InlineResponse20032VpnTrafficUplinkPreferences
type InlineResponse20032VpnTrafficUplinkPreferences struct {
	// Traffic filters
	TrafficFilters []InlineResponse20032TrafficFilters1 `json:"trafficFilters"`
	...
	PerformanceClass *InlineResponse20032PerformanceClass `json:"performanceClass,omitempty"`
}
...
func NewInlineResponse20032VpnTrafficUplinkPreferences(trafficFilters []InlineResponse20032TrafficFilters1, preferredUplink string) *InlineResponse20032VpnTrafficUplinkPreferences {
	this := InlineResponse20032VpnTrafficUplinkPreferences{}
...
func (o *InlineResponse20032VpnTrafficUplinkPreferences) GetTrafficFilters() []InlineResponse20032TrafficFilters1 {
	if o == nil {
		var ret []InlineResponse20032TrafficFilters1
		return ret
	}
...
func (o *InlineResponse20032VpnTrafficUplinkPreferences) GetPerformanceClass() InlineResponse20032PerformanceClass {
	if o == nil || isNil(o.PerformanceClass) {
		var ret InlineResponse20032PerformanceClass
		return ret
	}
...
// SetPerformanceClass gets a reference to the given InlineResponse20032PerformanceClass and assigns it to the PerformanceClass field.
...
func (o InlineResponse20032VpnTrafficUplinkPreferences) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20032VpnTrafficUplinkPreferences struct {
	value *InlineResponse20032VpnTrafficUplinkPreferences
	isSet bool
}

func (v NullableInlineResponse20032VpnTrafficUplinkPreferences) Get() *InlineResponse20032VpnTrafficUplinkPreferences {
	return v.value
}

func (v *NullableInlineResponse20032VpnTrafficUplinkPreferences) Set(val *InlineResponse20032VpnTrafficUplinkPreferences) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20032VpnTrafficUplinkPreferences) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20032VpnTrafficUplinkPreferences) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20032VpnTrafficUplinkPreferences(val *InlineResponse20032VpnTrafficUplinkPreferences) *NullableInlineResponse20032VpnTrafficUplinkPreferences {
	return &NullableInlineResponse20032VpnTrafficUplinkPreferences{value: val, isSet: true}
}

func (v NullableInlineResponse20032VpnTrafficUplinkPreferences) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20032VpnTrafficUplinkPreferences) UnmarshalJSON(src []byte) error {
	v.isSet = true
