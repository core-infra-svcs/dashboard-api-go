...
type InlineObject169 struct {
	...
	CustomPieChartItems []InlineResponse200175CustomPieChartItems `json:"customPieChartItems,omitempty"`
}
...
func (o *InlineObject169) GetCustomPieChartItems() []InlineResponse200175CustomPieChartItems {
	if o == nil || isNil(o.CustomPieChartItems) {
		var ret []InlineResponse200175CustomPieChartItems
		return ret
	}
...
// SetCustomPieChartItems gets a reference to the given []InlineResponse200175CustomPieChartItems and assigns it to the CustomPieChartItems field.
