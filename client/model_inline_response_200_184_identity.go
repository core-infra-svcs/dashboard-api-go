...
// InlineResponse200184Identity EAP settings for identity requests.
type InlineResponse200184Identity struct {
...
func NewInlineResponse200184Identity() *InlineResponse200184Identity {
	this := InlineResponse200184Identity{}
	return &this
}
...
func (o InlineResponse200184Identity) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200184Identity struct {
	value *InlineResponse200184Identity
	isSet bool
}

func (v NullableInlineResponse200184Identity) Get() *InlineResponse200184Identity {
	return v.value
}

func (v *NullableInlineResponse200184Identity) Set(val *InlineResponse200184Identity) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200184Identity) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200184Identity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200184Identity(val *InlineResponse200184Identity) *NullableInlineResponse200184Identity {
	return &NullableInlineResponse200184Identity{value: val, isSet: true}
}

func (v NullableInlineResponse200184Identity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200184Identity) UnmarshalJSON(src []byte) error {
	v.isSet = true
