...
// InlineResponse200132UsageOverall Overall data usage of all clients across organization
type InlineResponse200132UsageOverall struct {
...
func NewInlineResponse200132UsageOverall() *InlineResponse200132UsageOverall {
	this := InlineResponse200132UsageOverall{}
	return &this
}
...
func (o InlineResponse200132UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200132UsageOverall struct {
	value *InlineResponse200132UsageOverall
	isSet bool
}

func (v NullableInlineResponse200132UsageOverall) Get() *InlineResponse200132UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200132UsageOverall) Set(val *InlineResponse200132UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200132UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200132UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200132UsageOverall(val *InlineResponse200132UsageOverall) *NullableInlineResponse200132UsageOverall {
	return &NullableInlineResponse200132UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200132UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200132UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
