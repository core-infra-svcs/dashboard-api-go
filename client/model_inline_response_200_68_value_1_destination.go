...
// InlineResponse20068Value1Destination Destination of 'custom' type traffic filter
type InlineResponse20068Value1Destination struct {
...
func NewInlineResponse20068Value1Destination() *InlineResponse20068Value1Destination {
	this := InlineResponse20068Value1Destination{}
	return &this
}
...
func (o InlineResponse20068Value1Destination) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20068Value1Destination struct {
	value *InlineResponse20068Value1Destination
	isSet bool
}

func (v NullableInlineResponse20068Value1Destination) Get() *InlineResponse20068Value1Destination {
	return v.value
}

func (v *NullableInlineResponse20068Value1Destination) Set(val *InlineResponse20068Value1Destination) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20068Value1Destination) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20068Value1Destination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20068Value1Destination(val *InlineResponse20068Value1Destination) *NullableInlineResponse20068Value1Destination {
	return &NullableInlineResponse20068Value1Destination{value: val, isSet: true}
}

func (v NullableInlineResponse20068Value1Destination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20068Value1Destination) UnmarshalJSON(src []byte) error {
	v.isSet = true
