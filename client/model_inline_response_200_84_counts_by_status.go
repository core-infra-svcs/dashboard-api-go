...
// InlineResponse20084CountsByStatus byStatus
type InlineResponse20084CountsByStatus struct {
	// online count
...
func NewInlineResponse20084CountsByStatus() *InlineResponse20084CountsByStatus {
	this := InlineResponse20084CountsByStatus{}
	return &this
}
...
func (o InlineResponse20084CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20084CountsByStatus struct {
	value *InlineResponse20084CountsByStatus
	isSet bool
}

func (v NullableInlineResponse20084CountsByStatus) Get() *InlineResponse20084CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse20084CountsByStatus) Set(val *InlineResponse20084CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20084CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20084CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20084CountsByStatus(val *InlineResponse20084CountsByStatus) *NullableInlineResponse20084CountsByStatus {
	return &NullableInlineResponse20084CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse20084CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20084CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
