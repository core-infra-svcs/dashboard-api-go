...
// InlineResponse200238Totals Totals by Severity
type InlineResponse200238Totals struct {
...
func NewInlineResponse200238Totals() *InlineResponse200238Totals {
	this := InlineResponse200238Totals{}
	return &this
}
...
func (o InlineResponse200238Totals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200238Totals struct {
	value *InlineResponse200238Totals
	isSet bool
}

func (v NullableInlineResponse200238Totals) Get() *InlineResponse200238Totals {
	return v.value
}

func (v *NullableInlineResponse200238Totals) Set(val *InlineResponse200238Totals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200238Totals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200238Totals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200238Totals(val *InlineResponse200238Totals) *NullableInlineResponse200238Totals {
	return &NullableInlineResponse200238Totals{value: val, isSet: true}
}

func (v NullableInlineResponse200238Totals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200238Totals) UnmarshalJSON(src []byte) error {
	v.isSet = true
