...
// InlineResponse200194FiveGhzSettings Settings related to 5Ghz band
type InlineResponse200194FiveGhzSettings struct {
...
func NewInlineResponse200194FiveGhzSettings() *InlineResponse200194FiveGhzSettings {
	this := InlineResponse200194FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse200194FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200194FiveGhzSettings struct {
	value *InlineResponse200194FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse200194FiveGhzSettings) Get() *InlineResponse200194FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200194FiveGhzSettings) Set(val *InlineResponse200194FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200194FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200194FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200194FiveGhzSettings(val *InlineResponse200194FiveGhzSettings) *NullableInlineResponse200194FiveGhzSettings {
	return &NullableInlineResponse200194FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200194FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200194FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
