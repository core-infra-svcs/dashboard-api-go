...
func (r ClaimApiVmxNetworkDevicesClaimRequest) VmxNetworkDevicesClaim(vmxNetworkDevicesClaim InlineObject90) ClaimApiVmxNetworkDevicesClaimRequest {
	r.vmxNetworkDevicesClaim = &vmxNetworkDevicesClaim
	return r
}

func (r ClaimApiVmxNetworkDevicesClaimRequest) Execute() (*InlineResponse20087, *http.Response, error) {
...
func (a *ClaimApiService) VmxNetworkDevicesClaimExecute(r ClaimApiVmxNetworkDevicesClaimRequest) (*InlineResponse20087, *http.Response, error) {
	var (
