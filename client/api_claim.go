...
func (r ClaimApiVmxNetworkDevicesClaimRequest) Execute() (*InlineResponse20091, *http.Response, error) {
...
func (a *ClaimApiService) VmxNetworkDevicesClaimExecute(r ClaimApiVmxNetworkDevicesClaimRequest) (*InlineResponse20091, *http.Response, error) {
	var (
