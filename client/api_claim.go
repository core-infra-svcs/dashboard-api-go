...
type ClaimApiApiVmxNetworkDevicesClaimRequest struct {
...
func (r ClaimApiApiVmxNetworkDevicesClaimRequest) VmxNetworkDevicesClaim(vmxNetworkDevicesClaim InlineObject73) ClaimApiApiVmxNetworkDevicesClaimRequest {
	r.vmxNetworkDevicesClaim = &vmxNetworkDevicesClaim
	return r
}

func (r ClaimApiApiVmxNetworkDevicesClaimRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
Claim a vMX into a network
 ...
 @param networkId
 @return ClaimApiApiVmxNetworkDevicesClaimRequest
*/
func (a *ClaimApiService) VmxNetworkDevicesClaim(ctx _context.Context, networkId string) ClaimApiApiVmxNetworkDevicesClaimRequest {
	return ClaimApiApiVmxNetworkDevicesClaimRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *ClaimApiService) VmxNetworkDevicesClaimExecute(r ClaimApiApiVmxNetworkDevicesClaimRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
