...
func (r ClaimApiVmxNetworkDevicesClaimRequest) Execute() (*InlineResponse20099, *http.Response, error) {
...
func (a *ClaimApiService) VmxNetworkDevicesClaimExecute(r ClaimApiVmxNetworkDevicesClaimRequest) (*InlineResponse20099, *http.Response, error) {
	var (
