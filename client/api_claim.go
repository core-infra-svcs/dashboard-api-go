...
func (r ClaimApiVmxNetworkDevicesClaimRequest) Execute() (*InlineResponse20086, *http.Response, error) {
...
func (a *ClaimApiService) VmxNetworkDevicesClaimExecute(r ClaimApiVmxNetworkDevicesClaimRequest) (*InlineResponse20086, *http.Response, error) {
	var (
