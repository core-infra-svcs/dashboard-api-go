...
func (r ClaimApiVmxNetworkDevicesClaimRequest) Execute() (*InlineResponse20094, *http.Response, error) {
...
func (a *ClaimApiService) VmxNetworkDevicesClaimExecute(r ClaimApiVmxNetworkDevicesClaimRequest) (*InlineResponse20094, *http.Response, error) {
	var (
