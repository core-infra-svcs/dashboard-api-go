...
func (o *InlineObject316) GetDoorLockIds() []string {
...
func (o *InlineObject316) GetDoorLockIdsOk() ([]string, bool) {
	if o == nil || isNil(o.DoorLockIds) {
    return nil, false
	}
...
func (o *InlineObject316) HasDoorLockIds() bool {
	if o != nil && !isNil(o.DoorLockIds) {
		return true
	}
...
func (o *InlineObject316) SetDoorLockIds(v []string) {
	o.DoorLockIds = v
}
