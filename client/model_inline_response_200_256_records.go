...
// InlineResponse200256Records struct for InlineResponse200256Records
type InlineResponse200256Records struct {
	...
	ClientVpnConnections []InlineResponse200256ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200256Records() *InlineResponse200256Records {
	this := InlineResponse200256Records{}
	return &this
}
...
func (o *InlineResponse200256Records) GetClientVpnConnections() []InlineResponse200256ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200256ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200256ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200256Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200256Records struct {
	value *InlineResponse200256Records
	isSet bool
}

func (v NullableInlineResponse200256Records) Get() *InlineResponse200256Records {
	return v.value
}

func (v *NullableInlineResponse200256Records) Set(val *InlineResponse200256Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200256Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200256Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200256Records(val *InlineResponse200256Records) *NullableInlineResponse200256Records {
	return &NullableInlineResponse200256Records{value: val, isSet: true}
}

func (v NullableInlineResponse200256Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200256Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
