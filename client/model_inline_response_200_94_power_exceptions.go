...
// InlineResponse20094PowerExceptions struct for InlineResponse20094PowerExceptions
type InlineResponse20094PowerExceptions struct {
...
func NewInlineResponse20094PowerExceptions() *InlineResponse20094PowerExceptions {
	this := InlineResponse20094PowerExceptions{}
	return &this
}
...
func (o InlineResponse20094PowerExceptions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20094PowerExceptions struct {
	value *InlineResponse20094PowerExceptions
	isSet bool
}

func (v NullableInlineResponse20094PowerExceptions) Get() *InlineResponse20094PowerExceptions {
	return v.value
}

func (v *NullableInlineResponse20094PowerExceptions) Set(val *InlineResponse20094PowerExceptions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20094PowerExceptions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20094PowerExceptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20094PowerExceptions(val *InlineResponse20094PowerExceptions) *NullableInlineResponse20094PowerExceptions {
	return &NullableInlineResponse20094PowerExceptions{value: val, isSet: true}
}

func (v NullableInlineResponse20094PowerExceptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20094PowerExceptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
