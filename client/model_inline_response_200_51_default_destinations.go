...
// InlineResponse20051DefaultDestinations The network-wide destinations for all alerts on the network.
type InlineResponse20051DefaultDestinations struct {
...
func NewInlineResponse20051DefaultDestinations() *InlineResponse20051DefaultDestinations {
	this := InlineResponse20051DefaultDestinations{}
	return &this
}
...
func (o InlineResponse20051DefaultDestinations) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20051DefaultDestinations struct {
	value *InlineResponse20051DefaultDestinations
	isSet bool
}

func (v NullableInlineResponse20051DefaultDestinations) Get() *InlineResponse20051DefaultDestinations {
	return v.value
}

func (v *NullableInlineResponse20051DefaultDestinations) Set(val *InlineResponse20051DefaultDestinations) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20051DefaultDestinations) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20051DefaultDestinations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20051DefaultDestinations(val *InlineResponse20051DefaultDestinations) *NullableInlineResponse20051DefaultDestinations {
	return &NullableInlineResponse20051DefaultDestinations{value: val, isSet: true}
}

func (v NullableInlineResponse20051DefaultDestinations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20051DefaultDestinations) UnmarshalJSON(src []byte) error {
	v.isSet = true
