...
type InlineObject171 struct {
	...
	Identity *InlineResponse200111Identity `json:"identity,omitempty"`
	// Maximum number of general EAP retries.
	MaxRetries *int32 `json:"maxRetries,omitempty"`
	EapolKey *InlineResponse200111EapolKey `json:"eapolKey,omitempty"`
}
...
func (o *InlineObject171) GetIdentity() InlineResponse200111Identity {
	if o == nil || isNil(o.Identity) {
		var ret InlineResponse200111Identity
		return ret
	}
	return *o.Identity
}
...
// SetIdentity gets a reference to the given InlineResponse200111Identity and assigns it to the Identity field.
...
func (o *InlineObject171) GetEapolKey() InlineResponse200111EapolKey {
	if o == nil || isNil(o.EapolKey) {
		var ret InlineResponse200111EapolKey
		return ret
	}
	return *o.EapolKey
}
...
// SetEapolKey gets a reference to the given InlineResponse200111EapolKey and assigns it to the EapolKey field.
