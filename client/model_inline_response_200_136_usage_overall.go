...
// InlineResponse200136UsageOverall Overall data usage of all clients across organization
type InlineResponse200136UsageOverall struct {
...
func NewInlineResponse200136UsageOverall() *InlineResponse200136UsageOverall {
	this := InlineResponse200136UsageOverall{}
	return &this
}
...
func (o InlineResponse200136UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200136UsageOverall struct {
	value *InlineResponse200136UsageOverall
	isSet bool
}

func (v NullableInlineResponse200136UsageOverall) Get() *InlineResponse200136UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200136UsageOverall) Set(val *InlineResponse200136UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200136UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200136UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200136UsageOverall(val *InlineResponse200136UsageOverall) *NullableInlineResponse200136UsageOverall {
	return &NullableInlineResponse200136UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200136UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200136UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
