...
// InlineResponse200419Intervals struct for InlineResponse200419Intervals
type InlineResponse200419Intervals struct {
	// The start time of the query range with iso8601 format
	StartTs *string `json:"startTs,omitempty"`
	// The end time of the query range  with iso8601 format
	EndTs *string `json:"endTs,omitempty"`
	Overall *InlineResponse200419Overall `json:"overall,omitempty"`
	// The CPU usage per core of the wireless LAN controller
	ByCore []InlineResponse200419ByCore `json:"byCore,omitempty"`
}
...
func NewInlineResponse200419Intervals() *InlineResponse200419Intervals {
	this := InlineResponse200419Intervals{}
	return &this
}
...
func (o *InlineResponse200419Intervals) GetOverall() InlineResponse200419Overall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200419Overall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200419Overall and assigns it to the Overall field.
...
func (o *InlineResponse200419Intervals) GetByCore() []InlineResponse200419ByCore {
	if o == nil || isNil(o.ByCore) {
		var ret []InlineResponse200419ByCore
		return ret
	}
	return o.ByCore
}
...
// SetByCore gets a reference to the given []InlineResponse200419ByCore and assigns it to the ByCore field.
func (o *InlineResponse200419Intervals) SetByCore(v []InlineResponse200419ByCore) {
	o.ByCore = v
}

func (o InlineResponse200419Intervals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200419Intervals struct {
	value *InlineResponse200419Intervals
	isSet bool
}

func (v NullableInlineResponse200419Intervals) Get() *InlineResponse200419Intervals {
	return v.value
}

func (v *NullableInlineResponse200419Intervals) Set(val *InlineResponse200419Intervals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200419Intervals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200419Intervals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200419Intervals(val *InlineResponse200419Intervals) *NullableInlineResponse200419Intervals {
	return &NullableInlineResponse200419Intervals{value: val, isSet: true}
}

func (v NullableInlineResponse200419Intervals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200419Intervals) UnmarshalJSON(src []byte) error {
	v.isSet = true
