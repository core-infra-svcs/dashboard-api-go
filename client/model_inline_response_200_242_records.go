...
// InlineResponse200242Records struct for InlineResponse200242Records
type InlineResponse200242Records struct {
	...
	ClientVpnConnections []InlineResponse200242ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200242Records() *InlineResponse200242Records {
	this := InlineResponse200242Records{}
	return &this
}
...
func (o *InlineResponse200242Records) GetClientVpnConnections() []InlineResponse200242ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200242ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200242ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200242Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200242Records struct {
	value *InlineResponse200242Records
	isSet bool
}

func (v NullableInlineResponse200242Records) Get() *InlineResponse200242Records {
	return v.value
}

func (v *NullableInlineResponse200242Records) Set(val *InlineResponse200242Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200242Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200242Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200242Records(val *InlineResponse200242Records) *NullableInlineResponse200242Records {
	return &NullableInlineResponse200242Records{value: val, isSet: true}
}

func (v NullableInlineResponse200242Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200242Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
