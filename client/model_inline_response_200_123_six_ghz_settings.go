...
// InlineResponse200123SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200123SixGhzSettings struct {
...
func NewInlineResponse200123SixGhzSettings() *InlineResponse200123SixGhzSettings {
	this := InlineResponse200123SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200123SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200123SixGhzSettings struct {
	value *InlineResponse200123SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200123SixGhzSettings) Get() *InlineResponse200123SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200123SixGhzSettings) Set(val *InlineResponse200123SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200123SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200123SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200123SixGhzSettings(val *InlineResponse200123SixGhzSettings) *NullableInlineResponse200123SixGhzSettings {
	return &NullableInlineResponse200123SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200123SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200123SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
