...
// InlineResponse20011Addresses struct for InlineResponse20011Addresses
type InlineResponse20011Addresses struct {
...
func NewInlineResponse20011Addresses() *InlineResponse20011Addresses {
	this := InlineResponse20011Addresses{}
	return &this
}
...
func (o InlineResponse20011Addresses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20011Addresses struct {
	value *InlineResponse20011Addresses
	isSet bool
}

func (v NullableInlineResponse20011Addresses) Get() *InlineResponse20011Addresses {
	return v.value
}

func (v *NullableInlineResponse20011Addresses) Set(val *InlineResponse20011Addresses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20011Addresses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20011Addresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20011Addresses(val *InlineResponse20011Addresses) *NullableInlineResponse20011Addresses {
	return &NullableInlineResponse20011Addresses{value: val, isSet: true}
}

func (v NullableInlineResponse20011Addresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20011Addresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
