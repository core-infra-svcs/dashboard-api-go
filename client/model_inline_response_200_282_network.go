...
// InlineResponse200282Network Information regarding the network the device belongs to
type InlineResponse200282Network struct {
	// The network ID
...
func NewInlineResponse200282Network() *InlineResponse200282Network {
	this := InlineResponse200282Network{}
	return &this
}
...
func (o InlineResponse200282Network) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200282Network struct {
	value *InlineResponse200282Network
	isSet bool
}

func (v NullableInlineResponse200282Network) Get() *InlineResponse200282Network {
	return v.value
}

func (v *NullableInlineResponse200282Network) Set(val *InlineResponse200282Network) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200282Network) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200282Network) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200282Network(val *InlineResponse200282Network) *NullableInlineResponse200282Network {
	return &NullableInlineResponse200282Network{value: val, isSet: true}
}

func (v NullableInlineResponse200282Network) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200282Network) UnmarshalJSON(src []byte) error {
	v.isSet = true
