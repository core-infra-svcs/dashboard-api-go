...
// InlineResponse20023DynamicDns Dynamic DNS settings for a network
type InlineResponse20023DynamicDns struct {
	// Dynamic DNS enabled
...
func NewInlineResponse20023DynamicDns() *InlineResponse20023DynamicDns {
	this := InlineResponse20023DynamicDns{}
	return &this
}
...
func (o InlineResponse20023DynamicDns) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20023DynamicDns struct {
	value *InlineResponse20023DynamicDns
	isSet bool
}

func (v NullableInlineResponse20023DynamicDns) Get() *InlineResponse20023DynamicDns {
	return v.value
}

func (v *NullableInlineResponse20023DynamicDns) Set(val *InlineResponse20023DynamicDns) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20023DynamicDns) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20023DynamicDns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20023DynamicDns(val *InlineResponse20023DynamicDns) *NullableInlineResponse20023DynamicDns {
	return &NullableInlineResponse20023DynamicDns{value: val, isSet: true}
}

func (v NullableInlineResponse20023DynamicDns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20023DynamicDns) UnmarshalJSON(src []byte) error {
	v.isSet = true
