...
type InlineResponse200389 struct {
	...
	// Door locks
	DoorLocks []InlineResponse200389DoorLocks `json:"doorLocks,omitempty"`
}
...
func (o *InlineResponse200389) GetDoorLocks() []InlineResponse200389DoorLocks {
	if o == nil || isNil(o.DoorLocks) {
		var ret []InlineResponse200389DoorLocks
		return ret
	}
	return o.DoorLocks
}
...
// SetDoorLocks gets a reference to the given []InlineResponse200389DoorLocks and assigns it to the DoorLocks field.
