...
// InlineResponse20018PerSsidSettings Per-SSID radio settings by number.
type InlineResponse20018PerSsidSettings struct {
	Var1 *InlineResponse20018PerSsidSettings1 `json:"1,omitempty"`
	Var2 *InlineResponse20018PerSsidSettings2 `json:"2,omitempty"`
	Var3 *InlineResponse20018PerSsidSettings3 `json:"3,omitempty"`
	Var4 *InlineResponse20018PerSsidSettings4 `json:"4,omitempty"`
}
...
func NewInlineResponse20018PerSsidSettings() *InlineResponse20018PerSsidSettings {
	this := InlineResponse20018PerSsidSettings{}
	return &this
}
...
func (o *InlineResponse20018PerSsidSettings) GetVar1() InlineResponse20018PerSsidSettings1 {
	if o == nil || isNil(o.Var1) {
		var ret InlineResponse20018PerSsidSettings1
		return ret
	}
	return *o.Var1
}
...
// SetVar1 gets a reference to the given InlineResponse20018PerSsidSettings1 and assigns it to the Var1 field.
...
func (o *InlineResponse20018PerSsidSettings) GetVar2() InlineResponse20018PerSsidSettings2 {
	if o == nil || isNil(o.Var2) {
		var ret InlineResponse20018PerSsidSettings2
		return ret
	}
	return *o.Var2
}
...
// SetVar2 gets a reference to the given InlineResponse20018PerSsidSettings2 and assigns it to the Var2 field.
...
func (o *InlineResponse20018PerSsidSettings) GetVar3() InlineResponse20018PerSsidSettings3 {
	if o == nil || isNil(o.Var3) {
		var ret InlineResponse20018PerSsidSettings3
		return ret
	}
	return *o.Var3
}
...
// SetVar3 gets a reference to the given InlineResponse20018PerSsidSettings3 and assigns it to the Var3 field.
...
func (o *InlineResponse20018PerSsidSettings) GetVar4() InlineResponse20018PerSsidSettings4 {
	if o == nil || isNil(o.Var4) {
		var ret InlineResponse20018PerSsidSettings4
		return ret
	}
	return *o.Var4
}
...
// SetVar4 gets a reference to the given InlineResponse20018PerSsidSettings4 and assigns it to the Var4 field.
func (o *InlineResponse20018PerSsidSettings) SetVar4(v InlineResponse20018PerSsidSettings4) {
	o.Var4 = &v
}

func (o InlineResponse20018PerSsidSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20018PerSsidSettings struct {
	value *InlineResponse20018PerSsidSettings
	isSet bool
}

func (v NullableInlineResponse20018PerSsidSettings) Get() *InlineResponse20018PerSsidSettings {
	return v.value
}

func (v *NullableInlineResponse20018PerSsidSettings) Set(val *InlineResponse20018PerSsidSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20018PerSsidSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20018PerSsidSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20018PerSsidSettings(val *InlineResponse20018PerSsidSettings) *NullableInlineResponse20018PerSsidSettings {
	return &NullableInlineResponse20018PerSsidSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20018PerSsidSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20018PerSsidSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
