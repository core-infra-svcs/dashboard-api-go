...
func (o *InlineResponse200120) GetIds() []string {
...
func (o *InlineResponse200120) GetIdsOk() ([]string, bool) {
	if o == nil || isNil(o.Ids) {
    return nil, false
	}
	return o.Ids, true
...
func (o *InlineResponse200120) HasIds() bool {
	if o != nil && !isNil(o.Ids) {
		return true
	}
...
func (o *InlineResponse200120) SetIds(v []string) {
	o.Ids = v
}

// GetNewNetwork returns the NewNetwork field value if set, zero value otherwise.
func (o *InlineResponse200120) GetNewNetwork() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200120) GetNewNetworkOk() (*string, bool) {
	if o == nil || isNil(o.NewNetwork) {
    return nil, false
	}
...
func (o *InlineResponse200120) HasNewNetwork() bool {
	if o != nil && !isNil(o.NewNetwork) {
		return true
	}
...
func (o *InlineResponse200120) SetNewNetwork(v string) {
	o.NewNetwork = &v
}
