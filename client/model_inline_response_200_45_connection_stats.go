...
// InlineResponse20045ConnectionStats The connection stats of the device
type InlineResponse20045ConnectionStats struct {
...
func NewInlineResponse20045ConnectionStats() *InlineResponse20045ConnectionStats {
	this := InlineResponse20045ConnectionStats{}
	return &this
}
...
func (o InlineResponse20045ConnectionStats) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20045ConnectionStats struct {
	value *InlineResponse20045ConnectionStats
	isSet bool
}

func (v NullableInlineResponse20045ConnectionStats) Get() *InlineResponse20045ConnectionStats {
	return v.value
}

func (v *NullableInlineResponse20045ConnectionStats) Set(val *InlineResponse20045ConnectionStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20045ConnectionStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20045ConnectionStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20045ConnectionStats(val *InlineResponse20045ConnectionStats) *NullableInlineResponse20045ConnectionStats {
	return &NullableInlineResponse20045ConnectionStats{value: val, isSet: true}
}

func (v NullableInlineResponse20045ConnectionStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20045ConnectionStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
