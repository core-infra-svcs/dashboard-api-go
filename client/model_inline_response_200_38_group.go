...
// InlineResponse20038Group The staged upgrade group
type InlineResponse20038Group struct {
...
func (o InlineResponse20038Group) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20038Group struct {
	value *InlineResponse20038Group
	isSet bool
}

func (v NullableInlineResponse20038Group) Get() *InlineResponse20038Group {
	return v.value
}

func (v *NullableInlineResponse20038Group) Set(val *InlineResponse20038Group) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20038Group) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20038Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20038Group(val *InlineResponse20038Group) *NullableInlineResponse20038Group {
	return &NullableInlineResponse20038Group{value: val, isSet: true}
}

func (v NullableInlineResponse20038Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20038Group) UnmarshalJSON(src []byte) error {
	v.isSet = true
