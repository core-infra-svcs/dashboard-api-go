...
// InlineResponse200286Policies struct for InlineResponse200286Policies
type InlineResponse200286Policies struct {
...
func NewInlineResponse200286Policies() *InlineResponse200286Policies {
	this := InlineResponse200286Policies{}
	return &this
}
...
func (o InlineResponse200286Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200286Policies struct {
	value *InlineResponse200286Policies
	isSet bool
}

func (v NullableInlineResponse200286Policies) Get() *InlineResponse200286Policies {
	return v.value
}

func (v *NullableInlineResponse200286Policies) Set(val *InlineResponse200286Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200286Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200286Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200286Policies(val *InlineResponse200286Policies) *NullableInlineResponse200286Policies {
	return &NullableInlineResponse200286Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200286Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200286Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
