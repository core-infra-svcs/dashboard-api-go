...
// InlineResponse20051Alerts struct for InlineResponse20051Alerts
type InlineResponse20051Alerts struct {
	// The type of alert
	Type string `json:"type"`
	// A boolean depicting if the alert is turned on or off
	Enabled *bool `json:"enabled,omitempty"`
	AlertDestinations *InlineResponse20051AlertDestinations `json:"alertDestinations,omitempty"`
	Filters *InlineResponse20051Filters `json:"filters,omitempty"`
}
...
func NewInlineResponse20051Alerts(type_ string) *InlineResponse20051Alerts {
	this := InlineResponse20051Alerts{}
	this.Type = type_
	return &this
}
...
func (o *InlineResponse20051Alerts) GetAlertDestinations() InlineResponse20051AlertDestinations {
	if o == nil || isNil(o.AlertDestinations) {
		var ret InlineResponse20051AlertDestinations
		return ret
	}
...
// SetAlertDestinations gets a reference to the given InlineResponse20051AlertDestinations and assigns it to the AlertDestinations field.
...
func (o *InlineResponse20051Alerts) GetFilters() InlineResponse20051Filters {
	if o == nil || isNil(o.Filters) {
		var ret InlineResponse20051Filters
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given InlineResponse20051Filters and assigns it to the Filters field.
func (o *InlineResponse20051Alerts) SetFilters(v InlineResponse20051Filters) {
	o.Filters = &v
}

func (o InlineResponse20051Alerts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20051Alerts struct {
	value *InlineResponse20051Alerts
	isSet bool
}

func (v NullableInlineResponse20051Alerts) Get() *InlineResponse20051Alerts {
	return v.value
}

func (v *NullableInlineResponse20051Alerts) Set(val *InlineResponse20051Alerts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20051Alerts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20051Alerts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20051Alerts(val *InlineResponse20051Alerts) *NullableInlineResponse20051Alerts {
	return &NullableInlineResponse20051Alerts{value: val, isSet: true}
}

func (v NullableInlineResponse20051Alerts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20051Alerts) UnmarshalJSON(src []byte) error {
	v.isSet = true
