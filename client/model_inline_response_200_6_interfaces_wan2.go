...
// InlineResponse2006InterfacesWan2 WAN 2 settings.
type InlineResponse2006InterfacesWan2 struct {
...
func NewInlineResponse2006InterfacesWan2() *InlineResponse2006InterfacesWan2 {
	this := InlineResponse2006InterfacesWan2{}
	return &this
}
...
func (o InlineResponse2006InterfacesWan2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2006InterfacesWan2 struct {
	value *InlineResponse2006InterfacesWan2
	isSet bool
}

func (v NullableInlineResponse2006InterfacesWan2) Get() *InlineResponse2006InterfacesWan2 {
	return v.value
}

func (v *NullableInlineResponse2006InterfacesWan2) Set(val *InlineResponse2006InterfacesWan2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2006InterfacesWan2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2006InterfacesWan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2006InterfacesWan2(val *InlineResponse2006InterfacesWan2) *NullableInlineResponse2006InterfacesWan2 {
	return &NullableInlineResponse2006InterfacesWan2{value: val, isSet: true}
}

func (v NullableInlineResponse2006InterfacesWan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2006InterfacesWan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
