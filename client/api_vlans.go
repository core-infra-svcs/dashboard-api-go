...
func (r VlansApiGetNetworkApplianceVlanRequest) Execute() (*InlineResponse20028, *http.Response, error) {
...
func (a *VlansApiService) GetNetworkApplianceVlanExecute(r VlansApiGetNetworkApplianceVlanRequest) (*InlineResponse20028, *http.Response, error) {
	var (
...
func (r VlansApiGetNetworkApplianceVlansRequest) Execute() ([]InlineResponse20028, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20028
func (a *VlansApiService) GetNetworkApplianceVlansExecute(r VlansApiGetNetworkApplianceVlansRequest) ([]InlineResponse20028, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlansApiUpdateNetworkApplianceVlanRequest) Execute() (*InlineResponse20028, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20028
func (a *VlansApiService) UpdateNetworkApplianceVlanExecute(r VlansApiUpdateNetworkApplianceVlanRequest) (*InlineResponse20028, *http.Response, error) {
	var (
