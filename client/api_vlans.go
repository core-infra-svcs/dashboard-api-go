...
func (r VlansApiCreateNetworkApplianceVlanRequest) CreateNetworkApplianceVlan(createNetworkApplianceVlan InlineObject75) VlansApiCreateNetworkApplianceVlanRequest {
...
func (r VlansApiGetNetworkApplianceVlanRequest) Execute() (*InlineResponse20076, *http.Response, error) {
...
func (a *VlansApiService) GetNetworkApplianceVlanExecute(r VlansApiGetNetworkApplianceVlanRequest) (*InlineResponse20076, *http.Response, error) {
	var (
...
func (r VlansApiGetNetworkApplianceVlansRequest) Execute() ([]InlineResponse20076, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20076
func (a *VlansApiService) GetNetworkApplianceVlansExecute(r VlansApiGetNetworkApplianceVlansRequest) ([]InlineResponse20076, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlansApiGetNetworkApplianceVlansSettingsRequest) Execute() (*InlineResponse20077, *http.Response, error) {
...
func (a *VlansApiService) GetNetworkApplianceVlansSettingsExecute(r VlansApiGetNetworkApplianceVlansSettingsRequest) (*InlineResponse20077, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlansApiUpdateNetworkApplianceVlanRequest) UpdateNetworkApplianceVlan(updateNetworkApplianceVlan InlineObject77) VlansApiUpdateNetworkApplianceVlanRequest {
	r.updateNetworkApplianceVlan = &updateNetworkApplianceVlan
	return r
}

func (r VlansApiUpdateNetworkApplianceVlanRequest) Execute() (*InlineResponse20076, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20076
func (a *VlansApiService) UpdateNetworkApplianceVlanExecute(r VlansApiUpdateNetworkApplianceVlanRequest) (*InlineResponse20076, *http.Response, error) {
	var (
...
func (r VlansApiUpdateNetworkApplianceVlansSettingsRequest) UpdateNetworkApplianceVlansSettings(updateNetworkApplianceVlansSettings InlineObject76) VlansApiUpdateNetworkApplianceVlansSettingsRequest {
	r.updateNetworkApplianceVlansSettings = &updateNetworkApplianceVlansSettings
	return r
}

func (r VlansApiUpdateNetworkApplianceVlansSettingsRequest) Execute() (*InlineResponse20077, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20077
func (a *VlansApiService) UpdateNetworkApplianceVlansSettingsExecute(r VlansApiUpdateNetworkApplianceVlansSettingsRequest) (*InlineResponse20077, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
