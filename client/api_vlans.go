...
func (r VlansApiCreateNetworkApplianceVlanRequest) Execute() (*InlineResponse2019, *http.Response, error) {
...
func (a *VlansApiService) CreateNetworkApplianceVlanExecute(r VlansApiCreateNetworkApplianceVlanRequest) (*InlineResponse2019, *http.Response, error) {
	var (
...
func (r VlansApiGetNetworkApplianceVlanRequest) Execute() (*InlineResponse20073, *http.Response, error) {
...
func (a *VlansApiService) GetNetworkApplianceVlanExecute(r VlansApiGetNetworkApplianceVlanRequest) (*InlineResponse20073, *http.Response, error) {
	var (
...
func (r VlansApiGetNetworkApplianceVlansRequest) Execute() ([]InlineResponse20073, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20073
func (a *VlansApiService) GetNetworkApplianceVlansExecute(r VlansApiGetNetworkApplianceVlansRequest) ([]InlineResponse20073, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlansApiGetNetworkApplianceVlansSettingsRequest) Execute() (*InlineResponse20074, *http.Response, error) {
...
func (a *VlansApiService) GetNetworkApplianceVlansSettingsExecute(r VlansApiGetNetworkApplianceVlansSettingsRequest) (*InlineResponse20074, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlansApiUpdateNetworkApplianceVlanRequest) Execute() (*InlineResponse20073, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20073
func (a *VlansApiService) UpdateNetworkApplianceVlanExecute(r VlansApiUpdateNetworkApplianceVlanRequest) (*InlineResponse20073, *http.Response, error) {
	var (
...
func (r VlansApiUpdateNetworkApplianceVlansSettingsRequest) Execute() (*InlineResponse20074, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20074
func (a *VlansApiService) UpdateNetworkApplianceVlansSettingsExecute(r VlansApiUpdateNetworkApplianceVlansSettingsRequest) (*InlineResponse20074, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
