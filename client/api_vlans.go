...
func (r VlansApiCreateNetworkApplianceVlanRequest) Execute() (*InlineResponse2017, *http.Response, error) {
...
func (a *VlansApiService) CreateNetworkApplianceVlanExecute(r VlansApiCreateNetworkApplianceVlanRequest) (*InlineResponse2017, *http.Response, error) {
	var (
