...
func (r VlansApiCreateNetworkApplianceVlanRequest) CreateNetworkApplianceVlan(createNetworkApplianceVlan InlineObject74) VlansApiCreateNetworkApplianceVlanRequest {
	r.createNetworkApplianceVlan = &createNetworkApplianceVlan
	return r
}

func (r VlansApiCreateNetworkApplianceVlanRequest) Execute() (*InlineResponse20110, *http.Response, error) {
...
func (a *VlansApiService) CreateNetworkApplianceVlanExecute(r VlansApiCreateNetworkApplianceVlanRequest) (*InlineResponse20110, *http.Response, error) {
	var (
...
func (r VlansApiGetNetworkApplianceVlanRequest) Execute() (*InlineResponse20074, *http.Response, error) {
...
func (a *VlansApiService) GetNetworkApplianceVlanExecute(r VlansApiGetNetworkApplianceVlanRequest) (*InlineResponse20074, *http.Response, error) {
	var (
...
func (r VlansApiGetNetworkApplianceVlansRequest) Execute() ([]InlineResponse20074, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20074
func (a *VlansApiService) GetNetworkApplianceVlansExecute(r VlansApiGetNetworkApplianceVlansRequest) ([]InlineResponse20074, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlansApiGetNetworkApplianceVlansSettingsRequest) Execute() (*InlineResponse20075, *http.Response, error) {
...
func (a *VlansApiService) GetNetworkApplianceVlansSettingsExecute(r VlansApiGetNetworkApplianceVlansSettingsRequest) (*InlineResponse20075, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlansApiUpdateNetworkApplianceVlanRequest) UpdateNetworkApplianceVlan(updateNetworkApplianceVlan InlineObject76) VlansApiUpdateNetworkApplianceVlanRequest {
	r.updateNetworkApplianceVlan = &updateNetworkApplianceVlan
	return r
}

func (r VlansApiUpdateNetworkApplianceVlanRequest) Execute() (*InlineResponse20074, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20074
func (a *VlansApiService) UpdateNetworkApplianceVlanExecute(r VlansApiUpdateNetworkApplianceVlanRequest) (*InlineResponse20074, *http.Response, error) {
	var (
...
func (r VlansApiUpdateNetworkApplianceVlansSettingsRequest) UpdateNetworkApplianceVlansSettings(updateNetworkApplianceVlansSettings InlineObject75) VlansApiUpdateNetworkApplianceVlansSettingsRequest {
	r.updateNetworkApplianceVlansSettings = &updateNetworkApplianceVlansSettings
	return r
}

func (r VlansApiUpdateNetworkApplianceVlansSettingsRequest) Execute() (*InlineResponse20075, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20075
func (a *VlansApiService) UpdateNetworkApplianceVlansSettingsExecute(r VlansApiUpdateNetworkApplianceVlansSettingsRequest) (*InlineResponse20075, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
