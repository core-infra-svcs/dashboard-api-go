...
func (r VlansApiCreateNetworkApplianceVlanRequest) CreateNetworkApplianceVlan(createNetworkApplianceVlan InlineObject72) VlansApiCreateNetworkApplianceVlanRequest {
	r.createNetworkApplianceVlan = &createNetworkApplianceVlan
	return r
}

func (r VlansApiCreateNetworkApplianceVlanRequest) Execute() (*InlineResponse2018, *http.Response, error) {
...
func (a *VlansApiService) CreateNetworkApplianceVlanExecute(r VlansApiCreateNetworkApplianceVlanRequest) (*InlineResponse2018, *http.Response, error) {
	var (
...
func (r VlansApiGetNetworkApplianceVlanRequest) Execute() (*InlineResponse20068, *http.Response, error) {
...
func (a *VlansApiService) GetNetworkApplianceVlanExecute(r VlansApiGetNetworkApplianceVlanRequest) (*InlineResponse20068, *http.Response, error) {
	var (
...
func (r VlansApiGetNetworkApplianceVlansRequest) Execute() ([]InlineResponse20068, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20068
func (a *VlansApiService) GetNetworkApplianceVlansExecute(r VlansApiGetNetworkApplianceVlansRequest) ([]InlineResponse20068, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlansApiGetNetworkApplianceVlansSettingsRequest) Execute() (*InlineResponse20069, *http.Response, error) {
...
func (a *VlansApiService) GetNetworkApplianceVlansSettingsExecute(r VlansApiGetNetworkApplianceVlansSettingsRequest) (*InlineResponse20069, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlansApiUpdateNetworkApplianceVlanRequest) UpdateNetworkApplianceVlan(updateNetworkApplianceVlan InlineObject74) VlansApiUpdateNetworkApplianceVlanRequest {
	r.updateNetworkApplianceVlan = &updateNetworkApplianceVlan
	return r
}

func (r VlansApiUpdateNetworkApplianceVlanRequest) Execute() (*InlineResponse20068, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20068
func (a *VlansApiService) UpdateNetworkApplianceVlanExecute(r VlansApiUpdateNetworkApplianceVlanRequest) (*InlineResponse20068, *http.Response, error) {
	var (
...
func (r VlansApiUpdateNetworkApplianceVlansSettingsRequest) UpdateNetworkApplianceVlansSettings(updateNetworkApplianceVlansSettings InlineObject73) VlansApiUpdateNetworkApplianceVlansSettingsRequest {
	r.updateNetworkApplianceVlansSettings = &updateNetworkApplianceVlansSettings
	return r
}

func (r VlansApiUpdateNetworkApplianceVlansSettingsRequest) Execute() (*InlineResponse20069, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20069
func (a *VlansApiService) UpdateNetworkApplianceVlansSettingsExecute(r VlansApiUpdateNetworkApplianceVlansSettingsRequest) (*InlineResponse20069, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
