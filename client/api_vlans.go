...
func (r VlansApiCreateNetworkApplianceVlanRequest) CreateNetworkApplianceVlan(createNetworkApplianceVlan InlineObject67) VlansApiCreateNetworkApplianceVlanRequest {
	r.createNetworkApplianceVlan = &createNetworkApplianceVlan
	return r
}

func (r VlansApiCreateNetworkApplianceVlanRequest) Execute() (*InlineResponse2015, *http.Response, error) {
...
func (a *VlansApiService) CreateNetworkApplianceVlanExecute(r VlansApiCreateNetworkApplianceVlanRequest) (*InlineResponse2015, *http.Response, error) {
	var (
...
func (r VlansApiGetNetworkApplianceVlanRequest) Execute() (*InlineResponse20034, *http.Response, error) {
...
func (a *VlansApiService) GetNetworkApplianceVlanExecute(r VlansApiGetNetworkApplianceVlanRequest) (*InlineResponse20034, *http.Response, error) {
	var (
...
func (r VlansApiGetNetworkApplianceVlansRequest) Execute() ([]InlineResponse20034, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20034
func (a *VlansApiService) GetNetworkApplianceVlansExecute(r VlansApiGetNetworkApplianceVlansRequest) ([]InlineResponse20034, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlansApiUpdateNetworkApplianceVlanRequest) UpdateNetworkApplianceVlan(updateNetworkApplianceVlan InlineObject69) VlansApiUpdateNetworkApplianceVlanRequest {
	r.updateNetworkApplianceVlan = &updateNetworkApplianceVlan
	return r
}

func (r VlansApiUpdateNetworkApplianceVlanRequest) Execute() (*InlineResponse20034, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20034
func (a *VlansApiService) UpdateNetworkApplianceVlanExecute(r VlansApiUpdateNetworkApplianceVlanRequest) (*InlineResponse20034, *http.Response, error) {
	var (
...
func (r VlansApiUpdateNetworkApplianceVlansSettingsRequest) UpdateNetworkApplianceVlansSettings(updateNetworkApplianceVlansSettings InlineObject68) VlansApiUpdateNetworkApplianceVlansSettingsRequest {
