...
type InlineResponse200297 struct {
	...
	Items []InlineResponse200297Items `json:"items,omitempty"`
...
// SetItems gets a reference to the given []InlineResponse200297Items and assigns it to the Items field.
