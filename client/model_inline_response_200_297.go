...
type InlineResponse200297 struct {
	...
	States *InlineResponse200297States `json:"states,omitempty"`
	// Data by license type (Per-device licensing only)
	LicenseTypes []InlineResponse200297LicenseTypes `json:"licenseTypes,omitempty"`
	SystemsManager *InlineResponse200297SystemsManager `json:"systemsManager,omitempty"`
}
...
func (o *InlineResponse200297) GetStates() InlineResponse200297States {
	if o == nil || isNil(o.States) {
		var ret InlineResponse200297States
		return ret
	}
	return *o.States
}
...
// SetStates gets a reference to the given InlineResponse200297States and assigns it to the States field.
...
func (o *InlineResponse200297) GetLicenseTypes() []InlineResponse200297LicenseTypes {
	if o == nil || isNil(o.LicenseTypes) {
		var ret []InlineResponse200297LicenseTypes
		return ret
	}
...
// SetLicenseTypes gets a reference to the given []InlineResponse200297LicenseTypes and assigns it to the LicenseTypes field.
...
func (o *InlineResponse200297) GetSystemsManager() InlineResponse200297SystemsManager {
	if o == nil || isNil(o.SystemsManager) {
		var ret InlineResponse200297SystemsManager
		return ret
	}
...
// SetSystemsManager gets a reference to the given InlineResponse200297SystemsManager and assigns it to the SystemsManager field.
