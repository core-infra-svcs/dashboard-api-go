...
// InlineResponse200155Switches struct for InlineResponse200155Switches
type InlineResponse200155Switches struct {
...
func NewInlineResponse200155Switches() *InlineResponse200155Switches {
	this := InlineResponse200155Switches{}
	return &this
}
...
func (o InlineResponse200155Switches) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200155Switches struct {
	value *InlineResponse200155Switches
	isSet bool
}

func (v NullableInlineResponse200155Switches) Get() *InlineResponse200155Switches {
	return v.value
}

func (v *NullableInlineResponse200155Switches) Set(val *InlineResponse200155Switches) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200155Switches) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200155Switches) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200155Switches(val *InlineResponse200155Switches) *NullableInlineResponse200155Switches {
	return &NullableInlineResponse200155Switches{value: val, isSet: true}
}

func (v NullableInlineResponse200155Switches) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200155Switches) UnmarshalJSON(src []byte) error {
	v.isSet = true
