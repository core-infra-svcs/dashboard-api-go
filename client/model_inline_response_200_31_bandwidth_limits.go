...
// InlineResponse20031BandwidthLimits A hash uplink keys and their configured settings for the Appliance
type InlineResponse20031BandwidthLimits struct {
	Wan1 *InlineResponse20031BandwidthLimitsWan1 `json:"wan1,omitempty"`
	Wan2 *InlineResponse20031BandwidthLimitsWan2 `json:"wan2,omitempty"`
	Cellular *InlineResponse20031BandwidthLimitsCellular `json:"cellular,omitempty"`
}
...
func NewInlineResponse20031BandwidthLimits() *InlineResponse20031BandwidthLimits {
	this := InlineResponse20031BandwidthLimits{}
	return &this
}
...
func (o *InlineResponse20031BandwidthLimits) GetWan1() InlineResponse20031BandwidthLimitsWan1 {
	if o == nil || isNil(o.Wan1) {
		var ret InlineResponse20031BandwidthLimitsWan1
		return ret
	}
	return *o.Wan1
}
...
// SetWan1 gets a reference to the given InlineResponse20031BandwidthLimitsWan1 and assigns it to the Wan1 field.
...
func (o *InlineResponse20031BandwidthLimits) GetWan2() InlineResponse20031BandwidthLimitsWan2 {
	if o == nil || isNil(o.Wan2) {
		var ret InlineResponse20031BandwidthLimitsWan2
		return ret
	}
	return *o.Wan2
}
...
// SetWan2 gets a reference to the given InlineResponse20031BandwidthLimitsWan2 and assigns it to the Wan2 field.
...
func (o *InlineResponse20031BandwidthLimits) GetCellular() InlineResponse20031BandwidthLimitsCellular {
	if o == nil || isNil(o.Cellular) {
		var ret InlineResponse20031BandwidthLimitsCellular
		return ret
	}
	return *o.Cellular
}
...
// SetCellular gets a reference to the given InlineResponse20031BandwidthLimitsCellular and assigns it to the Cellular field.
func (o *InlineResponse20031BandwidthLimits) SetCellular(v InlineResponse20031BandwidthLimitsCellular) {
	o.Cellular = &v
}

func (o InlineResponse20031BandwidthLimits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20031BandwidthLimits struct {
	value *InlineResponse20031BandwidthLimits
	isSet bool
}

func (v NullableInlineResponse20031BandwidthLimits) Get() *InlineResponse20031BandwidthLimits {
	return v.value
}

func (v *NullableInlineResponse20031BandwidthLimits) Set(val *InlineResponse20031BandwidthLimits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20031BandwidthLimits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20031BandwidthLimits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20031BandwidthLimits(val *InlineResponse20031BandwidthLimits) *NullableInlineResponse20031BandwidthLimits {
	return &NullableInlineResponse20031BandwidthLimits{value: val, isSet: true}
}

func (v NullableInlineResponse20031BandwidthLimits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20031BandwidthLimits) UnmarshalJSON(src []byte) error {
	v.isSet = true
