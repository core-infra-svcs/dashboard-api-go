...
type InlineResponse200194 struct {
	...
	ApBandSettings *InlineResponse200194ApBandSettings `json:"apBandSettings,omitempty"`
	...
	SixGhzSettings *InlineResponse200194SixGhzSettings `json:"sixGhzSettings,omitempty"`
	Transmission *InlineResponse200194Transmission `json:"transmission,omitempty"`
	PerSsidSettings *InlineResponse200194PerSsidSettings `json:"perSsidSettings,omitempty"`
...
func (o *InlineResponse200194) GetApBandSettings() InlineResponse200194ApBandSettings {
	if o == nil || isNil(o.ApBandSettings) {
		var ret InlineResponse200194ApBandSettings
		return ret
	}
...
// SetApBandSettings gets a reference to the given InlineResponse200194ApBandSettings and assigns it to the ApBandSettings field.
...
func (o *InlineResponse200194) GetSixGhzSettings() InlineResponse200194SixGhzSettings {
	if o == nil || isNil(o.SixGhzSettings) {
		var ret InlineResponse200194SixGhzSettings
		return ret
	}
...
// SetSixGhzSettings gets a reference to the given InlineResponse200194SixGhzSettings and assigns it to the SixGhzSettings field.
...
func (o *InlineResponse200194) GetPerSsidSettings() InlineResponse200194PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse200194PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse200194PerSsidSettings and assigns it to the PerSsidSettings field.
