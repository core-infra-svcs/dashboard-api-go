...
// InlineResponse20054Assigned struct for InlineResponse20054Assigned
type InlineResponse20054Assigned struct {
	...
	TwoFourGhzSettings *InlineResponse20054TwoFourGhzSettings `json:"twoFourGhzSettings,omitempty"`
	FiveGhzSettings *InlineResponse20054FiveGhzSettings `json:"fiveGhzSettings,omitempty"`
	PerSsidSettings *InlineResponse20054PerSsidSettings `json:"perSsidSettings,omitempty"`
}
...
func NewInlineResponse20054Assigned() *InlineResponse20054Assigned {
	this := InlineResponse20054Assigned{}
	return &this
}
...
func (o *InlineResponse20054Assigned) GetTwoFourGhzSettings() InlineResponse20054TwoFourGhzSettings {
	if o == nil || isNil(o.TwoFourGhzSettings) {
		var ret InlineResponse20054TwoFourGhzSettings
		return ret
	}
...
// SetTwoFourGhzSettings gets a reference to the given InlineResponse20054TwoFourGhzSettings and assigns it to the TwoFourGhzSettings field.
...
func (o *InlineResponse20054Assigned) GetFiveGhzSettings() InlineResponse20054FiveGhzSettings {
	if o == nil || isNil(o.FiveGhzSettings) {
		var ret InlineResponse20054FiveGhzSettings
		return ret
	}
...
// SetFiveGhzSettings gets a reference to the given InlineResponse20054FiveGhzSettings and assigns it to the FiveGhzSettings field.
...
func (o *InlineResponse20054Assigned) GetPerSsidSettings() InlineResponse20054PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse20054PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse20054PerSsidSettings and assigns it to the PerSsidSettings field.
func (o *InlineResponse20054Assigned) SetPerSsidSettings(v InlineResponse20054PerSsidSettings) {
	o.PerSsidSettings = &v
}

func (o InlineResponse20054Assigned) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20054Assigned struct {
	value *InlineResponse20054Assigned
	isSet bool
}

func (v NullableInlineResponse20054Assigned) Get() *InlineResponse20054Assigned {
	return v.value
}

func (v *NullableInlineResponse20054Assigned) Set(val *InlineResponse20054Assigned) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20054Assigned) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20054Assigned) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20054Assigned(val *InlineResponse20054Assigned) *NullableInlineResponse20054Assigned {
	return &NullableInlineResponse20054Assigned{value: val, isSet: true}
}

func (v NullableInlineResponse20054Assigned) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20054Assigned) UnmarshalJSON(src []byte) error {
	v.isSet = true
