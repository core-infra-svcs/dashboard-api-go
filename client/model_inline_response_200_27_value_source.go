...
// InlineResponse20027ValueSource Source of 'custom' type traffic filter
type InlineResponse20027ValueSource struct {
...
func NewInlineResponse20027ValueSource() *InlineResponse20027ValueSource {
	this := InlineResponse20027ValueSource{}
	return &this
}
...
func (o InlineResponse20027ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20027ValueSource struct {
	value *InlineResponse20027ValueSource
	isSet bool
}

func (v NullableInlineResponse20027ValueSource) Get() *InlineResponse20027ValueSource {
	return v.value
}

func (v *NullableInlineResponse20027ValueSource) Set(val *InlineResponse20027ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20027ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20027ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20027ValueSource(val *InlineResponse20027ValueSource) *NullableInlineResponse20027ValueSource {
	return &NullableInlineResponse20027ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20027ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20027ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
