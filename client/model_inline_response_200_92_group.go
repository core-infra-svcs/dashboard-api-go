...
// InlineResponse20092Group The staged upgrade group
type InlineResponse20092Group struct {
...
func (o InlineResponse20092Group) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20092Group struct {
	value *InlineResponse20092Group
	isSet bool
}

func (v NullableInlineResponse20092Group) Get() *InlineResponse20092Group {
	return v.value
}

func (v *NullableInlineResponse20092Group) Set(val *InlineResponse20092Group) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20092Group) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20092Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20092Group(val *InlineResponse20092Group) *NullableInlineResponse20092Group {
	return &NullableInlineResponse20092Group{value: val, isSet: true}
}

func (v NullableInlineResponse20092Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20092Group) UnmarshalJSON(src []byte) error {
	v.isSet = true
