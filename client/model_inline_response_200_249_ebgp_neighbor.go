...
// InlineResponse200249EbgpNeighbor [optional] The BGP neighbor configuration for the VPN peer. Supported only for MX 19.1 and above.
type InlineResponse200249EbgpNeighbor struct {
	// ID of ebgp neighbor
...
func NewInlineResponse200249EbgpNeighbor() *InlineResponse200249EbgpNeighbor {
	this := InlineResponse200249EbgpNeighbor{}
	return &this
}
...
func (o InlineResponse200249EbgpNeighbor) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200249EbgpNeighbor struct {
	value *InlineResponse200249EbgpNeighbor
	isSet bool
}

func (v NullableInlineResponse200249EbgpNeighbor) Get() *InlineResponse200249EbgpNeighbor {
	return v.value
}

func (v *NullableInlineResponse200249EbgpNeighbor) Set(val *InlineResponse200249EbgpNeighbor) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200249EbgpNeighbor) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200249EbgpNeighbor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200249EbgpNeighbor(val *InlineResponse200249EbgpNeighbor) *NullableInlineResponse200249EbgpNeighbor {
	return &NullableInlineResponse200249EbgpNeighbor{value: val, isSet: true}
}

func (v NullableInlineResponse200249EbgpNeighbor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200249EbgpNeighbor) UnmarshalJSON(src []byte) error {
	v.isSet = true
