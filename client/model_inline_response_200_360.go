...
type InlineResponse200360 struct {
	...
	Example *InlineResponse200360Example `json:"example,omitempty"`
}
...
func (o *InlineResponse200360) GetExample() InlineResponse200360Example {
	if o == nil || isNil(o.Example) {
		var ret InlineResponse200360Example
		return ret
	}
	return *o.Example
}
...
// SetExample gets a reference to the given InlineResponse200360Example and assigns it to the Example field.
