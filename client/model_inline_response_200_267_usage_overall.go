...
// InlineResponse200267UsageOverall Overall data usage of all clients across organization
type InlineResponse200267UsageOverall struct {
...
func NewInlineResponse200267UsageOverall() *InlineResponse200267UsageOverall {
	this := InlineResponse200267UsageOverall{}
	return &this
}
...
func (o InlineResponse200267UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200267UsageOverall struct {
	value *InlineResponse200267UsageOverall
	isSet bool
}

func (v NullableInlineResponse200267UsageOverall) Get() *InlineResponse200267UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200267UsageOverall) Set(val *InlineResponse200267UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200267UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200267UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200267UsageOverall(val *InlineResponse200267UsageOverall) *NullableInlineResponse200267UsageOverall {
	return &NullableInlineResponse200267UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200267UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200267UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
