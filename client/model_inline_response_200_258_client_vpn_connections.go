...
// InlineResponse200258ClientVpnConnections struct for InlineResponse200258ClientVpnConnections
type InlineResponse200258ClientVpnConnections struct {
...
func NewInlineResponse200258ClientVpnConnections() *InlineResponse200258ClientVpnConnections {
	this := InlineResponse200258ClientVpnConnections{}
	return &this
}
...
func (o InlineResponse200258ClientVpnConnections) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200258ClientVpnConnections struct {
	value *InlineResponse200258ClientVpnConnections
	isSet bool
}

func (v NullableInlineResponse200258ClientVpnConnections) Get() *InlineResponse200258ClientVpnConnections {
	return v.value
}

func (v *NullableInlineResponse200258ClientVpnConnections) Set(val *InlineResponse200258ClientVpnConnections) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200258ClientVpnConnections) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200258ClientVpnConnections) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200258ClientVpnConnections(val *InlineResponse200258ClientVpnConnections) *NullableInlineResponse200258ClientVpnConnections {
	return &NullableInlineResponse200258ClientVpnConnections{value: val, isSet: true}
}

func (v NullableInlineResponse200258ClientVpnConnections) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200258ClientVpnConnections) UnmarshalJSON(src []byte) error {
	v.isSet = true
