...
type InlineResponse200112 struct {
	...
	Identity *InlineResponse200112Identity `json:"identity,omitempty"`
	EapolKey *InlineResponse200112EapolKey `json:"eapolKey,omitempty"`
}
...
func (o *InlineResponse200112) GetIdentity() InlineResponse200112Identity {
	if o == nil || isNil(o.Identity) {
		var ret InlineResponse200112Identity
		return ret
	}
	return *o.Identity
}
...
// SetIdentity gets a reference to the given InlineResponse200112Identity and assigns it to the Identity field.
...
func (o *InlineResponse200112) GetEapolKey() InlineResponse200112EapolKey {
	if o == nil || isNil(o.EapolKey) {
		var ret InlineResponse200112EapolKey
		return ret
	}
	return *o.EapolKey
}
...
// SetEapolKey gets a reference to the given InlineResponse200112EapolKey and assigns it to the EapolKey field.
