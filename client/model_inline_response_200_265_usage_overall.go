...
// InlineResponse200265UsageOverall Overall data usage of all clients across organization
type InlineResponse200265UsageOverall struct {
...
func NewInlineResponse200265UsageOverall() *InlineResponse200265UsageOverall {
	this := InlineResponse200265UsageOverall{}
	return &this
}
...
func (o InlineResponse200265UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200265UsageOverall struct {
	value *InlineResponse200265UsageOverall
	isSet bool
}

func (v NullableInlineResponse200265UsageOverall) Get() *InlineResponse200265UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200265UsageOverall) Set(val *InlineResponse200265UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200265UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200265UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200265UsageOverall(val *InlineResponse200265UsageOverall) *NullableInlineResponse200265UsageOverall {
	return &NullableInlineResponse200265UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200265UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200265UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
