...
type InlineResponse200245Items struct {
	...
	Ipsec *InlineResponse200245Ipsec `json:"ipsec,omitempty"`
}
...
func (o *InlineResponse200245Items) GetId() string {
	if o == nil || isNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *InlineResponse200245Items) GetIdOk() (*string, bool) {
	if o == nil || isNil(o.Id) {
    return nil, false
	}
	return o.Id, true
...
func (o *InlineResponse200245Items) HasId() bool {
	if o != nil && !isNil(o.Id) {
		return true
	}
...
func (o *InlineResponse200245Items) SetId(v string) {
	o.Id = &v
}
...
func (o *InlineResponse200245Items) GetUri() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200245Items) GetUriOk() (*string, bool) {
	if o == nil || isNil(o.Uri) {
    return nil, false
	}
	return o.Uri, true
...
func (o *InlineResponse200245Items) HasUri() bool {
	if o != nil && !isNil(o.Uri) {
		return true
	}
...
func (o *InlineResponse200245Items) SetUri(v string) {
	o.Uri = &v
}

// GetIpsec returns the Ipsec field value if set, zero value otherwise.
func (o *InlineResponse200245Items) GetIpsec() InlineResponse200245Ipsec {
	if o == nil || isNil(o.Ipsec) {
		var ret InlineResponse200245Ipsec
		return ret
	}
	return *o.Ipsec
}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200245Items) GetIpsecOk() (*InlineResponse200245Ipsec, bool) {
	if o == nil || isNil(o.Ipsec) {
    return nil, false
	}
	return o.Ipsec, true
...
func (o *InlineResponse200245Items) HasIpsec() bool {
	if o != nil && !isNil(o.Ipsec) {
		return true
	}
...
// SetIpsec gets a reference to the given InlineResponse200245Ipsec and assigns it to the Ipsec field.
func (o *InlineResponse200245Items) SetIpsec(v InlineResponse200245Ipsec) {
	o.Ipsec = &v
}
