...
type InlineResponse200231 struct {
	...
	Limits *InlineResponse200231Limits `json:"limits,omitempty"`
}
...
func (o *InlineResponse200231) GetLimits() InlineResponse200231Limits {
	if o == nil || isNil(o.Limits) {
		var ret InlineResponse200231Limits
		return ret
	}
	return *o.Limits
}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200231) GetLimitsOk() (*InlineResponse200231Limits, bool) {
	if o == nil || isNil(o.Limits) {
    return nil, false
	}
...
func (o *InlineResponse200231) HasLimits() bool {
	if o != nil && !isNil(o.Limits) {
		return true
	}
...
// SetLimits gets a reference to the given InlineResponse200231Limits and assigns it to the Limits field.
func (o *InlineResponse200231) SetLimits(v InlineResponse200231Limits) {
	o.Limits = &v
}
