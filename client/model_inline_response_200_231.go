...
type InlineResponse200231 struct {
	...
	Items []InlineResponse20072 `json:"items,omitempty"`
}
...
// SetItems gets a reference to the given []InlineResponse20072 and assigns it to the Items field.
