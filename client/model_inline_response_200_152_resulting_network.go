...
// InlineResponse200152ResultingNetwork Network after the combination
type InlineResponse200152ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200152ResultingNetwork() *InlineResponse200152ResultingNetwork {
	this := InlineResponse200152ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200152ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200152ResultingNetwork struct {
	value *InlineResponse200152ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200152ResultingNetwork) Get() *InlineResponse200152ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200152ResultingNetwork) Set(val *InlineResponse200152ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200152ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200152ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200152ResultingNetwork(val *InlineResponse200152ResultingNetwork) *NullableInlineResponse200152ResultingNetwork {
	return &NullableInlineResponse200152ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200152ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200152ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
