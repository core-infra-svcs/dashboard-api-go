...
func (r BluetoothApiGetDeviceWirelessBluetoothSettingsRequest) Execute() (*InlineResponse20015, *http.Response, error) {
...
func (a *BluetoothApiService) GetDeviceWirelessBluetoothSettingsExecute(r BluetoothApiGetDeviceWirelessBluetoothSettingsRequest) (*InlineResponse20015, *http.Response, error) {
	var (
...
func (r BluetoothApiGetNetworkWirelessBluetoothSettingsRequest) Execute() (*InlineResponse200101, *http.Response, error) {
...
func (a *BluetoothApiService) GetNetworkWirelessBluetoothSettingsExecute(r BluetoothApiGetNetworkWirelessBluetoothSettingsRequest) (*InlineResponse200101, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r BluetoothApiUpdateDeviceWirelessBluetoothSettingsRequest) UpdateDeviceWirelessBluetoothSettings(updateDeviceWirelessBluetoothSettings InlineObject29) BluetoothApiUpdateDeviceWirelessBluetoothSettingsRequest {
	r.updateDeviceWirelessBluetoothSettings = &updateDeviceWirelessBluetoothSettings
	return r
}

func (r BluetoothApiUpdateDeviceWirelessBluetoothSettingsRequest) Execute() (*InlineResponse20015, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20015
func (a *BluetoothApiService) UpdateDeviceWirelessBluetoothSettingsExecute(r BluetoothApiUpdateDeviceWirelessBluetoothSettingsRequest) (*InlineResponse20015, *http.Response, error) {
	var (
...
func (r BluetoothApiUpdateNetworkWirelessBluetoothSettingsRequest) UpdateNetworkWirelessBluetoothSettings(updateNetworkWirelessBluetoothSettings InlineObject163) BluetoothApiUpdateNetworkWirelessBluetoothSettingsRequest {
	r.updateNetworkWirelessBluetoothSettings = &updateNetworkWirelessBluetoothSettings
	return r
}

func (r BluetoothApiUpdateNetworkWirelessBluetoothSettingsRequest) Execute() (*InlineResponse200101, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200101
func (a *BluetoothApiService) UpdateNetworkWirelessBluetoothSettingsExecute(r BluetoothApiUpdateNetworkWirelessBluetoothSettingsRequest) (*InlineResponse200101, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
