...
func (r BluetoothApiGetDeviceWirelessBluetoothSettingsRequest) Execute() (*InlineResponse20044, *http.Response, error) {
...
func (a *BluetoothApiService) GetDeviceWirelessBluetoothSettingsExecute(r BluetoothApiGetDeviceWirelessBluetoothSettingsRequest) (*InlineResponse20044, *http.Response, error) {
	var (
...
func (r BluetoothApiGetNetworkWirelessBluetoothSettingsRequest) Execute() (*InlineResponse200181, *http.Response, error) {
...
func (a *BluetoothApiService) GetNetworkWirelessBluetoothSettingsExecute(r BluetoothApiGetNetworkWirelessBluetoothSettingsRequest) (*InlineResponse200181, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r BluetoothApiUpdateDeviceWirelessBluetoothSettingsRequest) UpdateDeviceWirelessBluetoothSettings(updateDeviceWirelessBluetoothSettings InlineObject36) BluetoothApiUpdateDeviceWirelessBluetoothSettingsRequest {
	r.updateDeviceWirelessBluetoothSettings = &updateDeviceWirelessBluetoothSettings
	return r
}

func (r BluetoothApiUpdateDeviceWirelessBluetoothSettingsRequest) Execute() (*InlineResponse20044, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20044
func (a *BluetoothApiService) UpdateDeviceWirelessBluetoothSettingsExecute(r BluetoothApiUpdateDeviceWirelessBluetoothSettingsRequest) (*InlineResponse20044, *http.Response, error) {
	var (
...
func (r BluetoothApiUpdateNetworkWirelessBluetoothSettingsRequest) UpdateNetworkWirelessBluetoothSettings(updateNetworkWirelessBluetoothSettings InlineObject184) BluetoothApiUpdateNetworkWirelessBluetoothSettingsRequest {
	r.updateNetworkWirelessBluetoothSettings = &updateNetworkWirelessBluetoothSettings
	return r
}

func (r BluetoothApiUpdateNetworkWirelessBluetoothSettingsRequest) Execute() (*InlineResponse200181, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200181
func (a *BluetoothApiService) UpdateNetworkWirelessBluetoothSettingsExecute(r BluetoothApiUpdateNetworkWirelessBluetoothSettingsRequest) (*InlineResponse200181, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
