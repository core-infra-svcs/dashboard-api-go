...
func (r BluetoothApiApiGetDeviceWirelessBluetoothSettingsRequest) Execute() (InlineResponse2005, *_nethttp.Response, error) {
...
func (a *BluetoothApiService) GetDeviceWirelessBluetoothSettingsExecute(r BluetoothApiApiGetDeviceWirelessBluetoothSettingsRequest) (InlineResponse2005, *_nethttp.Response, error) {
	var (
...
func (r BluetoothApiApiGetNetworkWirelessBluetoothSettingsRequest) Execute() (InlineResponse20053, *_nethttp.Response, error) {
...
func (a *BluetoothApiService) GetNetworkWirelessBluetoothSettingsExecute(r BluetoothApiApiGetNetworkWirelessBluetoothSettingsRequest) (InlineResponse20053, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r BluetoothApiApiUpdateDeviceWirelessBluetoothSettingsRequest) UpdateDeviceWirelessBluetoothSettings(updateDeviceWirelessBluetoothSettings InlineObject22) BluetoothApiApiUpdateDeviceWirelessBluetoothSettingsRequest {
	r.updateDeviceWirelessBluetoothSettings = &updateDeviceWirelessBluetoothSettings
	return r
}

func (r BluetoothApiApiUpdateDeviceWirelessBluetoothSettingsRequest) Execute() (InlineResponse2005, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2005
func (a *BluetoothApiService) UpdateDeviceWirelessBluetoothSettingsExecute(r BluetoothApiApiUpdateDeviceWirelessBluetoothSettingsRequest) (InlineResponse2005, *_nethttp.Response, error) {
	var (
...
func (r BluetoothApiApiUpdateNetworkWirelessBluetoothSettingsRequest) UpdateNetworkWirelessBluetoothSettings(updateNetworkWirelessBluetoothSettings InlineObject149) BluetoothApiApiUpdateNetworkWirelessBluetoothSettingsRequest {
	r.updateNetworkWirelessBluetoothSettings = &updateNetworkWirelessBluetoothSettings
	return r
}

func (r BluetoothApiApiUpdateNetworkWirelessBluetoothSettingsRequest) Execute() (InlineResponse20053, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20053
func (a *BluetoothApiService) UpdateNetworkWirelessBluetoothSettingsExecute(r BluetoothApiApiUpdateNetworkWirelessBluetoothSettingsRequest) (InlineResponse20053, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
