...
func (r BluetoothApiGetDeviceWirelessBluetoothSettingsRequest) Execute() (*InlineResponse20045, *http.Response, error) {
...
func (a *BluetoothApiService) GetDeviceWirelessBluetoothSettingsExecute(r BluetoothApiGetDeviceWirelessBluetoothSettingsRequest) (*InlineResponse20045, *http.Response, error) {
	var (
...
func (r BluetoothApiGetNetworkWirelessBluetoothSettingsRequest) Execute() (*InlineResponse200185, *http.Response, error) {
...
func (a *BluetoothApiService) GetNetworkWirelessBluetoothSettingsExecute(r BluetoothApiGetNetworkWirelessBluetoothSettingsRequest) (*InlineResponse200185, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r BluetoothApiUpdateDeviceWirelessBluetoothSettingsRequest) UpdateDeviceWirelessBluetoothSettings(updateDeviceWirelessBluetoothSettings InlineObject37) BluetoothApiUpdateDeviceWirelessBluetoothSettingsRequest {
	r.updateDeviceWirelessBluetoothSettings = &updateDeviceWirelessBluetoothSettings
	return r
}

func (r BluetoothApiUpdateDeviceWirelessBluetoothSettingsRequest) Execute() (*InlineResponse20045, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20045
func (a *BluetoothApiService) UpdateDeviceWirelessBluetoothSettingsExecute(r BluetoothApiUpdateDeviceWirelessBluetoothSettingsRequest) (*InlineResponse20045, *http.Response, error) {
	var (
...
func (r BluetoothApiUpdateNetworkWirelessBluetoothSettingsRequest) UpdateNetworkWirelessBluetoothSettings(updateNetworkWirelessBluetoothSettings InlineObject185) BluetoothApiUpdateNetworkWirelessBluetoothSettingsRequest {
	r.updateNetworkWirelessBluetoothSettings = &updateNetworkWirelessBluetoothSettings
	return r
}

func (r BluetoothApiUpdateNetworkWirelessBluetoothSettingsRequest) Execute() (*InlineResponse200185, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200185
func (a *BluetoothApiService) UpdateNetworkWirelessBluetoothSettingsExecute(r BluetoothApiUpdateNetworkWirelessBluetoothSettingsRequest) (*InlineResponse200185, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
