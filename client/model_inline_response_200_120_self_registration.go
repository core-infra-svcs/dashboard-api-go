...
// InlineResponse200120SelfRegistration Self-registration for splash with Meraki authentication.
type InlineResponse200120SelfRegistration struct {
...
func NewInlineResponse200120SelfRegistration() *InlineResponse200120SelfRegistration {
	this := InlineResponse200120SelfRegistration{}
	return &this
}
...
func (o InlineResponse200120SelfRegistration) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200120SelfRegistration struct {
	value *InlineResponse200120SelfRegistration
	isSet bool
}

func (v NullableInlineResponse200120SelfRegistration) Get() *InlineResponse200120SelfRegistration {
	return v.value
}

func (v *NullableInlineResponse200120SelfRegistration) Set(val *InlineResponse200120SelfRegistration) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200120SelfRegistration) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200120SelfRegistration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200120SelfRegistration(val *InlineResponse200120SelfRegistration) *NullableInlineResponse200120SelfRegistration {
	return &NullableInlineResponse200120SelfRegistration{value: val, isSet: true}
}

func (v NullableInlineResponse200120SelfRegistration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200120SelfRegistration) UnmarshalJSON(src []byte) error {
	v.isSet = true
