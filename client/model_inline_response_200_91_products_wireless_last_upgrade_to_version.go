...
// InlineResponse20091ProductsWirelessLastUpgradeToVersion Details of the version the device upgraded to
type InlineResponse20091ProductsWirelessLastUpgradeToVersion struct {
...
func NewInlineResponse20091ProductsWirelessLastUpgradeToVersion() *InlineResponse20091ProductsWirelessLastUpgradeToVersion {
	this := InlineResponse20091ProductsWirelessLastUpgradeToVersion{}
	return &this
}
...
func (o InlineResponse20091ProductsWirelessLastUpgradeToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20091ProductsWirelessLastUpgradeToVersion struct {
	value *InlineResponse20091ProductsWirelessLastUpgradeToVersion
	isSet bool
}

func (v NullableInlineResponse20091ProductsWirelessLastUpgradeToVersion) Get() *InlineResponse20091ProductsWirelessLastUpgradeToVersion {
	return v.value
}

func (v *NullableInlineResponse20091ProductsWirelessLastUpgradeToVersion) Set(val *InlineResponse20091ProductsWirelessLastUpgradeToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20091ProductsWirelessLastUpgradeToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20091ProductsWirelessLastUpgradeToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20091ProductsWirelessLastUpgradeToVersion(val *InlineResponse20091ProductsWirelessLastUpgradeToVersion) *NullableInlineResponse20091ProductsWirelessLastUpgradeToVersion {
	return &NullableInlineResponse20091ProductsWirelessLastUpgradeToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20091ProductsWirelessLastUpgradeToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20091ProductsWirelessLastUpgradeToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
