...
type InlineResponse20039 struct {
	...
	ClientVpnConnections []InlineResponse20039ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20039) GetClientVpnConnections() []InlineResponse20039ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20039ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20039ClientVpnConnections and assigns it to the ClientVpnConnections field.
