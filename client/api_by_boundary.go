...
func (r ByBoundaryApiGetOrganizationCameraDetectionsHistoryByBoundaryByIntervalRequest) Execute() ([]InlineResponse200149, *http.Response, error) {
...
func (a *ByBoundaryApiService) GetOrganizationCameraDetectionsHistoryByBoundaryByIntervalExecute(r ByBoundaryApiGetOrganizationCameraDetectionsHistoryByBoundaryByIntervalRequest) ([]InlineResponse200149, *http.Response, error) {
	var (
