...
func (r ByBoundaryApiGetOrganizationCameraDetectionsHistoryByBoundaryByIntervalRequest) CounterMode(counterMode string) ByBoundaryApiGetOrganizationCameraDetectionsHistoryByBoundaryByIntervalRequest {
	r.counterMode = &counterMode
	return r
}

func (r ByBoundaryApiGetOrganizationCameraDetectionsHistoryByBoundaryByIntervalRequest) Execute() ([]InlineResponse200254, *http.Response, error) {
...
func (a *ByBoundaryApiService) GetOrganizationCameraDetectionsHistoryByBoundaryByIntervalExecute(r ByBoundaryApiGetOrganizationCameraDetectionsHistoryByBoundaryByIntervalRequest) ([]InlineResponse200254, *http.Response, error) {
	var (
