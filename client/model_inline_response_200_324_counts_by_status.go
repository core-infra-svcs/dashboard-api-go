...
// InlineResponse200324CountsByStatus Associated client count on access point by status.
type InlineResponse200324CountsByStatus struct {
	// Active client count.
...
func NewInlineResponse200324CountsByStatus() *InlineResponse200324CountsByStatus {
	this := InlineResponse200324CountsByStatus{}
	return &this
}
...
func (o InlineResponse200324CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200324CountsByStatus struct {
	value *InlineResponse200324CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200324CountsByStatus) Get() *InlineResponse200324CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200324CountsByStatus) Set(val *InlineResponse200324CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200324CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200324CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200324CountsByStatus(val *InlineResponse200324CountsByStatus) *NullableInlineResponse200324CountsByStatus {
	return &NullableInlineResponse200324CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200324CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200324CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
