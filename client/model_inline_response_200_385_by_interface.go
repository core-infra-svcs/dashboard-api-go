...
// InlineResponse200385ByInterface struct for InlineResponse200385ByInterface
type InlineResponse200385ByInterface struct {
	// The name of the wireless LAN controller interface
	Name *string `json:"name,omitempty"`
	Usage *InlineResponse200385Usage `json:"usage,omitempty"`
}
...
func NewInlineResponse200385ByInterface() *InlineResponse200385ByInterface {
	this := InlineResponse200385ByInterface{}
	return &this
}
...
func (o *InlineResponse200385ByInterface) GetUsage() InlineResponse200385Usage {
	if o == nil || isNil(o.Usage) {
		var ret InlineResponse200385Usage
		return ret
	}
	return *o.Usage
}
...
// SetUsage gets a reference to the given InlineResponse200385Usage and assigns it to the Usage field.
func (o *InlineResponse200385ByInterface) SetUsage(v InlineResponse200385Usage) {
	o.Usage = &v
}

func (o InlineResponse200385ByInterface) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200385ByInterface struct {
	value *InlineResponse200385ByInterface
	isSet bool
}

func (v NullableInlineResponse200385ByInterface) Get() *InlineResponse200385ByInterface {
	return v.value
}

func (v *NullableInlineResponse200385ByInterface) Set(val *InlineResponse200385ByInterface) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200385ByInterface) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200385ByInterface) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200385ByInterface(val *InlineResponse200385ByInterface) *NullableInlineResponse200385ByInterface {
	return &NullableInlineResponse200385ByInterface{value: val, isSet: true}
}

func (v NullableInlineResponse200385ByInterface) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200385ByInterface) UnmarshalJSON(src []byte) error {
	v.isSet = true
