...
// InlineResponse200219Rules struct for InlineResponse200219Rules
type InlineResponse200219Rules struct {
...
func NewInlineResponse200219Rules(definitions []NetworksNetworkIdApplianceTrafficShapingRulesDefinitions) *InlineResponse200219Rules {
	this := InlineResponse200219Rules{}
...
func (o *InlineResponse200219Rules) SetDscpTagValueNil() {
...
func (o *InlineResponse200219Rules) SetPcpTagValueNil() {
...
func (o InlineResponse200219Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200219Rules struct {
	value *InlineResponse200219Rules
	isSet bool
}

func (v NullableInlineResponse200219Rules) Get() *InlineResponse200219Rules {
	return v.value
}

func (v *NullableInlineResponse200219Rules) Set(val *InlineResponse200219Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200219Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200219Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200219Rules(val *InlineResponse200219Rules) *NullableInlineResponse200219Rules {
	return &NullableInlineResponse200219Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200219Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200219Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
