...
// InlineResponse20094EventData An object containing more data related to the event.
type InlineResponse20094EventData struct {
...
func NewInlineResponse20094EventData() *InlineResponse20094EventData {
	this := InlineResponse20094EventData{}
	return &this
}
...
func (o InlineResponse20094EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20094EventData struct {
	value *InlineResponse20094EventData
	isSet bool
}

func (v NullableInlineResponse20094EventData) Get() *InlineResponse20094EventData {
	return v.value
}

func (v *NullableInlineResponse20094EventData) Set(val *InlineResponse20094EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20094EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20094EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20094EventData(val *InlineResponse20094EventData) *NullableInlineResponse20094EventData {
	return &NullableInlineResponse20094EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20094EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20094EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
