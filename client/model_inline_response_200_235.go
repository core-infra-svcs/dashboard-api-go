...
type InlineResponse200235 struct {
	...
	Peers []InlineResponse200235Peers `json:"peers,omitempty"`
}
...
func (o *InlineResponse200235) GetPeers() []InlineResponse200235Peers {
	if o == nil || isNil(o.Peers) {
		var ret []InlineResponse200235Peers
		return ret
	}
	return o.Peers
}
...
func (o *InlineResponse200235) GetPeersOk() ([]InlineResponse200235Peers, bool) {
	if o == nil || isNil(o.Peers) {
    return nil, false
	}
	return o.Peers, true
...
func (o *InlineResponse200235) HasPeers() bool {
	if o != nil && !isNil(o.Peers) {
		return true
	}
...
// SetPeers gets a reference to the given []InlineResponse200235Peers and assigns it to the Peers field.
func (o *InlineResponse200235) SetPeers(v []InlineResponse200235Peers) {
	o.Peers = v
}
