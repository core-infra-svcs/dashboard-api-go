...
func (o *InlineResponse20070) GetGroupPolicyId() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20070) GetGroupPolicyIdOk() (*string, bool) {
	if o == nil || isNil(o.GroupPolicyId) {
    return nil, false
	}
...
func (o *InlineResponse20070) HasGroupPolicyId() bool {
	if o != nil && !isNil(o.GroupPolicyId) {
		return true
	}
...
func (o *InlineResponse20070) SetGroupPolicyId(v string) {
	o.GroupPolicyId = &v
}

// GetPassphrase returns the Passphrase field value if set, zero value otherwise.
func (o *InlineResponse20070) GetPassphrase() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20070) GetPassphraseOk() (*string, bool) {
	if o == nil || isNil(o.Passphrase) {
    return nil, false
	}
...
func (o *InlineResponse20070) HasPassphrase() bool {
	if o != nil && !isNil(o.Passphrase) {
		return true
	}
...
func (o *InlineResponse20070) SetPassphrase(v string) {
	o.Passphrase = &v
}

// GetWifiPersonalNetworkId returns the WifiPersonalNetworkId field value if set, zero value otherwise.
func (o *InlineResponse20070) GetWifiPersonalNetworkId() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20070) GetWifiPersonalNetworkIdOk() (*string, bool) {
	if o == nil || isNil(o.WifiPersonalNetworkId) {
    return nil, false
	}
...
func (o *InlineResponse20070) HasWifiPersonalNetworkId() bool {
	if o != nil && !isNil(o.WifiPersonalNetworkId) {
		return true
	}
...
func (o *InlineResponse20070) SetWifiPersonalNetworkId(v string) {
