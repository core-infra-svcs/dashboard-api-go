...
type InlineResponse20070 struct {
	...
	Hubs []InlineResponse20070Hubs `json:"hubs,omitempty"`
	// The list of subnets and their VPN presence.
	Subnets []InlineResponse20070Subnets `json:"subnets,omitempty"`
}
...
func (o *InlineResponse20070) GetHubs() []InlineResponse20070Hubs {
	if o == nil || isNil(o.Hubs) {
		var ret []InlineResponse20070Hubs
		return ret
	}
	return o.Hubs
}
...
// SetHubs gets a reference to the given []InlineResponse20070Hubs and assigns it to the Hubs field.
...
func (o *InlineResponse20070) GetSubnets() []InlineResponse20070Subnets {
	if o == nil || isNil(o.Subnets) {
		var ret []InlineResponse20070Subnets
		return ret
	}
	return o.Subnets
}
...
// SetSubnets gets a reference to the given []InlineResponse20070Subnets and assigns it to the Subnets field.
