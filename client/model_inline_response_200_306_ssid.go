...
// InlineResponse200306Ssid Wireless access point and network identifier.
type InlineResponse200306Ssid struct {
...
func (o InlineResponse200306Ssid) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200306Ssid struct {
	value *InlineResponse200306Ssid
	isSet bool
}

func (v NullableInlineResponse200306Ssid) Get() *InlineResponse200306Ssid {
	return v.value
}

func (v *NullableInlineResponse200306Ssid) Set(val *InlineResponse200306Ssid) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200306Ssid) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200306Ssid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200306Ssid(val *InlineResponse200306Ssid) *NullableInlineResponse200306Ssid {
	return &NullableInlineResponse200306Ssid{value: val, isSet: true}
}

func (v NullableInlineResponse200306Ssid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200306Ssid) UnmarshalJSON(src []byte) error {
	v.isSet = true
