...
// InlineResponse200326Readings struct for InlineResponse200326Readings
type InlineResponse200326Readings struct {
	// The start time of the query range
	StartTs *time.Time `json:"startTs,omitempty"`
	// The end time of the query range
	EndTs *time.Time `json:"endTs,omitempty"`
	Counts *InlineResponse200326Counts `json:"counts,omitempty"`
}
...
func NewInlineResponse200326Readings() *InlineResponse200326Readings {
	this := InlineResponse200326Readings{}
	return &this
}
...
func (o *InlineResponse200326Readings) GetCounts() InlineResponse200326Counts {
	if o == nil || isNil(o.Counts) {
		var ret InlineResponse200326Counts
		return ret
	}
	return *o.Counts
}
...
// SetCounts gets a reference to the given InlineResponse200326Counts and assigns it to the Counts field.
func (o *InlineResponse200326Readings) SetCounts(v InlineResponse200326Counts) {
	o.Counts = &v
}

func (o InlineResponse200326Readings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200326Readings struct {
	value *InlineResponse200326Readings
	isSet bool
}

func (v NullableInlineResponse200326Readings) Get() *InlineResponse200326Readings {
	return v.value
}

func (v *NullableInlineResponse200326Readings) Set(val *InlineResponse200326Readings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200326Readings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200326Readings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200326Readings(val *InlineResponse200326Readings) *NullableInlineResponse200326Readings {
	return &NullableInlineResponse200326Readings{value: val, isSet: true}
}

func (v NullableInlineResponse200326Readings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200326Readings) UnmarshalJSON(src []byte) error {
	v.isSet = true
