...
// InlineResponse200105ReservedIpRanges struct for InlineResponse200105ReservedIpRanges
type InlineResponse200105ReservedIpRanges struct {
...
func NewInlineResponse200105ReservedIpRanges() *InlineResponse200105ReservedIpRanges {
	this := InlineResponse200105ReservedIpRanges{}
	return &this
}
...
func (o InlineResponse200105ReservedIpRanges) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200105ReservedIpRanges struct {
	value *InlineResponse200105ReservedIpRanges
	isSet bool
}

func (v NullableInlineResponse200105ReservedIpRanges) Get() *InlineResponse200105ReservedIpRanges {
	return v.value
}

func (v *NullableInlineResponse200105ReservedIpRanges) Set(val *InlineResponse200105ReservedIpRanges) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200105ReservedIpRanges) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200105ReservedIpRanges) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200105ReservedIpRanges(val *InlineResponse200105ReservedIpRanges) *NullableInlineResponse200105ReservedIpRanges {
	return &NullableInlineResponse200105ReservedIpRanges{value: val, isSet: true}
}

func (v NullableInlineResponse200105ReservedIpRanges) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200105ReservedIpRanges) UnmarshalJSON(src []byte) error {
	v.isSet = true
