...
func (r OptInsApiCreateOrganizationEarlyAccessFeaturesOptInRequest) CreateOrganizationEarlyAccessFeaturesOptIn(createOrganizationEarlyAccessFeaturesOptIn InlineObject222) OptInsApiCreateOrganizationEarlyAccessFeaturesOptInRequest {
	r.createOrganizationEarlyAccessFeaturesOptIn = &createOrganizationEarlyAccessFeaturesOptIn
	return r
}

func (r OptInsApiCreateOrganizationEarlyAccessFeaturesOptInRequest) Execute() (*InlineResponse200235, *http.Response, error) {
...
func (a *OptInsApiService) CreateOrganizationEarlyAccessFeaturesOptInExecute(r OptInsApiCreateOrganizationEarlyAccessFeaturesOptInRequest) (*InlineResponse200235, *http.Response, error) {
	var (
...
func (r OptInsApiGetOrganizationEarlyAccessFeaturesOptInRequest) Execute() (*InlineResponse200235, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200235
func (a *OptInsApiService) GetOrganizationEarlyAccessFeaturesOptInExecute(r OptInsApiGetOrganizationEarlyAccessFeaturesOptInRequest) (*InlineResponse200235, *http.Response, error) {
	var (
...
func (r OptInsApiGetOrganizationEarlyAccessFeaturesOptInsRequest) Execute() (*InlineResponse200235, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200235
func (a *OptInsApiService) GetOrganizationEarlyAccessFeaturesOptInsExecute(r OptInsApiGetOrganizationEarlyAccessFeaturesOptInsRequest) (*InlineResponse200235, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r OptInsApiUpdateOrganizationEarlyAccessFeaturesOptInRequest) UpdateOrganizationEarlyAccessFeaturesOptIn(updateOrganizationEarlyAccessFeaturesOptIn InlineObject223) OptInsApiUpdateOrganizationEarlyAccessFeaturesOptInRequest {
	r.updateOrganizationEarlyAccessFeaturesOptIn = &updateOrganizationEarlyAccessFeaturesOptIn
	return r
}

func (r OptInsApiUpdateOrganizationEarlyAccessFeaturesOptInRequest) Execute() (*InlineResponse200235, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200235
func (a *OptInsApiService) UpdateOrganizationEarlyAccessFeaturesOptInExecute(r OptInsApiUpdateOrganizationEarlyAccessFeaturesOptInRequest) (*InlineResponse200235, *http.Response, error) {
	var (
