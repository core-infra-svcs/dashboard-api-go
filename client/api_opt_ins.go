...
func (r OptInsApiCreateOrganizationEarlyAccessFeaturesOptInRequest) CreateOrganizationEarlyAccessFeaturesOptIn(createOrganizationEarlyAccessFeaturesOptIn InlineObject268) OptInsApiCreateOrganizationEarlyAccessFeaturesOptInRequest {
	r.createOrganizationEarlyAccessFeaturesOptIn = &createOrganizationEarlyAccessFeaturesOptIn
	return r
}

func (r OptInsApiCreateOrganizationEarlyAccessFeaturesOptInRequest) Execute() (*InlineResponse200299, *http.Response, error) {
...
func (a *OptInsApiService) CreateOrganizationEarlyAccessFeaturesOptInExecute(r OptInsApiCreateOrganizationEarlyAccessFeaturesOptInRequest) (*InlineResponse200299, *http.Response, error) {
	var (
...
func (r OptInsApiGetOrganizationEarlyAccessFeaturesOptInRequest) Execute() (*InlineResponse200299, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200299
func (a *OptInsApiService) GetOrganizationEarlyAccessFeaturesOptInExecute(r OptInsApiGetOrganizationEarlyAccessFeaturesOptInRequest) (*InlineResponse200299, *http.Response, error) {
	var (
...
func (r OptInsApiGetOrganizationEarlyAccessFeaturesOptInsRequest) Execute() (*InlineResponse200299, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200299
func (a *OptInsApiService) GetOrganizationEarlyAccessFeaturesOptInsExecute(r OptInsApiGetOrganizationEarlyAccessFeaturesOptInsRequest) (*InlineResponse200299, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r OptInsApiUpdateOrganizationEarlyAccessFeaturesOptInRequest) UpdateOrganizationEarlyAccessFeaturesOptIn(updateOrganizationEarlyAccessFeaturesOptIn InlineObject269) OptInsApiUpdateOrganizationEarlyAccessFeaturesOptInRequest {
	r.updateOrganizationEarlyAccessFeaturesOptIn = &updateOrganizationEarlyAccessFeaturesOptIn
	return r
}

func (r OptInsApiUpdateOrganizationEarlyAccessFeaturesOptInRequest) Execute() (*InlineResponse200299, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200299
func (a *OptInsApiService) UpdateOrganizationEarlyAccessFeaturesOptInExecute(r OptInsApiUpdateOrganizationEarlyAccessFeaturesOptInRequest) (*InlineResponse200299, *http.Response, error) {
	var (
