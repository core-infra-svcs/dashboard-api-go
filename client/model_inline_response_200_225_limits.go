...
// InlineResponse200225Limits The current limits of various adaptive policy objects.
type InlineResponse200225Limits struct {
...
func NewInlineResponse200225Limits() *InlineResponse200225Limits {
	this := InlineResponse200225Limits{}
	return &this
}
...
func (o InlineResponse200225Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200225Limits struct {
	value *InlineResponse200225Limits
	isSet bool
}

func (v NullableInlineResponse200225Limits) Get() *InlineResponse200225Limits {
	return v.value
}

func (v *NullableInlineResponse200225Limits) Set(val *InlineResponse200225Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200225Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200225Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200225Limits(val *InlineResponse200225Limits) *NullableInlineResponse200225Limits {
	return &NullableInlineResponse200225Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200225Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200225Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
