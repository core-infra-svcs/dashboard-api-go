...
// InlineResponse200348Webhook The webhook receiver used by the callback to send results
type InlineResponse200348Webhook struct {
	// The webhook receiver URL where the callback will be sent
	Url *string `json:"url,omitempty"`
	HttpServer *InlineResponse200348WebhookHttpServer `json:"httpServer,omitempty"`
	PayloadTemplate *InlineResponse200348WebhookPayloadTemplate `json:"payloadTemplate,omitempty"`
...
func NewInlineResponse200348Webhook() *InlineResponse200348Webhook {
	this := InlineResponse200348Webhook{}
	return &this
}
...
func (o *InlineResponse200348Webhook) GetHttpServer() InlineResponse200348WebhookHttpServer {
	if o == nil || isNil(o.HttpServer) {
		var ret InlineResponse200348WebhookHttpServer
		return ret
	}
	return *o.HttpServer
}
...
// SetHttpServer gets a reference to the given InlineResponse200348WebhookHttpServer and assigns it to the HttpServer field.
...
func (o *InlineResponse200348Webhook) GetPayloadTemplate() InlineResponse200348WebhookPayloadTemplate {
	if o == nil || isNil(o.PayloadTemplate) {
		var ret InlineResponse200348WebhookPayloadTemplate
		return ret
	}
...
// SetPayloadTemplate gets a reference to the given InlineResponse200348WebhookPayloadTemplate and assigns it to the PayloadTemplate field.
...
func (o InlineResponse200348Webhook) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200348Webhook struct {
	value *InlineResponse200348Webhook
	isSet bool
}

func (v NullableInlineResponse200348Webhook) Get() *InlineResponse200348Webhook {
	return v.value
}

func (v *NullableInlineResponse200348Webhook) Set(val *InlineResponse200348Webhook) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200348Webhook) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200348Webhook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200348Webhook(val *InlineResponse200348Webhook) *NullableInlineResponse200348Webhook {
	return &NullableInlineResponse200348Webhook{value: val, isSet: true}
}

func (v NullableInlineResponse200348Webhook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200348Webhook) UnmarshalJSON(src []byte) error {
	v.isSet = true
