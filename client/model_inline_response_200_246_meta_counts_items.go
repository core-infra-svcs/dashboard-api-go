...
// InlineResponse200246MetaCountsItems Count of eSIM Devices available
type InlineResponse200246MetaCountsItems struct {
...
func NewInlineResponse200246MetaCountsItems() *InlineResponse200246MetaCountsItems {
	this := InlineResponse200246MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200246MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200246MetaCountsItems struct {
	value *InlineResponse200246MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200246MetaCountsItems) Get() *InlineResponse200246MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200246MetaCountsItems) Set(val *InlineResponse200246MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200246MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200246MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200246MetaCountsItems(val *InlineResponse200246MetaCountsItems) *NullableInlineResponse200246MetaCountsItems {
	return &NullableInlineResponse200246MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200246MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200246MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
