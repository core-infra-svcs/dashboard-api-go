...
func (r FirewalledServicesApiGetNetworkApplianceFirewallFirewalledServiceRequest) Execute() (*InlineResponse20046, *http.Response, error) {
...
func (a *FirewalledServicesApiService) GetNetworkApplianceFirewallFirewalledServiceExecute(r FirewalledServicesApiGetNetworkApplianceFirewallFirewalledServiceRequest) (*InlineResponse20046, *http.Response, error) {
	var (
...
func (r FirewalledServicesApiGetNetworkApplianceFirewallFirewalledServicesRequest) Execute() ([]InlineResponse20046, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20046
func (a *FirewalledServicesApiService) GetNetworkApplianceFirewallFirewalledServicesExecute(r FirewalledServicesApiGetNetworkApplianceFirewallFirewalledServicesRequest) ([]InlineResponse20046, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r FirewalledServicesApiUpdateNetworkApplianceFirewallFirewalledServiceRequest) UpdateNetworkApplianceFirewallFirewalledService(updateNetworkApplianceFirewallFirewalledService InlineObject41) FirewalledServicesApiUpdateNetworkApplianceFirewallFirewalledServiceRequest {
	r.updateNetworkApplianceFirewallFirewalledService = &updateNetworkApplianceFirewallFirewalledService
	return r
}

func (r FirewalledServicesApiUpdateNetworkApplianceFirewallFirewalledServiceRequest) Execute() (*InlineResponse20046, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20046
func (a *FirewalledServicesApiService) UpdateNetworkApplianceFirewallFirewalledServiceExecute(r FirewalledServicesApiUpdateNetworkApplianceFirewallFirewalledServiceRequest) (*InlineResponse20046, *http.Response, error) {
	var (
