...
func (r FirewalledServicesApiGetNetworkApplianceFirewallFirewalledServiceRequest) Execute() (*InlineResponse20048, *http.Response, error) {
...
func (a *FirewalledServicesApiService) GetNetworkApplianceFirewallFirewalledServiceExecute(r FirewalledServicesApiGetNetworkApplianceFirewallFirewalledServiceRequest) (*InlineResponse20048, *http.Response, error) {
	var (
...
func (r FirewalledServicesApiGetNetworkApplianceFirewallFirewalledServicesRequest) Execute() ([]InlineResponse20048, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20048
func (a *FirewalledServicesApiService) GetNetworkApplianceFirewallFirewalledServicesExecute(r FirewalledServicesApiGetNetworkApplianceFirewallFirewalledServicesRequest) ([]InlineResponse20048, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r FirewalledServicesApiUpdateNetworkApplianceFirewallFirewalledServiceRequest) Execute() (*InlineResponse20048, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20048
func (a *FirewalledServicesApiService) UpdateNetworkApplianceFirewallFirewalledServiceExecute(r FirewalledServicesApiUpdateNetworkApplianceFirewallFirewalledServiceRequest) (*InlineResponse20048, *http.Response, error) {
	var (
