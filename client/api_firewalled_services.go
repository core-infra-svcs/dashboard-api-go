...
func (r FirewalledServicesApiGetNetworkApplianceFirewallFirewalledServiceRequest) Execute() (*InlineResponse20053, *http.Response, error) {
...
func (a *FirewalledServicesApiService) GetNetworkApplianceFirewallFirewalledServiceExecute(r FirewalledServicesApiGetNetworkApplianceFirewallFirewalledServiceRequest) (*InlineResponse20053, *http.Response, error) {
	var (
...
func (r FirewalledServicesApiGetNetworkApplianceFirewallFirewalledServicesRequest) Execute() ([]InlineResponse20053, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20053
func (a *FirewalledServicesApiService) GetNetworkApplianceFirewallFirewalledServicesExecute(r FirewalledServicesApiGetNetworkApplianceFirewallFirewalledServicesRequest) ([]InlineResponse20053, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r FirewalledServicesApiUpdateNetworkApplianceFirewallFirewalledServiceRequest) Execute() (*InlineResponse20053, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20053
func (a *FirewalledServicesApiService) UpdateNetworkApplianceFirewallFirewalledServiceExecute(r FirewalledServicesApiUpdateNetworkApplianceFirewallFirewalledServiceRequest) (*InlineResponse20053, *http.Response, error) {
	var (
