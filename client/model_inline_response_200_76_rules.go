...
// InlineResponse20076Rules struct for InlineResponse20076Rules
type InlineResponse20076Rules struct {
...
func (o InlineResponse20076Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20076Rules struct {
	value *InlineResponse20076Rules
	isSet bool
}

func (v NullableInlineResponse20076Rules) Get() *InlineResponse20076Rules {
	return v.value
}

func (v *NullableInlineResponse20076Rules) Set(val *InlineResponse20076Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20076Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20076Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20076Rules(val *InlineResponse20076Rules) *NullableInlineResponse20076Rules {
	return &NullableInlineResponse20076Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20076Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20076Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
