...
// InlineResponse20082UsageOverall Overall data usage of all clients across organization
type InlineResponse20082UsageOverall struct {
...
func NewInlineResponse20082UsageOverall() *InlineResponse20082UsageOverall {
	this := InlineResponse20082UsageOverall{}
	return &this
}
...
func (o InlineResponse20082UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20082UsageOverall struct {
	value *InlineResponse20082UsageOverall
	isSet bool
}

func (v NullableInlineResponse20082UsageOverall) Get() *InlineResponse20082UsageOverall {
	return v.value
}

func (v *NullableInlineResponse20082UsageOverall) Set(val *InlineResponse20082UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20082UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20082UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20082UsageOverall(val *InlineResponse20082UsageOverall) *NullableInlineResponse20082UsageOverall {
	return &NullableInlineResponse20082UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse20082UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20082UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
