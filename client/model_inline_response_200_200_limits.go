...
// InlineResponse200200Limits The current limits of various adaptive policy objects.
type InlineResponse200200Limits struct {
...
func NewInlineResponse200200Limits() *InlineResponse200200Limits {
	this := InlineResponse200200Limits{}
	return &this
}
...
func (o InlineResponse200200Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200200Limits struct {
	value *InlineResponse200200Limits
	isSet bool
}

func (v NullableInlineResponse200200Limits) Get() *InlineResponse200200Limits {
	return v.value
}

func (v *NullableInlineResponse200200Limits) Set(val *InlineResponse200200Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200200Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200200Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200200Limits(val *InlineResponse200200Limits) *NullableInlineResponse200200Limits {
	return &NullableInlineResponse200200Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200200Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200200Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
