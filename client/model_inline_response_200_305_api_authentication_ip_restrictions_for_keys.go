...
// InlineResponse200305ApiAuthenticationIpRestrictionsForKeys Details for API-only IP restrictions.
type InlineResponse200305ApiAuthenticationIpRestrictionsForKeys struct {
...
func NewInlineResponse200305ApiAuthenticationIpRestrictionsForKeys() *InlineResponse200305ApiAuthenticationIpRestrictionsForKeys {
	this := InlineResponse200305ApiAuthenticationIpRestrictionsForKeys{}
	return &this
}
...
func (o InlineResponse200305ApiAuthenticationIpRestrictionsForKeys) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200305ApiAuthenticationIpRestrictionsForKeys struct {
	value *InlineResponse200305ApiAuthenticationIpRestrictionsForKeys
	isSet bool
}

func (v NullableInlineResponse200305ApiAuthenticationIpRestrictionsForKeys) Get() *InlineResponse200305ApiAuthenticationIpRestrictionsForKeys {
	return v.value
}

func (v *NullableInlineResponse200305ApiAuthenticationIpRestrictionsForKeys) Set(val *InlineResponse200305ApiAuthenticationIpRestrictionsForKeys) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200305ApiAuthenticationIpRestrictionsForKeys) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200305ApiAuthenticationIpRestrictionsForKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200305ApiAuthenticationIpRestrictionsForKeys(val *InlineResponse200305ApiAuthenticationIpRestrictionsForKeys) *NullableInlineResponse200305ApiAuthenticationIpRestrictionsForKeys {
	return &NullableInlineResponse200305ApiAuthenticationIpRestrictionsForKeys{value: val, isSet: true}
}

func (v NullableInlineResponse200305ApiAuthenticationIpRestrictionsForKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200305ApiAuthenticationIpRestrictionsForKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
