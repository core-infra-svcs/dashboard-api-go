...
// InlineResponse20017Rules struct for InlineResponse20017Rules
type InlineResponse20017Rules struct {
...
func (o InlineResponse20017Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20017Rules struct {
	value *InlineResponse20017Rules
	isSet bool
}

func (v NullableInlineResponse20017Rules) Get() *InlineResponse20017Rules {
	return v.value
}

func (v *NullableInlineResponse20017Rules) Set(val *InlineResponse20017Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20017Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20017Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20017Rules(val *InlineResponse20017Rules) *NullableInlineResponse20017Rules {
	return &NullableInlineResponse20017Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20017Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20017Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
