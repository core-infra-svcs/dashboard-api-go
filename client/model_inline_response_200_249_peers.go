...
// InlineResponse200249Peers struct for InlineResponse200249Peers
type InlineResponse200249Peers struct {
	...
	IpsecPolicies *InlineResponse200249IpsecPolicies `json:"ipsecPolicies,omitempty"`
	SlaPolicy *InlineResponse200249SlaPolicy `json:"slaPolicy,omitempty"`
	...
	Network *InlineResponse200249Network `json:"network,omitempty"`
	...
	EbgpNeighbor *InlineResponse200249EbgpNeighbor `json:"ebgpNeighbor,omitempty"`
	// [optional] Represents the order of peer inside a group.
	PriorityInGroup *int32 `json:"priorityInGroup,omitempty"`
	Group *InlineResponse200249Group `json:"group,omitempty"`
}
...
func NewInlineResponse200249Peers() *InlineResponse200249Peers {
	this := InlineResponse200249Peers{}
...
func (o *InlineResponse200249Peers) GetIpsecPolicies() InlineResponse200249IpsecPolicies {
	if o == nil || isNil(o.IpsecPolicies) {
		var ret InlineResponse200249IpsecPolicies
		return ret
	}
...
// SetIpsecPolicies gets a reference to the given InlineResponse200249IpsecPolicies and assigns it to the IpsecPolicies field.
...
func (o *InlineResponse200249Peers) GetSlaPolicy() InlineResponse200249SlaPolicy {
	if o == nil || isNil(o.SlaPolicy) {
		var ret InlineResponse200249SlaPolicy
		return ret
	}
	return *o.SlaPolicy
}
...
// SetSlaPolicy gets a reference to the given InlineResponse200249SlaPolicy and assigns it to the SlaPolicy field.
...
func (o *InlineResponse200249Peers) GetNetwork() InlineResponse200249Network {
	if o == nil || isNil(o.Network) {
		var ret InlineResponse200249Network
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given InlineResponse200249Network and assigns it to the Network field.
...
func (o *InlineResponse200249Peers) GetEbgpNeighbor() InlineResponse200249EbgpNeighbor {
	if o == nil || isNil(o.EbgpNeighbor) {
		var ret InlineResponse200249EbgpNeighbor
		return ret
	}
...
// SetEbgpNeighbor gets a reference to the given InlineResponse200249EbgpNeighbor and assigns it to the EbgpNeighbor field.
...
func (o *InlineResponse200249Peers) GetGroup() InlineResponse200249Group {
	if o == nil || isNil(o.Group) {
		var ret InlineResponse200249Group
		return ret
	}
	return *o.Group
}
...
// SetGroup gets a reference to the given InlineResponse200249Group and assigns it to the Group field.
func (o *InlineResponse200249Peers) SetGroup(v InlineResponse200249Group) {
	o.Group = &v
}

func (o InlineResponse200249Peers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200249Peers struct {
	value *InlineResponse200249Peers
	isSet bool
}

func (v NullableInlineResponse200249Peers) Get() *InlineResponse200249Peers {
	return v.value
}

func (v *NullableInlineResponse200249Peers) Set(val *InlineResponse200249Peers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200249Peers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200249Peers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200249Peers(val *InlineResponse200249Peers) *NullableInlineResponse200249Peers {
	return &NullableInlineResponse200249Peers{value: val, isSet: true}
}

func (v NullableInlineResponse200249Peers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200249Peers) UnmarshalJSON(src []byte) error {
	v.isSet = true
