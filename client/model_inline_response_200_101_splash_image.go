...
// InlineResponse200101SplashImage The image used in the splash page.
type InlineResponse200101SplashImage struct {
...
func NewInlineResponse200101SplashImage() *InlineResponse200101SplashImage {
	this := InlineResponse200101SplashImage{}
	return &this
}
...
func (o InlineResponse200101SplashImage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200101SplashImage struct {
	value *InlineResponse200101SplashImage
	isSet bool
}

func (v NullableInlineResponse200101SplashImage) Get() *InlineResponse200101SplashImage {
	return v.value
}

func (v *NullableInlineResponse200101SplashImage) Set(val *InlineResponse200101SplashImage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200101SplashImage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200101SplashImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200101SplashImage(val *InlineResponse200101SplashImage) *NullableInlineResponse200101SplashImage {
	return &NullableInlineResponse200101SplashImage{value: val, isSet: true}
}

func (v NullableInlineResponse200101SplashImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200101SplashImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
