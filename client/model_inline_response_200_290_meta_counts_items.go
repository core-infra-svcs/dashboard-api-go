...
// InlineResponse200290MetaCountsItems The count metadata.
type InlineResponse200290MetaCountsItems struct {
...
func NewInlineResponse200290MetaCountsItems() *InlineResponse200290MetaCountsItems {
	this := InlineResponse200290MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200290MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200290MetaCountsItems struct {
	value *InlineResponse200290MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200290MetaCountsItems) Get() *InlineResponse200290MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200290MetaCountsItems) Set(val *InlineResponse200290MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200290MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200290MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200290MetaCountsItems(val *InlineResponse200290MetaCountsItems) *NullableInlineResponse200290MetaCountsItems {
	return &NullableInlineResponse200290MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200290MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200290MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
