...
// InlineResponse20038Stages struct for InlineResponse20038Stages
type InlineResponse20038Stages struct {
	Group *InlineResponse20038Group `json:"group,omitempty"`
	Milestones *InlineResponse20038Milestones `json:"milestones,omitempty"`
...
func NewInlineResponse20038Stages() *InlineResponse20038Stages {
	this := InlineResponse20038Stages{}
	return &this
}
...
func (o *InlineResponse20038Stages) GetGroup() InlineResponse20038Group {
	if o == nil || isNil(o.Group) {
		var ret InlineResponse20038Group
		return ret
	}
	return *o.Group
}
...
// SetGroup gets a reference to the given InlineResponse20038Group and assigns it to the Group field.
...
func (o *InlineResponse20038Stages) GetMilestones() InlineResponse20038Milestones {
	if o == nil || isNil(o.Milestones) {
		var ret InlineResponse20038Milestones
		return ret
	}
	return *o.Milestones
}
...
// SetMilestones gets a reference to the given InlineResponse20038Milestones and assigns it to the Milestones field.
...
func (o InlineResponse20038Stages) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20038Stages struct {
	value *InlineResponse20038Stages
	isSet bool
}

func (v NullableInlineResponse20038Stages) Get() *InlineResponse20038Stages {
	return v.value
}

func (v *NullableInlineResponse20038Stages) Set(val *InlineResponse20038Stages) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20038Stages) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20038Stages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20038Stages(val *InlineResponse20038Stages) *NullableInlineResponse20038Stages {
	return &NullableInlineResponse20038Stages{value: val, isSet: true}
}

func (v NullableInlineResponse20038Stages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20038Stages) UnmarshalJSON(src []byte) error {
	v.isSet = true
