...
// InlineResponse200153Rules struct for InlineResponse200153Rules
type InlineResponse200153Rules struct {
...
func NewInlineResponse200153Rules() *InlineResponse200153Rules {
	this := InlineResponse200153Rules{}
	return &this
}
...
func (o InlineResponse200153Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200153Rules struct {
	value *InlineResponse200153Rules
	isSet bool
}

func (v NullableInlineResponse200153Rules) Get() *InlineResponse200153Rules {
	return v.value
}

func (v *NullableInlineResponse200153Rules) Set(val *InlineResponse200153Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200153Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200153Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200153Rules(val *InlineResponse200153Rules) *NullableInlineResponse200153Rules {
	return &NullableInlineResponse200153Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200153Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200153Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
