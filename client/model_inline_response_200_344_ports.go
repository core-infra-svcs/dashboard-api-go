...
type InlineResponse200344Ports struct {
	...
	Cdp []InlineResponse200344Cdp `json:"cdp,omitempty"`
	// The Link Layer Discovery Protocol (LLDP) information of the connected device.
	Lldp []InlineResponse200344Lldp `json:"lldp,omitempty"`
}
...
func (o *InlineResponse200344Ports) GetCdp() []InlineResponse200344Cdp {
	if o == nil || isNil(o.Cdp) {
		var ret []InlineResponse200344Cdp
		return ret
	}
	return o.Cdp
}
...
// SetCdp gets a reference to the given []InlineResponse200344Cdp and assigns it to the Cdp field.
...
func (o *InlineResponse200344Ports) GetLldp() []InlineResponse200344Lldp {
	if o == nil || isNil(o.Lldp) {
		var ret []InlineResponse200344Lldp
		return ret
	}
	return o.Lldp
}
...
// SetLldp gets a reference to the given []InlineResponse200344Lldp and assigns it to the Lldp field.
