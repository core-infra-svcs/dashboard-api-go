...
type InlineResponse20056 struct {
	...
	ProtectedNetworks *InlineResponse20056ProtectedNetworks `json:"protectedNetworks,omitempty"`
}
...
func (o *InlineResponse20056) GetProtectedNetworks() InlineResponse20056ProtectedNetworks {
	if o == nil || isNil(o.ProtectedNetworks) {
		var ret InlineResponse20056ProtectedNetworks
		return ret
	}
...
// SetProtectedNetworks gets a reference to the given InlineResponse20056ProtectedNetworks and assigns it to the ProtectedNetworks field.
