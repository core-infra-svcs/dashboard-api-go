...
// InlineResponse200379Usage The usage on the interfaces of the wireless LAN controller
type InlineResponse200379Usage struct {
...
func NewInlineResponse200379Usage() *InlineResponse200379Usage {
	this := InlineResponse200379Usage{}
	return &this
}
...
func (o InlineResponse200379Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200379Usage struct {
	value *InlineResponse200379Usage
	isSet bool
}

func (v NullableInlineResponse200379Usage) Get() *InlineResponse200379Usage {
	return v.value
}

func (v *NullableInlineResponse200379Usage) Set(val *InlineResponse200379Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200379Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200379Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200379Usage(val *InlineResponse200379Usage) *NullableInlineResponse200379Usage {
	return &NullableInlineResponse200379Usage{value: val, isSet: true}
}

func (v NullableInlineResponse200379Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200379Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
