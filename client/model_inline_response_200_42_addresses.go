...
// InlineResponse20042Addresses struct for InlineResponse20042Addresses
type InlineResponse20042Addresses struct {
...
func NewInlineResponse20042Addresses() *InlineResponse20042Addresses {
	this := InlineResponse20042Addresses{}
	return &this
}
...
func (o InlineResponse20042Addresses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20042Addresses struct {
	value *InlineResponse20042Addresses
	isSet bool
}

func (v NullableInlineResponse20042Addresses) Get() *InlineResponse20042Addresses {
	return v.value
}

func (v *NullableInlineResponse20042Addresses) Set(val *InlineResponse20042Addresses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20042Addresses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20042Addresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20042Addresses(val *InlineResponse20042Addresses) *NullableInlineResponse20042Addresses {
	return &NullableInlineResponse20042Addresses{value: val, isSet: true}
}

func (v NullableInlineResponse20042Addresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20042Addresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
