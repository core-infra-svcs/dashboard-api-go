...
// InlineResponse200176VlanProfile The VLAN Profile
type InlineResponse200176VlanProfile struct {
...
func NewInlineResponse200176VlanProfile() *InlineResponse200176VlanProfile {
	this := InlineResponse200176VlanProfile{}
	return &this
}
...
func (o InlineResponse200176VlanProfile) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200176VlanProfile struct {
	value *InlineResponse200176VlanProfile
	isSet bool
}

func (v NullableInlineResponse200176VlanProfile) Get() *InlineResponse200176VlanProfile {
	return v.value
}

func (v *NullableInlineResponse200176VlanProfile) Set(val *InlineResponse200176VlanProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200176VlanProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200176VlanProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200176VlanProfile(val *InlineResponse200176VlanProfile) *NullableInlineResponse200176VlanProfile {
	return &NullableInlineResponse200176VlanProfile{value: val, isSet: true}
}

func (v NullableInlineResponse200176VlanProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200176VlanProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
