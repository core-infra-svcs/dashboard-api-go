...
// InlineResponse200337CreatedBy Information around who initiated the callback
type InlineResponse200337CreatedBy struct {
...
func NewInlineResponse200337CreatedBy() *InlineResponse200337CreatedBy {
	this := InlineResponse200337CreatedBy{}
	return &this
}
...
func (o InlineResponse200337CreatedBy) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200337CreatedBy struct {
	value *InlineResponse200337CreatedBy
	isSet bool
}

func (v NullableInlineResponse200337CreatedBy) Get() *InlineResponse200337CreatedBy {
	return v.value
}

func (v *NullableInlineResponse200337CreatedBy) Set(val *InlineResponse200337CreatedBy) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200337CreatedBy) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200337CreatedBy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200337CreatedBy(val *InlineResponse200337CreatedBy) *NullableInlineResponse200337CreatedBy {
	return &NullableInlineResponse200337CreatedBy{value: val, isSet: true}
}

func (v NullableInlineResponse200337CreatedBy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200337CreatedBy) UnmarshalJSON(src []byte) error {
	v.isSet = true
