...
// InlineResponse2008InterfacesWan1SvisIpv4 IPv4 settings for static/dynamic mode.
type InlineResponse2008InterfacesWan1SvisIpv4 struct {
...
func NewInlineResponse2008InterfacesWan1SvisIpv4() *InlineResponse2008InterfacesWan1SvisIpv4 {
	this := InlineResponse2008InterfacesWan1SvisIpv4{}
	return &this
}
...
func (o InlineResponse2008InterfacesWan1SvisIpv4) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2008InterfacesWan1SvisIpv4 struct {
	value *InlineResponse2008InterfacesWan1SvisIpv4
	isSet bool
}

func (v NullableInlineResponse2008InterfacesWan1SvisIpv4) Get() *InlineResponse2008InterfacesWan1SvisIpv4 {
	return v.value
}

func (v *NullableInlineResponse2008InterfacesWan1SvisIpv4) Set(val *InlineResponse2008InterfacesWan1SvisIpv4) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2008InterfacesWan1SvisIpv4) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2008InterfacesWan1SvisIpv4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2008InterfacesWan1SvisIpv4(val *InlineResponse2008InterfacesWan1SvisIpv4) *NullableInlineResponse2008InterfacesWan1SvisIpv4 {
	return &NullableInlineResponse2008InterfacesWan1SvisIpv4{value: val, isSet: true}
}

func (v NullableInlineResponse2008InterfacesWan1SvisIpv4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2008InterfacesWan1SvisIpv4) UnmarshalJSON(src []byte) error {
	v.isSet = true
