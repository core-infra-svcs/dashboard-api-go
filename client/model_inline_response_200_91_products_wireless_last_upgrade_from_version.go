...
// InlineResponse20091ProductsWirelessLastUpgradeFromVersion Details of the version the device upgraded from
type InlineResponse20091ProductsWirelessLastUpgradeFromVersion struct {
...
func NewInlineResponse20091ProductsWirelessLastUpgradeFromVersion() *InlineResponse20091ProductsWirelessLastUpgradeFromVersion {
	this := InlineResponse20091ProductsWirelessLastUpgradeFromVersion{}
	return &this
}
...
func (o InlineResponse20091ProductsWirelessLastUpgradeFromVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20091ProductsWirelessLastUpgradeFromVersion struct {
	value *InlineResponse20091ProductsWirelessLastUpgradeFromVersion
	isSet bool
}

func (v NullableInlineResponse20091ProductsWirelessLastUpgradeFromVersion) Get() *InlineResponse20091ProductsWirelessLastUpgradeFromVersion {
	return v.value
}

func (v *NullableInlineResponse20091ProductsWirelessLastUpgradeFromVersion) Set(val *InlineResponse20091ProductsWirelessLastUpgradeFromVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20091ProductsWirelessLastUpgradeFromVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20091ProductsWirelessLastUpgradeFromVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20091ProductsWirelessLastUpgradeFromVersion(val *InlineResponse20091ProductsWirelessLastUpgradeFromVersion) *NullableInlineResponse20091ProductsWirelessLastUpgradeFromVersion {
	return &NullableInlineResponse20091ProductsWirelessLastUpgradeFromVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20091ProductsWirelessLastUpgradeFromVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20091ProductsWirelessLastUpgradeFromVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
