...
// InlineResponse20064Value Value of traffic filter
type InlineResponse20064Value struct {
	// Protocol of 'custom' type traffic filter. Must be one of: 'tcp', 'udp', 'icmp6' or 'any'
	Protocol *string `json:"protocol,omitempty"`
	Source InlineResponse20064ValueSource `json:"source"`
...
func (o *InlineResponse20064Value) GetSource() InlineResponse20064ValueSource {
	if o == nil {
		var ret InlineResponse20064ValueSource
		return ret
	}
...
func (o InlineResponse20064Value) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20064Value struct {
	value *InlineResponse20064Value
	isSet bool
}

func (v NullableInlineResponse20064Value) Get() *InlineResponse20064Value {
	return v.value
}

func (v *NullableInlineResponse20064Value) Set(val *InlineResponse20064Value) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20064Value) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20064Value) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20064Value(val *InlineResponse20064Value) *NullableInlineResponse20064Value {
	return &NullableInlineResponse20064Value{value: val, isSet: true}
}

func (v NullableInlineResponse20064Value) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20064Value) UnmarshalJSON(src []byte) error {
	v.isSet = true
