...
// InlineResponse200350Ssid Wireless access point and network identifier.
type InlineResponse200350Ssid struct {
...
func (o InlineResponse200350Ssid) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200350Ssid struct {
	value *InlineResponse200350Ssid
	isSet bool
}

func (v NullableInlineResponse200350Ssid) Get() *InlineResponse200350Ssid {
	return v.value
}

func (v *NullableInlineResponse200350Ssid) Set(val *InlineResponse200350Ssid) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200350Ssid) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200350Ssid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200350Ssid(val *InlineResponse200350Ssid) *NullableInlineResponse200350Ssid {
	return &NullableInlineResponse200350Ssid{value: val, isSet: true}
}

func (v NullableInlineResponse200350Ssid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200350Ssid) UnmarshalJSON(src []byte) error {
	v.isSet = true
