...
func (r RolesApiCreateOrganizationSmAdminsRoleRequest) CreateOrganizationSmAdminsRole(createOrganizationSmAdminsRole InlineObject268) RolesApiCreateOrganizationSmAdminsRoleRequest {
	r.createOrganizationSmAdminsRole = &createOrganizationSmAdminsRole
	return r
}

func (r RolesApiCreateOrganizationSmAdminsRoleRequest) Execute() (*InlineResponse200286Items, *http.Response, error) {
...
func (a *RolesApiService) CreateOrganizationSmAdminsRoleExecute(r RolesApiCreateOrganizationSmAdminsRoleRequest) (*InlineResponse200286Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RolesApiGetOrganizationSmAdminsRoleRequest) Execute() (*InlineResponse200286Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200286Items
func (a *RolesApiService) GetOrganizationSmAdminsRoleExecute(r RolesApiGetOrganizationSmAdminsRoleRequest) (*InlineResponse200286Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RolesApiGetOrganizationSmAdminsRolesRequest) Execute() (*InlineResponse200286, *http.Response, error) {
...
func (a *RolesApiService) GetOrganizationSmAdminsRolesExecute(r RolesApiGetOrganizationSmAdminsRolesRequest) (*InlineResponse200286, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RolesApiUpdateOrganizationSmAdminsRoleRequest) UpdateOrganizationSmAdminsRole(updateOrganizationSmAdminsRole InlineObject269) RolesApiUpdateOrganizationSmAdminsRoleRequest {
	r.updateOrganizationSmAdminsRole = &updateOrganizationSmAdminsRole
	return r
}

func (r RolesApiUpdateOrganizationSmAdminsRoleRequest) Execute() (*InlineResponse200286Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200286Items
func (a *RolesApiService) UpdateOrganizationSmAdminsRoleExecute(r RolesApiUpdateOrganizationSmAdminsRoleRequest) (*InlineResponse200286Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
