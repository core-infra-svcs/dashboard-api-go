...
func (r RolesApiCreateOrganizationCameraRoleRequest) CreateOrganizationCameraRole(createOrganizationCameraRole InlineObject215) RolesApiCreateOrganizationCameraRoleRequest {
...
func (r RolesApiCreateOrganizationSmAdminsRoleRequest) CreateOrganizationSmAdminsRole(createOrganizationSmAdminsRole InlineObject250) RolesApiCreateOrganizationSmAdminsRoleRequest {
	r.createOrganizationSmAdminsRole = &createOrganizationSmAdminsRole
	return r
}

func (r RolesApiCreateOrganizationSmAdminsRoleRequest) Execute() (*InlineResponse200259Items, *http.Response, error) {
...
func (a *RolesApiService) CreateOrganizationSmAdminsRoleExecute(r RolesApiCreateOrganizationSmAdminsRoleRequest) (*InlineResponse200259Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RolesApiGetOrganizationSmAdminsRoleRequest) Execute() (*InlineResponse200259Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200259Items
func (a *RolesApiService) GetOrganizationSmAdminsRoleExecute(r RolesApiGetOrganizationSmAdminsRoleRequest) (*InlineResponse200259Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RolesApiGetOrganizationSmAdminsRolesRequest) Execute() (*InlineResponse200259, *http.Response, error) {
...
func (a *RolesApiService) GetOrganizationSmAdminsRolesExecute(r RolesApiGetOrganizationSmAdminsRolesRequest) (*InlineResponse200259, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r RolesApiUpdateOrganizationCameraRoleRequest) UpdateOrganizationCameraRole(updateOrganizationCameraRole InlineObject216) RolesApiUpdateOrganizationCameraRoleRequest {
...
func (r RolesApiUpdateOrganizationSmAdminsRoleRequest) UpdateOrganizationSmAdminsRole(updateOrganizationSmAdminsRole InlineObject251) RolesApiUpdateOrganizationSmAdminsRoleRequest {
	r.updateOrganizationSmAdminsRole = &updateOrganizationSmAdminsRole
	return r
}

func (r RolesApiUpdateOrganizationSmAdminsRoleRequest) Execute() (*InlineResponse200259Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200259Items
func (a *RolesApiService) UpdateOrganizationSmAdminsRoleExecute(r RolesApiUpdateOrganizationSmAdminsRoleRequest) (*InlineResponse200259Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
