...
// InlineResponse200119Limits The current limits of various adaptive policy objects.
type InlineResponse200119Limits struct {
...
func NewInlineResponse200119Limits() *InlineResponse200119Limits {
	this := InlineResponse200119Limits{}
	return &this
}
...
func (o InlineResponse200119Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200119Limits struct {
	value *InlineResponse200119Limits
	isSet bool
}

func (v NullableInlineResponse200119Limits) Get() *InlineResponse200119Limits {
	return v.value
}

func (v *NullableInlineResponse200119Limits) Set(val *InlineResponse200119Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200119Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200119Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200119Limits(val *InlineResponse200119Limits) *NullableInlineResponse200119Limits {
	return &NullableInlineResponse200119Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200119Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200119Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
