...
// InlineResponse20032ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20032ToVersion struct {
...
func NewInlineResponse20032ToVersion() *InlineResponse20032ToVersion {
	this := InlineResponse20032ToVersion{}
	return &this
}
...
func (o InlineResponse20032ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20032ToVersion struct {
	value *InlineResponse20032ToVersion
	isSet bool
}

func (v NullableInlineResponse20032ToVersion) Get() *InlineResponse20032ToVersion {
	return v.value
}

func (v *NullableInlineResponse20032ToVersion) Set(val *InlineResponse20032ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20032ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20032ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20032ToVersion(val *InlineResponse20032ToVersion) *NullableInlineResponse20032ToVersion {
	return &NullableInlineResponse20032ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20032ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20032ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
