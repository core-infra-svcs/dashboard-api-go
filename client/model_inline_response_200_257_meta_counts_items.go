...
// InlineResponse200257MetaCountsItems The count metadata.
type InlineResponse200257MetaCountsItems struct {
...
func NewInlineResponse200257MetaCountsItems() *InlineResponse200257MetaCountsItems {
	this := InlineResponse200257MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200257MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200257MetaCountsItems struct {
	value *InlineResponse200257MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200257MetaCountsItems) Get() *InlineResponse200257MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200257MetaCountsItems) Set(val *InlineResponse200257MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200257MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200257MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200257MetaCountsItems(val *InlineResponse200257MetaCountsItems) *NullableInlineResponse200257MetaCountsItems {
	return &NullableInlineResponse200257MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200257MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200257MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
