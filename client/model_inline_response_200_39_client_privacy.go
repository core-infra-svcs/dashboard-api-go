...
// InlineResponse20039ClientPrivacy Privacy settings
type InlineResponse20039ClientPrivacy struct {
...
func NewInlineResponse20039ClientPrivacy() *InlineResponse20039ClientPrivacy {
	this := InlineResponse20039ClientPrivacy{}
	return &this
}
...
func (o InlineResponse20039ClientPrivacy) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20039ClientPrivacy struct {
	value *InlineResponse20039ClientPrivacy
	isSet bool
}

func (v NullableInlineResponse20039ClientPrivacy) Get() *InlineResponse20039ClientPrivacy {
	return v.value
}

func (v *NullableInlineResponse20039ClientPrivacy) Set(val *InlineResponse20039ClientPrivacy) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20039ClientPrivacy) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20039ClientPrivacy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20039ClientPrivacy(val *InlineResponse20039ClientPrivacy) *NullableInlineResponse20039ClientPrivacy {
	return &NullableInlineResponse20039ClientPrivacy{value: val, isSet: true}
}

func (v NullableInlineResponse20039ClientPrivacy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20039ClientPrivacy) UnmarshalJSON(src []byte) error {
	v.isSet = true
