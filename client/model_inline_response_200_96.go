...
type InlineResponse20096 struct {
	...
	PoliciesBySsid []InlineResponse20096PoliciesBySsid `json:"policiesBySsid,omitempty"`
}
...
func (o *InlineResponse20096) GetPoliciesBySsid() []InlineResponse20096PoliciesBySsid {
	if o == nil || isNil(o.PoliciesBySsid) {
		var ret []InlineResponse20096PoliciesBySsid
		return ret
	}
...
// SetPoliciesBySsid gets a reference to the given []InlineResponse20096PoliciesBySsid and assigns it to the PoliciesBySsid field.
