...
type InlineResponse20096 struct {
	...
	Networks []InlineResponse20096Networks `json:"networks,omitempty"`
	// The list of tags that the SAML administrator has privleges on
	Tags []InlineResponse20096Tags `json:"tags,omitempty"`
}
...
func (o *InlineResponse20096) GetNetworks() []InlineResponse20096Networks {
	if o == nil || isNil(o.Networks) {
		var ret []InlineResponse20096Networks
		return ret
	}
	return o.Networks
}
...
// SetNetworks gets a reference to the given []InlineResponse20096Networks and assigns it to the Networks field.
...
func (o *InlineResponse20096) GetTags() []InlineResponse20096Tags {
	if o == nil || isNil(o.Tags) {
		var ret []InlineResponse20096Tags
		return ret
	}
	return o.Tags
}
...
// SetTags gets a reference to the given []InlineResponse20096Tags and assigns it to the Tags field.
