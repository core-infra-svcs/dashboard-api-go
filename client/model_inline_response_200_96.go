...
type InlineResponse20096 struct {
	...
	Usage *NetworksNetworkIdClientsUsage `json:"usage,omitempty"`
...
func (o *InlineResponse20096) GetUsage() NetworksNetworkIdClientsUsage {
	if o == nil || isNil(o.Usage) {
		var ret NetworksNetworkIdClientsUsage
		return ret
	}
	return *o.Usage
}
...
// SetUsage gets a reference to the given NetworksNetworkIdClientsUsage and assigns it to the Usage field.
