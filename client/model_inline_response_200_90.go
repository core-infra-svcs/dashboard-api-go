...
type InlineResponse20090 struct {
	...
	ToVersion *InlineResponse20090ToVersion `json:"toVersion,omitempty"`
...
func (o *InlineResponse20090) GetToVersion() InlineResponse20090ToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20090ToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20090ToVersion and assigns it to the ToVersion field.
