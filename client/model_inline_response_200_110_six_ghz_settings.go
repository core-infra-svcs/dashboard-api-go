...
// InlineResponse200110SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200110SixGhzSettings struct {
...
func NewInlineResponse200110SixGhzSettings() *InlineResponse200110SixGhzSettings {
	this := InlineResponse200110SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200110SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200110SixGhzSettings struct {
	value *InlineResponse200110SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200110SixGhzSettings) Get() *InlineResponse200110SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200110SixGhzSettings) Set(val *InlineResponse200110SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200110SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200110SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200110SixGhzSettings(val *InlineResponse200110SixGhzSettings) *NullableInlineResponse200110SixGhzSettings {
	return &NullableInlineResponse200110SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200110SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200110SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
