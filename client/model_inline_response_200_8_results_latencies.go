...
// InlineResponse2008ResultsLatencies Packet latency stats
type InlineResponse2008ResultsLatencies struct {
	// Minimum latency
...
func NewInlineResponse2008ResultsLatencies() *InlineResponse2008ResultsLatencies {
	this := InlineResponse2008ResultsLatencies{}
	return &this
}
...
func (o InlineResponse2008ResultsLatencies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2008ResultsLatencies struct {
	value *InlineResponse2008ResultsLatencies
	isSet bool
}

func (v NullableInlineResponse2008ResultsLatencies) Get() *InlineResponse2008ResultsLatencies {
	return v.value
}

func (v *NullableInlineResponse2008ResultsLatencies) Set(val *InlineResponse2008ResultsLatencies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2008ResultsLatencies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2008ResultsLatencies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2008ResultsLatencies(val *InlineResponse2008ResultsLatencies) *NullableInlineResponse2008ResultsLatencies {
	return &NullableInlineResponse2008ResultsLatencies{value: val, isSet: true}
}

func (v NullableInlineResponse2008ResultsLatencies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2008ResultsLatencies) UnmarshalJSON(src []byte) error {
	v.isSet = true
