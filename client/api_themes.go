...
func (r ThemesApiCreateOrganizationSplashThemeRequest) CreateOrganizationSplashTheme(createOrganizationSplashTheme InlineObject298) ThemesApiCreateOrganizationSplashThemeRequest {
	r.createOrganizationSplashTheme = &createOrganizationSplashTheme
	return r
}

func (r ThemesApiCreateOrganizationSplashThemeRequest) Execute() (*InlineResponse200323, *http.Response, error) {
...
func (a *ThemesApiService) CreateOrganizationSplashThemeExecute(r ThemesApiCreateOrganizationSplashThemeRequest) (*InlineResponse200323, *http.Response, error) {
	var (
...
func (r ThemesApiCreateOrganizationSplashThemeAssetRequest) CreateOrganizationSplashThemeAsset(createOrganizationSplashThemeAsset InlineObject299) ThemesApiCreateOrganizationSplashThemeAssetRequest {
	r.createOrganizationSplashThemeAsset = &createOrganizationSplashThemeAsset
	return r
}

func (r ThemesApiCreateOrganizationSplashThemeAssetRequest) Execute() (*InlineResponse200322, *http.Response, error) {
...
func (a *ThemesApiService) CreateOrganizationSplashThemeAssetExecute(r ThemesApiCreateOrganizationSplashThemeAssetRequest) (*InlineResponse200322, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ThemesApiGetOrganizationSplashThemesRequest) Execute() ([]InlineResponse200323, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200323
func (a *ThemesApiService) GetOrganizationSplashThemesExecute(r ThemesApiGetOrganizationSplashThemesRequest) ([]InlineResponse200323, *http.Response, error) {
	var (
