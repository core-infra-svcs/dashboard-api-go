...
func (r ThemesApiCreateOrganizationSplashThemeRequest) CreateOrganizationSplashTheme(createOrganizationSplashTheme InlineObject270) ThemesApiCreateOrganizationSplashThemeRequest {
	r.createOrganizationSplashTheme = &createOrganizationSplashTheme
	return r
}

func (r ThemesApiCreateOrganizationSplashThemeRequest) Execute() (*InlineResponse200291, *http.Response, error) {
...
func (a *ThemesApiService) CreateOrganizationSplashThemeExecute(r ThemesApiCreateOrganizationSplashThemeRequest) (*InlineResponse200291, *http.Response, error) {
	var (
...
func (r ThemesApiCreateOrganizationSplashThemeAssetRequest) CreateOrganizationSplashThemeAsset(createOrganizationSplashThemeAsset InlineObject271) ThemesApiCreateOrganizationSplashThemeAssetRequest {
	r.createOrganizationSplashThemeAsset = &createOrganizationSplashThemeAsset
	return r
}

func (r ThemesApiCreateOrganizationSplashThemeAssetRequest) Execute() (*InlineResponse200290, *http.Response, error) {
...
func (a *ThemesApiService) CreateOrganizationSplashThemeAssetExecute(r ThemesApiCreateOrganizationSplashThemeAssetRequest) (*InlineResponse200290, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ThemesApiGetOrganizationSplashThemesRequest) Execute() ([]InlineResponse200291, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200291
func (a *ThemesApiService) GetOrganizationSplashThemesExecute(r ThemesApiGetOrganizationSplashThemesRequest) ([]InlineResponse200291, *http.Response, error) {
	var (
