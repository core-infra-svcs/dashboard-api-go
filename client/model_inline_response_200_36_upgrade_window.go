...
// InlineResponse20036UpgradeWindow Upgrade window for devices in network
type InlineResponse20036UpgradeWindow struct {
	// Day of the week
...
func NewInlineResponse20036UpgradeWindow() *InlineResponse20036UpgradeWindow {
	this := InlineResponse20036UpgradeWindow{}
	return &this
}
...
func (o InlineResponse20036UpgradeWindow) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20036UpgradeWindow struct {
	value *InlineResponse20036UpgradeWindow
	isSet bool
}

func (v NullableInlineResponse20036UpgradeWindow) Get() *InlineResponse20036UpgradeWindow {
	return v.value
}

func (v *NullableInlineResponse20036UpgradeWindow) Set(val *InlineResponse20036UpgradeWindow) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20036UpgradeWindow) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20036UpgradeWindow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20036UpgradeWindow(val *InlineResponse20036UpgradeWindow) *NullableInlineResponse20036UpgradeWindow {
	return &NullableInlineResponse20036UpgradeWindow{value: val, isSet: true}
}

func (v NullableInlineResponse20036UpgradeWindow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20036UpgradeWindow) UnmarshalJSON(src []byte) error {
	v.isSet = true
