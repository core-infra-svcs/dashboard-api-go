...
func NewInlineObject35(rules []NetworksNetworkIdApplianceFirewallOneToOneNatRulesRules) *InlineObject35 {
	this := InlineObject35{}
	this.Rules = rules
	return &this
}
...
func (o *InlineObject35) GetRules() []NetworksNetworkIdApplianceFirewallOneToOneNatRulesRules {
	if o == nil {
...
func (o *InlineObject35) GetRulesOk() (*[]NetworksNetworkIdApplianceFirewallOneToOneNatRulesRules, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Rules, true
...
func (o *InlineObject35) SetRules(v []NetworksNetworkIdApplianceFirewallOneToOneNatRulesRules) {
	o.Rules = v
}
