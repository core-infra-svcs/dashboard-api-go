...
// InlineResponse200322Subscriptions struct for InlineResponse200322Subscriptions
type InlineResponse200322Subscriptions struct {
	// Subscription ID
...
func NewInlineResponse200322Subscriptions() *InlineResponse200322Subscriptions {
	this := InlineResponse200322Subscriptions{}
	return &this
}
...
func (o InlineResponse200322Subscriptions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200322Subscriptions struct {
	value *InlineResponse200322Subscriptions
	isSet bool
}

func (v NullableInlineResponse200322Subscriptions) Get() *InlineResponse200322Subscriptions {
	return v.value
}

func (v *NullableInlineResponse200322Subscriptions) Set(val *InlineResponse200322Subscriptions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200322Subscriptions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200322Subscriptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200322Subscriptions(val *InlineResponse200322Subscriptions) *NullableInlineResponse200322Subscriptions {
	return &NullableInlineResponse200322Subscriptions{value: val, isSet: true}
}

func (v NullableInlineResponse200322Subscriptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200322Subscriptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
