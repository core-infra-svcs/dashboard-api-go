...
// InlineResponse2006Interfaces Interface settings.
type InlineResponse2006Interfaces struct {
	Wan1 *InlineResponse2006InterfacesWan1 `json:"wan1,omitempty"`
	Wan2 *InlineResponse2006InterfacesWan2 `json:"wan2,omitempty"`
}
...
func NewInlineResponse2006Interfaces() *InlineResponse2006Interfaces {
	this := InlineResponse2006Interfaces{}
	return &this
}
...
func (o *InlineResponse2006Interfaces) GetWan1() InlineResponse2006InterfacesWan1 {
	if o == nil || isNil(o.Wan1) {
		var ret InlineResponse2006InterfacesWan1
		return ret
	}
	return *o.Wan1
}
...
// SetWan1 gets a reference to the given InlineResponse2006InterfacesWan1 and assigns it to the Wan1 field.
...
func (o *InlineResponse2006Interfaces) GetWan2() InlineResponse2006InterfacesWan2 {
	if o == nil || isNil(o.Wan2) {
		var ret InlineResponse2006InterfacesWan2
		return ret
	}
	return *o.Wan2
}
...
// SetWan2 gets a reference to the given InlineResponse2006InterfacesWan2 and assigns it to the Wan2 field.
func (o *InlineResponse2006Interfaces) SetWan2(v InlineResponse2006InterfacesWan2) {
	o.Wan2 = &v
}

func (o InlineResponse2006Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2006Interfaces struct {
	value *InlineResponse2006Interfaces
	isSet bool
}

func (v NullableInlineResponse2006Interfaces) Get() *InlineResponse2006Interfaces {
	return v.value
}

func (v *NullableInlineResponse2006Interfaces) Set(val *InlineResponse2006Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2006Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2006Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2006Interfaces(val *InlineResponse2006Interfaces) *NullableInlineResponse2006Interfaces {
	return &NullableInlineResponse2006Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse2006Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2006Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
