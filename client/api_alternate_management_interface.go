...
func (r AlternateManagementInterfaceApiGetNetworkSwitchAlternateManagementInterfaceRequest) Execute() (*InlineResponse200158, *http.Response, error) {
...
func (a *AlternateManagementInterfaceApiService) GetNetworkSwitchAlternateManagementInterfaceExecute(r AlternateManagementInterfaceApiGetNetworkSwitchAlternateManagementInterfaceRequest) (*InlineResponse200158, *http.Response, error) {
	var (
...
func (r AlternateManagementInterfaceApiUpdateNetworkSwitchAlternateManagementInterfaceRequest) Execute() (*InlineResponse200158, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200158
func (a *AlternateManagementInterfaceApiService) UpdateNetworkSwitchAlternateManagementInterfaceExecute(r AlternateManagementInterfaceApiUpdateNetworkSwitchAlternateManagementInterfaceRequest) (*InlineResponse200158, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
