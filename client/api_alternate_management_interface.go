...
func (r AlternateManagementInterfaceApiGetNetworkSwitchAlternateManagementInterfaceRequest) Execute() (*InlineResponse200147, *http.Response, error) {
...
func (a *AlternateManagementInterfaceApiService) GetNetworkSwitchAlternateManagementInterfaceExecute(r AlternateManagementInterfaceApiGetNetworkSwitchAlternateManagementInterfaceRequest) (*InlineResponse200147, *http.Response, error) {
	var (
...
func (r AlternateManagementInterfaceApiUpdateDeviceWirelessAlternateManagementInterfaceIpv6Request) Execute() (*InlineResponse20040, *http.Response, error) {
...
func (a *AlternateManagementInterfaceApiService) UpdateDeviceWirelessAlternateManagementInterfaceIpv6Execute(r AlternateManagementInterfaceApiUpdateDeviceWirelessAlternateManagementInterfaceIpv6Request) (*InlineResponse20040, *http.Response, error) {
	var (
...
func (r AlternateManagementInterfaceApiUpdateNetworkSwitchAlternateManagementInterfaceRequest) Execute() (*InlineResponse200147, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200147
func (a *AlternateManagementInterfaceApiService) UpdateNetworkSwitchAlternateManagementInterfaceExecute(r AlternateManagementInterfaceApiUpdateNetworkSwitchAlternateManagementInterfaceRequest) (*InlineResponse200147, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
