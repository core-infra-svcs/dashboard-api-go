...
func (r AlternateManagementInterfaceApiGetNetworkSwitchAlternateManagementInterfaceRequest) Execute() (*InlineResponse20075, *http.Response, error) {
...
func (a *AlternateManagementInterfaceApiService) GetNetworkSwitchAlternateManagementInterfaceExecute(r AlternateManagementInterfaceApiGetNetworkSwitchAlternateManagementInterfaceRequest) (*InlineResponse20075, *http.Response, error) {
	var (
...
func (r AlternateManagementInterfaceApiUpdateDeviceWirelessAlternateManagementInterfaceIpv6Request) Execute() (*InlineResponse20011, *http.Response, error) {
...
func (a *AlternateManagementInterfaceApiService) UpdateDeviceWirelessAlternateManagementInterfaceIpv6Execute(r AlternateManagementInterfaceApiUpdateDeviceWirelessAlternateManagementInterfaceIpv6Request) (*InlineResponse20011, *http.Response, error) {
	var (
