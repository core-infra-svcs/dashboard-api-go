...
func (r AlternateManagementInterfaceApiGetNetworkSwitchAlternateManagementInterfaceRequest) Execute() (*InlineResponse200142, *http.Response, error) {
...
func (a *AlternateManagementInterfaceApiService) GetNetworkSwitchAlternateManagementInterfaceExecute(r AlternateManagementInterfaceApiGetNetworkSwitchAlternateManagementInterfaceRequest) (*InlineResponse200142, *http.Response, error) {
	var (
...
func (r AlternateManagementInterfaceApiUpdateDeviceWirelessAlternateManagementInterfaceIpv6Request) Execute() (*InlineResponse20039, *http.Response, error) {
...
func (a *AlternateManagementInterfaceApiService) UpdateDeviceWirelessAlternateManagementInterfaceIpv6Execute(r AlternateManagementInterfaceApiUpdateDeviceWirelessAlternateManagementInterfaceIpv6Request) (*InlineResponse20039, *http.Response, error) {
	var (
...
func (r AlternateManagementInterfaceApiUpdateNetworkSwitchAlternateManagementInterfaceRequest) Execute() (*InlineResponse200142, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200142
func (a *AlternateManagementInterfaceApiService) UpdateNetworkSwitchAlternateManagementInterfaceExecute(r AlternateManagementInterfaceApiUpdateNetworkSwitchAlternateManagementInterfaceRequest) (*InlineResponse200142, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
