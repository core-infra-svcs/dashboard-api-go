...
// InlineResponse20038ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20038ToVersion struct {
...
func NewInlineResponse20038ToVersion() *InlineResponse20038ToVersion {
	this := InlineResponse20038ToVersion{}
	return &this
}
...
func (o InlineResponse20038ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20038ToVersion struct {
	value *InlineResponse20038ToVersion
	isSet bool
}

func (v NullableInlineResponse20038ToVersion) Get() *InlineResponse20038ToVersion {
	return v.value
}

func (v *NullableInlineResponse20038ToVersion) Set(val *InlineResponse20038ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20038ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20038ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20038ToVersion(val *InlineResponse20038ToVersion) *NullableInlineResponse20038ToVersion {
	return &NullableInlineResponse20038ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20038ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20038ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
