...
// InlineResponse200354Module The module of this wireless LAN controller interface
type InlineResponse200354Module struct {
...
func NewInlineResponse200354Module() *InlineResponse200354Module {
	this := InlineResponse200354Module{}
	return &this
}
...
func (o InlineResponse200354Module) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200354Module struct {
	value *InlineResponse200354Module
	isSet bool
}

func (v NullableInlineResponse200354Module) Get() *InlineResponse200354Module {
	return v.value
}

func (v *NullableInlineResponse200354Module) Set(val *InlineResponse200354Module) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200354Module) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200354Module) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200354Module(val *InlineResponse200354Module) *NullableInlineResponse200354Module {
	return &NullableInlineResponse200354Module{value: val, isSet: true}
}

func (v NullableInlineResponse200354Module) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200354Module) UnmarshalJSON(src []byte) error {
	v.isSet = true
