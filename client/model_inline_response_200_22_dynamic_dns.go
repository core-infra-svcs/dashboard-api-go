...
// InlineResponse20022DynamicDns Dynamic DNS settings for a network
type InlineResponse20022DynamicDns struct {
	// Dynamic DNS enabled
...
func NewInlineResponse20022DynamicDns() *InlineResponse20022DynamicDns {
	this := InlineResponse20022DynamicDns{}
	return &this
}
...
func (o InlineResponse20022DynamicDns) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20022DynamicDns struct {
	value *InlineResponse20022DynamicDns
	isSet bool
}

func (v NullableInlineResponse20022DynamicDns) Get() *InlineResponse20022DynamicDns {
	return v.value
}

func (v *NullableInlineResponse20022DynamicDns) Set(val *InlineResponse20022DynamicDns) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20022DynamicDns) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20022DynamicDns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20022DynamicDns(val *InlineResponse20022DynamicDns) *NullableInlineResponse20022DynamicDns {
	return &NullableInlineResponse20022DynamicDns{value: val, isSet: true}
}

func (v NullableInlineResponse20022DynamicDns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20022DynamicDns) UnmarshalJSON(src []byte) error {
	v.isSet = true
