...
func (r EventTypesApiGetNetworkEventsEventTypesRequest) Execute() ([]InlineResponse20090, *http.Response, error) {
...
func (a *EventTypesApiService) GetNetworkEventsEventTypesExecute(r EventTypesApiGetNetworkEventsEventTypesRequest) ([]InlineResponse20090, *http.Response, error) {
	var (
