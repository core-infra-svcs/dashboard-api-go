...
func (r EventTypesApiGetNetworkEventsEventTypesRequest) Execute() ([]InlineResponse20096, *http.Response, error) {
...
func (a *EventTypesApiService) GetNetworkEventsEventTypesExecute(r EventTypesApiGetNetworkEventsEventTypesRequest) ([]InlineResponse20096, *http.Response, error) {
	var (
