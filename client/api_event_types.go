...
func (r EventTypesApiGetNetworkEventsEventTypesRequest) Execute() ([]InlineResponse200107, *http.Response, error) {
...
func (a *EventTypesApiService) GetNetworkEventsEventTypesExecute(r EventTypesApiGetNetworkEventsEventTypesRequest) ([]InlineResponse200107, *http.Response, error) {
	var (
