...
// InlineResponse200193Billing Details associated with billing splash
type InlineResponse200193Billing struct {
	FreeAccess *InlineResponse200193BillingFreeAccess `json:"freeAccess,omitempty"`
...
func NewInlineResponse200193Billing() *InlineResponse200193Billing {
	this := InlineResponse200193Billing{}
	return &this
}
...
func (o *InlineResponse200193Billing) GetFreeAccess() InlineResponse200193BillingFreeAccess {
	if o == nil || isNil(o.FreeAccess) {
		var ret InlineResponse200193BillingFreeAccess
		return ret
	}
	return *o.FreeAccess
}
...
// SetFreeAccess gets a reference to the given InlineResponse200193BillingFreeAccess and assigns it to the FreeAccess field.
...
func (o InlineResponse200193Billing) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200193Billing struct {
	value *InlineResponse200193Billing
	isSet bool
}

func (v NullableInlineResponse200193Billing) Get() *InlineResponse200193Billing {
	return v.value
}

func (v *NullableInlineResponse200193Billing) Set(val *InlineResponse200193Billing) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200193Billing) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200193Billing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200193Billing(val *InlineResponse200193Billing) *NullableInlineResponse200193Billing {
	return &NullableInlineResponse200193Billing{value: val, isSet: true}
}

func (v NullableInlineResponse200193Billing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200193Billing) UnmarshalJSON(src []byte) error {
	v.isSet = true
