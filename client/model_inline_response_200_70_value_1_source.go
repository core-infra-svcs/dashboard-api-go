...
// InlineResponse20070Value1Source Source of 'custom' type traffic filter
type InlineResponse20070Value1Source struct {
...
func NewInlineResponse20070Value1Source() *InlineResponse20070Value1Source {
	this := InlineResponse20070Value1Source{}
	return &this
}
...
func (o InlineResponse20070Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20070Value1Source struct {
	value *InlineResponse20070Value1Source
	isSet bool
}

func (v NullableInlineResponse20070Value1Source) Get() *InlineResponse20070Value1Source {
	return v.value
}

func (v *NullableInlineResponse20070Value1Source) Set(val *InlineResponse20070Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20070Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20070Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20070Value1Source(val *InlineResponse20070Value1Source) *NullableInlineResponse20070Value1Source {
	return &NullableInlineResponse20070Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20070Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20070Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
