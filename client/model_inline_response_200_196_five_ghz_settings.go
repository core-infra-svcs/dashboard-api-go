...
// InlineResponse200196FiveGhzSettings Settings related to 5Ghz band
type InlineResponse200196FiveGhzSettings struct {
...
func NewInlineResponse200196FiveGhzSettings() *InlineResponse200196FiveGhzSettings {
	this := InlineResponse200196FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse200196FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200196FiveGhzSettings struct {
	value *InlineResponse200196FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse200196FiveGhzSettings) Get() *InlineResponse200196FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200196FiveGhzSettings) Set(val *InlineResponse200196FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200196FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200196FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200196FiveGhzSettings(val *InlineResponse200196FiveGhzSettings) *NullableInlineResponse200196FiveGhzSettings {
	return &NullableInlineResponse200196FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200196FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200196FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
