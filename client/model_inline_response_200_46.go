...
type InlineResponse20046 struct {
	...
	DhcpOptions []InlineResponse20046DhcpOptions `json:"dhcpOptions,omitempty"`
	// Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
	ReservedIpRanges []InlineResponse20046ReservedIpRanges `json:"reservedIpRanges,omitempty"`
	// Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
	FixedIpAssignments []InlineResponse20046FixedIpAssignments `json:"fixedIpAssignments,omitempty"`
}
...
func (o *InlineResponse20046) GetDhcpOptions() []InlineResponse20046DhcpOptions {
	if o == nil || isNil(o.DhcpOptions) {
		var ret []InlineResponse20046DhcpOptions
		return ret
	}
...
// SetDhcpOptions gets a reference to the given []InlineResponse20046DhcpOptions and assigns it to the DhcpOptions field.
...
func (o *InlineResponse20046) GetReservedIpRanges() []InlineResponse20046ReservedIpRanges {
	if o == nil || isNil(o.ReservedIpRanges) {
		var ret []InlineResponse20046ReservedIpRanges
		return ret
	}
...
// SetReservedIpRanges gets a reference to the given []InlineResponse20046ReservedIpRanges and assigns it to the ReservedIpRanges field.
...
func (o *InlineResponse20046) GetFixedIpAssignments() []InlineResponse20046FixedIpAssignments {
	if o == nil || isNil(o.FixedIpAssignments) {
		var ret []InlineResponse20046FixedIpAssignments
		return ret
	}
...
// SetFixedIpAssignments gets a reference to the given []InlineResponse20046FixedIpAssignments and assigns it to the FixedIpAssignments field.
