...
type InlineResponse20046 struct {
	...
	Destinations []InlineResponse20046Destinations `json:"destinations,omitempty"`
}
...
func (o *InlineResponse20046) GetDestinations() []InlineResponse20046Destinations {
	if o == nil || isNil(o.Destinations) {
		var ret []InlineResponse20046Destinations
		return ret
	}
...
func (o *InlineResponse20046) GetDestinationsOk() ([]InlineResponse20046Destinations, bool) {
	if o == nil || isNil(o.Destinations) {
    return nil, false
	}
...
// SetDestinations gets a reference to the given []InlineResponse20046Destinations and assigns it to the Destinations field.
func (o *InlineResponse20046) SetDestinations(v []InlineResponse20046Destinations) {
	o.Destinations = v
}
