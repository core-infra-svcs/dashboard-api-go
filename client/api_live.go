...
func (r LiveApiGetDeviceCameraAnalyticsLiveRequest) Execute() (*InlineResponse2008, *http.Response, error) {
...
// Deprecated
func (a *LiveApiService) GetDeviceCameraAnalyticsLiveExecute(r LiveApiGetDeviceCameraAnalyticsLiveRequest) (*InlineResponse2008, *http.Response, error) {
	var (
