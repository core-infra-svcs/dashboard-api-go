...
func (r LiveApiGetDeviceCameraAnalyticsLiveRequest) Execute() (*InlineResponse2009, *http.Response, error) {
...
// Deprecated
func (a *LiveApiService) GetDeviceCameraAnalyticsLiveExecute(r LiveApiGetDeviceCameraAnalyticsLiveRequest) (*InlineResponse2009, *http.Response, error) {
	var (
