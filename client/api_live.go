...
func (r LiveApiGetDeviceCameraAnalyticsLiveRequest) Execute() (*InlineResponse20011, *http.Response, error) {
...
// Deprecated
func (a *LiveApiService) GetDeviceCameraAnalyticsLiveExecute(r LiveApiGetDeviceCameraAnalyticsLiveRequest) (*InlineResponse20011, *http.Response, error) {
	var (
