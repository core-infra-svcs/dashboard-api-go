...
func (r SystemApiGetOrganizationDevicesSystemMemoryUsageHistoryByIntervalRequest) Execute() (*InlineResponse200268, *http.Response, error) {
...
func (a *SystemApiService) GetOrganizationDevicesSystemMemoryUsageHistoryByIntervalExecute(r SystemApiGetOrganizationDevicesSystemMemoryUsageHistoryByIntervalRequest) (*InlineResponse200268, *http.Response, error) {
	var (
...
func (r SystemApiGetOrganizationWirelessControllerDevicesSystemUtilizationHistoryByIntervalRequest) Execute() (*InlineResponse200358, *http.Response, error) {
...
func (a *SystemApiService) GetOrganizationWirelessControllerDevicesSystemUtilizationHistoryByIntervalExecute(r SystemApiGetOrganizationWirelessControllerDevicesSystemUtilizationHistoryByIntervalRequest) (*InlineResponse200358, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SystemApiGetOrganizationWirelessDevicesSystemCpuLoadHistoryRequest) Execute() (*InlineResponse200340, *http.Response, error) {
...
func (a *SystemApiService) GetOrganizationWirelessDevicesSystemCpuLoadHistoryExecute(r SystemApiGetOrganizationWirelessDevicesSystemCpuLoadHistoryRequest) (*InlineResponse200340, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
