...
func (r SystemApiGetOrganizationDevicesSystemMemoryUsageHistoryByIntervalRequest) Execute() (*InlineResponse200276, *http.Response, error) {
...
func (a *SystemApiService) GetOrganizationDevicesSystemMemoryUsageHistoryByIntervalExecute(r SystemApiGetOrganizationDevicesSystemMemoryUsageHistoryByIntervalRequest) (*InlineResponse200276, *http.Response, error) {
	var (
...
func (r SystemApiGetOrganizationWirelessControllerDevicesSystemUtilizationHistoryByIntervalRequest) Execute() (*InlineResponse200372, *http.Response, error) {
...
func (a *SystemApiService) GetOrganizationWirelessControllerDevicesSystemUtilizationHistoryByIntervalExecute(r SystemApiGetOrganizationWirelessControllerDevicesSystemUtilizationHistoryByIntervalRequest) (*InlineResponse200372, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SystemApiGetOrganizationWirelessDevicesSystemCpuLoadHistoryRequest) Execute() (*InlineResponse200351, *http.Response, error) {
...
func (a *SystemApiService) GetOrganizationWirelessDevicesSystemCpuLoadHistoryExecute(r SystemApiGetOrganizationWirelessDevicesSystemCpuLoadHistoryRequest) (*InlineResponse200351, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
