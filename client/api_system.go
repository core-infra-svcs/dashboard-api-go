...
func (r SystemApiGetOrganizationWirelessControllerDevicesSystemUtilizationHistoryByIntervalRequest) Execute() (*InlineResponse200360, *http.Response, error) {
...
func (a *SystemApiService) GetOrganizationWirelessControllerDevicesSystemUtilizationHistoryByIntervalExecute(r SystemApiGetOrganizationWirelessControllerDevicesSystemUtilizationHistoryByIntervalRequest) (*InlineResponse200360, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SystemApiGetOrganizationWirelessDevicesSystemCpuLoadHistoryRequest) Execute() (*InlineResponse200342, *http.Response, error) {
...
func (a *SystemApiService) GetOrganizationWirelessDevicesSystemCpuLoadHistoryExecute(r SystemApiGetOrganizationWirelessDevicesSystemCpuLoadHistoryRequest) (*InlineResponse200342, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
