...
func (r SystemApiGetOrganizationWirelessControllerDevicesSystemUtilizationHistoryByIntervalRequest) Execute() (*InlineResponse200344, *http.Response, error) {
...
func (a *SystemApiService) GetOrganizationWirelessControllerDevicesSystemUtilizationHistoryByIntervalExecute(r SystemApiGetOrganizationWirelessControllerDevicesSystemUtilizationHistoryByIntervalRequest) (*InlineResponse200344, *http.Response, error) {
	var (
