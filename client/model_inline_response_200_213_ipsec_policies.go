...
// InlineResponse200213IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200213IpsecPolicies struct {
...
func NewInlineResponse200213IpsecPolicies() *InlineResponse200213IpsecPolicies {
	this := InlineResponse200213IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200213IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200213IpsecPolicies struct {
	value *InlineResponse200213IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200213IpsecPolicies) Get() *InlineResponse200213IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200213IpsecPolicies) Set(val *InlineResponse200213IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200213IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200213IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200213IpsecPolicies(val *InlineResponse200213IpsecPolicies) *NullableInlineResponse200213IpsecPolicies {
	return &NullableInlineResponse200213IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200213IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200213IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
