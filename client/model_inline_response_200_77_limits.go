...
// InlineResponse20077Limits The current limits of various adaptive policy objects.
type InlineResponse20077Limits struct {
...
func NewInlineResponse20077Limits() *InlineResponse20077Limits {
	this := InlineResponse20077Limits{}
	return &this
}
...
func (o InlineResponse20077Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20077Limits struct {
	value *InlineResponse20077Limits
	isSet bool
}

func (v NullableInlineResponse20077Limits) Get() *InlineResponse20077Limits {
	return v.value
}

func (v *NullableInlineResponse20077Limits) Set(val *InlineResponse20077Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20077Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20077Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20077Limits(val *InlineResponse20077Limits) *NullableInlineResponse20077Limits {
	return &NullableInlineResponse20077Limits{value: val, isSet: true}
}

func (v NullableInlineResponse20077Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20077Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
