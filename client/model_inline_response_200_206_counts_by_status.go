...
// InlineResponse200206CountsByStatus byStatus
type InlineResponse200206CountsByStatus struct {
...
func NewInlineResponse200206CountsByStatus() *InlineResponse200206CountsByStatus {
	this := InlineResponse200206CountsByStatus{}
	return &this
}
...
func (o InlineResponse200206CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200206CountsByStatus struct {
	value *InlineResponse200206CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200206CountsByStatus) Get() *InlineResponse200206CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200206CountsByStatus) Set(val *InlineResponse200206CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200206CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200206CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200206CountsByStatus(val *InlineResponse200206CountsByStatus) *NullableInlineResponse200206CountsByStatus {
	return &NullableInlineResponse200206CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200206CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200206CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
