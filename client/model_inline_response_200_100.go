...
type InlineResponse200100 struct {
	...
	ToVersion *InlineResponse200100ToVersion `json:"toVersion,omitempty"`
...
func (o *InlineResponse200100) GetToVersion() InlineResponse200100ToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse200100ToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse200100ToVersion and assigns it to the ToVersion field.
