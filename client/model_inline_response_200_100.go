...
type InlineResponse200100 struct {
	...
	Devices []InlineResponse20092 `json:"devices,omitempty"`
...
// SetDevices gets a reference to the given []InlineResponse20092 and assigns it to the Devices field.
