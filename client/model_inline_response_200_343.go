...
type InlineResponse200343 struct {
	...
	Example *InlineResponse200343Example `json:"example,omitempty"`
}
...
func (o *InlineResponse200343) GetExample() InlineResponse200343Example {
	if o == nil || isNil(o.Example) {
		var ret InlineResponse200343Example
		return ret
	}
	return *o.Example
}
...
// SetExample gets a reference to the given InlineResponse200343Example and assigns it to the Example field.
