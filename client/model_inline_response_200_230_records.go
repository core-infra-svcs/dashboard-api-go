...
// InlineResponse200230Records struct for InlineResponse200230Records
type InlineResponse200230Records struct {
	Network *InlineResponse200230Network `json:"network,omitempty"`
	...
	ClientVpnConnections []InlineResponse200230ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200230Records() *InlineResponse200230Records {
	this := InlineResponse200230Records{}
	return &this
}
...
func (o *InlineResponse200230Records) GetNetwork() InlineResponse200230Network {
	if o == nil || isNil(o.Network) {
		var ret InlineResponse200230Network
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given InlineResponse200230Network and assigns it to the Network field.
...
func (o *InlineResponse200230Records) GetClientVpnConnections() []InlineResponse200230ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200230ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200230ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200230Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200230Records struct {
	value *InlineResponse200230Records
	isSet bool
}

func (v NullableInlineResponse200230Records) Get() *InlineResponse200230Records {
	return v.value
}

func (v *NullableInlineResponse200230Records) Set(val *InlineResponse200230Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200230Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200230Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200230Records(val *InlineResponse200230Records) *NullableInlineResponse200230Records {
	return &NullableInlineResponse200230Records{value: val, isSet: true}
}

func (v NullableInlineResponse200230Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200230Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
