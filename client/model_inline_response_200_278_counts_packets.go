...
// InlineResponse200278CountsPackets Object containing packet counts
type InlineResponse200278CountsPackets struct {
...
func NewInlineResponse200278CountsPackets() *InlineResponse200278CountsPackets {
	this := InlineResponse200278CountsPackets{}
	return &this
}
...
func (o InlineResponse200278CountsPackets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200278CountsPackets struct {
	value *InlineResponse200278CountsPackets
	isSet bool
}

func (v NullableInlineResponse200278CountsPackets) Get() *InlineResponse200278CountsPackets {
	return v.value
}

func (v *NullableInlineResponse200278CountsPackets) Set(val *InlineResponse200278CountsPackets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200278CountsPackets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200278CountsPackets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200278CountsPackets(val *InlineResponse200278CountsPackets) *NullableInlineResponse200278CountsPackets {
	return &NullableInlineResponse200278CountsPackets{value: val, isSet: true}
}

func (v NullableInlineResponse200278CountsPackets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200278CountsPackets) UnmarshalJSON(src []byte) error {
	v.isSet = true
