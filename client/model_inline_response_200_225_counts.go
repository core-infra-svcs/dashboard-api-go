...
// InlineResponse200225Counts The current amount of various adaptive policy objects.
type InlineResponse200225Counts struct {
...
func NewInlineResponse200225Counts() *InlineResponse200225Counts {
	this := InlineResponse200225Counts{}
	return &this
}
...
func (o InlineResponse200225Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200225Counts struct {
	value *InlineResponse200225Counts
	isSet bool
}

func (v NullableInlineResponse200225Counts) Get() *InlineResponse200225Counts {
	return v.value
}

func (v *NullableInlineResponse200225Counts) Set(val *InlineResponse200225Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200225Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200225Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200225Counts(val *InlineResponse200225Counts) *NullableInlineResponse200225Counts {
	return &NullableInlineResponse200225Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200225Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200225Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
