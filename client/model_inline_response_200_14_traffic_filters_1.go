...
// InlineResponse20014TrafficFilters1 struct for InlineResponse20014TrafficFilters1
type InlineResponse20014TrafficFilters1 struct {
	// Traffic filter type. Must be one of: 'applicationCategory', 'application' or 'custom'
	Type string `json:"type"`
	Value InlineResponse20014Value1 `json:"value"`
}
...
func NewInlineResponse20014TrafficFilters1(type_ string, value InlineResponse20014Value1) *InlineResponse20014TrafficFilters1 {
	this := InlineResponse20014TrafficFilters1{}
	this.Type = type_
	this.Value = value
	return &this
}
...
func (o *InlineResponse20014TrafficFilters1) GetValue() InlineResponse20014Value1 {
	if o == nil {
		var ret InlineResponse20014Value1
		return ret
	}
...
func (o InlineResponse20014TrafficFilters1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20014TrafficFilters1 struct {
	value *InlineResponse20014TrafficFilters1
	isSet bool
}

func (v NullableInlineResponse20014TrafficFilters1) Get() *InlineResponse20014TrafficFilters1 {
	return v.value
}

func (v *NullableInlineResponse20014TrafficFilters1) Set(val *InlineResponse20014TrafficFilters1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20014TrafficFilters1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20014TrafficFilters1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20014TrafficFilters1(val *InlineResponse20014TrafficFilters1) *NullableInlineResponse20014TrafficFilters1 {
	return &NullableInlineResponse20014TrafficFilters1{value: val, isSet: true}
}

func (v NullableInlineResponse20014TrafficFilters1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20014TrafficFilters1) UnmarshalJSON(src []byte) error {
	v.isSet = true
