...
type InlineResponse200180 struct {
	...
	ApiAuthentication *InlineResponse200180ApiAuthentication `json:"apiAuthentication,omitempty"`
}
...
func (o *InlineResponse200180) GetApiAuthentication() InlineResponse200180ApiAuthentication {
	if o == nil || isNil(o.ApiAuthentication) {
		var ret InlineResponse200180ApiAuthentication
		return ret
	}
...
// SetApiAuthentication gets a reference to the given InlineResponse200180ApiAuthentication and assigns it to the ApiAuthentication field.
