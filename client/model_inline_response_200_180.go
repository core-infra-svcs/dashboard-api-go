...
type InlineResponse200180 struct {
	...
	NamedVlans *InlineResponse200180NamedVlans `json:"namedVlans,omitempty"`
	RegulatoryDomain *InlineResponse200180RegulatoryDomain `json:"regulatoryDomain,omitempty"`
}
...
func (o *InlineResponse200180) GetNamedVlans() InlineResponse200180NamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret InlineResponse200180NamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given InlineResponse200180NamedVlans and assigns it to the NamedVlans field.
...
func (o *InlineResponse200180) GetRegulatoryDomain() InlineResponse200180RegulatoryDomain {
	if o == nil || isNil(o.RegulatoryDomain) {
		var ret InlineResponse200180RegulatoryDomain
		return ret
	}
...
// SetRegulatoryDomain gets a reference to the given InlineResponse200180RegulatoryDomain and assigns it to the RegulatoryDomain field.
