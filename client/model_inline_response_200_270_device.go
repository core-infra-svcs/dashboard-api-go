...
// InlineResponse200270Device Device associated to the schedule
type InlineResponse200270Device struct {
...
func NewInlineResponse200270Device() *InlineResponse200270Device {
	this := InlineResponse200270Device{}
	return &this
}
...
func (o InlineResponse200270Device) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200270Device struct {
	value *InlineResponse200270Device
	isSet bool
}

func (v NullableInlineResponse200270Device) Get() *InlineResponse200270Device {
	return v.value
}

func (v *NullableInlineResponse200270Device) Set(val *InlineResponse200270Device) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200270Device) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200270Device) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200270Device(val *InlineResponse200270Device) *NullableInlineResponse200270Device {
	return &NullableInlineResponse200270Device{value: val, isSet: true}
}

func (v NullableInlineResponse200270Device) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200270Device) UnmarshalJSON(src []byte) error {
	v.isSet = true
