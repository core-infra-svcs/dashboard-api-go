...
// InlineResponse200286StatesUnused Data for unused licenses
type InlineResponse200286StatesUnused struct {
	// The number of unused licenses
	Count *int32 `json:"count,omitempty"`
	SoonestActivation *InlineResponse200286StatesUnusedSoonestActivation `json:"soonestActivation,omitempty"`
}
...
func NewInlineResponse200286StatesUnused() *InlineResponse200286StatesUnused {
	this := InlineResponse200286StatesUnused{}
	return &this
}
...
func (o *InlineResponse200286StatesUnused) GetSoonestActivation() InlineResponse200286StatesUnusedSoonestActivation {
	if o == nil || isNil(o.SoonestActivation) {
		var ret InlineResponse200286StatesUnusedSoonestActivation
		return ret
	}
...
// SetSoonestActivation gets a reference to the given InlineResponse200286StatesUnusedSoonestActivation and assigns it to the SoonestActivation field.
...
func (o InlineResponse200286StatesUnused) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200286StatesUnused struct {
	value *InlineResponse200286StatesUnused
	isSet bool
}

func (v NullableInlineResponse200286StatesUnused) Get() *InlineResponse200286StatesUnused {
	return v.value
}

func (v *NullableInlineResponse200286StatesUnused) Set(val *InlineResponse200286StatesUnused) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200286StatesUnused) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200286StatesUnused) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200286StatesUnused(val *InlineResponse200286StatesUnused) *NullableInlineResponse200286StatesUnused {
	return &NullableInlineResponse200286StatesUnused{value: val, isSet: true}
}

func (v NullableInlineResponse200286StatesUnused) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200286StatesUnused) UnmarshalJSON(src []byte) error {
	v.isSet = true
