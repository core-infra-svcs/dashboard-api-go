...
// InlineResponse200143Peers struct for InlineResponse200143Peers
type InlineResponse200143Peers struct {
	...
	IpsecPolicies *InlineResponse200143IpsecPolicies `json:"ipsecPolicies,omitempty"`
...
func NewInlineResponse200143Peers() *InlineResponse200143Peers {
	this := InlineResponse200143Peers{}
...
func (o *InlineResponse200143Peers) GetIpsecPolicies() InlineResponse200143IpsecPolicies {
	if o == nil || isNil(o.IpsecPolicies) {
		var ret InlineResponse200143IpsecPolicies
		return ret
	}
...
// SetIpsecPolicies gets a reference to the given InlineResponse200143IpsecPolicies and assigns it to the IpsecPolicies field.
...
func (o InlineResponse200143Peers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200143Peers struct {
	value *InlineResponse200143Peers
	isSet bool
}

func (v NullableInlineResponse200143Peers) Get() *InlineResponse200143Peers {
	return v.value
}

func (v *NullableInlineResponse200143Peers) Set(val *InlineResponse200143Peers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200143Peers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200143Peers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200143Peers(val *InlineResponse200143Peers) *NullableInlineResponse200143Peers {
	return &NullableInlineResponse200143Peers{value: val, isSet: true}
}

func (v NullableInlineResponse200143Peers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200143Peers) UnmarshalJSON(src []byte) error {
	v.isSet = true
