...
// InlineResponse20071NamedVlansPoolDhcpMonitoring Named VLAN Pool DHCP Monitoring settings.
type InlineResponse20071NamedVlansPoolDhcpMonitoring struct {
...
func NewInlineResponse20071NamedVlansPoolDhcpMonitoring() *InlineResponse20071NamedVlansPoolDhcpMonitoring {
	this := InlineResponse20071NamedVlansPoolDhcpMonitoring{}
	return &this
}
...
func (o InlineResponse20071NamedVlansPoolDhcpMonitoring) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20071NamedVlansPoolDhcpMonitoring struct {
	value *InlineResponse20071NamedVlansPoolDhcpMonitoring
	isSet bool
}

func (v NullableInlineResponse20071NamedVlansPoolDhcpMonitoring) Get() *InlineResponse20071NamedVlansPoolDhcpMonitoring {
	return v.value
}

func (v *NullableInlineResponse20071NamedVlansPoolDhcpMonitoring) Set(val *InlineResponse20071NamedVlansPoolDhcpMonitoring) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20071NamedVlansPoolDhcpMonitoring) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20071NamedVlansPoolDhcpMonitoring) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20071NamedVlansPoolDhcpMonitoring(val *InlineResponse20071NamedVlansPoolDhcpMonitoring) *NullableInlineResponse20071NamedVlansPoolDhcpMonitoring {
	return &NullableInlineResponse20071NamedVlansPoolDhcpMonitoring{value: val, isSet: true}
}

func (v NullableInlineResponse20071NamedVlansPoolDhcpMonitoring) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20071NamedVlansPoolDhcpMonitoring) UnmarshalJSON(src []byte) error {
	v.isSet = true
