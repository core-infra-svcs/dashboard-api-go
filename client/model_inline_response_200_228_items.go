...
// InlineResponse200228Items struct for InlineResponse200228Items
type InlineResponse200228Items struct {
	// Service provider name.
	Name *string `json:"name,omitempty"`
	Logo *InlineResponse200228Logo `json:"logo,omitempty"`
	// Indicates if service provider is the bootstrap provider.
	IsBootstrap *bool `json:"isBootstrap,omitempty"`
	Terms *InlineResponse200228Terms `json:"terms,omitempty"`
}
...
func NewInlineResponse200228Items() *InlineResponse200228Items {
	this := InlineResponse200228Items{}
	return &this
}
...
func (o *InlineResponse200228Items) GetLogo() InlineResponse200228Logo {
	if o == nil || isNil(o.Logo) {
		var ret InlineResponse200228Logo
		return ret
	}
	return *o.Logo
}
...
// SetLogo gets a reference to the given InlineResponse200228Logo and assigns it to the Logo field.
...
func (o *InlineResponse200228Items) GetTerms() InlineResponse200228Terms {
	if o == nil || isNil(o.Terms) {
		var ret InlineResponse200228Terms
		return ret
	}
	return *o.Terms
}
...
// SetTerms gets a reference to the given InlineResponse200228Terms and assigns it to the Terms field.
func (o *InlineResponse200228Items) SetTerms(v InlineResponse200228Terms) {
	o.Terms = &v
}

func (o InlineResponse200228Items) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200228Items struct {
	value *InlineResponse200228Items
	isSet bool
}

func (v NullableInlineResponse200228Items) Get() *InlineResponse200228Items {
	return v.value
}

func (v *NullableInlineResponse200228Items) Set(val *InlineResponse200228Items) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200228Items) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200228Items) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200228Items(val *InlineResponse200228Items) *NullableInlineResponse200228Items {
	return &NullableInlineResponse200228Items{value: val, isSet: true}
}

func (v NullableInlineResponse200228Items) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200228Items) UnmarshalJSON(src []byte) error {
	v.isSet = true
