...
// InlineResponse200208CountsByStatus byStatus
type InlineResponse200208CountsByStatus struct {
...
func NewInlineResponse200208CountsByStatus() *InlineResponse200208CountsByStatus {
	this := InlineResponse200208CountsByStatus{}
	return &this
}
...
func (o InlineResponse200208CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200208CountsByStatus struct {
	value *InlineResponse200208CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200208CountsByStatus) Get() *InlineResponse200208CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200208CountsByStatus) Set(val *InlineResponse200208CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200208CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200208CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200208CountsByStatus(val *InlineResponse200208CountsByStatus) *NullableInlineResponse200208CountsByStatus {
	return &NullableInlineResponse200208CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200208CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200208CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
