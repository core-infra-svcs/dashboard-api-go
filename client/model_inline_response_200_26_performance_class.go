...
// InlineResponse20026PerformanceClass Performance class setting for uplink preference rule
type InlineResponse20026PerformanceClass struct {
...
func NewInlineResponse20026PerformanceClass(type_ string) *InlineResponse20026PerformanceClass {
	this := InlineResponse20026PerformanceClass{}
	this.Type = type_
	return &this
}
...
func (o InlineResponse20026PerformanceClass) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20026PerformanceClass struct {
	value *InlineResponse20026PerformanceClass
	isSet bool
}

func (v NullableInlineResponse20026PerformanceClass) Get() *InlineResponse20026PerformanceClass {
	return v.value
}

func (v *NullableInlineResponse20026PerformanceClass) Set(val *InlineResponse20026PerformanceClass) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20026PerformanceClass) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20026PerformanceClass) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20026PerformanceClass(val *InlineResponse20026PerformanceClass) *NullableInlineResponse20026PerformanceClass {
	return &NullableInlineResponse20026PerformanceClass{value: val, isSet: true}
}

func (v NullableInlineResponse20026PerformanceClass) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20026PerformanceClass) UnmarshalJSON(src []byte) error {
	v.isSet = true
