...
// InlineResponse20063Value1Source Source of 'custom' type traffic filter
type InlineResponse20063Value1Source struct {
...
func NewInlineResponse20063Value1Source() *InlineResponse20063Value1Source {
	this := InlineResponse20063Value1Source{}
	return &this
}
...
func (o InlineResponse20063Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20063Value1Source struct {
	value *InlineResponse20063Value1Source
	isSet bool
}

func (v NullableInlineResponse20063Value1Source) Get() *InlineResponse20063Value1Source {
	return v.value
}

func (v *NullableInlineResponse20063Value1Source) Set(val *InlineResponse20063Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20063Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20063Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20063Value1Source(val *InlineResponse20063Value1Source) *NullableInlineResponse20063Value1Source {
	return &NullableInlineResponse20063Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20063Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20063Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
