...
// InlineResponse200344MetaCountsItems The count metadata.
type InlineResponse200344MetaCountsItems struct {
...
func NewInlineResponse200344MetaCountsItems() *InlineResponse200344MetaCountsItems {
	this := InlineResponse200344MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200344MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200344MetaCountsItems struct {
	value *InlineResponse200344MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200344MetaCountsItems) Get() *InlineResponse200344MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200344MetaCountsItems) Set(val *InlineResponse200344MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200344MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200344MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200344MetaCountsItems(val *InlineResponse200344MetaCountsItems) *NullableInlineResponse200344MetaCountsItems {
	return &NullableInlineResponse200344MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200344MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200344MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
