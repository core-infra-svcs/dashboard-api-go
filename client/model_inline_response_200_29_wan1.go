...
// InlineResponse20029Wan1 WAN 1 settings
type InlineResponse20029Wan1 struct {
...
func (o InlineResponse20029Wan1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20029Wan1 struct {
	value *InlineResponse20029Wan1
	isSet bool
}

func (v NullableInlineResponse20029Wan1) Get() *InlineResponse20029Wan1 {
	return v.value
}

func (v *NullableInlineResponse20029Wan1) Set(val *InlineResponse20029Wan1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20029Wan1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20029Wan1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20029Wan1(val *InlineResponse20029Wan1) *NullableInlineResponse20029Wan1 {
	return &NullableInlineResponse20029Wan1{value: val, isSet: true}
}

func (v NullableInlineResponse20029Wan1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20029Wan1) UnmarshalJSON(src []byte) error {
	v.isSet = true
