...
// InlineResponse200357Events struct for InlineResponse200357Events
type InlineResponse200357Events struct {
...
func NewInlineResponse200357Events() *InlineResponse200357Events {
	this := InlineResponse200357Events{}
	return &this
}
...
func (o InlineResponse200357Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200357Events struct {
	value *InlineResponse200357Events
	isSet bool
}

func (v NullableInlineResponse200357Events) Get() *InlineResponse200357Events {
	return v.value
}

func (v *NullableInlineResponse200357Events) Set(val *InlineResponse200357Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200357Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200357Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200357Events(val *InlineResponse200357Events) *NullableInlineResponse200357Events {
	return &NullableInlineResponse200357Events{value: val, isSet: true}
}

func (v NullableInlineResponse200357Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200357Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
