...
func (o *InlineObject108) GetDevices() []NetworksNetworkIdFloorPlansAutoLocateJobsJobIdRecalculateDevices {
...
func (o *InlineObject108) GetDevicesOk() ([]NetworksNetworkIdFloorPlansAutoLocateJobsJobIdRecalculateDevices, bool) {
	if o == nil || isNil(o.Devices) {
    return nil, false
	}
...
func (o *InlineObject108) SetDevices(v []NetworksNetworkIdFloorPlansAutoLocateJobsJobIdRecalculateDevices) {
	o.Devices = v
}
