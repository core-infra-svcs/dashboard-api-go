...
// InlineResponse20096Group The staged upgrade group
type InlineResponse20096Group struct {
...
func (o InlineResponse20096Group) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20096Group struct {
	value *InlineResponse20096Group
	isSet bool
}

func (v NullableInlineResponse20096Group) Get() *InlineResponse20096Group {
	return v.value
}

func (v *NullableInlineResponse20096Group) Set(val *InlineResponse20096Group) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20096Group) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20096Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20096Group(val *InlineResponse20096Group) *NullableInlineResponse20096Group {
	return &NullableInlineResponse20096Group{value: val, isSet: true}
}

func (v NullableInlineResponse20096Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20096Group) UnmarshalJSON(src []byte) error {
	v.isSet = true
