...
type InlineResponse20099Products struct {
	Switch *InlineResponse20099ProductsSwitch `json:"switch,omitempty"`
}
...
func (o *InlineResponse20099Products) GetSwitch() InlineResponse20099ProductsSwitch {
	if o == nil || isNil(o.Switch) {
		var ret InlineResponse20099ProductsSwitch
		return ret
	}
	return *o.Switch
}
...
// SetSwitch gets a reference to the given InlineResponse20099ProductsSwitch and assigns it to the Switch field.
