...
func (o *InlineObject86) GetSsid() NetworksNetworkIdCameraWirelessProfilesWirelessProfileIdSsid {
...
// and a boolean to check if the value has been set.
func (o *InlineObject86) GetSsidOk() (*NetworksNetworkIdCameraWirelessProfilesWirelessProfileIdSsid, bool) {
	if o == nil || isNil(o.Ssid) {
    return nil, false
	}
	return o.Ssid, true
...
func (o *InlineObject86) HasSsid() bool {
	if o != nil && !isNil(o.Ssid) {
		return true
	}
...
func (o *InlineObject86) SetSsid(v NetworksNetworkIdCameraWirelessProfilesWirelessProfileIdSsid) {
	o.Ssid = &v
}

// GetIdentity returns the Identity field value if set, zero value otherwise.
func (o *InlineObject86) GetIdentity() NetworksNetworkIdCameraWirelessProfilesIdentity {
...
// and a boolean to check if the value has been set.
func (o *InlineObject86) GetIdentityOk() (*NetworksNetworkIdCameraWirelessProfilesIdentity, bool) {
	if o == nil || isNil(o.Identity) {
    return nil, false
	}
...
func (o *InlineObject86) HasIdentity() bool {
	if o != nil && !isNil(o.Identity) {
		return true
	}
...
func (o *InlineObject86) SetIdentity(v NetworksNetworkIdCameraWirelessProfilesIdentity) {
	o.Identity = &v
}
