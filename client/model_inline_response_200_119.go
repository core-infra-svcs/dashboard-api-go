...
func (o *InlineResponse200119) GetNotes() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200119) GetNotesOk() (*string, bool) {
	if o == nil || isNil(o.Notes) {
    return nil, false
	}
	return o.Notes, true
...
func (o *InlineResponse200119) HasNotes() bool {
	if o != nil && !isNil(o.Notes) {
		return true
	}
...
func (o *InlineResponse200119) SetNotes(v string) {
	o.Notes = &v
}
