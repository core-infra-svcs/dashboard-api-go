...
func (o *InlineResponse200119) GetUrl() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200119) GetUrlOk() (*string, bool) {
	if o == nil || isNil(o.Url) {
    return nil, false
	}
	return o.Url, true
...
func (o *InlineResponse200119) HasUrl() bool {
	if o != nil && !isNil(o.Url) {
		return true
	}
...
func (o *InlineResponse200119) SetUrl(v string) {
	o.Url = &v
}

// GetApi returns the Api field value if set, zero value otherwise.
func (o *InlineResponse200119) GetApi() OrganizationsApi {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200119) GetApiOk() (*OrganizationsApi, bool) {
	if o == nil || isNil(o.Api) {
    return nil, false
	}
	return o.Api, true
...
func (o *InlineResponse200119) HasApi() bool {
	if o != nil && !isNil(o.Api) {
		return true
	}
...
func (o *InlineResponse200119) SetApi(v OrganizationsApi) {
	o.Api = &v
}

// GetLicensing returns the Licensing field value if set, zero value otherwise.
func (o *InlineResponse200119) GetLicensing() OrganizationsLicensing {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200119) GetLicensingOk() (*OrganizationsLicensing, bool) {
	if o == nil || isNil(o.Licensing) {
    return nil, false
	}
...
func (o *InlineResponse200119) HasLicensing() bool {
	if o != nil && !isNil(o.Licensing) {
		return true
	}
...
func (o *InlineResponse200119) SetLicensing(v OrganizationsLicensing) {
	o.Licensing = &v
}

// GetCloud returns the Cloud field value if set, zero value otherwise.
func (o *InlineResponse200119) GetCloud() OrganizationsCloud {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200119) GetCloudOk() (*OrganizationsCloud, bool) {
	if o == nil || isNil(o.Cloud) {
    return nil, false
	}
	return o.Cloud, true
...
func (o *InlineResponse200119) HasCloud() bool {
	if o != nil && !isNil(o.Cloud) {
		return true
	}
...
func (o *InlineResponse200119) SetCloud(v OrganizationsCloud) {
	o.Cloud = &v
}

// GetManagement returns the Management field value if set, zero value otherwise.
func (o *InlineResponse200119) GetManagement() OrganizationsManagement {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200119) GetManagementOk() (*OrganizationsManagement, bool) {
	if o == nil || isNil(o.Management) {
    return nil, false
	}
...
func (o *InlineResponse200119) HasManagement() bool {
	if o != nil && !isNil(o.Management) {
		return true
	}
...
func (o *InlineResponse200119) SetManagement(v OrganizationsManagement) {
	o.Management = &v
}
