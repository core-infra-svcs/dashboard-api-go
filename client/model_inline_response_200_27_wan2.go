...
// InlineResponse20027Wan2 WAN 2 settings (only for MX devices)
type InlineResponse20027Wan2 struct {
...
func (o InlineResponse20027Wan2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20027Wan2 struct {
	value *InlineResponse20027Wan2
	isSet bool
}

func (v NullableInlineResponse20027Wan2) Get() *InlineResponse20027Wan2 {
	return v.value
}

func (v *NullableInlineResponse20027Wan2) Set(val *InlineResponse20027Wan2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20027Wan2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20027Wan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20027Wan2(val *InlineResponse20027Wan2) *NullableInlineResponse20027Wan2 {
	return &NullableInlineResponse20027Wan2{value: val, isSet: true}
}

func (v NullableInlineResponse20027Wan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20027Wan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
