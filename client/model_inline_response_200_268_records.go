...
// InlineResponse200268Records struct for InlineResponse200268Records
type InlineResponse200268Records struct {
	...
	ClientVpnConnections []InlineResponse200268ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200268Records() *InlineResponse200268Records {
	this := InlineResponse200268Records{}
	return &this
}
...
func (o *InlineResponse200268Records) GetClientVpnConnections() []InlineResponse200268ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200268ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200268ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200268Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200268Records struct {
	value *InlineResponse200268Records
	isSet bool
}

func (v NullableInlineResponse200268Records) Get() *InlineResponse200268Records {
	return v.value
}

func (v *NullableInlineResponse200268Records) Set(val *InlineResponse200268Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200268Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200268Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200268Records(val *InlineResponse200268Records) *NullableInlineResponse200268Records {
	return &NullableInlineResponse200268Records{value: val, isSet: true}
}

func (v NullableInlineResponse200268Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200268Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
