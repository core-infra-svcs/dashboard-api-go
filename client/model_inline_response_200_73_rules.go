...
// InlineResponse20073Rules struct for InlineResponse20073Rules
type InlineResponse20073Rules struct {
...
func (o InlineResponse20073Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20073Rules struct {
	value *InlineResponse20073Rules
	isSet bool
}

func (v NullableInlineResponse20073Rules) Get() *InlineResponse20073Rules {
	return v.value
}

func (v *NullableInlineResponse20073Rules) Set(val *InlineResponse20073Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20073Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20073Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20073Rules(val *InlineResponse20073Rules) *NullableInlineResponse20073Rules {
	return &NullableInlineResponse20073Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20073Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20073Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
