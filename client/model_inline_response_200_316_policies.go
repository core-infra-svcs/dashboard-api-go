...
// InlineResponse200316Policies struct for InlineResponse200316Policies
type InlineResponse200316Policies struct {
...
func NewInlineResponse200316Policies() *InlineResponse200316Policies {
	this := InlineResponse200316Policies{}
	return &this
}
...
func (o InlineResponse200316Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200316Policies struct {
	value *InlineResponse200316Policies
	isSet bool
}

func (v NullableInlineResponse200316Policies) Get() *InlineResponse200316Policies {
	return v.value
}

func (v *NullableInlineResponse200316Policies) Set(val *InlineResponse200316Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200316Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200316Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200316Policies(val *InlineResponse200316Policies) *NullableInlineResponse200316Policies {
	return &NullableInlineResponse200316Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200316Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200316Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
