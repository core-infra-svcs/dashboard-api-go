...
// InlineResponse20031Wan2 WAN 2 settings (only for MX devices)
type InlineResponse20031Wan2 struct {
...
func (o InlineResponse20031Wan2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20031Wan2 struct {
	value *InlineResponse20031Wan2
	isSet bool
}

func (v NullableInlineResponse20031Wan2) Get() *InlineResponse20031Wan2 {
	return v.value
}

func (v *NullableInlineResponse20031Wan2) Set(val *InlineResponse20031Wan2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20031Wan2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20031Wan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20031Wan2(val *InlineResponse20031Wan2) *NullableInlineResponse20031Wan2 {
	return &NullableInlineResponse20031Wan2{value: val, isSet: true}
}

func (v NullableInlineResponse20031Wan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20031Wan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
