...
// InlineResponse200385Overall The overall usage of all queried interfaces of the wireless LAN controller
type InlineResponse200385Overall struct {
...
func NewInlineResponse200385Overall() *InlineResponse200385Overall {
	this := InlineResponse200385Overall{}
	return &this
}
...
func (o InlineResponse200385Overall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200385Overall struct {
	value *InlineResponse200385Overall
	isSet bool
}

func (v NullableInlineResponse200385Overall) Get() *InlineResponse200385Overall {
	return v.value
}

func (v *NullableInlineResponse200385Overall) Set(val *InlineResponse200385Overall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200385Overall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200385Overall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200385Overall(val *InlineResponse200385Overall) *NullableInlineResponse200385Overall {
	return &NullableInlineResponse200385Overall{value: val, isSet: true}
}

func (v NullableInlineResponse200385Overall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200385Overall) UnmarshalJSON(src []byte) error {
	v.isSet = true
