...
// InlineResponse20019FixedIpAssignments struct for InlineResponse20019FixedIpAssignments
type InlineResponse20019FixedIpAssignments struct {
...
func NewInlineResponse20019FixedIpAssignments() *InlineResponse20019FixedIpAssignments {
	this := InlineResponse20019FixedIpAssignments{}
	return &this
}
...
func (o InlineResponse20019FixedIpAssignments) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20019FixedIpAssignments struct {
	value *InlineResponse20019FixedIpAssignments
	isSet bool
}

func (v NullableInlineResponse20019FixedIpAssignments) Get() *InlineResponse20019FixedIpAssignments {
	return v.value
}

func (v *NullableInlineResponse20019FixedIpAssignments) Set(val *InlineResponse20019FixedIpAssignments) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20019FixedIpAssignments) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20019FixedIpAssignments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20019FixedIpAssignments(val *InlineResponse20019FixedIpAssignments) *NullableInlineResponse20019FixedIpAssignments {
	return &NullableInlineResponse20019FixedIpAssignments{value: val, isSet: true}
}

func (v NullableInlineResponse20019FixedIpAssignments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20019FixedIpAssignments) UnmarshalJSON(src []byte) error {
	v.isSet = true
