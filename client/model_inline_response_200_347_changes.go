...
// InlineResponse200347Changes struct for InlineResponse200347Changes
type InlineResponse200347Changes struct {
...
func NewInlineResponse200347Changes() *InlineResponse200347Changes {
	this := InlineResponse200347Changes{}
	return &this
}
...
func (o InlineResponse200347Changes) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200347Changes struct {
	value *InlineResponse200347Changes
	isSet bool
}

func (v NullableInlineResponse200347Changes) Get() *InlineResponse200347Changes {
	return v.value
}

func (v *NullableInlineResponse200347Changes) Set(val *InlineResponse200347Changes) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200347Changes) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200347Changes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200347Changes(val *InlineResponse200347Changes) *NullableInlineResponse200347Changes {
	return &NullableInlineResponse200347Changes{value: val, isSet: true}
}

func (v NullableInlineResponse200347Changes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200347Changes) UnmarshalJSON(src []byte) error {
	v.isSet = true
