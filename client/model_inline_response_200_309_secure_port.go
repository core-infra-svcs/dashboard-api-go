...
// InlineResponse200309SecurePort The Secure Port status of the port.
type InlineResponse200309SecurePort struct {
...
func NewInlineResponse200309SecurePort() *InlineResponse200309SecurePort {
	this := InlineResponse200309SecurePort{}
	return &this
}
...
func (o InlineResponse200309SecurePort) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200309SecurePort struct {
	value *InlineResponse200309SecurePort
	isSet bool
}

func (v NullableInlineResponse200309SecurePort) Get() *InlineResponse200309SecurePort {
	return v.value
}

func (v *NullableInlineResponse200309SecurePort) Set(val *InlineResponse200309SecurePort) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200309SecurePort) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200309SecurePort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200309SecurePort(val *InlineResponse200309SecurePort) *NullableInlineResponse200309SecurePort {
	return &NullableInlineResponse200309SecurePort{value: val, isSet: true}
}

func (v NullableInlineResponse200309SecurePort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200309SecurePort) UnmarshalJSON(src []byte) error {
	v.isSet = true
