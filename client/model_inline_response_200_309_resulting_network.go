...
// InlineResponse200309ResultingNetwork Network after the combination
type InlineResponse200309ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200309ResultingNetwork() *InlineResponse200309ResultingNetwork {
	this := InlineResponse200309ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200309ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200309ResultingNetwork struct {
	value *InlineResponse200309ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200309ResultingNetwork) Get() *InlineResponse200309ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200309ResultingNetwork) Set(val *InlineResponse200309ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200309ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200309ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200309ResultingNetwork(val *InlineResponse200309ResultingNetwork) *NullableInlineResponse200309ResultingNetwork {
	return &NullableInlineResponse200309ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200309ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200309ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
