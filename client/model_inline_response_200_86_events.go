...
// InlineResponse20086Events struct for InlineResponse20086Events
type InlineResponse20086Events struct {
	...
	EventData *InlineResponse20086EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20086Events() *InlineResponse20086Events {
	this := InlineResponse20086Events{}
	return &this
}
...
func (o *InlineResponse20086Events) GetEventData() InlineResponse20086EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20086EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20086EventData and assigns it to the EventData field.
func (o *InlineResponse20086Events) SetEventData(v InlineResponse20086EventData) {
	o.EventData = &v
}

func (o InlineResponse20086Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20086Events struct {
	value *InlineResponse20086Events
	isSet bool
}

func (v NullableInlineResponse20086Events) Get() *InlineResponse20086Events {
	return v.value
}

func (v *NullableInlineResponse20086Events) Set(val *InlineResponse20086Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20086Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20086Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20086Events(val *InlineResponse20086Events) *NullableInlineResponse20086Events {
	return &NullableInlineResponse20086Events{value: val, isSet: true}
}

func (v NullableInlineResponse20086Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20086Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
