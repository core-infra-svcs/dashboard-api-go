...
// InlineResponse200371Interfaces struct for InlineResponse200371Interfaces
type InlineResponse200371Interfaces struct {
...
func NewInlineResponse200371Interfaces() *InlineResponse200371Interfaces {
	this := InlineResponse200371Interfaces{}
	return &this
}
...
func (o InlineResponse200371Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200371Interfaces struct {
	value *InlineResponse200371Interfaces
	isSet bool
}

func (v NullableInlineResponse200371Interfaces) Get() *InlineResponse200371Interfaces {
	return v.value
}

func (v *NullableInlineResponse200371Interfaces) Set(val *InlineResponse200371Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200371Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200371Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200371Interfaces(val *InlineResponse200371Interfaces) *NullableInlineResponse200371Interfaces {
	return &NullableInlineResponse200371Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200371Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200371Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
