...
type InlineObject282 struct {
	...
	ApiAuthentication *InlineResponse200306ApiAuthentication `json:"apiAuthentication,omitempty"`
}
...
func (o *InlineObject282) GetApiAuthentication() InlineResponse200306ApiAuthentication {
	if o == nil || isNil(o.ApiAuthentication) {
		var ret InlineResponse200306ApiAuthentication
		return ret
	}
...
// SetApiAuthentication gets a reference to the given InlineResponse200306ApiAuthentication and assigns it to the ApiAuthentication field.
