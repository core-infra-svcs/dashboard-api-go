...
type InlineObject282 struct {
	...
	ApiAuthentication *InlineResponse200305ApiAuthentication `json:"apiAuthentication,omitempty"`
}
...
func (o *InlineObject282) GetApiAuthentication() InlineResponse200305ApiAuthentication {
	if o == nil || isNil(o.ApiAuthentication) {
		var ret InlineResponse200305ApiAuthentication
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InlineObject282) GetApiAuthenticationOk() (*InlineResponse200305ApiAuthentication, bool) {
	if o == nil || isNil(o.ApiAuthentication) {
    return nil, false
	}
...
// SetApiAuthentication gets a reference to the given InlineResponse200305ApiAuthentication and assigns it to the ApiAuthentication field.
func (o *InlineObject282) SetApiAuthentication(v InlineResponse200305ApiAuthentication) {
