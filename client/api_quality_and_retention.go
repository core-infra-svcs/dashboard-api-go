...
func (r QualityAndRetentionApiGetDeviceCameraQualityAndRetentionRequest) Execute() (*InlineResponse20017, *http.Response, error) {
...
func (a *QualityAndRetentionApiService) GetDeviceCameraQualityAndRetentionExecute(r QualityAndRetentionApiGetDeviceCameraQualityAndRetentionRequest) (*InlineResponse20017, *http.Response, error) {
	var (
...
func (r QualityAndRetentionApiUpdateDeviceCameraQualityAndRetentionRequest) Execute() (*InlineResponse20017, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20017
func (a *QualityAndRetentionApiService) UpdateDeviceCameraQualityAndRetentionExecute(r QualityAndRetentionApiUpdateDeviceCameraQualityAndRetentionRequest) (*InlineResponse20017, *http.Response, error) {
	var (
