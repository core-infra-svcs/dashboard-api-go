...
// InlineResponse20090ProductsWirelessLastUpgradeFromVersion Details of the version the device upgraded from
type InlineResponse20090ProductsWirelessLastUpgradeFromVersion struct {
...
func NewInlineResponse20090ProductsWirelessLastUpgradeFromVersion() *InlineResponse20090ProductsWirelessLastUpgradeFromVersion {
	this := InlineResponse20090ProductsWirelessLastUpgradeFromVersion{}
	return &this
}
...
func (o InlineResponse20090ProductsWirelessLastUpgradeFromVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20090ProductsWirelessLastUpgradeFromVersion struct {
	value *InlineResponse20090ProductsWirelessLastUpgradeFromVersion
	isSet bool
}

func (v NullableInlineResponse20090ProductsWirelessLastUpgradeFromVersion) Get() *InlineResponse20090ProductsWirelessLastUpgradeFromVersion {
	return v.value
}

func (v *NullableInlineResponse20090ProductsWirelessLastUpgradeFromVersion) Set(val *InlineResponse20090ProductsWirelessLastUpgradeFromVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20090ProductsWirelessLastUpgradeFromVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20090ProductsWirelessLastUpgradeFromVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20090ProductsWirelessLastUpgradeFromVersion(val *InlineResponse20090ProductsWirelessLastUpgradeFromVersion) *NullableInlineResponse20090ProductsWirelessLastUpgradeFromVersion {
	return &NullableInlineResponse20090ProductsWirelessLastUpgradeFromVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20090ProductsWirelessLastUpgradeFromVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20090ProductsWirelessLastUpgradeFromVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
