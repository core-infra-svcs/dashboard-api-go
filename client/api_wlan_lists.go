...
func (r WlanListsApiGetNetworkSmDeviceWlanListsRequest) Execute() ([]InlineResponse200153, *http.Response, error) {
...
func (a *WlanListsApiService) GetNetworkSmDeviceWlanListsExecute(r WlanListsApiGetNetworkSmDeviceWlanListsRequest) ([]InlineResponse200153, *http.Response, error) {
	var (
