...
func (r WlanListsApiGetNetworkSmDeviceWlanListsRequest) Execute() ([]InlineResponse20050, *http.Response, error) {
...
func (a *WlanListsApiService) GetNetworkSmDeviceWlanListsExecute(r WlanListsApiGetNetworkSmDeviceWlanListsRequest) ([]InlineResponse20050, *http.Response, error) {
	var (
