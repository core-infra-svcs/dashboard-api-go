...
func (r WlanListsApiApiGetNetworkSmDeviceWlanListsRequest) Execute() ([]InlineResponse20040, *_nethttp.Response, error) {
...
func (a *WlanListsApiService) GetNetworkSmDeviceWlanListsExecute(r WlanListsApiApiGetNetworkSmDeviceWlanListsRequest) ([]InlineResponse20040, *_nethttp.Response, error) {
	var (
