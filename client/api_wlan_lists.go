...
func (r WlanListsApiGetNetworkSmDeviceWlanListsRequest) Execute() ([]InlineResponse20063, *http.Response, error) {
...
func (a *WlanListsApiService) GetNetworkSmDeviceWlanListsExecute(r WlanListsApiGetNetworkSmDeviceWlanListsRequest) ([]InlineResponse20063, *http.Response, error) {
	var (
