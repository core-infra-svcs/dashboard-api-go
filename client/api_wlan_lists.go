...
func (r WlanListsApiGetNetworkSmDeviceWlanListsRequest) Execute() ([]InlineResponse200130, *http.Response, error) {
...
func (a *WlanListsApiService) GetNetworkSmDeviceWlanListsExecute(r WlanListsApiGetNetworkSmDeviceWlanListsRequest) ([]InlineResponse200130, *http.Response, error) {
	var (
