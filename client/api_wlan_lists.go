...
func (r WlanListsApiGetNetworkSmDeviceWlanListsRequest) Execute() ([]InlineResponse20085, *http.Response, error) {
...
func (a *WlanListsApiService) GetNetworkSmDeviceWlanListsExecute(r WlanListsApiGetNetworkSmDeviceWlanListsRequest) ([]InlineResponse20085, *http.Response, error) {
	var (
