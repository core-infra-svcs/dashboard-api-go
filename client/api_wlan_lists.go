...
type WlanListsApiApiGetNetworkSmDeviceWlanListsRequest struct {
...
func (r WlanListsApiApiGetNetworkSmDeviceWlanListsRequest) Execute() ([]map[string]interface{}, *_nethttp.Response, error) {
...
List the saved SSID names on a device
 ...
 @param networkId
 @param deviceId
 @return WlanListsApiApiGetNetworkSmDeviceWlanListsRequest
*/
func (a *WlanListsApiService) GetNetworkSmDeviceWlanLists(ctx _context.Context, networkId string, deviceId string) WlanListsApiApiGetNetworkSmDeviceWlanListsRequest {
	return WlanListsApiApiGetNetworkSmDeviceWlanListsRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *WlanListsApiService) GetNetworkSmDeviceWlanListsExecute(r WlanListsApiApiGetNetworkSmDeviceWlanListsRequest) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
