...
func NewInlineObject161(name string, ports []NetworksNetworkIdWirelessEthernetPortsProfilesPorts1) *InlineObject161 {
...
func (o *InlineObject161) GetPorts() []NetworksNetworkIdWirelessEthernetPortsProfilesPorts1 {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *InlineObject161) GetPortsOk() ([]NetworksNetworkIdWirelessEthernetPortsProfilesPorts1, bool) {
	if o == nil {
    return nil, false
	}
	return o.Ports, true
...
func (o *InlineObject161) SetPorts(v []NetworksNetworkIdWirelessEthernetPortsProfilesPorts1) {
	o.Ports = v
}

// GetUsbPorts returns the UsbPorts field value if set, zero value otherwise.
func (o *InlineObject161) GetUsbPorts() []NetworksNetworkIdWirelessEthernetPortsProfilesUsbPorts1 {
...
// and a boolean to check if the value has been set.
func (o *InlineObject161) GetUsbPortsOk() ([]NetworksNetworkIdWirelessEthernetPortsProfilesUsbPorts1, bool) {
	if o == nil || isNil(o.UsbPorts) {
    return nil, false
	}
...
func (o *InlineObject161) HasUsbPorts() bool {
	if o != nil && !isNil(o.UsbPorts) {
		return true
	}
...
func (o *InlineObject161) SetUsbPorts(v []NetworksNetworkIdWirelessEthernetPortsProfilesUsbPorts1) {
	o.UsbPorts = v
}
