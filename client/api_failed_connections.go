...
func (r FailedConnectionsApiGetNetworkWirelessFailedConnectionsRequest) Execute() ([]InlineResponse200176, *http.Response, error) {
...
func (a *FailedConnectionsApiService) GetNetworkWirelessFailedConnectionsExecute(r FailedConnectionsApiGetNetworkWirelessFailedConnectionsRequest) ([]InlineResponse200176, *http.Response, error) {
	var (
