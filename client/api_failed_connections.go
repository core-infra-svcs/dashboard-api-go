...
func (r FailedConnectionsApiGetNetworkWirelessFailedConnectionsRequest) Execute() ([]InlineResponse200187, *http.Response, error) {
...
func (a *FailedConnectionsApiService) GetNetworkWirelessFailedConnectionsExecute(r FailedConnectionsApiGetNetworkWirelessFailedConnectionsRequest) ([]InlineResponse200187, *http.Response, error) {
	var (
