...
type InlineResponse200257 struct {
	...
	States *InlineResponse200257States `json:"states,omitempty"`
	// Data by license type (Per-device licensing only)
	LicenseTypes []InlineResponse200257LicenseTypes `json:"licenseTypes,omitempty"`
	SystemsManager *InlineResponse200257SystemsManager `json:"systemsManager,omitempty"`
}
...
func (o *InlineResponse200257) GetStates() InlineResponse200257States {
	if o == nil || isNil(o.States) {
		var ret InlineResponse200257States
		return ret
	}
	return *o.States
}
...
// SetStates gets a reference to the given InlineResponse200257States and assigns it to the States field.
...
func (o *InlineResponse200257) GetLicenseTypes() []InlineResponse200257LicenseTypes {
	if o == nil || isNil(o.LicenseTypes) {
		var ret []InlineResponse200257LicenseTypes
		return ret
	}
...
// SetLicenseTypes gets a reference to the given []InlineResponse200257LicenseTypes and assigns it to the LicenseTypes field.
...
func (o *InlineResponse200257) GetSystemsManager() InlineResponse200257SystemsManager {
	if o == nil || isNil(o.SystemsManager) {
		var ret InlineResponse200257SystemsManager
		return ret
	}
...
// SetSystemsManager gets a reference to the given InlineResponse200257SystemsManager and assigns it to the SystemsManager field.
