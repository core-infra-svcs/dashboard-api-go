...
// InlineResponse200357Usage The usage on the interfaces of the wireless LAN controller
type InlineResponse200357Usage struct {
...
func NewInlineResponse200357Usage() *InlineResponse200357Usage {
	this := InlineResponse200357Usage{}
	return &this
}
...
func (o InlineResponse200357Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200357Usage struct {
	value *InlineResponse200357Usage
	isSet bool
}

func (v NullableInlineResponse200357Usage) Get() *InlineResponse200357Usage {
	return v.value
}

func (v *NullableInlineResponse200357Usage) Set(val *InlineResponse200357Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200357Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200357Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200357Usage(val *InlineResponse200357Usage) *NullableInlineResponse200357Usage {
	return &NullableInlineResponse200357Usage{value: val, isSet: true}
}

func (v NullableInlineResponse200357Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200357Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
