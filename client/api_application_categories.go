...
func (r ApplicationCategoriesApiGetNetworkApplianceFirewallL7FirewallRulesApplicationCategoriesRequest) Execute() (*InlineResponse20051, *http.Response, error) {
...
func (a *ApplicationCategoriesApiService) GetNetworkApplianceFirewallL7FirewallRulesApplicationCategoriesExecute(r ApplicationCategoriesApiGetNetworkApplianceFirewallL7FirewallRulesApplicationCategoriesRequest) (*InlineResponse20051, *http.Response, error) {
	var (
