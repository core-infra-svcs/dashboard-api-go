...
func (r ApplicationCategoriesApiGetNetworkApplianceFirewallL7FirewallRulesApplicationCategoriesRequest) Execute() (*InlineResponse20024, *http.Response, error) {
...
func (a *ApplicationCategoriesApiService) GetNetworkApplianceFirewallL7FirewallRulesApplicationCategoriesExecute(r ApplicationCategoriesApiGetNetworkApplianceFirewallL7FirewallRulesApplicationCategoriesRequest) (*InlineResponse20024, *http.Response, error) {
	var (
