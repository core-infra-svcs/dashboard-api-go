...
// InlineResponse20046BasicServiceSets struct for InlineResponse20046BasicServiceSets
type InlineResponse20046BasicServiceSets struct {
...
func NewInlineResponse20046BasicServiceSets() *InlineResponse20046BasicServiceSets {
	this := InlineResponse20046BasicServiceSets{}
	return &this
}
...
func (o InlineResponse20046BasicServiceSets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20046BasicServiceSets struct {
	value *InlineResponse20046BasicServiceSets
	isSet bool
}

func (v NullableInlineResponse20046BasicServiceSets) Get() *InlineResponse20046BasicServiceSets {
	return v.value
}

func (v *NullableInlineResponse20046BasicServiceSets) Set(val *InlineResponse20046BasicServiceSets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20046BasicServiceSets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20046BasicServiceSets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20046BasicServiceSets(val *InlineResponse20046BasicServiceSets) *NullableInlineResponse20046BasicServiceSets {
	return &NullableInlineResponse20046BasicServiceSets{value: val, isSet: true}
}

func (v NullableInlineResponse20046BasicServiceSets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20046BasicServiceSets) UnmarshalJSON(src []byte) error {
	v.isSet = true
