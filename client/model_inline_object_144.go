...
func (o *InlineObject144) GetSwitchPorts() []NetworksNetworkIdSwitchLinkAggregationsSwitchPorts1 {
...
func (o *InlineObject144) GetSwitchPortsOk() ([]NetworksNetworkIdSwitchLinkAggregationsSwitchPorts1, bool) {
	if o == nil || isNil(o.SwitchPorts) {
    return nil, false
	}
...
func (o *InlineObject144) HasSwitchPorts() bool {
	if o != nil && !isNil(o.SwitchPorts) {
		return true
	}
...
func (o *InlineObject144) SetSwitchPorts(v []NetworksNetworkIdSwitchLinkAggregationsSwitchPorts1) {
	o.SwitchPorts = v
}

// GetSwitchProfilePorts returns the SwitchProfilePorts field value if set, zero value otherwise.
func (o *InlineObject144) GetSwitchProfilePorts() []NetworksNetworkIdSwitchLinkAggregationsSwitchProfilePorts {
...
// and a boolean to check if the value has been set.
func (o *InlineObject144) GetSwitchProfilePortsOk() ([]NetworksNetworkIdSwitchLinkAggregationsSwitchProfilePorts, bool) {
	if o == nil || isNil(o.SwitchProfilePorts) {
    return nil, false
	}
...
func (o *InlineObject144) HasSwitchProfilePorts() bool {
	if o != nil && !isNil(o.SwitchProfilePorts) {
		return true
	}
...
func (o *InlineObject144) SetSwitchProfilePorts(v []NetworksNetworkIdSwitchLinkAggregationsSwitchProfilePorts) {
