...
// InlineResponse200359Changes struct for InlineResponse200359Changes
type InlineResponse200359Changes struct {
...
func NewInlineResponse200359Changes() *InlineResponse200359Changes {
	this := InlineResponse200359Changes{}
	return &this
}
...
func (o InlineResponse200359Changes) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200359Changes struct {
	value *InlineResponse200359Changes
	isSet bool
}

func (v NullableInlineResponse200359Changes) Get() *InlineResponse200359Changes {
	return v.value
}

func (v *NullableInlineResponse200359Changes) Set(val *InlineResponse200359Changes) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200359Changes) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200359Changes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200359Changes(val *InlineResponse200359Changes) *NullableInlineResponse200359Changes {
	return &NullableInlineResponse200359Changes{value: val, isSet: true}
}

func (v NullableInlineResponse200359Changes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200359Changes) UnmarshalJSON(src []byte) error {
	v.isSet = true
