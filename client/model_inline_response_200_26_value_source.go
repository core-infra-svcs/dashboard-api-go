...
// InlineResponse20026ValueSource Source of 'custom' type traffic filter
type InlineResponse20026ValueSource struct {
...
func NewInlineResponse20026ValueSource() *InlineResponse20026ValueSource {
	this := InlineResponse20026ValueSource{}
	return &this
}
...
func (o InlineResponse20026ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20026ValueSource struct {
	value *InlineResponse20026ValueSource
	isSet bool
}

func (v NullableInlineResponse20026ValueSource) Get() *InlineResponse20026ValueSource {
	return v.value
}

func (v *NullableInlineResponse20026ValueSource) Set(val *InlineResponse20026ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20026ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20026ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20026ValueSource(val *InlineResponse20026ValueSource) *NullableInlineResponse20026ValueSource {
	return &NullableInlineResponse20026ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20026ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20026ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
