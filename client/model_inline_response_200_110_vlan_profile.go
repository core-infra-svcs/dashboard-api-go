...
// InlineResponse200110VlanProfile The VLAN Profile
type InlineResponse200110VlanProfile struct {
...
func NewInlineResponse200110VlanProfile() *InlineResponse200110VlanProfile {
	this := InlineResponse200110VlanProfile{}
	return &this
}
...
func (o InlineResponse200110VlanProfile) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200110VlanProfile struct {
	value *InlineResponse200110VlanProfile
	isSet bool
}

func (v NullableInlineResponse200110VlanProfile) Get() *InlineResponse200110VlanProfile {
	return v.value
}

func (v *NullableInlineResponse200110VlanProfile) Set(val *InlineResponse200110VlanProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200110VlanProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200110VlanProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200110VlanProfile(val *InlineResponse200110VlanProfile) *NullableInlineResponse200110VlanProfile {
	return &NullableInlineResponse200110VlanProfile{value: val, isSet: true}
}

func (v NullableInlineResponse200110VlanProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200110VlanProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
