...
// InlineResponse200199Identity EAP settings for identity requests.
type InlineResponse200199Identity struct {
...
func NewInlineResponse200199Identity() *InlineResponse200199Identity {
	this := InlineResponse200199Identity{}
	return &this
}
...
func (o InlineResponse200199Identity) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200199Identity struct {
	value *InlineResponse200199Identity
	isSet bool
}

func (v NullableInlineResponse200199Identity) Get() *InlineResponse200199Identity {
	return v.value
}

func (v *NullableInlineResponse200199Identity) Set(val *InlineResponse200199Identity) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200199Identity) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200199Identity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200199Identity(val *InlineResponse200199Identity) *NullableInlineResponse200199Identity {
	return &NullableInlineResponse200199Identity{value: val, isSet: true}
}

func (v NullableInlineResponse200199Identity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200199Identity) UnmarshalJSON(src []byte) error {
	v.isSet = true
