...
// InlineResponse20026Lldp lldp information
type InlineResponse20026Lldp struct {
	// Device system name
...
func (o InlineResponse20026Lldp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20026Lldp struct {
	value *InlineResponse20026Lldp
	isSet bool
}

func (v NullableInlineResponse20026Lldp) Get() *InlineResponse20026Lldp {
	return v.value
}

func (v *NullableInlineResponse20026Lldp) Set(val *InlineResponse20026Lldp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20026Lldp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20026Lldp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20026Lldp(val *InlineResponse20026Lldp) *NullableInlineResponse20026Lldp {
	return &NullableInlineResponse20026Lldp{value: val, isSet: true}
}

func (v NullableInlineResponse20026Lldp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20026Lldp) UnmarshalJSON(src []byte) error {
	v.isSet = true
