...
// InlineResponse200372WifiHysteresis Wi-Fi Hysteresis Settings for network
type InlineResponse200372WifiHysteresis struct {
...
func NewInlineResponse200372WifiHysteresis() *InlineResponse200372WifiHysteresis {
	this := InlineResponse200372WifiHysteresis{}
	return &this
}
...
func (o InlineResponse200372WifiHysteresis) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200372WifiHysteresis struct {
	value *InlineResponse200372WifiHysteresis
	isSet bool
}

func (v NullableInlineResponse200372WifiHysteresis) Get() *InlineResponse200372WifiHysteresis {
	return v.value
}

func (v *NullableInlineResponse200372WifiHysteresis) Set(val *InlineResponse200372WifiHysteresis) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200372WifiHysteresis) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200372WifiHysteresis) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200372WifiHysteresis(val *InlineResponse200372WifiHysteresis) *NullableInlineResponse200372WifiHysteresis {
	return &NullableInlineResponse200372WifiHysteresis{value: val, isSet: true}
}

func (v NullableInlineResponse200372WifiHysteresis) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200372WifiHysteresis) UnmarshalJSON(src []byte) error {
	v.isSet = true
