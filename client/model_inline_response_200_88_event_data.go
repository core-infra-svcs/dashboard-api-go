...
// InlineResponse20088EventData An object containing more data related to the event.
type InlineResponse20088EventData struct {
...
func NewInlineResponse20088EventData() *InlineResponse20088EventData {
	this := InlineResponse20088EventData{}
	return &this
}
...
func (o InlineResponse20088EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20088EventData struct {
	value *InlineResponse20088EventData
	isSet bool
}

func (v NullableInlineResponse20088EventData) Get() *InlineResponse20088EventData {
	return v.value
}

func (v *NullableInlineResponse20088EventData) Set(val *InlineResponse20088EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20088EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20088EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20088EventData(val *InlineResponse20088EventData) *NullableInlineResponse20088EventData {
	return &NullableInlineResponse20088EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20088EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20088EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
