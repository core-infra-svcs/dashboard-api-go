...
// InlineResponse20089ProductsWirelessLastUpgrade Details of the last firmware upgrade on the device
type InlineResponse20089ProductsWirelessLastUpgrade struct {
	// Timestamp of the last successful firmware upgrade
	Time *time.Time `json:"time,omitempty"`
	FromVersion *InlineResponse20089ProductsWirelessLastUpgradeFromVersion `json:"fromVersion,omitempty"`
	ToVersion *InlineResponse20089ProductsWirelessLastUpgradeToVersion `json:"toVersion,omitempty"`
}
...
func NewInlineResponse20089ProductsWirelessLastUpgrade() *InlineResponse20089ProductsWirelessLastUpgrade {
	this := InlineResponse20089ProductsWirelessLastUpgrade{}
	return &this
}
...
func (o *InlineResponse20089ProductsWirelessLastUpgrade) GetFromVersion() InlineResponse20089ProductsWirelessLastUpgradeFromVersion {
	if o == nil || isNil(o.FromVersion) {
		var ret InlineResponse20089ProductsWirelessLastUpgradeFromVersion
		return ret
	}
...
// SetFromVersion gets a reference to the given InlineResponse20089ProductsWirelessLastUpgradeFromVersion and assigns it to the FromVersion field.
...
func (o *InlineResponse20089ProductsWirelessLastUpgrade) GetToVersion() InlineResponse20089ProductsWirelessLastUpgradeToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20089ProductsWirelessLastUpgradeToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20089ProductsWirelessLastUpgradeToVersion and assigns it to the ToVersion field.
...
func (o InlineResponse20089ProductsWirelessLastUpgrade) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20089ProductsWirelessLastUpgrade struct {
	value *InlineResponse20089ProductsWirelessLastUpgrade
	isSet bool
}

func (v NullableInlineResponse20089ProductsWirelessLastUpgrade) Get() *InlineResponse20089ProductsWirelessLastUpgrade {
	return v.value
}

func (v *NullableInlineResponse20089ProductsWirelessLastUpgrade) Set(val *InlineResponse20089ProductsWirelessLastUpgrade) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20089ProductsWirelessLastUpgrade) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20089ProductsWirelessLastUpgrade) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20089ProductsWirelessLastUpgrade(val *InlineResponse20089ProductsWirelessLastUpgrade) *NullableInlineResponse20089ProductsWirelessLastUpgrade {
	return &NullableInlineResponse20089ProductsWirelessLastUpgrade{value: val, isSet: true}
}

func (v NullableInlineResponse20089ProductsWirelessLastUpgrade) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20089ProductsWirelessLastUpgrade) UnmarshalJSON(src []byte) error {
	v.isSet = true
