...
// InlineResponse200286StatesUnusedSoonestActivation Information about the soonest forthcoming license activation
type InlineResponse200286StatesUnusedSoonestActivation struct {
...
func NewInlineResponse200286StatesUnusedSoonestActivation() *InlineResponse200286StatesUnusedSoonestActivation {
	this := InlineResponse200286StatesUnusedSoonestActivation{}
	return &this
}
...
func (o InlineResponse200286StatesUnusedSoonestActivation) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200286StatesUnusedSoonestActivation struct {
	value *InlineResponse200286StatesUnusedSoonestActivation
	isSet bool
}

func (v NullableInlineResponse200286StatesUnusedSoonestActivation) Get() *InlineResponse200286StatesUnusedSoonestActivation {
	return v.value
}

func (v *NullableInlineResponse200286StatesUnusedSoonestActivation) Set(val *InlineResponse200286StatesUnusedSoonestActivation) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200286StatesUnusedSoonestActivation) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200286StatesUnusedSoonestActivation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200286StatesUnusedSoonestActivation(val *InlineResponse200286StatesUnusedSoonestActivation) *NullableInlineResponse200286StatesUnusedSoonestActivation {
	return &NullableInlineResponse200286StatesUnusedSoonestActivation{value: val, isSet: true}
}

func (v NullableInlineResponse200286StatesUnusedSoonestActivation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200286StatesUnusedSoonestActivation) UnmarshalJSON(src []byte) error {
	v.isSet = true
