...
// InlineResponse200121Counts The current amount of various adaptive policy objects.
type InlineResponse200121Counts struct {
...
func NewInlineResponse200121Counts() *InlineResponse200121Counts {
	this := InlineResponse200121Counts{}
	return &this
}
...
func (o InlineResponse200121Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200121Counts struct {
	value *InlineResponse200121Counts
	isSet bool
}

func (v NullableInlineResponse200121Counts) Get() *InlineResponse200121Counts {
	return v.value
}

func (v *NullableInlineResponse200121Counts) Set(val *InlineResponse200121Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200121Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200121Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200121Counts(val *InlineResponse200121Counts) *NullableInlineResponse200121Counts {
	return &NullableInlineResponse200121Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200121Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200121Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
