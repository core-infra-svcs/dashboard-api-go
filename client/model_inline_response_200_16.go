...
type InlineResponse20016 struct {
	...
	Sims []InlineResponse20016Sims `json:"sims,omitempty"`
	...
	SimFailover *InlineResponse20016SimFailover `json:"simFailover,omitempty"`
}
...
func (o *InlineResponse20016) GetSims() []InlineResponse20016Sims {
	if o == nil || isNil(o.Sims) {
		var ret []InlineResponse20016Sims
		return ret
	}
	return o.Sims
}
...
// SetSims gets a reference to the given []InlineResponse20016Sims and assigns it to the Sims field.
...
func (o *InlineResponse20016) GetSimFailover() InlineResponse20016SimFailover {
	if o == nil || isNil(o.SimFailover) {
		var ret InlineResponse20016SimFailover
		return ret
	}
...
// SetSimFailover gets a reference to the given InlineResponse20016SimFailover and assigns it to the SimFailover field.
