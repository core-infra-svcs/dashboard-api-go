...
type InlineResponse200206 struct {
	...
	SplashLogo *InlineResponse200206SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200206SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200206SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200206GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200206Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200206SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200206SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200206) GetSplashLogo() InlineResponse200206SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200206SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200206SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200206) GetSplashImage() InlineResponse200206SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200206SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200206SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200206) GetSplashPrepaidFront() InlineResponse200206SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200206SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200206SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200206) GetGuestSponsorship() InlineResponse200206GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200206GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200206GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200206) GetBilling() InlineResponse200206Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200206Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200206Billing and assigns it to the Billing field.
...
func (o *InlineResponse200206) GetSentryEnrollment() InlineResponse200206SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200206SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200206SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200206) GetSelfRegistration() InlineResponse200206SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200206SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200206SelfRegistration and assigns it to the SelfRegistration field.
