...
// InlineResponse200194TwoFourGhzSettings Settings related to 2.4Ghz band
type InlineResponse200194TwoFourGhzSettings struct {
...
func NewInlineResponse200194TwoFourGhzSettings() *InlineResponse200194TwoFourGhzSettings {
	this := InlineResponse200194TwoFourGhzSettings{}
	return &this
}
...
func (o InlineResponse200194TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200194TwoFourGhzSettings struct {
	value *InlineResponse200194TwoFourGhzSettings
	isSet bool
}

func (v NullableInlineResponse200194TwoFourGhzSettings) Get() *InlineResponse200194TwoFourGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200194TwoFourGhzSettings) Set(val *InlineResponse200194TwoFourGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200194TwoFourGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200194TwoFourGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200194TwoFourGhzSettings(val *InlineResponse200194TwoFourGhzSettings) *NullableInlineResponse200194TwoFourGhzSettings {
	return &NullableInlineResponse200194TwoFourGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200194TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200194TwoFourGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
