...
type InlineResponse200274 struct {
	...
	States *InlineResponse200274States `json:"states,omitempty"`
	// Data by license type (Per-device licensing only)
	LicenseTypes []InlineResponse200274LicenseTypes `json:"licenseTypes,omitempty"`
	SystemsManager *InlineResponse200274SystemsManager `json:"systemsManager,omitempty"`
}
...
func (o *InlineResponse200274) GetStates() InlineResponse200274States {
	if o == nil || isNil(o.States) {
		var ret InlineResponse200274States
		return ret
	}
	return *o.States
}
...
// SetStates gets a reference to the given InlineResponse200274States and assigns it to the States field.
...
func (o *InlineResponse200274) GetLicenseTypes() []InlineResponse200274LicenseTypes {
	if o == nil || isNil(o.LicenseTypes) {
		var ret []InlineResponse200274LicenseTypes
		return ret
	}
...
// SetLicenseTypes gets a reference to the given []InlineResponse200274LicenseTypes and assigns it to the LicenseTypes field.
...
func (o *InlineResponse200274) GetSystemsManager() InlineResponse200274SystemsManager {
	if o == nil || isNil(o.SystemsManager) {
		var ret InlineResponse200274SystemsManager
		return ret
	}
...
// SetSystemsManager gets a reference to the given InlineResponse200274SystemsManager and assigns it to the SystemsManager field.
