...
// InlineResponse200103ResultingNetwork Network after the combination
type InlineResponse200103ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200103ResultingNetwork() *InlineResponse200103ResultingNetwork {
	this := InlineResponse200103ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200103ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200103ResultingNetwork struct {
	value *InlineResponse200103ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200103ResultingNetwork) Get() *InlineResponse200103ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200103ResultingNetwork) Set(val *InlineResponse200103ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200103ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200103ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200103ResultingNetwork(val *InlineResponse200103ResultingNetwork) *NullableInlineResponse200103ResultingNetwork {
	return &NullableInlineResponse200103ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200103ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200103ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
