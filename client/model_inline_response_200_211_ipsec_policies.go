...
// InlineResponse200211IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200211IpsecPolicies struct {
...
func NewInlineResponse200211IpsecPolicies() *InlineResponse200211IpsecPolicies {
	this := InlineResponse200211IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200211IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200211IpsecPolicies struct {
	value *InlineResponse200211IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200211IpsecPolicies) Get() *InlineResponse200211IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200211IpsecPolicies) Set(val *InlineResponse200211IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200211IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200211IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200211IpsecPolicies(val *InlineResponse200211IpsecPolicies) *NullableInlineResponse200211IpsecPolicies {
	return &NullableInlineResponse200211IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200211IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200211IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
