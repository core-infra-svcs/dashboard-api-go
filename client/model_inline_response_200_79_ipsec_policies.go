...
// InlineResponse20079IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse20079IpsecPolicies struct {
...
func NewInlineResponse20079IpsecPolicies() *InlineResponse20079IpsecPolicies {
	this := InlineResponse20079IpsecPolicies{}
	return &this
}
...
func (o InlineResponse20079IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20079IpsecPolicies struct {
	value *InlineResponse20079IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse20079IpsecPolicies) Get() *InlineResponse20079IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse20079IpsecPolicies) Set(val *InlineResponse20079IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20079IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20079IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20079IpsecPolicies(val *InlineResponse20079IpsecPolicies) *NullableInlineResponse20079IpsecPolicies {
	return &NullableInlineResponse20079IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse20079IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20079IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
