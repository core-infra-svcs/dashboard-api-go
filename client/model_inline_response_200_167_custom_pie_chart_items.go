...
// InlineResponse200167CustomPieChartItems struct for InlineResponse200167CustomPieChartItems
type InlineResponse200167CustomPieChartItems struct {
...
func NewInlineResponse200167CustomPieChartItems(name string, type_ string, value string) *InlineResponse200167CustomPieChartItems {
	this := InlineResponse200167CustomPieChartItems{}
	this.Name = name
	this.Type = type_
	this.Value = value
	return &this
...
func (o InlineResponse200167CustomPieChartItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200167CustomPieChartItems struct {
	value *InlineResponse200167CustomPieChartItems
	isSet bool
}

func (v NullableInlineResponse200167CustomPieChartItems) Get() *InlineResponse200167CustomPieChartItems {
	return v.value
}

func (v *NullableInlineResponse200167CustomPieChartItems) Set(val *InlineResponse200167CustomPieChartItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200167CustomPieChartItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200167CustomPieChartItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200167CustomPieChartItems(val *InlineResponse200167CustomPieChartItems) *NullableInlineResponse200167CustomPieChartItems {
	return &NullableInlineResponse200167CustomPieChartItems{value: val, isSet: true}
}

func (v NullableInlineResponse200167CustomPieChartItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200167CustomPieChartItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
