...
// InlineResponse20035Events struct for InlineResponse20035Events
type InlineResponse20035Events struct {
	...
	EventData *InlineResponse20035EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20035Events() *InlineResponse20035Events {
	this := InlineResponse20035Events{}
	return &this
}
...
func (o *InlineResponse20035Events) GetEventData() InlineResponse20035EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20035EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20035EventData and assigns it to the EventData field.
func (o *InlineResponse20035Events) SetEventData(v InlineResponse20035EventData) {
	o.EventData = &v
}

func (o InlineResponse20035Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20035Events struct {
	value *InlineResponse20035Events
	isSet bool
}

func (v NullableInlineResponse20035Events) Get() *InlineResponse20035Events {
	return v.value
}

func (v *NullableInlineResponse20035Events) Set(val *InlineResponse20035Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20035Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20035Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20035Events(val *InlineResponse20035Events) *NullableInlineResponse20035Events {
	return &NullableInlineResponse20035Events{value: val, isSet: true}
}

func (v NullableInlineResponse20035Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20035Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
