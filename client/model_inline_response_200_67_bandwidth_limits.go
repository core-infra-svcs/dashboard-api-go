...
// InlineResponse20067BandwidthLimits A hash uplink keys and their configured settings for the Appliance
type InlineResponse20067BandwidthLimits struct {
	Wan1 *InlineResponse20067BandwidthLimitsWan1 `json:"wan1,omitempty"`
	Wan2 *InlineResponse20067BandwidthLimitsWan2 `json:"wan2,omitempty"`
	Cellular *InlineResponse20067BandwidthLimitsCellular `json:"cellular,omitempty"`
}
...
func NewInlineResponse20067BandwidthLimits() *InlineResponse20067BandwidthLimits {
	this := InlineResponse20067BandwidthLimits{}
	return &this
}
...
func (o *InlineResponse20067BandwidthLimits) GetWan1() InlineResponse20067BandwidthLimitsWan1 {
	if o == nil || isNil(o.Wan1) {
		var ret InlineResponse20067BandwidthLimitsWan1
		return ret
	}
	return *o.Wan1
}
...
// SetWan1 gets a reference to the given InlineResponse20067BandwidthLimitsWan1 and assigns it to the Wan1 field.
...
func (o *InlineResponse20067BandwidthLimits) GetWan2() InlineResponse20067BandwidthLimitsWan2 {
	if o == nil || isNil(o.Wan2) {
		var ret InlineResponse20067BandwidthLimitsWan2
		return ret
	}
	return *o.Wan2
}
...
// SetWan2 gets a reference to the given InlineResponse20067BandwidthLimitsWan2 and assigns it to the Wan2 field.
...
func (o *InlineResponse20067BandwidthLimits) GetCellular() InlineResponse20067BandwidthLimitsCellular {
	if o == nil || isNil(o.Cellular) {
		var ret InlineResponse20067BandwidthLimitsCellular
		return ret
	}
	return *o.Cellular
}
...
// SetCellular gets a reference to the given InlineResponse20067BandwidthLimitsCellular and assigns it to the Cellular field.
func (o *InlineResponse20067BandwidthLimits) SetCellular(v InlineResponse20067BandwidthLimitsCellular) {
	o.Cellular = &v
}

func (o InlineResponse20067BandwidthLimits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20067BandwidthLimits struct {
	value *InlineResponse20067BandwidthLimits
	isSet bool
}

func (v NullableInlineResponse20067BandwidthLimits) Get() *InlineResponse20067BandwidthLimits {
	return v.value
}

func (v *NullableInlineResponse20067BandwidthLimits) Set(val *InlineResponse20067BandwidthLimits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20067BandwidthLimits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20067BandwidthLimits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20067BandwidthLimits(val *InlineResponse20067BandwidthLimits) *NullableInlineResponse20067BandwidthLimits {
	return &NullableInlineResponse20067BandwidthLimits{value: val, isSet: true}
}

func (v NullableInlineResponse20067BandwidthLimits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20067BandwidthLimits) UnmarshalJSON(src []byte) error {
	v.isSet = true
