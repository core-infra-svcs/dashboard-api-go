...
func (r VppAccountsApiGetOrganizationSmVppAccountRequest) Execute() (*InlineResponse200313, *http.Response, error) {
...
func (a *VppAccountsApiService) GetOrganizationSmVppAccountExecute(r VppAccountsApiGetOrganizationSmVppAccountRequest) (*InlineResponse200313, *http.Response, error) {
	var (
...
func (r VppAccountsApiGetOrganizationSmVppAccountsRequest) Execute() ([]InlineResponse200313, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200313
func (a *VppAccountsApiService) GetOrganizationSmVppAccountsExecute(r VppAccountsApiGetOrganizationSmVppAccountsRequest) ([]InlineResponse200313, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
