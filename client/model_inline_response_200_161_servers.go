...
// InlineResponse200161Servers struct for InlineResponse200161Servers
type InlineResponse200161Servers struct {
...
func NewInlineResponse200161Servers() *InlineResponse200161Servers {
	this := InlineResponse200161Servers{}
	return &this
}
...
func (o InlineResponse200161Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200161Servers struct {
	value *InlineResponse200161Servers
	isSet bool
}

func (v NullableInlineResponse200161Servers) Get() *InlineResponse200161Servers {
	return v.value
}

func (v *NullableInlineResponse200161Servers) Set(val *InlineResponse200161Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200161Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200161Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200161Servers(val *InlineResponse200161Servers) *NullableInlineResponse200161Servers {
	return &NullableInlineResponse200161Servers{value: val, isSet: true}
}

func (v NullableInlineResponse200161Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200161Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
