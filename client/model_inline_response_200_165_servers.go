...
// InlineResponse200165Servers struct for InlineResponse200165Servers
type InlineResponse200165Servers struct {
...
func NewInlineResponse200165Servers() *InlineResponse200165Servers {
	this := InlineResponse200165Servers{}
	return &this
}
...
func (o InlineResponse200165Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200165Servers struct {
	value *InlineResponse200165Servers
	isSet bool
}

func (v NullableInlineResponse200165Servers) Get() *InlineResponse200165Servers {
	return v.value
}

func (v *NullableInlineResponse200165Servers) Set(val *InlineResponse200165Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200165Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200165Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200165Servers(val *InlineResponse200165Servers) *NullableInlineResponse200165Servers {
	return &NullableInlineResponse200165Servers{value: val, isSet: true}
}

func (v NullableInlineResponse200165Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200165Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
