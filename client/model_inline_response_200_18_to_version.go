...
// InlineResponse20018ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20018ToVersion struct {
...
func NewInlineResponse20018ToVersion() *InlineResponse20018ToVersion {
	this := InlineResponse20018ToVersion{}
	return &this
}
...
func (o InlineResponse20018ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20018ToVersion struct {
	value *InlineResponse20018ToVersion
	isSet bool
}

func (v NullableInlineResponse20018ToVersion) Get() *InlineResponse20018ToVersion {
	return v.value
}

func (v *NullableInlineResponse20018ToVersion) Set(val *InlineResponse20018ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20018ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20018ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20018ToVersion(val *InlineResponse20018ToVersion) *NullableInlineResponse20018ToVersion {
	return &NullableInlineResponse20018ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20018ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20018ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
