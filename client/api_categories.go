...
func (r CategoriesApiGetOrganizationAssuranceAlertsTaxonomyCategoriesRequest) Execute() ([]InlineResponse200245, *http.Response, error) {
...
func (a *CategoriesApiService) GetOrganizationAssuranceAlertsTaxonomyCategoriesExecute(r CategoriesApiGetOrganizationAssuranceAlertsTaxonomyCategoriesRequest) ([]InlineResponse200245, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CategoriesApiGetOrganizationSummaryTopApplicationsCategoriesByUsageRequest) Execute() ([]InlineResponse200331, *http.Response, error) {
...
func (a *CategoriesApiService) GetOrganizationSummaryTopApplicationsCategoriesByUsageExecute(r CategoriesApiGetOrganizationSummaryTopApplicationsCategoriesByUsageRequest) ([]InlineResponse200331, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
