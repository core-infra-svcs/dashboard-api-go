...
func (r CategoriesApiGetOrganizationAssuranceAlertsTaxonomyCategoriesRequest) Execute() ([]InlineResponse200247, *http.Response, error) {
...
func (a *CategoriesApiService) GetOrganizationAssuranceAlertsTaxonomyCategoriesExecute(r CategoriesApiGetOrganizationAssuranceAlertsTaxonomyCategoriesRequest) ([]InlineResponse200247, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CategoriesApiGetOrganizationSummaryTopApplicationsCategoriesByUsageRequest) Execute() ([]InlineResponse200334, *http.Response, error) {
...
func (a *CategoriesApiService) GetOrganizationSummaryTopApplicationsCategoriesByUsageExecute(r CategoriesApiGetOrganizationSummaryTopApplicationsCategoriesByUsageRequest) ([]InlineResponse200334, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
