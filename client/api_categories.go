...
type CategoriesApiGetOrganizationAssuranceAlertsTaxonomyCategoriesRequest struct {
	ctx context.Context
	ApiService *CategoriesApiService
	organizationId string
}

func (r CategoriesApiGetOrganizationAssuranceAlertsTaxonomyCategoriesRequest) Execute() ([]InlineResponse200248, *http.Response, error) {
...
Return a list of Category Types
 ...
 @return CategoriesApiGetOrganizationAssuranceAlertsTaxonomyCategoriesRequest
*/
func (a *CategoriesApiService) GetOrganizationAssuranceAlertsTaxonomyCategories(ctx context.Context, organizationId string) CategoriesApiGetOrganizationAssuranceAlertsTaxonomyCategoriesRequest {
	return CategoriesApiGetOrganizationAssuranceAlertsTaxonomyCategoriesRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *CategoriesApiService) GetOrganizationAssuranceAlertsTaxonomyCategoriesExecute(r CategoriesApiGetOrganizationAssuranceAlertsTaxonomyCategoriesRequest) ([]InlineResponse200248, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CategoriesApiService.GetOrganizationAssuranceAlertsTaxonomyCategories")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r CategoriesApiGetOrganizationSummaryTopApplicationsCategoriesByUsageRequest) Execute() ([]InlineResponse200335, *http.Response, error) {
...
func (a *CategoriesApiService) GetOrganizationSummaryTopApplicationsCategoriesByUsageExecute(r CategoriesApiGetOrganizationSummaryTopApplicationsCategoriesByUsageRequest) ([]InlineResponse200335, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
