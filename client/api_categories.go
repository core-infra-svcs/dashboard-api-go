...
func (r CategoriesApiGetOrganizationAssuranceAlertsTaxonomyCategoriesRequest) Execute() ([]InlineResponse200243, *http.Response, error) {
...
func (a *CategoriesApiService) GetOrganizationAssuranceAlertsTaxonomyCategoriesExecute(r CategoriesApiGetOrganizationAssuranceAlertsTaxonomyCategoriesRequest) ([]InlineResponse200243, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CategoriesApiGetOrganizationSummaryTopApplicationsCategoriesByUsageRequest) Execute() ([]InlineResponse200327, *http.Response, error) {
...
func (a *CategoriesApiService) GetOrganizationSummaryTopApplicationsCategoriesByUsageExecute(r CategoriesApiGetOrganizationSummaryTopApplicationsCategoriesByUsageRequest) ([]InlineResponse200327, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
