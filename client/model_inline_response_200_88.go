...
type InlineResponse20088 struct {
	...
	ToVersion *InlineResponse20088ToVersion `json:"toVersion,omitempty"`
...
func (o *InlineResponse20088) GetToVersion() InlineResponse20088ToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20088ToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20088ToVersion and assigns it to the ToVersion field.
