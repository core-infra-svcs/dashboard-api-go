...
type InlineResponse20088 struct {
	...
	ClientVpnConnections []InlineResponse20088ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20088) GetClientVpnConnections() []InlineResponse20088ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20088ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20088ClientVpnConnections and assigns it to the ClientVpnConnections field.
