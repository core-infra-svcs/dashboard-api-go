...
func (o *InlineResponse200182) GetBroadcastThreshold() int32 {
...
func (o *InlineResponse200182) GetBroadcastThresholdOk() (*int32, bool) {
	if o == nil || isNil(o.BroadcastThreshold) {
    return nil, false
	}
...
func (o *InlineResponse200182) HasBroadcastThreshold() bool {
	if o != nil && !isNil(o.BroadcastThreshold) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200182) GetMulticastThresholdOk() (*int32, bool) {
	if o == nil || isNil(o.MulticastThreshold) {
    return nil, false
	}
...
func (o *InlineResponse200182) HasMulticastThreshold() bool {
	if o != nil && !isNil(o.MulticastThreshold) {
		return true
	}
...
func (o *InlineResponse200182) SetMulticastThreshold(v int32) {
...
func (o *InlineResponse200182) GetUnknownUnicastThreshold() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200182) GetUnknownUnicastThresholdOk() (*int32, bool) {
	if o == nil || isNil(o.UnknownUnicastThreshold) {
    return nil, false
	}
...
func (o *InlineResponse200182) HasUnknownUnicastThreshold() bool {
	if o != nil && !isNil(o.UnknownUnicastThreshold) {
		return true
	}
...
func (o *InlineResponse200182) SetUnknownUnicastThreshold(v int32) {
...
func (o *InlineResponse200182) GetTreatTheseTrafficTypesAsOneThreshold() []string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200182) GetTreatTheseTrafficTypesAsOneThresholdOk() ([]string, bool) {
	if o == nil || isNil(o.TreatTheseTrafficTypesAsOneThreshold) {
    return nil, false
	}
...
func (o *InlineResponse200182) HasTreatTheseTrafficTypesAsOneThreshold() bool {
	if o != nil && !isNil(o.TreatTheseTrafficTypesAsOneThreshold) {
		return true
	}
...
func (o *InlineResponse200182) SetTreatTheseTrafficTypesAsOneThreshold(v []string) {
