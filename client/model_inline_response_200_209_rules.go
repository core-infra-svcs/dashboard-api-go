...
// InlineResponse200209Rules struct for InlineResponse200209Rules
type InlineResponse200209Rules struct {
...
func NewInlineResponse200209Rules(definitions []NetworksNetworkIdApplianceTrafficShapingRulesDefinitions) *InlineResponse200209Rules {
	this := InlineResponse200209Rules{}
...
func (o InlineResponse200209Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200209Rules struct {
	value *InlineResponse200209Rules
	isSet bool
}

func (v NullableInlineResponse200209Rules) Get() *InlineResponse200209Rules {
	return v.value
}

func (v *NullableInlineResponse200209Rules) Set(val *InlineResponse200209Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200209Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200209Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200209Rules(val *InlineResponse200209Rules) *NullableInlineResponse200209Rules {
	return &NullableInlineResponse200209Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200209Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200209Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
