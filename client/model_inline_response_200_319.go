...
type InlineResponse200319 struct {
	...
	Eox *OrganizationsOrganizationIdInventoryDevicesEox `json:"eox,omitempty"`
}
...
// GetEox returns the Eox field value if set, zero value otherwise.
func (o *InlineResponse200319) GetEox() OrganizationsOrganizationIdInventoryDevicesEox {
	if o == nil || isNil(o.Eox) {
		var ret OrganizationsOrganizationIdInventoryDevicesEox
		return ret
	}
	return *o.Eox
}

// GetEoxOk returns a tuple with the Eox field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetEox gets a reference to the given OrganizationsOrganizationIdInventoryDevicesEox and assigns it to the Eox field.
