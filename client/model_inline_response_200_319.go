...
type InlineResponse200319 struct {
	...
	RawTemperature *OrganizationsOrganizationIdSensorReadingsHistoryRawTemperature `json:"rawTemperature,omitempty"`
}
...
// SetRawTemperature gets a reference to the given OrganizationsOrganizationIdSensorReadingsHistoryRawTemperature and assigns it to the RawTemperature field.
...
func (o InlineResponse200319) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.RawTemperature) {
		toSerialize["rawTemperature"] = o.RawTemperature
	}
