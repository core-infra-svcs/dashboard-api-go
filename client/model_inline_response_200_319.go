...
type InlineResponse200319 struct {
	// Switches
	Items []InlineResponse200319Items `json:"items,omitempty"`
...
// SetItems gets a reference to the given []InlineResponse200319Items and assigns it to the Items field.
