...
type InlineResponse200319 struct {
	...
	States *InlineResponse200319States `json:"states,omitempty"`
	// Data by license type (Per-device licensing only)
	LicenseTypes []InlineResponse200319LicenseTypes `json:"licenseTypes,omitempty"`
	SystemsManager *InlineResponse200319SystemsManager `json:"systemsManager,omitempty"`
}
...
func (o *InlineResponse200319) GetStates() InlineResponse200319States {
	if o == nil || isNil(o.States) {
		var ret InlineResponse200319States
		return ret
	}
	return *o.States
}
...
// SetStates gets a reference to the given InlineResponse200319States and assigns it to the States field.
...
func (o *InlineResponse200319) GetLicenseTypes() []InlineResponse200319LicenseTypes {
	if o == nil || isNil(o.LicenseTypes) {
		var ret []InlineResponse200319LicenseTypes
		return ret
	}
...
// SetLicenseTypes gets a reference to the given []InlineResponse200319LicenseTypes and assigns it to the LicenseTypes field.
...
func (o *InlineResponse200319) GetSystemsManager() InlineResponse200319SystemsManager {
	if o == nil || isNil(o.SystemsManager) {
		var ret InlineResponse200319SystemsManager
		return ret
	}
...
// SetSystemsManager gets a reference to the given InlineResponse200319SystemsManager and assigns it to the SystemsManager field.
