...
func (r SimsApiGetDeviceCellularSimsRequest) Execute() (*InlineResponse20018, *http.Response, error) {
...
func (a *SimsApiService) GetDeviceCellularSimsExecute(r SimsApiGetDeviceCellularSimsRequest) (*InlineResponse20018, *http.Response, error) {
	var (
...
func (r SimsApiUpdateDeviceCellularSimsRequest) UpdateDeviceCellularSims(updateDeviceCellularSims InlineObject13) SimsApiUpdateDeviceCellularSimsRequest {
	r.updateDeviceCellularSims = &updateDeviceCellularSims
	return r
}

func (r SimsApiUpdateDeviceCellularSimsRequest) Execute() (*InlineResponse20018, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20018
func (a *SimsApiService) UpdateDeviceCellularSimsExecute(r SimsApiUpdateDeviceCellularSimsRequest) (*InlineResponse20018, *http.Response, error) {
	var (
