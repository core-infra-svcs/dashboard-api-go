...
func (r SimsApiGetDeviceCellularSimsRequest) Execute() (*InlineResponse20016, *http.Response, error) {
...
func (a *SimsApiService) GetDeviceCellularSimsExecute(r SimsApiGetDeviceCellularSimsRequest) (*InlineResponse20016, *http.Response, error) {
	var (
...
func (r SimsApiUpdateDeviceCellularSimsRequest) Execute() (*InlineResponse20016, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20016
func (a *SimsApiService) UpdateDeviceCellularSimsExecute(r SimsApiUpdateDeviceCellularSimsRequest) (*InlineResponse20016, *http.Response, error) {
	var (
