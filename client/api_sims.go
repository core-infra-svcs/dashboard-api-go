...
func (r SimsApiGetDeviceCellularSimsRequest) Execute() (*InlineResponse20015, *http.Response, error) {
...
func (a *SimsApiService) GetDeviceCellularSimsExecute(r SimsApiGetDeviceCellularSimsRequest) (*InlineResponse20015, *http.Response, error) {
	var (
...
func (r SimsApiUpdateDeviceCellularSimsRequest) Execute() (*InlineResponse20015, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20015
func (a *SimsApiService) UpdateDeviceCellularSimsExecute(r SimsApiUpdateDeviceCellularSimsRequest) (*InlineResponse20015, *http.Response, error) {
	var (
