...
func (r SimsApiGetDeviceCellularSimsRequest) Execute() (*InlineResponse20023, *http.Response, error) {
...
func (a *SimsApiService) GetDeviceCellularSimsExecute(r SimsApiGetDeviceCellularSimsRequest) (*InlineResponse20023, *http.Response, error) {
	var (
...
func (r SimsApiUpdateDeviceCellularSimsRequest) Execute() (*InlineResponse20023, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20023
func (a *SimsApiService) UpdateDeviceCellularSimsExecute(r SimsApiUpdateDeviceCellularSimsRequest) (*InlineResponse20023, *http.Response, error) {
	var (
