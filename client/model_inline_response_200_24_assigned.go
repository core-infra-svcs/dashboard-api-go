...
// InlineResponse20024Assigned struct for InlineResponse20024Assigned
type InlineResponse20024Assigned struct {
	...
	TwoFourGhzSettings *InlineResponse20024TwoFourGhzSettings `json:"twoFourGhzSettings,omitempty"`
	FiveGhzSettings *InlineResponse20024FiveGhzSettings `json:"fiveGhzSettings,omitempty"`
	PerSsidSettings *InlineResponse20024PerSsidSettings `json:"perSsidSettings,omitempty"`
}
...
func NewInlineResponse20024Assigned() *InlineResponse20024Assigned {
	this := InlineResponse20024Assigned{}
	return &this
}
...
func (o *InlineResponse20024Assigned) GetTwoFourGhzSettings() InlineResponse20024TwoFourGhzSettings {
	if o == nil || isNil(o.TwoFourGhzSettings) {
		var ret InlineResponse20024TwoFourGhzSettings
		return ret
	}
...
// SetTwoFourGhzSettings gets a reference to the given InlineResponse20024TwoFourGhzSettings and assigns it to the TwoFourGhzSettings field.
...
func (o *InlineResponse20024Assigned) GetFiveGhzSettings() InlineResponse20024FiveGhzSettings {
	if o == nil || isNil(o.FiveGhzSettings) {
		var ret InlineResponse20024FiveGhzSettings
		return ret
	}
...
// SetFiveGhzSettings gets a reference to the given InlineResponse20024FiveGhzSettings and assigns it to the FiveGhzSettings field.
...
func (o *InlineResponse20024Assigned) GetPerSsidSettings() InlineResponse20024PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse20024PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse20024PerSsidSettings and assigns it to the PerSsidSettings field.
func (o *InlineResponse20024Assigned) SetPerSsidSettings(v InlineResponse20024PerSsidSettings) {
	o.PerSsidSettings = &v
}

func (o InlineResponse20024Assigned) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20024Assigned struct {
	value *InlineResponse20024Assigned
	isSet bool
}

func (v NullableInlineResponse20024Assigned) Get() *InlineResponse20024Assigned {
	return v.value
}

func (v *NullableInlineResponse20024Assigned) Set(val *InlineResponse20024Assigned) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20024Assigned) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20024Assigned) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20024Assigned(val *InlineResponse20024Assigned) *NullableInlineResponse20024Assigned {
	return &NullableInlineResponse20024Assigned{value: val, isSet: true}
}

func (v NullableInlineResponse20024Assigned) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20024Assigned) UnmarshalJSON(src []byte) error {
	v.isSet = true
