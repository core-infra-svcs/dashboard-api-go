...
// InlineResponse20073ValueSource Source of 'custom' type traffic filter
type InlineResponse20073ValueSource struct {
...
func NewInlineResponse20073ValueSource() *InlineResponse20073ValueSource {
	this := InlineResponse20073ValueSource{}
	return &this
}
...
func (o InlineResponse20073ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20073ValueSource struct {
	value *InlineResponse20073ValueSource
	isSet bool
}

func (v NullableInlineResponse20073ValueSource) Get() *InlineResponse20073ValueSource {
	return v.value
}

func (v *NullableInlineResponse20073ValueSource) Set(val *InlineResponse20073ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20073ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20073ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20073ValueSource(val *InlineResponse20073ValueSource) *NullableInlineResponse20073ValueSource {
	return &NullableInlineResponse20073ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20073ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20073ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
