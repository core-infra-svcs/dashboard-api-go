...
// InlineResponse200227UsageOverall Overall data usage of all clients across organization
type InlineResponse200227UsageOverall struct {
...
func NewInlineResponse200227UsageOverall() *InlineResponse200227UsageOverall {
	this := InlineResponse200227UsageOverall{}
	return &this
}
...
func (o InlineResponse200227UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200227UsageOverall struct {
	value *InlineResponse200227UsageOverall
	isSet bool
}

func (v NullableInlineResponse200227UsageOverall) Get() *InlineResponse200227UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200227UsageOverall) Set(val *InlineResponse200227UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200227UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200227UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200227UsageOverall(val *InlineResponse200227UsageOverall) *NullableInlineResponse200227UsageOverall {
	return &NullableInlineResponse200227UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200227UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200227UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
