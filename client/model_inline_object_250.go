...
func NewInlineObject250(accountId string, apiKey string, serviceProvider OrganizationsOrganizationIdCellularGatewayEsimsServiceProvidersAccountsServiceProvider1, title string, username string) *InlineObject250 {
...
func (o *InlineObject250) GetAccountId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InlineObject250) GetAccountIdOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *InlineObject250) SetAccountId(v string) {
	o.AccountId = v
}
...
func (o *InlineObject250) GetServiceProvider() OrganizationsOrganizationIdCellularGatewayEsimsServiceProvidersAccountsServiceProvider1 {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *InlineObject250) GetServiceProviderOk() (*OrganizationsOrganizationIdCellularGatewayEsimsServiceProvidersAccountsServiceProvider1, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *InlineObject250) SetServiceProvider(v OrganizationsOrganizationIdCellularGatewayEsimsServiceProvidersAccountsServiceProvider1) {
	o.ServiceProvider = v
}
...
func (o *InlineObject250) GetUsername() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InlineObject250) GetUsernameOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *InlineObject250) SetUsername(v string) {
	o.Username = v
}
