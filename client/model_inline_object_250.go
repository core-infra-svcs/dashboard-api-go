...
func (o *InlineObject250) GetStatus() string {
...
func (o *InlineObject250) GetStatusOk() (*string, bool) {
	if o == nil || isNil(o.Status) {
    return nil, false
	}
...
func (o *InlineObject250) HasStatus() bool {
	if o != nil && !isNil(o.Status) {
		return true
	}
...
func (o *InlineObject250) SetStatus(v string) {
	o.Status = &v
}
