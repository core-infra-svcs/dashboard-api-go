...
// InlineResponse20025DynamicDns Dynamic DNS settings for a network
type InlineResponse20025DynamicDns struct {
	// Dynamic DNS enabled
...
func NewInlineResponse20025DynamicDns() *InlineResponse20025DynamicDns {
	this := InlineResponse20025DynamicDns{}
	return &this
}
...
func (o InlineResponse20025DynamicDns) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20025DynamicDns struct {
	value *InlineResponse20025DynamicDns
	isSet bool
}

func (v NullableInlineResponse20025DynamicDns) Get() *InlineResponse20025DynamicDns {
	return v.value
}

func (v *NullableInlineResponse20025DynamicDns) Set(val *InlineResponse20025DynamicDns) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20025DynamicDns) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20025DynamicDns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20025DynamicDns(val *InlineResponse20025DynamicDns) *NullableInlineResponse20025DynamicDns {
	return &NullableInlineResponse20025DynamicDns{value: val, isSet: true}
}

func (v NullableInlineResponse20025DynamicDns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20025DynamicDns) UnmarshalJSON(src []byte) error {
	v.isSet = true
