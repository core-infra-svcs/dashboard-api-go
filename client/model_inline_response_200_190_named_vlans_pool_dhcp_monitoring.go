...
// InlineResponse200190NamedVlansPoolDhcpMonitoring Named VLAN Pool DHCP Monitoring settings.
type InlineResponse200190NamedVlansPoolDhcpMonitoring struct {
...
func NewInlineResponse200190NamedVlansPoolDhcpMonitoring() *InlineResponse200190NamedVlansPoolDhcpMonitoring {
	this := InlineResponse200190NamedVlansPoolDhcpMonitoring{}
	return &this
}
...
func (o InlineResponse200190NamedVlansPoolDhcpMonitoring) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200190NamedVlansPoolDhcpMonitoring struct {
	value *InlineResponse200190NamedVlansPoolDhcpMonitoring
	isSet bool
}

func (v NullableInlineResponse200190NamedVlansPoolDhcpMonitoring) Get() *InlineResponse200190NamedVlansPoolDhcpMonitoring {
	return v.value
}

func (v *NullableInlineResponse200190NamedVlansPoolDhcpMonitoring) Set(val *InlineResponse200190NamedVlansPoolDhcpMonitoring) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200190NamedVlansPoolDhcpMonitoring) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200190NamedVlansPoolDhcpMonitoring) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200190NamedVlansPoolDhcpMonitoring(val *InlineResponse200190NamedVlansPoolDhcpMonitoring) *NullableInlineResponse200190NamedVlansPoolDhcpMonitoring {
	return &NullableInlineResponse200190NamedVlansPoolDhcpMonitoring{value: val, isSet: true}
}

func (v NullableInlineResponse200190NamedVlansPoolDhcpMonitoring) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200190NamedVlansPoolDhcpMonitoring) UnmarshalJSON(src []byte) error {
	v.isSet = true
