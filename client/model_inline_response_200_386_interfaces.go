...
// InlineResponse200386Interfaces struct for InlineResponse200386Interfaces
type InlineResponse200386Interfaces struct {
...
func NewInlineResponse200386Interfaces() *InlineResponse200386Interfaces {
	this := InlineResponse200386Interfaces{}
	return &this
}
...
func (o InlineResponse200386Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200386Interfaces struct {
	value *InlineResponse200386Interfaces
	isSet bool
}

func (v NullableInlineResponse200386Interfaces) Get() *InlineResponse200386Interfaces {
	return v.value
}

func (v *NullableInlineResponse200386Interfaces) Set(val *InlineResponse200386Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200386Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200386Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200386Interfaces(val *InlineResponse200386Interfaces) *NullableInlineResponse200386Interfaces {
	return &NullableInlineResponse200386Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200386Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200386Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
