...
// InlineResponse200314Ssid Wireless access point and network identifier.
type InlineResponse200314Ssid struct {
...
func (o InlineResponse200314Ssid) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200314Ssid struct {
	value *InlineResponse200314Ssid
	isSet bool
}

func (v NullableInlineResponse200314Ssid) Get() *InlineResponse200314Ssid {
	return v.value
}

func (v *NullableInlineResponse200314Ssid) Set(val *InlineResponse200314Ssid) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200314Ssid) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200314Ssid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200314Ssid(val *InlineResponse200314Ssid) *NullableInlineResponse200314Ssid {
	return &NullableInlineResponse200314Ssid{value: val, isSet: true}
}

func (v NullableInlineResponse200314Ssid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200314Ssid) UnmarshalJSON(src []byte) error {
	v.isSet = true
