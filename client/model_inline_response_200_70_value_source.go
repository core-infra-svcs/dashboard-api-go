...
// InlineResponse20070ValueSource Source of 'custom' type traffic filter
type InlineResponse20070ValueSource struct {
...
func NewInlineResponse20070ValueSource() *InlineResponse20070ValueSource {
	this := InlineResponse20070ValueSource{}
	return &this
}
...
func (o InlineResponse20070ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20070ValueSource struct {
	value *InlineResponse20070ValueSource
	isSet bool
}

func (v NullableInlineResponse20070ValueSource) Get() *InlineResponse20070ValueSource {
	return v.value
}

func (v *NullableInlineResponse20070ValueSource) Set(val *InlineResponse20070ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20070ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20070ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20070ValueSource(val *InlineResponse20070ValueSource) *NullableInlineResponse20070ValueSource {
	return &NullableInlineResponse20070ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20070ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20070ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
