...
// InlineResponse20015Applications struct for InlineResponse20015Applications
type InlineResponse20015Applications struct {
...
func NewInlineResponse20015Applications() *InlineResponse20015Applications {
	this := InlineResponse20015Applications{}
	return &this
}
...
func (o InlineResponse20015Applications) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20015Applications struct {
	value *InlineResponse20015Applications
	isSet bool
}

func (v NullableInlineResponse20015Applications) Get() *InlineResponse20015Applications {
	return v.value
}

func (v *NullableInlineResponse20015Applications) Set(val *InlineResponse20015Applications) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20015Applications) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20015Applications) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20015Applications(val *InlineResponse20015Applications) *NullableInlineResponse20015Applications {
	return &NullableInlineResponse20015Applications{value: val, isSet: true}
}

func (v NullableInlineResponse20015Applications) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20015Applications) UnmarshalJSON(src []byte) error {
	v.isSet = true
