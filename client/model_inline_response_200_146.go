...
func (o *InlineResponse200146) GetSuccess() bool {
...
func (o *InlineResponse200146) GetSuccessOk() (*bool, bool) {
	if o == nil || isNil(o.Success) {
    return nil, false
	}
...
func (o *InlineResponse200146) HasSuccess() bool {
	if o != nil && !isNil(o.Success) {
		return true
	}
...
func (o *InlineResponse200146) SetSuccess(v bool) {
	o.Success = &v
}
