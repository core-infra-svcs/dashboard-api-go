...
type InlineResponse200146 struct {
	...
	ResultingLicenses []InlineResponse200145 `json:"resultingLicenses,omitempty"`
}
...
func (o *InlineResponse200146) GetResultingLicenses() []InlineResponse200145 {
	if o == nil || isNil(o.ResultingLicenses) {
		var ret []InlineResponse200145
		return ret
	}
...
func (o *InlineResponse200146) GetResultingLicensesOk() ([]InlineResponse200145, bool) {
	if o == nil || isNil(o.ResultingLicenses) {
    return nil, false
	}
...
func (o *InlineResponse200146) HasResultingLicenses() bool {
	if o != nil && !isNil(o.ResultingLicenses) {
		return true
	}
...
// SetResultingLicenses gets a reference to the given []InlineResponse200145 and assigns it to the ResultingLicenses field.
func (o *InlineResponse200146) SetResultingLicenses(v []InlineResponse200145) {
