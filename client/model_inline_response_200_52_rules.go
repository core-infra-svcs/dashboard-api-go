...
// InlineResponse20052Rules struct for InlineResponse20052Rules
type InlineResponse20052Rules struct {
...
func (o InlineResponse20052Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20052Rules struct {
	value *InlineResponse20052Rules
	isSet bool
}

func (v NullableInlineResponse20052Rules) Get() *InlineResponse20052Rules {
	return v.value
}

func (v *NullableInlineResponse20052Rules) Set(val *InlineResponse20052Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20052Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20052Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20052Rules(val *InlineResponse20052Rules) *NullableInlineResponse20052Rules {
	return &NullableInlineResponse20052Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20052Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20052Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
