...
type InlineResponse20039Products struct {
	Wireless *InlineResponse20039ProductsWireless `json:"wireless,omitempty"`
	Appliance *InlineResponse20039ProductsWireless `json:"appliance,omitempty"`
	Switch *InlineResponse20039ProductsWireless `json:"switch,omitempty"`
	Camera *InlineResponse20039ProductsWireless `json:"camera,omitempty"`
	CellularGateway *InlineResponse20039ProductsWireless `json:"cellularGateway,omitempty"`
	Sensor *InlineResponse20039ProductsWireless `json:"sensor,omitempty"`
}
...
func (o *InlineResponse20039Products) GetWireless() InlineResponse20039ProductsWireless {
	if o == nil || isNil(o.Wireless) {
		var ret InlineResponse20039ProductsWireless
		return ret
	}
	return *o.Wireless
}
...
// SetWireless gets a reference to the given InlineResponse20039ProductsWireless and assigns it to the Wireless field.
...
// SetAppliance gets a reference to the given InlineResponse20039ProductsWireless and assigns it to the Appliance field.
...
// SetSwitch gets a reference to the given InlineResponse20039ProductsWireless and assigns it to the Switch field.
...
// SetCamera gets a reference to the given InlineResponse20039ProductsWireless and assigns it to the Camera field.
...
// SetCellularGateway gets a reference to the given InlineResponse20039ProductsWireless and assigns it to the CellularGateway field.
...
// SetSensor gets a reference to the given InlineResponse20039ProductsWireless and assigns it to the Sensor field.
