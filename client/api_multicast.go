...
func (r MulticastApiGetNetworkSwitchRoutingMulticastRequest) Execute() (*InlineResponse20086, *http.Response, error) {
...
func (a *MulticastApiService) GetNetworkSwitchRoutingMulticastExecute(r MulticastApiGetNetworkSwitchRoutingMulticastRequest) (*InlineResponse20086, *http.Response, error) {
	var (
