...
func (r MulticastApiGetNetworkSwitchRoutingMulticastRequest) Execute() (*InlineResponse20080, *http.Response, error) {
...
func (a *MulticastApiService) GetNetworkSwitchRoutingMulticastExecute(r MulticastApiGetNetworkSwitchRoutingMulticastRequest) (*InlineResponse20080, *http.Response, error) {
	var (
