...
func (r MulticastApiGetNetworkSwitchRoutingMulticastRequest) Execute() (*InlineResponse20079, *http.Response, error) {
...
func (a *MulticastApiService) GetNetworkSwitchRoutingMulticastExecute(r MulticastApiGetNetworkSwitchRoutingMulticastRequest) (*InlineResponse20079, *http.Response, error) {
	var (
