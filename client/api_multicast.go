...
func (r MulticastApiGetNetworkSwitchRoutingMulticastRequest) Execute() (*InlineResponse20087, *http.Response, error) {
...
func (a *MulticastApiService) GetNetworkSwitchRoutingMulticastExecute(r MulticastApiGetNetworkSwitchRoutingMulticastRequest) (*InlineResponse20087, *http.Response, error) {
	var (
