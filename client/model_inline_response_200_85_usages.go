...
// InlineResponse20085Usages The average usage of the clients on a network over a given time range
type InlineResponse20085Usages struct {
...
func NewInlineResponse20085Usages() *InlineResponse20085Usages {
	this := InlineResponse20085Usages{}
	return &this
}
...
func (o InlineResponse20085Usages) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20085Usages struct {
	value *InlineResponse20085Usages
	isSet bool
}

func (v NullableInlineResponse20085Usages) Get() *InlineResponse20085Usages {
	return v.value
}

func (v *NullableInlineResponse20085Usages) Set(val *InlineResponse20085Usages) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20085Usages) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20085Usages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20085Usages(val *InlineResponse20085Usages) *NullableInlineResponse20085Usages {
	return &NullableInlineResponse20085Usages{value: val, isSet: true}
}

func (v NullableInlineResponse20085Usages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20085Usages) UnmarshalJSON(src []byte) error {
	v.isSet = true
