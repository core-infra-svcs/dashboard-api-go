...
// InlineResponse200340Cdp struct for InlineResponse200340Cdp
type InlineResponse200340Cdp struct {
...
func (o InlineResponse200340Cdp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200340Cdp struct {
	value *InlineResponse200340Cdp
	isSet bool
}

func (v NullableInlineResponse200340Cdp) Get() *InlineResponse200340Cdp {
	return v.value
}

func (v *NullableInlineResponse200340Cdp) Set(val *InlineResponse200340Cdp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200340Cdp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200340Cdp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200340Cdp(val *InlineResponse200340Cdp) *NullableInlineResponse200340Cdp {
	return &NullableInlineResponse200340Cdp{value: val, isSet: true}
}

func (v NullableInlineResponse200340Cdp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200340Cdp) UnmarshalJSON(src []byte) error {
	v.isSet = true
