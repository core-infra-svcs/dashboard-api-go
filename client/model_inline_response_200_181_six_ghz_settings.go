...
// InlineResponse200181SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200181SixGhzSettings struct {
...
func NewInlineResponse200181SixGhzSettings() *InlineResponse200181SixGhzSettings {
	this := InlineResponse200181SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200181SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200181SixGhzSettings struct {
	value *InlineResponse200181SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200181SixGhzSettings) Get() *InlineResponse200181SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200181SixGhzSettings) Set(val *InlineResponse200181SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200181SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200181SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200181SixGhzSettings(val *InlineResponse200181SixGhzSettings) *NullableInlineResponse200181SixGhzSettings {
	return &NullableInlineResponse200181SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200181SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200181SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
