...
// InlineResponse200337CountsByStatusInactive The count data for inactive ports
type InlineResponse200337CountsByStatusInactive struct {
	// The total number of inactive ports
	Total *int32 `json:"total,omitempty"`
	ByMedia *InlineResponse200337CountsByStatusInactiveByMedia `json:"byMedia,omitempty"`
}
...
func NewInlineResponse200337CountsByStatusInactive() *InlineResponse200337CountsByStatusInactive {
	this := InlineResponse200337CountsByStatusInactive{}
	return &this
}
...
func (o *InlineResponse200337CountsByStatusInactive) GetByMedia() InlineResponse200337CountsByStatusInactiveByMedia {
	if o == nil || isNil(o.ByMedia) {
		var ret InlineResponse200337CountsByStatusInactiveByMedia
		return ret
	}
	return *o.ByMedia
}
...
// SetByMedia gets a reference to the given InlineResponse200337CountsByStatusInactiveByMedia and assigns it to the ByMedia field.
func (o *InlineResponse200337CountsByStatusInactive) SetByMedia(v InlineResponse200337CountsByStatusInactiveByMedia) {
	o.ByMedia = &v
}

func (o InlineResponse200337CountsByStatusInactive) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200337CountsByStatusInactive struct {
	value *InlineResponse200337CountsByStatusInactive
	isSet bool
}

func (v NullableInlineResponse200337CountsByStatusInactive) Get() *InlineResponse200337CountsByStatusInactive {
	return v.value
}

func (v *NullableInlineResponse200337CountsByStatusInactive) Set(val *InlineResponse200337CountsByStatusInactive) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200337CountsByStatusInactive) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200337CountsByStatusInactive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200337CountsByStatusInactive(val *InlineResponse200337CountsByStatusInactive) *NullableInlineResponse200337CountsByStatusInactive {
	return &NullableInlineResponse200337CountsByStatusInactive{value: val, isSet: true}
}

func (v NullableInlineResponse200337CountsByStatusInactive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200337CountsByStatusInactive) UnmarshalJSON(src []byte) error {
	v.isSet = true
