...
func (r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) Execute() (*InlineResponse200155, *http.Response, error) {
...
func (a *PortSchedulesApiService) CreateNetworkSwitchPortScheduleExecute(r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) (*InlineResponse200155, *http.Response, error) {
	var (
...
func (r PortSchedulesApiGetNetworkSwitchPortSchedulesRequest) Execute() ([]InlineResponse200155, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200155
func (a *PortSchedulesApiService) GetNetworkSwitchPortSchedulesExecute(r PortSchedulesApiGetNetworkSwitchPortSchedulesRequest) ([]InlineResponse200155, *http.Response, error) {
	var (
...
func (r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) Execute() (*InlineResponse200155, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200155
func (a *PortSchedulesApiService) UpdateNetworkSwitchPortScheduleExecute(r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) (*InlineResponse200155, *http.Response, error) {
	var (
