...
func (r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) CreateNetworkSwitchPortSchedule(createNetworkSwitchPortSchedule InlineObject130) PortSchedulesApiCreateNetworkSwitchPortScheduleRequest {
	r.createNetworkSwitchPortSchedule = &createNetworkSwitchPortSchedule
	return r
}

func (r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) Execute() (*InlineResponse20087, *http.Response, error) {
...
func (a *PortSchedulesApiService) CreateNetworkSwitchPortScheduleExecute(r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) (*InlineResponse20087, *http.Response, error) {
	var (
...
func (r PortSchedulesApiGetNetworkSwitchPortSchedulesRequest) Execute() ([]InlineResponse20087, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20087
func (a *PortSchedulesApiService) GetNetworkSwitchPortSchedulesExecute(r PortSchedulesApiGetNetworkSwitchPortSchedulesRequest) ([]InlineResponse20087, *http.Response, error) {
	var (
...
func (r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) UpdateNetworkSwitchPortSchedule(updateNetworkSwitchPortSchedule InlineObject131) PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest {
	r.updateNetworkSwitchPortSchedule = &updateNetworkSwitchPortSchedule
	return r
}

func (r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) Execute() (*InlineResponse20087, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20087
func (a *PortSchedulesApiService) UpdateNetworkSwitchPortScheduleExecute(r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) (*InlineResponse20087, *http.Response, error) {
	var (
