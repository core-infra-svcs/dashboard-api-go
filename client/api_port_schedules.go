...
func (r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) Execute() (*InlineResponse20082, *http.Response, error) {
...
func (a *PortSchedulesApiService) CreateNetworkSwitchPortScheduleExecute(r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) (*InlineResponse20082, *http.Response, error) {
	var (
...
func (r PortSchedulesApiGetNetworkSwitchPortSchedulesRequest) Execute() ([]InlineResponse20082, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20082
func (a *PortSchedulesApiService) GetNetworkSwitchPortSchedulesExecute(r PortSchedulesApiGetNetworkSwitchPortSchedulesRequest) ([]InlineResponse20082, *http.Response, error) {
	var (
...
func (r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) Execute() (*InlineResponse20082, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20082
func (a *PortSchedulesApiService) UpdateNetworkSwitchPortScheduleExecute(r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) (*InlineResponse20082, *http.Response, error) {
	var (
