...
func (r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) CreateNetworkSwitchPortSchedule(createNetworkSwitchPortSchedule InlineObject144) PortSchedulesApiCreateNetworkSwitchPortScheduleRequest {
	r.createNetworkSwitchPortSchedule = &createNetworkSwitchPortSchedule
	return r
}

func (r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) Execute() (*InlineResponse200158, *http.Response, error) {
...
func (a *PortSchedulesApiService) CreateNetworkSwitchPortScheduleExecute(r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) (*InlineResponse200158, *http.Response, error) {
	var (
...
func (r PortSchedulesApiGetNetworkSwitchPortSchedulesRequest) Execute() ([]InlineResponse200158, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200158
func (a *PortSchedulesApiService) GetNetworkSwitchPortSchedulesExecute(r PortSchedulesApiGetNetworkSwitchPortSchedulesRequest) ([]InlineResponse200158, *http.Response, error) {
	var (
...
func (r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) UpdateNetworkSwitchPortSchedule(updateNetworkSwitchPortSchedule InlineObject145) PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest {
	r.updateNetworkSwitchPortSchedule = &updateNetworkSwitchPortSchedule
	return r
}

func (r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) Execute() (*InlineResponse200158, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200158
func (a *PortSchedulesApiService) UpdateNetworkSwitchPortScheduleExecute(r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) (*InlineResponse200158, *http.Response, error) {
	var (
