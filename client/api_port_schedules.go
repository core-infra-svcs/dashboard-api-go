...
func (r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) CreateNetworkSwitchPortSchedule(createNetworkSwitchPortSchedule InlineObject148) PortSchedulesApiCreateNetworkSwitchPortScheduleRequest {
	r.createNetworkSwitchPortSchedule = &createNetworkSwitchPortSchedule
	return r
}

func (r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) Execute() (*InlineResponse200160, *http.Response, error) {
...
func (a *PortSchedulesApiService) CreateNetworkSwitchPortScheduleExecute(r PortSchedulesApiCreateNetworkSwitchPortScheduleRequest) (*InlineResponse200160, *http.Response, error) {
	var (
...
func (r PortSchedulesApiGetNetworkSwitchPortSchedulesRequest) Execute() ([]InlineResponse200160, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200160
func (a *PortSchedulesApiService) GetNetworkSwitchPortSchedulesExecute(r PortSchedulesApiGetNetworkSwitchPortSchedulesRequest) ([]InlineResponse200160, *http.Response, error) {
	var (
...
func (r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) UpdateNetworkSwitchPortSchedule(updateNetworkSwitchPortSchedule InlineObject149) PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest {
	r.updateNetworkSwitchPortSchedule = &updateNetworkSwitchPortSchedule
	return r
}

func (r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) Execute() (*InlineResponse200160, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200160
func (a *PortSchedulesApiService) UpdateNetworkSwitchPortScheduleExecute(r PortSchedulesApiUpdateNetworkSwitchPortScheduleRequest) (*InlineResponse200160, *http.Response, error) {
	var (
