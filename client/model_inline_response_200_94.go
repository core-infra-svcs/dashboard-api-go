...
type InlineResponse20094 struct {
	...
	Devices []InlineResponse20086 `json:"devices,omitempty"`
...
// SetDevices gets a reference to the given []InlineResponse20086 and assigns it to the Devices field.
