...
type InlineResponse20094 struct {
	...
	Subnets []InlineResponse20094Subnets `json:"subnets,omitempty"`
}
...
func (o *InlineResponse20094) GetSubnets() []InlineResponse20094Subnets {
	if o == nil || isNil(o.Subnets) {
		var ret []InlineResponse20094Subnets
		return ret
	}
	return o.Subnets
}
...
// SetSubnets gets a reference to the given []InlineResponse20094Subnets and assigns it to the Subnets field.
