...
type InlineResponse20094 struct {
	UpgradeWindow *InlineResponse20094UpgradeWindow `json:"upgradeWindow,omitempty"`
	// The timezone for the network
	Timezone *string `json:"timezone,omitempty"`
	Products *InlineResponse20094Products `json:"products,omitempty"`
}
...
func (o *InlineResponse20094) GetUpgradeWindow() InlineResponse20094UpgradeWindow {
	if o == nil || isNil(o.UpgradeWindow) {
		var ret InlineResponse20094UpgradeWindow
		return ret
	}
...
// SetUpgradeWindow gets a reference to the given InlineResponse20094UpgradeWindow and assigns it to the UpgradeWindow field.
...
func (o *InlineResponse20094) GetProducts() InlineResponse20094Products {
	if o == nil || isNil(o.Products) {
		var ret InlineResponse20094Products
		return ret
	}
	return *o.Products
}
...
// SetProducts gets a reference to the given InlineResponse20094Products and assigns it to the Products field.
