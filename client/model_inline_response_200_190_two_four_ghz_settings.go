...
// InlineResponse200190TwoFourGhzSettings Settings related to 2.4Ghz band
type InlineResponse200190TwoFourGhzSettings struct {
...
func NewInlineResponse200190TwoFourGhzSettings() *InlineResponse200190TwoFourGhzSettings {
	this := InlineResponse200190TwoFourGhzSettings{}
	return &this
}
...
func (o InlineResponse200190TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200190TwoFourGhzSettings struct {
	value *InlineResponse200190TwoFourGhzSettings
	isSet bool
}

func (v NullableInlineResponse200190TwoFourGhzSettings) Get() *InlineResponse200190TwoFourGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200190TwoFourGhzSettings) Set(val *InlineResponse200190TwoFourGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200190TwoFourGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200190TwoFourGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200190TwoFourGhzSettings(val *InlineResponse200190TwoFourGhzSettings) *NullableInlineResponse200190TwoFourGhzSettings {
	return &NullableInlineResponse200190TwoFourGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200190TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200190TwoFourGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
