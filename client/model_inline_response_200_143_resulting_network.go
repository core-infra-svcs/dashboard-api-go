...
// InlineResponse200143ResultingNetwork Network after the combination
type InlineResponse200143ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200143ResultingNetwork() *InlineResponse200143ResultingNetwork {
	this := InlineResponse200143ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200143ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200143ResultingNetwork struct {
	value *InlineResponse200143ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200143ResultingNetwork) Get() *InlineResponse200143ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200143ResultingNetwork) Set(val *InlineResponse200143ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200143ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200143ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200143ResultingNetwork(val *InlineResponse200143ResultingNetwork) *NullableInlineResponse200143ResultingNetwork {
	return &NullableInlineResponse200143ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200143ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200143ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
