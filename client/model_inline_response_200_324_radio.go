...
// InlineResponse200324Radio Wireless access point radio identifier.
type InlineResponse200324Radio struct {
...
func NewInlineResponse200324Radio() *InlineResponse200324Radio {
	this := InlineResponse200324Radio{}
	return &this
}
...
func (o InlineResponse200324Radio) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200324Radio struct {
	value *InlineResponse200324Radio
	isSet bool
}

func (v NullableInlineResponse200324Radio) Get() *InlineResponse200324Radio {
	return v.value
}

func (v *NullableInlineResponse200324Radio) Set(val *InlineResponse200324Radio) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200324Radio) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200324Radio) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200324Radio(val *InlineResponse200324Radio) *NullableInlineResponse200324Radio {
	return &NullableInlineResponse200324Radio{value: val, isSet: true}
}

func (v NullableInlineResponse200324Radio) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200324Radio) UnmarshalJSON(src []byte) error {
	v.isSet = true
