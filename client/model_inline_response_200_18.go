...
type InlineResponse20018 struct {
	...
	FailoverAndFailback *InlineResponse20018FailoverAndFailback `json:"failoverAndFailback,omitempty"`
	// Uplink preference rules for WAN traffic
	WanTrafficUplinkPreferences []InlineResponse20018WanTrafficUplinkPreferences `json:"wanTrafficUplinkPreferences,omitempty"`
	// Uplink preference rules for VPN traffic
	VpnTrafficUplinkPreferences []InlineResponse20018VpnTrafficUplinkPreferences `json:"vpnTrafficUplinkPreferences,omitempty"`
}
...
func (o *InlineResponse20018) GetFailoverAndFailback() InlineResponse20018FailoverAndFailback {
	if o == nil || isNil(o.FailoverAndFailback) {
		var ret InlineResponse20018FailoverAndFailback
		return ret
	}
...
// SetFailoverAndFailback gets a reference to the given InlineResponse20018FailoverAndFailback and assigns it to the FailoverAndFailback field.
...
func (o *InlineResponse20018) GetWanTrafficUplinkPreferences() []InlineResponse20018WanTrafficUplinkPreferences {
	if o == nil || isNil(o.WanTrafficUplinkPreferences) {
		var ret []InlineResponse20018WanTrafficUplinkPreferences
		return ret
	}
...
// SetWanTrafficUplinkPreferences gets a reference to the given []InlineResponse20018WanTrafficUplinkPreferences and assigns it to the WanTrafficUplinkPreferences field.
...
func (o *InlineResponse20018) GetVpnTrafficUplinkPreferences() []InlineResponse20018VpnTrafficUplinkPreferences {
	if o == nil || isNil(o.VpnTrafficUplinkPreferences) {
		var ret []InlineResponse20018VpnTrafficUplinkPreferences
		return ret
	}
...
// SetVpnTrafficUplinkPreferences gets a reference to the given []InlineResponse20018VpnTrafficUplinkPreferences and assigns it to the VpnTrafficUplinkPreferences field.
