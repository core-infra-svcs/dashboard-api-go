...
type InlineResponse20018 struct {
	...
	ClientVpnConnections []InlineResponse20018ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20018) GetClientVpnConnections() []InlineResponse20018ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20018ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20018ClientVpnConnections and assigns it to the ClientVpnConnections field.
