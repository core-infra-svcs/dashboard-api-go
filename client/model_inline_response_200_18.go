...
type InlineResponse20018 struct {
	...
	ApplicationCategories []InlineResponse20018ApplicationCategories `json:"applicationCategories,omitempty"`
}
...
func (o *InlineResponse20018) GetApplicationCategories() []InlineResponse20018ApplicationCategories {
	if o == nil || isNil(o.ApplicationCategories) {
		var ret []InlineResponse20018ApplicationCategories
		return ret
	}
...
// SetApplicationCategories gets a reference to the given []InlineResponse20018ApplicationCategories and assigns it to the ApplicationCategories field.
