...
func NewInlineObject20(ports []string) *InlineObject20 {
	this := InlineObject20{}
	this.Ports = ports
	return &this
}
...
func (o *InlineObject20) GetPorts() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *InlineObject20) GetPortsOk() ([]string, bool) {
	if o == nil {
    return nil, false
	}
	return o.Ports, true
...
func (o *InlineObject20) SetPorts(v []string) {
	o.Ports = v
}
