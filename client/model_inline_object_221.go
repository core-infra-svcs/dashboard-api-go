...
func (o *InlineObject221) GetEnabledNetworks() []string {
...
func (o *InlineObject221) GetEnabledNetworksOk() ([]string, bool) {
	if o == nil || isNil(o.EnabledNetworks) {
    return nil, false
	}
...
func (o *InlineObject221) HasEnabledNetworks() bool {
	if o != nil && !isNil(o.EnabledNetworks) {
		return true
	}
...
func (o *InlineObject221) SetEnabledNetworks(v []string) {
	o.EnabledNetworks = v
}
