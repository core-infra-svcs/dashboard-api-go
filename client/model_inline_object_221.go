...
func (o *InlineObject221) GetAdminSettings() OrganizationsOrganizationIdBrandingPoliciesAdminSettings {
...
// and a boolean to check if the value has been set.
func (o *InlineObject221) GetAdminSettingsOk() (*OrganizationsOrganizationIdBrandingPoliciesAdminSettings, bool) {
	if o == nil || isNil(o.AdminSettings) {
    return nil, false
	}
...
func (o *InlineObject221) HasAdminSettings() bool {
	if o != nil && !isNil(o.AdminSettings) {
		return true
	}
...
func (o *InlineObject221) SetAdminSettings(v OrganizationsOrganizationIdBrandingPoliciesAdminSettings) {
	o.AdminSettings = &v
}

// GetHelpSettings returns the HelpSettings field value if set, zero value otherwise.
func (o *InlineObject221) GetHelpSettings() OrganizationsOrganizationIdBrandingPoliciesHelpSettings1 {
...
// and a boolean to check if the value has been set.
func (o *InlineObject221) GetHelpSettingsOk() (*OrganizationsOrganizationIdBrandingPoliciesHelpSettings1, bool) {
	if o == nil || isNil(o.HelpSettings) {
    return nil, false
	}
...
func (o *InlineObject221) HasHelpSettings() bool {
	if o != nil && !isNil(o.HelpSettings) {
		return true
	}
...
func (o *InlineObject221) SetHelpSettings(v OrganizationsOrganizationIdBrandingPoliciesHelpSettings1) {
	o.HelpSettings = &v
}

// GetCustomLogo returns the CustomLogo field value if set, zero value otherwise.
func (o *InlineObject221) GetCustomLogo() OrganizationsOrganizationIdBrandingPoliciesCustomLogo1 {
...
// and a boolean to check if the value has been set.
func (o *InlineObject221) GetCustomLogoOk() (*OrganizationsOrganizationIdBrandingPoliciesCustomLogo1, bool) {
	if o == nil || isNil(o.CustomLogo) {
    return nil, false
	}
...
func (o *InlineObject221) HasCustomLogo() bool {
	if o != nil && !isNil(o.CustomLogo) {
		return true
	}
...
func (o *InlineObject221) SetCustomLogo(v OrganizationsOrganizationIdBrandingPoliciesCustomLogo1) {
	o.CustomLogo = &v
}
