...
// InlineResponse20095FiveGhzSettings Settings related to 5Ghz band
type InlineResponse20095FiveGhzSettings struct {
...
func NewInlineResponse20095FiveGhzSettings() *InlineResponse20095FiveGhzSettings {
	this := InlineResponse20095FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse20095FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20095FiveGhzSettings struct {
	value *InlineResponse20095FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse20095FiveGhzSettings) Get() *InlineResponse20095FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse20095FiveGhzSettings) Set(val *InlineResponse20095FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20095FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20095FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20095FiveGhzSettings(val *InlineResponse20095FiveGhzSettings) *NullableInlineResponse20095FiveGhzSettings {
	return &NullableInlineResponse20095FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20095FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20095FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
