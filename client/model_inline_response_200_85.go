...
type InlineResponse20085 struct {
	...
	// Organization-specific number of the Autonomous System to which the appliance belongs
	...
	Neighbors []InlineResponse20085Neighbors `json:"neighbors,omitempty"`
}
...
func (o *InlineResponse20085) GetNeighbors() []InlineResponse20085Neighbors {
	if o == nil || isNil(o.Neighbors) {
		var ret []InlineResponse20085Neighbors
		return ret
	}
	return o.Neighbors
}
...
// SetNeighbors gets a reference to the given []InlineResponse20085Neighbors and assigns it to the Neighbors field.
