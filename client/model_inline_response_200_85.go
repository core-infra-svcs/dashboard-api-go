...
type InlineResponse20085 struct {
	...
	SplashLogo *InlineResponse20085SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse20085SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse20085SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse20085GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse20085Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse20085SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse20085SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse20085) GetSplashLogo() InlineResponse20085SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse20085SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse20085SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse20085) GetSplashImage() InlineResponse20085SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse20085SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse20085SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse20085) GetSplashPrepaidFront() InlineResponse20085SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse20085SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse20085SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse20085) GetGuestSponsorship() InlineResponse20085GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse20085GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse20085GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse20085) GetBilling() InlineResponse20085Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse20085Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse20085Billing and assigns it to the Billing field.
...
func (o *InlineResponse20085) GetSentryEnrollment() InlineResponse20085SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse20085SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse20085SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse20085) GetSelfRegistration() InlineResponse20085SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse20085SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse20085SelfRegistration and assigns it to the SelfRegistration field.
