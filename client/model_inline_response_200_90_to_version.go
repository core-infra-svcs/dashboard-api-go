...
// InlineResponse20090ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20090ToVersion struct {
...
func NewInlineResponse20090ToVersion() *InlineResponse20090ToVersion {
	this := InlineResponse20090ToVersion{}
	return &this
}
...
func (o InlineResponse20090ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20090ToVersion struct {
	value *InlineResponse20090ToVersion
	isSet bool
}

func (v NullableInlineResponse20090ToVersion) Get() *InlineResponse20090ToVersion {
	return v.value
}

func (v *NullableInlineResponse20090ToVersion) Set(val *InlineResponse20090ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20090ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20090ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20090ToVersion(val *InlineResponse20090ToVersion) *NullableInlineResponse20090ToVersion {
	return &NullableInlineResponse20090ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20090ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20090ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
