...
type InlineResponse20023 struct {
	...
	ClientVpnConnections []InlineResponse20023ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20023) GetClientVpnConnections() []InlineResponse20023ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20023ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20023ClientVpnConnections and assigns it to the ClientVpnConnections field.
