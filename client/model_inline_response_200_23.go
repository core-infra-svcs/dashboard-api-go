...
type InlineResponse20023 struct {
	...
	Sims []InlineResponse20023Sims `json:"sims,omitempty"`
	...
	SimFailover *InlineResponse20023SimFailover `json:"simFailover,omitempty"`
}
...
func (o *InlineResponse20023) GetSims() []InlineResponse20023Sims {
	if o == nil || isNil(o.Sims) {
		var ret []InlineResponse20023Sims
		return ret
	}
	return o.Sims
}
...
// SetSims gets a reference to the given []InlineResponse20023Sims and assigns it to the Sims field.
...
func (o *InlineResponse20023) GetSimFailover() InlineResponse20023SimFailover {
	if o == nil || isNil(o.SimFailover) {
		var ret InlineResponse20023SimFailover
		return ret
	}
...
// SetSimFailover gets a reference to the given InlineResponse20023SimFailover and assigns it to the SimFailover field.
