...
type InlineResponse20023 struct {
	...
	FailoverAndFailback *InlineResponse20023FailoverAndFailback `json:"failoverAndFailback,omitempty"`
	// Uplink preference rules for WAN traffic
	WanTrafficUplinkPreferences []InlineResponse20023WanTrafficUplinkPreferences `json:"wanTrafficUplinkPreferences,omitempty"`
	// Uplink preference rules for VPN traffic
	VpnTrafficUplinkPreferences []InlineResponse20023VpnTrafficUplinkPreferences `json:"vpnTrafficUplinkPreferences,omitempty"`
}
...
func (o *InlineResponse20023) GetFailoverAndFailback() InlineResponse20023FailoverAndFailback {
	if o == nil || isNil(o.FailoverAndFailback) {
		var ret InlineResponse20023FailoverAndFailback
		return ret
	}
...
// SetFailoverAndFailback gets a reference to the given InlineResponse20023FailoverAndFailback and assigns it to the FailoverAndFailback field.
...
func (o *InlineResponse20023) GetWanTrafficUplinkPreferences() []InlineResponse20023WanTrafficUplinkPreferences {
	if o == nil || isNil(o.WanTrafficUplinkPreferences) {
		var ret []InlineResponse20023WanTrafficUplinkPreferences
		return ret
	}
...
// SetWanTrafficUplinkPreferences gets a reference to the given []InlineResponse20023WanTrafficUplinkPreferences and assigns it to the WanTrafficUplinkPreferences field.
...
func (o *InlineResponse20023) GetVpnTrafficUplinkPreferences() []InlineResponse20023VpnTrafficUplinkPreferences {
	if o == nil || isNil(o.VpnTrafficUplinkPreferences) {
		var ret []InlineResponse20023VpnTrafficUplinkPreferences
		return ret
	}
...
// SetVpnTrafficUplinkPreferences gets a reference to the given []InlineResponse20023VpnTrafficUplinkPreferences and assigns it to the VpnTrafficUplinkPreferences field.
