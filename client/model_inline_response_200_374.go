...
type InlineResponse200374 struct {
	...
	// Door locks
	DoorLocks []InlineResponse200374DoorLocks `json:"doorLocks,omitempty"`
}
...
func (o *InlineResponse200374) GetDoorLocks() []InlineResponse200374DoorLocks {
	if o == nil || isNil(o.DoorLocks) {
		var ret []InlineResponse200374DoorLocks
		return ret
	}
	return o.DoorLocks
}
...
// SetDoorLocks gets a reference to the given []InlineResponse200374DoorLocks and assigns it to the DoorLocks field.
