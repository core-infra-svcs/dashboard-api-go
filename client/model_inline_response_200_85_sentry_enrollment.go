...
// InlineResponse20085SentryEnrollment Systems Manager sentry enrollment splash settings.
type InlineResponse20085SentryEnrollment struct {
	SystemsManagerNetwork *InlineResponse20085SentryEnrollmentSystemsManagerNetwork `json:"systemsManagerNetwork,omitempty"`
...
func NewInlineResponse20085SentryEnrollment() *InlineResponse20085SentryEnrollment {
	this := InlineResponse20085SentryEnrollment{}
	return &this
}
...
func (o *InlineResponse20085SentryEnrollment) GetSystemsManagerNetwork() InlineResponse20085SentryEnrollmentSystemsManagerNetwork {
	if o == nil || isNil(o.SystemsManagerNetwork) {
		var ret InlineResponse20085SentryEnrollmentSystemsManagerNetwork
		return ret
	}
...
// SetSystemsManagerNetwork gets a reference to the given InlineResponse20085SentryEnrollmentSystemsManagerNetwork and assigns it to the SystemsManagerNetwork field.
...
func (o InlineResponse20085SentryEnrollment) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20085SentryEnrollment struct {
	value *InlineResponse20085SentryEnrollment
	isSet bool
}

func (v NullableInlineResponse20085SentryEnrollment) Get() *InlineResponse20085SentryEnrollment {
	return v.value
}

func (v *NullableInlineResponse20085SentryEnrollment) Set(val *InlineResponse20085SentryEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20085SentryEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20085SentryEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20085SentryEnrollment(val *InlineResponse20085SentryEnrollment) *NullableInlineResponse20085SentryEnrollment {
	return &NullableInlineResponse20085SentryEnrollment{value: val, isSet: true}
}

func (v NullableInlineResponse20085SentryEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20085SentryEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
