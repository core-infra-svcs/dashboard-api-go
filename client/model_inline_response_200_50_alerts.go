...
// InlineResponse20050Alerts struct for InlineResponse20050Alerts
type InlineResponse20050Alerts struct {
	// The type of alert
	Type string `json:"type"`
	// A boolean depicting if the alert is turned on or off
	Enabled *bool `json:"enabled,omitempty"`
	AlertDestinations *InlineResponse20050AlertDestinations `json:"alertDestinations,omitempty"`
	Filters *InlineResponse20050Filters `json:"filters,omitempty"`
}
...
func NewInlineResponse20050Alerts(type_ string) *InlineResponse20050Alerts {
	this := InlineResponse20050Alerts{}
	this.Type = type_
	return &this
}
...
func (o *InlineResponse20050Alerts) GetAlertDestinations() InlineResponse20050AlertDestinations {
	if o == nil || isNil(o.AlertDestinations) {
		var ret InlineResponse20050AlertDestinations
		return ret
	}
...
// SetAlertDestinations gets a reference to the given InlineResponse20050AlertDestinations and assigns it to the AlertDestinations field.
...
func (o *InlineResponse20050Alerts) GetFilters() InlineResponse20050Filters {
	if o == nil || isNil(o.Filters) {
		var ret InlineResponse20050Filters
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given InlineResponse20050Filters and assigns it to the Filters field.
func (o *InlineResponse20050Alerts) SetFilters(v InlineResponse20050Filters) {
	o.Filters = &v
}

func (o InlineResponse20050Alerts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20050Alerts struct {
	value *InlineResponse20050Alerts
	isSet bool
}

func (v NullableInlineResponse20050Alerts) Get() *InlineResponse20050Alerts {
	return v.value
}

func (v *NullableInlineResponse20050Alerts) Set(val *InlineResponse20050Alerts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20050Alerts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20050Alerts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20050Alerts(val *InlineResponse20050Alerts) *NullableInlineResponse20050Alerts {
	return &NullableInlineResponse20050Alerts{value: val, isSet: true}
}

func (v NullableInlineResponse20050Alerts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20050Alerts) UnmarshalJSON(src []byte) error {
	v.isSet = true
