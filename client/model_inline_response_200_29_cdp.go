...
// InlineResponse20029Cdp cdp information
type InlineResponse20029Cdp struct {
	// ID for the device
...
func (o InlineResponse20029Cdp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20029Cdp struct {
	value *InlineResponse20029Cdp
	isSet bool
}

func (v NullableInlineResponse20029Cdp) Get() *InlineResponse20029Cdp {
	return v.value
}

func (v *NullableInlineResponse20029Cdp) Set(val *InlineResponse20029Cdp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20029Cdp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20029Cdp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20029Cdp(val *InlineResponse20029Cdp) *NullableInlineResponse20029Cdp {
	return &NullableInlineResponse20029Cdp{value: val, isSet: true}
}

func (v NullableInlineResponse20029Cdp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20029Cdp) UnmarshalJSON(src []byte) error {
	v.isSet = true
