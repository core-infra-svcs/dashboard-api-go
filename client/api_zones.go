...
func (r ZonesApiGetDeviceCameraAnalyticsZoneHistoryRequest) Execute() ([]InlineResponse20015, *http.Response, error) {
...
// Deprecated
func (a *ZonesApiService) GetDeviceCameraAnalyticsZoneHistoryExecute(r ZonesApiGetDeviceCameraAnalyticsZoneHistoryRequest) ([]InlineResponse20015, *http.Response, error) {
	var (
...
func (r ZonesApiGetDeviceCameraAnalyticsZonesRequest) Execute() ([]InlineResponse20014, *http.Response, error) {
...
// Deprecated
func (a *ZonesApiService) GetDeviceCameraAnalyticsZonesExecute(r ZonesApiGetDeviceCameraAnalyticsZonesRequest) ([]InlineResponse20014, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
