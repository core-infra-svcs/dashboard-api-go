...
func (r ZonesApiApiGetDeviceCameraAnalyticsZoneHistoryRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *ZonesApiService) GetDeviceCameraAnalyticsZoneHistory(ctx context.Context, serial string, zoneId string) ZonesApiApiGetDeviceCameraAnalyticsZoneHistoryRequest {
	return ZonesApiApiGetDeviceCameraAnalyticsZoneHistoryRequest{
		ApiService: a,
		ctx: ctx,
		serial: serial,
...
func (a *ZonesApiService) GetDeviceCameraAnalyticsZoneHistoryExecute(r ZonesApiApiGetDeviceCameraAnalyticsZoneHistoryRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
...
func (r ZonesApiApiGetDeviceCameraAnalyticsZonesRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *ZonesApiService) GetDeviceCameraAnalyticsZones(ctx context.Context, serial string) ZonesApiApiGetDeviceCameraAnalyticsZonesRequest {
	return ZonesApiApiGetDeviceCameraAnalyticsZonesRequest{
		ApiService: a,
		ctx: ctx,
		serial: serial,
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *ZonesApiService) GetDeviceCameraAnalyticsZonesExecute(r ZonesApiApiGetDeviceCameraAnalyticsZonesRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
