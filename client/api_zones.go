...
func (r ZonesApiGetDeviceCameraAnalyticsZoneHistoryRequest) Execute() ([]InlineResponse20013, *http.Response, error) {
...
// Deprecated
func (a *ZonesApiService) GetDeviceCameraAnalyticsZoneHistoryExecute(r ZonesApiGetDeviceCameraAnalyticsZoneHistoryRequest) ([]InlineResponse20013, *http.Response, error) {
	var (
...
func (r ZonesApiGetDeviceCameraAnalyticsZonesRequest) Execute() ([]InlineResponse20012, *http.Response, error) {
...
// Deprecated
func (a *ZonesApiService) GetDeviceCameraAnalyticsZonesExecute(r ZonesApiGetDeviceCameraAnalyticsZonesRequest) ([]InlineResponse20012, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
