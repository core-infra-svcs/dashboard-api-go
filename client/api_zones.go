...
func (r ZonesApiGetDeviceCameraAnalyticsZoneHistoryRequest) Execute() ([]InlineResponse20012, *http.Response, error) {
...
// Deprecated
func (a *ZonesApiService) GetDeviceCameraAnalyticsZoneHistoryExecute(r ZonesApiGetDeviceCameraAnalyticsZoneHistoryRequest) ([]InlineResponse20012, *http.Response, error) {
	var (
...
func (r ZonesApiGetDeviceCameraAnalyticsZonesRequest) Execute() ([]InlineResponse20011, *http.Response, error) {
...
// Deprecated
func (a *ZonesApiService) GetDeviceCameraAnalyticsZonesExecute(r ZonesApiGetDeviceCameraAnalyticsZonesRequest) ([]InlineResponse20011, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
