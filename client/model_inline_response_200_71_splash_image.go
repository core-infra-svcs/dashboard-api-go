...
// InlineResponse20071SplashImage The image used in the splash page.
type InlineResponse20071SplashImage struct {
...
func NewInlineResponse20071SplashImage() *InlineResponse20071SplashImage {
	this := InlineResponse20071SplashImage{}
	return &this
}
...
func (o InlineResponse20071SplashImage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20071SplashImage struct {
	value *InlineResponse20071SplashImage
	isSet bool
}

func (v NullableInlineResponse20071SplashImage) Get() *InlineResponse20071SplashImage {
	return v.value
}

func (v *NullableInlineResponse20071SplashImage) Set(val *InlineResponse20071SplashImage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20071SplashImage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20071SplashImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20071SplashImage(val *InlineResponse20071SplashImage) *NullableInlineResponse20071SplashImage {
	return &NullableInlineResponse20071SplashImage{value: val, isSet: true}
}

func (v NullableInlineResponse20071SplashImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20071SplashImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
