...
// InlineResponse20013ConnectionStats The connection stats of the device
type InlineResponse20013ConnectionStats struct {
...
func NewInlineResponse20013ConnectionStats() *InlineResponse20013ConnectionStats {
	this := InlineResponse20013ConnectionStats{}
	return &this
}
...
func (o InlineResponse20013ConnectionStats) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20013ConnectionStats struct {
	value *InlineResponse20013ConnectionStats
	isSet bool
}

func (v NullableInlineResponse20013ConnectionStats) Get() *InlineResponse20013ConnectionStats {
	return v.value
}

func (v *NullableInlineResponse20013ConnectionStats) Set(val *InlineResponse20013ConnectionStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20013ConnectionStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20013ConnectionStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20013ConnectionStats(val *InlineResponse20013ConnectionStats) *NullableInlineResponse20013ConnectionStats {
	return &NullableInlineResponse20013ConnectionStats{value: val, isSet: true}
}

func (v NullableInlineResponse20013ConnectionStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20013ConnectionStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
