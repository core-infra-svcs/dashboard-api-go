...
// InlineResponse20052ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20052ToVersion struct {
...
func NewInlineResponse20052ToVersion() *InlineResponse20052ToVersion {
	this := InlineResponse20052ToVersion{}
	return &this
}
...
func (o InlineResponse20052ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20052ToVersion struct {
	value *InlineResponse20052ToVersion
	isSet bool
}

func (v NullableInlineResponse20052ToVersion) Get() *InlineResponse20052ToVersion {
	return v.value
}

func (v *NullableInlineResponse20052ToVersion) Set(val *InlineResponse20052ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20052ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20052ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20052ToVersion(val *InlineResponse20052ToVersion) *NullableInlineResponse20052ToVersion {
	return &NullableInlineResponse20052ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20052ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20052ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
