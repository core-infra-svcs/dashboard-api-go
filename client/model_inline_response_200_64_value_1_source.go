...
// InlineResponse20064Value1Source Source of 'custom' type traffic filter
type InlineResponse20064Value1Source struct {
...
func NewInlineResponse20064Value1Source() *InlineResponse20064Value1Source {
	this := InlineResponse20064Value1Source{}
	return &this
}
...
func (o InlineResponse20064Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20064Value1Source struct {
	value *InlineResponse20064Value1Source
	isSet bool
}

func (v NullableInlineResponse20064Value1Source) Get() *InlineResponse20064Value1Source {
	return v.value
}

func (v *NullableInlineResponse20064Value1Source) Set(val *InlineResponse20064Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20064Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20064Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20064Value1Source(val *InlineResponse20064Value1Source) *NullableInlineResponse20064Value1Source {
	return &NullableInlineResponse20064Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20064Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20064Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
