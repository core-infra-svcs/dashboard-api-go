...
// InlineResponse20070Value1Destination Destination of 'custom' type traffic filter
type InlineResponse20070Value1Destination struct {
...
func NewInlineResponse20070Value1Destination() *InlineResponse20070Value1Destination {
	this := InlineResponse20070Value1Destination{}
	return &this
}
...
func (o InlineResponse20070Value1Destination) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20070Value1Destination struct {
	value *InlineResponse20070Value1Destination
	isSet bool
}

func (v NullableInlineResponse20070Value1Destination) Get() *InlineResponse20070Value1Destination {
	return v.value
}

func (v *NullableInlineResponse20070Value1Destination) Set(val *InlineResponse20070Value1Destination) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20070Value1Destination) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20070Value1Destination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20070Value1Destination(val *InlineResponse20070Value1Destination) *NullableInlineResponse20070Value1Destination {
	return &NullableInlineResponse20070Value1Destination{value: val, isSet: true}
}

func (v NullableInlineResponse20070Value1Destination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20070Value1Destination) UnmarshalJSON(src []byte) error {
	v.isSet = true
