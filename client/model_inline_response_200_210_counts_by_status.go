...
// InlineResponse200210CountsByStatus byStatus
type InlineResponse200210CountsByStatus struct {
...
func NewInlineResponse200210CountsByStatus() *InlineResponse200210CountsByStatus {
	this := InlineResponse200210CountsByStatus{}
	return &this
}
...
func (o InlineResponse200210CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200210CountsByStatus struct {
	value *InlineResponse200210CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200210CountsByStatus) Get() *InlineResponse200210CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200210CountsByStatus) Set(val *InlineResponse200210CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200210CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200210CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200210CountsByStatus(val *InlineResponse200210CountsByStatus) *NullableInlineResponse200210CountsByStatus {
	return &NullableInlineResponse200210CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200210CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200210CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
