...
// InlineResponse20069Counts The current amount of various adaptive policy objects.
type InlineResponse20069Counts struct {
...
func NewInlineResponse20069Counts() *InlineResponse20069Counts {
	this := InlineResponse20069Counts{}
	return &this
}
...
func (o InlineResponse20069Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20069Counts struct {
	value *InlineResponse20069Counts
	isSet bool
}

func (v NullableInlineResponse20069Counts) Get() *InlineResponse20069Counts {
	return v.value
}

func (v *NullableInlineResponse20069Counts) Set(val *InlineResponse20069Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20069Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20069Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20069Counts(val *InlineResponse20069Counts) *NullableInlineResponse20069Counts {
	return &NullableInlineResponse20069Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20069Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20069Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
