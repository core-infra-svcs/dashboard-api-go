...
// InlineResponse20049Rules struct for InlineResponse20049Rules
type InlineResponse20049Rules struct {
...
func (o InlineResponse20049Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20049Rules struct {
	value *InlineResponse20049Rules
	isSet bool
}

func (v NullableInlineResponse20049Rules) Get() *InlineResponse20049Rules {
	return v.value
}

func (v *NullableInlineResponse20049Rules) Set(val *InlineResponse20049Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20049Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20049Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20049Rules(val *InlineResponse20049Rules) *NullableInlineResponse20049Rules {
	return &NullableInlineResponse20049Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20049Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20049Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
