...
// InlineResponse200220UsageOverall Overall data usage of all clients across organization
type InlineResponse200220UsageOverall struct {
...
func NewInlineResponse200220UsageOverall() *InlineResponse200220UsageOverall {
	this := InlineResponse200220UsageOverall{}
	return &this
}
...
func (o InlineResponse200220UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200220UsageOverall struct {
	value *InlineResponse200220UsageOverall
	isSet bool
}

func (v NullableInlineResponse200220UsageOverall) Get() *InlineResponse200220UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200220UsageOverall) Set(val *InlineResponse200220UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200220UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200220UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200220UsageOverall(val *InlineResponse200220UsageOverall) *NullableInlineResponse200220UsageOverall {
	return &NullableInlineResponse200220UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200220UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200220UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
