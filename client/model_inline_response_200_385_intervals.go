...
// InlineResponse200385Intervals struct for InlineResponse200385Intervals
type InlineResponse200385Intervals struct {
	...
	Overall *InlineResponse200385Overall `json:"overall,omitempty"`
	// The usage data on the interfaces of the wireless LAN controller
	ByInterface []InlineResponse200385ByInterface `json:"byInterface,omitempty"`
}
...
func NewInlineResponse200385Intervals() *InlineResponse200385Intervals {
	this := InlineResponse200385Intervals{}
	return &this
}
...
func (o *InlineResponse200385Intervals) GetOverall() InlineResponse200385Overall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200385Overall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200385Overall and assigns it to the Overall field.
...
func (o *InlineResponse200385Intervals) GetByInterface() []InlineResponse200385ByInterface {
	if o == nil || isNil(o.ByInterface) {
		var ret []InlineResponse200385ByInterface
		return ret
	}
...
// SetByInterface gets a reference to the given []InlineResponse200385ByInterface and assigns it to the ByInterface field.
func (o *InlineResponse200385Intervals) SetByInterface(v []InlineResponse200385ByInterface) {
	o.ByInterface = v
}

func (o InlineResponse200385Intervals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200385Intervals struct {
	value *InlineResponse200385Intervals
	isSet bool
}

func (v NullableInlineResponse200385Intervals) Get() *InlineResponse200385Intervals {
	return v.value
}

func (v *NullableInlineResponse200385Intervals) Set(val *InlineResponse200385Intervals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200385Intervals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200385Intervals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200385Intervals(val *InlineResponse200385Intervals) *NullableInlineResponse200385Intervals {
	return &NullableInlineResponse200385Intervals{value: val, isSet: true}
}

func (v NullableInlineResponse200385Intervals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200385Intervals) UnmarshalJSON(src []byte) error {
	v.isSet = true
