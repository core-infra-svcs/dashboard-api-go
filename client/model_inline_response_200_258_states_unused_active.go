...
// InlineResponse200258StatesUnusedActive Data for unused, active licenses
type InlineResponse200258StatesUnusedActive struct {
	// The number of unused, active licenses
	Count *int32 `json:"count,omitempty"`
	OldestActivation *InlineResponse200258StatesUnusedActiveOldestActivation `json:"oldestActivation,omitempty"`
}
...
func NewInlineResponse200258StatesUnusedActive() *InlineResponse200258StatesUnusedActive {
	this := InlineResponse200258StatesUnusedActive{}
	return &this
}
...
func (o *InlineResponse200258StatesUnusedActive) GetOldestActivation() InlineResponse200258StatesUnusedActiveOldestActivation {
	if o == nil || isNil(o.OldestActivation) {
		var ret InlineResponse200258StatesUnusedActiveOldestActivation
		return ret
	}
...
// SetOldestActivation gets a reference to the given InlineResponse200258StatesUnusedActiveOldestActivation and assigns it to the OldestActivation field.
...
func (o InlineResponse200258StatesUnusedActive) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200258StatesUnusedActive struct {
	value *InlineResponse200258StatesUnusedActive
	isSet bool
}

func (v NullableInlineResponse200258StatesUnusedActive) Get() *InlineResponse200258StatesUnusedActive {
	return v.value
}

func (v *NullableInlineResponse200258StatesUnusedActive) Set(val *InlineResponse200258StatesUnusedActive) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200258StatesUnusedActive) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200258StatesUnusedActive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200258StatesUnusedActive(val *InlineResponse200258StatesUnusedActive) *NullableInlineResponse200258StatesUnusedActive {
	return &NullableInlineResponse200258StatesUnusedActive{value: val, isSet: true}
}

func (v NullableInlineResponse200258StatesUnusedActive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200258StatesUnusedActive) UnmarshalJSON(src []byte) error {
	v.isSet = true
