...
// InlineResponse200178Example Example alert type
type InlineResponse200178Example struct {
...
func NewInlineResponse200178Example() *InlineResponse200178Example {
	this := InlineResponse200178Example{}
	return &this
}
...
func (o InlineResponse200178Example) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200178Example struct {
	value *InlineResponse200178Example
	isSet bool
}

func (v NullableInlineResponse200178Example) Get() *InlineResponse200178Example {
	return v.value
}

func (v *NullableInlineResponse200178Example) Set(val *InlineResponse200178Example) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200178Example) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200178Example) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200178Example(val *InlineResponse200178Example) *NullableInlineResponse200178Example {
	return &NullableInlineResponse200178Example{value: val, isSet: true}
}

func (v NullableInlineResponse200178Example) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200178Example) UnmarshalJSON(src []byte) error {
	v.isSet = true
