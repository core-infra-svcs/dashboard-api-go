...
type InlineResponse20027 struct {
	...
	Ports *map[string]InlineResponse20027Ports `json:"ports,omitempty"`
}
...
func (o *InlineResponse20027) GetPorts() map[string]InlineResponse20027Ports {
	if o == nil || isNil(o.Ports) {
		var ret map[string]InlineResponse20027Ports
		return ret
	}
	return *o.Ports
}
...
// SetPorts gets a reference to the given map[string]InlineResponse20027Ports and assigns it to the Ports field.
