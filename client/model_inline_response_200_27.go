...
type InlineResponse20027 struct {
	...
	FailoverAndFailback *InlineResponse20027FailoverAndFailback `json:"failoverAndFailback,omitempty"`
	// Uplink preference rules for WAN traffic
	WanTrafficUplinkPreferences []InlineResponse20027WanTrafficUplinkPreferences `json:"wanTrafficUplinkPreferences,omitempty"`
	// Uplink preference rules for VPN traffic
	VpnTrafficUplinkPreferences []InlineResponse20027VpnTrafficUplinkPreferences `json:"vpnTrafficUplinkPreferences,omitempty"`
}
...
func (o *InlineResponse20027) GetFailoverAndFailback() InlineResponse20027FailoverAndFailback {
	if o == nil || isNil(o.FailoverAndFailback) {
		var ret InlineResponse20027FailoverAndFailback
		return ret
	}
...
// SetFailoverAndFailback gets a reference to the given InlineResponse20027FailoverAndFailback and assigns it to the FailoverAndFailback field.
...
func (o *InlineResponse20027) GetWanTrafficUplinkPreferences() []InlineResponse20027WanTrafficUplinkPreferences {
	if o == nil || isNil(o.WanTrafficUplinkPreferences) {
		var ret []InlineResponse20027WanTrafficUplinkPreferences
		return ret
	}
...
// SetWanTrafficUplinkPreferences gets a reference to the given []InlineResponse20027WanTrafficUplinkPreferences and assigns it to the WanTrafficUplinkPreferences field.
...
func (o *InlineResponse20027) GetVpnTrafficUplinkPreferences() []InlineResponse20027VpnTrafficUplinkPreferences {
	if o == nil || isNil(o.VpnTrafficUplinkPreferences) {
		var ret []InlineResponse20027VpnTrafficUplinkPreferences
		return ret
	}
...
// SetVpnTrafficUplinkPreferences gets a reference to the given []InlineResponse20027VpnTrafficUplinkPreferences and assigns it to the VpnTrafficUplinkPreferences field.
