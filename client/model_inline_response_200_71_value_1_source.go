...
// InlineResponse20071Value1Source Source of 'custom' type traffic filter
type InlineResponse20071Value1Source struct {
...
func NewInlineResponse20071Value1Source() *InlineResponse20071Value1Source {
	this := InlineResponse20071Value1Source{}
	return &this
}
...
func (o InlineResponse20071Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20071Value1Source struct {
	value *InlineResponse20071Value1Source
	isSet bool
}

func (v NullableInlineResponse20071Value1Source) Get() *InlineResponse20071Value1Source {
	return v.value
}

func (v *NullableInlineResponse20071Value1Source) Set(val *InlineResponse20071Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20071Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20071Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20071Value1Source(val *InlineResponse20071Value1Source) *NullableInlineResponse20071Value1Source {
	return &NullableInlineResponse20071Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20071Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20071Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
