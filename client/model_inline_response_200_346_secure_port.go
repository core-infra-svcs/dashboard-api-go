...
// InlineResponse200346SecurePort The Secure Port status of the port.
type InlineResponse200346SecurePort struct {
...
func NewInlineResponse200346SecurePort() *InlineResponse200346SecurePort {
	this := InlineResponse200346SecurePort{}
	return &this
}
...
func (o InlineResponse200346SecurePort) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200346SecurePort struct {
	value *InlineResponse200346SecurePort
	isSet bool
}

func (v NullableInlineResponse200346SecurePort) Get() *InlineResponse200346SecurePort {
	return v.value
}

func (v *NullableInlineResponse200346SecurePort) Set(val *InlineResponse200346SecurePort) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200346SecurePort) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200346SecurePort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200346SecurePort(val *InlineResponse200346SecurePort) *NullableInlineResponse200346SecurePort {
	return &NullableInlineResponse200346SecurePort{value: val, isSet: true}
}

func (v NullableInlineResponse200346SecurePort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200346SecurePort) UnmarshalJSON(src []byte) error {
	v.isSet = true
