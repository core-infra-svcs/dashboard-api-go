...
// InlineResponse20092DhcpOptions struct for InlineResponse20092DhcpOptions
type InlineResponse20092DhcpOptions struct {
...
func NewInlineResponse20092DhcpOptions() *InlineResponse20092DhcpOptions {
	this := InlineResponse20092DhcpOptions{}
	return &this
}
...
func (o InlineResponse20092DhcpOptions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20092DhcpOptions struct {
	value *InlineResponse20092DhcpOptions
	isSet bool
}

func (v NullableInlineResponse20092DhcpOptions) Get() *InlineResponse20092DhcpOptions {
	return v.value
}

func (v *NullableInlineResponse20092DhcpOptions) Set(val *InlineResponse20092DhcpOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20092DhcpOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20092DhcpOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20092DhcpOptions(val *InlineResponse20092DhcpOptions) *NullableInlineResponse20092DhcpOptions {
	return &NullableInlineResponse20092DhcpOptions{value: val, isSet: true}
}

func (v NullableInlineResponse20092DhcpOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20092DhcpOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
