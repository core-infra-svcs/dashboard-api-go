...
// InlineResponse2004ResultsLatencies Packet latency stats
type InlineResponse2004ResultsLatencies struct {
	// Minimum latency
...
func NewInlineResponse2004ResultsLatencies() *InlineResponse2004ResultsLatencies {
	this := InlineResponse2004ResultsLatencies{}
	return &this
}
...
func (o InlineResponse2004ResultsLatencies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2004ResultsLatencies struct {
	value *InlineResponse2004ResultsLatencies
	isSet bool
}

func (v NullableInlineResponse2004ResultsLatencies) Get() *InlineResponse2004ResultsLatencies {
	return v.value
}

func (v *NullableInlineResponse2004ResultsLatencies) Set(val *InlineResponse2004ResultsLatencies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2004ResultsLatencies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2004ResultsLatencies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2004ResultsLatencies(val *InlineResponse2004ResultsLatencies) *NullableInlineResponse2004ResultsLatencies {
	return &NullableInlineResponse2004ResultsLatencies{value: val, isSet: true}
}

func (v NullableInlineResponse2004ResultsLatencies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2004ResultsLatencies) UnmarshalJSON(src []byte) error {
	v.isSet = true
