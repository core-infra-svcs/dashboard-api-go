...
// InlineResponse20027Value1Source Source of 'custom' type traffic filter
type InlineResponse20027Value1Source struct {
...
func NewInlineResponse20027Value1Source() *InlineResponse20027Value1Source {
	this := InlineResponse20027Value1Source{}
	return &this
}
...
func (o InlineResponse20027Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20027Value1Source struct {
	value *InlineResponse20027Value1Source
	isSet bool
}

func (v NullableInlineResponse20027Value1Source) Get() *InlineResponse20027Value1Source {
	return v.value
}

func (v *NullableInlineResponse20027Value1Source) Set(val *InlineResponse20027Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20027Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20027Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20027Value1Source(val *InlineResponse20027Value1Source) *NullableInlineResponse20027Value1Source {
	return &NullableInlineResponse20027Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20027Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20027Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
