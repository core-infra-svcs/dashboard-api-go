...
// InlineResponse200164CountsByStatus byStatus
type InlineResponse200164CountsByStatus struct {
	// online count
...
func NewInlineResponse200164CountsByStatus() *InlineResponse200164CountsByStatus {
	this := InlineResponse200164CountsByStatus{}
	return &this
}
...
func (o InlineResponse200164CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200164CountsByStatus struct {
	value *InlineResponse200164CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200164CountsByStatus) Get() *InlineResponse200164CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200164CountsByStatus) Set(val *InlineResponse200164CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200164CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200164CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200164CountsByStatus(val *InlineResponse200164CountsByStatus) *NullableInlineResponse200164CountsByStatus {
	return &NullableInlineResponse200164CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200164CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200164CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
