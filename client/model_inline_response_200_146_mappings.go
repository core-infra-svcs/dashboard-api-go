...
// InlineResponse200146Mappings struct for InlineResponse200146Mappings
type InlineResponse200146Mappings struct {
...
func NewInlineResponse200146Mappings() *InlineResponse200146Mappings {
	this := InlineResponse200146Mappings{}
	return &this
}
...
func (o InlineResponse200146Mappings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200146Mappings struct {
	value *InlineResponse200146Mappings
	isSet bool
}

func (v NullableInlineResponse200146Mappings) Get() *InlineResponse200146Mappings {
	return v.value
}

func (v *NullableInlineResponse200146Mappings) Set(val *InlineResponse200146Mappings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200146Mappings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200146Mappings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200146Mappings(val *InlineResponse200146Mappings) *NullableInlineResponse200146Mappings {
	return &NullableInlineResponse200146Mappings{value: val, isSet: true}
}

func (v NullableInlineResponse200146Mappings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200146Mappings) UnmarshalJSON(src []byte) error {
	v.isSet = true
