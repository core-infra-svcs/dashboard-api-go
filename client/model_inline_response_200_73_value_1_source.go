...
// InlineResponse20073Value1Source Source of 'custom' type traffic filter
type InlineResponse20073Value1Source struct {
...
func NewInlineResponse20073Value1Source() *InlineResponse20073Value1Source {
	this := InlineResponse20073Value1Source{}
	return &this
}
...
func (o InlineResponse20073Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20073Value1Source struct {
	value *InlineResponse20073Value1Source
	isSet bool
}

func (v NullableInlineResponse20073Value1Source) Get() *InlineResponse20073Value1Source {
	return v.value
}

func (v *NullableInlineResponse20073Value1Source) Set(val *InlineResponse20073Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20073Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20073Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20073Value1Source(val *InlineResponse20073Value1Source) *NullableInlineResponse20073Value1Source {
	return &NullableInlineResponse20073Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20073Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20073Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
