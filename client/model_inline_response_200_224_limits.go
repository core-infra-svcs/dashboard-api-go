...
// InlineResponse200224Limits The current limits of various adaptive policy objects.
type InlineResponse200224Limits struct {
...
func NewInlineResponse200224Limits() *InlineResponse200224Limits {
	this := InlineResponse200224Limits{}
	return &this
}
...
func (o InlineResponse200224Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200224Limits struct {
	value *InlineResponse200224Limits
	isSet bool
}

func (v NullableInlineResponse200224Limits) Get() *InlineResponse200224Limits {
	return v.value
}

func (v *NullableInlineResponse200224Limits) Set(val *InlineResponse200224Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200224Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200224Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200224Limits(val *InlineResponse200224Limits) *NullableInlineResponse200224Limits {
	return &NullableInlineResponse200224Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200224Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200224Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
