...
// InlineResponse200154Usage Usage information of all clients across organization
type InlineResponse200154Usage struct {
	Overall *InlineResponse200154UsageOverall `json:"overall,omitempty"`
...
func NewInlineResponse200154Usage() *InlineResponse200154Usage {
	this := InlineResponse200154Usage{}
	return &this
}
...
func (o *InlineResponse200154Usage) GetOverall() InlineResponse200154UsageOverall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200154UsageOverall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200154UsageOverall and assigns it to the Overall field.
...
func (o InlineResponse200154Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200154Usage struct {
	value *InlineResponse200154Usage
	isSet bool
}

func (v NullableInlineResponse200154Usage) Get() *InlineResponse200154Usage {
	return v.value
}

func (v *NullableInlineResponse200154Usage) Set(val *InlineResponse200154Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200154Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200154Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200154Usage(val *InlineResponse200154Usage) *NullableInlineResponse200154Usage {
	return &NullableInlineResponse200154Usage{value: val, isSet: true}
}

func (v NullableInlineResponse200154Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200154Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
