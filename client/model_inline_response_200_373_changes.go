...
// InlineResponse200373Changes struct for InlineResponse200373Changes
type InlineResponse200373Changes struct {
...
func NewInlineResponse200373Changes() *InlineResponse200373Changes {
	this := InlineResponse200373Changes{}
	return &this
}
...
func (o InlineResponse200373Changes) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200373Changes struct {
	value *InlineResponse200373Changes
	isSet bool
}

func (v NullableInlineResponse200373Changes) Get() *InlineResponse200373Changes {
	return v.value
}

func (v *NullableInlineResponse200373Changes) Set(val *InlineResponse200373Changes) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200373Changes) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200373Changes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200373Changes(val *InlineResponse200373Changes) *NullableInlineResponse200373Changes {
	return &NullableInlineResponse200373Changes{value: val, isSet: true}
}

func (v NullableInlineResponse200373Changes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200373Changes) UnmarshalJSON(src []byte) error {
	v.isSet = true
