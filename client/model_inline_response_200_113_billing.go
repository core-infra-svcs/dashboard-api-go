...
// InlineResponse200113Billing Details associated with billing splash
type InlineResponse200113Billing struct {
	FreeAccess *InlineResponse200113BillingFreeAccess `json:"freeAccess,omitempty"`
...
func NewInlineResponse200113Billing() *InlineResponse200113Billing {
	this := InlineResponse200113Billing{}
	return &this
}
...
func (o *InlineResponse200113Billing) GetFreeAccess() InlineResponse200113BillingFreeAccess {
	if o == nil || isNil(o.FreeAccess) {
		var ret InlineResponse200113BillingFreeAccess
		return ret
	}
	return *o.FreeAccess
}
...
// SetFreeAccess gets a reference to the given InlineResponse200113BillingFreeAccess and assigns it to the FreeAccess field.
...
func (o InlineResponse200113Billing) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200113Billing struct {
	value *InlineResponse200113Billing
	isSet bool
}

func (v NullableInlineResponse200113Billing) Get() *InlineResponse200113Billing {
	return v.value
}

func (v *NullableInlineResponse200113Billing) Set(val *InlineResponse200113Billing) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200113Billing) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200113Billing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200113Billing(val *InlineResponse200113Billing) *NullableInlineResponse200113Billing {
	return &NullableInlineResponse200113Billing{value: val, isSet: true}
}

func (v NullableInlineResponse200113Billing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200113Billing) UnmarshalJSON(src []byte) error {
	v.isSet = true
