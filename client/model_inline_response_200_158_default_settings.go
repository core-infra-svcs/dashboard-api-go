...
// InlineResponse200158DefaultSettings Default multicast setting for entire network. IGMP snooping and Flood unknown       multicast traffic settings are enabled by default.
type InlineResponse200158DefaultSettings struct {
...
func NewInlineResponse200158DefaultSettings() *InlineResponse200158DefaultSettings {
	this := InlineResponse200158DefaultSettings{}
	return &this
}
...
func (o InlineResponse200158DefaultSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200158DefaultSettings struct {
	value *InlineResponse200158DefaultSettings
	isSet bool
}

func (v NullableInlineResponse200158DefaultSettings) Get() *InlineResponse200158DefaultSettings {
	return v.value
}

func (v *NullableInlineResponse200158DefaultSettings) Set(val *InlineResponse200158DefaultSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200158DefaultSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200158DefaultSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200158DefaultSettings(val *InlineResponse200158DefaultSettings) *NullableInlineResponse200158DefaultSettings {
	return &NullableInlineResponse200158DefaultSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200158DefaultSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200158DefaultSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
