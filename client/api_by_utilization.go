...
func (r ByUtilizationApiGetOrganizationSummaryTopAppliancesByUtilizationRequest) Execute() ([]InlineResponse200356, *http.Response, error) {
...
func (a *ByUtilizationApiService) GetOrganizationSummaryTopAppliancesByUtilizationExecute(r ByUtilizationApiGetOrganizationSummaryTopAppliancesByUtilizationRequest) ([]InlineResponse200356, *http.Response, error) {
	var (
