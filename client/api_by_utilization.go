...
func (r ByUtilizationApiGetOrganizationSummaryTopAppliancesByUtilizationRequest) Execute() ([]InlineResponse200332, *http.Response, error) {
...
func (a *ByUtilizationApiService) GetOrganizationSummaryTopAppliancesByUtilizationExecute(r ByUtilizationApiGetOrganizationSummaryTopAppliancesByUtilizationRequest) ([]InlineResponse200332, *http.Response, error) {
	var (
