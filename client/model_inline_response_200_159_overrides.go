...
// InlineResponse200159Overrides struct for InlineResponse200159Overrides
type InlineResponse200159Overrides struct {
...
func NewInlineResponse200159Overrides(mtuSize int32) *InlineResponse200159Overrides {
	this := InlineResponse200159Overrides{}
...
func (o InlineResponse200159Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200159Overrides struct {
	value *InlineResponse200159Overrides
	isSet bool
}

func (v NullableInlineResponse200159Overrides) Get() *InlineResponse200159Overrides {
	return v.value
}

func (v *NullableInlineResponse200159Overrides) Set(val *InlineResponse200159Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200159Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200159Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200159Overrides(val *InlineResponse200159Overrides) *NullableInlineResponse200159Overrides {
	return &NullableInlineResponse200159Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse200159Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200159Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
