...
func (r UsersApiGetNetworkSmUserDeviceProfilesRequest) Execute() ([]InlineResponse20043, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUserDeviceProfilesExecute(r UsersApiGetNetworkSmUserDeviceProfilesRequest) ([]InlineResponse20043, *http.Response, error) {
	var (
...
func (r UsersApiGetNetworkSmUserSoftwaresRequest) Execute() ([]InlineResponse20047, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUserSoftwaresExecute(r UsersApiGetNetworkSmUserSoftwaresRequest) ([]InlineResponse20047, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UsersApiGetNetworkSmUsersRequest) Execute() ([]InlineResponse20052, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUsersExecute(r UsersApiGetNetworkSmUsersRequest) ([]InlineResponse20052, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
