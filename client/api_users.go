...
func (r UsersApiGetNetworkSmUserDeviceProfilesRequest) Execute() ([]InlineResponse20079, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUserDeviceProfilesExecute(r UsersApiGetNetworkSmUserDeviceProfilesRequest) ([]InlineResponse20079, *http.Response, error) {
	var (
...
func (r UsersApiGetNetworkSmUserSoftwaresRequest) Execute() ([]InlineResponse20083, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUserSoftwaresExecute(r UsersApiGetNetworkSmUserSoftwaresRequest) ([]InlineResponse20083, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UsersApiGetNetworkSmUsersRequest) Execute() ([]InlineResponse20089, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUsersExecute(r UsersApiGetNetworkSmUsersRequest) ([]InlineResponse20089, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
