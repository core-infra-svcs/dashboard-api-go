...
func (r UsersApiGetNetworkSmUserDeviceProfilesRequest) Execute() ([]InlineResponse20063, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUserDeviceProfilesExecute(r UsersApiGetNetworkSmUserDeviceProfilesRequest) ([]InlineResponse20063, *http.Response, error) {
	var (
...
func (r UsersApiGetNetworkSmUserSoftwaresRequest) Execute() ([]InlineResponse20067, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUserSoftwaresExecute(r UsersApiGetNetworkSmUserSoftwaresRequest) ([]InlineResponse20067, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UsersApiGetNetworkSmUsersRequest) Execute() ([]InlineResponse20073, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUsersExecute(r UsersApiGetNetworkSmUsersRequest) ([]InlineResponse20073, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
