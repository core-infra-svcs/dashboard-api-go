...
func (r UsersApiGetNetworkSmUserDeviceProfilesRequest) Execute() ([]InlineResponse200123, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUserDeviceProfilesExecute(r UsersApiGetNetworkSmUserDeviceProfilesRequest) ([]InlineResponse200123, *http.Response, error) {
	var (
...
func (r UsersApiGetNetworkSmUserSoftwaresRequest) Execute() ([]InlineResponse200128, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUserSoftwaresExecute(r UsersApiGetNetworkSmUserSoftwaresRequest) ([]InlineResponse200128, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UsersApiGetNetworkSmUsersRequest) Execute() ([]InlineResponse200135, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUsersExecute(r UsersApiGetNetworkSmUsersRequest) ([]InlineResponse200135, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
