...
func (r UsersApiGetNetworkSmUserDeviceProfilesRequest) Execute() ([]InlineResponse20045, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUserDeviceProfilesExecute(r UsersApiGetNetworkSmUserDeviceProfilesRequest) ([]InlineResponse20045, *http.Response, error) {
	var (
...
func (r UsersApiGetNetworkSmUserSoftwaresRequest) Execute() ([]InlineResponse20049, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUserSoftwaresExecute(r UsersApiGetNetworkSmUserSoftwaresRequest) ([]InlineResponse20049, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UsersApiGetNetworkSmUsersRequest) Execute() ([]InlineResponse20054, *http.Response, error) {
...
func (a *UsersApiService) GetNetworkSmUsersExecute(r UsersApiGetNetworkSmUsersRequest) ([]InlineResponse20054, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
