...
type InlineObject151 struct {
	...
	Md5AuthenticationKey *InlineResponse200159Md5AuthenticationKey `json:"md5AuthenticationKey,omitempty"`
}
...
func (o *InlineObject151) GetMd5AuthenticationKey() InlineResponse200159Md5AuthenticationKey {
	if o == nil || isNil(o.Md5AuthenticationKey) {
		var ret InlineResponse200159Md5AuthenticationKey
		return ret
	}
...
// SetMd5AuthenticationKey gets a reference to the given InlineResponse200159Md5AuthenticationKey and assigns it to the Md5AuthenticationKey field.
