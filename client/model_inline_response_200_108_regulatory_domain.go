...
// InlineResponse200108RegulatoryDomain Regulatory domain information for this network.
type InlineResponse200108RegulatoryDomain struct {
...
func NewInlineResponse200108RegulatoryDomain() *InlineResponse200108RegulatoryDomain {
	this := InlineResponse200108RegulatoryDomain{}
	return &this
}
...
func (o InlineResponse200108RegulatoryDomain) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200108RegulatoryDomain struct {
	value *InlineResponse200108RegulatoryDomain
	isSet bool
}

func (v NullableInlineResponse200108RegulatoryDomain) Get() *InlineResponse200108RegulatoryDomain {
	return v.value
}

func (v *NullableInlineResponse200108RegulatoryDomain) Set(val *InlineResponse200108RegulatoryDomain) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200108RegulatoryDomain) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200108RegulatoryDomain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200108RegulatoryDomain(val *InlineResponse200108RegulatoryDomain) *NullableInlineResponse200108RegulatoryDomain {
	return &NullableInlineResponse200108RegulatoryDomain{value: val, isSet: true}
}

func (v NullableInlineResponse200108RegulatoryDomain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200108RegulatoryDomain) UnmarshalJSON(src []byte) error {
	v.isSet = true
