...
// InlineResponse20098ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20098ToVersion struct {
...
func NewInlineResponse20098ToVersion() *InlineResponse20098ToVersion {
	this := InlineResponse20098ToVersion{}
	return &this
}
...
func (o InlineResponse20098ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20098ToVersion struct {
	value *InlineResponse20098ToVersion
	isSet bool
}

func (v NullableInlineResponse20098ToVersion) Get() *InlineResponse20098ToVersion {
	return v.value
}

func (v *NullableInlineResponse20098ToVersion) Set(val *InlineResponse20098ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20098ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20098ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20098ToVersion(val *InlineResponse20098ToVersion) *NullableInlineResponse20098ToVersion {
	return &NullableInlineResponse20098ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20098ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20098ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
