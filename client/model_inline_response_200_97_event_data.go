...
// InlineResponse20097EventData An object containing more data related to the event.
type InlineResponse20097EventData struct {
...
func NewInlineResponse20097EventData() *InlineResponse20097EventData {
	this := InlineResponse20097EventData{}
	return &this
}
...
func (o InlineResponse20097EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20097EventData struct {
	value *InlineResponse20097EventData
	isSet bool
}

func (v NullableInlineResponse20097EventData) Get() *InlineResponse20097EventData {
	return v.value
}

func (v *NullableInlineResponse20097EventData) Set(val *InlineResponse20097EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20097EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20097EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20097EventData(val *InlineResponse20097EventData) *NullableInlineResponse20097EventData {
	return &NullableInlineResponse20097EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20097EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20097EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
