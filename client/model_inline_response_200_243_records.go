...
// InlineResponse200243Records struct for InlineResponse200243Records
type InlineResponse200243Records struct {
	Network *InlineResponse200243Network `json:"network,omitempty"`
	...
	ClientVpnConnections []InlineResponse200243ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200243Records() *InlineResponse200243Records {
	this := InlineResponse200243Records{}
	return &this
}
...
func (o *InlineResponse200243Records) GetNetwork() InlineResponse200243Network {
	if o == nil || isNil(o.Network) {
		var ret InlineResponse200243Network
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given InlineResponse200243Network and assigns it to the Network field.
...
func (o *InlineResponse200243Records) GetClientVpnConnections() []InlineResponse200243ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200243ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200243ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200243Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200243Records struct {
	value *InlineResponse200243Records
	isSet bool
}

func (v NullableInlineResponse200243Records) Get() *InlineResponse200243Records {
	return v.value
}

func (v *NullableInlineResponse200243Records) Set(val *InlineResponse200243Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200243Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200243Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200243Records(val *InlineResponse200243Records) *NullableInlineResponse200243Records {
	return &NullableInlineResponse200243Records{value: val, isSet: true}
}

func (v NullableInlineResponse200243Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200243Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
