...
// InlineResponse200198ApBandSettings Settings that will be enabled if selectionType is set to 'ap'.
type InlineResponse200198ApBandSettings struct {
...
func NewInlineResponse200198ApBandSettings() *InlineResponse200198ApBandSettings {
	this := InlineResponse200198ApBandSettings{}
	return &this
}
...
func (o InlineResponse200198ApBandSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200198ApBandSettings struct {
	value *InlineResponse200198ApBandSettings
	isSet bool
}

func (v NullableInlineResponse200198ApBandSettings) Get() *InlineResponse200198ApBandSettings {
	return v.value
}

func (v *NullableInlineResponse200198ApBandSettings) Set(val *InlineResponse200198ApBandSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200198ApBandSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200198ApBandSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200198ApBandSettings(val *InlineResponse200198ApBandSettings) *NullableInlineResponse200198ApBandSettings {
	return &NullableInlineResponse200198ApBandSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200198ApBandSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200198ApBandSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
