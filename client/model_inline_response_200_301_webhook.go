...
// InlineResponse200301Webhook The webhook receiver used by the callback to send results
type InlineResponse200301Webhook struct {
	// The webhook receiver URL where the callback will be sent
	Url *string `json:"url,omitempty"`
	HttpServer *InlineResponse200301WebhookHttpServer `json:"httpServer,omitempty"`
	PayloadTemplate *InlineResponse200301WebhookPayloadTemplate `json:"payloadTemplate,omitempty"`
...
func NewInlineResponse200301Webhook() *InlineResponse200301Webhook {
	this := InlineResponse200301Webhook{}
	return &this
}
...
func (o *InlineResponse200301Webhook) GetHttpServer() InlineResponse200301WebhookHttpServer {
	if o == nil || isNil(o.HttpServer) {
		var ret InlineResponse200301WebhookHttpServer
		return ret
	}
	return *o.HttpServer
}
...
// SetHttpServer gets a reference to the given InlineResponse200301WebhookHttpServer and assigns it to the HttpServer field.
...
func (o *InlineResponse200301Webhook) GetPayloadTemplate() InlineResponse200301WebhookPayloadTemplate {
	if o == nil || isNil(o.PayloadTemplate) {
		var ret InlineResponse200301WebhookPayloadTemplate
		return ret
	}
...
// SetPayloadTemplate gets a reference to the given InlineResponse200301WebhookPayloadTemplate and assigns it to the PayloadTemplate field.
...
func (o InlineResponse200301Webhook) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200301Webhook struct {
	value *InlineResponse200301Webhook
	isSet bool
}

func (v NullableInlineResponse200301Webhook) Get() *InlineResponse200301Webhook {
	return v.value
}

func (v *NullableInlineResponse200301Webhook) Set(val *InlineResponse200301Webhook) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200301Webhook) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200301Webhook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200301Webhook(val *InlineResponse200301Webhook) *NullableInlineResponse200301Webhook {
	return &NullableInlineResponse200301Webhook{value: val, isSet: true}
}

func (v NullableInlineResponse200301Webhook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200301Webhook) UnmarshalJSON(src []byte) error {
	v.isSet = true
