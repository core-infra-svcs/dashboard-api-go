...
func (r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2ByDeviceRequest) Execute() (*InlineResponse200362, *http.Response, error) {
...
func (a *L2ApiService) GetOrganizationWirelessControllerDevicesInterfacesL2ByDeviceExecute(r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2ByDeviceRequest) (*InlineResponse200362, *http.Response, error) {
	var (
...
func (r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2StatusesChangeHistoryByDeviceRequest) Execute() (*InlineResponse200363, *http.Response, error) {
...
func (a *L2ApiService) GetOrganizationWirelessControllerDevicesInterfacesL2StatusesChangeHistoryByDeviceExecute(r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2StatusesChangeHistoryByDeviceRequest) (*InlineResponse200363, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2UsageHistoryByIntervalRequest) Execute() (*InlineResponse200364, *http.Response, error) {
...
func (a *L2ApiService) GetOrganizationWirelessControllerDevicesInterfacesL2UsageHistoryByIntervalExecute(r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2UsageHistoryByIntervalRequest) (*InlineResponse200364, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
