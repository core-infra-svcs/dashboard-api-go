...
func (r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2ByDeviceRequest) Execute() (*InlineResponse200397, *http.Response, error) {
...
func (a *L2ApiService) GetOrganizationWirelessControllerDevicesInterfacesL2ByDeviceExecute(r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2ByDeviceRequest) (*InlineResponse200397, *http.Response, error) {
	var (
...
func (r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2StatusesChangeHistoryByDeviceRequest) Execute() (*InlineResponse200398, *http.Response, error) {
...
func (a *L2ApiService) GetOrganizationWirelessControllerDevicesInterfacesL2StatusesChangeHistoryByDeviceExecute(r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2StatusesChangeHistoryByDeviceRequest) (*InlineResponse200398, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2UsageHistoryByIntervalRequest) Execute() (*InlineResponse200399, *http.Response, error) {
...
func (a *L2ApiService) GetOrganizationWirelessControllerDevicesInterfacesL2UsageHistoryByIntervalExecute(r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2UsageHistoryByIntervalRequest) (*InlineResponse200399, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
