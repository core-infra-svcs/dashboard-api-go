...
func (r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2ByDeviceRequest) Execute() (*InlineResponse200381, *http.Response, error) {
...
func (a *L2ApiService) GetOrganizationWirelessControllerDevicesInterfacesL2ByDeviceExecute(r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2ByDeviceRequest) (*InlineResponse200381, *http.Response, error) {
	var (
...
func (r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2StatusesChangeHistoryByDeviceRequest) Execute() (*InlineResponse200382, *http.Response, error) {
...
func (a *L2ApiService) GetOrganizationWirelessControllerDevicesInterfacesL2StatusesChangeHistoryByDeviceExecute(r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2StatusesChangeHistoryByDeviceRequest) (*InlineResponse200382, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2UsageHistoryByIntervalRequest) Execute() (*InlineResponse200383, *http.Response, error) {
...
func (a *L2ApiService) GetOrganizationWirelessControllerDevicesInterfacesL2UsageHistoryByIntervalExecute(r L2ApiGetOrganizationWirelessControllerDevicesInterfacesL2UsageHistoryByIntervalRequest) (*InlineResponse200383, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
