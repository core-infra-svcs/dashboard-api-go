...
func (r UsageHistoryApiGetNetworkApplianceUplinksUsageHistoryRequest) Execute() ([]InlineResponse20075, *http.Response, error) {
...
func (a *UsageHistoryApiService) GetNetworkApplianceUplinksUsageHistoryExecute(r UsageHistoryApiGetNetworkApplianceUplinksUsageHistoryRequest) ([]InlineResponse20075, *http.Response, error) {
	var (
...
func (r UsageHistoryApiGetNetworkClientUsageHistoryRequest) Execute() ([]InlineResponse20094, *http.Response, error) {
...
func (a *UsageHistoryApiService) GetNetworkClientUsageHistoryExecute(r UsageHistoryApiGetNetworkClientUsageHistoryRequest) ([]InlineResponse20094, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UsageHistoryApiGetNetworkWirelessUsageHistoryRequest) Execute() ([]InlineResponse200213, *http.Response, error) {
...
func (a *UsageHistoryApiService) GetNetworkWirelessUsageHistoryExecute(r UsageHistoryApiGetNetworkWirelessUsageHistoryRequest) ([]InlineResponse200213, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
