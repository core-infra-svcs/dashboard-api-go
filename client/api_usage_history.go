...
func (r UsageHistoryApiGetNetworkClientUsageHistoryRequest) Execute() ([]InlineResponse20082, *http.Response, error) {
...
func (a *UsageHistoryApiService) GetNetworkClientUsageHistoryExecute(r UsageHistoryApiGetNetworkClientUsageHistoryRequest) ([]InlineResponse20082, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UsageHistoryApiGetNetworkWirelessUsageHistoryRequest) Execute() ([]InlineResponse200191, *http.Response, error) {
...
func (a *UsageHistoryApiService) GetNetworkWirelessUsageHistoryExecute(r UsageHistoryApiGetNetworkWirelessUsageHistoryRequest) ([]InlineResponse200191, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
