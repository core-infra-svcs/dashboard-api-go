...
func (r UsageHistoryApiGetNetworkApplianceUplinksUsageHistoryRequest) Execute() ([]InlineResponse20082, *http.Response, error) {
...
func (a *UsageHistoryApiService) GetNetworkApplianceUplinksUsageHistoryExecute(r UsageHistoryApiGetNetworkApplianceUplinksUsageHistoryRequest) ([]InlineResponse20082, *http.Response, error) {
	var (
...
func (r UsageHistoryApiGetNetworkClientUsageHistoryRequest) Execute() ([]NetworksNetworkIdClientsUsageHistoriesUsageHistory, *http.Response, error) {
...
func (a *UsageHistoryApiService) GetNetworkClientUsageHistoryExecute(r UsageHistoryApiGetNetworkClientUsageHistoryRequest) ([]NetworksNetworkIdClientsUsageHistoriesUsageHistory, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UsageHistoryApiGetNetworkWirelessUsageHistoryRequest) Execute() ([]InlineResponse200226, *http.Response, error) {
...
func (a *UsageHistoryApiService) GetNetworkWirelessUsageHistoryExecute(r UsageHistoryApiGetNetworkWirelessUsageHistoryRequest) ([]InlineResponse200226, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
