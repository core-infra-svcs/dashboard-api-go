...
func (r BillingApiGetNetworkWirelessBillingRequest) Execute() (*InlineResponse200169, *http.Response, error) {
...
func (a *BillingApiService) GetNetworkWirelessBillingExecute(r BillingApiGetNetworkWirelessBillingRequest) (*InlineResponse200169, *http.Response, error) {
	var (
...
func (r BillingApiUpdateNetworkWirelessBillingRequest) Execute() (*InlineResponse200169, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200169
func (a *BillingApiService) UpdateNetworkWirelessBillingExecute(r BillingApiUpdateNetworkWirelessBillingRequest) (*InlineResponse200169, *http.Response, error) {
	var (
