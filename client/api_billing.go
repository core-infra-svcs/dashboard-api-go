...
func (r BillingApiGetNetworkWirelessBillingRequest) Execute() (*InlineResponse20092, *http.Response, error) {
...
func (a *BillingApiService) GetNetworkWirelessBillingExecute(r BillingApiGetNetworkWirelessBillingRequest) (*InlineResponse20092, *http.Response, error) {
	var (
...
func (r BillingApiUpdateNetworkWirelessBillingRequest) UpdateNetworkWirelessBilling(updateNetworkWirelessBilling InlineObject154) BillingApiUpdateNetworkWirelessBillingRequest {
	r.updateNetworkWirelessBilling = &updateNetworkWirelessBilling
	return r
}

func (r BillingApiUpdateNetworkWirelessBillingRequest) Execute() (*InlineResponse20092, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20092
func (a *BillingApiService) UpdateNetworkWirelessBillingExecute(r BillingApiUpdateNetworkWirelessBillingRequest) (*InlineResponse20092, *http.Response, error) {
	var (
