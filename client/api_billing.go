...
func (r BillingApiGetNetworkWirelessBillingRequest) Execute() (*InlineResponse20087, *http.Response, error) {
...
func (a *BillingApiService) GetNetworkWirelessBillingExecute(r BillingApiGetNetworkWirelessBillingRequest) (*InlineResponse20087, *http.Response, error) {
	var (
...
func (r BillingApiUpdateNetworkWirelessBillingRequest) Execute() (*InlineResponse20087, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20087
func (a *BillingApiService) UpdateNetworkWirelessBillingExecute(r BillingApiUpdateNetworkWirelessBillingRequest) (*InlineResponse20087, *http.Response, error) {
	var (
