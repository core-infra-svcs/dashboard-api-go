...
func (r BillingApiGetNetworkWirelessBillingRequest) Execute() (*InlineResponse20088, *http.Response, error) {
...
func (a *BillingApiService) GetNetworkWirelessBillingExecute(r BillingApiGetNetworkWirelessBillingRequest) (*InlineResponse20088, *http.Response, error) {
	var (
...
func (r BillingApiUpdateNetworkWirelessBillingRequest) Execute() (*InlineResponse20088, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20088
func (a *BillingApiService) UpdateNetworkWirelessBillingExecute(r BillingApiUpdateNetworkWirelessBillingRequest) (*InlineResponse20088, *http.Response, error) {
	var (
