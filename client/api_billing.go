...
func (r BillingApiGetNetworkWirelessBillingRequest) Execute() (*InlineResponse20097, *http.Response, error) {
...
func (a *BillingApiService) GetNetworkWirelessBillingExecute(r BillingApiGetNetworkWirelessBillingRequest) (*InlineResponse20097, *http.Response, error) {
	var (
...
func (r BillingApiUpdateNetworkWirelessBillingRequest) Execute() (*InlineResponse20097, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20097
func (a *BillingApiService) UpdateNetworkWirelessBillingExecute(r BillingApiUpdateNetworkWirelessBillingRequest) (*InlineResponse20097, *http.Response, error) {
	var (
