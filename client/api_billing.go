...
func (r BillingApiGetNetworkWirelessBillingRequest) Execute() (*InlineResponse200178, *http.Response, error) {
...
func (a *BillingApiService) GetNetworkWirelessBillingExecute(r BillingApiGetNetworkWirelessBillingRequest) (*InlineResponse200178, *http.Response, error) {
	var (
...
func (r BillingApiUpdateNetworkWirelessBillingRequest) Execute() (*InlineResponse200178, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200178
func (a *BillingApiService) UpdateNetworkWirelessBillingExecute(r BillingApiUpdateNetworkWirelessBillingRequest) (*InlineResponse200178, *http.Response, error) {
	var (
