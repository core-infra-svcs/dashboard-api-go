...
func (r BillingApiGetNetworkWirelessBillingRequest) Execute() (*InlineResponse20095, *http.Response, error) {
...
func (a *BillingApiService) GetNetworkWirelessBillingExecute(r BillingApiGetNetworkWirelessBillingRequest) (*InlineResponse20095, *http.Response, error) {
	var (
...
func (r BillingApiUpdateNetworkWirelessBillingRequest) UpdateNetworkWirelessBilling(updateNetworkWirelessBilling InlineObject159) BillingApiUpdateNetworkWirelessBillingRequest {
	r.updateNetworkWirelessBilling = &updateNetworkWirelessBilling
	return r
}

func (r BillingApiUpdateNetworkWirelessBillingRequest) Execute() (*InlineResponse20095, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20095
func (a *BillingApiService) UpdateNetworkWirelessBillingExecute(r BillingApiUpdateNetworkWirelessBillingRequest) (*InlineResponse20095, *http.Response, error) {
	var (
