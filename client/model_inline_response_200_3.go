...
type InlineResponse2003 struct {
	...
	SmartAccountStatus *string `json:"smartAccountStatus,omitempty"`
...
// GetSmartAccountStatus returns the SmartAccountStatus field value if set, zero value otherwise.
func (o *InlineResponse2003) GetSmartAccountStatus() string {
	if o == nil || isNil(o.SmartAccountStatus) {
		var ret string
		return ret
	}
	return *o.SmartAccountStatus
}

// GetSmartAccountStatusOk returns a tuple with the SmartAccountStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InlineResponse2003) GetSmartAccountStatusOk() (*string, bool) {
	if o == nil || isNil(o.SmartAccountStatus) {
    return nil, false
	}
	return o.SmartAccountStatus, true
}
...
// SetSmartAccountStatus gets a reference to the given string and assigns it to the SmartAccountStatus field.
func (o *InlineResponse2003) SetSmartAccountStatus(v string) {
	o.SmartAccountStatus = &v
}
...
func (o InlineResponse2003) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.SmartAccountStatus) {
		toSerialize["smartAccountStatus"] = o.SmartAccountStatus
	}
