...
type InlineResponse200272 struct {
	...
	States *InlineResponse200272States `json:"states,omitempty"`
	// Data by license type (Per-device licensing only)
	LicenseTypes []InlineResponse200272LicenseTypes `json:"licenseTypes,omitempty"`
	SystemsManager *InlineResponse200272SystemsManager `json:"systemsManager,omitempty"`
}
...
func (o *InlineResponse200272) GetStates() InlineResponse200272States {
	if o == nil || isNil(o.States) {
		var ret InlineResponse200272States
		return ret
	}
	return *o.States
}
...
// SetStates gets a reference to the given InlineResponse200272States and assigns it to the States field.
...
func (o *InlineResponse200272) GetLicenseTypes() []InlineResponse200272LicenseTypes {
	if o == nil || isNil(o.LicenseTypes) {
		var ret []InlineResponse200272LicenseTypes
		return ret
	}
...
// SetLicenseTypes gets a reference to the given []InlineResponse200272LicenseTypes and assigns it to the LicenseTypes field.
...
func (o *InlineResponse200272) GetSystemsManager() InlineResponse200272SystemsManager {
	if o == nil || isNil(o.SystemsManager) {
		var ret InlineResponse200272SystemsManager
		return ret
	}
...
// SetSystemsManager gets a reference to the given InlineResponse200272SystemsManager and assigns it to the SystemsManager field.
