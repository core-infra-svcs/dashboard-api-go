...
func (r SplashAuthorizationStatusApiApiGetNetworkClientSplashAuthorizationStatusRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *SplashAuthorizationStatusApiService) GetNetworkClientSplashAuthorizationStatus(ctx context.Context, networkId string, clientId string) SplashAuthorizationStatusApiApiGetNetworkClientSplashAuthorizationStatusRequest {
	return SplashAuthorizationStatusApiApiGetNetworkClientSplashAuthorizationStatusRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *SplashAuthorizationStatusApiService) GetNetworkClientSplashAuthorizationStatusExecute(r SplashAuthorizationStatusApiApiGetNetworkClientSplashAuthorizationStatusRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r SplashAuthorizationStatusApiApiUpdateNetworkClientSplashAuthorizationStatusRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *SplashAuthorizationStatusApiService) UpdateNetworkClientSplashAuthorizationStatus(ctx context.Context, networkId string, clientId string) SplashAuthorizationStatusApiApiUpdateNetworkClientSplashAuthorizationStatusRequest {
	return SplashAuthorizationStatusApiApiUpdateNetworkClientSplashAuthorizationStatusRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *SplashAuthorizationStatusApiService) UpdateNetworkClientSplashAuthorizationStatusExecute(r SplashAuthorizationStatusApiApiUpdateNetworkClientSplashAuthorizationStatusRequest) (map[string]interface{}, *http.Response, error) {
	var (
