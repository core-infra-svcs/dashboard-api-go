...
// InlineResponse200265StatesUnusedActive Data for unused, active licenses
type InlineResponse200265StatesUnusedActive struct {
	// The number of unused, active licenses
	Count *int32 `json:"count,omitempty"`
	OldestActivation *InlineResponse200265StatesUnusedActiveOldestActivation `json:"oldestActivation,omitempty"`
}
...
func NewInlineResponse200265StatesUnusedActive() *InlineResponse200265StatesUnusedActive {
	this := InlineResponse200265StatesUnusedActive{}
	return &this
}
...
func (o *InlineResponse200265StatesUnusedActive) GetOldestActivation() InlineResponse200265StatesUnusedActiveOldestActivation {
	if o == nil || isNil(o.OldestActivation) {
		var ret InlineResponse200265StatesUnusedActiveOldestActivation
		return ret
	}
...
// SetOldestActivation gets a reference to the given InlineResponse200265StatesUnusedActiveOldestActivation and assigns it to the OldestActivation field.
...
func (o InlineResponse200265StatesUnusedActive) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200265StatesUnusedActive struct {
	value *InlineResponse200265StatesUnusedActive
	isSet bool
}

func (v NullableInlineResponse200265StatesUnusedActive) Get() *InlineResponse200265StatesUnusedActive {
	return v.value
}

func (v *NullableInlineResponse200265StatesUnusedActive) Set(val *InlineResponse200265StatesUnusedActive) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200265StatesUnusedActive) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200265StatesUnusedActive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200265StatesUnusedActive(val *InlineResponse200265StatesUnusedActive) *NullableInlineResponse200265StatesUnusedActive {
	return &NullableInlineResponse200265StatesUnusedActive{value: val, isSet: true}
}

func (v NullableInlineResponse200265StatesUnusedActive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200265StatesUnusedActive) UnmarshalJSON(src []byte) error {
	v.isSet = true
