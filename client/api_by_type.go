...
func (r ByTypeApiGetOrganizationAssuranceAlertsOverviewByTypeRequest) Execute() (*InlineResponse200259, *http.Response, error) {
...
func (a *ByTypeApiService) GetOrganizationAssuranceAlertsOverviewByTypeExecute(r ByTypeApiGetOrganizationAssuranceAlertsOverviewByTypeRequest) (*InlineResponse200259, *http.Response, error) {
	var (
