...
func (r ByTypeApiGetOrganizationAssuranceAlertsOverviewByTypeRequest) Execute() (*InlineResponse200253, *http.Response, error) {
...
func (a *ByTypeApiService) GetOrganizationAssuranceAlertsOverviewByTypeExecute(r ByTypeApiGetOrganizationAssuranceAlertsOverviewByTypeRequest) (*InlineResponse200253, *http.Response, error) {
	var (
