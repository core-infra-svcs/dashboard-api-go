...
func (r ByTypeApiGetOrganizationAssuranceAlertsOverviewByTypeRequest) Execute() (*InlineResponse200223, *http.Response, error) {
...
func (a *ByTypeApiService) GetOrganizationAssuranceAlertsOverviewByTypeExecute(r ByTypeApiGetOrganizationAssuranceAlertsOverviewByTypeRequest) (*InlineResponse200223, *http.Response, error) {
	var (
