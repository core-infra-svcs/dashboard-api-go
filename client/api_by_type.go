...
func (r ByTypeApiGetOrganizationAssuranceAlertsOverviewByTypeRequest) Execute() (*InlineResponse200218, *http.Response, error) {
...
func (a *ByTypeApiService) GetOrganizationAssuranceAlertsOverviewByTypeExecute(r ByTypeApiGetOrganizationAssuranceAlertsOverviewByTypeRequest) (*InlineResponse200218, *http.Response, error) {
	var (
