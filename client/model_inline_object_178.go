...
func (o *InlineObject178) GetPorts() []NetworksNetworkIdWirelessEthernetPortsProfilesProfileIdPorts {
...
// and a boolean to check if the value has been set.
func (o *InlineObject178) GetPortsOk() ([]NetworksNetworkIdWirelessEthernetPortsProfilesProfileIdPorts, bool) {
	if o == nil || isNil(o.Ports) {
    return nil, false
	}
	return o.Ports, true
...
func (o *InlineObject178) HasPorts() bool {
	if o != nil && !isNil(o.Ports) {
		return true
	}
...
func (o *InlineObject178) SetPorts(v []NetworksNetworkIdWirelessEthernetPortsProfilesProfileIdPorts) {
	o.Ports = v
}

// GetUsbPorts returns the UsbPorts field value if set, zero value otherwise.
func (o *InlineObject178) GetUsbPorts() []NetworksNetworkIdWirelessEthernetPortsProfilesUsbPorts1 {
...
// and a boolean to check if the value has been set.
func (o *InlineObject178) GetUsbPortsOk() ([]NetworksNetworkIdWirelessEthernetPortsProfilesUsbPorts1, bool) {
	if o == nil || isNil(o.UsbPorts) {
    return nil, false
	}
...
func (o *InlineObject178) HasUsbPorts() bool {
	if o != nil && !isNil(o.UsbPorts) {
		return true
	}
...
func (o *InlineObject178) SetUsbPorts(v []NetworksNetworkIdWirelessEthernetPortsProfilesUsbPorts1) {
	o.UsbPorts = v
}
