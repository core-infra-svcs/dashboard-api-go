...
func (r PingDeviceApiCreateDeviceLiveToolsPingDeviceRequest) CreateDeviceLiveToolsPingDevice(createDeviceLiveToolsPingDevice InlineObject17) PingDeviceApiCreateDeviceLiveToolsPingDeviceRequest {
...
func (r PingDeviceApiGetDeviceLiveToolsPingDeviceRequest) Execute() (*InlineResponse2007, *http.Response, error) {
...
func (a *PingDeviceApiService) GetDeviceLiveToolsPingDeviceExecute(r PingDeviceApiGetDeviceLiveToolsPingDeviceRequest) (*InlineResponse2007, *http.Response, error) {
	var (
