...
func (r PingDeviceApiCreateDeviceLiveToolsPingDeviceRequest) CreateDeviceLiveToolsPingDevice(createDeviceLiveToolsPingDevice InlineObject20) PingDeviceApiCreateDeviceLiveToolsPingDeviceRequest {
	r.createDeviceLiveToolsPingDevice = &createDeviceLiveToolsPingDevice
	return r
}

func (r PingDeviceApiCreateDeviceLiveToolsPingDeviceRequest) Execute() (*InlineResponse2015, *http.Response, error) {
...
func (a *PingDeviceApiService) CreateDeviceLiveToolsPingDeviceExecute(r PingDeviceApiCreateDeviceLiveToolsPingDeviceRequest) (*InlineResponse2015, *http.Response, error) {
	var (
...
func (r PingDeviceApiGetDeviceLiveToolsPingDeviceRequest) Execute() (*InlineResponse20024, *http.Response, error) {
...
func (a *PingDeviceApiService) GetDeviceLiveToolsPingDeviceExecute(r PingDeviceApiGetDeviceLiveToolsPingDeviceRequest) (*InlineResponse20024, *http.Response, error) {
	var (
