...
// InlineResponse200277Items struct for InlineResponse200277Items
type InlineResponse200277Items struct {
...
func NewInlineResponse200277Items() *InlineResponse200277Items {
	this := InlineResponse200277Items{}
	return &this
}
...
func (o InlineResponse200277Items) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200277Items struct {
	value *InlineResponse200277Items
	isSet bool
}

func (v NullableInlineResponse200277Items) Get() *InlineResponse200277Items {
	return v.value
}

func (v *NullableInlineResponse200277Items) Set(val *InlineResponse200277Items) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200277Items) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200277Items) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200277Items(val *InlineResponse200277Items) *NullableInlineResponse200277Items {
	return &NullableInlineResponse200277Items{value: val, isSet: true}
}

func (v NullableInlineResponse200277Items) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200277Items) UnmarshalJSON(src []byte) error {
	v.isSet = true
