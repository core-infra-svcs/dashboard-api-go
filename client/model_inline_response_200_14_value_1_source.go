...
// InlineResponse20014Value1Source Source of 'custom' type traffic filter
type InlineResponse20014Value1Source struct {
...
func NewInlineResponse20014Value1Source() *InlineResponse20014Value1Source {
	this := InlineResponse20014Value1Source{}
	return &this
}
...
func (o InlineResponse20014Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20014Value1Source struct {
	value *InlineResponse20014Value1Source
	isSet bool
}

func (v NullableInlineResponse20014Value1Source) Get() *InlineResponse20014Value1Source {
	return v.value
}

func (v *NullableInlineResponse20014Value1Source) Set(val *InlineResponse20014Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20014Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20014Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20014Value1Source(val *InlineResponse20014Value1Source) *NullableInlineResponse20014Value1Source {
	return &NullableInlineResponse20014Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20014Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20014Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
