...
// InlineResponse20097ProductsWirelessAvailableVersions struct for InlineResponse20097ProductsWirelessAvailableVersions
type InlineResponse20097ProductsWirelessAvailableVersions struct {
...
func NewInlineResponse20097ProductsWirelessAvailableVersions() *InlineResponse20097ProductsWirelessAvailableVersions {
	this := InlineResponse20097ProductsWirelessAvailableVersions{}
	return &this
}
...
func (o InlineResponse20097ProductsWirelessAvailableVersions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20097ProductsWirelessAvailableVersions struct {
	value *InlineResponse20097ProductsWirelessAvailableVersions
	isSet bool
}

func (v NullableInlineResponse20097ProductsWirelessAvailableVersions) Get() *InlineResponse20097ProductsWirelessAvailableVersions {
	return v.value
}

func (v *NullableInlineResponse20097ProductsWirelessAvailableVersions) Set(val *InlineResponse20097ProductsWirelessAvailableVersions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20097ProductsWirelessAvailableVersions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20097ProductsWirelessAvailableVersions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20097ProductsWirelessAvailableVersions(val *InlineResponse20097ProductsWirelessAvailableVersions) *NullableInlineResponse20097ProductsWirelessAvailableVersions {
	return &NullableInlineResponse20097ProductsWirelessAvailableVersions{value: val, isSet: true}
}

func (v NullableInlineResponse20097ProductsWirelessAvailableVersions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20097ProductsWirelessAvailableVersions) UnmarshalJSON(src []byte) error {
	v.isSet = true
