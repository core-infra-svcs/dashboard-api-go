...
// InlineResponse200109RegulatoryDomain Regulatory domain information for this network.
type InlineResponse200109RegulatoryDomain struct {
...
func NewInlineResponse200109RegulatoryDomain() *InlineResponse200109RegulatoryDomain {
	this := InlineResponse200109RegulatoryDomain{}
	return &this
}
...
func (o InlineResponse200109RegulatoryDomain) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200109RegulatoryDomain struct {
	value *InlineResponse200109RegulatoryDomain
	isSet bool
}

func (v NullableInlineResponse200109RegulatoryDomain) Get() *InlineResponse200109RegulatoryDomain {
	return v.value
}

func (v *NullableInlineResponse200109RegulatoryDomain) Set(val *InlineResponse200109RegulatoryDomain) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200109RegulatoryDomain) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200109RegulatoryDomain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200109RegulatoryDomain(val *InlineResponse200109RegulatoryDomain) *NullableInlineResponse200109RegulatoryDomain {
	return &NullableInlineResponse200109RegulatoryDomain{value: val, isSet: true}
}

func (v NullableInlineResponse200109RegulatoryDomain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200109RegulatoryDomain) UnmarshalJSON(src []byte) error {
	v.isSet = true
