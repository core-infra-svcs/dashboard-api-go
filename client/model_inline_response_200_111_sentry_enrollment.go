...
// InlineResponse200111SentryEnrollment Systems Manager sentry enrollment splash settings.
type InlineResponse200111SentryEnrollment struct {
	SystemsManagerNetwork *InlineResponse200111SentryEnrollmentSystemsManagerNetwork `json:"systemsManagerNetwork,omitempty"`
...
func NewInlineResponse200111SentryEnrollment() *InlineResponse200111SentryEnrollment {
	this := InlineResponse200111SentryEnrollment{}
	return &this
}
...
func (o *InlineResponse200111SentryEnrollment) GetSystemsManagerNetwork() InlineResponse200111SentryEnrollmentSystemsManagerNetwork {
	if o == nil || isNil(o.SystemsManagerNetwork) {
		var ret InlineResponse200111SentryEnrollmentSystemsManagerNetwork
		return ret
	}
...
// SetSystemsManagerNetwork gets a reference to the given InlineResponse200111SentryEnrollmentSystemsManagerNetwork and assigns it to the SystemsManagerNetwork field.
...
func (o InlineResponse200111SentryEnrollment) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200111SentryEnrollment struct {
	value *InlineResponse200111SentryEnrollment
	isSet bool
}

func (v NullableInlineResponse200111SentryEnrollment) Get() *InlineResponse200111SentryEnrollment {
	return v.value
}

func (v *NullableInlineResponse200111SentryEnrollment) Set(val *InlineResponse200111SentryEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200111SentryEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200111SentryEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200111SentryEnrollment(val *InlineResponse200111SentryEnrollment) *NullableInlineResponse200111SentryEnrollment {
	return &NullableInlineResponse200111SentryEnrollment{value: val, isSet: true}
}

func (v NullableInlineResponse200111SentryEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200111SentryEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
