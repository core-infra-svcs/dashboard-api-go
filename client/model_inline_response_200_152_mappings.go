...
// InlineResponse200152Mappings struct for InlineResponse200152Mappings
type InlineResponse200152Mappings struct {
...
func NewInlineResponse200152Mappings() *InlineResponse200152Mappings {
	this := InlineResponse200152Mappings{}
	return &this
}
...
func (o InlineResponse200152Mappings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200152Mappings struct {
	value *InlineResponse200152Mappings
	isSet bool
}

func (v NullableInlineResponse200152Mappings) Get() *InlineResponse200152Mappings {
	return v.value
}

func (v *NullableInlineResponse200152Mappings) Set(val *InlineResponse200152Mappings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200152Mappings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200152Mappings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200152Mappings(val *InlineResponse200152Mappings) *NullableInlineResponse200152Mappings {
	return &NullableInlineResponse200152Mappings{value: val, isSet: true}
}

func (v NullableInlineResponse200152Mappings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200152Mappings) UnmarshalJSON(src []byte) error {
	v.isSet = true
