...
// InlineResponse20023ResultsLatencies Packet latency stats
type InlineResponse20023ResultsLatencies struct {
	// Minimum latency
...
func NewInlineResponse20023ResultsLatencies() *InlineResponse20023ResultsLatencies {
	this := InlineResponse20023ResultsLatencies{}
	return &this
}
...
func (o InlineResponse20023ResultsLatencies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20023ResultsLatencies struct {
	value *InlineResponse20023ResultsLatencies
	isSet bool
}

func (v NullableInlineResponse20023ResultsLatencies) Get() *InlineResponse20023ResultsLatencies {
	return v.value
}

func (v *NullableInlineResponse20023ResultsLatencies) Set(val *InlineResponse20023ResultsLatencies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20023ResultsLatencies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20023ResultsLatencies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20023ResultsLatencies(val *InlineResponse20023ResultsLatencies) *NullableInlineResponse20023ResultsLatencies {
	return &NullableInlineResponse20023ResultsLatencies{value: val, isSet: true}
}

func (v NullableInlineResponse20023ResultsLatencies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20023ResultsLatencies) UnmarshalJSON(src []byte) error {
	v.isSet = true
