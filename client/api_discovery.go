...
func (r DiscoveryApiGetOrganizationSwitchPortsTopologyDiscoveryByDeviceRequest) Execute() (*InlineResponse200347, *http.Response, error) {
...
func (a *DiscoveryApiService) GetOrganizationSwitchPortsTopologyDiscoveryByDeviceExecute(r DiscoveryApiGetOrganizationSwitchPortsTopologyDiscoveryByDeviceRequest) (*InlineResponse200347, *http.Response, error) {
	var (
