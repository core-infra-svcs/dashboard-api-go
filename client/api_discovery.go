...
func (r DiscoveryApiGetOrganizationSwitchPortsTopologyDiscoveryByDeviceRequest) Execute() (*InlineResponse200344, *http.Response, error) {
...
func (a *DiscoveryApiService) GetOrganizationSwitchPortsTopologyDiscoveryByDeviceExecute(r DiscoveryApiGetOrganizationSwitchPortsTopologyDiscoveryByDeviceRequest) (*InlineResponse200344, *http.Response, error) {
	var (
