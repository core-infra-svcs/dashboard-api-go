...
func (r DiscoveryApiGetOrganizationSwitchPortsTopologyDiscoveryByDeviceRequest) Execute() (*InlineResponse200327, *http.Response, error) {
...
func (a *DiscoveryApiService) GetOrganizationSwitchPortsTopologyDiscoveryByDeviceExecute(r DiscoveryApiGetOrganizationSwitchPortsTopologyDiscoveryByDeviceRequest) (*InlineResponse200327, *http.Response, error) {
	var (
