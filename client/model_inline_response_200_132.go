...
func (o *InlineResponse200132) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200132) GetDescriptionOk() (*string, bool) {
	if o == nil || isNil(o.Description) {
    return nil, false
	}
...
func (o *InlineResponse200132) HasDescription() bool {
	if o != nil && !isNil(o.Description) {
		return true
	}
...
func (o *InlineResponse200132) SetDescription(v string) {
	o.Description = &v
}
...
func (o *InlineResponse200132) GetPayloadTypes() []string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200132) GetPayloadTypesOk() ([]string, bool) {
	if o == nil || isNil(o.PayloadTypes) {
    return nil, false
	}
...
func (o *InlineResponse200132) HasPayloadTypes() bool {
	if o != nil && !isNil(o.PayloadTypes) {
		return true
	}
...
func (o *InlineResponse200132) SetPayloadTypes(v []string) {
	o.PayloadTypes = v
}
