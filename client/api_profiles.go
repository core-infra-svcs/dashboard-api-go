...
func (r ProfilesApiGetOrganizationConfigTemplateSwitchProfilePortRequest) Execute() (*InlineResponse200240, *http.Response, error) {
...
func (a *ProfilesApiService) GetOrganizationConfigTemplateSwitchProfilePortExecute(r ProfilesApiGetOrganizationConfigTemplateSwitchProfilePortRequest) (*InlineResponse200240, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ProfilesApiGetOrganizationConfigTemplateSwitchProfilePortsRequest) Execute() ([]InlineResponse200240, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200240
func (a *ProfilesApiService) GetOrganizationConfigTemplateSwitchProfilePortsExecute(r ProfilesApiGetOrganizationConfigTemplateSwitchProfilePortsRequest) ([]InlineResponse200240, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ProfilesApiGetOrganizationConfigTemplateSwitchProfilesRequest) Execute() ([]InlineResponse200239, *http.Response, error) {
...
func (a *ProfilesApiService) GetOrganizationConfigTemplateSwitchProfilesExecute(r ProfilesApiGetOrganizationConfigTemplateSwitchProfilesRequest) ([]InlineResponse200239, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ProfilesApiUpdateOrganizationConfigTemplateSwitchProfilePortRequest) UpdateOrganizationConfigTemplateSwitchProfilePort(updateOrganizationConfigTemplateSwitchProfilePort InlineObject232) ProfilesApiUpdateOrganizationConfigTemplateSwitchProfilePortRequest {
	r.updateOrganizationConfigTemplateSwitchProfilePort = &updateOrganizationConfigTemplateSwitchProfilePort
	return r
}

func (r ProfilesApiUpdateOrganizationConfigTemplateSwitchProfilePortRequest) Execute() (*InlineResponse200240, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200240
func (a *ProfilesApiService) UpdateOrganizationConfigTemplateSwitchProfilePortExecute(r ProfilesApiUpdateOrganizationConfigTemplateSwitchProfilePortRequest) (*InlineResponse200240, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
