...
type InlineResponse200179 struct {
	...
	ApBandSettings *InlineResponse200179ApBandSettings `json:"apBandSettings,omitempty"`
	...
	SixGhzSettings *InlineResponse200179SixGhzSettings `json:"sixGhzSettings,omitempty"`
	Transmission *InlineResponse200179Transmission `json:"transmission,omitempty"`
	PerSsidSettings *InlineResponse200179PerSsidSettings `json:"perSsidSettings,omitempty"`
}
...
func (o *InlineResponse200179) GetApBandSettings() InlineResponse200179ApBandSettings {
	if o == nil || isNil(o.ApBandSettings) {
		var ret InlineResponse200179ApBandSettings
		return ret
	}
...
// SetApBandSettings gets a reference to the given InlineResponse200179ApBandSettings and assigns it to the ApBandSettings field.
...
func (o *InlineResponse200179) GetSixGhzSettings() InlineResponse200179SixGhzSettings {
	if o == nil || isNil(o.SixGhzSettings) {
		var ret InlineResponse200179SixGhzSettings
		return ret
	}
...
// SetSixGhzSettings gets a reference to the given InlineResponse200179SixGhzSettings and assigns it to the SixGhzSettings field.
...
func (o *InlineResponse200179) GetPerSsidSettings() InlineResponse200179PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse200179PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse200179PerSsidSettings and assigns it to the PerSsidSettings field.
