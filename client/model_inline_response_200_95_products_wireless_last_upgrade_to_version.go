...
// InlineResponse20095ProductsWirelessLastUpgradeToVersion Details of the version the device upgraded to
type InlineResponse20095ProductsWirelessLastUpgradeToVersion struct {
...
func NewInlineResponse20095ProductsWirelessLastUpgradeToVersion() *InlineResponse20095ProductsWirelessLastUpgradeToVersion {
	this := InlineResponse20095ProductsWirelessLastUpgradeToVersion{}
	return &this
}
...
func (o InlineResponse20095ProductsWirelessLastUpgradeToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20095ProductsWirelessLastUpgradeToVersion struct {
	value *InlineResponse20095ProductsWirelessLastUpgradeToVersion
	isSet bool
}

func (v NullableInlineResponse20095ProductsWirelessLastUpgradeToVersion) Get() *InlineResponse20095ProductsWirelessLastUpgradeToVersion {
	return v.value
}

func (v *NullableInlineResponse20095ProductsWirelessLastUpgradeToVersion) Set(val *InlineResponse20095ProductsWirelessLastUpgradeToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20095ProductsWirelessLastUpgradeToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20095ProductsWirelessLastUpgradeToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20095ProductsWirelessLastUpgradeToVersion(val *InlineResponse20095ProductsWirelessLastUpgradeToVersion) *NullableInlineResponse20095ProductsWirelessLastUpgradeToVersion {
	return &NullableInlineResponse20095ProductsWirelessLastUpgradeToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20095ProductsWirelessLastUpgradeToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20095ProductsWirelessLastUpgradeToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
