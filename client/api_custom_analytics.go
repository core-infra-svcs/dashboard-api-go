...
func (r CustomAnalyticsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) CreateOrganizationCameraCustomAnalyticsArtifact(createOrganizationCameraCustomAnalyticsArtifact InlineObject244) CustomAnalyticsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest {
	r.createOrganizationCameraCustomAnalyticsArtifact = &createOrganizationCameraCustomAnalyticsArtifact
	return r
}

func (r CustomAnalyticsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) Execute() (*InlineResponse20120, *http.Response, error) {
...
func (a *CustomAnalyticsApiService) CreateOrganizationCameraCustomAnalyticsArtifactExecute(r CustomAnalyticsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) (*InlineResponse20120, *http.Response, error) {
	var (
...
func (r CustomAnalyticsApiGetDeviceCameraCustomAnalyticsRequest) Execute() (*InlineResponse20016, *http.Response, error) {
...
func (a *CustomAnalyticsApiService) GetDeviceCameraCustomAnalyticsExecute(r CustomAnalyticsApiGetDeviceCameraCustomAnalyticsRequest) (*InlineResponse20016, *http.Response, error) {
	var (
...
func (r CustomAnalyticsApiGetOrganizationCameraCustomAnalyticsArtifactRequest) Execute() (*InlineResponse200254, *http.Response, error) {
...
func (a *CustomAnalyticsApiService) GetOrganizationCameraCustomAnalyticsArtifactExecute(r CustomAnalyticsApiGetOrganizationCameraCustomAnalyticsArtifactRequest) (*InlineResponse200254, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CustomAnalyticsApiGetOrganizationCameraCustomAnalyticsArtifactsRequest) Execute() ([]InlineResponse200254, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200254
func (a *CustomAnalyticsApiService) GetOrganizationCameraCustomAnalyticsArtifactsExecute(r CustomAnalyticsApiGetOrganizationCameraCustomAnalyticsArtifactsRequest) ([]InlineResponse200254, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CustomAnalyticsApiUpdateDeviceCameraCustomAnalyticsRequest) UpdateDeviceCameraCustomAnalytics(updateDeviceCameraCustomAnalytics InlineObject7) CustomAnalyticsApiUpdateDeviceCameraCustomAnalyticsRequest {
	r.updateDeviceCameraCustomAnalytics = &updateDeviceCameraCustomAnalytics
	return r
}

func (r CustomAnalyticsApiUpdateDeviceCameraCustomAnalyticsRequest) Execute() (*InlineResponse20016, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20016
func (a *CustomAnalyticsApiService) UpdateDeviceCameraCustomAnalyticsExecute(r CustomAnalyticsApiUpdateDeviceCameraCustomAnalyticsRequest) (*InlineResponse20016, *http.Response, error) {
	var (
