...
func (r CustomAnalyticsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) CreateOrganizationCameraCustomAnalyticsArtifact(createOrganizationCameraCustomAnalyticsArtifact InlineObject218) CustomAnalyticsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest {
	r.createOrganizationCameraCustomAnalyticsArtifact = &createOrganizationCameraCustomAnalyticsArtifact
	return r
}

func (r CustomAnalyticsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) Execute() (*InlineResponse20113, *http.Response, error) {
...
func (a *CustomAnalyticsApiService) CreateOrganizationCameraCustomAnalyticsArtifactExecute(r CustomAnalyticsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) (*InlineResponse20113, *http.Response, error) {
	var (
...
func (r CustomAnalyticsApiGetDeviceCameraCustomAnalyticsRequest) Execute() (*InlineResponse20013, *http.Response, error) {
...
func (a *CustomAnalyticsApiService) GetDeviceCameraCustomAnalyticsExecute(r CustomAnalyticsApiGetDeviceCameraCustomAnalyticsRequest) (*InlineResponse20013, *http.Response, error) {
	var (
...
func (r CustomAnalyticsApiGetOrganizationCameraCustomAnalyticsArtifactRequest) Execute() (*InlineResponse200221, *http.Response, error) {
...
func (a *CustomAnalyticsApiService) GetOrganizationCameraCustomAnalyticsArtifactExecute(r CustomAnalyticsApiGetOrganizationCameraCustomAnalyticsArtifactRequest) (*InlineResponse200221, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CustomAnalyticsApiGetOrganizationCameraCustomAnalyticsArtifactsRequest) Execute() ([]InlineResponse200221, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200221
func (a *CustomAnalyticsApiService) GetOrganizationCameraCustomAnalyticsArtifactsExecute(r CustomAnalyticsApiGetOrganizationCameraCustomAnalyticsArtifactsRequest) ([]InlineResponse200221, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CustomAnalyticsApiUpdateDeviceCameraCustomAnalyticsRequest) Execute() (*InlineResponse20013, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20013
func (a *CustomAnalyticsApiService) UpdateDeviceCameraCustomAnalyticsExecute(r CustomAnalyticsApiUpdateDeviceCameraCustomAnalyticsRequest) (*InlineResponse20013, *http.Response, error) {
	var (
