...
type InlineResponse200130 struct {
	Usage *InlineResponse200130Usage `json:"usage,omitempty"`
	Counts *InlineResponse200130Counts `json:"counts,omitempty"`
}
...
func (o *InlineResponse200130) GetUsage() InlineResponse200130Usage {
	if o == nil || isNil(o.Usage) {
		var ret InlineResponse200130Usage
		return ret
	}
	return *o.Usage
}
...
// SetUsage gets a reference to the given InlineResponse200130Usage and assigns it to the Usage field.
...
func (o *InlineResponse200130) GetCounts() InlineResponse200130Counts {
	if o == nil || isNil(o.Counts) {
		var ret InlineResponse200130Counts
		return ret
	}
	return *o.Counts
}
...
// SetCounts gets a reference to the given InlineResponse200130Counts and assigns it to the Counts field.
