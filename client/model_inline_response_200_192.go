...
type InlineResponse200192 struct {
	...
	HighAvailability *OrganizationsOrganizationIdUplinksStatusesHighAvailability `json:"highAvailability,omitempty"`
	// Uplinks
...
func (o *InlineResponse200192) GetHighAvailability() OrganizationsOrganizationIdUplinksStatusesHighAvailability {
	if o == nil || isNil(o.HighAvailability) {
		var ret OrganizationsOrganizationIdUplinksStatusesHighAvailability
		return ret
	}
...
// SetHighAvailability gets a reference to the given OrganizationsOrganizationIdUplinksStatusesHighAvailability and assigns it to the HighAvailability field.
