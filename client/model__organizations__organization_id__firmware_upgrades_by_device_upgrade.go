...
type OrganizationsOrganizationIdFirmwareUpgradesByDeviceUpgrade struct {
	...
	UpgradeBatchId NullableString `json:"upgradeBatchId,omitempty"`
...
// GetUpgradeBatchId returns the UpgradeBatchId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *OrganizationsOrganizationIdFirmwareUpgradesByDeviceUpgrade) GetUpgradeBatchId() string {
	if o == nil || isNil(o.UpgradeBatchId.Get()) {
		var ret string
		return ret
	}
	return *o.UpgradeBatchId.Get()
}
...
// SetUpgradeBatchId gets a reference to the given NullableString and assigns it to the UpgradeBatchId field.
func (o *OrganizationsOrganizationIdFirmwareUpgradesByDeviceUpgrade) SetUpgradeBatchId(v string) {
	o.UpgradeBatchId.Set(&v)
}
// SetUpgradeBatchIdNil sets the value for UpgradeBatchId to be an explicit nil
func (o *OrganizationsOrganizationIdFirmwareUpgradesByDeviceUpgrade) SetUpgradeBatchIdNil() {
	o.UpgradeBatchId.Set(nil)
}
...
func (o OrganizationsOrganizationIdFirmwareUpgradesByDeviceUpgrade) MarshalJSON() ([]byte, error) {
	...
	if o.UpgradeBatchId.IsSet() {
		toSerialize["upgradeBatchId"] = o.UpgradeBatchId.Get()
	}
	if !isNil(o.Staged) {
