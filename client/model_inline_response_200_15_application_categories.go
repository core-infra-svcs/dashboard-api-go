...
// InlineResponse20015ApplicationCategories struct for InlineResponse20015ApplicationCategories
type InlineResponse20015ApplicationCategories struct {
	// The id of the category
	Id *string `json:"id,omitempty"`
	// The name of the category
	Name *string `json:"name,omitempty"`
	// Details of the associated applications
	Applications []InlineResponse20015Applications `json:"applications,omitempty"`
}
...
func NewInlineResponse20015ApplicationCategories() *InlineResponse20015ApplicationCategories {
	this := InlineResponse20015ApplicationCategories{}
	return &this
}
...
func (o *InlineResponse20015ApplicationCategories) GetApplications() []InlineResponse20015Applications {
	if o == nil || isNil(o.Applications) {
		var ret []InlineResponse20015Applications
		return ret
	}
...
// SetApplications gets a reference to the given []InlineResponse20015Applications and assigns it to the Applications field.
func (o *InlineResponse20015ApplicationCategories) SetApplications(v []InlineResponse20015Applications) {
	o.Applications = v
}

func (o InlineResponse20015ApplicationCategories) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20015ApplicationCategories struct {
	value *InlineResponse20015ApplicationCategories
	isSet bool
}

func (v NullableInlineResponse20015ApplicationCategories) Get() *InlineResponse20015ApplicationCategories {
	return v.value
}

func (v *NullableInlineResponse20015ApplicationCategories) Set(val *InlineResponse20015ApplicationCategories) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20015ApplicationCategories) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20015ApplicationCategories) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20015ApplicationCategories(val *InlineResponse20015ApplicationCategories) *NullableInlineResponse20015ApplicationCategories {
	return &NullableInlineResponse20015ApplicationCategories{value: val, isSet: true}
}

func (v NullableInlineResponse20015ApplicationCategories) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20015ApplicationCategories) UnmarshalJSON(src []byte) error {
	v.isSet = true
