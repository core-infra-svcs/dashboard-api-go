...
// InlineResponse20071IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse20071IpsecPolicies struct {
...
func NewInlineResponse20071IpsecPolicies() *InlineResponse20071IpsecPolicies {
	this := InlineResponse20071IpsecPolicies{}
	return &this
}
...
func (o InlineResponse20071IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20071IpsecPolicies struct {
	value *InlineResponse20071IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse20071IpsecPolicies) Get() *InlineResponse20071IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse20071IpsecPolicies) Set(val *InlineResponse20071IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20071IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20071IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20071IpsecPolicies(val *InlineResponse20071IpsecPolicies) *NullableInlineResponse20071IpsecPolicies {
	return &NullableInlineResponse20071IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse20071IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20071IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
