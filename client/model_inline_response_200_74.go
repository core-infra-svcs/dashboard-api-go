...
type InlineResponse20074 struct {
	...
	SplashLogo *InlineResponse20074SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse20074SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse20074SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse20074GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse20074Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse20074SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse20074SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse20074) GetSplashLogo() InlineResponse20074SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse20074SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse20074SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse20074) GetSplashImage() InlineResponse20074SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse20074SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse20074SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse20074) GetSplashPrepaidFront() InlineResponse20074SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse20074SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse20074SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse20074) GetGuestSponsorship() InlineResponse20074GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse20074GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse20074GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse20074) GetBilling() InlineResponse20074Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse20074Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse20074Billing and assigns it to the Billing field.
...
func (o *InlineResponse20074) GetSentryEnrollment() InlineResponse20074SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse20074SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse20074SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse20074) GetSelfRegistration() InlineResponse20074SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse20074SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse20074SelfRegistration and assigns it to the SelfRegistration field.
