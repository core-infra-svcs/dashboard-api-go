...
type InlineResponse20074 struct {
	...
	Hubs []InlineResponse20074Hubs `json:"hubs,omitempty"`
...
func (o *InlineResponse20074) GetHubs() []InlineResponse20074Hubs {
	if o == nil || isNil(o.Hubs) {
		var ret []InlineResponse20074Hubs
		return ret
	}
	return o.Hubs
}
...
// SetHubs gets a reference to the given []InlineResponse20074Hubs and assigns it to the Hubs field.
