...
type InlineResponse20074 struct {
	...
	Neighbors []InlineResponse20074Neighbors `json:"neighbors,omitempty"`
}
...
func (o *InlineResponse20074) GetNeighbors() []InlineResponse20074Neighbors {
	if o == nil || isNil(o.Neighbors) {
		var ret []InlineResponse20074Neighbors
		return ret
	}
	return o.Neighbors
}
...
// SetNeighbors gets a reference to the given []InlineResponse20074Neighbors and assigns it to the Neighbors field.
