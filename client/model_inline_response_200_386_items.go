...
type InlineResponse200386Items struct {
	...
	Readings []InlineResponse200383Readings `json:"readings,omitempty"`
}
...
func (o *InlineResponse200386Items) GetReadings() []InlineResponse200383Readings {
	if o == nil || isNil(o.Readings) {
		var ret []InlineResponse200383Readings
		return ret
	}
	return o.Readings
}
...
// SetReadings gets a reference to the given []InlineResponse200383Readings and assigns it to the Readings field.
