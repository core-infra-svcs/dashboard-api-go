...
// InlineResponse20077Counts The current amount of various adaptive policy objects.
type InlineResponse20077Counts struct {
...
func NewInlineResponse20077Counts() *InlineResponse20077Counts {
	this := InlineResponse20077Counts{}
	return &this
}
...
func (o InlineResponse20077Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20077Counts struct {
	value *InlineResponse20077Counts
	isSet bool
}

func (v NullableInlineResponse20077Counts) Get() *InlineResponse20077Counts {
	return v.value
}

func (v *NullableInlineResponse20077Counts) Set(val *InlineResponse20077Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20077Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20077Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20077Counts(val *InlineResponse20077Counts) *NullableInlineResponse20077Counts {
	return &NullableInlineResponse20077Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20077Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20077Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
