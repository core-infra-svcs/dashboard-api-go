...
// InlineResponse20060DynamicDns Dynamic DNS settings for a network
type InlineResponse20060DynamicDns struct {
	// Dynamic DNS enabled
...
func NewInlineResponse20060DynamicDns() *InlineResponse20060DynamicDns {
	this := InlineResponse20060DynamicDns{}
	return &this
}
...
func (o InlineResponse20060DynamicDns) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20060DynamicDns struct {
	value *InlineResponse20060DynamicDns
	isSet bool
}

func (v NullableInlineResponse20060DynamicDns) Get() *InlineResponse20060DynamicDns {
	return v.value
}

func (v *NullableInlineResponse20060DynamicDns) Set(val *InlineResponse20060DynamicDns) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20060DynamicDns) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20060DynamicDns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20060DynamicDns(val *InlineResponse20060DynamicDns) *NullableInlineResponse20060DynamicDns {
	return &NullableInlineResponse20060DynamicDns{value: val, isSet: true}
}

func (v NullableInlineResponse20060DynamicDns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20060DynamicDns) UnmarshalJSON(src []byte) error {
	v.isSet = true
