...
func (r PortsApiGetOrganizationConfigTemplateSwitchProfilePortRequest) Execute() (*InlineResponse200234, *http.Response, error) {
...
func (a *PortsApiService) GetOrganizationConfigTemplateSwitchProfilePortExecute(r PortsApiGetOrganizationConfigTemplateSwitchProfilePortRequest) (*InlineResponse200234, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PortsApiGetOrganizationConfigTemplateSwitchProfilePortsRequest) Execute() ([]InlineResponse200234, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200234
func (a *PortsApiService) GetOrganizationConfigTemplateSwitchProfilePortsExecute(r PortsApiGetOrganizationConfigTemplateSwitchProfilePortsRequest) ([]InlineResponse200234, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PortsApiGetOrganizationSwitchPortsBySwitchRequest) Execute() ([]InlineResponse200291, *http.Response, error) {
...
func (a *PortsApiService) GetOrganizationSwitchPortsBySwitchExecute(r PortsApiGetOrganizationSwitchPortsBySwitchRequest) ([]InlineResponse200291, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PortsApiGetOrganizationSwitchPortsOverviewRequest) Execute() (*InlineResponse200292, *http.Response, error) {
...
func (a *PortsApiService) GetOrganizationSwitchPortsOverviewExecute(r PortsApiGetOrganizationSwitchPortsOverviewRequest) (*InlineResponse200292, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PortsApiUpdateOrganizationConfigTemplateSwitchProfilePortRequest) Execute() (*InlineResponse200234, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200234
func (a *PortsApiService) UpdateOrganizationConfigTemplateSwitchProfilePortExecute(r PortsApiUpdateOrganizationConfigTemplateSwitchProfilePortRequest) (*InlineResponse200234, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
