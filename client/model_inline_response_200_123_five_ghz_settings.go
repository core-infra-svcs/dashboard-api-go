...
// InlineResponse200123FiveGhzSettings Settings related to 5Ghz band
type InlineResponse200123FiveGhzSettings struct {
...
func NewInlineResponse200123FiveGhzSettings() *InlineResponse200123FiveGhzSettings {
	this := InlineResponse200123FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse200123FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200123FiveGhzSettings struct {
	value *InlineResponse200123FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse200123FiveGhzSettings) Get() *InlineResponse200123FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200123FiveGhzSettings) Set(val *InlineResponse200123FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200123FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200123FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200123FiveGhzSettings(val *InlineResponse200123FiveGhzSettings) *NullableInlineResponse200123FiveGhzSettings {
	return &NullableInlineResponse200123FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200123FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200123FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
