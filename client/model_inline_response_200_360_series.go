...
// InlineResponse200360Series struct for InlineResponse200360Series
type InlineResponse200360Series struct {
...
func NewInlineResponse200360Series() *InlineResponse200360Series {
	this := InlineResponse200360Series{}
	return &this
}
...
func (o InlineResponse200360Series) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200360Series struct {
	value *InlineResponse200360Series
	isSet bool
}

func (v NullableInlineResponse200360Series) Get() *InlineResponse200360Series {
	return v.value
}

func (v *NullableInlineResponse200360Series) Set(val *InlineResponse200360Series) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200360Series) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200360Series) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200360Series(val *InlineResponse200360Series) *NullableInlineResponse200360Series {
	return &NullableInlineResponse200360Series{value: val, isSet: true}
}

func (v NullableInlineResponse200360Series) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200360Series) UnmarshalJSON(src []byte) error {
	v.isSet = true
