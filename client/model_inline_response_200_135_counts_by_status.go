...
// InlineResponse200135CountsByStatus byStatus
type InlineResponse200135CountsByStatus struct {
	// online count
...
func NewInlineResponse200135CountsByStatus() *InlineResponse200135CountsByStatus {
	this := InlineResponse200135CountsByStatus{}
	return &this
}
...
func (o InlineResponse200135CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200135CountsByStatus struct {
	value *InlineResponse200135CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200135CountsByStatus) Get() *InlineResponse200135CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200135CountsByStatus) Set(val *InlineResponse200135CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200135CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200135CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200135CountsByStatus(val *InlineResponse200135CountsByStatus) *NullableInlineResponse200135CountsByStatus {
	return &NullableInlineResponse200135CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200135CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200135CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
