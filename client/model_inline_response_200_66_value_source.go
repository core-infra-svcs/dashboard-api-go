...
// InlineResponse20066ValueSource Source of 'custom' type traffic filter
type InlineResponse20066ValueSource struct {
...
func NewInlineResponse20066ValueSource() *InlineResponse20066ValueSource {
	this := InlineResponse20066ValueSource{}
	return &this
}
...
func (o InlineResponse20066ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20066ValueSource struct {
	value *InlineResponse20066ValueSource
	isSet bool
}

func (v NullableInlineResponse20066ValueSource) Get() *InlineResponse20066ValueSource {
	return v.value
}

func (v *NullableInlineResponse20066ValueSource) Set(val *InlineResponse20066ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20066ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20066ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20066ValueSource(val *InlineResponse20066ValueSource) *NullableInlineResponse20066ValueSource {
	return &NullableInlineResponse20066ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20066ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20066ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
