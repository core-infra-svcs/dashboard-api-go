...
type InlineResponse200109 struct {
	...
	LocalStatusPage *InlineResponse200109LocalStatusPage `json:"localStatusPage,omitempty"`
	SecurePort *InlineResponse200109SecurePort `json:"securePort,omitempty"`
	Fips *InlineResponse200109Fips `json:"fips,omitempty"`
	NamedVlans *InlineResponse200109NamedVlans `json:"namedVlans,omitempty"`
}
...
func (o *InlineResponse200109) GetLocalStatusPage() InlineResponse200109LocalStatusPage {
	if o == nil || isNil(o.LocalStatusPage) {
		var ret InlineResponse200109LocalStatusPage
		return ret
	}
...
// SetLocalStatusPage gets a reference to the given InlineResponse200109LocalStatusPage and assigns it to the LocalStatusPage field.
...
func (o *InlineResponse200109) GetSecurePort() InlineResponse200109SecurePort {
	if o == nil || isNil(o.SecurePort) {
		var ret InlineResponse200109SecurePort
		return ret
	}
	return *o.SecurePort
}
...
// SetSecurePort gets a reference to the given InlineResponse200109SecurePort and assigns it to the SecurePort field.
...
func (o *InlineResponse200109) GetFips() InlineResponse200109Fips {
	if o == nil || isNil(o.Fips) {
		var ret InlineResponse200109Fips
		return ret
	}
	return *o.Fips
}
...
// SetFips gets a reference to the given InlineResponse200109Fips and assigns it to the Fips field.
...
func (o *InlineResponse200109) GetNamedVlans() InlineResponse200109NamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret InlineResponse200109NamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given InlineResponse200109NamedVlans and assigns it to the NamedVlans field.
