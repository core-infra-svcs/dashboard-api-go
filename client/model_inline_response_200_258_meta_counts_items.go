...
// InlineResponse200258MetaCountsItems Count of eSIM Devices available
type InlineResponse200258MetaCountsItems struct {
...
func NewInlineResponse200258MetaCountsItems() *InlineResponse200258MetaCountsItems {
	this := InlineResponse200258MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200258MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200258MetaCountsItems struct {
	value *InlineResponse200258MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200258MetaCountsItems) Get() *InlineResponse200258MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200258MetaCountsItems) Set(val *InlineResponse200258MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200258MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200258MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200258MetaCountsItems(val *InlineResponse200258MetaCountsItems) *NullableInlineResponse200258MetaCountsItems {
	return &NullableInlineResponse200258MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200258MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200258MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
