...
func (r QosRulesApiGetNetworkSwitchQosRuleRequest) Execute() (*InlineResponse20079, *http.Response, error) {
...
func (a *QosRulesApiService) GetNetworkSwitchQosRuleExecute(r QosRulesApiGetNetworkSwitchQosRuleRequest) (*InlineResponse20079, *http.Response, error) {
	var (
