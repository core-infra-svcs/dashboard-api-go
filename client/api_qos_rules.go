...
func (r QosRulesApiCreateNetworkSwitchQosRuleRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
func (a *QosRulesApiService) CreateNetworkSwitchQosRuleExecute(r QosRulesApiCreateNetworkSwitchQosRuleRequest) (*InlineResponse200159, *http.Response, error) {
	var (
...
func (r QosRulesApiGetNetworkSwitchQosRuleRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200159
func (a *QosRulesApiService) GetNetworkSwitchQosRuleExecute(r QosRulesApiGetNetworkSwitchQosRuleRequest) (*InlineResponse200159, *http.Response, error) {
	var (
...
func (r QosRulesApiGetNetworkSwitchQosRulesRequest) Execute() ([]InlineResponse200159, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200159
func (a *QosRulesApiService) GetNetworkSwitchQosRulesExecute(r QosRulesApiGetNetworkSwitchQosRulesRequest) ([]InlineResponse200159, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r QosRulesApiGetNetworkSwitchQosRulesOrderRequest) Execute() (*InlineResponse200160, *http.Response, error) {
...
func (a *QosRulesApiService) GetNetworkSwitchQosRulesOrderExecute(r QosRulesApiGetNetworkSwitchQosRulesOrderRequest) (*InlineResponse200160, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r QosRulesApiUpdateNetworkSwitchQosRuleRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200159
func (a *QosRulesApiService) UpdateNetworkSwitchQosRuleExecute(r QosRulesApiUpdateNetworkSwitchQosRuleRequest) (*InlineResponse200159, *http.Response, error) {
	var (
...
func (r QosRulesApiUpdateNetworkSwitchQosRulesOrderRequest) Execute() (*InlineResponse200160, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200160
func (a *QosRulesApiService) UpdateNetworkSwitchQosRulesOrderExecute(r QosRulesApiUpdateNetworkSwitchQosRulesOrderRequest) (*InlineResponse200160, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
