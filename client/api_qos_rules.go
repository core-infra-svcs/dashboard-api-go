...
func (r QosRulesApiGetNetworkSwitchQosRuleRequest) Execute() (*InlineResponse20078, *http.Response, error) {
...
func (a *QosRulesApiService) GetNetworkSwitchQosRuleExecute(r QosRulesApiGetNetworkSwitchQosRuleRequest) (*InlineResponse20078, *http.Response, error) {
	var (
