...
func (r QosRulesApiCreateNetworkSwitchQosRuleRequest) Execute() (*InlineResponse200148, *http.Response, error) {
...
func (a *QosRulesApiService) CreateNetworkSwitchQosRuleExecute(r QosRulesApiCreateNetworkSwitchQosRuleRequest) (*InlineResponse200148, *http.Response, error) {
	var (
...
func (r QosRulesApiGetNetworkSwitchQosRuleRequest) Execute() (*InlineResponse200148, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200148
func (a *QosRulesApiService) GetNetworkSwitchQosRuleExecute(r QosRulesApiGetNetworkSwitchQosRuleRequest) (*InlineResponse200148, *http.Response, error) {
	var (
...
func (r QosRulesApiGetNetworkSwitchQosRulesRequest) Execute() ([]InlineResponse200148, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200148
func (a *QosRulesApiService) GetNetworkSwitchQosRulesExecute(r QosRulesApiGetNetworkSwitchQosRulesRequest) ([]InlineResponse200148, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r QosRulesApiGetNetworkSwitchQosRulesOrderRequest) Execute() (*InlineResponse200149, *http.Response, error) {
...
func (a *QosRulesApiService) GetNetworkSwitchQosRulesOrderExecute(r QosRulesApiGetNetworkSwitchQosRulesOrderRequest) (*InlineResponse200149, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r QosRulesApiUpdateNetworkSwitchQosRuleRequest) Execute() (*InlineResponse200148, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200148
func (a *QosRulesApiService) UpdateNetworkSwitchQosRuleExecute(r QosRulesApiUpdateNetworkSwitchQosRuleRequest) (*InlineResponse200148, *http.Response, error) {
	var (
...
func (r QosRulesApiUpdateNetworkSwitchQosRulesOrderRequest) Execute() (*InlineResponse200149, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200149
func (a *QosRulesApiService) UpdateNetworkSwitchQosRulesOrderExecute(r QosRulesApiUpdateNetworkSwitchQosRulesOrderRequest) (*InlineResponse200149, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
