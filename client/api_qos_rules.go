...
func (r QosRulesApiGetNetworkSwitchQosRuleRequest) Execute() (*InlineResponse20086, *http.Response, error) {
...
func (a *QosRulesApiService) GetNetworkSwitchQosRuleExecute(r QosRulesApiGetNetworkSwitchQosRuleRequest) (*InlineResponse20086, *http.Response, error) {
	var (
