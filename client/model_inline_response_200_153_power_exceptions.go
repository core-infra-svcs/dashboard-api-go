...
// InlineResponse200153PowerExceptions struct for InlineResponse200153PowerExceptions
type InlineResponse200153PowerExceptions struct {
...
func NewInlineResponse200153PowerExceptions() *InlineResponse200153PowerExceptions {
	this := InlineResponse200153PowerExceptions{}
	return &this
}
...
func (o InlineResponse200153PowerExceptions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200153PowerExceptions struct {
	value *InlineResponse200153PowerExceptions
	isSet bool
}

func (v NullableInlineResponse200153PowerExceptions) Get() *InlineResponse200153PowerExceptions {
	return v.value
}

func (v *NullableInlineResponse200153PowerExceptions) Set(val *InlineResponse200153PowerExceptions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200153PowerExceptions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200153PowerExceptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200153PowerExceptions(val *InlineResponse200153PowerExceptions) *NullableInlineResponse200153PowerExceptions {
	return &NullableInlineResponse200153PowerExceptions{value: val, isSet: true}
}

func (v NullableInlineResponse200153PowerExceptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200153PowerExceptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
