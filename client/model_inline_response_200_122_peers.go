...
// InlineResponse200122Peers struct for InlineResponse200122Peers
type InlineResponse200122Peers struct {
	...
	IpsecPolicies *InlineResponse200122IpsecPolicies `json:"ipsecPolicies,omitempty"`
...
func NewInlineResponse200122Peers() *InlineResponse200122Peers {
	this := InlineResponse200122Peers{}
...
func (o *InlineResponse200122Peers) GetIpsecPolicies() InlineResponse200122IpsecPolicies {
	if o == nil || isNil(o.IpsecPolicies) {
		var ret InlineResponse200122IpsecPolicies
		return ret
	}
...
// SetIpsecPolicies gets a reference to the given InlineResponse200122IpsecPolicies and assigns it to the IpsecPolicies field.
...
func (o InlineResponse200122Peers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200122Peers struct {
	value *InlineResponse200122Peers
	isSet bool
}

func (v NullableInlineResponse200122Peers) Get() *InlineResponse200122Peers {
	return v.value
}

func (v *NullableInlineResponse200122Peers) Set(val *InlineResponse200122Peers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200122Peers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200122Peers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200122Peers(val *InlineResponse200122Peers) *NullableInlineResponse200122Peers {
	return &NullableInlineResponse200122Peers{value: val, isSet: true}
}

func (v NullableInlineResponse200122Peers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200122Peers) UnmarshalJSON(src []byte) error {
	v.isSet = true
