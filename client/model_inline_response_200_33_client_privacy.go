...
// InlineResponse20033ClientPrivacy Privacy settings
type InlineResponse20033ClientPrivacy struct {
...
func NewInlineResponse20033ClientPrivacy() *InlineResponse20033ClientPrivacy {
	this := InlineResponse20033ClientPrivacy{}
	return &this
}
...
func (o InlineResponse20033ClientPrivacy) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20033ClientPrivacy struct {
	value *InlineResponse20033ClientPrivacy
	isSet bool
}

func (v NullableInlineResponse20033ClientPrivacy) Get() *InlineResponse20033ClientPrivacy {
	return v.value
}

func (v *NullableInlineResponse20033ClientPrivacy) Set(val *InlineResponse20033ClientPrivacy) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20033ClientPrivacy) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20033ClientPrivacy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20033ClientPrivacy(val *InlineResponse20033ClientPrivacy) *NullableInlineResponse20033ClientPrivacy {
	return &NullableInlineResponse20033ClientPrivacy{value: val, isSet: true}
}

func (v NullableInlineResponse20033ClientPrivacy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20033ClientPrivacy) UnmarshalJSON(src []byte) error {
	v.isSet = true
