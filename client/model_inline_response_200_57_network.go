...
// InlineResponse20057Network Network details
type InlineResponse20057Network struct {
...
func NewInlineResponse20057Network(id string, name string) *InlineResponse20057Network {
	this := InlineResponse20057Network{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o InlineResponse20057Network) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20057Network struct {
	value *InlineResponse20057Network
	isSet bool
}

func (v NullableInlineResponse20057Network) Get() *InlineResponse20057Network {
	return v.value
}

func (v *NullableInlineResponse20057Network) Set(val *InlineResponse20057Network) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20057Network) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20057Network) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20057Network(val *InlineResponse20057Network) *NullableInlineResponse20057Network {
	return &NullableInlineResponse20057Network{value: val, isSet: true}
}

func (v NullableInlineResponse20057Network) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20057Network) UnmarshalJSON(src []byte) error {
	v.isSet = true
