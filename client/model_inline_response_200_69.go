...
type InlineResponse20069 struct {
	...
	Hubs []InlineResponse20069Hubs `json:"hubs,omitempty"`
	// The list of subnets and their VPN presence.
	Subnets []InlineResponse20069Subnets `json:"subnets,omitempty"`
}
...
func (o *InlineResponse20069) GetHubs() []InlineResponse20069Hubs {
	if o == nil || isNil(o.Hubs) {
		var ret []InlineResponse20069Hubs
		return ret
	}
	return o.Hubs
}
...
// SetHubs gets a reference to the given []InlineResponse20069Hubs and assigns it to the Hubs field.
...
func (o *InlineResponse20069) GetSubnets() []InlineResponse20069Subnets {
	if o == nil || isNil(o.Subnets) {
		var ret []InlineResponse20069Subnets
		return ret
	}
	return o.Subnets
}
...
// SetSubnets gets a reference to the given []InlineResponse20069Subnets and assigns it to the Subnets field.
