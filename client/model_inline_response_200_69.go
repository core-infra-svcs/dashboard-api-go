...
type InlineResponse20069 struct {
	...
	MandatoryDhcp *InlineResponse20069MandatoryDhcp `json:"mandatoryDhcp,omitempty"`
...
func (o *InlineResponse20069) GetMandatoryDhcp() InlineResponse20069MandatoryDhcp {
	if o == nil || isNil(o.MandatoryDhcp) {
		var ret InlineResponse20069MandatoryDhcp
		return ret
	}
...
// SetMandatoryDhcp gets a reference to the given InlineResponse20069MandatoryDhcp and assigns it to the MandatoryDhcp field.
