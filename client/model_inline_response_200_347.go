...
func (o *InlineResponse200347) GetEstimatedCompletedAt() string {
...
func (o *InlineResponse200347) GetEstimatedCompletedAtOk() (*string, bool) {
	if o == nil || isNil(o.EstimatedCompletedAt) {
    return nil, false
	}
...
func (o *InlineResponse200347) HasEstimatedCompletedAt() bool {
	if o != nil && !isNil(o.EstimatedCompletedAt) {
		return true
	}
...
func (o *InlineResponse200347) SetEstimatedCompletedAt(v string) {
