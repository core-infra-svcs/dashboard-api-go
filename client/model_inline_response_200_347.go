...
type InlineResponse200347 struct {
	...
	Example *InlineResponse200347Example `json:"example,omitempty"`
}
...
func (o *InlineResponse200347) GetExample() InlineResponse200347Example {
	if o == nil || isNil(o.Example) {
		var ret InlineResponse200347Example
		return ret
	}
	return *o.Example
}
...
// SetExample gets a reference to the given InlineResponse200347Example and assigns it to the Example field.
