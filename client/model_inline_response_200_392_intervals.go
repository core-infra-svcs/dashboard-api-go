...
// InlineResponse200392Intervals struct for InlineResponse200392Intervals
type InlineResponse200392Intervals struct {
	// The start time of the query range with iso8601 format
	StartTs *string `json:"startTs,omitempty"`
	// The end time of the query range  with iso8601 format
	EndTs *string `json:"endTs,omitempty"`
	Overall *InlineResponse200392Overall `json:"overall,omitempty"`
	// The CPU usage per core of the wireless LAN controller
	ByCore []InlineResponse200392ByCore `json:"byCore,omitempty"`
}
...
func NewInlineResponse200392Intervals() *InlineResponse200392Intervals {
	this := InlineResponse200392Intervals{}
	return &this
}
...
func (o *InlineResponse200392Intervals) GetOverall() InlineResponse200392Overall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200392Overall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200392Overall and assigns it to the Overall field.
...
func (o *InlineResponse200392Intervals) GetByCore() []InlineResponse200392ByCore {
	if o == nil || isNil(o.ByCore) {
		var ret []InlineResponse200392ByCore
		return ret
	}
	return o.ByCore
}
...
// SetByCore gets a reference to the given []InlineResponse200392ByCore and assigns it to the ByCore field.
func (o *InlineResponse200392Intervals) SetByCore(v []InlineResponse200392ByCore) {
	o.ByCore = v
}

func (o InlineResponse200392Intervals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200392Intervals struct {
	value *InlineResponse200392Intervals
	isSet bool
}

func (v NullableInlineResponse200392Intervals) Get() *InlineResponse200392Intervals {
	return v.value
}

func (v *NullableInlineResponse200392Intervals) Set(val *InlineResponse200392Intervals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200392Intervals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200392Intervals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200392Intervals(val *InlineResponse200392Intervals) *NullableInlineResponse200392Intervals {
	return &NullableInlineResponse200392Intervals{value: val, isSet: true}
}

func (v NullableInlineResponse200392Intervals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200392Intervals) UnmarshalJSON(src []byte) error {
	v.isSet = true
