...
// InlineResponse20097Events struct for InlineResponse20097Events
type InlineResponse20097Events struct {
	...
	EventData *InlineResponse20097EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20097Events() *InlineResponse20097Events {
	this := InlineResponse20097Events{}
	return &this
}
...
func (o *InlineResponse20097Events) GetEventData() InlineResponse20097EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20097EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20097EventData and assigns it to the EventData field.
func (o *InlineResponse20097Events) SetEventData(v InlineResponse20097EventData) {
	o.EventData = &v
}

func (o InlineResponse20097Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20097Events struct {
	value *InlineResponse20097Events
	isSet bool
}

func (v NullableInlineResponse20097Events) Get() *InlineResponse20097Events {
	return v.value
}

func (v *NullableInlineResponse20097Events) Set(val *InlineResponse20097Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20097Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20097Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20097Events(val *InlineResponse20097Events) *NullableInlineResponse20097Events {
	return &NullableInlineResponse20097Events{value: val, isSet: true}
}

func (v NullableInlineResponse20097Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20097Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
