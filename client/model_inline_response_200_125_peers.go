...
// InlineResponse200125Peers struct for InlineResponse200125Peers
type InlineResponse200125Peers struct {
	...
	IpsecPolicies *InlineResponse200125IpsecPolicies `json:"ipsecPolicies,omitempty"`
...
func NewInlineResponse200125Peers() *InlineResponse200125Peers {
	this := InlineResponse200125Peers{}
...
func (o *InlineResponse200125Peers) GetIpsecPolicies() InlineResponse200125IpsecPolicies {
	if o == nil || isNil(o.IpsecPolicies) {
		var ret InlineResponse200125IpsecPolicies
		return ret
	}
...
// SetIpsecPolicies gets a reference to the given InlineResponse200125IpsecPolicies and assigns it to the IpsecPolicies field.
...
func (o InlineResponse200125Peers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200125Peers struct {
	value *InlineResponse200125Peers
	isSet bool
}

func (v NullableInlineResponse200125Peers) Get() *InlineResponse200125Peers {
	return v.value
}

func (v *NullableInlineResponse200125Peers) Set(val *InlineResponse200125Peers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200125Peers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200125Peers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200125Peers(val *InlineResponse200125Peers) *NullableInlineResponse200125Peers {
	return &NullableInlineResponse200125Peers{value: val, isSet: true}
}

func (v NullableInlineResponse200125Peers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200125Peers) UnmarshalJSON(src []byte) error {
	v.isSet = true
