...
// InlineResponse200233CountsByStatus byStatus
type InlineResponse200233CountsByStatus struct {
...
func NewInlineResponse200233CountsByStatus() *InlineResponse200233CountsByStatus {
	this := InlineResponse200233CountsByStatus{}
	return &this
}
...
func (o InlineResponse200233CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200233CountsByStatus struct {
	value *InlineResponse200233CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200233CountsByStatus) Get() *InlineResponse200233CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200233CountsByStatus) Set(val *InlineResponse200233CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200233CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200233CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200233CountsByStatus(val *InlineResponse200233CountsByStatus) *NullableInlineResponse200233CountsByStatus {
	return &NullableInlineResponse200233CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200233CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200233CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
