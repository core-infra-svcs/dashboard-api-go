...
// InlineResponse20024BasicServiceSets struct for InlineResponse20024BasicServiceSets
type InlineResponse20024BasicServiceSets struct {
...
func NewInlineResponse20024BasicServiceSets() *InlineResponse20024BasicServiceSets {
	this := InlineResponse20024BasicServiceSets{}
	return &this
}
...
func (o InlineResponse20024BasicServiceSets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20024BasicServiceSets struct {
	value *InlineResponse20024BasicServiceSets
	isSet bool
}

func (v NullableInlineResponse20024BasicServiceSets) Get() *InlineResponse20024BasicServiceSets {
	return v.value
}

func (v *NullableInlineResponse20024BasicServiceSets) Set(val *InlineResponse20024BasicServiceSets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20024BasicServiceSets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20024BasicServiceSets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20024BasicServiceSets(val *InlineResponse20024BasicServiceSets) *NullableInlineResponse20024BasicServiceSets {
	return &NullableInlineResponse20024BasicServiceSets{value: val, isSet: true}
}

func (v NullableInlineResponse20024BasicServiceSets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20024BasicServiceSets) UnmarshalJSON(src []byte) error {
	v.isSet = true
