...
// InlineResponse200313Example Example alert type
type InlineResponse200313Example struct {
...
func NewInlineResponse200313Example() *InlineResponse200313Example {
	this := InlineResponse200313Example{}
	return &this
}
...
func (o InlineResponse200313Example) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200313Example struct {
	value *InlineResponse200313Example
	isSet bool
}

func (v NullableInlineResponse200313Example) Get() *InlineResponse200313Example {
	return v.value
}

func (v *NullableInlineResponse200313Example) Set(val *InlineResponse200313Example) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200313Example) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200313Example) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200313Example(val *InlineResponse200313Example) *NullableInlineResponse200313Example {
	return &NullableInlineResponse200313Example{value: val, isSet: true}
}

func (v NullableInlineResponse200313Example) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200313Example) UnmarshalJSON(src []byte) error {
	v.isSet = true
