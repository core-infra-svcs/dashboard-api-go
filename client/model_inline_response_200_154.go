...
type InlineResponse200154 struct {
	Alerts *InlineResponse200154Alerts `json:"alerts,omitempty"`
	...
	ArpInspection *InlineResponse200154ArpInspection `json:"arpInspection,omitempty"`
}
...
func (o *InlineResponse200154) GetAlerts() InlineResponse200154Alerts {
	if o == nil || isNil(o.Alerts) {
		var ret InlineResponse200154Alerts
		return ret
	}
	return *o.Alerts
}
...
// SetAlerts gets a reference to the given InlineResponse200154Alerts and assigns it to the Alerts field.
...
func (o *InlineResponse200154) GetArpInspection() InlineResponse200154ArpInspection {
	if o == nil || isNil(o.ArpInspection) {
		var ret InlineResponse200154ArpInspection
		return ret
	}
...
// SetArpInspection gets a reference to the given InlineResponse200154ArpInspection and assigns it to the ArpInspection field.
