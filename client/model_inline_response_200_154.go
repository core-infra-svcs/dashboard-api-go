...
type InlineResponse200154 struct {
	...
	PowerExceptions []InlineResponse200154PowerExceptions `json:"powerExceptions,omitempty"`
	UplinkClientSampling *InlineResponse200154UplinkClientSampling `json:"uplinkClientSampling,omitempty"`
	MacBlocklist *InlineResponse200154MacBlocklist `json:"macBlocklist,omitempty"`
}
...
func (o *InlineResponse200154) GetPowerExceptions() []InlineResponse200154PowerExceptions {
	if o == nil || isNil(o.PowerExceptions) {
		var ret []InlineResponse200154PowerExceptions
		return ret
	}
...
// SetPowerExceptions gets a reference to the given []InlineResponse200154PowerExceptions and assigns it to the PowerExceptions field.
...
func (o *InlineResponse200154) GetUplinkClientSampling() InlineResponse200154UplinkClientSampling {
	if o == nil || isNil(o.UplinkClientSampling) {
		var ret InlineResponse200154UplinkClientSampling
		return ret
	}
...
// SetUplinkClientSampling gets a reference to the given InlineResponse200154UplinkClientSampling and assigns it to the UplinkClientSampling field.
...
func (o *InlineResponse200154) GetMacBlocklist() InlineResponse200154MacBlocklist {
	if o == nil || isNil(o.MacBlocklist) {
		var ret InlineResponse200154MacBlocklist
		return ret
	}
...
// SetMacBlocklist gets a reference to the given InlineResponse200154MacBlocklist and assigns it to the MacBlocklist field.
