...
// InlineResponse200305Policies struct for InlineResponse200305Policies
type InlineResponse200305Policies struct {
...
func NewInlineResponse200305Policies() *InlineResponse200305Policies {
	this := InlineResponse200305Policies{}
	return &this
}
...
func (o InlineResponse200305Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200305Policies struct {
	value *InlineResponse200305Policies
	isSet bool
}

func (v NullableInlineResponse200305Policies) Get() *InlineResponse200305Policies {
	return v.value
}

func (v *NullableInlineResponse200305Policies) Set(val *InlineResponse200305Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200305Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200305Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200305Policies(val *InlineResponse200305Policies) *NullableInlineResponse200305Policies {
	return &NullableInlineResponse200305Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200305Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200305Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
