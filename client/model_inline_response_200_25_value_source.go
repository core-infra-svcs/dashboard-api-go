...
// InlineResponse20025ValueSource Source of 'custom' type traffic filter
type InlineResponse20025ValueSource struct {
...
func NewInlineResponse20025ValueSource() *InlineResponse20025ValueSource {
	this := InlineResponse20025ValueSource{}
	return &this
}
...
func (o InlineResponse20025ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20025ValueSource struct {
	value *InlineResponse20025ValueSource
	isSet bool
}

func (v NullableInlineResponse20025ValueSource) Get() *InlineResponse20025ValueSource {
	return v.value
}

func (v *NullableInlineResponse20025ValueSource) Set(val *InlineResponse20025ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20025ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20025ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20025ValueSource(val *InlineResponse20025ValueSource) *NullableInlineResponse20025ValueSource {
	return &NullableInlineResponse20025ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20025ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20025ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
