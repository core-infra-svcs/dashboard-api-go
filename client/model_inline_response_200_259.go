...
type InlineResponse200259 struct {
	ResultingNetwork *InlineResponse200259ResultingNetwork `json:"resultingNetwork,omitempty"`
}
...
func (o *InlineResponse200259) GetResultingNetwork() InlineResponse200259ResultingNetwork {
	if o == nil || isNil(o.ResultingNetwork) {
		var ret InlineResponse200259ResultingNetwork
		return ret
	}
...
// SetResultingNetwork gets a reference to the given InlineResponse200259ResultingNetwork and assigns it to the ResultingNetwork field.
