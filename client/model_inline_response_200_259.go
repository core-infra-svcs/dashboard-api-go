...
type InlineResponse200259 struct {
	...
	LimitScopeToNetworks []InlineResponse200259LimitScopeToNetworks `json:"limitScopeToNetworks,omitempty"`
	OptOutEligibility *InlineResponse200259OptOutEligibility `json:"optOutEligibility,omitempty"`
...
func (o *InlineResponse200259) GetLimitScopeToNetworks() []InlineResponse200259LimitScopeToNetworks {
	if o == nil || isNil(o.LimitScopeToNetworks) {
		var ret []InlineResponse200259LimitScopeToNetworks
		return ret
	}
...
// SetLimitScopeToNetworks gets a reference to the given []InlineResponse200259LimitScopeToNetworks and assigns it to the LimitScopeToNetworks field.
...
func (o *InlineResponse200259) GetOptOutEligibility() InlineResponse200259OptOutEligibility {
	if o == nil || isNil(o.OptOutEligibility) {
		var ret InlineResponse200259OptOutEligibility
		return ret
	}
...
// SetOptOutEligibility gets a reference to the given InlineResponse200259OptOutEligibility and assigns it to the OptOutEligibility field.
