...
// InlineResponse20065Value1 Value of traffic filter
type InlineResponse20065Value1 struct {
	...
	Source *InlineResponse20065Value1Source `json:"source,omitempty"`
	Destination *InlineResponse20065Value1Destination `json:"destination,omitempty"`
}
...
func NewInlineResponse20065Value1() *InlineResponse20065Value1 {
	this := InlineResponse20065Value1{}
	return &this
}
...
func (o *InlineResponse20065Value1) GetSource() InlineResponse20065Value1Source {
	if o == nil || isNil(o.Source) {
		var ret InlineResponse20065Value1Source
		return ret
	}
	return *o.Source
}
...
// SetSource gets a reference to the given InlineResponse20065Value1Source and assigns it to the Source field.
...
func (o *InlineResponse20065Value1) GetDestination() InlineResponse20065Value1Destination {
	if o == nil || isNil(o.Destination) {
		var ret InlineResponse20065Value1Destination
		return ret
	}
...
// SetDestination gets a reference to the given InlineResponse20065Value1Destination and assigns it to the Destination field.
func (o *InlineResponse20065Value1) SetDestination(v InlineResponse20065Value1Destination) {
	o.Destination = &v
}

func (o InlineResponse20065Value1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20065Value1 struct {
	value *InlineResponse20065Value1
	isSet bool
}

func (v NullableInlineResponse20065Value1) Get() *InlineResponse20065Value1 {
	return v.value
}

func (v *NullableInlineResponse20065Value1) Set(val *InlineResponse20065Value1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20065Value1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20065Value1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20065Value1(val *InlineResponse20065Value1) *NullableInlineResponse20065Value1 {
	return &NullableInlineResponse20065Value1{value: val, isSet: true}
}

func (v NullableInlineResponse20065Value1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20065Value1) UnmarshalJSON(src []byte) error {
	v.isSet = true
