...
func NewInlineObject176(defaultPolicy string) *InlineObject176 {
...
func (o *InlineObject176) GetDefaultPolicy() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InlineObject176) GetDefaultPolicyOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *InlineObject176) SetDefaultPolicy(v string) {
	o.DefaultPolicy = v
}
