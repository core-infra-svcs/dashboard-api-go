...
func (r LanApiGetDeviceCellularGatewayLanRequest) Execute() (*InlineResponse20019, *http.Response, error) {
...
func (a *LanApiService) GetDeviceCellularGatewayLanExecute(r LanApiGetDeviceCellularGatewayLanRequest) (*InlineResponse20019, *http.Response, error) {
	var (
...
func (r LanApiUpdateDeviceCellularGatewayLanRequest) UpdateDeviceCellularGatewayLan(updateDeviceCellularGatewayLan InlineObject14) LanApiUpdateDeviceCellularGatewayLanRequest {
	r.updateDeviceCellularGatewayLan = &updateDeviceCellularGatewayLan
	return r
}

func (r LanApiUpdateDeviceCellularGatewayLanRequest) Execute() (*InlineResponse20019, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20019
func (a *LanApiService) UpdateDeviceCellularGatewayLanExecute(r LanApiUpdateDeviceCellularGatewayLanRequest) (*InlineResponse20019, *http.Response, error) {
	var (
