...
func (r LanApiGetDeviceCellularGatewayLanRequest) Execute() (*InlineResponse20024, *http.Response, error) {
...
func (a *LanApiService) GetDeviceCellularGatewayLanExecute(r LanApiGetDeviceCellularGatewayLanRequest) (*InlineResponse20024, *http.Response, error) {
	var (
...
func (r LanApiUpdateDeviceCellularGatewayLanRequest) Execute() (*InlineResponse20024, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20024
func (a *LanApiService) UpdateDeviceCellularGatewayLanExecute(r LanApiUpdateDeviceCellularGatewayLanRequest) (*InlineResponse20024, *http.Response, error) {
	var (
