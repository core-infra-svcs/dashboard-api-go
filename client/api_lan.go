...
func (r LanApiGetDeviceCellularGatewayLanRequest) Execute() (*InlineResponse20016, *http.Response, error) {
...
func (a *LanApiService) GetDeviceCellularGatewayLanExecute(r LanApiGetDeviceCellularGatewayLanRequest) (*InlineResponse20016, *http.Response, error) {
	var (
...
func (r LanApiUpdateDeviceCellularGatewayLanRequest) Execute() (*InlineResponse20016, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20016
func (a *LanApiService) UpdateDeviceCellularGatewayLanExecute(r LanApiUpdateDeviceCellularGatewayLanRequest) (*InlineResponse20016, *http.Response, error) {
	var (
