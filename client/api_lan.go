...
func (r LanApiGetDeviceCellularGatewayLanRequest) Execute() (*InlineResponse20017, *http.Response, error) {
...
func (a *LanApiService) GetDeviceCellularGatewayLanExecute(r LanApiGetDeviceCellularGatewayLanRequest) (*InlineResponse20017, *http.Response, error) {
	var (
...
func (r LanApiUpdateDeviceCellularGatewayLanRequest) Execute() (*InlineResponse20017, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20017
func (a *LanApiService) UpdateDeviceCellularGatewayLanExecute(r LanApiUpdateDeviceCellularGatewayLanRequest) (*InlineResponse20017, *http.Response, error) {
	var (
