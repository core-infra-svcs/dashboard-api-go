...
type InlineResponse20032 struct {
	...
	ClientVpnConnections []InlineResponse20032ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20032) GetClientVpnConnections() []InlineResponse20032ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20032ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20032ClientVpnConnections and assigns it to the ClientVpnConnections field.
