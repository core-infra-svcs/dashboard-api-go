...
type InlineResponse20032 struct {
	...
	Hubs []InlineResponse20032Hubs `json:"hubs,omitempty"`
	// The list of subnets and their VPN presence.
	Subnets []InlineResponse20032Subnets `json:"subnets,omitempty"`
}
...
func (o *InlineResponse20032) GetHubs() []InlineResponse20032Hubs {
	if o == nil || isNil(o.Hubs) {
		var ret []InlineResponse20032Hubs
		return ret
	}
	return o.Hubs
}
...
// SetHubs gets a reference to the given []InlineResponse20032Hubs and assigns it to the Hubs field.
...
func (o *InlineResponse20032) GetSubnets() []InlineResponse20032Subnets {
	if o == nil || isNil(o.Subnets) {
		var ret []InlineResponse20032Subnets
		return ret
	}
	return o.Subnets
}
...
// SetSubnets gets a reference to the given []InlineResponse20032Subnets and assigns it to the Subnets field.
