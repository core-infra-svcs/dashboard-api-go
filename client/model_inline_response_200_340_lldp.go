...
// InlineResponse200340Lldp struct for InlineResponse200340Lldp
type InlineResponse200340Lldp struct {
...
func (o InlineResponse200340Lldp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200340Lldp struct {
	value *InlineResponse200340Lldp
	isSet bool
}

func (v NullableInlineResponse200340Lldp) Get() *InlineResponse200340Lldp {
	return v.value
}

func (v *NullableInlineResponse200340Lldp) Set(val *InlineResponse200340Lldp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200340Lldp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200340Lldp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200340Lldp(val *InlineResponse200340Lldp) *NullableInlineResponse200340Lldp {
	return &NullableInlineResponse200340Lldp{value: val, isSet: true}
}

func (v NullableInlineResponse200340Lldp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200340Lldp) UnmarshalJSON(src []byte) error {
	v.isSet = true
