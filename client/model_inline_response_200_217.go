...
type InlineResponse200217 struct {
	ResponseCodeCounts *InlineResponse200217ResponseCodeCounts `json:"responseCodeCounts,omitempty"`
}
...
func (o *InlineResponse200217) GetResponseCodeCounts() InlineResponse200217ResponseCodeCounts {
	if o == nil || isNil(o.ResponseCodeCounts) {
		var ret InlineResponse200217ResponseCodeCounts
		return ret
	}
...
// SetResponseCodeCounts gets a reference to the given InlineResponse200217ResponseCodeCounts and assigns it to the ResponseCodeCounts field.
