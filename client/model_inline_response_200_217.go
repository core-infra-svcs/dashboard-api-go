...
type InlineResponse200217 struct {
	...
	SplashLogo *InlineResponse200217SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200217SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200217SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200217GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200217Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200217SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200217SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200217) GetSplashLogo() InlineResponse200217SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200217SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200217SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200217) GetSplashImage() InlineResponse200217SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200217SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200217SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200217) GetSplashPrepaidFront() InlineResponse200217SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200217SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200217SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200217) GetGuestSponsorship() InlineResponse200217GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200217GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200217GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200217) GetBilling() InlineResponse200217Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200217Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200217Billing and assigns it to the Billing field.
...
func (o *InlineResponse200217) GetSentryEnrollment() InlineResponse200217SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200217SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200217SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200217) GetSelfRegistration() InlineResponse200217SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200217SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200217SelfRegistration and assigns it to the SelfRegistration field.
