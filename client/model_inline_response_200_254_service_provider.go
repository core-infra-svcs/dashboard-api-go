...
// InlineResponse200254ServiceProvider Service Provider information
type InlineResponse200254ServiceProvider struct {
	// Service Provider name
	Name *string `json:"name,omitempty"`
	// Plans currently active on the eSIM
	Plans []InlineResponse200254ServiceProviderPlans `json:"plans,omitempty"`
}
...
func NewInlineResponse200254ServiceProvider() *InlineResponse200254ServiceProvider {
	this := InlineResponse200254ServiceProvider{}
	return &this
}
...
func (o *InlineResponse200254ServiceProvider) GetPlans() []InlineResponse200254ServiceProviderPlans {
	if o == nil || isNil(o.Plans) {
		var ret []InlineResponse200254ServiceProviderPlans
		return ret
	}
	return o.Plans
}
...
// SetPlans gets a reference to the given []InlineResponse200254ServiceProviderPlans and assigns it to the Plans field.
func (o *InlineResponse200254ServiceProvider) SetPlans(v []InlineResponse200254ServiceProviderPlans) {
	o.Plans = v
}

func (o InlineResponse200254ServiceProvider) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200254ServiceProvider struct {
	value *InlineResponse200254ServiceProvider
	isSet bool
}

func (v NullableInlineResponse200254ServiceProvider) Get() *InlineResponse200254ServiceProvider {
	return v.value
}

func (v *NullableInlineResponse200254ServiceProvider) Set(val *InlineResponse200254ServiceProvider) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200254ServiceProvider) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200254ServiceProvider) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200254ServiceProvider(val *InlineResponse200254ServiceProvider) *NullableInlineResponse200254ServiceProvider {
	return &NullableInlineResponse200254ServiceProvider{value: val, isSet: true}
}

func (v NullableInlineResponse200254ServiceProvider) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200254ServiceProvider) UnmarshalJSON(src []byte) error {
	v.isSet = true
