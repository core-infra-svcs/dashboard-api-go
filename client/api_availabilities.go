...
func (r AvailabilitiesApiGetOrganizationDevicesAvailabilitiesRequest) Execute() ([]InlineResponse200281, *http.Response, error) {
...
func (a *AvailabilitiesApiService) GetOrganizationDevicesAvailabilitiesExecute(r AvailabilitiesApiGetOrganizationDevicesAvailabilitiesRequest) ([]InlineResponse200281, *http.Response, error) {
	var (
...
func (r AvailabilitiesApiGetOrganizationDevicesAvailabilitiesChangeHistoryRequest) Execute() ([]InlineResponse200282, *http.Response, error) {
...
func (a *AvailabilitiesApiService) GetOrganizationDevicesAvailabilitiesChangeHistoryExecute(r AvailabilitiesApiGetOrganizationDevicesAvailabilitiesChangeHistoryRequest) ([]InlineResponse200282, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AvailabilitiesApiGetOrganizationWirelessControllerAvailabilitiesChangeHistoryRequest) Execute() (*InlineResponse200390, *http.Response, error) {
...
func (a *AvailabilitiesApiService) GetOrganizationWirelessControllerAvailabilitiesChangeHistoryExecute(r AvailabilitiesApiGetOrganizationWirelessControllerAvailabilitiesChangeHistoryRequest) (*InlineResponse200390, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
