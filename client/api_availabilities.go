...
func (r AvailabilitiesApiGetOrganizationDevicesAvailabilitiesRequest) Execute() ([]InlineResponse200123, *http.Response, error) {
...
func (a *AvailabilitiesApiService) GetOrganizationDevicesAvailabilitiesExecute(r AvailabilitiesApiGetOrganizationDevicesAvailabilitiesRequest) ([]InlineResponse200123, *http.Response, error) {
	var (
...
func (r AvailabilitiesApiGetOrganizationDevicesAvailabilitiesChangeHistoryRequest) Execute() ([]InlineResponse200124, *http.Response, error) {
...
func (a *AvailabilitiesApiService) GetOrganizationDevicesAvailabilitiesChangeHistoryExecute(r AvailabilitiesApiGetOrganizationDevicesAvailabilitiesChangeHistoryRequest) ([]InlineResponse200124, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
