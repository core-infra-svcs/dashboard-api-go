...
func (r AvailabilitiesApiGetOrganizationDevicesAvailabilitiesRequest) Execute() ([]InlineResponse200274, *http.Response, error) {
...
func (a *AvailabilitiesApiService) GetOrganizationDevicesAvailabilitiesExecute(r AvailabilitiesApiGetOrganizationDevicesAvailabilitiesRequest) ([]InlineResponse200274, *http.Response, error) {
	var (
...
func (r AvailabilitiesApiGetOrganizationDevicesAvailabilitiesChangeHistoryRequest) Execute() ([]InlineResponse200275, *http.Response, error) {
...
func (a *AvailabilitiesApiService) GetOrganizationDevicesAvailabilitiesChangeHistoryExecute(r AvailabilitiesApiGetOrganizationDevicesAvailabilitiesChangeHistoryRequest) ([]InlineResponse200275, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AvailabilitiesApiGetOrganizationWirelessControllerAvailabilitiesChangeHistoryRequest) Execute() (*InlineResponse200381, *http.Response, error) {
...
func (a *AvailabilitiesApiService) GetOrganizationWirelessControllerAvailabilitiesChangeHistoryExecute(r AvailabilitiesApiGetOrganizationWirelessControllerAvailabilitiesChangeHistoryRequest) (*InlineResponse200381, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
