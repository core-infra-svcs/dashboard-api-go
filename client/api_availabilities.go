...
func (r AvailabilitiesApiGetOrganizationWirelessControllerAvailabilitiesChangeHistoryRequest) Execute() (*InlineResponse200379, *http.Response, error) {
...
func (a *AvailabilitiesApiService) GetOrganizationWirelessControllerAvailabilitiesChangeHistoryExecute(r AvailabilitiesApiGetOrganizationWirelessControllerAvailabilitiesChangeHistoryRequest) (*InlineResponse200379, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
