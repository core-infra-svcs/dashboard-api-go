...
// InlineResponse200149Overrides struct for InlineResponse200149Overrides
type InlineResponse200149Overrides struct {
...
func NewInlineResponse200149Overrides(mtuSize int32) *InlineResponse200149Overrides {
	this := InlineResponse200149Overrides{}
...
func (o InlineResponse200149Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200149Overrides struct {
	value *InlineResponse200149Overrides
	isSet bool
}

func (v NullableInlineResponse200149Overrides) Get() *InlineResponse200149Overrides {
	return v.value
}

func (v *NullableInlineResponse200149Overrides) Set(val *InlineResponse200149Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200149Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200149Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200149Overrides(val *InlineResponse200149Overrides) *NullableInlineResponse200149Overrides {
	return &NullableInlineResponse200149Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse200149Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200149Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
