...
type InlineResponse20026 struct {
	UpgradeWindow *InlineResponse20026UpgradeWindow `json:"upgradeWindow,omitempty"`
...
func (o *InlineResponse20026) GetUpgradeWindow() InlineResponse20026UpgradeWindow {
	if o == nil || isNil(o.UpgradeWindow) {
		var ret InlineResponse20026UpgradeWindow
		return ret
	}
...
// SetUpgradeWindow gets a reference to the given InlineResponse20026UpgradeWindow and assigns it to the UpgradeWindow field.
