...
type InlineResponse20026 struct {
	BandwidthLimits *InlineResponse20026BandwidthLimits `json:"bandwidthLimits,omitempty"`
}
...
func (o *InlineResponse20026) GetBandwidthLimits() InlineResponse20026BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse20026BandwidthLimits
		return ret
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse20026BandwidthLimits and assigns it to the BandwidthLimits field.
