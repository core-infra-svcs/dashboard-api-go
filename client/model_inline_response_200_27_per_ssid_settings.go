...
// InlineResponse20027PerSsidSettings Per-SSID radio settings by number.
type InlineResponse20027PerSsidSettings struct {
	Var1 *InlineResponse20027PerSsidSettings1 `json:"1,omitempty"`
	Var2 *InlineResponse20027PerSsidSettings2 `json:"2,omitempty"`
	Var3 *InlineResponse20027PerSsidSettings3 `json:"3,omitempty"`
	Var4 *InlineResponse20027PerSsidSettings4 `json:"4,omitempty"`
}
...
func NewInlineResponse20027PerSsidSettings() *InlineResponse20027PerSsidSettings {
	this := InlineResponse20027PerSsidSettings{}
	return &this
}
...
func (o *InlineResponse20027PerSsidSettings) GetVar1() InlineResponse20027PerSsidSettings1 {
	if o == nil || isNil(o.Var1) {
		var ret InlineResponse20027PerSsidSettings1
		return ret
	}
	return *o.Var1
}
...
// SetVar1 gets a reference to the given InlineResponse20027PerSsidSettings1 and assigns it to the Var1 field.
...
func (o *InlineResponse20027PerSsidSettings) GetVar2() InlineResponse20027PerSsidSettings2 {
	if o == nil || isNil(o.Var2) {
		var ret InlineResponse20027PerSsidSettings2
		return ret
	}
	return *o.Var2
}
...
// SetVar2 gets a reference to the given InlineResponse20027PerSsidSettings2 and assigns it to the Var2 field.
...
func (o *InlineResponse20027PerSsidSettings) GetVar3() InlineResponse20027PerSsidSettings3 {
	if o == nil || isNil(o.Var3) {
		var ret InlineResponse20027PerSsidSettings3
		return ret
	}
	return *o.Var3
}
...
// SetVar3 gets a reference to the given InlineResponse20027PerSsidSettings3 and assigns it to the Var3 field.
...
func (o *InlineResponse20027PerSsidSettings) GetVar4() InlineResponse20027PerSsidSettings4 {
	if o == nil || isNil(o.Var4) {
		var ret InlineResponse20027PerSsidSettings4
		return ret
	}
	return *o.Var4
}
...
// SetVar4 gets a reference to the given InlineResponse20027PerSsidSettings4 and assigns it to the Var4 field.
func (o *InlineResponse20027PerSsidSettings) SetVar4(v InlineResponse20027PerSsidSettings4) {
	o.Var4 = &v
}

func (o InlineResponse20027PerSsidSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20027PerSsidSettings struct {
	value *InlineResponse20027PerSsidSettings
	isSet bool
}

func (v NullableInlineResponse20027PerSsidSettings) Get() *InlineResponse20027PerSsidSettings {
	return v.value
}

func (v *NullableInlineResponse20027PerSsidSettings) Set(val *InlineResponse20027PerSsidSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20027PerSsidSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20027PerSsidSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20027PerSsidSettings(val *InlineResponse20027PerSsidSettings) *NullableInlineResponse20027PerSsidSettings {
	return &NullableInlineResponse20027PerSsidSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20027PerSsidSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20027PerSsidSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
