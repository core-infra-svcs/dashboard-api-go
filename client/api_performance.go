...
func (r PerformanceApiGetDeviceAppliancePerformanceRequest) Execute() (*InlineResponse2008, *http.Response, error) {
...
func (a *PerformanceApiService) GetDeviceAppliancePerformanceExecute(r PerformanceApiGetDeviceAppliancePerformanceRequest) (*InlineResponse2008, *http.Response, error) {
	var (
