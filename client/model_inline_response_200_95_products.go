...
// InlineResponse20095Products The network devices to be updated
type InlineResponse20095Products struct {
	Wireless *InlineResponse20095ProductsWireless `json:"wireless,omitempty"`
	Appliance *InlineResponse20095ProductsWireless `json:"appliance,omitempty"`
	Switch *InlineResponse20095ProductsWireless `json:"switch,omitempty"`
	Camera *InlineResponse20095ProductsWireless `json:"camera,omitempty"`
	CellularGateway *InlineResponse20095ProductsWireless `json:"cellularGateway,omitempty"`
	Sensor *InlineResponse20095ProductsWireless `json:"sensor,omitempty"`
	WirelessController *InlineResponse20095ProductsWireless `json:"wirelessController,omitempty"`
	SecureConnect *InlineResponse20095ProductsWireless `json:"secureConnect,omitempty"`
}
...
func NewInlineResponse20095Products() *InlineResponse20095Products {
	this := InlineResponse20095Products{}
	return &this
}
...
func (o *InlineResponse20095Products) GetWireless() InlineResponse20095ProductsWireless {
	if o == nil || isNil(o.Wireless) {
		var ret InlineResponse20095ProductsWireless
		return ret
	}
	return *o.Wireless
}
...
// SetWireless gets a reference to the given InlineResponse20095ProductsWireless and assigns it to the Wireless field.
...
// SetAppliance gets a reference to the given InlineResponse20095ProductsWireless and assigns it to the Appliance field.
...
// SetSwitch gets a reference to the given InlineResponse20095ProductsWireless and assigns it to the Switch field.
func (o *InlineResponse20095Products) SetSwitch(v InlineResponse20095ProductsWireless) {
	o.Switch = &v
}
...
// SetCamera gets a reference to the given InlineResponse20095ProductsWireless and assigns it to the Camera field.
...
func (o *InlineResponse20095Products) HasCellularGateway() bool {
	if o != nil && !isNil(o.CellularGateway) {
		return true
	}
...
// SetCellularGateway gets a reference to the given InlineResponse20095ProductsWireless and assigns it to the CellularGateway field.
...
// SetSensor gets a reference to the given InlineResponse20095ProductsWireless and assigns it to the Sensor field.
...
// SetWirelessController gets a reference to the given InlineResponse20095ProductsWireless and assigns it to the WirelessController field.
...
// SetSecureConnect gets a reference to the given InlineResponse20095ProductsWireless and assigns it to the SecureConnect field.
func (o *InlineResponse20095Products) SetSecureConnect(v InlineResponse20095ProductsWireless) {
	o.SecureConnect = &v
}

func (o InlineResponse20095Products) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20095Products struct {
	value *InlineResponse20095Products
	isSet bool
}

func (v NullableInlineResponse20095Products) Get() *InlineResponse20095Products {
	return v.value
}

func (v *NullableInlineResponse20095Products) Set(val *InlineResponse20095Products) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20095Products) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20095Products) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20095Products(val *InlineResponse20095Products) *NullableInlineResponse20095Products {
	return &NullableInlineResponse20095Products{value: val, isSet: true}
}

func (v NullableInlineResponse20095Products) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20095Products) UnmarshalJSON(src []byte) error {
	v.isSet = true
