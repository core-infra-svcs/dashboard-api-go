...
type NetworksNetworkIdFirmwareUpgradesProducts struct {
	...
	WirelessController *NetworksNetworkIdFirmwareUpgradesProductsWireless `json:"wirelessController,omitempty"`
	SecureConnect *NetworksNetworkIdFirmwareUpgradesProductsWireless `json:"secureConnect,omitempty"`
...
// SetWirelessController gets a reference to the given NetworksNetworkIdFirmwareUpgradesProductsWireless and assigns it to the WirelessController field.
...
// SetSecureConnect gets a reference to the given NetworksNetworkIdFirmwareUpgradesProductsWireless and assigns it to the SecureConnect field.
