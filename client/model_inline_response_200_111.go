...
type InlineResponse200111 struct {
	...
	SplashLogo *InlineResponse200111SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200111SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200111SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200111GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200111Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200111SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200111SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200111) GetSplashLogo() InlineResponse200111SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200111SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200111SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200111) GetSplashImage() InlineResponse200111SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200111SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200111SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200111) GetSplashPrepaidFront() InlineResponse200111SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200111SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200111SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200111) GetGuestSponsorship() InlineResponse200111GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200111GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200111GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200111) GetBilling() InlineResponse200111Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200111Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200111Billing and assigns it to the Billing field.
...
func (o *InlineResponse200111) GetSentryEnrollment() InlineResponse200111SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200111SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200111SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200111) GetSelfRegistration() InlineResponse200111SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200111SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200111SelfRegistration and assigns it to the SelfRegistration field.
