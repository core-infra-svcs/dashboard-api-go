...
// InlineResponse200261Licenses struct for InlineResponse200261Licenses
type InlineResponse200261Licenses struct {
...
func NewInlineResponse200261Licenses() *InlineResponse200261Licenses {
	this := InlineResponse200261Licenses{}
	return &this
}
...
func (o InlineResponse200261Licenses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200261Licenses struct {
	value *InlineResponse200261Licenses
	isSet bool
}

func (v NullableInlineResponse200261Licenses) Get() *InlineResponse200261Licenses {
	return v.value
}

func (v *NullableInlineResponse200261Licenses) Set(val *InlineResponse200261Licenses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200261Licenses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200261Licenses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200261Licenses(val *InlineResponse200261Licenses) *NullableInlineResponse200261Licenses {
	return &NullableInlineResponse200261Licenses{value: val, isSet: true}
}

func (v NullableInlineResponse200261Licenses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200261Licenses) UnmarshalJSON(src []byte) error {
	v.isSet = true
