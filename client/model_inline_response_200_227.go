...
type InlineResponse200227 struct {
	...
	Items []InlineResponse20070 `json:"items,omitempty"`
}
...
// SetItems gets a reference to the given []InlineResponse20070 and assigns it to the Items field.
