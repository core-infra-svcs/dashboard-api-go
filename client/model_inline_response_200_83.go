...
type InlineResponse20083 struct {
	BandwidthLimits *InlineResponse20083BandwidthLimits `json:"bandwidthLimits,omitempty"`
}
...
func (o *InlineResponse20083) GetBandwidthLimits() InlineResponse20083BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse20083BandwidthLimits
		return ret
	}
...
func (o *InlineResponse20083) GetBandwidthLimitsOk() (*InlineResponse20083BandwidthLimits, bool) {
	if o == nil || isNil(o.BandwidthLimits) {
    return nil, false
	}
...
func (o *InlineResponse20083) HasBandwidthLimits() bool {
	if o != nil && !isNil(o.BandwidthLimits) {
		return true
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse20083BandwidthLimits and assigns it to the BandwidthLimits field.
func (o *InlineResponse20083) SetBandwidthLimits(v InlineResponse20083BandwidthLimits) {
	o.BandwidthLimits = &v
}
