...
type InlineResponse20083 struct {
	...
	Components *InlineResponse20083Components `json:"components,omitempty"`
	// Model
...
func (o *InlineResponse20083) GetComponents() InlineResponse20083Components {
	if o == nil || isNil(o.Components) {
		var ret InlineResponse20083Components
		return ret
	}
	return *o.Components
}
...
// SetComponents gets a reference to the given InlineResponse20083Components and assigns it to the Components field.
