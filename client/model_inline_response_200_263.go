...
type InlineResponse200263 struct {
	ResultingNetwork *InlineResponse200263ResultingNetwork `json:"resultingNetwork,omitempty"`
}
...
func (o *InlineResponse200263) GetResultingNetwork() InlineResponse200263ResultingNetwork {
	if o == nil || isNil(o.ResultingNetwork) {
		var ret InlineResponse200263ResultingNetwork
		return ret
	}
...
// SetResultingNetwork gets a reference to the given InlineResponse200263ResultingNetwork and assigns it to the ResultingNetwork field.
