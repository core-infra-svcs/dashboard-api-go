...
// InlineResponse20085Servers struct for InlineResponse20085Servers
type InlineResponse20085Servers struct {
...
func NewInlineResponse20085Servers() *InlineResponse20085Servers {
	this := InlineResponse20085Servers{}
	return &this
}
...
func (o InlineResponse20085Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20085Servers struct {
	value *InlineResponse20085Servers
	isSet bool
}

func (v NullableInlineResponse20085Servers) Get() *InlineResponse20085Servers {
	return v.value
}

func (v *NullableInlineResponse20085Servers) Set(val *InlineResponse20085Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20085Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20085Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20085Servers(val *InlineResponse20085Servers) *NullableInlineResponse20085Servers {
	return &NullableInlineResponse20085Servers{value: val, isSet: true}
}

func (v NullableInlineResponse20085Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20085Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
