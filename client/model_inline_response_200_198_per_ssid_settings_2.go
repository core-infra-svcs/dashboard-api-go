...
// InlineResponse200198PerSsidSettings2 Settings for SSID 2
type InlineResponse200198PerSsidSettings2 struct {
	// Name of SSID
...
func NewInlineResponse200198PerSsidSettings2() *InlineResponse200198PerSsidSettings2 {
	this := InlineResponse200198PerSsidSettings2{}
	return &this
}
...
func (o InlineResponse200198PerSsidSettings2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200198PerSsidSettings2 struct {
	value *InlineResponse200198PerSsidSettings2
	isSet bool
}

func (v NullableInlineResponse200198PerSsidSettings2) Get() *InlineResponse200198PerSsidSettings2 {
	return v.value
}

func (v *NullableInlineResponse200198PerSsidSettings2) Set(val *InlineResponse200198PerSsidSettings2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200198PerSsidSettings2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200198PerSsidSettings2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200198PerSsidSettings2(val *InlineResponse200198PerSsidSettings2) *NullableInlineResponse200198PerSsidSettings2 {
	return &NullableInlineResponse200198PerSsidSettings2{value: val, isSet: true}
}

func (v NullableInlineResponse200198PerSsidSettings2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200198PerSsidSettings2) UnmarshalJSON(src []byte) error {
	v.isSet = true
