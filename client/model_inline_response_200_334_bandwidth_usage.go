...
// InlineResponse200334BandwidthUsage Bandwidth usage data for the given interval.
type InlineResponse200334BandwidthUsage struct {
...
func NewInlineResponse200334BandwidthUsage() *InlineResponse200334BandwidthUsage {
	this := InlineResponse200334BandwidthUsage{}
	return &this
}
...
func (o InlineResponse200334BandwidthUsage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200334BandwidthUsage struct {
	value *InlineResponse200334BandwidthUsage
	isSet bool
}

func (v NullableInlineResponse200334BandwidthUsage) Get() *InlineResponse200334BandwidthUsage {
	return v.value
}

func (v *NullableInlineResponse200334BandwidthUsage) Set(val *InlineResponse200334BandwidthUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200334BandwidthUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200334BandwidthUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200334BandwidthUsage(val *InlineResponse200334BandwidthUsage) *NullableInlineResponse200334BandwidthUsage {
	return &NullableInlineResponse200334BandwidthUsage{value: val, isSet: true}
}

func (v NullableInlineResponse200334BandwidthUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200334BandwidthUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
