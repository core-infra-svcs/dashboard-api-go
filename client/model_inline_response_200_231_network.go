...
// InlineResponse200231Network The network upon which a client with the given MAC address was found
type InlineResponse200231Network struct {
...
func NewInlineResponse200231Network() *InlineResponse200231Network {
	this := InlineResponse200231Network{}
	return &this
}
...
func (o InlineResponse200231Network) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200231Network struct {
	value *InlineResponse200231Network
	isSet bool
}

func (v NullableInlineResponse200231Network) Get() *InlineResponse200231Network {
	return v.value
}

func (v *NullableInlineResponse200231Network) Set(val *InlineResponse200231Network) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200231Network) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200231Network) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200231Network(val *InlineResponse200231Network) *NullableInlineResponse200231Network {
	return &NullableInlineResponse200231Network{value: val, isSet: true}
}

func (v NullableInlineResponse200231Network) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200231Network) UnmarshalJSON(src []byte) error {
	v.isSet = true
