...
// InlineResponse200210Counts The current amount of various adaptive policy objects.
type InlineResponse200210Counts struct {
...
func NewInlineResponse200210Counts() *InlineResponse200210Counts {
	this := InlineResponse200210Counts{}
	return &this
}
...
func (o InlineResponse200210Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200210Counts struct {
	value *InlineResponse200210Counts
	isSet bool
}

func (v NullableInlineResponse200210Counts) Get() *InlineResponse200210Counts {
	return v.value
}

func (v *NullableInlineResponse200210Counts) Set(val *InlineResponse200210Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200210Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200210Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200210Counts(val *InlineResponse200210Counts) *NullableInlineResponse200210Counts {
	return &NullableInlineResponse200210Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200210Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200210Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
