...
// InlineResponse20059TwoFourGhzSettings Settings related to 2.4Ghz band.
type InlineResponse20059TwoFourGhzSettings struct {
...
func NewInlineResponse20059TwoFourGhzSettings() *InlineResponse20059TwoFourGhzSettings {
	this := InlineResponse20059TwoFourGhzSettings{}
	return &this
}
...
func (o InlineResponse20059TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20059TwoFourGhzSettings struct {
	value *InlineResponse20059TwoFourGhzSettings
	isSet bool
}

func (v NullableInlineResponse20059TwoFourGhzSettings) Get() *InlineResponse20059TwoFourGhzSettings {
	return v.value
}

func (v *NullableInlineResponse20059TwoFourGhzSettings) Set(val *InlineResponse20059TwoFourGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20059TwoFourGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20059TwoFourGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20059TwoFourGhzSettings(val *InlineResponse20059TwoFourGhzSettings) *NullableInlineResponse20059TwoFourGhzSettings {
	return &NullableInlineResponse20059TwoFourGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20059TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20059TwoFourGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
