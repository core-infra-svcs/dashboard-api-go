...
// InlineResponse200231Records struct for InlineResponse200231Records
type InlineResponse200231Records struct {
	Network *InlineResponse200231Network `json:"network,omitempty"`
	...
	ClientVpnConnections []InlineResponse200231ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200231Records() *InlineResponse200231Records {
	this := InlineResponse200231Records{}
	return &this
}
...
func (o *InlineResponse200231Records) GetNetwork() InlineResponse200231Network {
	if o == nil || isNil(o.Network) {
		var ret InlineResponse200231Network
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given InlineResponse200231Network and assigns it to the Network field.
...
func (o *InlineResponse200231Records) GetClientVpnConnections() []InlineResponse200231ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200231ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200231ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200231Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200231Records struct {
	value *InlineResponse200231Records
	isSet bool
}

func (v NullableInlineResponse200231Records) Get() *InlineResponse200231Records {
	return v.value
}

func (v *NullableInlineResponse200231Records) Set(val *InlineResponse200231Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200231Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200231Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200231Records(val *InlineResponse200231Records) *NullableInlineResponse200231Records {
	return &NullableInlineResponse200231Records{value: val, isSet: true}
}

func (v NullableInlineResponse200231Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200231Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
