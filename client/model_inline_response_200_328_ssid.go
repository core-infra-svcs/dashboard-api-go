...
// InlineResponse200328Ssid Wireless access point and network identifier.
type InlineResponse200328Ssid struct {
...
func (o InlineResponse200328Ssid) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200328Ssid struct {
	value *InlineResponse200328Ssid
	isSet bool
}

func (v NullableInlineResponse200328Ssid) Get() *InlineResponse200328Ssid {
	return v.value
}

func (v *NullableInlineResponse200328Ssid) Set(val *InlineResponse200328Ssid) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200328Ssid) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200328Ssid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200328Ssid(val *InlineResponse200328Ssid) *NullableInlineResponse200328Ssid {
	return &NullableInlineResponse200328Ssid{value: val, isSet: true}
}

func (v NullableInlineResponse200328Ssid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200328Ssid) UnmarshalJSON(src []byte) error {
	v.isSet = true
