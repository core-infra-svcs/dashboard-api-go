...
func (o *InlineObject253) GetOrders() []string {
...
func (o *InlineObject253) GetOrdersOk() ([]string, bool) {
	if o == nil || isNil(o.Orders) {
    return nil, false
	}
...
func (o *InlineObject253) HasOrders() bool {
	if o != nil && !isNil(o.Orders) {
		return true
	}
...
func (o *InlineObject253) SetOrders(v []string) {
	o.Orders = v
}
...
func (o *InlineObject253) HasSerials() bool {
	if o != nil && !isNil(o.Serials) {
		return true
	}
...
func (o *InlineObject253) GetLicenses() []OrganizationsOrganizationIdClaimLicenses {
...
// and a boolean to check if the value has been set.
func (o *InlineObject253) GetLicensesOk() ([]OrganizationsOrganizationIdClaimLicenses, bool) {
	if o == nil || isNil(o.Licenses) {
    return nil, false
	}
...
func (o *InlineObject253) HasLicenses() bool {
	if o != nil && !isNil(o.Licenses) {
		return true
	}
...
func (o *InlineObject253) SetLicenses(v []OrganizationsOrganizationIdClaimLicenses) {
	o.Licenses = v
}
