...
// InlineResponse200138Rules struct for InlineResponse200138Rules
type InlineResponse200138Rules struct {
...
func NewInlineResponse200138Rules() *InlineResponse200138Rules {
	this := InlineResponse200138Rules{}
	return &this
}
...
func (o InlineResponse200138Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200138Rules struct {
	value *InlineResponse200138Rules
	isSet bool
}

func (v NullableInlineResponse200138Rules) Get() *InlineResponse200138Rules {
	return v.value
}

func (v *NullableInlineResponse200138Rules) Set(val *InlineResponse200138Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200138Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200138Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200138Rules(val *InlineResponse200138Rules) *NullableInlineResponse200138Rules {
	return &NullableInlineResponse200138Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200138Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200138Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
