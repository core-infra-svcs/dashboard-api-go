...
// InlineResponse200108Ranging Ranging status and progress information
type InlineResponse200108Ranging struct {
	// Ranging status. Possible values: 'scheduled', 'in progress', 'error', 'finished', 'no neighbors'
	Status *string `json:"status,omitempty"`
	Completed *InlineResponse200108RangingCompleted `json:"completed,omitempty"`
}
...
func NewInlineResponse200108Ranging() *InlineResponse200108Ranging {
	this := InlineResponse200108Ranging{}
	return &this
}
...
func (o *InlineResponse200108Ranging) GetCompleted() InlineResponse200108RangingCompleted {
	if o == nil || isNil(o.Completed) {
		var ret InlineResponse200108RangingCompleted
		return ret
	}
	return *o.Completed
}
...
// SetCompleted gets a reference to the given InlineResponse200108RangingCompleted and assigns it to the Completed field.
func (o *InlineResponse200108Ranging) SetCompleted(v InlineResponse200108RangingCompleted) {
	o.Completed = &v
}

func (o InlineResponse200108Ranging) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200108Ranging struct {
	value *InlineResponse200108Ranging
	isSet bool
}

func (v NullableInlineResponse200108Ranging) Get() *InlineResponse200108Ranging {
	return v.value
}

func (v *NullableInlineResponse200108Ranging) Set(val *InlineResponse200108Ranging) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200108Ranging) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200108Ranging) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200108Ranging(val *InlineResponse200108Ranging) *NullableInlineResponse200108Ranging {
	return &NullableInlineResponse200108Ranging{value: val, isSet: true}
}

func (v NullableInlineResponse200108Ranging) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200108Ranging) UnmarshalJSON(src []byte) error {
	v.isSet = true
