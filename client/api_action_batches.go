...
type ActionBatchesApiCreateOrganizationActionBatchRequest struct {
	...
	createOrganizationActionBatch *InlineObject214
}

func (r ActionBatchesApiCreateOrganizationActionBatchRequest) CreateOrganizationActionBatch(createOrganizationActionBatch InlineObject214) ActionBatchesApiCreateOrganizationActionBatchRequest {
	r.createOrganizationActionBatch = &createOrganizationActionBatch
	return r
}

func (r ActionBatchesApiCreateOrganizationActionBatchRequest) Execute() (*InlineResponse20118, *http.Response, error) {
...
func (a *ActionBatchesApiService) CreateOrganizationActionBatchExecute(r ActionBatchesApiCreateOrganizationActionBatchRequest) (*InlineResponse20118, *http.Response, error) {
	var (
...
func (r ActionBatchesApiGetOrganizationActionBatchRequest) Execute() (*InlineResponse20118, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20118
func (a *ActionBatchesApiService) GetOrganizationActionBatchExecute(r ActionBatchesApiGetOrganizationActionBatchRequest) (*InlineResponse20118, *http.Response, error) {
	var (
...
func (r ActionBatchesApiGetOrganizationActionBatchesRequest) Execute() ([]InlineResponse200228, *http.Response, error) {
...
func (a *ActionBatchesApiService) GetOrganizationActionBatchesExecute(r ActionBatchesApiGetOrganizationActionBatchesRequest) ([]InlineResponse200228, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ActionBatchesApiUpdateOrganizationActionBatchRequest struct {
	...
	organizationId string
	actionBatchId string
	updateOrganizationActionBatch *InlineObject215
}

func (r ActionBatchesApiUpdateOrganizationActionBatchRequest) UpdateOrganizationActionBatch(updateOrganizationActionBatch InlineObject215) ActionBatchesApiUpdateOrganizationActionBatchRequest {
	r.updateOrganizationActionBatch = &updateOrganizationActionBatch
	return r
}

func (r ActionBatchesApiUpdateOrganizationActionBatchRequest) Execute() (*InlineResponse200228, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200228
func (a *ActionBatchesApiService) UpdateOrganizationActionBatchExecute(r ActionBatchesApiUpdateOrganizationActionBatchRequest) (*InlineResponse200228, *http.Response, error) {
	var (
