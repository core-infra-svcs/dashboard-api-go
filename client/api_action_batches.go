...
func (r ActionBatchesApiCreateOrganizationActionBatchRequest) CreateOrganizationActionBatch(createOrganizationActionBatch InlineObject192) ActionBatchesApiCreateOrganizationActionBatchRequest {
	r.createOrganizationActionBatch = &createOrganizationActionBatch
	return r
}

func (r ActionBatchesApiCreateOrganizationActionBatchRequest) Execute() (*InlineResponse2019, *http.Response, error) {
...
func (a *ActionBatchesApiService) CreateOrganizationActionBatchExecute(r ActionBatchesApiCreateOrganizationActionBatchRequest) (*InlineResponse2019, *http.Response, error) {
	var (
...
func (r ActionBatchesApiGetOrganizationActionBatchRequest) Execute() (*InlineResponse2019, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2019
func (a *ActionBatchesApiService) GetOrganizationActionBatchExecute(r ActionBatchesApiGetOrganizationActionBatchRequest) (*InlineResponse2019, *http.Response, error) {
	var (
...
func (r ActionBatchesApiGetOrganizationActionBatchesRequest) Execute() ([]InlineResponse200133, *http.Response, error) {
...
func (a *ActionBatchesApiService) GetOrganizationActionBatchesExecute(r ActionBatchesApiGetOrganizationActionBatchesRequest) ([]InlineResponse200133, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ActionBatchesApiUpdateOrganizationActionBatchRequest) UpdateOrganizationActionBatch(updateOrganizationActionBatch InlineObject193) ActionBatchesApiUpdateOrganizationActionBatchRequest {
	r.updateOrganizationActionBatch = &updateOrganizationActionBatch
	return r
}

func (r ActionBatchesApiUpdateOrganizationActionBatchRequest) Execute() (*InlineResponse200133, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200133
func (a *ActionBatchesApiService) UpdateOrganizationActionBatchExecute(r ActionBatchesApiUpdateOrganizationActionBatchRequest) (*InlineResponse200133, *http.Response, error) {
	var (
