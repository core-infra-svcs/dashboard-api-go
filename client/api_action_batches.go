...
func (r ActionBatchesApiCreateOrganizationActionBatchRequest) CreateOrganizationActionBatch(createOrganizationActionBatch InlineObject209) ActionBatchesApiCreateOrganizationActionBatchRequest {
	r.createOrganizationActionBatch = &createOrganizationActionBatch
	return r
}

func (r ActionBatchesApiCreateOrganizationActionBatchRequest) Execute() (*InlineResponse20115, *http.Response, error) {
...
func (a *ActionBatchesApiService) CreateOrganizationActionBatchExecute(r ActionBatchesApiCreateOrganizationActionBatchRequest) (*InlineResponse20115, *http.Response, error) {
	var (
...
func (r ActionBatchesApiGetOrganizationActionBatchRequest) Execute() (*InlineResponse20115, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20115
func (a *ActionBatchesApiService) GetOrganizationActionBatchExecute(r ActionBatchesApiGetOrganizationActionBatchRequest) (*InlineResponse20115, *http.Response, error) {
	var (
...
func (r ActionBatchesApiUpdateOrganizationActionBatchRequest) UpdateOrganizationActionBatch(updateOrganizationActionBatch InlineObject210) ActionBatchesApiUpdateOrganizationActionBatchRequest {
