...
func (r ActionBatchesApiCreateOrganizationActionBatchRequest) CreateOrganizationActionBatch(createOrganizationActionBatch InlineObject205) ActionBatchesApiCreateOrganizationActionBatchRequest {
...
func (r ActionBatchesApiGetOrganizationActionBatchesRequest) Execute() ([]InlineResponse200208, *http.Response, error) {
...
func (a *ActionBatchesApiService) GetOrganizationActionBatchesExecute(r ActionBatchesApiGetOrganizationActionBatchesRequest) ([]InlineResponse200208, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ActionBatchesApiUpdateOrganizationActionBatchRequest) UpdateOrganizationActionBatch(updateOrganizationActionBatch InlineObject206) ActionBatchesApiUpdateOrganizationActionBatchRequest {
	r.updateOrganizationActionBatch = &updateOrganizationActionBatch
	return r
}

func (r ActionBatchesApiUpdateOrganizationActionBatchRequest) Execute() (*InlineResponse200208, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200208
func (a *ActionBatchesApiService) UpdateOrganizationActionBatchExecute(r ActionBatchesApiUpdateOrganizationActionBatchRequest) (*InlineResponse200208, *http.Response, error) {
	var (
