...
func (r ActionBatchesApiCreateOrganizationActionBatchRequest) CreateOrganizationActionBatch(createOrganizationActionBatch InlineObject204) ActionBatchesApiCreateOrganizationActionBatchRequest {
	r.createOrganizationActionBatch = &createOrganizationActionBatch
	return r
}

func (r ActionBatchesApiCreateOrganizationActionBatchRequest) Execute() (*InlineResponse20113, *http.Response, error) {
...
func (a *ActionBatchesApiService) CreateOrganizationActionBatchExecute(r ActionBatchesApiCreateOrganizationActionBatchRequest) (*InlineResponse20113, *http.Response, error) {
	var (
...
func (r ActionBatchesApiGetOrganizationActionBatchRequest) Execute() (*InlineResponse20113, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20113
func (a *ActionBatchesApiService) GetOrganizationActionBatchExecute(r ActionBatchesApiGetOrganizationActionBatchRequest) (*InlineResponse20113, *http.Response, error) {
	var (
...
func (r ActionBatchesApiGetOrganizationActionBatchesRequest) Execute() ([]InlineResponse200207, *http.Response, error) {
...
func (a *ActionBatchesApiService) GetOrganizationActionBatchesExecute(r ActionBatchesApiGetOrganizationActionBatchesRequest) ([]InlineResponse200207, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ActionBatchesApiUpdateOrganizationActionBatchRequest) UpdateOrganizationActionBatch(updateOrganizationActionBatch InlineObject205) ActionBatchesApiUpdateOrganizationActionBatchRequest {
	r.updateOrganizationActionBatch = &updateOrganizationActionBatch
	return r
}

func (r ActionBatchesApiUpdateOrganizationActionBatchRequest) Execute() (*InlineResponse200207, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200207
func (a *ActionBatchesApiService) UpdateOrganizationActionBatchExecute(r ActionBatchesApiUpdateOrganizationActionBatchRequest) (*InlineResponse200207, *http.Response, error) {
	var (
