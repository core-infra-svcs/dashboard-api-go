...
// InlineResponse200194SixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type InlineResponse200194SixGhzSettings struct {
...
func NewInlineResponse200194SixGhzSettings() *InlineResponse200194SixGhzSettings {
	this := InlineResponse200194SixGhzSettings{}
	return &this
}
...
func (o InlineResponse200194SixGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200194SixGhzSettings struct {
	value *InlineResponse200194SixGhzSettings
	isSet bool
}

func (v NullableInlineResponse200194SixGhzSettings) Get() *InlineResponse200194SixGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200194SixGhzSettings) Set(val *InlineResponse200194SixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200194SixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200194SixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200194SixGhzSettings(val *InlineResponse200194SixGhzSettings) *NullableInlineResponse200194SixGhzSettings {
	return &NullableInlineResponse200194SixGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200194SixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200194SixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
