...
// InlineResponse200139Switches struct for InlineResponse200139Switches
type InlineResponse200139Switches struct {
...
func NewInlineResponse200139Switches() *InlineResponse200139Switches {
	this := InlineResponse200139Switches{}
	return &this
}
...
func (o InlineResponse200139Switches) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200139Switches struct {
	value *InlineResponse200139Switches
	isSet bool
}

func (v NullableInlineResponse200139Switches) Get() *InlineResponse200139Switches {
	return v.value
}

func (v *NullableInlineResponse200139Switches) Set(val *InlineResponse200139Switches) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200139Switches) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200139Switches) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200139Switches(val *InlineResponse200139Switches) *NullableInlineResponse200139Switches {
	return &NullableInlineResponse200139Switches{value: val, isSet: true}
}

func (v NullableInlineResponse200139Switches) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200139Switches) UnmarshalJSON(src []byte) error {
	v.isSet = true
