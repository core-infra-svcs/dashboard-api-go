...
// InlineResponse200242SeverityCounts struct for InlineResponse200242SeverityCounts
type InlineResponse200242SeverityCounts struct {
	// Type
...
func NewInlineResponse200242SeverityCounts(type_ string, count int32) *InlineResponse200242SeverityCounts {
	this := InlineResponse200242SeverityCounts{}
	this.Type = type_
	this.Count = count
	return &this
}
...
func (o InlineResponse200242SeverityCounts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200242SeverityCounts struct {
	value *InlineResponse200242SeverityCounts
	isSet bool
}

func (v NullableInlineResponse200242SeverityCounts) Get() *InlineResponse200242SeverityCounts {
	return v.value
}

func (v *NullableInlineResponse200242SeverityCounts) Set(val *InlineResponse200242SeverityCounts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200242SeverityCounts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200242SeverityCounts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200242SeverityCounts(val *InlineResponse200242SeverityCounts) *NullableInlineResponse200242SeverityCounts {
	return &NullableInlineResponse200242SeverityCounts{value: val, isSet: true}
}

func (v NullableInlineResponse200242SeverityCounts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200242SeverityCounts) UnmarshalJSON(src []byte) error {
	v.isSet = true
