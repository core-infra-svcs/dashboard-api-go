...
// InlineResponse200344Ssid Wireless access point and network identifier.
type InlineResponse200344Ssid struct {
...
func (o InlineResponse200344Ssid) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200344Ssid struct {
	value *InlineResponse200344Ssid
	isSet bool
}

func (v NullableInlineResponse200344Ssid) Get() *InlineResponse200344Ssid {
	return v.value
}

func (v *NullableInlineResponse200344Ssid) Set(val *InlineResponse200344Ssid) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200344Ssid) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200344Ssid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200344Ssid(val *InlineResponse200344Ssid) *NullableInlineResponse200344Ssid {
	return &NullableInlineResponse200344Ssid{value: val, isSet: true}
}

func (v NullableInlineResponse200344Ssid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200344Ssid) UnmarshalJSON(src []byte) error {
	v.isSet = true
