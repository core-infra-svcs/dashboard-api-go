...
// InlineResponse20011ResultsReplies struct for InlineResponse20011ResultsReplies
type InlineResponse20011ResultsReplies struct {
...
func NewInlineResponse20011ResultsReplies() *InlineResponse20011ResultsReplies {
	this := InlineResponse20011ResultsReplies{}
	return &this
}
...
func (o InlineResponse20011ResultsReplies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20011ResultsReplies struct {
	value *InlineResponse20011ResultsReplies
	isSet bool
}

func (v NullableInlineResponse20011ResultsReplies) Get() *InlineResponse20011ResultsReplies {
	return v.value
}

func (v *NullableInlineResponse20011ResultsReplies) Set(val *InlineResponse20011ResultsReplies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20011ResultsReplies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20011ResultsReplies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20011ResultsReplies(val *InlineResponse20011ResultsReplies) *NullableInlineResponse20011ResultsReplies {
	return &NullableInlineResponse20011ResultsReplies{value: val, isSet: true}
}

func (v NullableInlineResponse20011ResultsReplies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20011ResultsReplies) UnmarshalJSON(src []byte) error {
	v.isSet = true
