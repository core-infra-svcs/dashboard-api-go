...
type InlineResponse20078 struct {
	...
	Wan1 *InlineResponse20078Wan1 `json:"wan1,omitempty"`
	Wan2 *InlineResponse20078Wan2 `json:"wan2,omitempty"`
}
...
func (o *InlineResponse20078) GetWan1() InlineResponse20078Wan1 {
	if o == nil || isNil(o.Wan1) {
		var ret InlineResponse20078Wan1
		return ret
	}
	return *o.Wan1
}
...
// SetWan1 gets a reference to the given InlineResponse20078Wan1 and assigns it to the Wan1 field.
...
func (o *InlineResponse20078) GetWan2() InlineResponse20078Wan2 {
	if o == nil || isNil(o.Wan2) {
		var ret InlineResponse20078Wan2
		return ret
	}
	return *o.Wan2
}
...
// SetWan2 gets a reference to the given InlineResponse20078Wan2 and assigns it to the Wan2 field.
