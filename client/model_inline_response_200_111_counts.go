...
// InlineResponse200111Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse200111Counts struct {
	...
	Noise *InlineResponse200111CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse200111Counts() *InlineResponse200111Counts {
	this := InlineResponse200111Counts{}
	return &this
}
...
func (o *InlineResponse200111Counts) GetNoise() InlineResponse200111CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse200111CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse200111CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse200111Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200111Counts struct {
	value *InlineResponse200111Counts
	isSet bool
}

func (v NullableInlineResponse200111Counts) Get() *InlineResponse200111Counts {
	return v.value
}

func (v *NullableInlineResponse200111Counts) Set(val *InlineResponse200111Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200111Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200111Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200111Counts(val *InlineResponse200111Counts) *NullableInlineResponse200111Counts {
	return &NullableInlineResponse200111Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200111Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200111Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
