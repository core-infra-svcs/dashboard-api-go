...
// InlineResponse200102Transmission Settings related to radio transmission.
type InlineResponse200102Transmission struct {
...
func NewInlineResponse200102Transmission() *InlineResponse200102Transmission {
	this := InlineResponse200102Transmission{}
	return &this
}
...
func (o InlineResponse200102Transmission) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200102Transmission struct {
	value *InlineResponse200102Transmission
	isSet bool
}

func (v NullableInlineResponse200102Transmission) Get() *InlineResponse200102Transmission {
	return v.value
}

func (v *NullableInlineResponse200102Transmission) Set(val *InlineResponse200102Transmission) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200102Transmission) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200102Transmission) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200102Transmission(val *InlineResponse200102Transmission) *NullableInlineResponse200102Transmission {
	return &NullableInlineResponse200102Transmission{value: val, isSet: true}
}

func (v NullableInlineResponse200102Transmission) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200102Transmission) UnmarshalJSON(src []byte) error {
	v.isSet = true
