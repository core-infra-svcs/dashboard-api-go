...
func (r NetworksApiCombineOrganizationNetworksRequest) Execute() (*InlineResponse200162, *http.Response, error) {
...
func (a *NetworksApiService) CombineOrganizationNetworksExecute(r NetworksApiCombineOrganizationNetworksRequest) (*InlineResponse200162, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
