...
// InlineResponse200363Interfaces struct for InlineResponse200363Interfaces
type InlineResponse200363Interfaces struct {
...
func NewInlineResponse200363Interfaces() *InlineResponse200363Interfaces {
	this := InlineResponse200363Interfaces{}
	return &this
}
...
func (o InlineResponse200363Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200363Interfaces struct {
	value *InlineResponse200363Interfaces
	isSet bool
}

func (v NullableInlineResponse200363Interfaces) Get() *InlineResponse200363Interfaces {
	return v.value
}

func (v *NullableInlineResponse200363Interfaces) Set(val *InlineResponse200363Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200363Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200363Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200363Interfaces(val *InlineResponse200363Interfaces) *NullableInlineResponse200363Interfaces {
	return &NullableInlineResponse200363Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200363Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200363Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
