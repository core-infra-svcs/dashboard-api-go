...
type InlineResponse20045 struct {
	...
	ClientVpnConnections []InlineResponse20045ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20045) GetClientVpnConnections() []InlineResponse20045ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20045ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20045ClientVpnConnections and assigns it to the ClientVpnConnections field.
