...
type InlineResponse20045 struct {
	DefaultDestinations *InlineResponse20045DefaultDestinations `json:"defaultDestinations,omitempty"`
	// Alert-specific configuration for each type. Only alerts that pertain to the network can be updated.
	Alerts []InlineResponse20045Alerts `json:"alerts,omitempty"`
	Muting *InlineResponse20045Muting `json:"muting,omitempty"`
}
...
func (o *InlineResponse20045) GetDefaultDestinations() InlineResponse20045DefaultDestinations {
	if o == nil || isNil(o.DefaultDestinations) {
		var ret InlineResponse20045DefaultDestinations
		return ret
	}
...
// SetDefaultDestinations gets a reference to the given InlineResponse20045DefaultDestinations and assigns it to the DefaultDestinations field.
...
func (o *InlineResponse20045) GetAlerts() []InlineResponse20045Alerts {
	if o == nil || isNil(o.Alerts) {
		var ret []InlineResponse20045Alerts
		return ret
	}
	return o.Alerts
}
...
// SetAlerts gets a reference to the given []InlineResponse20045Alerts and assigns it to the Alerts field.
...
func (o *InlineResponse20045) GetMuting() InlineResponse20045Muting {
	if o == nil || isNil(o.Muting) {
		var ret InlineResponse20045Muting
		return ret
	}
	return *o.Muting
}
...
// SetMuting gets a reference to the given InlineResponse20045Muting and assigns it to the Muting field.
