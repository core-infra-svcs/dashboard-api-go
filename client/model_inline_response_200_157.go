...
type InlineResponse200157 struct {
	...
	RemainderLicenses []InlineResponse200156 `json:"remainderLicenses,omitempty"`
	// Newly moved licenses created in the destination organization of the license move operation
	MovedLicenses []InlineResponse200156 `json:"movedLicenses,omitempty"`
}
...
// SetRemainderLicenses gets a reference to the given []InlineResponse200156 and assigns it to the RemainderLicenses field.
...
// SetMovedLicenses gets a reference to the given []InlineResponse200156 and assigns it to the MovedLicenses field.
