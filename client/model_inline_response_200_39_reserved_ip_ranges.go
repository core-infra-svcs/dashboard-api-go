...
// InlineResponse20039ReservedIpRanges struct for InlineResponse20039ReservedIpRanges
type InlineResponse20039ReservedIpRanges struct {
...
func NewInlineResponse20039ReservedIpRanges() *InlineResponse20039ReservedIpRanges {
	this := InlineResponse20039ReservedIpRanges{}
	return &this
}
...
func (o InlineResponse20039ReservedIpRanges) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20039ReservedIpRanges struct {
	value *InlineResponse20039ReservedIpRanges
	isSet bool
}

func (v NullableInlineResponse20039ReservedIpRanges) Get() *InlineResponse20039ReservedIpRanges {
	return v.value
}

func (v *NullableInlineResponse20039ReservedIpRanges) Set(val *InlineResponse20039ReservedIpRanges) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20039ReservedIpRanges) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20039ReservedIpRanges) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20039ReservedIpRanges(val *InlineResponse20039ReservedIpRanges) *NullableInlineResponse20039ReservedIpRanges {
	return &NullableInlineResponse20039ReservedIpRanges{value: val, isSet: true}
}

func (v NullableInlineResponse20039ReservedIpRanges) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20039ReservedIpRanges) UnmarshalJSON(src []byte) error {
	v.isSet = true
