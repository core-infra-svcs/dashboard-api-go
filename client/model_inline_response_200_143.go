...
type InlineResponse200143 struct {
	ResultingNetwork *InlineResponse200143ResultingNetwork `json:"resultingNetwork,omitempty"`
}
...
func (o *InlineResponse200143) GetResultingNetwork() InlineResponse200143ResultingNetwork {
	if o == nil || isNil(o.ResultingNetwork) {
		var ret InlineResponse200143ResultingNetwork
		return ret
	}
...
// SetResultingNetwork gets a reference to the given InlineResponse200143ResultingNetwork and assigns it to the ResultingNetwork field.
