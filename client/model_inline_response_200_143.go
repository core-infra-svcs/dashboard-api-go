...
type InlineResponse200143 struct {
	Alerts *InlineResponse200143Alerts `json:"alerts,omitempty"`
	...
	ArpInspection *InlineResponse200143ArpInspection `json:"arpInspection,omitempty"`
}
...
func (o *InlineResponse200143) GetAlerts() InlineResponse200143Alerts {
	if o == nil || isNil(o.Alerts) {
		var ret InlineResponse200143Alerts
		return ret
	}
	return *o.Alerts
}
...
// SetAlerts gets a reference to the given InlineResponse200143Alerts and assigns it to the Alerts field.
...
func (o *InlineResponse200143) GetArpInspection() InlineResponse200143ArpInspection {
	if o == nil || isNil(o.ArpInspection) {
		var ret InlineResponse200143ArpInspection
		return ret
	}
...
// SetArpInspection gets a reference to the given InlineResponse200143ArpInspection and assigns it to the ArpInspection field.
