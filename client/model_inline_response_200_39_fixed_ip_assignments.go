...
// InlineResponse20039FixedIpAssignments struct for InlineResponse20039FixedIpAssignments
type InlineResponse20039FixedIpAssignments struct {
...
func NewInlineResponse20039FixedIpAssignments() *InlineResponse20039FixedIpAssignments {
	this := InlineResponse20039FixedIpAssignments{}
	return &this
}
...
func (o InlineResponse20039FixedIpAssignments) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20039FixedIpAssignments struct {
	value *InlineResponse20039FixedIpAssignments
	isSet bool
}

func (v NullableInlineResponse20039FixedIpAssignments) Get() *InlineResponse20039FixedIpAssignments {
	return v.value
}

func (v *NullableInlineResponse20039FixedIpAssignments) Set(val *InlineResponse20039FixedIpAssignments) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20039FixedIpAssignments) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20039FixedIpAssignments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20039FixedIpAssignments(val *InlineResponse20039FixedIpAssignments) *NullableInlineResponse20039FixedIpAssignments {
	return &NullableInlineResponse20039FixedIpAssignments{value: val, isSet: true}
}

func (v NullableInlineResponse20039FixedIpAssignments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20039FixedIpAssignments) UnmarshalJSON(src []byte) error {
	v.isSet = true
