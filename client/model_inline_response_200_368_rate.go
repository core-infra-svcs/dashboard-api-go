...
// InlineResponse200368Rate The interface packet rates measured in packets per second
type InlineResponse200368Rate struct {
...
func (o InlineResponse200368Rate) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200368Rate struct {
	value *InlineResponse200368Rate
	isSet bool
}

func (v NullableInlineResponse200368Rate) Get() *InlineResponse200368Rate {
	return v.value
}

func (v *NullableInlineResponse200368Rate) Set(val *InlineResponse200368Rate) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200368Rate) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200368Rate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200368Rate(val *InlineResponse200368Rate) *NullableInlineResponse200368Rate {
	return &NullableInlineResponse200368Rate{value: val, isSet: true}
}

func (v NullableInlineResponse200368Rate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200368Rate) UnmarshalJSON(src []byte) error {
	v.isSet = true
