...
type InlineResponse20014 struct {
	...
	ConnectionStats *InlineResponse20014ConnectionStats `json:"connectionStats,omitempty"`
}
...
func (o *InlineResponse20014) GetConnectionStats() InlineResponse20014ConnectionStats {
	if o == nil || isNil(o.ConnectionStats) {
		var ret InlineResponse20014ConnectionStats
		return ret
	}
...
// SetConnectionStats gets a reference to the given InlineResponse20014ConnectionStats and assigns it to the ConnectionStats field.
