...
// InlineResponse20015BasicServiceSets struct for InlineResponse20015BasicServiceSets
type InlineResponse20015BasicServiceSets struct {
...
func NewInlineResponse20015BasicServiceSets() *InlineResponse20015BasicServiceSets {
	this := InlineResponse20015BasicServiceSets{}
	return &this
}
...
func (o InlineResponse20015BasicServiceSets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20015BasicServiceSets struct {
	value *InlineResponse20015BasicServiceSets
	isSet bool
}

func (v NullableInlineResponse20015BasicServiceSets) Get() *InlineResponse20015BasicServiceSets {
	return v.value
}

func (v *NullableInlineResponse20015BasicServiceSets) Set(val *InlineResponse20015BasicServiceSets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20015BasicServiceSets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20015BasicServiceSets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20015BasicServiceSets(val *InlineResponse20015BasicServiceSets) *NullableInlineResponse20015BasicServiceSets {
	return &NullableInlineResponse20015BasicServiceSets{value: val, isSet: true}
}

func (v NullableInlineResponse20015BasicServiceSets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20015BasicServiceSets) UnmarshalJSON(src []byte) error {
	v.isSet = true
