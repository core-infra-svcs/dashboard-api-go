...
// InlineResponse20074SplashImage The image used in the splash page.
type InlineResponse20074SplashImage struct {
...
func NewInlineResponse20074SplashImage() *InlineResponse20074SplashImage {
	this := InlineResponse20074SplashImage{}
	return &this
}
...
func (o InlineResponse20074SplashImage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20074SplashImage struct {
	value *InlineResponse20074SplashImage
	isSet bool
}

func (v NullableInlineResponse20074SplashImage) Get() *InlineResponse20074SplashImage {
	return v.value
}

func (v *NullableInlineResponse20074SplashImage) Set(val *InlineResponse20074SplashImage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20074SplashImage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20074SplashImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20074SplashImage(val *InlineResponse20074SplashImage) *NullableInlineResponse20074SplashImage {
	return &NullableInlineResponse20074SplashImage{value: val, isSet: true}
}

func (v NullableInlineResponse20074SplashImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20074SplashImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
