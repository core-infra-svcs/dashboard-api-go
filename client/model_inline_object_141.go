...
func NewInlineObject141(ruleIds []string) *InlineObject141 {
...
func (o *InlineObject141) GetRuleIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *InlineObject141) GetRuleIdsOk() ([]string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *InlineObject141) SetRuleIds(v []string) {
	o.RuleIds = v
}
