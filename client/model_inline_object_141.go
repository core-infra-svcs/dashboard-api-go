...
func (o *InlineObject141) GetPassphrase() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject141) GetPassphraseOk() (*string, bool) {
	if o == nil || o.Passphrase == nil {
		return nil, false
	}
...
func (o *InlineObject141) HasPassphrase() bool {
	if o != nil && o.Passphrase != nil {
		return true
	}
...
func (o *InlineObject141) SetPassphrase(v string) {
	o.Passphrase = &v
}

// GetGroupPolicyId returns the GroupPolicyId field value if set, zero value otherwise.
func (o *InlineObject141) GetGroupPolicyId() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject141) GetGroupPolicyIdOk() (*string, bool) {
	if o == nil || o.GroupPolicyId == nil {
		return nil, false
	}
...
func (o *InlineObject141) HasGroupPolicyId() bool {
	if o != nil && o.GroupPolicyId != nil {
		return true
	}
...
func (o *InlineObject141) SetGroupPolicyId(v string) {
	o.GroupPolicyId = &v
}
