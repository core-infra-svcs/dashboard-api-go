...
type InlineResponse200103 struct {
	...
	NamedVlans *InlineResponse200103NamedVlans `json:"namedVlans,omitempty"`
	RegulatoryDomain *InlineResponse200103RegulatoryDomain `json:"regulatoryDomain,omitempty"`
}
...
func (o *InlineResponse200103) GetNamedVlans() InlineResponse200103NamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret InlineResponse200103NamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given InlineResponse200103NamedVlans and assigns it to the NamedVlans field.
...
func (o *InlineResponse200103) GetRegulatoryDomain() InlineResponse200103RegulatoryDomain {
	if o == nil || isNil(o.RegulatoryDomain) {
		var ret InlineResponse200103RegulatoryDomain
		return ret
	}
...
// SetRegulatoryDomain gets a reference to the given InlineResponse200103RegulatoryDomain and assigns it to the RegulatoryDomain field.
