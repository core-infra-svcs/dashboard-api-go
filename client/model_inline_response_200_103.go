...
type InlineResponse200103 struct {
	...
	ToVersion *InlineResponse200103ToVersion `json:"toVersion,omitempty"`
...
func (o *InlineResponse200103) GetToVersion() InlineResponse200103ToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse200103ToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse200103ToVersion and assigns it to the ToVersion field.
