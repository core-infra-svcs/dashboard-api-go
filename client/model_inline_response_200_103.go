...
type InlineResponse200103 struct {
	...
	Jobs []InlineResponse200103Jobs `json:"jobs,omitempty"`
}
...
func (o *InlineResponse200103) GetJobs() []InlineResponse200103Jobs {
	if o == nil || isNil(o.Jobs) {
		var ret []InlineResponse200103Jobs
		return ret
	}
	return o.Jobs
}
...
// SetJobs gets a reference to the given []InlineResponse200103Jobs and assigns it to the Jobs field.
