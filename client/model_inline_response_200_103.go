...
type InlineResponse200103 struct {
	ResultingNetwork *InlineResponse200103ResultingNetwork `json:"resultingNetwork,omitempty"`
}
...
func (o *InlineResponse200103) GetResultingNetwork() InlineResponse200103ResultingNetwork {
	if o == nil || isNil(o.ResultingNetwork) {
		var ret InlineResponse200103ResultingNetwork
		return ret
	}
...
// SetResultingNetwork gets a reference to the given InlineResponse200103ResultingNetwork and assigns it to the ResultingNetwork field.
