...
// InlineResponse200289CreatedBy Information around who initiated the callback
type InlineResponse200289CreatedBy struct {
...
func NewInlineResponse200289CreatedBy() *InlineResponse200289CreatedBy {
	this := InlineResponse200289CreatedBy{}
	return &this
}
...
func (o InlineResponse200289CreatedBy) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200289CreatedBy struct {
	value *InlineResponse200289CreatedBy
	isSet bool
}

func (v NullableInlineResponse200289CreatedBy) Get() *InlineResponse200289CreatedBy {
	return v.value
}

func (v *NullableInlineResponse200289CreatedBy) Set(val *InlineResponse200289CreatedBy) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200289CreatedBy) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200289CreatedBy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200289CreatedBy(val *InlineResponse200289CreatedBy) *NullableInlineResponse200289CreatedBy {
	return &NullableInlineResponse200289CreatedBy{value: val, isSet: true}
}

func (v NullableInlineResponse200289CreatedBy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200289CreatedBy) UnmarshalJSON(src []byte) error {
	v.isSet = true
