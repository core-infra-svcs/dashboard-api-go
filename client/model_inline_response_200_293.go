...
type InlineResponse200293 struct {
	Counts *InlineResponse200293Counts `json:"counts,omitempty"`
}
...
func (o *InlineResponse200293) GetCounts() InlineResponse200293Counts {
	if o == nil || isNil(o.Counts) {
		var ret InlineResponse200293Counts
		return ret
	}
	return *o.Counts
}
...
func (o *InlineResponse200293) GetCountsOk() (*InlineResponse200293Counts, bool) {
	if o == nil || isNil(o.Counts) {
    return nil, false
	}
...
func (o *InlineResponse200293) HasCounts() bool {
	if o != nil && !isNil(o.Counts) {
		return true
	}
...
// SetCounts gets a reference to the given InlineResponse200293Counts and assigns it to the Counts field.
func (o *InlineResponse200293) SetCounts(v InlineResponse200293Counts) {
	o.Counts = &v
}
