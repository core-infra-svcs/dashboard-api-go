...
type InlineResponse20097 struct {
	...
	ToVersion *InlineResponse20097ToVersion `json:"toVersion,omitempty"`
...
func (o *InlineResponse20097) GetToVersion() InlineResponse20097ToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20097ToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20097ToVersion and assigns it to the ToVersion field.
