...
type InlineResponse20097 struct {
	...
	ApiAuthentication *InlineResponse20097ApiAuthentication `json:"apiAuthentication,omitempty"`
}
...
func (o *InlineResponse20097) GetEnforcePasswordExpiration() bool {
...
func (o *InlineResponse20097) GetEnforcePasswordExpirationOk() (*bool, bool) {
	if o == nil || isNil(o.EnforcePasswordExpiration) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasEnforcePasswordExpiration() bool {
	if o != nil && !isNil(o.EnforcePasswordExpiration) {
		return true
	}
...
func (o *InlineResponse20097) SetEnforcePasswordExpiration(v bool) {
...
func (o *InlineResponse20097) GetPasswordExpirationDays() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20097) GetPasswordExpirationDaysOk() (*int32, bool) {
	if o == nil || isNil(o.PasswordExpirationDays) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasPasswordExpirationDays() bool {
	if o != nil && !isNil(o.PasswordExpirationDays) {
		return true
	}
...
func (o *InlineResponse20097) SetPasswordExpirationDays(v int32) {
...
func (o *InlineResponse20097) GetEnforceDifferentPasswords() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20097) GetEnforceDifferentPasswordsOk() (*bool, bool) {
	if o == nil || isNil(o.EnforceDifferentPasswords) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasEnforceDifferentPasswords() bool {
	if o != nil && !isNil(o.EnforceDifferentPasswords) {
		return true
	}
...
func (o *InlineResponse20097) SetEnforceDifferentPasswords(v bool) {
...
func (o *InlineResponse20097) GetNumDifferentPasswords() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20097) GetNumDifferentPasswordsOk() (*int32, bool) {
	if o == nil || isNil(o.NumDifferentPasswords) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasNumDifferentPasswords() bool {
	if o != nil && !isNil(o.NumDifferentPasswords) {
		return true
	}
...
func (o *InlineResponse20097) SetNumDifferentPasswords(v int32) {
...
func (o *InlineResponse20097) GetEnforceStrongPasswords() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20097) GetEnforceStrongPasswordsOk() (*bool, bool) {
	if o == nil || isNil(o.EnforceStrongPasswords) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasEnforceStrongPasswords() bool {
	if o != nil && !isNil(o.EnforceStrongPasswords) {
		return true
	}
...
func (o *InlineResponse20097) SetEnforceStrongPasswords(v bool) {
...
func (o *InlineResponse20097) GetEnforceAccountLockout() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20097) GetEnforceAccountLockoutOk() (*bool, bool) {
	if o == nil || isNil(o.EnforceAccountLockout) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasEnforceAccountLockout() bool {
	if o != nil && !isNil(o.EnforceAccountLockout) {
		return true
	}
...
func (o *InlineResponse20097) SetEnforceAccountLockout(v bool) {
...
func (o *InlineResponse20097) GetAccountLockoutAttempts() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20097) GetAccountLockoutAttemptsOk() (*int32, bool) {
	if o == nil || isNil(o.AccountLockoutAttempts) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasAccountLockoutAttempts() bool {
	if o != nil && !isNil(o.AccountLockoutAttempts) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20097) GetEnforceIdleTimeoutOk() (*bool, bool) {
	if o == nil || isNil(o.EnforceIdleTimeout) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasEnforceIdleTimeout() bool {
	if o != nil && !isNil(o.EnforceIdleTimeout) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20097) GetIdleTimeoutMinutesOk() (*int32, bool) {
	if o == nil || isNil(o.IdleTimeoutMinutes) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasIdleTimeoutMinutes() bool {
	if o != nil && !isNil(o.IdleTimeoutMinutes) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20097) GetEnforceTwoFactorAuthOk() (*bool, bool) {
	if o == nil || isNil(o.EnforceTwoFactorAuth) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasEnforceTwoFactorAuth() bool {
	if o != nil && !isNil(o.EnforceTwoFactorAuth) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20097) GetEnforceLoginIpRangesOk() (*bool, bool) {
	if o == nil || isNil(o.EnforceLoginIpRanges) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasEnforceLoginIpRanges() bool {
	if o != nil && !isNil(o.EnforceLoginIpRanges) {
		return true
	}
...
func (o *InlineResponse20097) SetEnforceLoginIpRanges(v bool) {
	o.EnforceLoginIpRanges = &v
}

// GetLoginIpRanges returns the LoginIpRanges field value if set, zero value otherwise.
func (o *InlineResponse20097) GetLoginIpRanges() []string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20097) GetLoginIpRangesOk() ([]string, bool) {
	if o == nil || isNil(o.LoginIpRanges) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasLoginIpRanges() bool {
	if o != nil && !isNil(o.LoginIpRanges) {
		return true
	}
...
func (o *InlineResponse20097) SetLoginIpRanges(v []string) {
	o.LoginIpRanges = v
}

// GetApiAuthentication returns the ApiAuthentication field value if set, zero value otherwise.
func (o *InlineResponse20097) GetApiAuthentication() InlineResponse20097ApiAuthentication {
	if o == nil || isNil(o.ApiAuthentication) {
		var ret InlineResponse20097ApiAuthentication
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20097) GetApiAuthenticationOk() (*InlineResponse20097ApiAuthentication, bool) {
	if o == nil || isNil(o.ApiAuthentication) {
    return nil, false
	}
...
func (o *InlineResponse20097) HasApiAuthentication() bool {
	if o != nil && !isNil(o.ApiAuthentication) {
		return true
	}
...
// SetApiAuthentication gets a reference to the given InlineResponse20097ApiAuthentication and assigns it to the ApiAuthentication field.
func (o *InlineResponse20097) SetApiAuthentication(v InlineResponse20097ApiAuthentication) {
