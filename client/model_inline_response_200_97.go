...
type InlineResponse20097 struct {
	UpgradeWindow *InlineResponse20097UpgradeWindow `json:"upgradeWindow,omitempty"`
...
func (o *InlineResponse20097) GetUpgradeWindow() InlineResponse20097UpgradeWindow {
	if o == nil || isNil(o.UpgradeWindow) {
		var ret InlineResponse20097UpgradeWindow
		return ret
	}
...
// SetUpgradeWindow gets a reference to the given InlineResponse20097UpgradeWindow and assigns it to the UpgradeWindow field.
