...
type InlineResponse20097 struct {
	...
	NamedVlans *InlineResponse20097NamedVlans `json:"namedVlans,omitempty"`
	RegulatoryDomain *InlineResponse20097RegulatoryDomain `json:"regulatoryDomain,omitempty"`
}
...
func (o *InlineResponse20097) GetNamedVlans() InlineResponse20097NamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret InlineResponse20097NamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given InlineResponse20097NamedVlans and assigns it to the NamedVlans field.
...
func (o *InlineResponse20097) GetRegulatoryDomain() InlineResponse20097RegulatoryDomain {
	if o == nil || isNil(o.RegulatoryDomain) {
		var ret InlineResponse20097RegulatoryDomain
		return ret
	}
...
// SetRegulatoryDomain gets a reference to the given InlineResponse20097RegulatoryDomain and assigns it to the RegulatoryDomain field.
