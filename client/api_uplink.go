...
func (r UplinkApiGetNetworkCellularGatewayUplinkRequest) Execute() (*InlineResponse20089, *http.Response, error) {
...
func (a *UplinkApiService) GetNetworkCellularGatewayUplinkExecute(r UplinkApiGetNetworkCellularGatewayUplinkRequest) (*InlineResponse20089, *http.Response, error) {
	var (
...
func (r UplinkApiGetOrganizationCellularGatewayUplinkStatusesRequest) Execute() ([]InlineResponse200272, *http.Response, error) {
...
func (a *UplinkApiService) GetOrganizationCellularGatewayUplinkStatusesExecute(r UplinkApiGetOrganizationCellularGatewayUplinkStatusesRequest) ([]InlineResponse200272, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinkApiUpdateNetworkCellularGatewayUplinkRequest) Execute() (*InlineResponse20089, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20089
func (a *UplinkApiService) UpdateNetworkCellularGatewayUplinkExecute(r UplinkApiUpdateNetworkCellularGatewayUplinkRequest) (*InlineResponse20089, *http.Response, error) {
	var (
