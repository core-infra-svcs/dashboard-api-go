...
func (r UplinkApiGetNetworkCellularGatewayUplinkRequest) Execute() (*InlineResponse20078, *http.Response, error) {
...
func (a *UplinkApiService) GetNetworkCellularGatewayUplinkExecute(r UplinkApiGetNetworkCellularGatewayUplinkRequest) (*InlineResponse20078, *http.Response, error) {
	var (
...
func (r UplinkApiGetOrganizationCellularGatewayUplinkStatusesRequest) Execute() ([]InlineResponse200227, *http.Response, error) {
...
func (a *UplinkApiService) GetOrganizationCellularGatewayUplinkStatusesExecute(r UplinkApiGetOrganizationCellularGatewayUplinkStatusesRequest) ([]InlineResponse200227, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UplinkApiUpdateNetworkCellularGatewayUplinkRequest) UpdateNetworkCellularGatewayUplink(updateNetworkCellularGatewayUplink InlineObject85) UplinkApiUpdateNetworkCellularGatewayUplinkRequest {
	r.updateNetworkCellularGatewayUplink = &updateNetworkCellularGatewayUplink
	return r
}

func (r UplinkApiUpdateNetworkCellularGatewayUplinkRequest) Execute() (*InlineResponse20078, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20078
func (a *UplinkApiService) UpdateNetworkCellularGatewayUplinkExecute(r UplinkApiUpdateNetworkCellularGatewayUplinkRequest) (*InlineResponse20078, *http.Response, error) {
	var (
