...
// InlineResponse20040EventData An object containing more data related to the event.
type InlineResponse20040EventData struct {
...
func NewInlineResponse20040EventData() *InlineResponse20040EventData {
	this := InlineResponse20040EventData{}
	return &this
}
...
func (o InlineResponse20040EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20040EventData struct {
	value *InlineResponse20040EventData
	isSet bool
}

func (v NullableInlineResponse20040EventData) Get() *InlineResponse20040EventData {
	return v.value
}

func (v *NullableInlineResponse20040EventData) Set(val *InlineResponse20040EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20040EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20040EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20040EventData(val *InlineResponse20040EventData) *NullableInlineResponse20040EventData {
	return &NullableInlineResponse20040EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20040EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20040EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
