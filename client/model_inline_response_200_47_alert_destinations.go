...
// InlineResponse20047AlertDestinations A hash of destinations for this specific alert
type InlineResponse20047AlertDestinations struct {
...
func NewInlineResponse20047AlertDestinations() *InlineResponse20047AlertDestinations {
	this := InlineResponse20047AlertDestinations{}
	return &this
}
...
func (o InlineResponse20047AlertDestinations) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20047AlertDestinations struct {
	value *InlineResponse20047AlertDestinations
	isSet bool
}

func (v NullableInlineResponse20047AlertDestinations) Get() *InlineResponse20047AlertDestinations {
	return v.value
}

func (v *NullableInlineResponse20047AlertDestinations) Set(val *InlineResponse20047AlertDestinations) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20047AlertDestinations) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20047AlertDestinations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20047AlertDestinations(val *InlineResponse20047AlertDestinations) *NullableInlineResponse20047AlertDestinations {
	return &NullableInlineResponse20047AlertDestinations{value: val, isSet: true}
}

func (v NullableInlineResponse20047AlertDestinations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20047AlertDestinations) UnmarshalJSON(src []byte) error {
	v.isSet = true
