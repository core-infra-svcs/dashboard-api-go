...
func (r NetworkHealthApiApiGetNetworkNetworkHealthChannelUtilizationRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *NetworkHealthApiService) GetNetworkNetworkHealthChannelUtilization(ctx context.Context, networkId string) NetworkHealthApiApiGetNetworkNetworkHealthChannelUtilizationRequest {
	return NetworkHealthApiApiGetNetworkNetworkHealthChannelUtilizationRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *NetworkHealthApiService) GetNetworkNetworkHealthChannelUtilizationExecute(r NetworkHealthApiApiGetNetworkNetworkHealthChannelUtilizationRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
