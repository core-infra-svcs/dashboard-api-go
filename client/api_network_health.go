...
func (r NetworkHealthApiGetNetworkNetworkHealthChannelUtilizationRequest) Execute() ([]InlineResponse200113, *http.Response, error) {
...
func (a *NetworkHealthApiService) GetNetworkNetworkHealthChannelUtilizationExecute(r NetworkHealthApiGetNetworkNetworkHealthChannelUtilizationRequest) ([]InlineResponse200113, *http.Response, error) {
	var (
