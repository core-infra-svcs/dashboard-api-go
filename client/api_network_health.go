...
func (r NetworkHealthApiGetNetworkNetworkHealthChannelUtilizationRequest) Execute() ([]InlineResponse20099, *http.Response, error) {
...
func (a *NetworkHealthApiService) GetNetworkNetworkHealthChannelUtilizationExecute(r NetworkHealthApiGetNetworkNetworkHealthChannelUtilizationRequest) ([]InlineResponse20099, *http.Response, error) {
	var (
