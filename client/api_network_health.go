...
func (r NetworkHealthApiGetNetworkNetworkHealthChannelUtilizationRequest) Execute() ([]InlineResponse200102, *http.Response, error) {
...
func (a *NetworkHealthApiService) GetNetworkNetworkHealthChannelUtilizationExecute(r NetworkHealthApiGetNetworkNetworkHealthChannelUtilizationRequest) ([]InlineResponse200102, *http.Response, error) {
	var (
