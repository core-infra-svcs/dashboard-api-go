...
func (r NetworkHealthApiGetNetworkNetworkHealthChannelUtilizationRequest) Execute() ([]InlineResponse200115, *http.Response, error) {
...
func (a *NetworkHealthApiService) GetNetworkNetworkHealthChannelUtilizationExecute(r NetworkHealthApiGetNetworkNetworkHealthChannelUtilizationRequest) ([]InlineResponse200115, *http.Response, error) {
	var (
