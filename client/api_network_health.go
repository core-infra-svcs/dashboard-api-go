...
func (r NetworkHealthApiGetNetworkNetworkHealthChannelUtilizationRequest) Execute() ([]InlineResponse200118, *http.Response, error) {
...
func (a *NetworkHealthApiService) GetNetworkNetworkHealthChannelUtilizationExecute(r NetworkHealthApiGetNetworkNetworkHealthChannelUtilizationRequest) ([]InlineResponse200118, *http.Response, error) {
	var (
