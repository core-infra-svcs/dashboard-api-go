...
// InlineResponse200244Totals Totals by Severity
type InlineResponse200244Totals struct {
...
func NewInlineResponse200244Totals() *InlineResponse200244Totals {
	this := InlineResponse200244Totals{}
	return &this
}
...
func (o InlineResponse200244Totals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200244Totals struct {
	value *InlineResponse200244Totals
	isSet bool
}

func (v NullableInlineResponse200244Totals) Get() *InlineResponse200244Totals {
	return v.value
}

func (v *NullableInlineResponse200244Totals) Set(val *InlineResponse200244Totals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200244Totals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200244Totals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200244Totals(val *InlineResponse200244Totals) *NullableInlineResponse200244Totals {
	return &NullableInlineResponse200244Totals{value: val, isSet: true}
}

func (v NullableInlineResponse200244Totals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200244Totals) UnmarshalJSON(src []byte) error {
	v.isSet = true
