...
// InlineResponse200317MetaCountsItems Items
type InlineResponse200317MetaCountsItems struct {
...
func NewInlineResponse200317MetaCountsItems() *InlineResponse200317MetaCountsItems {
	this := InlineResponse200317MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200317MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200317MetaCountsItems struct {
	value *InlineResponse200317MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200317MetaCountsItems) Get() *InlineResponse200317MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200317MetaCountsItems) Set(val *InlineResponse200317MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200317MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200317MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200317MetaCountsItems(val *InlineResponse200317MetaCountsItems) *NullableInlineResponse200317MetaCountsItems {
	return &NullableInlineResponse200317MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200317MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200317MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
