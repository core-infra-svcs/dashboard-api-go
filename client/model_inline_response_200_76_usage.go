...
// InlineResponse20076Usage Usage, sent and received
type InlineResponse20076Usage struct {
...
func (o InlineResponse20076Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20076Usage struct {
	value *InlineResponse20076Usage
	isSet bool
}

func (v NullableInlineResponse20076Usage) Get() *InlineResponse20076Usage {
	return v.value
}

func (v *NullableInlineResponse20076Usage) Set(val *InlineResponse20076Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20076Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20076Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20076Usage(val *InlineResponse20076Usage) *NullableInlineResponse20076Usage {
	return &NullableInlineResponse20076Usage{value: val, isSet: true}
}

func (v NullableInlineResponse20076Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20076Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
