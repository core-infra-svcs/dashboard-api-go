...
// InlineResponse200208ThirdPartyVpnPeers struct for InlineResponse200208ThirdPartyVpnPeers
type InlineResponse200208ThirdPartyVpnPeers struct {
	// Name of the peer
...
func NewInlineResponse200208ThirdPartyVpnPeers() *InlineResponse200208ThirdPartyVpnPeers {
	this := InlineResponse200208ThirdPartyVpnPeers{}
	return &this
}
...
func (o InlineResponse200208ThirdPartyVpnPeers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200208ThirdPartyVpnPeers struct {
	value *InlineResponse200208ThirdPartyVpnPeers
	isSet bool
}

func (v NullableInlineResponse200208ThirdPartyVpnPeers) Get() *InlineResponse200208ThirdPartyVpnPeers {
	return v.value
}

func (v *NullableInlineResponse200208ThirdPartyVpnPeers) Set(val *InlineResponse200208ThirdPartyVpnPeers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200208ThirdPartyVpnPeers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200208ThirdPartyVpnPeers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200208ThirdPartyVpnPeers(val *InlineResponse200208ThirdPartyVpnPeers) *NullableInlineResponse200208ThirdPartyVpnPeers {
	return &NullableInlineResponse200208ThirdPartyVpnPeers{value: val, isSet: true}
}

func (v NullableInlineResponse200208ThirdPartyVpnPeers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200208ThirdPartyVpnPeers) UnmarshalJSON(src []byte) error {
	v.isSet = true
