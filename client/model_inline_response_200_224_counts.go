...
// InlineResponse200224Counts The current amount of various adaptive policy objects.
type InlineResponse200224Counts struct {
...
func NewInlineResponse200224Counts() *InlineResponse200224Counts {
	this := InlineResponse200224Counts{}
	return &this
}
...
func (o InlineResponse200224Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200224Counts struct {
	value *InlineResponse200224Counts
	isSet bool
}

func (v NullableInlineResponse200224Counts) Get() *InlineResponse200224Counts {
	return v.value
}

func (v *NullableInlineResponse200224Counts) Set(val *InlineResponse200224Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200224Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200224Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200224Counts(val *InlineResponse200224Counts) *NullableInlineResponse200224Counts {
	return &NullableInlineResponse200224Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200224Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200224Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
