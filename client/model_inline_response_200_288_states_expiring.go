...
// InlineResponse200288StatesExpiring Data for expiring licenses
type InlineResponse200288StatesExpiring struct {
	// The number of expiring licenses
	Count *int32 `json:"count,omitempty"`
	Critical *InlineResponse200288StatesExpiringCritical `json:"critical,omitempty"`
	Warning *InlineResponse200288StatesExpiringWarning `json:"warning,omitempty"`
}
...
func NewInlineResponse200288StatesExpiring() *InlineResponse200288StatesExpiring {
	this := InlineResponse200288StatesExpiring{}
	return &this
}
...
func (o *InlineResponse200288StatesExpiring) GetCritical() InlineResponse200288StatesExpiringCritical {
	if o == nil || isNil(o.Critical) {
		var ret InlineResponse200288StatesExpiringCritical
		return ret
	}
	return *o.Critical
}
...
// SetCritical gets a reference to the given InlineResponse200288StatesExpiringCritical and assigns it to the Critical field.
...
func (o *InlineResponse200288StatesExpiring) GetWarning() InlineResponse200288StatesExpiringWarning {
	if o == nil || isNil(o.Warning) {
		var ret InlineResponse200288StatesExpiringWarning
		return ret
	}
	return *o.Warning
}
...
// SetWarning gets a reference to the given InlineResponse200288StatesExpiringWarning and assigns it to the Warning field.
func (o *InlineResponse200288StatesExpiring) SetWarning(v InlineResponse200288StatesExpiringWarning) {
	o.Warning = &v
}

func (o InlineResponse200288StatesExpiring) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200288StatesExpiring struct {
	value *InlineResponse200288StatesExpiring
	isSet bool
}

func (v NullableInlineResponse200288StatesExpiring) Get() *InlineResponse200288StatesExpiring {
	return v.value
}

func (v *NullableInlineResponse200288StatesExpiring) Set(val *InlineResponse200288StatesExpiring) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200288StatesExpiring) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200288StatesExpiring) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200288StatesExpiring(val *InlineResponse200288StatesExpiring) *NullableInlineResponse200288StatesExpiring {
	return &NullableInlineResponse200288StatesExpiring{value: val, isSet: true}
}

func (v NullableInlineResponse200288StatesExpiring) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200288StatesExpiring) UnmarshalJSON(src []byte) error {
	v.isSet = true
