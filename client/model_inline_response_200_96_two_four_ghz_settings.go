...
// InlineResponse20096TwoFourGhzSettings Settings related to 2.4Ghz band
type InlineResponse20096TwoFourGhzSettings struct {
...
func NewInlineResponse20096TwoFourGhzSettings() *InlineResponse20096TwoFourGhzSettings {
	this := InlineResponse20096TwoFourGhzSettings{}
	return &this
}
...
func (o InlineResponse20096TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20096TwoFourGhzSettings struct {
	value *InlineResponse20096TwoFourGhzSettings
	isSet bool
}

func (v NullableInlineResponse20096TwoFourGhzSettings) Get() *InlineResponse20096TwoFourGhzSettings {
	return v.value
}

func (v *NullableInlineResponse20096TwoFourGhzSettings) Set(val *InlineResponse20096TwoFourGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20096TwoFourGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20096TwoFourGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20096TwoFourGhzSettings(val *InlineResponse20096TwoFourGhzSettings) *NullableInlineResponse20096TwoFourGhzSettings {
	return &NullableInlineResponse20096TwoFourGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20096TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20096TwoFourGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
