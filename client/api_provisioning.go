...
func (r ProvisioningApiGetOrganizationDevicesProvisioningStatusesRequest) Execute() ([]InlineResponse200265, *http.Response, error) {
...
func (a *ProvisioningApiService) GetOrganizationDevicesProvisioningStatusesExecute(r ProvisioningApiGetOrganizationDevicesProvisioningStatusesRequest) ([]InlineResponse200265, *http.Response, error) {
	var (
