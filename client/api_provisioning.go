...
func (r ProvisioningApiGetOrganizationDevicesProvisioningStatusesRequest) Execute() ([]InlineResponse200281, *http.Response, error) {
...
func (a *ProvisioningApiService) GetOrganizationDevicesProvisioningStatusesExecute(r ProvisioningApiGetOrganizationDevicesProvisioningStatusesRequest) ([]InlineResponse200281, *http.Response, error) {
	var (
