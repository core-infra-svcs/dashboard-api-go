...
func (r ProvisioningApiGetOrganizationDevicesProvisioningStatusesRequest) Execute() ([]InlineResponse200279, *http.Response, error) {
...
func (a *ProvisioningApiService) GetOrganizationDevicesProvisioningStatusesExecute(r ProvisioningApiGetOrganizationDevicesProvisioningStatusesRequest) ([]InlineResponse200279, *http.Response, error) {
	var (
