...
// InlineResponse20052Destinations struct for InlineResponse20052Destinations
type InlineResponse20052Destinations struct {
...
func NewInlineResponse20052Destinations() *InlineResponse20052Destinations {
	this := InlineResponse20052Destinations{}
	return &this
}
...
func (o InlineResponse20052Destinations) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20052Destinations struct {
	value *InlineResponse20052Destinations
	isSet bool
}

func (v NullableInlineResponse20052Destinations) Get() *InlineResponse20052Destinations {
	return v.value
}

func (v *NullableInlineResponse20052Destinations) Set(val *InlineResponse20052Destinations) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20052Destinations) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20052Destinations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20052Destinations(val *InlineResponse20052Destinations) *NullableInlineResponse20052Destinations {
	return &NullableInlineResponse20052Destinations{value: val, isSet: true}
}

func (v NullableInlineResponse20052Destinations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20052Destinations) UnmarshalJSON(src []byte) error {
	v.isSet = true
