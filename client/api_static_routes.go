...
func (r StaticRoutesApiGetDeviceSwitchRoutingStaticRouteRequest) Execute() (*InlineResponse2007, *http.Response, error) {
...
func (a *StaticRoutesApiService) GetDeviceSwitchRoutingStaticRouteExecute(r StaticRoutesApiGetDeviceSwitchRoutingStaticRouteRequest) (*InlineResponse2007, *http.Response, error) {
	var (
