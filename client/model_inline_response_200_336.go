...
type InlineResponse200336 struct {
	...
	Example *InlineResponse200336Example `json:"example,omitempty"`
}
...
func (o *InlineResponse200336) GetExample() InlineResponse200336Example {
	if o == nil || isNil(o.Example) {
		var ret InlineResponse200336Example
		return ret
	}
	return *o.Example
}
...
// SetExample gets a reference to the given InlineResponse200336Example and assigns it to the Example field.
