...
// InlineResponse20096UsageOverall Overall data usage of all clients across organization
type InlineResponse20096UsageOverall struct {
...
func NewInlineResponse20096UsageOverall() *InlineResponse20096UsageOverall {
	this := InlineResponse20096UsageOverall{}
	return &this
}
...
func (o InlineResponse20096UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20096UsageOverall struct {
	value *InlineResponse20096UsageOverall
	isSet bool
}

func (v NullableInlineResponse20096UsageOverall) Get() *InlineResponse20096UsageOverall {
	return v.value
}

func (v *NullableInlineResponse20096UsageOverall) Set(val *InlineResponse20096UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20096UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20096UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20096UsageOverall(val *InlineResponse20096UsageOverall) *NullableInlineResponse20096UsageOverall {
	return &NullableInlineResponse20096UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse20096UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20096UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
