...
// InlineResponse200329MetaCountsItems Items
type InlineResponse200329MetaCountsItems struct {
...
func NewInlineResponse200329MetaCountsItems() *InlineResponse200329MetaCountsItems {
	this := InlineResponse200329MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200329MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200329MetaCountsItems struct {
	value *InlineResponse200329MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200329MetaCountsItems) Get() *InlineResponse200329MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200329MetaCountsItems) Set(val *InlineResponse200329MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200329MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200329MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200329MetaCountsItems(val *InlineResponse200329MetaCountsItems) *NullableInlineResponse200329MetaCountsItems {
	return &NullableInlineResponse200329MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200329MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200329MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
