...
// InlineResponse20066Value1Source Source of 'custom' type traffic filter
type InlineResponse20066Value1Source struct {
...
func NewInlineResponse20066Value1Source() *InlineResponse20066Value1Source {
	this := InlineResponse20066Value1Source{}
	return &this
}
...
func (o InlineResponse20066Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20066Value1Source struct {
	value *InlineResponse20066Value1Source
	isSet bool
}

func (v NullableInlineResponse20066Value1Source) Get() *InlineResponse20066Value1Source {
	return v.value
}

func (v *NullableInlineResponse20066Value1Source) Set(val *InlineResponse20066Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20066Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20066Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20066Value1Source(val *InlineResponse20066Value1Source) *NullableInlineResponse20066Value1Source {
	return &NullableInlineResponse20066Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20066Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20066Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
