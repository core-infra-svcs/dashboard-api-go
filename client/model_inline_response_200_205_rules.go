...
// InlineResponse200205Rules struct for InlineResponse200205Rules
type InlineResponse200205Rules struct {
...
func NewInlineResponse200205Rules(definitions []NetworksNetworkIdApplianceTrafficShapingRulesDefinitions) *InlineResponse200205Rules {
	this := InlineResponse200205Rules{}
...
func (o InlineResponse200205Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200205Rules struct {
	value *InlineResponse200205Rules
	isSet bool
}

func (v NullableInlineResponse200205Rules) Get() *InlineResponse200205Rules {
	return v.value
}

func (v *NullableInlineResponse200205Rules) Set(val *InlineResponse200205Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200205Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200205Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200205Rules(val *InlineResponse200205Rules) *NullableInlineResponse200205Rules {
	return &NullableInlineResponse200205Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200205Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200205Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
