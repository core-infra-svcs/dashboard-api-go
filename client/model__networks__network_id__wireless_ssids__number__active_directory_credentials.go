...
func (o *NetworksNetworkIdWirelessSsidsNumberActiveDirectoryCredentials) SetLogonNameNil() {
	o.LogonName.Set(nil)
}
...
func (o *NetworksNetworkIdWirelessSsidsNumberActiveDirectoryCredentials) SetPasswordNil() {
	o.Password.Set(nil)
}
