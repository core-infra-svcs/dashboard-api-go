...
// InlineResponse200345Series struct for InlineResponse200345Series
type InlineResponse200345Series struct {
...
func NewInlineResponse200345Series() *InlineResponse200345Series {
	this := InlineResponse200345Series{}
	return &this
}
...
func (o InlineResponse200345Series) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200345Series struct {
	value *InlineResponse200345Series
	isSet bool
}

func (v NullableInlineResponse200345Series) Get() *InlineResponse200345Series {
	return v.value
}

func (v *NullableInlineResponse200345Series) Set(val *InlineResponse200345Series) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200345Series) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200345Series) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200345Series(val *InlineResponse200345Series) *NullableInlineResponse200345Series {
	return &NullableInlineResponse200345Series{value: val, isSet: true}
}

func (v NullableInlineResponse200345Series) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200345Series) UnmarshalJSON(src []byte) error {
	v.isSet = true
