...
// InlineResponse200218Counts The current amount of various adaptive policy objects.
type InlineResponse200218Counts struct {
...
func NewInlineResponse200218Counts() *InlineResponse200218Counts {
	this := InlineResponse200218Counts{}
	return &this
}
...
func (o InlineResponse200218Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200218Counts struct {
	value *InlineResponse200218Counts
	isSet bool
}

func (v NullableInlineResponse200218Counts) Get() *InlineResponse200218Counts {
	return v.value
}

func (v *NullableInlineResponse200218Counts) Set(val *InlineResponse200218Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200218Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200218Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200218Counts(val *InlineResponse200218Counts) *NullableInlineResponse200218Counts {
	return &NullableInlineResponse200218Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200218Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200218Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
