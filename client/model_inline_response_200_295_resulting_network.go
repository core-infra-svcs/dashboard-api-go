...
// InlineResponse200295ResultingNetwork Network after the combination
type InlineResponse200295ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200295ResultingNetwork() *InlineResponse200295ResultingNetwork {
	this := InlineResponse200295ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200295ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200295ResultingNetwork struct {
	value *InlineResponse200295ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200295ResultingNetwork) Get() *InlineResponse200295ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200295ResultingNetwork) Set(val *InlineResponse200295ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200295ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200295ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200295ResultingNetwork(val *InlineResponse200295ResultingNetwork) *NullableInlineResponse200295ResultingNetwork {
	return &NullableInlineResponse200295ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200295ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200295ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
