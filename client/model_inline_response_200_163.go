...
type InlineResponse200163 struct {
	...
	V3 *InlineResponse200163V3 `json:"v3,omitempty"`
	...
	Md5AuthenticationKey *InlineResponse200163Md5AuthenticationKey `json:"md5AuthenticationKey,omitempty"`
}
...
func (o *InlineResponse200163) GetV3() InlineResponse200163V3 {
	if o == nil || isNil(o.V3) {
		var ret InlineResponse200163V3
		return ret
	}
	return *o.V3
}
...
// SetV3 gets a reference to the given InlineResponse200163V3 and assigns it to the V3 field.
...
func (o *InlineResponse200163) GetMd5AuthenticationKey() InlineResponse200163Md5AuthenticationKey {
	if o == nil || isNil(o.Md5AuthenticationKey) {
		var ret InlineResponse200163Md5AuthenticationKey
		return ret
	}
...
// SetMd5AuthenticationKey gets a reference to the given InlineResponse200163Md5AuthenticationKey and assigns it to the Md5AuthenticationKey field.
