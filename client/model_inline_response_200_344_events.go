...
// InlineResponse200344Events struct for InlineResponse200344Events
type InlineResponse200344Events struct {
...
func NewInlineResponse200344Events() *InlineResponse200344Events {
	this := InlineResponse200344Events{}
	return &this
}
...
func (o InlineResponse200344Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200344Events struct {
	value *InlineResponse200344Events
	isSet bool
}

func (v NullableInlineResponse200344Events) Get() *InlineResponse200344Events {
	return v.value
}

func (v *NullableInlineResponse200344Events) Set(val *InlineResponse200344Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200344Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200344Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200344Events(val *InlineResponse200344Events) *NullableInlineResponse200344Events {
	return &NullableInlineResponse200344Events{value: val, isSet: true}
}

func (v NullableInlineResponse200344Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200344Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
