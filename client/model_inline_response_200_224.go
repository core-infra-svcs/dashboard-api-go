...
type InlineResponse200224 struct {
	...
	SplashLogo *InlineResponse200224SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200224SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200224SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200224GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200224Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200224SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200224SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200224) GetSplashLogo() InlineResponse200224SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200224SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200224SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200224) GetSplashImage() InlineResponse200224SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200224SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200224SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200224) GetSplashPrepaidFront() InlineResponse200224SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200224SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200224SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200224) GetGuestSponsorship() InlineResponse200224GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200224GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200224GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200224) GetBilling() InlineResponse200224Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200224Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200224Billing and assigns it to the Billing field.
...
func (o *InlineResponse200224) GetSentryEnrollment() InlineResponse200224SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200224SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200224SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200224) GetSelfRegistration() InlineResponse200224SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200224SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200224SelfRegistration and assigns it to the SelfRegistration field.
