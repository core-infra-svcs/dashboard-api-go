...
// InlineResponse20087Events struct for InlineResponse20087Events
type InlineResponse20087Events struct {
	...
	EventData *InlineResponse20087EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20087Events() *InlineResponse20087Events {
	this := InlineResponse20087Events{}
	return &this
}
...
func (o *InlineResponse20087Events) GetEventData() InlineResponse20087EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20087EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20087EventData and assigns it to the EventData field.
func (o *InlineResponse20087Events) SetEventData(v InlineResponse20087EventData) {
	o.EventData = &v
}

func (o InlineResponse20087Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20087Events struct {
	value *InlineResponse20087Events
	isSet bool
}

func (v NullableInlineResponse20087Events) Get() *InlineResponse20087Events {
	return v.value
}

func (v *NullableInlineResponse20087Events) Set(val *InlineResponse20087Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20087Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20087Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20087Events(val *InlineResponse20087Events) *NullableInlineResponse20087Events {
	return &NullableInlineResponse20087Events{value: val, isSet: true}
}

func (v NullableInlineResponse20087Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20087Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
