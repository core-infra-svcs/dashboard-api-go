...
// InlineResponse200194NamedVlansPoolDhcpMonitoring Named VLAN Pool DHCP Monitoring settings.
type InlineResponse200194NamedVlansPoolDhcpMonitoring struct {
...
func NewInlineResponse200194NamedVlansPoolDhcpMonitoring() *InlineResponse200194NamedVlansPoolDhcpMonitoring {
	this := InlineResponse200194NamedVlansPoolDhcpMonitoring{}
	return &this
}
...
func (o InlineResponse200194NamedVlansPoolDhcpMonitoring) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200194NamedVlansPoolDhcpMonitoring struct {
	value *InlineResponse200194NamedVlansPoolDhcpMonitoring
	isSet bool
}

func (v NullableInlineResponse200194NamedVlansPoolDhcpMonitoring) Get() *InlineResponse200194NamedVlansPoolDhcpMonitoring {
	return v.value
}

func (v *NullableInlineResponse200194NamedVlansPoolDhcpMonitoring) Set(val *InlineResponse200194NamedVlansPoolDhcpMonitoring) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200194NamedVlansPoolDhcpMonitoring) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200194NamedVlansPoolDhcpMonitoring) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200194NamedVlansPoolDhcpMonitoring(val *InlineResponse200194NamedVlansPoolDhcpMonitoring) *NullableInlineResponse200194NamedVlansPoolDhcpMonitoring {
	return &NullableInlineResponse200194NamedVlansPoolDhcpMonitoring{value: val, isSet: true}
}

func (v NullableInlineResponse200194NamedVlansPoolDhcpMonitoring) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200194NamedVlansPoolDhcpMonitoring) UnmarshalJSON(src []byte) error {
	v.isSet = true
