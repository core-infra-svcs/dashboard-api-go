...
// InlineResponse20029Value1Source Source of 'custom' type traffic filter
type InlineResponse20029Value1Source struct {
...
func NewInlineResponse20029Value1Source() *InlineResponse20029Value1Source {
	this := InlineResponse20029Value1Source{}
	return &this
}
...
func (o InlineResponse20029Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20029Value1Source struct {
	value *InlineResponse20029Value1Source
	isSet bool
}

func (v NullableInlineResponse20029Value1Source) Get() *InlineResponse20029Value1Source {
	return v.value
}

func (v *NullableInlineResponse20029Value1Source) Set(val *InlineResponse20029Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20029Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20029Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20029Value1Source(val *InlineResponse20029Value1Source) *NullableInlineResponse20029Value1Source {
	return &NullableInlineResponse20029Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20029Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20029Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
