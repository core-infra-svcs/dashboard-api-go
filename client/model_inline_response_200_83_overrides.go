...
// InlineResponse20083Overrides struct for InlineResponse20083Overrides
type InlineResponse20083Overrides struct {
...
func NewInlineResponse20083Overrides(mtuSize int32) *InlineResponse20083Overrides {
	this := InlineResponse20083Overrides{}
...
func (o InlineResponse20083Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20083Overrides struct {
	value *InlineResponse20083Overrides
	isSet bool
}

func (v NullableInlineResponse20083Overrides) Get() *InlineResponse20083Overrides {
	return v.value
}

func (v *NullableInlineResponse20083Overrides) Set(val *InlineResponse20083Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20083Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20083Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20083Overrides(val *InlineResponse20083Overrides) *NullableInlineResponse20083Overrides {
	return &NullableInlineResponse20083Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse20083Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20083Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
