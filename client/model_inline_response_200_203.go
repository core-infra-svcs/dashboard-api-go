...
type InlineResponse200203 struct {
	...
	AccessControl *NetworksNetworkIdWirelessSsidsAccessControl `json:"accessControl,omitempty"`
...
func (o *InlineResponse200203) GetAccessControl() NetworksNetworkIdWirelessSsidsAccessControl {
	if o == nil || isNil(o.AccessControl) {
		var ret NetworksNetworkIdWirelessSsidsAccessControl
		return ret
	}
...
// SetAccessControl gets a reference to the given NetworksNetworkIdWirelessSsidsAccessControl and assigns it to the AccessControl field.
