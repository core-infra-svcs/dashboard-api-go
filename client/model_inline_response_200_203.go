...
type InlineResponse200203 struct {
	...
	SplashLogo *InlineResponse200203SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200203SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200203SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200203GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200203Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200203SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200203SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200203) GetSplashLogo() InlineResponse200203SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200203SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200203SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200203) GetSplashImage() InlineResponse200203SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200203SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200203SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200203) GetSplashPrepaidFront() InlineResponse200203SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200203SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200203SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200203) GetGuestSponsorship() InlineResponse200203GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200203GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200203GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200203) GetBilling() InlineResponse200203Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200203Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200203Billing and assigns it to the Billing field.
...
func (o *InlineResponse200203) GetSentryEnrollment() InlineResponse200203SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200203SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200203SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200203) GetSelfRegistration() InlineResponse200203SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200203SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200203SelfRegistration and assigns it to the SelfRegistration field.
