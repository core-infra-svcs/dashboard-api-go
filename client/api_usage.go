...
func (r UsageApiGetOrganizationApplianceUplinksUsageByNetworkRequest) Execute() ([]InlineResponse200207, *http.Response, error) {
...
func (a *UsageApiService) GetOrganizationApplianceUplinksUsageByNetworkExecute(r UsageApiGetOrganizationApplianceUplinksUsageByNetworkRequest) ([]InlineResponse200207, *http.Response, error) {
	var (
