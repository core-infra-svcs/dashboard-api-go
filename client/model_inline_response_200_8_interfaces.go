...
// InlineResponse2008Interfaces Interface settings.
type InlineResponse2008Interfaces struct {
	Wan1 *InlineResponse2008InterfacesWan1 `json:"wan1,omitempty"`
	Wan2 *InlineResponse2008InterfacesWan2 `json:"wan2,omitempty"`
}
...
func NewInlineResponse2008Interfaces() *InlineResponse2008Interfaces {
	this := InlineResponse2008Interfaces{}
	return &this
}
...
func (o *InlineResponse2008Interfaces) GetWan1() InlineResponse2008InterfacesWan1 {
	if o == nil || isNil(o.Wan1) {
		var ret InlineResponse2008InterfacesWan1
		return ret
	}
	return *o.Wan1
}
...
// SetWan1 gets a reference to the given InlineResponse2008InterfacesWan1 and assigns it to the Wan1 field.
...
func (o *InlineResponse2008Interfaces) GetWan2() InlineResponse2008InterfacesWan2 {
	if o == nil || isNil(o.Wan2) {
		var ret InlineResponse2008InterfacesWan2
		return ret
	}
	return *o.Wan2
}
...
// SetWan2 gets a reference to the given InlineResponse2008InterfacesWan2 and assigns it to the Wan2 field.
func (o *InlineResponse2008Interfaces) SetWan2(v InlineResponse2008InterfacesWan2) {
	o.Wan2 = &v
}

func (o InlineResponse2008Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2008Interfaces struct {
	value *InlineResponse2008Interfaces
	isSet bool
}

func (v NullableInlineResponse2008Interfaces) Get() *InlineResponse2008Interfaces {
	return v.value
}

func (v *NullableInlineResponse2008Interfaces) Set(val *InlineResponse2008Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2008Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2008Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2008Interfaces(val *InlineResponse2008Interfaces) *NullableInlineResponse2008Interfaces {
	return &NullableInlineResponse2008Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse2008Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2008Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
