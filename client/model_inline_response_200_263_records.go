...
// InlineResponse200263Records struct for InlineResponse200263Records
type InlineResponse200263Records struct {
	Network *InlineResponse200263Network `json:"network,omitempty"`
	...
	ClientVpnConnections []InlineResponse200263ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200263Records() *InlineResponse200263Records {
	this := InlineResponse200263Records{}
	return &this
}
...
func (o *InlineResponse200263Records) GetNetwork() InlineResponse200263Network {
	if o == nil || isNil(o.Network) {
		var ret InlineResponse200263Network
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given InlineResponse200263Network and assigns it to the Network field.
...
func (o *InlineResponse200263Records) GetClientVpnConnections() []InlineResponse200263ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200263ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200263ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200263Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200263Records struct {
	value *InlineResponse200263Records
	isSet bool
}

func (v NullableInlineResponse200263Records) Get() *InlineResponse200263Records {
	return v.value
}

func (v *NullableInlineResponse200263Records) Set(val *InlineResponse200263Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200263Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200263Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200263Records(val *InlineResponse200263Records) *NullableInlineResponse200263Records {
	return &NullableInlineResponse200263Records{value: val, isSet: true}
}

func (v NullableInlineResponse200263Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200263Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
