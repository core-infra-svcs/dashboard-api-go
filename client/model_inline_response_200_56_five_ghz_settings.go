...
// InlineResponse20056FiveGhzSettings Settings related to 5Ghz band.
type InlineResponse20056FiveGhzSettings struct {
...
func NewInlineResponse20056FiveGhzSettings() *InlineResponse20056FiveGhzSettings {
	this := InlineResponse20056FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse20056FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20056FiveGhzSettings struct {
	value *InlineResponse20056FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse20056FiveGhzSettings) Get() *InlineResponse20056FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse20056FiveGhzSettings) Set(val *InlineResponse20056FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20056FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20056FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20056FiveGhzSettings(val *InlineResponse20056FiveGhzSettings) *NullableInlineResponse20056FiveGhzSettings {
	return &NullableInlineResponse20056FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20056FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20056FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
