...
func (o *InlineObject259) GetScope() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject259) GetScopeOk() (*string, bool) {
	if o == nil || isNil(o.Scope) {
    return nil, false
	}
	return o.Scope, true
...
func (o *InlineObject259) HasScope() bool {
	if o != nil && !isNil(o.Scope) {
		return true
	}
...
func (o *InlineObject259) SetScope(v string) {
	o.Scope = &v
}

// GetTags returns the Tags field value if set, zero value otherwise.
func (o *InlineObject259) GetTags() []string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject259) GetTagsOk() ([]string, bool) {
	if o == nil || isNil(o.Tags) {
    return nil, false
	}
	return o.Tags, true
...
func (o *InlineObject259) HasTags() bool {
	if o != nil && !isNil(o.Tags) {
		return true
	}
...
func (o *InlineObject259) SetTags(v []string) {
	o.Tags = v
}
