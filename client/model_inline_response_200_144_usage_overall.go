...
// InlineResponse200144UsageOverall Overall data usage of all clients across organization
type InlineResponse200144UsageOverall struct {
...
func NewInlineResponse200144UsageOverall() *InlineResponse200144UsageOverall {
	this := InlineResponse200144UsageOverall{}
	return &this
}
...
func (o InlineResponse200144UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200144UsageOverall struct {
	value *InlineResponse200144UsageOverall
	isSet bool
}

func (v NullableInlineResponse200144UsageOverall) Get() *InlineResponse200144UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200144UsageOverall) Set(val *InlineResponse200144UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200144UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200144UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200144UsageOverall(val *InlineResponse200144UsageOverall) *NullableInlineResponse200144UsageOverall {
	return &NullableInlineResponse200144UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200144UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200144UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
