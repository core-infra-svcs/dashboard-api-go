...
// InlineResponse20023Rules struct for InlineResponse20023Rules
type InlineResponse20023Rules struct {
...
func (o InlineResponse20023Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20023Rules struct {
	value *InlineResponse20023Rules
	isSet bool
}

func (v NullableInlineResponse20023Rules) Get() *InlineResponse20023Rules {
	return v.value
}

func (v *NullableInlineResponse20023Rules) Set(val *InlineResponse20023Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20023Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20023Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20023Rules(val *InlineResponse20023Rules) *NullableInlineResponse20023Rules {
	return &NullableInlineResponse20023Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20023Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20023Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
