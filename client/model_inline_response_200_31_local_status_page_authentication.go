...
// InlineResponse20031LocalStatusPageAuthentication A hash of Local Status page(s)' authentication options applied to the Network.
type InlineResponse20031LocalStatusPageAuthentication struct {
...
func NewInlineResponse20031LocalStatusPageAuthentication() *InlineResponse20031LocalStatusPageAuthentication {
	this := InlineResponse20031LocalStatusPageAuthentication{}
	return &this
}
...
func (o InlineResponse20031LocalStatusPageAuthentication) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20031LocalStatusPageAuthentication struct {
	value *InlineResponse20031LocalStatusPageAuthentication
	isSet bool
}

func (v NullableInlineResponse20031LocalStatusPageAuthentication) Get() *InlineResponse20031LocalStatusPageAuthentication {
	return v.value
}

func (v *NullableInlineResponse20031LocalStatusPageAuthentication) Set(val *InlineResponse20031LocalStatusPageAuthentication) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20031LocalStatusPageAuthentication) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20031LocalStatusPageAuthentication) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20031LocalStatusPageAuthentication(val *InlineResponse20031LocalStatusPageAuthentication) *NullableInlineResponse20031LocalStatusPageAuthentication {
	return &NullableInlineResponse20031LocalStatusPageAuthentication{value: val, isSet: true}
}

func (v NullableInlineResponse20031LocalStatusPageAuthentication) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20031LocalStatusPageAuthentication) UnmarshalJSON(src []byte) error {
	v.isSet = true
