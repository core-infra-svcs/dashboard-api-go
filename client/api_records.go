...
func (r RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest) CreateOrganizationApplianceDnsLocalRecord(createOrganizationApplianceDnsLocalRecord InlineObject229) RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest {
	r.createOrganizationApplianceDnsLocalRecord = &createOrganizationApplianceDnsLocalRecord
	return r
}

func (r RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest) Execute() ([]InlineResponse200229, *http.Response, error) {
...
func (a *RecordsApiService) CreateOrganizationApplianceDnsLocalRecordExecute(r RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest) ([]InlineResponse200229, *http.Response, error) {
	var (
...
func (r RecordsApiGetOrganizationApplianceDnsLocalRecordsRequest) Execute() ([]InlineResponse200229, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200229
func (a *RecordsApiService) GetOrganizationApplianceDnsLocalRecordsExecute(r RecordsApiGetOrganizationApplianceDnsLocalRecordsRequest) ([]InlineResponse200229, *http.Response, error) {
	var (
...
func (r RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest) UpdateOrganizationApplianceDnsLocalRecord(updateOrganizationApplianceDnsLocalRecord InlineObject230) RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest {
	r.updateOrganizationApplianceDnsLocalRecord = &updateOrganizationApplianceDnsLocalRecord
	return r
}

func (r RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest) Execute() (*InlineResponse200229, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200229
func (a *RecordsApiService) UpdateOrganizationApplianceDnsLocalRecordExecute(r RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest) (*InlineResponse200229, *http.Response, error) {
	var (
