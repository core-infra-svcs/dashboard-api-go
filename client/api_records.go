...
func (r RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest) CreateOrganizationApplianceDnsLocalRecord(createOrganizationApplianceDnsLocalRecord InlineObject221) RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest {
	r.createOrganizationApplianceDnsLocalRecord = &createOrganizationApplianceDnsLocalRecord
	return r
}

func (r RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest) Execute() ([]InlineResponse200221, *http.Response, error) {
...
func (a *RecordsApiService) CreateOrganizationApplianceDnsLocalRecordExecute(r RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest) ([]InlineResponse200221, *http.Response, error) {
	var (
...
func (r RecordsApiGetOrganizationApplianceDnsLocalRecordsRequest) Execute() ([]InlineResponse200221, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200221
func (a *RecordsApiService) GetOrganizationApplianceDnsLocalRecordsExecute(r RecordsApiGetOrganizationApplianceDnsLocalRecordsRequest) ([]InlineResponse200221, *http.Response, error) {
	var (
...
func (r RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest) UpdateOrganizationApplianceDnsLocalRecord(updateOrganizationApplianceDnsLocalRecord InlineObject222) RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest {
	r.updateOrganizationApplianceDnsLocalRecord = &updateOrganizationApplianceDnsLocalRecord
	return r
}

func (r RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest) Execute() (*InlineResponse200221, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200221
func (a *RecordsApiService) UpdateOrganizationApplianceDnsLocalRecordExecute(r RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest) (*InlineResponse200221, *http.Response, error) {
	var (
