...
func (r RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest) Execute() ([]InlineResponse200235, *http.Response, error) {
...
func (a *RecordsApiService) CreateOrganizationApplianceDnsLocalRecordExecute(r RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest) ([]InlineResponse200235, *http.Response, error) {
	var (
...
func (r RecordsApiGetOrganizationApplianceDnsLocalRecordsRequest) Execute() ([]InlineResponse200235, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200235
func (a *RecordsApiService) GetOrganizationApplianceDnsLocalRecordsExecute(r RecordsApiGetOrganizationApplianceDnsLocalRecordsRequest) ([]InlineResponse200235, *http.Response, error) {
	var (
...
func (r RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest) Execute() (*InlineResponse200235, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200235
func (a *RecordsApiService) UpdateOrganizationApplianceDnsLocalRecordExecute(r RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest) (*InlineResponse200235, *http.Response, error) {
	var (
