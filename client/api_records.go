...
func (r RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest) CreateOrganizationApplianceDnsLocalRecord(createOrganizationApplianceDnsLocalRecord InlineObject228) RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest {
	r.createOrganizationApplianceDnsLocalRecord = &createOrganizationApplianceDnsLocalRecord
	return r
}

func (r RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest) Execute() ([]InlineResponse200228, *http.Response, error) {
...
func (a *RecordsApiService) CreateOrganizationApplianceDnsLocalRecordExecute(r RecordsApiCreateOrganizationApplianceDnsLocalRecordRequest) ([]InlineResponse200228, *http.Response, error) {
	var (
...
func (r RecordsApiGetOrganizationApplianceDnsLocalRecordsRequest) Execute() ([]InlineResponse200228, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200228
func (a *RecordsApiService) GetOrganizationApplianceDnsLocalRecordsExecute(r RecordsApiGetOrganizationApplianceDnsLocalRecordsRequest) ([]InlineResponse200228, *http.Response, error) {
	var (
...
func (r RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest) UpdateOrganizationApplianceDnsLocalRecord(updateOrganizationApplianceDnsLocalRecord InlineObject229) RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest {
	r.updateOrganizationApplianceDnsLocalRecord = &updateOrganizationApplianceDnsLocalRecord
	return r
}

func (r RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest) Execute() (*InlineResponse200228, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200228
func (a *RecordsApiService) UpdateOrganizationApplianceDnsLocalRecordExecute(r RecordsApiUpdateOrganizationApplianceDnsLocalRecordRequest) (*InlineResponse200228, *http.Response, error) {
	var (
