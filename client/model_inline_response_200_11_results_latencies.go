...
// InlineResponse20011ResultsLatencies Packet latency stats
type InlineResponse20011ResultsLatencies struct {
	// Minimum latency
...
func NewInlineResponse20011ResultsLatencies() *InlineResponse20011ResultsLatencies {
	this := InlineResponse20011ResultsLatencies{}
	return &this
}
...
func (o InlineResponse20011ResultsLatencies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20011ResultsLatencies struct {
	value *InlineResponse20011ResultsLatencies
	isSet bool
}

func (v NullableInlineResponse20011ResultsLatencies) Get() *InlineResponse20011ResultsLatencies {
	return v.value
}

func (v *NullableInlineResponse20011ResultsLatencies) Set(val *InlineResponse20011ResultsLatencies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20011ResultsLatencies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20011ResultsLatencies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20011ResultsLatencies(val *InlineResponse20011ResultsLatencies) *NullableInlineResponse20011ResultsLatencies {
	return &NullableInlineResponse20011ResultsLatencies{value: val, isSet: true}
}

func (v NullableInlineResponse20011ResultsLatencies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20011ResultsLatencies) UnmarshalJSON(src []byte) error {
	v.isSet = true
