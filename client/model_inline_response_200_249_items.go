...
type InlineResponse200249Items struct {
	...
	// Available APNs
	Apns []InlineResponse200249Apns `json:"apns,omitempty"`
...
func (o *InlineResponse200249Items) GetApns() []InlineResponse200249Apns {
	if o == nil || isNil(o.Apns) {
		var ret []InlineResponse200249Apns
		return ret
	}
	return o.Apns
}
...
// SetApns gets a reference to the given []InlineResponse200249Apns and assigns it to the Apns field.
