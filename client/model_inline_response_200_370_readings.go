...
// InlineResponse200370Readings struct for InlineResponse200370Readings
type InlineResponse200370Readings struct {
	// The start time of the query range
	StartTs *time.Time `json:"startTs,omitempty"`
	// The end time of the query range
	EndTs *time.Time `json:"endTs,omitempty"`
	Counts *InlineResponse200370Counts `json:"counts,omitempty"`
}
...
func NewInlineResponse200370Readings() *InlineResponse200370Readings {
	this := InlineResponse200370Readings{}
	return &this
}
...
func (o *InlineResponse200370Readings) GetCounts() InlineResponse200370Counts {
	if o == nil || isNil(o.Counts) {
		var ret InlineResponse200370Counts
		return ret
	}
	return *o.Counts
}
...
// SetCounts gets a reference to the given InlineResponse200370Counts and assigns it to the Counts field.
func (o *InlineResponse200370Readings) SetCounts(v InlineResponse200370Counts) {
	o.Counts = &v
}

func (o InlineResponse200370Readings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200370Readings struct {
	value *InlineResponse200370Readings
	isSet bool
}

func (v NullableInlineResponse200370Readings) Get() *InlineResponse200370Readings {
	return v.value
}

func (v *NullableInlineResponse200370Readings) Set(val *InlineResponse200370Readings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200370Readings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200370Readings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200370Readings(val *InlineResponse200370Readings) *NullableInlineResponse200370Readings {
	return &NullableInlineResponse200370Readings{value: val, isSet: true}
}

func (v NullableInlineResponse200370Readings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200370Readings) UnmarshalJSON(src []byte) error {
	v.isSet = true
