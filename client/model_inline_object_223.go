...
func (o *InlineObject223) GetLimitScopeToNetworks() []string {
...
func (o *InlineObject223) GetLimitScopeToNetworksOk() ([]string, bool) {
	if o == nil || isNil(o.LimitScopeToNetworks) {
    return nil, false
	}
...
func (o *InlineObject223) HasLimitScopeToNetworks() bool {
	if o != nil && !isNil(o.LimitScopeToNetworks) {
		return true
	}
...
func (o *InlineObject223) SetLimitScopeToNetworks(v []string) {
