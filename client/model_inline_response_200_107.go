...
type InlineResponse200107 struct {
	...
	ApBandSettings *InlineResponse200107ApBandSettings `json:"apBandSettings,omitempty"`
	TwoFourGhzSettings *InlineResponse200107TwoFourGhzSettings `json:"twoFourGhzSettings,omitempty"`
	FiveGhzSettings *InlineResponse200107FiveGhzSettings `json:"fiveGhzSettings,omitempty"`
	SixGhzSettings *InlineResponse200107SixGhzSettings `json:"sixGhzSettings,omitempty"`
	Transmission *InlineResponse200107Transmission `json:"transmission,omitempty"`
	PerSsidSettings *InlineResponse200107PerSsidSettings `json:"perSsidSettings,omitempty"`
}
...
func (o *InlineResponse200107) GetApBandSettings() InlineResponse200107ApBandSettings {
	if o == nil || isNil(o.ApBandSettings) {
		var ret InlineResponse200107ApBandSettings
		return ret
	}
...
// SetApBandSettings gets a reference to the given InlineResponse200107ApBandSettings and assigns it to the ApBandSettings field.
...
func (o *InlineResponse200107) GetTwoFourGhzSettings() InlineResponse200107TwoFourGhzSettings {
	if o == nil || isNil(o.TwoFourGhzSettings) {
		var ret InlineResponse200107TwoFourGhzSettings
		return ret
	}
...
// SetTwoFourGhzSettings gets a reference to the given InlineResponse200107TwoFourGhzSettings and assigns it to the TwoFourGhzSettings field.
...
func (o *InlineResponse200107) GetFiveGhzSettings() InlineResponse200107FiveGhzSettings {
	if o == nil || isNil(o.FiveGhzSettings) {
		var ret InlineResponse200107FiveGhzSettings
		return ret
	}
...
// SetFiveGhzSettings gets a reference to the given InlineResponse200107FiveGhzSettings and assigns it to the FiveGhzSettings field.
...
func (o *InlineResponse200107) GetSixGhzSettings() InlineResponse200107SixGhzSettings {
	if o == nil || isNil(o.SixGhzSettings) {
		var ret InlineResponse200107SixGhzSettings
		return ret
	}
...
// SetSixGhzSettings gets a reference to the given InlineResponse200107SixGhzSettings and assigns it to the SixGhzSettings field.
...
func (o *InlineResponse200107) GetTransmission() InlineResponse200107Transmission {
	if o == nil || isNil(o.Transmission) {
		var ret InlineResponse200107Transmission
		return ret
	}
...
// SetTransmission gets a reference to the given InlineResponse200107Transmission and assigns it to the Transmission field.
...
func (o *InlineResponse200107) GetPerSsidSettings() InlineResponse200107PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse200107PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse200107PerSsidSettings and assigns it to the PerSsidSettings field.
