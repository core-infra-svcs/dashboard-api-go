...
type InlineResponse200107 struct {
	...
	Devices []InlineResponse20099 `json:"devices,omitempty"`
...
// SetDevices gets a reference to the given []InlineResponse20099 and assigns it to the Devices field.
