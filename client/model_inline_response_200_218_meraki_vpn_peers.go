...
// InlineResponse200218MerakiVpnPeers struct for InlineResponse200218MerakiVpnPeers
type InlineResponse200218MerakiVpnPeers struct {
	// Network ID
...
func NewInlineResponse200218MerakiVpnPeers() *InlineResponse200218MerakiVpnPeers {
	this := InlineResponse200218MerakiVpnPeers{}
	return &this
}
...
func (o InlineResponse200218MerakiVpnPeers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200218MerakiVpnPeers struct {
	value *InlineResponse200218MerakiVpnPeers
	isSet bool
}

func (v NullableInlineResponse200218MerakiVpnPeers) Get() *InlineResponse200218MerakiVpnPeers {
	return v.value
}

func (v *NullableInlineResponse200218MerakiVpnPeers) Set(val *InlineResponse200218MerakiVpnPeers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200218MerakiVpnPeers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200218MerakiVpnPeers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200218MerakiVpnPeers(val *InlineResponse200218MerakiVpnPeers) *NullableInlineResponse200218MerakiVpnPeers {
	return &NullableInlineResponse200218MerakiVpnPeers{value: val, isSet: true}
}

func (v NullableInlineResponse200218MerakiVpnPeers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200218MerakiVpnPeers) UnmarshalJSON(src []byte) error {
	v.isSet = true
