...
// InlineResponse20058AllowedFiles struct for InlineResponse20058AllowedFiles
type InlineResponse20058AllowedFiles struct {
...
func NewInlineResponse20058AllowedFiles() *InlineResponse20058AllowedFiles {
	this := InlineResponse20058AllowedFiles{}
	return &this
}
...
func (o InlineResponse20058AllowedFiles) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20058AllowedFiles struct {
	value *InlineResponse20058AllowedFiles
	isSet bool
}

func (v NullableInlineResponse20058AllowedFiles) Get() *InlineResponse20058AllowedFiles {
	return v.value
}

func (v *NullableInlineResponse20058AllowedFiles) Set(val *InlineResponse20058AllowedFiles) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20058AllowedFiles) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20058AllowedFiles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20058AllowedFiles(val *InlineResponse20058AllowedFiles) *NullableInlineResponse20058AllowedFiles {
	return &NullableInlineResponse20058AllowedFiles{value: val, isSet: true}
}

func (v NullableInlineResponse20058AllowedFiles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20058AllowedFiles) UnmarshalJSON(src []byte) error {
	v.isSet = true
