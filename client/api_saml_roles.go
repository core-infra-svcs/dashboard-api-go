...
func (r SamlRolesApiCreateOrganizationSamlRoleRequest) CreateOrganizationSamlRole(createOrganizationSamlRole InlineObject260) SamlRolesApiCreateOrganizationSamlRoleRequest {
	r.createOrganizationSamlRole = &createOrganizationSamlRole
	return r
}

func (r SamlRolesApiCreateOrganizationSamlRoleRequest) Execute() (*InlineResponse200274, *http.Response, error) {
...
func (a *SamlRolesApiService) CreateOrganizationSamlRoleExecute(r SamlRolesApiCreateOrganizationSamlRoleRequest) (*InlineResponse200274, *http.Response, error) {
	var (
...
func (r SamlRolesApiGetOrganizationSamlRoleRequest) Execute() (*InlineResponse200274, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200274
func (a *SamlRolesApiService) GetOrganizationSamlRoleExecute(r SamlRolesApiGetOrganizationSamlRoleRequest) (*InlineResponse200274, *http.Response, error) {
	var (
...
func (r SamlRolesApiGetOrganizationSamlRolesRequest) Execute() ([]InlineResponse200274, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200274
func (a *SamlRolesApiService) GetOrganizationSamlRolesExecute(r SamlRolesApiGetOrganizationSamlRolesRequest) ([]InlineResponse200274, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SamlRolesApiUpdateOrganizationSamlRoleRequest) UpdateOrganizationSamlRole(updateOrganizationSamlRole InlineObject261) SamlRolesApiUpdateOrganizationSamlRoleRequest {
	r.updateOrganizationSamlRole = &updateOrganizationSamlRole
	return r
}

func (r SamlRolesApiUpdateOrganizationSamlRoleRequest) Execute() (*InlineResponse200274, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200274
func (a *SamlRolesApiService) UpdateOrganizationSamlRoleExecute(r SamlRolesApiUpdateOrganizationSamlRoleRequest) (*InlineResponse200274, *http.Response, error) {
	var (
