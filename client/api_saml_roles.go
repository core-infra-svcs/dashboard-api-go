...
func (r SamlRolesApiUpdateOrganizationSamlRoleRequest) Execute() (*InlineResponse20096, *http.Response, error) {
...
func (a *SamlRolesApiService) UpdateOrganizationSamlRoleExecute(r SamlRolesApiUpdateOrganizationSamlRoleRequest) (*InlineResponse20096, *http.Response, error) {
	var (
