...
type SamlRolesApiCreateOrganizationSamlRoleRequest struct {
	...
	createOrganizationSamlRole *InlineObject295
}

func (r SamlRolesApiCreateOrganizationSamlRoleRequest) CreateOrganizationSamlRole(createOrganizationSamlRole InlineObject295) SamlRolesApiCreateOrganizationSamlRoleRequest {
	r.createOrganizationSamlRole = &createOrganizationSamlRole
	return r
}

func (r SamlRolesApiCreateOrganizationSamlRoleRequest) Execute() (*InlineResponse200318, *http.Response, error) {
...
func (a *SamlRolesApiService) CreateOrganizationSamlRoleExecute(r SamlRolesApiCreateOrganizationSamlRoleRequest) (*InlineResponse200318, *http.Response, error) {
	var (
...
func (r SamlRolesApiGetOrganizationSamlRoleRequest) Execute() (*InlineResponse200318, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200318
func (a *SamlRolesApiService) GetOrganizationSamlRoleExecute(r SamlRolesApiGetOrganizationSamlRoleRequest) (*InlineResponse200318, *http.Response, error) {
	var (
...
func (r SamlRolesApiGetOrganizationSamlRolesRequest) Execute() ([]InlineResponse200318, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200318
func (a *SamlRolesApiService) GetOrganizationSamlRolesExecute(r SamlRolesApiGetOrganizationSamlRolesRequest) ([]InlineResponse200318, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type SamlRolesApiUpdateOrganizationSamlRoleRequest struct {
	...
	organizationId string
	samlRoleId string
	updateOrganizationSamlRole *InlineObject296
}

func (r SamlRolesApiUpdateOrganizationSamlRoleRequest) UpdateOrganizationSamlRole(updateOrganizationSamlRole InlineObject296) SamlRolesApiUpdateOrganizationSamlRoleRequest {
	r.updateOrganizationSamlRole = &updateOrganizationSamlRole
	return r
}

func (r SamlRolesApiUpdateOrganizationSamlRoleRequest) Execute() (*InlineResponse200318, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200318
func (a *SamlRolesApiService) UpdateOrganizationSamlRoleExecute(r SamlRolesApiUpdateOrganizationSamlRoleRequest) (*InlineResponse200318, *http.Response, error) {
	var (
