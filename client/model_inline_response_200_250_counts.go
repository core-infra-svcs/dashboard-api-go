...
// InlineResponse200250Counts Counts of alerts on the organization
type InlineResponse200250Counts struct {
	...
	BySeverity []InlineResponse200250CountsBySeverity `json:"bySeverity"`
}
...
func (o *InlineResponse200250Counts) GetBySeverity() []InlineResponse200250CountsBySeverity {
	if o == nil {
		var ret []InlineResponse200250CountsBySeverity
		return ret
	}
