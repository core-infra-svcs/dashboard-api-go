...
// InlineResponse20096ProductsWirelessAvailableVersions struct for InlineResponse20096ProductsWirelessAvailableVersions
type InlineResponse20096ProductsWirelessAvailableVersions struct {
...
func NewInlineResponse20096ProductsWirelessAvailableVersions() *InlineResponse20096ProductsWirelessAvailableVersions {
	this := InlineResponse20096ProductsWirelessAvailableVersions{}
	return &this
}
...
func (o InlineResponse20096ProductsWirelessAvailableVersions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20096ProductsWirelessAvailableVersions struct {
	value *InlineResponse20096ProductsWirelessAvailableVersions
	isSet bool
}

func (v NullableInlineResponse20096ProductsWirelessAvailableVersions) Get() *InlineResponse20096ProductsWirelessAvailableVersions {
	return v.value
}

func (v *NullableInlineResponse20096ProductsWirelessAvailableVersions) Set(val *InlineResponse20096ProductsWirelessAvailableVersions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20096ProductsWirelessAvailableVersions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20096ProductsWirelessAvailableVersions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20096ProductsWirelessAvailableVersions(val *InlineResponse20096ProductsWirelessAvailableVersions) *NullableInlineResponse20096ProductsWirelessAvailableVersions {
	return &NullableInlineResponse20096ProductsWirelessAvailableVersions{value: val, isSet: true}
}

func (v NullableInlineResponse20096ProductsWirelessAvailableVersions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20096ProductsWirelessAvailableVersions) UnmarshalJSON(src []byte) error {
	v.isSet = true
