...
// InlineResponse20064Value1 Value of traffic filter
type InlineResponse20064Value1 struct {
	...
	Source *InlineResponse20064Value1Source `json:"source,omitempty"`
	Destination *InlineResponse20064Value1Destination `json:"destination,omitempty"`
}
...
func NewInlineResponse20064Value1() *InlineResponse20064Value1 {
	this := InlineResponse20064Value1{}
	return &this
}
...
func (o *InlineResponse20064Value1) GetSource() InlineResponse20064Value1Source {
	if o == nil || isNil(o.Source) {
		var ret InlineResponse20064Value1Source
		return ret
	}
	return *o.Source
}
...
// SetSource gets a reference to the given InlineResponse20064Value1Source and assigns it to the Source field.
...
func (o *InlineResponse20064Value1) GetDestination() InlineResponse20064Value1Destination {
	if o == nil || isNil(o.Destination) {
		var ret InlineResponse20064Value1Destination
		return ret
	}
...
// SetDestination gets a reference to the given InlineResponse20064Value1Destination and assigns it to the Destination field.
func (o *InlineResponse20064Value1) SetDestination(v InlineResponse20064Value1Destination) {
	o.Destination = &v
}

func (o InlineResponse20064Value1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20064Value1 struct {
	value *InlineResponse20064Value1
	isSet bool
}

func (v NullableInlineResponse20064Value1) Get() *InlineResponse20064Value1 {
	return v.value
}

func (v *NullableInlineResponse20064Value1) Set(val *InlineResponse20064Value1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20064Value1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20064Value1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20064Value1(val *InlineResponse20064Value1) *NullableInlineResponse20064Value1 {
	return &NullableInlineResponse20064Value1{value: val, isSet: true}
}

func (v NullableInlineResponse20064Value1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20064Value1) UnmarshalJSON(src []byte) error {
	v.isSet = true
