...
// InlineResponse200170VlanProfile The VLAN Profile
type InlineResponse200170VlanProfile struct {
...
func NewInlineResponse200170VlanProfile() *InlineResponse200170VlanProfile {
	this := InlineResponse200170VlanProfile{}
	return &this
}
...
func (o InlineResponse200170VlanProfile) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200170VlanProfile struct {
	value *InlineResponse200170VlanProfile
	isSet bool
}

func (v NullableInlineResponse200170VlanProfile) Get() *InlineResponse200170VlanProfile {
	return v.value
}

func (v *NullableInlineResponse200170VlanProfile) Set(val *InlineResponse200170VlanProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200170VlanProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200170VlanProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200170VlanProfile(val *InlineResponse200170VlanProfile) *NullableInlineResponse200170VlanProfile {
	return &NullableInlineResponse200170VlanProfile{value: val, isSet: true}
}

func (v NullableInlineResponse200170VlanProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200170VlanProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
