...
// InlineResponse20091Peers struct for InlineResponse20091Peers
type InlineResponse20091Peers struct {
	...
	IpsecPolicies *InlineResponse20091IpsecPolicies `json:"ipsecPolicies,omitempty"`
...
func (o *InlineResponse20091Peers) GetIpsecPolicies() InlineResponse20091IpsecPolicies {
	if o == nil || isNil(o.IpsecPolicies) {
		var ret InlineResponse20091IpsecPolicies
		return ret
	}
...
// SetIpsecPolicies gets a reference to the given InlineResponse20091IpsecPolicies and assigns it to the IpsecPolicies field.
...
func (o InlineResponse20091Peers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20091Peers struct {
	value *InlineResponse20091Peers
	isSet bool
}

func (v NullableInlineResponse20091Peers) Get() *InlineResponse20091Peers {
	return v.value
}

func (v *NullableInlineResponse20091Peers) Set(val *InlineResponse20091Peers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20091Peers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20091Peers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20091Peers(val *InlineResponse20091Peers) *NullableInlineResponse20091Peers {
	return &NullableInlineResponse20091Peers{value: val, isSet: true}
}

func (v NullableInlineResponse20091Peers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20091Peers) UnmarshalJSON(src []byte) error {
	v.isSet = true
