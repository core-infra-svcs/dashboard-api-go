...
// InlineResponse200143CountsByStatus byStatus
type InlineResponse200143CountsByStatus struct {
	// online count
...
func NewInlineResponse200143CountsByStatus() *InlineResponse200143CountsByStatus {
	this := InlineResponse200143CountsByStatus{}
	return &this
}
...
func (o InlineResponse200143CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200143CountsByStatus struct {
	value *InlineResponse200143CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200143CountsByStatus) Get() *InlineResponse200143CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200143CountsByStatus) Set(val *InlineResponse200143CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200143CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200143CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200143CountsByStatus(val *InlineResponse200143CountsByStatus) *NullableInlineResponse200143CountsByStatus {
	return &NullableInlineResponse200143CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200143CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200143CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
