...
// InlineResponse200237Records struct for InlineResponse200237Records
type InlineResponse200237Records struct {
	...
	ClientVpnConnections []InlineResponse200237ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200237Records() *InlineResponse200237Records {
	this := InlineResponse200237Records{}
	return &this
}
...
func (o *InlineResponse200237Records) GetClientVpnConnections() []InlineResponse200237ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200237ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200237ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200237Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200237Records struct {
	value *InlineResponse200237Records
	isSet bool
}

func (v NullableInlineResponse200237Records) Get() *InlineResponse200237Records {
	return v.value
}

func (v *NullableInlineResponse200237Records) Set(val *InlineResponse200237Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200237Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200237Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200237Records(val *InlineResponse200237Records) *NullableInlineResponse200237Records {
	return &NullableInlineResponse200237Records{value: val, isSet: true}
}

func (v NullableInlineResponse200237Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200237Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
