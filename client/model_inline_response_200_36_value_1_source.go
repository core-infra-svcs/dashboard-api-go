...
// InlineResponse20036Value1Source Source of 'custom' type traffic filter
type InlineResponse20036Value1Source struct {
...
func NewInlineResponse20036Value1Source() *InlineResponse20036Value1Source {
	this := InlineResponse20036Value1Source{}
	return &this
}
...
func (o InlineResponse20036Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20036Value1Source struct {
	value *InlineResponse20036Value1Source
	isSet bool
}

func (v NullableInlineResponse20036Value1Source) Get() *InlineResponse20036Value1Source {
	return v.value
}

func (v *NullableInlineResponse20036Value1Source) Set(val *InlineResponse20036Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20036Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20036Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20036Value1Source(val *InlineResponse20036Value1Source) *NullableInlineResponse20036Value1Source {
	return &NullableInlineResponse20036Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20036Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20036Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
