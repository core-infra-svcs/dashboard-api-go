...
// InlineResponse200259ResultingNetwork Network after the combination
type InlineResponse200259ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200259ResultingNetwork() *InlineResponse200259ResultingNetwork {
	this := InlineResponse200259ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200259ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200259ResultingNetwork struct {
	value *InlineResponse200259ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200259ResultingNetwork) Get() *InlineResponse200259ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200259ResultingNetwork) Set(val *InlineResponse200259ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200259ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200259ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200259ResultingNetwork(val *InlineResponse200259ResultingNetwork) *NullableInlineResponse200259ResultingNetwork {
	return &NullableInlineResponse200259ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200259ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200259ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
