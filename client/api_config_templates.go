...
func (r ConfigTemplatesApiCreateOrganizationConfigTemplateRequest) CreateOrganizationConfigTemplate(createOrganizationConfigTemplate InlineObject190) ConfigTemplatesApiCreateOrganizationConfigTemplateRequest {
...
func (r ConfigTemplatesApiGetOrganizationConfigTemplateSwitchProfilePortRequest) Execute() (*InlineResponse20075, *http.Response, error) {
...
func (a *ConfigTemplatesApiService) GetOrganizationConfigTemplateSwitchProfilePortExecute(r ConfigTemplatesApiGetOrganizationConfigTemplateSwitchProfilePortRequest) (*InlineResponse20075, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ConfigTemplatesApiGetOrganizationConfigTemplateSwitchProfilePortsRequest) Execute() ([]InlineResponse20075, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20075
func (a *ConfigTemplatesApiService) GetOrganizationConfigTemplateSwitchProfilePortsExecute(r ConfigTemplatesApiGetOrganizationConfigTemplateSwitchProfilePortsRequest) ([]InlineResponse20075, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ConfigTemplatesApiUpdateOrganizationConfigTemplateRequest) UpdateOrganizationConfigTemplate(updateOrganizationConfigTemplate InlineObject191) ConfigTemplatesApiUpdateOrganizationConfigTemplateRequest {
...
func (r ConfigTemplatesApiUpdateOrganizationConfigTemplateSwitchProfilePortRequest) UpdateOrganizationConfigTemplateSwitchProfilePort(updateOrganizationConfigTemplateSwitchProfilePort InlineObject192) ConfigTemplatesApiUpdateOrganizationConfigTemplateSwitchProfilePortRequest {
	r.updateOrganizationConfigTemplateSwitchProfilePort = &updateOrganizationConfigTemplateSwitchProfilePort
	return r
}

func (r ConfigTemplatesApiUpdateOrganizationConfigTemplateSwitchProfilePortRequest) Execute() (*InlineResponse20075, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20075
func (a *ConfigTemplatesApiService) UpdateOrganizationConfigTemplateSwitchProfilePortExecute(r ConfigTemplatesApiUpdateOrganizationConfigTemplateSwitchProfilePortRequest) (*InlineResponse20075, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
