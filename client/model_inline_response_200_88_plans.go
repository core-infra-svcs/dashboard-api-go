...
// InlineResponse20088Plans struct for InlineResponse20088Plans
type InlineResponse20088Plans struct {
	// The id of the pricing plan to update.
	Id *string `json:"id,omitempty"`
	// The price of the billing plan.
	Price *float32 `json:"price,omitempty"`
	BandwidthLimits *InlineResponse20088BandwidthLimits `json:"bandwidthLimits,omitempty"`
...
func (o *InlineResponse20088Plans) GetBandwidthLimits() InlineResponse20088BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse20088BandwidthLimits
		return ret
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse20088BandwidthLimits and assigns it to the BandwidthLimits field.
...
func (o InlineResponse20088Plans) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20088Plans struct {
	value *InlineResponse20088Plans
	isSet bool
}

func (v NullableInlineResponse20088Plans) Get() *InlineResponse20088Plans {
	return v.value
}

func (v *NullableInlineResponse20088Plans) Set(val *InlineResponse20088Plans) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20088Plans) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20088Plans) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20088Plans(val *InlineResponse20088Plans) *NullableInlineResponse20088Plans {
	return &NullableInlineResponse20088Plans{value: val, isSet: true}
}

func (v NullableInlineResponse20088Plans) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20088Plans) UnmarshalJSON(src []byte) error {
	v.isSet = true
