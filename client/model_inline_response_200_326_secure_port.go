...
// InlineResponse200326SecurePort The Secure Port status of the port.
type InlineResponse200326SecurePort struct {
...
func NewInlineResponse200326SecurePort() *InlineResponse200326SecurePort {
	this := InlineResponse200326SecurePort{}
	return &this
}
...
func (o InlineResponse200326SecurePort) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200326SecurePort struct {
	value *InlineResponse200326SecurePort
	isSet bool
}

func (v NullableInlineResponse200326SecurePort) Get() *InlineResponse200326SecurePort {
	return v.value
}

func (v *NullableInlineResponse200326SecurePort) Set(val *InlineResponse200326SecurePort) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200326SecurePort) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200326SecurePort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200326SecurePort(val *InlineResponse200326SecurePort) *NullableInlineResponse200326SecurePort {
	return &NullableInlineResponse200326SecurePort{value: val, isSet: true}
}

func (v NullableInlineResponse200326SecurePort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200326SecurePort) UnmarshalJSON(src []byte) error {
	v.isSet = true
