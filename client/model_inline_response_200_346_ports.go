...
// InlineResponse200346Ports struct for InlineResponse200346Ports
type InlineResponse200346Ports struct {
	...
	SecurePort *InlineResponse200346SecurePort `json:"securePort,omitempty"`
}
...
func NewInlineResponse200346Ports() *InlineResponse200346Ports {
	this := InlineResponse200346Ports{}
	return &this
}
...
func (o *InlineResponse200346Ports) GetSecurePort() InlineResponse200346SecurePort {
	if o == nil || isNil(o.SecurePort) {
		var ret InlineResponse200346SecurePort
		return ret
	}
	return *o.SecurePort
}
...
// SetSecurePort gets a reference to the given InlineResponse200346SecurePort and assigns it to the SecurePort field.
func (o *InlineResponse200346Ports) SetSecurePort(v InlineResponse200346SecurePort) {
	o.SecurePort = &v
}

func (o InlineResponse200346Ports) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200346Ports struct {
	value *InlineResponse200346Ports
	isSet bool
}

func (v NullableInlineResponse200346Ports) Get() *InlineResponse200346Ports {
	return v.value
}

func (v *NullableInlineResponse200346Ports) Set(val *InlineResponse200346Ports) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200346Ports) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200346Ports) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200346Ports(val *InlineResponse200346Ports) *NullableInlineResponse200346Ports {
	return &NullableInlineResponse200346Ports{value: val, isSet: true}
}

func (v NullableInlineResponse200346Ports) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200346Ports) UnmarshalJSON(src []byte) error {
	v.isSet = true
