...
func (r ByEnergyUsageApiApiGetOrganizationSummaryTopSwitchesByEnergyUsageRequest) Execute() ([]InlineResponse2009, *_nethttp.Response, error) {
...
func (a *ByEnergyUsageApiService) GetOrganizationSummaryTopSwitchesByEnergyUsageExecute(r ByEnergyUsageApiApiGetOrganizationSummaryTopSwitchesByEnergyUsageRequest) ([]InlineResponse2009, *_nethttp.Response, error) {
	var (
