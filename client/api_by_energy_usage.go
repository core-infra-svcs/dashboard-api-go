...
func (r ByEnergyUsageApiApiGetOrganizationSummaryTopSwitchesByEnergyUsageRequest) Execute() ([]InlineResponse2008, *http.Response, error) {
...
*/
func (a *ByEnergyUsageApiService) GetOrganizationSummaryTopSwitchesByEnergyUsage(ctx context.Context, organizationId string) ByEnergyUsageApiApiGetOrganizationSummaryTopSwitchesByEnergyUsageRequest {
	return ByEnergyUsageApiApiGetOrganizationSummaryTopSwitchesByEnergyUsageRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *ByEnergyUsageApiService) GetOrganizationSummaryTopSwitchesByEnergyUsageExecute(r ByEnergyUsageApiApiGetOrganizationSummaryTopSwitchesByEnergyUsageRequest) ([]InlineResponse2008, *http.Response, error) {
	var (
