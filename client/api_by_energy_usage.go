...
func (r ByEnergyUsageApiGetOrganizationSummaryTopSwitchesByEnergyUsageRequest) Execute() ([]InlineResponse200177, *http.Response, error) {
...
func (a *ByEnergyUsageApiService) GetOrganizationSummaryTopSwitchesByEnergyUsageExecute(r ByEnergyUsageApiGetOrganizationSummaryTopSwitchesByEnergyUsageRequest) ([]InlineResponse200177, *http.Response, error) {
	var (
