...
// InlineResponse20012Addresses struct for InlineResponse20012Addresses
type InlineResponse20012Addresses struct {
...
func NewInlineResponse20012Addresses() *InlineResponse20012Addresses {
	this := InlineResponse20012Addresses{}
	return &this
}
...
func (o InlineResponse20012Addresses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20012Addresses struct {
	value *InlineResponse20012Addresses
	isSet bool
}

func (v NullableInlineResponse20012Addresses) Get() *InlineResponse20012Addresses {
	return v.value
}

func (v *NullableInlineResponse20012Addresses) Set(val *InlineResponse20012Addresses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20012Addresses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20012Addresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20012Addresses(val *InlineResponse20012Addresses) *NullableInlineResponse20012Addresses {
	return &NullableInlineResponse20012Addresses{value: val, isSet: true}
}

func (v NullableInlineResponse20012Addresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20012Addresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
