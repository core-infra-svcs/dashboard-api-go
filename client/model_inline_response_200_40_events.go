...
// InlineResponse20040Events struct for InlineResponse20040Events
type InlineResponse20040Events struct {
	...
	EventData *InlineResponse20040EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20040Events() *InlineResponse20040Events {
	this := InlineResponse20040Events{}
	return &this
}
...
func (o *InlineResponse20040Events) GetEventData() InlineResponse20040EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20040EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20040EventData and assigns it to the EventData field.
func (o *InlineResponse20040Events) SetEventData(v InlineResponse20040EventData) {
	o.EventData = &v
}

func (o InlineResponse20040Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20040Events struct {
	value *InlineResponse20040Events
	isSet bool
}

func (v NullableInlineResponse20040Events) Get() *InlineResponse20040Events {
	return v.value
}

func (v *NullableInlineResponse20040Events) Set(val *InlineResponse20040Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20040Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20040Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20040Events(val *InlineResponse20040Events) *NullableInlineResponse20040Events {
	return &NullableInlineResponse20040Events{value: val, isSet: true}
}

func (v NullableInlineResponse20040Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20040Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
