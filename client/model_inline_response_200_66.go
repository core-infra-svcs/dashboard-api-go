...
type InlineResponse20066 struct {
	...
	LocalStatusPage *InlineResponse20066LocalStatusPage `json:"localStatusPage,omitempty"`
	SecurePort *InlineResponse20066SecurePort `json:"securePort,omitempty"`
	Fips *InlineResponse20066Fips `json:"fips,omitempty"`
	NamedVlans *InlineResponse20066NamedVlans `json:"namedVlans,omitempty"`
}
...
func (o *InlineResponse20066) GetLocalStatusPage() InlineResponse20066LocalStatusPage {
	if o == nil || isNil(o.LocalStatusPage) {
		var ret InlineResponse20066LocalStatusPage
		return ret
	}
...
// SetLocalStatusPage gets a reference to the given InlineResponse20066LocalStatusPage and assigns it to the LocalStatusPage field.
...
func (o *InlineResponse20066) GetFips() InlineResponse20066Fips {
	if o == nil || isNil(o.Fips) {
		var ret InlineResponse20066Fips
		return ret
	}
	return *o.Fips
}
...
// SetFips gets a reference to the given InlineResponse20066Fips and assigns it to the Fips field.
...
func (o *InlineResponse20066) GetNamedVlans() InlineResponse20066NamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret InlineResponse20066NamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given InlineResponse20066NamedVlans and assigns it to the NamedVlans field.
