...
type InlineResponse20066 struct {
	...
	AllowedUrls []InlineResponse20066AllowedUrls `json:"allowedUrls,omitempty"`
	// Sha256 digests of files permitted by the malware detection engine
	AllowedFiles []InlineResponse20066AllowedFiles `json:"allowedFiles,omitempty"`
}
...
func (o *InlineResponse20066) GetAllowedUrls() []InlineResponse20066AllowedUrls {
	if o == nil || isNil(o.AllowedUrls) {
		var ret []InlineResponse20066AllowedUrls
		return ret
	}
...
// SetAllowedUrls gets a reference to the given []InlineResponse20066AllowedUrls and assigns it to the AllowedUrls field.
...
func (o *InlineResponse20066) GetAllowedFiles() []InlineResponse20066AllowedFiles {
	if o == nil || isNil(o.AllowedFiles) {
		var ret []InlineResponse20066AllowedFiles
		return ret
	}
...
// SetAllowedFiles gets a reference to the given []InlineResponse20066AllowedFiles and assigns it to the AllowedFiles field.
