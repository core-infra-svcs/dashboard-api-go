...
func (o *InlineResponse20066) GetCustomPerformanceClassId() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20066) GetCustomPerformanceClassIdOk() (*string, bool) {
	if o == nil || isNil(o.CustomPerformanceClassId) {
    return nil, false
	}
...
func (o *InlineResponse20066) HasCustomPerformanceClassId() bool {
	if o != nil && !isNil(o.CustomPerformanceClassId) {
		return true
	}
...
func (o *InlineResponse20066) SetCustomPerformanceClassId(v string) {
	o.CustomPerformanceClassId = &v
}

// GetMaxLatency returns the MaxLatency field value if set, zero value otherwise.
func (o *InlineResponse20066) GetMaxLatency() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20066) GetMaxLatencyOk() (*int32, bool) {
	if o == nil || isNil(o.MaxLatency) {
    return nil, false
	}
...
func (o *InlineResponse20066) HasMaxLatency() bool {
	if o != nil && !isNil(o.MaxLatency) {
		return true
	}
...
func (o *InlineResponse20066) SetMaxLatency(v int32) {
	o.MaxLatency = &v
}

// GetMaxJitter returns the MaxJitter field value if set, zero value otherwise.
func (o *InlineResponse20066) GetMaxJitter() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20066) GetMaxJitterOk() (*int32, bool) {
	if o == nil || isNil(o.MaxJitter) {
    return nil, false
	}
...
func (o *InlineResponse20066) HasMaxJitter() bool {
	if o != nil && !isNil(o.MaxJitter) {
		return true
	}
...
func (o *InlineResponse20066) SetMaxJitter(v int32) {
	o.MaxJitter = &v
}

// GetMaxLossPercentage returns the MaxLossPercentage field value if set, zero value otherwise.
func (o *InlineResponse20066) GetMaxLossPercentage() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20066) GetMaxLossPercentageOk() (*int32, bool) {
	if o == nil || isNil(o.MaxLossPercentage) {
    return nil, false
	}
...
func (o *InlineResponse20066) HasMaxLossPercentage() bool {
	if o != nil && !isNil(o.MaxLossPercentage) {
		return true
	}
...
func (o *InlineResponse20066) SetMaxLossPercentage(v int32) {
