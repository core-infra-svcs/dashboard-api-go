...
type InlineResponse20066 struct {
	...
	Rules []InlineResponse20066Rules `json:"rules,omitempty"`
}
...
func (o *InlineResponse20066) GetRules() []InlineResponse20066Rules {
	if o == nil || isNil(o.Rules) {
		var ret []InlineResponse20066Rules
		return ret
	}
	return o.Rules
}
...
func (o *InlineResponse20066) GetRulesOk() ([]InlineResponse20066Rules, bool) {
	if o == nil || isNil(o.Rules) {
    return nil, false
	}
	return o.Rules, true
...
func (o *InlineResponse20066) HasRules() bool {
	if o != nil && !isNil(o.Rules) {
		return true
	}
...
// SetRules gets a reference to the given []InlineResponse20066Rules and assigns it to the Rules field.
func (o *InlineResponse20066) SetRules(v []InlineResponse20066Rules) {
	o.Rules = v
}
