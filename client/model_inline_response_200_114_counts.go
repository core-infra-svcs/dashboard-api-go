...
// InlineResponse200114Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse200114Counts struct {
	...
	Noise *InlineResponse200114CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse200114Counts() *InlineResponse200114Counts {
	this := InlineResponse200114Counts{}
	return &this
}
...
func (o *InlineResponse200114Counts) GetNoise() InlineResponse200114CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse200114CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse200114CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse200114Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200114Counts struct {
	value *InlineResponse200114Counts
	isSet bool
}

func (v NullableInlineResponse200114Counts) Get() *InlineResponse200114Counts {
	return v.value
}

func (v *NullableInlineResponse200114Counts) Set(val *InlineResponse200114Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200114Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200114Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200114Counts(val *InlineResponse200114Counts) *NullableInlineResponse200114Counts {
	return &NullableInlineResponse200114Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200114Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200114Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
