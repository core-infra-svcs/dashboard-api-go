...
// InlineResponse20027Cdp cdp information
type InlineResponse20027Cdp struct {
	// ID for the device
...
func (o InlineResponse20027Cdp) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20027Cdp struct {
	value *InlineResponse20027Cdp
	isSet bool
}

func (v NullableInlineResponse20027Cdp) Get() *InlineResponse20027Cdp {
	return v.value
}

func (v *NullableInlineResponse20027Cdp) Set(val *InlineResponse20027Cdp) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20027Cdp) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20027Cdp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20027Cdp(val *InlineResponse20027Cdp) *NullableInlineResponse20027Cdp {
	return &NullableInlineResponse20027Cdp{value: val, isSet: true}
}

func (v NullableInlineResponse20027Cdp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20027Cdp) UnmarshalJSON(src []byte) error {
	v.isSet = true
