...
func (r CellularGatewayApiGetNetworkCellularGatewayDhcpRequest) Execute() (*InlineResponse20016, *http.Response, error) {
...
func (a *CellularGatewayApiService) GetNetworkCellularGatewayDhcpExecute(r CellularGatewayApiGetNetworkCellularGatewayDhcpRequest) (*InlineResponse20016, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CellularGatewayApiGetOrganizationCellularGatewayUplinkStatusesRequest) Execute() ([]InlineResponse20077, *http.Response, error) {
...
func (a *CellularGatewayApiService) GetOrganizationCellularGatewayUplinkStatusesExecute(r CellularGatewayApiGetOrganizationCellularGatewayUplinkStatusesRequest) ([]InlineResponse20077, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type CellularGatewayApiUpdateNetworkCellularGatewayConnectivityMonitoringDestinationsRequest struct {
	...
	ApiService *CellularGatewayApiService
	networkId string
	updateNetworkCellularGatewayConnectivityMonitoringDestinations *InlineObject66
}

func (r CellularGatewayApiUpdateNetworkCellularGatewayConnectivityMonitoringDestinationsRequest) UpdateNetworkCellularGatewayConnectivityMonitoringDestinations(updateNetworkCellularGatewayConnectivityMonitoringDestinations InlineObject66) CellularGatewayApiUpdateNetworkCellularGatewayConnectivityMonitoringDestinationsRequest {
...
func (r CellularGatewayApiUpdateNetworkCellularGatewayDhcpRequest) UpdateNetworkCellularGatewayDhcp(updateNetworkCellularGatewayDhcp InlineObject67) CellularGatewayApiUpdateNetworkCellularGatewayDhcpRequest {
	r.updateNetworkCellularGatewayDhcp = &updateNetworkCellularGatewayDhcp
	return r
}

func (r CellularGatewayApiUpdateNetworkCellularGatewayDhcpRequest) Execute() (*InlineResponse20016, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20016
func (a *CellularGatewayApiService) UpdateNetworkCellularGatewayDhcpExecute(r CellularGatewayApiUpdateNetworkCellularGatewayDhcpRequest) (*InlineResponse20016, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
type CellularGatewayApiUpdateNetworkCellularGatewaySubnetPoolRequest struct {
	...
	ApiService *CellularGatewayApiService
	networkId string
	updateNetworkCellularGatewaySubnetPool *InlineObject68
}

func (r CellularGatewayApiUpdateNetworkCellularGatewaySubnetPoolRequest) UpdateNetworkCellularGatewaySubnetPool(updateNetworkCellularGatewaySubnetPool InlineObject68) CellularGatewayApiUpdateNetworkCellularGatewaySubnetPoolRequest {
...
type CellularGatewayApiUpdateNetworkCellularGatewayUplinkRequest struct {
	...
	ApiService *CellularGatewayApiService
	networkId string
	updateNetworkCellularGatewayUplink *InlineObject69
}

func (r CellularGatewayApiUpdateNetworkCellularGatewayUplinkRequest) UpdateNetworkCellularGatewayUplink(updateNetworkCellularGatewayUplink InlineObject69) CellularGatewayApiUpdateNetworkCellularGatewayUplinkRequest {
