...
// InlineResponse200224MetaCountsItems Counts relating to the paginated items
type InlineResponse200224MetaCountsItems struct {
...
func NewInlineResponse200224MetaCountsItems() *InlineResponse200224MetaCountsItems {
	this := InlineResponse200224MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200224MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200224MetaCountsItems struct {
	value *InlineResponse200224MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200224MetaCountsItems) Get() *InlineResponse200224MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200224MetaCountsItems) Set(val *InlineResponse200224MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200224MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200224MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200224MetaCountsItems(val *InlineResponse200224MetaCountsItems) *NullableInlineResponse200224MetaCountsItems {
	return &NullableInlineResponse200224MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200224MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200224MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
