...
// InlineResponse200219IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200219IpsecPolicies struct {
...
func NewInlineResponse200219IpsecPolicies() *InlineResponse200219IpsecPolicies {
	this := InlineResponse200219IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200219IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200219IpsecPolicies struct {
	value *InlineResponse200219IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200219IpsecPolicies) Get() *InlineResponse200219IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200219IpsecPolicies) Set(val *InlineResponse200219IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200219IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200219IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200219IpsecPolicies(val *InlineResponse200219IpsecPolicies) *NullableInlineResponse200219IpsecPolicies {
	return &NullableInlineResponse200219IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200219IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200219IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
