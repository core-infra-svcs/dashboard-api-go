...
type InlineResponse200357Items struct {
	...
	Intervals []InlineResponse200357Intervals `json:"intervals,omitempty"`
}
...
func (o *InlineResponse200357Items) GetIntervals() []InlineResponse200357Intervals {
	if o == nil || isNil(o.Intervals) {
		var ret []InlineResponse200357Intervals
		return ret
	}
	return o.Intervals
}
...
// SetIntervals gets a reference to the given []InlineResponse200357Intervals and assigns it to the Intervals field.
