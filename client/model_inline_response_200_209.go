...
func (o *InlineResponse200209) GetByUplink() []OrganizationsOrganizationIdApplianceUplinksUsageByNetworkByUplink {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200209) GetByUplinkOk() ([]OrganizationsOrganizationIdApplianceUplinksUsageByNetworkByUplink, bool) {
	if o == nil || isNil(o.ByUplink) {
    return nil, false
	}
...
func (o *InlineResponse200209) HasByUplink() bool {
	if o != nil && !isNil(o.ByUplink) {
		return true
	}
...
func (o *InlineResponse200209) SetByUplink(v []OrganizationsOrganizationIdApplianceUplinksUsageByNetworkByUplink) {
	o.ByUplink = v
}
