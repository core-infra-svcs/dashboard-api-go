...
func (o *InlineResponse200209) GetUrl() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200209) GetUrlOk() (*string, bool) {
	if o == nil || isNil(o.Url) {
    return nil, false
	}
	return o.Url, true
...
func (o *InlineResponse200209) HasUrl() bool {
	if o != nil && !isNil(o.Url) {
		return true
	}
...
func (o *InlineResponse200209) SetUrl(v string) {
	o.Url = &v
}

// GetApi returns the Api field value if set, zero value otherwise.
func (o *InlineResponse200209) GetApi() OrganizationsApi {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200209) GetApiOk() (*OrganizationsApi, bool) {
	if o == nil || isNil(o.Api) {
    return nil, false
	}
	return o.Api, true
...
func (o *InlineResponse200209) SetApi(v OrganizationsApi) {
	o.Api = &v
}

// GetLicensing returns the Licensing field value if set, zero value otherwise.
func (o *InlineResponse200209) GetLicensing() OrganizationsLicensing {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200209) GetLicensingOk() (*OrganizationsLicensing, bool) {
	if o == nil || isNil(o.Licensing) {
    return nil, false
	}
...
func (o *InlineResponse200209) HasLicensing() bool {
	if o != nil && !isNil(o.Licensing) {
		return true
	}
...
func (o *InlineResponse200209) SetLicensing(v OrganizationsLicensing) {
	o.Licensing = &v
}

// GetCloud returns the Cloud field value if set, zero value otherwise.
func (o *InlineResponse200209) GetCloud() OrganizationsCloud {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200209) GetCloudOk() (*OrganizationsCloud, bool) {
	if o == nil || isNil(o.Cloud) {
    return nil, false
	}
	return o.Cloud, true
...
func (o *InlineResponse200209) HasCloud() bool {
	if o != nil && !isNil(o.Cloud) {
		return true
	}
...
func (o *InlineResponse200209) SetCloud(v OrganizationsCloud) {
	o.Cloud = &v
}

// GetManagement returns the Management field value if set, zero value otherwise.
func (o *InlineResponse200209) GetManagement() OrganizationsManagement {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200209) GetManagementOk() (*OrganizationsManagement, bool) {
	if o == nil || isNil(o.Management) {
    return nil, false
	}
...
func (o *InlineResponse200209) HasManagement() bool {
	if o != nil && !isNil(o.Management) {
		return true
	}
...
func (o *InlineResponse200209) SetManagement(v OrganizationsManagement) {
	o.Management = &v
}
