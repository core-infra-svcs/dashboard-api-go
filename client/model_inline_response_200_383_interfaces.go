...
// InlineResponse200383Interfaces struct for InlineResponse200383Interfaces
type InlineResponse200383Interfaces struct {
	...
	Changes []InlineResponse200383Changes `json:"changes,omitempty"`
}
...
func NewInlineResponse200383Interfaces() *InlineResponse200383Interfaces {
	this := InlineResponse200383Interfaces{}
	return &this
}
...
func (o *InlineResponse200383Interfaces) GetChanges() []InlineResponse200383Changes {
	if o == nil || isNil(o.Changes) {
		var ret []InlineResponse200383Changes
		return ret
	}
	return o.Changes
}
...
// SetChanges gets a reference to the given []InlineResponse200383Changes and assigns it to the Changes field.
func (o *InlineResponse200383Interfaces) SetChanges(v []InlineResponse200383Changes) {
	o.Changes = v
}

func (o InlineResponse200383Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200383Interfaces struct {
	value *InlineResponse200383Interfaces
	isSet bool
}

func (v NullableInlineResponse200383Interfaces) Get() *InlineResponse200383Interfaces {
	return v.value
}

func (v *NullableInlineResponse200383Interfaces) Set(val *InlineResponse200383Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200383Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200383Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200383Interfaces(val *InlineResponse200383Interfaces) *NullableInlineResponse200383Interfaces {
	return &NullableInlineResponse200383Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200383Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200383Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
