...
// InlineResponse20064BandwidthLimitsWan2 uplink wan2 configured limits [optional]
type InlineResponse20064BandwidthLimitsWan2 struct {
...
func NewInlineResponse20064BandwidthLimitsWan2() *InlineResponse20064BandwidthLimitsWan2 {
	this := InlineResponse20064BandwidthLimitsWan2{}
	return &this
}
...
func (o InlineResponse20064BandwidthLimitsWan2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20064BandwidthLimitsWan2 struct {
	value *InlineResponse20064BandwidthLimitsWan2
	isSet bool
}

func (v NullableInlineResponse20064BandwidthLimitsWan2) Get() *InlineResponse20064BandwidthLimitsWan2 {
	return v.value
}

func (v *NullableInlineResponse20064BandwidthLimitsWan2) Set(val *InlineResponse20064BandwidthLimitsWan2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20064BandwidthLimitsWan2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20064BandwidthLimitsWan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20064BandwidthLimitsWan2(val *InlineResponse20064BandwidthLimitsWan2) *NullableInlineResponse20064BandwidthLimitsWan2 {
	return &NullableInlineResponse20064BandwidthLimitsWan2{value: val, isSet: true}
}

func (v NullableInlineResponse20064BandwidthLimitsWan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20064BandwidthLimitsWan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
