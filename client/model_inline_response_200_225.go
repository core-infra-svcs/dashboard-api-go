...
type InlineResponse200225 struct {
	...
	Items []InlineResponse20069 `json:"items,omitempty"`
}
...
// SetItems gets a reference to the given []InlineResponse20069 and assigns it to the Items field.
