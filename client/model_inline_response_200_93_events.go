...
// InlineResponse20093Events struct for InlineResponse20093Events
type InlineResponse20093Events struct {
	...
	EventData *InlineResponse20093EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20093Events() *InlineResponse20093Events {
	this := InlineResponse20093Events{}
	return &this
}
...
func (o *InlineResponse20093Events) GetEventData() InlineResponse20093EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20093EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20093EventData and assigns it to the EventData field.
func (o *InlineResponse20093Events) SetEventData(v InlineResponse20093EventData) {
	o.EventData = &v
}

func (o InlineResponse20093Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20093Events struct {
	value *InlineResponse20093Events
	isSet bool
}

func (v NullableInlineResponse20093Events) Get() *InlineResponse20093Events {
	return v.value
}

func (v *NullableInlineResponse20093Events) Set(val *InlineResponse20093Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20093Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20093Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20093Events(val *InlineResponse20093Events) *NullableInlineResponse20093Events {
	return &NullableInlineResponse20093Events{value: val, isSet: true}
}

func (v NullableInlineResponse20093Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20093Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
