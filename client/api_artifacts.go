...
func (r ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) CreateOrganizationCameraCustomAnalyticsArtifact(createOrganizationCameraCustomAnalyticsArtifact InlineObject235) ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest {
	r.createOrganizationCameraCustomAnalyticsArtifact = &createOrganizationCameraCustomAnalyticsArtifact
	return r
}

func (r ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) Execute() (*InlineResponse20115, *http.Response, error) {
...
func (a *ArtifactsApiService) CreateOrganizationCameraCustomAnalyticsArtifactExecute(r ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) (*InlineResponse20115, *http.Response, error) {
	var (
...
func (r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactRequest) Execute() (*InlineResponse200241, *http.Response, error) {
...
func (a *ArtifactsApiService) GetOrganizationCameraCustomAnalyticsArtifactExecute(r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactRequest) (*InlineResponse200241, *http.Response, error) {
	var (
...
func (r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactsRequest) Execute() ([]InlineResponse200241, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200241
func (a *ArtifactsApiService) GetOrganizationCameraCustomAnalyticsArtifactsExecute(r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactsRequest) ([]InlineResponse200241, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
