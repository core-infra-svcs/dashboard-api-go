...
func (r ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) CreateOrganizationCameraCustomAnalyticsArtifact(createOrganizationCameraCustomAnalyticsArtifact InlineObject245) ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest {
...
func (r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactRequest) Execute() (*InlineResponse200261, *http.Response, error) {
...
func (a *ArtifactsApiService) GetOrganizationCameraCustomAnalyticsArtifactExecute(r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactRequest) (*InlineResponse200261, *http.Response, error) {
	var (
...
func (r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactsRequest) Execute() ([]InlineResponse200261, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200261
func (a *ArtifactsApiService) GetOrganizationCameraCustomAnalyticsArtifactsExecute(r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactsRequest) ([]InlineResponse200261, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
