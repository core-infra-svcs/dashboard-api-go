...
func (r ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) CreateOrganizationCameraCustomAnalyticsArtifact(createOrganizationCameraCustomAnalyticsArtifact InlineObject241) ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest {
	r.createOrganizationCameraCustomAnalyticsArtifact = &createOrganizationCameraCustomAnalyticsArtifact
	return r
}

func (r ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) Execute() (*InlineResponse20117, *http.Response, error) {
...
func (a *ArtifactsApiService) CreateOrganizationCameraCustomAnalyticsArtifactExecute(r ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) (*InlineResponse20117, *http.Response, error) {
	var (
...
func (r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactRequest) Execute() (*InlineResponse200249, *http.Response, error) {
...
func (a *ArtifactsApiService) GetOrganizationCameraCustomAnalyticsArtifactExecute(r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactRequest) (*InlineResponse200249, *http.Response, error) {
	var (
...
func (r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactsRequest) Execute() ([]InlineResponse200249, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200249
func (a *ArtifactsApiService) GetOrganizationCameraCustomAnalyticsArtifactsExecute(r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactsRequest) ([]InlineResponse200249, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
