...
func (r ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) CreateOrganizationCameraCustomAnalyticsArtifact(createOrganizationCameraCustomAnalyticsArtifact InlineObject220) ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest {
	r.createOrganizationCameraCustomAnalyticsArtifact = &createOrganizationCameraCustomAnalyticsArtifact
	return r
}

func (r ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) Execute() (*InlineResponse20113, *http.Response, error) {
...
func (a *ArtifactsApiService) CreateOrganizationCameraCustomAnalyticsArtifactExecute(r ArtifactsApiCreateOrganizationCameraCustomAnalyticsArtifactRequest) (*InlineResponse20113, *http.Response, error) {
	var (
...
func (r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactRequest) Execute() (*InlineResponse200223, *http.Response, error) {
...
func (a *ArtifactsApiService) GetOrganizationCameraCustomAnalyticsArtifactExecute(r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactRequest) (*InlineResponse200223, *http.Response, error) {
	var (
...
func (r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactsRequest) Execute() ([]InlineResponse200223, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200223
func (a *ArtifactsApiService) GetOrganizationCameraCustomAnalyticsArtifactsExecute(r ArtifactsApiGetOrganizationCameraCustomAnalyticsArtifactsRequest) ([]InlineResponse200223, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
