...
// InlineResponse20029Ipv6PrefixAssignments struct for InlineResponse20029Ipv6PrefixAssignments
type InlineResponse20029Ipv6PrefixAssignments struct {
...
func NewInlineResponse20029Ipv6PrefixAssignments() *InlineResponse20029Ipv6PrefixAssignments {
	this := InlineResponse20029Ipv6PrefixAssignments{}
	return &this
}
...
func (o InlineResponse20029Ipv6PrefixAssignments) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20029Ipv6PrefixAssignments struct {
	value *InlineResponse20029Ipv6PrefixAssignments
	isSet bool
}

func (v NullableInlineResponse20029Ipv6PrefixAssignments) Get() *InlineResponse20029Ipv6PrefixAssignments {
	return v.value
}

func (v *NullableInlineResponse20029Ipv6PrefixAssignments) Set(val *InlineResponse20029Ipv6PrefixAssignments) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20029Ipv6PrefixAssignments) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20029Ipv6PrefixAssignments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20029Ipv6PrefixAssignments(val *InlineResponse20029Ipv6PrefixAssignments) *NullableInlineResponse20029Ipv6PrefixAssignments {
	return &NullableInlineResponse20029Ipv6PrefixAssignments{value: val, isSet: true}
}

func (v NullableInlineResponse20029Ipv6PrefixAssignments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20029Ipv6PrefixAssignments) UnmarshalJSON(src []byte) error {
	v.isSet = true
