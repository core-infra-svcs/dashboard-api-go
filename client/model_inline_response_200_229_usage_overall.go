...
// InlineResponse200229UsageOverall Overall data usage of all clients across organization
type InlineResponse200229UsageOverall struct {
...
func NewInlineResponse200229UsageOverall() *InlineResponse200229UsageOverall {
	this := InlineResponse200229UsageOverall{}
	return &this
}
...
func (o InlineResponse200229UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200229UsageOverall struct {
	value *InlineResponse200229UsageOverall
	isSet bool
}

func (v NullableInlineResponse200229UsageOverall) Get() *InlineResponse200229UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200229UsageOverall) Set(val *InlineResponse200229UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200229UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200229UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200229UsageOverall(val *InlineResponse200229UsageOverall) *NullableInlineResponse200229UsageOverall {
	return &NullableInlineResponse200229UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200229UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200229UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
