...
type InlineResponse200273 struct {
	...
	States *InlineResponse200273States `json:"states,omitempty"`
	// Data by license type (Per-device licensing only)
	LicenseTypes []InlineResponse200273LicenseTypes `json:"licenseTypes,omitempty"`
	SystemsManager *InlineResponse200273SystemsManager `json:"systemsManager,omitempty"`
}
...
func (o *InlineResponse200273) GetStates() InlineResponse200273States {
	if o == nil || isNil(o.States) {
		var ret InlineResponse200273States
		return ret
	}
	return *o.States
}
...
// SetStates gets a reference to the given InlineResponse200273States and assigns it to the States field.
...
func (o *InlineResponse200273) GetLicenseTypes() []InlineResponse200273LicenseTypes {
	if o == nil || isNil(o.LicenseTypes) {
		var ret []InlineResponse200273LicenseTypes
		return ret
	}
...
// SetLicenseTypes gets a reference to the given []InlineResponse200273LicenseTypes and assigns it to the LicenseTypes field.
...
func (o *InlineResponse200273) GetSystemsManager() InlineResponse200273SystemsManager {
	if o == nil || isNil(o.SystemsManager) {
		var ret InlineResponse200273SystemsManager
		return ret
	}
...
// SetSystemsManager gets a reference to the given InlineResponse200273SystemsManager and assigns it to the SystemsManager field.
