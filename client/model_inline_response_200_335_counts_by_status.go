...
// InlineResponse200335CountsByStatus Associated client count on access point by status
type InlineResponse200335CountsByStatus struct {
	// Active client count
...
func NewInlineResponse200335CountsByStatus() *InlineResponse200335CountsByStatus {
	this := InlineResponse200335CountsByStatus{}
	return &this
}
...
func (o InlineResponse200335CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200335CountsByStatus struct {
	value *InlineResponse200335CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200335CountsByStatus) Get() *InlineResponse200335CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200335CountsByStatus) Set(val *InlineResponse200335CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200335CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200335CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200335CountsByStatus(val *InlineResponse200335CountsByStatus) *NullableInlineResponse200335CountsByStatus {
	return &NullableInlineResponse200335CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200335CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200335CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
