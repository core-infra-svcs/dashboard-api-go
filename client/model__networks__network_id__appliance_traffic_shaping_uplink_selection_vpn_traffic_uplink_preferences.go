...
type NetworksNetworkIdApplianceTrafficShapingUplinkSelectionVpnTrafficUplinkPreferences struct {
	...
	// Preferred uplink for this uplink preference rule. Must be one of: 'wan1', 'wan2', 'bestForVoIP', 'loadBalancing', 'defaultUplink' or 'cellular', or any other valid uplink(wanX) if it applies to the network
