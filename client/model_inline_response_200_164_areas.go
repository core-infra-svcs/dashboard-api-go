...
// InlineResponse200164Areas struct for InlineResponse200164Areas
type InlineResponse200164Areas struct {
	// OSPF area ID
...
func NewInlineResponse200164Areas() *InlineResponse200164Areas {
	this := InlineResponse200164Areas{}
	return &this
}
...
func (o InlineResponse200164Areas) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200164Areas struct {
	value *InlineResponse200164Areas
	isSet bool
}

func (v NullableInlineResponse200164Areas) Get() *InlineResponse200164Areas {
	return v.value
}

func (v *NullableInlineResponse200164Areas) Set(val *InlineResponse200164Areas) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200164Areas) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200164Areas) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200164Areas(val *InlineResponse200164Areas) *NullableInlineResponse200164Areas {
	return &NullableInlineResponse200164Areas{value: val, isSet: true}
}

func (v NullableInlineResponse200164Areas) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200164Areas) UnmarshalJSON(src []byte) error {
	v.isSet = true
