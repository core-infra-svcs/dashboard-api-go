...
type InlineResponse200153 struct {
	Alerts *InlineResponse200153Alerts `json:"alerts,omitempty"`
	...
	ArpInspection *InlineResponse200153ArpInspection `json:"arpInspection,omitempty"`
}
...
func (o *InlineResponse200153) GetAlerts() InlineResponse200153Alerts {
	if o == nil || isNil(o.Alerts) {
		var ret InlineResponse200153Alerts
		return ret
	}
	return *o.Alerts
}
...
// SetAlerts gets a reference to the given InlineResponse200153Alerts and assigns it to the Alerts field.
...
func (o *InlineResponse200153) GetArpInspection() InlineResponse200153ArpInspection {
	if o == nil || isNil(o.ArpInspection) {
		var ret InlineResponse200153ArpInspection
		return ret
	}
...
// SetArpInspection gets a reference to the given InlineResponse200153ArpInspection and assigns it to the ArpInspection field.
