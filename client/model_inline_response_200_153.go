...
type InlineResponse200153 struct {
	...
	ResultingLicenses []InlineResponse200152 `json:"resultingLicenses,omitempty"`
}
...
func (o *InlineResponse200153) GetResultingLicenses() []InlineResponse200152 {
	if o == nil || isNil(o.ResultingLicenses) {
		var ret []InlineResponse200152
		return ret
	}
...
func (o *InlineResponse200153) GetResultingLicensesOk() ([]InlineResponse200152, bool) {
	if o == nil || isNil(o.ResultingLicenses) {
    return nil, false
	}
...
func (o *InlineResponse200153) HasResultingLicenses() bool {
	if o != nil && !isNil(o.ResultingLicenses) {
		return true
	}
...
// SetResultingLicenses gets a reference to the given []InlineResponse200152 and assigns it to the ResultingLicenses field.
func (o *InlineResponse200153) SetResultingLicenses(v []InlineResponse200152) {
