...
// InlineResponse200133Usage Usage information of all clients across organization
type InlineResponse200133Usage struct {
	Overall *InlineResponse200133UsageOverall `json:"overall,omitempty"`
...
func NewInlineResponse200133Usage() *InlineResponse200133Usage {
	this := InlineResponse200133Usage{}
	return &this
}
...
func (o *InlineResponse200133Usage) GetOverall() InlineResponse200133UsageOverall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200133UsageOverall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200133UsageOverall and assigns it to the Overall field.
...
func (o InlineResponse200133Usage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200133Usage struct {
	value *InlineResponse200133Usage
	isSet bool
}

func (v NullableInlineResponse200133Usage) Get() *InlineResponse200133Usage {
	return v.value
}

func (v *NullableInlineResponse200133Usage) Set(val *InlineResponse200133Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200133Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200133Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200133Usage(val *InlineResponse200133Usage) *NullableInlineResponse200133Usage {
	return &NullableInlineResponse200133Usage{value: val, isSet: true}
}

func (v NullableInlineResponse200133Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200133Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
