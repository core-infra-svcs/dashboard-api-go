...
func (r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3ByDeviceRequest) Execute() (*InlineResponse200387, *http.Response, error) {
...
func (a *L3ApiService) GetOrganizationWirelessControllerDevicesInterfacesL3ByDeviceExecute(r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3ByDeviceRequest) (*InlineResponse200387, *http.Response, error) {
	var (
...
func (r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDeviceRequest) Execute() (*InlineResponse200388, *http.Response, error) {
...
func (a *L3ApiService) GetOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDeviceExecute(r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDeviceRequest) (*InlineResponse200388, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3UsageHistoryByIntervalRequest) Execute() (*InlineResponse200389, *http.Response, error) {
...
func (a *L3ApiService) GetOrganizationWirelessControllerDevicesInterfacesL3UsageHistoryByIntervalExecute(r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3UsageHistoryByIntervalRequest) (*InlineResponse200389, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
