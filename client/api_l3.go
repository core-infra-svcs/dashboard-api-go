...
func (r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3ByDeviceRequest) Execute() (*InlineResponse200412, *http.Response, error) {
...
func (a *L3ApiService) GetOrganizationWirelessControllerDevicesInterfacesL3ByDeviceExecute(r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3ByDeviceRequest) (*InlineResponse200412, *http.Response, error) {
	var (
...
func (r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDeviceRequest) Execute() (*InlineResponse200413, *http.Response, error) {
...
func (a *L3ApiService) GetOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDeviceExecute(r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDeviceRequest) (*InlineResponse200413, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3UsageHistoryByIntervalRequest) Execute() (*InlineResponse200414, *http.Response, error) {
...
func (a *L3ApiService) GetOrganizationWirelessControllerDevicesInterfacesL3UsageHistoryByIntervalExecute(r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3UsageHistoryByIntervalRequest) (*InlineResponse200414, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
