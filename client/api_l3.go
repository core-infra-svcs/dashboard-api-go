...
func (r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3ByDeviceRequest) Execute() (*InlineResponse200335, *http.Response, error) {
...
func (a *L3ApiService) GetOrganizationWirelessControllerDevicesInterfacesL3ByDeviceExecute(r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3ByDeviceRequest) (*InlineResponse200335, *http.Response, error) {
	var (
...
func (r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDeviceRequest) Execute() (*InlineResponse200336, *http.Response, error) {
...
func (a *L3ApiService) GetOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDeviceExecute(r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDeviceRequest) (*InlineResponse200336, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3UsageHistoryByIntervalRequest) Execute() (*InlineResponse200337, *http.Response, error) {
...
func (a *L3ApiService) GetOrganizationWirelessControllerDevicesInterfacesL3UsageHistoryByIntervalExecute(r L3ApiGetOrganizationWirelessControllerDevicesInterfacesL3UsageHistoryByIntervalRequest) (*InlineResponse200337, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
