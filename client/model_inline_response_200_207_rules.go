...
// InlineResponse200207Rules struct for InlineResponse200207Rules
type InlineResponse200207Rules struct {
...
func NewInlineResponse200207Rules() *InlineResponse200207Rules {
	this := InlineResponse200207Rules{}
	return &this
}
...
func (o InlineResponse200207Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200207Rules struct {
	value *InlineResponse200207Rules
	isSet bool
}

func (v NullableInlineResponse200207Rules) Get() *InlineResponse200207Rules {
	return v.value
}

func (v *NullableInlineResponse200207Rules) Set(val *InlineResponse200207Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200207Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200207Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200207Rules(val *InlineResponse200207Rules) *NullableInlineResponse200207Rules {
	return &NullableInlineResponse200207Rules{value: val, isSet: true}
}

func (v NullableInlineResponse200207Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200207Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
