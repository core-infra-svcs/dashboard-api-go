...
// InlineResponse2008InterfacesWan2 WAN 2 settings.
type InlineResponse2008InterfacesWan2 struct {
...
func NewInlineResponse2008InterfacesWan2() *InlineResponse2008InterfacesWan2 {
	this := InlineResponse2008InterfacesWan2{}
	return &this
}
...
func (o InlineResponse2008InterfacesWan2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2008InterfacesWan2 struct {
	value *InlineResponse2008InterfacesWan2
	isSet bool
}

func (v NullableInlineResponse2008InterfacesWan2) Get() *InlineResponse2008InterfacesWan2 {
	return v.value
}

func (v *NullableInlineResponse2008InterfacesWan2) Set(val *InlineResponse2008InterfacesWan2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2008InterfacesWan2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2008InterfacesWan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2008InterfacesWan2(val *InlineResponse2008InterfacesWan2) *NullableInlineResponse2008InterfacesWan2 {
	return &NullableInlineResponse2008InterfacesWan2{value: val, isSet: true}
}

func (v NullableInlineResponse2008InterfacesWan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2008InterfacesWan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
