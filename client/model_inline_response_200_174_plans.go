...
// InlineResponse200174Plans struct for InlineResponse200174Plans
type InlineResponse200174Plans struct {
	// The id of the pricing plan to update.
	Id *string `json:"id,omitempty"`
	// The price of the billing plan.
	Price *float32 `json:"price,omitempty"`
	BandwidthLimits *InlineResponse200174BandwidthLimits `json:"bandwidthLimits,omitempty"`
...
func NewInlineResponse200174Plans() *InlineResponse200174Plans {
	this := InlineResponse200174Plans{}
	return &this
}
...
func (o *InlineResponse200174Plans) GetBandwidthLimits() InlineResponse200174BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse200174BandwidthLimits
		return ret
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse200174BandwidthLimits and assigns it to the BandwidthLimits field.
...
func (o InlineResponse200174Plans) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200174Plans struct {
	value *InlineResponse200174Plans
	isSet bool
}

func (v NullableInlineResponse200174Plans) Get() *InlineResponse200174Plans {
	return v.value
}

func (v *NullableInlineResponse200174Plans) Set(val *InlineResponse200174Plans) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200174Plans) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200174Plans) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200174Plans(val *InlineResponse200174Plans) *NullableInlineResponse200174Plans {
	return &NullableInlineResponse200174Plans{value: val, isSet: true}
}

func (v NullableInlineResponse200174Plans) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200174Plans) UnmarshalJSON(src []byte) error {
	v.isSet = true
