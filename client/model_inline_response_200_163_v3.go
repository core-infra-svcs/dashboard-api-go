...
// InlineResponse200163V3 OSPF v3 configuration
type InlineResponse200163V3 struct {
	...
	// OSPF v3 areas
	Areas []InlineResponse200163Areas `json:"areas,omitempty"`
}
...
func (o *InlineResponse200163V3) GetAreas() []InlineResponse200163Areas {
	if o == nil || isNil(o.Areas) {
		var ret []InlineResponse200163Areas
		return ret
	}
	return o.Areas
}
...
// SetAreas gets a reference to the given []InlineResponse200163Areas and assigns it to the Areas field.
func (o *InlineResponse200163V3) SetAreas(v []InlineResponse200163Areas) {
	o.Areas = v
}

func (o InlineResponse200163V3) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200163V3 struct {
	value *InlineResponse200163V3
	isSet bool
}

func (v NullableInlineResponse200163V3) Get() *InlineResponse200163V3 {
	return v.value
}

func (v *NullableInlineResponse200163V3) Set(val *InlineResponse200163V3) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200163V3) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200163V3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200163V3(val *InlineResponse200163V3) *NullableInlineResponse200163V3 {
	return &NullableInlineResponse200163V3{value: val, isSet: true}
}

func (v NullableInlineResponse200163V3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200163V3) UnmarshalJSON(src []byte) error {
	v.isSet = true
