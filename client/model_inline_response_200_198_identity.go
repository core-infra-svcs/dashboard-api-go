...
// InlineResponse200198Identity EAP settings for identity requests.
type InlineResponse200198Identity struct {
...
func NewInlineResponse200198Identity() *InlineResponse200198Identity {
	this := InlineResponse200198Identity{}
	return &this
}
...
func (o InlineResponse200198Identity) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200198Identity struct {
	value *InlineResponse200198Identity
	isSet bool
}

func (v NullableInlineResponse200198Identity) Get() *InlineResponse200198Identity {
	return v.value
}

func (v *NullableInlineResponse200198Identity) Set(val *InlineResponse200198Identity) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200198Identity) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200198Identity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200198Identity(val *InlineResponse200198Identity) *NullableInlineResponse200198Identity {
	return &NullableInlineResponse200198Identity{value: val, isSet: true}
}

func (v NullableInlineResponse200198Identity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200198Identity) UnmarshalJSON(src []byte) error {
	v.isSet = true
