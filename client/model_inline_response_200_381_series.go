...
// InlineResponse200381Series struct for InlineResponse200381Series
type InlineResponse200381Series struct {
...
func NewInlineResponse200381Series() *InlineResponse200381Series {
	this := InlineResponse200381Series{}
	return &this
}
...
func (o InlineResponse200381Series) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200381Series struct {
	value *InlineResponse200381Series
	isSet bool
}

func (v NullableInlineResponse200381Series) Get() *InlineResponse200381Series {
	return v.value
}

func (v *NullableInlineResponse200381Series) Set(val *InlineResponse200381Series) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200381Series) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200381Series) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200381Series(val *InlineResponse200381Series) *NullableInlineResponse200381Series {
	return &NullableInlineResponse200381Series{value: val, isSet: true}
}

func (v NullableInlineResponse200381Series) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200381Series) UnmarshalJSON(src []byte) error {
	v.isSet = true
