...
type InlineResponse200198 struct {
	...
	ApBandSettings *InlineResponse200198ApBandSettings `json:"apBandSettings,omitempty"`
	...
	SixGhzSettings *InlineResponse200198SixGhzSettings `json:"sixGhzSettings,omitempty"`
	Transmission *InlineResponse200198Transmission `json:"transmission,omitempty"`
	PerSsidSettings *InlineResponse200198PerSsidSettings `json:"perSsidSettings,omitempty"`
...
func (o *InlineResponse200198) GetApBandSettings() InlineResponse200198ApBandSettings {
	if o == nil || isNil(o.ApBandSettings) {
		var ret InlineResponse200198ApBandSettings
		return ret
	}
...
// SetApBandSettings gets a reference to the given InlineResponse200198ApBandSettings and assigns it to the ApBandSettings field.
...
func (o *InlineResponse200198) GetSixGhzSettings() InlineResponse200198SixGhzSettings {
	if o == nil || isNil(o.SixGhzSettings) {
		var ret InlineResponse200198SixGhzSettings
		return ret
	}
...
// SetSixGhzSettings gets a reference to the given InlineResponse200198SixGhzSettings and assigns it to the SixGhzSettings field.
...
func (o *InlineResponse200198) GetPerSsidSettings() InlineResponse200198PerSsidSettings {
	if o == nil || isNil(o.PerSsidSettings) {
		var ret InlineResponse200198PerSsidSettings
		return ret
	}
...
// SetPerSsidSettings gets a reference to the given InlineResponse200198PerSsidSettings and assigns it to the PerSsidSettings field.
