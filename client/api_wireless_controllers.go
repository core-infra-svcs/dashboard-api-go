...
func (r WirelessControllersApiGetOrganizationWirelessDevicesWirelessControllersByDeviceRequest) Execute() (*InlineResponse200394, *http.Response, error) {
...
func (a *WirelessControllersApiService) GetOrganizationWirelessDevicesWirelessControllersByDeviceExecute(r WirelessControllersApiGetOrganizationWirelessDevicesWirelessControllersByDeviceRequest) (*InlineResponse200394, *http.Response, error) {
	var (
