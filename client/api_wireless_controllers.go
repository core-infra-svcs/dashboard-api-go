...
func (r WirelessControllersApiGetOrganizationWirelessDevicesWirelessControllersByDeviceRequest) Execute() (*InlineResponse200379, *http.Response, error) {
...
func (a *WirelessControllersApiService) GetOrganizationWirelessDevicesWirelessControllersByDeviceExecute(r WirelessControllersApiGetOrganizationWirelessDevicesWirelessControllersByDeviceRequest) (*InlineResponse200379, *http.Response, error) {
	var (
