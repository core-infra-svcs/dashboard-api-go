...
func (r WirelessControllersApiGetOrganizationWirelessDevicesWirelessControllersByDeviceRequest) Execute() (*InlineResponse200346, *http.Response, error) {
...
func (a *WirelessControllersApiService) GetOrganizationWirelessDevicesWirelessControllersByDeviceExecute(r WirelessControllersApiGetOrganizationWirelessDevicesWirelessControllersByDeviceRequest) (*InlineResponse200346, *http.Response, error) {
	var (
