...
func (r WirelessControllersApiGetOrganizationWirelessDevicesWirelessControllersByDeviceRequest) Execute() (*InlineResponse200366, *http.Response, error) {
...
func (a *WirelessControllersApiService) GetOrganizationWirelessDevicesWirelessControllersByDeviceExecute(r WirelessControllersApiGetOrganizationWirelessDevicesWirelessControllersByDeviceRequest) (*InlineResponse200366, *http.Response, error) {
	var (
