...
// InlineResponse200361Tags struct for InlineResponse200361Tags
type InlineResponse200361Tags struct {
	// Policy tag
...
func (o InlineResponse200361Tags) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200361Tags struct {
	value *InlineResponse200361Tags
	isSet bool
}

func (v NullableInlineResponse200361Tags) Get() *InlineResponse200361Tags {
	return v.value
}

func (v *NullableInlineResponse200361Tags) Set(val *InlineResponse200361Tags) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200361Tags) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200361Tags) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200361Tags(val *InlineResponse200361Tags) *NullableInlineResponse200361Tags {
	return &NullableInlineResponse200361Tags{value: val, isSet: true}
}

func (v NullableInlineResponse200361Tags) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200361Tags) UnmarshalJSON(src []byte) error {
	v.isSet = true
