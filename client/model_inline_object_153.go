...
func NewInlineObject153(ruleIds []string) *InlineObject153 {
...
func (o *InlineObject153) GetRuleIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *InlineObject153) GetRuleIdsOk() ([]string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *InlineObject153) SetRuleIds(v []string) {
	o.RuleIds = v
}
