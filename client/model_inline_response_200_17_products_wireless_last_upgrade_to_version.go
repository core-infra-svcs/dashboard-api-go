...
// InlineResponse20017ProductsWirelessLastUpgradeToVersion Details of the version the device upgraded to
type InlineResponse20017ProductsWirelessLastUpgradeToVersion struct {
...
func NewInlineResponse20017ProductsWirelessLastUpgradeToVersion() *InlineResponse20017ProductsWirelessLastUpgradeToVersion {
	this := InlineResponse20017ProductsWirelessLastUpgradeToVersion{}
	return &this
}
...
func (o InlineResponse20017ProductsWirelessLastUpgradeToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20017ProductsWirelessLastUpgradeToVersion struct {
	value *InlineResponse20017ProductsWirelessLastUpgradeToVersion
	isSet bool
}

func (v NullableInlineResponse20017ProductsWirelessLastUpgradeToVersion) Get() *InlineResponse20017ProductsWirelessLastUpgradeToVersion {
	return v.value
}

func (v *NullableInlineResponse20017ProductsWirelessLastUpgradeToVersion) Set(val *InlineResponse20017ProductsWirelessLastUpgradeToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20017ProductsWirelessLastUpgradeToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20017ProductsWirelessLastUpgradeToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20017ProductsWirelessLastUpgradeToVersion(val *InlineResponse20017ProductsWirelessLastUpgradeToVersion) *NullableInlineResponse20017ProductsWirelessLastUpgradeToVersion {
	return &NullableInlineResponse20017ProductsWirelessLastUpgradeToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20017ProductsWirelessLastUpgradeToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20017ProductsWirelessLastUpgradeToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
