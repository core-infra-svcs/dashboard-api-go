...
func (o *InlineResponse200266) GetBoundaries() OrganizationsOrganizationIdCameraBoundariesLinesByDeviceBoundaries {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200266) GetBoundariesOk() (*OrganizationsOrganizationIdCameraBoundariesLinesByDeviceBoundaries, bool) {
	if o == nil || isNil(o.Boundaries) {
    return nil, false
	}
...
func (o *InlineResponse200266) HasBoundaries() bool {
	if o != nil && !isNil(o.Boundaries) {
		return true
	}
...
func (o *InlineResponse200266) SetBoundaries(v OrganizationsOrganizationIdCameraBoundariesLinesByDeviceBoundaries) {
	o.Boundaries = &v
}
