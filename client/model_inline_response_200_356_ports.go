...
// InlineResponse200356Ports struct for InlineResponse200356Ports
type InlineResponse200356Ports struct {
...
func NewInlineResponse200356Ports() *InlineResponse200356Ports {
	this := InlineResponse200356Ports{}
	return &this
}
...
func (o InlineResponse200356Ports) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200356Ports struct {
	value *InlineResponse200356Ports
	isSet bool
}

func (v NullableInlineResponse200356Ports) Get() *InlineResponse200356Ports {
	return v.value
}

func (v *NullableInlineResponse200356Ports) Set(val *InlineResponse200356Ports) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200356Ports) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200356Ports) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200356Ports(val *InlineResponse200356Ports) *NullableInlineResponse200356Ports {
	return &NullableInlineResponse200356Ports{value: val, isSet: true}
}

func (v NullableInlineResponse200356Ports) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200356Ports) UnmarshalJSON(src []byte) error {
	v.isSet = true
