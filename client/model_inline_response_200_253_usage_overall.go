...
// InlineResponse200253UsageOverall Overall data usage of all clients across organization
type InlineResponse200253UsageOverall struct {
...
func NewInlineResponse200253UsageOverall() *InlineResponse200253UsageOverall {
	this := InlineResponse200253UsageOverall{}
	return &this
}
...
func (o InlineResponse200253UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200253UsageOverall struct {
	value *InlineResponse200253UsageOverall
	isSet bool
}

func (v NullableInlineResponse200253UsageOverall) Get() *InlineResponse200253UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200253UsageOverall) Set(val *InlineResponse200253UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200253UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200253UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200253UsageOverall(val *InlineResponse200253UsageOverall) *NullableInlineResponse200253UsageOverall {
	return &NullableInlineResponse200253UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200253UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200253UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
