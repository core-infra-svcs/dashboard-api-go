...
// InlineResponse200276Details struct for InlineResponse200276Details
type InlineResponse200276Details struct {
	// Name of detail
...
func NewInlineResponse200276Details() *InlineResponse200276Details {
	this := InlineResponse200276Details{}
	return &this
}
...
func (o InlineResponse200276Details) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200276Details struct {
	value *InlineResponse200276Details
	isSet bool
}

func (v NullableInlineResponse200276Details) Get() *InlineResponse200276Details {
	return v.value
}

func (v *NullableInlineResponse200276Details) Set(val *InlineResponse200276Details) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200276Details) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200276Details) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200276Details(val *InlineResponse200276Details) *NullableInlineResponse200276Details {
	return &NullableInlineResponse200276Details{value: val, isSet: true}
}

func (v NullableInlineResponse200276Details) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200276Details) UnmarshalJSON(src []byte) error {
	v.isSet = true
