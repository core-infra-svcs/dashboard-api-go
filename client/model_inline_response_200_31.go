...
type InlineResponse20031 struct {
	BandwidthLimits *InlineResponse20031BandwidthLimits `json:"bandwidthLimits,omitempty"`
}
...
func (o *InlineResponse20031) GetBandwidthLimits() InlineResponse20031BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse20031BandwidthLimits
		return ret
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse20031BandwidthLimits and assigns it to the BandwidthLimits field.
