...
// InlineResponse200255StatesExpiringWarning Data for the warning threshold
type InlineResponse200255StatesExpiringWarning struct {
...
func NewInlineResponse200255StatesExpiringWarning() *InlineResponse200255StatesExpiringWarning {
	this := InlineResponse200255StatesExpiringWarning{}
	return &this
}
...
func (o InlineResponse200255StatesExpiringWarning) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200255StatesExpiringWarning struct {
	value *InlineResponse200255StatesExpiringWarning
	isSet bool
}

func (v NullableInlineResponse200255StatesExpiringWarning) Get() *InlineResponse200255StatesExpiringWarning {
	return v.value
}

func (v *NullableInlineResponse200255StatesExpiringWarning) Set(val *InlineResponse200255StatesExpiringWarning) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200255StatesExpiringWarning) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200255StatesExpiringWarning) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200255StatesExpiringWarning(val *InlineResponse200255StatesExpiringWarning) *NullableInlineResponse200255StatesExpiringWarning {
	return &NullableInlineResponse200255StatesExpiringWarning{value: val, isSet: true}
}

func (v NullableInlineResponse200255StatesExpiringWarning) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200255StatesExpiringWarning) UnmarshalJSON(src []byte) error {
	v.isSet = true
