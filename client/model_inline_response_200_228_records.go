...
// InlineResponse200228Records struct for InlineResponse200228Records
type InlineResponse200228Records struct {
	Network *InlineResponse200228Network `json:"network,omitempty"`
	...
	ClientVpnConnections []InlineResponse200228ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func NewInlineResponse200228Records() *InlineResponse200228Records {
	this := InlineResponse200228Records{}
	return &this
}
...
func (o *InlineResponse200228Records) GetNetwork() InlineResponse200228Network {
	if o == nil || isNil(o.Network) {
		var ret InlineResponse200228Network
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given InlineResponse200228Network and assigns it to the Network field.
...
func (o *InlineResponse200228Records) GetClientVpnConnections() []InlineResponse200228ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200228ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200228ClientVpnConnections and assigns it to the ClientVpnConnections field.
...
func (o InlineResponse200228Records) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200228Records struct {
	value *InlineResponse200228Records
	isSet bool
}

func (v NullableInlineResponse200228Records) Get() *InlineResponse200228Records {
	return v.value
}

func (v *NullableInlineResponse200228Records) Set(val *InlineResponse200228Records) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200228Records) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200228Records) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200228Records(val *InlineResponse200228Records) *NullableInlineResponse200228Records {
	return &NullableInlineResponse200228Records{value: val, isSet: true}
}

func (v NullableInlineResponse200228Records) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200228Records) UnmarshalJSON(src []byte) error {
	v.isSet = true
