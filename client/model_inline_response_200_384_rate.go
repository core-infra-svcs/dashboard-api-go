...
// InlineResponse200384Rate The interface packet rates measured in packets per second
type InlineResponse200384Rate struct {
...
func (o InlineResponse200384Rate) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200384Rate struct {
	value *InlineResponse200384Rate
	isSet bool
}

func (v NullableInlineResponse200384Rate) Get() *InlineResponse200384Rate {
	return v.value
}

func (v *NullableInlineResponse200384Rate) Set(val *InlineResponse200384Rate) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200384Rate) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200384Rate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200384Rate(val *InlineResponse200384Rate) *NullableInlineResponse200384Rate {
	return &NullableInlineResponse200384Rate{value: val, isSet: true}
}

func (v NullableInlineResponse200384Rate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200384Rate) UnmarshalJSON(src []byte) error {
	v.isSet = true
