...
// InlineResponse200300ApiAuthenticationIpRestrictionsForKeys Details for API-only IP restrictions.
type InlineResponse200300ApiAuthenticationIpRestrictionsForKeys struct {
...
func NewInlineResponse200300ApiAuthenticationIpRestrictionsForKeys() *InlineResponse200300ApiAuthenticationIpRestrictionsForKeys {
	this := InlineResponse200300ApiAuthenticationIpRestrictionsForKeys{}
	return &this
}
...
func (o InlineResponse200300ApiAuthenticationIpRestrictionsForKeys) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200300ApiAuthenticationIpRestrictionsForKeys struct {
	value *InlineResponse200300ApiAuthenticationIpRestrictionsForKeys
	isSet bool
}

func (v NullableInlineResponse200300ApiAuthenticationIpRestrictionsForKeys) Get() *InlineResponse200300ApiAuthenticationIpRestrictionsForKeys {
	return v.value
}

func (v *NullableInlineResponse200300ApiAuthenticationIpRestrictionsForKeys) Set(val *InlineResponse200300ApiAuthenticationIpRestrictionsForKeys) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200300ApiAuthenticationIpRestrictionsForKeys) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200300ApiAuthenticationIpRestrictionsForKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200300ApiAuthenticationIpRestrictionsForKeys(val *InlineResponse200300ApiAuthenticationIpRestrictionsForKeys) *NullableInlineResponse200300ApiAuthenticationIpRestrictionsForKeys {
	return &NullableInlineResponse200300ApiAuthenticationIpRestrictionsForKeys{value: val, isSet: true}
}

func (v NullableInlineResponse200300ApiAuthenticationIpRestrictionsForKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200300ApiAuthenticationIpRestrictionsForKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
