...
// InlineResponse200269ClientVpnConnections struct for InlineResponse200269ClientVpnConnections
type InlineResponse200269ClientVpnConnections struct {
...
func NewInlineResponse200269ClientVpnConnections() *InlineResponse200269ClientVpnConnections {
	this := InlineResponse200269ClientVpnConnections{}
	return &this
}
...
func (o InlineResponse200269ClientVpnConnections) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200269ClientVpnConnections struct {
	value *InlineResponse200269ClientVpnConnections
	isSet bool
}

func (v NullableInlineResponse200269ClientVpnConnections) Get() *InlineResponse200269ClientVpnConnections {
	return v.value
}

func (v *NullableInlineResponse200269ClientVpnConnections) Set(val *InlineResponse200269ClientVpnConnections) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200269ClientVpnConnections) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200269ClientVpnConnections) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200269ClientVpnConnections(val *InlineResponse200269ClientVpnConnections) *NullableInlineResponse200269ClientVpnConnections {
	return &NullableInlineResponse200269ClientVpnConnections{value: val, isSet: true}
}

func (v NullableInlineResponse200269ClientVpnConnections) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200269ClientVpnConnections) UnmarshalJSON(src []byte) error {
	v.isSet = true
