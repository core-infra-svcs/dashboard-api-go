...
// InlineResponse200239EbgpNeighbor [optional] The BGP neighbor configuration for the VPN peer. Supported only for MX 19.1 and above.
type InlineResponse200239EbgpNeighbor struct {
	// ID of ebgp neighbor
...
func NewInlineResponse200239EbgpNeighbor() *InlineResponse200239EbgpNeighbor {
	this := InlineResponse200239EbgpNeighbor{}
	return &this
}
...
func (o InlineResponse200239EbgpNeighbor) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200239EbgpNeighbor struct {
	value *InlineResponse200239EbgpNeighbor
	isSet bool
}

func (v NullableInlineResponse200239EbgpNeighbor) Get() *InlineResponse200239EbgpNeighbor {
	return v.value
}

func (v *NullableInlineResponse200239EbgpNeighbor) Set(val *InlineResponse200239EbgpNeighbor) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200239EbgpNeighbor) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200239EbgpNeighbor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200239EbgpNeighbor(val *InlineResponse200239EbgpNeighbor) *NullableInlineResponse200239EbgpNeighbor {
	return &NullableInlineResponse200239EbgpNeighbor{value: val, isSet: true}
}

func (v NullableInlineResponse200239EbgpNeighbor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200239EbgpNeighbor) UnmarshalJSON(src []byte) error {
	v.isSet = true
