...
// InlineResponse20066Value1 Value of traffic filter
type InlineResponse20066Value1 struct {
	...
	Source *InlineResponse20066Value1Source `json:"source,omitempty"`
	Destination *InlineResponse20066Value1Destination `json:"destination,omitempty"`
}
...
func NewInlineResponse20066Value1() *InlineResponse20066Value1 {
	this := InlineResponse20066Value1{}
	return &this
}
...
func (o *InlineResponse20066Value1) GetSource() InlineResponse20066Value1Source {
	if o == nil || isNil(o.Source) {
		var ret InlineResponse20066Value1Source
		return ret
	}
	return *o.Source
}
...
// SetSource gets a reference to the given InlineResponse20066Value1Source and assigns it to the Source field.
...
func (o *InlineResponse20066Value1) GetDestination() InlineResponse20066Value1Destination {
	if o == nil || isNil(o.Destination) {
		var ret InlineResponse20066Value1Destination
		return ret
	}
...
// SetDestination gets a reference to the given InlineResponse20066Value1Destination and assigns it to the Destination field.
func (o *InlineResponse20066Value1) SetDestination(v InlineResponse20066Value1Destination) {
	o.Destination = &v
}

func (o InlineResponse20066Value1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20066Value1 struct {
	value *InlineResponse20066Value1
	isSet bool
}

func (v NullableInlineResponse20066Value1) Get() *InlineResponse20066Value1 {
	return v.value
}

func (v *NullableInlineResponse20066Value1) Set(val *InlineResponse20066Value1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20066Value1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20066Value1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20066Value1(val *InlineResponse20066Value1) *NullableInlineResponse20066Value1 {
	return &NullableInlineResponse20066Value1{value: val, isSet: true}
}

func (v NullableInlineResponse20066Value1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20066Value1) UnmarshalJSON(src []byte) error {
	v.isSet = true
