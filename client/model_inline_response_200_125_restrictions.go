...
// InlineResponse200125Restrictions struct for InlineResponse200125Restrictions
type InlineResponse200125Restrictions struct {
...
func NewInlineResponse200125Restrictions() *InlineResponse200125Restrictions {
	this := InlineResponse200125Restrictions{}
	return &this
}
...
func (o InlineResponse200125Restrictions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200125Restrictions struct {
	value *InlineResponse200125Restrictions
	isSet bool
}

func (v NullableInlineResponse200125Restrictions) Get() *InlineResponse200125Restrictions {
	return v.value
}

func (v *NullableInlineResponse200125Restrictions) Set(val *InlineResponse200125Restrictions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200125Restrictions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200125Restrictions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200125Restrictions(val *InlineResponse200125Restrictions) *NullableInlineResponse200125Restrictions {
	return &NullableInlineResponse200125Restrictions{value: val, isSet: true}
}

func (v NullableInlineResponse200125Restrictions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200125Restrictions) UnmarshalJSON(src []byte) error {
	v.isSet = true
