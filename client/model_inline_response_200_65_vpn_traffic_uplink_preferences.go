...
// InlineResponse20065VpnTrafficUplinkPreferences struct for InlineResponse20065VpnTrafficUplinkPreferences
type InlineResponse20065VpnTrafficUplinkPreferences struct {
	// Traffic filters
	TrafficFilters []InlineResponse20065TrafficFilters1 `json:"trafficFilters"`
	...
	PerformanceClass *InlineResponse20065PerformanceClass `json:"performanceClass,omitempty"`
}
...
func NewInlineResponse20065VpnTrafficUplinkPreferences(trafficFilters []InlineResponse20065TrafficFilters1, preferredUplink string) *InlineResponse20065VpnTrafficUplinkPreferences {
	this := InlineResponse20065VpnTrafficUplinkPreferences{}
...
func (o *InlineResponse20065VpnTrafficUplinkPreferences) GetTrafficFilters() []InlineResponse20065TrafficFilters1 {
	if o == nil {
		var ret []InlineResponse20065TrafficFilters1
		return ret
	}
...
func (o *InlineResponse20065VpnTrafficUplinkPreferences) GetPerformanceClass() InlineResponse20065PerformanceClass {
	if o == nil || isNil(o.PerformanceClass) {
		var ret InlineResponse20065PerformanceClass
		return ret
	}
...
// SetPerformanceClass gets a reference to the given InlineResponse20065PerformanceClass and assigns it to the PerformanceClass field.
...
func (o InlineResponse20065VpnTrafficUplinkPreferences) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20065VpnTrafficUplinkPreferences struct {
	value *InlineResponse20065VpnTrafficUplinkPreferences
	isSet bool
}

func (v NullableInlineResponse20065VpnTrafficUplinkPreferences) Get() *InlineResponse20065VpnTrafficUplinkPreferences {
	return v.value
}

func (v *NullableInlineResponse20065VpnTrafficUplinkPreferences) Set(val *InlineResponse20065VpnTrafficUplinkPreferences) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20065VpnTrafficUplinkPreferences) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20065VpnTrafficUplinkPreferences) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20065VpnTrafficUplinkPreferences(val *InlineResponse20065VpnTrafficUplinkPreferences) *NullableInlineResponse20065VpnTrafficUplinkPreferences {
	return &NullableInlineResponse20065VpnTrafficUplinkPreferences{value: val, isSet: true}
}

func (v NullableInlineResponse20065VpnTrafficUplinkPreferences) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20065VpnTrafficUplinkPreferences) UnmarshalJSON(src []byte) error {
	v.isSet = true
