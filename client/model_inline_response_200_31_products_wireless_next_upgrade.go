...
// InlineResponse20031ProductsWirelessNextUpgrade Details of the next firmware upgrade on the device
type InlineResponse20031ProductsWirelessNextUpgrade struct {
	// Timestamp of the next scheduled firmware upgrade
	Time *time.Time `json:"time,omitempty"`
	ToVersion *InlineResponse20031ProductsWirelessNextUpgradeToVersion `json:"toVersion,omitempty"`
}
...
func NewInlineResponse20031ProductsWirelessNextUpgrade() *InlineResponse20031ProductsWirelessNextUpgrade {
	this := InlineResponse20031ProductsWirelessNextUpgrade{}
	return &this
}
...
func (o *InlineResponse20031ProductsWirelessNextUpgrade) GetToVersion() InlineResponse20031ProductsWirelessNextUpgradeToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20031ProductsWirelessNextUpgradeToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20031ProductsWirelessNextUpgradeToVersion and assigns it to the ToVersion field.
...
func (o InlineResponse20031ProductsWirelessNextUpgrade) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20031ProductsWirelessNextUpgrade struct {
	value *InlineResponse20031ProductsWirelessNextUpgrade
	isSet bool
}

func (v NullableInlineResponse20031ProductsWirelessNextUpgrade) Get() *InlineResponse20031ProductsWirelessNextUpgrade {
	return v.value
}

func (v *NullableInlineResponse20031ProductsWirelessNextUpgrade) Set(val *InlineResponse20031ProductsWirelessNextUpgrade) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20031ProductsWirelessNextUpgrade) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20031ProductsWirelessNextUpgrade) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20031ProductsWirelessNextUpgrade(val *InlineResponse20031ProductsWirelessNextUpgrade) *NullableInlineResponse20031ProductsWirelessNextUpgrade {
	return &NullableInlineResponse20031ProductsWirelessNextUpgrade{value: val, isSet: true}
}

func (v NullableInlineResponse20031ProductsWirelessNextUpgrade) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20031ProductsWirelessNextUpgrade) UnmarshalJSON(src []byte) error {
	v.isSet = true
