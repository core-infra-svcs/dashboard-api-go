...
// InlineResponse200140Switches struct for InlineResponse200140Switches
type InlineResponse200140Switches struct {
...
func NewInlineResponse200140Switches() *InlineResponse200140Switches {
	this := InlineResponse200140Switches{}
	return &this
}
...
func (o InlineResponse200140Switches) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200140Switches struct {
	value *InlineResponse200140Switches
	isSet bool
}

func (v NullableInlineResponse200140Switches) Get() *InlineResponse200140Switches {
	return v.value
}

func (v *NullableInlineResponse200140Switches) Set(val *InlineResponse200140Switches) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200140Switches) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200140Switches) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200140Switches(val *InlineResponse200140Switches) *NullableInlineResponse200140Switches {
	return &NullableInlineResponse200140Switches{value: val, isSet: true}
}

func (v NullableInlineResponse200140Switches) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200140Switches) UnmarshalJSON(src []byte) error {
	v.isSet = true
