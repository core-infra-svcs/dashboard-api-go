...
// InlineResponse20026ProductsWirelessLastUpgradeFromVersion Details of the version the device upgraded from
type InlineResponse20026ProductsWirelessLastUpgradeFromVersion struct {
...
func NewInlineResponse20026ProductsWirelessLastUpgradeFromVersion() *InlineResponse20026ProductsWirelessLastUpgradeFromVersion {
	this := InlineResponse20026ProductsWirelessLastUpgradeFromVersion{}
	return &this
}
...
func (o InlineResponse20026ProductsWirelessLastUpgradeFromVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20026ProductsWirelessLastUpgradeFromVersion struct {
	value *InlineResponse20026ProductsWirelessLastUpgradeFromVersion
	isSet bool
}

func (v NullableInlineResponse20026ProductsWirelessLastUpgradeFromVersion) Get() *InlineResponse20026ProductsWirelessLastUpgradeFromVersion {
	return v.value
}

func (v *NullableInlineResponse20026ProductsWirelessLastUpgradeFromVersion) Set(val *InlineResponse20026ProductsWirelessLastUpgradeFromVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20026ProductsWirelessLastUpgradeFromVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20026ProductsWirelessLastUpgradeFromVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20026ProductsWirelessLastUpgradeFromVersion(val *InlineResponse20026ProductsWirelessLastUpgradeFromVersion) *NullableInlineResponse20026ProductsWirelessLastUpgradeFromVersion {
	return &NullableInlineResponse20026ProductsWirelessLastUpgradeFromVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20026ProductsWirelessLastUpgradeFromVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20026ProductsWirelessLastUpgradeFromVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
