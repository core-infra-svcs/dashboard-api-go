...
// InlineResponse200376MetaCountsItems The count metadata.
type InlineResponse200376MetaCountsItems struct {
...
func NewInlineResponse200376MetaCountsItems() *InlineResponse200376MetaCountsItems {
	this := InlineResponse200376MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200376MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200376MetaCountsItems struct {
	value *InlineResponse200376MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200376MetaCountsItems) Get() *InlineResponse200376MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200376MetaCountsItems) Set(val *InlineResponse200376MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200376MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200376MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200376MetaCountsItems(val *InlineResponse200376MetaCountsItems) *NullableInlineResponse200376MetaCountsItems {
	return &NullableInlineResponse200376MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200376MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200376MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
