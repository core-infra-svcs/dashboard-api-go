...
// InlineResponse20088ProductsWirelessNextUpgradeToVersion Details of the version the device will upgrade to if it exists
type InlineResponse20088ProductsWirelessNextUpgradeToVersion struct {
...
func NewInlineResponse20088ProductsWirelessNextUpgradeToVersion() *InlineResponse20088ProductsWirelessNextUpgradeToVersion {
	this := InlineResponse20088ProductsWirelessNextUpgradeToVersion{}
	return &this
}
...
func (o InlineResponse20088ProductsWirelessNextUpgradeToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20088ProductsWirelessNextUpgradeToVersion struct {
	value *InlineResponse20088ProductsWirelessNextUpgradeToVersion
	isSet bool
}

func (v NullableInlineResponse20088ProductsWirelessNextUpgradeToVersion) Get() *InlineResponse20088ProductsWirelessNextUpgradeToVersion {
	return v.value
}

func (v *NullableInlineResponse20088ProductsWirelessNextUpgradeToVersion) Set(val *InlineResponse20088ProductsWirelessNextUpgradeToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20088ProductsWirelessNextUpgradeToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20088ProductsWirelessNextUpgradeToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20088ProductsWirelessNextUpgradeToVersion(val *InlineResponse20088ProductsWirelessNextUpgradeToVersion) *NullableInlineResponse20088ProductsWirelessNextUpgradeToVersion {
	return &NullableInlineResponse20088ProductsWirelessNextUpgradeToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20088ProductsWirelessNextUpgradeToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20088ProductsWirelessNextUpgradeToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
