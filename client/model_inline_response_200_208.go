...
type InlineResponse200208 struct {
	...
	SplashLogo *InlineResponse200208SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200208SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200208SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200208GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200208Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200208SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200208SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200208) GetSplashLogo() InlineResponse200208SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200208SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200208SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200208) GetSplashImage() InlineResponse200208SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200208SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200208SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200208) GetSplashPrepaidFront() InlineResponse200208SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200208SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200208SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200208) GetGuestSponsorship() InlineResponse200208GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200208GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200208GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200208) GetBilling() InlineResponse200208Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200208Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200208Billing and assigns it to the Billing field.
...
func (o *InlineResponse200208) GetSentryEnrollment() InlineResponse200208SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200208SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200208SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200208) GetSelfRegistration() InlineResponse200208SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200208SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200208SelfRegistration and assigns it to the SelfRegistration field.
