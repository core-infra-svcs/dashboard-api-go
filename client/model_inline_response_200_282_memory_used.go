...
// InlineResponse200282MemoryUsed Information regarding memory usage on the device over the interval
type InlineResponse200282MemoryUsed struct {
	...
	Percentages *InlineResponse200282MemoryUsedPercentages `json:"percentages,omitempty"`
}
...
func NewInlineResponse200282MemoryUsed() *InlineResponse200282MemoryUsed {
	this := InlineResponse200282MemoryUsed{}
	return &this
}
...
func (o *InlineResponse200282MemoryUsed) GetPercentages() InlineResponse200282MemoryUsedPercentages {
	if o == nil || isNil(o.Percentages) {
		var ret InlineResponse200282MemoryUsedPercentages
		return ret
	}
...
// SetPercentages gets a reference to the given InlineResponse200282MemoryUsedPercentages and assigns it to the Percentages field.
func (o *InlineResponse200282MemoryUsed) SetPercentages(v InlineResponse200282MemoryUsedPercentages) {
	o.Percentages = &v
}

func (o InlineResponse200282MemoryUsed) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200282MemoryUsed struct {
	value *InlineResponse200282MemoryUsed
	isSet bool
}

func (v NullableInlineResponse200282MemoryUsed) Get() *InlineResponse200282MemoryUsed {
	return v.value
}

func (v *NullableInlineResponse200282MemoryUsed) Set(val *InlineResponse200282MemoryUsed) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200282MemoryUsed) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200282MemoryUsed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200282MemoryUsed(val *InlineResponse200282MemoryUsed) *NullableInlineResponse200282MemoryUsed {
	return &NullableInlineResponse200282MemoryUsed{value: val, isSet: true}
}

func (v NullableInlineResponse200282MemoryUsed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200282MemoryUsed) UnmarshalJSON(src []byte) error {
	v.isSet = true
