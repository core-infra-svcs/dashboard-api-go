...
func (r LossAndLatencyHistoryApiGetDeviceLossAndLatencyHistoryRequest) Execute() ([]InlineResponse20027, *http.Response, error) {
...
func (a *LossAndLatencyHistoryApiService) GetDeviceLossAndLatencyHistoryExecute(r LossAndLatencyHistoryApiGetDeviceLossAndLatencyHistoryRequest) ([]InlineResponse20027, *http.Response, error) {
	var (
