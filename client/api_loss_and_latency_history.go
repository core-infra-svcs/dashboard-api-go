...
func (r LossAndLatencyHistoryApiGetDeviceLossAndLatencyHistoryRequest) Execute() ([]InlineResponse20030, *http.Response, error) {
...
func (a *LossAndLatencyHistoryApiService) GetDeviceLossAndLatencyHistoryExecute(r LossAndLatencyHistoryApiGetDeviceLossAndLatencyHistoryRequest) ([]InlineResponse20030, *http.Response, error) {
	var (
