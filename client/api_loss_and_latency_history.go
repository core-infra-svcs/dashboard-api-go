...
func (r LossAndLatencyHistoryApiGetDeviceLossAndLatencyHistoryRequest) Execute() ([]InlineResponse20032, *http.Response, error) {
...
func (a *LossAndLatencyHistoryApiService) GetDeviceLossAndLatencyHistoryExecute(r LossAndLatencyHistoryApiGetDeviceLossAndLatencyHistoryRequest) ([]InlineResponse20032, *http.Response, error) {
	var (
