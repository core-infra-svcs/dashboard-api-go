...
func (r BrandingPoliciesApiGetOrganizationBrandingPoliciesRequest) Execute() ([]InlineResponse200124, *http.Response, error) {
...
func (a *BrandingPoliciesApiService) GetOrganizationBrandingPoliciesExecute(r BrandingPoliciesApiGetOrganizationBrandingPoliciesRequest) ([]InlineResponse200124, *http.Response, error) {
	var (
...
func (r BrandingPoliciesApiGetOrganizationBrandingPoliciesPrioritiesRequest) Execute() (*InlineResponse200125, *http.Response, error) {
...
func (a *BrandingPoliciesApiService) GetOrganizationBrandingPoliciesPrioritiesExecute(r BrandingPoliciesApiGetOrganizationBrandingPoliciesPrioritiesRequest) (*InlineResponse200125, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r BrandingPoliciesApiGetOrganizationBrandingPolicyRequest) Execute() (*InlineResponse200124, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200124
func (a *BrandingPoliciesApiService) GetOrganizationBrandingPolicyExecute(r BrandingPoliciesApiGetOrganizationBrandingPolicyRequest) (*InlineResponse200124, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r BrandingPoliciesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) Execute() (*InlineResponse200125, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200125
func (a *BrandingPoliciesApiService) UpdateOrganizationBrandingPoliciesPrioritiesExecute(r BrandingPoliciesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) (*InlineResponse200125, *http.Response, error) {
	var (
...
func (r BrandingPoliciesApiUpdateOrganizationBrandingPolicyRequest) Execute() (*InlineResponse200124, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200124
func (a *BrandingPoliciesApiService) UpdateOrganizationBrandingPolicyExecute(r BrandingPoliciesApiUpdateOrganizationBrandingPolicyRequest) (*InlineResponse200124, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
