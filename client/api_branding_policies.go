...
func (r BrandingPoliciesApiGetOrganizationBrandingPoliciesRequest) Execute() ([]InlineResponse200127, *http.Response, error) {
...
func (a *BrandingPoliciesApiService) GetOrganizationBrandingPoliciesExecute(r BrandingPoliciesApiGetOrganizationBrandingPoliciesRequest) ([]InlineResponse200127, *http.Response, error) {
	var (
...
func (r BrandingPoliciesApiGetOrganizationBrandingPoliciesPrioritiesRequest) Execute() (*InlineResponse200128, *http.Response, error) {
...
func (a *BrandingPoliciesApiService) GetOrganizationBrandingPoliciesPrioritiesExecute(r BrandingPoliciesApiGetOrganizationBrandingPoliciesPrioritiesRequest) (*InlineResponse200128, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r BrandingPoliciesApiGetOrganizationBrandingPolicyRequest) Execute() (*InlineResponse200127, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200127
func (a *BrandingPoliciesApiService) GetOrganizationBrandingPolicyExecute(r BrandingPoliciesApiGetOrganizationBrandingPolicyRequest) (*InlineResponse200127, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r BrandingPoliciesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) Execute() (*InlineResponse200128, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200128
func (a *BrandingPoliciesApiService) UpdateOrganizationBrandingPoliciesPrioritiesExecute(r BrandingPoliciesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) (*InlineResponse200128, *http.Response, error) {
	var (
...
func (r BrandingPoliciesApiUpdateOrganizationBrandingPolicyRequest) Execute() (*InlineResponse200127, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200127
func (a *BrandingPoliciesApiService) UpdateOrganizationBrandingPolicyExecute(r BrandingPoliciesApiUpdateOrganizationBrandingPolicyRequest) (*InlineResponse200127, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
