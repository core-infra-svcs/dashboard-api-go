...
func (r BrandingPoliciesApiGetOrganizationBrandingPoliciesRequest) Execute() ([]InlineResponse20092, *http.Response, error) {
...
func (a *BrandingPoliciesApiService) GetOrganizationBrandingPoliciesExecute(r BrandingPoliciesApiGetOrganizationBrandingPoliciesRequest) ([]InlineResponse20092, *http.Response, error) {
	var (
...
func (r BrandingPoliciesApiGetOrganizationBrandingPoliciesPrioritiesRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
func (a *BrandingPoliciesApiService) GetOrganizationBrandingPoliciesPrioritiesExecute(r BrandingPoliciesApiGetOrganizationBrandingPoliciesPrioritiesRequest) (*InlineResponse20093, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r BrandingPoliciesApiGetOrganizationBrandingPolicyRequest) Execute() (*InlineResponse20092, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20092
func (a *BrandingPoliciesApiService) GetOrganizationBrandingPolicyExecute(r BrandingPoliciesApiGetOrganizationBrandingPolicyRequest) (*InlineResponse20092, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r BrandingPoliciesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20093
func (a *BrandingPoliciesApiService) UpdateOrganizationBrandingPoliciesPrioritiesExecute(r BrandingPoliciesApiUpdateOrganizationBrandingPoliciesPrioritiesRequest) (*InlineResponse20093, *http.Response, error) {
	var (
...
func (r BrandingPoliciesApiUpdateOrganizationBrandingPolicyRequest) Execute() (*InlineResponse20092, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20092
func (a *BrandingPoliciesApiService) UpdateOrganizationBrandingPolicyExecute(r BrandingPoliciesApiUpdateOrganizationBrandingPolicyRequest) (*InlineResponse20092, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
