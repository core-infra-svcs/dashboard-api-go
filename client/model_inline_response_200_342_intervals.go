...
// InlineResponse200342Intervals struct for InlineResponse200342Intervals
type InlineResponse200342Intervals struct {
	// The start time of the query range with iso8601 format
	StartTs *string `json:"startTs,omitempty"`
	// The end time of the query range  with iso8601 format
	EndTs *string `json:"endTs,omitempty"`
	Overall *InlineResponse200342Overall `json:"overall,omitempty"`
	// The CPU usage per core of the wireless LAN controller
	ByCore []InlineResponse200342ByCore `json:"byCore,omitempty"`
}
...
func NewInlineResponse200342Intervals() *InlineResponse200342Intervals {
	this := InlineResponse200342Intervals{}
	return &this
}
...
func (o *InlineResponse200342Intervals) GetOverall() InlineResponse200342Overall {
	if o == nil || isNil(o.Overall) {
		var ret InlineResponse200342Overall
		return ret
	}
	return *o.Overall
}
...
// SetOverall gets a reference to the given InlineResponse200342Overall and assigns it to the Overall field.
...
func (o *InlineResponse200342Intervals) GetByCore() []InlineResponse200342ByCore {
	if o == nil || isNil(o.ByCore) {
		var ret []InlineResponse200342ByCore
		return ret
	}
	return o.ByCore
}
...
// SetByCore gets a reference to the given []InlineResponse200342ByCore and assigns it to the ByCore field.
func (o *InlineResponse200342Intervals) SetByCore(v []InlineResponse200342ByCore) {
	o.ByCore = v
}

func (o InlineResponse200342Intervals) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200342Intervals struct {
	value *InlineResponse200342Intervals
	isSet bool
}

func (v NullableInlineResponse200342Intervals) Get() *InlineResponse200342Intervals {
	return v.value
}

func (v *NullableInlineResponse200342Intervals) Set(val *InlineResponse200342Intervals) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200342Intervals) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200342Intervals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200342Intervals(val *InlineResponse200342Intervals) *NullableInlineResponse200342Intervals {
	return &NullableInlineResponse200342Intervals{value: val, isSet: true}
}

func (v NullableInlineResponse200342Intervals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200342Intervals) UnmarshalJSON(src []byte) error {
	v.isSet = true
