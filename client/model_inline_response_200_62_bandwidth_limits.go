...
// InlineResponse20062BandwidthLimits A hash uplink keys and their configured settings for the Appliance
type InlineResponse20062BandwidthLimits struct {
	Wan1 *InlineResponse20062BandwidthLimitsWan1 `json:"wan1,omitempty"`
	Wan2 *InlineResponse20062BandwidthLimitsWan2 `json:"wan2,omitempty"`
	Cellular *InlineResponse20062BandwidthLimitsCellular `json:"cellular,omitempty"`
}
...
func NewInlineResponse20062BandwidthLimits() *InlineResponse20062BandwidthLimits {
	this := InlineResponse20062BandwidthLimits{}
	return &this
}
...
func (o *InlineResponse20062BandwidthLimits) GetWan1() InlineResponse20062BandwidthLimitsWan1 {
	if o == nil || isNil(o.Wan1) {
		var ret InlineResponse20062BandwidthLimitsWan1
		return ret
	}
	return *o.Wan1
}
...
// SetWan1 gets a reference to the given InlineResponse20062BandwidthLimitsWan1 and assigns it to the Wan1 field.
...
func (o *InlineResponse20062BandwidthLimits) GetWan2() InlineResponse20062BandwidthLimitsWan2 {
	if o == nil || isNil(o.Wan2) {
		var ret InlineResponse20062BandwidthLimitsWan2
		return ret
	}
	return *o.Wan2
}
...
// SetWan2 gets a reference to the given InlineResponse20062BandwidthLimitsWan2 and assigns it to the Wan2 field.
...
func (o *InlineResponse20062BandwidthLimits) GetCellular() InlineResponse20062BandwidthLimitsCellular {
	if o == nil || isNil(o.Cellular) {
		var ret InlineResponse20062BandwidthLimitsCellular
		return ret
	}
	return *o.Cellular
}
...
// SetCellular gets a reference to the given InlineResponse20062BandwidthLimitsCellular and assigns it to the Cellular field.
func (o *InlineResponse20062BandwidthLimits) SetCellular(v InlineResponse20062BandwidthLimitsCellular) {
	o.Cellular = &v
}

func (o InlineResponse20062BandwidthLimits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20062BandwidthLimits struct {
	value *InlineResponse20062BandwidthLimits
	isSet bool
}

func (v NullableInlineResponse20062BandwidthLimits) Get() *InlineResponse20062BandwidthLimits {
	return v.value
}

func (v *NullableInlineResponse20062BandwidthLimits) Set(val *InlineResponse20062BandwidthLimits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20062BandwidthLimits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20062BandwidthLimits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20062BandwidthLimits(val *InlineResponse20062BandwidthLimits) *NullableInlineResponse20062BandwidthLimits {
	return &NullableInlineResponse20062BandwidthLimits{value: val, isSet: true}
}

func (v NullableInlineResponse20062BandwidthLimits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20062BandwidthLimits) UnmarshalJSON(src []byte) error {
	v.isSet = true
