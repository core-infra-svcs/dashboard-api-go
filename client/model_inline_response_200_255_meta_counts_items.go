...
// InlineResponse200255MetaCountsItems Service Providers available
type InlineResponse200255MetaCountsItems struct {
...
func NewInlineResponse200255MetaCountsItems() *InlineResponse200255MetaCountsItems {
	this := InlineResponse200255MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200255MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200255MetaCountsItems struct {
	value *InlineResponse200255MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200255MetaCountsItems) Get() *InlineResponse200255MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200255MetaCountsItems) Set(val *InlineResponse200255MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200255MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200255MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200255MetaCountsItems(val *InlineResponse200255MetaCountsItems) *NullableInlineResponse200255MetaCountsItems {
	return &NullableInlineResponse200255MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200255MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200255MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
