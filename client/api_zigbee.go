...
func (r ZigbeeApiCreateOrganizationWirelessZigbeeDisenrollmentRequest) CreateOrganizationWirelessZigbeeDisenrollment(createOrganizationWirelessZigbeeDisenrollment InlineObject319) ZigbeeApiCreateOrganizationWirelessZigbeeDisenrollmentRequest {
...
func (r ZigbeeApiGetDeviceWirelessZigbeeEnrollmentRequest) Execute() (*InlineResponse20054, *http.Response, error) {
...
func (a *ZigbeeApiService) GetDeviceWirelessZigbeeEnrollmentExecute(r ZigbeeApiGetDeviceWirelessZigbeeEnrollmentRequest) (*InlineResponse20054, *http.Response, error) {
	var (
...
func (r ZigbeeApiGetOrganizationWirelessZigbeeDevicesRequest) Execute() ([]InlineResponse200404, *http.Response, error) {
...
func (a *ZigbeeApiService) GetOrganizationWirelessZigbeeDevicesExecute(r ZigbeeApiGetOrganizationWirelessZigbeeDevicesRequest) ([]InlineResponse200404, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiGetOrganizationWirelessZigbeeDisenrollmentRequest) Execute() (*InlineResponse200405, *http.Response, error) {
...
func (a *ZigbeeApiService) GetOrganizationWirelessZigbeeDisenrollmentExecute(r ZigbeeApiGetOrganizationWirelessZigbeeDisenrollmentRequest) (*InlineResponse200405, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiGetOrganizationWirelessZigbeeDoorLocksRequest) Execute() ([]InlineResponse20054DoorLocks, *http.Response, error) {
...
func (a *ZigbeeApiService) GetOrganizationWirelessZigbeeDoorLocksExecute(r ZigbeeApiGetOrganizationWirelessZigbeeDoorLocksRequest) ([]InlineResponse20054DoorLocks, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiUpdateNetworkWirelessZigbeeRequest) UpdateNetworkWirelessZigbee(updateNetworkWirelessZigbee InlineObject211) ZigbeeApiUpdateNetworkWirelessZigbeeRequest {
...
func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest) UpdateOrganizationWirelessZigbeeDevice(updateOrganizationWirelessZigbeeDevice InlineObject318) ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest {
	r.updateOrganizationWirelessZigbeeDevice = &updateOrganizationWirelessZigbeeDevice
	return r
}

func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest) Execute() (*InlineResponse200404, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200404
func (a *ZigbeeApiService) UpdateOrganizationWirelessZigbeeDeviceExecute(r ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest) (*InlineResponse200404, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDoorLockRequest) UpdateOrganizationWirelessZigbeeDoorLock(updateOrganizationWirelessZigbeeDoorLock InlineObject320) ZigbeeApiUpdateOrganizationWirelessZigbeeDoorLockRequest {
	r.updateOrganizationWirelessZigbeeDoorLock = &updateOrganizationWirelessZigbeeDoorLock
	return r
}

func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDoorLockRequest) Execute() (*InlineResponse20054DoorLocks, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20054DoorLocks
func (a *ZigbeeApiService) UpdateOrganizationWirelessZigbeeDoorLockExecute(r ZigbeeApiUpdateOrganizationWirelessZigbeeDoorLockRequest) (*InlineResponse20054DoorLocks, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
