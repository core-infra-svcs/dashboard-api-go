...
func (r ZigbeeApiCreateOrganizationWirelessZigbeeDisenrollmentRequest) CreateOrganizationWirelessZigbeeDisenrollment(createOrganizationWirelessZigbeeDisenrollment InlineObject311) ZigbeeApiCreateOrganizationWirelessZigbeeDisenrollmentRequest {
...
func (r ZigbeeApiGetOrganizationWirelessZigbeeDevicesRequest) Execute() ([]InlineResponse200377, *http.Response, error) {
...
func (a *ZigbeeApiService) GetOrganizationWirelessZigbeeDevicesExecute(r ZigbeeApiGetOrganizationWirelessZigbeeDevicesRequest) ([]InlineResponse200377, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiGetOrganizationWirelessZigbeeDisenrollmentRequest) Execute() (*InlineResponse200378, *http.Response, error) {
...
func (a *ZigbeeApiService) GetOrganizationWirelessZigbeeDisenrollmentExecute(r ZigbeeApiGetOrganizationWirelessZigbeeDisenrollmentRequest) (*InlineResponse200378, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiUpdateNetworkWirelessZigbeeRequest) UpdateNetworkWirelessZigbee(updateNetworkWirelessZigbee InlineObject208) ZigbeeApiUpdateNetworkWirelessZigbeeRequest {
...
func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest) UpdateOrganizationWirelessZigbeeDevice(updateOrganizationWirelessZigbeeDevice InlineObject310) ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest {
	r.updateOrganizationWirelessZigbeeDevice = &updateOrganizationWirelessZigbeeDevice
	return r
}

func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest) Execute() (*InlineResponse200377, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200377
func (a *ZigbeeApiService) UpdateOrganizationWirelessZigbeeDeviceExecute(r ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest) (*InlineResponse200377, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDoorLockRequest) UpdateOrganizationWirelessZigbeeDoorLock(updateOrganizationWirelessZigbeeDoorLock InlineObject312) ZigbeeApiUpdateOrganizationWirelessZigbeeDoorLockRequest {
