...
func (r ZigbeeApiCreateOrganizationWirelessZigbeeDisenrollmentRequest) CreateOrganizationWirelessZigbeeDisenrollment(createOrganizationWirelessZigbeeDisenrollment InlineObject315) ZigbeeApiCreateOrganizationWirelessZigbeeDisenrollmentRequest {
	r.createOrganizationWirelessZigbeeDisenrollment = &createOrganizationWirelessZigbeeDisenrollment
	return r
}

func (r ZigbeeApiCreateOrganizationWirelessZigbeeDisenrollmentRequest) Execute() (*InlineResponse20125, *http.Response, error) {
...
func (a *ZigbeeApiService) CreateOrganizationWirelessZigbeeDisenrollmentExecute(r ZigbeeApiCreateOrganizationWirelessZigbeeDisenrollmentRequest) (*InlineResponse20125, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiGetOrganizationWirelessZigbeeDevicesRequest) Execute() ([]InlineResponse200388, *http.Response, error) {
...
func (a *ZigbeeApiService) GetOrganizationWirelessZigbeeDevicesExecute(r ZigbeeApiGetOrganizationWirelessZigbeeDevicesRequest) ([]InlineResponse200388, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiGetOrganizationWirelessZigbeeDisenrollmentRequest) Execute() (*InlineResponse200389, *http.Response, error) {
...
func (a *ZigbeeApiService) GetOrganizationWirelessZigbeeDisenrollmentExecute(r ZigbeeApiGetOrganizationWirelessZigbeeDisenrollmentRequest) (*InlineResponse200389, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest) UpdateOrganizationWirelessZigbeeDevice(updateOrganizationWirelessZigbeeDevice InlineObject314) ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest {
	r.updateOrganizationWirelessZigbeeDevice = &updateOrganizationWirelessZigbeeDevice
	return r
}

func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest) Execute() (*InlineResponse200388, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200388
func (a *ZigbeeApiService) UpdateOrganizationWirelessZigbeeDeviceExecute(r ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest) (*InlineResponse200388, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDoorLockRequest) UpdateOrganizationWirelessZigbeeDoorLock(updateOrganizationWirelessZigbeeDoorLock InlineObject316) ZigbeeApiUpdateOrganizationWirelessZigbeeDoorLockRequest {
