...
func (r ZigbeeApiCreateOrganizationWirelessZigbeeDisenrollmentRequest) CreateOrganizationWirelessZigbeeDisenrollment(createOrganizationWirelessZigbeeDisenrollment InlineObject310) ZigbeeApiCreateOrganizationWirelessZigbeeDisenrollmentRequest {
...
func (r ZigbeeApiGetOrganizationWirelessZigbeeDevicesRequest) Execute() ([]InlineResponse200376, *http.Response, error) {
...
func (a *ZigbeeApiService) GetOrganizationWirelessZigbeeDevicesExecute(r ZigbeeApiGetOrganizationWirelessZigbeeDevicesRequest) ([]InlineResponse200376, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiGetOrganizationWirelessZigbeeDisenrollmentRequest) Execute() (*InlineResponse200377, *http.Response, error) {
...
func (a *ZigbeeApiService) GetOrganizationWirelessZigbeeDisenrollmentExecute(r ZigbeeApiGetOrganizationWirelessZigbeeDisenrollmentRequest) (*InlineResponse200377, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest) UpdateOrganizationWirelessZigbeeDevice(updateOrganizationWirelessZigbeeDevice InlineObject309) ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest {
	r.updateOrganizationWirelessZigbeeDevice = &updateOrganizationWirelessZigbeeDevice
	return r
}

func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest) Execute() (*InlineResponse200376, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200376
func (a *ZigbeeApiService) UpdateOrganizationWirelessZigbeeDeviceExecute(r ZigbeeApiUpdateOrganizationWirelessZigbeeDeviceRequest) (*InlineResponse200376, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ZigbeeApiUpdateOrganizationWirelessZigbeeDoorLockRequest) UpdateOrganizationWirelessZigbeeDoorLock(updateOrganizationWirelessZigbeeDoorLock InlineObject311) ZigbeeApiUpdateOrganizationWirelessZigbeeDoorLockRequest {
