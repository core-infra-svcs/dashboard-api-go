...
func (r ContentFilteringApiGetNetworkApplianceContentFilteringRequest) Execute() (*InlineResponse20054, *http.Response, error) {
...
func (a *ContentFilteringApiService) GetNetworkApplianceContentFilteringExecute(r ContentFilteringApiGetNetworkApplianceContentFilteringRequest) (*InlineResponse20054, *http.Response, error) {
	var (
...
func (r ContentFilteringApiUpdateNetworkApplianceContentFilteringRequest) Execute() (*InlineResponse20054, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20054
func (a *ContentFilteringApiService) UpdateNetworkApplianceContentFilteringExecute(r ContentFilteringApiUpdateNetworkApplianceContentFilteringRequest) (*InlineResponse20054, *http.Response, error) {
	var (
