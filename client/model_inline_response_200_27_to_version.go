...
// InlineResponse20027ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20027ToVersion struct {
...
func NewInlineResponse20027ToVersion() *InlineResponse20027ToVersion {
	this := InlineResponse20027ToVersion{}
	return &this
}
...
func (o InlineResponse20027ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20027ToVersion struct {
	value *InlineResponse20027ToVersion
	isSet bool
}

func (v NullableInlineResponse20027ToVersion) Get() *InlineResponse20027ToVersion {
	return v.value
}

func (v *NullableInlineResponse20027ToVersion) Set(val *InlineResponse20027ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20027ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20027ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20027ToVersion(val *InlineResponse20027ToVersion) *NullableInlineResponse20027ToVersion {
	return &NullableInlineResponse20027ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20027ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20027ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
