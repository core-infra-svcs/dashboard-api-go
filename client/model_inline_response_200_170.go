...
type InlineResponse200170 struct {
	VlanProfile *InlineResponse200170VlanProfile `json:"vlanProfile,omitempty"`
...
func (o *InlineResponse200170) GetVlanProfile() InlineResponse200170VlanProfile {
	if o == nil || isNil(o.VlanProfile) {
		var ret InlineResponse200170VlanProfile
		return ret
	}
...
// SetVlanProfile gets a reference to the given InlineResponse200170VlanProfile and assigns it to the VlanProfile field.
