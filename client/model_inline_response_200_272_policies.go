...
// InlineResponse200272Policies struct for InlineResponse200272Policies
type InlineResponse200272Policies struct {
...
func NewInlineResponse200272Policies() *InlineResponse200272Policies {
	this := InlineResponse200272Policies{}
	return &this
}
...
func (o InlineResponse200272Policies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200272Policies struct {
	value *InlineResponse200272Policies
	isSet bool
}

func (v NullableInlineResponse200272Policies) Get() *InlineResponse200272Policies {
	return v.value
}

func (v *NullableInlineResponse200272Policies) Set(val *InlineResponse200272Policies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200272Policies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200272Policies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200272Policies(val *InlineResponse200272Policies) *NullableInlineResponse200272Policies {
	return &NullableInlineResponse200272Policies{value: val, isSet: true}
}

func (v NullableInlineResponse200272Policies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200272Policies) UnmarshalJSON(src []byte) error {
	v.isSet = true
