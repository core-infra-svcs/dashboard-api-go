...
type InlineResponse200215 struct {
	Counts *InlineResponse200215Counts `json:"counts,omitempty"`
	Limits *InlineResponse200215Limits `json:"limits,omitempty"`
}
...
// SetCounts gets a reference to the given InlineResponse200215Counts and assigns it to the Counts field.
...
func (o *InlineResponse200215) GetLimits() InlineResponse200215Limits {
	if o == nil || isNil(o.Limits) {
		var ret InlineResponse200215Limits
		return ret
	}
	return *o.Limits
}
...
// SetLimits gets a reference to the given InlineResponse200215Limits and assigns it to the Limits field.
