...
func (o *InlineResponse200215) GetTenantId() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200215) GetTenantIdOk() (*string, bool) {
	if o == nil || isNil(o.TenantId) {
    return nil, false
	}
...
func (o *InlineResponse200215) HasTenantId() bool {
	if o != nil && !isNil(o.TenantId) {
		return true
	}
...
func (o *InlineResponse200215) SetTenantId(v string) {
	o.TenantId = &v
}
