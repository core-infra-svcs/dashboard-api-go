...
// InlineResponse200335Interfaces struct for InlineResponse200335Interfaces
type InlineResponse200335Interfaces struct {
	...
	Addresses []InlineResponse200335Addresses `json:"addresses,omitempty"`
	Vrf *InlineResponse200335Vrf `json:"vrf,omitempty"`
...
func NewInlineResponse200335Interfaces() *InlineResponse200335Interfaces {
	this := InlineResponse200335Interfaces{}
	return &this
}
...
func (o *InlineResponse200335Interfaces) GetAddresses() []InlineResponse200335Addresses {
	if o == nil || isNil(o.Addresses) {
		var ret []InlineResponse200335Addresses
		return ret
	}
	return o.Addresses
}
...
// SetAddresses gets a reference to the given []InlineResponse200335Addresses and assigns it to the Addresses field.
...
func (o *InlineResponse200335Interfaces) GetVrf() InlineResponse200335Vrf {
	if o == nil || isNil(o.Vrf) {
		var ret InlineResponse200335Vrf
		return ret
	}
	return *o.Vrf
}
...
// SetVrf gets a reference to the given InlineResponse200335Vrf and assigns it to the Vrf field.
...
func (o InlineResponse200335Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200335Interfaces struct {
	value *InlineResponse200335Interfaces
	isSet bool
}

func (v NullableInlineResponse200335Interfaces) Get() *InlineResponse200335Interfaces {
	return v.value
}

func (v *NullableInlineResponse200335Interfaces) Set(val *InlineResponse200335Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200335Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200335Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200335Interfaces(val *InlineResponse200335Interfaces) *NullableInlineResponse200335Interfaces {
	return &NullableInlineResponse200335Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200335Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200335Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
