...
// InlineResponse200181ResultingNetwork Network after the combination
type InlineResponse200181ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200181ResultingNetwork() *InlineResponse200181ResultingNetwork {
	this := InlineResponse200181ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200181ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200181ResultingNetwork struct {
	value *InlineResponse200181ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200181ResultingNetwork) Get() *InlineResponse200181ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200181ResultingNetwork) Set(val *InlineResponse200181ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200181ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200181ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200181ResultingNetwork(val *InlineResponse200181ResultingNetwork) *NullableInlineResponse200181ResultingNetwork {
	return &NullableInlineResponse200181ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200181ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200181ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
