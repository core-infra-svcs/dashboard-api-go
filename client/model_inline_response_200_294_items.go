...
// InlineResponse200294Items struct for InlineResponse200294Items
type InlineResponse200294Items struct {
	...
	Used *InlineResponse200294Used `json:"used,omitempty"`
	Free *InlineResponse200294Free `json:"free,omitempty"`
	...
	Intervals []InlineResponse200294Intervals `json:"intervals,omitempty"`
}
...
func NewInlineResponse200294Items() *InlineResponse200294Items {
	this := InlineResponse200294Items{}
	return &this
}
...
func (o *InlineResponse200294Items) GetUsed() InlineResponse200294Used {
	if o == nil || isNil(o.Used) {
		var ret InlineResponse200294Used
		return ret
	}
	return *o.Used
}
...
// SetUsed gets a reference to the given InlineResponse200294Used and assigns it to the Used field.
...
func (o *InlineResponse200294Items) GetFree() InlineResponse200294Free {
	if o == nil || isNil(o.Free) {
		var ret InlineResponse200294Free
		return ret
	}
	return *o.Free
}
...
// SetFree gets a reference to the given InlineResponse200294Free and assigns it to the Free field.
...
func (o *InlineResponse200294Items) GetIntervals() []InlineResponse200294Intervals {
	if o == nil || isNil(o.Intervals) {
		var ret []InlineResponse200294Intervals
		return ret
	}
	return o.Intervals
}
...
// SetIntervals gets a reference to the given []InlineResponse200294Intervals and assigns it to the Intervals field.
func (o *InlineResponse200294Items) SetIntervals(v []InlineResponse200294Intervals) {
	o.Intervals = v
}

func (o InlineResponse200294Items) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200294Items struct {
	value *InlineResponse200294Items
	isSet bool
}

func (v NullableInlineResponse200294Items) Get() *InlineResponse200294Items {
	return v.value
}

func (v *NullableInlineResponse200294Items) Set(val *InlineResponse200294Items) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200294Items) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200294Items) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200294Items(val *InlineResponse200294Items) *NullableInlineResponse200294Items {
	return &NullableInlineResponse200294Items{value: val, isSet: true}
}

func (v NullableInlineResponse200294Items) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200294Items) UnmarshalJSON(src []byte) error {
	v.isSet = true
