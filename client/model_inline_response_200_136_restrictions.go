...
// InlineResponse200136Restrictions struct for InlineResponse200136Restrictions
type InlineResponse200136Restrictions struct {
...
func NewInlineResponse200136Restrictions() *InlineResponse200136Restrictions {
	this := InlineResponse200136Restrictions{}
	return &this
}
...
func (o InlineResponse200136Restrictions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200136Restrictions struct {
	value *InlineResponse200136Restrictions
	isSet bool
}

func (v NullableInlineResponse200136Restrictions) Get() *InlineResponse200136Restrictions {
	return v.value
}

func (v *NullableInlineResponse200136Restrictions) Set(val *InlineResponse200136Restrictions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200136Restrictions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200136Restrictions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200136Restrictions(val *InlineResponse200136Restrictions) *NullableInlineResponse200136Restrictions {
	return &NullableInlineResponse200136Restrictions{value: val, isSet: true}
}

func (v NullableInlineResponse200136Restrictions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200136Restrictions) UnmarshalJSON(src []byte) error {
	v.isSet = true
