...
// InlineResponse200362Tags struct for InlineResponse200362Tags
type InlineResponse200362Tags struct {
	// Policy tag
...
func (o InlineResponse200362Tags) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200362Tags struct {
	value *InlineResponse200362Tags
	isSet bool
}

func (v NullableInlineResponse200362Tags) Get() *InlineResponse200362Tags {
	return v.value
}

func (v *NullableInlineResponse200362Tags) Set(val *InlineResponse200362Tags) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200362Tags) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200362Tags) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200362Tags(val *InlineResponse200362Tags) *NullableInlineResponse200362Tags {
	return &NullableInlineResponse200362Tags{value: val, isSet: true}
}

func (v NullableInlineResponse200362Tags) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200362Tags) UnmarshalJSON(src []byte) error {
	v.isSet = true
