...
// InlineResponse200356Interfaces struct for InlineResponse200356Interfaces
type InlineResponse200356Interfaces struct {
...
func NewInlineResponse200356Interfaces() *InlineResponse200356Interfaces {
	this := InlineResponse200356Interfaces{}
	return &this
}
...
func (o InlineResponse200356Interfaces) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200356Interfaces struct {
	value *InlineResponse200356Interfaces
	isSet bool
}

func (v NullableInlineResponse200356Interfaces) Get() *InlineResponse200356Interfaces {
	return v.value
}

func (v *NullableInlineResponse200356Interfaces) Set(val *InlineResponse200356Interfaces) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200356Interfaces) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200356Interfaces) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200356Interfaces(val *InlineResponse200356Interfaces) *NullableInlineResponse200356Interfaces {
	return &NullableInlineResponse200356Interfaces{value: val, isSet: true}
}

func (v NullableInlineResponse200356Interfaces) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200356Interfaces) UnmarshalJSON(src []byte) error {
	v.isSet = true
