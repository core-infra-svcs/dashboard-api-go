...
// InlineResponse200198Limits The current limits of various adaptive policy objects.
type InlineResponse200198Limits struct {
...
func NewInlineResponse200198Limits() *InlineResponse200198Limits {
	this := InlineResponse200198Limits{}
	return &this
}
...
func (o InlineResponse200198Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200198Limits struct {
	value *InlineResponse200198Limits
	isSet bool
}

func (v NullableInlineResponse200198Limits) Get() *InlineResponse200198Limits {
	return v.value
}

func (v *NullableInlineResponse200198Limits) Set(val *InlineResponse200198Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200198Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200198Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200198Limits(val *InlineResponse200198Limits) *NullableInlineResponse200198Limits {
	return &NullableInlineResponse200198Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200198Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200198Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
