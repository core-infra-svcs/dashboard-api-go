...
// InlineResponse20095TwoFourGhzSettings Settings related to 2.4Ghz band
type InlineResponse20095TwoFourGhzSettings struct {
...
func NewInlineResponse20095TwoFourGhzSettings() *InlineResponse20095TwoFourGhzSettings {
	this := InlineResponse20095TwoFourGhzSettings{}
	return &this
}
...
func (o InlineResponse20095TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20095TwoFourGhzSettings struct {
	value *InlineResponse20095TwoFourGhzSettings
	isSet bool
}

func (v NullableInlineResponse20095TwoFourGhzSettings) Get() *InlineResponse20095TwoFourGhzSettings {
	return v.value
}

func (v *NullableInlineResponse20095TwoFourGhzSettings) Set(val *InlineResponse20095TwoFourGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20095TwoFourGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20095TwoFourGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20095TwoFourGhzSettings(val *InlineResponse20095TwoFourGhzSettings) *NullableInlineResponse20095TwoFourGhzSettings {
	return &NullableInlineResponse20095TwoFourGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20095TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20095TwoFourGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
