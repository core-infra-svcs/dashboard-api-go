...
func (r NetworkAdaptersApiApiGetNetworkSmDeviceNetworkAdaptersRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *NetworkAdaptersApiService) GetNetworkSmDeviceNetworkAdapters(ctx context.Context, networkId string, deviceId string) NetworkAdaptersApiApiGetNetworkSmDeviceNetworkAdaptersRequest {
	return NetworkAdaptersApiApiGetNetworkSmDeviceNetworkAdaptersRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *NetworkAdaptersApiService) GetNetworkSmDeviceNetworkAdaptersExecute(r NetworkAdaptersApiApiGetNetworkSmDeviceNetworkAdaptersRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
