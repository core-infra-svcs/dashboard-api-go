...
func (r NetworkAdaptersApiGetNetworkSmDeviceNetworkAdaptersRequest) Execute() ([]InlineResponse200136, *http.Response, error) {
...
func (a *NetworkAdaptersApiService) GetNetworkSmDeviceNetworkAdaptersExecute(r NetworkAdaptersApiGetNetworkSmDeviceNetworkAdaptersRequest) ([]InlineResponse200136, *http.Response, error) {
	var (
