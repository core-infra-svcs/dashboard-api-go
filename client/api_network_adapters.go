...
func (r NetworkAdaptersApiGetNetworkSmDeviceNetworkAdaptersRequest) Execute() ([]InlineResponse200130, *http.Response, error) {
...
func (a *NetworkAdaptersApiService) GetNetworkSmDeviceNetworkAdaptersExecute(r NetworkAdaptersApiGetNetworkSmDeviceNetworkAdaptersRequest) ([]InlineResponse200130, *http.Response, error) {
	var (
