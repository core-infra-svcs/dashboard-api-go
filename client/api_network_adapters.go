...
func (r NetworkAdaptersApiApiGetNetworkSmDeviceNetworkAdaptersRequest) Execute() ([]map[string]interface{}, *_nethttp.Response, error) {
...
func (a *NetworkAdaptersApiService) GetNetworkSmDeviceNetworkAdaptersExecute(r NetworkAdaptersApiApiGetNetworkSmDeviceNetworkAdaptersRequest) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
