...
func (r NetworkAdaptersApiGetNetworkSmDeviceNetworkAdaptersRequest) Execute() ([]InlineResponse200129, *http.Response, error) {
...
func (a *NetworkAdaptersApiService) GetNetworkSmDeviceNetworkAdaptersExecute(r NetworkAdaptersApiGetNetworkSmDeviceNetworkAdaptersRequest) ([]InlineResponse200129, *http.Response, error) {
	var (
