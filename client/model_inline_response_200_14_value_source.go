...
// InlineResponse20014ValueSource Source of 'custom' type traffic filter
type InlineResponse20014ValueSource struct {
...
func NewInlineResponse20014ValueSource() *InlineResponse20014ValueSource {
	this := InlineResponse20014ValueSource{}
	return &this
}
...
func (o InlineResponse20014ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20014ValueSource struct {
	value *InlineResponse20014ValueSource
	isSet bool
}

func (v NullableInlineResponse20014ValueSource) Get() *InlineResponse20014ValueSource {
	return v.value
}

func (v *NullableInlineResponse20014ValueSource) Set(val *InlineResponse20014ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20014ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20014ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20014ValueSource(val *InlineResponse20014ValueSource) *NullableInlineResponse20014ValueSource {
	return &NullableInlineResponse20014ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20014ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20014ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
