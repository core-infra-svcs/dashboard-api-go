...
type InlineResponse200121 struct {
	Counts *InlineResponse200121Counts `json:"counts,omitempty"`
	Limits *InlineResponse200121Limits `json:"limits,omitempty"`
}
...
func (o *InlineResponse200121) GetCounts() InlineResponse200121Counts {
	if o == nil || isNil(o.Counts) {
		var ret InlineResponse200121Counts
		return ret
	}
	return *o.Counts
}
...
// SetCounts gets a reference to the given InlineResponse200121Counts and assigns it to the Counts field.
...
func (o *InlineResponse200121) GetLimits() InlineResponse200121Limits {
	if o == nil || isNil(o.Limits) {
		var ret InlineResponse200121Limits
		return ret
	}
	return *o.Limits
}
...
// SetLimits gets a reference to the given InlineResponse200121Limits and assigns it to the Limits field.
