...
// InlineResponse20097ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20097ToVersion struct {
...
func NewInlineResponse20097ToVersion() *InlineResponse20097ToVersion {
	this := InlineResponse20097ToVersion{}
	return &this
}
...
func (o InlineResponse20097ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20097ToVersion struct {
	value *InlineResponse20097ToVersion
	isSet bool
}

func (v NullableInlineResponse20097ToVersion) Get() *InlineResponse20097ToVersion {
	return v.value
}

func (v *NullableInlineResponse20097ToVersion) Set(val *InlineResponse20097ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20097ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20097ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20097ToVersion(val *InlineResponse20097ToVersion) *NullableInlineResponse20097ToVersion {
	return &NullableInlineResponse20097ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20097ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20097ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
