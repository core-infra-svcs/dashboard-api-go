...
// OrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork Network information
type OrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork struct {
	// Network id
...
func NewOrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork() *OrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork {
	this := OrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork{}
	return &this
}
...
func (o OrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork) MarshalJSON() ([]byte, error) {
...
type NullableOrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork struct {
	value *OrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork
	isSet bool
}

func (v NullableOrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork) Get() *OrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork {
	return v.value
}

func (v *NullableOrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork) Set(val *OrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork(val *OrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork) *NullableOrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork {
	return &NullableOrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork{value: val, isSet: true}
}

func (v NullableOrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationsOrganizationIdDevicesAvailabilitiesChangeHistoryNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
