...
// APIClient manages communication with the Meraki Dashboard API API v1.44.0
...
type APIClient struct {
	...
	VlansEnabledStateApi *VlansEnabledStateApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.VlansEnabledStateApi = (*VlansEnabledStateApiService)(&c.common)
