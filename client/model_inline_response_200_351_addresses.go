...
// InlineResponse200351Addresses struct for InlineResponse200351Addresses
type InlineResponse200351Addresses struct {
...
func NewInlineResponse200351Addresses() *InlineResponse200351Addresses {
	this := InlineResponse200351Addresses{}
	return &this
}
...
func (o InlineResponse200351Addresses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200351Addresses struct {
	value *InlineResponse200351Addresses
	isSet bool
}

func (v NullableInlineResponse200351Addresses) Get() *InlineResponse200351Addresses {
	return v.value
}

func (v *NullableInlineResponse200351Addresses) Set(val *InlineResponse200351Addresses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200351Addresses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200351Addresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200351Addresses(val *InlineResponse200351Addresses) *NullableInlineResponse200351Addresses {
	return &NullableInlineResponse200351Addresses{value: val, isSet: true}
}

func (v NullableInlineResponse200351Addresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200351Addresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
