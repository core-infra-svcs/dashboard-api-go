...
// InlineResponse200160ResultingNetwork Network after the combination
type InlineResponse200160ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200160ResultingNetwork() *InlineResponse200160ResultingNetwork {
	this := InlineResponse200160ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200160ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200160ResultingNetwork struct {
	value *InlineResponse200160ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200160ResultingNetwork) Get() *InlineResponse200160ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200160ResultingNetwork) Set(val *InlineResponse200160ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200160ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200160ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200160ResultingNetwork(val *InlineResponse200160ResultingNetwork) *NullableInlineResponse200160ResultingNetwork {
	return &NullableInlineResponse200160ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200160ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200160ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
