...
// InlineResponse20085SelfRegistration Self-registration for splash with Meraki authentication.
type InlineResponse20085SelfRegistration struct {
...
func NewInlineResponse20085SelfRegistration() *InlineResponse20085SelfRegistration {
	this := InlineResponse20085SelfRegistration{}
	return &this
}
...
func (o InlineResponse20085SelfRegistration) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20085SelfRegistration struct {
	value *InlineResponse20085SelfRegistration
	isSet bool
}

func (v NullableInlineResponse20085SelfRegistration) Get() *InlineResponse20085SelfRegistration {
	return v.value
}

func (v *NullableInlineResponse20085SelfRegistration) Set(val *InlineResponse20085SelfRegistration) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20085SelfRegistration) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20085SelfRegistration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20085SelfRegistration(val *InlineResponse20085SelfRegistration) *NullableInlineResponse20085SelfRegistration {
	return &NullableInlineResponse20085SelfRegistration{value: val, isSet: true}
}

func (v NullableInlineResponse20085SelfRegistration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20085SelfRegistration) UnmarshalJSON(src []byte) error {
	v.isSet = true
