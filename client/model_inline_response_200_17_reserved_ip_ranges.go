...
// InlineResponse20017ReservedIpRanges struct for InlineResponse20017ReservedIpRanges
type InlineResponse20017ReservedIpRanges struct {
...
func NewInlineResponse20017ReservedIpRanges() *InlineResponse20017ReservedIpRanges {
	this := InlineResponse20017ReservedIpRanges{}
	return &this
}
...
func (o InlineResponse20017ReservedIpRanges) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20017ReservedIpRanges struct {
	value *InlineResponse20017ReservedIpRanges
	isSet bool
}

func (v NullableInlineResponse20017ReservedIpRanges) Get() *InlineResponse20017ReservedIpRanges {
	return v.value
}

func (v *NullableInlineResponse20017ReservedIpRanges) Set(val *InlineResponse20017ReservedIpRanges) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20017ReservedIpRanges) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20017ReservedIpRanges) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20017ReservedIpRanges(val *InlineResponse20017ReservedIpRanges) *NullableInlineResponse20017ReservedIpRanges {
	return &NullableInlineResponse20017ReservedIpRanges{value: val, isSet: true}
}

func (v NullableInlineResponse20017ReservedIpRanges) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20017ReservedIpRanges) UnmarshalJSON(src []byte) error {
	v.isSet = true
