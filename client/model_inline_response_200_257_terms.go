...
// InlineResponse200257Terms Service provider terms.
type InlineResponse200257Terms struct {
...
func NewInlineResponse200257Terms() *InlineResponse200257Terms {
	this := InlineResponse200257Terms{}
	return &this
}
...
func (o InlineResponse200257Terms) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200257Terms struct {
	value *InlineResponse200257Terms
	isSet bool
}

func (v NullableInlineResponse200257Terms) Get() *InlineResponse200257Terms {
	return v.value
}

func (v *NullableInlineResponse200257Terms) Set(val *InlineResponse200257Terms) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200257Terms) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200257Terms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200257Terms(val *InlineResponse200257Terms) *NullableInlineResponse200257Terms {
	return &NullableInlineResponse200257Terms{value: val, isSet: true}
}

func (v NullableInlineResponse200257Terms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200257Terms) UnmarshalJSON(src []byte) error {
	v.isSet = true
