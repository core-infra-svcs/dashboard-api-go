...
// InlineResponse20033Custom struct for InlineResponse20033Custom
type InlineResponse20033Custom struct {
	// Protocol.
...
func NewInlineResponse20033Custom(protocol string, destination string, port string) *InlineResponse20033Custom {
	this := InlineResponse20033Custom{}
...
func (o InlineResponse20033Custom) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20033Custom struct {
	value *InlineResponse20033Custom
	isSet bool
}

func (v NullableInlineResponse20033Custom) Get() *InlineResponse20033Custom {
	return v.value
}

func (v *NullableInlineResponse20033Custom) Set(val *InlineResponse20033Custom) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20033Custom) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20033Custom) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20033Custom(val *InlineResponse20033Custom) *NullableInlineResponse20033Custom {
	return &NullableInlineResponse20033Custom{value: val, isSet: true}
}

func (v NullableInlineResponse20033Custom) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20033Custom) UnmarshalJSON(src []byte) error {
	v.isSet = true
