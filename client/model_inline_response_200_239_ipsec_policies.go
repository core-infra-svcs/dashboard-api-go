...
// InlineResponse200239IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse200239IpsecPolicies struct {
...
func NewInlineResponse200239IpsecPolicies() *InlineResponse200239IpsecPolicies {
	this := InlineResponse200239IpsecPolicies{}
	return &this
}
...
func (o InlineResponse200239IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200239IpsecPolicies struct {
	value *InlineResponse200239IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse200239IpsecPolicies) Get() *InlineResponse200239IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse200239IpsecPolicies) Set(val *InlineResponse200239IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200239IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200239IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200239IpsecPolicies(val *InlineResponse200239IpsecPolicies) *NullableInlineResponse200239IpsecPolicies {
	return &NullableInlineResponse200239IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse200239IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200239IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
