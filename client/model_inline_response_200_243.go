...
type InlineResponse200243 struct {
	...
	LimitScopeToNetworks []InlineResponse200243LimitScopeToNetworks `json:"limitScopeToNetworks,omitempty"`
	OptOutEligibility *InlineResponse200243OptOutEligibility `json:"optOutEligibility,omitempty"`
...
func (o *InlineResponse200243) GetLimitScopeToNetworks() []InlineResponse200243LimitScopeToNetworks {
	if o == nil || isNil(o.LimitScopeToNetworks) {
		var ret []InlineResponse200243LimitScopeToNetworks
		return ret
	}
...
// SetLimitScopeToNetworks gets a reference to the given []InlineResponse200243LimitScopeToNetworks and assigns it to the LimitScopeToNetworks field.
...
func (o *InlineResponse200243) GetOptOutEligibility() InlineResponse200243OptOutEligibility {
	if o == nil || isNil(o.OptOutEligibility) {
		var ret InlineResponse200243OptOutEligibility
		return ret
	}
...
// SetOptOutEligibility gets a reference to the given InlineResponse200243OptOutEligibility and assigns it to the OptOutEligibility field.
