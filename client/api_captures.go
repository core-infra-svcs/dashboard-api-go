...
func (r CapturesApiCreateOrganizationDevicesPacketCaptureCaptureRequest) Execute() (*InlineResponse200274Items, *http.Response, error) {
...
func (a *CapturesApiService) CreateOrganizationDevicesPacketCaptureCaptureExecute(r CapturesApiCreateOrganizationDevicesPacketCaptureCaptureRequest) (*InlineResponse200274Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CapturesApiGenerateOrganizationDevicesPacketCaptureCaptureDownloadUrlRequest) Execute() (*InlineResponse200275, *http.Response, error) {
...
func (a *CapturesApiService) GenerateOrganizationDevicesPacketCaptureCaptureDownloadUrlExecute(r CapturesApiGenerateOrganizationDevicesPacketCaptureCaptureDownloadUrlRequest) (*InlineResponse200275, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CapturesApiGetOrganizationDevicesPacketCaptureCapturesRequest) Execute() (*InlineResponse200274, *http.Response, error) {
...
func (a *CapturesApiService) GetOrganizationDevicesPacketCaptureCapturesExecute(r CapturesApiGetOrganizationDevicesPacketCaptureCapturesRequest) (*InlineResponse200274, *http.Response, error) {
	var (
...
func (r CapturesApiStopOrganizationDevicesPacketCaptureCaptureRequest) Execute() (*InlineResponse200274Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200274Items
func (a *CapturesApiService) StopOrganizationDevicesPacketCaptureCaptureExecute(r CapturesApiStopOrganizationDevicesPacketCaptureCaptureRequest) (*InlineResponse200274Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
