...
func (r CapturesApiCreateOrganizationDevicesPacketCaptureCaptureRequest) Execute() (*InlineResponse200286Items, *http.Response, error) {
...
func (a *CapturesApiService) CreateOrganizationDevicesPacketCaptureCaptureExecute(r CapturesApiCreateOrganizationDevicesPacketCaptureCaptureRequest) (*InlineResponse200286Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CapturesApiGenerateOrganizationDevicesPacketCaptureCaptureDownloadUrlRequest) Execute() (*InlineResponse200287, *http.Response, error) {
...
func (a *CapturesApiService) GenerateOrganizationDevicesPacketCaptureCaptureDownloadUrlExecute(r CapturesApiGenerateOrganizationDevicesPacketCaptureCaptureDownloadUrlRequest) (*InlineResponse200287, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CapturesApiGetOrganizationDevicesPacketCaptureCapturesRequest) Execute() (*InlineResponse200286, *http.Response, error) {
...
func (a *CapturesApiService) GetOrganizationDevicesPacketCaptureCapturesExecute(r CapturesApiGetOrganizationDevicesPacketCaptureCapturesRequest) (*InlineResponse200286, *http.Response, error) {
	var (
...
func (r CapturesApiStopOrganizationDevicesPacketCaptureCaptureRequest) Execute() (*InlineResponse200286Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200286Items
func (a *CapturesApiService) StopOrganizationDevicesPacketCaptureCaptureExecute(r CapturesApiStopOrganizationDevicesPacketCaptureCaptureRequest) (*InlineResponse200286Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
