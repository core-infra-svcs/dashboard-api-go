...
func (r CapturesApiBulkOrganizationDevicesPacketCaptureCapturesCreateRequest) BulkOrganizationDevicesPacketCaptureCapturesCreate(bulkOrganizationDevicesPacketCaptureCapturesCreate InlineObject260) CapturesApiBulkOrganizationDevicesPacketCaptureCapturesCreateRequest {
...
func (r CapturesApiBulkOrganizationDevicesPacketCaptureCapturesDeleteRequest) BulkOrganizationDevicesPacketCaptureCapturesDelete(bulkOrganizationDevicesPacketCaptureCapturesDelete InlineObject261) CapturesApiBulkOrganizationDevicesPacketCaptureCapturesDeleteRequest {
...
func (r CapturesApiCreateOrganizationDevicesPacketCaptureCaptureRequest) CreateOrganizationDevicesPacketCaptureCapture(createOrganizationDevicesPacketCaptureCapture InlineObject259) CapturesApiCreateOrganizationDevicesPacketCaptureCaptureRequest {
	r.createOrganizationDevicesPacketCaptureCapture = &createOrganizationDevicesPacketCaptureCapture
	return r
}

func (r CapturesApiCreateOrganizationDevicesPacketCaptureCaptureRequest) Execute() (*InlineResponse200279Items, *http.Response, error) {
...
func (a *CapturesApiService) CreateOrganizationDevicesPacketCaptureCaptureExecute(r CapturesApiCreateOrganizationDevicesPacketCaptureCaptureRequest) (*InlineResponse200279Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CapturesApiGenerateOrganizationDevicesPacketCaptureCaptureDownloadUrlRequest) Execute() (*InlineResponse200280, *http.Response, error) {
...
func (a *CapturesApiService) GenerateOrganizationDevicesPacketCaptureCaptureDownloadUrlExecute(r CapturesApiGenerateOrganizationDevicesPacketCaptureCaptureDownloadUrlRequest) (*InlineResponse200280, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CapturesApiGetOrganizationDevicesPacketCaptureCapturesRequest) Execute() (*InlineResponse200279, *http.Response, error) {
...
func (a *CapturesApiService) GetOrganizationDevicesPacketCaptureCapturesExecute(r CapturesApiGetOrganizationDevicesPacketCaptureCapturesRequest) (*InlineResponse200279, *http.Response, error) {
	var (
...
func (r CapturesApiStopOrganizationDevicesPacketCaptureCaptureRequest) StopOrganizationDevicesPacketCaptureCapture(stopOrganizationDevicesPacketCaptureCapture InlineObject262) CapturesApiStopOrganizationDevicesPacketCaptureCaptureRequest {
	r.stopOrganizationDevicesPacketCaptureCapture = &stopOrganizationDevicesPacketCaptureCapture
	return r
}

func (r CapturesApiStopOrganizationDevicesPacketCaptureCaptureRequest) Execute() (*InlineResponse200279Items, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200279Items
func (a *CapturesApiService) StopOrganizationDevicesPacketCaptureCaptureExecute(r CapturesApiStopOrganizationDevicesPacketCaptureCaptureRequest) (*InlineResponse200279Items, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
