...
type OrganizationsOrganizationIdWirelessDevicesEthernetStatusesLinkNegotiation struct {
	// The duplex mode of the port. Can be 'full' or 'half' will return null on Catalyst devices
	Duplex *string `json:"duplex,omitempty"`
	// Show the speed of the port. The port speed will return null on Catalyst devices
