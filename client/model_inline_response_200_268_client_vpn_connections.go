...
// InlineResponse200268ClientVpnConnections struct for InlineResponse200268ClientVpnConnections
type InlineResponse200268ClientVpnConnections struct {
...
func NewInlineResponse200268ClientVpnConnections() *InlineResponse200268ClientVpnConnections {
	this := InlineResponse200268ClientVpnConnections{}
	return &this
}
...
func (o InlineResponse200268ClientVpnConnections) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200268ClientVpnConnections struct {
	value *InlineResponse200268ClientVpnConnections
	isSet bool
}

func (v NullableInlineResponse200268ClientVpnConnections) Get() *InlineResponse200268ClientVpnConnections {
	return v.value
}

func (v *NullableInlineResponse200268ClientVpnConnections) Set(val *InlineResponse200268ClientVpnConnections) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200268ClientVpnConnections) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200268ClientVpnConnections) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200268ClientVpnConnections(val *InlineResponse200268ClientVpnConnections) *NullableInlineResponse200268ClientVpnConnections {
	return &NullableInlineResponse200268ClientVpnConnections{value: val, isSet: true}
}

func (v NullableInlineResponse200268ClientVpnConnections) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200268ClientVpnConnections) UnmarshalJSON(src []byte) error {
	v.isSet = true
