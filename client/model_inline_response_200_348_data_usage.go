...
// InlineResponse200348DataUsage Usage data for the given interval.
type InlineResponse200348DataUsage struct {
...
func NewInlineResponse200348DataUsage() *InlineResponse200348DataUsage {
	this := InlineResponse200348DataUsage{}
	return &this
}
...
func (o InlineResponse200348DataUsage) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200348DataUsage struct {
	value *InlineResponse200348DataUsage
	isSet bool
}

func (v NullableInlineResponse200348DataUsage) Get() *InlineResponse200348DataUsage {
	return v.value
}

func (v *NullableInlineResponse200348DataUsage) Set(val *InlineResponse200348DataUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200348DataUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200348DataUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200348DataUsage(val *InlineResponse200348DataUsage) *NullableInlineResponse200348DataUsage {
	return &NullableInlineResponse200348DataUsage{value: val, isSet: true}
}

func (v NullableInlineResponse200348DataUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200348DataUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
