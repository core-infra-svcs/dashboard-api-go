...
// InlineResponse200277MetaCountsItems Counts relating to the paginated items
type InlineResponse200277MetaCountsItems struct {
...
func NewInlineResponse200277MetaCountsItems() *InlineResponse200277MetaCountsItems {
	this := InlineResponse200277MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200277MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200277MetaCountsItems struct {
	value *InlineResponse200277MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200277MetaCountsItems) Get() *InlineResponse200277MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200277MetaCountsItems) Set(val *InlineResponse200277MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200277MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200277MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200277MetaCountsItems(val *InlineResponse200277MetaCountsItems) *NullableInlineResponse200277MetaCountsItems {
	return &NullableInlineResponse200277MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200277MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200277MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
