...
type InlineResponse200294 struct {
	...
	Example *InlineResponse200294Example `json:"example,omitempty"`
}
...
func (o *InlineResponse200294) GetExample() InlineResponse200294Example {
	if o == nil || isNil(o.Example) {
		var ret InlineResponse200294Example
		return ret
	}
	return *o.Example
}
...
// SetExample gets a reference to the given InlineResponse200294Example and assigns it to the Example field.
