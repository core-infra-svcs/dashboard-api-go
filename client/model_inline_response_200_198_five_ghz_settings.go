...
// InlineResponse200198FiveGhzSettings Settings related to 5Ghz band
type InlineResponse200198FiveGhzSettings struct {
...
func NewInlineResponse200198FiveGhzSettings() *InlineResponse200198FiveGhzSettings {
	this := InlineResponse200198FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse200198FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200198FiveGhzSettings struct {
	value *InlineResponse200198FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse200198FiveGhzSettings) Get() *InlineResponse200198FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse200198FiveGhzSettings) Set(val *InlineResponse200198FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200198FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200198FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200198FiveGhzSettings(val *InlineResponse200198FiveGhzSettings) *NullableInlineResponse200198FiveGhzSettings {
	return &NullableInlineResponse200198FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse200198FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200198FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
