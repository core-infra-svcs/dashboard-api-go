...
// InlineResponse200296Items struct for InlineResponse200296Items
type InlineResponse200296Items struct {
	...
	Match *InlineResponse200296Match `json:"match,omitempty"`
}
...
func NewInlineResponse200296Items() *InlineResponse200296Items {
	this := InlineResponse200296Items{}
	return &this
}
...
func (o *InlineResponse200296Items) GetMatch() InlineResponse200296Match {
	if o == nil || isNil(o.Match) {
		var ret InlineResponse200296Match
		return ret
	}
	return *o.Match
}
...
// SetMatch gets a reference to the given InlineResponse200296Match and assigns it to the Match field.
func (o *InlineResponse200296Items) SetMatch(v InlineResponse200296Match) {
	o.Match = &v
}

func (o InlineResponse200296Items) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200296Items struct {
	value *InlineResponse200296Items
	isSet bool
}

func (v NullableInlineResponse200296Items) Get() *InlineResponse200296Items {
	return v.value
}

func (v *NullableInlineResponse200296Items) Set(val *InlineResponse200296Items) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200296Items) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200296Items) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200296Items(val *InlineResponse200296Items) *NullableInlineResponse200296Items {
	return &NullableInlineResponse200296Items{value: val, isSet: true}
}

func (v NullableInlineResponse200296Items) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200296Items) UnmarshalJSON(src []byte) error {
	v.isSet = true
