...
// InlineResponse200293Networks struct for InlineResponse200293Networks
type InlineResponse200293Networks struct {
	// Network ID
...
func NewInlineResponse200293Networks() *InlineResponse200293Networks {
	this := InlineResponse200293Networks{}
	return &this
}
...
func (o InlineResponse200293Networks) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200293Networks struct {
	value *InlineResponse200293Networks
	isSet bool
}

func (v NullableInlineResponse200293Networks) Get() *InlineResponse200293Networks {
	return v.value
}

func (v *NullableInlineResponse200293Networks) Set(val *InlineResponse200293Networks) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200293Networks) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200293Networks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200293Networks(val *InlineResponse200293Networks) *NullableInlineResponse200293Networks {
	return &NullableInlineResponse200293Networks{value: val, isSet: true}
}

func (v NullableInlineResponse200293Networks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200293Networks) UnmarshalJSON(src []byte) error {
	v.isSet = true
