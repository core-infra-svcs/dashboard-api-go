...
// InlineResponse200115Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse200115Counts struct {
	...
	Noise *InlineResponse200115CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse200115Counts() *InlineResponse200115Counts {
	this := InlineResponse200115Counts{}
	return &this
}
...
func (o *InlineResponse200115Counts) GetNoise() InlineResponse200115CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse200115CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse200115CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse200115Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200115Counts struct {
	value *InlineResponse200115Counts
	isSet bool
}

func (v NullableInlineResponse200115Counts) Get() *InlineResponse200115Counts {
	return v.value
}

func (v *NullableInlineResponse200115Counts) Set(val *InlineResponse200115Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200115Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200115Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200115Counts(val *InlineResponse200115Counts) *NullableInlineResponse200115Counts {
	return &NullableInlineResponse200115Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200115Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200115Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
