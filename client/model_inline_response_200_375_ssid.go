...
// InlineResponse200375Ssid Wireless access point and network identifier.
type InlineResponse200375Ssid struct {
...
func (o InlineResponse200375Ssid) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200375Ssid struct {
	value *InlineResponse200375Ssid
	isSet bool
}

func (v NullableInlineResponse200375Ssid) Get() *InlineResponse200375Ssid {
	return v.value
}

func (v *NullableInlineResponse200375Ssid) Set(val *InlineResponse200375Ssid) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200375Ssid) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200375Ssid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200375Ssid(val *InlineResponse200375Ssid) *NullableInlineResponse200375Ssid {
	return &NullableInlineResponse200375Ssid{value: val, isSet: true}
}

func (v NullableInlineResponse200375Ssid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200375Ssid) UnmarshalJSON(src []byte) error {
	v.isSet = true
