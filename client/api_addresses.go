...
func (r AddressesApiGetOrganizationDevicesUplinksAddressesByDeviceRequest) Execute() ([]InlineResponse200282, *http.Response, error) {
...
func (a *AddressesApiService) GetOrganizationDevicesUplinksAddressesByDeviceExecute(r AddressesApiGetOrganizationDevicesUplinksAddressesByDeviceRequest) ([]InlineResponse200282, *http.Response, error) {
	var (
