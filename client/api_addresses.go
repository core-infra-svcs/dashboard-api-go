...
func (r AddressesApiGetOrganizationDevicesUplinksAddressesByDeviceRequest) Execute() ([]InlineResponse200147, *http.Response, error) {
...
func (a *AddressesApiService) GetOrganizationDevicesUplinksAddressesByDeviceExecute(r AddressesApiGetOrganizationDevicesUplinksAddressesByDeviceRequest) ([]InlineResponse200147, *http.Response, error) {
	var (
