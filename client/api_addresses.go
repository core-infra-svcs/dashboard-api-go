...
func (r AddressesApiGetOrganizationDevicesUplinksAddressesByDeviceRequest) Execute() ([]InlineResponse200257, *http.Response, error) {
...
func (a *AddressesApiService) GetOrganizationDevicesUplinksAddressesByDeviceExecute(r AddressesApiGetOrganizationDevicesUplinksAddressesByDeviceRequest) ([]InlineResponse200257, *http.Response, error) {
	var (
