...
// InlineResponse20089Events struct for InlineResponse20089Events
type InlineResponse20089Events struct {
	...
	EventData *InlineResponse20089EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20089Events() *InlineResponse20089Events {
	this := InlineResponse20089Events{}
	return &this
}
...
func (o *InlineResponse20089Events) GetEventData() InlineResponse20089EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20089EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20089EventData and assigns it to the EventData field.
func (o *InlineResponse20089Events) SetEventData(v InlineResponse20089EventData) {
	o.EventData = &v
}

func (o InlineResponse20089Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20089Events struct {
	value *InlineResponse20089Events
	isSet bool
}

func (v NullableInlineResponse20089Events) Get() *InlineResponse20089Events {
	return v.value
}

func (v *NullableInlineResponse20089Events) Set(val *InlineResponse20089Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20089Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20089Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20089Events(val *InlineResponse20089Events) *NullableInlineResponse20089Events {
	return &NullableInlineResponse20089Events{value: val, isSet: true}
}

func (v NullableInlineResponse20089Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20089Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
