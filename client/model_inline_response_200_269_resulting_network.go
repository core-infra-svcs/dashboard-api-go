...
// InlineResponse200269ResultingNetwork Network after the combination
type InlineResponse200269ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200269ResultingNetwork() *InlineResponse200269ResultingNetwork {
	this := InlineResponse200269ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200269ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200269ResultingNetwork struct {
	value *InlineResponse200269ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200269ResultingNetwork) Get() *InlineResponse200269ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200269ResultingNetwork) Set(val *InlineResponse200269ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200269ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200269ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200269ResultingNetwork(val *InlineResponse200269ResultingNetwork) *NullableInlineResponse200269ResultingNetwork {
	return &NullableInlineResponse200269ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200269ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200269ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
