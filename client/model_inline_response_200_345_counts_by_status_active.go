...
// InlineResponse200345CountsByStatusActive The count data for active ports
type InlineResponse200345CountsByStatusActive struct {
	// The total number of active ports
	Total *int32 `json:"total,omitempty"`
	ByMediaAndLinkSpeed *InlineResponse200345CountsByStatusActiveByMediaAndLinkSpeed `json:"byMediaAndLinkSpeed,omitempty"`
}
...
func NewInlineResponse200345CountsByStatusActive() *InlineResponse200345CountsByStatusActive {
	this := InlineResponse200345CountsByStatusActive{}
	return &this
}
...
func (o *InlineResponse200345CountsByStatusActive) GetByMediaAndLinkSpeed() InlineResponse200345CountsByStatusActiveByMediaAndLinkSpeed {
	if o == nil || isNil(o.ByMediaAndLinkSpeed) {
		var ret InlineResponse200345CountsByStatusActiveByMediaAndLinkSpeed
		return ret
	}
...
// SetByMediaAndLinkSpeed gets a reference to the given InlineResponse200345CountsByStatusActiveByMediaAndLinkSpeed and assigns it to the ByMediaAndLinkSpeed field.
...
func (o InlineResponse200345CountsByStatusActive) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200345CountsByStatusActive struct {
	value *InlineResponse200345CountsByStatusActive
	isSet bool
}

func (v NullableInlineResponse200345CountsByStatusActive) Get() *InlineResponse200345CountsByStatusActive {
	return v.value
}

func (v *NullableInlineResponse200345CountsByStatusActive) Set(val *InlineResponse200345CountsByStatusActive) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200345CountsByStatusActive) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200345CountsByStatusActive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200345CountsByStatusActive(val *InlineResponse200345CountsByStatusActive) *NullableInlineResponse200345CountsByStatusActive {
	return &NullableInlineResponse200345CountsByStatusActive{value: val, isSet: true}
}

func (v NullableInlineResponse200345CountsByStatusActive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200345CountsByStatusActive) UnmarshalJSON(src []byte) error {
	v.isSet = true
