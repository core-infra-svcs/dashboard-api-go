...
func (r DataRateHistoryApiGetNetworkWirelessDataRateHistoryRequest) Execute() ([]InlineResponse200176, *http.Response, error) {
...
func (a *DataRateHistoryApiService) GetNetworkWirelessDataRateHistoryExecute(r DataRateHistoryApiGetNetworkWirelessDataRateHistoryRequest) ([]InlineResponse200176, *http.Response, error) {
	var (
