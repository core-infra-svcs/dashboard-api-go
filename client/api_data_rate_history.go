...
func (r DataRateHistoryApiGetNetworkWirelessDataRateHistoryRequest) Execute() ([]InlineResponse200183, *http.Response, error) {
...
func (a *DataRateHistoryApiService) GetNetworkWirelessDataRateHistoryExecute(r DataRateHistoryApiGetNetworkWirelessDataRateHistoryRequest) ([]InlineResponse200183, *http.Response, error) {
	var (
