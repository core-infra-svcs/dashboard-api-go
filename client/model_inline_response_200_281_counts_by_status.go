...
// InlineResponse200281CountsByStatus byStatus
type InlineResponse200281CountsByStatus struct {
	// online count
...
func NewInlineResponse200281CountsByStatus() *InlineResponse200281CountsByStatus {
	this := InlineResponse200281CountsByStatus{}
	return &this
}
...
func (o InlineResponse200281CountsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200281CountsByStatus struct {
	value *InlineResponse200281CountsByStatus
	isSet bool
}

func (v NullableInlineResponse200281CountsByStatus) Get() *InlineResponse200281CountsByStatus {
	return v.value
}

func (v *NullableInlineResponse200281CountsByStatus) Set(val *InlineResponse200281CountsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200281CountsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200281CountsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200281CountsByStatus(val *InlineResponse200281CountsByStatus) *NullableInlineResponse200281CountsByStatus {
	return &NullableInlineResponse200281CountsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200281CountsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200281CountsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
