...
func (o *InlineResponse200371) GetDownstream() OrganizationsOrganizationIdWirelessDevicesPacketLossByClientDownstream {
...
func (o *InlineResponse200371) GetDownstreamOk() (*OrganizationsOrganizationIdWirelessDevicesPacketLossByClientDownstream, bool) {
	if o == nil || isNil(o.Downstream) {
    return nil, false
	}
...
func (o *InlineResponse200371) HasDownstream() bool {
	if o != nil && !isNil(o.Downstream) {
		return true
	}
...
func (o *InlineResponse200371) SetDownstream(v OrganizationsOrganizationIdWirelessDevicesPacketLossByClientDownstream) {
	o.Downstream = &v
}

// GetUpstream returns the Upstream field value if set, zero value otherwise.
func (o *InlineResponse200371) GetUpstream() OrganizationsOrganizationIdWirelessDevicesPacketLossByClientUpstream {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200371) GetUpstreamOk() (*OrganizationsOrganizationIdWirelessDevicesPacketLossByClientUpstream, bool) {
	if o == nil || isNil(o.Upstream) {
    return nil, false
	}
...
func (o *InlineResponse200371) HasUpstream() bool {
	if o != nil && !isNil(o.Upstream) {
		return true
	}
...
func (o *InlineResponse200371) SetUpstream(v OrganizationsOrganizationIdWirelessDevicesPacketLossByClientUpstream) {
	o.Upstream = &v
}

// GetClient returns the Client field value if set, zero value otherwise.
func (o *InlineResponse200371) GetClient() OrganizationsOrganizationIdWirelessDevicesPacketLossByClientClient {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200371) GetClientOk() (*OrganizationsOrganizationIdWirelessDevicesPacketLossByClientClient, bool) {
	if o == nil || isNil(o.Client) {
    return nil, false
	}
...
func (o *InlineResponse200371) HasClient() bool {
	if o != nil && !isNil(o.Client) {
		return true
	}
...
func (o *InlineResponse200371) SetClient(v OrganizationsOrganizationIdWirelessDevicesPacketLossByClientClient) {
	o.Client = &v
}

// GetNetwork returns the Network field value if set, zero value otherwise.
func (o *InlineResponse200371) GetNetwork() OrganizationsOrganizationIdWirelessDevicesPacketLossByClientNetwork {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200371) GetNetworkOk() (*OrganizationsOrganizationIdWirelessDevicesPacketLossByClientNetwork, bool) {
	if o == nil || isNil(o.Network) {
    return nil, false
	}
...
func (o *InlineResponse200371) SetNetwork(v OrganizationsOrganizationIdWirelessDevicesPacketLossByClientNetwork) {
	o.Network = &v
}
