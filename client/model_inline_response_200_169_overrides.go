...
// InlineResponse200169Overrides struct for InlineResponse200169Overrides
type InlineResponse200169Overrides struct {
...
func NewInlineResponse200169Overrides() *InlineResponse200169Overrides {
	this := InlineResponse200169Overrides{}
	return &this
}
...
func (o InlineResponse200169Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200169Overrides struct {
	value *InlineResponse200169Overrides
	isSet bool
}

func (v NullableInlineResponse200169Overrides) Get() *InlineResponse200169Overrides {
	return v.value
}

func (v *NullableInlineResponse200169Overrides) Set(val *InlineResponse200169Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200169Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200169Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200169Overrides(val *InlineResponse200169Overrides) *NullableInlineResponse200169Overrides {
	return &NullableInlineResponse200169Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse200169Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200169Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
