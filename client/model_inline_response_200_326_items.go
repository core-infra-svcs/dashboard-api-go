...
type InlineResponse200326Items struct {
	...
	Readings []InlineResponse200326Readings `json:"readings,omitempty"`
}
...
func (o *InlineResponse200326Items) GetReadings() []InlineResponse200326Readings {
	if o == nil || isNil(o.Readings) {
		var ret []InlineResponse200326Readings
		return ret
	}
	return o.Readings
}
...
// SetReadings gets a reference to the given []InlineResponse200326Readings and assigns it to the Readings field.
