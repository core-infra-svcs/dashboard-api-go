...
func (r UsageHistoriesApiGetNetworkClientsUsageHistoriesRequest) Execute() ([]InlineResponse200100, *http.Response, error) {
...
func (a *UsageHistoriesApiService) GetNetworkClientsUsageHistoriesExecute(r UsageHistoriesApiGetNetworkClientsUsageHistoriesRequest) ([]InlineResponse200100, *http.Response, error) {
	var (
