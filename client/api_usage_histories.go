...
func (r UsageHistoriesApiGetNetworkClientsUsageHistoriesRequest) Execute() ([]InlineResponse20094, *http.Response, error) {
...
func (a *UsageHistoriesApiService) GetNetworkClientsUsageHistoriesExecute(r UsageHistoriesApiGetNetworkClientsUsageHistoriesRequest) ([]InlineResponse20094, *http.Response, error) {
	var (
