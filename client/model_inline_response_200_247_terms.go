...
// InlineResponse200247Terms Service provider terms.
type InlineResponse200247Terms struct {
...
func NewInlineResponse200247Terms() *InlineResponse200247Terms {
	this := InlineResponse200247Terms{}
	return &this
}
...
func (o InlineResponse200247Terms) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200247Terms struct {
	value *InlineResponse200247Terms
	isSet bool
}

func (v NullableInlineResponse200247Terms) Get() *InlineResponse200247Terms {
	return v.value
}

func (v *NullableInlineResponse200247Terms) Set(val *InlineResponse200247Terms) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200247Terms) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200247Terms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200247Terms(val *InlineResponse200247Terms) *NullableInlineResponse200247Terms {
	return &NullableInlineResponse200247Terms{value: val, isSet: true}
}

func (v NullableInlineResponse200247Terms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200247Terms) UnmarshalJSON(src []byte) error {
	v.isSet = true
