...
// InlineResponse200230Network The network upon which a client with the given MAC address was found
type InlineResponse200230Network struct {
...
func NewInlineResponse200230Network() *InlineResponse200230Network {
	this := InlineResponse200230Network{}
	return &this
}
...
func (o InlineResponse200230Network) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200230Network struct {
	value *InlineResponse200230Network
	isSet bool
}

func (v NullableInlineResponse200230Network) Get() *InlineResponse200230Network {
	return v.value
}

func (v *NullableInlineResponse200230Network) Set(val *InlineResponse200230Network) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200230Network) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200230Network) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200230Network(val *InlineResponse200230Network) *NullableInlineResponse200230Network {
	return &NullableInlineResponse200230Network{value: val, isSet: true}
}

func (v NullableInlineResponse200230Network) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200230Network) UnmarshalJSON(src []byte) error {
	v.isSet = true
