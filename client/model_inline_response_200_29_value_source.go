...
// InlineResponse20029ValueSource Source of 'custom' type traffic filter
type InlineResponse20029ValueSource struct {
...
func NewInlineResponse20029ValueSource() *InlineResponse20029ValueSource {
	this := InlineResponse20029ValueSource{}
	return &this
}
...
func (o InlineResponse20029ValueSource) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20029ValueSource struct {
	value *InlineResponse20029ValueSource
	isSet bool
}

func (v NullableInlineResponse20029ValueSource) Get() *InlineResponse20029ValueSource {
	return v.value
}

func (v *NullableInlineResponse20029ValueSource) Set(val *InlineResponse20029ValueSource) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20029ValueSource) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20029ValueSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20029ValueSource(val *InlineResponse20029ValueSource) *NullableInlineResponse20029ValueSource {
	return &NullableInlineResponse20029ValueSource{value: val, isSet: true}
}

func (v NullableInlineResponse20029ValueSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20029ValueSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
