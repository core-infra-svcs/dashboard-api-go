...
// InlineResponse200376Radio Wireless access point radio identifier.
type InlineResponse200376Radio struct {
...
func NewInlineResponse200376Radio() *InlineResponse200376Radio {
	this := InlineResponse200376Radio{}
	return &this
}
...
func (o InlineResponse200376Radio) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200376Radio struct {
	value *InlineResponse200376Radio
	isSet bool
}

func (v NullableInlineResponse200376Radio) Get() *InlineResponse200376Radio {
	return v.value
}

func (v *NullableInlineResponse200376Radio) Set(val *InlineResponse200376Radio) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200376Radio) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200376Radio) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200376Radio(val *InlineResponse200376Radio) *NullableInlineResponse200376Radio {
	return &NullableInlineResponse200376Radio{value: val, isSet: true}
}

func (v NullableInlineResponse200376Radio) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200376Radio) UnmarshalJSON(src []byte) error {
	v.isSet = true
