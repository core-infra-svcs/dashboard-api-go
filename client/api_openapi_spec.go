...
type OpenapiSpecApiApiGetOrganizationOpenapiSpecRequest struct {
...
func (r OpenapiSpecApiApiGetOrganizationOpenapiSpecRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
Return the OpenAPI 2.0 Specification of the organization's API documentation in JSON
 ...
 @return OpenapiSpecApiApiGetOrganizationOpenapiSpecRequest
*/
func (a *OpenapiSpecApiService) GetOrganizationOpenapiSpec(ctx _context.Context, organizationId string) OpenapiSpecApiApiGetOrganizationOpenapiSpecRequest {
	return OpenapiSpecApiApiGetOrganizationOpenapiSpecRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *OpenapiSpecApiService) GetOrganizationOpenapiSpecExecute(r OpenapiSpecApiApiGetOrganizationOpenapiSpecRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
