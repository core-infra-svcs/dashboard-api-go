...
// InlineResponse20026Ipv6 IPv6 configuration on the single LAN
type InlineResponse20026Ipv6 struct {
	// Enable IPv6 on single LAN
	Enabled *bool `json:"enabled,omitempty"`
	// Prefix assignments on the single LAN
	PrefixAssignments []InlineResponse20026Ipv6PrefixAssignments `json:"prefixAssignments,omitempty"`
}
...
func (o *InlineResponse20026Ipv6) GetPrefixAssignments() []InlineResponse20026Ipv6PrefixAssignments {
	if o == nil || isNil(o.PrefixAssignments) {
		var ret []InlineResponse20026Ipv6PrefixAssignments
		return ret
	}
...
// SetPrefixAssignments gets a reference to the given []InlineResponse20026Ipv6PrefixAssignments and assigns it to the PrefixAssignments field.
func (o *InlineResponse20026Ipv6) SetPrefixAssignments(v []InlineResponse20026Ipv6PrefixAssignments) {
	o.PrefixAssignments = v
}

func (o InlineResponse20026Ipv6) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20026Ipv6 struct {
	value *InlineResponse20026Ipv6
	isSet bool
}

func (v NullableInlineResponse20026Ipv6) Get() *InlineResponse20026Ipv6 {
	return v.value
}

func (v *NullableInlineResponse20026Ipv6) Set(val *InlineResponse20026Ipv6) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20026Ipv6) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20026Ipv6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20026Ipv6(val *InlineResponse20026Ipv6) *NullableInlineResponse20026Ipv6 {
	return &NullableInlineResponse20026Ipv6{value: val, isSet: true}
}

func (v NullableInlineResponse20026Ipv6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20026Ipv6) UnmarshalJSON(src []byte) error {
	v.isSet = true
