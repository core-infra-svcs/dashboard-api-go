...
// DevicesSerialSwitchPortsStatusesTrafficInKbps A breakdown of the average speed of data that has passed through this port during the timespan. Note that this data is collected periodically from the switch. Any data from the past five minutes may be incomplete.
