...
func (r GroupPoliciesApiCreateNetworkGroupPolicyRequest) CreateNetworkGroupPolicy(createNetworkGroupPolicy InlineObject106) GroupPoliciesApiCreateNetworkGroupPolicyRequest {
	r.createNetworkGroupPolicy = &createNetworkGroupPolicy
	return r
}

func (r GroupPoliciesApiCreateNetworkGroupPolicyRequest) Execute() (*InlineResponse200100, *http.Response, error) {
...
func (a *GroupPoliciesApiService) CreateNetworkGroupPolicyExecute(r GroupPoliciesApiCreateNetworkGroupPolicyRequest) (*InlineResponse200100, *http.Response, error) {
	var (
...
func (r GroupPoliciesApiGetNetworkGroupPoliciesRequest) Execute() ([]InlineResponse200100, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200100
func (a *GroupPoliciesApiService) GetNetworkGroupPoliciesExecute(r GroupPoliciesApiGetNetworkGroupPoliciesRequest) ([]InlineResponse200100, *http.Response, error) {
	var (
...
func (r GroupPoliciesApiGetNetworkGroupPolicyRequest) Execute() (*InlineResponse200100, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200100
func (a *GroupPoliciesApiService) GetNetworkGroupPolicyExecute(r GroupPoliciesApiGetNetworkGroupPolicyRequest) (*InlineResponse200100, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r GroupPoliciesApiUpdateNetworkGroupPolicyRequest) UpdateNetworkGroupPolicy(updateNetworkGroupPolicy InlineObject107) GroupPoliciesApiUpdateNetworkGroupPolicyRequest {
	r.updateNetworkGroupPolicy = &updateNetworkGroupPolicy
	return r
}

func (r GroupPoliciesApiUpdateNetworkGroupPolicyRequest) Execute() (*InlineResponse200100, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200100
func (a *GroupPoliciesApiService) UpdateNetworkGroupPolicyExecute(r GroupPoliciesApiUpdateNetworkGroupPolicyRequest) (*InlineResponse200100, *http.Response, error) {
	var (
