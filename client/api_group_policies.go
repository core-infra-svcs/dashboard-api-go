...
func (r GroupPoliciesApiCreateNetworkGroupPolicyRequest) Execute() (*InlineResponse200107, *http.Response, error) {
...
func (a *GroupPoliciesApiService) CreateNetworkGroupPolicyExecute(r GroupPoliciesApiCreateNetworkGroupPolicyRequest) (*InlineResponse200107, *http.Response, error) {
	var (
...
func (r GroupPoliciesApiGetNetworkGroupPoliciesRequest) Execute() ([]InlineResponse200107, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200107
func (a *GroupPoliciesApiService) GetNetworkGroupPoliciesExecute(r GroupPoliciesApiGetNetworkGroupPoliciesRequest) ([]InlineResponse200107, *http.Response, error) {
	var (
...
func (r GroupPoliciesApiGetNetworkGroupPolicyRequest) Execute() (*InlineResponse200107, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200107
func (a *GroupPoliciesApiService) GetNetworkGroupPolicyExecute(r GroupPoliciesApiGetNetworkGroupPolicyRequest) (*InlineResponse200107, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r GroupPoliciesApiUpdateNetworkGroupPolicyRequest) Execute() (*InlineResponse200107, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200107
func (a *GroupPoliciesApiService) UpdateNetworkGroupPolicyExecute(r GroupPoliciesApiUpdateNetworkGroupPolicyRequest) (*InlineResponse200107, *http.Response, error) {
	var (
