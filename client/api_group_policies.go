...
func (r GroupPoliciesApiCreateNetworkGroupPolicyRequest) Execute() (*InlineResponse200104, *http.Response, error) {
...
func (a *GroupPoliciesApiService) CreateNetworkGroupPolicyExecute(r GroupPoliciesApiCreateNetworkGroupPolicyRequest) (*InlineResponse200104, *http.Response, error) {
	var (
...
func (r GroupPoliciesApiGetNetworkGroupPoliciesRequest) Execute() ([]InlineResponse200104, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200104
func (a *GroupPoliciesApiService) GetNetworkGroupPoliciesExecute(r GroupPoliciesApiGetNetworkGroupPoliciesRequest) ([]InlineResponse200104, *http.Response, error) {
	var (
...
func (r GroupPoliciesApiGetNetworkGroupPolicyRequest) Execute() (*InlineResponse200104, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200104
func (a *GroupPoliciesApiService) GetNetworkGroupPolicyExecute(r GroupPoliciesApiGetNetworkGroupPolicyRequest) (*InlineResponse200104, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r GroupPoliciesApiUpdateNetworkGroupPolicyRequest) Execute() (*InlineResponse200104, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200104
func (a *GroupPoliciesApiService) UpdateNetworkGroupPolicyExecute(r GroupPoliciesApiUpdateNetworkGroupPolicyRequest) (*InlineResponse200104, *http.Response, error) {
	var (
