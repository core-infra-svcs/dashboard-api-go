...
func (r GroupPoliciesApiCreateNetworkGroupPolicyRequest) Execute() (*InlineResponse20094, *http.Response, error) {
...
func (a *GroupPoliciesApiService) CreateNetworkGroupPolicyExecute(r GroupPoliciesApiCreateNetworkGroupPolicyRequest) (*InlineResponse20094, *http.Response, error) {
	var (
...
func (r GroupPoliciesApiGetNetworkGroupPoliciesRequest) Execute() ([]InlineResponse20094, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20094
func (a *GroupPoliciesApiService) GetNetworkGroupPoliciesExecute(r GroupPoliciesApiGetNetworkGroupPoliciesRequest) ([]InlineResponse20094, *http.Response, error) {
	var (
...
func (r GroupPoliciesApiGetNetworkGroupPolicyRequest) Execute() (*InlineResponse20094, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20094
func (a *GroupPoliciesApiService) GetNetworkGroupPolicyExecute(r GroupPoliciesApiGetNetworkGroupPolicyRequest) (*InlineResponse20094, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r GroupPoliciesApiUpdateNetworkGroupPolicyRequest) Execute() (*InlineResponse20094, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20094
func (a *GroupPoliciesApiService) UpdateNetworkGroupPolicyExecute(r GroupPoliciesApiUpdateNetworkGroupPolicyRequest) (*InlineResponse20094, *http.Response, error) {
	var (
