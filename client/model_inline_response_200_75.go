...
type InlineResponse20075 struct {
	BandwidthLimits *InlineResponse20075BandwidthLimits `json:"bandwidthLimits,omitempty"`
}
...
func (o *InlineResponse20075) GetBandwidthLimits() InlineResponse20075BandwidthLimits {
	if o == nil || isNil(o.BandwidthLimits) {
		var ret InlineResponse20075BandwidthLimits
		return ret
	}
...
func (o *InlineResponse20075) GetBandwidthLimitsOk() (*InlineResponse20075BandwidthLimits, bool) {
	if o == nil || isNil(o.BandwidthLimits) {
    return nil, false
	}
...
func (o *InlineResponse20075) HasBandwidthLimits() bool {
	if o != nil && !isNil(o.BandwidthLimits) {
		return true
	}
...
// SetBandwidthLimits gets a reference to the given InlineResponse20075BandwidthLimits and assigns it to the BandwidthLimits field.
func (o *InlineResponse20075) SetBandwidthLimits(v InlineResponse20075BandwidthLimits) {
	o.BandwidthLimits = &v
}
