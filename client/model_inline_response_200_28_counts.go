...
// InlineResponse20028Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse20028Counts struct {
	...
	Noise *InlineResponse20028CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse20028Counts() *InlineResponse20028Counts {
	this := InlineResponse20028Counts{}
	return &this
}
...
func (o *InlineResponse20028Counts) GetNoise() InlineResponse20028CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse20028CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse20028CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse20028Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20028Counts struct {
	value *InlineResponse20028Counts
	isSet bool
}

func (v NullableInlineResponse20028Counts) Get() *InlineResponse20028Counts {
	return v.value
}

func (v *NullableInlineResponse20028Counts) Set(val *InlineResponse20028Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20028Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20028Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20028Counts(val *InlineResponse20028Counts) *NullableInlineResponse20028Counts {
	return &NullableInlineResponse20028Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20028Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20028Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
