...
// InlineResponse20096FiveGhzSettings Settings related to 5Ghz band
type InlineResponse20096FiveGhzSettings struct {
...
func NewInlineResponse20096FiveGhzSettings() *InlineResponse20096FiveGhzSettings {
	this := InlineResponse20096FiveGhzSettings{}
	return &this
}
...
func (o InlineResponse20096FiveGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20096FiveGhzSettings struct {
	value *InlineResponse20096FiveGhzSettings
	isSet bool
}

func (v NullableInlineResponse20096FiveGhzSettings) Get() *InlineResponse20096FiveGhzSettings {
	return v.value
}

func (v *NullableInlineResponse20096FiveGhzSettings) Set(val *InlineResponse20096FiveGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20096FiveGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20096FiveGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20096FiveGhzSettings(val *InlineResponse20096FiveGhzSettings) *NullableInlineResponse20096FiveGhzSettings {
	return &NullableInlineResponse20096FiveGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20096FiveGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20096FiveGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
