...
// InlineResponse20053PerSsidSettings Per-SSID radio settings by number.
type InlineResponse20053PerSsidSettings struct {
	Var1 *InlineResponse20053PerSsidSettings1 `json:"1,omitempty"`
	Var2 *InlineResponse20053PerSsidSettings2 `json:"2,omitempty"`
	Var3 *InlineResponse20053PerSsidSettings3 `json:"3,omitempty"`
	Var4 *InlineResponse20053PerSsidSettings4 `json:"4,omitempty"`
}
...
func NewInlineResponse20053PerSsidSettings() *InlineResponse20053PerSsidSettings {
	this := InlineResponse20053PerSsidSettings{}
	return &this
}
...
func (o *InlineResponse20053PerSsidSettings) GetVar1() InlineResponse20053PerSsidSettings1 {
	if o == nil || isNil(o.Var1) {
		var ret InlineResponse20053PerSsidSettings1
		return ret
	}
	return *o.Var1
}
...
// SetVar1 gets a reference to the given InlineResponse20053PerSsidSettings1 and assigns it to the Var1 field.
...
func (o *InlineResponse20053PerSsidSettings) GetVar2() InlineResponse20053PerSsidSettings2 {
	if o == nil || isNil(o.Var2) {
		var ret InlineResponse20053PerSsidSettings2
		return ret
	}
	return *o.Var2
}
...
// SetVar2 gets a reference to the given InlineResponse20053PerSsidSettings2 and assigns it to the Var2 field.
...
func (o *InlineResponse20053PerSsidSettings) GetVar3() InlineResponse20053PerSsidSettings3 {
	if o == nil || isNil(o.Var3) {
		var ret InlineResponse20053PerSsidSettings3
		return ret
	}
	return *o.Var3
}
...
// SetVar3 gets a reference to the given InlineResponse20053PerSsidSettings3 and assigns it to the Var3 field.
...
func (o *InlineResponse20053PerSsidSettings) GetVar4() InlineResponse20053PerSsidSettings4 {
	if o == nil || isNil(o.Var4) {
		var ret InlineResponse20053PerSsidSettings4
		return ret
	}
	return *o.Var4
}
...
// SetVar4 gets a reference to the given InlineResponse20053PerSsidSettings4 and assigns it to the Var4 field.
func (o *InlineResponse20053PerSsidSettings) SetVar4(v InlineResponse20053PerSsidSettings4) {
	o.Var4 = &v
}

func (o InlineResponse20053PerSsidSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20053PerSsidSettings struct {
	value *InlineResponse20053PerSsidSettings
	isSet bool
}

func (v NullableInlineResponse20053PerSsidSettings) Get() *InlineResponse20053PerSsidSettings {
	return v.value
}

func (v *NullableInlineResponse20053PerSsidSettings) Set(val *InlineResponse20053PerSsidSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20053PerSsidSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20053PerSsidSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20053PerSsidSettings(val *InlineResponse20053PerSsidSettings) *NullableInlineResponse20053PerSsidSettings {
	return &NullableInlineResponse20053PerSsidSettings{value: val, isSet: true}
}

func (v NullableInlineResponse20053PerSsidSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20053PerSsidSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
