...
// InlineResponse20037EventData An object containing more data related to the event.
type InlineResponse20037EventData struct {
...
func NewInlineResponse20037EventData() *InlineResponse20037EventData {
	this := InlineResponse20037EventData{}
	return &this
}
...
func (o InlineResponse20037EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20037EventData struct {
	value *InlineResponse20037EventData
	isSet bool
}

func (v NullableInlineResponse20037EventData) Get() *InlineResponse20037EventData {
	return v.value
}

func (v *NullableInlineResponse20037EventData) Set(val *InlineResponse20037EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20037EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20037EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20037EventData(val *InlineResponse20037EventData) *NullableInlineResponse20037EventData {
	return &NullableInlineResponse20037EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20037EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20037EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
