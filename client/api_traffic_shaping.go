...
func (r TrafficShapingApiGetNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*InlineResponse200190, *http.Response, error) {
...
func (a *TrafficShapingApiService) GetNetworkWirelessSsidTrafficShapingRulesExecute(r TrafficShapingApiGetNetworkWirelessSsidTrafficShapingRulesRequest) (*InlineResponse200190, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r TrafficShapingApiGetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkRequest) Execute() (*InlineResponse200204, *http.Response, error) {
...
func (a *TrafficShapingApiService) GetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkExecute(r TrafficShapingApiGetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkRequest) (*InlineResponse200204, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r TrafficShapingApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) UpdateNetworkWirelessSsidTrafficShapingRules(updateNetworkWirelessSsidTrafficShapingRules InlineObject190) TrafficShapingApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest {
	r.updateNetworkWirelessSsidTrafficShapingRules = &updateNetworkWirelessSsidTrafficShapingRules
	return r
}

func (r TrafficShapingApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*InlineResponse200190, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200190
func (a *TrafficShapingApiService) UpdateNetworkWirelessSsidTrafficShapingRulesExecute(r TrafficShapingApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) (*InlineResponse200190, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
