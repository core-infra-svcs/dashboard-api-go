...
func (r TrafficShapingApiGetNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*InlineResponse200211, *http.Response, error) {
...
func (a *TrafficShapingApiService) GetNetworkWirelessSsidTrafficShapingRulesExecute(r TrafficShapingApiGetNetworkWirelessSsidTrafficShapingRulesRequest) (*InlineResponse200211, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r TrafficShapingApiGetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkRequest) Execute() (*InlineResponse200233, *http.Response, error) {
...
func (a *TrafficShapingApiService) GetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkExecute(r TrafficShapingApiGetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkRequest) (*InlineResponse200233, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r TrafficShapingApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) UpdateNetworkWirelessSsidTrafficShapingRules(updateNetworkWirelessSsidTrafficShapingRules InlineObject206) TrafficShapingApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest {
	r.updateNetworkWirelessSsidTrafficShapingRules = &updateNetworkWirelessSsidTrafficShapingRules
	return r
}

func (r TrafficShapingApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*InlineResponse200211, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200211
func (a *TrafficShapingApiService) UpdateNetworkWirelessSsidTrafficShapingRulesExecute(r TrafficShapingApiUpdateNetworkWirelessSsidTrafficShapingRulesRequest) (*InlineResponse200211, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
