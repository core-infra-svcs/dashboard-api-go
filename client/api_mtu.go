...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse200159, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) UpdateNetworkSwitchMtu(updateNetworkSwitchMtu InlineObject145) MtuApiUpdateNetworkSwitchMtuRequest {
	r.updateNetworkSwitchMtu = &updateNetworkSwitchMtu
	return r
}

func (r MtuApiUpdateNetworkSwitchMtuRequest) Execute() (*InlineResponse200159, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200159
func (a *MtuApiService) UpdateNetworkSwitchMtuExecute(r MtuApiUpdateNetworkSwitchMtuRequest) (*InlineResponse200159, *http.Response, error) {
	var (
