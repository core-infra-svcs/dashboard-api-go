...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse20081, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse20081, *http.Response, error) {
	var (
