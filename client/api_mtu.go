...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse200154, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse200154, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) UpdateNetworkSwitchMtu(updateNetworkSwitchMtu InlineObject143) MtuApiUpdateNetworkSwitchMtuRequest {
	r.updateNetworkSwitchMtu = &updateNetworkSwitchMtu
	return r
}

func (r MtuApiUpdateNetworkSwitchMtuRequest) Execute() (*InlineResponse200154, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200154
func (a *MtuApiService) UpdateNetworkSwitchMtuExecute(r MtuApiUpdateNetworkSwitchMtuRequest) (*InlineResponse200154, *http.Response, error) {
	var (
