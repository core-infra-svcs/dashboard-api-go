...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse20083, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse20083, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) UpdateNetworkSwitchMtu(updateNetworkSwitchMtu InlineObject126) MtuApiUpdateNetworkSwitchMtuRequest {
