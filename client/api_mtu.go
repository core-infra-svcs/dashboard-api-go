...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse20090, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse20090, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) UpdateNetworkSwitchMtu(updateNetworkSwitchMtu InlineObject134) MtuApiUpdateNetworkSwitchMtuRequest {
