...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse200148, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse200148, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) Execute() (*InlineResponse200148, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200148
func (a *MtuApiService) UpdateNetworkSwitchMtuExecute(r MtuApiUpdateNetworkSwitchMtuRequest) (*InlineResponse200148, *http.Response, error) {
	var (
