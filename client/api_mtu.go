...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse20084, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse20084, *http.Response, error) {
	var (
