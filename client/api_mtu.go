...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse20099, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse20099, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) UpdateNetworkSwitchMtu(updateNetworkSwitchMtu InlineObject135) MtuApiUpdateNetworkSwitchMtuRequest {
