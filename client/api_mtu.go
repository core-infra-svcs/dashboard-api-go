...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse200162, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse200162, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) UpdateNetworkSwitchMtu(updateNetworkSwitchMtu InlineObject148) MtuApiUpdateNetworkSwitchMtuRequest {
	r.updateNetworkSwitchMtu = &updateNetworkSwitchMtu
	return r
}

func (r MtuApiUpdateNetworkSwitchMtuRequest) Execute() (*InlineResponse200162, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200162
func (a *MtuApiService) UpdateNetworkSwitchMtuExecute(r MtuApiUpdateNetworkSwitchMtuRequest) (*InlineResponse200162, *http.Response, error) {
	var (
