...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse200157, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse200157, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) Execute() (*InlineResponse200157, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200157
func (a *MtuApiService) UpdateNetworkSwitchMtuExecute(r MtuApiUpdateNetworkSwitchMtuRequest) (*InlineResponse200157, *http.Response, error) {
	var (
