...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse200147, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse200147, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) Execute() (*InlineResponse200147, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200147
func (a *MtuApiService) UpdateNetworkSwitchMtuExecute(r MtuApiUpdateNetworkSwitchMtuRequest) (*InlineResponse200147, *http.Response, error) {
	var (
