...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse20067, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse20067, *http.Response, error) {
	var (
