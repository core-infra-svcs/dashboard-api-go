...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse20077, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse20077, *http.Response, error) {
	var (
