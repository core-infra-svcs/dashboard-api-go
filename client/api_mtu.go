...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse20086, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse20086, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) UpdateNetworkSwitchMtu(updateNetworkSwitchMtu InlineObject129) MtuApiUpdateNetworkSwitchMtuRequest {
