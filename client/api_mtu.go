...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse200165, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse200165, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) Execute() (*InlineResponse200165, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200165
func (a *MtuApiService) UpdateNetworkSwitchMtuExecute(r MtuApiUpdateNetworkSwitchMtuRequest) (*InlineResponse200165, *http.Response, error) {
	var (
