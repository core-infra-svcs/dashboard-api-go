...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse200153, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse200153, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) UpdateNetworkSwitchMtu(updateNetworkSwitchMtu InlineObject142) MtuApiUpdateNetworkSwitchMtuRequest {
	r.updateNetworkSwitchMtu = &updateNetworkSwitchMtu
	return r
}

func (r MtuApiUpdateNetworkSwitchMtuRequest) Execute() (*InlineResponse200153, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200153
func (a *MtuApiService) UpdateNetworkSwitchMtuExecute(r MtuApiUpdateNetworkSwitchMtuRequest) (*InlineResponse200153, *http.Response, error) {
	var (
