...
// InlineResponse2009Entries struct for InlineResponse2009Entries
type InlineResponse2009Entries struct {
...
func NewInlineResponse2009Entries() *InlineResponse2009Entries {
	this := InlineResponse2009Entries{}
	return &this
}
...
func (o InlineResponse2009Entries) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2009Entries struct {
	value *InlineResponse2009Entries
	isSet bool
}

func (v NullableInlineResponse2009Entries) Get() *InlineResponse2009Entries {
	return v.value
}

func (v *NullableInlineResponse2009Entries) Set(val *InlineResponse2009Entries) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2009Entries) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2009Entries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2009Entries(val *InlineResponse2009Entries) *NullableInlineResponse2009Entries {
	return &NullableInlineResponse2009Entries{value: val, isSet: true}
}

func (v NullableInlineResponse2009Entries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2009Entries) UnmarshalJSON(src []byte) error {
	v.isSet = true
