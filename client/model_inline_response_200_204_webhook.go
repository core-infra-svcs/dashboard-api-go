...
// InlineResponse200204Webhook The webhook receiver used by the callback to send results
type InlineResponse200204Webhook struct {
	// The webhook receiver URL where the callback will be sent
	Url *string `json:"url,omitempty"`
	HttpServer *InlineResponse200204WebhookHttpServer `json:"httpServer,omitempty"`
	PayloadTemplate *InlineResponse200204WebhookPayloadTemplate `json:"payloadTemplate,omitempty"`
...
func NewInlineResponse200204Webhook() *InlineResponse200204Webhook {
	this := InlineResponse200204Webhook{}
	return &this
}
...
func (o *InlineResponse200204Webhook) GetHttpServer() InlineResponse200204WebhookHttpServer {
	if o == nil || isNil(o.HttpServer) {
		var ret InlineResponse200204WebhookHttpServer
		return ret
	}
	return *o.HttpServer
}
...
// SetHttpServer gets a reference to the given InlineResponse200204WebhookHttpServer and assigns it to the HttpServer field.
...
func (o *InlineResponse200204Webhook) GetPayloadTemplate() InlineResponse200204WebhookPayloadTemplate {
	if o == nil || isNil(o.PayloadTemplate) {
		var ret InlineResponse200204WebhookPayloadTemplate
		return ret
	}
...
// SetPayloadTemplate gets a reference to the given InlineResponse200204WebhookPayloadTemplate and assigns it to the PayloadTemplate field.
...
func (o InlineResponse200204Webhook) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200204Webhook struct {
	value *InlineResponse200204Webhook
	isSet bool
}

func (v NullableInlineResponse200204Webhook) Get() *InlineResponse200204Webhook {
	return v.value
}

func (v *NullableInlineResponse200204Webhook) Set(val *InlineResponse200204Webhook) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200204Webhook) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200204Webhook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200204Webhook(val *InlineResponse200204Webhook) *NullableInlineResponse200204Webhook {
	return &NullableInlineResponse200204Webhook{value: val, isSet: true}
}

func (v NullableInlineResponse200204Webhook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200204Webhook) UnmarshalJSON(src []byte) error {
	v.isSet = true
