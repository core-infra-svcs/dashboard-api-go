...
// InlineResponse20035EventData An object containing more data related to the event.
type InlineResponse20035EventData struct {
...
func NewInlineResponse20035EventData() *InlineResponse20035EventData {
	this := InlineResponse20035EventData{}
	return &this
}
...
func (o InlineResponse20035EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20035EventData struct {
	value *InlineResponse20035EventData
	isSet bool
}

func (v NullableInlineResponse20035EventData) Get() *InlineResponse20035EventData {
	return v.value
}

func (v *NullableInlineResponse20035EventData) Set(val *InlineResponse20035EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20035EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20035EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20035EventData(val *InlineResponse20035EventData) *NullableInlineResponse20035EventData {
	return &NullableInlineResponse20035EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20035EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20035EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
