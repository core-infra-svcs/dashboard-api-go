...
type InlineResponse20076 struct {
	...
	Neighbors []InlineResponse20076Neighbors `json:"neighbors,omitempty"`
}
...
func (o *InlineResponse20076) GetNeighbors() []InlineResponse20076Neighbors {
	if o == nil || isNil(o.Neighbors) {
		var ret []InlineResponse20076Neighbors
		return ret
	}
	return o.Neighbors
}
...
// SetNeighbors gets a reference to the given []InlineResponse20076Neighbors and assigns it to the Neighbors field.
