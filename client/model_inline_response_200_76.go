...
type InlineResponse20076 struct {
	...
	Wan1 *InlineResponse20076Wan1 `json:"wan1,omitempty"`
	Wan2 *InlineResponse20076Wan2 `json:"wan2,omitempty"`
}
...
func (o *InlineResponse20076) GetWan1() InlineResponse20076Wan1 {
	if o == nil || isNil(o.Wan1) {
		var ret InlineResponse20076Wan1
		return ret
	}
	return *o.Wan1
}
...
// SetWan1 gets a reference to the given InlineResponse20076Wan1 and assigns it to the Wan1 field.
...
func (o *InlineResponse20076) GetWan2() InlineResponse20076Wan2 {
	if o == nil || isNil(o.Wan2) {
		var ret InlineResponse20076Wan2
		return ret
	}
	return *o.Wan2
}
...
// SetWan2 gets a reference to the given InlineResponse20076Wan2 and assigns it to the Wan2 field.
