...
// InlineResponse20110Addresses2 struct for InlineResponse20110Addresses2
type InlineResponse20110Addresses2 struct {
...
func NewInlineResponse20110Addresses2() *InlineResponse20110Addresses2 {
	this := InlineResponse20110Addresses2{}
	return &this
}
...
func (o InlineResponse20110Addresses2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20110Addresses2 struct {
	value *InlineResponse20110Addresses2
	isSet bool
}

func (v NullableInlineResponse20110Addresses2) Get() *InlineResponse20110Addresses2 {
	return v.value
}

func (v *NullableInlineResponse20110Addresses2) Set(val *InlineResponse20110Addresses2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20110Addresses2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20110Addresses2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20110Addresses2(val *InlineResponse20110Addresses2) *NullableInlineResponse20110Addresses2 {
	return &NullableInlineResponse20110Addresses2{value: val, isSet: true}
}

func (v NullableInlineResponse20110Addresses2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20110Addresses2) UnmarshalJSON(src []byte) error {
	v.isSet = true
