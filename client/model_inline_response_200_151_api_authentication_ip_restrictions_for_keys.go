...
// InlineResponse200151ApiAuthenticationIpRestrictionsForKeys Details for API-only IP restrictions.
type InlineResponse200151ApiAuthenticationIpRestrictionsForKeys struct {
...
func NewInlineResponse200151ApiAuthenticationIpRestrictionsForKeys() *InlineResponse200151ApiAuthenticationIpRestrictionsForKeys {
	this := InlineResponse200151ApiAuthenticationIpRestrictionsForKeys{}
	return &this
}
...
func (o InlineResponse200151ApiAuthenticationIpRestrictionsForKeys) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200151ApiAuthenticationIpRestrictionsForKeys struct {
	value *InlineResponse200151ApiAuthenticationIpRestrictionsForKeys
	isSet bool
}

func (v NullableInlineResponse200151ApiAuthenticationIpRestrictionsForKeys) Get() *InlineResponse200151ApiAuthenticationIpRestrictionsForKeys {
	return v.value
}

func (v *NullableInlineResponse200151ApiAuthenticationIpRestrictionsForKeys) Set(val *InlineResponse200151ApiAuthenticationIpRestrictionsForKeys) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200151ApiAuthenticationIpRestrictionsForKeys) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200151ApiAuthenticationIpRestrictionsForKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200151ApiAuthenticationIpRestrictionsForKeys(val *InlineResponse200151ApiAuthenticationIpRestrictionsForKeys) *NullableInlineResponse200151ApiAuthenticationIpRestrictionsForKeys {
	return &NullableInlineResponse200151ApiAuthenticationIpRestrictionsForKeys{value: val, isSet: true}
}

func (v NullableInlineResponse200151ApiAuthenticationIpRestrictionsForKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200151ApiAuthenticationIpRestrictionsForKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
