...
func (r DelegatedApiCreateNetworkAppliancePrefixesDelegatedStaticRequest) CreateNetworkAppliancePrefixesDelegatedStatic(createNetworkAppliancePrefixesDelegatedStatic InlineObject40) DelegatedApiCreateNetworkAppliancePrefixesDelegatedStaticRequest {
...
func (r DelegatedApiGetNetworkAppliancePrefixesDelegatedStaticRequest) Execute() (*InlineResponse20010, *http.Response, error) {
...
func (a *DelegatedApiService) GetNetworkAppliancePrefixesDelegatedStaticExecute(r DelegatedApiGetNetworkAppliancePrefixesDelegatedStaticRequest) (*InlineResponse20010, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r DelegatedApiGetNetworkAppliancePrefixesDelegatedStaticsRequest) Execute() ([]InlineResponse20010, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20010
func (a *DelegatedApiService) GetNetworkAppliancePrefixesDelegatedStaticsExecute(r DelegatedApiGetNetworkAppliancePrefixesDelegatedStaticsRequest) ([]InlineResponse20010, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r DelegatedApiUpdateNetworkAppliancePrefixesDelegatedStaticRequest) UpdateNetworkAppliancePrefixesDelegatedStatic(updateNetworkAppliancePrefixesDelegatedStatic InlineObject41) DelegatedApiUpdateNetworkAppliancePrefixesDelegatedStaticRequest {
