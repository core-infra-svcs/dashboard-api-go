...
func (r DelegatedApiCreateNetworkAppliancePrefixesDelegatedStaticRequest) CreateNetworkAppliancePrefixesDelegatedStatic(createNetworkAppliancePrefixesDelegatedStatic InlineObject55) DelegatedApiCreateNetworkAppliancePrefixesDelegatedStaticRequest {
...
func (r DelegatedApiGetNetworkAppliancePrefixesDelegatedStaticRequest) Execute() (*InlineResponse20059, *http.Response, error) {
...
func (a *DelegatedApiService) GetNetworkAppliancePrefixesDelegatedStaticExecute(r DelegatedApiGetNetworkAppliancePrefixesDelegatedStaticRequest) (*InlineResponse20059, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r DelegatedApiGetNetworkAppliancePrefixesDelegatedStaticsRequest) Execute() ([]InlineResponse20059, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20059
func (a *DelegatedApiService) GetNetworkAppliancePrefixesDelegatedStaticsExecute(r DelegatedApiGetNetworkAppliancePrefixesDelegatedStaticsRequest) ([]InlineResponse20059, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r DelegatedApiUpdateNetworkAppliancePrefixesDelegatedStaticRequest) UpdateNetworkAppliancePrefixesDelegatedStatic(updateNetworkAppliancePrefixesDelegatedStatic InlineObject56) DelegatedApiUpdateNetworkAppliancePrefixesDelegatedStaticRequest {
