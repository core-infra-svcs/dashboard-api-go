...
func (r DelegatedApiGetNetworkAppliancePrefixesDelegatedStaticRequest) Execute() (*InlineResponse20063, *http.Response, error) {
...
func (a *DelegatedApiService) GetNetworkAppliancePrefixesDelegatedStaticExecute(r DelegatedApiGetNetworkAppliancePrefixesDelegatedStaticRequest) (*InlineResponse20063, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r DelegatedApiGetNetworkAppliancePrefixesDelegatedStaticsRequest) Execute() ([]InlineResponse20063, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20063
func (a *DelegatedApiService) GetNetworkAppliancePrefixesDelegatedStaticsExecute(r DelegatedApiGetNetworkAppliancePrefixesDelegatedStaticsRequest) ([]InlineResponse20063, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
