...
// InlineResponse200126Limits The current limits of various adaptive policy objects.
type InlineResponse200126Limits struct {
...
func NewInlineResponse200126Limits() *InlineResponse200126Limits {
	this := InlineResponse200126Limits{}
	return &this
}
...
func (o InlineResponse200126Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200126Limits struct {
	value *InlineResponse200126Limits
	isSet bool
}

func (v NullableInlineResponse200126Limits) Get() *InlineResponse200126Limits {
	return v.value
}

func (v *NullableInlineResponse200126Limits) Set(val *InlineResponse200126Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200126Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200126Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200126Limits(val *InlineResponse200126Limits) *NullableInlineResponse200126Limits {
	return &NullableInlineResponse200126Limits{value: val, isSet: true}
}

func (v NullableInlineResponse200126Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200126Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
