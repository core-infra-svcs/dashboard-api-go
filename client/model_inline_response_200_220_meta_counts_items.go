...
// InlineResponse200220MetaCountsItems Counts relating to the paginated items
type InlineResponse200220MetaCountsItems struct {
...
func NewInlineResponse200220MetaCountsItems() *InlineResponse200220MetaCountsItems {
	this := InlineResponse200220MetaCountsItems{}
	return &this
}
...
func (o InlineResponse200220MetaCountsItems) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200220MetaCountsItems struct {
	value *InlineResponse200220MetaCountsItems
	isSet bool
}

func (v NullableInlineResponse200220MetaCountsItems) Get() *InlineResponse200220MetaCountsItems {
	return v.value
}

func (v *NullableInlineResponse200220MetaCountsItems) Set(val *InlineResponse200220MetaCountsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200220MetaCountsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200220MetaCountsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200220MetaCountsItems(val *InlineResponse200220MetaCountsItems) *NullableInlineResponse200220MetaCountsItems {
	return &NullableInlineResponse200220MetaCountsItems{value: val, isSet: true}
}

func (v NullableInlineResponse200220MetaCountsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200220MetaCountsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
