...
// InlineResponse200111Billing Details associated with billing splash
type InlineResponse200111Billing struct {
	FreeAccess *InlineResponse200111BillingFreeAccess `json:"freeAccess,omitempty"`
...
func NewInlineResponse200111Billing() *InlineResponse200111Billing {
	this := InlineResponse200111Billing{}
	return &this
}
...
func (o *InlineResponse200111Billing) GetFreeAccess() InlineResponse200111BillingFreeAccess {
	if o == nil || isNil(o.FreeAccess) {
		var ret InlineResponse200111BillingFreeAccess
		return ret
	}
	return *o.FreeAccess
}
...
// SetFreeAccess gets a reference to the given InlineResponse200111BillingFreeAccess and assigns it to the FreeAccess field.
...
func (o InlineResponse200111Billing) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200111Billing struct {
	value *InlineResponse200111Billing
	isSet bool
}

func (v NullableInlineResponse200111Billing) Get() *InlineResponse200111Billing {
	return v.value
}

func (v *NullableInlineResponse200111Billing) Set(val *InlineResponse200111Billing) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200111Billing) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200111Billing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200111Billing(val *InlineResponse200111Billing) *NullableInlineResponse200111Billing {
	return &NullableInlineResponse200111Billing{value: val, isSet: true}
}

func (v NullableInlineResponse200111Billing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200111Billing) UnmarshalJSON(src []byte) error {
	v.isSet = true
