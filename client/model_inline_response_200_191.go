...
type InlineResponse200191 struct {
	...
	SplashLogo *InlineResponse200191SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse200191SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse200191SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse200191GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse200191Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse200191SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse200191SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse200191) GetSplashLogo() InlineResponse200191SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse200191SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse200191SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse200191) GetSplashImage() InlineResponse200191SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse200191SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse200191SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse200191) GetSplashPrepaidFront() InlineResponse200191SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse200191SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse200191SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse200191) GetGuestSponsorship() InlineResponse200191GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse200191GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse200191GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse200191) GetBilling() InlineResponse200191Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse200191Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse200191Billing and assigns it to the Billing field.
...
func (o *InlineResponse200191) GetSentryEnrollment() InlineResponse200191SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse200191SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse200191SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse200191) GetSelfRegistration() InlineResponse200191SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse200191SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse200191SelfRegistration and assigns it to the SelfRegistration field.
