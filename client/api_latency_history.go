...
func (r LatencyHistoryApiGetNetworkWirelessClientLatencyHistoryRequest) Execute() ([]InlineResponse200188, *http.Response, error) {
...
func (a *LatencyHistoryApiService) GetNetworkWirelessClientLatencyHistoryExecute(r LatencyHistoryApiGetNetworkWirelessClientLatencyHistoryRequest) ([]InlineResponse200188, *http.Response, error) {
	var (
...
func (r LatencyHistoryApiGetNetworkWirelessLatencyHistoryRequest) Execute() ([]InlineResponse200195, *http.Response, error) {
...
func (a *LatencyHistoryApiService) GetNetworkWirelessLatencyHistoryExecute(r LatencyHistoryApiGetNetworkWirelessLatencyHistoryRequest) ([]InlineResponse200195, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
