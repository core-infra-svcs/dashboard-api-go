...
func (r LatencyHistoryApiGetNetworkWirelessLatencyHistoryRequest) Execute() ([]InlineResponse200101, *http.Response, error) {
...
func (a *LatencyHistoryApiService) GetNetworkWirelessLatencyHistoryExecute(r LatencyHistoryApiGetNetworkWirelessLatencyHistoryRequest) ([]InlineResponse200101, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
