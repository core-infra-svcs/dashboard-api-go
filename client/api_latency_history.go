...
func (r LatencyHistoryApiGetNetworkWirelessClientLatencyHistoryRequest) Execute() ([]InlineResponse200184, *http.Response, error) {
...
func (a *LatencyHistoryApiService) GetNetworkWirelessClientLatencyHistoryExecute(r LatencyHistoryApiGetNetworkWirelessClientLatencyHistoryRequest) ([]InlineResponse200184, *http.Response, error) {
	var (
...
func (r LatencyHistoryApiGetNetworkWirelessLatencyHistoryRequest) Execute() ([]InlineResponse200191, *http.Response, error) {
...
func (a *LatencyHistoryApiService) GetNetworkWirelessLatencyHistoryExecute(r LatencyHistoryApiGetNetworkWirelessLatencyHistoryRequest) ([]InlineResponse200191, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
