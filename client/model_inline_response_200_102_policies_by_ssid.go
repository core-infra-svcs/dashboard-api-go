...
// InlineResponse200102PoliciesBySsid struct for InlineResponse200102PoliciesBySsid
type InlineResponse200102PoliciesBySsid struct {
...
func NewInlineResponse200102PoliciesBySsid() *InlineResponse200102PoliciesBySsid {
	this := InlineResponse200102PoliciesBySsid{}
	return &this
}
...
func (o InlineResponse200102PoliciesBySsid) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200102PoliciesBySsid struct {
	value *InlineResponse200102PoliciesBySsid
	isSet bool
}

func (v NullableInlineResponse200102PoliciesBySsid) Get() *InlineResponse200102PoliciesBySsid {
	return v.value
}

func (v *NullableInlineResponse200102PoliciesBySsid) Set(val *InlineResponse200102PoliciesBySsid) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200102PoliciesBySsid) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200102PoliciesBySsid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200102PoliciesBySsid(val *InlineResponse200102PoliciesBySsid) *NullableInlineResponse200102PoliciesBySsid {
	return &NullableInlineResponse200102PoliciesBySsid{value: val, isSet: true}
}

func (v NullableInlineResponse200102PoliciesBySsid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200102PoliciesBySsid) UnmarshalJSON(src []byte) error {
	v.isSet = true
