...
func (r AlertTypesApiApiGetOrganizationWebhooksAlertTypesRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *AlertTypesApiService) GetOrganizationWebhooksAlertTypes(ctx context.Context, organizationId string) AlertTypesApiApiGetOrganizationWebhooksAlertTypesRequest {
	return AlertTypesApiApiGetOrganizationWebhooksAlertTypesRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *AlertTypesApiService) GetOrganizationWebhooksAlertTypesExecute(r AlertTypesApiApiGetOrganizationWebhooksAlertTypesRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
