...
func (r AlertTypesApiGetOrganizationWebhooksAlertTypesRequest) Execute() (*InlineResponse200336, *http.Response, error) {
...
func (a *AlertTypesApiService) GetOrganizationWebhooksAlertTypesExecute(r AlertTypesApiGetOrganizationWebhooksAlertTypesRequest) (*InlineResponse200336, *http.Response, error) {
	var (
