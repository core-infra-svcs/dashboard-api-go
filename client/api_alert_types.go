...
func (r AlertTypesApiGetOrganizationWebhooksAlertTypesRequest) Execute() (*InlineResponse200181, *http.Response, error) {
...
func (a *AlertTypesApiService) GetOrganizationWebhooksAlertTypesExecute(r AlertTypesApiGetOrganizationWebhooksAlertTypesRequest) (*InlineResponse200181, *http.Response, error) {
	var (
