...
func (r AlertTypesApiGetOrganizationWebhooksAlertTypesRequest) Execute() (*InlineResponse200325, *http.Response, error) {
...
func (a *AlertTypesApiService) GetOrganizationWebhooksAlertTypesExecute(r AlertTypesApiGetOrganizationWebhooksAlertTypesRequest) (*InlineResponse200325, *http.Response, error) {
	var (
