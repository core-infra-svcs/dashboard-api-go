...
func (r AlertTypesApiGetOrganizationWebhooksAlertTypesRequest) Execute() (*InlineResponse200193, *http.Response, error) {
...
func (a *AlertTypesApiService) GetOrganizationWebhooksAlertTypesExecute(r AlertTypesApiGetOrganizationWebhooksAlertTypesRequest) (*InlineResponse200193, *http.Response, error) {
	var (
