...
func (r AlertTypesApiGetOrganizationWebhooksAlertTypesRequest) Execute() (*InlineResponse200360, *http.Response, error) {
...
func (a *AlertTypesApiService) GetOrganizationWebhooksAlertTypesExecute(r AlertTypesApiGetOrganizationWebhooksAlertTypesRequest) (*InlineResponse200360, *http.Response, error) {
	var (
