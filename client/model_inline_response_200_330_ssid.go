...
// InlineResponse200330Ssid Wireless access point and network identifier.
type InlineResponse200330Ssid struct {
...
func (o InlineResponse200330Ssid) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200330Ssid struct {
	value *InlineResponse200330Ssid
	isSet bool
}

func (v NullableInlineResponse200330Ssid) Get() *InlineResponse200330Ssid {
	return v.value
}

func (v *NullableInlineResponse200330Ssid) Set(val *InlineResponse200330Ssid) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200330Ssid) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200330Ssid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200330Ssid(val *InlineResponse200330Ssid) *NullableInlineResponse200330Ssid {
	return &NullableInlineResponse200330Ssid{value: val, isSet: true}
}

func (v NullableInlineResponse200330Ssid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200330Ssid) UnmarshalJSON(src []byte) error {
	v.isSet = true
