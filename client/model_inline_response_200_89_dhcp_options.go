...
// InlineResponse20089DhcpOptions struct for InlineResponse20089DhcpOptions
type InlineResponse20089DhcpOptions struct {
...
func NewInlineResponse20089DhcpOptions() *InlineResponse20089DhcpOptions {
	this := InlineResponse20089DhcpOptions{}
	return &this
}
...
func (o InlineResponse20089DhcpOptions) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20089DhcpOptions struct {
	value *InlineResponse20089DhcpOptions
	isSet bool
}

func (v NullableInlineResponse20089DhcpOptions) Get() *InlineResponse20089DhcpOptions {
	return v.value
}

func (v *NullableInlineResponse20089DhcpOptions) Set(val *InlineResponse20089DhcpOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20089DhcpOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20089DhcpOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20089DhcpOptions(val *InlineResponse20089DhcpOptions) *NullableInlineResponse20089DhcpOptions {
	return &NullableInlineResponse20089DhcpOptions{value: val, isSet: true}
}

func (v NullableInlineResponse20089DhcpOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20089DhcpOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
