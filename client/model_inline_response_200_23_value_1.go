...
// InlineResponse20023Value1 Value of traffic filter
type InlineResponse20023Value1 struct {
	...
	Source *InlineResponse20023Value1Source `json:"source,omitempty"`
	Destination *InlineResponse20023Value1Destination `json:"destination,omitempty"`
}
...
func NewInlineResponse20023Value1() *InlineResponse20023Value1 {
	this := InlineResponse20023Value1{}
	return &this
}
...
func (o *InlineResponse20023Value1) GetSource() InlineResponse20023Value1Source {
	if o == nil || isNil(o.Source) {
		var ret InlineResponse20023Value1Source
		return ret
	}
	return *o.Source
}
...
// SetSource gets a reference to the given InlineResponse20023Value1Source and assigns it to the Source field.
...
func (o *InlineResponse20023Value1) GetDestination() InlineResponse20023Value1Destination {
	if o == nil || isNil(o.Destination) {
		var ret InlineResponse20023Value1Destination
		return ret
	}
...
// SetDestination gets a reference to the given InlineResponse20023Value1Destination and assigns it to the Destination field.
func (o *InlineResponse20023Value1) SetDestination(v InlineResponse20023Value1Destination) {
	o.Destination = &v
}

func (o InlineResponse20023Value1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20023Value1 struct {
	value *InlineResponse20023Value1
	isSet bool
}

func (v NullableInlineResponse20023Value1) Get() *InlineResponse20023Value1 {
	return v.value
}

func (v *NullableInlineResponse20023Value1) Set(val *InlineResponse20023Value1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20023Value1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20023Value1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20023Value1(val *InlineResponse20023Value1) *NullableInlineResponse20023Value1 {
	return &NullableInlineResponse20023Value1{value: val, isSet: true}
}

func (v NullableInlineResponse20023Value1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20023Value1) UnmarshalJSON(src []byte) error {
	v.isSet = true
