...
func (r ChannelsApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) Execute() (*InlineResponse200365, *http.Response, error) {
...
func (a *ChannelsApiService) RecalculateOrganizationWirelessRadioAutoRfChannelsExecute(r ChannelsApiRecalculateOrganizationWirelessRadioAutoRfChannelsRequest) (*InlineResponse200365, *http.Response, error) {
	var (
