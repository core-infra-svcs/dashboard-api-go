...
// InlineResponse2006Entries struct for InlineResponse2006Entries
type InlineResponse2006Entries struct {
...
func NewInlineResponse2006Entries() *InlineResponse2006Entries {
	this := InlineResponse2006Entries{}
	return &this
}
...
func (o InlineResponse2006Entries) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2006Entries struct {
	value *InlineResponse2006Entries
	isSet bool
}

func (v NullableInlineResponse2006Entries) Get() *InlineResponse2006Entries {
	return v.value
}

func (v *NullableInlineResponse2006Entries) Set(val *InlineResponse2006Entries) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2006Entries) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2006Entries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2006Entries(val *InlineResponse2006Entries) *NullableInlineResponse2006Entries {
	return &NullableInlineResponse2006Entries{value: val, isSet: true}
}

func (v NullableInlineResponse2006Entries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2006Entries) UnmarshalJSON(src []byte) error {
	v.isSet = true
