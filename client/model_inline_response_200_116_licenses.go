...
// InlineResponse200116Licenses struct for InlineResponse200116Licenses
type InlineResponse200116Licenses struct {
...
func NewInlineResponse200116Licenses() *InlineResponse200116Licenses {
	this := InlineResponse200116Licenses{}
	return &this
}
...
func (o InlineResponse200116Licenses) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200116Licenses struct {
	value *InlineResponse200116Licenses
	isSet bool
}

func (v NullableInlineResponse200116Licenses) Get() *InlineResponse200116Licenses {
	return v.value
}

func (v *NullableInlineResponse200116Licenses) Set(val *InlineResponse200116Licenses) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200116Licenses) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200116Licenses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200116Licenses(val *InlineResponse200116Licenses) *NullableInlineResponse200116Licenses {
	return &NullableInlineResponse200116Licenses{value: val, isSet: true}
}

func (v NullableInlineResponse200116Licenses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200116Licenses) UnmarshalJSON(src []byte) error {
	v.isSet = true
