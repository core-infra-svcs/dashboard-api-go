...
func (r ByModelApiGetOrganizationDevicesOverviewByModelRequest) Execute() (*InlineResponse200239, *http.Response, error) {
...
func (a *ByModelApiService) GetOrganizationDevicesOverviewByModelExecute(r ByModelApiGetOrganizationDevicesOverviewByModelRequest) (*InlineResponse200239, *http.Response, error) {
	var (
