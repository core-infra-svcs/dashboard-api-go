...
func (r ByModelApiGetOrganizationDevicesOverviewByModelRequest) Execute() (*InlineResponse200294, *http.Response, error) {
...
func (a *ByModelApiService) GetOrganizationDevicesOverviewByModelExecute(r ByModelApiGetOrganizationDevicesOverviewByModelRequest) (*InlineResponse200294, *http.Response, error) {
	var (
