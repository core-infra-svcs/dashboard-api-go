...
func (r ByModelApiGetOrganizationDevicesOverviewByModelRequest) Execute() (*InlineResponse200263, *http.Response, error) {
...
func (a *ByModelApiService) GetOrganizationDevicesOverviewByModelExecute(r ByModelApiGetOrganizationDevicesOverviewByModelRequest) (*InlineResponse200263, *http.Response, error) {
	var (
