...
func (r ByModelApiGetOrganizationDevicesOverviewByModelRequest) Execute() (*InlineResponse200245, *http.Response, error) {
...
func (a *ByModelApiService) GetOrganizationDevicesOverviewByModelExecute(r ByModelApiGetOrganizationDevicesOverviewByModelRequest) (*InlineResponse200245, *http.Response, error) {
	var (
