...
func (r ByModelApiGetOrganizationDevicesOverviewByModelRequest) Execute() (*InlineResponse200277, *http.Response, error) {
...
func (a *ByModelApiService) GetOrganizationDevicesOverviewByModelExecute(r ByModelApiGetOrganizationDevicesOverviewByModelRequest) (*InlineResponse200277, *http.Response, error) {
	var (
