...
func (r DesktopLogsApiGetNetworkSmDeviceDesktopLogsRequest) Execute() ([]InlineResponse20062, *http.Response, error) {
...
func (a *DesktopLogsApiService) GetNetworkSmDeviceDesktopLogsExecute(r DesktopLogsApiGetNetworkSmDeviceDesktopLogsRequest) ([]InlineResponse20062, *http.Response, error) {
	var (
