...
func (r DesktopLogsApiGetNetworkSmDeviceDesktopLogsRequest) Execute() ([]InlineResponse20068, *http.Response, error) {
...
func (a *DesktopLogsApiService) GetNetworkSmDeviceDesktopLogsExecute(r DesktopLogsApiGetNetworkSmDeviceDesktopLogsRequest) ([]InlineResponse20068, *http.Response, error) {
	var (
