...
// InlineResponse20046Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse20046Counts struct {
	...
	Noise *InlineResponse20046CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse20046Counts() *InlineResponse20046Counts {
	this := InlineResponse20046Counts{}
	return &this
}
...
func (o *InlineResponse20046Counts) GetNoise() InlineResponse20046CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse20046CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse20046CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse20046Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20046Counts struct {
	value *InlineResponse20046Counts
	isSet bool
}

func (v NullableInlineResponse20046Counts) Get() *InlineResponse20046Counts {
	return v.value
}

func (v *NullableInlineResponse20046Counts) Set(val *InlineResponse20046Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20046Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20046Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20046Counts(val *InlineResponse20046Counts) *NullableInlineResponse20046Counts {
	return &NullableInlineResponse20046Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20046Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20046Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
