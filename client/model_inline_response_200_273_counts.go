...
// InlineResponse200273Counts Aggregated count data for the license type
...
func (o *InlineResponse200273Counts) GetUnassigned() int32 {
...
func (o *InlineResponse200273Counts) GetUnassignedOk() (*int32, bool) {
	if o == nil || isNil(o.Unassigned) {
    return nil, false
	}
...
func (o *InlineResponse200273Counts) HasUnassigned() bool {
	if o != nil && !isNil(o.Unassigned) {
		return true
	}
...
func (o *InlineResponse200273Counts) SetUnassigned(v int32) {
	o.Unassigned = &v
}
