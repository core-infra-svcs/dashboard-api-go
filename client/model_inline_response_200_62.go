...
type InlineResponse20062 struct {
	...
	DynamicDns *InlineResponse20062DynamicDns `json:"dynamicDns,omitempty"`
}
...
func (o *InlineResponse20062) GetDynamicDns() InlineResponse20062DynamicDns {
	if o == nil || isNil(o.DynamicDns) {
		var ret InlineResponse20062DynamicDns
		return ret
	}
	return *o.DynamicDns
}
...
// SetDynamicDns gets a reference to the given InlineResponse20062DynamicDns and assigns it to the DynamicDns field.
