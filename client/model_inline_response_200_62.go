...
type InlineResponse20062 struct {
	...
	ProtectedNetworks *InlineResponse20062ProtectedNetworks `json:"protectedNetworks,omitempty"`
}
...
func (o *InlineResponse20062) GetProtectedNetworks() InlineResponse20062ProtectedNetworks {
	if o == nil || isNil(o.ProtectedNetworks) {
		var ret InlineResponse20062ProtectedNetworks
		return ret
	}
...
// SetProtectedNetworks gets a reference to the given InlineResponse20062ProtectedNetworks and assigns it to the ProtectedNetworks field.
