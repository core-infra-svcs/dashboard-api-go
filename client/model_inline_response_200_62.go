...
func (o *InlineResponse20062) GetNotValidAfter() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20062) GetNotValidAfterOk() (*string, bool) {
	if o == nil || isNil(o.NotValidAfter) {
    return nil, false
	}
...
func (o *InlineResponse20062) HasNotValidAfter() bool {
	if o != nil && !isNil(o.NotValidAfter) {
		return true
	}
...
func (o *InlineResponse20062) SetNotValidAfter(v string) {
	o.NotValidAfter = &v
}

// GetNotValidBefore returns the NotValidBefore field value if set, zero value otherwise.
func (o *InlineResponse20062) GetNotValidBefore() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20062) GetNotValidBeforeOk() (*string, bool) {
	if o == nil || isNil(o.NotValidBefore) {
    return nil, false
	}
...
func (o *InlineResponse20062) HasNotValidBefore() bool {
	if o != nil && !isNil(o.NotValidBefore) {
		return true
	}
...
func (o *InlineResponse20062) SetNotValidBefore(v string) {
	o.NotValidBefore = &v
}

// GetCertPem returns the CertPem field value if set, zero value otherwise.
func (o *InlineResponse20062) GetCertPem() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20062) GetCertPemOk() (*string, bool) {
	if o == nil || isNil(o.CertPem) {
    return nil, false
	}
...
func (o *InlineResponse20062) HasCertPem() bool {
	if o != nil && !isNil(o.CertPem) {
		return true
	}
...
func (o *InlineResponse20062) SetCertPem(v string) {
	o.CertPem = &v
}
...
func (o *InlineResponse20062) GetIssuer() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20062) GetIssuerOk() (*string, bool) {
	if o == nil || isNil(o.Issuer) {
    return nil, false
	}
...
func (o *InlineResponse20062) HasIssuer() bool {
	if o != nil && !isNil(o.Issuer) {
		return true
	}
...
func (o *InlineResponse20062) SetIssuer(v string) {
	o.Issuer = &v
}

// GetSubject returns the Subject field value if set, zero value otherwise.
func (o *InlineResponse20062) GetSubject() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20062) GetSubjectOk() (*string, bool) {
	if o == nil || isNil(o.Subject) {
    return nil, false
	}
...
func (o *InlineResponse20062) HasSubject() bool {
	if o != nil && !isNil(o.Subject) {
		return true
	}
...
func (o *InlineResponse20062) SetSubject(v string) {
	o.Subject = &v
}
