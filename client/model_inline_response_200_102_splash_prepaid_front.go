...
// InlineResponse200102SplashPrepaidFront The prepaid front image used in the splash page.
type InlineResponse200102SplashPrepaidFront struct {
...
func NewInlineResponse200102SplashPrepaidFront() *InlineResponse200102SplashPrepaidFront {
	this := InlineResponse200102SplashPrepaidFront{}
	return &this
}
...
func (o InlineResponse200102SplashPrepaidFront) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200102SplashPrepaidFront struct {
	value *InlineResponse200102SplashPrepaidFront
	isSet bool
}

func (v NullableInlineResponse200102SplashPrepaidFront) Get() *InlineResponse200102SplashPrepaidFront {
	return v.value
}

func (v *NullableInlineResponse200102SplashPrepaidFront) Set(val *InlineResponse200102SplashPrepaidFront) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200102SplashPrepaidFront) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200102SplashPrepaidFront) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200102SplashPrepaidFront(val *InlineResponse200102SplashPrepaidFront) *NullableInlineResponse200102SplashPrepaidFront {
	return &NullableInlineResponse200102SplashPrepaidFront{value: val, isSet: true}
}

func (v NullableInlineResponse200102SplashPrepaidFront) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200102SplashPrepaidFront) UnmarshalJSON(src []byte) error {
	v.isSet = true
