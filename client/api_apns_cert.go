...
func (r ApnsCertApiGetOrganizationSmApnsCertRequest) Execute() (*InlineResponse200304, *http.Response, error) {
...
func (a *ApnsCertApiService) GetOrganizationSmApnsCertExecute(r ApnsCertApiGetOrganizationSmApnsCertRequest) (*InlineResponse200304, *http.Response, error) {
	var (
