...
func (r ApnsCertApiGetOrganizationSmApnsCertRequest) Execute() (*InlineResponse200109, *http.Response, error) {
...
func (a *ApnsCertApiService) GetOrganizationSmApnsCertExecute(r ApnsCertApiGetOrganizationSmApnsCertRequest) (*InlineResponse200109, *http.Response, error) {
	var (
