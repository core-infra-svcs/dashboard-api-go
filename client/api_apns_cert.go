...
func (r ApnsCertApiApiGetOrganizationSmApnsCertRequest) Execute() (InlineResponse20089, *_nethttp.Response, error) {
...
func (a *ApnsCertApiService) GetOrganizationSmApnsCertExecute(r ApnsCertApiApiGetOrganizationSmApnsCertRequest) (InlineResponse20089, *_nethttp.Response, error) {
	var (
