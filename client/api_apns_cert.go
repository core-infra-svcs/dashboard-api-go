...
func (r ApnsCertApiGetOrganizationSmApnsCertRequest) Execute() (*InlineResponse200168, *http.Response, error) {
...
func (a *ApnsCertApiService) GetOrganizationSmApnsCertExecute(r ApnsCertApiGetOrganizationSmApnsCertRequest) (*InlineResponse200168, *http.Response, error) {
	var (
