...
func (r ApnsCertApiGetOrganizationSmApnsCertRequest) Execute() (*InlineResponse200162, *http.Response, error) {
...
func (a *ApnsCertApiService) GetOrganizationSmApnsCertExecute(r ApnsCertApiGetOrganizationSmApnsCertRequest) (*InlineResponse200162, *http.Response, error) {
	var (
