...
func (r ApnsCertApiGetOrganizationSmApnsCertRequest) Execute() (*InlineResponse20099, *http.Response, error) {
...
func (a *ApnsCertApiService) GetOrganizationSmApnsCertExecute(r ApnsCertApiGetOrganizationSmApnsCertRequest) (*InlineResponse20099, *http.Response, error) {
	var (
