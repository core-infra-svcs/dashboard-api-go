...
func (r ApnsCertApiGetOrganizationSmApnsCertRequest) Execute() (*InlineResponse200169, *http.Response, error) {
...
func (a *ApnsCertApiService) GetOrganizationSmApnsCertExecute(r ApnsCertApiGetOrganizationSmApnsCertRequest) (*InlineResponse200169, *http.Response, error) {
	var (
