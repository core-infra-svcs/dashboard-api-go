...
func (r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) BulkUpdateOrganizationDevicesDetails(bulkUpdateOrganizationDevicesDetails InlineObject229) DetailsApiBulkUpdateOrganizationDevicesDetailsRequest {
	r.bulkUpdateOrganizationDevicesDetails = &bulkUpdateOrganizationDevicesDetails
	return r
}

func (r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) Execute() (*InlineResponse200237, *http.Response, error) {
...
func (a *DetailsApiService) BulkUpdateOrganizationDevicesDetailsExecute(r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) (*InlineResponse200237, *http.Response, error) {
	var (
