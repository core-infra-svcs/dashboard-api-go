...
func (r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) BulkUpdateOrganizationDevicesDetails(bulkUpdateOrganizationDevicesDetails InlineObject257) DetailsApiBulkUpdateOrganizationDevicesDetailsRequest {
	r.bulkUpdateOrganizationDevicesDetails = &bulkUpdateOrganizationDevicesDetails
	return r
}

func (r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) Execute() (*InlineResponse200276, *http.Response, error) {
...
func (a *DetailsApiService) BulkUpdateOrganizationDevicesDetailsExecute(r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) (*InlineResponse200276, *http.Response, error) {
	var (
