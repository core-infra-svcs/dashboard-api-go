...
func (r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) BulkUpdateOrganizationDevicesDetails(bulkUpdateOrganizationDevicesDetails InlineObject255) DetailsApiBulkUpdateOrganizationDevicesDetailsRequest {
	r.bulkUpdateOrganizationDevicesDetails = &bulkUpdateOrganizationDevicesDetails
	return r
}

func (r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) Execute() (*InlineResponse200271, *http.Response, error) {
...
func (a *DetailsApiService) BulkUpdateOrganizationDevicesDetailsExecute(r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) (*InlineResponse200271, *http.Response, error) {
	var (
