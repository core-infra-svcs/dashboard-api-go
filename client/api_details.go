...
func (r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) BulkUpdateOrganizationDevicesDetails(bulkUpdateOrganizationDevicesDetails InlineObject259) DetailsApiBulkUpdateOrganizationDevicesDetailsRequest {
	r.bulkUpdateOrganizationDevicesDetails = &bulkUpdateOrganizationDevicesDetails
	return r
}

func (r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) Execute() (*InlineResponse200285, *http.Response, error) {
...
func (a *DetailsApiService) BulkUpdateOrganizationDevicesDetailsExecute(r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) (*InlineResponse200285, *http.Response, error) {
	var (
