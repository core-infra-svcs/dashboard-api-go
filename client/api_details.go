...
func (r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) BulkUpdateOrganizationDevicesDetails(bulkUpdateOrganizationDevicesDetails InlineObject239) DetailsApiBulkUpdateOrganizationDevicesDetailsRequest {
	r.bulkUpdateOrganizationDevicesDetails = &bulkUpdateOrganizationDevicesDetails
	return r
}

func (r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) Execute() (*InlineResponse200251, *http.Response, error) {
...
func (a *DetailsApiService) BulkUpdateOrganizationDevicesDetailsExecute(r DetailsApiBulkUpdateOrganizationDevicesDetailsRequest) (*InlineResponse200251, *http.Response, error) {
	var (
