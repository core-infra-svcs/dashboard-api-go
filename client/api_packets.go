...
func (r PacketsApiGetDeviceSwitchPortsStatusesPacketsRequest) Execute() ([]InlineResponse20033, *http.Response, error) {
...
func (a *PacketsApiService) GetDeviceSwitchPortsStatusesPacketsExecute(r PacketsApiGetDeviceSwitchPortsStatusesPacketsRequest) ([]InlineResponse20033, *http.Response, error) {
	var (
