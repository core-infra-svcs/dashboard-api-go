...
// InlineResponse200292CountsByStatusActive The count data for active ports
type InlineResponse200292CountsByStatusActive struct {
	// The total number of active ports
	Total *int32 `json:"total,omitempty"`
	ByMediaAndLinkSpeed *InlineResponse200292CountsByStatusActiveByMediaAndLinkSpeed `json:"byMediaAndLinkSpeed,omitempty"`
}
...
func NewInlineResponse200292CountsByStatusActive() *InlineResponse200292CountsByStatusActive {
	this := InlineResponse200292CountsByStatusActive{}
	return &this
}
...
func (o *InlineResponse200292CountsByStatusActive) GetByMediaAndLinkSpeed() InlineResponse200292CountsByStatusActiveByMediaAndLinkSpeed {
	if o == nil || isNil(o.ByMediaAndLinkSpeed) {
		var ret InlineResponse200292CountsByStatusActiveByMediaAndLinkSpeed
		return ret
	}
...
// SetByMediaAndLinkSpeed gets a reference to the given InlineResponse200292CountsByStatusActiveByMediaAndLinkSpeed and assigns it to the ByMediaAndLinkSpeed field.
...
func (o InlineResponse200292CountsByStatusActive) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200292CountsByStatusActive struct {
	value *InlineResponse200292CountsByStatusActive
	isSet bool
}

func (v NullableInlineResponse200292CountsByStatusActive) Get() *InlineResponse200292CountsByStatusActive {
	return v.value
}

func (v *NullableInlineResponse200292CountsByStatusActive) Set(val *InlineResponse200292CountsByStatusActive) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200292CountsByStatusActive) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200292CountsByStatusActive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200292CountsByStatusActive(val *InlineResponse200292CountsByStatusActive) *NullableInlineResponse200292CountsByStatusActive {
	return &NullableInlineResponse200292CountsByStatusActive{value: val, isSet: true}
}

func (v NullableInlineResponse200292CountsByStatusActive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200292CountsByStatusActive) UnmarshalJSON(src []byte) error {
	v.isSet = true
