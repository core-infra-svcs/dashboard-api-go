...
// InlineResponse200212ThirdPartyVpnPeers struct for InlineResponse200212ThirdPartyVpnPeers
type InlineResponse200212ThirdPartyVpnPeers struct {
	// Name of the peer
...
func NewInlineResponse200212ThirdPartyVpnPeers() *InlineResponse200212ThirdPartyVpnPeers {
	this := InlineResponse200212ThirdPartyVpnPeers{}
	return &this
}
...
func (o InlineResponse200212ThirdPartyVpnPeers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200212ThirdPartyVpnPeers struct {
	value *InlineResponse200212ThirdPartyVpnPeers
	isSet bool
}

func (v NullableInlineResponse200212ThirdPartyVpnPeers) Get() *InlineResponse200212ThirdPartyVpnPeers {
	return v.value
}

func (v *NullableInlineResponse200212ThirdPartyVpnPeers) Set(val *InlineResponse200212ThirdPartyVpnPeers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200212ThirdPartyVpnPeers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200212ThirdPartyVpnPeers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200212ThirdPartyVpnPeers(val *InlineResponse200212ThirdPartyVpnPeers) *NullableInlineResponse200212ThirdPartyVpnPeers {
	return &NullableInlineResponse200212ThirdPartyVpnPeers{value: val, isSet: true}
}

func (v NullableInlineResponse200212ThirdPartyVpnPeers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200212ThirdPartyVpnPeers) UnmarshalJSON(src []byte) error {
	v.isSet = true
