...
// InlineResponse20096ProductsWirelessCurrentVersion Details of the current version on the device
type InlineResponse20096ProductsWirelessCurrentVersion struct {
...
func NewInlineResponse20096ProductsWirelessCurrentVersion() *InlineResponse20096ProductsWirelessCurrentVersion {
	this := InlineResponse20096ProductsWirelessCurrentVersion{}
	return &this
}
...
func (o InlineResponse20096ProductsWirelessCurrentVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20096ProductsWirelessCurrentVersion struct {
	value *InlineResponse20096ProductsWirelessCurrentVersion
	isSet bool
}

func (v NullableInlineResponse20096ProductsWirelessCurrentVersion) Get() *InlineResponse20096ProductsWirelessCurrentVersion {
	return v.value
}

func (v *NullableInlineResponse20096ProductsWirelessCurrentVersion) Set(val *InlineResponse20096ProductsWirelessCurrentVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20096ProductsWirelessCurrentVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20096ProductsWirelessCurrentVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20096ProductsWirelessCurrentVersion(val *InlineResponse20096ProductsWirelessCurrentVersion) *NullableInlineResponse20096ProductsWirelessCurrentVersion {
	return &NullableInlineResponse20096ProductsWirelessCurrentVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20096ProductsWirelessCurrentVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20096ProductsWirelessCurrentVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
