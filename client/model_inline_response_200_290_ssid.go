...
// InlineResponse200290Ssid Wireless access point and network identifier.
type InlineResponse200290Ssid struct {
...
func (o InlineResponse200290Ssid) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200290Ssid struct {
	value *InlineResponse200290Ssid
	isSet bool
}

func (v NullableInlineResponse200290Ssid) Get() *InlineResponse200290Ssid {
	return v.value
}

func (v *NullableInlineResponse200290Ssid) Set(val *InlineResponse200290Ssid) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200290Ssid) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200290Ssid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200290Ssid(val *InlineResponse200290Ssid) *NullableInlineResponse200290Ssid {
	return &NullableInlineResponse200290Ssid{value: val, isSet: true}
}

func (v NullableInlineResponse200290Ssid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200290Ssid) UnmarshalJSON(src []byte) error {
	v.isSet = true
