...
func (r InboundFirewallRulesApiGetNetworkApplianceFirewallInboundFirewallRulesRequest) Execute() (*InlineResponse20018, *http.Response, error) {
...
func (a *InboundFirewallRulesApiService) GetNetworkApplianceFirewallInboundFirewallRulesExecute(r InboundFirewallRulesApiGetNetworkApplianceFirewallInboundFirewallRulesRequest) (*InlineResponse20018, *http.Response, error) {
	var (
...
func (r InboundFirewallRulesApiUpdateNetworkApplianceFirewallInboundFirewallRulesRequest) Execute() (*InlineResponse20018, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20018
func (a *InboundFirewallRulesApiService) UpdateNetworkApplianceFirewallInboundFirewallRulesExecute(r InboundFirewallRulesApiUpdateNetworkApplianceFirewallInboundFirewallRulesRequest) (*InlineResponse20018, *http.Response, error) {
	var (
