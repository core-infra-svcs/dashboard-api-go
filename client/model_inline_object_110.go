...
type InlineObject110 struct {
	...
	SecurePort *InlineResponse20066SecurePort `json:"securePort,omitempty"`
...
func (o *InlineObject110) GetSecurePort() InlineResponse20066SecurePort {
	if o == nil || isNil(o.SecurePort) {
		var ret InlineResponse20066SecurePort
		return ret
	}
	return *o.SecurePort
}
...
// SetSecurePort gets a reference to the given InlineResponse20066SecurePort and assigns it to the SecurePort field.
