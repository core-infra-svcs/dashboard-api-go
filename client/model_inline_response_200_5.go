...
type InlineResponse2005 struct {
	...
	TwoFourGhzSettings *InlineResponse2005TwoFourGhzSettings `json:"twoFourGhzSettings,omitempty"`
	FiveGhzSettings *InlineResponse2005FiveGhzSettings `json:"fiveGhzSettings,omitempty"`
}
...
func (o *InlineResponse2005) GetTwoFourGhzSettings() InlineResponse2005TwoFourGhzSettings {
	if o == nil || isNil(o.TwoFourGhzSettings) {
		var ret InlineResponse2005TwoFourGhzSettings
		return ret
	}
...
// SetTwoFourGhzSettings gets a reference to the given InlineResponse2005TwoFourGhzSettings and assigns it to the TwoFourGhzSettings field.
...
func (o *InlineResponse2005) GetFiveGhzSettings() InlineResponse2005FiveGhzSettings {
	if o == nil || isNil(o.FiveGhzSettings) {
		var ret InlineResponse2005FiveGhzSettings
		return ret
	}
...
// SetFiveGhzSettings gets a reference to the given InlineResponse2005FiveGhzSettings and assigns it to the FiveGhzSettings field.
