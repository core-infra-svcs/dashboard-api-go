...
// InlineResponse20083ReservedIpRanges struct for InlineResponse20083ReservedIpRanges
type InlineResponse20083ReservedIpRanges struct {
...
func NewInlineResponse20083ReservedIpRanges() *InlineResponse20083ReservedIpRanges {
	this := InlineResponse20083ReservedIpRanges{}
	return &this
}
...
func (o InlineResponse20083ReservedIpRanges) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20083ReservedIpRanges struct {
	value *InlineResponse20083ReservedIpRanges
	isSet bool
}

func (v NullableInlineResponse20083ReservedIpRanges) Get() *InlineResponse20083ReservedIpRanges {
	return v.value
}

func (v *NullableInlineResponse20083ReservedIpRanges) Set(val *InlineResponse20083ReservedIpRanges) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20083ReservedIpRanges) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20083ReservedIpRanges) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20083ReservedIpRanges(val *InlineResponse20083ReservedIpRanges) *NullableInlineResponse20083ReservedIpRanges {
	return &NullableInlineResponse20083ReservedIpRanges{value: val, isSet: true}
}

func (v NullableInlineResponse20083ReservedIpRanges) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20083ReservedIpRanges) UnmarshalJSON(src []byte) error {
	v.isSet = true
