...
// InlineResponse200338Counts The count data of all ports
type InlineResponse200338Counts struct {
	// The total number of ports
	Total *int32 `json:"total,omitempty"`
	ByStatus *InlineResponse200338CountsByStatus `json:"byStatus,omitempty"`
}
...
func NewInlineResponse200338Counts() *InlineResponse200338Counts {
	this := InlineResponse200338Counts{}
	return &this
}
...
func (o *InlineResponse200338Counts) GetByStatus() InlineResponse200338CountsByStatus {
	if o == nil || isNil(o.ByStatus) {
		var ret InlineResponse200338CountsByStatus
		return ret
	}
	return *o.ByStatus
}
...
// SetByStatus gets a reference to the given InlineResponse200338CountsByStatus and assigns it to the ByStatus field.
func (o *InlineResponse200338Counts) SetByStatus(v InlineResponse200338CountsByStatus) {
	o.ByStatus = &v
}

func (o InlineResponse200338Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200338Counts struct {
	value *InlineResponse200338Counts
	isSet bool
}

func (v NullableInlineResponse200338Counts) Get() *InlineResponse200338Counts {
	return v.value
}

func (v *NullableInlineResponse200338Counts) Set(val *InlineResponse200338Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200338Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200338Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200338Counts(val *InlineResponse200338Counts) *NullableInlineResponse200338Counts {
	return &NullableInlineResponse200338Counts{value: val, isSet: true}
}

func (v NullableInlineResponse200338Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200338Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
