...
func (r VpnExclusionsApiGetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkRequest) Execute() (*InlineResponse200206, *http.Response, error) {
...
func (a *VpnExclusionsApiService) GetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkExecute(r VpnExclusionsApiGetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkRequest) (*InlineResponse200206, *http.Response, error) {
	var (
