...
func (r VpnExclusionsApiGetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkRequest) Execute() ([]InlineResponse20027, *http.Response, error) {
...
func (a *VpnExclusionsApiService) GetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkExecute(r VpnExclusionsApiGetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkRequest) ([]InlineResponse20027, *http.Response, error) {
	var (
...
func (r VpnExclusionsApiUpdateNetworkApplianceTrafficShapingVpnExclusionsRequest) Execute() (*InlineResponse20027, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20027
func (a *VpnExclusionsApiService) UpdateNetworkApplianceTrafficShapingVpnExclusionsExecute(r VpnExclusionsApiUpdateNetworkApplianceTrafficShapingVpnExclusionsRequest) (*InlineResponse20027, *http.Response, error) {
	var (
