...
func (r VpnExclusionsApiGetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkRequest) Execute() ([]InlineResponse20028, *http.Response, error) {
...
func (a *VpnExclusionsApiService) GetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkExecute(r VpnExclusionsApiGetOrganizationApplianceTrafficShapingVpnExclusionsByNetworkRequest) ([]InlineResponse20028, *http.Response, error) {
	var (
...
func (r VpnExclusionsApiUpdateNetworkApplianceTrafficShapingVpnExclusionsRequest) Execute() (*InlineResponse20028, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20028
func (a *VpnExclusionsApiService) UpdateNetworkApplianceTrafficShapingVpnExclusionsExecute(r VpnExclusionsApiUpdateNetworkApplianceTrafficShapingVpnExclusionsRequest) (*InlineResponse20028, *http.Response, error) {
	var (
