...
// InlineResponse20017UpgradeWindow Upgrade window for devices in network
type InlineResponse20017UpgradeWindow struct {
	// Day of the week
...
func NewInlineResponse20017UpgradeWindow() *InlineResponse20017UpgradeWindow {
	this := InlineResponse20017UpgradeWindow{}
	return &this
}
...
func (o InlineResponse20017UpgradeWindow) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20017UpgradeWindow struct {
	value *InlineResponse20017UpgradeWindow
	isSet bool
}

func (v NullableInlineResponse20017UpgradeWindow) Get() *InlineResponse20017UpgradeWindow {
	return v.value
}

func (v *NullableInlineResponse20017UpgradeWindow) Set(val *InlineResponse20017UpgradeWindow) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20017UpgradeWindow) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20017UpgradeWindow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20017UpgradeWindow(val *InlineResponse20017UpgradeWindow) *NullableInlineResponse20017UpgradeWindow {
	return &NullableInlineResponse20017UpgradeWindow{value: val, isSet: true}
}

func (v NullableInlineResponse20017UpgradeWindow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20017UpgradeWindow) UnmarshalJSON(src []byte) error {
	v.isSet = true
