...
type InlineResponse200251 struct {
	...
	Counts []InlineResponse200251Counts `json:"counts,omitempty"`
}
...
// SetCounts gets a reference to the given []InlineResponse200251Counts and assigns it to the Counts field.
