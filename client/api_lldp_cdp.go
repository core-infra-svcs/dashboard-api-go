...
func (r LldpCdpApiGetDeviceLldpCdpRequest) Execute() (*InlineResponse20025, *http.Response, error) {
...
func (a *LldpCdpApiService) GetDeviceLldpCdpExecute(r LldpCdpApiGetDeviceLldpCdpRequest) (*InlineResponse20025, *http.Response, error) {
	var (
