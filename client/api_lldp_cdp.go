...
func (r LldpCdpApiGetDeviceLldpCdpRequest) Execute() (*InlineResponse20030, *http.Response, error) {
...
func (a *LldpCdpApiService) GetDeviceLldpCdpExecute(r LldpCdpApiGetDeviceLldpCdpRequest) (*InlineResponse20030, *http.Response, error) {
	var (
