...
func (r LldpCdpApiGetDeviceLldpCdpRequest) Execute() (*InlineResponse20036, *http.Response, error) {
...
func (a *LldpCdpApiService) GetDeviceLldpCdpExecute(r LldpCdpApiGetDeviceLldpCdpRequest) (*InlineResponse20036, *http.Response, error) {
	var (
