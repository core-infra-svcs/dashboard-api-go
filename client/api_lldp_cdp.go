...
func (r LldpCdpApiGetDeviceLldpCdpRequest) Execute() (*InlineResponse20029, *http.Response, error) {
...
func (a *LldpCdpApiService) GetDeviceLldpCdpExecute(r LldpCdpApiGetDeviceLldpCdpRequest) (*InlineResponse20029, *http.Response, error) {
	var (
