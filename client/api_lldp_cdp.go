...
func (r LldpCdpApiGetDeviceLldpCdpRequest) Execute() (*InlineResponse20031, *http.Response, error) {
...
func (a *LldpCdpApiService) GetDeviceLldpCdpExecute(r LldpCdpApiGetDeviceLldpCdpRequest) (*InlineResponse20031, *http.Response, error) {
	var (
