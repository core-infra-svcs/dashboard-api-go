...
func (r LldpCdpApiApiGetDeviceLldpCdpRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *LldpCdpApiService) GetDeviceLldpCdp(ctx context.Context, serial string) LldpCdpApiApiGetDeviceLldpCdpRequest {
	return LldpCdpApiApiGetDeviceLldpCdpRequest{
		ApiService: a,
		ctx: ctx,
		serial: serial,
...
func (a *LldpCdpApiService) GetDeviceLldpCdpExecute(r LldpCdpApiApiGetDeviceLldpCdpRequest) (map[string]interface{}, *http.Response, error) {
	var (
