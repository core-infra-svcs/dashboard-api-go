...
type LldpCdpApiApiGetDeviceLldpCdpRequest struct {
...
func (r LldpCdpApiApiGetDeviceLldpCdpRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
List LLDP and CDP information for a device
 ...
 @param serial
 @return LldpCdpApiApiGetDeviceLldpCdpRequest
*/
func (a *LldpCdpApiService) GetDeviceLldpCdp(ctx _context.Context, serial string) LldpCdpApiApiGetDeviceLldpCdpRequest {
	return LldpCdpApiApiGetDeviceLldpCdpRequest{
		ApiService: a,
		ctx: ctx,
		serial: serial,
...
func (a *LldpCdpApiService) GetDeviceLldpCdpExecute(r LldpCdpApiApiGetDeviceLldpCdpRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
