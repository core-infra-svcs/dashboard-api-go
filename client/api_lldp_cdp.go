...
func (r LldpCdpApiGetDeviceLldpCdpRequest) Execute() (*InlineResponse20026, *http.Response, error) {
...
func (a *LldpCdpApiService) GetDeviceLldpCdpExecute(r LldpCdpApiGetDeviceLldpCdpRequest) (*InlineResponse20026, *http.Response, error) {
	var (
