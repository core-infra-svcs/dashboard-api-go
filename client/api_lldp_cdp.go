...
func (r LldpCdpApiGetDeviceLldpCdpRequest) Execute() (*InlineResponse20027, *http.Response, error) {
...
func (a *LldpCdpApiService) GetDeviceLldpCdpExecute(r LldpCdpApiGetDeviceLldpCdpRequest) (*InlineResponse20027, *http.Response, error) {
	var (
