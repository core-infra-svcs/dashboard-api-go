...
func (r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) Execute() (*InlineResponse200315, *http.Response, error) {
...
func (a *LatestApiService) GetOrganizationSensorGatewaysConnectionsLatestExecute(r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) (*InlineResponse200315, *http.Response, error) {
	var (
...
func (r LatestApiGetOrganizationSensorReadingsLatestRequest) Execute() ([]InlineResponse200317, *http.Response, error) {
...
func (a *LatestApiService) GetOrganizationSensorReadingsLatestExecute(r LatestApiGetOrganizationSensorReadingsLatestRequest) ([]InlineResponse200317, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
