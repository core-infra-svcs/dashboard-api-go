...
func (r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) Execute() (*InlineResponse200328, *http.Response, error) {
...
func (a *LatestApiService) GetOrganizationSensorGatewaysConnectionsLatestExecute(r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) (*InlineResponse200328, *http.Response, error) {
	var (
...
func (r LatestApiGetOrganizationSensorReadingsLatestRequest) Execute() ([]InlineResponse200330, *http.Response, error) {
...
func (a *LatestApiService) GetOrganizationSensorReadingsLatestExecute(r LatestApiGetOrganizationSensorReadingsLatestRequest) ([]InlineResponse200330, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
