...
func (r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) Execute() (*InlineResponse200331, *http.Response, error) {
...
func (a *LatestApiService) GetOrganizationSensorGatewaysConnectionsLatestExecute(r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) (*InlineResponse200331, *http.Response, error) {
	var (
...
func (r LatestApiGetOrganizationSensorReadingsLatestRequest) Execute() ([]InlineResponse200333, *http.Response, error) {
...
func (a *LatestApiService) GetOrganizationSensorReadingsLatestExecute(r LatestApiGetOrganizationSensorReadingsLatestRequest) ([]InlineResponse200333, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
