...
func (r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) Execute() (*InlineResponse200318, *http.Response, error) {
...
func (a *LatestApiService) GetOrganizationSensorGatewaysConnectionsLatestExecute(r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) (*InlineResponse200318, *http.Response, error) {
	var (
...
func (r LatestApiGetOrganizationSensorReadingsLatestRequest) Execute() ([]InlineResponse200320, *http.Response, error) {
...
func (a *LatestApiService) GetOrganizationSensorReadingsLatestExecute(r LatestApiGetOrganizationSensorReadingsLatestRequest) ([]InlineResponse200320, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
