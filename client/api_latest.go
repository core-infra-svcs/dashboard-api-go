...
func (r LatestApiGetOrganizationSensorReadingsLatestRequest) Execute() ([]InlineResponse200186, *http.Response, error) {
...
func (a *LatestApiService) GetOrganizationSensorReadingsLatestExecute(r LatestApiGetOrganizationSensorReadingsLatestRequest) ([]InlineResponse200186, *http.Response, error) {
	var (
