...
type LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest struct {
	ctx context.Context
...
func (r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) SensorSerials(sensorSerials []string) LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest {
	r.sensorSerials = &sensorSerials
	return r
}

// The number of entries per page returned. Acceptable range is 3 - 1000. Default is 1000.
func (r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) PerPage(perPage int32) LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest {
	r.perPage = &perPage
	return r
}

// A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) StartingAfter(startingAfter string) LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest {
	r.startingAfter = &startingAfter
	return r
}

// A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) EndingBefore(endingBefore string) LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest {
	r.endingBefore = &endingBefore
	return r
}

func (r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) Execute() (*InlineResponse200319, *http.Response, error) {
...
Returns latest sensor-gateway connectivity data.
 ...
 @return LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest
*/
func (a *LatestApiService) GetOrganizationSensorGatewaysConnectionsLatest(ctx context.Context, organizationId string) LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest {
	return LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *LatestApiService) GetOrganizationSensorGatewaysConnectionsLatestExecute(r LatestApiGetOrganizationSensorGatewaysConnectionsLatestRequest) (*InlineResponse200319, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LatestApiService.GetOrganizationSensorGatewaysConnectionsLatest")
	if err != nil {
...
func (r LatestApiGetOrganizationSensorReadingsLatestRequest) Execute() ([]InlineResponse200321, *http.Response, error) {
...
func (a *LatestApiService) GetOrganizationSensorReadingsLatestExecute(r LatestApiGetOrganizationSensorReadingsLatestRequest) ([]InlineResponse200321, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
