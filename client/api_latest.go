...
func (r LatestApiGetOrganizationSensorReadingsLatestRequest) Execute() ([]InlineResponse200266, *http.Response, error) {
...
func (a *LatestApiService) GetOrganizationSensorReadingsLatestExecute(r LatestApiGetOrganizationSensorReadingsLatestRequest) ([]InlineResponse200266, *http.Response, error) {
	var (
