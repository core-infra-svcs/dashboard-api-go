...
// InlineResponse200108BillingFreeAccess Details associated with a free access plan with limits
type InlineResponse200108BillingFreeAccess struct {
...
func NewInlineResponse200108BillingFreeAccess() *InlineResponse200108BillingFreeAccess {
	this := InlineResponse200108BillingFreeAccess{}
	return &this
}
...
func (o InlineResponse200108BillingFreeAccess) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200108BillingFreeAccess struct {
	value *InlineResponse200108BillingFreeAccess
	isSet bool
}

func (v NullableInlineResponse200108BillingFreeAccess) Get() *InlineResponse200108BillingFreeAccess {
	return v.value
}

func (v *NullableInlineResponse200108BillingFreeAccess) Set(val *InlineResponse200108BillingFreeAccess) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200108BillingFreeAccess) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200108BillingFreeAccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200108BillingFreeAccess(val *InlineResponse200108BillingFreeAccess) *NullableInlineResponse200108BillingFreeAccess {
	return &NullableInlineResponse200108BillingFreeAccess{value: val, isSet: true}
}

func (v NullableInlineResponse200108BillingFreeAccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200108BillingFreeAccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
