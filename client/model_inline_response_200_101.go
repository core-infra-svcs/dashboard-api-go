...
type InlineResponse200101 struct {
	...
	ClientVpnConnections []InlineResponse200101ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse200101) GetClientVpnConnections() []InlineResponse200101ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse200101ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse200101ClientVpnConnections and assigns it to the ClientVpnConnections field.
