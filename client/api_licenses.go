...
func (r LicensesApiAssignOrganizationLicensesSeatsRequest) Execute() (*InlineResponse20094, *http.Response, error) {
...
func (a *LicensesApiService) AssignOrganizationLicensesSeatsExecute(r LicensesApiAssignOrganizationLicensesSeatsRequest) (*InlineResponse20094, *http.Response, error) {
	var (
...
func (r LicensesApiGetOrganizationLicenseRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
func (a *LicensesApiService) GetOrganizationLicenseExecute(r LicensesApiGetOrganizationLicenseRequest) (*InlineResponse20093, *http.Response, error) {
	var (
...
func (r LicensesApiGetOrganizationLicensesRequest) Execute() ([]InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20093
func (a *LicensesApiService) GetOrganizationLicensesExecute(r LicensesApiGetOrganizationLicensesRequest) ([]InlineResponse20093, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r LicensesApiMoveOrganizationLicensesRequest) Execute() (*InlineResponse20095, *http.Response, error) {
...
func (a *LicensesApiService) MoveOrganizationLicensesExecute(r LicensesApiMoveOrganizationLicensesRequest) (*InlineResponse20095, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r LicensesApiMoveOrganizationLicensesSeatsRequest) Execute() (*InlineResponse20096, *http.Response, error) {
...
func (a *LicensesApiService) MoveOrganizationLicensesSeatsExecute(r LicensesApiMoveOrganizationLicensesSeatsRequest) (*InlineResponse20096, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r LicensesApiRenewOrganizationLicensesSeatsRequest) Execute() (*InlineResponse20094, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20094
func (a *LicensesApiService) RenewOrganizationLicensesSeatsExecute(r LicensesApiRenewOrganizationLicensesSeatsRequest) (*InlineResponse20094, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r LicensesApiUpdateOrganizationLicenseRequest) Execute() (*InlineResponse20093, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20093
func (a *LicensesApiService) UpdateOrganizationLicenseExecute(r LicensesApiUpdateOrganizationLicenseRequest) (*InlineResponse20093, *http.Response, error) {
	var (
