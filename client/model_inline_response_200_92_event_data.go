...
// InlineResponse20092EventData An object containing more data related to the event.
type InlineResponse20092EventData struct {
...
func NewInlineResponse20092EventData() *InlineResponse20092EventData {
	this := InlineResponse20092EventData{}
	return &this
}
...
func (o InlineResponse20092EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20092EventData struct {
	value *InlineResponse20092EventData
	isSet bool
}

func (v NullableInlineResponse20092EventData) Get() *InlineResponse20092EventData {
	return v.value
}

func (v *NullableInlineResponse20092EventData) Set(val *InlineResponse20092EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20092EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20092EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20092EventData(val *InlineResponse20092EventData) *NullableInlineResponse20092EventData {
	return &NullableInlineResponse20092EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20092EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20092EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
