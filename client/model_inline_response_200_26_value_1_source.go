...
// InlineResponse20026Value1Source Source of 'custom' type traffic filter
type InlineResponse20026Value1Source struct {
...
func NewInlineResponse20026Value1Source() *InlineResponse20026Value1Source {
	this := InlineResponse20026Value1Source{}
	return &this
}
...
func (o InlineResponse20026Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20026Value1Source struct {
	value *InlineResponse20026Value1Source
	isSet bool
}

func (v NullableInlineResponse20026Value1Source) Get() *InlineResponse20026Value1Source {
	return v.value
}

func (v *NullableInlineResponse20026Value1Source) Set(val *InlineResponse20026Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20026Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20026Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20026Value1Source(val *InlineResponse20026Value1Source) *NullableInlineResponse20026Value1Source {
	return &NullableInlineResponse20026Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20026Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20026Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
