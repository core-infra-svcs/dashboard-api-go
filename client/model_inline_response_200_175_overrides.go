...
// InlineResponse200175Overrides struct for InlineResponse200175Overrides
type InlineResponse200175Overrides struct {
...
// NewInlineResponse200175Overrides instantiates a new InlineResponse200175Overrides object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInlineResponse200175Overrides() *InlineResponse200175Overrides {
	this := InlineResponse200175Overrides{}
	return &this
}

// NewInlineResponse200175OverridesWithDefaults instantiates a new InlineResponse200175Overrides object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInlineResponse200175OverridesWithDefaults() *InlineResponse200175Overrides {
	this := InlineResponse200175Overrides{}
	return &this
}

// GetSwitches returns the Switches field value if set, zero value otherwise.
func (o *InlineResponse200175Overrides) GetSwitches() []string {
...
func (o *InlineResponse200175Overrides) GetSwitchesOk() ([]string, bool) {
	if o == nil || isNil(o.Switches) {
    return nil, false
	}
...
func (o *InlineResponse200175Overrides) HasSwitches() bool {
	if o != nil && !isNil(o.Switches) {
		return true
	}
...
func (o *InlineResponse200175Overrides) SetSwitches(v []string) {
	o.Switches = v
}

// GetStacks returns the Stacks field value if set, zero value otherwise.
func (o *InlineResponse200175Overrides) GetStacks() []string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200175Overrides) GetStacksOk() ([]string, bool) {
	if o == nil || isNil(o.Stacks) {
    return nil, false
	}
...
func (o *InlineResponse200175Overrides) HasStacks() bool {
	if o != nil && !isNil(o.Stacks) {
		return true
	}
...
func (o *InlineResponse200175Overrides) SetStacks(v []string) {
	o.Stacks = v
}

// GetSwitchProfiles returns the SwitchProfiles field value if set, zero value otherwise.
func (o *InlineResponse200175Overrides) GetSwitchProfiles() []string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200175Overrides) GetSwitchProfilesOk() ([]string, bool) {
	if o == nil || isNil(o.SwitchProfiles) {
    return nil, false
	}
...
func (o *InlineResponse200175Overrides) HasSwitchProfiles() bool {
	if o != nil && !isNil(o.SwitchProfiles) {
		return true
	}
...
func (o *InlineResponse200175Overrides) SetSwitchProfiles(v []string) {
	o.SwitchProfiles = v
}

// GetIgmpSnoopingEnabled returns the IgmpSnoopingEnabled field value if set, zero value otherwise.
func (o *InlineResponse200175Overrides) GetIgmpSnoopingEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200175Overrides) GetIgmpSnoopingEnabledOk() (*bool, bool) {
	if o == nil || isNil(o.IgmpSnoopingEnabled) {
    return nil, false
	}
...
func (o *InlineResponse200175Overrides) HasIgmpSnoopingEnabled() bool {
	if o != nil && !isNil(o.IgmpSnoopingEnabled) {
		return true
	}
...
func (o *InlineResponse200175Overrides) SetIgmpSnoopingEnabled(v bool) {
...
func (o *InlineResponse200175Overrides) GetFloodUnknownMulticastTrafficEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200175Overrides) GetFloodUnknownMulticastTrafficEnabledOk() (*bool, bool) {
	if o == nil || isNil(o.FloodUnknownMulticastTrafficEnabled) {
    return nil, false
	}
...
func (o *InlineResponse200175Overrides) HasFloodUnknownMulticastTrafficEnabled() bool {
	if o != nil && !isNil(o.FloodUnknownMulticastTrafficEnabled) {
		return true
	}
...
func (o *InlineResponse200175Overrides) SetFloodUnknownMulticastTrafficEnabled(v bool) {
	o.FloodUnknownMulticastTrafficEnabled = &v
}

func (o InlineResponse200175Overrides) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200175Overrides struct {
	value *InlineResponse200175Overrides
	isSet bool
}

func (v NullableInlineResponse200175Overrides) Get() *InlineResponse200175Overrides {
	return v.value
}

func (v *NullableInlineResponse200175Overrides) Set(val *InlineResponse200175Overrides) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200175Overrides) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200175Overrides) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200175Overrides(val *InlineResponse200175Overrides) *NullableInlineResponse200175Overrides {
	return &NullableInlineResponse200175Overrides{value: val, isSet: true}
}

func (v NullableInlineResponse200175Overrides) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200175Overrides) UnmarshalJSON(src []byte) error {
	v.isSet = true
