...
// InlineResponse20044AlertDestinations A hash of destinations for this specific alert
type InlineResponse20044AlertDestinations struct {
...
func NewInlineResponse20044AlertDestinations() *InlineResponse20044AlertDestinations {
	this := InlineResponse20044AlertDestinations{}
	return &this
}
...
func (o InlineResponse20044AlertDestinations) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20044AlertDestinations struct {
	value *InlineResponse20044AlertDestinations
	isSet bool
}

func (v NullableInlineResponse20044AlertDestinations) Get() *InlineResponse20044AlertDestinations {
	return v.value
}

func (v *NullableInlineResponse20044AlertDestinations) Set(val *InlineResponse20044AlertDestinations) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20044AlertDestinations) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20044AlertDestinations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20044AlertDestinations(val *InlineResponse20044AlertDestinations) *NullableInlineResponse20044AlertDestinations {
	return &NullableInlineResponse20044AlertDestinations{value: val, isSet: true}
}

func (v NullableInlineResponse20044AlertDestinations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20044AlertDestinations) UnmarshalJSON(src []byte) error {
	v.isSet = true
