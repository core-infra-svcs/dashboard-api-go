...
type InlineResponse200343Items struct {
	...
	Controller *InlineResponse200343Controller `json:"controller,omitempty"`
	// The time when AP joins wireless controller
	JoinedAt *string `json:"joinedAt,omitempty"`
	// AP model
	Model *string `json:"model,omitempty"`
	// The tags of the catalyst access point
	Tags []InlineResponse200343Tags `json:"tags,omitempty"`
	// AP mode (local, flex, etc.)
	Mode *string `json:"mode,omitempty"`
	// Country code (2 characters)
	CountryCode *string `json:"countryCode,omitempty"`
	// Catalyst access point details
	Details []InlineResponse200343Details `json:"details,omitempty"`
}
...
func (o *InlineResponse200343Items) GetController() InlineResponse200343Controller {
	if o == nil || isNil(o.Controller) {
		var ret InlineResponse200343Controller
		return ret
	}
	return *o.Controller
}
...
// SetController gets a reference to the given InlineResponse200343Controller and assigns it to the Controller field.
...
func (o *InlineResponse200343Items) GetTags() []InlineResponse200343Tags {
	if o == nil || isNil(o.Tags) {
		var ret []InlineResponse200343Tags
		return ret
	}
	return o.Tags
}
...
// SetTags gets a reference to the given []InlineResponse200343Tags and assigns it to the Tags field.
...
func (o *InlineResponse200343Items) GetDetails() []InlineResponse200343Details {
	if o == nil || isNil(o.Details) {
		var ret []InlineResponse200343Details
		return ret
	}
	return o.Details
}
...
// SetDetails gets a reference to the given []InlineResponse200343Details and assigns it to the Details field.
