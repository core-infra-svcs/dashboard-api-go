...
// InlineResponse200392CountsConnectionsByStatus Access point counts by their status
type InlineResponse200392CountsConnectionsByStatus struct {
...
func NewInlineResponse200392CountsConnectionsByStatus() *InlineResponse200392CountsConnectionsByStatus {
	this := InlineResponse200392CountsConnectionsByStatus{}
	return &this
}
...
func (o InlineResponse200392CountsConnectionsByStatus) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200392CountsConnectionsByStatus struct {
	value *InlineResponse200392CountsConnectionsByStatus
	isSet bool
}

func (v NullableInlineResponse200392CountsConnectionsByStatus) Get() *InlineResponse200392CountsConnectionsByStatus {
	return v.value
}

func (v *NullableInlineResponse200392CountsConnectionsByStatus) Set(val *InlineResponse200392CountsConnectionsByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200392CountsConnectionsByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200392CountsConnectionsByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200392CountsConnectionsByStatus(val *InlineResponse200392CountsConnectionsByStatus) *NullableInlineResponse200392CountsConnectionsByStatus {
	return &NullableInlineResponse200392CountsConnectionsByStatus{value: val, isSet: true}
}

func (v NullableInlineResponse200392CountsConnectionsByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200392CountsConnectionsByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
