...
func (o *InlineObject40) GetRules() []NetworksNetworkIdApplianceFirewallL7FirewallRulesRules {
...
func (o *InlineObject40) GetRulesOk() ([]NetworksNetworkIdApplianceFirewallL7FirewallRulesRules, bool) {
	if o == nil || isNil(o.Rules) {
    return nil, false
	}
	return o.Rules, true
...
func (o *InlineObject40) SetRules(v []NetworksNetworkIdApplianceFirewallL7FirewallRulesRules) {
	o.Rules = v
}
