...
func (r MigrationsApiCreateOrganizationDevicesControllerMigrationRequest) Execute() ([]InlineResponse200283Items, *http.Response, error) {
...
func (a *MigrationsApiService) CreateOrganizationDevicesControllerMigrationExecute(r MigrationsApiCreateOrganizationDevicesControllerMigrationRequest) ([]InlineResponse200283Items, *http.Response, error) {
	var (
...
func (r MigrationsApiGetOrganizationDevicesControllerMigrationsRequest) Execute() (*InlineResponse200283, *http.Response, error) {
...
func (a *MigrationsApiService) GetOrganizationDevicesControllerMigrationsExecute(r MigrationsApiGetOrganizationDevicesControllerMigrationsRequest) (*InlineResponse200283, *http.Response, error) {
	var (
