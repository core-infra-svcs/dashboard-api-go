...
func (r MigrationsApiCreateOrganizationDevicesControllerMigrationRequest) Execute() ([]InlineResponse200270Items, *http.Response, error) {
...
func (a *MigrationsApiService) CreateOrganizationDevicesControllerMigrationExecute(r MigrationsApiCreateOrganizationDevicesControllerMigrationRequest) ([]InlineResponse200270Items, *http.Response, error) {
	var (
...
func (r MigrationsApiGetOrganizationDevicesControllerMigrationsRequest) Execute() (*InlineResponse200270, *http.Response, error) {
...
func (a *MigrationsApiService) GetOrganizationDevicesControllerMigrationsExecute(r MigrationsApiGetOrganizationDevicesControllerMigrationsRequest) (*InlineResponse200270, *http.Response, error) {
	var (
