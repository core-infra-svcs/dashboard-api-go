...
func (r IpsecApiGetOrganizationApplianceVpnSiteToSiteIpsecPeersSlasRequest) Execute() (*InlineResponse200244, *http.Response, error) {
...
func (a *IpsecApiService) GetOrganizationApplianceVpnSiteToSiteIpsecPeersSlasExecute(r IpsecApiGetOrganizationApplianceVpnSiteToSiteIpsecPeersSlasRequest) (*InlineResponse200244, *http.Response, error) {
	var (
...
func (r IpsecApiUpdateOrganizationApplianceVpnSiteToSiteIpsecPeersSlasRequest) Execute() (*InlineResponse200245, *http.Response, error) {
...
func (a *IpsecApiService) UpdateOrganizationApplianceVpnSiteToSiteIpsecPeersSlasExecute(r IpsecApiUpdateOrganizationApplianceVpnSiteToSiteIpsecPeersSlasRequest) (*InlineResponse200245, *http.Response, error) {
	var (
