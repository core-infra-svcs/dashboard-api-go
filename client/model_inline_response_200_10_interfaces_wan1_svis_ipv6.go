...
// InlineResponse20010InterfacesWan1SvisIpv6 IPv6 settings for static/dynamic mode.
type InlineResponse20010InterfacesWan1SvisIpv6 struct {
	...
	Nameservers *InlineResponse20010InterfacesWan1SvisIpv4Nameservers `json:"nameservers,omitempty"`
}
...
func NewInlineResponse20010InterfacesWan1SvisIpv6() *InlineResponse20010InterfacesWan1SvisIpv6 {
	this := InlineResponse20010InterfacesWan1SvisIpv6{}
	return &this
}
...
func (o *InlineResponse20010InterfacesWan1SvisIpv6) GetNameservers() InlineResponse20010InterfacesWan1SvisIpv4Nameservers {
	if o == nil || isNil(o.Nameservers) {
		var ret InlineResponse20010InterfacesWan1SvisIpv4Nameservers
		return ret
	}
...
// SetNameservers gets a reference to the given InlineResponse20010InterfacesWan1SvisIpv4Nameservers and assigns it to the Nameservers field.
func (o *InlineResponse20010InterfacesWan1SvisIpv6) SetNameservers(v InlineResponse20010InterfacesWan1SvisIpv4Nameservers) {
	o.Nameservers = &v
}

func (o InlineResponse20010InterfacesWan1SvisIpv6) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20010InterfacesWan1SvisIpv6 struct {
	value *InlineResponse20010InterfacesWan1SvisIpv6
	isSet bool
}

func (v NullableInlineResponse20010InterfacesWan1SvisIpv6) Get() *InlineResponse20010InterfacesWan1SvisIpv6 {
	return v.value
}

func (v *NullableInlineResponse20010InterfacesWan1SvisIpv6) Set(val *InlineResponse20010InterfacesWan1SvisIpv6) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20010InterfacesWan1SvisIpv6) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20010InterfacesWan1SvisIpv6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20010InterfacesWan1SvisIpv6(val *InlineResponse20010InterfacesWan1SvisIpv6) *NullableInlineResponse20010InterfacesWan1SvisIpv6 {
	return &NullableInlineResponse20010InterfacesWan1SvisIpv6{value: val, isSet: true}
}

func (v NullableInlineResponse20010InterfacesWan1SvisIpv6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20010InterfacesWan1SvisIpv6) UnmarshalJSON(src []byte) error {
	v.isSet = true
