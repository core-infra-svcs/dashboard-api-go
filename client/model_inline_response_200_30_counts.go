...
// InlineResponse20030Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse20030Counts struct {
	...
	Noise *InlineResponse20030CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse20030Counts() *InlineResponse20030Counts {
	this := InlineResponse20030Counts{}
	return &this
}
...
func (o *InlineResponse20030Counts) GetNoise() InlineResponse20030CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse20030CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse20030CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse20030Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20030Counts struct {
	value *InlineResponse20030Counts
	isSet bool
}

func (v NullableInlineResponse20030Counts) Get() *InlineResponse20030Counts {
	return v.value
}

func (v *NullableInlineResponse20030Counts) Set(val *InlineResponse20030Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20030Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20030Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20030Counts(val *InlineResponse20030Counts) *NullableInlineResponse20030Counts {
	return &NullableInlineResponse20030Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20030Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20030Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
