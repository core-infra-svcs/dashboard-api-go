...
// InlineResponse20046DefaultDestinations The network-wide destinations for all alerts on the network.
type InlineResponse20046DefaultDestinations struct {
...
func NewInlineResponse20046DefaultDestinations() *InlineResponse20046DefaultDestinations {
	this := InlineResponse20046DefaultDestinations{}
	return &this
}
...
func (o InlineResponse20046DefaultDestinations) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20046DefaultDestinations struct {
	value *InlineResponse20046DefaultDestinations
	isSet bool
}

func (v NullableInlineResponse20046DefaultDestinations) Get() *InlineResponse20046DefaultDestinations {
	return v.value
}

func (v *NullableInlineResponse20046DefaultDestinations) Set(val *InlineResponse20046DefaultDestinations) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20046DefaultDestinations) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20046DefaultDestinations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20046DefaultDestinations(val *InlineResponse20046DefaultDestinations) *NullableInlineResponse20046DefaultDestinations {
	return &NullableInlineResponse20046DefaultDestinations{value: val, isSet: true}
}

func (v NullableInlineResponse20046DefaultDestinations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20046DefaultDestinations) UnmarshalJSON(src []byte) error {
	v.isSet = true
