...
// InlineResponse20028DynamicDns Dynamic DNS settings for a network
type InlineResponse20028DynamicDns struct {
	// Dynamic DNS enabled
...
func NewInlineResponse20028DynamicDns() *InlineResponse20028DynamicDns {
	this := InlineResponse20028DynamicDns{}
	return &this
}
...
func (o InlineResponse20028DynamicDns) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20028DynamicDns struct {
	value *InlineResponse20028DynamicDns
	isSet bool
}

func (v NullableInlineResponse20028DynamicDns) Get() *InlineResponse20028DynamicDns {
	return v.value
}

func (v *NullableInlineResponse20028DynamicDns) Set(val *InlineResponse20028DynamicDns) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20028DynamicDns) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20028DynamicDns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20028DynamicDns(val *InlineResponse20028DynamicDns) *NullableInlineResponse20028DynamicDns {
	return &NullableInlineResponse20028DynamicDns{value: val, isSet: true}
}

func (v NullableInlineResponse20028DynamicDns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20028DynamicDns) UnmarshalJSON(src []byte) error {
	v.isSet = true
