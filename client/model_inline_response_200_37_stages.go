...
// InlineResponse20037Stages struct for InlineResponse20037Stages
type InlineResponse20037Stages struct {
	Group *InlineResponse20037Group `json:"group,omitempty"`
	Milestones *InlineResponse20037Milestones `json:"milestones,omitempty"`
...
func NewInlineResponse20037Stages() *InlineResponse20037Stages {
	this := InlineResponse20037Stages{}
	return &this
}
...
func (o *InlineResponse20037Stages) GetGroup() InlineResponse20037Group {
	if o == nil || isNil(o.Group) {
		var ret InlineResponse20037Group
		return ret
	}
	return *o.Group
}
...
// SetGroup gets a reference to the given InlineResponse20037Group and assigns it to the Group field.
...
func (o *InlineResponse20037Stages) GetMilestones() InlineResponse20037Milestones {
	if o == nil || isNil(o.Milestones) {
		var ret InlineResponse20037Milestones
		return ret
	}
	return *o.Milestones
}
...
// SetMilestones gets a reference to the given InlineResponse20037Milestones and assigns it to the Milestones field.
...
func (o InlineResponse20037Stages) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20037Stages struct {
	value *InlineResponse20037Stages
	isSet bool
}

func (v NullableInlineResponse20037Stages) Get() *InlineResponse20037Stages {
	return v.value
}

func (v *NullableInlineResponse20037Stages) Set(val *InlineResponse20037Stages) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20037Stages) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20037Stages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20037Stages(val *InlineResponse20037Stages) *NullableInlineResponse20037Stages {
	return &NullableInlineResponse20037Stages{value: val, isSet: true}
}

func (v NullableInlineResponse20037Stages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20037Stages) UnmarshalJSON(src []byte) error {
	v.isSet = true
