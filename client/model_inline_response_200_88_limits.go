...
// InlineResponse20088Limits The current limits of various adaptive policy objects.
type InlineResponse20088Limits struct {
...
func NewInlineResponse20088Limits() *InlineResponse20088Limits {
	this := InlineResponse20088Limits{}
	return &this
}
...
func (o InlineResponse20088Limits) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20088Limits struct {
	value *InlineResponse20088Limits
	isSet bool
}

func (v NullableInlineResponse20088Limits) Get() *InlineResponse20088Limits {
	return v.value
}

func (v *NullableInlineResponse20088Limits) Set(val *InlineResponse20088Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20088Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20088Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20088Limits(val *InlineResponse20088Limits) *NullableInlineResponse20088Limits {
	return &NullableInlineResponse20088Limits{value: val, isSet: true}
}

func (v NullableInlineResponse20088Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20088Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
