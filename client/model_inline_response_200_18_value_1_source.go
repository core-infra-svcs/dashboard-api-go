...
// InlineResponse20018Value1Source Source of 'custom' type traffic filter
type InlineResponse20018Value1Source struct {
...
func NewInlineResponse20018Value1Source() *InlineResponse20018Value1Source {
	this := InlineResponse20018Value1Source{}
	return &this
}
...
func (o InlineResponse20018Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20018Value1Source struct {
	value *InlineResponse20018Value1Source
	isSet bool
}

func (v NullableInlineResponse20018Value1Source) Get() *InlineResponse20018Value1Source {
	return v.value
}

func (v *NullableInlineResponse20018Value1Source) Set(val *InlineResponse20018Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20018Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20018Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20018Value1Source(val *InlineResponse20018Value1Source) *NullableInlineResponse20018Value1Source {
	return &NullableInlineResponse20018Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20018Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20018Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
