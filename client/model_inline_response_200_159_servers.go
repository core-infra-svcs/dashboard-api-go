...
// InlineResponse200159Servers struct for InlineResponse200159Servers
type InlineResponse200159Servers struct {
...
func NewInlineResponse200159Servers() *InlineResponse200159Servers {
	this := InlineResponse200159Servers{}
	return &this
}
...
func (o InlineResponse200159Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200159Servers struct {
	value *InlineResponse200159Servers
	isSet bool
}

func (v NullableInlineResponse200159Servers) Get() *InlineResponse200159Servers {
	return v.value
}

func (v *NullableInlineResponse200159Servers) Set(val *InlineResponse200159Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200159Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200159Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200159Servers(val *InlineResponse200159Servers) *NullableInlineResponse200159Servers {
	return &NullableInlineResponse200159Servers{value: val, isSet: true}
}

func (v NullableInlineResponse200159Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200159Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
