...
func (r CustomPerformanceClassesApiCreateNetworkApplianceTrafficShapingCustomPerformanceClassRequest) Execute() (*InlineResponse20072, *http.Response, error) {
...
func (a *CustomPerformanceClassesApiService) CreateNetworkApplianceTrafficShapingCustomPerformanceClassExecute(r CustomPerformanceClassesApiCreateNetworkApplianceTrafficShapingCustomPerformanceClassRequest) (*InlineResponse20072, *http.Response, error) {
	var (
...
func (r CustomPerformanceClassesApiGetNetworkApplianceTrafficShapingCustomPerformanceClassRequest) Execute() (*InlineResponse20072, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20072
func (a *CustomPerformanceClassesApiService) GetNetworkApplianceTrafficShapingCustomPerformanceClassExecute(r CustomPerformanceClassesApiGetNetworkApplianceTrafficShapingCustomPerformanceClassRequest) (*InlineResponse20072, *http.Response, error) {
	var (
...
func (r CustomPerformanceClassesApiGetNetworkApplianceTrafficShapingCustomPerformanceClassesRequest) Execute() ([]InlineResponse20072, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20072
func (a *CustomPerformanceClassesApiService) GetNetworkApplianceTrafficShapingCustomPerformanceClassesExecute(r CustomPerformanceClassesApiGetNetworkApplianceTrafficShapingCustomPerformanceClassesRequest) ([]InlineResponse20072, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CustomPerformanceClassesApiUpdateNetworkApplianceTrafficShapingCustomPerformanceClassRequest) Execute() (*InlineResponse20072, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20072
func (a *CustomPerformanceClassesApiService) UpdateNetworkApplianceTrafficShapingCustomPerformanceClassExecute(r CustomPerformanceClassesApiUpdateNetworkApplianceTrafficShapingCustomPerformanceClassRequest) (*InlineResponse20072, *http.Response, error) {
	var (
