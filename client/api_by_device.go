...
func (r ByDeviceApiApiGetNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDeviceRequest) Execute() ([]map[string]interface{}, *_nethttp.Response, error) {
...
func (a *ByDeviceApiService) GetNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDeviceExecute(r ByDeviceApiApiGetNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDeviceRequest) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
