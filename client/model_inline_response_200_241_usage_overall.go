...
// InlineResponse200241UsageOverall Overall data usage of all clients across organization
type InlineResponse200241UsageOverall struct {
...
func NewInlineResponse200241UsageOverall() *InlineResponse200241UsageOverall {
	this := InlineResponse200241UsageOverall{}
	return &this
}
...
func (o InlineResponse200241UsageOverall) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200241UsageOverall struct {
	value *InlineResponse200241UsageOverall
	isSet bool
}

func (v NullableInlineResponse200241UsageOverall) Get() *InlineResponse200241UsageOverall {
	return v.value
}

func (v *NullableInlineResponse200241UsageOverall) Set(val *InlineResponse200241UsageOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200241UsageOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200241UsageOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200241UsageOverall(val *InlineResponse200241UsageOverall) *NullableInlineResponse200241UsageOverall {
	return &NullableInlineResponse200241UsageOverall{value: val, isSet: true}
}

func (v NullableInlineResponse200241UsageOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200241UsageOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
