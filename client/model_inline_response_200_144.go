...
type InlineResponse200144 struct {
	Alerts *InlineResponse200144Alerts `json:"alerts,omitempty"`
	...
	ArpInspection *InlineResponse200144ArpInspection `json:"arpInspection,omitempty"`
}
...
func (o *InlineResponse200144) GetAlerts() InlineResponse200144Alerts {
	if o == nil || isNil(o.Alerts) {
		var ret InlineResponse200144Alerts
		return ret
	}
	return *o.Alerts
}
...
// SetAlerts gets a reference to the given InlineResponse200144Alerts and assigns it to the Alerts field.
...
func (o *InlineResponse200144) GetArpInspection() InlineResponse200144ArpInspection {
	if o == nil || isNil(o.ArpInspection) {
		var ret InlineResponse200144ArpInspection
		return ret
	}
...
// SetArpInspection gets a reference to the given InlineResponse200144ArpInspection and assigns it to the ArpInspection field.
