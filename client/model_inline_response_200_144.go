...
type InlineResponse200144 struct {
	...
	Mappings []InlineResponse200144Mappings `json:"mappings,omitempty"`
}
...
func (o *InlineResponse200144) GetMappings() []InlineResponse200144Mappings {
	if o == nil || isNil(o.Mappings) {
		var ret []InlineResponse200144Mappings
		return ret
	}
	return o.Mappings
}
...
// SetMappings gets a reference to the given []InlineResponse200144Mappings and assigns it to the Mappings field.
