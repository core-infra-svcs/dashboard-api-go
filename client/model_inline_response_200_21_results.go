...
// InlineResponse20021Results Results of the ping request.
type InlineResponse20021Results struct {
	// Number of packets sent
	Sent *int32 `json:"sent,omitempty"`
	// Number of packets received
	Received *int32 `json:"received,omitempty"`
	Loss *InlineResponse20021ResultsLoss `json:"loss,omitempty"`
	Latencies *InlineResponse20021ResultsLatencies `json:"latencies,omitempty"`
	// Received packets
	Replies []InlineResponse20021ResultsReplies `json:"replies,omitempty"`
}
...
func (o *InlineResponse20021Results) GetLoss() InlineResponse20021ResultsLoss {
	if o == nil || isNil(o.Loss) {
		var ret InlineResponse20021ResultsLoss
		return ret
	}
	return *o.Loss
}
...
// SetLoss gets a reference to the given InlineResponse20021ResultsLoss and assigns it to the Loss field.
...
func (o *InlineResponse20021Results) GetLatencies() InlineResponse20021ResultsLatencies {
	if o == nil || isNil(o.Latencies) {
		var ret InlineResponse20021ResultsLatencies
		return ret
	}
	return *o.Latencies
}
...
// SetLatencies gets a reference to the given InlineResponse20021ResultsLatencies and assigns it to the Latencies field.
...
func (o *InlineResponse20021Results) GetReplies() []InlineResponse20021ResultsReplies {
	if o == nil || isNil(o.Replies) {
		var ret []InlineResponse20021ResultsReplies
		return ret
	}
	return o.Replies
}
...
// SetReplies gets a reference to the given []InlineResponse20021ResultsReplies and assigns it to the Replies field.
