...
// InlineResponse20027PerSsidSettings3 Settings for SSID 3.
type InlineResponse20027PerSsidSettings3 struct {
...
func NewInlineResponse20027PerSsidSettings3() *InlineResponse20027PerSsidSettings3 {
	this := InlineResponse20027PerSsidSettings3{}
	return &this
}
...
func (o InlineResponse20027PerSsidSettings3) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20027PerSsidSettings3 struct {
	value *InlineResponse20027PerSsidSettings3
	isSet bool
}

func (v NullableInlineResponse20027PerSsidSettings3) Get() *InlineResponse20027PerSsidSettings3 {
	return v.value
}

func (v *NullableInlineResponse20027PerSsidSettings3) Set(val *InlineResponse20027PerSsidSettings3) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20027PerSsidSettings3) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20027PerSsidSettings3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20027PerSsidSettings3(val *InlineResponse20027PerSsidSettings3) *NullableInlineResponse20027PerSsidSettings3 {
	return &NullableInlineResponse20027PerSsidSettings3{value: val, isSet: true}
}

func (v NullableInlineResponse20027PerSsidSettings3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20027PerSsidSettings3) UnmarshalJSON(src []byte) error {
	v.isSet = true
