...
func (r HealthByTimeApiGetNetworkInsightApplicationHealthByTimeRequest) Execute() ([]InlineResponse200111, *http.Response, error) {
...
func (a *HealthByTimeApiService) GetNetworkInsightApplicationHealthByTimeExecute(r HealthByTimeApiGetNetworkInsightApplicationHealthByTimeRequest) ([]InlineResponse200111, *http.Response, error) {
	var (
