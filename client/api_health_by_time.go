...
func (r HealthByTimeApiGetNetworkInsightApplicationHealthByTimeRequest) Execute() ([]InlineResponse200102, *http.Response, error) {
...
func (a *HealthByTimeApiService) GetNetworkInsightApplicationHealthByTimeExecute(r HealthByTimeApiGetNetworkInsightApplicationHealthByTimeRequest) ([]InlineResponse200102, *http.Response, error) {
	var (
