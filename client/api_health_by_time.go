...
func (r HealthByTimeApiGetNetworkInsightApplicationHealthByTimeRequest) Execute() ([]InlineResponse20097, *http.Response, error) {
...
func (a *HealthByTimeApiService) GetNetworkInsightApplicationHealthByTimeExecute(r HealthByTimeApiGetNetworkInsightApplicationHealthByTimeRequest) ([]InlineResponse20097, *http.Response, error) {
	var (
