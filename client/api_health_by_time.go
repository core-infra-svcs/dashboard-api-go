...
func (r HealthByTimeApiGetNetworkInsightApplicationHealthByTimeRequest) Execute() ([]InlineResponse20027, *http.Response, error) {
...
func (a *HealthByTimeApiService) GetNetworkInsightApplicationHealthByTimeExecute(r HealthByTimeApiGetNetworkInsightApplicationHealthByTimeRequest) ([]InlineResponse20027, *http.Response, error) {
	var (
