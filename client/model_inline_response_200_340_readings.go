...
// InlineResponse200340Readings struct for InlineResponse200340Readings
type InlineResponse200340Readings struct {
	...
	Rate *InlineResponse200340Rate `json:"rate,omitempty"`
}
...
func NewInlineResponse200340Readings() *InlineResponse200340Readings {
	this := InlineResponse200340Readings{}
	return &this
}
...
func (o *InlineResponse200340Readings) GetRate() InlineResponse200340Rate {
	if o == nil || isNil(o.Rate) {
		var ret InlineResponse200340Rate
		return ret
	}
	return *o.Rate
}
...
// SetRate gets a reference to the given InlineResponse200340Rate and assigns it to the Rate field.
func (o *InlineResponse200340Readings) SetRate(v InlineResponse200340Rate) {
	o.Rate = &v
}

func (o InlineResponse200340Readings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200340Readings struct {
	value *InlineResponse200340Readings
	isSet bool
}

func (v NullableInlineResponse200340Readings) Get() *InlineResponse200340Readings {
	return v.value
}

func (v *NullableInlineResponse200340Readings) Set(val *InlineResponse200340Readings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200340Readings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200340Readings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200340Readings(val *InlineResponse200340Readings) *NullableInlineResponse200340Readings {
	return &NullableInlineResponse200340Readings{value: val, isSet: true}
}

func (v NullableInlineResponse200340Readings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200340Readings) UnmarshalJSON(src []byte) error {
	v.isSet = true
