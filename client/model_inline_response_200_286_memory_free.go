...
// InlineResponse200286MemoryFree Information regarding memory availability on the device over the interval
type InlineResponse200286MemoryFree struct {
...
func NewInlineResponse200286MemoryFree() *InlineResponse200286MemoryFree {
	this := InlineResponse200286MemoryFree{}
	return &this
}
...
func (o InlineResponse200286MemoryFree) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200286MemoryFree struct {
	value *InlineResponse200286MemoryFree
	isSet bool
}

func (v NullableInlineResponse200286MemoryFree) Get() *InlineResponse200286MemoryFree {
	return v.value
}

func (v *NullableInlineResponse200286MemoryFree) Set(val *InlineResponse200286MemoryFree) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200286MemoryFree) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200286MemoryFree) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200286MemoryFree(val *InlineResponse200286MemoryFree) *NullableInlineResponse200286MemoryFree {
	return &NullableInlineResponse200286MemoryFree{value: val, isSet: true}
}

func (v NullableInlineResponse200286MemoryFree) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200286MemoryFree) UnmarshalJSON(src []byte) error {
	v.isSet = true
