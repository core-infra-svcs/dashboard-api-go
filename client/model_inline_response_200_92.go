...
type InlineResponse20092 struct {
	...
	ToVersion *InlineResponse20092ToVersion `json:"toVersion,omitempty"`
...
func (o *InlineResponse20092) GetToVersion() InlineResponse20092ToVersion {
	if o == nil || isNil(o.ToVersion) {
		var ret InlineResponse20092ToVersion
		return ret
	}
	return *o.ToVersion
}
...
// SetToVersion gets a reference to the given InlineResponse20092ToVersion and assigns it to the ToVersion field.
