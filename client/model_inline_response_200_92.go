...
type InlineResponse20092 struct {
	...
	DhcpOptions []InlineResponse20092DhcpOptions `json:"dhcpOptions,omitempty"`
	// Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
	ReservedIpRanges []InlineResponse20092ReservedIpRanges `json:"reservedIpRanges,omitempty"`
	// Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
	FixedIpAssignments []InlineResponse20092FixedIpAssignments `json:"fixedIpAssignments,omitempty"`
}
...
func (o *InlineResponse20092) GetDhcpOptions() []InlineResponse20092DhcpOptions {
	if o == nil || isNil(o.DhcpOptions) {
		var ret []InlineResponse20092DhcpOptions
		return ret
	}
...
// SetDhcpOptions gets a reference to the given []InlineResponse20092DhcpOptions and assigns it to the DhcpOptions field.
...
func (o *InlineResponse20092) GetReservedIpRanges() []InlineResponse20092ReservedIpRanges {
	if o == nil || isNil(o.ReservedIpRanges) {
		var ret []InlineResponse20092ReservedIpRanges
		return ret
	}
...
// SetReservedIpRanges gets a reference to the given []InlineResponse20092ReservedIpRanges and assigns it to the ReservedIpRanges field.
...
func (o *InlineResponse20092) GetFixedIpAssignments() []InlineResponse20092FixedIpAssignments {
	if o == nil || isNil(o.FixedIpAssignments) {
		var ret []InlineResponse20092FixedIpAssignments
		return ret
	}
...
// SetFixedIpAssignments gets a reference to the given []InlineResponse20092FixedIpAssignments and assigns it to the FixedIpAssignments field.
