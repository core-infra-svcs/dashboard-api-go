...
type InlineResponse20092 struct {
	...
	ApiAuthentication *InlineResponse20092ApiAuthentication `json:"apiAuthentication,omitempty"`
}
...
func (o *InlineResponse20092) GetEnforcePasswordExpiration() bool {
...
func (o *InlineResponse20092) GetEnforcePasswordExpirationOk() (*bool, bool) {
	if o == nil || isNil(o.EnforcePasswordExpiration) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasEnforcePasswordExpiration() bool {
	if o != nil && !isNil(o.EnforcePasswordExpiration) {
		return true
	}
...
func (o *InlineResponse20092) SetEnforcePasswordExpiration(v bool) {
...
func (o *InlineResponse20092) GetPasswordExpirationDays() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20092) GetPasswordExpirationDaysOk() (*int32, bool) {
	if o == nil || isNil(o.PasswordExpirationDays) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasPasswordExpirationDays() bool {
	if o != nil && !isNil(o.PasswordExpirationDays) {
		return true
	}
...
func (o *InlineResponse20092) SetPasswordExpirationDays(v int32) {
...
func (o *InlineResponse20092) GetEnforceDifferentPasswords() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20092) GetEnforceDifferentPasswordsOk() (*bool, bool) {
	if o == nil || isNil(o.EnforceDifferentPasswords) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasEnforceDifferentPasswords() bool {
	if o != nil && !isNil(o.EnforceDifferentPasswords) {
		return true
	}
...
func (o *InlineResponse20092) SetEnforceDifferentPasswords(v bool) {
...
func (o *InlineResponse20092) GetNumDifferentPasswords() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20092) GetNumDifferentPasswordsOk() (*int32, bool) {
	if o == nil || isNil(o.NumDifferentPasswords) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasNumDifferentPasswords() bool {
	if o != nil && !isNil(o.NumDifferentPasswords) {
		return true
	}
...
func (o *InlineResponse20092) SetNumDifferentPasswords(v int32) {
...
func (o *InlineResponse20092) GetEnforceStrongPasswords() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20092) GetEnforceStrongPasswordsOk() (*bool, bool) {
	if o == nil || isNil(o.EnforceStrongPasswords) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasEnforceStrongPasswords() bool {
	if o != nil && !isNil(o.EnforceStrongPasswords) {
		return true
	}
...
func (o *InlineResponse20092) SetEnforceStrongPasswords(v bool) {
...
func (o *InlineResponse20092) GetEnforceAccountLockout() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20092) GetEnforceAccountLockoutOk() (*bool, bool) {
	if o == nil || isNil(o.EnforceAccountLockout) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasEnforceAccountLockout() bool {
	if o != nil && !isNil(o.EnforceAccountLockout) {
		return true
	}
...
func (o *InlineResponse20092) SetEnforceAccountLockout(v bool) {
...
func (o *InlineResponse20092) GetAccountLockoutAttempts() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20092) GetAccountLockoutAttemptsOk() (*int32, bool) {
	if o == nil || isNil(o.AccountLockoutAttempts) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasAccountLockoutAttempts() bool {
	if o != nil && !isNil(o.AccountLockoutAttempts) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20092) GetEnforceIdleTimeoutOk() (*bool, bool) {
	if o == nil || isNil(o.EnforceIdleTimeout) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasEnforceIdleTimeout() bool {
	if o != nil && !isNil(o.EnforceIdleTimeout) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20092) GetIdleTimeoutMinutesOk() (*int32, bool) {
	if o == nil || isNil(o.IdleTimeoutMinutes) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasIdleTimeoutMinutes() bool {
	if o != nil && !isNil(o.IdleTimeoutMinutes) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20092) GetEnforceTwoFactorAuthOk() (*bool, bool) {
	if o == nil || isNil(o.EnforceTwoFactorAuth) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasEnforceTwoFactorAuth() bool {
	if o != nil && !isNil(o.EnforceTwoFactorAuth) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20092) GetEnforceLoginIpRangesOk() (*bool, bool) {
	if o == nil || isNil(o.EnforceLoginIpRanges) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasEnforceLoginIpRanges() bool {
	if o != nil && !isNil(o.EnforceLoginIpRanges) {
		return true
	}
...
func (o *InlineResponse20092) SetEnforceLoginIpRanges(v bool) {
	o.EnforceLoginIpRanges = &v
}

// GetLoginIpRanges returns the LoginIpRanges field value if set, zero value otherwise.
func (o *InlineResponse20092) GetLoginIpRanges() []string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20092) GetLoginIpRangesOk() ([]string, bool) {
	if o == nil || isNil(o.LoginIpRanges) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasLoginIpRanges() bool {
	if o != nil && !isNil(o.LoginIpRanges) {
		return true
	}
...
func (o *InlineResponse20092) SetLoginIpRanges(v []string) {
	o.LoginIpRanges = v
}

// GetApiAuthentication returns the ApiAuthentication field value if set, zero value otherwise.
func (o *InlineResponse20092) GetApiAuthentication() InlineResponse20092ApiAuthentication {
	if o == nil || isNil(o.ApiAuthentication) {
		var ret InlineResponse20092ApiAuthentication
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20092) GetApiAuthenticationOk() (*InlineResponse20092ApiAuthentication, bool) {
	if o == nil || isNil(o.ApiAuthentication) {
    return nil, false
	}
...
func (o *InlineResponse20092) HasApiAuthentication() bool {
	if o != nil && !isNil(o.ApiAuthentication) {
		return true
	}
...
// SetApiAuthentication gets a reference to the given InlineResponse20092ApiAuthentication and assigns it to the ApiAuthentication field.
func (o *InlineResponse20092) SetApiAuthentication(v InlineResponse20092ApiAuthentication) {
