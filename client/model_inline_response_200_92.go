...
type InlineResponse20092 struct {
	...
	Devices []InlineResponse20084 `json:"devices,omitempty"`
...
// SetDevices gets a reference to the given []InlineResponse20084 and assigns it to the Devices field.
