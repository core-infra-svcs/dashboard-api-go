...
type InlineResponse20092 struct {
	...
	PoliciesBySsid []InlineResponse20092PoliciesBySsid `json:"policiesBySsid,omitempty"`
}
...
func (o *InlineResponse20092) GetPoliciesBySsid() []InlineResponse20092PoliciesBySsid {
	if o == nil || isNil(o.PoliciesBySsid) {
		var ret []InlineResponse20092PoliciesBySsid
		return ret
	}
...
// SetPoliciesBySsid gets a reference to the given []InlineResponse20092PoliciesBySsid and assigns it to the PoliciesBySsid field.
