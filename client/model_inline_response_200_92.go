...
type InlineResponse20092 struct {
	...
	Events []InlineResponse20092Events `json:"events,omitempty"`
}
...
func (o *InlineResponse20092) GetEvents() []InlineResponse20092Events {
	if o == nil || isNil(o.Events) {
		var ret []InlineResponse20092Events
		return ret
	}
	return o.Events
}
...
// SetEvents gets a reference to the given []InlineResponse20092Events and assigns it to the Events field.
