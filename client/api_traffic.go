...
func (r TrafficApiGetNetworkTrafficRequest) Execute() ([]InlineResponse200172, *http.Response, error) {
...
func (a *TrafficApiService) GetNetworkTrafficExecute(r TrafficApiGetNetworkTrafficRequest) ([]InlineResponse200172, *http.Response, error) {
	var (
