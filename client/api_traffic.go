...
func (r TrafficApiGetNetworkTrafficRequest) Execute() ([]InlineResponse200171, *http.Response, error) {
...
func (a *TrafficApiService) GetNetworkTrafficExecute(r TrafficApiGetNetworkTrafficRequest) ([]InlineResponse200171, *http.Response, error) {
	var (
