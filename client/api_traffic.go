...
func (r TrafficApiGetNetworkTrafficRequest) Execute() ([]InlineResponse200180, *http.Response, error) {
...
func (a *TrafficApiService) GetNetworkTrafficExecute(r TrafficApiGetNetworkTrafficRequest) ([]InlineResponse200180, *http.Response, error) {
	var (
