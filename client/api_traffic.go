...
func (r TrafficApiGetNetworkTrafficRequest) Execute() ([]InlineResponse200166, *http.Response, error) {
...
func (a *TrafficApiService) GetNetworkTrafficExecute(r TrafficApiGetNetworkTrafficRequest) ([]InlineResponse200166, *http.Response, error) {
	var (
