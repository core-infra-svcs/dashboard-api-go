...
func (r TrafficApiGetNetworkTrafficRequest) Execute() ([]InlineResponse200174, *http.Response, error) {
...
func (a *TrafficApiService) GetNetworkTrafficExecute(r TrafficApiGetNetworkTrafficRequest) ([]InlineResponse200174, *http.Response, error) {
	var (
