...
func (r TrafficApiApiGetNetworkTrafficRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *TrafficApiService) GetNetworkTraffic(ctx context.Context, networkId string) TrafficApiApiGetNetworkTrafficRequest {
	return TrafficApiApiGetNetworkTrafficRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
func (a *TrafficApiService) GetNetworkTrafficExecute(r TrafficApiApiGetNetworkTrafficRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
