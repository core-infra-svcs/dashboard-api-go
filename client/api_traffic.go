...
func (r TrafficApiGetNetworkTrafficRequest) Execute() ([]InlineResponse200186, *http.Response, error) {
...
func (a *TrafficApiService) GetNetworkTrafficExecute(r TrafficApiGetNetworkTrafficRequest) ([]InlineResponse200186, *http.Response, error) {
	var (
