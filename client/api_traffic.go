...
func (r TrafficApiGetNetworkTrafficRequest) Execute() ([]InlineResponse200176, *http.Response, error) {
...
func (a *TrafficApiService) GetNetworkTrafficExecute(r TrafficApiGetNetworkTrafficRequest) ([]InlineResponse200176, *http.Response, error) {
	var (
