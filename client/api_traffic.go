...
func (r TrafficApiGetNetworkTrafficRequest) Execute() ([]InlineResponse200170, *http.Response, error) {
...
func (a *TrafficApiService) GetNetworkTrafficExecute(r TrafficApiGetNetworkTrafficRequest) ([]InlineResponse200170, *http.Response, error) {
	var (
